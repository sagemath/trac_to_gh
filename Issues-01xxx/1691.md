...
```json
{
    ...
    "title": "[with positive review] old bug in pari.gen __setitem__ code",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11592",
    "user": "https://github.com/craigcitro"
}
```
...
archive/attachments_001307.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_1691.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1691/trac_1691.patch",
    "created_at": "2008-01-05T09:00:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11593",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1691#event-4962"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nI think I understand what this patch is doing.  It seems excessively complicated and possibly broken.\n\n1) Sometimes `_GEN_`owner refers to another gen with the same value as self; sometimes it refers to another gen (a matrix or vector) such that self is an element of `_GEN_`owner.  This is quite confusing.\n\nI think the latter case is the only important case; then `_GEN_`owner should be renamed to `_GEN_`parent.\n\nIn the former case, instead of creating multiple gen elements with the same value, and setting `_GEN_`owner, it should just use the original gen.  So:\n\n```\n                    return P.new_ref((<gen>x).g,x)\n```\nwould become\n\n```\n                    return x\n```\n\n2) There need to be more comments describing these fields.\n\n3) (less important): It seems that ._owner_set is true iff ._GEN_owner is not None; I recommend removing this field and just checking ._GEN_owner (or, in the rewritten patch, ._GEN_parent), to save memory at a (probably) negligible cost in time.",
    "created_at": "2008-01-06T05:28:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11594",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with new patch] old bug in pari.gen __setitem__ code"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1691#event-4963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11595",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1691/1691v2.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11596",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11597",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "rename": {
        "from": "[with new patch] old bug in pari.gen __setitem__ code",
        "to": "[with positive review] old bug in pari.gen __setitem__ code"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1691#event-4964"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1691#event-4965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11598",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1691#issuecomment-11599",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
