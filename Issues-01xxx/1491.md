...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10023",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10024",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "rename": {
        "from": "[with patch] improve conversion from interface to sage objects (i.e., the dot sage method)",
        "to": "[with patch, with positive review] improve conversion from interface to sage objects (i.e., the dot sage method)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1491#event-5106"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10025",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1491#event-5107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10026",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
