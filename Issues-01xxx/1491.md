# Issue 1491: [with positive review] improve conversion from interface to sage objects (i.e., the dot sage method)
...
```json
{
    ...
    "title": "[with positive review] improve conversion from interface to sage objects (i.e., the dot sage method)",
    "type": "issue",
...
```json
{
    ...
    "asset_name": "trac-1491.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1491/trac-1491.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10330",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10331",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "rename": {
        "from": "improve conversion from interface to sage objects (i.e., the dot sage method)",
        "to": "[with positive review] improve conversion from interface to sage objects (i.e., the dot sage method)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1491#event-4487"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10332",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1491#event-4488"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1491#issuecomment-10333",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
