...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1491/trac-1491.patch",
    "created_at": "2007-12-13T20:24:12Z",
    "issue": "https://github.com/sagemath/sage/issues/1491",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1491/trac-1491.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [trac-1491.patch](https://github.com/sagemath/sage/files/ticket1491/trac-1491.patch) by @williamstein created at 2007-12-13 20:24:12",
    "created_at": "2007-12-13T20:24:12Z",
    "issue": "https://github.com/sagemath/sage/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1491#issuecomment-7412",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac-1491.patch](https://github.com/sagemath/sage/files/ticket1491/trac-1491.patch) by @williamstein created at 2007-12-13 20:24:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1491#issuecomment-7413",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1491#event-7001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1491#issuecomment-7414",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1491#event-7002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1491",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1491#event-7003"
}
```
