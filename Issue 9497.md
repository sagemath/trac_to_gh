...
```json
{
    "body": "cf. http://trac.sagemath.org/sage_trac/ticket/8059#comment:65",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9497#issuecomment-91199",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "Dave: the test seems to have succeeded: each of the 100 builds reported building successfully.  I suppose to really test it, I should run full doctests after each build, but I didn't do that.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9497#issuecomment-91203",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "As far as doctesting goes, it's probably not sufficient, but testing sage/sage/libs/singular/ is a quick check to make sure things are working.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9497#issuecomment-91205",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "Oops, I repeated the 5 seconds test data twice. So there are 10 builds now, averaging 21-22 minutes.",
    "created_at": "2011-03-28T00:40:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9497#issuecomment-91207",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9497#issuecomment-91208",
    "user": "drkirkby"
}
```
