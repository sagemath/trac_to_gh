# Issue 6297: [with patch, positive review] fix LaTeX formatting in sage/schemes/elliptic_curves/period_lattice.py
...
```json
{
    ...
    "title": "[with patch, positive review] fix LaTeX formatting in sage/schemes/elliptic_curves/period_lattice.py",
    "type": "issue",
