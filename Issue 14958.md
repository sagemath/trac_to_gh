...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190801",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Attachment [trac_15195-family_cardinality-ts.patch](tarball://root/attachments/some-uuid/ticket15195/trac_15195-family_cardinality-ts.patch) by @nathanncohen created at 2013-10-23 11:38:51\n\nHmmm... It fixes the bug indeed, but why wouldn't we do the opposite and first try to call `.set.cardinality()` and on `AttributeError` run the `len` version ? Is this a speed problem ?\n\nNathann",
    "created_at": "2013-10-23T11:38:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190802",
    "user": "https://github.com/nathanncohen"
}
```

Attachment [trac_15195-family_cardinality-ts.patch](tarball://root/attachments/some-uuid/ticket15195/trac_15195-family_cardinality-ts.patch) by @nathanncohen created at 2013-10-23 11:38:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190803",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190804",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190805",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190806",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14958#issuecomment-190807",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14958",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14958#event-43869"
}
```
