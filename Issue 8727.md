...
```json
{
    "body": "Where is 0.8, just out of curiosity?  It would be helpful to have a link to that Trac ticket as well.",
...
```json
{
    "body": "Sorry, I saw the email now - for reference, it's #8725.",
...
```json
{
    "body": "Out of sync with latest package.",
    "created_at": "2010-07-05T10:39:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8727",
    "type": "issue_comment",
