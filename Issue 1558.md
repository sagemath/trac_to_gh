# Issue 1558: [with patch, with positive review] more NTL wrapping, coefficient access and factoring
...
```json
{
    ...
    "title": "[with patch, with positive review] more NTL wrapping, coefficient access and factoring",
    "type": "issue",
