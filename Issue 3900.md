...
```json
{
    "body": "We need to deal with -sdist and -bdist copying pickle_jar.tar.bz2. One way to do this would be to check the file into the repo, but that seems like a bad idea. \n\nThoughts?\n\nCheers,\n\nMichael",
    "created_at": "2008-11-18T18:11:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-27907",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-27908",
    "user": "GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-27909",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "On closer inspection: we don't even have to check in the pickle jar into the ext repo, so I will just put it in there.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-19T21:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-27910",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-27911",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-27912",
    "user": "mabshoff"
}
```
