...
```json
{
    "body": "Attachment [boolean_polynomials.py.2.patch](tarball://root/attachments/some-uuid/ticket13575/boolean_polynomials.py.2.patch) by cosh created at 2012-10-08 13:49:07\n\nMade all the changes. Above is the new version.",
...
Attachment [boolean_polynomials.py.2.patch](tarball://root/attachments/some-uuid/ticket13575/boolean_polynomials.py.2.patch) by cosh created at 2012-10-08 13:49:07
