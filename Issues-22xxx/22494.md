...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417700",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417701",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[ecc7ac8](https://git.sagemath.org/sage.git/commit?id=ecc7ac83127b90206a262316657602da83ab099c)|`add hilbert_ramification`|\n|[1c421f8](https://git.sagemath.org/sage.git/commit?id=1c421f8336cdebbcd01691bbf0cd56f0e04b2271)|`quatalg ramification: discriminant over nf and factor only once`|\n|[0fd6575](https://git.sagemath.org/sage.git/commit?id=0fd657546800099c9a62bd4bbf84490b7670b38a)|`quatalg: add ramified_infinite_places`|\n|[a828d9e](https://git.sagemath.org/sage.git/commit?id=a828d9e5eb56934f185d9b49b29edb40105f1958)|`quatalg: is_division_algebra and is_matrix_ring over nf`|",
    "created_at": "2017-03-02T16:19:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417702",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417703",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417704",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417705",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417706",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417707",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22494#issuecomment-417708",
    "user": "https://trac.sagemath.org/admin/accounts/users/aurel"
}
```
