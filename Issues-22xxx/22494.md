...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22494#issuecomment-335715",
    "user": "https://github.com/sagetrac-aurel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22494#issuecomment-335716",
    "user": "https://github.com/sagetrac-aurel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22494#event-296442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22494#event-296443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22494#event-296444"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22494#event-296445"
}
```
