...
```json
{
    "body": "<a id='comment:1'></a>Clearly, a similar idea should probably work for `ceil`.",
    "created_at": "2016-12-04T20:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22022#issuecomment-321692",
    "user": "https://github.com/pelegm"
}
```

<a id='comment:1'></a>Clearly, a similar idea should probably work for `ceil`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22022#issuecomment-321693",
    "user": "https://github.com/pelegm"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22022#event-57987"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I am interested in solving this. How do I solve this?(Implementation). Do I need to change the function body in expression.pyx here?",
    "created_at": "2017-03-09T20:18:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22022#issuecomment-321694",
    "user": "https://trac.sagemath.org/admin/accounts/users/aashu12"
}
```

<a id='comment:3'></a>I am interested in solving this. How do I solve this?(Implementation). Do I need to change the function body in expression.pyx here?
