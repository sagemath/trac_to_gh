...
```json
{
    "body": "<a id='comment:1'></a>I can confirm the issue. The trick fells very dirty but I can easily test it I think.",
    "created_at": "2017-02-01T00:12:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413075",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>I can confirm the issue. The trick fells very dirty but I can easily test it I think.
...
```json
{
    "body": "<a id='comment:2'></a>Has expected passing `-D__x86_64__ -DSMARTPTR64` choke the build. Fails as soon as we load gmp headers which complain about the ABI being unsupported.\nNow by default the thing builds but fails in calling `pari`. We could temporarily disable building against `pari` on non x86 (`--disable-pari` in giac-1.2.3-13).\n\nMore fundamentally I suspect the way pari is called is what is really wrong here, as discussed on sage-packaging   https://groups.google.com/d/msgid/sage-packaging/ac9575ae-4dd3-4d29-97aa-a3ef785d3509%40googlegroups.com",
    "created_at": "2017-02-01T01:00:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413076",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>Has expected passing `-D__x86_64__ -DSMARTPTR64` choke the build. Fails as soon as we load gmp headers which complain about the ABI being unsupported.
Now by default the thing builds but fails in calling `pari`. We could temporarily disable building against `pari` on non x86 (`--disable-pari` in giac-1.2.3-13).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413077",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I don't know if it helps but the 1.2.3.25 version such as in #22101 contains the modifications for pari asked there:\n\nhttp://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1776",
    "created_at": "2017-02-13T20:31:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413078",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

<a id='comment:3'></a>I don't know if it helps but the 1.2.3.25 version such as in #22101 contains the modifications for pari asked there:
...
```json
{
    "body": "<a id='comment:4'></a>Still failing. Those changes are, I think are a progress but not the full changes that are needed - not that I would really be able to do them myself. The fact that we still have\n\n```\n#ifdef ENABLE_TLS\n  extern THREAD void *PARI_stack_limit;\n#else\n   extern void *PARI_stack_limit;\n#endif\n```\nwhich is a private function is a sign you are doing something wrong.",
    "created_at": "2017-02-16T10:22:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413079",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>Still failing. Those changes are, I think are a progress but not the full changes that are needed - not that I would really be able to do them myself. The fact that we still have
...
```json
{
    "body": "<a id='comment:5'></a>See http://pari.math.u-bordeaux.fr/archives/pari-users-1702/msg00002.html for a suggestion from the PARI developers on how this should be fixed.",
    "created_at": "2017-02-16T10:57:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413080",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>See http://pari.math.u-bordeaux.fr/archives/pari-users-1702/msg00002.html for a suggestion from the PARI developers on how this should be fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413081",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>(1) What does this refer to:\n\n> One can maybe cheat and pass  `-D__x86_64__ -DSMARTPTR64` in CPPFLAGS but that's dirty, see:\n> * http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=19&t=1723\n\n\n(2) From the comments it seems that you think that there is a problem with PARI. Why do you think that?",
    "created_at": "2017-02-19T10:45:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413082",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>(1) What does this refer to:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413083",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Note that compiling with `-D__x86_64__` obviously does not work due to the use of inline assembly in `ifactor.cc`.",
    "created_at": "2017-02-19T11:11:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413084",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>Note that compiling with `-D__x86_64__` obviously does not work due to the use of inline assembly in `ifactor.cc`.
...
```json
{
    "body": "<a id='comment:9'></a>And compiling with `-DSMARTPTR64` (whatever that means) does not change anything.",
    "created_at": "2017-02-19T11:25:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413085",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>And compiling with `-DSMARTPTR64` (whatever that means) does not change anything.
...
```json
{
    "body": "<a id='comment:10'></a>There is a related topic (about SMARTPTR64 that should not be undefined by first.h)here:\nhttp://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1785",
    "created_at": "2017-02-28T12:16:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413086",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

<a id='comment:10'></a>There is a related topic (about SMARTPTR64 that should not be undefined by first.h)here:
http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1785
...
```json
{
    "body": "<a id='comment:11'></a>I am not sure if it is the same error, but i cannot build+check `giac` on Debian Jessie 32bits, see the attached log. It fails at `chk_fhan1` and before there are tons of \"bug in PARI/GP (Segmentation Fault), please report.\"\n\nSince `giac` is a standard package, i set the priority to blocker.",
    "created_at": "2017-03-13T11:36:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413087",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:11'></a>I am not sure if it is the same error, but i cannot build+check `giac` on Debian Jessie 32bits, see the attached log. It fails at `chk_fhan1` and before there are tons of "bug in PARI/GP (Segmentation Fault), please report."
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413088",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Unless something happens real soon I'll ignore this for sage 7.6. If it isn't fixed we should think about downgrading giac to optional.\n\nThe snippet in the description is hopefully not repesentative of the giac code quality:\n* Randomly mixed French / English names for identifiers.\n* Use of reserved identifiers (starts with leading underscore + capital letter)",
    "created_at": "2017-03-15T19:18:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413090",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>Unless something happens real soon I'll ignore this for sage 7.6. If it isn't fixed we should think about downgrading giac to optional.
...
```json
{
    "body": "<a id='comment:14'></a>If the upgrade can not be done soon (i hope it could!), another possibility would be to downgrade `giac/giacpy_sage` to a previously working version. Indeed, `pynac` is standard and depends on `giac`.",
    "created_at": "2017-03-16T09:29:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413091",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:14'></a>If the upgrade can not be done soon (i hope it could!), another possibility would be to downgrade `giac/giacpy_sage` to a previously working version. Indeed, `pynac` is standard and depends on `giac`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413092",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#22101\"",
    "created_at": "2017-03-16T16:47:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413093",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

Changing dependencies from "" to "#22101"
...
```json
{
    "body": "<a id='comment:17'></a>If people running powerpc and other platforms coudl check #22101, it seems to solve the issue.",
    "created_at": "2017-03-16T16:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413094",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:17'></a>If people running powerpc and other platforms coudl check #22101, it seems to solve the issue.
...
```json
{
    "body": "<a id='comment:18'></a>Trying it on ppc64.",
    "created_at": "2017-03-16T16:50:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413095",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:18'></a>Trying it on ppc64.
...
```json
{
    "body": "<a id='comment:20'></a>I can confirm nothing changed on ppc64.",
    "created_at": "2017-03-16T19:52:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413097",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:20'></a>I can confirm nothing changed on ppc64.
...
```json
{
    "body": "<a id='comment:21'></a>I think `SMARTPTR64` is unrelated to our problems. It is added in some pre-made makefile, some of them for the debian package specifically. But there is no way I can see for it to make its way in the build system on a regular build - any system. Same story for `DOUBLEVAL` but this time with windows and OS X - it could be of interest since on OS X it included ppc.",
    "created_at": "2017-03-16T21:18:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413098",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:21'></a>I think `SMARTPTR64` is unrelated to our problems. It is added in some pre-made makefile, some of them for the debian package specifically. But there is no way I can see for it to make its way in the build system on a regular build - any system. Same story for `DOUBLEVAL` but this time with windows and OS X - it could be of interest since on OS X it included ppc.
...
```json
{
    "body": "<a id='comment:22'></a>does\n\n```\n./configure --enable-shared=no\n```\nchanges things?",
    "created_at": "2017-03-16T21:26:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413099",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

<a id='comment:22'></a>does
...
```json
{
    "body": "<a id='comment:23'></a>I cannot test right now - I am waiting for a world update to finish on the machine (this is a gentoo prefix, everything is compiled) but I am putting it on the things to try.",
    "created_at": "2017-03-16T21:30:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413100",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:23'></a>I cannot test right now - I am waiting for a world update to finish on the machine (this is a gentoo prefix, everything is compiled) but I am putting it on the things to try.
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [frederichan](#comment%3A19):\n> Replying to [tmonteil](#comment%3A17):\n> > If people running powerpc and other platforms coudl check #22101, it seems to solve the issue.\n\n> Really? I thought it was only improving for i386. (cf comment4)\n\nSorry, i meant it solves the issue on i386.",
    "created_at": "2017-03-17T08:48:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413101",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:24'></a>Replying to [frederichan](#comment%3A19):
> Replying to [tmonteil](#comment%3A17):
> > If people running powerpc and other platforms coudl check #22101, it seems to solve the issue.
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22280#event-58469"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Indeed, if I configure giac with disable-shared, I can ask e in icas without sefgault.",
    "created_at": "2017-05-19T09:32:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413108",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:32'></a>Indeed, if I configure giac with disable-shared, I can ask e in icas without sefgault.
...
```json
{
    "body": "<a id='comment:35'></a>This looks bad:\n\n```\n(gdb) p this->ref_FUNCptr()->ptr()\n$8 = (giac::unary_function_abstract *) 0xffffe3a8\n```\nAddress has been cut.",
    "created_at": "2017-05-19T10:23:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413111",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:35'></a>This looks bad:
...
```json
{
    "body": "<a id='comment:36'></a>One can circumvent that by setting  `__x86_64__` but this automatically sets `SMARTPTR64` which might be broken on ppc64 because of endianness (vould work on ppc64le) and `_I386_` which includes assembly code.\n\nI'm now trying with proper 64 bits pointers but without \"smart\" pointers.",
    "created_at": "2017-05-19T13:30:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413112",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:36'></a>One can circumvent that by setting  `__x86_64__` but this automatically sets `SMARTPTR64` which might be broken on ppc64 because of endianness (vould work on ppc64le) and `_I386_` which includes assembly code.
...
```json
{
    "body": "<a id='comment:37'></a>Oh yeah and on 64 bits systems, not using `SMARTPTR64` is doomed to fail because C(++) types of different lengths are used to access the `_FUNC_` part of a `gen`.",
    "created_at": "2017-05-19T13:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413113",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:37'></a>Oh yeah and on 64 bits systems, not using `SMARTPTR64` is doomed to fail because C(++) types of different lengths are used to access the `_FUNC_` part of a `gen`.
...
```json
{
    "body": "<a id='comment:38'></a>And `double` storage trick fails because of byte order and is fixed when passing `-DDOUBLEVAL`.",
    "created_at": "2017-05-19T15:20:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413114",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:38'></a>And `double` storage trick fails because of byte order and is fixed when passing `-DDOUBLEVAL`.
...
```json
{
    "body": "<a id='comment:39'></a>Everything seems fine now, patches on their way.",
    "created_at": "2017-05-19T15:22:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413115",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:39'></a>Everything seems fine now, patches on their way.
...
```json
{
    "body": "Changing commit from \"\" to \"f5e35f22f55f56921aa3314689aa8a3c84db64b6\"",
    "created_at": "2017-05-22T11:41:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413116",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Changing commit from "" to "f5e35f22f55f56921aa3314689aa8a3c84db64b6"
...
```json
{
    "body": "<a id='comment:40'></a>Here you go.\nPlease report any success/failure with this branch.\n\n---\nNew commits:",
    "created_at": "2017-05-22T11:41:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413117",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:40'></a>Here you go.
Please report any success/failure with this branch.
...
```json
{
    "body": "Changing branch from \"\" to \"public/giac\"",
    "created_at": "2017-05-22T11:41:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413118",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Changing branch from "" to "public/giac"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413119",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413120",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413121",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>And let's even say it's needs_review...",
    "created_at": "2017-05-22T13:34:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413122",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:41'></a>And let's even say it's needs_review...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413124",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Did you suggest the fix for libpng/lpng1x too ([/22159#comment:29 suggested on this comment])?",
    "created_at": "2017-05-25T16:14:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413125",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:44'></a>Did you suggest the fix for libpng/lpng1x too ([/22159#comment:29 suggested on this comment])?
...
```json
{
    "body": "<a id='comment:45'></a>Which version is your starting point? I am trying with 1.2.3-25 at the moment (because I have it handy on ppc64 right now) and while it is an improvement there are still failures, and I seem to be hanging at `chk_morley_demo` and a few others.",
    "created_at": "2017-05-25T23:02:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413126",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:45'></a>Which version is your starting point? I am trying with 1.2.3-25 at the moment (because I have it handy on ppc64 right now) and while it is an improvement there are still failures, and I seem to be hanging at `chk_morley_demo` and a few others.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413127",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413128",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Note that using static or shared libraries makes no difference, both work well.",
    "created_at": "2017-05-30T10:17:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413129",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:48'></a>Note that using static or shared libraries makes no difference, both work well.
...
```json
{
    "body": "<a id='comment:49'></a>Thanks to Bernard and debian folk work the latest stable version seems ok.\nPass `-Dx86_64` into `CPPFLAGS`.",
    "created_at": "2017-05-31T08:35:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413130",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:49'></a>Thanks to Bernard and debian folk work the latest stable version seems ok.
Pass `-Dx86_64` into `CPPFLAGS`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413131",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "Changing commit from \"f5e35f22f55f56921aa3314689aa8a3c84db64b6\" to \"8dc4c88c3f7a0f9a8710f54d839cacc0936fd959\"",
    "created_at": "2017-05-31T21:14:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413132",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "f5e35f22f55f56921aa3314689aa8a3c84db64b6" to "8dc4c88c3f7a0f9a8710f54d839cacc0936fd959"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413133",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413134",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>If you want to add `arm64` support, please do so.\nBut I think this is ready to go now.",
    "created_at": "2017-05-31T21:17:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413135",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:52'></a>If you want to add `arm64` support, please do so.
But I think this is ready to go now.
...
```json
{
    "body": "<a id='comment:53'></a>Feel free to send this to the bots!",
    "created_at": "2017-06-02T15:37:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413136",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:53'></a>Feel free to send this to the bots!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413137",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>I am sorry I haven't had time to test this fully yet. I will try to give it another go over the weekend.",
    "created_at": "2017-06-02T23:13:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413138",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:55'></a>I am sorry I haven't had time to test this fully yet. I will try to give it another go over the weekend.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413139",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>`@` Jean-Pierre, what version of gcc did you test this with?",
    "created_at": "2017-06-08T00:24:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413140",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:57'></a>`@` Jean-Pierre, what version of gcc did you test this with?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413142",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:60'></a>Most tests seem to pass on my machine except for some numerical noise and some very long or looping tests I killed.",
    "created_at": "2017-06-08T12:20:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413143",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:60'></a>Most tests seem to pass on my machine except for some numerical noise and some very long or looping tests I killed.
...
```json
{
    "body": "<a id='comment:62'></a>Just patch the `Makefile` to use `-lpng16` rather than `-lpng`.",
    "created_at": "2017-06-15T12:16:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413145",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:62'></a>Just patch the `Makefile` to use `-lpng16` rather than `-lpng`.
...
```json
{
    "body": "<a id='comment:65'></a>Ragarding building giac with png support, thanks Jean-Pierre and Fran\u00e7ois for your hints, i opened #23262.",
    "created_at": "2017-06-17T09:05:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413148",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:65'></a>Ragarding building giac with png support, thanks Jean-Pierre and François for your hints, i opened #23262.
...
```json
{
    "body": "<a id='comment:66'></a>Unfortunately, I still have no luck on ppc64 with gcc-5.4.0. It is better than before in that some tests are now succeeding. But things seems to get stuck in a C++ allocator for a number of them.",
    "created_at": "2017-06-17T09:07:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413149",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:66'></a>Unfortunately, I still have no luck on ppc64 with gcc-5.4.0. It is better than before in that some tests are now succeeding. But things seems to get stuck in a C++ allocator for a number of them.
...
```json
{
    "body": "<a id='comment:67'></a>Is `giac` itself functional?\nThat is: is it only failing its testsuite or is it completely broken as well?",
    "created_at": "2017-06-19T09:37:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413150",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:67'></a>Is `giac` itself functional?
That is: is it only failing its testsuite or is it completely broken as well?
...
```json
{
    "body": "<a id='comment:68'></a>Fair question. \"1+1\" works, the fact that some tests work means that it is working up to a point. I haven't tried to run the sage testsuite with it. Any tests I should run?",
    "created_at": "2017-06-19T09:47:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413151",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:68'></a>Fair question. "1+1" works, the fact that some tests work means that it is working up to a point. I haven't tried to run the sage testsuite with it. Any tests I should run?
...
```json
{
    "body": "<a id='comment:69'></a>Maybe `sage -t src/sage/interfaces/giac.py` and `rings` and `symbolic` would tell you if it looks functional or not.\n\nOn my side, `giac` also fails a lot of its own testsuite, inlcuding bunch of numerical noise, but also more worrying stuff i did not investigate, but running tests as above seems to indicate it is good enough for sage.",
    "created_at": "2017-06-19T09:51:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413152",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:69'></a>Maybe `sage -t src/sage/interfaces/giac.py` and `rings` and `symbolic` would tell you if it looks functional or not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413153",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:70'></a>OK, I did run those tests and the few failures I have are unrelated to `giac` (I'll have to investigate some of them more deeply but they are definitely not `giac`). I guess we can go ahead with this.",
    "created_at": "2017-06-19T12:10:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413154",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:70'></a>OK, I did run those tests and the few failures I have are unrelated to `giac` (I'll have to investigate some of them more deeply but they are definitely not `giac`). I guess we can go ahead with this.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Thierry Monteil, Jean-Pierre Flori, Fran\u00e7ois Bissey\"",
    "created_at": "2017-06-19T12:10:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413155",
    "user": "https://github.com/kiwifb"
}
```

Changing reviewer from "" to "Thierry Monteil, Jean-Pierre Flori, François Bissey"
...
```json
{
    "body": "Changing branch from \"public/giac\" to \"8dc4c88c3f7a0f9a8710f54d839cacc0936fd959\"",
    "created_at": "2017-06-22T07:24:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413156",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/giac" to "8dc4c88c3f7a0f9a8710f54d839cacc0936fd959"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22280#event-58470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413157",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"8dc4c88c3f7a0f9a8710f54d839cacc0936fd959\" to \"\"",
    "created_at": "2017-06-24T13:34:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413158",
    "user": "https://github.com/infinity0"
}
```

Changing commit from "8dc4c88c3f7a0f9a8710f54d839cacc0936fd959" to ""
...
```json
{
    "body": "<a id='comment:72'></a>Do you guys know *why* the `-Dx86_64` is needed on ppc64? That is still a bug that should be fixed upstream. In theory upstream should [now be detecting](http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?p=8877#p8877) 64-bit in a cross-platform way so I'm confused why it fails on ppc64.",
    "created_at": "2017-06-24T13:34:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413159",
    "user": "https://github.com/infinity0"
}
```

<a id='comment:72'></a>Do you guys know *why* the `-Dx86_64` is needed on ppc64? That is still a bug that should be fixed upstream. In theory upstream should [now be detecting](http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?p=8877#p8877) 64-bit in a cross-platform way so I'm confused why it fails on ppc64.
...
```json
{
    "body": "<a id='comment:73'></a>(sorry, I have no idea why my comment there deleted the commit field)\n\n(I can't seem to fix it either, even by Modifying the ticket with that commit)",
    "created_at": "2017-06-24T13:35:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413160",
    "user": "https://github.com/infinity0"
}
```

<a id='comment:73'></a>(sorry, I have no idea why my comment there deleted the commit field)
...
```json
{
    "body": "<a id='comment:74'></a>All tests pass for me for 1.2.3-51 on arm64 on Debian without further changes or extra flags, btw.",
    "created_at": "2017-06-24T13:40:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413161",
    "user": "https://github.com/infinity0"
}
```

<a id='comment:74'></a>All tests pass for me for 1.2.3-51 on arm64 on Debian without further changes or extra flags, btw.
...
```json
{
    "body": "<a id='comment:75'></a>I'll have to try 1.2.3-51 on ppc64 without extra flags then. 1.2.3-47 builds but a lot of tests fail for me. We may want to consider a further upgrade.\n\nThe removal of the commit when you comment further is a \"feature\" of track. It is annoying but not harmfull.",
    "created_at": "2017-06-24T20:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413162",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:75'></a>I'll have to try 1.2.3-51 on ppc64 without extra flags then. 1.2.3-47 builds but a lot of tests fail for me. We may want to consider a further upgrade.
...
```json
{
    "body": "<a id='comment:76'></a>Well, you probably don't have that problem but I allow compilation without gui, and sage itself doesn't depend on fltk\n\n```\n  bool has_graph3d(Fl_Widget * widget){\n#ifdef HAVE_LIBFLTK\n    Fl_Group * g=dynamic_cast<Fl_Group *>(widget);\n```\nOooops! in src/Xcas.cc (line 3360) there goes your compilation failure if you don't have fltk.",
    "created_at": "2017-06-24T21:46:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413163",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:76'></a>Well, you probably don't have that problem but I allow compilation without gui, and sage itself doesn't depend on fltk
...
```json
{
    "body": "<a id='comment:77'></a>I have found that annoying too, in Debian I am forced to ship the non-GUI icas program (which is what Sage actually wants) together with the GUI xcas program, and it even links against X libraries. I've [filed a bug](http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1812) about it upstream, hopefully they can fix it.",
    "created_at": "2017-06-25T13:50:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413164",
    "user": "https://github.com/infinity0"
}
```

<a id='comment:77'></a>I have found that annoying too, in Debian I am forced to ship the non-GUI icas program (which is what Sage actually wants) together with the GUI xcas program, and it even links against X libraries. I've [filed a bug](http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1812) about it upstream, hopefully they can fix it.
...
```json
{
    "body": "<a id='comment:78'></a>Well, I pilled up some more in http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1814 because your request, I felt, was much broader than mine (but yes something should be done about all that X stuff).",
    "created_at": "2017-06-25T22:01:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413165",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:78'></a>Well, I pilled up some more in http://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?f=4&t=1814 because your request, I felt, was much broader than mine (but yes something should be done about all that X stuff).
...
```json
{
    "body": "<a id='comment:79'></a>Unfortunately giac fails to compile for me on a arm64 (aarch64) 4.9 Linux kernel:\n\nhttp://xcas.e.ujf-grenoble.fr/XCAS/viewtopic.php?p=8941#p8941\n\nIt succeeded on a 3.16 Linux kernel though, as I reported above. Could someone reproduce this and if so re-open this ticket or open another one?",
    "created_at": "2017-07-19T12:08:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413166",
    "user": "https://github.com/infinity0"
}
```

<a id='comment:79'></a>Unfortunately giac fails to compile for me on a arm64 (aarch64) 4.9 Linux kernel:
...
```json
{
    "body": "<a id='comment:80'></a>A potential solution to this has been suggested on the Debian bug tracker: https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=855078#29\n\nI'll try to test it next week, in the meantime feel free to jump in ahead.",
    "created_at": "2017-07-19T12:14:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22280#issuecomment-413167",
    "user": "https://github.com/infinity0"
}
```

<a id='comment:80'></a>A potential solution to this has been suggested on the Debian bug tracker: https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=855078#29
