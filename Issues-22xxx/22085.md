...
```json
{
    "body": "<a id='comment:1'></a>\nNot sure that will be included in 7.5. but it is a consequence of multiple things I have authored in the current release cycle including #20646 and #21625. It probably should have gone as QA in #20646 really and then I would done things slightly differently in #21625.\n\n---\nNew commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[4d48ef3](https://git.sagemath.org/sage.git/commit?id=4d48ef39d7566a451b9d29a2fb45e6f34507ce55)|`Remove gslcblas from gsl.pc so we don't have a double cblas.`|\n|[2825cb5](https://git.sagemath.org/sage.git/commit?id=2825cb582a127b667f7414a3dafc1bce63b54085)|`Stop removing gslcblas from gsl.pc output. It breaks when gslcblas is not there. Furthermore if someone wants to use gslcblas they will be prevented.`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[467bd5e](https://git.sagemath.org/sage.git/commit/?id=467bd5ef0f2b8d74d9db9d04f0c8b9d50f492e8b)|`Edit the remark in module_list.py to reflect the new setup.`|",
