...
```json
{
    "body": "<a id='comment:1'></a>did you see this on the same system?",
    "created_at": "2017-03-07T07:25:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418658",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>did you see this on the same system?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418659",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>it's baffling to me that you get SIGFPEs, for GAP doesn't really do floating point things. Do you have a weird list of GAP packages installed?",
    "created_at": "2017-03-10T12:50:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418661",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>it's baffling to me that you get SIGFPEs, for GAP doesn't really do floating point things. Do you have a weird list of GAP packages installed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418662",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The last time (from [comment:3]) was again after doing some Cython development and downgrading from 7.6.beta6 (#22554 to be precise) to 7.6.beta4 (#22471 to be precise).",
    "created_at": "2017-03-10T12:54:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418663",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>The last time (from [comment:3]) was again after doing some Cython development and downgrading from 7.6.beta6 (#22554 to be precise) to 7.6.beta4 (#22471 to be precise).
...
```json
{
    "body": "<a id='comment:7'></a>could it be #22437 ? Did you see this before the latter was merged?\n(in case you have a stale bunch of `gap/` headers somewhere...)",
    "created_at": "2017-03-10T13:01:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418664",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:7'></a>could it be #22437 ? Did you see this before the latter was merged?
(in case you have a stale bunch of `gap/` headers somewhere...)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418665",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418666",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I'm wondering if this is related to #20421 somehow. Maybe a race condition in writing the workspace, leading to corruption?",
    "created_at": "2017-03-10T13:16:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418667",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>I'm wondering if this is related to #20421 somehow. Maybe a race condition in writing the workspace, leading to corruption?
...
```json
{
    "body": "<a id='comment:12'></a>Corrupt workspaces almost always crash GAP (or libGAP), no wonder.",
    "created_at": "2017-03-10T13:28:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418669",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>Corrupt workspaces almost always crash GAP (or libGAP), no wonder.
...
```json
{
    "body": "<a id='comment:13'></a>I'm not sure if gap workspaces are compatible between normal and debug builds.\n\nPresumably the issue is mitated by #22570\n\nI'm leaning towards not making this a blocker",
    "created_at": "2017-03-15T19:23:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418670",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>I'm not sure if gap workspaces are compatible between normal and debug builds.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418671",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22536#event-58884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418672",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22536#event-58885"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22536#issuecomment-418673",
    "user": "https://github.com/jdemeyer"
}
```
