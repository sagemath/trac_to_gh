...
```json
{
    "body": "did you see this on the same system?",
...
```json
{
    "body": "it's baffling to me that you get SIGFPEs, for GAP doesn't really do floating point things. Do you have a weird list of GAP packages installed?",
...
```json
{
    "body": "The last time (from [comment:3]) was again after doing some Cython development and downgrading from 7.6.beta6 (#22554 to be precise) to 7.6.beta4 (#22471 to be precise).",
...
```json
{
    "body": "could it be #22437 ? Did you see this before the latter was merged?\n(in case you have a stale bunch of `gap/` headers somewhere...)",
...
```json
{
    "body": "I'm wondering if this is related to #20421 somehow. Maybe a race condition in writing the workspace, leading to corruption?",
...
```json
{
    "body": "Corrupt workspaces almost always crash GAP (or libGAP), no wonder.",
