...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[a55e734](https://git.sagemath.org/sage.git/commit/?id=a55e73411211516d6ab69cb8ba0edb694c597688)|`This is fixed, for now, in sage by #21399 so we can live without this patch.`|\n|[90e46fd](https://git.sagemath.org/sage.git/commit/?id=90e46fd1f8769a256cd122c5972a60dabe7b047c)|`This patch has been part of the Cygwin port of Python since Python 2.6, but it has not been needed in Sage.`|\n|[cd51023](https://git.sagemath.org/sage.git/commit/?id=cd51023705656562733d4330264eab6e8d82a9f3)|`This patch seems to have been part of Cygwin's Python for a long time, but I'm not actually sure what case it's for and can't find anything referencing it.`|\n|[eb02004](https://git.sagemath.org/sage.git/commit/?id=eb020040775c73abdfd94906a6c63d41c82c9fa7)|`This patch was needed for the tkinter module to build.  But we don't guarantee`|\n|[46df7dc](https://git.sagemath.org/sage.git/commit/?id=46df7dca8f45df271960ccb1d9922b9851d17f6c)|`Rewrote this patch to the actual fix to the issue that was accepted upstream`|\n|[f7f4535](https://git.sagemath.org/sage.git/commit/?id=f7f4535fd94051c7232b07edc5d0c6161d603589)|`This patch has been part of Cygwin's Python for a long time, but I don't think it's still needed.`|\n|[1618c0f](https://git.sagemath.org/sage.git/commit/?id=1618c0f0d26c989df228b28db45c714fbc281178)|`Adds descriptions of more of the new patches`|",
    "created_at": "2017-04-20T13:51:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22666",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[5031e42](https://git.sagemath.org/sage.git/commit/?id=5031e422023459fdbe3a48cb5159abc63ec57cf2)|`Added a brief description of the ncurses patch with link to the original issue.`|",
