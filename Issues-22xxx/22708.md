...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299117"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299118"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299119"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299120"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22708#issuecomment-340431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22708#issuecomment-340432",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299122"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22708#event-299123"
}
```
