...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22708#issuecomment-333373",
...
```json
{
    "body": "<a id='comment:1'></a>I think we should focus a little bit more on speeding up the default/generic implementation. Towards that goal, #22632 will be the first step (and benefit a larger portion of Sage). The next step would be directly cythonizing the free algebra element and possibly having a better/faster index set.\n\nI would say defect = bug, and just being the slowest would not have it fall into that category IMO (especially since it is possibly the most general).",
    "created_at": "2017-03-29T15:06:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22708#issuecomment-333374",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>I think we should focus a little bit more on speeding up the default/generic implementation. Towards that goal, #22632 will be the first step (and benefit a larger portion of Sage). The next step would be directly cythonizing the free algebra element and possibly having a better/faster index set.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22708#issuecomment-333375",
    "user": "https://github.com/tscrim"
}
```
