...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427217",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Currently running tests, but they passed in the most critical folders.",
    "created_at": "2017-04-25T15:14:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427218",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>Currently running tests, but they passed in the most critical folders.
...
```json
{
    "body": "<a id='comment:4'></a>I was able to build on Cygwin. I did not run the test suite.",
    "created_at": "2017-04-26T02:30:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427220",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>I was able to build on Cygwin. I did not run the test suite.
...
```json
{
    "body": "<a id='comment:5'></a>That may not be a show stopper at runtime. I suspect the test itself has a bug rather than singular has a bug. However `spkg-check` is run on at least some of the patchbot and that may come back to us if we just push for it.",
    "created_at": "2017-04-26T02:33:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427221",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>That may not be a show stopper at runtime. I suspect the test itself has a bug rather than singular has a bug. However `spkg-check` is run on at least some of the patchbot and that may come back to us if we just push for it.
...
```json
{
    "body": "<a id='comment:6'></a>And there might be a leak introduced by p_Copy in:\n* https://git.sagemath.org/sage.git/commit/?h=85d00244d0db1cce5933bd6ee46114c58bb32fbb&id=0d6f025a6bf3ac858f331de21b4d9dc298c5c7ec",
    "created_at": "2017-04-26T07:54:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427222",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:6'></a>And there might be a leak introduced by p_Copy in:
* https://git.sagemath.org/sage.git/commit/?h=85d00244d0db1cce5933bd6ee46114c58bb32fbb&id=0d6f025a6bf3ac858f331de21b4d9dc298c5c7ec
...
```json
{
    "body": "<a id='comment:8'></a>Stupid libtool bug. Sometime a system path (like `/usr/lib64`) is inserted in the `LD_LIBRARY_PATH` that is built for the test program to run. I have seen that before with `octave`. Not sure how to fix it. Anyway the test script set the following `LD_LIBRARY_PATH`:\n\n```\n/dev/shm/portage/sci-mathematics/singular-4.1.0_p3/work/singular-4.1.0/factory/.libs:/usr/lib64:/dev/shm/portage/sci-mathematics/singular-4.1.0_p3/work/singular-4.1.0/resources/.libs:/dev/shm/portage/sci-mathematics/singular-4.1.0_p3/work/singular-4.1.0/omalloc/.libs\n```\nand the `/usr/lib64` in second position is the cause of the failure. Because of it libomalloc and libsinguar_resources from an installed 4.1.0_p2 are used. Of course it wouldn't happen if the sonames had been bumped.",
    "created_at": "2017-04-26T09:21:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427224",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>Stupid libtool bug. Sometime a system path (like `/usr/lib64`) is inserted in the `LD_LIBRARY_PATH` that is built for the test program to run. I have seen that before with `octave`. Not sure how to fix it. Anyway the test script set the following `LD_LIBRARY_PATH`:
...
```json
{
    "body": "<a id='comment:9'></a>OK I have now figured out why the test fail and it is not singular upstream's fault. Rogue installed .la file were at fault (libntl.la to be precise). So it is all clear on singular own tests.",
    "created_at": "2017-04-26T11:25:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427225",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:9'></a>OK I have now figured out why the test fail and it is not singular upstream's fault. Rogue installed .la file were at fault (libntl.la to be precise). So it is all clear on singular own tests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427226",
...
```json
{
    "body": "Changing commit from \"85d00244d0db1cce5933bd6ee46114c58bb32fbb\" to \"72c31808c7dcf6693596431e9ea9a454a827991e\"",
    "created_at": "2017-04-26T13:36:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427227",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "85d00244d0db1cce5933bd6ee46114c58bb32fbb" to "72c31808c7dcf6693596431e9ea9a454a827991e"
...
```json
{
    "body": "<a id='comment:11'></a>`@`francois: so is this good for you?",
    "created_at": "2017-04-28T07:26:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427228",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:11'></a>`@`francois: so is this good for you?
...
```json
{
    "body": "<a id='comment:12'></a>Yup. Good for the next stage.",
    "created_at": "2017-04-28T07:30:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427229",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:12'></a>Yup. Good for the next stage.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Fran\u00e7ois Bissey, Travis Scrimshaw\"",
    "created_at": "2017-04-28T13:12:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427230",
    "user": "https://github.com/tscrim"
}
```

Changing reviewer from "" to "François Bissey, Travis Scrimshaw"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427231",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing branch from \"public/singular410p3\" to \"72c31808c7dcf6693596431e9ea9a454a827991e\"",
    "created_at": "2017-04-29T23:30:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427232",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/singular410p3" to "72c31808c7dcf6693596431e9ea9a454a827991e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22868#issuecomment-427233",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22868",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22868#event-59405"
}
```
