...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22671#issuecomment-422342",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22671#issuecomment-422343",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59095"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59096"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59097"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59098"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59099"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22671#issuecomment-422344",
...
```json
{
    "body": "<a id='comment:6'></a>This may be an issue with the maxima result\n\n```\nsage: B = G.integrate(x, 2., 3., algorithm=\"mathematica_free\")\nsage: B.n()\n-0.887083000000000\nsage: B = G.integrate(x, 2., 3., algorithm=\"giac\")\nsage: B.n()\n-0.887083238620000\n```",
    "created_at": "2022-02-24T15:52:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22671#issuecomment-422345",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:6'></a>This may be an issue with the maxima result
...
```json
{
    "body": "<a id='comment:7'></a>Perhaps the integration engine\n\n- uses a dedicated \"real cube root\" function in one case\n- lacks a \"real fifth root\" function for the other case",
    "created_at": "2022-02-25T09:00:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22671#issuecomment-422346",
    "user": "https://github.com/slel"
}
```

<a id='comment:7'></a>Perhaps the integration engine
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59100"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59101"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59102"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22671#event-59103"
}
```
