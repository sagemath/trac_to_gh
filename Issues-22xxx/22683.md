...
```json
{
    "body": "<a id='comment:20'></a>I would have been somewhat surprised if the doc did build on Volker's testing branch given[comment:13](#comment%3A13). Changes LGTM.",
    "created_at": "2017-04-02T19:10:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22683",
    "type": "issue_comment",
...
<a id='comment:20'></a>I would have been somewhat surprised if the doc did build on Volker's testing branch given[comment:13](#comment%3A13). Changes LGTM.
