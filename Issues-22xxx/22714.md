...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423472",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423473",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423474",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423475",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423476",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>This seems like a very nice enhancement! I have had a very similar setup in my own scripts for identifying algebraic numbers...\n\n\nI plan to run some tests and review it swiftly.",
    "created_at": "2017-04-04T19:07:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423477",
    "user": "https://github.com/mo271"
}
```

<a id='comment:6'></a>This seems like a very nice enhancement! I have had a very similar setup in my own scripts for identifying algebraic numbers...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423478",
    "user": "https://github.com/mo271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423479",
    "user": "https://github.com/mo271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423481",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423482",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I do not understand why this does not touch src/sage/rings/complex_double.pyx, which has  its own (unfixed) algdep (calling PARI directly), and needless to say it still fails on FreeBSD 11.0 with clang:\n\n```\nsage -t --warn-long 41.0 src/sage/rings/complex_double.pyx\n**********************************************************************\nFile \"src/sage/rings/complex_double.pyx\", line 2363, in sage.rings.complex_double.ComplexDoubleElement.algdep\nFailed example:\n    p = z.algdep(5); p\nExpected:\n    x^3 + 1\nGot:\n    x^5 + x^2\n**********************************************************************\nFile \"src/sage/rings/complex_double.pyx\", line 2365, in sage.rings.complex_double.ComplexDoubleElement.algdep\nFailed example:\n    p.factor()\nExpected:\n    (x + 1) * (x^2 - x + 1)\nGot:\n    (x + 1) * x^2 * (x^2 - x + 1)\n**********************************************************************\n```",
    "created_at": "2017-04-05T07:43:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423483",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:8'></a>I do not understand why this does not touch src/sage/rings/complex_double.pyx, which has  its own (unfixed) algdep (calling PARI directly), and needless to say it still fails on FreeBSD 11.0 with clang:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423484",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423485",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423486",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22714#event-59181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423487",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22714#issuecomment-423488",
    "user": "https://github.com/vbraun"
}
```
