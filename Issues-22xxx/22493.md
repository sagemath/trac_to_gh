...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22493#issuecomment-335631",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22493#issuecomment-335632",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22493#event-296434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22493#event-296435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22493#event-296436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22493",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22493#event-296437"
}
```
...
```json
{
    "body": "<div id=\"comment:73\" align=\"right\">Comment 73</div>\n\nReplying to [@sagetrac-myself](#comment%3A72): Indeed, changing `2.[0-2]` to `2.2[0-2]` solves the issue. Follow-up at #23209.",
