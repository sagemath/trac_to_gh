...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290835"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290836"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22050#issuecomment-327608",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22050#issuecomment-327609",
    "user": "https://github.com/sagetrac-msaaltink"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290838"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290842"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22050",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22050#event-290843"
}
```
