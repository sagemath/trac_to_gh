...
```json
{
    "body": "<a id='comment:8'></a>\nI did the following:\n- add rounding inside `_circle_embedding` so that `sin(pi)` is 0 and not `1.2246467991473532e-16`.\n- add a parameter `angle` to `_circle_embedding`\n- patch `add_circle` to avoid adding a loop when the list of vertices has a single node\n- use `_circle_embedding` in many methods\n \n---\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[adea1f1](https://git.sagemath.org/sage.git/commit?id=adea1f157cd7c533f9f857fcf26256c1cdef01b9)|`trac #22050: round cos and sin in _circle_embedding`|\n|[c45f9eb](https://git.sagemath.org/sage.git/commit?id=c45f9eb09c63a1ca1ebea083773ea93132baeaef)|`trac #22050: adds parameter angle to _circle_embedding`|\n|[259136c](https://git.sagemath.org/sage.git/commit?id=259136cc6fc41c341681496adeaedbb0340075ff)|`trac #22050: use _circle_embedding for cycle, path, complete and star graphs`|\n|[f56b3bd](https://git.sagemath.org/sage.git/commit?id=f56b3bd729f5c3ce02cd5bc1e3f6d394484382ca)|`trac #22050: use _circle_embedding for CircularLadderGraph`|\n|[d0d0637](https://git.sagemath.org/sage.git/commit?id=d0d06372319e7278d32c54a7b1cad56599d39448)|`trac #22050: fix add_path, add_cycle, add_clique`|\n|[de55548](https://git.sagemath.org/sage.git/commit?id=de55548e27d7150c52984efe85bbc3cd20cb9378)|`trac #22050: fix layout when n==2 in CircularLadderGraph`|\n|[e365a50](https://git.sagemath.org/sage.git/commit?id=e365a500c96adddedcc98feab5610345b5b747da)|`trac #22050: use _circle_embedding in FriendshipGraph`|\n|[58860b0](https://git.sagemath.org/sage.git/commit?id=58860b0620415ac9e6adcaf847773eecbf4ef75b)|`trac #22050: use _circle_embedding in GeneralizedPetersenGraph`|\n|[1c4ea29](https://git.sagemath.org/sage.git/commit?id=1c4ea2904f2b58ef8a5c29d9e9e04d04c5e62ae0)|`trac #22050: more use of _circle_embedding`|",
    "created_at": "2018-08-15T12:18:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22050",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[a8683bb](https://git.sagemath.org/sage.git/commit/?id=a8683bb75616f17fa2da449673ab4bd460b2f3a3)|`trac #22050: Merged with 8.4.beta1`|\n|[990e39b](https://git.sagemath.org/sage.git/commit/?id=990e39bbaf4f0ab3b12fdf3c665e98a2826c89bc)|`trac #22050: fix doctests`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[98bacd3](https://git.sagemath.org/sage.git/commit/?id=98bacd3d4f25b59e4431ae67a42fde84634711dd)|`trac #22050: move methods to generic_graph.py and update usage`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[1f33553](https://git.sagemath.org/sage.git/commit/?id=1f33553e55ea8acedfd5ea836735abc33accf7de)|`trac #: rebase on 8.4.beta3`|",
    "created_at": "2018-09-02T12:00:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22050",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[1649785](https://git.sagemath.org/sage.git/commit/?id=1649785ce3366354b2efdc2364e72a90b8d73f21)|`trac #22050: Merged with 8.4.beta7`|\n|[9b3ffc6](https://git.sagemath.org/sage.git/commit/?id=9b3ffc60828e3993a2ad286d442916cf6ef68d78)|`trac #22050: pyflakes in families.py`|",
    "created_at": "2018-10-04T17:54:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22050",
    "type": "issue_comment",
