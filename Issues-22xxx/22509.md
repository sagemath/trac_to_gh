...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420831",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420832",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420833",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420834",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420835",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420836",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420837",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420838",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420839",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420840",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420841",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420842",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,3 +11,11 @@\n For packages that already support the `DESTDIR` convention, then, we pass `DESTDIR=$SAGE_DESTDIR` to `make install`.  It is also already possible for Python packages (e.g. `pip install --root`).\n \n Since the introduction of the build helper scripts in #23160, it makes the most sense to make these changes directly in the helper scripts, and then update more packages to use those helper scripts where possible.\n+\n+Dependent tickets:\n+\n+* #24106 - implement the basic functionality of supporting staged installs through `sage-spkg`\n+* #24024 - update more `spkg-build/install` scripts to use the `sdh_` helper functions, since that is the fastest way to add `DESTDIR` support for many packages.\n+* #????? - add support for `--root=${SAGE_DESTDIR}` to Python spkgs\n+* #????? - add support for post-install scripts; this can be useful for cases where, for example, local files are generated after the package is installed, or to handle cases where one file is shared by multiple packages and needs to be updated when a package that uses it is installed (see e.g. #22510#comment:5)\n+* #????? - convert all spkgs to support staged-install; for many packages this can be covered by using the helper functions, but some packages require additional steps; in particular, packages that have files that are manually copied into `$SAGE_LOCAL`, rather than through a standard installer\n``````\n",
    "created_at": "2017-10-25T15:04:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420843",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420844",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420845",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420846",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420847",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420848",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420849",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420850",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420851",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420852",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420853",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420854",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420855",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22509#issuecomment-420856",
    "user": "https://github.com/mkoeppe"
}
```
