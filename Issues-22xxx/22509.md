...
```json
{
    "body": "<a id='comment:3'></a>\nStarted work on this, and converted I think all standard packages to work with a staged installation (install first to a temporary directory, then copy from the temp directory into `$SAGE_LOCAL`).\n\nAs I wrote in the description, most packages are easy--either they use automake, or at least a Makefile that's compatible with the `DESTDIR` convention, or they are Python packages in which case the `--root` option does the same thing.  A handful of packages needed hand-tweaking.\n\nThis is currently implemented in such a way that if a package *doesn't* yet support staged install, it will still install just fine. The only major downside is that the installed files are not recorded yet, so they wouldn't be able to take advantage of improved uninstall.\n\nThat said, I'm going to continue converting the remaining packages. My only question is whether to continue work in this ticket, or separate the general changes (i.e. to `sage-spkg`) from the updates to the packages themselves.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[3fa088a](https://git.sagemath.org/sage.git/commit?id=3fa088a137af80e1e5a6caf0e7ecdde76ac48cd3)|`Update pip install to use --root`|\n|[30aad2f](https://git.sagemath.org/sage.git/commit?id=30aad2f0fc94fb4e3a09dfa5e14c28ab95e165c8)|`Update freetype and pkgconf to use DESTDIR`|\n|[b1aabaa](https://git.sagemath.org/sage.git/commit?id=b1aabaa32decdde4e8573d06b034e1df1dabfaca)|`Updated various packages with non-standard installers or that are otherwise`|\n|[223608f](https://git.sagemath.org/sage.git/commit?id=223608f53595217d2a66b5ddf06a65020a961670)|`Update cephes to work with staged install.`|\n|[27878c3](https://git.sagemath.org/sage.git/commit?id=27878c313369cb6b3116eb7b7f0df0be09982ea7)|`Update openblas to use staged install`|\n|[ecd214c](https://git.sagemath.org/sage.git/commit?id=ecd214c42ca6863a249318ae6de6cce1340a9e9d)|`Update lcalc to support staged install`|\n|[3d64db8](https://git.sagemath.org/sage.git/commit?id=3d64db8dbc2f89d40a65f949d15e87e47a4647fc)|`Update zn_poly, which doesn't really have a proper installer, to use staged install`|\n|[609393a](https://git.sagemath.org/sage.git/commit?id=609393ad73188016b15137552dc6e481886686ff)|`Roll back accidental change from dc46ea2dfa97be79d7ef8ddbe9130d4c717acc3d that broke build of Python 2 on Cygwin.`|\n|[03424e1](https://git.sagemath.org/sage.git/commit?id=03424e19de9385c6a30cae01fedfac065cf3a53c)|`Merge remote-tracking branch 'upstream/u/embray/cygwin/ticket-23059' into u/embray/build/destdir`|\n|[a25a42a](https://git.sagemath.org/sage.git/commit?id=a25a42a02a89a20058d41d95c56efc1cd0875f26)|`Updated the python2/3 pacakges to use staged install.`|",
    "created_at": "2017-05-31T12:13:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|\n|[3a32187](https://git.sagemath.org/sage.git/commit/?id=3a32187468218cd79e6a5c0defb1f365a488c147)|`Roll back accidental change from dc46ea2dfa97be79d7ef8ddbe9130d4c717acc3d that broke build of Python 2 on Cygwin.`|\n|[8a621af](https://git.sagemath.org/sage.git/commit/?id=8a621af7a5f3e10d1337c07b42d04edee6a8f1b8)|`Updated the python2/3 pacakges to use staged install.`|",
    "created_at": "2017-05-31T12:25:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[1391089](https://git.sagemath.org/sage.git/commit/?id=1391089b36f43b45fa0eb7bf04e83fc1e351dfea)|`Remove the '-v' from the 'cp' command.`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[e294123](https://git.sagemath.org/sage.git/commit/?id=e2941230aea00481d6cf1f58992faa006a7b63f2)|`Add staged install support for atlas`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[00f6de8](https://git.sagemath.org/sage.git/commit/?id=00f6de8d173a25b865c26c6af3f588b49e8401eb)|`This file should be deleted from the temp install dir during staged install on OSX`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[16bc700](https://git.sagemath.org/sage.git/commit/?id=16bc700b5cb5cb54697702154f37f1121238fb15)|`Update freetype and pkgconf to use DESTDIR`|\n|[eb660c7](https://git.sagemath.org/sage.git/commit/?id=eb660c7c262195f4d8910f3e8e6a1953b24e3c91)|`Updated various packages with non-standard installers or that are otherwise`|\n|[8de16d2](https://git.sagemath.org/sage.git/commit/?id=8de16d2f311650cb4308b11935735350f586d54c)|`Update cephes to work with staged install.`|\n|[73c45e6](https://git.sagemath.org/sage.git/commit/?id=73c45e6c71706a012ec3e2209da63ca6efb4176f)|`Update openblas to use staged install`|\n|[e1ad6d5](https://git.sagemath.org/sage.git/commit/?id=e1ad6d5ff7b7b5e11a8de9316c2dbb4971036d65)|`Update lcalc to support staged install`|\n|[f07e056](https://git.sagemath.org/sage.git/commit/?id=f07e0568957fd46d4ada5f9b6b18fc04de1767b1)|`Update zn_poly, which doesn't really have a proper installer, to use staged install`|\n|[9997a37](https://git.sagemath.org/sage.git/commit/?id=9997a37138448b82eef16b34645c902ed93e03c9)|`Updated the python2/3 pacakges to use staged install.`|\n|[f9cfa6f](https://git.sagemath.org/sage.git/commit/?id=f9cfa6f2e806c6d809f3429429e8f05273616297)|`Remove the '-v' from the 'cp' command.`|\n|[e51f578](https://git.sagemath.org/sage.git/commit/?id=e51f578ed9c1a31e24461ec935e043204aa0d65d)|`Add staged install support for atlas`|\n|[48e9ffb](https://git.sagemath.org/sage.git/commit/?id=48e9ffbf5fe86d3186a505ae1e9ab1b13c8195f2)|`This file should be deleted from the temp install dir during staged install on OSX`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[d794f97](https://git.sagemath.org/sage.git/commit/?id=d794f9701e20106fbdd412ceee990a685090d24f)|`Updates the autotools spkg to use staged install`|\n|[7bcbccb](https://git.sagemath.org/sage.git/commit/?id=7bcbccb7a1b223017eb45d334cb097f365632c48)|`Fix installation of files containing spaces in their names`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[9eb5876](https://git.sagemath.org/sage.git/commit/?id=9eb5876c6793718ba6225aaba0e07fcf71eab432)|`Remove this sanity check`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[5f7d079](https://git.sagemath.org/sage.git/commit/?id=5f7d07967411a4c2ebdf2a837f6427bc210a761e)|`Fix sagenb installation`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[23799c8](https://git.sagemath.org/sage.git/commit/?id=23799c8b38066712b67354916bba6c265b4f15d2)|`Actually fix sagenb install`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[f30f964](https://git.sagemath.org/sage.git/commit/?id=f30f96437555e3e86fba17c028afe8f1fb72542d)|`Remove this sanity check`|\n|[637d136](https://git.sagemath.org/sage.git/commit/?id=637d13628ebd79c5f9976d2241793efd3380c6e4)|`Fix sagenb installation`|\n|[03b50fe](https://git.sagemath.org/sage.git/commit/?id=03b50fea279268b525f46cb35961e9e7332d54f6)|`Actually fix sagenb install`|\n|[2095d1d](https://git.sagemath.org/sage.git/commit/?id=2095d1d5fa3fbfbc39010fa7caa061d2be1cd77c)|`Make sure the path these symlinks are installed in exists first.`|\n|[48304f2](https://git.sagemath.org/sage.git/commit/?id=48304f2970132eeda72c4e3c7edd1ba7c55095fa)|`Some more enhancements to the sage-dist-helpers:`|\n|[5f0637d](https://git.sagemath.org/sage.git/commit/?id=5f0637dbbcdb3dd87c69e803cd694d10ed86e52d)|`Include the PKG_NAME, PKG_BASE, and PKG_VER variables directly in the install`|\n|[b5633e1](https://git.sagemath.org/sage.git/commit/?id=b5633e10f551c453adf785be2614bfcf7faa6852)|`Now that sdh_make_install implements DESTDIR we can replace all manual`|\n|[f41ab62](https://git.sagemath.org/sage.git/commit/?id=f41ab626a625b7b544c4a0731df061c35237a365)|`A few more standard autotools packages that are easily updated but I missed previously`|\n|[06e7339](https://git.sagemath.org/sage.git/commit/?id=06e7339f535ee8fc69454b202aa17be1f466a50a)|`Disable pip installation when installing Python 3; see #23398`|\n|[84a6827](https://git.sagemath.org/sage.git/commit/?id=84a6827229bbaa3a26154b1202d4f12fe4acad43)|`Don't override the valgrind suppression file from python2; add a separate one for Python 3`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[0885622](https://git.sagemath.org/sage.git/commit/?id=0885622958923d3f9f00725076b6553e10b8de4b)|`Handle the 2to3 script better so that Python2 and Python3 don't overwrite each other`|",
    "created_at": "2017-07-11T15:28:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[57ea8c9](https://git.sagemath.org/sage.git/commit/?id=57ea8c9df098426c4116d9644260ade6fff42b8f)|`Added the ability for packages to have a post-install script called spkg-postinst.`|\n|[76703a4](https://git.sagemath.org/sage.git/commit/?id=76703a467e7f4d053066c95dde6a416fb4afa3c7)|`Add special post-install handling for the backports/__init__.py shared`|\n|[be4f47a](https://git.sagemath.org/sage.git/commit/?id=be4f47afdf4260100fd30cf38f3317056b86ccef)|`Remove some no-longer used local variables`|\n|[62e916b](https://git.sagemath.org/sage.git/commit/?id=62e916b7cda969e7798fb096672923a2c049fa10)|`Add handling for packages that install .info files and update share/info/dir`|",
    "created_at": "2017-07-12T16:07:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[01c05f0](https://git.sagemath.org/sage.git/commit/?id=01c05f0c3bdd164d07846c72324e15f897328d6b)|`Rename $SAGE_INST_TEMP to $SAGE_DESTDIR`|",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[d950036](https://git.sagemath.org/sage.git/commit/?id=d9500366634b7eb5b24eea91dbf5fd78a50848e3)|`Don't use the -u option to cp.  It's not portable to BSD's cp, and is`|",
    "created_at": "2017-07-20T17:14:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:42'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[d605943](https://git.sagemath.org/sage.git/commit/?id=d605943e4ee29256ea30180803b96aa6a2d6917c)|`Just use 'cp -a' which seems to be compatible across most cp's.`|",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[dbdb947](https://git.sagemath.org/sage.git/commit/?id=dbdb94788f6275e19c5fd150bec8a889188f3164)|`Fix Python build on non-Cygwin systems (namely OSX) with case-insensitive filesystems`|",
    "created_at": "2017-07-31T12:45:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:57'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[4360f31](https://git.sagemath.org/sage.git/commit/?id=4360f314520c3394f788d64b3585f391b5c6b8c7)|`Added the ability for packages to have a post-install script called spkg-postinst.`|\n|[0972a41](https://git.sagemath.org/sage.git/commit/?id=0972a41e1de2dfe3e9f1e74d5e46dff4df939d82)|`Add special post-install handling for the backports/__init__.py shared`|\n|[41c73a3](https://git.sagemath.org/sage.git/commit/?id=41c73a3b12f8096d8c734607a849d9549e029461)|`Remove some no-longer used local variables`|\n|[750943a](https://git.sagemath.org/sage.git/commit/?id=750943a34b27fc9d134326bf85d9f0278718effe)|`Add handling for packages that install .info files and update share/info/dir`|\n|[53a9c47](https://git.sagemath.org/sage.git/commit/?id=53a9c478704380f9cacb9e36c632b67bdee05e33)|`Rename $SAGE_INST_TEMP to $SAGE_DESTDIR`|\n|[7615714](https://git.sagemath.org/sage.git/commit/?id=76157141ee63f260a097bc8a4fa46cf79f266322)|`Don't use the -u option to cp.  It's not portable to BSD's cp, and is`|\n|[d4bb6f7](https://git.sagemath.org/sage.git/commit/?id=d4bb6f7849adf520b557af4038e3c9b2d749e942)|`Just use 'cp -a' which seems to be compatible across most cp's.`|\n|[ed89571](https://git.sagemath.org/sage.git/commit/?id=ed8957174bfc4fd7d74a113bb38cf340c9f50714)|`Fix Python build on non-Cygwin systems (namely OSX) with case-insensitive filesystems`|\n|[44228b2](https://git.sagemath.org/sage.git/commit/?id=44228b281303b311abb8026429a6c2327d5a9d8b)|`On OSX DYLD_LIBRARY_PATH should be set a la LD_LIBRARY_PATH to run Python from its build directory`|\n|[ce38d07](https://git.sagemath.org/sage.git/commit/?id=ce38d0756f226ec9a87b55890e716edd80f0cbdc)|`Work around bug in OpenBLAS's Makefile with its use of DESTDIR with`|",
...
```json
{
    "body": "<a id='comment:72'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[ed2446b](https://git.sagemath.org/sage.git/commit/?id=ed2446b0cec371fd5fa83389f50e6b719b849467)|`Move spkg-check to after the package has been installed to SAGE_LOCAL.`|\n|[7001343](https://git.sagemath.org/sage.git/commit/?id=70013431e8c8a4ac4f49191378aea54e006b1a4b)|`Enable widgetsnbextension in the notebook's config file as a postinst step.`|",
    "created_at": "2017-09-04T08:37:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:76'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|\n|[0275058](https://git.sagemath.org/sage.git/commit/?id=02750584ab2382f1b986e674adc7a98c0ed279bb)|`On OSX DYLD_LIBRARY_PATH should be set a la LD_LIBRARY_PATH to run Python from its build directory`|\n|[8e193db](https://git.sagemath.org/sage.git/commit/?id=8e193dba196ccdfe5f5bc37c462a5fa02ac7e910)|`Move spkg-check to after the package has been installed to SAGE_LOCAL.`|\n|[53e3dc5](https://git.sagemath.org/sage.git/commit/?id=53e3dc54db7658c6eceb50d573eeb324d886a532)|`Enable widgetsnbextension in the notebook's config file as a postinst step.`|",
...
```json
{
    "body": "<a id='comment:81'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[71cb02d](https://git.sagemath.org/sage.git/commit/?id=71cb02d1ae524fa40910ff9eaed5ba03f0ce289f)|`Added the ability for packages to have a post-install script called spkg-postinst.`|\n|[013e6f3](https://git.sagemath.org/sage.git/commit/?id=013e6f329bb215f4bd37423b1224cabbaac97ab6)|`Add special post-install handling for the backports/__init__.py shared`|\n|[b886725](https://git.sagemath.org/sage.git/commit/?id=b8867259c68a782f235912cff35aa3108dead396)|`Remove some no-longer used local variables`|\n|[f94b3ec](https://git.sagemath.org/sage.git/commit/?id=f94b3ec48660ca9a226f90074683dbf672440f1f)|`Add handling for packages that install .info files and update share/info/dir`|\n|[f4960ea](https://git.sagemath.org/sage.git/commit/?id=f4960ea1e510e836c35612a1c0fc1698a7c6ade5)|`Rename $SAGE_INST_TEMP to $SAGE_DESTDIR`|\n|[36ff6ca](https://git.sagemath.org/sage.git/commit/?id=36ff6cac7e67438ab46b4efd9bde3955ab11fc5a)|`Don't use the -u option to cp.  It's not portable to BSD's cp, and is`|\n|[25c4d01](https://git.sagemath.org/sage.git/commit/?id=25c4d01bb69035512f218029c1c6665a67704f5d)|`Just use 'cp -a' which seems to be compatible across most cp's.`|\n|[8c9a60f](https://git.sagemath.org/sage.git/commit/?id=8c9a60f8f37eb1015f8a4cbcf0f15ad43658bba0)|`Work around bug in OpenBLAS's Makefile with its use of DESTDIR with`|\n|[1389380](https://git.sagemath.org/sage.git/commit/?id=1389380f87705b23698db8aea3c4476b845e9e3b)|`Move spkg-check to after the package has been installed to SAGE_LOCAL.`|\n|[f97fdf9](https://git.sagemath.org/sage.git/commit/?id=f97fdf916d7a58006d1be37c419180c8c8ee1893)|`Enable widgetsnbextension in the notebook's config file as a postinst step.`|",
    "created_at": "2017-09-04T18:02:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22509",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:92'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[be70ddb](https://git.sagemath.org/sage.git/commit/?id=be70ddb7efa5935b58bf31b5bebfb4f472b928ec)|`Added the ability for packages to have a post-install script called spkg-postinst.`|\n|[e246937](https://git.sagemath.org/sage.git/commit/?id=e246937533ebea75a42e56898d29a7c2b3cdb4b0)|`Add special post-install handling for the backports/__init__.py shared`|\n|[87a02ac](https://git.sagemath.org/sage.git/commit/?id=87a02ac25b1b17cf09a44edcd2046f913e449164)|`Remove some no-longer used local variables`|\n|[5927318](https://git.sagemath.org/sage.git/commit/?id=592731866e491d27f38ad65492af07f85cff2e23)|`Add handling for packages that install .info files and update share/info/dir`|\n|[73245de](https://git.sagemath.org/sage.git/commit/?id=73245de422500f2649b856ee5c44837586278d46)|`Rename $SAGE_INST_TEMP to $SAGE_DESTDIR`|\n|[a771cd8](https://git.sagemath.org/sage.git/commit/?id=a771cd891ed1478f5359f4a6611c6914fcd11f59)|`Don't use the -u option to cp.  It's not portable to BSD's cp, and is`|\n|[5125047](https://git.sagemath.org/sage.git/commit/?id=512504710450294645f1a65c67b5f6df660a534a)|`Just use 'cp -a' which seems to be compatible across most cp's.`|\n|[3e8e7b5](https://git.sagemath.org/sage.git/commit/?id=3e8e7b5868e4b8ff55616ba761523e974a68d608)|`Work around bug in OpenBLAS's Makefile with its use of DESTDIR with`|\n|[58676b4](https://git.sagemath.org/sage.git/commit/?id=58676b476bfcd1e2c636c3b97afb44ba1eb52683)|`Move spkg-check to after the package has been installed to SAGE_LOCAL.`|\n|[c1d5453](https://git.sagemath.org/sage.git/commit/?id=c1d5453c2735cdda78d53dc36b56fb54ec7dd336)|`Enable widgetsnbextension in the notebook's config file as a postinst step.`|",
