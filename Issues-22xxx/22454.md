...
```json
{
    "body": "Changing branch from \"\" to \"u/msaaltink/is_unit_can_give_wrong_results_in_mutlivariate_and_infinite_polynomial_rings_\"",
    "created_at": "2017-02-28T22:19:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416945",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```

Changing branch from "" to "u/msaaltink/is_unit_can_give_wrong_results_in_mutlivariate_and_infinite_polynomial_rings_"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416946",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"429dde814708ad2b01c04b5ab667756d635d58c5\"",
    "created_at": "2017-02-28T23:38:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416947",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```

Changing commit from "" to "429dde814708ad2b01c04b5ab667756d635d58c5"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416948",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416949",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>For `is_unit` in `multi_polynomial.pyx`, I would do:\n\n```sage\n        if not self.constant_coefficient().is_unit():\n            return False\n        from polydict import ETuple\n        cdef dict d = self.dict()\n        cdef ETuple zero_key = ETuple([0]*self.parent().ngens())\n        if zero_key in d:\n            d.pop(zero_key)\n        return all(d[k].is_nilpotent() for k in d)\n```\nfor speed.",
    "created_at": "2017-03-01T15:26:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416950",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>For `is_unit` in `multi_polynomial.pyx`, I would do:
...
```json
{
    "body": "Changing commit from \"429dde814708ad2b01c04b5ab667756d635d58c5\" to \"c42072d33bfef2db3b69013f45585d454e089624\"",
    "created_at": "2017-03-01T20:17:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416953",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "429dde814708ad2b01c04b5ab667756d635d58c5" to "c42072d33bfef2db3b69013f45585d454e089624"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416954",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>If you could make the one additional change to use:\n\n```\ncdef ETuple zero_key = ETuple({}, int(self.parent().ngens()))\n```\nthen you can set a positive review on my behalf.",
    "created_at": "2017-03-07T17:22:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416955",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>If you could make the one additional change to use:
...
```json
{
    "body": "Changing commit from \"c42072d33bfef2db3b69013f45585d454e089624\" to \"4c2f79266e38b6312eb5041575bfc73bf6e6f47c\"",
    "created_at": "2017-03-07T20:13:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416956",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "c42072d33bfef2db3b69013f45585d454e089624" to "4c2f79266e38b6312eb5041575bfc73bf6e6f47c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416957",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>tscrim: Done.  I looked at ETuple and see that this call goes to a simpler code path.  As you showed above, it is indeed a bit faster.  Thanks for the review.",
    "created_at": "2017-03-07T20:19:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416958",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```

<a id='comment:9'></a>tscrim: Done.  I looked at ETuple and see that this call goes to a simpler code path.  As you showed above, it is indeed a bit faster.  Thanks for the review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416959",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416960",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416961",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22454#event-58727"
}
```
...
```json
{
    "body": "Changing branch from \"u/msaaltink/is_unit_can_give_wrong_results_in_mutlivariate_and_infinite_polynomial_rings_\" to \"4c2f79266e38b6312eb5041575bfc73bf6e6f47c\"",
    "created_at": "2017-03-10T23:12:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416962",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/msaaltink/is_unit_can_give_wrong_results_in_mutlivariate_and_infinite_polynomial_rings_" to "4c2f79266e38b6312eb5041575bfc73bf6e6f47c"
...
```json
{
    "body": "Changing commit from \"4c2f79266e38b6312eb5041575bfc73bf6e6f47c\" to \"\"",
    "created_at": "2018-06-29T13:46:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22454#issuecomment-416963",
    "user": "https://github.com/enriqueartal"
}
```

Changing commit from "4c2f79266e38b6312eb5041575bfc73bf6e6f47c" to ""
