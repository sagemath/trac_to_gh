...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22866#issuecomment-336210",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22866#issuecomment-336211",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22866#issuecomment-336212",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>zeromq is also failing.  I don't know if it passed earlier but IIRC it did not , and was just left off this ticket by mistake.",
    "created_at": "2018-09-28T16:27:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22866#issuecomment-336213",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>zeromq is also failing.  I don't know if it passed earlier but IIRC it did not , and was just left off this ticket by mistake.
