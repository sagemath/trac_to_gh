...
```json
{
    "body": "<a id='comment:1'></a>\nThere are two commits.  The first unconditionally adds the menu item and the second greys it out if there are no files to be upgraded.  It's fine with me if you want to just use the first because you think it will be less confusing.\n\nI should note that I didn't test the actual upgrade.\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[acf111a](https://git.sagemath.org/sage.git/commit?id=acf111a3ea6f4870e633a7052ce64c39dc5ec062)|`trac 22821 Add menu item for upgrading NB to Jupyter`|\n|[b7ca77e](https://git.sagemath.org/sage.git/commit?id=b7ca77edd2e11f28582d8d41074f832a92bbd258)|`trac 22821 Grey out the menu item if there is nothing to upgrade`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[aa00327](https://git.sagemath.org/sage.git/commit/?id=aa00327db00dd4c9d034b84088822553e6c657a5)|`trac 22821 Prefer Jupyter by default`|",
    "created_at": "2017-04-20T03:14:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22821",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[a06cabd](https://git.sagemath.org/sage.git/commit/?id=a06cabdacb9310c8cd5ebf0e187363f55d4e5840)|`trac 22821 Create Jupyter directory before use and prompt if it doesn\u2019t exist`|",
    "created_at": "2017-04-25T04:22:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22821",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[ca3f558](https://git.sagemath.org/sage.git/commit/?id=ca3f558cc2b1c3e69ae263d280cfbcb2490d6824)|`trac 22821 don\u2019t check the \"Stop Sage\" menu item`|\n|[5aabb31](https://git.sagemath.org/sage.git/commit/?id=5aabb312cfa68e73d6edd699f3fd79cc3ec65033)|`trac 22821 Open loading page for Jupyter as well as SageNB`|",
    "created_at": "2017-04-26T05:10:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22821",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[84fb008](https://git.sagemath.org/sage.git/commit/?id=84fb0088b171dcd9236366265d896b349daad3f8)|`Add Upgrade SageNB menu to the status bar item.`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[b52cfea](https://git.sagemath.org/sage.git/commit/?id=b52cfea75aa66f7a7d40ebbee7ef4943a012ee7d)|`trac 22821 Add menu item for upgrading NB to Jupyter`|\n|[63f7e83](https://git.sagemath.org/sage.git/commit/?id=63f7e83669e5dc852a5d24ed1b9b9294ece11ad5)|`trac 22821 Prefer Jupyter by default`|\n|[dd241a7](https://git.sagemath.org/sage.git/commit/?id=dd241a7ecfb1a4077465eef9f2aa0bd6b3108cc6)|`trac 22821 Create Jupyter directory before use and prompt if it doesn\u2019t exist`|\n|[7e734a5](https://git.sagemath.org/sage.git/commit/?id=7e734a5135ba4ee3b7f72b0312e98fcdf40d1e2d)|`trac 22821 Open loading page for Jupyter as well as SageNB`|\n|[1cfce71](https://git.sagemath.org/sage.git/commit/?id=1cfce71a794ca7812873683cc1e8473c984443f4)|`trac 22821 Clean up menus a little`|",
    "created_at": "2017-05-03T03:53:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22821",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[6f89dd5](https://git.sagemath.org/sage.git/commit/?id=6f89dd5e2d3cc179b52476d20a2859604ea64644)|`trac 22821 Hide New Worksheet in the File menu too`|\n|[6ca6859](https://git.sagemath.org/sage.git/commit/?id=6ca685969e894679af93a2a489870ce1d5731dc7)|`trac 22821 Correctly start Jupyter on startup based on setting`|",
    "created_at": "2017-05-24T03:13:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22821",
    "type": "issue_comment",
