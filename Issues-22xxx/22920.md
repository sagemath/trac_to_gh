...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22920#event-301687"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22920#event-301688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22920#event-301689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22920#event-301690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22920#issuecomment-344491",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22920#issuecomment-344492",
    "user": "https://github.com/rwst"
}
```
