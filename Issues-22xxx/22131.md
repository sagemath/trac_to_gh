...
```json
{
    "body": "<a id='comment:1'></a>For instance, by analogy with `random_prime` one could do `random_integer` as a top-level thing.  At the very least we should improve documentation.",
    "created_at": "2017-01-03T15:06:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22131",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22131#issuecomment-409581",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>For instance, by analogy with `random_prime` one could do `random_integer` as a top-level thing.  At the very least we should improve documentation.
