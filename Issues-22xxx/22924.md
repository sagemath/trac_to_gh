...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320368",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320369",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "How would one test that this is fixed?   It does look identical to the fix in the previous ticket.",
    "created_at": "2017-06-08T14:48:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320370",
...
```json
{
    "body": "A better solution would probably be to fix the Python linking, there is something wrong with Jeroen's binaries that I can't reproduce. The `_ssl.so` module should have an RPATH set and this will come first in the library resolution order even for transitive dependencies...",
    "created_at": "2017-06-11T09:39:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320371",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320372",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Very interesting blog post. Cleared a few things up for me. I am fairly sure Jeroen uses Gentoo and that it default to `-Wl,--enable-new-dtags` by default. So disabling that is an easy option.",
    "created_at": "2017-06-14T21:41:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320374",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320375",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Jeroen, does that fix it for you?\n\n---\nNew commits:",
    "created_at": "2017-06-17T13:51:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320376",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Hmm, for some reason I cannot reproduce the problem anymore. There must be some non-deterministic aspect...\n\nNow (without this patch), I get\n\n```\n$ readelf -d local/lib/python2.7/lib-dynload/_ssl.so\n\nDynamic section at offset 0x14d60 contains 29 entries:\n  Tag        Type                         Name/Value\n 0x0000000000000001 (NEEDED)             Shared library: [libssl.so.1.0.0]\n 0x0000000000000001 (NEEDED)             Shared library: [libcrypto.so.1.0.0]\n 0x0000000000000001 (NEEDED)             Shared library: [libpython2.7.so.1.0]\n 0x0000000000000001 (NEEDED)             Shared library: [libpthread.so.0]\n 0x0000000000000001 (NEEDED)             Shared library: [libc.so.6]\n 0x000000000000001d (RUNPATH)            Library runpath: [/usr/local/src/sage-config/local/lib]\n 0x000000000000000c (INIT)               0x71d8\n 0x000000000000000d (FINI)               0xf6f0\n 0x0000000000000019 (INIT_ARRAY)         0x214d48\n 0x000000000000001b (INIT_ARRAYSZ)       8 (bytes)\n 0x000000000000001a (FINI_ARRAY)         0x214d50\n 0x000000000000001c (FINI_ARRAYSZ)       8 (bytes)\n 0x000000006ffffef5 (GNU_HASH)           0x1c8\n 0x0000000000000005 (STRTAB)             0x18d0\n 0x0000000000000006 (SYMTAB)             0x208\n 0x000000000000000a (STRSZ)              4539 (bytes)\n 0x000000000000000b (SYMENT)             24 (bytes)\n 0x0000000000000003 (PLTGOT)             0x215000\n 0x0000000000000002 (PLTRELSZ)           5256 (bytes)\n 0x0000000000000014 (PLTREL)             RELA\n 0x0000000000000017 (JMPREL)             0x5d50\n 0x0000000000000007 (RELA)               0x2cd8\n 0x0000000000000008 (RELASZ)             12408 (bytes)\n 0x0000000000000009 (RELAENT)            24 (bytes)\n 0x000000006ffffffe (VERNEED)            0x2c78\n 0x000000006fffffff (VERNEEDNUM)         2\n 0x000000006ffffff0 (VERSYM)             0x2a8c\n 0x000000006ffffff9 (RELACOUNT)          499\n 0x0000000000000000 (NULL)               0x0\n```",
    "created_at": "2017-06-19T08:36:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320377",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320378",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320379",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "It depends on which transitive dependency is pulled first, so it may very well be random.",
    "created_at": "2017-06-20T10:52:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320380",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320383",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "I can no longer reproduce this, so I'm downgrading the priority.",
    "created_at": "2017-07-06T10:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320384",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22924#event-59844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22924#issuecomment-320385",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22924",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22924#event-59845"
}
```
