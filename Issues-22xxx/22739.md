...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|\n|[9a82925](https://git.sagemath.org/sage.git/commit/?id=9a829255a356e0edb2959fd197f2a8f64f088e83)|`Mac install dmg: scaling background image to 72dpi and exporting png from InkScape such that the bars have a gradient as intended.`|\n|[db0460e](https://git.sagemath.org/sage.git/commit/?id=db0460e04ff4bce8becc26804c8b2449673850b5)|`Using AppleScript to set background image of the .app.dmg (for Mac installations) instead of the ds_store python package by Alastair Houghton.`|\n|[8e10f56](https://git.sagemath.org/sage.git/commit/?id=8e10f56bfd47b651ebc1481de1c6cf05eeeb9396)|`Deleting old code trying to directly create the .DS_Store file since we are now using AppleScript.`|",
