...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[0887bf0](https://git.sagemath.org/sage.git/commit/?id=0887bf09f9136193966b0c980f38db451419c234)|`Slight fixes to some of the tests to reflect the last changes.`|\n|[51daae0](https://git.sagemath.org/sage.git/commit/?id=51daae0f857e876f5ec39202fe28c29dc1420103)|`Allow default_lang to be passed to get_documents, through to AllBuilder.get_all_documents`|\n|[0bf054a](https://git.sagemath.org/sage.git/commit/?id=0bf054ae9f14d727d3e4e961efbb8c4d223aa0e3)|`This module should still work if sage hasn't been built yet and can't import complicated submodules`|",
    "created_at": "2016-12-21T15:15:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22080",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[974e238](https://git.sagemath.org/sage.git/commit/?id=974e238b3e22a0edd6d40e3f8f2e56fa8636467e)|`Initial refactoring of sage_setup.docbuild.__init__ into a number of`|\n|[92fc235](https://git.sagemath.org/sage.git/commit/?id=92fc2356361d6f31ae81083aa5eee67e89d2464c)|`Ensure that AllBuilder.get_all_documents() handles 'reference' correctly when default_lang is 'en'`|\n|[2ff16e8](https://git.sagemath.org/sage.git/commit/?id=2ff16e82dbd653ca5ea7e0c2142f83d59752a32b)|`Three more changes I had in mind, that were tricky to disentangle:`|\n|[d975591](https://git.sagemath.org/sage.git/commit/?id=d9755910ba197185437254ccb1bab2b4beddfc08)|`Use importlib.import_module instead of __import__ in a couple places`|\n|[6e87372](https://git.sagemath.org/sage.git/commit/?id=6e87372eb1d6090914510a8543b43096c864756b)|`Implement a minor TODO item: although maybe unnecessary here it's lways good practice to restore globals in sys after we mess with them.`|\n|[701526b](https://git.sagemath.org/sage.git/commit/?id=701526bdd38e0522f3ac69affde51e2f3d972997)|`Slight fixes to some of the tests to reflect the last changes.`|\n|[5dab10a](https://git.sagemath.org/sage.git/commit/?id=5dab10a5ffe78f3687ea69f47dfb436d56d4c719)|`Allow default_lang to be passed to get_documents, through to AllBuilder.get_all_documents`|\n|[1b532cf](https://git.sagemath.org/sage.git/commit/?id=1b532cfba2aba4ceeb9229fbaa570b02cb90c6f8)|`This module should still work if sage hasn't been built yet and can't import complicated submodules`|\n|[1a88454](https://git.sagemath.org/sage.git/commit/?id=1a88454d22186c7908308e75003c055592282e6a)|`Static methods not (easily) pickleable for use with multiprocessing; should be module-level functions.`|\n|[dfeaa78](https://git.sagemath.org/sage.git/commit/?id=dfeaa78686c0c1476b7a7eafce4333c5ec02cee2)|`Restore this import which is (unfortunately) necessary for imports from sage to not break.`|",
    "created_at": "2017-05-19T10:35:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22080",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nFor easier reviewing, I squashed this branch and made it into 2 commits: one which literally just moves code around and one which makes further changes.\n\n---\nNew commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[d95a52b](https://git.sagemath.org/sage.git/commit?id=d95a52bf4ade210ff9aa5d3739887dce9e286250)|`Split up docbuilding code`|\n|[652c41e](https://git.sagemath.org/sage.git/commit?id=652c41e26b268bbe7860184e3129b9836da734b6)|`Refactor sage_setup.docbuild`|",
    "created_at": "2017-05-22T10:05:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22080",
    "type": "issue_comment",
