...
```json
{
    "body": "<a id='comment:4'></a>Haven't fully tested yet, but i think adding `-std=gnu++98` to the `CXXFLAGS` should work around it, a la #20381.",
...
<a id='comment:4'></a>Haven't fully tested yet, but i think adding `-std=gnu++98` to the `CXXFLAGS` should work around it, a la #20381.
...
```json
{
    "body": "<a id='comment:5'></a>Yes, that seems to have done the trick.",
...
<a id='comment:5'></a>Yes, that seems to have done the trick.
