...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22401#event-295253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22401#event-295254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22401#event-295255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22401#event-295256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22401#issuecomment-333857",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22401#issuecomment-333858",
    "user": "https://github.com/rwst"
}
```
