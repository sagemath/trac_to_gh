...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301221"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301224"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22878#issuecomment-343907",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22878#issuecomment-343908",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301225"
}
```
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">Comment 8</div>\n\n@sagetrac-jeroen: what do you think?",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301226"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301228"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22878",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22878#event-301229"
}
```
