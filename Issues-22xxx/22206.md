...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22206#issuecomment-330923",
    "user": "https://github.com/sagetrac-pvalicov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22206#issuecomment-330924",
...
```json
{
    "body": "Changed keywords from none to **graphs, orientations**",
    "created_at": "2017-01-19T10:51:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/22206",
    "type": "issue_comment",
...
Changed keywords from none to **graphs, orientations**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22206#event-293031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22206#event-293032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22206#event-293033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22206",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22206#event-293034"
}
```
