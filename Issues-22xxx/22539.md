...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22539#issuecomment-336555",
    "user": "https://github.com/sagetrac-rrissner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22539#issuecomment-336556",
    "user": "https://github.com/sagetrac-rrissner"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22539#event-296980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22539#event-296981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22539#event-296982"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22539#event-296983"
}
```
