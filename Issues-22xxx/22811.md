...
```json
{
    "body": "Attachment [config.log](https://github.com/sagemath/sage/files/ticket22811/config.log) by rrogers created at 2017-04-14 17:55:30\n\nAutomatic config.log",
    "created_at": "2017-04-14T17:55:30Z",
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342505",
    "user": "https://trac.sagemath.org/admin/accounts/users/rrogers"
}
```

Attachment [config.log](https://github.com/sagemath/sage/files/ticket22811/config.log) by rrogers created at 2017-04-14 17:55:30
...
```json
{
    "body": "Attachment [make.err](https://github.com/sagemath/sage/files/ticket22811/make.err) by rrogers created at 2017-04-14 17:56:23\n\nfrom  make 1>make.log  2>make.err",
    "created_at": "2017-04-14T17:56:23Z",
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342506",
    "user": "https://trac.sagemath.org/admin/accounts/users/rrogers"
}
```

Attachment [make.err](https://github.com/sagemath/sage/files/ticket22811/make.err) by rrogers created at 2017-04-14 17:56:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342507",
    "user": "https://trac.sagemath.org/admin/accounts/users/rrogers"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [make.log](https://github.com/sagemath/sage/files/ticket22811/make.log) by @mkoeppe created at 2021-09-07 08:47:41\n\nOutdated, should close",
    "created_at": "2021-09-07T08:47:41Z",
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342508",
    "user": "https://github.com/mkoeppe"
}
```
