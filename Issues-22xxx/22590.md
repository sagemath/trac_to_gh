...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-297669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-297670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-297671"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-297672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337591",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337592",
    "user": "https://github.com/zimmermann6"
}
```
