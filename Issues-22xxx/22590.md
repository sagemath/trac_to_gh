...
```json
{
    ...
    "type": "issue",
    "updated_at": "2017-03-13T15:59:42Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-273885"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-273886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-273887"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22590#event-273888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337472",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337473",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337474",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337475",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337476",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22590#issuecomment-337477",
    "user": "https://github.com/zimmermann6"
}
```
