...
```json
{
    "body": "<a id='comment:1'></a>Obvious question: do you have `surf` installed on your system?",
...
<a id='comment:1'></a>Obvious question: do you have `surf` installed on your system?
...
```json
{
    "body": "<a id='comment:2'></a>> Obvious question: do you have surf installed on your system?\n\n\nit seems no. I thought Sage was self-content...\n\nPaul",
...
<a id='comment:2'></a>> Obvious question: do you have surf installed on your system?
...
<a id='comment:3'></a>now with surf installed, the last command opens a new window where it is written:
...
<a id='comment:4'></a>Replying to [zimmerma](#comment%3A2):
> > Obvious question: do you have surf installed on your system?
...
<a id='comment:5'></a>If you type (with J the ideal in the description):
...
<a id='comment:6'></a>sorry I retract part of what I said in the description: the example in the book differs.
However the failure is still there. If plot is not able to deal with 3D ideals, I believe the error message should be improved.
