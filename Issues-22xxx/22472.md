...
```json
{
    "body": "<a id='comment:2'></a>Once this is done, we should reorganise the top index (in #22386) so that \nDiscrete Mathematics will get a heading \"Optimization and Solvers\" expanding into\nSAT Solvers, Knapsack, ILP.",
    "created_at": "2017-03-13T13:31:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22472#issuecomment-308662",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:2'></a>Once this is done, we should reorganise the top index (in #22386) so that 
Discrete Mathematics will get a heading "Optimization and Solvers" expanding into
SAT Solvers, Knapsack, ILP.
