...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22055#issuecomment-302404",
...
```json
{
    "body": "<a id='comment:2'></a>Marc, I just did `git pull` from Sage 7.4, then `git branch -r` does not show any branch with sollya in it.\n\nPaul",
    "created_at": "2016-12-14T12:58:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22055#issuecomment-302405",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>Marc, I just did `git pull` from Sage 7.4, then `git branch -r` does not show any branch with sollya in it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22055#issuecomment-302406",
    "user": "https://github.com/mezzarobba"
}
```
