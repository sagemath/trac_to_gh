...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22387#issuecomment-415253",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Maybe just include a warning that the result is untrustworthy?",
    "created_at": "2017-02-17T17:27:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22387#issuecomment-415255",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:3'></a>Maybe just include a warning that the result is untrustworthy?
