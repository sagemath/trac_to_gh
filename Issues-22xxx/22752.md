...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424239",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424240",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424241",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424242",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424243",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424244",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424245",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424246",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424247",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424248",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424249",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424250",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I don't think using the context manager is thread safe, and python as a whole doesn't forbid using threads. I'm afraid we're stuck with other, less attractive syntax.\n\nI haven't looked into this in detail, but python does have an impressive hooks etc. in the import system (hooks that have changed quite a bit in later versions of 3.* as well ...). If we want to co-opt the `import` statement syntax, perhaps we can do something using\n[meta_path](https://docs.python.org/3/reference/import.html#the-meta-path) so that we can do something like\n\n```\nimport lazy.sage.calculus.calculus\n```",
    "created_at": "2017-04-05T19:57:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424251",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:9'></a>I don't think using the context manager is thread safe, and python as a whole doesn't forbid using threads. I'm afraid we're stuck with other, less attractive syntax.
...
```json
{
    "body": "<a id='comment:10'></a>Different note on lazy imports: Currently we have hundreds of \"lazy-import\" objects hanging around coming from\nin module `A`:\n\n```\nlazy_import('C',XXX}\n```\nand then in module `B`:\n\n```\nfrom A import XXX\n```\nThe problem is that the lazy import object that gets bound to B.XXX still has a pointer to the namespace of A, so every time B.XXX gets called, it will looking at A.XXX. See #16522. \n\nIf we're going to put hooks into the import system, perhaps we can filter out these issues as well.",
    "created_at": "2017-04-05T20:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424252",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:10'></a>Different note on lazy imports: Currently we have hundreds of "lazy-import" objects hanging around coming from
in module `A`:
...
```json
{
    "body": "<a id='comment:12'></a>Hm. Replacing `__import__` within a context manager isn't thread safe. But we COULD replace `__import__` wholesale to do what it normally does, and in extended form allow things like\n\n```\nimport lazy.sage.calculus.calculus\nfrom lazy.sage.interfaces.maxima_lib import maxima\n```\nwhat's more, we could also wrap\n\n```\nfrom A import XXX\n```\nto check if XXX is a `LazyImport` object and if so, rewrap it referencing the appropriate namespace.\n\nThe only offence is that we'd be incompatible with a top-level module \"lazy\" existing.",
    "created_at": "2017-04-06T00:15:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424254",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:12'></a>Hm. Replacing `__import__` within a context manager isn't thread safe. But we COULD replace `__import__` wholesale to do what it normally does, and in extended form allow things like
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424255",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424256",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424258",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424259",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Nils, you idea doesn't allow passing extra options to `LazyImport`. You cannot do\n\n```\nfrom sage.calculus.calculus.__lazy__(deprecation=12345) import something\n```",
    "created_at": "2017-04-06T08:41:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424260",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>Nils, you idea doesn't allow passing extra options to `LazyImport`. You cannot do
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424261",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424262",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424264",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Regarding thread-safety, the only thing that we cannot protect against is another thread also changing `__builtin__.__import__`. If you are willing to live with that, I think it's possible to fix other thread issues.",
    "created_at": "2017-04-06T09:38:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424266",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>Regarding thread-safety, the only thing that we cannot protect against is another thread also changing `__builtin__.__import__`. If you are willing to live with that, I think it's possible to fix other thread issues.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424267",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424268",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424269",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424270",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Replying to [nbruin](#comment%3A12):\n> We could also wrap\n> \n> ```\n> from A import XXX\n> ```\n> to check if XXX is a `LazyImport` object and if so, rewrap it referencing the appropriate namespace.\n\n\nI suggest to do this *not* on this ticket, but on #16522.",
    "created_at": "2017-04-06T10:35:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424271",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>Replying to [nbruin](#comment%3A12):
> We could also wrap
> 
> ```
> from A import XXX
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424272",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424273",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Continuing the name discussion, I realized that lazy imports are often used in `all.py` files which are then imported by an `from ... import *` statement. It's better that this latter statement does not import the name `lazyimport` (imagine seeing `lazyimport` in a catalogue). For that reason, it is better to start the name with an underscore. So I changed the name to `_lazyimport_`.",
    "created_at": "2017-04-06T12:35:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424274",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:27'></a>Continuing the name discussion, I realized that lazy imports are often used in `all.py` files which are then imported by an `from ... import *` statement. It's better that this latter statement does not import the name `lazyimport` (imagine seeing `lazyimport` in a catalogue). For that reason, it is better to start the name with an underscore. So I changed the name to `_lazyimport_`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424275",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424276",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424278",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424279",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424280",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424281",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424284",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424286",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424288",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Anyway, with 2 people clearly against my idea, I will stop fighting...",
    "created_at": "2017-04-06T20:15:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424289",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:40'></a>Anyway, with 2 people clearly against my idea, I will stop fighting...
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22752#event-59236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22752#event-59237"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>Once you implement lazy imports with your hypothetical fix using PEP 302, remember to fix #15648 and #20626 too.",
    "created_at": "2017-04-06T20:22:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424290",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:41'></a>Once you implement lazy imports with your hypothetical fix using PEP 302, remember to fix #15648 and #20626 too.
...
```json
{
    "body": "<a id='comment:42'></a>And maybe #21636 too, while you're at it.",
    "created_at": "2017-04-06T20:24:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424291",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:42'></a>And maybe #21636 too, while you're at it.
...
```json
{
    "body": "<a id='comment:43'></a>...which should eventually lead to a fix for #22747 which I need for https://github.com/OpenDreamKit/OpenDreamKit/issues/87",
    "created_at": "2017-04-06T20:25:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424292",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:43'></a>...which should eventually lead to a fix for #22747 which I need for https://github.com/OpenDreamKit/OpenDreamKit/issues/87
...
```json
{
    "body": "<a id='comment:45'></a>I also remind you about #22755, which makes some fixes to the existing lazy imports. If you do work on lazy imports, please do so on top of #22755.",
    "created_at": "2017-04-07T08:33:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424294",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:45'></a>I also remind you about #22755, which makes some fixes to the existing lazy imports. If you do work on lazy imports, please do so on top of #22755.
...
```json
{
    "body": "<a id='comment:46'></a>> PEP 302 wouldn't make a difference for this because it also uses global variables like sys.meta_path\n\n\nYou wouldn't be manipulating `sys.meta_path` in general, except very early on in `sage.__init__` for example.",
    "created_at": "2017-04-07T09:42:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424295",
    "user": "https://github.com/embray"
}
```

<a id='comment:46'></a>> PEP 302 wouldn't make a difference for this because it also uses global variables like sys.meta_path
...
```json
{
    "body": "<a id='comment:48'></a>Just out of curiosity, I'm going to take a stab at replacing our proxy with `lazy_object_proxy` (without any other changes to lazy_import) and see how far I can get, or if it can resolve any of the known bugs.",
    "created_at": "2017-04-07T12:12:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424297",
    "user": "https://github.com/embray"
}
```

<a id='comment:48'></a>Just out of curiosity, I'm going to take a stab at replacing our proxy with `lazy_object_proxy` (without any other changes to lazy_import) and see how far I can get, or if it can resolve any of the known bugs.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424298",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:54'></a>Or are there also cases where lazy import is used for performance reasons, and if so what are some examples of that?",
    "created_at": "2017-04-11T09:34:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424303",
    "user": "https://github.com/embray"
}
```

<a id='comment:54'></a>Or are there also cases where lazy import is used for performance reasons, and if so what are some examples of that?
...
```json
{
    "body": "<a id='comment:56'></a>Got it--thanks for clarifying.",
    "created_at": "2017-04-11T09:43:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424305",
    "user": "https://github.com/embray"
}
```

<a id='comment:56'></a>Got it--thanks for clarifying.
...
```json
{
    "body": "<a id='comment:57'></a>TODO: discuss lazy imports next week too with `@`embray.",
    "created_at": "2017-04-20T09:39:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424306",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:57'></a>TODO: discuss lazy imports next week too with `@`embray.
...
```json
{
    "body": "<a id='comment:58'></a>Good news for myself: I think I can get #22747 to work without requiring this.",
    "created_at": "2017-04-21T15:27:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424307",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:58'></a>Good news for myself: I think I can get #22747 to work without requiring this.
...
```json
{
    "body": "<a id='comment:59'></a>Is that the issue you refer to when you mean \"works with Cython\"?",
    "created_at": "2017-04-21T17:23:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424308",
    "user": "https://github.com/embray"
}
```

<a id='comment:59'></a>Is that the issue you refer to when you mean "works with Cython"?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424309",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424310",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22752#issuecomment-424311",
    "user": "https://github.com/jdemeyer"
}
```
