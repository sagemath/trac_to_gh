...
```json
{
    "body": "<a id='comment:1'></a>\nWork in progress. In particular doc still needs to be adapted.\n\n---\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[c156606](https://git.sagemath.org/sage.git/commit?id=c156606639fd64f3ec26a131a0700e6b5a7758a5)|`change slighty semantics of equality in real mpfi`|\n|[6d2bf26](https://git.sagemath.org/sage.git/commit?id=6d2bf26b18212f171be543703f78a7215f55b17d)|`cmp in real mpfi : doctests`|\n|[6a919fa](https://git.sagemath.org/sage.git/commit?id=6a919fa0cb113b648fd79001cd4ef1afbf30a40b)|`py3 : removal of cmp() in real_lazy`|\n|[7f5c49a](https://git.sagemath.org/sage.git/commit?id=7f5c49a768aef4407032946687e5b3ebd3eca3a5)|`Merge branch 'u/chapoton/22257' in real_mpfi branch`|\n|[fd2e363](https://git.sagemath.org/sage.git/commit?id=fd2e363687a61efd7a53279c59c2327fb8991a3e)|`py3: change semantics of equality for real and cplx interval fields`|",
    "created_at": "2017-03-08T10:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22549",
    "type": "issue_comment",
