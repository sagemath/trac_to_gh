...
```json
{
    "body": "<a id='comment:1'></a>An answer to my side question:\n\n```\nsage: a=RDF(pi); a\n3.141592653589793\nsage: a.__repr__()\n'3.141592653589793'\n```",
    "created_at": "2017-04-12T10:41:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425267",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>An answer to my side question:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425268",
...
```json
{
    "body": "<a id='comment:3'></a>> 2) why does RDF output one more digit than RR (and two less with the str method)?\n> See #21124.\n\n\nthis does not answer my question.",
    "created_at": "2017-04-13T06:35:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425269",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:3'></a>> 2) why does RDF output one more digit than RR (and two less with the str method)?
> See #21124.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425270",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>in my opinion, it would be better if RR would also print 16 significant digits, for two\nreasons:\n\n1) consistency with RDF\n\n2) like for RDF, we could write `RR(\"the string\")` to get back the number, and two\n   different numbers would be guaranteed to have different string representations.\n\nBesides, note that the `0.1 + 0.2` issue still happens:\n\n```\nsage: 1.2-1.1\n0.0999999999999999\n```\nPaul",
    "created_at": "2017-04-13T07:59:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425271",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>in my opinion, it would be better if RR would also print 16 significant digits, for two
reasons:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425272",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425273",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425274",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>> Side question: how can I obtain (in a program) the string `'3.141592653589793'` corresponding to the first output?\n\n\nUse `repr(foo)` to get the display representation of `foo`.",
    "created_at": "2017-09-06T12:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425275",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>> Side question: how can I obtain (in a program) the string `'3.141592653589793'` corresponding to the first output?
...
```json
{
    "body": "<a id='comment:10'></a>I'm a bit confused here. I can answer all your questions but I don't know whether there remains a bug or not...",
    "created_at": "2017-09-06T12:37:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425276",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>I'm a bit confused here. I can answer all your questions but I don't know whether there remains a bug or not...
...
```json
{
    "body": "<a id='comment:11'></a>thank you for answering 3). It remains 1) and 2) which show inconsistent behaviour in my opinion.",
    "created_at": "2017-09-07T14:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22797#issuecomment-425277",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:11'></a>thank you for answering 3). It remains 1) and 2) which show inconsistent behaviour in my opinion.
