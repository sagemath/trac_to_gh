...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22691#event-59131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22691#event-59132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422906",
...
```json
{
    "body": "<a id='comment:1'></a>Duplicate of #22584 I guess.",
    "created_at": "2017-03-28T12:32:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422907",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Duplicate of #22584 I guess.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422908",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22691#event-59133"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Issue still exists, reopening...",
    "created_at": "2017-04-22T20:10:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422909",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Issue still exists, reopening...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422910",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422911",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422912",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -49,6 +49,8 @@\n **********************************************************************\n ```\n \n+**Tarball**: https://github.com/sagemath/cysignals/releases/download/1.6.4/cysignals-1.6.4.tar.bz2\n+\n Comment: 1\n \n Summary: Cypari2 sigabrt in debug build\n``````\n",
    "created_at": "2017-04-23T13:08:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422913",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22691#event-59134"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22691#event-59135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422914",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422915",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422916",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422917",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422918",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422919",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Note that this still doesn't fix the issue 100%. It's an improvement over the existing situation, but there is still a non-deterministic problem with `bernmm.pyx` (probably due to the use of multi-threading, see https://github.com/sagemath/cysignals/issues/21)",
    "created_at": "2017-04-23T18:11:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422920",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>Note that this still doesn't fix the issue 100%. It's an improvement over the existing situation, but there is still a non-deterministic problem with `bernmm.pyx` (probably due to the use of multi-threading, see https://github.com/sagemath/cysignals/issues/21)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422921",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22691#event-59136"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22691#issuecomment-422922",
    "user": "https://github.com/vbraun"
}
```
