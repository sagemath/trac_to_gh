...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[f2bcabd](https://git.sagemath.org/sage.git/commit?id=f2bcabd8c5342e576ba93a61897915be1468ab6d)|`Upgrade to cysignals version 1.6.3`|\n|[8c05957](https://git.sagemath.org/sage.git/commit?id=8c059574a67f401635ebc4a5708e8bf56ae2c3e5)|`Fix doctest for cysignals upgrade`|\n|[f11f773](https://git.sagemath.org/sage.git/commit?id=f11f773689833978ba9d964f5d4de9e295012555)|`Run \"check-install\" (to check installed version of cysignals)`|\n|[63415cd](https://git.sagemath.org/sage.git/commit?id=63415cd19668b2a7abe366bb7fc5e11a3a58503e)|`Upgrade cysignals to version 1.6.4`|",
    "created_at": "2017-04-23T13:22:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22691",
    "type": "issue_comment",
