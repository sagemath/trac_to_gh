...
<a id='comment:6'></a>Replying to [mforets](#comment%3A5):
> the new issue is because Fresnel integrals are not implemented in Sage (right?)
...
```json
{
    "body": "<a id='comment:10'></a>do you want me to update (in a new ticket) the doctest from[comment:5](#comment%3A5)? the patchbots, do they test with `optional - internet`?",
...
<a id='comment:10'></a>do you want me to update (in a new ticket) the doctest from[comment:5](#comment%3A5)? the patchbots, do they test with `optional - internet`?
