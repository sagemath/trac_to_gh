...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[33233d1](https://git.sagemath.org/sage.git/commit/?id=33233d1788b3d030169c1e65ba83aa3de09cdec3)|`Better library cleanup for Singular on Cygwin`|",
    "created_at": "2017-03-22T15:12:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22628",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[15e37fe](https://git.sagemath.org/sage.git/commit/?id=15e37fe1a10e35b6b40d2ba2bcd984e0517a6416)|`'libresources' was renamed 'libsingular_resources' in Singular 4.0`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[4f33a48](https://git.sagemath.org/sage.git/commit/?id=4f33a48f6fee31322f89916437cf8009f564df06)|`Don't hard-code the extension on other platforms (e.g. to support OSX)`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nI made two minor corrections. You can set this ticket to positive_review if you agree.\n\n---\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[48f1827](https://git.sagemath.org/sage.git/commit?id=48f1827d02ee6cc65756fe4a614057c751da2687)|`Libraries are not directories, no need for rm -r`|\n|[a5ddc04](https://git.sagemath.org/sage.git/commit?id=a5ddc0406a1ca806cf3d5159e1b135c95b7fb30d)|`SINGULAR_SO should not be None`|",
    "created_at": "2017-03-28T11:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22628",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nWent ahead and did what I had in mind.  This will error out very early on in `sage.env` on all platforms if Singular is not built/installed properly.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[2e45504](https://git.sagemath.org/sage.git/commit?id=2e45504a577c8d72177cb526617b68358b9038c9)|`raise an error very early in sage.env if SINGULAR_SO cannot be located`|",
    "created_at": "2017-05-05T14:46:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22628",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[cb3dadf](https://git.sagemath.org/sage.git/commit/?id=cb3dadf42350807cc7da3d9e6365ce5cfed78c39)|`Still allow SINGULAR_SO to be read from the environment in case it's specified there`|",
