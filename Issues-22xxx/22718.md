...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423530",
...
```json
{
    "body": "<a id='comment:3'></a>I see--so if we convert the scripts with gp2c and compile their functionality into the pari interface (also, how does this fit in with cypari2?) then the rest can be done through the pari interface.\n\nWould I be able to help revive #15809 for now, until/unless a better approach is available?",
    "created_at": "2017-03-31T08:40:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423531",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>I see--so if we convert the scripts with gp2c and compile their functionality into the pari interface (also, how does this fit in with cypari2?) then the rest can be done through the pari interface.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423532",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>That's fine--I can probably find a workaround as it relates to Cygwin in the meantime.",
    "created_at": "2017-03-31T08:45:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423533",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>That's fine--I can probably find a workaround as it relates to Cygwin in the meantime.
...
```json
{
    "body": "<a id='comment:7'></a>Went ahead and tried my idea for templating the script and it seems to work.  Need to massage the code a bit more, but all the tests pass with this hack, and now only one `gp` process is needed for all Dokchitser L-function calculations.",
    "created_at": "2017-03-31T16:39:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423535",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>Went ahead and tried my idea for templating the script and it seems to work.  Need to massage the code a bit more, but all the tests pass with this hack, and now only one `gp` process is needed for all Dokchitser L-function calculations.
...
```json
{
    "body": "<a id='comment:8'></a>See #22746 for a workaround.",
    "created_at": "2017-04-03T09:31:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423536",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>See #22746 for a workaround.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22718#event-59185"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Between #22746 and #22839 this is fixed.",
    "created_at": "2017-05-02T13:00:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423537",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Between #22746 and #22839 this is fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22718#issuecomment-423538",
    "user": "https://github.com/embray"
}
```
