...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[cde0e45](https://git.sagemath.org/sage.git/commit/?id=cde0e458741b69322ad3d6bf4c021fc9c706766c)|`remove SetPartitions.__contains__`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|\n|[74c437b](https://git.sagemath.org/sage.git/commit/?id=74c437b5d1234d88f274d742707b239512744bcf)|`Merge branch 'public/combinat/improve_set_partitions-22361' of git://trac.sagemath.org/sage into public/combinat/improve_set_partitions-22361`|",
