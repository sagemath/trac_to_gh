...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409276",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [config.log](tarball://root/attachments/some-uuid/ticket22112/config.log) by @NathanDunfield created at 2016-12-30 21:11:46\n\nReplying to [fbissey](#comment%3A1):\n> Was it a build from scratch or an incremental upgrade from an older sage? \n\n\nIt was build from scratch in a brand new clone of the development branch from the git repo. I have uploaded the file you requested, as well as the global `config.log` in case that is helpful.  The CPU on this machine is a Xeon E5-1680 v2.",
    "created_at": "2016-12-30T21:11:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409277",
    "user": "https://github.com/NathanDunfield"
}
```

<a id='comment:2'></a>Attachment [config.log](tarball://root/attachments/some-uuid/ticket22112/config.log) by @NathanDunfield created at 2016-12-30 21:11:46
...
```json
{
    "body": "<a id='comment:3'></a>Ouch, you have brew on your system. It seems that you have things set up to use clang from the system and gfortran from brew, but usually the presence of brew in its default location brings trouble.\nI now that brew recommends installing itself in `/usr/local` so it just works out of the box. But the reality of it, is that installing it there means that it will interfere with competing systems or stuff that doesn't expect it.",
    "created_at": "2016-12-30T21:18:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409278",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>Ouch, you have brew on your system. It seems that you have things set up to use clang from the system and gfortran from brew, but usually the presence of brew in its default location brings trouble.
I now that brew recommends installing itself in `/usr/local` so it just works out of the box. But the reality of it, is that installing it there means that it will interfere with competing systems or stuff that doesn't expect it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409279",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Put your name in the reviewer field and give it a positive review now.",
    "created_at": "2016-12-30T23:45:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409280",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>Put your name in the reviewer field and give it a positive review now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409281",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22112#event-58173"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409282",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409283",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22112#event-58174"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22112#issuecomment-409284",
