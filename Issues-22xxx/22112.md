...
```json
{
    "body": "The package openblas-0.2.19.p0 in [SageMath](../wikis/SageMath) 7.5rc1 fails to compile on a Mac Pro running macOS Sierra with Xcode 8.2.1.  See attached log for details.\n\n**CC:**  @vbraun @kiwifb jpflori\n\n**Keywords:** OpenBLAS\n\n**Reviewer:** Nathan Dunfield\n\nIssue created by migration from https://trac.sagemath.org/ticket/22112\n\n",
...
```
The package openblas-0.2.19.p0 in [SageMath](../wikis/SageMath) 7.5rc1 fails to compile on a Mac Pro running macOS Sierra with Xcode 8.2.1.  See attached log for details.
