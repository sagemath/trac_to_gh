...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[90cda5e](https://git.sagemath.org/sage.git/commit/?id=90cda5ec752c76051b77536dc53560fd0645700e)|`Iterate over the weight's orbit as we may not need the full list.`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[aaaa56d](https://git.sagemath.org/sage.git/commit/?id=aaaa56d4537647b237abf19c038fc3a270184e48)|`I need to actually call the function...`|\n|[d800645](https://git.sagemath.org/sage.git/commit/?id=d800645cd9e7b1cc927205f0ca3f30f6ee445e3d)|`Use the iterator in the other internal place orbit() is used.`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                           |              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------|\n|[8ae3722](https://git.sagemath.org/sage.git/commit/?id=8ae3722130bd42d45c2919f45531a591244af2e7)|`Fixing typo.`|",
