...
```json
{
    "body": "<a id='comment:2'></a>However, that doesn't absolve the problem. I would say it is evidence that it is more systematic. I think I will start digging into this on the code side.\n\nI guess another question is should `1*ZZ == ZZ` and/or be `ZZ`?",
    "created_at": "2017-04-01T03:27:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22722#issuecomment-312967",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>However, that doesn't absolve the problem. I would say it is evidence that it is more systematic. I think I will start digging into this on the code side.
