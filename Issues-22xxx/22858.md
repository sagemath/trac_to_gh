...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22858#event-301008"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22858#event-301009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22858#event-301010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22858#event-301011"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22858#issuecomment-343629",
    "user": "https://github.com/sagetrac-mirgee"
}
```
