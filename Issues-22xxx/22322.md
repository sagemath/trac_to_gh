...
```json
{
    "body": "<a id='comment:1'></a>AFAIK, also useful for equations where the unkown appears as an exponent, cf. [solve(4.94 * 1.062^x == 15, x)](https://ask.sagemath.org/question/37640/solving-returns-x/)",
    "created_at": "2017-05-20T09:51:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413852",
    "user": "https://github.com/mforets"
}
```

<a id='comment:1'></a>AFAIK, also useful for equations where the unkown appears as an exponent, cf. [solve(4.94 * 1.062^x == 15, x)](https://ask.sagemath.org/question/37640/solving-returns-x/)
...
```json
{
    "body": "<a id='comment:3'></a>`solve` (from `expression.pyx`) passes a relational expression to Maxima's solve, but this doesn't seem to be available in sympy:\n\n```\nsage: (x==1)._maxima_()\n_SAGE_VAR_x=1\nsage: (x==1)._sympy_()\nTraceback (most recent call last)\n...\nNotImplementedError: relation\n```\n\ndo you have some idea on how to tackle this? otherwise, what about passing `ex.lhs()-ex.rhs()` to sympy's solve.",
    "created_at": "2017-06-04T13:05:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413853",
    "user": "https://github.com/mforets"
}
```

<a id='comment:3'></a>`solve` (from `expression.pyx`) passes a relational expression to Maxima's solve, but this doesn't seem to be available in sympy:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413854",
...
```json
{
    "body": "<a id='comment:5'></a>Correction, doing `ex.lhs()-ex.rhs()` is not needed if the `SympyConverter` is fixed.",
    "created_at": "2017-06-05T05:38:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413855",
    "user": "https://github.com/rwst"
}
```

<a id='comment:5'></a>Correction, doing `ex.lhs()-ex.rhs()` is not needed if the `SympyConverter` is fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413856",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413858",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>As I explained in #23990 that is the SymPy convention.",
    "created_at": "2017-10-10T13:28:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413859",
    "user": "https://github.com/rwst"
}
```

<a id='comment:9'></a>As I explained in #23990 that is the SymPy convention.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413860",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413861",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22322#event-58515"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Now that (with #23990) relations are translated from/to SymPy there are still things needed. For example we need to translate any assumptions on variables (and maybe anon. functions?) that were made using `assume` and `var('x', domain=...)`. This is not only relevant for this ticket, any SymPy operation may access the SymPy knowledge base any time. So I think this should be handled the same way as with Maxima, i.e. at the time the `assume`/`var` calls are made. This is #24078.",
    "created_at": "2017-10-20T13:06:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413862",
    "user": "https://github.com/rwst"
}
```

<a id='comment:11'></a>Now that (with #23990) relations are translated from/to SymPy there are still things needed. For example we need to translate any assumptions on variables (and maybe anon. functions?) that were made using `assume` and `var('x', domain=...)`. This is not only relevant for this ticket, any SymPy operation may access the SymPy knowledge base any time. So I think this should be handled the same way as with Maxima, i.e. at the time the `assume`/`var` calls are made. This is #24078.
...
```json
{
    "body": "<a id='comment:12'></a>Note that SymPy's solve does not respect the global assumptions database:\n\n```\nIn [12]: global_assumptions\nOut[12]: AssumptionsContext([Q.is_true(x > 2), Q.positive(x)])\n\nIn [13]: solve(x<3)\nOut[13]: -\u221e < x \u2227 x < 3\n\nIn [15]: solve((x>2,x<3))\nOut[15]: 2 < x \u2227 x < 3\n```\nSo the dependency is irrelevant (at the moment).",
    "created_at": "2017-10-20T13:33:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413863",
    "user": "https://github.com/rwst"
}
```

<a id='comment:12'></a>Note that SymPy's solve does not respect the global assumptions database:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413864",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Our solve doesn't either, so it all is localized in the solve arguments:\n\n```\nsage: assume(x>2)\nsage: solve(x<3,x)\n[[x < 3]]\nsage: solve((x>2,x<3),x)\n[[2 < x, x < 3]]\n```",
    "created_at": "2017-10-20T13:51:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413865",
    "user": "https://github.com/rwst"
}
```

<a id='comment:13'></a>Our solve doesn't either, so it all is localized in the solve arguments:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413867",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413868",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413869",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I cannot believe devs maintained two different versions of `solve` in `symbolic/expression.pyx` and `symbolic/relation.py`. `expression.pyx` should only be an interface to a function elsewhere, preferably in `solve.py`.",
    "created_at": "2017-10-25T07:48:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413870",
    "user": "https://github.com/rwst"
}
```

<a id='comment:17'></a>I cannot believe devs maintained two different versions of `solve` in `symbolic/expression.pyx` and `symbolic/relation.py`. `expression.pyx` should only be an interface to a function elsewhere, preferably in `solve.py`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413874",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413875",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413876",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Caveat of using `RealSet`:\n\n```\nsage: pi.n(30) in RealSet.point(pi)\nFalse\nsage: pi.n(50) in RealSet.point(pi)\nTrue\n```",
    "created_at": "2017-10-26T13:56:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413878",
    "user": "https://github.com/rwst"
}
```

<a id='comment:25'></a>Caveat of using `RealSet`:
...
```json
{
    "body": "<a id='comment:26'></a>Replying to [comment:18 mforets]:\n> i find that the interface `(equation, variable, domain)` is very clear. isn't it preferable than relying on global assumptions? (or to fallback into the global assumptions if the domain is not provided.)\n\n\nIt is. Propagating the `solveset` interface to our solve would mean at least supporting the option `domain='real'` with complex the default.",
    "created_at": "2017-10-26T14:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413879",
    "user": "https://github.com/rwst"
}
```

<a id='comment:26'></a>Replying to [comment:18 mforets]:
> i find that the interface `(equation, variable, domain)` is very clear. isn't it preferable than relying on global assumptions? (or to fallback into the global assumptions if the domain is not provided.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413880",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>SymPy seems to make a clear distinction between the operators in `x>0` and `Gt(x,0)`. I think it's wrong that `(x>0)._sympy_()` returns `x>0`.",
    "created_at": "2017-10-27T13:52:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413881",
    "user": "https://github.com/rwst"
}
```

<a id='comment:28'></a>SymPy seems to make a clear distinction between the operators in `x>0` and `Gt(x,0)`. I think it's wrong that `(x>0)._sympy_()` returns `x>0`.
...
```json
{
    "body": "<a id='comment:29'></a>Ah no, I'm wrong. We do the right translation.",
    "created_at": "2017-10-27T13:55:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413882",
    "user": "https://github.com/rwst"
}
```

<a id='comment:29'></a>Ah no, I'm wrong. We do the right translation.
...
```json
{
    "body": "Changing branch from \"\" to \"u/rws/22322\"",
    "created_at": "2017-10-27T14:45:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413883",
    "user": "https://github.com/rwst"
}
```

Changing branch from "" to "u/rws/22322"
...
```json
{
    "body": "<a id='comment:31'></a>This branch works quite well and can be used and reviewed. It lacks doctests and documentation, which I'll add next. But please experiment with it. We use `solveset` with single-expression univariate tasks, `solve` for the rest. The output is unified to Sage's list \"format\".\n\n---\nLast 10 new commits:",
    "created_at": "2017-10-27T14:50:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413884",
    "user": "https://github.com/rwst"
}
```

<a id='comment:31'></a>This branch works quite well and can be used and reviewed. It lacks doctests and documentation, which I'll add next. But please experiment with it. We use `solveset` with single-expression univariate tasks, `solve` for the rest. The output is unified to Sage's list "format".
...
```json
{
    "body": "Changing commit from \"\" to \"3073840e81e526524eea0ce89cb28bc83723c7d5\"",
    "created_at": "2017-10-27T14:50:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413885",
    "user": "https://github.com/rwst"
}
```

Changing commit from "" to "3073840e81e526524eea0ce89cb28bc83723c7d5"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413886",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>And `domain='real'` is recognized too.",
    "created_at": "2017-10-27T14:52:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413887",
    "user": "https://github.com/rwst"
}
```

<a id='comment:32'></a>And `domain='real'` is recognized too.
...
```json
{
    "body": "<a id='comment:33'></a>Ah, multivariate doesn't work at the moment.",
    "created_at": "2017-10-27T15:36:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413888",
    "user": "https://github.com/rwst"
}
```

<a id='comment:33'></a>Ah, multivariate doesn't work at the moment.
...
```json
{
    "body": "Changing commit from \"3073840e81e526524eea0ce89cb28bc83723c7d5\" to \"eac5f8bf8a12da0373bed819bcd060673a2f7aa4\"",
    "created_at": "2017-10-28T06:07:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413889",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "3073840e81e526524eea0ce89cb28bc83723c7d5" to "eac5f8bf8a12da0373bed819bcd060673a2f7aa4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413890",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413893",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413895",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Just a thought : I see that the patchbots fail to build the package, for lack of source tarball. It could be useful to add a pointer to it in the ticket description (ISTR that thos worked for #24026...).",
    "created_at": "2017-10-30T21:24:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413896",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:39'></a>Just a thought : I see that the patchbots fail to build the package, for lack of source tarball. It could be useful to add a pointer to it in the ticket description (ISTR that thos worked for #24026...).
...
```json
{
    "body": "<a id='comment:40'></a>Thanks. I have to do more Work, at least the merge of #24104 changes and necessary documentation. The tarball will be no longer necessary with the next release because the SymPy upgrade is in there.",
    "created_at": "2017-10-31T04:21:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413897",
    "user": "https://github.com/rwst"
}
```

<a id='comment:40'></a>Thanks. I have to do more Work, at least the merge of #24104 changes and necessary documentation. The tarball will be no longer necessary with the next release because the SymPy upgrade is in there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413898",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>We'll need to work on #22024 next because `solve(x^5 + 3*x^3 + 7, x, algorithm='sympy')` will fail. But not for this ticket.",
    "created_at": "2017-10-31T16:00:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413899",
    "user": "https://github.com/rwst"
}
```

<a id='comment:41'></a>We'll need to work on #22024 next because `solve(x^5 + 3*x^3 + 7, x, algorithm='sympy')` will fail. But not for this ticket.
...
```json
{
    "body": "Changing branch from \"u/rws/22322\" to \"u/rws/22322-1\"",
    "created_at": "2017-10-31T17:27:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413900",
    "user": "https://github.com/rwst"
}
```

Changing branch from "u/rws/22322" to "u/rws/22322-1"
...
```json
{
    "body": "Changing commit from \"eac5f8bf8a12da0373bed819bcd060673a2f7aa4\" to \"963cc0e6cb2ea5441422f73beb961b882dfec420\"",
    "created_at": "2017-10-31T17:31:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413901",
    "user": "https://github.com/rwst"
}
```

Changing commit from "eac5f8bf8a12da0373bed819bcd060673a2f7aa4" to "963cc0e6cb2ea5441422f73beb961b882dfec420"
...
```json
{
    "body": "<a id='comment:43'></a>This is a new branch because of differences in the dependencies. I also added the missing translation of `LambertW`. Another problem is that SymPy's `solveset` is not always better than its `solve` esp. with nonlinear equations, compare e.g. `x+2**x==0`. This needs more work later.\n\nPlease review, these should be the last big changes.\n\n---\nNew commits:",
    "created_at": "2017-10-31T17:31:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413902",
    "user": "https://github.com/rwst"
}
```

<a id='comment:43'></a>This is a new branch because of differences in the dependencies. I also added the missing translation of `LambertW`. Another problem is that SymPy's `solveset` is not always better than its `solve` esp. with nonlinear equations, compare e.g. `x+2**x==0`. This needs more work later.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413903",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413904",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>On top of 8.1.beta9 + #23980+2#4026+#24119, passes ptestlong with no errors whatsoever.",
    "created_at": "2017-11-01T05:37:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413905",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:44'></a>On top of 8.1.beta9 + #23980+2#4026+#24119, passes ptestlong with no errors whatsoever.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413906",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413907",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413908",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>`@`charpent I hope you don't mind me adding your name.",
    "created_at": "2017-11-02T14:54:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413909",
    "user": "https://github.com/rwst"
}
```

<a id='comment:47'></a>`@`charpent I hope you don't mind me adding your name.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413910",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413912",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"963cc0e6cb2ea5441422f73beb961b882dfec420\" to \"8e1e240bb9b8d735251847e67deec1fdb32eccba\"",
    "created_at": "2017-12-10T14:05:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413913",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "963cc0e6cb2ea5441422f73beb961b882dfec420" to "8e1e240bb9b8d735251847e67deec1fdb32eccba"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413914",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413915",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413916",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"u/rws/22322-1\" to \"8e1e240bb9b8d735251847e67deec1fdb32eccba\"",
    "created_at": "2017-12-13T17:38:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22322#issuecomment-413917",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/rws/22322-1" to "8e1e240bb9b8d735251847e67deec1fdb32eccba"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22322",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22322#event-58516"
}
```
