...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22330#event-294419"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22330#event-294420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22330#event-294421"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22330#event-294422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22330#issuecomment-332716",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    "body": "Changed keywords from **** to **speed, performance, matrix**",
    "created_at": "2019-06-01T07:49:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/22330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22330#issuecomment-332717",
    "user": "https://github.com/fchapoton"
}
```

Changed keywords from **** to **speed, performance, matrix**
...
```json
{
    ...
    "milestone_title": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22330#event-294423"
}
```
