...
```json
{
    "body": "<a id='comment:1'></a>Won't this conflict with #22755?",
    "created_at": "2017-04-10T15:38:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425187",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Won't this conflict with #22755?
...
```json
{
    "body": "<a id='comment:2'></a>Probably; I didn't see that ticket.",
    "created_at": "2017-04-10T16:57:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425188",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>Probably; I didn't see that ticket.
...
```json
{
    "body": "<a id='comment:3'></a>Probably; I didn't see that ticket.",
    "created_at": "2017-04-10T16:59:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425189",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>Probably; I didn't see that ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425190",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I mean, I would say this mostly supersedes #22755, though there are some changes from that ticket that would still be applicable, and I could integrate.",
    "created_at": "2017-04-10T17:06:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425191",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>I mean, I would say this mostly supersedes #22755, though there are some changes from that ticket that would still be applicable, and I could integrate.
...
```json
{
    "body": "<a id='comment:6'></a>I do, but they're not 100% dependent on this; it was just an idea.  What do you mean, in this case, by \"works with Cython\"?",
    "created_at": "2017-04-10T17:21:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425193",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>I do, but they're not 100% dependent on this; it was just an idea.  What do you mean, in this case, by "works with Cython"?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425194",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425195",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Possible cause for the slowdown: the overhead of the factory function, which is a full-blown python function call, rather than the cdef `_get_object` we had originally. It looks like the the right amount of overhead (python function calls are expensive, and we're getting two of them in the benchmark).\n\nOf course, the whole idea of LazyImport is that the proxy shim removes itself, which is carefully avoided in the test above. So we are benchmarking something that should be avoided ...",
    "created_at": "2017-04-10T20:28:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425196",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:9'></a>Possible cause for the slowdown: the overhead of the factory function, which is a full-blown python function call, rather than the cdef `_get_object` we had originally. It looks like the the right amount of overhead (python function calls are expensive, and we're getting two of them in the benchmark).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425197",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425200",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425201",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Unfortunately, for inexact matches `PyObject_IsInstance` is a lot more complicated than that due to the need to support `__instancecheck__`.  That would *definitely* account for the amount of slowdown.",
    "created_at": "2017-04-11T10:30:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22793#issuecomment-425202",
    "user": "https://github.com/embray"
}
```

<a id='comment:15'></a>Unfortunately, for inexact matches `PyObject_IsInstance` is a lot more complicated than that due to the need to support `__instancecheck__`.  That would *definitely* account for the amount of slowdown.
