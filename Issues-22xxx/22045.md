...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407668",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407669",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407670",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"39822e8772127bdd0b939d0bc5a01332977ae7f6\"",
    "created_at": "2016-12-13T09:30:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407674",
    "user": "https://github.com/dcoudert"
}
```

Changing commit from "" to "39822e8772127bdd0b939d0bc5a01332977ae7f6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407675",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/dcoudert/pathwidth\"",
    "created_at": "2016-12-13T09:30:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407676",
    "user": "https://github.com/dcoudert"
}
```

Changing branch from "" to "u/dcoudert/pathwidth"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407677",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I have pushed a proposal for discussed issues: expose method pathwidth with similar behavior than treewidth. Let me know if something is missing.\n\n---\nNew commits:",
    "created_at": "2016-12-13T09:30:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407678",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>I have pushed a proposal for discussed issues: expose method pathwidth with similar behavior than treewidth. Let me know if something is missing.
...
```json
{
    "body": "<a id='comment:10'></a>Any help reviewing this patch is more than welcome.",
    "created_at": "2017-01-09T15:01:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407681",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:10'></a>Any help reviewing this patch is more than welcome.
...
```json
{
    "body": "<a id='comment:12'></a>Have you tried to run the doc tests using a command like `sage -btp src/sage/graphs/graph_decompositions/vertex_separation.pyx` ? same with `graph.py` since this patch exposes the method for `Graph`. You can also try to build the doc using e.g. `sage -docbuild reference/graphs html` and check if it looks good.\nIf everything is ok, then you can set the patch to positive review, or let me know if I should improve something.\n\nIt will now be easier to verify if a graph is asteroidal triple free graphs then we have  treewidth = pathwidth ;)\n\nBy the way, I could change ref CMN14 with the journal version, but it's not so important.",
    "created_at": "2017-01-09T19:38:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407683",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:12'></a>Have you tried to run the doc tests using a command like `sage -btp src/sage/graphs/graph_decompositions/vertex_separation.pyx` ? same with `graph.py` since this patch exposes the method for `Graph`. You can also try to build the doc using e.g. `sage -docbuild reference/graphs html` and check if it looks good.
If everything is ok, then you can set the patch to positive review, or let me know if I should improve something.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407684",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Ran the tests you suggested and checked the documentation. All the tests passed and the docs look fine. Everything seems okay from here.",
    "created_at": "2017-01-09T19:57:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407685",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```

<a id='comment:13'></a>Ran the tests you suggested and checked the documentation. All the tests passed and the docs look fine. Everything seems okay from here.
...
```json
{
    "body": "<a id='comment:14'></a>You will need to put your real name as the reviewer.",
    "created_at": "2017-01-10T08:00:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407686",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:14'></a>You will need to put your real name as the reviewer.
...
```json
{
    "body": "<a id='comment:15'></a>I put my real name in the 'Reviewers' field.",
    "created_at": "2017-01-10T08:38:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407687",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```

<a id='comment:15'></a>I put my real name in the 'Reviewers' field.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Rolf Morel\"",
    "created_at": "2017-01-10T08:38:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407688",
    "user": "https://trac.sagemath.org/admin/accounts/users/RMorel"
}
```

Changing reviewer from "" to "Rolf Morel"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407689",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407690",
...
```json
{
    "body": "Changing branch from \"u/dcoudert/pathwidth\" to \"39822e8772127bdd0b939d0bc5a01332977ae7f6\"",
    "created_at": "2017-01-23T22:52:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22045#issuecomment-407691",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/dcoudert/pathwidth" to "39822e8772127bdd0b939d0bc5a01332977ae7f6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22045#event-58017"
}
```
