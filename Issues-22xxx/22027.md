...
```json
{
    "body": "<a id='comment:1'></a>That is a Maxima bug.",
    "created_at": "2017-01-14T08:08:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22027#issuecomment-407168",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>That is a Maxima bug.
...
```json
{
    "body": "<a id='comment:2'></a>Are we ok with sage returning 1 for 0^0? This is the case in Python, but in Maxima is it undefined.\n\nIs maxima under active development? Should we report that issue there?\n\nNote that sympy handles this properly:\n\n```\nIn [6]: sympy.simplify(0**x)\nOut[6]: 0**x\n```",
    "created_at": "2018-06-29T14:32:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22027#issuecomment-407169",
    "user": "https://github.com/pelegm"
}
```

<a id='comment:2'></a>Are we ok with sage returning 1 for 0^0? This is the case in Python, but in Maxima is it undefined.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22027#issuecomment-407172",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22027#issuecomment-407173",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The \"maxima-discuss\" mailing list had a thread last month\nabout zero to the zero:\n\n- https://sourceforge.net/p/maxima/mailman/message/37606840/\n\n(from there click \"View entire thread\").",
    "created_at": "2022-03-06T00:38:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22027#issuecomment-407174",
    "user": "https://github.com/slel"
}
```

<a id='comment:5'></a>The "maxima-discuss" mailing list had a thread last month
about zero to the zero:
