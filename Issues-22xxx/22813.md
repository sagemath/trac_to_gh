...
```json
{
    "body": "<a id='comment:1'></a>> Replying to nbruin : var(*args) already means the same thing as for a in args: var(a), so the signature is not available for different interpretation.\n\n\nif we parse the arg by the length we get the desired behavior:\n\n```\n    if len(args)==1:\n        name = args[0]\n    elif len(args)==2:\n        name = args[0]\n        num_vars = args[1]\n        if num_vars > 1:\n            name = [name + str(i) for i in range(num_vars)]\n    else:\n        name = args\n```\n\ndoes it have some other undesired effects? \n\nwith the current set of tests in `var.pyx`, it seems to pass.",
    "created_at": "2017-04-14T22:21:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425927",
    "user": "https://github.com/mforets"
}
```

<a id='comment:1'></a>> Replying to nbruin : var(*args) already means the same thing as for a in args: var(a), so the signature is not available for different interpretation.
...
```json
{
    "body": "<a id='comment:2'></a>Problem: `var(\"x\",\"y\")`, as long as `\"y\">1`(which is true at the moment). Problem in python: duck typing. The second argument could be \"stringy\" or \"integery\" or both. In the \"both\" case, there's no way to choose.",
    "created_at": "2017-04-14T22:33:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425928",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:2'></a>Problem: `var("x","y")`, as long as `"y">1`(which is true at the moment). Problem in python: duck typing. The second argument could be "stringy" or "integery" or both. In the "both" case, there's no way to choose.
...
```json
{
    "body": "<a id='comment:3'></a>IIRC `'y' > 1` will fail in Python3. However, you could do `isinstance(args[1], str)` to get around the ducktyping. It's not like any of this code needs to be super fast/lightweight.",
    "created_at": "2017-04-14T23:51:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425929",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>IIRC `'y' > 1` will fail in Python3. However, you could do `isinstance(args[1], str)` to get around the ducktyping. It's not like any of this code needs to be super fast/lightweight.
...
```json
{
    "body": "Changing branch from \"\" to \"u/mforets/pass_number_of_variables_to_var\"",
    "created_at": "2017-04-15T07:35:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425930",
    "user": "https://github.com/mforets"
}
```

Changing branch from "" to "u/mforets/pass_number_of_variables_to_var"
...
```json
{
    "body": "Changing commit from \"\" to \"34441b77670a1f81e57c030a2fa246b95ecbb8ae\"",
    "created_at": "2017-04-15T07:41:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425932",
    "user": "https://github.com/mforets"
}
```

Changing commit from "" to "34441b77670a1f81e57c030a2fa246b95ecbb8ae"
...
```json
{
    "body": "<a id='comment:7'></a>I would expect `var('y1', 2)` to give me `y10, y11`, so having that be the initial value would be very surprising. So -1 on parsing out the number of the variable to be the start index.",
    "created_at": "2017-04-15T15:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425934",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>I would expect `var('y1', 2)` to give me `y10, y11`, so having that be the initial value would be very surprising. So -1 on parsing out the number of the variable to be the start index.
...
```json
{
    "body": "<a id='comment:8'></a>fair enough about naming conventions or handy constructions. as far as i'm concerned, this ticket is ready for peer-review!",
    "created_at": "2017-04-15T19:16:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425935",
    "user": "https://github.com/mforets"
}
```

<a id='comment:8'></a>fair enough about naming conventions or handy constructions. as far as i'm concerned, this ticket is ready for peer-review!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425936",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425937",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425938",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Perhaps what we want is the output of `var('x', 3)` to inject the tuple `x` of variables `(x0, x1, x2)`. This would be in line with polynomial rings and what we do with other calls to `var`.",
    "created_at": "2017-04-17T14:55:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425939",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:11'></a>Perhaps what we want is the output of `var('x', 3)` to inject the tuple `x` of variables `(x0, x1, x2)`. This would be in line with polynomial rings and what we do with other calls to `var`.
...
```json
{
    "body": "Changing commit from \"34441b77670a1f81e57c030a2fa246b95ecbb8ae\" to \"3d52b597053ce271b8956b84112391694c511d33\"",
    "created_at": "2017-04-21T09:59:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425940",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "34441b77670a1f81e57c030a2fa246b95ecbb8ae" to "3d52b597053ce271b8956b84112391694c511d33"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425941",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425942",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Instead of checking for a string and assuming it's a number otherwise, I'd rather do it the other way around: check for a number with `operator.index()`. If that fails, assume it's a string.\n\nI also dislike the `if num_vars > 1`: why special-case `num_vars == 0` and `num_vars == 1`? There should also be a check for negative numbers like `var(x, -23)`.",
    "created_at": "2017-04-21T12:05:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425943",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>Instead of checking for a string and assuming it's a number otherwise, I'd rather do it the other way around: check for a number with `operator.index()`. If that fails, assume it's a string.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425944",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425945",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425946",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"3d52b597053ce271b8956b84112391694c511d33\" to \"521230176b40e38fd1f638da4e4a206edcd03d75\"",
    "created_at": "2017-04-21T19:19:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425947",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "3d52b597053ce271b8956b84112391694c511d33" to "521230176b40e38fd1f638da4e4a206edcd03d75"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425948",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425951",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425952",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Is this is **invalid/wontfix**? Who does that? Thanks.",
    "created_at": "2017-05-25T11:22:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425953",
    "user": "https://github.com/mforets"
}
```

<a id='comment:23'></a>Is this is **invalid/wontfix**? Who does that? Thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425954",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425956",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425957",
...
```json
{
    "body": "<a id='comment:26'></a>This is fixed by #22909 (albeit requesting using the `n=` keyword...).\n\n==> marking as duplicate and requesting review in order to solve...",
    "created_at": "2021-03-13T14:08:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425958",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:26'></a>This is fixed by #22909 (albeit requesting using the `n=` keyword...).
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22813#event-59312"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>As you can see from the discussion, at least Travis thought this wasn't 100% resolved, since this ticket is now about injection into the global namespace of the `SR.var` from #22909.\n\nOf course, we could also close this as undesirable or something not to work on now but rather if it comes up again.  Marcelo and Nils seemed to agree with me that maybe that wasn't bad.  See if Travis responds (he's usually pretty aware of relevant ticket changes he's cc:ed on) otherwise I this we can indeed close this, though as wontfix rather than a dup.",
    "created_at": "2021-03-13T22:14:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425959",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:27'></a>As you can see from the discussion, at least Travis thought this wasn't 100% resolved, since this ticket is now about injection into the global namespace of the `SR.var` from #22909.
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22813#event-59313"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22813#event-59314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425960",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>Okay.  Then let's close this one, and Travis can you open a new ticket that describes exactly what you are thinking of?  I don't have a horse in this race other than making sure everything is meta-documented on Trac :-)",
    "created_at": "2021-03-15T17:37:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425963",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:31'></a>Okay.  Then let's close this one, and Travis can you open a new ticket that describes exactly what you are thinking of?  I don't have a horse in this race other than making sure everything is meta-documented on Trac :-)
...
```json
{
    "body": "<a id='comment:32'></a>We can just refer to this ticket for now until we have a more concrete proposal. I am also stretched a little too thin right now to put much effort into this.",
    "created_at": "2021-03-22T04:59:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425964",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:32'></a>We can just refer to this ticket for now until we have a more concrete proposal. I am also stretched a little too thin right now to put much effort into this.
...
```json
{
    "body": "Changing commit from \"521230176b40e38fd1f638da4e4a206edcd03d75\" to \"\"",
    "created_at": "2021-03-22T04:59:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425965",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "521230176b40e38fd1f638da4e4a206edcd03d75" to ""
...
```json
{
    "body": "Changing branch from \"u/mforets/pass_number_of_variables_to_var\" to \"\"",
    "created_at": "2021-03-22T04:59:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425966",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "u/mforets/pass_number_of_variables_to_var" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425967",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425968",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22813#event-59315"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22813#event-59316"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22813#issuecomment-425969",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22813",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22813#event-59317"
}
```
