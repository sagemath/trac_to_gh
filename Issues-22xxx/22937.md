...
<a id='comment:21'></a>Replying to [tscrim](#comment%3A18):
...
<a id='comment:27'></a>RReplying to [tscrim](#comment%3A22):
> I shouldn't be because I just did some simple review changes
...
<a id='comment:28'></a>Replying to [charpent](#comment%3A27):
> RReplying to [tscrim](#comment%3A22):
> > I shouldn't be because I just did some simple review changes
