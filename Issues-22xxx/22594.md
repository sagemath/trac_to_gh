...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22594#issuecomment-330940",
...
```json
{
    "body": "<a id='comment:2'></a>This is a very simplified example. My use case is right in the middle of somthing more complicated. This breaks my program because it triggers the coercion failure in #22591.",
    "created_at": "2017-03-14T09:17:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22594",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22594#issuecomment-330941",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:2'></a>This is a very simplified example. My use case is right in the middle of somthing more complicated. This breaks my program because it triggers the coercion failure in #22591.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22594",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22594#issuecomment-330942",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22594",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22594#issuecomment-330943",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22594",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22594#issuecomment-330944",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22594",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22594#issuecomment-330945",
    "user": "https://github.com/tscrim"
}
```
