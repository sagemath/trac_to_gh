...
```json
{
    "body": "The `RuntimeError: Aborted` is from Cysignals.  Something is causing a `SIGABRT` somewhere, though I'm not sure why.",
...
```json
{
    "body": "Confirmed that building libgc with `./configure --enable-threads=none` works around this particular issue.\n\nBut I'd still like to get to the bottom of this; ISTM like it might be a simple bug at the end of the day.",
