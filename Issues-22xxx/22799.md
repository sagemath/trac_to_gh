...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319690"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319693"
}
```
...
```json
{
    "body": "<div id=\"comment:72\" align=\"right\">comment:72</div>\n\nWith the patch from [comment:69](#comment:69):\n\n```\nsage: import numpy as np\nsage: np.float128(5).__gt__(e)\nx[53]=1 rnd=3\ny[53]=2.71828 inexact=-1\nx[53]=1 rnd=2\ny[53]=2.71828 inexact=1\n/Users/jpalmier/Desktop/Sage_stuff/sage_builds/TESTING/sage-8.0.beta5/src/bin/sage-ipython:1: RuntimeWarning: invalid value encountered in greater\n  #!/usr/bin/env python\nTrue\n```",
...
```json
{
    "body": "<div id=\"comment:73\" align=\"right\">comment:73</div>\n\nAny suggestions for other changes along the lines of [comment:69](#comment:69) to help track down the problem?",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319696"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319697"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22799",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22799#event-319698"
}
```
