...
```json
{
    "body": "<a id='comment:1'></a>I think the crash happens in line `281\tin /home/ralf/sage/local/var/tmp/sage/build/ecl-16.1.2.p2/src/src/c/interpreter.d`.",
    "created_at": "2017-04-06T06:29:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424656",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>I think the crash happens in line `281	in /home/ralf/sage/local/var/tmp/sage/build/ecl-16.1.2.p2/src/src/c/interpreter.d`.
...
```json
{
    "body": "<a id='comment:2'></a>It is because since IPython 5.*, tab completion happens in a different thread.\nAnd here you initialise Maxima in the main thread, but run Maxima (via triggering tab completion) in a separate thread.\n\nSee also #23700 and #23956 for a different way to trigger the same bug.",
    "created_at": "2017-10-02T16:38:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424657",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:2'></a>It is because since IPython 5.*, tab completion happens in a different thread.
And here you initialise Maxima in the main thread, but run Maxima (via triggering tab completion) in a separate thread.
...
```json
{
    "body": "<a id='comment:3'></a>On OS X (10.12.6, Xcode 8.3.3, Sage 8.1.beta6), I don't get this crash, and I also don't see the message \"Building Maxima command completion list ...\": I just immediately get a list of completions.",
    "created_at": "2017-10-02T17:36:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424658",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>On OS X (10.12.6, Xcode 8.3.3, Sage 8.1.beta6), I don't get this crash, and I also don't see the message "Building Maxima command completion list ...": I just immediately get a list of completions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424659",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Okay, I get the crash after deleting `.sage/maxima_commandlist_cache.sobj`. Do you know why starting Sage and then doing `maxima.<TAB>` doesn't trigger the crash, but instead rebuilds this file?",
    "created_at": "2017-10-02T17:50:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424660",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Okay, I get the crash after deleting `.sage/maxima_commandlist_cache.sobj`. Do you know why starting Sage and then doing `maxima.<TAB>` doesn't trigger the crash, but instead rebuilds this file?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424661",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Making maxima_lib \"thread-safe\" would consist of *locking* it to one thread. Due to the signal management switching that happens upon entering/exiting ecllib makes it fundamentally incompatible with multi-threading, because signal handlers are process-specific; not thread-specific.\n\nSage installs special signal handlers (for SIGINT, for instance), and so does ECL. If ECL runs with multi-threading, ECL even goes further with signal handling (it makes a dedicated signal handling thread), and it uses signals to synchronize threads for critical GC operations.\n\nIf you want to get ecllib to a state where it can safely be used in a multi-threaded environment, I think one would have to unify the signal management of sage and ecl.\n\nThe result would not actually make maxima_lib threadsafe, because maxima itself is rather fundamentally not thread-safe.",
    "created_at": "2017-10-03T05:26:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424662",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:7'></a>Making maxima_lib "thread-safe" would consist of *locking* it to one thread. Due to the signal management switching that happens upon entering/exiting ecllib makes it fundamentally incompatible with multi-threading, because signal handlers are process-specific; not thread-specific.
...
```json
{
    "body": "<a id='comment:8'></a>Removing dependencies seems so much more promising, see https://trac.sagemath.org/wiki/symbolics/maxima",
    "created_at": "2017-10-03T06:06:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424663",
    "user": "https://github.com/rwst"
}
```

<a id='comment:8'></a>Removing dependencies seems so much more promising, see https://trac.sagemath.org/wiki/symbolics/maxima
...
```json
{
    "body": "<a id='comment:10'></a>I think what we see here is ECL being initialised in a thread (number 32) that later is shut down, and then `maxima_lib` import breaks, as ECL isn't available to run.\n\nIt seems that indeed we must make sure that ECL is always started in the main thread, which does not disappear.",
    "created_at": "2017-10-04T14:32:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424665",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:10'></a>I think what we see here is ECL being initialised in a thread (number 32) that later is shut down, and then `maxima_lib` import breaks, as ECL isn't available to run.
...
```json
{
    "body": "<a id='comment:11'></a>A part of the relevant discussion is on #23956, which I'll close as duplicate.",
    "created_at": "2017-10-05T17:42:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424666",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:11'></a>A part of the relevant discussion is on #23956, which I'll close as duplicate.
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22766#event-59254"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424667",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#23956\"",
    "created_at": "2017-10-05T17:43:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424668",
    "user": "https://github.com/dimpase"
}
```

Changing dependencies from "" to "#23956"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424669",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I wonder whether any other extension (apart from ECL/Maxima) is affected by this issue.",
    "created_at": "2017-10-05T18:24:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424670",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:14'></a>I wonder whether any other extension (apart from ECL/Maxima) is affected by this issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424672",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424673",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424675",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I don't think that signal handling has anything to do with this bug here. I don't see any signals being raised in a `strace` dump and also the error message from ECL says \"Stack overflow\".",
    "created_at": "2017-10-06T09:26:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424676",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>I don't think that signal handling has anything to do with this bug here. I don't see any signals being raised in a `strace` dump and also the error message from ECL says "Stack overflow".
...
```json
{
    "body": "<a id='comment:21'></a>Wait a minute... the \"stack overflow\" reminds me of a very similar issue that affected PARI/GP: #17773",
    "created_at": "2017-10-06T09:34:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424677",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>Wait a minute... the "stack overflow" reminds me of a very similar issue that affected PARI/GP: #17773
...
```json
{
    "body": "<a id='comment:22'></a>Boehm GC (which is used by ECL) installs its own signal handlers in order to be able to scan for garbage. Thus if another thread does something  to signals, then GC and thus ECL might go belly up. \n\n\"Stack overflow\" might be due to GC being given data to work on from another thread it does not know about. \n\nThe more I think about it the more inclined I become towards disabling tab completion in a separate thread.",
    "created_at": "2017-10-06T09:51:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424678",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:22'></a>Boehm GC (which is used by ECL) installs its own signal handlers in order to be able to scan for garbage. Thus if another thread does something  to signals, then GC and thus ECL might go belly up. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424679",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424680",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424683",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424684",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>I was just pointed out at a solved  IPython issue I missed, which reverts reliance on prompt_toolkit, and brings back single-threading behaviour of IPython:\nhttps://github.com/ipython/ipython/issues/10364/#issuecomment-300829008\n\nThere is another reason for avoiding prompt_toolkit - it does multi-threaded importing of Python modules, and given how fragile Sage is in its dependencies handling, this is something to avoid, unless we want more mysterious crashes to happen.",
    "created_at": "2017-10-08T08:53:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424685",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:29'></a>I was just pointed out at a solved  IPython issue I missed, which reverts reliance on prompt_toolkit, and brings back single-threading behaviour of IPython:
https://github.com/ipython/ipython/issues/10364/#issuecomment-300829008
...
```json
{
    "body": "<a id='comment:30'></a>By the way, FriCAS is another (soon to be optional (see #23847), currently experimental) Sage package dependent on ECL in a substantial way.",
    "created_at": "2017-10-08T10:24:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424686",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:30'></a>By the way, FriCAS is another (soon to be optional (see #23847), currently experimental) Sage package dependent on ECL in a substantial way.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424687",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424690",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>I don't think that this should be a blocker issue. It's an annoying bug which crashes Sage, but it's not very likely to appear since the TAB completion is cashed.",
    "created_at": "2017-11-13T13:21:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424691",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:35'></a>I don't think that this should be a blocker issue. It's an annoying bug which crashes Sage, but it's not very likely to appear since the TAB completion is cashed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424692",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>It appears that this has nuked GAP pexpect interface, too:\nhitting Tab at\n`sage: gap.`\nleads to \n`Warning: this should never happen` printed ABOVE the line\n\n```\nsage: gap.\n```\n\nand Sage becomes irresponsive and has to be killed.\n(this is with Sage 8.2.beta5)",
    "created_at": "2018-02-17T09:07:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424694",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:37'></a>It appears that this has nuked GAP pexpect interface, too:
hitting Tab at
`sage: gap.`
leads to 
`Warning: this should never happen` printed ABOVE the line
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424695",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Confirmed that `gap.` works on OpenSuSE with beta6. But `maxima_lib.` as in the ticket description still crashes.",
    "created_at": "2018-03-01T06:26:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424696",
    "user": "https://github.com/rwst"
}
```

<a id='comment:39'></a>Confirmed that `gap.` works on OpenSuSE with beta6. But `maxima_lib.` as in the ticket description still crashes.
...
```json
{
    "body": "<a id='comment:40'></a>Moreover if I `rm -f ~/.sage/giac_commandlist_cache.sobj` then `giac.<TAB>` does not crash. Probably the peculiar properties of ECL make maxima a special case.",
    "created_at": "2018-03-01T06:31:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424697",
    "user": "https://github.com/rwst"
}
```

<a id='comment:40'></a>Moreover if I `rm -f ~/.sage/giac_commandlist_cache.sobj` then `giac.<TAB>` does not crash. Probably the peculiar properties of ECL make maxima a special case.
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22766#event-59255"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22766#event-59256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424699",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>all is good in Sage 9.3.rc1",
    "created_at": "2021-04-11T13:30:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424700",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:42'></a>all is good in Sage 9.3.rc1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424701",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424702",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22766#event-59257"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22766#issuecomment-424703",
