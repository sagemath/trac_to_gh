...
```json
{
    "body": "<a id='comment:9'></a>\nI removed the test branch (kept as public/pyint_as_long_in_cc)\n\nand added a branch making the needed changes in triangulations.\n\n---\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[8cc4478](https://git.sagemath.org/sage.git/commit?id=8cc4478dc88662473d34817a7f477ff9e287786a)|`replace PyInt_* by PyLong_* in triangulations.cc`|",
    "created_at": "2017-02-10T16:56:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22335",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nok, I have tried to add the suggested lines.\nI put them in the .h files, near the top.\nPlease tell me if this is ok.\nI am going to launch my bot on it now.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[42ef83b](https://git.sagemath.org/sage.git/commit?id=42ef83b01aaef18f50674a82098e095566e24c1b)|`py3, trac 22335 adding alias for PyInt in C files for use with python3`|",
    "created_at": "2017-02-13T20:35:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22335",
    "type": "issue_comment",
