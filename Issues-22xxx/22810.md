...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22810#event-300404"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22810#event-300405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22810#event-300406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22810#event-300407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22810",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22810#issuecomment-342649",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22810",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22810#issuecomment-342650",
    "user": "https://github.com/jdemeyer"
}
```
