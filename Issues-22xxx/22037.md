...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267559"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267561"
}
```
...
```json
{
    "body": "**Attachment:** [example.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22037/example.tar.gz.gz)\n\nThis is a small example showing how the ClasscallMetaclass leads to the error.",
...
**Attachment:** [example.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22037/example.tar.gz.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267563"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22037",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22037#event-267568"
}
```
