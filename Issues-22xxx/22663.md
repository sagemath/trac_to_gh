...
```json
{
    "body": "<a id='comment:2'></a>\nUm, what do you mean not used much??? For involved interacts it is quite important to have some control on placement of controls, although perhaps we can use [SageMathCell](../wikis/SageMathCell) ideas that allow you to provide HTML code with locations for controls marked, see e.g. http://interact.math.ualberta.ca/MultivariateCalculus/Vector_fields.html with layout at line 289.",
