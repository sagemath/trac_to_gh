...
```json
{
    "body": "I am not exactly sure what you are proposing. I want repeated calls `f(a)` to be fast. Are you saying that in this case both `a` and the result of `f(a)` should be stored in a cache with weak references? Then, yes, I can imagine that.",
