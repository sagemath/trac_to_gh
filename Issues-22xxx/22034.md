...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407423",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407424",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407425",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407426",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407427",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I am not exactly sure what you are proposing. I want repeated calls `f(a)` to be fast. Are you saying that in this case both `a` and the result of `f(a)` should be stored in a cache with weak references? Then, yes, I can imagine that.",
    "created_at": "2016-12-08T05:07:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407429",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:7'></a>I am not exactly sure what you are proposing. I want repeated calls `f(a)` to be fast. Are you saying that in this case both `a` and the result of `f(a)` should be stored in a cache with weak references? Then, yes, I can imagine that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407430",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>It looks to me like you should have an \"element of a valuation-equipped polynomial ring\" type, where the element would naturally have a slot for storing the valuation. That way you solve the problem in the way that you wanted.\n\nSubclassing is cheap:\n\n```\nsage: f=ZZ['x']([1,2,3])\nsage: f\n3*x^2 + 2*x + 1\nsage: class A(type(f)): pass\nsage: g=A(parent(f),f)\nsage: g.valuation=10\nsage: g.valuation\n10\n```\n\nThere's a reason why the default polynomial type does not have a dict: to be lightweight. But clearly in your situation, that's TOO lightweight. So a subclass would be entirely justified.\n\nThere are of course some issues that arithmetic will not result in your \"augmented\" polynomials, so you'd have to wrap at judicious times or subclass more extensively.",
    "created_at": "2016-12-09T02:58:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407432",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:10'></a>It looks to me like you should have an "element of a valuation-equipped polynomial ring" type, where the element would naturally have a slot for storing the valuation. That way you solve the problem in the way that you wanted.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22034#issuecomment-407434",
    "user": "https://github.com/roed314"
}
```
