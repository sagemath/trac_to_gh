...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274501"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274503"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274504"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-222.tar.gz.gz\n+[https://github.com/sagemath/sage/files/ticket22646/configure-222.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-222.tar.gz.gz)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-222.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-222.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-226.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-226.tar.gz.gz)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-226.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-226.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-227.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-227.tar.gz.gz)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-227.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-227.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-228.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-228.tar.gz.gz)\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274507"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274512"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-228.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-228.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-229.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-229.tar.gz.gz)\n \n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274513"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274514"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-229.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-229.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-231.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-231.tar.gz.gz)\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274518"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this -- and probably also for all SAGE_... variables listed in the installation manual. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-231.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-231.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-232.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-232.tar.gz.gz)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-232.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-232.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-233.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-233.tar.gz.gz)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n In this ticket, we add support for this. (The syntax already works, but the settings right now only end up in the unused file `build/make/Makefile-auto`.)\n \n New configure tarball:\n-[https://github.com/sagemath/sage/files/ticket22646/configure-233.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-233.tar.gz.gz)\n+[https://github.com/sagemath/sage/files/ticket22646/configure-235.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-235.tar.gz.gz)\n \n``````\n",
    "created_at": "2017-08-29T23:36:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/22646",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [configure-235.tar.gz.gz](https://github.com/sagemath/sage/files/ticket22646/configure-235.tar.gz.gz)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274521"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22646",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22646#event-274522"
}
```
