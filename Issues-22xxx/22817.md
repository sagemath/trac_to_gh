...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[67f23e7](https://git.sagemath.org/sage.git/commit?id=67f23e7d5aa105f83637587cc8527d607da0c367)|`#22817 : package cryptominisat 5.0.1`|",
    "created_at": "2017-05-14T16:26:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22817",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nOK as mentioned on #22818 the package needs some love on OS X. I did a few QA on `CMakeList.txt` and tried not to get too carried away. As a bonus I changed `spkg-install` to find sage's zlib rather than the system one.\n\nPeople should check for adverse effects on linux. But on OS X things should now work better.\n\n---\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[6e93c20](https://git.sagemath.org/sage.git/commit?id=6e93c20da0c01fc0a60eceabefd179b7d8cabf73)|`Merge branch 'develop' into package_cryptominisat_5`|\n|[a8db509](https://git.sagemath.org/sage.git/commit?id=a8db509e92abb402737b1790115716373d069eab)|`patch to get install_name to be properly installed on OS X. Subtle QA for install by using GNUInstallDirs - may need more love.`|\n|[fd86b98](https://git.sagemath.org/sage.git/commit?id=fd86b98ca8cfe57743036ec32425ba95fd1b9028)|`Make sure we find sage's zlib rather the system one.`|",
