...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[7653735](https://git.sagemath.org/sage.git/commit/?id=765373538db297f27359b9ad07a92088af8e59f1)|`Removed the old cygwin build patches that were not being applied.`|",
    "created_at": "2017-04-05T13:09:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22761",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------|\n|[ed3fa8c](https://git.sagemath.org/sage.git/commit/?id=ed3fa8c7edd12c2e46ae4e96dae880931b8a4089)|`Update R patch level`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[84ab84a](https://git.sagemath.org/sage.git/commit/?id=84ab84a98d6c22480533d0d48c139c2662d4cf71)|`Updated this patch not to mess with R_HOME_DIR if SAGE_LOCAL is *not* set.`|\n|[0f4f542](https://git.sagemath.org/sage.git/commit/?id=0f4f542890ab66b6b995b7d05e1fbfb53011c0cf)|`Added some basic comments to this patch`|\n|[1a02d2b](https://git.sagemath.org/sage.git/commit/?id=1a02d2bfd17f98edea5eb39bbb909e60424419ca)|`Updated this patch to also include the actual resulting updates to the configure script`|\n|[5e9c424](https://git.sagemath.org/sage.git/commit/?id=5e9c424c3d9388c17273759519e84b191fa7b286)|`Removed the old cygwin build patches that were not being applied.`|\n|[6fb42c2](https://git.sagemath.org/sage.git/commit/?id=6fb42c2737d21153348393bf3e16384369ea9f95)|`Update R patch level`|",
    "created_at": "2017-04-10T10:13:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22761",
    "type": "issue_comment",
