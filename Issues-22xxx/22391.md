...
```json
{
    "body": "<a id='comment:2'></a>\nLast 10 new commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[db3b54e](https://git.sagemath.org/sage.git/commit?id=db3b54e20e98572a34918526aa0e8c28c83dea78)|`Fix doctests - mostly due to different order of vertices`|\n|[5281cf4](https://git.sagemath.org/sage.git/commit?id=5281cf4faf91d67d95e29230d3f8120008598307)|`Use PPL for facet normals of full-dimensional polytopes`|\n|[d244793](https://git.sagemath.org/sage.git/commit?id=d24479380a46e868d64c9fe8a228813259ad9414)|`Update a lot of toric doctests for the new facet order`|\n|[e70f34d](https://git.sagemath.org/sage.git/commit?id=e70f34d196c21ab0a3e1a5548af103b37f53eb27)|`Merge tag '7.6.beta3' into PPL_for_normals`|\n|[b27e343](https://git.sagemath.org/sage.git/commit?id=b27e34359dbc6f46e57654185b391279ace519cf)|`Always use PPL for LatticePolytope.facet_normals()`|\n|[8e77861](https://git.sagemath.org/sage.git/commit?id=8e7786165b1532bf083d7a696f7db9276438ca36)|`Update docstrings for facet normals and constants`|\n|[ba7656a](https://git.sagemath.org/sage.git/commit?id=ba7656a2b1ddd8fca1630f10eed3eca7e01fa60c)|`Use PPL for LatticePolytope.dim()`|\n|[38bbdb2](https://git.sagemath.org/sage.git/commit?id=38bbdb2f2060f3f4b83f27435b00ea42b5277696)|`Don't use embedding in LatticePolytope.distances()`|\n|[f4a696b](https://git.sagemath.org/sage.git/commit?id=f4a696bfdd5107b4d5098476bd4221c83d1e5fd1)|`Implement point containment test for LatticePolytope`|\n|[b4410f1](https://git.sagemath.org/sage.git/commit?id=b4410f11f98d3bb09d4a2018187b6ff840ea7c87)|`Do not rely on distances for containment check`|",
    "created_at": "2017-02-18T22:23:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nI made some small formatting changes to more match our style guide. If my changes look good, then positive review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|\n|[49be993](https://git.sagemath.org/sage.git/commit?id=49be993f66b5f72786b30dd39717cde91071061f)|`Merge branch 'u/novoselt/PPL_for_normals' of git://trac.sagemath.org/sage into u/novoselt/PPL_for_normals`|\n|[baf0a4a](https://git.sagemath.org/sage.git/commit?id=baf0a4ad48cffc0a166b6db9ca9ba471f59c93eb)|`A little bit of reviewer cleanup.`|",
    "created_at": "2017-10-25T00:56:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22391",
    "type": "issue_comment",
