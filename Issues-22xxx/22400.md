...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22400#event-295244"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22400#event-295245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22400#event-295246"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22400#event-295247"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22400#issuecomment-333855",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22400#issuecomment-333856",
    "user": "https://github.com/vbraun"
}
```
