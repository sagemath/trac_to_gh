...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423189",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423190",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423191",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423192",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#22422\"",
    "created_at": "2017-04-01T12:33:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423194",
    "user": "https://github.com/mforets"
}
```

Changing dependencies from "" to "#22422"
...
```json
{
    "body": "Changing branch from \"\" to \"u/paulmasson/22706\"",
    "created_at": "2017-04-02T23:29:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423195",
    "user": "https://github.com/paulmasson"
}
```

Changing branch from "" to "u/paulmasson/22706"
...
```json
{
    "body": "Changing commit from \"\" to \"bdc2807934ce570c7a29547f3ff3fdff5a387beb\"",
    "created_at": "2017-04-02T23:38:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423196",
    "user": "https://github.com/paulmasson"
}
```

Changing commit from "" to "bdc2807934ce570c7a29547f3ff3fdff5a387beb"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423197",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I went through the files in `sage/functions` to add as many conversions for special functions as possible, but could only find ten that were different from Sage.\n\nThe Giac exponential integrals `Ei`, `Si` and `Ci` have existing Sage aliases, so there shouldn't be a problem with those.\n\nThe orthogonal polynomials `hermite` and `laguerre` have the same names in Giac and Sage. Same for `erf` and a pending `erfc`, as well as `binomial` and `factorial`.\n\nThe Giac function `Psi` has is a different name from Sage `psi`, but the order of the arguments is reversed so I didn't add it now.\n\n---\nNew commits:",
    "created_at": "2017-04-02T23:38:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423198",
    "user": "https://github.com/paulmasson"
}
```

<a id='comment:9'></a>I went through the files in `sage/functions` to add as many conversions for special functions as possible, but could only find ten that were different from Sage.
...
```json
{
    "body": "<a id='comment:11'></a>Replying to [frederichan](#comment%3A5):\n> This one doesn't look easy. Any idea to deal with rootof?\n> \n> ```\n> sage: giac.simplify((exp(2*i*pi/3)+exp(2*i*pi/15))^3)\n> ((-768*i)*(-1)^(2/15)*sqrt(3)-768*(-1)^(2/15)+768*i*(-1)^(4/15)*sqrt(3)-768*(-1)^(4/15)+rootof([[16-16*i,-16+16*i,-400+528*i,144+240*i],[1,0,-30,-40,5]]))/512\n> ```\n> do we need to chose a name for the variable in the extention field? (if yes  then how? (or what would be a good name))\n\n\nThis appears to be #22024.",
    "created_at": "2017-04-05T15:06:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423200",
    "user": "https://github.com/rwst"
}
```

<a id='comment:11'></a>Replying to [frederichan](#comment%3A5):
> This one doesn't look easy. Any idea to deal with rootof?
> 
> ```
> sage: giac.simplify((exp(2*i*pi/3)+exp(2*i*pi/15))^3)
...
```json
{
    "body": "<a id='comment:14'></a>after this one is done, we could go for \"Add giac interface to integrate\". what do you think?",
    "created_at": "2017-04-18T11:31:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423203",
    "user": "https://github.com/mforets"
}
```

<a id='comment:14'></a>after this one is done, we could go for "Add giac interface to integrate". what do you think?
...
```json
{
    "body": "Changing branch from \"u/paulmasson/22706\" to \"u/mforets/22706\"",
    "created_at": "2017-04-27T11:47:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423204",
    "user": "https://github.com/mforets"
}
```

Changing branch from "u/paulmasson/22706" to "u/mforets/22706"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423205",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "Changing commit from \"bdc2807934ce570c7a29547f3ff3fdff5a387beb\" to \"9143bd2c7f60e364f3864e862d0cf8d563bc6a60\"",
    "created_at": "2017-04-27T12:04:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423206",
    "user": "https://github.com/mforets"
}
```

Changing commit from "bdc2807934ce570c7a29547f3ff3fdff5a387beb" to "9143bd2c7f60e364f3864e862d0cf8d563bc6a60"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423207",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>see #22891 for \"add giac interface to integrate\"",
    "created_at": "2017-04-27T20:52:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423208",
    "user": "https://github.com/mforets"
}
```

<a id='comment:17'></a>see #22891 for "add giac interface to integrate"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423210",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>branch looks good to me and bot is green, but is this in \"needs review\" state ?",
    "created_at": "2017-05-16T19:22:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423213",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:22'></a>branch looks good to me and bot is green, but is this in "needs review" state ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423214",
...
```json
{
    "body": "Changing commit from \"9143bd2c7f60e364f3864e862d0cf8d563bc6a60\" to \"6e5e3e2af7f55105b5b85b5940dcbe916c3a35d9\"",
    "created_at": "2017-05-17T06:20:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423215",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "9143bd2c7f60e364f3864e862d0cf8d563bc6a60" to "6e5e3e2af7f55105b5b85b5940dcbe916c3a35d9"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423216",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423217",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing commit from \"6e5e3e2af7f55105b5b85b5940dcbe916c3a35d9\" to \"71bc33610a526043a93ff68f45964ed5b4b93660\"",
    "created_at": "2017-05-25T21:08:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423218",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6e5e3e2af7f55105b5b85b5940dcbe916c3a35d9" to "71bc33610a526043a93ff68f45964ed5b4b93660"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423219",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423220",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"71bc33610a526043a93ff68f45964ed5b4b93660\" to \"b2f426184bbd24ddc9b8d710ed937ff7b24eef0c\"",
    "created_at": "2017-05-25T22:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423221",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "71bc33610a526043a93ff68f45964ed5b4b93660" to "b2f426184bbd24ddc9b8d710ed937ff7b24eef0c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423222",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"b2f426184bbd24ddc9b8d710ed937ff7b24eef0c\" to \"6592c6197fbdb40307c6bad3e01e97116af448a3\"",
    "created_at": "2017-05-26T05:56:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423223",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b2f426184bbd24ddc9b8d710ed937ff7b24eef0c" to "6592c6197fbdb40307c6bad3e01e97116af448a3"
...
```json
{
    "body": "<a id='comment:29'></a>partial progress: with the last commit one has\n\n```\nsage:\u00a0giac('Psi(x,1)')._sage_()\npsi(1,\u00a0x)\n```\n\nas desired. however the other way round doesn't work get swapped:\n\n```\nsage: psi(1, x)._giac_() \npsi(1, x)   # Psi(x, 1) is expected\n```",
    "created_at": "2017-05-26T06:01:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423224",
    "user": "https://github.com/mforets"
}
```

<a id='comment:29'></a>partial progress: with the last commit one has
...
```json
{
    "body": "<a id='comment:30'></a>It works if you give a giac conversion in the psi2 init as well.",
    "created_at": "2017-05-26T06:48:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423225",
    "user": "https://github.com/rwst"
}
```

<a id='comment:30'></a>It works if you give a giac conversion in the psi2 init as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423226",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"6592c6197fbdb40307c6bad3e01e97116af448a3\" to \"350316fe0bc69cb8c1fdebbd3363d3437661f28f\"",
    "created_at": "2017-05-26T08:08:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423227",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6592c6197fbdb40307c6bad3e01e97116af448a3" to "350316fe0bc69cb8c1fdebbd3363d3437661f28f"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423228",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423229",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423230",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>ok, let it be",
    "created_at": "2017-06-02T13:54:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423231",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:34'></a>ok, let it be
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423232",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423233",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423234",
...
```json
{
    "body": "Changing branch from \"u/mforets/22706\" to \"350316fe0bc69cb8c1fdebbd3363d3437661f28f\"",
    "created_at": "2017-06-04T10:08:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22706#issuecomment-423235",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/mforets/22706" to "350316fe0bc69cb8c1fdebbd3363d3437661f28f"
