...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198718"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198719"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198720"
}
```
...
```json
{
    ...
    "asset_name": "threejs-r80.tar.gz",
    "asset_url": "tarball://root/attachments/ticket22226/threejs-r80.tar.gz",
    "created_at": "2017-01-29T02:18:54Z",
    "issue": "https://github.com/sagemath/sage/issues/22226",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket22226/threejs-r80.tar.gz",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>\nWell, the current implementation of threejs in [SageMathCell](../wikis/SageMathCell) uses it, and while browsers support WebGL there may be hardware (or software environment) that does not support it - my old notebook had to fall back to canvas and I believe Windows in VM had to do it as well when it at all worked.\n\nIf you think it is completely useless, I can just as well download it for [SageMathCell](../wikis/SageMathCell) during build (there are other files pulled directly from github, so another one is not a problem). The plan is to drop current threejs function anyway.",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198721"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198722"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22226",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22226#event-198724"
}
```
