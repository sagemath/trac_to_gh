...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[cc43a97](https://git.sagemath.org/sage.git/commit/?id=cc43a97d62ca3d9e399a109f8b95d14aa46599a2)|`Reimplements DocTestDispatcher.parallel_dispatch in a dedicated class for maintaining all the relevant state and breaks the main loop into subroutines.`|\n|[ff9c50c](https://git.sagemath.org/sage.git/commit/?id=ff9c50c734b7ed39792b50c71a9708c0e19f31fa)|`Use the changesignal context manager from cysignals`|",
    "created_at": "2017-04-24T13:49:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22842",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|\n|[403a322](https://git.sagemath.org/sage.git/commit/?id=403a3220ddfd83d0d7fdc5dc87d8f56ff112a405)|`A minor bug I noticed: atexit handlers should be restored even if an exception occurred.`|",
