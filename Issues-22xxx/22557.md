...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[68cd0e1](https://git.sagemath.org/sage.git/commit?id=68cd0e153c5f5aa9ab4aa3e43327d54895ad7477)|`Update patches and script for 4.0.0`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[417f036](https://git.sagemath.org/sage.git/commit/?id=417f03626e2641be2031a2bf3ed91ee6d6d5decb)|`Update patches and script for 4.0.0`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[3be8be5](https://git.sagemath.org/sage.git/commit/?id=3be8be56da99a2c959fb166be1d89c6a6bd3d800)|`Use OPT=opt on Linux. Check results of test suite`|",
    "created_at": "2017-03-18T15:58:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22557",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[019ca15](https://git.sagemath.org/sage.git/commit/?id=019ca154ad99d4fc25cf32d4ce00b6cd45a85368)|`scip: Working configuration for clang on Mac`|\n|[8ba0287](https://git.sagemath.org/sage.git/commit/?id=8ba0287e850b064400ed4d44f743e3bb0db9ab60)|`scipoptsuite: Use clang on Mac OS`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[e7fb756](https://git.sagemath.org/sage.git/commit/?id=e7fb756a5fc4836481d843a1bed49ae514cb1e15)|`Update patch to get libtpinone makefile dependency right`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[a8b5ccf](https://git.sagemath.org/sage.git/commit/?id=a8b5ccf3856915631b8f391ad315347dcd60aec2)|`Update patch to get libtpinone makefile dependency right`|",
    "created_at": "2017-03-20T22:01:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22557",
    "type": "issue_comment",
