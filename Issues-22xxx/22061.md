...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280476"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22061#issuecomment-327766",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280483"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22061",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22061#event-280486"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22061#issuecomment-327767",
    "user": "https://github.com/vbraun"
}
```
