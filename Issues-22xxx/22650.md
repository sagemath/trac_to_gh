...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22650#event-298416"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22650#event-298417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22650#event-298418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22650#event-298419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22650#issuecomment-339269",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22650#issuecomment-339270",
    "user": "https://github.com/rwst"
}
```
