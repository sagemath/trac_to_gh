...
```json
{
    "body": "<a id='comment:2'></a>\niteritems is not python3-compatible\n\nyou should rather use\n\n```\nfrom six import iteritems\nfor xx in iteritems(dd):\n    pass\n```\n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[90a31a1](https://git.sagemath.org/sage.git/commit?id=90a31a1749d3314e2e3be44e952f7b69301b520d)|`Bug in Poset.is_slender(?)`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nI added a doctest, currently return the wrong answer 5.\n\nI also changed six.iteritems to iteritems in the full file.\n\n---\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[6feb62f](https://git.sagemath.org/sage.git/commit?id=6feb62faa5e936b4a55f7dc9f084af328ba61ec9)|`Merge branch 'u/mmezzarobba/22373-is_slender' in 7.6.rc0`|\n|[7608202](https://git.sagemath.org/sage.git/commit?id=7608202b228c7d6ff5388d19632f415a575f13b1)|`trac 22373 adding a doctest`|",
    "created_at": "2017-03-15T17:00:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22373",
    "type": "issue_comment",
