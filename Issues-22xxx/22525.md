...
```json
{
    "body": "<a id='comment:14'></a>\nHere is a tentative of enhancement.\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[7775304](https://git.sagemath.org/sage.git/commit?id=77753048d3778fc4c286d1ed689e0502fc58e2d4)|`trac 22525 better conversion from fricas expressions`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------|\n|[f9b0635](https://git.sagemath.org/sage.git/commit/?id=f9b0635bc6f56595c16c4db99ccc6733270dc2b7)|`add a test`|",
