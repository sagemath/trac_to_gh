# Issue 4182: [with patch, positive review] plot3d fails with 'IndexError: list index out of range'
...
```json
{
    ...
    "title": "[with patch, positive review] plot3d fails with 'IndexError: list index out of range'",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-30291",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-30292",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-30293",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-30294",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4182#event-9493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-30295",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
