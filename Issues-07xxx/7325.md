...
```json
{
    "body": "<a id='comment:29'></a>\nThere seems to be something wrong with [attachment:trac_7325_2_rebased_for_4.3.1.patch](https://github.com/sagemath/sage/files/ticket7325/trac_7325_2_rebased_for_4.3.1.patch)It contains two similar patches, with distinct headers etc. I didn't check if they are identical copies of the same patch.",
...
```json
{
    "body": "<a id='comment:36'></a>\nMerged only [trac_7325-final-for-real.patch](https://github.com/sagemath/sage/files/ticket7325/trac_7325-final-for-real.patch).",
    "created_at": "2010-01-30T23:39:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7325",
    "type": "issue_comment",
