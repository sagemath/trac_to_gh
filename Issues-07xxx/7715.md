...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7715#issuecomment-59508",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7715/vector_mod2_dense.patch",
    "created_at": "2009-12-16T17:38:51Z",
    "issue": "https://github.com/sagemath/sage/issues/7715",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7715/vector_mod2_dense.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "Attachment [vector_mod2_dense.patch](https://github.com/sagemath/sage/files/ticket7715/vector_mod2_dense.patch) by @malb created at 2009-12-16 17:38:51",
    "created_at": "2009-12-16T17:38:51Z",
    "issue": "https://github.com/sagemath/sage/issues/7715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7715#issuecomment-59509",
    "user": "https://github.com/malb"
}
```

Attachment [vector_mod2_dense.patch](https://github.com/sagemath/sage/files/ticket7715/vector_mod2_dense.patch) by @malb created at 2009-12-16 17:38:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7715#issuecomment-59510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7715#issuecomment-59511",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7715#issuecomment-59512",
    "user": "https://github.com/mwhansen"
}
```
