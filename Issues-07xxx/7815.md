...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78863",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78864",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78866",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78867",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Make sure CFLAG64 and CXXFLAG64 are both exported to -m64 when testing this. It relies on that, which will happen automatically very soon I hope, when my updates to sage-env get incorporated.",
    "created_at": "2010-01-06T02:03:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78868",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>Make sure CFLAG64 and CXXFLAG64 are both exported to -m64 when testing this. It relies on that, which will happen automatically very soon I hope, when my updates to sage-env get incorporated.
...
```json
{
    "body": "<a id='comment:4'></a>This depends on  #7818 so should not be applied until that is applied.",
    "created_at": "2010-01-13T07:55:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78869",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>This depends on  #7818 so should not be applied until that is applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78870",
...
```json
{
    "body": "<a id='comment:5'></a>Everything works on boxen, and I trust dkirkby on the Open Solaris end.",
    "created_at": "2010-01-14T08:12:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78871",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:5'></a>Everything works on boxen, and I trust dkirkby on the Open Solaris end.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78872",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78873",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78874",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Not only does it work on Open Solaris on x86 hardware, but I just tried for the first time to build a 64-bit version of Sage on a Sun Blade 2000 with a pair of UltraSPARC III+ CPUs running Solaris 10. This was based on the 4.3.1.alpha2 source code, but with this patch added. There are warnings issued during the 64-bit SPARC build that there are no 64-bit assembly routines, so C is used. But apart from that, Flint is now at least building on:\n\n* 32-bit Solaris 10 SPARC \n* 64-bit Solaris 10 SPARC\n* 64-bit Open Solaris x86",
    "created_at": "2010-01-14T09:02:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7815#issuecomment-78875",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>Not only does it work on Open Solaris on x86 hardware, but I just tried for the first time to build a 64-bit version of Sage on a Sun Blade 2000 with a pair of UltraSPARC III+ CPUs running Solaris 10. This was based on the 4.3.1.alpha2 source code, but with this patch added. There are warnings issued during the 64-bit SPARC build that there are no 64-bit assembly routines, so C is used. But apart from that, Flint is now at least building on:
