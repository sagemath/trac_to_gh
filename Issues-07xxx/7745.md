...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59896",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59897",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53351"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53352"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59898",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59899",
    "user": "https://github.com/kcrisman"
}
```
...
archive/attachments_009424.json:
```json
{
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [trac_7745-upgrade-maxima.patch](https://github.com/sagemath/sage/files/ticket7745/trac_7745-upgrade-maxima.patch) by @kcrisman created at 2009-12-22 21:17:14\n\nSee #6423 and #4142 for other bugs fixed by this spkg.",
    "created_at": "2009-12-22T21:17:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59900",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59901",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59902",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59903",
    "user": "https://github.com/kcrisman"
}
```
...
archive/attachments_009425.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [trac_7745-reviewer.patch](https://github.com/sagemath/sage/files/ticket7745/trac_7745-reviewer.patch) by @robert-marik created at 2009-12-23 08:33:11\n\napply on the top of the previous patch and #6423 and #4142",
    "created_at": "2009-12-23T08:33:11Z",
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59904",
    "user": "https://github.com/robert-marik"
}
```

Attachment [trac_7745-reviewer.patch](https://github.com/sagemath/sage/files/ticket7745/trac_7745-reviewer.patch) by @robert-marik created at 2009-12-23 08:33:11
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53353"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59905",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59906",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59907",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7745#issuecomment-59908",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7745",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7745#event-53356"
}
```
