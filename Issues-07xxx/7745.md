...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77654",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77656",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Came up with fixes of one kind or another for all these things.  The real remaining issue is that there isn't a super-simple way to parse %if when it comes from to_poly_solve, so for now I am just leaving that alone.  As soon as anyone can think of a way to do this, please open a ticket and post a patch.   Otherwise this patch should make the new spkg work.",
    "created_at": "2009-12-22T21:16:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77657",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>Came up with fixes of one kind or another for all these things.  The real remaining issue is that there isn't a super-simple way to parse %if when it comes from to_poly_solve, so for now I am just leaving that alone.  As soon as anyone can think of a way to do this, please open a ticket and post a patch.   Otherwise this patch should make the new spkg work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77658",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_7745-upgrade-maxima.patch](tarball://root/attachments/some-uuid/ticket7745/trac_7745-upgrade-maxima.patch) by @kcrisman created at 2009-12-22 21:17:14\n\nSee #6423 and #4142 for other bugs fixed by this spkg.",
    "created_at": "2009-12-22T21:17:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77659",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Attachment [trac_7745-upgrade-maxima.patch](tarball://root/attachments/some-uuid/ticket7745/trac_7745-upgrade-maxima.patch) by @kcrisman created at 2009-12-22 21:17:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77660",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Installs fine. Still running tests, but have the following (trivial) errors.\n\n```\nsage -t  \"devel/sage/sage/interfaces/maxima.py\"\n**********************************************************************\nFile \"/opt/sage-4.3.rc0/devel/sage/sage/interfaces/maxima.py\", line 1204:\n    sage: maxima.version()\nExpected:\n    '5.19.1'\nGot:\n    '5.20.1'\n**********************************************************************\nFile \"/opt/sage-4.3.rc0/devel/sage/sage/interfaces/maxima.py\", line 2723:\n    sage: maxima_version()\nExpected:\n    '5.19.1'\nGot:\n    '5.20.1'\n**********************************************************************\n```",
    "created_at": "2009-12-23T00:35:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77661",
    "user": "https://github.com/robert-marik"
}
```

<a id='comment:7'></a>Installs fine. Still running tests, but have the following (trivial) errors.
...
```json
{
    "body": "<a id='comment:8'></a>If those are the only ones you get, can you put a reviewer patch of those?  I always forget little things like that, and unfortunately the horsepower I have precludes running full tests if I ever want to get anything done.  I did get the one in rings/number_field, though.",
    "created_at": "2009-12-23T04:44:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77662",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>If those are the only ones you get, can you put a reviewer patch of those?  I always forget little things like that, and unfortunately the horsepower I have precludes running full tests if I ever want to get anything done.  I did get the one in rings/number_field, though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77663",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77664",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Positive review! Tested on 4.3.rc0 and got only errors which have been reported on sage-devel and are not relevent to this ticket. Tested together with #6423 and #4142.\n\nPositive review, thanks for upgrading.",
    "created_at": "2009-12-23T08:37:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77665",
    "user": "https://github.com/robert-marik"
}
```

<a id='comment:9'></a>Positive review! Tested on 4.3.rc0 and got only errors which have been reported on sage-devel and are not relevent to this ticket. Tested together with #6423 and #4142.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77666",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Note that if sage.math is still down, one can also get this at [http://boxen.math.washington.edu/home/kcrisman/maxima-5.20.1.spkg](http://boxen.math.washington.edu/home/kcrisman/maxima-5.20.1.spkg).",
    "created_at": "2009-12-27T03:28:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77667",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:11'></a>Note that if sage.math is still down, one can also get this at [http://boxen.math.washington.edu/home/kcrisman/maxima-5.20.1.spkg](http://boxen.math.washington.edu/home/kcrisman/maxima-5.20.1.spkg).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7745#issuecomment-77669",
    "user": "https://github.com/mwhansen"
}
```
