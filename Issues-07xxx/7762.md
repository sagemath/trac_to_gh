...
```json
{
    "body": "Attachment [trac_7762-conf-sagenb-path.patch](https://github.com/sagemath/sage/files/ticket7762/trac_7762-conf-sagenb-path.patch) by @TimDumol created at 2009-12-24 17:26:42\n\nUses `sagenb.misc.misc.DATA` instead.",
    "created_at": "2009-12-24T17:26:42Z",
    "issue": "https://github.com/sagemath/sage/issues/7762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7762#issuecomment-60096",
    "user": "https://github.com/TimDumol"
}
```

Attachment [trac_7762-conf-sagenb-path.patch](https://github.com/sagemath/sage/files/ticket7762/trac_7762-conf-sagenb-path.patch) by @TimDumol created at 2009-12-24 17:26:42
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7762#issuecomment-60097",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7762#issuecomment-60098",
    "user": "https://github.com/TimDumol"
}
```
