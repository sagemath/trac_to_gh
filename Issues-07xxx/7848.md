...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61158",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61159",
...
```json
{
    "body": "Attachment [trac_7848-misleading_HTML_cells.patch](https://github.com/sagemath/sage/files/ticket7848/trac_7848-misleading_HTML_cells.patch) by acleone created at 2010-01-19 07:21:56\n\nChanges the tutorial help verbage regarding text (HTML) cells.  Also replaces all the <b> tags in the tutorial with <strong>",
    "created_at": "2010-01-19T07:21:56Z",
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61160",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

Attachment [trac_7848-misleading_HTML_cells.patch](https://github.com/sagemath/sage/files/ticket7848/trac_7848-misleading_HTML_cells.patch) by acleone created at 2010-01-19 07:21:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61161",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61162",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61163",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61164",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7848#issuecomment-61165",
    "user": "https://github.com/qed777"
}
```
