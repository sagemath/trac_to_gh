...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86671"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7090",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86673"
}
```
