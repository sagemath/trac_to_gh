...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86338"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86339"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7090#issuecomment-50844",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7090#issuecomment-50845",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7090",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7090#event-86342"
}
```
