...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83328"
}
```
...
```json
{
    "body": "<a id='comment:4'>Comment 4:</a>\nAttachment: **[trac_7661-maxima_convert_back.patch.gz](https://github.com/sagemath/sage/files/ticket7661/trac_7661-maxima_convert_back.patch.gz)**\n\nI updated [attachment: trac_7661-maxima_convert_back.patch.gz](https://github.com/sagemath/sage/files/ticket7661/trac_7661-maxima_convert_back.patch.gz) to remove a doctest fix broken by a previous patch in my queue (#6949, `symbol...` line in sage/symbolic/ring.pyx).\n\nThis patch depends on #7748.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58896",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58897",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58898",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58899",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:11'>Comment 11:</a>\nThanks a lot for the quick feedback. \n* `a` is because you have the pynac package from #8644 installed, but not the corresponding patch from #8565. \n* `b` is a simple import problem, fixed by the updated [attachment: trac_7661-maxima_convert_back.take2.patch.gz](https://github.com/sagemath/sage/files/ticket7661/trac_7661-maxima_convert_back.take2.patch.gz)\n* I can't reproduce `c` here. It doesn't seem to be related to the changes in ticket. Do you have any other patches applied?",
    "created_at": "2010-04-09T18:57:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58900",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58901",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83331"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83332"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58902",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58903",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83333"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83334"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58904",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83335"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7661#event-83336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7661#issuecomment-58905",
    "user": "https://github.com/jhpalmieri"
}
```
