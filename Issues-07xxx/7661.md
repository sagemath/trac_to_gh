...
```json
{
    "body": "<a id='comment:3'></a>attachment:trac_7661-maxima_convert_back.patch fixes the problem reported above, and a similar problem with function conversions back from maxima reported in[comment:2](#comment%3A2):ticket:8459.",
    "created_at": "2010-04-05T10:24:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76294",
    "user": "https://github.com/burcin"
}
```

<a id='comment:3'></a>attachment:trac_7661-maxima_convert_back.patch fixes the problem reported above, and a similar problem with function conversions back from maxima reported in[comment:2](#comment%3A2):ticket:8459.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76295",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76296",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76297",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_7661-maxima_convert_back.patch](tarball://root/attachments/some-uuid/ticket7661/trac_7661-maxima_convert_back.patch) by @burcin created at 2010-04-06 15:42:51\n\nI updated attachment:trac_7661-maxima_convert_back.patch to remove a doctest fix broken by a previous patch in my queue (#6949, `symbol...` line in sage/symbolic/ring.pyx).\n\nThis patch depends on #7748.",
    "created_at": "2010-04-06T15:42:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76298",
    "user": "https://github.com/burcin"
}
```

<a id='comment:4'></a>Attachment [trac_7661-maxima_convert_back.patch](tarball://root/attachments/some-uuid/ticket7661/trac_7661-maxima_convert_back.patch) by @burcin created at 2010-04-06 15:42:51
...
```json
{
    "body": "<a id='comment:5'></a>Thanks for working onthis. Is #7748 the only prerequisity? I installed three patches as described at #7748 and got the following error\n\n```\npatching file sage/calculus/calculus.py\nHunk #3 succeeded at 1414 with fuzz 1 (offset -4 lines).\nHunk #5 FAILED at 1455\n1 out of 14 hunks FAILED -- saving rejects to file sage/calculus/calculus.py.rej\nabort: patch failed to apply\n```",
    "created_at": "2010-04-09T08:15:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76299",
    "user": "https://github.com/robert-marik"
}
```

<a id='comment:5'></a>Thanks for working onthis. Is #7748 the only prerequisity? I installed three patches as described at #7748 and got the following error
...
```json
{
    "body": "<a id='comment:6'></a>AFAICT, #8237 also changes that code. Can you try with #8237 applied?\n\nI'm sorry for the dependency hell we get into with these patches for every release. I don't know any way to automatically get a list of dependencies for a patch in my queue.\n\nThanks for your time Robert.",
    "created_at": "2010-04-09T10:46:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76300",
    "user": "https://github.com/burcin"
}
```

<a id='comment:6'></a>AFAICT, #8237 also changes that code. Can you try with #8237 applied?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76301",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>OK. That is one approach to solving this problem. Now we need to rebase the patch at #8237 so that it applies on top of these. Removing the offending hunk from `calculus.py` should be enough for that.\n\nNote that your updated patch shows you as the author. I'd appreciate it if you changed that back.\n\nThanks.",
    "created_at": "2010-04-09T14:34:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76303",
    "user": "https://github.com/burcin"
}
```

<a id='comment:8'></a>OK. That is one approach to solving this problem. Now we need to rebase the patch at #8237 so that it applies on top of these. Removing the offending hunk from `calculus.py` should be enough for that.
...
```json
{
    "body": "<a id='comment:9'></a>Sure, it was intended as temporary patch and from this reason I did not upload to trac server unless tested. I got some doctest failures in three files. See http://boxen.math.washington.edu/home/marik/ and the files a, b and c.\n\nI think that b is simple to fix, but have no idea about a and c.",
    "created_at": "2010-04-09T16:52:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76304",
    "user": "https://github.com/robert-marik"
}
```

<a id='comment:9'></a>Sure, it was intended as temporary patch and from this reason I did not upload to trac server unless tested. I got some doctest failures in three files. See http://boxen.math.washington.edu/home/marik/ and the files a, b and c.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76305",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76306",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I tested it on a fresh install and seems that all a,b,c are resolved.\nI am running all tests again, to be sure :)",
    "created_at": "2010-04-10T17:29:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76308",
    "user": "https://github.com/robert-marik"
}
```

<a id='comment:12'></a>I tested it on a fresh install and seems that all a,b,c are resolved.
I am running all tests again, to be sure :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76309",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Tests passed, postive review, thanks for fixing - very very usefull ticket.\n\nRelease manager: apply only trac_7661-maxima_convert_back.take2.patch",
    "created_at": "2010-04-10T19:31:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76310",
    "user": "https://github.com/robert-marik"
}
```

<a id='comment:13'></a>Tests passed, postive review, thanks for fixing - very very usefull ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76311",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76312",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Merged \"trac_7661-maxima_convert_back.take2.patch\" in 4.4.alpha0",
    "created_at": "2010-04-15T20:15:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76313",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:14'></a>Merged "trac_7661-maxima_convert_back.take2.patch" in 4.4.alpha0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76314",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7661#issuecomment-76315",
    "user": "https://github.com/jhpalmieri"
}
```
