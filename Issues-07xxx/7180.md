...
```json
{
    "body": "Changing upstream from \"\" to \"None of the above - read trac for reasoning.\"",
    "created_at": "2009-11-27T13:29:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75091",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing upstream from "" to "None of the above - read trac for reasoning."
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75092",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75093",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21651"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21652"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21653"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21654"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21655"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21656"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21657"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21658"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21659"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75094",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75095",
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21660"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75096",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7180#event-21662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7180#issuecomment-75097",
