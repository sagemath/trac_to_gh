...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81306",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81307",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81308",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81309",
...
```json
{
    "body": "<a id='comment:3'></a>Applying the patch to 4.3, this works.  In the notebook, running reset() then show_identifiers() returns only ['DATA', 'base64'], which are excluded from the call to reset().",
    "created_at": "2010-01-19T01:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81310",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```

<a id='comment:3'></a>Applying the patch to 4.3, this works.  In the notebook, running reset() then show_identifiers() returns only ['DATA', 'base64'], which are excluded from the call to reset().
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81311",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81312",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81313",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7972#issuecomment-81314",
    "user": "https://github.com/rlmill"
}
```
