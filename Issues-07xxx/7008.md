...
```json
{
    ...
    "asset_name": "trac-7008-refactor-setup-eval-on-grid.patch",
    "asset_url": "tarball://root/attachments/ticket7008/trac-7008-refactor-setup-eval-on-grid.patch",
    "created_at": "2009-09-25T04:14:51Z",
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7008/trac-7008-refactor-setup-eval-on-grid.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [trac-7008-refactor-setup-eval-on-grid.patch](https://github.com/sagemath/sage/files/ticket7008/trac-7008-refactor-setup-eval-on-grid.patch) by @jasongrout created at 2009-09-25 04:14:51",
    "created_at": "2009-09-25T04:14:51Z",
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51735",
    "user": "https://github.com/jasongrout"
}
```

Attachment [trac-7008-refactor-setup-eval-on-grid.patch](https://github.com/sagemath/sage/files/ticket7008/trac-7008-refactor-setup-eval-on-grid.patch) by @jasongrout created at 2009-09-25 04:14:51
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51736",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51737",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51738",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46666"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51739",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51740",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51741",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46668"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46669"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46670"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46671"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51742",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51743",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51744",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46672"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46673"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac-7008-doctests.patch",
    "asset_url": "tarball://root/attachments/ticket7008/trac-7008-doctests.patch",
    "created_at": "2009-09-29T06:08:12Z",
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7008/trac-7008-doctests.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>\nAttachment [trac-7008-doctests.patch](https://github.com/sagemath/sage/files/ticket7008/trac-7008-doctests.patch) by @jasongrout created at 2009-09-29 06:08:12\n\nI posted about the parametric_plot deprecation and no one opposed the deprecation.  So the new patch should fix everything up just right.",
    "created_at": "2009-09-29T06:08:12Z",
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51745",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46674"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51746",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51747",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7008#event-46677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7008#issuecomment-51748",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
