...
```json
{
    "body": "<a id='comment:1'></a>I still think that this is a serious bug, and it has  not been addressed in the 18 months since this ticket was opened.",
    "created_at": "2011-05-28T09:22:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76119",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>I still think that this is a serious bug, and it has  not been addressed in the 18 months since this ticket was opened.
...
```json
{
    "body": "<a id='comment:2'></a>Hi, sorry for taking so long to take a look. The reason for this behaviour is that currently, conversion is simply defined by index:\n\n```python\nsage: R.<a,b,c> = GF(3)[]\nsage: S = QQ['x','y','z']\nsage: S(a)\nx\n```\n\nSo, technically, it is not a bug. However, it might be a good idea to change this behaviour?",
    "created_at": "2011-06-21T13:49:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76120",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>Hi, sorry for taking so long to take a look. The reason for this behaviour is that currently, conversion is simply defined by index:
...
```json
{
    "body": "<a id='comment:3'></a>I noticed a bug in the code when looking into this issue attachment:trac_7654.patch fixes it.",
    "created_at": "2011-06-21T14:29:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76121",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>I noticed a bug in the code when looking into this issue attachment:trac_7654.patch fixes it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76122",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76124",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The attached patch deals with 1) and 2). However, for 3) it currently just raises an error. I'm not sure allowing more variables in the input ring + matching by index is such a good idea. Let me know what you think.",
    "created_at": "2011-06-22T12:10:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76125",
    "user": "https://github.com/malb"
}
```

<a id='comment:7'></a>The attached patch deals with 1) and 2). However, for 3) it currently just raises an error. I'm not sure allowing more variables in the input ring + matching by index is such a good idea. Let me know what you think.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76126",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76127",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>If I understood correctly, I still find this confusing, for the following reason:\n\n```python]\nsage: P.<a,x,y> = QQ[]\nsage: S = QQ['x','y','b']\nsage: S(a) # conversion by index\nx\nsage: S(x) # conversion by name\nx\n```\n\nso we get collisions which I don't like.",
    "created_at": "2011-06-23T11:56:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76128",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>If I understood correctly, I still find this confusing, for the following reason:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76129",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Okay, I understood: the variables in the polynomial instead of in the ring. If we take the variables of the ring, everything is fine.\n\nNote, however, that this implies that your original example will fail (?)\n\n```python\nsage: R.<y_6, y_3, y_2, y_1, z_6, z_5, z_4, z_3, z_2, z_1> = GF(3)[]\nsage: S = GF(3)['y_4', 'y_3', 'y_2', 'y_1', 'z_5', 'z_4', 'z_3', 'z_2', 'z_1']\nsage: S(y_1*z_2^2*z_1)\n```",
    "created_at": "2011-06-23T15:28:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76130",
    "user": "https://github.com/malb"
}
```

<a id='comment:12'></a>Okay, I understood: the variables in the polynomial instead of in the ring. If we take the variables of the ring, everything is fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76131",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76132",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>The updated patch *should* do the trick.",
    "created_at": "2011-06-25T14:52:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76133",
    "user": "https://github.com/malb"
}
```

<a id='comment:14'></a>The updated patch *should* do the trick.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76134",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Oops, I completely forgot about that ticket!",
    "created_at": "2011-08-17T12:51:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76135",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>Oops, I completely forgot about that ticket!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76137",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76138",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Attachment [trac_7654.patch](tarball://root/attachments/some-uuid/ticket7654/trac_7654.patch) by @malb created at 2011-08-18 14:04:41\n\nReplying to [comment:18 SimonKing]:\n> We got two failures (interestingly in two modules I'm quite familiar with):\n> So, you just need to change two error messages.\n\n\nThe updated patch does just that.\n \n> I am not sure, but it seems to me that the doc tests of the elliptic curves code became slower. Testing it now.\n\n\nOkay, good. Let me know what the verdict is and I'll take a look at performance if needed.",
    "created_at": "2011-08-18T14:04:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76140",
    "user": "https://github.com/malb"
}
```

<a id='comment:19'></a>Attachment [trac_7654.patch](tarball://root/attachments/some-uuid/ticket7654/trac_7654.patch) by @malb created at 2011-08-18 14:04:41
...
```json
{
    "body": "<a id='comment:20'></a>Concerning timings, I was mistaken (had remembered wrong figures): It is 920 versus 922 seconds for all long tests on elliptic curves. So, no significant difference.\n\nWith the new patch, all non-long tests pass, and with the old version all but two long tests passed. Hence, it is a positive review.",
    "created_at": "2011-08-18T15:02:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76141",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>Concerning timings, I was mistaken (had remembered wrong figures): It is 920 versus 922 seconds for all long tests on elliptic curves. So, no significant difference.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76142",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76143",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7654#issuecomment-76144",
    "user": "https://github.com/jdemeyer"
}
```
