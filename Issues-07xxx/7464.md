...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72829",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>> It is unusual in that the .spkg file, was a tar file, and \n> not a compressed tar file as they usually are. \n\n\nThis is the case for all databases of compressed files.  One makes a non-compressed spkg by doing\n\n```\n   sage -pkg_nc directory_name\n```",
    "created_at": "2009-11-17T06:59:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72830",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>> It is unusual in that the .spkg file, was a tar file, and 
> not a compressed tar file as they usually are. 
...
```json
{
    "body": "<a id='comment:3'></a>Thank you for the information. I used 'tar' to create it, rather than Sage with any option. It seems to work for me. Perhaps you can test it and review it.",
    "created_at": "2009-11-17T23:03:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72831",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>Thank you for the information. I used 'tar' to create it, rather than Sage with any option. It seems to work for me. Perhaps you can test it and review it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72832",
...
```json
{
    "body": "<a id='comment:4'></a>This looks fine to me. I read the changed files and also successfully installed it onto 4.2.1.  I am happy to be the upstream contact (and would expect to be contacted if anyone found an error in the database).  I should probably volunteer to be the spkg maintainer, but (embarrassingly) I do not even know the format of the main data file \"cremona\" in there!  So in practice William is the maintainer.  I will ask him to give me instructions....",
    "created_at": "2009-11-22T12:17:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72833",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>This looks fine to me. I read the changed files and also successfully installed it onto 4.2.1.  I am happy to be the upstream contact (and would expect to be contacted if anyone found an error in the database).  I should probably volunteer to be the spkg maintainer, but (embarrassingly) I do not even know the format of the main data file "cremona" in there!  So in practice William is the maintainer.  I will ask him to give me instructions....
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72834",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>>  I do not even know the format of the main data file \"cremona\" in there! \n\n> So in practice William is the maintainer. I will ask him to give me instructions.... \n\nIt's just a Python pickle.\n\nWilliam",
    "created_at": "2009-11-22T21:57:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72835",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>>  I do not even know the format of the main data file "cremona" in there! 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72836",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72837",
...
```json
{
    "body": "<a id='comment:7'></a>Copied into optional packages.",
    "created_at": "2009-11-29T05:39:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7464#issuecomment-72838",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>Copied into optional packages.
