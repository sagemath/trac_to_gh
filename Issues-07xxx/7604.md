...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58181",
    "user": "https://trac.sagemath.org/admin/accounts/users/solevillar"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [contfrac.py](https://github.com/sagemath/sage/files/ticket7604/contfrac.py) by solevillar created at 2009-12-04 16:42:14",
    "created_at": "2009-12-04T16:42:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58182",
    "user": "https://trac.sagemath.org/admin/accounts/users/solevillar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58184",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_7604.patch](https://github.com/sagemath/sage/files/ticket7604/trac_7604.patch) by @mwhansen created at 2009-12-07 08:12:11\n\nLooks good to me.\n\nsolevillar@gmail.com, could we get your name for the release notes?  Or, you could updated the Authors field on this ticket.  Thanks!",
    "created_at": "2009-12-07T08:12:11Z",
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58185",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58186",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58187",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58188",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58189",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7604#issuecomment-58190",
    "user": "https://trac.sagemath.org/admin/accounts/users/solevillar"
}
```
