...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16723"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16724"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16725"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16726"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16727"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16728"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67181",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16730"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16731"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67182",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67183",
...
```json
{
    "body": "<a id='comment:6'></a>The goal of these tickets is laudable, but:\n\n* We need at least one user who is able to test.\n* The package/OS information on this ticket is outdated beyond usefulness.\n* Upstream is a better place to report portability issues these days.",
    "created_at": "2020-07-12T20:04:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67184",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:6'></a>The goal of these tickets is laudable, but:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67185",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67186",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67187",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7074#issuecomment-67188",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7074",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7074#event-16732"
}
```
