...
```json
{
    "body": "Changed assignee from **whuss** to **@jasongrout**",
...
Changed assignee from **whuss** to **@jasongrout**
...
```json
{
    "body": "Changed assignee from **@jasongrout** to **whuss**",
...
Changed assignee from **@jasongrout** to **whuss**
...
```json
{
    "body": "<a id='comment:8'>Comment 8:</a>\nAttachment: **[trac-7298-ogv.patch.gz](https://github.com/sagemath/sage/files/ticket7298/trac-7298-ogv.patch.gz)**\n\nReplying to [@qed777](#comment%3A7):\n> I'm getting a docbuild warning from `sage/plot/animate.py`:\n> \n> ```\n> :0: (WARNING/2) Literal block expected; none found.\n> ```\n> I think the problem is that the `ogv` method's docstring ends with\n> \n> ```\n>         .. note::\n>            If libtheora is not installed, you will get an error\n>            message like this::\n> ```\n> Could someone please fix this?  For now, I'm removing [attachment: ogv.patch.gz](https://github.com/sagemath/sage/files/ticket7298/ogv.patch.gz) from 4.5.2.alpha0.\n\nI added the error message to the documentation in the new patch [attachment: trac-7298-ogv.patch.gz](https://github.com/sagemath/sage/files/ticket7298/trac-7298-ogv.patch.gz).",
    "created_at": "2010-07-21T07:21:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7298",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7298#issuecomment-54458",
    "user": "https://github.com/gagern"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7298#issuecomment-54459",
    "user": "https://github.com/vbraun"
}
```
