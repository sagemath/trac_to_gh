...
```json
{
    "body": "**Attachment:** [trac_7455-searching-on-log-page.patch](https://github.com/sagemath/sage/files/ticket7455/trac_7455-searching-on-log-page.patch)\n\nThis remvoes the search bar from the history page and updates the tests to reflect that.",
    "created_at": "2009-11-13T23:31:29Z",
    "issue": "https://github.com/sagemath/sage/issues/7455",
    "type": "issue_comment",
...
**Attachment:** [trac_7455-searching-on-log-page.patch](https://github.com/sagemath/sage/files/ticket7455/trac_7455-searching-on-log-page.patch)
