...
```json
{
    "body": "<a id='comment:1'></a>This is probably my fault--maybe adding a --std=c99 flags or the like to the module list will help. (I know this code is valid, as we use it elsewhere, e.g. for the CDF fast float). \n\nI'll try to track it down during Sage days if I don't see a resolution sooner.",
    "created_at": "2010-01-15T02:42:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80764",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>This is probably my fault--maybe adding a --std=c99 flags or the like to the module list will help. (I know this code is valid, as we use it elsewhere, e.g. for the CDF fast float). 
...
```json
{
    "body": "<a id='comment:3'></a>I think it boils down to this: the file http://sage.math.washington.edu/home/robertwb/solaris/simple_complex.c compiles fine on sage.math, but not on t2. Any ideas why?",
    "created_at": "2010-01-15T05:33:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80766",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>I think it boils down to this: the file http://sage.math.washington.edu/home/robertwb/solaris/simple_complex.c compiles fine on sage.math, but not on t2. Any ideas why?
...
```json
{
    "body": "<a id='comment:5'></a>I've submitted bug reports for Solaris 10 (SPARC)\n\nhttp://gcc.gnu.org/bugzilla/show_bug.cgi?id=42753\n\nand Open Solaris (x86)\n\nhttp://gcc.gnu.org/bugzilla/show_bug.cgi?id=42755\n\nDave",
    "created_at": "2010-01-15T10:47:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80768",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>I've submitted bug reports for Solaris 10 (SPARC)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80769",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80770",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>See spkg at http://sage/home/robertwb/cython/cython-0.12.p1\n\nThis changes \n\n```\n#if CYTHON_CCOMPLEX\n  #ifdef __cplusplus\n    #include <complex>\n  #else\n    #include <complex.h>\n  #endif\n#endif\n```\n\nto\n\n```\n#if CYTHON_CCOMPLEX\n  #ifdef __cplusplus\n    #include <complex>\n  #else\n    #include <complex.h>\n    #if defined(__sun__) && defined(__GNUC__)\n      #undef _Complex_I\n      #define _Complex_I 1j\n    #endif\n  #endif\n#endif\n```\n\nbut it feels a bit hackish.",
    "created_at": "2010-01-16T00:25:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80771",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:8'></a>See spkg at http://sage/home/robertwb/cython/cython-0.12.p1
...
```json
{
    "body": "<a id='comment:9'></a>Also, http://gcc.gnu.org/bugzilla/show_bug.cgi?id=42753",
    "created_at": "2010-01-16T00:26:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80772",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>Also, http://gcc.gnu.org/bugzilla/show_bug.cgi?id=42753
...
```json
{
    "body": "<a id='comment:10'></a>This does actually solve the problem, so if you could make this into an updated package, it would allow the Solaris build to get further, though it has recently been broken again by #7867 \n\nDave",
    "created_at": "2010-02-12T23:22:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80773",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:10'></a>This does actually solve the problem, so if you could make this into an updated package, it would allow the Solaris build to get further, though it has recently been broken again by #7867 
...
```json
{
    "body": "<a id='comment:12'></a>The new version of Cython at #8163 fixes this issue. You need to do a sage -ba after installing.",
    "created_at": "2010-02-15T19:49:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80775",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:12'></a>The new version of Cython at #8163 fixes this issue. You need to do a sage -ba after installing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80776",
...
```json
{
    "body": "<a id='comment:13'></a>Close as fixed by #8163.",
    "created_at": "2010-03-01T01:53:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7932#issuecomment-80777",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:13'></a>Close as fixed by #8163.
