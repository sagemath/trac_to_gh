...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82229"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57990",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57991",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57992",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82235"
}
```
...
```json
{
    "body": "<a id='comment:3'>Comment 3:</a>\n[attachment: trac_7582-libsingular_segfault.patch.gz](https://github.com/sagemath/sage/files/ticket7582/trac_7582-libsingular_segfault.patch.gz) fixes this. The `sa2si_NF` method worked before only because the `list()` method on number field elements always returned a list padded with zeroes.\n\nThe variety computation in the given example still doesn't work, since we can only compute varieties for zero dimensional ideals and this one has dimension 2.",
    "created_at": "2010-01-17T02:10:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57993",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57994",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57995",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57996",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-82239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57997",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-57998",
    "user": "https://github.com/rlmill"
}
```
