...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75077",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75078",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75079",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75080",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75081",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>attachment:trac_7582-libsingular_segfault.patch fixes this. The `sa2si_NF` method worked before only because the `list()` method on number field elements always returned a list padded with zeroes.\n\nThe variety computation in the given example still doesn't work, since we can only compute varieties for zero dimensional ideals and this one has dimension 2.",
    "created_at": "2010-01-17T02:10:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75082",
    "user": "https://github.com/burcin"
}
```

<a id='comment:3'></a>attachment:trac_7582-libsingular_segfault.patch fixes this. The `sa2si_NF` method worked before only because the `list()` method on number field elements always returned a list padded with zeroes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75083",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75084",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75085",
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_7582-libsingular_segfault.patch](tarball://root/attachments/some-uuid/ticket7582/trac_7582-libsingular_segfault.patch) by @wjp created at 2010-01-17 17:30:48\n\nLooks good.",
    "created_at": "2010-01-17T17:30:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75086",
    "user": "https://github.com/wjp"
}
```

<a id='comment:4'></a>Attachment [trac_7582-libsingular_segfault.patch](tarball://root/attachments/some-uuid/ticket7582/trac_7582-libsingular_segfault.patch) by @wjp created at 2010-01-17 17:30:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75087",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75088",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7582#issuecomment-75089",
    "user": "https://github.com/rlmill"
}
```
