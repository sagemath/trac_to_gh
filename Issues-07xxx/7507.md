...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56909",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56910",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56911",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_7507-forget_assumptions.patch](https://github.com/sagemath/sage/files/ticket7507/trac_7507-forget_assumptions.patch) by @burcin created at 2011-05-08 20:11:15\n\nThis seems to be fixed in the meanwhile. attachment:trac_7507-forget_assumptions.patch adds a doctest.",
    "created_at": "2011-05-08T20:11:15Z",
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56912",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56913",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56914",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56915",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7507#issuecomment-56916",
