...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79940"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79943"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79944"
}
```
...
```json
{
    "body": "Changed keywords from **** to **permutations, inversion vector, lehmer code**",
...
Changed keywords from **** to **permutations, inversion vector, lehmer code**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79946"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7414#issuecomment-55907",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79952"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7414",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79953"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7414#issuecomment-55908",
...
```json
{
    ...
    "milestone_title": "sage-4.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7414#event-79955"
}
```
