...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_7077.patch](https://github.com/sagemath/sage/files/ticket7077/trac_7077.patch) by @aghitza created at 2009-10-19 23:38:29\n\nThere are a number of methods called `variables()` in the Sage library.  The attached patch makes sure that all of them return tuples.  (This is what univariate polynomials, and symbolics return.)",
    "created_at": "2009-10-19T23:38:29Z",
    "issue": "https://github.com/sagemath/sage/issues/7077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7077#issuecomment-52316",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7077#issuecomment-52317",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7077#issuecomment-52318",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7077#issuecomment-52319",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7077#issuecomment-52320",
