...
```json
{
    "body": "<a id='comment:2'></a>Can `distutils` or `setuptools` can do this more simply?",
...
<a id='comment:2'></a>Can `distutils` or `setuptools` can do this more simply?
...
```json
{
    "body": "<a id='comment:3'></a>See #7467 for a `setuptools` alternative.",
...
<a id='comment:3'></a>See #7467 for a `setuptools` alternative.
...
<a id='comment:5'></a>Attachment [trac_7447-sagenb_version_v2.patch](tarball://root/attachments/some-uuid/ticket7447/trac_7447-sagenb_version_v2.patch) by @qed777 created at 2009-12-06 00:21:49
...
```json
{
    "body": "<a id='comment:6'></a>Nice.  I had to rebase it, but that's fine.",
    "created_at": "2009-12-09T00:11:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7447",
    "type": "issue_comment",
...
<a id='comment:6'></a>Nice.  I had to rebase it, but that's fine.
...
```json
{
    "body": "<a id='comment:7'></a>I merged this patch into sagenb-0.4.6.",
    "created_at": "2009-12-09T01:11:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7447",
    "type": "issue_comment",
...
<a id='comment:7'></a>I merged this patch into sagenb-0.4.6.
