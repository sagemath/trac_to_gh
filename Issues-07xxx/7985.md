...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-62797",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [fix-annoying-doctest.patch](https://github.com/sagemath/sage/files/ticket7985/fix-annoying-doctest.patch) by @wjp created at 2010-01-19 04:39:07",
    "created_at": "2010-01-19T04:39:07Z",
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-62798",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-62799",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-62800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-62801",
    "user": "https://github.com/rlmill"
}
```
