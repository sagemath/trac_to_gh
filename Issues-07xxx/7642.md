...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7642#issuecomment-75940",
    "user": "https://trac.sagemath.org/admin/accounts/users/abergeron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7642#issuecomment-75941",
    "user": "https://trac.sagemath.org/admin/accounts/users/abergeron"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Has this been checked on Solaris?\n\nThere's general information about building on Solaris at\n\n http://wiki.sagemath.org/solaris\n\nInformation specifically for 't2' at\n\n http://wiki.sagemath.org/devel/Building-Sage-on-the-T5240-t2\n\nBoth the source (4.3.0.1 is the latest to build on Solaris) and a binary which will run on any SPARC can be found at http://www.sagemath.org/download-source.html\n\nDave",
    "created_at": "2010-02-21T23:42:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7642#issuecomment-75943",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>Has this been checked on Solaris?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7642#issuecomment-75944",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7642#issuecomment-75945",
    "user": "https://github.com/nathanncohen"
}
```
