...
<a id='comment:1'></a>Dicyclic groups are implemented as a new class in the named permutation groups collection.
...
```json
{
    "body": "<a id='comment:2'></a>There's a typo in line 495, and these groups are sufficiently unusual that some reference to online documentation of them would be useful.   I realize these are fairly trivial comments, my apologies.",
    "created_at": "2009-10-21T16:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7244",
    "type": "issue_comment",
...
<a id='comment:2'></a>There's a typo in line 495, and these groups are sufficiently unusual that some reference to online documentation of them would be useful.   I realize these are fairly trivial comments, my apologies.
...
```json
{
    "body": "<a id='comment:4'></a>passes sage -testall (on ubuntu 9.04 32 but running under vmware under mac 10.6) and does what it claims.\n\nThanks Rob!",
...
<a id='comment:4'></a>passes sage -testall (on ubuntu 9.04 32 but running under vmware under mac 10.6) and does what it claims.
...
```json
{
    "body": "<a id='comment:5'></a>Release manager:  please obsolete #7151 when this gets merged.  Thanks!",
...
<a id='comment:5'></a>Release manager:  please obsolete #7151 when this gets merged.  Thanks!
