...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89392"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89395"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62011",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62012",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89396"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62013",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62014",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62015",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62016",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'>Comment 4:</a>\nAttachment: **[trac_7916-same_name_method.take2.patch.gz](https://github.com/sagemath/sage/files/ticket7916/trac_7916-same_name_method.take2.patch.gz)**\n\n[attachment: trac_7916-same_name_method.take2.patch.gz](https://github.com/sagemath/sage/files/ticket7916/trac_7916-same_name_method.take2.patch.gz) is slightly faster than the previous one.",
    "created_at": "2010-01-19T13:13:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62017",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62018",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89397"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89398"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62019",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62020",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62021",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89399"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7916#issuecomment-62022",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89400"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7916",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7916#event-89401"
}
```
