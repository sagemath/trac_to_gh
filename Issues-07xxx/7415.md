...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72205",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72207",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72208",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Speed regression for small input\"",
    "created_at": "2009-11-09T08:53:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72210",
    "user": "https://github.com/hivert"
}
```

Changing work_issues from "" to "Speed regression for small input"
...
```json
{
    "body": "<a id='comment:3'></a>Actually after some experiment I find out that this is a not a so good idea to use list + bisect. As it should be in a reasonable world, using python set is faster ! I'm preparing a new patch for this. \n\nCheers,\n\nFlorent",
    "created_at": "2009-11-09T09:24:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72211",
    "user": "https://github.com/hivert"
}
```

<a id='comment:3'></a>Actually after some experiment I find out that this is a not a so good idea to use list + bisect. As it should be in a reasonable world, using python set is faster ! I'm preparing a new patch for this. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72212",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72213",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72214",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72216",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72217",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_7415-review.patch](tarball://root/attachments/some-uuid/ticket7415/trac_7415-review.patch) by ylchapuy created at 2009-11-09 22:41:50\n\nNice work.\n\nI added a tiny patch to correct two typos, otherwise it seems good to me.\nHere is the positive review.\n\nCheers,\n Yann\n\n(note: apply only the last two patches)",
    "created_at": "2009-11-09T22:41:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72218",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:6'></a>Attachment [trac_7415-review.patch](tarball://root/attachments/some-uuid/ticket7415/trac_7415-review.patch) by ylchapuy created at 2009-11-09 22:41:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72219",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7415#issuecomment-72220",
    "user": "https://github.com/mwhansen"
}
```
