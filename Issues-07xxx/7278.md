...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88826"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88829"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7278#issuecomment-52620",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7278#issuecomment-52621",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88832"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7278#event-88834"
}
```
