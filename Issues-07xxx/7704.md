...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95108"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95110"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7704#issuecomment-57783",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95112"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7704#issuecomment-57784",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7704#issuecomment-57785",
    "user": "https://github.com/sagetrac-spancratz"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95114"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7704#issuecomment-57786",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7704#event-95116"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7704#issuecomment-57787",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7704#issuecomment-57788",
    "user": "https://github.com/mwhansen"
}
```
