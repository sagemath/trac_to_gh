...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7486#issuecomment-56639",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_009022.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ipauto.py",
    "asset_url": "tarball://root/attachments/ticket7486/ipauto.py",
    "created_at": "2010-08-21T23:26:40Z",
    "issue": "https://github.com/sagemath/sage/issues/7486",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7486/ipauto.py",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [ipauto.py](https://github.com/sagemath/sage/files/ticket7486/ipauto.py) by olazo created at 2010-08-21 23:26:40",
    "created_at": "2010-08-21T23:26:40Z",
    "issue": "https://github.com/sagemath/sage/issues/7486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7486#issuecomment-56640",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50755"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50756"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50757"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50758"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50759"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50760"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50761"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50762"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50763"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7486#event-50764"
}
```
