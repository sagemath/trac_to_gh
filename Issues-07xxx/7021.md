...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66637",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66638",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66639",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Would this updated spkg invalidate the GCC 3.4.x requirement for ratpoint at #6580?",
    "created_at": "2009-09-27T06:22:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66641",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:3'></a>Would this updated spkg invalidate the GCC 3.4.x requirement for ratpoint at #6580?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66645",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This is such a major improvement -- and fairly safe -- I would really like this in 4.1.2 so I'm upgrading this to blocker.",
    "created_at": "2009-10-04T02:45:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66647",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>This is such a major improvement -- and fairly safe -- I would really like this in 4.1.2 so I'm upgrading this to blocker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66648",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>William, since you believe this is fairly safe and a major improvement, can you update it to 'positive review'? And thank you for the comments!",
    "created_at": "2009-10-04T09:06:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66649",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:9'></a>William, since you believe this is fairly safe and a major improvement, can you update it to 'positive review'? And thank you for the comments!
...
```json
{
    "body": "<a id='comment:12'></a>> I have made prereq-install executable on the web site, but when I download it, it\n> looses the exe permissions. I dont think there is anything I can do about that - whoever adds it to sage will have to do that.\n\n\nYep, that's reasonable.",
    "created_at": "2009-10-04T18:59:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66652",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:12'></a>> I have made prereq-install executable on the web site, but when I download it, it
> looses the exe permissions. I dont think there is anything I can do about that - whoever adds it to sage will have to do that.
...
```json
{
    "body": "<a id='comment:14'></a>Good work, positive review!",
    "created_at": "2009-10-05T20:52:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66654",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:14'></a>Good work, positive review!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66655",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>When implemented, in additon to the two tickets mentioned above, I found another one this can close. I believe all these 3 can be closed. \n\n* #6707   \t Sage will try to build on compilers known to be too old.\n* #6701   \t prereq-0.3.tar has many issues and needs updating.\n* #3384   \t Issues a warning for all unsupported / poorly supported operating systems.\n\nDave",
    "created_at": "2009-10-07T08:46:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66656",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:15'></a>When implemented, in additon to the two tickets mentioned above, I found another one this can close. I believe all these 3 can be closed. 
...
```json
{
    "body": "<a id='comment:16'></a>I've merged the code from http://sage.math.washington.edu/home/kirkby/Solaris-fixes/prereq-0.4-3rd-try/ into sage-4.1.2.rc1.alpha3.",
    "created_at": "2009-10-07T15:42:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66657",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:16'></a>I've merged the code from http://sage.math.washington.edu/home/kirkby/Solaris-fixes/prereq-0.4-3rd-try/ into sage-4.1.2.rc1.alpha3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66658",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I have closed #6707, #6701, and #3384.",
    "created_at": "2009-10-07T15:44:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66659",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:17'></a>I have closed #6707, #6701, and #3384.
...
```json
{
    "body": "<a id='comment:18'></a>unique name please",
    "created_at": "2017-07-19T08:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66660",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:18'></a>unique name please
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66661",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7021#issuecomment-66662",
    "user": "https://github.com/fchapoton"
}
```
