...
```json
{
    ...
    "type": "issue",
    "updated_at": "2017-07-19T08:51:09Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84705"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84709"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50353",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    "body": "Attachment: **[prereq-0.4.tar.gz](https://github.com/sagemath/sage/files/ticket7021/prereq-0.4.tar.gz)**\n\nAttachment: **[prereq-0.4-install.gz](https://github.com/sagemath/sage/files/ticket7021/prereq-0.4-install.gz)**\n\nexecutable shell script to install as $SAGE_HOME/spkg/base/prereq-0.4-install",
    "created_at": "2009-09-27T01:39:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50354",
    "user": "https://github.com/sagetrac-drkirkby"
}
```

Attachment: **[prereq-0.4.tar.gz](https://github.com/sagemath/sage/files/ticket7021/prereq-0.4.tar.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50355",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50356",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50357",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50359",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50360",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    "body": "Changed author from **David Kirkby** to **David Kirkby, Minh Nguyen**",
    "created_at": "2009-09-28T16:01:19Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50361",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50362",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84711"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50363",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50364",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50365",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50366",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50367",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50369",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50370",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50371",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7021#event-84720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50372",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50373",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50374",
...
```json
{
    "body": "Changed author from **David Kirkby, Minh Nguyen** to **David Kirkby, Minh Van Nguyen**",
    "created_at": "2017-07-19T08:51:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7021#issuecomment-50375",
    "user": "https://github.com/fchapoton"
}
```
