...
```json
{
    "body": "Attachment [trac_7955-integrate_latex.patch](https://github.com/sagemath/sage/files/ticket7955/trac_7955-integrate_latex.patch) by @burcin created at 2010-01-17 09:10:29\n\nfix typesetting of unevaluated integrals",
    "created_at": "2010-01-17T09:10:29Z",
    "issue": "https://github.com/sagemath/sage/issues/7955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7955#issuecomment-62481",
    "user": "https://github.com/burcin"
}
```

Attachment [trac_7955-integrate_latex.patch](https://github.com/sagemath/sage/files/ticket7955/trac_7955-integrate_latex.patch) by @burcin created at 2010-01-17 09:10:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7955#issuecomment-62482",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7955#issuecomment-62483",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7955#issuecomment-62484",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7955#issuecomment-62485",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7955#issuecomment-62486",
