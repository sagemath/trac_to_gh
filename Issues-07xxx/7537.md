...
```json
{
    "body": "<a id='comment:2'></a>I see your point but why not return `self` in that case?",
    "created_at": "2010-02-25T13:31:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74205",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>I see your point but why not return `self` in that case?
...
```json
{
    "body": "<a id='comment:4'></a>I am converting boolean polynomials to Integer Programming problems, for this I convert them to symbolic expressions first and then to MIP. Probably not the most natural application.",
    "created_at": "2010-02-25T14:11:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74207",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>I am converting boolean polynomials to Integer Programming problems, for this I convert them to symbolic expressions first and then to MIP. Probably not the most natural application.
...
```json
{
    "body": "<a id='comment:5'></a>So let's close this bug then?",
    "created_at": "2010-07-14T13:38:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74208",
    "user": "https://github.com/malb"
}
```

<a id='comment:5'></a>So let's close this bug then?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74209",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>With attachment:trac_7537-iterator.patch we get an error when trying to iterate over symbols, constants or numeric objects:\n\n```\nsage: x.iterator()\nTraceback (most recent call last):\n...\nValueError: cannot iterate over numeric, constant or symbol\nsage: pi.iterator()\nTraceback (most recent call last):\n...\nValueError: cannot iterate over numeric, constant or symbol\nsage: SR(5).iterator()\nTraceback (most recent call last):\n...\nValueError: cannot iterate over numeric, constant or symbol\n```\n\nThis patch depends on #9989 (not in terms of functionality, but it will fail to apply since the patch there touches the same part of `sage/symbolic/expression.pyx`).",
    "created_at": "2010-09-26T14:36:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74210",
    "user": "https://github.com/burcin"
}
```

<a id='comment:6'></a>With attachment:trac_7537-iterator.patch we get an error when trying to iterate over symbols, constants or numeric objects:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74211",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74212",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74213",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I updated the patch with a new error message recommended in #9989.",
    "created_at": "2011-03-23T12:10:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74214",
    "user": "https://github.com/burcin"
}
```

<a id='comment:7'></a>I updated the patch with a new error message recommended in #9989.
...
```json
{
    "body": "<a id='comment:8'></a>Patch looks good, applies cleanly against 4.7.alpha2 and doctests pass.",
    "created_at": "2011-03-24T14:17:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74215",
    "user": "https://github.com/malb"
}
```

<a id='comment:8'></a>Patch looks good, applies cleanly against 4.7.alpha2 and doctests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74216",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74217",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7537#event-17874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74218",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7537#issuecomment-74219",
    "user": "https://github.com/jdemeyer"
}
```
