...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88675"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88676"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7866#issuecomment-61406",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88680"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7866#issuecomment-61407",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7866",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7866#event-88683"
}
```
