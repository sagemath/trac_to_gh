...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_7402-pkg_resources.patch](tarball://root/attachments/some-uuid/ticket7402/trac_7402-pkg_resources.patch) by @TimDumol created at 2009-11-06 11:31:18\n\nThis patch should do it.\n\nAs a note, we won't even need to restart the server if all we edit are template files. A big plus in ease of development, IMHO.",
...
<a id='comment:1'></a>Attachment [trac_7402-pkg_resources.patch](tarball://root/attachments/some-uuid/ticket7402/trac_7402-pkg_resources.patch) by @TimDumol created at 2009-11-06 11:31:18
...
<a id='comment:2'></a>This works for me.  In particular, the Se test suite is oblivious to the change.
...
<a id='comment:3'></a>A Sphinx warning to keep in mind:
