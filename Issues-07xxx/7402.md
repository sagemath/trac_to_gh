...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55779",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7402/trac_7402-pkg_resources.patch",
    "created_at": "2009-11-06T11:31:18Z",
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7402/trac_7402-pkg_resources.patch",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_7402-pkg_resources.patch](https://github.com/sagemath/sage/files/ticket7402/trac_7402-pkg_resources.patch) by @TimDumol created at 2009-11-06 11:31:18\n\nThis patch should do it.\n\nAs a note, we won't even need to restart the server if all we edit are template files. A big plus in ease of development, IMHO.",
    "created_at": "2009-11-06T11:31:18Z",
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55780",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55781",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55782",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55783",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55784",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55785",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7402#issuecomment-55786",
    "user": "https://github.com/TimDumol"
}
```
