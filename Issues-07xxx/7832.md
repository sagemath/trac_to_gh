...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79149",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [7832.singular.patch](tarball://root/attachments/some-uuid/ticket7832/7832.singular.patch) by @peterjeremy created at 2010-01-03 10:11:18",
    "created_at": "2010-01-03T10:11:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79150",
    "user": "https://github.com/peterjeremy"
}
```

<a id='comment:1'></a>Attachment [7832.singular.patch](tarball://root/attachments/some-uuid/ticket7832/7832.singular.patch) by @peterjeremy created at 2010-01-03 10:11:18
...
```json
{
    "body": "<a id='comment:2'></a>Unless I am mistaken, you have modified the singular sources directly, which is not permitted. Instead, you should create new versions of the files, put them in the 'patches' directory, and have something in spkg-install like\n\n```\ncp patch/mod_raw.cc src/kernel/mod_raw.cc\n```\nLikewise, you should not change the configure script, or configure.ac, but instead have \n\n```\ncp patches/configure src/\n```\nand created a diff file between the old configure.ac and the new configure.ac and put that in the patches directory. \n\nOnce that is done, it would need testing on Solaris, OS X and Linux in addition to FreeBSD. \n\nDave",
    "created_at": "2010-02-22T00:12:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79151",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>Unless I am mistaken, you have modified the singular sources directly, which is not permitted. Instead, you should create new versions of the files, put them in the 'patches' directory, and have something in spkg-install like
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79152",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Apparently the following attached patch was all that was needed for now by Stephen Montgomery-Smith.    This could be due to the fairly major upgrades in Singular.\n\n```\n\n--- singular-3-1-3-3.p3/src/omalloc/configure-orig\t2012-01-21 19:51:08.000000000 +0000\n+++ singular-3-1-3-3.p3/src/omalloc/configure\t2012-01-21 19:51:32.000000000 +0000\n@@ -1293,9 +1293,6 @@\n   echo \"$ac_t\"\"no\" 1>&6\n fi\n \n-if test \"$ac_cv_prog_AR\" != ar; then\n-  { echo \"configure: error: *** ar program not found\" 1>&2; exit 1; }\n-fi\n for ac_prog in perl\n do\n # Extract the first word of \"$ac_prog\", so it can be a program name with args.\n```",
    "created_at": "2012-01-31T01:56:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79153",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Apparently the following attached patch was all that was needed for now by Stephen Montgomery-Smith.    This could be due to the fairly major upgrades in Singular.
...
```json
{
    "body": "<a id='comment:4'></a>The patch by Stephen Montgomery-Smith, reported above by kcrisman, is only needed because when building using the FreeBSD port math/sage, the program ar is replaced by another program.\n\nIt would be really great if these three lines could be removed from the configure file.  As best as I can tell, they serve no purpose whatsoever for any OS.",
    "created_at": "2012-04-08T15:03:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79154",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```

<a id='comment:4'></a>The patch by Stephen Montgomery-Smith, reported above by kcrisman, is only needed because when building using the FreeBSD port math/sage, the program ar is replaced by another program.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79155",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79156",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I've reported this upstream at [this Singular ticket](http://www.singular.uni-kl.de:8002/trac/ticket/418).",
    "created_at": "2012-04-15T02:26:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79157",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>I've reported this upstream at [this Singular ticket](http://www.singular.uni-kl.de:8002/trac/ticket/418).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79158",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79160",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79161",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Okay, [here](https://github.com/Singular/Sources/blob/spielwiese/omalloc/configure.ac#L110) is the current Singular code, which raises a message but doesn't stop compiling.",
    "created_at": "2012-06-20T19:05:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79162",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Okay, [here](https://github.com/Singular/Sources/blob/spielwiese/omalloc/configure.ac#L110) is the current Singular code, which raises a message but doesn't stop compiling.
...
```json
{
    "body": "<a id='comment:9'></a>This has been fixed in sage-5.4, because it is fixed singular-3-1-5.p1.\n\nSo I suppose this ticket can be closed.",
    "created_at": "2012-09-12T03:39:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79163",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```

<a id='comment:9'></a>This has been fixed in sage-5.4, because it is fixed singular-3-1-5.p1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79164",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79165",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Good catch!  Sorry I haven't been better about helping move the !FreeBSD stuff along; I was nearly offline much of the summer, and since you are one of the only people to have such a machine easily available who frequents these tickets, it's hard to get independent review of the tickets.  Please please *please* keep reporting when these fixes are adopted upstream, it's so helpful!  Thanks.",
    "created_at": "2012-09-12T12:09:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79166",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Good catch!  Sorry I haven't been better about helping move the !FreeBSD stuff along; I was nearly offline much of the summer, and since you are one of the only people to have such a machine easily available who frequents these tickets, it's hard to get independent review of the tickets.  Please please *please* keep reporting when these fixes are adopted upstream, it's so helpful!  Thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79167",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79168",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7832#event-18732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79169",
...
```json
{
    "body": "<a id='comment:11'></a>Indeed, see #13237.",
    "created_at": "2012-09-13T22:37:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7832#issuecomment-79170",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Indeed, see #13237.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7832",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7832#event-18733"
}
```
