...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76800",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76801",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Here is a complete spkg up to the Sage standard for spkg's (hopefully):\n\nhttp://sage.math.washington.edu/home/wstein/patches/database_sloane_oeis-2009-12.spkg",
    "created_at": "2009-12-18T01:35:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76802",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Here is a complete spkg up to the Sage standard for spkg's (hopefully):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76803",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76804",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76806",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>More readable version:\n\nI completely forgot that the array size was hardcoded in SloaneEncyclopediaClass -- this is what caused the error, since now the number of entries is bigger than the array size. There's a bizarre new issue with numbering, though: most of the online sequences are sequentially numbered, but in the version I downloaded last night the sequential numbers end at A175062 and then there's a single sequence, A557274, after that. (To check the numbers in your database file, run \"cut -d' ' -f1 sloane-oeis | head\".)\n\nThe two best fixes I have in mind, other than getting Sloane to renumber that one extra sequence, are to replace SloaneEncyclopediaClass.__data__ with a hashtable whose keys are the indices and to let it be a huge array whose last index is 557274. The first might be slower, but the second one will require storing almost 400000 extra \"None\" entries in the __data__ array, and they'll have to be iterated through and ignored in the find() method.\n\nIf we stick to using an array instead of a hash table, then probably the right thing to do as far as the array size is to add a line to the update-sloane script: something like\n\n```\ncut -d' ' -f1 sloane-oeis | sort -r | head -1 | sed 's/A//' > sloane-maxseq\n```\n\nwhere sloane-oeis is the unzipped encyclopedia file, to write the maximal sequence number (in this case, 557274) to a file sloane-maxseq. Then the SloaneEncyclopediaClass.load() method could read this number (plus one) from the sloane-maxseq file into the variable self.__arraysize__ before it creates self.__data__, and continue as normal.\n\nWhich of these do you think is the best way to proceed?\n\nSteven",
    "created_at": "2009-12-19T05:39:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76807",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>More readable version:
...
```json
{
    "body": "<a id='comment:6'></a>FWIW, I downloaded a snapshot of the OEIS: all sequences up to date 2009-12-19.\n\nI made a bz2 file: [http://sage.math.washington.edu/home/jsp/cat25.bz2](http://sage.math.washington.edu/home/jsp/cat25.bz2)\n\n43 MB, expanded this is 176 MB.\n\nNice to have around.\n\nJaap",
    "created_at": "2009-12-19T19:22:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76808",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:6'></a>FWIW, I downloaded a snapshot of the OEIS: all sequences up to date 2009-12-19.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76809",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76810",
    "user": "https://trac.sagemath.org/admin/accounts/users/ssivek"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76812",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76813",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76814",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76815",
    "user": "https://trac.sagemath.org/admin/accounts/users/ssivek"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Ticket #7749 is now open, and I expect to have a patch submitted in the next day or so.",
    "created_at": "2009-12-22T18:21:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76816",
    "user": "https://trac.sagemath.org/admin/accounts/users/ssivek"
}
```

<a id='comment:10'></a>Ticket #7749 is now open, and I expect to have a patch submitted in the next day or so.
...
```json
{
    "body": "Changing author from \"\" to \"Steven Sivek\"",
    "created_at": "2009-12-22T18:43:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76817",
    "user": "https://github.com/jaapspies"
}
```

Changing author from "" to "Steven Sivek"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76818",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76819",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7692#issuecomment-76820",
    "user": "https://github.com/mwhansen"
}
```
