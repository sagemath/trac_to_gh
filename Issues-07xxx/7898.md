...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61796",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7898/singular-variables-to-names.patch",
    "created_at": "2010-01-12T03:41:04Z",
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7898/singular-variables-to-names.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [singular-variables-to-names.patch](https://github.com/sagemath/sage/files/ticket7898/singular-variables-to-names.patch) by drkirkby created at 2010-01-12 03:41:04\n\nNote, $CP is purposely left as '$CP', since the GNU version of 'cp' have an extra option which can be useful.",
    "created_at": "2010-01-12T03:41:04Z",
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61797",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61798",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61799",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61801",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61802",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61803",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61804",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-61805",
    "user": "https://github.com/rlmill"
}
```
