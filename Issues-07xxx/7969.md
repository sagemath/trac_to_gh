...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62582",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "Attachment [trac_7969-escaped-backslash.patch](https://github.com/sagemath/sage/files/ticket7969/trac_7969-escaped-backslash.patch) by @TimDumol created at 2010-01-17 21:23:49\n\nPrevents end-of-line backslashse from being replaced in sage and python systems.",
    "created_at": "2010-01-17T21:23:49Z",
    "issue": "https://github.com/sagemath/sage/issues/7969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62583",
    "user": "https://github.com/TimDumol"
}
```

Attachment [trac_7969-escaped-backslash.patch](https://github.com/sagemath/sage/files/ticket7969/trac_7969-escaped-backslash.patch) by @TimDumol created at 2010-01-17 21:23:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62584",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62585",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62586",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62587",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7969#issuecomment-62588",
