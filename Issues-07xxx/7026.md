...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7026#issuecomment-51991",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7026/config.log.64-bit.gcc.SPARC.txt",
    "created_at": "2010-01-14T16:26:49Z",
    "issue": "https://github.com/sagemath/sage/issues/7026",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7026/config.log.64-bit.gcc.SPARC.txt",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [config.log.64-bit.gcc.SPARC.txt](https://github.com/sagemath/sage/files/ticket7026/config.log.64-bit.gcc.SPARC.txt) by drkirkby created at 2010-01-14 16:26:49\n\nconfig.log seen on a SPARC using gcc in 64-bit mode",
    "created_at": "2010-01-14T16:26:49Z",
    "issue": "https://github.com/sagemath/sage/issues/7026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7026#issuecomment-51992",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [config.log.64-bit.gcc.SPARC.txt](https://github.com/sagemath/sage/files/ticket7026/config.log.64-bit.gcc.SPARC.txt) by drkirkby created at 2010-01-14 16:26:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7026#issuecomment-51993",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7026#issuecomment-51994",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7026#issuecomment-51995",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7026#issuecomment-51996",
    "user": "https://github.com/jdemeyer"
}
```
