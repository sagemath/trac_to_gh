...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7141#issuecomment-66632",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7141",
    "rename": {
        "from": "`math_parse` parses $'s in <script> tags",
        "to": "[with patch, needs review] `math_parse` parses $'s in <script> tags"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7141#event-28942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7141",
    "rename": {
        "from": "[with patch, needs review] `math_parse` parses $'s in <script> tags",
        "to": "[with patch, positive review] `math_parse` parses $'s in <script> tags"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7141#event-28943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7141",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7141#issuecomment-66633",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7141",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7141#issuecomment-66634",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7141",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7141#event-28944"
}
```
