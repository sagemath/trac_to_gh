# Issue 7186: [with patch; positive review] maxima update #6699 introduced hard-coded paths, unable to start maxima
...
```json
{
    ...
    "title": "[with patch; positive review] maxima update #6699 introduced hard-coded paths, unable to start maxima",
    "type": "issue",
