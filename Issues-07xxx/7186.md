...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68483",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68485",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Changing Maxima as you mention above is not a good plan at all, since one still wants to be able to run ECL from Sage, e.g., no matter what hack you can imagine to fix Maxima along the lines above, this will still fail:\n\n```\n./sage -ecl\n```",
    "created_at": "2009-10-12T04:55:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68487",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>Changing Maxima as you mention above is not a good plan at all, since one still wants to be able to run ECL from Sage, e.g., no matter what hack you can imagine to fix Maxima along the lines above, this will still fail:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68488",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>See the new spkg here, which must be combine with the attached patch to sage-env (against \"scripts\" repo):\nhttp://sage.math.washington.edu/home/wstein/patches/ecl-9.8.4-20090913cvs.p2.spkg",
    "created_at": "2009-10-12T05:02:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68489",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>See the new spkg here, which must be combine with the attached patch to sage-env (against "scripts" repo):
http://sage.math.washington.edu/home/wstein/patches/ecl-9.8.4-20090913cvs.p2.spkg
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_scripts-7186.patch](tarball://root/attachments/some-uuid/ticket7186/trac_scripts-7186.patch) by GeorgSWeber created at 2009-10-12 06:05:21\n\nYep, I missed the point about standalone \"./sage -sh && sage -ecl\" not working after a move of the Sage tree. This should go in now, in order to get the necessary testing on many platforms as soon as possible. The new spkg is clean (I just downloaded it, unpacked it, and looked at \"hg export default\"), and the changes to sage-env look sane, so I give a positive review right away.",
    "created_at": "2009-10-12T06:05:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68490",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:7'></a>Attachment [trac_scripts-7186.patch](tarball://root/attachments/some-uuid/ticket7186/trac_scripts-7186.patch) by GeorgSWeber created at 2009-10-12 06:05:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68491",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68492",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68493",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Just fixing the title to make sure it isn't confusing.",
    "created_at": "2009-10-12T09:59:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68494",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:8'></a>Just fixing the title to make sure it isn't confusing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68495",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>> and the changes to sage-env look sane, so I give a positive review right away. \n\n\nFor the record, it turns out one must do\n\n```\nECLDIR=\"$SAGE_LOCAL/lib/ecl/\"\n```\ninstead of what I had.  I've made this fix.",
    "created_at": "2009-10-12T19:30:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68496",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>> and the changes to sage-env look sane, so I give a positive review right away. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68497",
...
```json
{
    "body": "<a id='comment:10'></a>for uniqueness of author names",
    "created_at": "2017-07-19T09:02:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68498",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:10'></a>for uniqueness of author names
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7186#issuecomment-68499",
    "user": "https://github.com/fchapoton"
}
```
