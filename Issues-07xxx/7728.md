...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77303",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77304",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>OK, this likely need some more docs about the caching aspect...",
    "created_at": "2009-12-19T22:45:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77305",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```

<a id='comment:2'></a>OK, this likely need some more docs about the caching aspect...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77306",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_7728-immutablefactors.2.patch](tarball://root/attachments/some-uuid/ticket7728/trac_7728-immutablefactors.2.patch) by dagss created at 2009-12-21 15:12:06\n\nLast attachment contains the same changes + a little more docs.\n\nLU was previously cached, so this just makes things more consistent by caching all decompositions -- easier to remember.\n\nI also plan to make use of the caching if I get around to fixing #4932, see my comment there, short story: `solve_left` should be able to use the results of a call to `LU()`, which makes caching a lot more important.",
    "created_at": "2009-12-21T15:12:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77307",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```

<a id='comment:3'></a>Attachment [trac_7728-immutablefactors.2.patch](tarball://root/attachments/some-uuid/ticket7728/trac_7728-immutablefactors.2.patch) by dagss created at 2009-12-21 15:12:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77308",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77309",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77311",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77312",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77313",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7728#issuecomment-77314",
    "user": "https://github.com/mwhansen"
}
```
