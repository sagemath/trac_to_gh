...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-98335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-98336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-98337"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-98338"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7920#issuecomment-60381",
    "user": "https://github.com/sagetrac-dagss"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-98339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7920#issuecomment-60382",
    "user": "https://github.com/sagetrac-dagss"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-98340"
}
```
