...
<a id='comment:13'></a>Replying to [rbeezer](#comment%3A9):
> Been working most of the day straightening this up.
...
<a id='comment:14'></a>Replying to [nthiery](#comment%3A12):
Hi Nicolas,
...
<a id='comment:28'></a>Replying to [rbeezer](#comment%3A27):
> Feel free to add yourself to the author field - it'd be good to "share" a patch with you.
