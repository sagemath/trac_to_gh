...
```json
{
    "body": "**Attachment:** [trac_7555_operation_table.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_operation_table.patch)",
    "created_at": "2010-03-18T04:44:07Z",
    "issue": "https://github.com/sagemath/sage/issues/7555",
    "type": "issue_comment",
...
**Attachment:** [trac_7555_operation_table.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_operation_table.patch)
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [trac_7555_doctest_failure.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_doctest_failure.patch)\n\nIgnore that doctest failure patch - I found the problem.",
    "created_at": "2010-03-20T18:10:57Z",
    "issue": "https://github.com/sagemath/sage/issues/7555",
    "type": "issue_comment",
...
archive/attachments_009505.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Changing work issues** from \"fix 3 doctests\" to \"\".",
...
**Changing work issues** from "fix 3 doctests" to "".
...
```json
{
    "body": "<a id='comment:23'></a>\n**Attachment:** [trac_7555_operation_table-categories.2.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_operation_table-categories.2.patch)\n\nDone. Diff to previous version on: http://combinat.sagemath.org/hgwebdir.cgi/patches/diff/233de3ecbcb7/trac_7555_operation_table-categories.patch",
    "created_at": "2010-03-23T16:37:54Z",
    "issue": "https://github.com/sagemath/sage/issues/7555",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_7555_minor-fixups.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_minor-fixups.patch)",
    "created_at": "2010-03-24T05:11:20Z",
    "issue": "https://github.com/sagemath/sage/issues/7555",
    "type": "issue_comment",
...
**Attachment:** [trac_7555_minor-fixups.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_minor-fixups.patch)
...
```json
{
    "body": "**Attachment:** [trac_7555_minor-fixups-nt.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_minor-fixups-nt.patch)",
    "created_at": "2010-03-24T08:47:45Z",
    "issue": "https://github.com/sagemath/sage/issues/7555",
    "type": "issue_comment",
...
**Attachment:** [trac_7555_minor-fixups-nt.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_minor-fixups-nt.patch)
...
```json
{
    "body": "**Attachment:** [trac_7555_operation_table-categories-all-in-one.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_operation_table-categories-all-in-one.patch)\n\nApply only this one",
    "created_at": "2010-03-24T08:49:27Z",
    "issue": "https://github.com/sagemath/sage/issues/7555",
    "type": "issue_comment",
...
**Attachment:** [trac_7555_operation_table-categories-all-in-one.patch](https://github.com/sagemath/sage/files/ticket7555/trac_7555_operation_table-categories-all-in-one.patch)
