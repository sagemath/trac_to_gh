...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7134#issuecomment-67981",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7134#issuecomment-67982",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7134#issuecomment-67983",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This can be closed as fixed, as the issue was resolved in sage-4.3.3.alpha0 #8101. \n\nDave",
    "created_at": "2011-04-02T13:15:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7134#issuecomment-67984",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>This can be closed as fixed, as the issue was resolved in sage-4.3.3.alpha0 #8101. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7134#issuecomment-67985",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7134#issuecomment-67986",
    "user": "https://github.com/jdemeyer"
}
```
