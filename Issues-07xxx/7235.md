...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53665",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53666",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53667",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48519"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48520"
}
```
...
```json
{
    "body": "Attachment [sage-README-osx.txt](https://github.com/sagemath/sage/files/ticket7235/sage-README-osx.txt) by @williamstein created at 2009-11-11 19:11:58\n\nI changed the line as suggested by Georg Weber.  I agree with his suggestion.",
    "created_at": "2009-11-11T19:11:58Z",
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53668",
    "user": "https://github.com/williamstein"
}
```

Attachment [sage-README-osx.txt](https://github.com/sagemath/sage/files/ticket7235/sage-README-osx.txt) by @williamstein created at 2009-11-11 19:11:58
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48521"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53669",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48522"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48523"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53670",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53671",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53672",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7235#issuecomment-53673",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7235",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7235#event-48525"
}
```
