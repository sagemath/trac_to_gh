...
<a id='comment:16'></a>Replying to [comment:13 was]:
>     sage: InfinitePolynomial(X,alpha_2)
...
<a id='comment:33'></a>Replying to [comment:32 wjp]:
> The patch has DOS/Windows endlines, so maybe doing a
> 
> 
> ```
...
<a id='comment:39'></a>Replying to [comment:38 cremona]:
