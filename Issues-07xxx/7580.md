...
```json
{
    "body": "<a id='comment:1'></a>I am glad to see in various posts on sage-devel and sage-support that finally people are using Infinite Polynomial Rings. They are using it in a way that I did not think of when I worked on the code (but perhaps Mike Hansen had this in mind? After all, it started with his implementation).\n\nThe fact that people seem not to use it for Symmetric Groebner Bases implies two things:\n\n* The current default implementation (which goes back to Mike Hansen) is good for Symmetric Groebner Bases, but not so good for other applications. So, should we change the default?\n\n* The new usage reveals a couple of bugs, that should be fixed.\n\nMy impression is that the code needs a thorough overhaul. Can we use this ticket for it?",
    "created_at": "2009-12-02T09:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74989",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>I am glad to see in various posts on sage-devel and sage-support that finally people are using Infinite Polynomial Rings. They are using it in a way that I did not think of when I worked on the code (but perhaps Mike Hansen had this in mind? After all, it started with his implementation).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74990",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Concerning the erroneous result of `a[2/3]` or `a['0+5']`: It is correct that it comes from the use of strings. I am now explicitely converting the argument to an integer. It is silly that I forgot it in the original implementation. This also fixes the `a[Mod(2,3)]` bug.\n\nI meanwhile have code that allows for any alphanumeric variable names. Only requirement: `isalnum()` must return `True` (in particular, there must be no underscore in the name, as I have explained above). I am now testing the new code and will hopefully soon be able to post it.\n\nThe reason for requiring a base *field*: It is needed for my original application, Symmetric Gr\u00f6bner Bases. But as people now  want other applications, it seems fair to allow *any* base ring that is also allowed for classical polynomial rings. So, the exception should only be raised in the `groebner_basis` method of symmetric ideals.",
    "created_at": "2009-12-02T21:32:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74994",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Concerning the erroneous result of `a[2/3]` or `a['0+5']`: It is correct that it comes from the use of strings. I am now explicitely converting the argument to an integer. It is silly that I forgot it in the original implementation. This also fixes the `a[Mod(2,3)]` bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74995",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74996",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Here it is !! Perhaps you do not need fixing the docstrings in class mip as they should be changed by this patch soon :\n\nhttp://trac.sagemath.org/sage_trac/ticket/7561\n\nI'm mainly waiting for a answer from Martin and this ticket should be settled :-)\n\nNathann",
    "created_at": "2009-12-04T05:54:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74997",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:7'></a>Here it is !! Perhaps you do not need fixing the docstrings in class mip as they should be changed by this patch soon :
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74998",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-74999",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>While I started to comment my patch, I found that not all issues are resolved. For example, I can define an infinite polynomial ring whose base ring is another infinite polynomial ring -- but the computations with elements of such ring don't quite work yet.\n\nSorry.\n\nLater, I'll provide another patch that fixes it.",
    "created_at": "2009-12-04T16:39:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75000",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>While I started to comment my patch, I found that not all issues are resolved. For example, I can define an infinite polynomial ring whose base ring is another infinite polynomial ring -- but the computations with elements of such ring don't quite work yet.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75001",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75002",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75003",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75004",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>\"The variable names can be any alphanumeric string. The base ring can be any commutative ring. Note the rhyme...\"\n\n```\nThe bugs in your code can really sting.\nBut the speed will really zing!\n```",
    "created_at": "2009-12-10T19:31:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75005",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>"The variable names can be any alphanumeric string. The base ring can be any commutative ring. Note the rhyme..."
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75006",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75008",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75011",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Doctests for 32 bit; work around bug in multipolynomial conversion (#7654)\"",
    "created_at": "2009-12-11T00:42:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75013",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Doctests for 32 bit; work around bug in multipolynomial conversion (#7654)"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75016",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75018",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75019",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75020",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Here is an example (in unpatched 4.3.1.alpha1) which fails\n\n```\nsage: R.<a> = InfinitePolynomialRing(QQ)\nsage: S.<x> = R[]\n(boom)\nor\nsage: PolynomialRing(R,'x')\n(boom)\n```\nBasically, the PolynomialRing constructor gets called with base_ring==R, and in that it tries to check if base_ring.is_field(proof = False).",
    "created_at": "2010-01-09T15:08:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75021",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:24'></a>Here is an example (in unpatched 4.3.1.alpha1) which fails
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75022",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75025",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75026",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Has anybody tried yet whether the patch really fails to apply?",
    "created_at": "2010-01-12T12:36:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75027",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:30'></a>Has anybody tried yet whether the patch really fails to apply?
...
```json
{
    "body": "<a id='comment:31'></a>I'm building a new 4.3.1.alpha1 (for another reason) and when that's finished I'll try again.",
    "created_at": "2010-01-12T17:21:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75028",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:31'></a>I'm building a new 4.3.1.alpha1 (for another reason) and when that's finished I'll try again.
...
```json
{
    "body": "<a id='comment:32'></a>The patch has DOS/Windows endlines, so maybe doing a\n\n```\ndos2unix 7580_fixes_and_extensions.patch\n```\n\nwill make it apply cleanly.",
    "created_at": "2010-01-20T22:08:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75029",
    "user": "https://github.com/wjp"
}
```

<a id='comment:32'></a>The patch has DOS/Windows endlines, so maybe doing a
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75030",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75032",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75034",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75035",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75036",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>The patch *7580_unpickling.patch* is to be applied after *7580_fixes_and_extensions.patc* (disregard the third patch). With the patch, `sage -testall` worked perfectly for me. Hence, I think it is ready to review.\n\nTo summarize the content of the patch bomb, I refer to my comments 10 and 20.",
    "created_at": "2010-01-26T12:18:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75037",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:37'></a>The patch *7580_unpickling.patch* is to be applied after *7580_fixes_and_extensions.patc* (disregard the third patch). With the patch, `sage -testall` worked perfectly for me. Hence, I think it is ready to review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75038",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Patch problem:  I tried applying 7580_fixes_and_extensions.patch to both 4.3.1 and 4.3.2.alpha0 and in both cases there were many hunks which failed.\n\nCould you list by name which of the three patches should be applied and in which order?  I seem to have this confused...",
    "created_at": "2010-02-01T10:38:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75039",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:38'></a>Patch problem:  I tried applying 7580_fixes_and_extensions.patch to both 4.3.1 and 4.3.2.alpha0 and in both cases there were many hunks which failed.
...
```json
{
    "body": "<a id='comment:41'></a>On a new clone of a  new build of 4.3.2.alpha1,  I cannot apply the first patch (i.e. 7580_fixes_and_extensions.patch).\n\nI think someone else had better try!",
    "created_at": "2010-02-01T14:41:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75042",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:41'></a>On a new clone of a  new build of 4.3.2.alpha1,  I cannot apply the first patch (i.e. 7580_fixes_and_extensions.patch).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75043",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75045",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>The latest patch applies fine to 4.3.2.alpha1, and all tests pass!  I tested the whole library (but not with long).",
    "created_at": "2010-02-02T17:21:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75047",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:45'></a>The latest patch applies fine to 4.3.2.alpha1, and all tests pass!  I tested the whole library (but not with long).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75048",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75049",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75050",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7580#issuecomment-75051",
    "user": "https://github.com/qed777"
}
```
