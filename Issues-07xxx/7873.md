...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79850",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [gap-#7873.patch](tarball://root/attachments/some-uuid/ticket7873/gap-#7873.patch) by drkirkby created at 2010-01-08 20:22:42\n\nAt a new spkg, which fixes these can found at \n\nhttp://boxen.math.washington.edu/home/kirkby/portability/gap-4.4.10.p13/gap-4.4.10.p13.spkg\n\n\nDave",
    "created_at": "2010-01-08T20:22:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79851",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>Attachment [gap-#7873.patch](tarball://root/attachments/some-uuid/ticket7873/gap-#7873.patch) by drkirkby created at 2010-01-08 20:22:42
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79852",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79853",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Two comments: you've changed \"$CP\" to \"cp\" even though $CP is still defined in sage-env.  Does this matter?\n\nAlso (and this is not new -- it happens with the old spkg, too): when I install the spkg, I get this at the end:\n\n```\ncp: ../../bin is a directory (not copied).\ncp: cp: No such file or directory\n```\nAny ideas why?  Anyway, since gap works, maybe we shouldn't worry about this right now.",
    "created_at": "2010-01-08T20:53:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79854",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Two comments: you've changed "$CP" to "cp" even though $CP is still defined in sage-env.  Does this matter?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79855",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79856",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It works for me on OS X 10.6, and the changes are obviously the right ones to make.  Positive review.",
    "created_at": "2010-01-08T21:25:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79857",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>It works for me on OS X 10.6, and the changes are obviously the right ones to make.  Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79858",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Thank you very much for the positive review.",
    "created_at": "2010-01-08T22:39:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79859",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>Thank you very much for the positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79860",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7873#issuecomment-79861",
    "user": "https://github.com/rlmill"
}
```
