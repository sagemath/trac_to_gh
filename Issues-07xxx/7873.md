...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88801"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88803"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7873#issuecomment-61567",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7873#issuecomment-61568",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88805"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88806"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88807"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88808"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7873",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7873#event-88809"
}
```
