...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7412#issuecomment-55863",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7412#issuecomment-55864",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_7412-lehmer.patch](https://github.com/sagemath/sage/files/ticket7412/trac_7412-lehmer.patch) by ylchapuy created at 2009-11-08 17:47:26\n\nHi Florent,\n\nHere is the patch. Sorry for the CC, next time I'll follow your advice.\n\nRegards,\n Yann",
    "created_at": "2009-11-08T17:47:26Z",
    "issue": "https://github.com/sagemath/sage/issues/7412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7412#issuecomment-55865",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7412#issuecomment-55866",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7412#issuecomment-55867",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7412#issuecomment-55868",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
