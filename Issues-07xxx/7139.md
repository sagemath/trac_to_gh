...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7139#issuecomment-68017",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7139#issuecomment-68018",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Like an idiot, I created another ticket for this same problem. I'm closing this one, as the other one has the patch and is more upto date.",
    "created_at": "2010-01-02T06:52:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7139#issuecomment-68019",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>Like an idiot, I created another ticket for this same problem. I'm closing this one, as the other one has the patch and is more upto date.
