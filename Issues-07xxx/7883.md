...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80003",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80004",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [7585_7_ideal.patch](tarball://root/attachments/some-uuid/ticket7883/7585_7_ideal.patch) by @robertwb created at 2010-01-09 20:11:52\n\nThere's a lot of useful looking code in here, but it's unclear what exactly it does or it's intended to fix. Some more explanations would be nice, and the new behavior should be doctested. Especially for most of the changes in `sage/rings/ideal.py`\n\nWhat is the parameter in _ideal_class_ supposed to mean? (Then why is it 0 by default?) \n\nDepends on #7881?",
    "created_at": "2010-01-09T20:11:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80005",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>Attachment [7585_7_ideal.patch](tarball://root/attachments/some-uuid/ticket7883/7585_7_ideal.patch) by @robertwb created at 2010-01-09 20:11:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80006",
...
```json
{
    "body": "<a id='comment:2'></a>I haven't made the changes Robert suggested, but I wanted to get an updated patch up since other finite field functionality depends on this.",
    "created_at": "2010-02-23T15:05:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80007",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>I haven't made the changes Robert suggested, but I wanted to get an updated patch up since other finite field functionality depends on this.
...
```json
{
    "body": "<a id='comment:4'></a>Tried this under 4.3.4.rc0 with 8218, 8332, 7880 applied. It applies fine but seven doctests fail. Moreover, I second Robert's criticism: it's not clear what all this new code is actually for. (The fact that other finite-field stuff depends on this doesn't change that.) Can we have a new patch with some more docstrings etc?",
    "created_at": "2010-03-17T22:11:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80009",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:4'></a>Tried this under 4.3.4.rc0 with 8218, 8332, 7880 applied. It applies fine but seven doctests fail. Moreover, I second Robert's criticism: it's not clear what all this new code is actually for. (The fact that other finite-field stuff depends on this doesn't change that.) Can we have a new patch with some more docstrings etc?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80010",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80011",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Apply:\n\n```\n7883_ideals.patch\n7883_fixes.patch\n```\n\nProbably will not pass doctests unless you also apply the patches on #8333 and #8334.",
    "created_at": "2010-09-19T13:19:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80012",
    "user": "https://github.com/roed314"
}
```

<a id='comment:5'></a>Apply:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80013",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80015",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80016",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80017",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80018",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80019",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7883#issuecomment-80020",
    "user": "https://github.com/qed777"
}
```
