...
```json
{
    "body": "<a id='comment:1'></a>Since Sage uses pari's nffactor() for factoring polynomials over number fields, I tried the same example in pari (gp version 2.4.3 (development svn-11651) to be precise).  there, it found one linear factor but failed to factor the other degree 8 part.  This suggests that we'll have to wait for bug fixes in pari before this can be closed.",
    "created_at": "2009-10-02T16:16:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67459",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>Since Sage uses pari's nffactor() for factoring polynomials over number fields, I tried the same example in pari (gp version 2.4.3 (development svn-11651) to be precise).  there, it found one linear factor but failed to factor the other degree 8 part.  This suggests that we'll have to wait for bug fixes in pari before this can be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67462",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67463",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67465",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67466",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67467",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67468",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67470",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67471",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67472",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67473",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67474",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67475",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Replying to [cremona](#comment%3A7):\n> We should still use factornf instead, once we upgrade the pari library to a version in which the upstream bug has been fixed.\n\n\nThere is the latest stable PARI at #8453.",
    "created_at": "2010-03-06T06:26:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67476",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>Replying to [cremona](#comment%3A7):
> We should still use factornf instead, once we upgrade the pari library to a version in which the upstream bug has been fixed.
...
```json
{
    "body": "<a id='comment:11'></a>This is all solved by using a later pari release as in the spkg at #8453.",
    "created_at": "2010-03-11T21:14:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7097#issuecomment-67477",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:11'></a>This is all solved by using a later pari release as in the spkg at #8453.
