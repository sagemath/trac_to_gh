...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79313",
...
```json
{
    "body": "<a id='comment:1'></a>Can you systematically trigger this?  It looks serious?  What was the worksheet that caused this.  The problem is probably symlinks to ___code___.py files being created when they shouldn't be, or something.   Those files should be completely ignored when copying the worksheet.",
    "created_at": "2010-01-05T03:45:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79314",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Can you systematically trigger this?  It looks serious?  What was the worksheet that caused this.  The problem is probably symlinks to ___code___.py files being created when they shouldn't be, or something.   Those files should be completely ignored when copying the worksheet.
...
```json
{
    "body": "<a id='comment:2'></a>I'll try to find a reproducible case.",
    "created_at": "2010-01-05T04:07:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79315",
    "user": "https://github.com/qed777"
}
```

<a id='comment:2'></a>I'll try to find a reproducible case.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79316",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_7846-no_CODE_PY_symlinks.patch](tarball://root/attachments/some-uuid/ticket7846/trac_7846-no_CODE_PY_symlinks.patch) by @qed777 created at 2010-01-05 06:35:09\n\nThe attached patch should work for copying and re-publishing worksheets --- both use `Notebook._initialize_worksheet`.  But we should cover\n\n```python\nfname = 'foo.txt'\nfd = open(fname, 'w')\nfd.write('bar')\nfd.close()\nprint os.listdir('.')\nimport time; time.sleep(3)\nos.unlink(fname)\nprint os.listdir('.')\n```\ntoo...",
    "created_at": "2010-01-05T06:35:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79317",
    "user": "https://github.com/qed777"
}
```

<a id='comment:3'></a>Attachment [trac_7846-no_CODE_PY_symlinks.patch](tarball://root/attachments/some-uuid/ticket7846/trac_7846-no_CODE_PY_symlinks.patch) by @qed777 created at 2010-01-05 06:35:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79319",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79320",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It seems safer to skip non-existent files.  I haven't changed the lines in `Notebook.migrate_old_worksheet`, since the they're wrapped in Try-N-Save blocks.\n\nShould we delete all files that are temporarily symlinked but not actually in the final output?  Do people like to keep track of intermediaries?\n\nDifferent problem: Should deleting a cell in the notebook delete its contents on disk?",
    "created_at": "2010-01-05T08:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79321",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>It seems safer to skip non-existent files.  I haven't changed the lines in `Notebook.migrate_old_worksheet`, since the they're wrapped in Try-N-Save blocks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79322",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79323",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79324",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79325",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79326",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7846#issuecomment-79327",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
