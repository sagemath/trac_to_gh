...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98221"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98223"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7912#issuecomment-60316",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7912#issuecomment-60317",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7912#issuecomment-60318",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-98229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7912#issuecomment-60319",
    "user": "https://github.com/jhpalmieri"
}
```
