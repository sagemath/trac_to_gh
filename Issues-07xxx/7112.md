...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7112/trac_7112.patch",
    "created_at": "2009-10-07T12:15:31Z",
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7112/trac_7112.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [trac_7112.patch](https://github.com/sagemath/sage/files/ticket7112/trac_7112.patch) by @williamstein created at 2009-10-07 12:15:31\n\nwith this patch applied all doctest pass for me on OS X 10.5 PPC",
    "created_at": "2009-10-07T12:15:31Z",
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52720",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac_7112.patch](https://github.com/sagemath/sage/files/ticket7112/trac_7112.patch) by @williamstein created at 2009-10-07 12:15:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52721",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52722",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7112/trac_7112-part2.patch",
    "created_at": "2009-10-07T12:57:20Z",
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7112/trac_7112-part2.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_7112-part2.patch](https://github.com/sagemath/sage/files/ticket7112/trac_7112-part2.patch) by @williamstein created at 2009-10-07 12:57:20\n\n(Note that I already merged this in sage-4.1.2.rc1.alpha3.  However, it awaits review before I'll release sage-4.1.2.)",
    "created_at": "2009-10-07T12:57:20Z",
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52723",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52724",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52725",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52726",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52727",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7112#issuecomment-52728",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
