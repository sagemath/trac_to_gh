...
```json
{
    "body": "<a id='comment:2'></a>Just a small remark: there is no mmpf algorithm available, this should be removed from the docstring.\n\n(and it needs #7375 ...)",
    "created_at": "2009-11-26T02:00:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7531",
    "type": "issue_comment",
...
<a id='comment:2'></a>Just a small remark: there is no mmpf algorithm available, this should be removed from the docstring.
...
```json
{
    "body": "<a id='comment:3'></a>Fixed in updated patch.",
...
<a id='comment:3'></a>Fixed in updated patch.
...
<a id='comment:4'></a>typo in the pxd: assymptotically
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [m4ri_lqup.patch](tarball://root/attachments/some-uuid/ticket7531/m4ri_lqup.patch) by @malb created at 2009-11-26 14:56:05\n\nThanks, fixed.",
...
<a id='comment:5'></a>Attachment [m4ri_lqup.patch](tarball://root/attachments/some-uuid/ticket7531/m4ri_lqup.patch) by @malb created at 2009-11-26 14:56:05
...
```json
{
    "body": "<a id='comment:6'></a>seems good to me now :)",
...
<a id='comment:6'></a>seems good to me now :)
