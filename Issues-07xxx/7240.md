...
```json
{
    "body": "<a id='comment:23'></a>\nAs encouragement for working on this ticket, I'm using `_factor_cunningham` in #7931.  Now that #8334 has a positive review, #7931 is ready to review, but it's getting doctest failures because of the warning generated by `_factor_`cunningham.",
