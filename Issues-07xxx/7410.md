...
```json
{
    "body": "<a id='comment:1'></a>This may be fixed by #7666.",
    "created_at": "2009-12-14T17:41:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7410",
    "type": "issue_comment",
...
<a id='comment:1'></a>This may be fixed by #7666.
...
```json
{
    "body": "<a id='comment:2'></a>Possibly related: #7663.",
...
<a id='comment:2'></a>Possibly related: #7663.
...
```json
{
    "body": "<a id='comment:3'></a>#7648's patch (alone!) gives the correct answer.  If I'm right, please close this ticket when #7648 and #7663 merge.",
    "created_at": "2010-01-18T04:31:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7410",
    "type": "issue_comment",
...
<a id='comment:3'></a>#7648's patch (alone!) gives the correct answer.  If I'm right, please close this ticket when #7648 and #7663 merge.
...
```json
{
    "body": "<a id='comment:4'></a>#7648's patch (alone!?) gives the correct answer.  If I'm right, please close this ticket when #7648 and #7663 merge.",
...
<a id='comment:4'></a>#7648's patch (alone!?) gives the correct answer.  If I'm right, please close this ticket when #7648 and #7663 merge.
