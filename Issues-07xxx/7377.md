...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7377#event-81871"
}
```
...
```json
{
    "body": "<a id='comment:0'>Comment 0:</a>\nHmm, that shouldn't be failing now that JP put that back in - it was fine for me.  Did you use [attachment: trac_7377-doctests-p1.patch.gz](https://github.com/sagemath/sage/files/ticket7377/trac_7377-doctests-p1.patch.gz) or [attachment: trac_7377-doctests-p2.patch.gz](https://github.com/sagemath/sage/files/ticket7377/trac_7377-doctests-p2.patch.gz) (either of these should be fine) instead of [attachment: trac_7377-doctests.patch.gz](https://github.com/sagemath/sage/files/ticket7377/trac_7377-doctests.patch.gz) (bad)?",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7377#issuecomment-55582",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7377#issuecomment-55583",
    "user": "https://github.com/jdemeyer"
}
```
