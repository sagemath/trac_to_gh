...
<a id='comment:1'></a>Computing the Twin Prime Counting Function
...
<a id='comment:2'></a>You could make some of these functions methods of the Primes() object:
...
<a id='comment:3'></a>After thinking about this some more, this problem seems easier than I had first realized.  You do not need to sieve out all non twin primes to calculate the twin prime counting function.
...
```json
{
    "body": "<a id='comment:5'></a>[rihanna pictures](http://top20search.biz/)",
...
<a id='comment:5'></a>[rihanna pictures](http://top20search.biz/)
