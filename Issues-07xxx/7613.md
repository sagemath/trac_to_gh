...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7613#issuecomment-58329",
    "user": "https://github.com/sagetrac-kevin-stueve"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7613#issuecomment-58330",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7613#issuecomment-58331",
    "user": "https://github.com/sagetrac-kevin-stueve"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7613#issuecomment-58332",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52051"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52052"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52054"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52055"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52056"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52057"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7613#event-52058"
}
```
