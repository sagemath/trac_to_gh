...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7613#issuecomment-64898",
...
```json
{
    "body": "After thinking about this some more, this problem seems easier than I had first realized.  You do not need to sieve out all non twin primes to calculate the twin prime counting function.\n\nAs sieving is likely much more computationally demanding than iterating over a bit array, it would be a better to sieve out primes, then iterate through your bit array, noting each twin prime, prime triplet, etc as the case may be.\n\nKevin Stueve",
    "created_at": "2009-12-10T22:36:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7613#issuecomment-64899",
    "user": "https://trac.sagemath.org/admin/accounts/users/kevin.stueve"
}
```
...
```json
{
    "body": "[rihanna pictures](http://top20search.biz/)",
    "created_at": "2010-05-26T08:41:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7613#issuecomment-64900",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18085"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18086"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18087"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18088"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18089"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18090"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7613#event-18091"
}
```
