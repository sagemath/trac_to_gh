...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66549",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66550",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66551",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66552",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Your benchmarks would be more convincing if you used `set_random_seed` beforehand, so you're actually testing the same \"random\" graph.\n\nThe changes to the code look good, and the speedups are impressive.",
    "created_at": "2009-12-01T16:15:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66553",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>Your benchmarks would be more convincing if you used `set_random_seed` beforehand, so you're actually testing the same "random" graph.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66554",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7571#issuecomment-66556",
