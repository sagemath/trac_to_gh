...
```json
{
    "body": "<a id='comment:5'></a>Major progress -- a lot of problems appear to just \"go away\" when using GCC-4.0.x!  In particular, the above issue with \"Abort Trap\" goes away.  The main problem is that some of the fixes I put in for OS X 10.6 with GCC-4.2.x actually break the 4.0.x build....  anyway, I'm very optimistic for a complete resolution to the problem of building Sage on OS X 10.6 using GCC 4.0.x.",
    "created_at": "2009-10-07T17:00:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60500",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>Major progress -- a lot of problems appear to just "go away" when using GCC-4.0.x!  In particular, the above issue with "Abort Trap" goes away.  The main problem is that some of the fixes I put in for OS X 10.6 with GCC-4.2.x actually break the 4.0.x build....  anyway, I'm very optimistic for a complete resolution to the problem of building Sage on OS X 10.6 using GCC 4.0.x.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60501",
...
```json
{
    "body": "<a id='comment:8'></a>The `factorial(factorial(x))` error above is really from `factorial(CIF(1))` which leads to the same error.  Combining this with  fwclarke's remark above, suggests complex interval fields are somehow the one place where things are broken somehow.",
    "created_at": "2009-10-11T01:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60503",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>The `factorial(factorial(x))` error above is really from `factorial(CIF(1))` which leads to the same error.  Combining this with  fwclarke's remark above, suggests complex interval fields are somehow the one place where things are broken somehow.
...
```json
{
    "body": "<a id='comment:10'></a>I wonder about lines 123--124 of local/lib/python/config/Makefile (which have been there since at least 3.1.4):\n\n```\nMACOSX_DEPLOYMENT_TARGET=10.3\nexport MACOSX_DEPLOYMENT_TARGET\n```\nIt seems to be these lines that are giving rise (in 10.6 but not in 10.5) to many warnings of the form\n\n```\n#warning Building for Intel with Mac OS X Deployment Target < 10.4 is invalid.\n```\nWhether this is causing the problems, I don't know, but it does need to be changed (presumably to 10.4).",
    "created_at": "2009-10-15T07:31:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60505",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```

<a id='comment:10'></a>I wonder about lines 123--124 of local/lib/python/config/Makefile (which have been there since at least 3.1.4):
...
```json
{
    "body": "<a id='comment:11'></a>Since we still have no clue, I'm targeting this for 4.3.",
    "created_at": "2009-11-11T17:44:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60506",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>Since we still have no clue, I'm targeting this for 4.3.
...
```json
{
    "body": "<a id='comment:12'></a>Given the comment I put on sage-devel about there two quite respectable parties believing gcc 4.3.3 is the most stable gcc, it might be worth trying a build with gcc 4.3.3. \n\nAlthough it will lengthen the build process a bit, I would be tempted to enable all the mpfr tests by default. They have a habbit of finding compiler bugs. Having known of several mpfr test failures, my experience has always been that the test is ok, and mpfr has discovered a bug in other code. In one case it was the Solaris memset() call, but on an several cases it is gcc bugs. \n\nDave",
    "created_at": "2009-11-29T09:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60507",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:12'></a>Given the comment I put on sage-devel about there two quite respectable parties believing gcc 4.3.3 is the most stable gcc, it might be worth trying a build with gcc 4.3.3. 
...
```json
{
    "body": "<a id='comment:17'></a>There's a lot of patches to the python .spkg file. Some look to me like they might be old and perhaps not needed any more. (There's things done because they caused problems in python 2.5). \n\nIt might be worth updating to 2.6.4 (which is only a bug-fix upgrade), then looking at seeing what python patches are actually necessary, so making a clearer python package. \n\nIt could be one of the patches which is causing the failures.",
    "created_at": "2009-12-21T13:16:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60511",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:17'></a>There's a lot of patches to the python .spkg file. Some look to me like they might be old and perhaps not needed any more. (There's things done because they caused problems in python 2.5). 
...
```json
{
    "body": "<a id='comment:18'></a>See #7022 for perhaps the same matplotlib issue.",
    "created_at": "2009-12-21T17:44:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60512",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:18'></a>See #7022 for perhaps the same matplotlib issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60513",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60514",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I'm declaring a total feature freeze on sage-4.3.  Also, this is clearly not a blocker for making a release so I changed it to critical.",
    "created_at": "2009-12-24T07:07:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60515",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:20'></a>I'm declaring a total feature freeze on sage-4.3.  Also, this is clearly not a blocker for making a release so I changed it to critical.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60516",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>> By the way, with an ordinary (gcc 4.2.1) build of 4.3.1.alpha0, I'm now getting over 90 files with failures\n\n\nI'm seeing this on one OS X 10.6 machine, but not another one, so I'm confused...\n\n> I don't know if this Intel compiler takes the same options as gcc, but I suspect it would.  http://software.intel.com/en-us/articles/intel-software-development-products-for-mac-os-x/ You can get a free trial.\n\n\nUnfortunately, for OS X, I only see a C++ compiler, not a C compiler.",
    "created_at": "2010-01-06T03:01:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60519",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:24'></a>> By the way, with an ordinary (gcc 4.2.1) build of 4.3.1.alpha0, I'm now getting over 90 files with failures
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60520",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>You're right.  I replaced the file \".matplotlib/fontList.cache\" on the broken machine with the one from the working machine, and now more doctests pass.  (I haven't run the full doctesting suite, but I'll do that next.)",
    "created_at": "2010-01-06T04:11:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60521",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:26'></a>You're right.  I replaced the file ".matplotlib/fontList.cache" on the broken machine with the one from the working machine, and now more doctests pass.  (I haven't run the full doctesting suite, but I'll do that next.)
...
```json
{
    "body": "<a id='comment:27'></a>This webpage could be very, very helpful:   http://blog.hyperjeff.net/?p=160\n   \nThe guy claims to be able to get numpy+scipy+matplotlib to actually work from source on Snow Leopard (OS X 10.6)!\n\nWilliam",
    "created_at": "2010-01-06T04:15:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60522",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:27'></a>This webpage could be very, very helpful:   http://blog.hyperjeff.net/?p=160
...
```json
{
    "body": "<a id='comment:29'></a>I hate to bring this up, but didn't drkirkby think that -a and -o were not so good for such scripts?  I can't remember if they were just deprecated or actual so-called \"Gnuisms\"...\n\nOn the plus side, I think jhpalmieri is probably right.  Could the following help?\n\n```\nstring1 < string2\nTrue if string1 sorts before string2 lexicographically in the current locale. \nstring1 > string2\nTrue if string1 sorts after string2 lexicographically in the current locale.\n```\nso maybe a cleaned-up version of \n\n```\nif [ $UNAME = \"Darwin\" && [uname -r > \"10.0.0\" || uname -r = \"10.0.0\"]]; then\n```\ncould work?  Just a naive thought.  Obviously this would only help with the mpl issue, not the rest.",
    "created_at": "2010-01-06T17:16:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60524",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:29'></a>I hate to bring this up, but didn't drkirkby think that -a and -o were not so good for such scripts?  I can't remember if they were just deprecated or actual so-called "Gnuisms"...
...
```json
{
    "body": "<a id='comment:31'></a>See #7856 for a new matplotlib spkg.",
    "created_at": "2010-01-06T17:59:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60526",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:31'></a>See #7856 for a new matplotlib spkg.
...
```json
{
    "body": "<a id='comment:32'></a>The following link looks both useful and promising as to 10.6.3: [http://software.intel.com/en-us/forums/intel-fortran-compiler-for-linux-and-mac-os-x/topic/71015/](http://software.intel.com/en-us/forums/intel-fortran-compiler-for-linux-and-mac-os-x/topic/71015/)\n\nPass this on to your Mac developers...Apple on Wednesday began widespread testing of Mac OS X 10.6.3, the third planned maintenance and security update to its Snow Leopard operating system, early betas of which already includes bug fixes to over seven dozen system components with an emphasis on stabilization. People familiar with the matter say the first external build of the software -- labeled Mac OS X 10.6.3 build 10D522 and weighing in at 665.7MB in barebones delta form -- includes a total of 221 code corrections to 92 distinct system components.",
    "created_at": "2010-01-07T18:47:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60527",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:32'></a>The following link looks both useful and promising as to 10.6.3: [http://software.intel.com/en-us/forums/intel-fortran-compiler-for-linux-and-mac-os-x/topic/71015/](http://software.intel.com/en-us/forums/intel-fortran-compiler-for-linux-and-mac-os-x/topic/71015/)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60529",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>I should have said I don't use OS X a lot. I do sometimes test on bsd.math, but I don't own a Mac.",
    "created_at": "2010-01-08T02:53:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60530",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:35'></a>I should have said I don't use OS X a lot. I do sometimes test on bsd.math, but I don't own a Mac.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60532",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60533",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60534",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60536",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60537",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>For what it's worth, the following article provides some information on the \"clever\" trickery:\n\nhttp://developer.apple.com/mac/library/releasenotes/Darwin/SymbolVariantsRelNotes/",
    "created_at": "2010-01-14T22:57:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60538",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:38'></a>For what it's worth, the following article provides some information on the "clever" trickery:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60539",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60541",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60542",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Yes you are correct, the *if-else-fi* should take care of that. Don't bother about my name. I can live with that error!",
    "created_at": "2010-01-15T01:37:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60543",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:42'></a>Yes you are correct, the *if-else-fi* should take care of that. Don't bother about my name. I can live with that error!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60545",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60546",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60547",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>I spoke too soon. The current python spkg in 4.3.1 is at p5 already. You'll need to grab that:\n\nhttp://boxen.math.washington.edu/home/rlmill/python-2.6.2.p5.spkg\n\nand apply your updates there and make a p6. I'm rolling rc0 without this, so that there's a base for bug days, but I'll do an rc1 just to get this in. Unless someone else thinks better.",
    "created_at": "2010-01-16T05:46:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60548",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:46'></a>I spoke too soon. The current python spkg in 4.3.1 is at p5 already. You'll need to grab that:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60549",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>When we transition from Python 2.6.2 to 2.6.4, do we need to maintain the patch numbering?  2.6.4.p3 contains all of the patches from 2.6.2.p5.",
    "created_at": "2010-01-16T05:50:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60550",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:47'></a>When we transition from Python 2.6.2 to 2.6.4, do we need to maintain the patch numbering?  2.6.4.p3 contains all of the patches from 2.6.2.p5.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60551",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60552",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Oh! I didn't realize you upgraded Python also, I just saw the p*'s.",
    "created_at": "2010-01-16T05:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60553",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:48'></a>Oh! I didn't realize you upgraded Python also, I just saw the p*'s.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60554",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60556",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60557",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>Update: The scipy spkg has the same problem (with the same solution) as the numpy spkg.",
    "created_at": "2010-01-16T22:44:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60558",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:52'></a>Update: The scipy spkg has the same problem (with the same solution) as the numpy spkg.
...
```json
{
    "body": "<a id='comment:53'></a>Replying to [comment:50 jhpalmieri]:\n> Should we just add these lines to sage-env?\n\n\nI'm +1 on this. Has someone rolled a new patch/spkg, or should I do it tonight?",
    "created_at": "2010-01-17T00:55:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60559",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:53'></a>Replying to [comment:50 jhpalmieri]:
> Should we just add these lines to sage-env?
...
```json
{
    "body": "<a id='comment:54'></a>Since I'd made a major update to sage-env which went wrong, as setting CFLAGS had an inadvertant side effect, I'd like to change to do what it does now, but not export CFLAGS, CXXFLATS etc. \n\nI can easily tac those on at the same time. And rolls that out as a refinement of #7817. \n\nI can do that tonight if you want. \n\nDave",
    "created_at": "2010-01-17T01:04:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60560",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:54'></a>Since I'd made a major update to sage-env which went wrong, as setting CFLAGS had an inadvertant side effect, I'd like to change to do what it does now, but not export CFLAGS, CXXFLATS etc. 
...
```json
{
    "body": "<a id='comment:55'></a>Well, I'd like this to get into the next rc, and it sounds like #7818 may get pushed to the next release for more serious testing. So I'd like to go ahead and get something pushed for this ticket ...",
    "created_at": "2010-01-17T01:06:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60561",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:55'></a>Well, I'd like this to get into the next rc, and it sounds like #7818 may get pushed to the next release for more serious testing. So I'd like to go ahead and get something pushed for this ticket ...
...
```json
{
    "body": "<a id='comment:56'></a>ok, go for it",
    "created_at": "2010-01-17T01:08:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60562",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:56'></a>ok, go for it
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60563",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:59'></a>No sweat -- I actually didn't know there was a second copy. (Does sdist and/or bdist do something where it copies the one from local/bin into spkg/base when making a tarball? If not, someone should file an enhancement ticket ...)",
    "created_at": "2010-01-17T18:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60566",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:59'></a>No sweat -- I actually didn't know there was a second copy. (Does sdist and/or bdist do something where it copies the one from local/bin into spkg/base when making a tarball? If not, someone should file an enhancement ticket ...)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60567",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:60'></a>The sage-env in local/bin does not start there - it gets copied there from spkg/base\n\nDave",
    "created_at": "2010-01-17T18:43:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60568",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:60'></a>The sage-env in local/bin does not start there - it gets copied there from spkg/base
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60569",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60570",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:61'></a>Looks OK to me.",
    "created_at": "2010-01-17T19:25:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60571",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:61'></a>Looks OK to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-60573",
    "user": "https://github.com/rlmill"
}
```
