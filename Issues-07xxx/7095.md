...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67345",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67346",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67347",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67348",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67350",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67351",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67352",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67353",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67354",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67355",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67356",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67357",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-67358",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
<a id='comment:16'></a>Replying to [fwclarke](#comment%3A10):
> I wonder about lines 123--124 of local/lib/python/config/Makefile (which have been there since at least 3.1.4):
> 
> ```
> MACOSX_DEPLOYMENT_TARGET=10.3
...
```json
{
    "body": "Changing author from \"\" to \"Craig Citro, John Palmieri, Francis Clarke, William Stein\"",
    "created_at": "2010-01-14T20:11:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
...
Changing author from "" to "Craig Citro, John Palmieri, Francis Clarke, William Stein"
...
<a id='comment:53'></a>Replying to [jhpalmieri](#comment%3A50):
> Should we just add these lines to sage-env?
...
<a id='comment:62'></a>Replying to [jhpalmieri](#comment%3A58):
> Hi Craig,
> 
> Could you also post a copy of the modified sage-env?  There are two copies in sage, one in SAGE_ROOT/local/bin which is part of sage_scripts, and another one (which should be identical) in SAGE_ROOT/spkg/base -- I think this one gets run at the start of the make process.  Does it ever get run later?  Anyway, we should make sure that the two copies are the same, and the release manager might need sage-env posted here for that.
