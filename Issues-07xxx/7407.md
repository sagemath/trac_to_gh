...
```json
{
    ...
    "created_at": "2009-11-30T22:33:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72117",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72118",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I modified the title and description slightly, since with second thoughts, perhaps its best to leave the name of the file unchaged. \n\nDave",
    "created_at": "2009-12-09T15:43:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72119",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>I modified the title and description slightly, since with second thoughts, perhaps its best to leave the name of the file unchaged. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72121",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Here's a patch, changing the options to -pPR for all platforms.  This needs testing on a variety of platforms.  It seems to work for me on a Mac and on sage.math.  Something similar worked for me on t2 before, and I'll try this patch with t2 when I've built sage there.",
    "created_at": "2010-06-09T20:44:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72122",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Here's a patch, changing the options to -pPR for all platforms.  This needs testing on a variety of platforms.  It seems to work for me on a Mac and on sage.math.  Something similar worked for me on t2 before, and I'll try this patch with t2 when I've built sage there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72123",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72124",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>When you say it works, is the binary distribution a sensible size? I've found ways before, which meant that libraries were copied rather than links made, which swelled the size of the binary considerably. \n\nDave",
    "created_at": "2010-06-09T20:47:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72125",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>When you say it works, is the binary distribution a sensible size? I've found ways before, which meant that libraries were copied rather than links made, which swelled the size of the binary considerably. 
...
```json
{
    "body": "<a id='comment:9'></a>It applied cleanly:\n\n```\ndrkirkby@redstart:~/32/sage-4.4.3$ time ./sage -bdist Solaris10_release_3_05_for_sun4u_or_sun4v\nSage works!\nCopying files over to tmp directory\n```\n\ntime for bed!",
    "created_at": "2010-06-09T23:01:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72128",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:9'></a>It applied cleanly:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72129",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>This works well. The resulting binaries work fine (tested on both Solaris and Linux). \n\nPositive review.",
    "created_at": "2010-06-11T01:12:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72130",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:10'></a>This works well. The resulting binaries work fine (tested on both Solaris and Linux). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72131",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72132",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72134",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7407#issuecomment-72135",
    "user": "https://github.com/mwhansen"
}
```
