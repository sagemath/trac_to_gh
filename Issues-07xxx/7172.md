...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7172#issuecomment-68369",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7172#issuecomment-68370",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7172#issuecomment-68371",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7172#issuecomment-68372",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Since Sage ships `gmp.h` (by MPIR), this is a non-issue.",
    "created_at": "2013-06-03T15:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7172#issuecomment-68373",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>Since Sage ships `gmp.h` (by MPIR), this is a non-issue.
