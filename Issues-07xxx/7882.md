...
```json
{
    "body": "<a id='comment:1'></a>Attachment [Macaulay2_prompt_only_in_the_beginning_of_lines.patch](tarball://root/attachments/some-uuid/ticket7882/Macaulay2_prompt_only_in_the_beginning_of_lines.patch) by @novoselt created at 2010-01-09 20:02:48",
    "created_at": "2010-01-09T20:02:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7882#issuecomment-79999",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:1'></a>Attachment [Macaulay2_prompt_only_in_the_beginning_of_lines.patch](tarball://root/attachments/some-uuid/ticket7882/Macaulay2_prompt_only_in_the_beginning_of_lines.patch) by @novoselt created at 2010-01-09 20:02:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7882#issuecomment-80000",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7882#issuecomment-80001",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7882#issuecomment-80002",
    "user": "https://github.com/novoselt"
}
```
