...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72112"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72114"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7107#issuecomment-52650",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72116"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7107",
    "rename": {
        "from": "sage does not build on ppc os x 10.4 anymore, failing with mpfr",
        "to": "[with solution, needs patch and review] sage does not build on ppc os x 10.4 anymore, failing with mpfr"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72117"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7107#issuecomment-52651",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7107#issuecomment-52652",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7107",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72119"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72120"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7107#event-72121"
}
```
