...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7107#issuecomment-60722",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Just to confirm that this seems to work.  I can find_root, I can do factor(factorial(100000)), and various other things.  Doesn't mean it's perfect, but at least Sage will build and run if you don't do the spkg-check for mpfr.",
    "created_at": "2009-10-08T00:30:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7107#issuecomment-60723",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Just to confirm that this seems to work.  I can find_root, I can do factor(factorial(100000)), and various other things.  Doesn't mean it's perfect, but at least Sage will build and run if you don't do the spkg-check for mpfr.
...
```json
{
    "body": "<a id='comment:5'></a>Another followup - I changed the script back to include spkg-check, sage -f'ed the spkg, and all mpfr test files built, and all mpfr tests passed.    Again, this is PPC G4 box running OSX.4.  Is it possible to try this again on varro?",
    "created_at": "2009-10-08T11:11:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7107#issuecomment-60724",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>Another followup - I changed the script back to include spkg-check, sage -f'ed the spkg, and all mpfr test files built, and all mpfr tests passed.    Again, this is PPC G4 box running OSX.4.  Is it possible to try this again on varro?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7107#issuecomment-60725",
    "user": "https://github.com/williamstein"
}
```
