...
```json
{
    "body": "<a id='comment:15'></a>There was a merge conflict with the current development branch.  I also fixed a doctest and made the changes suggested by Johan in[comment:9](#comment%3A9).  If you agree with these, it is a positive review from me.",
    "created_at": "2014-04-24T14:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7191",
    "type": "issue_comment",
...
<a id='comment:15'></a>There was a merge conflict with the current development branch.  I also fixed a doctest and made the changes suggested by Johan in[comment:9](#comment%3A9).  If you agree with these, it is a positive review from me.
