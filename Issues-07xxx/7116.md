...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52750",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52751",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52752",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_7116-miller_functions.patch](https://github.com/sagemath/sage/files/ticket7116/trac_7116-miller_functions.patch) by @JohnCremona created at 2009-10-04 20:25:51\n\nThe patch tests for Q=0 in the functions `_line_` and `_miller_` and raise an error if so.  Doctests added.",
    "created_at": "2009-10-04T20:25:51Z",
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52753",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52754",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52755",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52756",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7116#issuecomment-52758",
    "user": "https://github.com/mwhansen"
}
```
