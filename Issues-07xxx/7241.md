...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69290",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_7241.patch](tarball://root/attachments/some-uuid/ticket7241/trac_7241.patch) by @mwhansen created at 2009-10-18 17:44:06\n\nIt would also be nice to have it use a more robust downloader such as cURL or wget if it is present.  The current one doesn't resume downloads.",
    "created_at": "2009-10-18T17:44:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69291",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>Attachment [trac_7241.patch](tarball://root/attachments/some-uuid/ticket7241/trac_7241.patch) by @mwhansen created at 2009-10-18 17:44:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69293",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69294",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>For some reason the patch needed a little rebase. I just uploaded a rebased patch which is ready to go. => positive review. \n\nCheers,\n\nFlorent",
    "created_at": "2009-11-07T08:58:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69295",
    "user": "https://github.com/hivert"
}
```

<a id='comment:2'></a>For some reason the patch needed a little rebase. I just uploaded a rebased patch which is ready to go. => positive review. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69296",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7241#issuecomment-69297",
    "user": "https://github.com/mwhansen"
}
```
