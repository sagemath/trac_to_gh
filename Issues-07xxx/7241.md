...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_7241.patch](https://github.com/sagemath/sage/files/ticket7241/trac_7241.patch) by @mwhansen created at 2009-10-18 17:44:06\n\nIt would also be nice to have it use a more robust downloader such as cURL or wget if it is present.  The current one doesn't resume downloads.",
    "created_at": "2009-10-18T17:44:06Z",
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7241#issuecomment-53774",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "Attachment [trac_7241-rebase.patch](https://github.com/sagemath/sage/files/ticket7241/trac_7241-rebase.patch) by @hivert created at 2009-11-07 08:56:52",
    "created_at": "2009-11-07T08:56:52Z",
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7241#issuecomment-53775",
    "user": "https://github.com/hivert"
}
```

Attachment [trac_7241-rebase.patch](https://github.com/sagemath/sage/files/ticket7241/trac_7241-rebase.patch) by @hivert created at 2009-11-07 08:56:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7241#issuecomment-53776",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7241#issuecomment-53777",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7241#issuecomment-53778",
    "user": "https://github.com/mwhansen"
}
```
