...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7772#event-87419"
}
```
...
```json
{
    "body": "Changed keywords from **** to **tutorial**",
...
Changed keywords from **** to **tutorial**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7772#issuecomment-60248",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7772#issuecomment-60249",
