...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69606",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69607",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>By the way, should we \"polish\" `interact`'s docstring and move it to the top of its reference manual section?",
    "created_at": "2009-11-08T05:33:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69610",
    "user": "https://github.com/qed777"
}
```

<a id='comment:3'></a>By the way, should we "polish" `interact`'s docstring and move it to the top of its reference manual section?
...
```json
{
    "body": "<a id='comment:4'></a>Although both of the new jQuery plug-ins are relatively short, we should consider loading them lazily.  [Ajile](http://ajile.net/) may help.  I'll try to investigate.",
    "created_at": "2009-11-08T05:38:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69611",
    "user": "https://github.com/qed777"
}
```

<a id='comment:4'></a>Although both of the new jQuery plug-ins are relatively short, we should consider loading them lazily.  [Ajile](http://ajile.net/) may help.  I'll try to investigate.
...
```json
{
    "body": "<a id='comment:5'></a>I should add that I have absolutely no problem with not including one or both selectors in `head.tmpl.`  I'll just need to update `interact.py`.  But I think we should have a compact color picker for the settings pages.",
    "created_at": "2009-11-10T03:36:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69612",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>I should add that I have absolutely no problem with not including one or both selectors in `head.tmpl.`  I'll just need to update `interact.py`.  But I think we should have a compact color picker for the settings pages.
...
```json
{
    "body": "<a id='comment:7'></a>IMHO, it may be best to have a particular reason to include these packages (i.e., create a patch that makes use of either of them) first, so as to prevent including these and leaving them orphaned in the source tree. I personally favor ColorPicker over jPicker, since it is more customizable, and apparently has better functionality, as you previously remarked.",
    "created_at": "2009-11-15T10:25:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69613",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:7'></a>IMHO, it may be best to have a particular reason to include these packages (i.e., create a patch that makes use of either of them) first, so as to prevent including these and leaving them orphaned in the source tree. I personally favor ColorPicker over jPicker, since it is more customizable, and apparently has better functionality, as you previously remarked.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69615",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69617",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69618",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69619",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I merged this patch into sagenb-0.4.6.",
    "created_at": "2009-12-09T01:12:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69620",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>I merged this patch into sagenb-0.4.6.
...
```json
{
    "body": "<a id='comment:12'></a>Thanks!  On version numbers:  We could use symbolic links, but I don't think they're available on Windows (cf. [os](http://docs.python.org/library/os.html), #6614).",
    "created_at": "2009-12-10T00:58:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69621",
    "user": "https://github.com/qed777"
}
```

<a id='comment:12'></a>Thanks!  On version numbers:  We could use symbolic links, but I don't think they're available on Windows (cf. [os](http://docs.python.org/library/os.html), #6614).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69622",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69623",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7267#issuecomment-69624",
