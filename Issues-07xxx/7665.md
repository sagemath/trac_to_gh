...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76355",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>On Snow Leopard (OSX 10.6), re-enabling aqua allows the following:\n\n```\nsage: r.quartz(type='png')\nNULL # But nice quartz viewer pops up!\nsage: x = r([1,2,3])\nsage: y = r([4,5,6])\nsage: r.plot(x,y) # Nice plot of this pops up!\nNULL\nsage: r.dev_off() # Turns off the quartz viewer\nnull device \n          1 \n```",
    "created_at": "2010-02-09T15:36:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76357",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>On Snow Leopard (OSX 10.6), re-enabling aqua allows the following:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76358",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76360",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76361",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76362",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Changing to 'needs work' based on some discussion with an R developer that might solve the issue completely or provide more options for plotting (separate device, just popping up png as usual, etc.) and allow use of the other plot commands in the notebook.",
    "created_at": "2010-02-12T11:56:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76363",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Changing to 'needs work' based on some discussion with an R developer that might solve the issue completely or provide more options for plotting (separate device, just popping up png as usual, etc.) and allow use of the other plot commands in the notebook.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76364",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76366",
...
```json
{
    "body": "<a id='comment:10'></a>Umm... what comments?  It looks like this removes a reference to a directory - will this break anything else or cause a security problem?  Unfortunately I don't have an easy way to test this on the sagenb repo, since we still don't have hg_sagenb.\n\nI'm also surprised I was able to make a change to the ticket after you had already made this change!",
    "created_at": "2010-04-13T17:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76367",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Umm... what comments?  It looks like this removes a reference to a directory - will this break anything else or cause a security problem?  Unfortunately I don't have an easy way to test this on the sagenb repo, since we still don't have hg_sagenb.
...
```json
{
    "body": "<a id='comment:11'></a>Depends on #7997. Before this patch, non-Sage systems are made to switch to the cell directory, which, aside from being a security vulnerability (I think?), doesn't seem to be possible with server pools. This removes the directory change, so that evaluation is done in the temporary directory.\n\nIf you want, I'll post a custom sagenb package with this patch, so you can try it out. (It will have a bunch of other (positively reviewed) patches in the queue, too, though.)",
    "created_at": "2010-04-13T17:22:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76368",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:11'></a>Depends on #7997. Before this patch, non-Sage systems are made to switch to the cell directory, which, aside from being a security vulnerability (I think?), doesn't seem to be possible with server pools. This removes the directory change, so that evaluation is done in the temporary directory.
...
```json
{
    "body": "<a id='comment:12'></a>Thanks, Tim, that would be fantastic to have the sagenb package to try this out.  I wish I had access to a GUI to test notebook behavior on sage.math... otherwise I don't have access to a Linux box.",
    "created_at": "2010-04-13T17:32:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76369",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:12'></a>Thanks, Tim, that would be fantastic to have the sagenb package to try this out.  I wish I had access to a GUI to test notebook behavior on sage.math... otherwise I don't have access to a Linux box.
...
```json
{
    "body": "<a id='comment:13'></a>The new spkg is here: http://sage.math.washington.edu/home/timdumol/sagenb-0.7.5.3-devel-7665.spkg\n\nYou could launch a temporary Sage notebook server, and try that out.\n\n```\n\nsage: notebook(interface=\"\", secure=True, port=10000)\n\n```",
    "created_at": "2010-04-13T17:37:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76370",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:13'></a>The new spkg is here: http://sage.math.washington.edu/home/timdumol/sagenb-0.7.5.3-devel-7665.spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76372",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>So maybe \n\n```\n-def _eval_cmd(self, system, cmd, dir): \n+def _eval_cmd(self, system, cmd): \n```\nwould suffice?  I'll try this out.",
    "created_at": "2010-04-13T19:37:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76374",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:17'></a>So maybe 
...
```json
{
    "body": "<a id='comment:18'></a>Unfortunately, making the changes indicated in the patch along with this change in vanilla Sage-4.3.5 doesn't fix the problem either, though I can now use Shift+Enter again.  So somehow this isn't doing the job.",
    "created_at": "2010-04-13T20:03:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76375",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>Unfortunately, making the changes indicated in the patch along with this change in vanilla Sage-4.3.5 doesn't fix the problem either, though I can now use Shift+Enter again.  So somehow this isn't doing the job.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76376",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76377",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Ah, sorrry. I managed to attach and package the incomplete version of the patch (which still didn't work properly). This should do the job. I'll be posting an updated spkg soon.",
    "created_at": "2010-04-14T01:14:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76378",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:19'></a>Ah, sorrry. I managed to attach and package the incomplete version of the patch (which still didn't work properly). This should do the job. I'll be posting an updated spkg soon.
...
```json
{
    "body": "<a id='comment:20'></a>Alright, new spkg up at the same link: http://sage.math.washington.edu/home/timdumol/sagenb-0.7.5.3-devel-7665.spkg",
    "created_at": "2010-04-14T01:22:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76379",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:20'></a>Alright, new spkg up at the same link: http://sage.math.washington.edu/home/timdumol/sagenb-0.7.5.3-devel-7665.spkg
...
```json
{
    "body": "<a id='comment:22'></a>I don't think that's the problem. The problem, as far as I can tell, is that the interpreter is reused between sessions, and so its working directory has to be changed each time to the temp folder used for evaluation.",
    "created_at": "2010-04-14T12:29:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76381",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:22'></a>I don't think that's the problem. The problem, as far as I can tell, is that the interpreter is reused between sessions, and so its working directory has to be changed each time to the temp folder used for evaluation.
...
```json
{
    "body": "<a id='comment:24'></a>I posted the wrong patch. Let me get the right one.",
    "created_at": "2010-04-14T17:49:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76383",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:24'></a>I posted the wrong patch. Let me get the right one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76384",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>This is the right one. trac_7665-sage-library-R-plotting.patch is to be applied to the main Sage library, trac_7655-sagenb-R-plotting.2.patch is to be applied to sagenb, or used via the spkg.",
    "created_at": "2010-04-14T17:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76385",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:25'></a>This is the right one. trac_7665-sage-library-R-plotting.patch is to be applied to the main Sage library, trac_7655-sagenb-R-plotting.2.patch is to be applied to sagenb, or used via the spkg.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76386",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>It took me a while to figure out what this was about, but you need this so that syseval in server/support.py works correctly, right?  It works!  Wonderful, and thank you.\n\nOkay, that doesn't mean I'm done with this ticket, but at any rate hopefully within the next day or two I will have resolved this to my satisfaction and then it can be reviewed.  \n\nIncidentally, \"know it's ID\" should be \"know its ID\" :-)",
    "created_at": "2010-04-14T18:53:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76387",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:26'></a>It took me a while to figure out what this was about, but you need this so that syseval in server/support.py works correctly, right?  It works!  Wonderful, and thank you.
...
```json
{
    "body": "<a id='comment:27'></a>Sorry :P Was a bit sleepy when I wrote the documentation.",
    "created_at": "2010-04-15T00:07:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76388",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:27'></a>Sorry :P Was a bit sleepy when I wrote the documentation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76389",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76393",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>I get test failures in sagenb/notebook/cell.py and sagenb/notebook/notebook.py which seem unrelated to this ticket on the spkg .p0 I post with above, as well as the sagenb/notebook/worksheet.py errors which are dealt with in timdumol's updated patch.  Having an \"official\" sagenb package to test would be really great.  Otherwise the following patch is the only one that has to be applied to the Sage library.",
    "created_at": "2010-04-20T01:29:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76394",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:31'></a>I get test failures in sagenb/notebook/cell.py and sagenb/notebook/notebook.py which seem unrelated to this ticket on the spkg .p0 I post with above, as well as the sagenb/notebook/worksheet.py errors which are dealt with in timdumol's updated patch.  Having an "official" sagenb package to test would be really great.  Otherwise the following patch is the only one that has to be applied to the Sage library.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76395",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Need to apply new R spkg [http://sage.math.washington.edu/home/kcrisman/r-2.10.1.p1.spkg](http://sage.math.washington.edu/home/kcrisman/r-2.10.1.p1.spkg) and some new version of sagenb package to test this, as well as the Sage library patch.",
    "created_at": "2010-04-20T01:41:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76396",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:32'></a>Need to apply new R spkg [http://sage.math.washington.edu/home/kcrisman/r-2.10.1.p1.spkg](http://sage.math.washington.edu/home/kcrisman/r-2.10.1.p1.spkg) and some new version of sagenb package to test this, as well as the Sage library patch.
...
```json
{
    "body": "<a id='comment:33'></a>The SageNB package version suitable for testing this is at #8727.",
    "created_at": "2010-04-20T16:14:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76397",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:33'></a>The SageNB package version suitable for testing this is at #8727.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76399",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>Positive review, subject to anybody at all signing off on my referee patch (which is pure documentation) and sagenb rebase.",
    "created_at": "2010-04-24T23:46:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76400",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:35'></a>Positive review, subject to anybody at all signing off on my referee patch (which is pure documentation) and sagenb rebase.
...
```json
{
    "body": "Changing reviewer from \"\" to \"William Stein, John Verzani\"",
    "created_at": "2010-04-25T00:04:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76401",
    "user": "https://github.com/kcrisman"
}
```

Changing reviewer from "" to "William Stein, John Verzani"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76403",
...
```json
{
    "body": "<a id='comment:37'></a>Recent two patches both apply and build, library-part2 is just documentation changes.\n\nI got an r.plot() out just fine, though an r.bwplot() didn't do anything.\n\nSo the recent changes by was look just fine, ie this is a sign-off on those, so as mentioned I'm changing this to positive review.",
    "created_at": "2010-04-25T00:13:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76404",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:37'></a>Recent two patches both apply and build, library-part2 is just documentation changes.
...
```json
{
    "body": "<a id='comment:38'></a>You need to call r.dev_off() to get the r.bwplot() guy.  Great!",
    "created_at": "2010-04-25T00:16:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76405",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:38'></a>You need to call r.dev_off() to get the r.bwplot() guy.  Great!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76406",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Merged into sagneb-0.8.p0 in sage-4.4.1.alpha2",
    "created_at": "2010-04-29T05:26:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76408",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:40'></a>Merged into sagneb-0.8.p0 in sage-4.4.1.alpha2
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76409",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76410",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7665#event-18268"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>[\u043a\u0430\u0440\u0442\u0438\u043d\u043a\u0438 \u043f\u0440\u043e \u0436\u0438\u0432\u043e\u0442\u043d\u044b\u0445](http://rapidshare.in.ua/)",
    "created_at": "2010-04-30T14:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76411",
    "user": "https://trac.sagemath.org/admin/accounts/users/bascorp"
}
```

<a id='comment:41'></a>[картинки про животных](http://rapidshare.in.ua/)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7665#issuecomment-76414",
