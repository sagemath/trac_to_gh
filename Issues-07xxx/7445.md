...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72577",
...
```json
{
    "body": "<a id='comment:2'></a>A suggestion for anybody who might implement this.  It might be nice to be able to add a caption, or explanatory text, as part of an automated conversion to an HTML page.  Maybe a command to use at the command line could include a \"caption\" keyword, or from the notebook a dialog might pop-up to ask?",
    "created_at": "2009-11-12T22:42:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72578",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:2'></a>A suggestion for anybody who might implement this.  It might be nice to be able to add a caption, or explanatory text, as part of an automated conversion to an HTML page.  Maybe a command to use at the command line could include a "caption" keyword, or from the notebook a dialog might pop-up to ask?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72579",
...
```json
{
    "body": "<a id='comment:4'></a>See discussion at http://groups.google.com/group/sage-edu/browse_thread/thread/d497a28ac9dcac11?hl=en\n\nIn particular, in the latest versions of jmol one can set defaultdirectory to be inside the zip file, negating the need for an external script that does (only) that.",
    "created_at": "2010-01-07T06:32:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72580",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:4'></a>See discussion at http://groups.google.com/group/sage-edu/browse_thread/thread/d497a28ac9dcac11?hl=en
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72581",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72582",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7445#issuecomment-72583",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
