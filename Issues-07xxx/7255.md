...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7255#issuecomment-68053",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "rename": {
        "from": "sagenb notebook: reset() causes the worksheet to stop working.  fix this.",
        "to": "[with patch; needs review] sagenb notebook: reset() causes the worksheet to stop working.  fix this."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7255#event-29301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7255#issuecomment-68054",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7255#issuecomment-68055",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7255#issuecomment-68056",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "rename": {
        "from": "[with patch; needs review] sagenb notebook: reset() causes the worksheet to stop working.  fix this.",
        "to": "[with patch; positive review] sagenb notebook: reset() causes the worksheet to stop working.  fix this."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7255#event-29302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7255#issuecomment-68057",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7255#event-29303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7255#issuecomment-68058",
    "user": "https://github.com/williamstein"
}
```
