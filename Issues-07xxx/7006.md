...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65033",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65034",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "rename": {
        "from": "[with patch; needs review] os x 10.6 port -- update mpir to autodetect ABI on OS X since ABI=32 is *no* longer necessarily the default on 10.6",
        "to": "[with patch; needs work] os x 10.6 port -- update mpir to autodetect ABI on OS X since ABI=32 is *no* longer necessarily the default on 10.6"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7006#event-28325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65035",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "rename": {
        "from": "[with patch; needs work] os x 10.6 port -- update mpir to autodetect ABI on OS X since ABI=32 is *no* longer necessarily the default on 10.6",
        "to": "[with spkg, positive review] os x 10.6 port -- update mpir to autodetect ABI on OS X since ABI=32 is *no* longer necessarily the default on 10.6"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7006#event-28326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7006#event-28327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65037",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65038",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65039",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65040",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-65041",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
