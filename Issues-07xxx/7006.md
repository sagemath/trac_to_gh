...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66390",
...
```json
{
    "body": "<a id='comment:2'></a>New version here that should behave as before on all older os x's:\n\n  http://sage.math.washington.edu/home/wstein/patches/mpir-1.2.p6.spkg",
    "created_at": "2009-09-25T21:51:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66392",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>New version here that should behave as before on all older os x's:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66394",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66395",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66396",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66397",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7006#issuecomment-66398",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
