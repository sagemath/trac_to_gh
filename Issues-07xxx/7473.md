...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80696"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80699"
}
```
...
```json
{
    "body": "<a id='comment:7'>Comment 7:</a>\nAttachment: **[trac_7473-scripts_clone.patch.gz](https://github.com/sagemath/sage/files/ticket7473/trac_7473-scripts_clone.patch.gz)**\n\nI *think* the [attached patch] for the scripts repository prevents the hang when cloning.  The [attachment:trac_7473-sage_builder.patch sage repository patch](https://github.com/sagemath/sage/files/ticket7473/trac_7473-scripts_clone.patch.gz) should ensure that we usually keep just one copy of the reference manual's `environment.pickle`.\n\nBut I'm still not sure about how to avoid rebuilding nearly all of the manual when cloning or after trivially switching branches.  The latter may be a separate problem.",
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80701"
}
```
...
```json
{
    "body": "<a id='comment:11'>Comment 11:</a>\nnthiery, ncohen:  If you have a chance, could you let us know if the patches above work?  In particular,\n\n* Apply [attachment: trac_7473-sage_builder.patch.gz](https://github.com/sagemath/sage/files/ticket7473/trac_7473-sage_builder.patch.gz) to the sage repository.\n* Apply [attachment: trac_7473-scripts_clone_v3.patch.gz](https://github.com/sagemath/sage/files/ticket7473/trac_7473-scripts_clone_v3.patch.gz) to the scripts repository.\n\nIf this is yet another false positive, I apologize.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80702"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80703"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56429",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80704"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80705"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56430",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56431",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56432",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56433",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56434",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56435",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7473#issuecomment-56436",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7473",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7473#event-80710"
}
```
