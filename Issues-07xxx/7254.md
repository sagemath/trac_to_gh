...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80282"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-53918",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-53919",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-53920",
...
```json
{
    "body": "<a id='comment:16'>Comment 16:</a>\nUnless I'm wrong, only the [attached patch] and the changes in [comment 13](#comment%3A13) were merged into [an ancestor of](https://github.com/sagemath/sage/files/ticket7254/trac_7254.patch.gz) sagenb 0.4 (and Sage 4.2).  Moreover, sagenb 0.4 is exactly the notebook version running on sagenb.org.\n\nI think we should close this ticket.",
    "created_at": "2009-11-01T01:04:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-53921",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-53922",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-53923",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80294"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80296"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80297"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80298"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-80300"
}
```
