...
```json
{
    "body": "<a id='comment:16'></a>Unless I'm wrong, only the [attachment:trac_7254.patch attached patch] and the changes in [comment 13](#comment%3A13) were merged into [an ancestor of] sagenb 0.4 (and Sage 4.2).  Moreover, sagenb 0.4 is exactly the notebook version running on sagenb.org.\n\nI think we should close this ticket.",
...
<a id='comment:16'></a>Unless I'm wrong, only the [attachment:trac_7254.patch attached patch] and the changes in [comment 13](#comment%3A13) were merged into [an ancestor of] sagenb 0.4 (and Sage 4.2).  Moreover, sagenb 0.4 is exactly the notebook version running on sagenb.org.
