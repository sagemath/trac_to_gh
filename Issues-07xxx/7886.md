...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61660",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    "body": "Attachment [trac_7886_conjugacy_classes.patch](https://github.com/sagemath/sage/files/ticket7886/trac_7886_conjugacy_classes.patch) by jlopez created at 2011-12-06 18:01:03\n\nConjugacy classes code",
    "created_at": "2011-12-06T18:01:03Z",
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61661",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```

Attachment [trac_7886_conjugacy_classes.patch](https://github.com/sagemath/sage/files/ticket7886/trac_7886_conjugacy_classes.patch) by jlopez created at 2011-12-06 18:01:03
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54646"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61662",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61663",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61664",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61665",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61666",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac_7886_conjugacy_classes_module.patch](https://github.com/sagemath/sage/files/ticket7886/trac_7886_conjugacy_classes_module.patch) by jlopez created at 2011-12-07 16:46:30\n\nUpdated the conjugacy_classes.py module with the fixed `_cmp_` method so that the testsuite passes. All test pass on my machine, so ready for review.",
    "created_at": "2011-12-07T16:46:30Z",
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61667",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61668",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61669",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61670",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54647"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61671",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61672",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54649"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61673",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61674",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54651"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54652"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>\nAttachment [trac_7886_conjugacy_classes_encoding_fix.patch](https://github.com/sagemath/sage/files/ticket7886/trac_7886_conjugacy_classes_encoding_fix.patch) by jlopez created at 2011-12-12 11:51:23\n\nSorry, I thought we were using utf-8 by default. Fixed the encoding in permgroup.py and conjugacy_classes.py\nAlso implemented a more efficient fallback method using TransitiveIdeal.\nNeeds review.",
    "created_at": "2011-12-12T11:51:23Z",
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61675",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61676",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61677",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7886#issuecomment-61678",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54653"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54654"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54655"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54656"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54657"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54658"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54659"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54660"
}
```
...
```json
{
    "body": "Attachment [trac_7886_conjugacy_classes_combined.patch](https://github.com/sagemath/sage/files/ticket7886/trac_7886_conjugacy_classes_combined.patch) by @tscrim created at 2013-02-22 17:19:01",
    "created_at": "2013-02-22T17:19:01Z",
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_comment",
...
Attachment [trac_7886_conjugacy_classes_combined.patch](https://github.com/sagemath/sage/files/ticket7886/trac_7886_conjugacy_classes_combined.patch) by @tscrim created at 2013-02-22 17:19:01
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54661"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54662"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7886",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7886#event-54664"
}
```
