...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75743"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75744"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75751"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75752"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75753"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75754"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -29,9 +29,7 @@\n \n ```\n \n-This is still an issue with the palp-2.0.p0 spkg at #12055\n \n----\n-\n-**spkg**:\n-[http://wstein.org/home/ohanar/spkgs/palp-2.0.p1.spkg](http://wstein.org/home/ohanar/spkgs/palp-2.0.p1.spkg)\n+To update:\n+* Replace the palp spkg with [http://wstein.org/home/ohanar/spkgs/palp-2.0.p1.spkg](http://wstein.org/home/ohanar/spkgs/palp-2.0.p1.spkg)\n+* Apply [attachment: trac-12055-SAGELOCAL_BIN.patch.gz](https://github.com/sagemath/sage/files/ticket7071/trac-12055-SAGELOCAL_BIN.patch.gz)\n``````\n",
    "created_at": "2012-02-27T01:09:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7071",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75755"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75757"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7071#issuecomment-52320",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75759"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7071",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7071#event-75760"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7071#issuecomment-52321",
    "user": "https://github.com/jdemeyer"
}
```
