...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62576",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "Attachment [trac_7968.patch](https://github.com/sagemath/sage/files/ticket7968/trac_7968.patch) by @williamstein created at 2010-01-17 22:41:18",
    "created_at": "2010-01-17T22:41:18Z",
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62577",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac_7968.patch](https://github.com/sagemath/sage/files/ticket7968/trac_7968.patch) by @williamstein created at 2010-01-17 22:41:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62578",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62579",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62580",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62581",
    "user": "https://github.com/rlmill"
}
```
