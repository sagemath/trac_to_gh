...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78065",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78066",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78068",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78069",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78070",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This may need slight rebasing after #7665.",
    "created_at": "2010-04-27T20:29:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78071",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>This may need slight rebasing after #7665.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78072",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78073",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78075",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78076",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The above isn't really a problem; it says explicitly that it requires the Hmisc R package, and should be expected to fail unless you have it, which is why it's optional.\n\nThe change in the reviewer patch is not okay, though.  If R does not start or causes an error, it is silent, but the two print statements will still happen (I just checked this by introducing a typo in the R command).  Can you try that again - I assume you were connected to the internet when you tested it, as the optional flag says?",
    "created_at": "2010-05-10T15:48:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78077",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>The above isn't really a problem; it says explicitly that it requires the Hmisc R package, and should be expected to fail unless you have it, which is why it's optional.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7771#issuecomment-78079",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18590"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18591"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18592"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18593"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18594"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18595"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7771#event-18596"
}
```
