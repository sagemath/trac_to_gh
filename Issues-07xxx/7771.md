...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7771#event-87403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7771#issuecomment-60238",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Changed keywords from **** to **r-project, R**",
    "created_at": "2012-05-21T13:18:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7771#issuecomment-60239",
    "user": "https://github.com/kcrisman"
}
```

Changed keywords from **** to **r-project, R**
