...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7780#issuecomment-60289",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7780#issuecomment-60290",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7780/trac_7780-docstring.patch",
    "created_at": "2009-12-28T16:58:31Z",
    "issue": "https://github.com/sagemath/sage/issues/7780",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7780/trac_7780-docstring.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_7780-docstring.patch](https://github.com/sagemath/sage/files/ticket7780/trac_7780-docstring.patch) by @JohnCremona created at 2009-12-28 16:58:31\n\nPatch attached.  Review is trivial but requires waiting for docs to rebuild...",
    "created_at": "2009-12-28T16:58:31Z",
    "issue": "https://github.com/sagemath/sage/issues/7780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7780#issuecomment-60291",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7780#issuecomment-60292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7780#issuecomment-60293",
    "user": "https://github.com/JohnCremona"
}
```
