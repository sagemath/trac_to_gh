...
{
    "assignees": [],
    "body": "We have not been doctesting SageNB files as often as we test Sage files.\n\nPlease apply\n\n* [attachment: trac_7650-scripts_doctest_force_lib_v5.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-scripts_doctest_force_lib_v5.patch.gz) to the scripts repository.  This adds two options to `sage -t`: `-sagenb` tests all SageNB files and `-force_lib` tests files *as if* they live in `SAGE_ROOT/devel/sage`, i.e., in the Sage library.\n\n* [**and** [attachment: trac_7650-reviewer_v2.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-reviewer_v2.patch.gz)(https://github.com/sagemath/sage/files/ticket7650/746a88b2f103f8cb8cb7535ec0238ac2.gz) to the sagenb repository.  This fixes broken SageNB tests.\n\nand replace `SAGE_ROOT/makefile` with\n\n* [attachment: makefile.gz](https://github.com/sagemath/sage/files/ticket7650/makefile.gz).  This makes `make test` and `make ptest` test all SageNB files, too.\n\nDependencies: Sage 4.3.1.alpha1, #7269.\n\nAssignee: **@williamstein**\n\nCC:  @williamstein @TimDumol @mwhansen @jasongrout\n\nAuthor: **Mitesh Patel**\n\nReviewer: **Tim Dumol**\n\nMerged: **sage-4.3.1.rc1**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/7650_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83132"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83140"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83141"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83146"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83147"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83150"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,12 @@\n-`sage -t sagenb/` yields several\n+We have not been doctesting SageNB files as often as we test Sage files.\n \n-```\n-A mysterious error (perhaps a memory error?) occurred, which may have crashed doctest.\n-```\n+Please apply\n \n+* [attachment: trac_7650-scripts_doctest_force_lib_v5.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-scripts_doctest_force_lib_v5.patch.gz) to the scripts repository.  This adds two options to `sage -t`: `-sagenb` tests all SageNB files and `-force_lib` tests files *as if* they live in `SAGE_ROOT/devel/sage`, i.e., in the Sage library.\n+\n+* [attachment: trac_7650-sagenb_doctesting_v2.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v2.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n+\n+and replace `SAGE_ROOT/makefile` with\n+\n+* [attachment: makefile.gz](https://github.com/sagemath/sage/files/ticket7650/makefile.gz).  This makes `make test` and `make ptest` test all SageNB files, too.\n+\n``````\n",
    "created_at": "2009-12-28T23:20:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7650",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,9 +4,10 @@\n \n * [attachment: trac_7650-scripts_doctest_force_lib_v5.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-scripts_doctest_force_lib_v5.patch.gz) to the scripts repository.  This adds two options to `sage -t`: `-sagenb` tests all SageNB files and `-force_lib` tests files *as if* they live in `SAGE_ROOT/devel/sage`, i.e., in the Sage library.\n \n-* [attachment: trac_7650-sagenb_doctesting_v2.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v2.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n+* [attachment: trac_7650-sagenb_doctesting_v3.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v3.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n \n and replace `SAGE_ROOT/makefile` with\n \n * [attachment: makefile.gz](https://github.com/sagemath/sage/files/ticket7650/makefile.gz).  This makes `make test` and `make ptest` test all SageNB files, too.\n \n+Dependency chain: Sage 4.3 / SageNB 0.4.8, #7483, #7514, #7482.\n``````\n",
    "created_at": "2010-01-01T10:57:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7650",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,10 +4,10 @@\n \n * [attachment: trac_7650-scripts_doctest_force_lib_v5.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-scripts_doctest_force_lib_v5.patch.gz) to the scripts repository.  This adds two options to `sage -t`: `-sagenb` tests all SageNB files and `-force_lib` tests files *as if* they live in `SAGE_ROOT/devel/sage`, i.e., in the Sage library.\n \n-* [attachment: trac_7650-sagenb_doctesting_v3.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v3.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n+* [attachment: trac_7650-sagenb_doctesting_v4.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v4.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n \n and replace `SAGE_ROOT/makefile` with\n \n * [attachment: makefile.gz](https://github.com/sagemath/sage/files/ticket7650/makefile.gz).  This makes `make test` and `make ptest` test all SageNB files, too.\n \n-Dependency chain: Sage 4.3 / SageNB 0.4.8, #7483, #7514, #7482.\n+Dependencies: Sage 4.3.1.alpha1, #7269.\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,7 +4,7 @@\n \n * [attachment: trac_7650-scripts_doctest_force_lib_v5.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-scripts_doctest_force_lib_v5.patch.gz) to the scripts repository.  This adds two options to `sage -t`: `-sagenb` tests all SageNB files and `-force_lib` tests files *as if* they live in `SAGE_ROOT/devel/sage`, i.e., in the Sage library.\n \n-* [attachment: trac_7650-sagenb_doctesting_v4.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v4.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n+* [attachment: trac_7650-sagenb_doctesting_v5.patch.gz](https://github.com/sagemath/sage/files/ticket7650/trac_7650-sagenb_doctesting_v5.patch.gz) to the sagenb repository.  This fixes broken SageNB tests.\n \n and replace `SAGE_ROOT/makefile` with\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7650#issuecomment-58723",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7650",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7650#event-83154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7650#issuecomment-58724",
    "user": "https://github.com/rlmill"
}
```
