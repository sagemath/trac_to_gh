...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7424/trac_7424.patch",
    "created_at": "2013-08-02T19:17:20Z",
    "issue": "https://github.com/sagemath/sage/issues/7424",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7424/trac_7424.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_7424.patch](https://github.com/sagemath/sage/files/ticket7424/trac_7424.patch) by @fchapoton created at 2013-08-02 19:17:20\n\nhere is a patch, that also cleans a bit the doc",
    "created_at": "2013-08-02T19:17:20Z",
    "issue": "https://github.com/sagemath/sage/issues/7424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7424#issuecomment-55963",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7424#issuecomment-55964",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7424#issuecomment-55965",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7424#issuecomment-55966",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7424#issuecomment-55967",
