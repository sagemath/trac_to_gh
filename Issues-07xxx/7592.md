...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75195",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75196",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75198",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It could have, but in this case it was mainly my fault. I have no idea why, but the patch did not even apply on my version, perhaps they were not based on alpha... Here is a new version based on alpha, with my excuses :-)",
    "created_at": "2009-12-08T20:52:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75199",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:5'></a>It could have, but in this case it was mainly my fault. I have no idea why, but the patch did not even apply on my version, perhaps they were not based on alpha... Here is a new version based on alpha, with my excuses :-)
...
```json
{
    "body": "<a id='comment:6'></a>There was a small mistake in the \n\n```\nif vertex_bound:            \n        CORRECTED LINE\n```\nSome variable had no assigned value.... And the patch I just updated takes this into account :-)",
    "created_at": "2009-12-08T21:11:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75200",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>There was a small mistake in the 
...
```json
{
    "body": "<a id='comment:7'></a>You need more examples in the doctest section. Some of the options return something different than what the docs say, such as:\n\n```\nsage: g.flow(1,2, value_only=False)\n[3.0, Pappus Graph: Graph on 18 vertices]\n```",
    "created_at": "2009-12-15T17:04:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75201",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:7'></a>You need more examples in the doctest section. Some of the options return something different than what the docs say, such as:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75202",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_7592.patch](tarball://root/attachments/some-uuid/ticket7592/trac_7592.patch) by @nathanncohen created at 2009-12-16 00:44:53\n\nI corrected the documentation as I finally thought returning a graph would be much more useful :-)\n\nI also added a more interesting example of what one can do with flows :-)\n\nNathann",
    "created_at": "2009-12-16T00:44:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75203",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:8'></a>Attachment [trac_7592.patch](tarball://root/attachments/some-uuid/ticket7592/trac_7592.patch) by @nathanncohen created at 2009-12-16 00:44:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75204",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75205",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75206",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75207",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75208",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7592#issuecomment-75209",
    "user": "https://github.com/mwhansen"
}
```
