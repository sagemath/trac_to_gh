...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7584#event-93291"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7584#event-93292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7584#event-93293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7584#event-93294"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7584#issuecomment-56386",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7584#event-93295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7584#issuecomment-56387",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7584#issuecomment-56388",
    "user": "https://github.com/mwhansen"
}
```
