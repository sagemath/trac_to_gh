...
```json
{
    ...
    "rename": {
        "from": "include new separated sage notebook in Sage",
        "to": "[with patch; needs review] include new separated sage notebook in Sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7080#event-28719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7080",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7080#issuecomment-65842",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7080",
    "rename": {
        "from": "[with patch; needs review] include new separated sage notebook in Sage",
        "to": "include new separated sage notebook in Sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7080#event-28720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7080#event-28721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7080",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7080#issuecomment-65843",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7080",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7080#event-28722"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7080#event-28723"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7080#event-28724"
}
```
