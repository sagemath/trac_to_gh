...
```json
{
    "body": "<a id='comment:1'></a>Could the problem be `sagenb.notebook.user.User`'s use of [crypt](http://docs.python.org/library/crypt.html):\n\n```python\n>>> import crypt\n>>> crypt.crypt('abcdefgh', 'aa')\n'aaHHlPHAM4sjs'\n>>> crypt.crypt('abcdefghi', 'aa')\n'aaHHlPHAM4sjs'\n```\n?",
    "created_at": "2009-12-12T17:02:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7670#issuecomment-76482",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>Could the problem be `sagenb.notebook.user.User`'s use of [crypt](http://docs.python.org/library/crypt.html):
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18275"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18276"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18277"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18278"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18279"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18280"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18281"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7670#issuecomment-76484",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7670#issuecomment-76485",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18282"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18283"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I cannot replicate this, and it is so old I am going to ask to close this.",
    "created_at": "2014-09-17T02:15:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7670#issuecomment-76486",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>I cannot replicate this, and it is so old I am going to ask to close this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7670#issuecomment-76487",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7670#issuecomment-76488",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7670",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7670#event-18284"
}
```
