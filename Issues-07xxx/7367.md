...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79365"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79366"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79369"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79371"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7367",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-79374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7367#issuecomment-55293",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7367#issuecomment-55294",
    "user": "https://github.com/mwhansen"
}
```
