...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7485#event-50750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7485#event-50751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7485#event-50752"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7485#event-50753"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7485#event-50754"
}
```
