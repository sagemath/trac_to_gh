...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7494#event-83437"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -8,4 +8,10 @@\n ```\n I can put the same directory online somewhere, and move the fortran file that is used in one doctest out.  I'm just really curious if anybody knows about this directory and cares. \n \n+**Apply**:\n+1.  [attachment: trac_7494.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494.patch.gz)\n \n+**Release Manager**\n+\n+Delete `$SAGE_ROOT/examples` as part of this ticket.\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,7 +9,8 @@\n I can put the same directory online somewhere, and move the fortran file that is used in one doctest out.  I'm just really curious if anybody knows about this directory and cares. \n \n **Apply**:\n-1.  [attachment: trac_7494.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494.patch.gz)\n+1.  [attachment: trac_7494.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494.patch.gz) to the Sage repo\n+2.  [attachment: trac_7494-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494-scripts.patch.gz) to the scripts repo\n \n **Release Manager**\n \n``````\n",
    "created_at": "2011-08-25T21:59:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7494",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,7 +11,7 @@\n **Apply**:\n 1. [attachment: trac_7494.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494.patch.gz) to the Sage library repo\n 2. [attachment: trac_7494-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494-scripts.patch.gz) to the **scripts** repo\n-3. <Add a patch> to the **Sage root** repository\n+3. [attachment: trac_7494-root-repo.patch.gz](https://github.com/sagemath/sage/files/ticket7494/trac_7494-root-repo.patch.gz) to the **Sage root** repository\n \n **Release Manager:**\n \n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7494#issuecomment-56772",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7494#issuecomment-56773",
    "user": "https://github.com/jhpalmieri"
}
```
