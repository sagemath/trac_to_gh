...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61378",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61379",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61380",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61381",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61382",
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61383",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61384",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61385",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>\nAh, I mistakenly thought that was already where you were adding the `-D_XOPEN_SOURCE=600` since that was the error you reported.\n\nThe patch at #6583 adds the `sage.schemes.elliptic_curves.descent_two_isogeny` extension that's failing with a `-std=c99` flag. (Right at the top of the patch at https://github.com/sagemath/sage/files/ticket6583/trac_6583-rebase.patch .) That would be the place to add the extra `-D_XOPEN_SOURCE=600` option (if it works...), I think.",
    "created_at": "2010-02-24T21:15:10Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61386",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61387",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61388",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54433"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54434"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61389",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61390",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7867/allow-python-modules-to-build-on-Solaris.patch",
    "created_at": "2010-03-02T09:10:07Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7867/allow-python-modules-to-build-on-Solaris.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [allow-python-modules-to-build-on-Solaris.patch](https://github.com/sagemath/sage/files/ticket7867/allow-python-modules-to-build-on-Solaris.patch) by drkirkby created at 2010-03-02 09:10:07\n\nUpdated spkg-install to avoid clash with 7761",
    "created_at": "2010-03-02T09:10:07Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61391",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [allow-python-modules-to-build-on-Solaris.patch](https://github.com/sagemath/sage/files/ticket7867/allow-python-modules-to-build-on-Solaris.patch) by drkirkby created at 2010-03-02 09:10:07
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "SPKG.txt",
    "asset_url": "tarball://root/attachments/ticket7867/SPKG.txt",
    "created_at": "2010-03-02T09:11:22Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7867/SPKG.txt",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [SPKG.txt](https://github.com/sagemath/sage/files/ticket7867/SPKG.txt) by drkirkby created at 2010-03-02 09:11:22\n\nUpdated SPKG.txt  patch to avoid clash with 7761",
    "created_at": "2010-03-02T09:11:22Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61392",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [SPKG.txt](https://github.com/sagemath/sage/files/ticket7867/SPKG.txt) by drkirkby created at 2010-03-02 09:11:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61393",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7867/configure.in.Solaris.patch",
    "created_at": "2010-03-02T09:49:15Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7867/configure.in.Solaris.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54435"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61395",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61396",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54437"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61397",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61398",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61399",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54439"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7867#event-54440"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61400",
