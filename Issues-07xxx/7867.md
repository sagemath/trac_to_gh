...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61401",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61402",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61403",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61404",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61405",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61406",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7867#issuecomment-61407",
...
archive/attachments_009960.json:
```json
{
...
```json
{
    "body": "**Attachment:** [allow-python-modules-to-build-on-Solaris.patch](https://github.com/sagemath/sage/files/ticket7867/allow-python-modules-to-build-on-Solaris.patch)\n\nUpdated spkg-install to avoid clash with 7761",
    "created_at": "2010-03-02T09:10:07Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "issue_comment",
...
**Attachment:** [allow-python-modules-to-build-on-Solaris.patch](https://github.com/sagemath/sage/files/ticket7867/allow-python-modules-to-build-on-Solaris.patch)
...
archive/attachments_009961.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "spkg-install",
    "asset_url": "tarball://root/attachments/ticket7867/spkg-install",
    "created_at": "2010-03-02T09:11:22Z",
    "issue": "https://github.com/sagemath/sage/issues/7867",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7867/spkg-install",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
**Attachment:** [spkg-install](https://github.com/sagemath/sage/files/ticket7867/spkg-install)
