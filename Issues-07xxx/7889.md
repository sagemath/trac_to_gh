...
```json
{
    "body": "Changed assignee from **@sagetrac-olazo** to **@jasongrout**",
    "created_at": "2010-02-27T19:19:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-olazo** to **@jasongrout**
...
```json
{
    "body": "Changed assignee from **@jasongrout** to **@sagetrac-olazo**",
...
Changed assignee from **@jasongrout** to **@sagetrac-olazo**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-89060"
}
```
