...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86338"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86339"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86341"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86342"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86343"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86345"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86347"
}
```
...
```json
{
    "body": "Attachment: **[torus.png.gz](https://github.com/sagemath/sage/files/ticket7889/torus.png.gz)**",
...
Attachment: **[torus.png.gz](https://github.com/sagemath/sage/files/ticket7889/torus.png.gz)**
...
```json
{
    "body": "Attachment: **[deformed torus.png.gz](https://github.com/sagemath/sage/files/ticket7889/97bda5012de20f75c681478876eb1b3f.gz)**",
...
Attachment: **[deformed torus.png.gz](https://github.com/sagemath/sage/files/ticket7889/97bda5012de20f75c681478876eb1b3f.gz)**
...
```json
{
    "body": "Attachment: **[goblet.png.gz](https://github.com/sagemath/sage/files/ticket7889/goblet.png.gz)**",
...
Attachment: **[goblet.png.gz](https://github.com/sagemath/sage/files/ticket7889/goblet.png.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86353"
}
```
...
```json
{
    "body": "Attachment: **[revolution_solid.png.gz](https://github.com/sagemath/sage/files/ticket7889/revolution_solid.png.gz)**",
...
Attachment: **[revolution_solid.png.gz](https://github.com/sagemath/sage/files/ticket7889/revolution_solid.png.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86359"
}
```
...
```json
{
    "body": "Changed assignee from **olazo** to **@jasongrout**",
    "created_at": "2010-02-27T19:19:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
...
Changed assignee from **olazo** to **@jasongrout**
...
```json
{
    "body": "Changed assignee from **@jasongrout** to **olazo**",
...
Changed assignee from **@jasongrout** to **olazo**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61765",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61766",
    "user": "https://github.com/sagetrac-mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61767",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61768",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61769",
    "user": "https://github.com/sagetrac-mhampton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61770",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61771",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86366"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86367"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61772",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61773",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61774",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61775",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61776",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7889#issuecomment-61777",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86372"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7889",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7889#event-86373"
}
```
