...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68443",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_7184.patch](tarball://root/attachments/some-uuid/ticket7184/trac_7184.patch) by @haaninjo created at 2009-10-10 18:03:00",
    "created_at": "2009-10-10T18:03:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68444",
    "user": "https://github.com/haaninjo"
}
```

<a id='comment:1'></a>Attachment [trac_7184.patch](tarball://root/attachments/some-uuid/ticket7184/trac_7184.patch) by @haaninjo created at 2009-10-10 18:03:00
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,7 +3,8 @@\n Method used: Kirchhoff's matrix tree theorem [1] and the Laplacian matrix for the simple graphs, and a variation of the same [2] in the directed case.\n \n \n-[1] http://en.wikipedia.org/wiki/Kirchhoff%27s_theorem\n+[1] http://en.wikipedia.org/wiki/Kirchhoff%27s_theorem \n+\n [2] corollary 4.4 in http://books.google.se/books?id=vbxdqhDKOSYC&printsec=frontcover&hl=en&source=gbs_navlinks_s\n \n Summary: [with patch, needs review] Implement counting of spanning trees for graphs and digraphs\n``````\n",
    "created_at": "2009-10-10T18:03:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68445",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68446",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Ooops, sorry for the last line, which was not meant to be included in my message. Besides, I meant that you had to redefine the kirchhoff matrix, not the adjacency matrix.. Sorry :-)",
    "created_at": "2009-10-18T12:18:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68448",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Ooops, sorry for the last line, which was not meant to be included in my message. Besides, I meant that you had to redefine the kirchhoff matrix, not the adjacency matrix.. Sorry :-)
...
```json
{
    "body": "<a id='comment:5'></a>Ncohen, you've broken kirchhoff_matrix.  According to the definition, row-sums of the Kirchhoff matrix should be zero.  Here's the doctest before you changed it:\n\n```\nsage: G = DiGraph({1:{1:2,2:3}, 2:{1:4}}, weighted=True,sparse=True) \nsage: G.laplacian_matrix() \n[ 3 -3] \n[-4  4] \n```\nhere, the row-sums are zero.\n\nBut you actually had to change the doctest to make the code pass,\n\n```\nsage: G = DiGraph({1:{1:2,2:3}, 2:{1:4}}, weighted=True,sparse=True) \nsage: G.laplacian_matrix() \n[ 4 -3] \n[-4  3] \n```\nbut the row-sums aren't zero!  Don't break math to make code work!",
    "created_at": "2009-10-18T17:10:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68449",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

<a id='comment:5'></a>Ncohen, you've broken kirchhoff_matrix.  According to the definition, row-sums of the Kirchhoff matrix should be zero.  Here's the doctest before you changed it:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68450",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68451",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68452",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68453",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68454",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68456",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68457",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Looks fine to me. With your patch applied there is another line in count_spanning_trees that no longer is needed. Apply this patch on top of trac_7184-reviewer.patch to remove that line.",
    "created_at": "2009-10-21T12:07:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68461",
    "user": "https://github.com/haaninjo"
}
```

<a id='comment:13'></a>Looks fine to me. With your patch applied there is another line in count_spanning_trees that no longer is needed. Apply this patch on top of trac_7184-reviewer.patch to remove that line.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68462",
    "user": "https://github.com/haaninjo"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [trac_7184-reviewer.patch](tarball://root/attachments/some-uuid/ticket7184/trac_7184-reviewer.patch) by @haaninjo created at 2009-10-21 14:37:28\n\nLooks really nice. I'm fully satisfied with the patch.\n\nAnders",
    "created_at": "2009-10-21T14:37:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68464",
    "user": "https://github.com/haaninjo"
}
```

<a id='comment:15'></a>Attachment [trac_7184-reviewer.patch](tarball://root/attachments/some-uuid/ticket7184/trac_7184-reviewer.patch) by @haaninjo created at 2009-10-21 14:37:28
...
```json
{
    "body": "<a id='comment:16'></a>Do we both agree on a positive review, then ? ;-)",
    "created_at": "2009-10-22T08:04:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68465",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:16'></a>Do we both agree on a positive review, then ? ;-)
...
```json
{
    "body": "<a id='comment:17'></a>Well, I'll take your \"Looks really nice. I'm fully satisfied with the patch\" as as an answer :-)",
    "created_at": "2009-10-26T07:03:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68466",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:17'></a>Well, I'll take your "Looks really nice. I'm fully satisfied with the patch" as as an answer :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68467",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68468",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Sorry guys, reviewers need to not touch the code.  Rather... authors can't give the final +1.",
    "created_at": "2009-10-26T23:01:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68469",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

<a id='comment:18'></a>Sorry guys, reviewers need to not touch the code.  Rather... authors can't give the final +1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68470",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68471",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68472",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68473",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Anders Jonsson, Nathann Cohen\"",
    "created_at": "2009-12-07T08:47:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68474",
    "user": "https://github.com/mwhansen"
}
```

Changing author from "" to "Anders Jonsson, Nathann Cohen"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68475",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7184#issuecomment-68476",
    "user": "https://github.com/mwhansen"
}
```
