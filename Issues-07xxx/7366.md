...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7366/finite_field_givaro_iter.patch",
    "created_at": "2009-11-01T00:11:34Z",
    "issue": "https://github.com/sagemath/sage/issues/7366",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7366/finite_field_givaro_iter.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "Attachment [finite_field_givaro_iter.patch](https://github.com/sagemath/sage/files/ticket7366/finite_field_givaro_iter.patch) by @malb created at 2009-11-01 00:11:34",
    "created_at": "2009-11-01T00:11:34Z",
    "issue": "https://github.com/sagemath/sage/issues/7366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7366#issuecomment-55253",
    "user": "https://github.com/malb"
}
```

Attachment [finite_field_givaro_iter.patch](https://github.com/sagemath/sage/files/ticket7366/finite_field_givaro_iter.patch) by @malb created at 2009-11-01 00:11:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7366#issuecomment-55254",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7366#issuecomment-55255",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7366#issuecomment-55256",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7366#issuecomment-55257",
