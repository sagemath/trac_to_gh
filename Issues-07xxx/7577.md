...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [mpolynomial_rr_libsingular.patch](https://github.com/sagemath/sage/files/ticket7577/mpolynomial_rr_libsingular.patch) by @malb created at 2009-12-01 23:15:19\n\nI am CCing burcin because he knows libSingular and I am CCing ncohen because I wrote this patch in order to speed up the linear programming interface.",
    "created_at": "2009-12-01T23:15:19Z",
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57872",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57873",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57874",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57875",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57876",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57877",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "Attachment [mpolynomial_rr_libsingular_fixes.patch](https://github.com/sagemath/sage/files/ticket7577/mpolynomial_rr_libsingular_fixes.patch) by @malb created at 2009-12-02 14:32:32",
    "created_at": "2009-12-02T14:32:32Z",
    "issue": "https://github.com/sagemath/sage/issues/7577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7577#issuecomment-57878",
    "user": "https://github.com/malb"
}
```

Attachment [mpolynomial_rr_libsingular_fixes.patch](https://github.com/sagemath/sage/files/ticket7577/mpolynomial_rr_libsingular_fixes.patch) by @malb created at 2009-12-02 14:32:32
