...
<a id='comment:2'></a>Pynac gets into an infinite recursion with these lines:
...
```json
{
    "body": "<a id='comment:4'></a>This is a duplicate of #7264. The patch attached to that ticket contains this example as a doctest as well.",
    "created_at": "2009-11-22T18:02:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7394",
    "type": "issue_comment",
...
<a id='comment:4'></a>This is a duplicate of #7264. The patch attached to that ticket contains this example as a doctest as well.
