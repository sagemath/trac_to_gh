...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79207"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79213"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79215"
}
```
...
```json
{
    "body": "<a id='comment:9'>Comment 9:</a>\nAttachment: **[trac_7355-sage-i-no-version.3.patch.gz](https://github.com/sagemath/sage/files/ticket7355/trac_7355-sage-i-no-version.3.patch.gz)**\n\nHrm, I think [attachment: rac_7355-sage-i-no-version.3.patch.gz](https://github.com/sagemath/sage/files/ticket7355/rac_7355-sage-i-no-version.3.patch.gz) was supposed to be uploaded to another ticket -- I see a one-line patch to `sagenb/data/sage/html/worksheet/worksheet.html`.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55188",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55189",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55190",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55191",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55192",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55193",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7355#issuecomment-55194",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79228"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7355#event-79229"
}
```
