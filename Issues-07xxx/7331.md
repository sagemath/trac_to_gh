...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54889",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_7331.patch](https://github.com/sagemath/sage/files/ticket7331/trac_7331.patch) by @categorie created at 2009-10-28 13:02:44\n\nThis patch allows now for non-split multiplicative reduction and for p=3 when the rank is 0. (As we do not need p-adic heights in this case)",
    "created_at": "2009-10-28T13:02:44Z",
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54890",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54891",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54892",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54893",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54894",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54895",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "Attachment [trac_7331_2.patch](https://github.com/sagemath/sage/files/ticket7331/trac_7331_2.patch) by @categorie created at 2009-10-28 18:50:28\n\nto be applied after teh first patch",
    "created_at": "2009-10-28T18:50:28Z",
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54896",
    "user": "https://github.com/categorie"
}
```

Attachment [trac_7331_2.patch](https://github.com/sagemath/sage/files/ticket7331/trac_7331_2.patch) by @categorie created at 2009-10-28 18:50:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54897",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7331#issuecomment-54898",
