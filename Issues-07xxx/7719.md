...
<a id='comment:6'></a>Replying to [comment:4 robertwb]:
...
<a id='comment:24'></a>Replying to [comment:23 robertwb]:
> That's why I avoid the fold command for tickets with multiple authors... (BTW, I'm Bradshaw, not Miller.)
