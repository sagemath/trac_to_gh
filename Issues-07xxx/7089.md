...
```json
{
    "body": "<a id='comment:1'></a>Attachment [makefile.patch](tarball://root/attachments/some-uuid/ticket7089/makefile.patch) by @dandrake created at 2009-10-01 03:41:52",
    "created_at": "2009-10-01T03:41:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7089",
    "type": "issue_comment",
...
<a id='comment:1'></a>Attachment [makefile.patch](tarball://root/attachments/some-uuid/ticket7089/makefile.patch) by @dandrake created at 2009-10-01 03:41:52
...
```json
{
    "body": "<a id='comment:2'></a>Patch applies, and the tests run properly. Positive review.",
...
<a id='comment:2'></a>Patch applies, and the tests run properly. Positive review.
