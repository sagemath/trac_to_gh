...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67804",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac7119.patch](tarball://root/attachments/some-uuid/ticket7119/trac7119.patch) by @kwankyu created at 2009-10-05 04:59:59\n\nThe patch corrects the bug.",
    "created_at": "2009-10-05T04:59:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67805",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:1'></a>Attachment [trac7119.patch](tarball://root/attachments/some-uuid/ticket7119/trac7119.patch) by @kwankyu created at 2009-10-05 04:59:59
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67806",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67807",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I think a doctest should be added for the case that the patch fixes. ~ adam",
    "created_at": "2009-10-10T10:19:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67808",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:2'></a>I think a doctest should be added for the case that the patch fixes. ~ adam
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_#7119.patch](tarball://root/attachments/some-uuid/ticket7119/trac_#7119.patch) by @kwankyu created at 2009-10-12 08:03:55\n\nThe new patch includes doctests and a bugfix of the patch itself.\n\nMartin says:\n\nAlex Ghitza wrote a patch to fix printing of multivariate polynomials in\ngeneral\n\n  http://trac.sagemath.org/sage_trac/ticket/6551\n\nwhich might contain your fix. However, it needs some work before it can go in.\n\n\nHowever, it seems to me that Alex Ghitza's patch is independent with the current patch.",
    "created_at": "2009-10-12T08:03:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67809",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:3'></a>Attachment [trac_#7119.patch](tarball://root/attachments/some-uuid/ticket7119/trac_#7119.patch) by @kwankyu created at 2009-10-12 08:03:55
...
```json
{
    "body": "<a id='comment:5'></a>What does the TESTS: label do? When I build the reference the Test section is also included. In which case, why not just add to the Examples section (separated by a line with a :: to start a new section)?\n\nI think it would be easier to use something like:\n\n```\nsage: R.<x,y>=PolynomialRing(GF(2),2,order='lex')\nsage: f=x+y\nsage: f.lt()\nx\n```\n\nThen you don't need the long import statement.  What do you think?\n\nAdam",
    "created_at": "2009-10-12T11:25:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67811",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:5'></a>What does the TESTS: label do? When I build the reference the Test section is also included. In which case, why not just add to the Examples section (separated by a line with a :: to start a new section)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67812",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67813",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_7119_b.patch](tarball://root/attachments/some-uuid/ticket7119/trac_7119_b.patch) by @maxthemouse created at 2009-10-12 11:43:09\n\nI added a \"suggested changes\" patch just to clarify. ~ Adam",
    "created_at": "2009-10-12T11:43:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67814",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:7'></a>Attachment [trac_7119_b.patch](tarball://root/attachments/some-uuid/ticket7119/trac_7119_b.patch) by @maxthemouse created at 2009-10-12 11:43:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67816",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67817",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67818",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7119#issuecomment-67819",
    "user": "https://github.com/mwhansen"
}
```
