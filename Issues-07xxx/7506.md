...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7506#event-83632"
}
```
...
```json
{
    "body": "<a id='comment:11'>Comment 11:</a>\nWe should have added a note about [attachment: trac_7506-sage_core_lib-notebook-obj-ref.patch.gz](https://github.com/sagemath/sage/files/ticket7506/trac_7506-sage_core_lib-notebook-obj-ref.patch.gz), which also adds `notebook_object` to the reference manual.  I'm not sure why it's missing the usual Mercurial header.\n\nIf Tim doesn't mind, I suggest that the release manager merge\n\n* [attachment: trac_7506-ref-manual.patch.gz](https://github.com/sagemath/sage/files/ticket7506/trac_7506-ref-manual.patch.gz) into the sage repo.\n* [attachment: trac_7506-notebook_object-documentation.2.patch.gz](https://github.com/sagemath/sage/files/ticket7506/trac_7506-notebook_object-documentation.2.patch.gz) into the sagenb repo.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7506#issuecomment-56934",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7506#issuecomment-56935",
    "user": "https://github.com/qed777"
}
```
