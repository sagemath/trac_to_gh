...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7689#issuecomment-76782",
...
```json
{
    "body": "<a id='comment:2'></a>Currently, `cd build; ./install scripts` doesn't work and it certainly isn't an \"official\" way to bootstrap anything.",
    "created_at": "2013-12-29T23:21:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7689#issuecomment-76783",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Currently, `cd build; ./install scripts` doesn't work and it certainly isn't an "official" way to bootstrap anything.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7689#issuecomment-76784",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7689#issuecomment-76785",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7689#issuecomment-76786",
