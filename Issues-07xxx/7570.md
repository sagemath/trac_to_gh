...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82026"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82029"
}
```
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "title_is": "Make plot methods accept 'empty' input to return empty Graphics object",
    "title_was": "default : list_plot of empty lists",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82040"
}
```
...
```json
{
    "body": "Changed reviewer from **Aly Deines** to **Aly Deines, Gagan Sekhon**",
...
Changed reviewer from **Aly Deines** to **Aly Deines, Gagan Sekhon**
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82045"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -13,3 +13,5 @@\n ```\n \n does work. It would be nicer if list_plot of empty lists gives an empty graphics object.\n+\n+**Apply**: [attachment: trac_7570_empty_graphics.2.patch.gz](https://github.com/sagemath/sage/files/ticket7570/trac_7570_empty_graphics.2.patch.gz)\n``````\n",
    "created_at": "2011-01-27T17:35:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57816",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57817",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changed work issues from **update commit message** to **commit message, sphinx**",
    "created_at": "2011-01-28T08:36:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57818",
    "user": "https://github.com/jdemeyer"
}
```

Changed work issues from **update commit message** to **commit message, sphinx**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57819",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57820",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57821",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57822",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82053"
}
```
...
```json
{
    "body": "Changed work issues from **commit message, sphinx** to none",
    "created_at": "2011-02-08T08:49:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57823",
    "user": "https://github.com/jdemeyer"
}
```

Changed work issues from **commit message, sphinx** to none
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57824",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82054"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7570#event-82055"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7570#issuecomment-57825",
    "user": "https://github.com/jasongrout"
}
```
