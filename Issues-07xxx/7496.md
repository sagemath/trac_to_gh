...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,3 +10,6 @@\n ```\n \n When this ticket is closed, #9724 can also be closed.\n+\n+---\n+Apply [and [attachment:trac_7496-reviewer.patch](https://github.com/sagemath/sage/files/ticket7496/c2a2b92e56acf84bf6682dfc5290a600.patch](https://github.com/sagemath/sage/files/ticket7496/5ac83fb54efe4033d49356355d4df9bd.patch)).\n``````\n",
