...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [glpk_sage_free.patch](https://github.com/sagemath/sage/files/ticket7572/glpk_sage_free.patch) by @malb created at 2009-12-01 15:54:16\n\nThe attached patch is for the GLPK SPKG.",
    "created_at": "2009-12-01T15:54:16Z",
    "issue": "https://github.com/sagemath/sage/issues/7572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7572#issuecomment-57804",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7572#issuecomment-57805",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7572#issuecomment-57806",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7572#issuecomment-57807",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7572#issuecomment-57808",
    "user": "https://github.com/malb"
}
```
