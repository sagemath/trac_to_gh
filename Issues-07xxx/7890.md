...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7890#issuecomment-78629",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs work] Improve conversion of GAP objects into sage objects."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7890#event-31193"
}
```
