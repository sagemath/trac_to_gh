...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7142#event-87034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7142#event-87035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7142#event-87036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7142#event-87037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7142#issuecomment-51372",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7142",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7142#event-87038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7142#issuecomment-51373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7142#issuecomment-51374",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7142#issuecomment-51375",
    "user": "https://github.com/mwhansen"
}
```
