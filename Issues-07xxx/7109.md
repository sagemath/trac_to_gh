...
archive/attachments_008803.json:
```json
{
...
archive/attachments_008804.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [polyhedra.py](https://github.com/sagemath/sage/files/ticket7109/polyhedra.py)\n\nRefactored version of polyhedra.py",
    "created_at": "2009-10-12T17:08:54Z",
    "issue": "https://github.com/sagemath/sage/issues/7109",
    "type": "issue_comment",
...
**Attachment:** [polyhedra.py](https://github.com/sagemath/sage/files/ticket7109/polyhedra.py)
...
archive/attachments_008805.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [polyhedron-v8.patch](https://github.com/sagemath/sage/files/ticket7109/polyhedron-v8.patch)\n\nCurrent revision is final version, all goals accomplished.",
    "created_at": "2009-10-12T17:16:37Z",
    "issue": "https://github.com/sagemath/sage/issues/7109",
    "type": "issue_comment",
...
archive/attachments_008806.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [cddlib-094f.spkg](https://github.com/sagemath/sage/files/ticket7109/cddlib-094f.spkg)\n\ncdd_both_reps now reports timing information for individual operations",
    "created_at": "2009-10-28T17:11:56Z",
    "issue": "https://github.com/sagemath/sage/issues/7109",
    "type": "issue_comment",
...
**Attachment:** [cddlib-094f.spkg](https://github.com/sagemath/sage/files/ticket7109/cddlib-094f.spkg)
...
archive/attachments_008807.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_7109_mh1.patch](https://github.com/sagemath/sage/files/ticket7109/trac_7109_mh1.patch)\n\nBased against 4.2.1, cumulative of all changes except cddlib spkg",
    "created_at": "2009-12-29T23:33:30Z",
    "issue": "https://github.com/sagemath/sage/issues/7109",
    "type": "issue_comment",
...
**Attachment:** [trac_7109_mh1.patch](https://github.com/sagemath/sage/files/ticket7109/trac_7109_mh1.patch)
...
archive/attachments_008808.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_7109_mh2.patch](https://github.com/sagemath/sage/files/ticket7109/trac_7109_mh2.patch)\n\nCumulative patch, includes vbraun's latest additions + 2 doctests",
    "created_at": "2010-01-23T21:59:27Z",
    "issue": "https://github.com/sagemath/sage/issues/7109",
    "type": "issue_comment",
...
**Attachment:** [trac_7109_mh2.patch](https://github.com/sagemath/sage/files/ticket7109/trac_7109_mh2.patch)
...
```json
{
    "body": "**Attachment:** [trac_7109-rebase.patch](https://github.com/sagemath/sage/files/ticket7109/trac_7109-rebase.patch)\n\ncumulative patch, rebased on top of #7535; apply only this patch",
    "created_at": "2010-01-25T05:34:30Z",
    "issue": "https://github.com/sagemath/sage/issues/7109",
    "type": "issue_comment",
...
**Attachment:** [trac_7109-rebase.patch](https://github.com/sagemath/sage/files/ticket7109/trac_7109-rebase.patch)
