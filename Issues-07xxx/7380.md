...
```json
{
    "body": "<a id='comment:2'></a>Read [this section](http://www.sagemath.org/doc/developer/trac.html#closing-tickets) before closing tickets. Can you explain why you want to close this ticket?",
...
<a id='comment:2'></a>Read [this section](http://www.sagemath.org/doc/developer/trac.html#closing-tickets) before closing tickets. Can you explain why you want to close this ticket?
...
<a id='comment:3'></a>Well, as I created it I thought it would not be so bad to close it too ^^;
...
<a id='comment:5'></a>Sorry for commenting a closed ticket, but...
...
```json
{
    "body": "<a id='comment:6'></a>oops... Well, if \"vertices()\" is calling vertex_iterator, plus sorts it, then I said nothing...",
    "created_at": "2010-03-01T07:24:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7380",
    "type": "issue_comment",
...
<a id='comment:6'></a>oops... Well, if "vertices()" is calling vertex_iterator, plus sorts it, then I said nothing...
