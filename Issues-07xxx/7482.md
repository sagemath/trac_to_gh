...
archive/attachments_009348.json:
```json
{
...
```json
{
    "body": "**Attachment:** [sagenb_7482.patch](https://github.com/sagemath/sage/files/ticket7482/sagenb_7482.patch)\n\napply to the sagenb spkg",
    "created_at": "2009-11-18T03:29:41Z",
    "issue": "https://github.com/sagemath/sage/issues/7482",
    "type": "issue_comment",
...
**Attachment:** [sagenb_7482.patch](https://github.com/sagemath/sage/files/ticket7482/sagenb_7482.patch)
...
archive/attachments_009349.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [sagelib_7482.patch](https://github.com/sagemath/sage/files/ticket7482/sagelib_7482.patch)\n\napply to the core sage library",
    "created_at": "2009-11-18T03:29:54Z",
    "issue": "https://github.com/sagemath/sage/issues/7482",
    "type": "issue_comment",
...
**Attachment:** [sagelib_7482.patch](https://github.com/sagemath/sage/files/ticket7482/sagelib_7482.patch)
...
archive/attachments_009350.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [sagenb_7482.2.patch](https://github.com/sagemath/sage/files/ticket7482/sagenb_7482.2.patch)\n\nV3 changes\n\n```\n            sage: automatic_names(True)\n```\nto\n\n```\n            sage: automatic_names(True)      # not tested\n```",
    "created_at": "2009-12-10T06:20:39Z",
    "issue": "https://github.com/sagemath/sage/issues/7482",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [sagenb_7482.3.patch](https://github.com/sagemath/sage/files/ticket7482/sagenb_7482.3.patch)\n\nSuppress a doctest (cf. #7650).  Replaces **sagenb** patch.",
    "created_at": "2009-12-10T06:21:38Z",
    "issue": "https://github.com/sagemath/sage/issues/7482",
    "type": "issue_comment",
...
**Attachment:** [sagenb_7482.3.patch](https://github.com/sagemath/sage/files/ticket7482/sagenb_7482.3.patch)
...
```json
{
    "body": "<a id='comment:13'></a>\n**Attachment:** [sagenb_7482.4.patch](https://github.com/sagemath/sage/files/ticket7482/sagenb_7482.4.patch)\n\nI've merged the sagelib patch in 4.3.1.alpha0.",
    "created_at": "2010-01-03T22:08:41Z",
    "issue": "https://github.com/sagemath/sage/issues/7482",
    "type": "issue_comment",
