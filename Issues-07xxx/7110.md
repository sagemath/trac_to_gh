...
<a id='comment:1'></a>Apart from rebasing existing patches, I've rearranged some files:
...
```json
{
    "body": "<a id='comment:2'></a>Patch v2 takes care of `\"main.js\"` in `notebook.list_javascript_window()`, although this function is currently unused, it seems.",
...
<a id='comment:2'></a>Patch v2 takes care of `"main.js"` in `notebook.list_javascript_window()`, although this function is currently unused, it seems.
...
<a id='comment:3'></a>For #5447, here are the SageNB patches:
...
```json
{
    "body": "<a id='comment:4'></a>The latest patch is just a minimal rebase of #4046, #6694, #6865, and #6939 for SageNB.",
...
<a id='comment:4'></a>The latest patch is just a minimal rebase of #4046, #6694, #6865, and #6939 for SageNB.
...
```json
{
    "body": "<a id='comment:6'></a>I merged this into the official sagenb repo and pushed it.  And it works very nicely!",
    "created_at": "2009-10-11T19:27:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7110",
    "type": "issue_comment",
...
<a id='comment:6'></a>I merged this into the official sagenb repo and pushed it.  And it works very nicely!
