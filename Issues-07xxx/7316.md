...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70598",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70599",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70600",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>All doctests pass, if I copy the patched `sagenb.misc.sageinspect.py` to `$SAGE_ROOT/devel/sage/sage`, say, and run `sage -t sageinspect.py` in that directory.\n\nTo the extent that it counts, my review is positive.",
    "created_at": "2009-10-27T02:53:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70601",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>All doctests pass, if I copy the patched `sagenb.misc.sageinspect.py` to `$SAGE_ROOT/devel/sage/sage`, say, and run `sage -t sageinspect.py` in that directory.
...
```json
{
    "body": "<a id='comment:2'></a>Is this now a duplicate of #7349?",
    "created_at": "2009-10-29T17:22:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70602",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Is this now a duplicate of #7349?
...
```json
{
    "body": "<a id='comment:3'></a>Doctests count and the the bugs are fixed. Positive review.",
    "created_at": "2009-10-29T18:12:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70603",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:3'></a>Doctests count and the the bugs are fixed. Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70604",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70605",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>merged into sagenb-0.4.2 (sage-4.2.1)",
    "created_at": "2009-11-11T19:49:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70606",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>merged into sagenb-0.4.2 (sage-4.2.1)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7316#event-17333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7316#issuecomment-70607",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7316",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7316#event-17334"
}
```
