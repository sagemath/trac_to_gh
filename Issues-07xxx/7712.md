...
```json
{
    "body": "<a id='comment:1'></a>It seems it just a printing issue:\n\n```\nsage: r = C(y/2)\nsage: r\n0\nsage: r.monomials()\n[y^3]\nsage: r.monomial_coefficient(y^3).str(style='brackets')\n'[-0.00 .. 0.25]'\n```",
    "created_at": "2009-12-16T14:09:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77100",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:1'></a>It seems it just a printing issue:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77101",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'm declaring a total feature freeze on sage-4.3.",
    "created_at": "2009-12-24T07:08:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77103",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>I'm declaring a total feature freeze on sage-4.3.
...
```json
{
    "body": "<a id='comment:5'></a>Still there in 4.3.1.",
    "created_at": "2010-02-05T20:22:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77104",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>Still there in 4.3.1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77105",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Yann, are you sure this method __call__ is called? I've added a print statement before\n`y=K(0)` and nothing is printed (in 4.3.3). I add David in cc, maybe he can help us.",
    "created_at": "2010-03-12T08:53:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77106",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:8'></a>Yann, are you sure this method __call__ is called? I've added a print statement before
`y=K(0)` and nothing is printed (in 4.3.3). I add David in cc, maybe he can help us.
...
```json
{
    "body": "<a id='comment:9'></a>Sorry, my last comment was not clear. The method call is called when you do `return C(0,0,0)`.",
    "created_at": "2010-03-12T09:15:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77107",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:9'></a>Sorry, my last comment was not clear. The method call is called when you do `return C(0,0,0)`.
...
```json
{
    "body": "<a id='comment:10'></a>> Sorry, my last comment was not clear. The method call is called when you do return C(0,0,0). \n\n\nwith `C(0,0,0)` I see no problem:\n\n```\nsage: P.<y,z> = PolynomialRing(RealIntervalField(2))\nsage: Q.<x> = PolynomialRing(P)\nsage: C = (y-x)^3\nsage: a=C(0,0,0)\nsage: type(a)\n<type 'sage.rings.real_mpfi.RealIntervalFieldElement'>\nsage: a.lower()\n0.00\nsage: a.upper()\n0.00\n```",
    "created_at": "2010-03-12T09:22:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77108",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:10'></a>> Sorry, my last comment was not clear. The method call is called when you do return C(0,0,0). 
...
```json
{
    "body": "<a id='comment:13'></a>I didn't see this ticket when submitting the new ticket #13760. There I provide a patch that corrects this bug. The two tickets should be merged (and probably closed after review of the patch).",
    "created_at": "2012-12-06T10:35:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77111",
    "user": "https://trac.sagemath.org/admin/accounts/users/gmoroz"
}
```

<a id='comment:13'></a>I didn't see this ticket when submitting the new ticket #13760. There I provide a patch that corrects this bug. The two tickets should be merged (and probably closed after review of the patch).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77112",
    "user": "https://trac.sagemath.org/admin/accounts/users/gmoroz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77113",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77114",
    "user": "https://trac.sagemath.org/admin/accounts/users/gmoroz"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#13760\"",
    "created_at": "2012-12-14T17:16:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77115",
    "user": "https://github.com/zimmermann6"
}
```

Changing dependencies from "" to "#13760"
...
```json
{
    "body": "<a id='comment:16'></a>I propose to mark this as \"duplicate\", since #13760 solves that issue.\n\nPaul",
    "created_at": "2012-12-14T17:16:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77116",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:16'></a>I propose to mark this as "duplicate", since #13760 solves that issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77118",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77119",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7712#issuecomment-77120",
