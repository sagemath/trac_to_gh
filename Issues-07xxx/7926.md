...
archive/attachments_010080.json:
```json
{
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_7926_new.patch](https://github.com/sagemath/sage/files/ticket7926/trac_7926_new.patch)\n\nThis is a rebase against 5.0.beta9.",
    "created_at": "2012-03-21T18:44:52Z",
    "issue": "https://github.com/sagemath/sage/issues/7926",
    "type": "issue_comment",
...
archive/attachments_010081.json:
```json
{
    "asset_content_type": "application/octet-stream",
