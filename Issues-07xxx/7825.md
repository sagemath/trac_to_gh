...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79011",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79014",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79015",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79017",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79018",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79019",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79020",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79021",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I've made an SPKG out of this fix and merged it in 4.3.1.alpha0.  The spkg can be found at http://sage.math.washington.edu/home/mhansen/pari-2.3.3.p6.spkg",
    "created_at": "2010-01-04T07:14:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79022",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>I've made an SPKG out of this fix and merged it in 4.3.1.alpha0.  The spkg can be found at http://sage.math.washington.edu/home/mhansen/pari-2.3.3.p6.spkg
...
```json
{
    "body": "<a id='comment:5'></a>I note the date in SPKG.txt was 2009 and not 2010. I'm just about to update this again, due to the SAGE64 issues (#7133), so I'll correct that then.",
    "created_at": "2010-01-05T22:04:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7825#issuecomment-79023",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>I note the date in SPKG.txt was 2009 and not 2010. I'm just about to update this again, due to the SAGE64 issues (#7133), so I'll correct that then.
