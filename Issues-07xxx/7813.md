...
```json
{
    "body": "Attachment [conf.py](https://github.com/sagemath/sage/files/ticket7813/conf.py) by slosoi created at 2010-01-02 03:46:15\n\nSee lines 156, 159, and 162. `hg qnew -f docs patch` did not work for me this time so I include the whole file.",
    "created_at": "2010-01-02T03:46:15Z",
    "issue": "https://github.com/sagemath/sage/issues/7813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7813#issuecomment-60792",
    "user": "https://trac.sagemath.org/admin/accounts/users/slosoi"
}
```

Attachment [conf.py](https://github.com/sagemath/sage/files/ticket7813/conf.py) by slosoi created at 2010-01-02 03:46:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7813#issuecomment-60793",
    "user": "https://trac.sagemath.org/admin/accounts/users/slosoi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7813#issuecomment-60794",
    "user": "https://trac.sagemath.org/admin/accounts/users/slosoi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7813#issuecomment-60795",
    "user": "https://trac.sagemath.org/admin/accounts/users/slosoi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7813#issuecomment-60796",
    "user": "https://trac.sagemath.org/admin/accounts/users/slosoi"
}
```
