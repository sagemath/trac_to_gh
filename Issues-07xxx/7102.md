...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66151",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66152",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "rename": {
        "from": "R.py doctest fails for non-english locale",
        "to": "[with patch, needs review] R.py doctest fails for non-english locale"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7102#event-28804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66153",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66154",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66155",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66156",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7102#event-28805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "rename": {
        "from": "[with patch, needs review] R.py doctest fails for non-english locale",
        "to": "[with patch, positive review] R.py doctest fails for non-english locale"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7102#event-28806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7102#issuecomment-66157",
    "user": "https://github.com/williamstein"
}
```
