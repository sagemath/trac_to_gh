...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7669#event-52588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7669#event-52589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7669#event-52590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7669#event-52591"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7669",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7669#event-52592"
}
```
