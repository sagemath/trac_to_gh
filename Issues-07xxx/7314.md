...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70576",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>In the docstrings, you should not put comments on the sage: line like in \n\n```\nEXAMPLE:: \n\n    sage: # From [2], cited in [1] \n    sage: g=graphs.PathGraph(10) \n    sage: w=lambda x: (x*(x*x -1)/6) \n    sage: g.wiener_index()==w(10) \n    True \n```\n\nInstead, it should be\n\n```\nEXAMPLE:\n\nFrom [2], cited in [1]::\n\n    sage: g=graphs.PathGraph(10) \n    sage: w=lambda x: (x*(x*x -1)/6) \n    sage: g.wiener_index()==w(10) \n    True \n```\n\nAlso, you should see the way that references are handled elsewhere in the Sage library.",
    "created_at": "2009-10-26T16:59:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70577",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>In the docstrings, you should not put comments on the sage: line like in 
...
```json
{
    "body": "<a id='comment:3'></a>I hope you will prefer this one ! I had taken as examples other docstrings which you may find badly formatted... This time, I took as an example Minh's code from Cliques functiosn, knowing that never I witnessed Minh making the slightest error :-)\n\nNathann",
    "created_at": "2009-10-26T19:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70578",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:3'></a>I hope you will prefer this one ! I had taken as examples other docstrings which you may find badly formatted... This time, I took as an example Minh's code from Cliques functiosn, knowing that never I witnessed Minh making the slightest error :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70579",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70580",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70581",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_7314.patch](tarball://root/attachments/some-uuid/ticket7314/trac_7314.patch) by @rlmill created at 2009-12-15 17:17:02",
    "created_at": "2009-12-15T17:17:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70582",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>Attachment [trac_7314.patch](tarball://root/attachments/some-uuid/ticket7314/trac_7314.patch) by @rlmill created at 2009-12-15 17:17:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70583",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70584",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7314#issuecomment-70585",
    "user": "https://github.com/mwhansen"
}
```
