...
```json
{
    "body": "<a id='comment:1'></a>Since guava was supposed to be removed a long time ago (http://trac.sagemath.org/sage_trac/ticket/5701), I don't see why this trac ticket is necessary.",
...
<a id='comment:1'></a>Since guava was supposed to be removed a long time ago (http://trac.sagemath.org/sage_trac/ticket/5701), I don't see why this trac ticket is necessary.
...
```json
{
    "body": "<a id='comment:5'></a>`leonconv` is not shipped anymore.",
    "created_at": "2014-06-22T14:10:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7687",
    "type": "issue_comment",
...
<a id='comment:5'></a>`leonconv` is not shipped anymore.
