...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81252",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Small modification to distance_graph too:\n\nBefore :\n\n```\nsage: %timeit g.distance_graph([2,8,9])\n10 loops, best of 3: 127 ms per loop\n```\nAfter\n\n```\nsage: %timeit g.distance_graph([2,8,9])\n10 loops, best of 3: 49 ms per loop\n```\n\nNathann",
    "created_at": "2010-01-17T15:36:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81253",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>Small modification to distance_graph too:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81255",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81256",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81258",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81259",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_7966.patch](tarball://root/attachments/some-uuid/ticket7966/trac_7966.patch) by @zimmermann6 created at 2010-02-26 11:02:06\n\nwith the new patch `c_graph.pyx` works again:\n\n```\n[zimmerma@coing sage]$ sage -t  graphs/base/c_graph.pyx\nsage -t  \"devel/sage-7966/sage/graphs/base/c_graph.pyx\"     \n         [2.5 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 2.5 seconds\n```\nThus a positive review.\n\nPaul",
    "created_at": "2010-02-26T11:02:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81260",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>Attachment [trac_7966.patch](tarball://root/attachments/some-uuid/ticket7966/trac_7966.patch) by @zimmermann6 created at 2010-02-26 11:02:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81261",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81262",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7966#issuecomment-81263",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
