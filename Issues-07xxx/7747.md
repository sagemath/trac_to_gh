...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77687",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77688",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77689",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77690",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77691",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77692",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is a duplicate of #7659, but the patch here does a little more.  Can we use this patch instead of that one?",
    "created_at": "2009-12-22T19:02:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77694",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>This is a duplicate of #7659, but the patch here does a little more.  Can we use this patch instead of that one?
...
```json
{
    "body": "<a id='comment:4'></a>I've merged the patch here instead of the one at #7659.",
    "created_at": "2009-12-23T13:28:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77695",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>I've merged the patch here instead of the one at #7659.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77696",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77697",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Could you please make sure that burcin also gets author credit for this (for his work on #7659)?  Thanks.",
    "created_at": "2009-12-23T15:54:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77698",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Could you please make sure that burcin also gets author credit for this (for his work on #7659)?  Thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77699",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7747#issuecomment-77700",
    "user": "https://github.com/mwhansen"
}
```
