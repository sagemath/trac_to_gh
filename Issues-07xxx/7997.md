...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81735",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_7997-ast-display-hook-incomplete.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook-incomplete.patch) by @TimDumol created at 2010-01-20 23:59:18\n\nHey, are you working on the pexpect stuff yet? If not, I'll start work on it as soon as you reply.",
    "created_at": "2010-01-20T23:59:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81736",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:1'></a>Attachment [trac_7997-ast-display-hook-incomplete.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook-incomplete.patch) by @TimDumol created at 2010-01-20 23:59:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81738",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81739",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81740",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Hi, has there been any progress on this? I'd love to assist/continue any work done here.",
    "created_at": "2010-03-09T15:48:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81743",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:6'></a>Hi, has there been any progress on this? I'd love to assist/continue any work done here.
...
```json
{
    "body": "<a id='comment:7'></a>Unfortunately not - I overestimated the amount of time I had.",
    "created_at": "2010-03-09T16:40:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81744",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

<a id='comment:7'></a>Unfortunately not - I overestimated the amount of time I had.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81745",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81746",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Wow - that's awesome - great work Tim!  I definitely need to read up on the `multiprocessing` module.  Using `multiprocessing.Pipe()` and `multiprocessing.Connection()` is definitely the way to go.  Also it should be fairly easy to create a remote implementation with `multiprocessing.connection.Client()`.\n\nJust a note for others on how this works: The worker process that executes the code has a `multiprocessing.Connection()` back to the manager process.  That connection can `send(obj)` and `recv() -> obj`, where `obj` is a picklable object, in this case:\n* Manager to Worker: `ExecutionData(preparse, print_expressions, string, tempdir, temp_file.name, transaction_number)` objects\n* Worker to Manager: either `(transaction_number, data)` where `data` is a string from `sys.stdout` or `sys.stderr`, or `(transaction_number, 0)` where the `0` means that the computation is finished.",
    "created_at": "2010-04-02T17:40:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81747",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

<a id='comment:9'></a>Wow - that's awesome - great work Tim!  I definitely need to read up on the `multiprocessing` module.  Using `multiprocessing.Pipe()` and `multiprocessing.Connection()` is definitely the way to go.  Also it should be fairly easy to create a remote implementation with `multiprocessing.connection.Client()`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81748",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81750",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81751",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81752",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [trac_7997-ast-display-hook.2.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook.2.patch) by @TimDumol created at 2010-04-14 18:20:46",
    "created_at": "2010-04-14T18:20:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81753",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:11'></a>Attachment [trac_7997-ast-display-hook.2.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook.2.patch) by @TimDumol created at 2010-04-14 18:20:46
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81754",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81755",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [trac_7997-ast-display-hook.3.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook.3.patch) by @TimDumol created at 2010-04-18 07:43:45\n\nThis patch fixes a doctest. Please ignore attachment:trac_7908-pub_interact_c11-rebase.patch.",
    "created_at": "2010-04-18T07:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81756",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:14'></a>Attachment [trac_7997-ast-display-hook.3.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook.3.patch) by @TimDumol created at 2010-04-18 07:43:45
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81757",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [trac_7997-ast-display-hook.4.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook.4.patch) by @TimDumol created at 2010-05-04 04:27:19\n\nHow's the refactoring going?",
    "created_at": "2010-05-04T04:27:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81758",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:15'></a>Attachment [trac_7997-ast-display-hook.4.patch](tarball://root/attachments/some-uuid/ticket7997/trac_7997-ast-display-hook.4.patch) by @TimDumol created at 2010-05-04 04:27:19
...
```json
{
    "body": "<a id='comment:16'></a>Tim: Can you split this into 2 patches:\n1. The AST stuff and API changes.\n2. Adding the multiprocessing interface.\n\nWilliam mentioned that we should keep the pexpect interface working.",
    "created_at": "2010-05-20T08:26:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81759",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

<a id='comment:16'></a>Tim: Can you split this into 2 patches:
1. The AST stuff and API changes.
2. Adding the multiprocessing interface.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81760",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>This new patch lets the pexpect interface work again, and allows one to configure the backend to pexpect, pipes or reference (defaulting to pipes). Is this enough, or shall I split it?",
    "created_at": "2010-05-23T13:08:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81761",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:17'></a>This new patch lets the pexpect interface work again, and allows one to configure the backend to pexpect, pipes or reference (defaulting to pipes). Is this enough, or shall I split it?
...
```json
{
    "body": "<a id='comment:18'></a>ping about reviewing.  If the two of you wrote this together, what do you want from a third reviewer?  I don't have time to read and understand it all right now.  But I can install and test it.\n\nI had a student complain the other day that Sage only did one thing at a time, so this patch would be appreciated!",
    "created_at": "2010-09-28T21:07:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81762",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:18'></a>ping about reviewing.  If the two of you wrote this together, what do you want from a third reviewer?  I don't have time to read and understand it all right now.  But I can install and test it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81764",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Proposing to close all sagenb tickets as outdated, so that all remaining open tickets in the notebook component are about the Jupyter notebook.",
    "created_at": "2020-08-18T00:36:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81765",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:24'></a>Proposing to close all sagenb tickets as outdated, so that all remaining open tickets in the notebook component are about the Jupyter notebook.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81766",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81767",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81768",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7997#issuecomment-81769",
