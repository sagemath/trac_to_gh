...
{
    "assignees": [],
    "body": "Observe the docstring for solve_left for an RDF matrix:\n\n```\nsage: A = random_matrix(RDF,3)\nsage: A.solve_left?\nSolve the equation A*x = b, where\n        \n        EXAMPLES:\n            sage: A = matrix(RDF, 3,3, [1,2,5,7.6,2.3,1,1,2,-1]); A\n            [ 1.0  2.0  5.0]\n            [ 7.6  2.3  1.0]\n            [ 1.0  2.0 -1.0]\n            sage: b = vector(RDF,[1,2,3])\n            sage: x = A.solve_left(b); x\n            (-0.113695090439, 1.39018087855, -0.333333333333)\n            sage: A*x\n            (1.0, 2.0, 3.0)\n```\n\nBut that is solve_right. \n\nThis was evidently introduced by maybe Grout's \"Switch the RDF and CDF matrices to a numpy 1.2 backend; factor out common functionality to matrix_double_dense.pyx.\".\n\nReported by Stephanie Dietzel\n\n---\n\nApply\n1. [attachment: trac_7852-solve-linear-systems-CDF.patch.gz](https://github.com/sagemath/sage/files/ticket7852/trac_7852-solve-linear-systems-CDF.patch.gz)\n2. [attachment: trac_7852-fix_noise_errors_in_preparser_examples.reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket7852/trac_7852-fix_noise_errors_in_preparser_examples.reviewer.patch.gz)\n3. [attachment: trac_7852-fix_noise_errors_in_polys.reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket7852/trac_7852-fix_noise_errors_in_polys.reviewer.patch.gz)\n4. [attachment: trac_7852-fix_noisy_zero_error_in_matrix_double_dense.reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket7852/trac_7852-fix_noisy_zero_error_in_matrix_double_dense.reviewer.patch.gz)\n5. [attachment: trac_7852-adjust_noisy_zero_term_threshold_for_polys.reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket7852/trac_7852-adjust_noisy_zero_term_threshold_for_polys.reviewer.patch.gz)\nto the Sage library.\n\n\nDepends on #11848\n\nAssignee: **@williamstein**\n\nCC:  @jasongrout\n\nAuthor: **Rob Beezer,  Leif Leonhardy**\n\nReviewer: **Martin Raum, Leif Leonhardy, Rob Beezer**\n\nMerged: **sage-4.7.2.alpha3**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/7852_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88457"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88467"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88468"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88469"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,3 +22,8 @@\n This was evidently introduced by maybe Grout's \"Switch the RDF and CDF matrices to a numpy 1.2 backend; factor out common functionality to matrix_double_dense.pyx.\".\n \n Reported by Stephanie Dietzel\n+\n+---\n+\n+Apply [attachment: trac_7852-solve-linear-systems-CDF.patch.gz](https://github.com/sagemath/sage/files/ticket7852/trac_7852-solve-linear-systems-CDF.patch.gz) to the Sage library.\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88472"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7852#event-88473"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61245",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61246",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61247",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61248",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61249",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61250",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61251",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61252",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61253",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61254",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61255",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61256",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7852#issuecomment-61257",
    "user": "https://github.com/nexttime"
}
```
