# Issue 7055: [with patch, positive review] Fix 32-bit versus 64-bit in pbori.pyx doctest
...
```json
{
    ...
    "title": "[with patch, positive review] Fix 32-bit versus 64-bit in pbori.pyx doctest",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7055#issuecomment-58288",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7055#issuecomment-58289",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7055",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7055#event-16631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7055#issuecomment-58290",
