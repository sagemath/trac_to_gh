...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_7145-iet-vd.patch](tarball://root/attachments/some-uuid/ticket7145/trac_7145-iet-vd.patch) by @videlec created at 2009-10-07 12:15:27",
    "created_at": "2009-10-07T12:15:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68044",
    "user": "https://github.com/videlec"
}
```

<a id='comment:1'></a>Attachment [trac_7145-iet-vd.patch](tarball://root/attachments/some-uuid/ticket7145/trac_7145-iet-vd.patch) by @videlec created at 2009-10-07 12:15:27
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68045",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68046",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68047",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68048",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68049",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I submitted before preview. So I repeat below the lists that I messed up above.\n\nFor constructor.py, I suggest to\n\n- Create a class constructor containing the functions `PermutationsIET`, `PermutationIET`, `PermutationLI`, `GeneralizedPermutation`, `RauzyDiagram`, `IntervalExchangeTransformation`. \n- Create the object `IET` = `constructor()` \n- Rename `PermutationsIET` to `PermutationsIET_iterator` \n- Add a function named `IntervalExchangeTransformation` to the class constructor that wrapped the constructor of IET in `iet.py`. \n- Do we want `AbelianStratum`, `QuadraticStratum` and `AbelianStrata` to be wrapped in constructor as well? I don't know, but if it is realated to everything in iet folder, then it would clearly help the user to know about it.\n\nFor iet.py\n\n- Rename `IntervalExchangeTransformation.__mul__` to something like `multiply_lengths`. \n- Keep `IntervalExchangeTransformation.__mul__` for multiplication of two IET. \n- Change `IntervalExchangeTransformation._repr_` to look more like an `IET` and less as two tuples. For example it could say Interval exchange transformation from [0, 1[ to [0, 1[ of permutation ?. \n- Rename `IntervalExchangeTransformation.copy` as `__copy__` or `__deepcopy__` if it corresponds to what you want. This may applies to many other classes in the files.",
    "created_at": "2009-12-08T16:36:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68051",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>I submitted before preview. So I repeat below the lists that I messed up above.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68052",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_7145-review-sl.patch](tarball://root/attachments/some-uuid/ticket7145/trac_7145-review-sl.patch) by @seblabbe created at 2009-12-10 16:17:35\n\nVincent, I tried your code again with Thierry Monteil who knows better this field and he liked all the functions you implemented.\n\nHe suggested that you change Permutation* to `LabelledPermutation` or `PermutationwithLabel`... up to you.\n\nAlso, I notice the following. I think it should be a method and not an attribute :\n\n```\nsage: p = Permutation([4,3,2,1])\nsage: pp = PermutationIET(p)\nsage: pp.alphabet\nOrdered Alphabet [1, 2, 3, 4]\n```",
    "created_at": "2009-12-10T16:17:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68053",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:5'></a>Attachment [trac_7145-review-sl.patch](tarball://root/attachments/some-uuid/ticket7145/trac_7145-review-sl.patch) by @seblabbe created at 2009-12-10 16:17:35
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68054",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68055",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68056",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68058",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68059",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68060",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68061",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68062",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68063",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68064",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68065",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Attachment [trac_7145-corrections2-vd.patch](tarball://root/attachments/some-uuid/ticket7145/trac_7145-corrections2-vd.patch) by @seblabbe created at 2010-01-06 15:09:54\n\nGreat. Point ONE above was addressed. The documentation coverage is now 100% perfect. All tests passed. \n\nI builded the documentation and there was several sphinx issues. I corrected them in a patch that I will upload shortly.",
    "created_at": "2010-01-06T15:09:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68066",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:10'></a>Attachment [trac_7145-corrections2-vd.patch](tarball://root/attachments/some-uuid/ticket7145/trac_7145-corrections2-vd.patch) by @seblabbe created at 2010-01-06 15:09:54
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68067",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Vincent, can you review my last patch and make sure everything is OK with the sphinx output? My patch solved some sphinx syntax, but I feel like more improvements could be done.",
    "created_at": "2010-01-06T15:43:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68068",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:11'></a>Vincent, can you review my last patch and make sure everything is OK with the sphinx output? My patch solved some sphinx syntax, but I feel like more improvements could be done.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68069",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>> I'm not sure about what you did with the OUTPUT part of the documentation string. It does not correspond to what is written in the \"developer's guide\"\n\n\nMy fault. In fact, I should update the way I write the OUTPUT part. I will take a closer look to the developer's guide. Feel free to change those.",
    "created_at": "2010-01-08T15:06:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68070",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:13'></a>> I'm not sure about what you did with the OUTPUT part of the documentation string. It does not correspond to what is written in the "developer's guide"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68072",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68073",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68074",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68075",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I folded the relevant patches together : trac_7145-iet-final.patch .\n\nPositive review.",
    "created_at": "2010-01-13T17:59:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68076",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:15'></a>I folded the relevant patches together : trac_7145-iet-final.patch .
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68077",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68078",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7145#issuecomment-68079",
    "user": "https://github.com/rlmill"
}
```
