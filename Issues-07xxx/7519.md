...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83822"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83825"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7519#issuecomment-57113",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7519#issuecomment-57114",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7519",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7519#event-83830"
}
```
