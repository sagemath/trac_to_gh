...
```json
{
    "body": "**Attachment:** [sagenb_7783.patch](https://github.com/sagemath/sage/files/ticket7783/sagenb_7783.patch)\n\nApply this patch alone to the sagenb repo. Updates scripts to use pkg_resources to look for sagenb.",
    "created_at": "2009-12-29T08:40:50Z",
    "issue": "https://github.com/sagemath/sage/issues/7783",
    "type": "issue_comment",
...
**Attachment:** [sagenb_7783.patch](https://github.com/sagemath/sage/files/ticket7783/sagenb_7783.patch)
...
archive/attachments_009834.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_7783-sagenb-scripts.patch",
    "asset_url": "tarball://root/attachments/ticket7783/trac_7783-sagenb-scripts.patch",
    "created_at": "2009-12-29T08:41:26Z",
    "issue": "https://github.com/sagemath/sage/issues/7783",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7783/trac_7783-sagenb-scripts.patch",
    "user": "https://github.com/TimDumol"
}
```
...
archive/attachments_009835.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_7783-sagenb-scripts.patch](https://github.com/sagemath/sage/files/ticket7783/trac_7783-sagenb-scripts.patch)\n\n**Attachment:** [trac_7783-sage-scripts.patch](https://github.com/sagemath/sage/files/ticket7783/trac_7783-sage-scripts.patch)\n\nApply this patch alone to the sage scripts repo. Adds a script that uses pkg_resources to find the location of a given package.",
    "created_at": "2009-12-29T08:41:26Z",
    "issue": "https://github.com/sagemath/sage/issues/7783",
    "type": "issue_comment",
...
**Attachment:** [trac_7783-sagenb-scripts.patch](https://github.com/sagemath/sage/files/ticket7783/trac_7783-sagenb-scripts.patch)
