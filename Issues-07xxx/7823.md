...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-78993",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-78994",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-78995",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I'll trust you it worked on FreeBSD. Clearly it can have no impact on any other system, so its a positive from me. \n\nDave",
    "created_at": "2010-01-05T18:49:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-78996",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>I'll trust you it worked on FreeBSD. Clearly it can have no impact on any other system, so its a positive from me. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-78997",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-78999",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-79000",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7823#issuecomment-79001",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
