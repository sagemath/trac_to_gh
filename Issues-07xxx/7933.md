...
```json
{
    "body": "<a id='comment:1'></a>Attachment [README.patch](tarball://root/attachments/some-uuid/ticket7933/README.patch) by mvngu created at 2010-01-15 11:01:07",
...
<a id='comment:1'></a>Attachment [README.patch](tarball://root/attachments/some-uuid/ticket7933/README.patch) by mvngu created at 2010-01-15 11:01:07
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-It's that time of the year again when the copyright years for Sage need to be updated to reflect the new year. The copyright years should now span 2006--2010. The [Sage wiki](http://wiki.sagemath.org/devel/UpdateCopyright) contains a page that lists file you need to edit in order to update the copyright years.\n+It's that time of the year again when the copyright years for Sage need to be updated to reflect the new year. The copyright years should now span 2005--2010. The [Sage wiki](http://wiki.sagemath.org/devel/UpdateCopyright) contains a page that lists file you need to edit in order to update the copyright years.\n \n Summary: update copyright years to span 2006--2010\n \n``````\n",
...
<a id='comment:3'></a>I think the above patches should take care of updating the copyright years. Here's a description of these patches and where to apply them:
...
<a id='comment:4'></a>All three patches apply cleanly.  In particular, they're in line with [UpdateCopyright](http://wiki.sagemath.org/devel/UpdateCopyright).
...
```json
{
    "body": "<a id='comment:5'></a>Merged as per the above instructions.",
    "created_at": "2010-02-02T05:17:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7933",
    "type": "issue_comment",
...
<a id='comment:5'></a>Merged as per the above instructions.
