...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7465#issuecomment-56301",
...
archive/attachments_008984.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac-8010_numpy.patch",
    "asset_url": "tarball://root/attachments/ticket7465/trac-8010_numpy.patch",
    "created_at": "2010-11-04T11:55:08Z",
    "issue": "https://github.com/sagemath/sage/issues/7465",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7465/trac-8010_numpy.patch",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac-8010_numpy.patch](https://github.com/sagemath/sage/files/ticket7465/trac-8010_numpy.patch) by mvngu created at 2010-11-04 11:55:08",
    "created_at": "2010-11-04T11:55:08Z",
    "issue": "https://github.com/sagemath/sage/issues/7465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7465#issuecomment-56302",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7465#issuecomment-56303",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7465#issuecomment-56304",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7465#event-50554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7465",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7465#event-50555"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7465#event-50556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7465#issuecomment-56305",
