...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7493#issuecomment-56705",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7493#issuecomment-56706",
...
```json
{
    "body": "Attachment [trac_7493-check-long-time.patch](https://github.com/sagemath/sage/files/ticket7493/trac_7493-check-long-time.patch) by @nthiery created at 2010-01-23 22:59:26",
    "created_at": "2010-01-23T22:59:26Z",
    "issue": "https://github.com/sagemath/sage/issues/7493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7493#issuecomment-56707",
    "user": "https://github.com/nthiery"
}
```

Attachment [trac_7493-check-long-time.patch](https://github.com/sagemath/sage/files/ticket7493/trac_7493-check-long-time.patch) by @nthiery created at 2010-01-23 22:59:26
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7493#issuecomment-56708",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7493#issuecomment-56709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7493#issuecomment-56710",
    "user": "https://github.com/jdemeyer"
}
```
