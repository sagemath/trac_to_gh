...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93793"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93796"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93797"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93798"
}
```
...
```json
{
    ...
    "subject": "https://github.com/rlmill",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93799"
}
```
...
```json
{
    ...
    "subject": "https://github.com/rlmill",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56738",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56739",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56740",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93801"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93802"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56741",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56742",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56743",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93803"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56744",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93805"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56745",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56746",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93807"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93808"
}
```
...
```json
{
    "body": "<div id=\"comment:12\" align=\"right\">comment:12</div>\n\nReplying to [@sagetrac-fwclarke](#comment:10):\n> After the patch (with 4.3.rc0):\n> \n> ```\n> sage: K.<a> = QuadraticField(-3)\n> sage: L.<b> = K.extension(x - 5)\n> sage: a*b\n> 5*a\n> ```\n> The result was `0` before.\n\nSince b == 5, this is correct.\n\n> But\n> \n> ```\n> sage: b\n> ---------------------------------------------------------------------------\n> IndexError \n> ...\n> IndexError: tuple index out of range\n> ```\n> The result was `5` before.\n\nI've fixed this, and posted a new patch.",
    "created_at": "2009-12-22T07:00:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56747",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56748",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93810"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93811"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93812"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56749",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56750",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56751",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56752",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56753",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56754",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56755",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56756",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93813"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7616#issuecomment-56757",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7616",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7616#event-93816"
}
```
