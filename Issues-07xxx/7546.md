...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74405",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>In the app-bundle patch I accidentally added a .DS_Store file, but then I removed it.  I hope that doesn't cause any problems with history.",
    "created_at": "2009-11-27T20:51:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74406",
    "user": "https://github.com/gvol"
}
```

<a id='comment:1'></a>In the app-bundle patch I accidentally added a .DS_Store file, but then I removed it.  I hope that doesn't cause any problems with history.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74407",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Is it possible to fix #5261 in here as well (somehow detecting Intel vs. PPC, for instance)?",
    "created_at": "2009-11-28T04:24:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74408",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>Is it possible to fix #5261 in here as well (somehow detecting Intel vs. PPC, for instance)?
...
```json
{
    "body": "<a id='comment:3'></a>I haven't added anything to detect Intel/PPC, but I think I have fixed the rest of #5261.  I think detection should be a separate ticket.",
    "created_at": "2009-11-28T09:44:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74409",
    "user": "https://github.com/gvol"
}
```

<a id='comment:3'></a>I haven't added anything to detect Intel/PPC, but I think I have fixed the rest of #5261.  I think detection should be a separate ticket.
...
```json
{
    "body": "<a id='comment:4'></a>I like the bdist patch, except for some reason it doesn't look like the sage-bdist at [http://hg.sagemath.org/scripts-main](http://hg.sagemath.org/scripts-main).    Does this depend on some other patch (perhaps one in 4.3.alpha0)?",
    "created_at": "2009-12-04T16:03:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74410",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>I like the bdist patch, except for some reason it doesn't look like the sage-bdist at [http://hg.sagemath.org/scripts-main](http://hg.sagemath.org/scripts-main).    Does this depend on some other patch (perhaps one in 4.3.alpha0)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74411",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Oops, very sorry about that.  I had some local changes committed when upgrading.  I have updated the patch to work against 4.3.alpha1, and have started using mercurial queues to prevent this sort of mistake in the future.",
    "created_at": "2009-12-06T21:20:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74412",
    "user": "https://github.com/gvol"
}
```

<a id='comment:5'></a>Oops, very sorry about that.  I had some local changes committed when upgrading.  I have updated the patch to work against 4.3.alpha1, and have started using mercurial queues to prevent this sort of mistake in the future.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74413",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74415",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Ack!  That's exactly what I meant.  That's what I get for not waiting the incredible amount of time it takes to build before posting a patch.  I have uploaded a patch that I actually tested this time :)\n\nAs for the other, try (from the top level sage directory)\n\ncd data/extcode\ncurl http://trac.sagemath.org/sage_trac/raw-attachment/ticket/7546/app-bundle-7546.patch | sage -hg import -\n\nthat seems to have worked for me.  I tried to use hg_sage.import_patch(...) but it put it in the wrong place.  I'm no expert in that part of sage so I probably did something wrong.",
    "created_at": "2009-12-07T22:16:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74417",
    "user": "https://github.com/gvol"
}
```

<a id='comment:8'></a>Ack!  That's exactly what I meant.  That's what I get for not waiting the incredible amount of time it takes to build before posting a patch.  I have uploaded a patch that I actually tested this time :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74418",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74419",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>> So obviously hg_sage.import... didn't actually import these files.\n\n\nIt's a patch to the extcode repo, so you have to use `hg_extcode.import`...",
    "created_at": "2009-12-08T06:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74421",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:10'></a>> So obviously hg_sage.import... didn't actually import these files.
...
```json
{
    "body": "<a id='comment:11'></a>kcrisman thanks for reviewing it even through all the rockiness, and thanks was for the pointer to hg_extcode.  It makes so much more sense now.",
    "created_at": "2009-12-08T09:28:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74422",
    "user": "https://github.com/gvol"
}
```

<a id='comment:11'></a>kcrisman thanks for reviewing it even through all the rockiness, and thanks was for the pointer to hg_extcode.  It makes so much more sense now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74424",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74425",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74427",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I'm also looking to check what happens when I try to run an Intel bundle on a PPC, but unless the network significantly speeds up, that won't happen today.\n\nThe reason why I still put positive review despite the migration issue is that at this point the sage-bdist doesn't make these by default, and sage-support can easily point to downloading the non-notebook version when that time comes.  I'm putting that on #7622 as well.",
    "created_at": "2009-12-08T16:57:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74428",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:15'></a>I'm also looking to check what happens when I try to run an Intel bundle on a PPC, but unless the network significantly speeds up, that won't happen today.
...
```json
{
    "body": "<a id='comment:16'></a>Sorry, that is not the right ticket, so I guess I'll leave it here.",
    "created_at": "2009-12-08T16:58:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74429",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:16'></a>Sorry, that is not the right ticket, so I guess I'll leave it here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74430",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7546#issuecomment-74431",
    "user": "https://github.com/mwhansen"
}
```
