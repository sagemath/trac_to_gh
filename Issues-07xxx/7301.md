...
<a id='comment:25'></a>Replying to [comment:6 ncohen]:
> Now with non-square matrices ;-)
...
<a id='comment:26'></a>Replying to [comment:25 wdj]:
> Replying to [comment:6 ncohen]:
> > Now with non-square matrices ;-)
