...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86929"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86930"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86931"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86932"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7133#issuecomment-51343",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86933"
}
```
