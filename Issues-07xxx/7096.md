...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67427",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67429",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67431",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I worked on the bugs for isogenies and I found two. They should be corrected with the above patch. But I have to do some more work and test it carefully, before it is ready for a review.",
    "created_at": "2009-10-17T23:13:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67432",
    "user": "https://github.com/categorie"
}
```

<a id='comment:5'></a>I worked on the bugs for isogenies and I found two. They should be corrected with the above patch. But I have to do some more work and test it carefully, before it is ready for a review.
...
```json
{
    "body": "<a id='comment:8'></a>Yet another bug with `dual`. I have to chase that. It does not look like being related to the previously reported bugs.\n\n```\nk = GF(103)\nE = EllipticCurve(k,[1,0,0,1,-1])\nP = E(60,85)\nphi = E.isogeny(P)\nphi.dual()\n```\n\ngives\n\n```\nIndexError: list index out of range\n```\n\nin  line 3789.\n\n(I keep on adding these bugs here and I try to resolve as many as I can with the patch for this. Only then I will open new tickets for the remaining ones)",
    "created_at": "2009-10-24T17:29:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67435",
    "user": "https://github.com/categorie"
}
```

<a id='comment:8'></a>Yet another bug with `dual`. I have to chase that. It does not look like being related to the previously reported bugs.
...
```json
{
    "body": "<a id='comment:9'></a>Thanks for your work on this.  Perhaps we should make dual raise a NotImplementedError since it fails in so many different ways?\n\nI think that when Dan Shumow implemented all the isogeny stuff he was mainly interested in certain kinds of isogenies (over finite fields?) so did not test as much in other situations.  Just guessing.  [For example, he added the model parameter on my request, over Q only;  I would have made that the default over Q.]",
    "created_at": "2009-10-24T19:19:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67436",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>Thanks for your work on this.  Perhaps we should make dual raise a NotImplementedError since it fails in so many different ways?
...
```json
{
    "body": "<a id='comment:10'></a>The problem is that most errors go back to problems for the `EllipticCurveIsogeny` constructor itself. So they can be recreated without `dual`. Of course, I don't want `isogeny()` to raise a `NotImplementedError`. But I will include warnings in the documentation...",
    "created_at": "2009-10-24T20:22:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67437",
    "user": "https://github.com/categorie"
}
```

<a id='comment:10'></a>The problem is that most errors go back to problems for the `EllipticCurveIsogeny` constructor itself. So they can be recreated without `dual`. Of course, I don't want `isogeny()` to raise a `NotImplementedError`. But I will include warnings in the documentation...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67438",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67440",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67441",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Sorry I saw that the patch does not include the new file ell_wp.py.",
    "created_at": "2009-11-01T14:33:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67442",
    "user": "https://github.com/categorie"
}
```

<a id='comment:13'></a>Sorry I saw that the patch does not include the new file ell_wp.py.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67443",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>You have done a great job, and I look forward to studying it in detail.  Unfortunately other work prevents me from doing so for quite a while, so although I was the one who posted this (complete with under-estimation of the work involved) I would be very happy if someone else interested reviews it first.",
    "created_at": "2009-11-01T15:06:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67444",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:14'></a>You have done a great job, and I look forward to studying it in detail.  Unfortunately other work prevents me from doing so for quite a while, so although I was the one who posted this (complete with under-estimation of the work involved) I would be very happy if someone else interested reviews it first.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67445",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67446",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>After writing the above I went ahead anyway and read the patch -- when ell_wp.py is added too I'll try test to test it as well.",
    "created_at": "2009-11-01T15:15:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67447",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:16'></a>After writing the above I went ahead anyway and read the patch -- when ell_wp.py is added too I'll try test to test it as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67448",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Ok that was easy. now it should be review-able.",
    "created_at": "2009-11-01T15:23:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67449",
    "user": "https://github.com/categorie"
}
```

<a id='comment:17'></a>Ok that was easy. now it should be review-able.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67450",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>That was quick ! Thanks a lot.\n\nChris.",
    "created_at": "2009-11-01T17:37:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67452",
    "user": "https://github.com/categorie"
}
```

<a id='comment:19'></a>That was quick ! Thanks a lot.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67453",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67454",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67455",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67456",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67457",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7096#issuecomment-67458",
    "user": "https://github.com/fchapoton"
}
```
