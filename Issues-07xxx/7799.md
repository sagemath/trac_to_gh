...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60675",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60676",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7799/trac_7799-install-scripts.patch",
    "created_at": "2009-12-31T07:07:44Z",
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7799/trac_7799-install-scripts.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [trac_7799-install-scripts.patch](https://github.com/sagemath/sage/files/ticket7799/trac_7799-install-scripts.patch) by @jhpalmieri created at 2009-12-31 07:07:44\n\npatch for main Sage repository",
    "created_at": "2009-12-31T07:07:44Z",
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60677",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [trac_7799-install-scripts.patch](https://github.com/sagemath/sage/files/ticket7799/trac_7799-install-scripts.patch) by @jhpalmieri created at 2009-12-31 07:07:44
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60678",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60679",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60680",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7799#issuecomment-60681",
