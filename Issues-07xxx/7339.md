...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7339#issuecomment-54988",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7339#issuecomment-54989",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7339#issuecomment-54990",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "Attachment [trac_7339-sagenb_cell_bugs_v2.patch](https://github.com/sagemath/sage/files/ticket7339/trac_7339-sagenb_cell_bugs_v2.patch) by @qed777 created at 2009-10-31 08:50:47\n\nRebased vs. #7309, #7310, #7332.  Apply only this patch.",
    "created_at": "2009-10-31T08:50:47Z",
    "issue": "https://github.com/sagemath/sage/issues/7339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7339#issuecomment-54992",
    "user": "https://github.com/qed777"
}
```

Attachment [trac_7339-sagenb_cell_bugs_v2.patch](https://github.com/sagemath/sage/files/ticket7339/trac_7339-sagenb_cell_bugs_v2.patch) by @qed777 created at 2009-10-31 08:50:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7339#issuecomment-54993",
