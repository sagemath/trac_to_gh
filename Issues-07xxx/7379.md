...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71748",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71749",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71750",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Two patches are attached: one for sagenb, and one for sage devel repository.  \n\nCCing timdumol (naturally, for the notebook/decorator stuff), and mhansen (for the decorator trickery) and was",
    "created_at": "2010-05-13T07:50:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71751",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>Two patches are attached: one for sagenb, and one for sage devel repository.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71752",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71753",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>CCing mhampton, who has expressed interest in looking at this patch before.",
    "created_at": "2010-05-13T07:54:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71754",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>CCing mhampton, who has expressed interest in looking at this patch before.
...
```json
{
    "body": "<a id='comment:6'></a>See #8959 for further extensions of this idea that allow arbitrary HTML in the layout.",
    "created_at": "2010-05-13T09:06:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71755",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>See #8959 for further extensions of this idea that allow arbitrary HTML in the layout.
...
```json
{
    "body": "<a id='comment:7'></a>The patch at #8959 doesn't quite allow the user to specify arbitrary HTML yet, but does allow the controls to be placed on any of the four sides of the interact.\n\nPlease, please review the patch at #8959 after reviewing this patch.  The patch there extends the functionality of the patch here, and should be easy to review after you've looked at this patch.",
    "created_at": "2010-05-14T07:17:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71756",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>The patch at #8959 doesn't quite allow the user to specify arbitrary HTML yet, but does allow the controls to be placed on any of the four sides of the interact.
...
```json
{
    "body": "<a id='comment:9'></a>mhampton: that's a corner case in the `@`interact functionality (a magic parameter).  I see two possible fixes: fix `@`interact to make this not a corner case (i.e., not a magic parameter), or move the auto_update switch into the `@`interact arguments:\n\n```\n@interact(auto_update=False)\ndef _(...)\n    ...\n```",
    "created_at": "2010-05-15T21:31:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71758",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:9'></a>mhampton: that's a corner case in the `@`interact functionality (a magic parameter).  I see two possible fixes: fix `@`interact to make this not a corner case (i.e., not a magic parameter), or move the auto_update switch into the `@`interact arguments:
...
```json
{
    "body": "<a id='comment:10'></a>The reason auto_update was included in the function arguments, rather than the `@`interact arguments, is given here: http://groups.google.com/group/sage-devel/browse_thread/thread/9ff935e0d6a729b3/b295d52d195ac9ec?lnk=gst&q=interact#b295d52d195ac9ec\n\nHowever, with this patch is a decorator that transparently and easily takes care of the objection.  Are there any objections now to moving the auto_update argument up to the `@`interact decorator (other than backwards compatibility)?\n\nMike? William? You guys were the ones that objected to `@`interact(auto_update=False) in the thread listed above.",
    "created_at": "2010-05-15T22:03:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71759",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:10'></a>The reason auto_update was included in the function arguments, rather than the `@`interact arguments, is given here: http://groups.google.com/group/sage-devel/browse_thread/thread/9ff935e0d6a729b3/b295d52d195ac9ec?lnk=gst&q=interact#b295d52d195ac9ec
...
```json
{
    "body": "<a id='comment:11'></a>I think it's fine with the decorator defaults patch.",
    "created_at": "2010-05-15T22:07:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71760",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:11'></a>I think it's fine with the decorator defaults patch.
...
```json
{
    "body": "<a id='comment:12'></a>I just posted a long message to sage-notebook for a vote.",
    "created_at": "2010-05-15T22:17:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71761",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:12'></a>I just posted a long message to sage-notebook for a vote.
...
```json
{
    "body": "<a id='comment:13'></a>I'm posting a fix to the auto_update doctest that Marshall mentioned on #8959.",
    "created_at": "2010-05-16T04:46:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71762",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:13'></a>I'm posting a fix to the auto_update doctest that Marshall mentioned on #8959.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71763",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71764",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>OK, with the fix in 8959 I see no problems with this.  I've tested a bunch of interacts from the wiki, and there seem to be no back-compatibility issues.  So I think I can give this a positive review.",
    "created_at": "2010-05-16T14:29:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71765",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:14'></a>OK, with the fix in 8959 I see no problems with this.  I've tested a bunch of interacts from the wiki, and there seem to be no back-compatibility issues.  So I think I can give this a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71766",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71768",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71769",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>In the two comments above yours, it says that the doctest is fixed in #8959.  Did you apply that patch as well?",
    "created_at": "2010-07-07T14:43:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71770",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:16'></a>In the two comments above yours, it says that the doctest is fixed in #8959.  Did you apply that patch as well?
...
```json
{
    "body": "<a id='comment:17'></a>I didn't notice the comment. Sorry! The doctests do pass now. Marking as positive review (we really do need to add a pathway from needs_info to positive review).",
    "created_at": "2010-07-07T14:51:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71771",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:17'></a>I didn't notice the comment. Sorry! The doctests do pass now. Marking as positive review (we really do need to add a pathway from needs_info to positive review).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71772",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71773",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71774",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71775",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71776",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71777",
...
```json
{
    "body": "<a id='comment:20'></a>Merged the sage-devel patch in sage-4.5.rc1.",
    "created_at": "2010-07-12T08:13:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7379#issuecomment-71778",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:20'></a>Merged the sage-devel patch in sage-4.5.rc1.
