...
```json
{
    "body": "**Attachment:** [swap_term_and_monomial-jb.patch](https://github.com/sagemath/sage/files/ticket7938/swap_term_and_monomial-jb.patch)",
    "created_at": "2010-01-15T18:51:07Z",
    "issue": "https://github.com/sagemath/sage/issues/7938",
    "type": "issue_comment",
...
**Attachment:** [swap_term_and_monomial-jb.patch](https://github.com/sagemath/sage/files/ticket7938/swap_term_and_monomial-jb.patch)
...
archive/attachments_010114.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_010115.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:8'></a>\n**Attachment:** [trac_7938_swap_term_and_monomial-jb.2.patch](https://github.com/sagemath/sage/files/ticket7938/trac_7938_swap_term_and_monomial-jb.2.patch)\n\n> Sorry for bothering you again. Please also remove the [mq] line, and put the rest on one line (hg treats the first line specifically).\n\nDone. Patch ready for merging into Sage.",
    "created_at": "2010-01-23T10:07:04Z",
    "issue": "https://github.com/sagemath/sage/issues/7938",
    "type": "issue_comment",
