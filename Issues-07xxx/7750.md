...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95835"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95836"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7750#issuecomment-58369",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95839"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7750#issuecomment-58370",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95840"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7750#issuecomment-58371",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7750#issuecomment-58372",
    "user": "https://github.com/mwhansen"
}
```
