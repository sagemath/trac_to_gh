...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7979#issuecomment-62666",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [pari_fltk.patch](https://github.com/sagemath/sage/files/ticket7979/pari_fltk.patch) by @wjp created at 2010-01-18 18:21:12\n\nI contacted Karim Belabas about this, suggesting the attached patch to pari's `config/get_fltk`.",
    "created_at": "2010-01-18T18:21:12Z",
    "issue": "https://github.com/sagemath/sage/issues/7979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7979#issuecomment-62667",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7979#issuecomment-62668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7979#issuecomment-62669",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7979#issuecomment-62670",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7979#issuecomment-62671",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
