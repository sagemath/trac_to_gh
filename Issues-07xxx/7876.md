...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79893",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79894",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I fixed this in pynac. attachment:trac_7876-pynac_print.patch contains doctest fixes.\n\nI will post a pynac package with the fix in the next few days.\n\nThanks a lot for the report.",
    "created_at": "2010-01-17T06:00:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79895",
    "user": "https://github.com/burcin"
}
```

<a id='comment:1'></a>I fixed this in pynac. attachment:trac_7876-pynac_print.patch contains doctest fixes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79896",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79897",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79898",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_7876-pynac_print.take2.patch](tarball://root/attachments/some-uuid/ticket7876/trac_7876-pynac_print.take2.patch) by @burcin created at 2010-01-19 14:09:15\n\nNew pynac package available here:\n\nhttp://sage.math.washington.edu/home/burcin/pynac/pynac-0.1.11.spkg\n\nThe package contains fixes for #7822, #6961, #7876, #7363, #6465 and #6559. Apart from this ticket, #7363 contains printing changes. Doctests should be run with the patch from that ticket applied as well.",
    "created_at": "2010-01-19T14:09:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79899",
    "user": "https://github.com/burcin"
}
```

<a id='comment:2'></a>Attachment [trac_7876-pynac_print.take2.patch](tarball://root/attachments/some-uuid/ticket7876/trac_7876-pynac_print.take2.patch) by @burcin created at 2010-01-19 14:09:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79900",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79901",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>See #6559 for the correct order of patches to avoid the reject.",
    "created_at": "2010-01-21T01:46:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79903",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>See #6559 for the correct order of patches to avoid the reject.
...
```json
{
    "body": "<a id='comment:5'></a>The following now displays correctly using Sage Version 4.3.1 (Release Date: 2010-01-20)\nwith pynac 0.1.11 (and also without any patches mentioned in this ticket)\n\n```\nsage: f=(1/2-1/2*I )*sqrt(2)\n\nsage: f\n(-1/2*I + 1/2)*sqrt(2)\n\nsage: f-1/2*sqrt(2)\n-1/2*I*sqrt(2)\n\nsage: f+1/2*sqrt(2)\n(-1/2*I + 1)*sqrt(2)\n\nsage: f-I*1/2*sqrt(2)\n(-I + 1/2)*sqrt(2)\n\nsage: f-I/2*sqrt(2)\n(-I + 1/2)*sqrt(2)\n\nsage: f+I/2*sqrt(2)\n1/2*sqrt(2)\n\nsage: latex(f)\n\\left(-\\frac{1}{2} I + \\frac{1}{2}\\right) \\, \\sqrt{2}\n\nsage: latex(f+I/2*sqrt(2))\n\\frac{1}{2} \\, \\sqrt{2}\n\nsage: (1-I)^2\n-2*I\n\nsage: (1+I)^2\n2*I\n\nsage: (1+I*sqrt(2))^2\n(I*sqrt(2) + 1)^2\n\nsage: expand((1+I*sqrt(2))^2)\n2*I*sqrt(2) - 1\n```",
    "created_at": "2010-01-25T08:23:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79904",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```

<a id='comment:5'></a>The following now displays correctly using Sage Version 4.3.1 (Release Date: 2010-01-20)
with pynac 0.1.11 (and also without any patches mentioned in this ticket)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79905",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79906",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79907",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79908",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Merged [trac_7876-pynac_print.take2.patch](http://trac.sagemath.org/sage_trac/attachment/ticket/7876/trac_7876-pynac_print.take2.patch).",
    "created_at": "2010-02-18T21:40:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7876#issuecomment-79909",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>Merged [trac_7876-pynac_print.take2.patch](http://trac.sagemath.org/sage_trac/attachment/ticket/7876/trac_7876-pynac_print.take2.patch).
