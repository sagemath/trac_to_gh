...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket7115/trac_7115-1st_draft.patch",
...
```json
{
    "body": "patch against cliquer-1.2.p0.spkg (root hg repo)",
    "created_at": "2009-10-06T22:20:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7115",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket7115/spkg-install",
