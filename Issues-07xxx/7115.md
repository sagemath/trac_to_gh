...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7115#issuecomment-52756",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7115#issuecomment-52757",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7115#issuecomment-52758",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7115#issuecomment-52759",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "**Attachment:** [trac_7115-1st_draft.patch](https://github.com/sagemath/sage/files/ticket7115/trac_7115-1st_draft.patch)\n\npatch against cliquer-1.2.p0.spkg (root hg repo)",
    "created_at": "2009-10-06T22:20:29Z",
    "issue": "https://github.com/sagemath/sage/issues/7115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7115#issuecomment-52760",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

**Attachment:** [trac_7115-1st_draft.patch](https://github.com/sagemath/sage/files/ticket7115/trac_7115-1st_draft.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7115#issuecomment-52761",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
