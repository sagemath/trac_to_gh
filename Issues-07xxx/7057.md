...
```json
{
    "body": "<a id='comment:1'></a>That's because cliquer-1.2.spkg is using SCons. The package cliquer-1.2.p0.spkg at #6681 doesn't use SCons at all.",
    "created_at": "2009-09-29T17:00:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7057#issuecomment-60271",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>That's because cliquer-1.2.spkg is using SCons. The package cliquer-1.2.p0.spkg at #6681 doesn't use SCons at all.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7057#issuecomment-60272",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7057#event-16642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7057",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7057#event-16643"
}
```
