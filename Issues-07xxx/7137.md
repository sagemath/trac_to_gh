...
```json
{
    "body": "<a id='comment:2'></a>This was fixed for OpenSolaris #8351. The fix also works for Solaris 10, so this can be closed. \n\nDave",
    "created_at": "2010-08-20T15:27:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7137",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7137#issuecomment-68001",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>This was fixed for OpenSolaris #8351. The fix also works for Solaris 10, so this can be closed. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7137",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7137#issuecomment-68002",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7137",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7137#issuecomment-68003",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
