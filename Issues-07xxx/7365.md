...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71341",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71342",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71343",
...
```json
{
    "body": "<a id='comment:2'></a>If you're introducing a new module in sage.graphs, the header of the file should be much more descriptive of what the module is for, etc... Take a look at some of the other files for examples.\n\nI'm (personally) very curious about what else you plan on including in `graph_decompositions`...\n\nThe patch applies cleanly, and the code looks good. Once again, I'd like to see a little more examples in the documentation.",
    "created_at": "2009-12-15T17:27:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71344",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:2'></a>If you're introducing a new module in sage.graphs, the header of the file should be much more descriptive of what the module is for, etc... Take a look at some of the other files for examples.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71345",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71346",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71347",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71348",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_7365.patch](tarball://root/attachments/some-uuid/ticket7365/trac_7365.patch) by @nathanncohen created at 2009-12-18 08:54:06\n\nI tried to find another example, but could not find any interesting/funny one (the theorem and its proof by themselves are enough to make me laugh :-) ). If you can think of a good one, just tell me and I'll add it :-)\n\nNathann",
    "created_at": "2009-12-18T08:54:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71349",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Attachment [trac_7365.patch](tarball://root/attachments/some-uuid/ticket7365/trac_7365.patch) by @nathanncohen created at 2009-12-18 08:54:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71350",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71351",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_7365-doctest.patch](tarball://root/attachments/some-uuid/ticket7365/trac_7365-doctest.patch) by @rlmill created at 2009-12-18 19:22:58",
    "created_at": "2009-12-18T19:22:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71352",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:5'></a>Attachment [trac_7365-doctest.patch](tarball://root/attachments/some-uuid/ticket7365/trac_7365-doctest.patch) by @rlmill created at 2009-12-18 19:22:58
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71353",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71354",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71355",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7365#issuecomment-71356",
    "user": "https://github.com/mwhansen"
}
```
