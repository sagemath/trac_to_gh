...
```json
{
    "body": "<a id='comment:1'></a>This is one of those functions that should probably be written in Cython, on as low a level as possible...",
    "created_at": "2009-12-09T17:03:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75913",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:1'></a>This is one of those functions that should probably be written in Cython, on as low a level as possible...
...
```json
{
    "body": "<a id='comment:2'></a>To be honest, I intended to write it as soon as your partch to make them the default format is merged :-)",
    "created_at": "2009-12-09T17:36:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75914",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>To be honest, I intended to write it as soon as your partch to make them the default format is merged :-)
...
```json
{
    "body": "<a id='comment:3'></a>It should be the other order: this ticket needs to be dealt with before we switch over. There are probably other issues like this one lurking...",
    "created_at": "2009-12-09T17:37:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75915",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>It should be the other order: this ticket needs to be dealt with before we switch over. There are probably other issues like this one lurking...
...
```json
{
    "body": "<a id='comment:4'></a>One problem IMHO with `c_graph` is that as is (correct me if I'm wrong)\nwe won't be able to have a fast `in_neighbors`.\n\nAt least the current implementation is to test all vertices in the graph.",
    "created_at": "2009-12-09T19:31:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75916",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:4'></a>One problem IMHO with `c_graph` is that as is (correct me if I'm wrong)
we won't be able to have a fast `in_neighbors`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75917",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75919",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75921",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75924",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75926",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75927",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75928",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>The first (test of isomorphism) error was a mistake in the algorithm and is fixed already. I am dealing with the second one (transitive_reduction) which is related to the fact that we are dealing with a digraph... I am not worried by the RuntimeErrors that follow... I will update this patch as soon as possible :-)",
    "created_at": "2009-12-12T19:03:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75929",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:16'></a>The first (test of isomorphism) error was a mistake in the algorithm and is fixed already. I am dealing with the second one (transitive_reduction) which is related to the fact that we are dealing with a digraph... I am not worried by the RuntimeErrors that follow... I will update this patch as soon as possible :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75930",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75932",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75933",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I've created #7673 to deal with the `by_weight=True` case. I like this patch as it is, since it makes it possible to test #7634. Also, by itself it passes long tests in sage/graphs. Nice work!",
    "created_at": "2009-12-12T20:02:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75934",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:19'></a>I've created #7673 to deal with the `by_weight=True` case. I like this patch as it is, since it makes it possible to test #7634. Also, by itself it passes long tests in sage/graphs. Nice work!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75935",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75936",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75937",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75938",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7640#issuecomment-75939",
    "user": "https://github.com/mwhansen"
}
```
