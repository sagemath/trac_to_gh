...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61061",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61062",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7836/trac_7836-CRT.patch",
    "created_at": "2010-01-04T17:22:50Z",
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7836/trac_7836-CRT.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_7836-CRT.patch](https://github.com/sagemath/sage/files/ticket7836/trac_7836-CRT.patch) by @JohnCremona created at 2010-01-04 17:22:50\n\nThe attached patch is based on 4.3 + the patches at #7595.  I tested all files which use either CRT_list or CRT_basis.",
    "created_at": "2010-01-04T17:22:50Z",
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61063",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61064",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61065",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61066",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61067",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7836#issuecomment-61068",
