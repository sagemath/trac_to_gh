...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7082#issuecomment-52341",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "asset_name": "trac_7082-old-style-class.patch",
    "asset_url": "tarball://root/attachments/ticket7082/trac_7082-old-style-class.patch",
    "created_at": "2009-10-04T06:05:41Z",
    "issue": "https://github.com/sagemath/sage/issues/7082",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7082/trac_7082-old-style-class.patch",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-47319"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7082#issuecomment-52343",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-47320"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7082",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-47321"
}
```
...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-47322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-47323"
}
```
