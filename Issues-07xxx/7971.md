...
```json
{
    "body": "<a id='comment:1'></a>This patch will build, and the tests in sage/coding all pass.  But I don't have Guava installed, which is needed for most of the affected doctests.\n\nDavid - maybe you can run the optional tests as part of a review?",
    "created_at": "2010-01-18T05:41:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81295",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>This patch will build, and the tests in sage/coding all pass.  But I don't have Guava installed, which is needed for most of the affected doctests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81296",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81297",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81298",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81299",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81300",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81301",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This needs work (deprecation warnings) and so should just be handled as part of #6094.  \n\nI've marked this as \"needs work\" but should be marked some form of invalid.",
    "created_at": "2010-01-18T21:21:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81302",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:4'></a>This needs work (deprecation warnings) and so should just be handled as part of #6094.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81303",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The currently newest uploaded patch for Trac #6094 -- needing a positive review -- handles all these cases, so this Trac should just be closed.",
    "created_at": "2010-11-02T14:02:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81304",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:5'></a>The currently newest uploaded patch for Trac #6094 -- needing a positive review -- handles all these cases, so this Trac should just be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7971#issuecomment-81305",
