...
archive/attachments_009898.json:
```json
{
...
**Attachment:** [sage-env](https://github.com/sagemath/sage/files/ticket7818/sage-env)
...
```json
{
    "body": "**Attachment:** [sage-env.patch](https://github.com/sagemath/sage/files/ticket7818/sage-env.patch)\n\nPatch file which should hopefully commit, as Robert  Miller said the previous one had a problem.",
    "created_at": "2010-01-13T23:33:16Z",
    "issue": "https://github.com/sagemath/sage/issues/7818",
    "type": "issue_comment",
...
**Attachment:** [sage-env.patch](https://github.com/sagemath/sage/files/ticket7818/sage-env.patch)
