...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7773#event-87428"
}
```
...
```json
{
    "body": "Changed assignee from **GeorgSWeber** to **@zimmermann6**",
    "created_at": "2010-02-23T15:42:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7773",
    "type": "issue_comment",
...
Changed assignee from **GeorgSWeber** to **@zimmermann6**
...
```json
{
    "body": "Changed assignee from **@zimmermann6** to **GeorgSWeber**",
...
Changed assignee from **@zimmermann6** to **GeorgSWeber**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7773#issuecomment-60274",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7773#issuecomment-60275",
