...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78093",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78094",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78095",
...
```json
{
    "body": "<a id='comment:3'></a>Doctest error log added.",
    "created_at": "2010-01-28T04:55:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78096",
    "user": "https://trac.sagemath.org/admin/accounts/users/GokhanSever"
}
```

<a id='comment:3'></a>Doctest error log added.
...
```json
{
    "body": "<a id='comment:6'></a>This problem is still present with 4.3.3. I have put on http://www.loria.fr/~zimmerma/sage-t.log.4.3.3 the log of `sage -t *`, and in http://www.loria.fr/~zimmerma/install.log.4.3.3.bz2\nthe install log.",
    "created_at": "2010-02-23T15:42:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78099",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:6'></a>This problem is still present with 4.3.3. I have put on http://www.loria.fr/~zimmerma/sage-t.log.4.3.3 the log of `sage -t *`, and in http://www.loria.fr/~zimmerma/install.log.4.3.3.bz2
the install log.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78100",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I don't have these two lines failing on v4.3.3 comparing to my 4.3.2.alpha0 tests:\n\nUsing ./sage -testall\n\n\tsage -t  \"devel/sage/sage/rings/polynomial/multi_polynomial_libsingular.pyx\"\n\n\tsage -t  \"devel/sage/sage/libs/cremona/newforms.pyx\"\n\n```\nuname -a\nLinux ccn 2.6.31.9-174.fc12.i686.PAE #1 SMP Mon Dec 21 06:04:56 UTC 2009 i686 i686 i386 GNU/Linux\n```",
    "created_at": "2010-03-03T21:30:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78102",
    "user": "https://trac.sagemath.org/admin/accounts/users/GokhanSever"
}
```

<a id='comment:8'></a>I don't have these two lines failing on v4.3.3 comparing to my 4.3.2.alpha0 tests:
...
```json
{
    "body": "<a id='comment:9'></a>thanks to Robert Bradshaw, I was able to isolate the following test case:\n\n```\nH = Hom(GF(32, 'a'), GF(1024, 'b'))\nD = H.domain()\nC = H.codomain()\nf = D.modulus()\ng = C['x'](f)\nr = g.roots()\nr = [r[0]]\nprint r[0][0]\nv = D.hom(r[0][0], C)\nquit\n```\nwhere the Segfault does not occur without the last instruction `v = D.hom(r[0][0], C)`.\nNow D.hom is a builtin with Givaro...",
    "created_at": "2010-03-05T20:20:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78103",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:9'></a>thanks to Robert Bradshaw, I was able to isolate the following test case:
...
```json
{
    "body": "<a id='comment:10'></a>Note: I'm ready to do more investigation if someone tells me what to do...",
    "created_at": "2010-03-06T09:44:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78104",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:10'></a>Note: I'm ready to do more investigation if someone tells me what to do...
...
```json
{
    "body": "<a id='comment:11'></a>I don't have time to look at this this weekend, but only note that GF(32) and GF(1024) are `FiniteField_ntl_gf2e` objects.  Does the same problem happen with Givaro?  If not, maybe it's a problem restoring the NTL context; I already found one such bug in `finite_field_ntl_gf2e`.",
    "created_at": "2010-03-06T14:04:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78105",
    "user": "https://github.com/roed314"
}
```

<a id='comment:11'></a>I don't have time to look at this this weekend, but only note that GF(32) and GF(1024) are `FiniteField_ntl_gf2e` objects.  Does the same problem happen with Givaro?  If not, maybe it's a problem restoring the NTL context; I already found one such bug in `finite_field_ntl_gf2e`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78106",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Ah, you're right.  You should be able to use the `impl` keyword to `GF` to get other implementations.\n\nI don't know what's going on if it's givaro.",
    "created_at": "2010-03-07T16:12:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78107",
    "user": "https://github.com/roed314"
}
```

<a id='comment:13'></a>Ah, you're right.  You should be able to use the `impl` keyword to `GF` to get other implementations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78110",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>All this doctest failures went away for me with the release of sage-4.4.1.alpha3!!!!\n\nJaap",
    "created_at": "2010-05-01T18:38:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78112",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:17'></a>All this doctest failures went away for me with the release of sage-4.4.1.alpha3!!!!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78114",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Paul,\n\nsage-4.4.1.alpha1 was a mess on Fedora 12.\n\nIn sage-4.4.1.rc0 all test passed.\n\nJaap",
    "created_at": "2010-05-02T15:10:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78115",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:20'></a>Paul,
...
```json
{
    "body": "<a id='comment:22'></a>should we close this ticket?\n\nPaul",
    "created_at": "2013-01-08T08:48:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78117",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:22'></a>should we close this ticket?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78118",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78119",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78120",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7773#issuecomment-78121",
    "user": "https://github.com/jdemeyer"
}
```
