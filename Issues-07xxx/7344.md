...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71035",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Oops that was a TIFF example, but it happens with jpegs too:\n\n```\nsage: im = Image.open(\"/Users/mh/Pictures/v2shot.jpg\")\nsage: im.show()\nsage: dyld: Symbol not found: __cg_jpeg_resync_to_restart\n  Referenced from: /System/Library/Frameworks/ApplicationServices.framework/Versions/A/Frameworks/ImageIO.framework/Versions/A/ImageIO\n  Expected in: /Volumes/E/sage-4.2.1/local/lib//libJPEG.dylib\n```",
    "created_at": "2009-11-17T15:42:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71037",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:3'></a>Oops that was a TIFF example, but it happens with jpegs too:
...
```json
{
    "body": "<a id='comment:4'></a>The error seems to be an issue with having multiple versions of libjpeg in OS X. Refer to: http://old.nabble.com/dyld:-Symbol-not-found:-__cg_jpeg_resync_to_restart-to9949988.html. I am unsure as to how to fix that problem (I haven ever used a Mac).",
    "created_at": "2009-11-18T15:50:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71038",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:4'></a>The error seems to be an issue with having multiple versions of libjpeg in OS X. Refer to: http://old.nabble.com/dyld:-Symbol-not-found:-__cg_jpeg_resync_to_restart-to9949988.html. I am unsure as to how to fix that problem (I haven ever used a Mac).
...
```json
{
    "body": "<a id='comment:5'></a>A new version without SPKG.txt~ is up at http://sage.math.washington.edu/home/timdumol/libjpeg-7.p1.spkg.",
    "created_at": "2009-11-18T15:53:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71039",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:5'></a>A new version without SPKG.txt~ is up at http://sage.math.washington.edu/home/timdumol/libjpeg-7.p1.spkg.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71040",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>This needs checking on Solaris",
    "created_at": "2009-12-03T05:01:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71041",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>This needs checking on Solaris
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71042",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>When I try an example like mhampton's above (`im = Image.open(...), im.show()`, I get the message\n\n```\nImportError: The _imaging C module is not installed\n```\n(This is on OS X 10.6.)  Is this an issue?",
    "created_at": "2009-12-22T06:13:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71043",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>When I try an example like mhampton's above (`im = Image.open(...), im.show()`, I get the message
...
```json
{
    "body": "<a id='comment:8'></a>Sorry, I did not  set up email notifications until recently, so cc'ing me did not help. I only stumbled across this when looking for tickets to review. I will check it on Solaris. \n\nDave",
    "created_at": "2010-01-10T04:12:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71044",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:8'></a>Sorry, I did not  set up email notifications until recently, so cc'ing me did not help. I only stumbled across this when looking for tickets to review. I will check it on Solaris. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71046",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71047",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71048",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>See also [here](http://groups.google.com/group/sage-devel/browse_frm/thread/48f720062cc4e38b/ff817dfb819e5ce).",
    "created_at": "2010-08-02T17:59:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71050",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:12'></a>See also [here](http://groups.google.com/group/sage-devel/browse_frm/thread/48f720062cc4e38b/ff817dfb819e5ce).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71051",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71052",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>(I could have deleted Dave from the cc-list, but just added the missing trailing \"t\"...)",
    "created_at": "2010-09-03T21:59:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71054",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:14'></a>(I could have deleted Dave from the cc-list, but just added the missing trailing "t"...)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71056",
...
```json
{
    "body": "<a id='comment:16'></a>If this package causes compilation failure, then it needs work, not\nreview.",
    "created_at": "2011-05-13T13:20:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71057",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```

<a id='comment:16'></a>If this package causes compilation failure, then it needs work, not
review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71058",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>.p1 gave compilation failure. .p2 fixes it.",
    "created_at": "2011-08-02T18:29:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71059",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:17'></a>.p1 gave compilation failure. .p2 fixes it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71060",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>It seems that libjpeg's license is not compatible with GPL, according to: http://www.thomasalspaugh.org/pub/osl-sps/libjpeg8c.html. Also, libjpeg-turbo seems to be significantly faster than libjpeg, while being licensed under GPL. I'm making a package for that now.",
    "created_at": "2011-08-02T21:58:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71061",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:18'></a>It seems that libjpeg's license is not compatible with GPL, according to: http://www.thomasalspaugh.org/pub/osl-sps/libjpeg8c.html. Also, libjpeg-turbo seems to be significantly faster than libjpeg, while being licensed under GPL. I'm making a package for that now.
...
```json
{
    "body": "<a id='comment:19'></a>Here is the new libjpeg-turbo package: http://sage.math.washington.edu/home/timdumol/libjpeg_turbo-1.1.1.spkg",
    "created_at": "2011-08-02T22:21:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71062",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:19'></a>Here is the new libjpeg-turbo package: http://sage.math.washington.edu/home/timdumol/libjpeg_turbo-1.1.1.spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71063",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71064",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Review instructions are as above. This definitely needs testing on a Mac, as I am unsure as to whether the patches that were included in the libjpeg package are required for libjpeg-turbo. This version does not include those patches.",
    "created_at": "2011-08-02T22:22:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71065",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:20'></a>Review instructions are as above. This definitely needs testing on a Mac, as I am unsure as to whether the patches that were included in the libjpeg package are required for libjpeg-turbo. This version does not include those patches.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71067",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71068",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71069",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71070",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Replying to [leif](#comment%3A27):\n> I wonder if it builds (on MacOS X) without assembly parts (perhaps with `--without-simd` passed to `configure`), as I mentioned above.\n\n\nYep, configuring with `--without-simd` should work, as the only assembler source files are all in `src/simd/`.",
    "created_at": "2011-08-03T06:23:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71074",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:28'></a>Replying to [leif](#comment%3A27):
> I wonder if it builds (on MacOS X) without assembly parts (perhaps with `--without-simd` passed to `configure`), as I mentioned above.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71076",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>I think we should simply check whether `nasm` is installed (`command -v nasm >/dev/null`), and if so, its version (`nasm -v`), and then -- depending on the operating system (especially 32-bit vs. 64-bit on Darwin) -- decide whether we configure with `--without-simd` or not.\n\nThis should work on all platforms, and this way machines having (at least) the required version installed won't suffer from not using faster implementations.\n\nIf `SAGE_FAT_BINARY=yes`, we should perhaps disable it too.\n\nAccording to the docs, it might also be necessary to either pass `--build=...` or update the **very old** `config.guess`, at least on / for 64-bit Darwin (MacOS X >=10.6, or 10.5 if `SAGE64=yes`). Maybe setting `ABI` accordingly also works.",
    "created_at": "2011-08-03T11:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71077",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:31'></a>I think we should simply check whether `nasm` is installed (`command -v nasm >/dev/null`), and if so, its version (`nasm -v`), and then -- depending on the operating system (especially 32-bit vs. 64-bit on Darwin) -- decide whether we configure with `--without-simd` or not.
...
```json
{
    "body": "<a id='comment:32'></a>Building with `--without-simd` and then reinstalling PIL allows me to execute the code above (although `im.format` is `None`).",
    "created_at": "2011-08-03T15:50:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71078",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:32'></a>Building with `--without-simd` and then reinstalling PIL allows me to execute the code above (although `im.format` is `None`).
...
```json
{
    "body": "<a id='comment:33'></a>As with the spkg at #7345, you should also provide a patch to the scripts repo, adding the appropriate files to .hgignore there.",
    "created_at": "2011-08-03T22:17:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71079",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:33'></a>As with the spkg at #7345, you should also provide a patch to the scripts repo, adding the appropriate files to .hgignore there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71080",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71081",
...
```json
{
    "body": "<a id='comment:37'></a>I tried building libjpeg_turbo-1.1.1.spkg on OS X 10.7 (Lion) with XCode 4.2.x and it fails during the ./configure stage:\n\n```\n...\nchecking whether the assembler (nasm -fmacho -DMACHO) works... yes\nchecking whether the linker accepts assembler output... no\nconfigure: error: configuration problem: maybe object file format mismatch.\nFailed to configure libjpeg ... exiting\n\nreal\t0m14.878s\n```",
    "created_at": "2011-11-14T16:34:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71083",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:37'></a>I tried building libjpeg_turbo-1.1.1.spkg on OS X 10.7 (Lion) with XCode 4.2.x and it fails during the ./configure stage:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71084",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71085",
...
```json
{
    "body": "<a id='comment:39'></a>outdated, should close",
    "created_at": "2021-08-26T02:40:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71086",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:39'></a>outdated, should close
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71087",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7344#issuecomment-71088",
