...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208308",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208309",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208310",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208311",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208312",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208313",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208315",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "I think at this stage we should check if it works with other implementations of pkg-config. So far we are relying on it being a particular implementation if not version. As soon as my new build on power7 finishes I'll test the one currently shipping with sage.",
    "created_at": "2014-05-01T23:28:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208316",
...
```json
{
    "body": "Version we ship in sage doesn't have \"--debug\" so our best effort so far relies on any pkg-config out there being the freedesktop version which to fair is not a bad assumption. Do we know any distro not defaulting to that?",
    "created_at": "2014-05-02T00:02:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208318",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Of course after saying that I realised that in Gentoo I can switch to the BSD one if I want (but freedesktop is the default). I would imagine debian would be similar, freedesktop is the default but you have an alternative.\n\nThen again anyone savvy enough to use an alternative should be able to deal with the fall out.",
    "created_at": "2014-05-02T00:05:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208319",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "One issue still is that we have to call the system-wide `pkg-config` (if present) in `spkg-install`; I'd suggest to modify `sage-env` to save the original `PATH` in `SAGE_ORIG_PATH`, say.\n\n(Otherwise we'd presumably at least accumulate folders upon reinstallation of Sage's `pkgconf`.)\n\nOr we could first try to delete Sage's symlink from `pkg-config` to `pkgconf`.",
    "created_at": "2014-05-02T00:24:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208320",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208321",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208322",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "FWIW, here's the `--debug` version with just `sed` (one line per folder):\n\n```sh\n$ pkg-config --debug 2>&1 | sed -n '/^Scanning /s/.*'\\''\\([^'\\'']*\\)'\\''/\\1/p'\n/usr/local/lib/pkgconfig\n/usr/lib/pkgconfig\n/usr/share/pkgconfig\n```\n",
    "created_at": "2014-05-02T01:23:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208323",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208325",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Ok different approach. Instead of just creating a symlink \"pkg-config\", use a shell script that calls the system pkg-config if there is one.",
    "created_at": "2014-05-02T19:06:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208326",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Hmmm, that way broken `pkg-config` installations (seen on Darwin) aren't (or can't be) cured.\n\nAnyway, why `/bin/sh`?\n\ns/`\"pkg-config\" binary`/`\"pkg-config\" script`/\n\nYou'd have to change the error message (in case `m4` failed) accordingly.",
    "created_at": "2014-05-02T19:26:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208327",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Also, `PKG_CONFIG_PATH` gets *overwritten*.  (We already treat it correctly in `sage-env`, *pre*pending Sage's folders in case it's already set/non-empty.)",
    "created_at": "2014-05-02T19:31:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208328",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208330",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208331",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208332",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "I still wonder whether we should install our `pkg-config` at all if a system-wide one is already present (as William suggested, i.e., don't install it in that case), unless perhaps `SAGE_INSTALL_PKGCONFIG=yes`.  (I know you do like such environment variables very much.)\n\nIn the latter (hopefully rarely used or hardly necessary) case, we might even run something like\n\n```sh\npc_folders_to_search=`find / -name \\*.pc -exec dirname {} \\; 2>/dev/null | sort -u`\n```\n\n(probably limiting the root folder(s) to the usual suspectives, depending on the OS, and excluding [unrelated] Sage folders).",
    "created_at": "2014-05-02T22:38:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208333",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208334",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "IMHO its better to have a definitive behavior when calling `$SAGE_LOCAL/bin/pkg-config` than hoping that the environment variables have been correctly set up.\n\nJust searching all directories is wrong, this would find cross-compile toolchains etc.",
    "created_at": "2014-05-02T22:51:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208335",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208336",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208337",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Hmm `PKG_CONFIG_LIBDIR` also has the effect of not searching the compiled-in default path any more, removed.\n\nI've added a `spkg-check` that will try to find the system pc files if we can guess their location.",
    "created_at": "2014-05-03T08:06:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208339",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208340",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208342",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208343",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Ah, no, it's even weirder...  Take a *close* look at\n\n```sh\nm4 ../patches/pkg-config.in > \"$SAGE_LOCAL/bin/pkg-config\"\n```\n\n\nGuess what happens...",
    "created_at": "2014-05-03T15:26:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208344",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "... although it shouldn't be executable yet (but that also depends on the umask).",
    "created_at": "2014-05-03T15:29:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208345",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208347",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208349",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208350",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208351",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208352",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "... but actually a similar message should get printed by `spkg-install`; as is, with our current wrapper script, IMHO installing `pkgconf` at all if a system-wide `pkg-config` is present doesn't make much sense (unless we introduce e.g. `SAGE_INSTALL_PKGCONFIG`... ;-) ).",
    "created_at": "2014-05-03T18:04:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208354",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "IMHO it still makes sense, its better to have a definitive behavior when calling `$SAGE_LOCAL/bin/pkg-config` than hoping that the environment variables have been correctly set up.",
    "created_at": "2014-05-03T18:21:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208355",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208356",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208357",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208359",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208360",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208361",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208362",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208363",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "I confirm that I am happy with this.",
    "created_at": "2014-05-03T22:27:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208364",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208365",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208366",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16037#event-15605"
}
```
...
```json
{
    "body": "Since we now no longer set `PKG_CONFIG_PATH` in `sage-env`, and the wrapper script setting it gets only installed with `pkgconf`, we have to fix our deps such that other packages ([currently] built before `pkgconf`) see Sage's `pkgconfig` folder at all.\n\nOr we reenable setting it in `sage-env`... (which I'd personally prefer)",
    "created_at": "2014-05-16T23:14:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208367",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16037#issuecomment-208368",
    "user": "https://github.com/nexttime"
}
```
