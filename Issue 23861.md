# Issue 23861: S_hilbert_symbol() helper function to find integer with negative Hilbert symbol for primes in a set S
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23861#event-61181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23861",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23861#event-61182"
}
```
