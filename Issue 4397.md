# Issue 4397: [with patch; need review] Sage 3.1.4: optional doctest failure in sage/rings/number_field/number_field.py
...
```json
{
    ...
    "title": "[with patch; need review] Sage 3.1.4: optional doctest failure in sage/rings/number_field/number_field.py",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-32292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-32293",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-32294",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4397#event-9930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-32295",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4397#event-9931"
}
```
