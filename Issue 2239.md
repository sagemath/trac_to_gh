# Issue 2239: [with patch, with positive review] Leak in totallyreal.py
...
```json
{
    ...
    "title": "[with patch, with positive review] Leak in totallyreal.py",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2239",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2239#event-5323"
}
```
