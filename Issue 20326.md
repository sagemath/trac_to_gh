# Issue 20326: Cannot compile SnapPy for sage because sage's gcc is incompatible with system's as
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20326#event-55469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20326",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20326#event-55470"
}
```
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20326#event-55471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20326#event-55472"
}
```
