...
```json
{
    "body": "Attachment [trac_14089-crystal-speed-up-as.patch](tarball://root/attachments/some-uuid/ticket14089/trac_14089-crystal-speed-up-as.patch) by aschilling created at 2013-02-10 07:26:38",
    "created_at": "2013-02-10T07:26:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172863",
    "user": "aschilling"
}
```

Attachment [trac_14089-crystal-speed-up-as.patch](tarball://root/attachments/some-uuid/ticket14089/trac_14089-crystal-speed-up-as.patch) by aschilling created at 2013-02-10 07:26:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172864",
    "user": "aschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172866",
    "user": "aschilling"
}
```
...
```json
{
    "body": "> So it does help, but they still take a long time to initialize compared to their counterparts. However this can be an issue for another ticket.\n\nUnless you have a specific suggestion on how to improve this, I would leave it for another ticket.\n\n> As for the caching of the `index_set()`, the problem is (as you stated) this returns a mutable list rather than an immutable tuple. I tried doing this once and from what I recall, the rigged configurations code broke because it does something like\n> {{{\n> I = self.index_set()\n> I.pop(0)\n> }}}\n> which would have to be tweaked to\n> {{{\n> I = self.index_set()[1:]\n> }}}\n> but IDK if this behavior occurs anywhere else.\n\nYes, this also occurs in tensor_product in /combinat/crystals\n\nAnne",
    "created_at": "2013-02-11T01:31:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172869",
    "user": "aschilling"
}
```
...
```json
{
    "body": "> As for the caching of the `index_set()`, the problem is (as you stated) this returns a mutable list rather than an immutable tuple. I tried doing this once and from what I recall, the rigged configurations code broke because it does something like\n> {{{\n> I = self.index_set()\n> I.pop(0)\n> }}}\n> which would have to be tweaked to\n> {{{\n> I = self.index_set()[1:]\n> }}}\n\nOr just: `self.cartan_type().classical().index_set()` (which would\nby the way be safer w.r.t. affine types where the special node would\nnot be 0).",
    "created_at": "2013-02-11T03:41:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172870",
    "user": "nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172871",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172872",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172873",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172874",
    "user": "aschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172875",
    "user": "aschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13885#issuecomment-172876",
    "user": "jdemeyer"
}
```
