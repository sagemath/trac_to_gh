# Issue 25861: Implement L-functions using the PARI library
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25861#event-65117"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25861#event-65118"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25861#event-65119"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25861#event-65120"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25861#event-65121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25861",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25861#event-65122"
}
```
