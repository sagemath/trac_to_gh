...
```json
{
    "body": "`trac_4237_part1.patch` assumes that we always store the entries as positive integers. Is this a sensible assumption?",
...
```json
{
    "body": "A quick comment.  The *new* output you're getting is *right*.  The old output, which is in sage, is wrong.  Somebody (probably me) fixed a bug. The matrix is a matrix modulo 19, so its entries should be normalized between 0 and 18, inclusive. That 19 should be 0, as it is in the output you get now.",
...
```json
{
    "body": "The doctest that \"fails\" (by giving correct output) is *not* in the patch I submitted.  In my code I fixed some free's that should be sage_free, and implemented a correct specialized faster list method.  Probably one of those two fixed the bug.",
...
```json
{
    "body": "Attachment [trac_4237_part3-neg_bugfix.patch](tarball://root/attachments/some-uuid/ticket4237/trac_4237_part3-neg_bugfix.patch) by mabshoff created at 2008-12-17 07:32:53",
    "created_at": "2008-12-17T07:32:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4237#issuecomment-30798",
    "user": "mabshoff"
}
```

Attachment [trac_4237_part3-neg_bugfix.patch](tarball://root/attachments/some-uuid/ticket4237/trac_4237_part3-neg_bugfix.patch) by mabshoff created at 2008-12-17 07:32:53
...
```json
{
    "body": "Positive review for all three patches.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-17T14:50:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4237#issuecomment-30799",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4237#issuecomment-30800",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "Merged all three patches in Sage 3.2.2.rc1",
    "created_at": "2008-12-17T15:12:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4237#issuecomment-30801",
    "user": "mabshoff"
}
```
