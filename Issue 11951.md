...
sage: f = Piecewise([This is the Trac macro ** that was inherited from the migration called with arguments (-2, 2), 2 * x^0)](https://trac.sagemath.org/wiki/WikiMacros#-macro))
sage: g = Piecewise([This is the Trac macro ** that was inherited from the migration called with arguments (0, 2), 3/4 * x^0)](https://trac.sagemath.org/wiki/WikiMacros#-macro))
...
f1 = Piecewise([This is the Trac macro ** that was inherited from the migration called with arguments (-1, 1), 1*x^0)](https://trac.sagemath.org/wiki/WikiMacros#-macro))
