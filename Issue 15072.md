...
```json
{
    "body": "This may not be the only instance of something like this happening, but it's one I found. In some respect, this is just a stopgap for https://groups.google.com/forum/?fromgroups=#!topic/sage-devel/pH-97DE41wA.",
    "created_at": "2013-10-20T17:57:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193043",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193044",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193046",
    "user": "tscrim"
}
```
...
```json
{
    "body": "Attachment [trac_15309-more-dg.patch](tarball://root/attachments/some-uuid/ticket15309/trac_15309-more-dg.patch) by darij created at 2013-10-25 22:53:37\n\nchanges in a similar vein for (minor?) speedup",
    "created_at": "2013-10-25T22:53:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193047",
    "user": "darij"
}
```

Attachment [trac_15309-more-dg.patch](tarball://root/attachments/some-uuid/ticket15309/trac_15309-more-dg.patch) by darij created at 2013-10-25 22:53:37
...
```json
{
    "body": "Nice change (doubles the speed beyound fixing the bug). What do you say about the similar changes I suggest? (If they don't apply, please let me know -- I'm working on top of #15174.)",
    "created_at": "2013-10-25T22:55:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193048",
    "user": "darij"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193049",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193050",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193051",
    "user": "darij"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193052",
    "user": "darij"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193053",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15072#issuecomment-193054",
    "user": "jdemeyer"
}
```
