# Issue 4387: [with patch, with positive review] Fix memory leak in si2sa_ZZ in sage/libs/singular/singular.pyx
...
```json
{
    ...
    "title": "[with patch, with positive review] Fix memory leak in si2sa_ZZ in sage/libs/singular/singular.pyx",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4387",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4387#event-9909"
}
```
