...
Original creation time: 2012-09-11 15:46:53
...
Comment by nbruin created at 2012-09-11 16:07:27
...
Comment by nbruin created at 2012-09-12 06:19:42
...
Comment by SimonKing created at 2012-09-12 18:55:48
...
Comment by SimonKing created at 2012-09-12 18:59:23
...
Comment by nbruin created at 2012-09-12 20:42:33
...
Comment by nbruin created at 2012-09-13 02:16:45
...
Comment by SimonKing created at 2012-09-13 05:37:02
...
Comment by nbruin created at 2012-09-13 06:51:01
...
Comment by SimonKing created at 2012-09-13 13:10:50
...
Comment by SimonKing created at 2012-09-13 13:37:58
...
Comment by nbruin created at 2012-09-15 03:17:17
...
Comment by nbruin created at 2012-09-15 17:11:55
...
Comment by nbruin created at 2012-09-15 17:33:45
...
Comment by SimonKing created at 2012-09-15 17:42:00
...
PS: You really deserve a badge for debugging excellence! Do I understand correctly that the bug is _not_ on the side of Singular? I'll inform Hans accordingly.


---

Comment by nbruin created at 2012-09-15 19:07:06
...
Comment by SimonKing created at 2012-09-15 20:22:57
...
Comment by vbraun created at 2012-09-15 20:36:45
...
Comment by SimonKing created at 2012-09-16 06:40:47
...
Comment by SimonKing created at 2012-09-16 06:41:54
...
Comment by nbruin created at 2012-09-16 15:58:04
...
Comment by SimonKing created at 2012-09-16 17:33:42
...
Comment by SimonKing created at 2012-09-16 17:39:05
...
Comment by SimonKing created at 2012-09-16 19:07:10
...
Comment by SimonKing created at 2012-09-16 20:10:36
...
Comment by nbruin created at 2012-09-17 00:40:05
...
Comment by SimonKing created at 2012-09-17 05:37:25
...
Comment by nbruin created at 2012-09-17 06:02:36
...
Comment by nbruin created at 2012-09-17 06:49:14
...
Comment by SimonKing created at 2012-09-17 07:01:25
...
Comment by SimonKing created at 2012-09-17 09:32:57
...
As I have announced, I also fixed the failing modular symbols test, by computing the dimension before displaying it: The test previously worked _only_ because a computation happened in a different test that happened to be executed early enough, that side effect being possible because Hecke modules would stay in memory permanently.
...
Comment by SimonKing created at 2012-09-17 11:25:22
...
While we are at it: Perhaps it would be better to _not_ unmerge #13145, but to use it as a dependency.
...
Comment by SimonKing created at 2012-09-17 11:34:29
...
Comment by SimonKing created at 2012-09-17 12:04:33
...
Of course, the question is whether we really need to incref the ring if we create an element. I think, in the commutative case, it _is_ needed, because deallocation of an element refers to the cparent.
...
Comment by nbruin created at 2012-09-17 14:13:55
...
Comment by SimonKing created at 2012-09-17 14:19:55
...
Comment by SimonKing created at 2012-09-17 14:50:56

There is one nasty detail with singular_function. If one sets `ring = singular_function('ring')` and then uses the singular_function to create a ring, then its reference counter is _not_ incremented, even though the following function is called in this case:
...
Comment by SimonKing created at 2012-09-17 16:45:12
...
Comment by SimonKing created at 2012-09-17 16:49:18
...
Comment by SimonKing created at 2012-09-17 17:06:04
...
Comment by nbruin created at 2012-09-17 22:00:15
...
Comment by SimonKing created at 2012-09-18 04:56:33
...
Comment by SimonKing created at 2012-09-18 05:59:34
...
Comment by SimonKing created at 2012-09-18 07:31:25
...
Comment by SimonKing created at 2012-09-18 08:00:58

Now I think I understand:

`currRingHdl = enterid("my_awesome_sage_ring", 0, RING_CMD, &IDROOT, 1)` has the purpose to create `currRingHdl` (it is only called if `currRingHdl==NULL`), but the value assigned to `currRingHdl.data.uring` is _invalid_. In particular, the attempt to change to `currRingHdl.data.uring` results in a segfault. Hence, `singular_ring_delete(currRingHdl.data.uring)` would not work.
...
Comment by SimonKing created at 2012-09-18 08:07:43
...
Comment by SimonKing created at 2012-09-18 08:26:39
...
Comment by SimonKing created at 2012-09-18 08:59:21
...
Comment by nbruin created at 2012-09-18 16:01:26
...
Comment by nbruin created at 2012-09-18 17:24:42
...
Comment by SimonKing created at 2012-09-18 18:54:44
...
According to the code snipped, the ring is deleted if `r->ref==0`. So, apparently `r->ref==0` means that there is _no_ reference.
...
Comment by nbruin created at 2012-09-18 19:16:18

Replying to [comment:53 SimonKing]:
> According to the code snipped, the ring is deleted if `r->ref==0`. So, apparently `r->ref==0` means that there is _no_ reference.

Indeed, but this is tested _before_ decrement. So for this to work, you'd need
...
Comment by nbruin created at 2012-09-18 19:51:40
...
Comment by SimonKing created at 2012-09-19 09:41:01
...
Comment by SimonKing created at 2012-09-19 11:27:56

Hans Schönemann gave me a couple of answers - many thanks! I hope I am translating and summarising correctly:

`r->ref` counts the number of _interpreter variables_ referencing a ring _minus one_. Hence:
...
Concerning debugging: If one builds Singular so that `OM_NDEBUG` is _not_ defined, then a debug version of omalloc is used. In that way, we would have more easily detected the original problem with `omStrDup`.
...
If `currRing==NULL`, we should _not_ create `currRingHdl`. If `currRing!=NULL` then we should let uring point to it. the latter is already done in my patch, *the former should be done.*
...
Comment by SimonKing created at 2012-09-19 11:28:44
...
Comment by SimonKing created at 2012-09-19 12:59:31
...
Or perhaps we do _not_ have a leak. Namely, the internal data are also referenced via python, and thus will be deleted when the ring is deleted.
Well, let's see if `rKill` results in segfaults (due to the attempt to deallocate the internal data twice)...


---

Comment by SimonKing created at 2012-09-19 13:40:20
...
Comment by SimonKing created at 2012-09-19 14:17:21
...
Comment by SimonKing created at 2012-09-19 14:57:45
...
Comment by nbruin created at 2012-09-19 15:05:16
...
Comment by nbruin created at 2012-09-19 15:24:02
...
Comment by SimonKing created at 2012-09-20 08:11:13
...
No, we don't. With the current patch, `rKill` is _only_ called if ref==0.
...
Comment by SimonKing created at 2012-09-20 08:19:39
...
Comment by SimonKing created at 2012-09-20 08:53:02
...
Comment by SimonKing created at 2012-09-20 09:05:08
...
There was some example where the refcount was wrong _without_ calling `singular_ring_reference`, but for SCA it is wrong _with_ that call.
...
Comment by SimonKing created at 2012-09-20 10:56:07
...
Special care needs to be taken on `currRingHdl`. According to Hans, `rKill` can make it NULL, and it should be NULL if and only if `currRing` is NULL. Currently, we create `currRingHdl` when we _create_ a Singular function, but we only use it when we _call_ a Singular function. That's asking for trouble. Hence, we should move the creation of currRingHdl to `SingularFunction.__call__`, where we also set the correct `currRing`. `SingularFunction.__init__` is not the right place.


---

Comment by SimonKing created at 2012-09-20 13:17:18

I think one potential problem with our current use of `currRingHdl` in combination with `rKill` is that we would _redefine_ `my_awesome_sage_ring`, hence, we would see the following message on stderr:
...
Comment by SimonKing created at 2012-09-20 15:26:57
...
Comment by nbruin created at 2012-09-20 15:31:16
...
Comment by SimonKing created at 2012-09-20 15:42:22
...
Comment by SimonKing created at 2012-09-20 17:19:12
...
The same should hold for a `RingWrap`: If one has a naked `RingWrap` then the underlying ring should be deletable when deleting `RingWrap`. A complication arises if both a `RingWrap` and a polynomial ring refer to _the same_ underlying libsingular ring.
...
So, here you see the problem with creating the mock ring. I can only hope that Hans will tell us how one can _create_ a `currRingHdl` for a given `currRing`, rather than only finding a previously created `currRingHdl`.
...
Comment by SimonKing created at 2012-09-20 17:49:29
...
Comment by nbruin created at 2012-09-21 03:12:41
...
Comment by SimonKing created at 2012-09-21 06:46:44

I guess the recreation of my_awesome_sage_ring can be avoided, because Singular certainly has methods to return a previously defined ring when you know the name of that ring. So, no need that _Sage_ keeps a pointer to it, because Singular already does.
...
Comment by SimonKing created at 2012-09-21 08:54:35
...
Comment by SimonKing created at 2012-09-21 09:02:30
...
Comment by SimonKing created at 2012-09-21 16:45:27
...
Comment by SimonKing created at 2012-09-22 16:43:44
...
Comment by SimonKing created at 2012-09-23 06:37:46

I found: Applying the function `ringlist` decreases the ref counter of `currRing`, while `gwalk` increases the counter.

Since the number of references by Sage objects does _not_ change, this is asking for trouble, I suppose.


---

Comment by SimonKing created at 2012-09-23 06:44:07
...
Comment by jdemeyer created at 2012-09-25 19:28:25
...
Comment by SimonKing created at 2012-09-26 06:08:45
...
Comment by jpflori created at 2012-10-01 09:59:58
...
Comment by SimonKing created at 2012-10-01 10:16:30
...
Comment by jpflori created at 2012-10-01 10:29:22
...
Comment by SimonKing created at 2012-10-01 13:04:23
...
Comment by nthiery created at 2013-03-26 21:48:07
...
Comment by SimonKing created at 2013-03-27 18:42:56
...
Comment by jpflori created at 2013-03-27 19:08:23
...
Comment by nbruin created at 2013-03-27 19:32:02
...
Comment by SimonKing created at 2013-03-27 19:42:54
...
According to Hans Schönemann, the internal refcount is _only_ relevant in the Singular user interface. One could argue that libsingular replaces the Singular's user interface and should thus use the same refcounting than the user interface. However, internal calls in Singular will not change the refcount.
...
Comment by SimonKing created at 2013-03-27 20:26:31

Replying to [comment:97 SimonKing]:
> One could argue that libsingular replaces the Singular's user interface...

To be precise: _Our_ use of libsingular for constructing polynomial rings in Sage could be considered as something like the Singular user interface.


---

Comment by nbruin created at 2013-03-27 23:43:36
...
Comment by nbruin created at 2013-03-31 21:26:56
...
Comment by nthiery created at 2013-05-10 20:45:44
