# Issue 2365: [with patch, with positive review] with sage -wthread, attach runs code in wrong thread on subsequent loads
...
```json
{
    ...
    "title": "[with patch, with positive review] with sage -wthread, attach runs code in wrong thread on subsequent loads",
    "type": "issue",
...
```json
{
    "body": "Attachment [attach-ipython-threads.patch](tarball://root/attachments/some-uuid/ticket2365/attach-ipython-threads.patch) by @garyfurnish created at 2008-03-03 05:02:49\n\nThis seems good.",
    "created_at": "2008-03-03T05:02:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2365#issuecomment-15926",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2365#event-5581"
}
```
...
```json
{
    "body": "Merged in Sage 2.10.3.rc1. This patch is low risk for people who do not use the thread option, so I am also fine with it.\n\nCheers,\n\nMichael",
    "created_at": "2008-03-03T12:25:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2365#issuecomment-15927",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2365#issuecomment-15928",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
