...
```json
{
    "body": "Ok, having talked with Michael, we've cleaned up lots of valgrind-inspired stuff (explicitly initializing memory, etc), and caught one buglet (7 and 6 are apparently not equal).",
...
```json
{
    "body": "Positive review on trac-4155-2.patch from my end - I was deeply involved with the fixes, but aside from one issue left over this is a giant improvement from millions of errors to two, which will be addressed via a follow up ticket.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-22T05:17:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30176",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "Merged both patches in Sage 3.1.3.alpha1",
    "created_at": "2008-09-23T00:09:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30177",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30178",
    "user": "mabshoff"
}
```
