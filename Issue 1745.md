# Issue 1745: [with patch, positive review] bug in point enumeration mod p.
...
```json
{
    ...
    "title": "[with patch, positive review] bug in point enumeration mod p.",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-10992",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-10993",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Positive review by David Kohel\n\n```\nHi William,\n\nThe small points enumeration code indeed fixes the enumeration bug.\n\n```",
    "created_at": "2008-01-16T18:36:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-10994",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-10995",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-10996",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
