# Issue 19336: Natural coercion from Integers(p*k) to GF(p) for prime p
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19336#event-53856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19336",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19336#event-53857"
}
```
