...
```
sage: P = Polyhedron([This is the Trac macro *7* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#7-macro))
sage: P
...
```
sage: P = Polyhedron([This is the Trac macro *7* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#7-macro)); P
A 0-dimensional polyhedron in ZZ^1 defined as the convex hull of 1 vertex
sage: P.affine_hull()
