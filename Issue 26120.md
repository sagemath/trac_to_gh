...
```json
{
    "body": "First attempt at automatic conversion. \n----\nNew commits:",
    "created_at": "2018-09-28T17:26:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368280",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368281",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368282",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368283",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Wouldn't it make more sense to put `polymake` documentation in `local/share/doc/polymake`? I don't see any reference to Sage at all in the tutorials, so it really doesn't belong in Sage's `thematic_tutorials` directory. This is especially the case since this is an experimental package.",
    "created_at": "2019-05-09T17:20:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368284",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368286",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Still, does it make sense to have a long multi-page document as part of the standard Sage documentation, based on an experimental package? Is there a way to include this as part of the polymake package, so it is only included when the package is installed?",
    "created_at": "2019-05-10T16:21:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368287",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "perhaps one can wrap it as an experimental package.",
    "created_at": "2019-05-10T16:49:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368288",
    "user": "dimpase"
}
```
...
```json
{
    "body": "polymake is far from being available on all platforms we support, see last comments on #24905",
    "created_at": "2019-05-11T00:09:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368290",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368291",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368292",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368293",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368294",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368295",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368296",
    "user": "git"
}
```
...
```json
{
    "body": "Rebased on top of #28265, 8.9.beta3",
    "created_at": "2019-07-26T17:31:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368297",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368298",
    "user": "git"
}
```
...
```json
{
    "body": "The tutorials are currently listed in alphabetical order by file name; they should probably be structured in the same way as here: https://polymake.org/doku.php/user_guide/start",
    "created_at": "2019-07-27T20:49:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368299",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26120#issuecomment-368300",
    "user": "git"
}
```
