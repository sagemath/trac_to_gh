...
The latest development sources have been migrated to github, in a fork of Sage 6.0 master branch, see [http://sagemanifolds.obspm.fr/install_from_git.txt](http://sagemanifolds.obspm.fr/install_from_git.txt)(http://sagemanifolds.obspm.fr/install_from_git.txt)
...
The development version is at [https://github.com/sagemanifolds/](https://github.com/sagemanifolds/)(https://github.com/sagemanifolds/) and can be installed according to these [instructions](http://sagemanifolds.obspm.fr/install_from_git.txt).
