...
```json
{
    ...
    "title": "Avoid initialization of Pari at startup time",
    "type": "issue",
...
```json
{
    "body": "How should I understand this? Would it be possible to profile `import sage.libs.pari` to see in detail what's taking all that time? For example, if it's the `virtual_memory_limit()` call, we could try to do something about that.\n\nOn Linux, `import sage.libs.pari` takes about 35ms, which is 2 orders of magnitude faster than on Windows.",
    "created_at": "2019-07-08T09:13:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393463",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393464",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "I feel a blast from the past... the whole point of `parisizemax` is precisely to avoid resizing the stack on the fly. The idea is to allocate a large \"virtual\" stack with the intention of using only a small part of it, but having the possibility of using it all if needed.\n\nBefore `parisizemax` existed, I recall that Sage used to have a mechanism to retry failed PARI computations if it detected that the PARI stack overflowed. But thanks to `parisizemax`, we got rid of that hack. I'm not looking forward to putting that back.",
    "created_at": "2019-07-08T19:04:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393468",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393469",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Attachment [cygwin_mmap.png](tarball://root/attachments/some-uuid/ticket28132/cygwin_mmap.png) by @embray created at 2019-07-09 10:54:46",
    "created_at": "2019-07-09T10:54:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393470",
    "user": "https://github.com/embray"
}
```

Attachment [cygwin_mmap.png](tarball://root/attachments/some-uuid/ticket28132/cygwin_mmap.png) by @embray created at 2019-07-09 10:54:46
...
```json
{
    "body": "The problem is that you can't know how much PARI stack you need in advance. If you're halfway a computation and suddenly the stack turns out to be too small, then what do you do?",
    "created_at": "2019-07-09T10:55:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393471",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "After a bit of experimenting I found the awful truth, which is that on Cygwin (at least the current version I'm on (3.13.0-170)) the time taken for an anonymous `mmap` and `munmap` scales logarithmically (with munmap typically taking ~twice as long for some reason).\n\nOn Linux both are more-or-less instant no matter the size.\n\n![](cygwin_mmap.png)",
    "created_at": "2019-07-09T10:57:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393472",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Thanks for that. Does it depend on the flags, in particular `MAP_NORESERVE`?",
    "created_at": "2019-07-09T10:59:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393473",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393474",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393475",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Attachment [cygwin_mmap_noreserve.png](tarball://root/attachments/some-uuid/ticket28132/cygwin_mmap_noreserve.png) by @embray created at 2019-07-09 11:11:23",
    "created_at": "2019-07-09T11:11:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393476",
    "user": "https://github.com/embray"
}
```

Attachment [cygwin_mmap_noreserve.png](tarball://root/attachments/some-uuid/ticket28132/cygwin_mmap_noreserve.png) by @embray created at 2019-07-09 11:11:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393477",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "One thing that would be helpful is if the cypari interface had an easy way (as a method on the `Pari` class if possible) to resize the stack sizemax allocation later.  I know in principle it's already possible by manually re-calling `Pari.__init__`, but a more dedicated method would be clearer.\n\nThat way I could so something like start with a smaller stack (just for startup), but then resize it after Sage's initial startup is complete (how exactly that would work I'm not exactly sure yet; possibly in a thread...).",
    "created_at": "2019-07-09T12:54:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393478",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393480",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing component from interfaces to porting: Cygwin.",
    "created_at": "2020-09-23T17:58:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393481",
...
```json
{
    "body": "I forgot all about this issue.  It should just require a simple patch to PARI.",
    "created_at": "2021-03-10T15:33:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393482",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393483",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Patch attached, finally.\n----\nNew commits:",
    "created_at": "2021-08-18T16:23:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393484",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393485",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69818"
}
```
...
```json
{
    "body": "Note, I have not tested this due to not having at the moment an up-to-date Cygwin build.  I hope to try it soon.",
    "created_at": "2021-08-18T16:26:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393486",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Seems to work, but based on the testing slelievre and I have done this patch might not be necessary anymore.  It doesn't seem that pari is as significant a startup time contributor as it used to be, and this patch doesn't seem to make a whole lot of difference.\n\nI don't know if it's something cypari2 does differently, or it could be improvements in cygwin's mmap, or even changes in Windows that have sped this up.",
    "created_at": "2021-08-20T16:11:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393487",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Some more startup related tickets:\n\n- https://trac.sagemath.org/query?order=id&desc=1&summary=~startup&status=!closed",
    "created_at": "2021-08-21T15:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393489",
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69819"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27895#issuecomment-393490",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69821"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69822"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69823"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27895#event-69824"
}
```
