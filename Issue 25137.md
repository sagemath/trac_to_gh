...
```json
{
    "body": "CC:  slelievre tscrim jmantysalo embray jdemeyer saraedum tmonteil vdelecroix mjo novoselt fbissey dimpase\n\n\n\nIssue created by migration from https://trac.sagemath.org/ticket/25374\n\n",
...
```json
{
    "body": "Attachment [cryptominisat-5.8.0-rm_extra_python_vars.patch](tarball://root/attachments/some-uuid/ticket25374/cryptominisat-5.8.0-rm_extra_python_vars.patch) by fbissey created at 2022-06-23 00:53:21\n\nexperimental patch for cryptominisat on cygwin",
...
Attachment [cryptominisat-5.8.0-rm_extra_python_vars.patch](tarball://root/attachments/some-uuid/ticket25374/cryptominisat-5.8.0-rm_extra_python_vars.patch) by fbissey created at 2022-06-23 00:53:21
