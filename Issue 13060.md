...
sage: P = L.plot(size=[[-1..1],[-1..1]],alcovewalks=[This is the Trac macro *0,2,0,1,2,1,2,0,2,1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0,2,0,1,2,1,2,0,2,1-macro)); P
```
