# Issue 28322: py3 + OS X + linear_tensor_element.pyx
...
```json
{
    ...
    "title": "py3 + OS X + linear_tensor_element.pyx",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399527",
...
```json
{
    "body": "No one proposes a solution. How about adopting John's temporary measure here just to push sage on python 3? We can create a regular ticket to further track the issue.",
    "created_at": "2019-12-02T07:39:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399530",
...
```json
{
    "body": "I'm still surprised this isn't similar or related to #28106.  Memory exhaustion is the most likely culprit for random failures like this.",
    "created_at": "2019-12-16T16:11:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399531",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399533",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399534",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71681"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71682"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71683"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71684"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71685"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399535",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "I haven't seen this problem in a long time. Has anyone else?",
    "created_at": "2021-03-12T18:59:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399536",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Yes, this happened on the NixOS builders yesterday: https://nix-cache.s3.amazonaws.com/log/npaj3152j2q7nq1n58i8sncx57mkf6g3-sage-tests-9.2.drv",
    "created_at": "2021-03-12T19:03:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399537",
...
```json
{
    "body": "It's easy to find examples of thread-safety issues related to GLPK in other projects, such as https://github.com/jyp/glpk-hs/pull/9. I don't know how Cython's `__dealloc__` works, but could it interact badly with GLPK's use of thread-local storage?",
    "created_at": "2021-04-02T12:53:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399538",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-399539",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71687"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71688"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71689"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71690"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71691"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71692"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71693"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28322#event-71694"
}
```
