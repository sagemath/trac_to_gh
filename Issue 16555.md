...
```json
{
    "body": "Is there a reason why not using `self.cache.clear()`?",
    "created_at": "2014-08-10T12:40:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16555#issuecomment-217506",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16555#event-49158"
}
```
