...
```json
{
    "body": "Attachment [singledispatch-3.4.0.3.tar.gz](tarball://root/attachments/some-uuid/ticket19638/singledispatch-3.4.0.3.tar.gz) by charpent created at 2015-12-01 17:32:00\n\nTarball for the new sigledispatch package",
...
Attachment [singledispatch-3.4.0.3.tar.gz](tarball://root/attachments/some-uuid/ticket19638/singledispatch-3.4.0.3.tar.gz) by charpent created at 2015-12-01 17:32:00
...
```json
{
    "body": "Attachment [six-1.10.0.tar.gz](tarball://root/attachments/some-uuid/ticket19638/six-1.10.0.tar.gz) by charpent created at 2015-12-01 17:32:21\n\nNew tarball for six",
...
Attachment [six-1.10.0.tar.gz](tarball://root/attachments/some-uuid/ticket19638/six-1.10.0.tar.gz) by charpent created at 2015-12-01 17:32:21
...
```json
{
    "body": "Attachment [rpy2-2.7.4.tar.gz](tarball://root/attachments/some-uuid/ticket19638/rpy2-2.7.4.tar.gz) by charpent created at 2015-12-01 17:34:05\n\nOur damn \"corporate\" firewall mangled the upload of new tarballs...",
...
Attachment [rpy2-2.7.4.tar.gz](tarball://root/attachments/some-uuid/ticket19638/rpy2-2.7.4.tar.gz) by charpent created at 2015-12-01 17:34:05
