# Issue 2003: [with spkg] gnutls configure script finds local copy of guile when it shouldn't
...
```json
{
    ...
    "title": "[with spkg] gnutls configure script finds local copy of guile when it shouldn't",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2003#event-4832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2003",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2003#event-4833"
}
```
