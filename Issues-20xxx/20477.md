...
```json
{
    "body": "<a id='comment:2'></a>What I am doing is iterating through the group and then doing multiplication. The groups are not so big that I couldn't store what I need in a `dict` (which sent a 30s computation to 30ms!), but it would be good for doing testing on random elements for, e.g., G<sub>32</sub>.",
    "created_at": "2016-04-21T13:21:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20477#issuecomment-371840",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>What I am doing is iterating through the group and then doing multiplication. The groups are not so big that I couldn't store what I need in a `dict` (which sent a 30s computation to 30ms!), but it would be good for doing testing on random elements for, e.g., G<sub>32</sub>.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20477#issuecomment-371842",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>https://groups.google.com/d/topic/sage-support/Bl9hRMRauFo/discussion",
    "created_at": "2016-05-04T12:30:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20477#issuecomment-371843",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```

<a id='comment:5'></a>https://groups.google.com/d/topic/sage-support/Bl9hRMRauFo/discussion
...
```json
{
    "body": "<a id='comment:6'></a>Travis, could you send me some example of what you do and where you get the `30s vs. 30ms` timings?",
    "created_at": "2016-05-04T12:32:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20477#issuecomment-371844",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```

<a id='comment:6'></a>Travis, could you send me some example of what you do and where you get the `30s vs. 30ms` timings?
...
```json
{
    "body": "<a id='comment:7'></a>I am looking at lengths of coset representatives, so I am doing a multiplication and then looking at the length. What instead I did was loop over the group and created a dictionary `{element: length}` (essentially I cached the results which are known from the iteration).",
    "created_at": "2016-05-15T15:01:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20477#issuecomment-371845",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>I am looking at lengths of coset representatives, so I am doing a multiplication and then looking at the length. What instead I did was loop over the group and created a dictionary `{element: length}` (essentially I cached the results which are known from the iteration).
