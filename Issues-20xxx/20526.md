...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20526#event-271361"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20526#event-271362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20526#event-271363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20526#event-271364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20526#issuecomment-299137",
    "user": "https://github.com/sagetrac-dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20526#issuecomment-299138",
    "user": "https://github.com/johanrosenkilde"
}
```
