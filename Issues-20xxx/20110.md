...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20110#issuecomment-291254",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20110#issuecomment-291255",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20110",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20110#event-266212"
}
```
