...
```json
{
    "body": "<a id='comment:4'></a>It might actually be safer to use something like that (without calls to ceil, floor):\n\n```\nsage: n,r=20,3\nsage: [n//r]*(r-n%r)+[n//r+1]*(n%r)\n[6, 7, 7]\n```",
...
<a id='comment:4'></a>It might actually be safer to use something like that (without calls to ceil, floor):
...
```json
{
    "body": "<a id='comment:15'></a>This patch is now good to go.\nThanks.\nDavid.",
    "created_at": "2016-03-10T07:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20155",
    "type": "issue_comment",
...
<a id='comment:15'></a>This patch is now good to go.
Thanks.
David.
