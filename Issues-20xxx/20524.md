...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20524#event-271312"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20524#event-271313"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20524#event-271314"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20524#event-271315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20524#issuecomment-299025",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20524#issuecomment-299026",
    "user": "https://github.com/vbraun"
}
```
