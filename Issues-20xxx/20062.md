...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280842"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287526",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287527",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287528",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287529",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287530",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287531",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287532",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287533",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280849"
}
```
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">comment:8</div>\n\nReplying to [@pjbruin](#comment:7):\n> After thinking about this a bit more, it still seems meaningful to me to have an operator `//` that is different from `/`, and that returns the \"Euclidean\" quotient in the case of power series over a field.  (I am not sure what to do for power series over **Z**, for example).\n> \n> However, both to warn users and because the \"correct\" `//` seems to be non-trivial to implement, it is probably good to start by deprecating the current behaviour where `//` behaves identically to `/`.  Hence I am setting this ticket back to \"needs review\" and propose to do the \"meaningful\" reimplementation of `//` at a later time.\n\nNote that there exists a method `quo_rem` for `DiscreteValuationRing`s which works. Thus it should be possible to use it to get a method `__floordiv__`. I am not sure to understand the subtleties described in [comment:5](#comment:5) and [comment:6](#comment:6), but at least there is some working code. For instance:\n\n```python\nsage: R.<x> = QQ[[]]\nsage: R(1).quo_rem(1+t)\n(1 - t + t^2 - t^3 + t^4 - t^5 + t^6 - t^7 + t^8 - t^9 + t^10 - t^11 + t^12 - t^13 + t^14 - t^15 + t^16 - t^17 + t^18 - t^19 + O(t^20),\n 0)\n```",
    "created_at": "2016-04-01T08:05:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287534",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    "body": "<div id=\"comment:9\" align=\"right\">comment:9</div>\n\nReplying to [@bgrenet](#comment:8):\n> Note that there exists a method `quo_rem` for `DiscreteValuationRing`s which works.\n\nYes, I added that in #20283.\n> Thus it should be possible to use it to get a method `__floordiv__`. I am not sure to understand the subtleties described in [comment:5](#comment:5) and [comment:6](#comment:6), but at least there is some working code. For instance:\n> \n> ```python\n> sage: R.<x> = QQ[[]]\n> sage: R(1).quo_rem(1+t)\n> (1 - t + t^2 - t^3 + t^4 - t^5 + t^6 - t^7 + t^8 - t^9 + t^10 - t^11 + t^12 - t^13 + t^14 - t^15 + t^16 - t^17 + t^18 - t^19 + O(t^20),\n>  0)\n> ```\n\nYes, absolutely.  There are two problems: (1) due to the problem mentioned in [comment:5](#comment:5), it seems that we cannot easily implement a generic `__floordiv__` using `quo_rem` for all Euclidean domains simultaneously, and (2) in view of backward compatibility it would not be very good to change the behaviour of `__floordiv__` without any warning or deprecation of the old behaviour.",
    "created_at": "2016-04-01T09:19:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287535",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287536",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287537",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287538",
...
```json
{
    "body": "<div id=\"comment:12\"></div>\n\nBranch pushed to git repo; I updated commit sha1. New commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/5e5748bdaf542f550aadd722d06925c668b473ab\"><code>5e5748b</code></a></td><td><code>Trac 20062: make `_floordiv_` do Euclidean division for power series over fields</code></td></tr></table>\n",
    "created_at": "2016-04-09T13:05:40Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287539",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287540",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287541",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287542",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    "body": "<div id=\"comment:14\"></div>\n\nBranch pushed to git repo; I updated commit sha1. New commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/b7cd5cb0331479589f777c4da8fdd35c3bc1bb2b\"><code>b7cd5cb</code></a></td><td><code>Trac 20062: improvements related to imports</code></td></tr></table>\n",
    "created_at": "2016-04-11T22:08:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287543",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287544",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287545",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20062#issuecomment-287546",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20062",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20062#event-280854"
}
```
