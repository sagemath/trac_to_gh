...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[ea5d90f](http://git.sagemath.org/sage.git/commit/?id=ea5d90fddb95bc90e21796fdfe708cee4adc80e8)|`Add click as a standard package`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nrebased on 7.6.b5\n\n---\nNew commits:\n|                                                                                                                                          |                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[98d7b94](https://git.sagemath.org/sage.git/commit?id=98d7b94fd064200fedf3edb3611f219f8e556530)|`Merge branch 'u/vbraun/update_flask__babel_' in 7.6.b5`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[ad6269e](https://git.sagemath.org/sage.git/commit/?id=ad6269e27e8910db412bbd649f368f0c883a13c1)|`Merge branch 'public/20922' of trac.sagemath.org:sage into 8.2.b3`|\n|[d18c2f2](https://git.sagemath.org/sage.git/commit/?id=d18c2f2d20189526f8752adc67b5a749779ab8f5)|`new-style spkg-install`|",
