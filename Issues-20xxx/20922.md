...
```json
{
    "body": "<a id='comment:9'></a>Sure, if the notebook will still work.  Is the code you have in[comment:7](#comment%3A7) pretty standard as a workaround?",
...
<a id='comment:9'></a>Sure, if the notebook will still work.  Is the code you have in[comment:7](#comment%3A7) pretty standard as a workaround?
...
```json
{
    "body": "<a id='comment:10'></a>A priori, the changes suggested in[comment:7](#comment%3A7) are included in the notebook since a long time, and should already be in the notebook version inside sage.\n\nSo indeed, the matter is just now to see if updating flask breaks sagenb or not..",
...
<a id='comment:10'></a>A priori, the changes suggested in[comment:7](#comment%3A7) are included in the notebook since a long time, and should already be in the notebook version inside sage.
