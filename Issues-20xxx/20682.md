# Issue 20682: Wrong behaviour when `existence=True` for `incomplete_orthogonal_array` and `difference_family`
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20682#issuecomment-285415",
    "user": "https://github.com/eviatarbach"
}
```
