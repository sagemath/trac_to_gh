...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20887#event-275995"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20887#event-275996"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20887#event-275997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20887#event-275998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20887#issuecomment-305662",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20887#issuecomment-305663",
    "user": "https://github.com/vbraun"
}
```
