...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20019#issuecomment-289321",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20019#issuecomment-289322",
    "user": "https://github.com/sagetrac-dlaurain"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20019#event-264967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20019#event-264968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20019",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20019#event-264969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20019#event-264970"
}
```
