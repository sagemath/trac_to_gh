...
```json
{
    "body": "<a id='comment:24'></a>\nMaybe, maybe not.  Some projects just make their source tarballs by bundling what's in the VCS--sometimes this is done directly though [GitHub](../wikis/GitHub) or other VCS interfaces.  I don't think it's wrong.  Slightly inconvenient but not wrong.",
