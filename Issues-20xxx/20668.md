...
<a id='comment:21'></a>Replying to [vbraun](#comment%3A18):
> But it should be enabled for doctests; Just add the print_function import to src/sage/doctest/sources.py as virtual doctest.
...
```json
{
    "body": "<a id='comment:22'></a>ping ? Please, Volker, what do you mean exactly by[comment:18](#comment%3A18) ?",
...
<a id='comment:22'></a>ping ? Please, Volker, what do you mean exactly by[comment:18](#comment%3A18) ?
