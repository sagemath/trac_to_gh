...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[64eb69e](https://git.sagemath.org/sage.git/commit/?id=64eb69eca4d560773a8057b533a341f18c5ab3cf)|`GMP-ECM: #20385: (Also) run 'make longcheck' in spkg-check`|",
    "created_at": "2016-08-03T05:28:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20385",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|\n|[0affd29](https://git.sagemath.org/sage.git/commit/?id=0affd290f491cf624f15fec080f3b349bd07477c)|`GMP-ECM: #20385: Restore note on work-around in SPKG.txt that accidentally got dropped in the 6.4.4 package.`|",
    "created_at": "2016-08-03T08:42:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20385",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:56'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[6741ee0](https://git.sagemath.org/sage.git/commit/?id=6741ee0e6e3d3570157fb453c54bcde586bffea8)|`GMP-ECM: #20385: Add temporary patch for '-Wl,znoexecstack' [sic] (Makefile.{am,in})`|",
...
```json
{
    "body": "<a id='comment:77'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|\n|[e115141](https://git.sagemath.org/sage.git/commit/?id=e115141455e83eb0213a83d4153f72d80a767e2d)|`GMP-ECM: #20385: Add another patch avoiding nested archives and rebase the previous on it.`|",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[eaee6e0](https://git.sagemath.org/sage.git/commit/?id=eaee6e002fd1b89dc5c63401f72a3ff93678825c)|`Fix libecm doctests`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nAdding the patch from arch linux (and credit the author properly) and let's try to finish this.\n\n---\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[dea25cd](https://git.sagemath.org/sage.git/commit?id=dea25cde0565301bbb2016ec9aea8784c928fd75)|`Merge branch 'develop' into gmp-ecm-7.x`|\n|[dde736b](https://git.sagemath.org/sage.git/commit?id=dde736b3c5382de6617fadd7597e4f48131af4cb)|`Add interface patch for emc 7 from the Arch linux port. The Arch commit is credited to Antonio Rojas (arojas`@`archlinux.org)`|",
    "created_at": "2017-05-11T01:53:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20385",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[946c580](https://git.sagemath.org/sage.git/commit/?id=946c5808691c5437cb6b2148fe0a5b7a200ce140)|`making the longcheck tests run serially`|",
    "created_at": "2017-05-12T23:40:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20385",
    "type": "issue_comment",
