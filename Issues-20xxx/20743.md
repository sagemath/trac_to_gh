...
```json
{
    "body": "<a id='comment:1'></a>+1 to returning a tuple",
    "created_at": "2016-06-01T09:20:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378050",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>+1 to returning a tuple
...
```json
{
    "body": "<a id='comment:2'></a>-1 to returning a tuple. `foo.list()` should return the same as `list(foo)`, which is always a list, and `foo.tuple()` should return the same as `tuple(foo)`, which is always a tuple. And for that matter, `foo.str()` returns the same as `str(foo)` which is always a string, et cetera.",
    "created_at": "2016-06-02T05:13:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378051",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:2'></a>-1 to returning a tuple. `foo.list()` should return the same as `list(foo)`, which is always a list, and `foo.tuple()` should return the same as `tuple(foo)`, which is always a tuple. And for that matter, `foo.str()` returns the same as `str(foo)` which is always a string, et cetera.
...
```json
{
    "body": "<a id='comment:6'></a>Definitely +1 on returning something immutable, and a tuple is the natural choice; I have been desiring it for a while. The naming issue is somewhat annoying, but that's life, I guess. The only thing that worries me is that this is going to break backward compatibility, and I am not sure there is anything we can do ...",
    "created_at": "2016-06-02T15:11:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378054",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:6'></a>Definitely +1 on returning something immutable, and a tuple is the natural choice; I have been desiring it for a while. The naming issue is somewhat annoying, but that's life, I guess. The only thing that worries me is that this is going to break backward compatibility, and I am not sure there is anything we can do ...
...
```json
{
    "body": "<a id='comment:7'></a>Alternative idea: create a new type `immutable_list` inheriting from `list`. This has the advantage of being backwards compatible: `isinstance(foo, list)` would still be true and the printing would be like a list. This works and behaves like a `list`:\n\n```\ncdef class immutable_list(list):\n    def __setitem__(self, i, value):\n        raise TypeError\n```\nOf course, you also need to disallow `.append()`, `+=`, `__delitem__`, ... but the basic idea works.",
    "created_at": "2016-06-02T15:27:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378055",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Alternative idea: create a new type `immutable_list` inheriting from `list`. This has the advantage of being backwards compatible: `isinstance(foo, list)` would still be true and the printing would be like a list. This works and behaves like a `list`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378058",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Replying to [kedlaya](#comment%3A11):\n> {{{\n> math.floor()\n> math.ceil()\n> float.hex()\n> list.index()\n> str.title()\n> str.upper()\n> }}}\n\nThis sublist could be all verbs? They are definitely funnier that way.",
    "created_at": "2016-06-02T16:24:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378061",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:13'></a>Replying to [kedlaya](#comment%3A11):
> {{{
> math.floor()
> math.ceil()
> float.hex()
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378064",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378066",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Trying to fix the bug, I did something else in #20902, which also fixes somehow the bug in the current ticket. Please check.",
    "created_at": "2016-06-29T02:10:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378067",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:19'></a>Trying to fix the bug, I did something else in #20902, which also fixes somehow the bug in the current ticket. Please check.
...
```json
{
    "body": "<a id='comment:20'></a>Perhaps I need to clarify how #20902 fixes the issue. With the patch,\n\n```\nsage: F=GF(5)\nsage: F.list()\n[0, 1, 2, 3, 4]\nsage: F.list().remove(0)\nsage: F.list()\n[0, 1, 2, 3, 4]\nsage: F.list.__module__\n'sage.categories.finite_enumerated_sets' \n```",
    "created_at": "2016-07-06T06:43:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378068",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:20'></a>Perhaps I need to clarify how #20902 fixes the issue. With the patch,
...
```json
{
    "body": "<a id='comment:22'></a>We can just keep this around for right now to note the discussion and the issue.",
    "created_at": "2016-11-11T14:52:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20743#issuecomment-378070",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:22'></a>We can just keep this around for right now to note the discussion and the issue.
