...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20803#event-274943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20803#issuecomment-304382",
    "user": "https://github.com/sagetrac-ehlen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20803#issuecomment-304383",
    "user": "https://github.com/sagetrac-ehlen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20803#event-274944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20803#event-274945"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20803#event-274946"
}
```
