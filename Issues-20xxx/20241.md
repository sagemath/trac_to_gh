...
```json
{
    "body": "<a id='comment:29'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[a8b8b7c](https://github.com/sagemath/sagetrac-mirror/commit/a8b8b7c5bfd6f412eb0f35e5009bc888a80e83b2)|<code>Fixed minor bugs, changed behaviour of `pari(complex(x,y))`</code>|",
