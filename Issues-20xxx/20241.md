...
```json
{
    "body": "<a id='comment:10'></a>\nYup. Second step. I needed to know who was using it anyway. Any module importing `_pari_`instance is doing bad, and I'm fixing it. I just pushed this to get help from patchbot.",
