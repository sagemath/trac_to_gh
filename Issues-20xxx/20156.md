...
```json
{
    "body": "<a id='comment:1'></a>That means you have #20133 in, on top of `7.1.beta6`. Of course that means we need to add `pkgconf` to the list of build time dependency of the sage library.",
    "created_at": "2016-03-04T01:34:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20156#issuecomment-291714",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>That means you have #20133 in, on top of `7.1.beta6`. Of course that means we need to add `pkgconf` to the list of build time dependency of the sage library.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20156#issuecomment-291715",
    "user": "https://github.com/jdemeyer"
}
```
