...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286833"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286835"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286836"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286837"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286839"
}
```
...
```json
{
    "body": "<div id=\"comment:10\" align=\"right\">comment:10</div>\n\nMy three commits should correct the problems noticed above. The problem mentioned in the \"**[edit]**\" part of [comment:5](#comment:5) is corrected by the latest commit: Instead of trying to use the generic method `gcd` for multivariate polynomials, it directly tests whether Singular can perform the computation.\n\nMy main concern now is performance: At some point, I run tests that were very slow, but I am not able to reproduce the behavior anymore. That's why I put Needs Review: Please perform tests to see whether my changes imply slowdown in some parts. It should'nt...",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286841"
}
```
...
```json
{
    "body": "<div id=\"comment:12\" align=\"right\">comment:12</div>\n\nReplying to [@bgrenet](#comment:10):\n> My main concern now is performance: At some point, I run tests that were very slow, but I am not able to reproduce the behavior anymore. That's why I put Needs Review: Please perform tests to see whether my changes imply slowdown in some parts. It should'nt...\n\nThis is not valid (anymore)!",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20220",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20220#event-286845"
}
```
