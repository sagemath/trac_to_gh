...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273911"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20726#issuecomment-302716",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20726#issuecomment-302717",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273917"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20726",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20726#event-273919"
}
```
