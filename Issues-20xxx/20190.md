...
<a id='comment:30'></a>Replying to [charpent](#comment%3A28):
> * changing `cd src` to `cd R-revised/src`
...
<a id='comment:36'></a>Replying to [vbraun](#comment%3A34):
