...
```json
{
    "body": "<a id='comment:1'></a>Happened again. The scenario was:\n1. `make distclean`\n2. build Sage but don't run it\n3. `make ptestlong` -> got this failure",
    "created_at": "2016-04-24T21:17:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370881",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Happened again. The scenario was:
1. `make distclean`
2. build Sage but don't run it
3. `make ptestlong` -> got this failure
...
```json
{
    "body": "<a id='comment:2'></a>For what it's worth I had some doctest failures when the `gap` upgrade landed [https://github.com/cschwan/sage-on-gentoo/issues/412](https://github.com/cschwan/sage-on-gentoo/issues/412). They did go away as mysteriously as they came after a couple of beta releases. They were persistent across rebuilding gap/libgap and sage.",
    "created_at": "2016-04-24T22:06:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370882",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>For what it's worth I had some doctest failures when the `gap` upgrade landed [https://github.com/cschwan/sage-on-gentoo/issues/412](https://github.com/cschwan/sage-on-gentoo/issues/412). They did go away as mysteriously as they came after a couple of beta releases. They were persistent across rebuilding gap/libgap and sage.
...
```json
{
    "body": "<a id='comment:3'></a>Thats probably a race with building the workspace caches...",
    "created_at": "2016-05-07T23:12:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370883",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Thats probably a race with building the workspace caches...
...
```json
{
    "body": "<a id='comment:4'></a>also reproduced on OSX: https://groups.google.com/d/msg/sage-release/iNYoT5KK3pw/EAiAqQmMMQAJ",
    "created_at": "2016-05-10T08:37:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370884",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>also reproduced on OSX: https://groups.google.com/d/msg/sage-release/iNYoT5KK3pw/EAiAqQmMMQAJ
...
```json
{
    "body": "<a id='comment:6'></a>Just for info: I just got this while upgrading to (lib)gap 4.9 (dev)",
    "created_at": "2017-03-16T22:32:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370886",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:6'></a>Just for info: I just got this while upgrading to (lib)gap 4.9 (dev)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370887",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>That was with 7.6.beta6 (and some of #22626). So without #22570 I believe.",
    "created_at": "2017-03-16T23:44:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370888",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:8'></a>That was with 7.6.beta6 (and some of #22626). So without #22570 I believe.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370889",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Don't do that. You can look at the development branch but don't touch it.... commits may be rewritting / removed until it is published.",
    "created_at": "2017-03-17T07:46:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370890",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>Don't do that. You can look at the development branch but don't touch it.... commits may be rewritting / removed until it is published.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20421#issuecomment-370891",
    "user": "https://github.com/kiwifb"
}
```
