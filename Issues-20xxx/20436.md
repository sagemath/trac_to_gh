...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20436#event-270274"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20436#event-270275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20436#event-270276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20436#event-270277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20436#issuecomment-297625",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20436#issuecomment-297626",
    "user": "https://github.com/kcrisman"
}
```
