...
```json
{
    "body": "<a id='comment:3'></a>\nNot sure if this installation should be done using CPAN scripts instead.\n\n---\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[3c5a4ac](https://git.sagemath.org/sage.git/commit?id=3c5a4acabe29c8bb6263ffb0fd280808d7c2f462)|`Add Sage package for Perl 5 readline library`|\n|[ac47794](https://git.sagemath.org/sage.git/commit?id=ac4779403ecf003fdcd25fd9fcd8ba2b97c04575)|`Set PERL5LIB environment variable`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[4088bec](http://git.sagemath.org/sage.git/commit/?id=4088becb513fe5a5a41002f5e4511941894da21d)|`Merge tag '7.3.beta6' into t/20894/sage_package_for_perl_5_readline_library`|\n|[cfffc5e](http://git.sagemath.org/sage.git/commit/?id=cfffc5e577405f996f10471273ee137d8cbd7966)|`Conditionalize ARCHFLAGS based on uname`|",
