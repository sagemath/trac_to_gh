...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382554",
    "user": "https://trac.sagemath.org/admin/accounts/users/panda314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382555",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382556",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382557",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382558",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> What are ticket states? Is there a way to automate the merging with latest version?\n\n\nOh, no, you have to merge it by hand. What I meant by ticket states is to switch from `new` to `needs_review` when you finish working on it, etc. \n\n>As far as i remember the reed solomon super code method is apllicable only for q-ary reed muller codes with order<field_size. It is applicable for binary reed muller code only if the order<=1. I guess i can allow for such binary reed muller codes.\n\n\nYes, that would be great!\n\n> Yeah i will add the option for using a reed solomon decoder. I had arbitrarily picked Gao. \n\n\nOk, perfect.\n\nDavid",
    "created_at": "2016-07-22T07:36:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382560",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:5'></a>> What are ticket states? Is there a way to automate the merging with latest version?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382561",
    "user": "https://trac.sagemath.org/admin/accounts/users/panda314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382563",
    "user": "https://trac.sagemath.org/admin/accounts/users/panda314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382564",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382565",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382566",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382568",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20938#issuecomment-382569",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
