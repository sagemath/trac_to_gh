...
```json
{
    "body": "<a id='comment:3'></a>\nWent ahead and fixed this for most, if not all packages, while waiting for a build to finish.\n\nAgain, the only thing this is fixing as an annoying warning (that will appear for almost every file compiled) on Cygwin where the `-fPIC` flag is enabled.  If future spkgs add this flag it's not a big deal.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[78ecb4f](https://git.sagemath.org/sage.git/commit?id=78ecb4fc6f8e5e64b120bfaa5e4de0b7f97025c3)|`Disable -fPIC when building libfplll on Cygwin`|\n|[6c28afc](https://git.sagemath.org/sage.git/commit?id=6c28afc4939a83708526e30021690af72ff2011f)|`Disable -fPIC when building libpng on Cygwin`|\n|[65efc90](https://git.sagemath.org/sage.git/commit?id=65efc908d3ffbe3592949abf852976e0142143fc)|`Disable -fPIC when building m4ri and m4rie on Cygwin`|\n|[048b1ff](https://git.sagemath.org/sage.git/commit?id=048b1ff830e85b8c1870bb2a48dfd23902a1e0f3)|`Disable -fPIC when building meataxe on Cygwin`|\n|[60bf280](https://git.sagemath.org/sage.git/commit?id=60bf280ee1e0c686f8f62ae43ad01ac841b00eba)|`Disable -fPIC when building modular_decomposition on Cygwin`|\n|[8bd68be](https://git.sagemath.org/sage.git/commit?id=8bd68be1f1ed448ced7ea5ae3713f8e3706f849e)|`Disable -fPIC when building mpfi on Cygwin`|\n|[fa849c8](https://git.sagemath.org/sage.git/commit?id=fa849c84f1c6d0fe63eec30efe954a37331e9e73)|`Disable -fPIC when building ratpoints on Cygwin`|\n|[f1d3819](https://git.sagemath.org/sage.git/commit?id=f1d38190c634ada5e7f53316b66e31c12f2d9d4f)|`Disable -fPIC when building singular on Cygwin`|\n|[ea62369](https://git.sagemath.org/sage.git/commit?id=ea623698b56bef5e3538dd293f458c765c04d778)|`Disable -fPIC when building symmetrica on Cygwin`|\n|[3302dc8](https://git.sagemath.org/sage.git/commit?id=3302dc8cd42338976dfa232dc9b9c6281d52a289)|`Disable -fPIC when building termcap on Cygwin`|",
    "created_at": "2016-07-06T14:46:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20508",
    "type": "issue_comment",
