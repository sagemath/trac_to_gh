...
```json
{
    "body": "<a id='comment:1'></a>A bit annoying, but as far as I can see the deprecation is from the `traitlet` module deprecating how `IPython.core` sets default values. So its something that needs to be fixed in IPython...",
    "created_at": "2016-03-14T17:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20206#issuecomment-365670",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>A bit annoying, but as far as I can see the deprecation is from the `traitlet` module deprecating how `IPython.core` sets default values. So its something that needs to be fixed in IPython...
...
```json
{
    "body": "<a id='comment:3'></a>outdated, can we close ?",
    "created_at": "2021-09-02T12:31:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20206#issuecomment-365672",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>outdated, can we close ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20206#issuecomment-365673",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Yes, I think so",
    "created_at": "2021-09-02T20:09:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20206#issuecomment-365674",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>Yes, I think so
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20206#event-54890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20206#issuecomment-365675",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20206#event-54891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20206#issuecomment-365676",
    "user": "https://github.com/fchapoton"
}
```
