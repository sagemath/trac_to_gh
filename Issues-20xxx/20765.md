...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -51,6 +51,8 @@\n ImportError: No module named moves.urllib.request\n ```\n \n+This was on a machine running OS X 10.10\n+\n Comment: 1\n \n Summary: load not working via https\n``````\n",
    "created_at": "2016-06-02T23:08:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301614",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301615",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It seems like the culprit is that someone added a six.py file in misc so that the import is now importing from the local six.py file instead of the actual six file!",
    "created_at": "2016-12-16T21:03:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301617",
    "user": "https://github.com/koffie"
}
```

<a id='comment:5'></a>It seems like the culprit is that someone added a six.py file in misc so that the import is now importing from the local six.py file instead of the actual six file!
...
```json
{
    "body": "<a id='comment:7'></a>Seems like it is already fixed in #20797 so this ticket can be closed.",
    "created_at": "2016-12-17T16:13:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301619",
    "user": "https://github.com/koffie"
}
```

<a id='comment:7'></a>Seems like it is already fixed in #20797 so this ticket can be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301620",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301621",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20765#event-55769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20765#event-55770"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20765#issuecomment-301622",
