...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360843",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360844",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360845",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360846",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360847",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360850",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360851",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360852",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360853",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360854",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>LGTM! This is actually a nice lexicographic iterator over all compositions of size `\\leq n`.\n\nIf you doctest sage/combinat  (this iterator is used a lot, and who knows what could happen), feel free to set this to positive review.",
    "created_at": "2016-02-04T23:21:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360855",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:9'></a>LGTM! This is actually a nice lexicographic iterator over all compositions of size `\leq n`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360856",
...
```json
{
    "body": "<a id='comment:11'></a>I'm wondering how much we could get by going one step further and moving `IntegerListsLex` to a small standalone C/C++ library, where we can really get to low-level optimizations. Although I see some technical challenges with this; in particular, taking functions as input and the lambda functions involved with the current implementation. Perhaps Cython will be sufficient.\n\nI agree that this would further benefit from cythonization/C-ifying. Right now we don't have a set place upon where we can put these functions. I also do not see them as code bloat because to really optimize `IntegerListsLex`, we will almost certainly have specialized implementations for special cases to avoid overhead of the general case. (This implementation can be easily tweaked to cover a number of other cases, but would likely have bad performance in general.)\n\nHowever, I think we should do all of these things on a separate ticket(s), which is why I'm setting this to a positive review given [comment:9 Darij's comment] and the green patchbot. Feel free to set it back if you disagree. Yet +1 to adding a common place/library for all of these iterator functions (and their cython/C versions).",
    "created_at": "2016-02-05T17:51:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360857",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:11'></a>I'm wondering how much we could get by going one step further and moving `IntegerListsLex` to a small standalone C/C++ library, where we can really get to low-level optimizations. Although I see some technical challenges with this; in particular, taking functions as input and the lambda functions involved with the current implementation. Perhaps Cython will be sufficient.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360858",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360859",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20008#event-54535"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20008#issuecomment-360860",
    "user": "https://github.com/vbraun"
}
```
