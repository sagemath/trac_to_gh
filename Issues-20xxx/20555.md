...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261913"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261917"
}
```
...
```json
{
    "body": "Changed keywords from **** to **permutation**",
    "created_at": "2016-05-04T12:19:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/20555",
    "type": "issue_comment",
...
Changed keywords from **** to **permutation**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261918"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261919"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20555#issuecomment-299628",
    "user": "https://github.com/sagetrac-stumpc5"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20555",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20555#event-261921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20555#issuecomment-299629",
