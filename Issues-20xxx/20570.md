...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|\n|[2ac4760](http://git.sagemath.org/sage.git/commit/?id=2ac4760f7add8c8b91232a99b8fbf31bb608d708)|`InteractiveLPProblem: Refactor plot using new methods get_plot_bounding_box and plot_objective_growth_and_solution`|\n|[0416add](http://git.sagemath.org/sage.git/commit/?id=0416add046cd38e811a5a48706a6009569e2ef59)|`Minor cleanup`|\n|[aa3fa4b](http://git.sagemath.org/sage.git/commit/?id=aa3fa4bcfa7ede354fd4b214a6c3e8f9e4148a53)|`Add testcase for plotting of irrational polygons`|",
