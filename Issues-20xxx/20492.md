...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288853"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295901",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295902",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-288861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295903",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295905",
    "user": "https://github.com/embray"
}
```
