...
```json
{
    "body": "<a id='comment:2'></a>\nNeeds review. Comments on the proposed interface are welcome.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[7cb2b3a](https://git.sagemath.org/sage.git/commit?id=7cb2b3a54149fa30ea6bc2f47b50a311dca6935d)|`MIPVariable, MixedIntegerLinearProgram.new_variable: Take optional static list of component indices`|",
    "created_at": "2018-09-18T15:49:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20773",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[604b2c7](https://git.sagemath.org/sage.git/commit/?id=604b2c76f28df5d7b9684a2c874ee41e9de51bfd)|`MIPVariable, MixedIntegerLinearProgram.new_variable: Use None instead of 'dynamic'`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[23689dd](https://git.sagemath.org/sage.git/commit/?id=23689ddb190d6e2847fd492c91c996a7afa2bbea)|`MIPVariable.__getitem__: Add doctest`|",
    "created_at": "2018-09-20T02:09:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20773",
    "type": "issue_comment",
