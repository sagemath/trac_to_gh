...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363544",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I have little idea whether this should be considered to be a jupyter issue or a sage issue --- after all, sage put kernel specification files into the users homedirectories without informing them about that.\n\nFrom jupyter's perspective, the user provided an incorrect specification file, so perhaps there is no reason to react gracefully. Sage should IMHO.\n\nSo I'd appreciate if somebody with more knowledge about the jupyter/sage integration could take over here.",
    "created_at": "2016-02-26T06:15:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363545",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:1'></a>I have little idea whether this should be considered to be a jupyter issue or a sage issue --- after all, sage put kernel specification files into the users homedirectories without informing them about that.
...
```json
{
    "body": "<a id='comment:3'></a>Sounds like a Jupyter bug. Do you have a minimal testcase (empty notebook)?",
    "created_at": "2016-02-26T11:19:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363546",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Sounds like a Jupyter bug. Do you have a minimal testcase (empty notebook)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363547",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [sage-6-9-notebook.ipynb](tarball://root/attachments/some-uuid/ticket20121/sage-6-9-notebook.ipynb) by @cheuberg created at 2016-02-26 11:30:54\n\nReplying to [comment:3 vbraun]:\n> Sounds like a Jupyter bug. Do you have a minimal testcase (empty notebook)?\n\n\nattached. It contains one cell (`sage.version.version`): load it in 7.0, observe the kernel error, switch to kernel 7.0, but kernel error still persists (try running the notebook).",
    "created_at": "2016-02-26T11:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363548",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:4'></a>Attachment [sage-6-9-notebook.ipynb](tarball://root/attachments/some-uuid/ticket20121/sage-6-9-notebook.ipynb) by @cheuberg created at 2016-02-26 11:30:54
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20121#event-54749"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This is likely outdated.",
    "created_at": "2020-08-17T04:10:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363549",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>This is likely outdated.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363550",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363551",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363552",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>indeed, it cannot be reproduced in 9.2.beta - no crash any more",
    "created_at": "2020-08-18T08:55:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363553",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:6'></a>indeed, it cannot be reproduced in 9.2.beta - no crash any more
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20121#event-54750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20121#issuecomment-363554",
