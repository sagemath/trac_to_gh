...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291275",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291276",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291277",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291278",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket20121/sage-6-9-notebook.ipynb",
    "created_at": "2016-02-26T11:30:54Z",
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket20121/sage-6-9-notebook.ipynb",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [sage-6-9-notebook.ipynb](https://github.com/sagemath/sage/files/ticket20121/sage-6-9-notebook.ipynb) by @cheuberg created at 2016-02-26 11:30:54\n\nReplying to [vbraun](#comment%3A3):\n> Sounds like a Jupyter bug. Do you have a minimal testcase (empty notebook)?\n\n\nattached. It contains one cell (`sage.version.version`): load it in 7.0, observe the kernel error, switch to kernel 7.0, but kernel error still persists (try running the notebook).",
    "created_at": "2016-02-26T11:30:54Z",
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291279",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291280",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291281",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20121#issuecomment-291282",
    "user": "https://github.com/dimpase"
}
```
