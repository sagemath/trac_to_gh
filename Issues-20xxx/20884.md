...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|\n|[611480d](http://git.sagemath.org/sage.git/commit/?id=611480df1194bb460abfbc77c6418bab1d0518e4)|`No matter what I do, even with sed --unbuffered, sed will read either up to the EOF or the EOL, but otherwise buffers until EOL.`|\n|[632fea7](http://git.sagemath.org/sage.git/commit/?id=632fea7e3912f4769fa65413c62dbbaec098b613)|`Add a new -y argument to sage-spkg to make it automatically answer 'y' to all prompts.`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[4f7b63f](http://git.sagemath.org/sage.git/commit/?id=4f7b63f16b156891638b546427f4d9c7e66c7137)|`Display an additional message when continuing automatically`|",
    "created_at": "2016-06-30T12:44:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20884",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------|\n|[bdcfff4](http://git.sagemath.org/sage.git/commit/?id=bdcfff486256625b42541e505905e3a7d2e083e7)|`Two fixes:`|",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[0fc8fde](http://git.sagemath.org/sage.git/commit/?id=0fc8fde498193be273b22ec69e5e97a67caa0dc0)|`Change -N 1 to -n 1 in sage-logger, since the former does not work on`|",
    "created_at": "2016-07-04T13:24:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20884",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:31'></a>\nFixed `sage-logger` to not use `read -N 1` as well.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[0fc8fde](https://git.sagemath.org/sage.git/commit?id=0fc8fde498193be273b22ec69e5e97a67caa0dc0)|`Change -N 1 to -n 1 in sage-logger, since the former does not work on`|",
    "created_at": "2016-07-04T13:24:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20884",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[4ce1311](http://git.sagemath.org/sage.git/commit/?id=4ce1311c5eb580adc85ab95f596e85d13145847c)|`Don't use -d'' to read, since it mysteriously treats - as a delimiter.`|",
...
```json
{
    "body": "<a id='comment:45'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[7a6f70c](http://git.sagemath.org/sage.git/commit/?id=7a6f70c6cb3f7106109d61093fc07240e4a5bfe1)|`Now that we know what the correct syntax is, went back to using `-d ''``|",
...
```json
{
    "body": "<a id='comment:47'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[7055736](http://git.sagemath.org/sage.git/commit/?id=705573623266f1017aa4a433e816c0e878960836)|`Replace one more example of echo -n with printf`|",
    "created_at": "2016-07-05T12:23:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20884",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:69'></a>\nre-introduced branch name\n\n---\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[ccff005](https://git.sagemath.org/sage.git/commit?id=ccff00540641c9a7b19166c550433b6d4495a5ba)|`Disable the y/n prompt when installing experimental packages.`|\n|[611480d](https://git.sagemath.org/sage.git/commit?id=611480df1194bb460abfbc77c6418bab1d0518e4)|`No matter what I do, even with sed --unbuffered, sed will read either up to the EOF or the EOL, but otherwise buffers until EOL.`|\n|[632fea7](https://git.sagemath.org/sage.git/commit?id=632fea7e3912f4769fa65413c62dbbaec098b613)|`Add a new -y argument to sage-spkg to make it automatically answer 'y' to all prompts.`|\n|[4f7b63f](https://git.sagemath.org/sage.git/commit?id=4f7b63f16b156891638b546427f4d9c7e66c7137)|`Display an additional message when continuing automatically`|\n|[bdcfff4](https://git.sagemath.org/sage.git/commit?id=bdcfff486256625b42541e505905e3a7d2e083e7)|`Two fixes:`|\n|[0fc8fde](https://git.sagemath.org/sage.git/commit?id=0fc8fde498193be273b22ec69e5e97a67caa0dc0)|`Change -N 1 to -n 1 in sage-logger, since the former does not work on`|\n|[4ce1311](https://git.sagemath.org/sage.git/commit?id=4ce1311c5eb580adc85ab95f596e85d13145847c)|`Don't use -d'' to read, since it mysteriously treats - as a delimiter.`|\n|[7a6f70c](https://git.sagemath.org/sage.git/commit?id=7a6f70c6cb3f7106109d61093fc07240e4a5bfe1)|`Now that we know what the correct syntax is, went back to using `-d ''``|\n|[7055736](https://git.sagemath.org/sage.git/commit?id=705573623266f1017aa4a433e816c0e878960836)|`Replace one more example of echo -n with printf`|",
    "created_at": "2016-07-12T09:50:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20884",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:88'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[e2cf8fb](https://git.sagemath.org/sage.git/commit/?id=e2cf8fbe05c83a0827bcdbd7feba9e510524232e)|`A simplified approach to #20884`|",
...
```json
{
    "body": "<a id='comment:89'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[035e1d8](https://git.sagemath.org/sage.git/commit/?id=035e1d8e972d15f50229869da42fe669e9abc35e)|`A simplified approach to #20884`|",
...
```json
{
    "body": "<a id='comment:0'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[6888a67](https://git.sagemath.org/sage.git/commit/?id=6888a6788eb25bcc293a465091c68850346f0e85)|`untabify changes`|",
    "created_at": "2016-07-21T07:48:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20884",
    "type": "issue_comment",
