...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20101#issuecomment-276653",
...
```json
{
    "body": "Is an_element() always supposed to return \"0\" in some guise?  In any case, if the ring is \"known\", we can handle it (PID, UFD, domain, ...), no?",
    "created_at": "2016-03-31T20:02:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20101#issuecomment-276654",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
