...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287378"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-293793",
    "user": "https://github.com/sagetrac-jcristau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-293794",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-293795",
...
```json
{
    ...
    "milestone_title": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-293796",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-287386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-293797",
    "user": "https://github.com/jdemeyer"
}
```
