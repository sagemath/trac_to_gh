...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269489"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269490"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296343",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296344",
    "user": "https://github.com/jdemeyer"
}
```
