...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269493"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296338",
    "user": "https://github.com/sagetrac-jcristau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296339",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296340",
...
```json
{
    ...
    "milestone_title": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296341",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269500"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-269501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296342",
    "user": "https://github.com/jdemeyer"
}
```
