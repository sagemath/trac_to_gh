...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20944#event-276801"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20944#event-276802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20944#event-276803"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20944#event-276804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20944#issuecomment-306990",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20944#issuecomment-306991",
    "user": "https://github.com/vbraun"
}
```
