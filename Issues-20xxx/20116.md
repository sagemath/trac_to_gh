...
```json
{
    ...
    "type": "issue",
    "updated_at": "2016-02-27T11:14:24Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20116#event-245363"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20116#event-245364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20116#event-245365"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20116#event-245366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20116#issuecomment-291231",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20116#issuecomment-291232",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20116#issuecomment-291233",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20116#issuecomment-291234",
    "user": "https://github.com/jdemeyer"
}
```
