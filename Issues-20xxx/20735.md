...
```json
{
    "body": "This hasn't had any progress recently; should we close it as won't-fix?  Volker, any comments?",
...
```json
{
    "body": "Ping.  I'm changing the milestone to wontfix; if there's disagreement feel free to continue the discussion.",
...
```json
{
    "body": "No comments for several months after David set the ticket to wontfix...",
    "created_at": "2018-05-31T07:45:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20735",
    "type": "issue_comment",
