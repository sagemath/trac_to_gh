...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[4688e64](http://git.sagemath.org/sage.git/commit/?id=4688e6411e5506ccbcdd70d690658c4d3f26a522)|`taking care of the remaining classic divisions in combinat folder`|",
    "created_at": "2016-04-19T20:33:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20471",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[fb736f3](http://git.sagemath.org/sage.git/commit/?id=fb736f3818af93f9849949f2c7eb97080c4fce27)|`trac 20471 adding from future import division in some combinat files`|",
    "created_at": "2016-04-20T09:01:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20471",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[cbeeb2c](http://git.sagemath.org/sage.git/commit/?id=cbeeb2c6514f9b3dcf2d27f04e2e675e93e931fd)|`trac #20471 small details as suggested by reviewer`|",
