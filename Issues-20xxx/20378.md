...
```
Using the `_fix_`positions method we extend the catalog with the standard (Oxley's) postioning schemes for the following for matroids:
R6
P6
P7
Q6
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20378#issuecomment-372915",
    "user": "https://trac.sagemath.org/admin/accounts/users/RikSchepens"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20378#issuecomment-372916",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20378#issuecomment-372917",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
