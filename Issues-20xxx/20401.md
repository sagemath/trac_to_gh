...
```json
{
    "body": "<a id='comment:1'></a>At Days93.51, we have been porting all hard-coded data files from chevie to python (untested and probably containing tons of errors still), these can be found at\n\n    https://github.com/jmichel7/gap3-jm/tree/master/sage/cheviedata\n\nand will be updated when we find issues.",
    "created_at": "2018-05-30T15:55:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20401#issuecomment-277695",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```

<a id='comment:1'></a>At Days93.51, we have been porting all hard-coded data files from chevie to python (untested and probably containing tons of errors still), these can be found at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20401#issuecomment-277696",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```
