...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378327",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>As I just discovered, I already made an attempt at this about a year ago as a follow-up to #252.  I finished it and made it into the attached branch.  Now testing...",
    "created_at": "2016-06-01T14:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378328",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:1'></a>As I just discovered, I already made an attempt at this about a year ago as a follow-up to #252.  I finished it and made it into the attached branch.  Now testing...
...
```json
{
    "body": "Changing branch from \"\" to \"u/pbruin/20749-pari_nfeltup\"",
    "created_at": "2016-06-01T14:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378329",
    "user": "https://github.com/pjbruin"
}
```

Changing branch from "" to "u/pbruin/20749-pari_nfeltup"
...
```json
{
    "body": "Changing commit from \"\" to \"9f1d90be8d3f05b6d5de8ee75e36e6d17ad52095\"",
    "created_at": "2016-06-01T14:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378330",
    "user": "https://github.com/pjbruin"
}
```

Changing commit from "" to "9f1d90be8d3f05b6d5de8ee75e36e6d17ad52095"
...
```json
{
    "body": "<a id='comment:2'></a>Since I'm very interested in this and its implications for computing newforms  (#20693), I can review it once you'e happy with the patch. Thanks a lot for digging into this!",
    "created_at": "2016-06-01T15:03:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378331",
    "user": "https://trac.sagemath.org/admin/accounts/users/ehlen"
}
```

<a id='comment:2'></a>Since I'm very interested in this and its implications for computing newforms  (#20693), I can review it once you'e happy with the patch. Thanks a lot for digging into this!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378332",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>All doctests passed.",
    "created_at": "2016-06-01T20:18:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378333",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:3'></a>All doctests passed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378334",
    "user": "https://trac.sagemath.org/admin/accounts/users/ehlen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378338",
    "user": "https://trac.sagemath.org/admin/accounts/users/ehlen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378341",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378342",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>The only remaining problem (after applying #20759 [non-essential], this branch and the above PARI patch) seems to be that the following is still too slow:\n\n```\nsage: K.<zeta22> = CyclotomicField(22)\nsage: x = polygen(K)\nsage: f = x^9 + (zeta22^9 - zeta22^6 + zeta22^4 + 1)*x^8 + (2*zeta22^8 + 4*zeta22^7 - 6*zeta22^5 - 205*zeta22^4 - 6*zeta22^3 + 4*zeta22 + 2)*x^7 + (181*zeta22^9 - 354*zeta22^8 + 145*zeta22^7 - 253*zeta22^6 + 145*zeta22^5 - 354*zeta22^4 + 181*zeta22^3 + 189*zeta22 - 189)*x^6 + (902*zeta22^9 + 13116*zeta22^8 + 902*zeta22^7 - 500*zeta22^5 - 322*zeta22^4 - 176*zeta22^3 + 176*zeta22^2 + 322*zeta22 + 500)*x^5 + (13196*zeta22^9 + 548*zeta22^8 + 9176*zeta22^7 - 17964*zeta22^6 + 8512*zeta22^5 - 8512*zeta22^4 + 17964*zeta22^3 - 9176*zeta22^2 - 548*zeta22 - 13196)*x^4 + (17104*zeta22^9 + 23456*zeta22^8 + 8496*zeta22^7 - 8496*zeta22^6 - 23456*zeta22^5 - 17104*zeta22^4 + 39680*zeta22^2 + 283184*zeta22 + 39680)*x^3 + (118736*zeta22^9 - 118736*zeta22^8 - 93520*zeta22^6 + 225600*zeta22^5 + 66496*zeta22^4 + 373744*zeta22^3 + 66496*zeta22^2 + 225600*zeta22 - 93520)*x^2 + (342176*zeta22^9 + 388928*zeta22^8 + 4800*zeta22^7 - 234464*zeta22^6 - 1601152*zeta22^5 - 234464*zeta22^4 + 4800*zeta22^3 + 388928*zeta22^2 + 342176*zeta22)*x + 431552*zeta22^9 - 1830400*zeta22^8 - 1196800*zeta22^7 - 1830400*zeta22^6 + 431552*zeta22^5 + 1196096*zeta22^3 - 12672*zeta22^2 + 12672*zeta22 - 1196096\nsage: L.<a> = K.extension(f)\nsage: %prun a*zeta22\n```\nApparently several push-outs of number fields are constructed, which are apparently different from `L` (most of the time is spent in two calls to the PARI function `nf_rnfeq`).  This is probably a separate issue from this ticket.",
    "created_at": "2016-06-08T15:38:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378343",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:13'></a>The only remaining problem (after applying #20759 [non-essential], this branch and the above PARI patch) seems to be that the following is still too slow:
...
```json
{
    "body": "<a id='comment:14'></a>The problem in[comment:13](#comment%3A13) should be solved by #20791.",
    "created_at": "2016-06-09T07:04:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378344",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:14'></a>The problem in[comment:13](#comment%3A13) should be solved by #20791.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378345",
...
```json
{
    "body": "Changing commit from \"9f1d90be8d3f05b6d5de8ee75e36e6d17ad52095\" to \"2cb5c94937b32696f607d6cc901b34dabd1e33a8\"",
    "created_at": "2016-06-09T07:39:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378346",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "9f1d90be8d3f05b6d5de8ee75e36e6d17ad52095" to "2cb5c94937b32696f607d6cc901b34dabd1e33a8"
...
```json
{
    "body": "<a id='comment:17'></a>I think this should be merged now. I tested the latest version with the patch and it works like a charm.\nThe crash observed in[comment:9](#comment%3A9) is the same as in #20693, so we don't need a new ticket for now.",
    "created_at": "2016-06-10T18:38:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378348",
    "user": "https://trac.sagemath.org/admin/accounts/users/ehlen"
}
```

<a id='comment:17'></a>I think this should be merged now. I tested the latest version with the patch and it works like a charm.
The crash observed in[comment:9](#comment%3A9) is the same as in #20693, so we don't need a new ticket for now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378349",
    "user": "https://trac.sagemath.org/admin/accounts/users/ehlen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378350",
...
```json
{
    "body": "Changing branch from \"u/pbruin/20749-pari_nfeltup\" to \"2cb5c94937b32696f607d6cc901b34dabd1e33a8\"",
    "created_at": "2016-06-11T22:28:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20749#issuecomment-378351",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/pbruin/20749-pari_nfeltup" to "2cb5c94937b32696f607d6cc901b34dabd1e33a8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20749",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20749#event-55747"
}
```
