...
```json
{
    "body": "<a id='comment:1'></a>It would be nice but it may not be what we want. The only way to feed your user configuration whatever it is is to set those variables to `None`. I did this in #20157 and the goal is to have the user choice respected whatever they are. You can read the description in #20157, without disabling everything, I could get whatever is found first in the list rather than what I want. Note that at least one new implementation has been added to the list in 1.11 if I am not mistaken (`bliss`).\n\nAs far as I am concerned `numpy` should take user's wishes first and work out what it is if it can.",
    "created_at": "2016-04-27T20:20:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297213",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>It would be nice but it may not be what we want. The only way to feed your user configuration whatever it is is to set those variables to `None`. I did this in #20157 and the goal is to have the user choice respected whatever they are. You can read the description in #20157, without disabling everything, I could get whatever is found first in the list rather than what I want. Note that at least one new implementation has been added to the list in 1.11 if I am not mistaken (`bliss`).
...
```json
{
    "body": "<a id='comment:3'></a>The means used by `numpy`sucks. Why do you even need to know which blas/lapack you are using? For `ATLAS` it means that `numpy` may use `ATLAS` c interface to lapack - well if you want to do that may be you should look for lapacke instead, something with a standard interface.\n\nThe point being, if you are after blas/lapack functions, they are standard and you shouldn't worry about the implementation underneath. `numpy`'s mechanism is a cute way (at best) to try various known libraries in a given order of preference. My preference would be for `numpy` to start looking for something I feed it before/rather than trying autodetection.",
    "created_at": "2016-05-02T10:06:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297215",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>The means used by `numpy`sucks. Why do you even need to know which blas/lapack you are using? For `ATLAS` it means that `numpy` may use `ATLAS` c interface to lapack - well if you want to do that may be you should look for lapacke instead, something with a standard interface.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297219",
...
```json
{
    "body": "<a id='comment:8'></a>I don't know if that was the whole point of #17075, but the result of that ticket does not achieve what I'm talking about.",
    "created_at": "2016-05-02T12:45:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297220",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>I don't know if that was the whole point of #17075, but the result of that ticket does not achieve what I'm talking about.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297221",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Next step may be to add options in `configure` for users to provide details of the blas/lapack setup instead of using the old environment variable for system ATLAS. But that's orthogonal to this ticket.",
    "created_at": "2016-05-02T23:10:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297222",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:10'></a>Next step may be to add options in `configure` for users to provide details of the blas/lapack setup instead of using the old environment variable for system ATLAS. But that's orthogonal to this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297225",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I don't think it's overkill at all, and as I described above is fairly straightforward to do.  For example if you wanted to do performance comparisons between BLAS libraries having parallel installations would make it easy--otherwise one would have to have fully separate parallel Sage installs.",
    "created_at": "2016-05-03T12:37:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297226",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297227",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I created a ticket #20542 to allow using openblas instead of ATLAS in Sage (but not a side-by-side installation of both).",
    "created_at": "2016-05-03T12:48:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297228",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>I created a ticket #20542 to allow using openblas instead of ATLAS in Sage (but not a side-by-side installation of both).
...
```json
{
    "body": "<a id='comment:17'></a>If I spent some 24 hours waiting for ATLAS to build, and then I install OpenBLAS, it will clobber my ATLAS installation.  That alone is a good reason to allow side-by-side installation.\n\nI'm not saying that other packages might not need to be rebuilt if you switch (some maybe, others no), but switching shouldn't be a matter of effectively uninstalling one library or the other.",
    "created_at": "2016-05-03T13:33:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297229",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>If I spent some 24 hours waiting for ATLAS to build, and then I install OpenBLAS, it will clobber my ATLAS installation.  That alone is a good reason to allow side-by-side installation.
...
```json
{
    "body": "<a id='comment:18'></a>I see your point but I still think it's a large effort for a small gain...",
    "created_at": "2016-05-03T13:38:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297230",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>I see your point but I still think it's a large effort for a small gain...
...
```json
{
    "body": "<a id='comment:19'></a>I don't know. I think #20542 did a large portion of the work (thanks!).  Maybe there's something I'm not seeing that you think makes this difficult.",
    "created_at": "2016-05-03T13:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297231",
    "user": "https://github.com/embray"
}
```

<a id='comment:19'></a>I don't know. I think #20542 did a large portion of the work (thanks!).  Maybe there's something I'm not seeing that you think makes this difficult.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297232",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20507#event-55401"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297233",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297234",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297235",
...
```json
{
    "body": "<a id='comment:22'></a>SPKG management problems should generally be solved with a system package, not by adding more complexity to sage's duct-tape package manager. In any case, Atlas is being removed soon in #30350.",
    "created_at": "2021-10-04T23:25:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297236",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:22'></a>SPKG management problems should generally be solved with a system package, not by adding more complexity to sage's duct-tape package manager. In any case, Atlas is being removed soon in #30350.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20507#event-55402"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20507#issuecomment-297237",
    "user": "https://github.com/mkoeppe"
}
```
