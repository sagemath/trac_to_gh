...
```json
{
    "body": "<a id='comment:1'></a>\nAh goodie! This brings back fond memories from the ticket from hell #10963. Specifically: [ticket:10963#comment:242 [comment:242](#comment%3A242)]. Note that there the (ignored) errors in the Eraser classes were a symptom of an overloaded call stack caused by other (basically) infinite recursions.\n\nI'm curious to see what's causing this. If it's actually a too-deep recursion in a deletion somewhere, I would be very surprised.",
    "created_at": "2016-05-18T22:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302319",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302320",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302321",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20624#event-188371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302322",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302323",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302324",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302325",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302326",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20624#event-188372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20624#event-188373"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20624#event-188374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20624#event-188375"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-302327",
    "user": "https://github.com/vbraun"
}
```
