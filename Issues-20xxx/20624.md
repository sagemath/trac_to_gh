...
```json
{
    "body": "<a id='comment:4'></a>\nJust removing the `_evalf_` implementations seems to do the trick. If someone wants to add doctests, go ahead.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[58db8ae](http://git.sagemath.org/sage.git/commit/?id=58db8ae83a2d9e2148a31c1711c1879517685fc7)|`trac 20624: remove _evalf_ that leads to infinite recursion due to changes on #14766`|",
    "created_at": "2016-05-19T16:32:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
