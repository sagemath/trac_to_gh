...
```json
{
    "body": "<a id='comment:1'></a>Ah goodie! This brings back fond memories from the ticket from hell #10963. Specifically: [comment:242](http://trac.sagemath.org/ticket/10963#comment:242). Note that there the (ignored) errors in the Eraser classes were a symptom of an overloaded call stack caused by other (basically) infinite recursions.\n\nI'm curious to see what's causing this. If it's actually a too-deep recursion in a deletion somewhere, I would be very surprised.",
    "created_at": "2016-05-18T22:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375075",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:1'></a>Ah goodie! This brings back fond memories from the ticket from hell #10963. Specifically: [comment:242](http://trac.sagemath.org/ticket/10963#comment:242). Note that there the (ignored) errors in the Eraser classes were a symptom of an overloaded call stack caused by other (basically) infinite recursions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375077",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375078",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375079",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Just removing the `_evalf_` implementations seems to do the trick. If someone wants to add doctests, go ahead.\n\n---\nNew commits:",
    "created_at": "2016-05-19T16:32:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375080",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:4'></a>Just removing the `_evalf_` implementations seems to do the trick. If someone wants to add doctests, go ahead.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375081",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375082",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375083",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375084",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20624#event-55556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375085",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20624#issuecomment-375086",
    "user": "https://github.com/vbraun"
}
```
