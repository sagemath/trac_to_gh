...
```json
{
    "body": "<a id='comment:1'></a>I think the easiest thing we could agree on is using the SI unit abbreviations. For non SI units, maybe use the long name to avoid ambiguity.\n\nhttp://www.ewh.ieee.org/soc/ias/pub-dept/abbreviation.pdf",
    "created_at": "2016-04-13T03:58:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20411#issuecomment-277855",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcognetta"
}
```

<a id='comment:1'></a>I think the easiest thing we could agree on is using the SI unit abbreviations. For non SI units, maybe use the long name to avoid ambiguity.
