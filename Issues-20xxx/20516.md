...
```json
{
    "body": "Changing branch from \"\" to \"u/jmantysalo/generate_lattices\"",
    "created_at": "2016-04-29T10:59:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372574",
    "user": "https://github.com/jm58660"
}
```

Changing branch from "" to "u/jmantysalo/generate_lattices"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372576",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372577",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"55d1ef911cdfb3c04d35fbf1cfc2b7c90aa47e16\"",
    "created_at": "2016-04-29T11:06:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372578",
    "user": "https://github.com/jm58660"
}
```

Changing commit from "" to "55d1ef911cdfb3c04d35fbf1cfc2b7c90aa47e16"
...
```json
{
    "body": "<a id='comment:3'></a>Just pinging this up to ask \"anybody interested at least a little?\".",
    "created_at": "2016-08-20T05:14:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372579",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:3'></a>Just pinging this up to ask "anybody interested at least a little?".
...
```json
{
    "body": "<a id='comment:4'></a>From a quick look, it seems more like the generation code should be an iterator class: it also would avoid the `globals` (which would become instance variables) and could be an iterator proper (which is lighter weight for loops).\n\nSome other small comments, you should use Python3 compatible `print` statements and be more PEP8 compliant (in particular, things like this should be 2 lines `except: print i, orb, p, L, le`).",
    "created_at": "2016-08-21T16:00:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372580",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>From a quick look, it seems more like the generation code should be an iterator class: it also would avoid the `globals` (which would become instance variables) and could be an iterator proper (which is lighter weight for loops).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372581",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>With all of the extra functions and cross usage of variables, it's a (IMO big) \"technical debt\" and could be a maintenance headache down the road. If you don't want to do the extra work, at least have a separate class to do the iteration and then return a list over that iterator.",
    "created_at": "2016-08-22T00:53:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372582",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:6'></a>With all of the extra functions and cross usage of variables, it's a (IMO big) "technical debt" and could be a maintenance headache down the road. If you don't want to do the extra work, at least have a separate class to do the iteration and then return a list over that iterator.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20516#issuecomment-372583",
    "user": "https://github.com/jm58660"
}
```
