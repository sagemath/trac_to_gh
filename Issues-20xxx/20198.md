...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[52b22ba](http://git.sagemath.org/sage.git/commit/?id=52b22ba532e6edfc2f46626c45bfbd4e0c356c62)|`20198: 'LinearCode(C)' for some code 'C' should construct a code`|\n|[5c49bc4](http://git.sagemath.org/sage.git/commit/?id=5c49bc43c9b3a19488ac9479ed42bc033df2ba61)|`Fixed bug (generator.basis()->generator.row_space().basis()) for original usecase; passed all doctests.`|\n|[84c1e39](http://git.sagemath.org/sage.git/commit/?id=84c1e39a4450f95d2c96ad9d6dbcf6bf80cec089)|`Fixed doc typo`|",
    "created_at": "2016-03-29T21:50:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20198",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[b1e49ea](http://git.sagemath.org/sage.git/commit/?id=b1e49eacc83ca0ac69d042460ee6b65a028dd240)|`Logic simplified as per jsrn's suggestions.`|",
    "created_at": "2016-03-30T14:23:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20198",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\n> \n> I implemented your suggestions, let me know what you think.\n\n\nYou still needlessly recomputed `basis` so I removed that, and also removed some other minor recomputations (which are probably cached anyway, but still). Other than that your code looks good and I accept it. I've run tests on `src/sage/coding` and it's currently testing the rest of the Sage lib, but I'm not expecting any problems. If you can accept my changes, just set to positive_review :-)\n\nBest,\nJohan\n\n---\nNew commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[140a743](http://git.sagemath.org/sage.git/commit/?id=140a743cdd9baaf9401534be8a2a5388ea11f518)|`minor doc improvements`|\n|[48ea66f](http://git.sagemath.org/sage.git/commit/?id=48ea66f7cf66203b8b895916b624e9e1ba918e14)|`Merge branch 'u/cprior/_linearcode_c___for_some_code__c__should_construct_a_code' of git://trac.sagemath.org/sage into 20198_linear_code_from_code`|\n|[6162d95](http://git.sagemath.org/sage.git/commit/?id=6162d956dff16a29fa9a57fe28329473a8e1c706)|`Avoid some recomputations. Clarify a comment`|",
    "created_at": "2016-03-30T18:58:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20198",
    "type": "issue_comment",
