...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[170b3fc](http://git.sagemath.org/sage.git/commit/?id=170b3fc8ff8e9f7333a06e0c84f552857e911732)|`Removed the use of a flag variable and used iterator to initialize the loop over the code. Edited the documentation to match that of the decode_to_code method of the Syndrom Decoding algorithm.`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[9fcf54d](http://git.sagemath.org/sage.git/commit/?id=9fcf54ddeae6ce3bf0815390caf4e2c24fcdd0aa)|`updated the initialization using iter`|",
    "created_at": "2016-04-18T15:05:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20201",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[febfd7f](http://git.sagemath.org/sage.git/commit/?id=febfd7f6b8ed021f2be228645b304ed8926509e9)|`Use the zero of the code to initialize`|",
