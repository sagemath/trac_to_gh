...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20622#event-262747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20622#event-262748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20622#event-262749"
}
```
...
```json
{
    "body": "Changed keywords from **** to **species, LazyPowerSeries**",
...
Changed keywords from **** to **species, LazyPowerSeries**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20622#event-262750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20622",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20622#issuecomment-300799",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20622#event-262751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20622",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20622#issuecomment-300800",
