...
```json
{
    "body": "<a id='comment:11'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[db17474](http://git.sagemath.org/sage.git/commit/?id=db17474cf8af39dbd6baa0454f181afc1f0bfe74)|`Adding python script that creates a .DS_Store for the app.dmg distribution for Mac so that the icons are placed on top of a supplied background image when opening the dmg in finder.`|",
    "created_at": "2016-02-28T18:11:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20119",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[c48edac](http://git.sagemath.org/sage.git/commit/?id=c48edac5d6c4f607ce55e3d9708b383146e6e1e8)|`Adding background image that will be used for app.dmg distribution.`|\n|[c066daf](http://git.sagemath.org/sage.git/commit/?id=c066daf83133551c9243a52f92d84857bbdc8bbc)|`Makefile for building the mac app`|\n|[2a18cf5](http://git.sagemath.org/sage.git/commit/?id=2a18cf5ceb11408481866af3f36d50ca757b3839)|`Improve the Mac app Makefile`|\n|[105edb2](http://git.sagemath.org/sage.git/commit/?id=105edb2258793ecc4e02684e4969e04140d8fc21)|`Prevent copying Sage.app inside the versioned app`|\n|[db0c354](http://git.sagemath.org/sage.git/commit/?id=db0c354f9f8d4cfb7e16f35d662dffa24cd05856)|`Exclude .git/ from Mac app`|\n|[4e6400c](http://git.sagemath.org/sage.git/commit/?id=4e6400c8eb0229cf4d1614161983cd5b3d9cdb89)|`Merge branch 'u/iandrus/makefile_for_osx_app' (http://trac.sagemath.org/ticket/19673) into u/mgoerner/createDSStore (http://trac.sagemath.org/ticket/20119)`|\n|[c03804b](http://git.sagemath.org/sage.git/commit/?id=c03804bc812d046161d136d717a6e6c3597d1745)|`Adding code to Makefile building .app.dmg distribution to:`|",
    "created_at": "2016-03-01T20:18:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20119",
    "type": "issue_comment",
