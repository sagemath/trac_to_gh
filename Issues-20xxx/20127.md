...
```json
{
    "body": "Changing commit from \"\" to \"4ddf10c1c65acabc21bae40d80b51735cf26be24\"",
    "created_at": "2016-02-29T06:20:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363633",
    "user": "https://github.com/behackl"
}
```

Changing commit from "" to "4ddf10c1c65acabc21bae40d80b51735cf26be24"
...
```json
{
    "body": "Changing branch from \"\" to \"u/behackl/symbolic/test_relation/noconvergence\"",
    "created_at": "2016-02-29T06:20:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363634",
    "user": "https://github.com/behackl"
}
```

Changing branch from "" to "u/behackl/symbolic/test_relation/noconvergence"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363635",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Looks fine, can you please add a doctest?",
    "created_at": "2016-03-05T07:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363636",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>Looks fine, can you please add a doctest?
...
```json
{
    "body": "<a id='comment:3'></a>In principle I could, yes. However, the simplest (reliable) doctest I can construct takes about 25 sec., and that's not really ideal. I'd really like to understand why this takes so much time.",
    "created_at": "2016-03-08T11:43:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363637",
    "user": "https://github.com/behackl"
}
```

<a id='comment:3'></a>In principle I could, yes. However, the simplest (reliable) doctest I can construct takes about 25 sec., and that's not really ideal. I'd really like to understand why this takes so much time.
...
```json
{
    "body": "<a id='comment:4'></a>Which code would that be? Have you tried callgrind? I tried to confirm the random behaviour of the above but the first 16 tries all gave False. Do you have a reliable example?",
    "created_at": "2016-03-08T14:29:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363638",
    "user": "https://github.com/rwst"
}
```

<a id='comment:4'></a>Which code would that be? Have you tried callgrind? I tried to confirm the random behaviour of the above but the first 16 tries all gave False. Do you have a reliable example?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363639",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I get 10 times immediately False with develop. I can even do\n\n```\nsage: %timeit assert not bool(gamma(2 + k*pi*I/log(2)) * zetaderiv(1,1+k*pi*I/log(2))/log(2)^10 == 0)\n10 loops, best of 3: 45.3 ms per loop\n```",
    "created_at": "2016-03-08T14:48:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363640",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>I get 10 times immediately False with develop. I can even do
...
```json
{
    "body": "<a id='comment:7'></a>I think the difference to your result is that I had a command `k = var('k', domain='complex')` instead of `k = var('k')`. With the latter I can confirm the issue. I thought I needed complex because I used `k` as integer before that. Now isn't the default complex anyway? It gets more mysterious.",
    "created_at": "2016-03-08T15:07:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363641",
    "user": "https://github.com/rwst"
}
```

<a id='comment:7'></a>I think the difference to your result is that I had a command `k = var('k', domain='complex')` instead of `k = var('k')`. With the latter I can confirm the issue. I thought I needed complex because I used `k` as integer before that. Now isn't the default complex anyway? It gets more mysterious.
...
```json
{
    "body": "<a id='comment:9'></a>See #14305. Variables may by default be complex in Pynac, but they are not in Maxima, which is (still) used by `__nonzero__` (see #19040).",
    "created_at": "2016-03-08T15:28:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363643",
    "user": "https://github.com/rwst"
}
```

<a id='comment:9'></a>See #14305. Variables may by default be complex in Pynac, but they are not in Maxima, which is (still) used by `__nonzero__` (see #19040).
...
```json
{
    "body": "<a id='comment:10'></a>The exception happens when executing `test_relation()`. With `domain='complex'` `test_relation()` is not called at all because then the assumption `(k, 'complex')` has to be taken into account so Maxima is called for proof which, remarkably, is faster here and correct.\n\nHowever what happens with the original case is that in `test_relation()` random substitutions into the relation are performed to see if the resulting values differ. One substitution that causes the exception is for example `{k: -312.363505734545? + 152.010201758413?*I}` so you can get the exception with the code `(gamma(2 + k*pi*I/log(2)) * zetaderiv(1,1+k*pi*I/log(2))/log(2)^10 == 0).subs({k: CIF(-312.363505734545 + 152.010201758413*I)}).n()` reliably.",
    "created_at": "2016-03-08T16:06:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363644",
    "user": "https://github.com/rwst"
}
```

<a id='comment:10'></a>The exception happens when executing `test_relation()`. With `domain='complex'` `test_relation()` is not called at all because then the assumption `(k, 'complex')` has to be taken into account so Maxima is called for proof which, remarkably, is faster here and correct.
...
```json
{
    "body": "<a id='comment:11'></a>Coincidentally, this solves my original problem. However, I still think that the fact that this\n\n```\nsage: zetaderiv(1, CIF(-600)).n()\n```\nis both very slow and raises the `NoConvergence`-error is a problem.\n\nIs it possible to use a numerically more stable version of the derivative of the zeta function? Maybe someone knowing more about this numerical stuff could help with this.",
    "created_at": "2016-03-08T16:30:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363645",
    "user": "https://github.com/behackl"
}
```

<a id='comment:11'></a>Coincidentally, this solves my original problem. However, I still think that the fact that this
...
```json
{
    "body": "<a id='comment:12'></a>Change of title and component suggested so interested people find it better.",
    "created_at": "2016-03-09T09:06:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363646",
    "user": "https://github.com/rwst"
}
```

<a id='comment:12'></a>Change of title and component suggested so interested people find it better.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363647",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20127#issuecomment-363648",
    "user": "https://github.com/behackl"
}
```
