...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373782",
    "user": "https://github.com/unhyperbolic"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The GNU assembler (gas) is part of the GNU binutils. gcc and gas (the GNU assembler) can be built together at the same time by adding softlinks to binutil's bfd, opcodes, and gas directory to gcc's src directory and compiling gcc, see https://gcc.gnu.org/install/download.html.\n\nI gave this a try by adding a few lines to gcc/spkg-install. sage's gcc is fairly old, so I ran into some problems with binutils version 2.25 and later. But I got binutils-2.24 to work (with some mild patching necessary due to stricter compiler flags) on Linux.",
    "created_at": "2016-05-05T20:29:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373783",
    "user": "https://github.com/unhyperbolic"
}
```

<a id='comment:1'></a>The GNU assembler (gas) is part of the GNU binutils. gcc and gas (the GNU assembler) can be built together at the same time by adding softlinks to binutil's bfd, opcodes, and gas directory to gcc's src directory and compiling gcc, see https://gcc.gnu.org/install/download.html.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373784",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373785",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I'm inclined to say that this is a snappy bug, since it most likely passes options to GCC which are not supported. Do you have a complete log of the failed snappy build?",
    "created_at": "2016-05-06T16:54:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373786",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>I'm inclined to say that this is a snappy bug, since it most likely passes options to GCC which are not supported. Do you have a complete log of the failed snappy build?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373787",
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [snappy_build.log](tarball://root/attachments/some-uuid/ticket20563/snappy_build.log) by @NathanDunfield created at 2016-05-06 17:56:43\n\nNo, snappy doesn't specify any additional gcc flags for the compilation step that fails, see the log I just uploaded. \n\nIf I understand things correctly, the issue is that because gcc was built against 10.11's \"as\" command, it generates asm codes that are incompatible with the older version of \"as\" that ships with, for example, 10.9.",
    "created_at": "2016-05-06T17:56:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373788",
    "user": "https://github.com/NathanDunfield"
}
```

<a id='comment:3'></a>Attachment [snappy_build.log](tarball://root/attachments/some-uuid/ticket20563/snappy_build.log) by @NathanDunfield created at 2016-05-06 17:56:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373790",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373791",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mgoerner/binutils2.24\"",
    "created_at": "2016-05-07T21:11:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373794",
    "user": "https://github.com/unhyperbolic"
}
```

Changing branch from "" to "u/mgoerner/binutils2.24"
...
```json
{
    "body": "Changing commit from \"\" to \"afbe56b320454d496e82bf62d1a8efda15aededc\"",
    "created_at": "2016-05-08T06:33:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373796",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "afbe56b320454d496e82bf62d1a8efda15aededc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373797",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Not requiring xcode would be nice, though we might also depend on system headers (don't know).\n\nWould it be sufficient to make binutils optional, and you just install it by hand if your system assembler is borked?",
    "created_at": "2016-05-12T07:29:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373798",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>Not requiring xcode would be nice, though we might also depend on system headers (don't know).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373799",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373800",
    "user": "https://github.com/unhyperbolic"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373803",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373804",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20563#event-55469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373805",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>> This issue was first noticed with `SnapPy`, but, yes, it is really a general problem with old Apple assemblers: for example, it also occurs when compiling pandas or the chomp optional package.  The manifestation in #20779 is the more serious form, since you can't currently even build that version of NTL from source on 10.9.  This current ticket could also be dealt with by offering binary releases of Sage built on 10.8 or 10.9 machines.  (Such binaries are now posted for Sage 7.2 thanks to mgoerner, but I believe the only build-bot is running 10.11.) \n\nAnd just for reference, I posted my last 10.7 binary for Sage 7.2 - that machine was taken back by my employer.  But I think there will still be limited, but nonzero, demand for binaries for 10.8 and 10.9.  See e.g. [the analogous situation when 10.10 was released](https://www.intego.com/mac-security-blog/os-x-market-share-statistics-1-in-5-macs-still-unsupported/).",
    "created_at": "2016-06-25T11:47:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373806",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:19'></a>> This issue was first noticed with `SnapPy`, but, yes, it is really a general problem with old Apple assemblers: for example, it also occurs when compiling pandas or the chomp optional package.  The manifestation in #20779 is the more serious form, since you can't currently even build that version of NTL from source on 10.9.  This current ticket could also be dealt with by offering binary releases of Sage built on 10.8 or 10.9 machines.  (Such binaries are now posted for Sage 7.2 thanks to mgoerner, but I believe the only build-bot is running 10.11.) 
...
```json
{
    "body": "<a id='comment:21'></a>Provided one updates XCode to the latest version *available for the specific MacOS*, with how many Xcode versions for MacOS X (10.6?) 10.{7,8,9}, 10.10, 10.11 do we have to deal?\n\nWhile AFAIK Apple's old GAS assembler had not been changed/updated for years but simply been dropped at some point (XCode for 10.10+?), LLVM and clang are of course still under development, such that the versions Apple ships are a more or less moving target (presumably with a \"final\" version for each or a couple of older MacOS X releases).",
    "created_at": "2016-06-25T13:57:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373808",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>Provided one updates XCode to the latest version *available for the specific MacOS*, with how many Xcode versions for MacOS X (10.6?) 10.{7,8,9}, 10.10, 10.11 do we have to deal?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373809",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>On a possibly related note, see the discussion at https://groups.google.com/forum/#!topic/sage-devel/JsZ9Ig10Znc",
    "created_at": "2018-10-02T15:31:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373811",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:24'></a>On a possibly related note, see the discussion at https://groups.google.com/forum/#!topic/sage-devel/JsZ9Ig10Znc
...
```json
{
    "body": "<a id='comment:25'></a>And possibly https://bitbucket.org/t3m/snappy/issues/13/trouble-with-installing-snappy-in-sagemath",
    "created_at": "2018-10-02T15:40:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373812",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:25'></a>And possibly https://bitbucket.org/t3m/snappy/issues/13/trouble-with-installing-snappy-in-sagemath
...
```json
{
    "body": "<a id='comment:26'></a>Is this still an issue after #12426 was closed as fixed on 2018-02-01,\nand merged in Sage 8.2.beta5?\n\nAre the Sage macOS binaries built with gcc or with clang nowadays?\n\nDo they ship gcc or rely at runtime on the user's system clang?",
    "created_at": "2019-01-14T17:32:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373813",
    "user": "https://github.com/slel"
}
```

<a id='comment:26'></a>Is this still an issue after #12426 was closed as fixed on 2018-02-01,
and merged in Sage 8.2.beta5?
...
```json
{
    "body": "<a id='comment:27'></a>Do the discussions pointed to by kcrisman in[comment:24](#comment%3A24) and[comment:25](#comment%3A25)\nmean the issue discussed here is resolved and this ticket can be closed?",
    "created_at": "2019-01-14T17:35:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373814",
    "user": "https://github.com/slel"
}
```

<a id='comment:27'></a>Do the discussions pointed to by kcrisman in[comment:24](#comment%3A24) and[comment:25](#comment%3A25)
mean the issue discussed here is resolved and this ticket can be closed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20563#event-55470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20563#issuecomment-373816",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20563#event-55471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20563#event-55472"
}
```
