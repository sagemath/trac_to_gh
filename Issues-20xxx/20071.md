...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20071#event-265602"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20071#event-265603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20071#event-265604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20071#event-265605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20071#issuecomment-290264",
    "user": "https://github.com/dkrenn"
}
```
