...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273937"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20728#issuecomment-302750",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20728#issuecomment-302751",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273943"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20728",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20728#event-273945"
}
```
