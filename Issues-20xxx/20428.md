...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20428#event-270177"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20428#event-270178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20428#event-270179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20428#event-270180"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20428#issuecomment-297547",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20428#issuecomment-297548",
    "user": "https://github.com/rwst"
}
```
