...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|\n|[1a434e8](http://git.sagemath.org/sage.git/commit/?id=1a434e8a269cc7eb901817ae0dbd74dd9b804cab)|`Add from __future__ import print_function, absolute_import to all (non-empty) modules for forward compatibility.`|",
    "created_at": "2016-05-31T12:57:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20730",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[3f0541d](http://git.sagemath.org/sage.git/commit/?id=3f0541dae4474d9afcc88103a51f1b3350071969)|`Change the name attributes of the interpreter implementations to class`|\n|[0becca2](http://git.sagemath.org/sage.git/commit/?id=0becca20bfab3373f41dc5c3d528dc267a40ef26)|`Update Makefile to more explicitly make targets for the files generated for the interpreters, as well as rebuild those targets when any of the autogen/interpreters sources change.`|\n|[a7c88ed](http://git.sagemath.org/sage.git/commit/?id=a7c88ed2a04f32754cf727ee2eccd61d067ed34d)|`Make Makefile simpler to understand / more robust by calling a function in sage_setup.autogen.interpreters that explicitly prints the names of all interpreters.`|\n|[6dbab61](http://git.sagemath.org/sage.git/commit/?id=6dbab6144024130f3edd0c29b421f9bf21347d9d)|`Also avoid reexpansion of the $(INTERP_SRCS) variable.`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|\n|[301fbe8](http://git.sagemath.org/sage.git/commit/?id=301fbe89797b718fe3ea31d9a528e5fb0fe3bcd0)|`Deduplicate code in anticipation of adding more generated file(s) for interpreters.`|\n|[65a0519](http://git.sagemath.org/sage.git/commit/?id=65a05199a4422491e97934569f950cf8ae10ff39)|`Simplify Makefile further by replacing print_names() with a list_sources() that just prints the names of all generated source files.`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|\n|[d5225c3](https://git.sagemath.org/sage.git/commit/?id=d5225c350c9b7e01708f68dddff955857a9aea5d)|`Simplify Makefile further by replacing print_names() with a list_sources() that just prints the names of all generated source files.`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|\n|[750a67d](https://git.sagemath.org/sage.git/commit/?id=750a67dc0b20086165d87cbc83a92583f9ae9862)|`Add all of sage_setup to in_lib so that the doctest runner will not try to load the modules individually.`|\n|[7621549](https://git.sagemath.org/sage.git/commit/?id=7621549c99e8d44ab95cd89511ecc14728908cb1)|`Add from __future__ import print_function, absolute_import to all (non-empty) modules for forward compatibility.`|\n|[4570ef2](https://git.sagemath.org/sage.git/commit/?id=4570ef2b71f709571cf934340b5eb1186bdc3cfc)|`Change the name attributes of the interpreter implementations to class`|\n|[e73f68e](https://git.sagemath.org/sage.git/commit/?id=e73f68efc9babddf9e21517558424118707dc3c0)|`Update Makefile to more explicitly make targets for the files generated for the interpreters, as well as rebuild those targets when any of the autogen/interpreters sources change.`|\n|[22a4ef5](https://git.sagemath.org/sage.git/commit/?id=22a4ef548d7a7120e304501bf2253dc54431e3a3)|`Make Makefile simpler to understand / more robust by calling a function in sage_setup.autogen.interpreters that explicitly prints the names of all interpreters.`|\n|[ffa16f4](https://git.sagemath.org/sage.git/commit/?id=ffa16f40573a825413b9675e826bf519139bcfe9)|`Also avoid reexpansion of the $(INTERP_SRCS) variable.`|\n|[1d4dc46](https://git.sagemath.org/sage.git/commit/?id=1d4dc46759275ce57091be664974fab8e53b02ac)|`Deduplicate code in anticipation of adding more generated file(s) for interpreters.`|\n|[baa34eb](https://git.sagemath.org/sage.git/commit/?id=baa34eb41acc5bcb3cf74f10c784f622e5910d2f)|`Simplify Makefile further by replacing print_names() with a list_sources() that just prints the names of all generated source files.`|\n|[9f9c44d](https://git.sagemath.org/sage.git/commit/?id=9f9c44d27f24871eff22f2e9aac3f6400a8f50ae)|`Fixes to testing sage_setup`|\n|[206138a](https://git.sagemath.org/sage.git/commit/?id=206138aaf56066e5cac608a792590e45b82c20f3)|`Ensure that the value of in_lib is a bool.`|",
    "created_at": "2016-08-24T09:23:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20730",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[a47bb08](https://git.sagemath.org/sage.git/commit/?id=a47bb081f3a45dde575aabd8156e391006751988)|`interpreters.py was quite long, so converted it to a package`|\n|[4df82c8](https://git.sagemath.org/sage.git/commit/?id=4df82c86615db56f471f5510c84527b80c9d65fe)|`Changed indentation on several chunks of template code that was previously broken out of the normal Python indentation flow.`|\n|[721cf50](https://git.sagemath.org/sage.git/commit/?id=721cf507b4e25f70a14b5aa6e3f496f0bf861152)|`Fixes a newline that messed up the formtting a bit.`|\n|[45ce2f1](https://git.sagemath.org/sage.git/commit/?id=45ce2f173a868403eccb5db64a27745e70550608)|`One more whitespae fix`|\n|[6620390](https://git.sagemath.org/sage.git/commit/?id=6620390654dc1dab0fcbff980b6e3c22388005c3)|`Add some __main__ modules for ease of testing.`|\n|[241dc1b](https://git.sagemath.org/sage.git/commit/?id=241dc1b24009f1f0bfffde5d29fc4b1ca331e162)|`Just import everything into the top-level __init__ to rebuild the original sage_setup.autogen.interpreters namespace.  This enures that all the tests pass.`|\n|[eb5acf9](https://git.sagemath.org/sage.git/commit/?id=eb5acf9882bdaae46fc74b39dd095c986c5fe565)|`Add from __future__ import print_function, absolute_import to all (non-empty) modules for forward compatibility.`|\n|[1f46f30](https://git.sagemath.org/sage.git/commit/?id=1f46f30e57afb3c9532e3a4e6ed9c9b7bfce796f)|`Change the name attributes of the interpreter implementations to class`|\n|[f039d8c](https://git.sagemath.org/sage.git/commit/?id=f039d8cd9a9c242b2c9f8adb88d1cfab6ff0bec6)|`Deduplicate code in anticipation of adding more generated file(s) for interpreters.`|\n|[b34d5d8](https://git.sagemath.org/sage.git/commit/?id=b34d5d8fc509f6773fe3c72c3d1b0e24a358efde)|`More programmatic discovery of interpreter types rather than manually listing them`|",
