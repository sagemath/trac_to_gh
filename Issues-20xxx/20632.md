...
```json
{
    "body": "<a id='comment:1'></a>It's conceivable I may need to do another `rebaseall` or something.  I haven't tried that yet.",
    "created_at": "2016-05-19T15:40:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280852",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>It's conceivable I may need to do another `rebaseall` or something.  I haven't tried that yet.
...
```json
{
    "body": "<a id='comment:3'></a>Hmm, not sure why that would be happening, but the line in question reads:\n\n```\n         on the list returned by :meth:`.edge_label`)::\n```\n\nThis syntax would seem to automatically imply the `edge_label` method of `GenericGraph` so I don't know why it would think that was ambiguous.",
    "created_at": "2016-05-19T15:56:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280854",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>Hmm, not sure why that would be happening, but the line in question reads:
...
```json
{
    "body": "<a id='comment:6'></a>I added a new ticket about the reference issue in Sphinx, since I think it's technically distinct from the issue I'm having running parallel doc builds on Windows: #20639",
    "created_at": "2016-05-20T09:15:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280857",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>I added a new ticket about the reference issue in Sphinx, since I think it's technically distinct from the issue I'm having running parallel doc builds on Windows: #20639
...
```json
{
    "body": "<a id='comment:9'></a>Okay, it's just the same segfault as #20463 so at least nothing new. Don't know why I'm getting it now though, since the patch for it is applied and I can run sage normally just fine.",
    "created_at": "2016-05-25T16:03:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280860",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Okay, it's just the same segfault as #20463 so at least nothing new. Don't know why I'm getting it now though, since the patch for it is applied and I can run sage normally just fine.
...
```json
{
    "body": "<a id='comment:11'></a>I still haven't had success with parallel docs build on Cygwin; leaving this open for now but clearing the old milestone.",
    "created_at": "2017-04-13T10:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280862",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>I still haven't had success with parallel docs build on Cygwin; leaving this open for now but clearing the old milestone.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20632#event-55573"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20632#event-55574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280863",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>This was probably related to some other bugs, but I'm not sure anymore.  However, this has not been a problem for some time--since other issues have been fixed the doc build runs fine on Cygwin, even in parallel (though there are still some issues, namely #25089).",
    "created_at": "2018-04-11T14:43:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20632#issuecomment-280864",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>This was probably related to some other bugs, but I'm not sure anymore.  However, this has not been a problem for some time--since other issues have been fixed the doc build runs fine on Cygwin, even in parallel (though there are still some issues, namely #25089).
