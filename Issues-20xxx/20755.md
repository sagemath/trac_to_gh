...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378443",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Well, `multiplicities` is a system variable. See [http://maxima.sourceforge.net/docs/manual/maxima_20.html](http://maxima.sourceforge.net/docs/manual/maxima_20.html). Who knows when it gets updated? In particular, the reconstruction of symbolic expressions from strings might be calling into maxima again.\n\nThe quick fix is to get the correct value of `multiplicities` out as soon as we can, before conversion back.\n\nIn the longer run, it would be preferable to do the conversion while avoiding strings altogether. See `sr_sum` and `sr_limit` etc. for examples how one can use `sr_to_max` and `max_to_sr` to convert.",
    "created_at": "2016-06-01T18:00:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378444",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:2'></a>Well, `multiplicities` is a system variable. See [http://maxima.sourceforge.net/docs/manual/maxima_20.html](http://maxima.sourceforge.net/docs/manual/maxima_20.html). Who knows when it gets updated? In particular, the reconstruction of symbolic expressions from strings might be calling into maxima again.
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20755#event-55754"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>seems to work in 8.9.b1\n\none needs to check and add a doctest",
    "created_at": "2019-07-09T19:20:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378445",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>seems to work in 8.9.b1
...
```json
{
    "body": "Changing commit from \"\" to \"eb0ad68ae007807828945e13e58e9865c67adf77\"",
    "created_at": "2019-08-21T12:43:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378446",
    "user": "https://github.com/bgrenet"
}
```

Changing commit from "" to "eb0ad68ae007807828945e13e58e9865c67adf77"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378447",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>The bug seems indeed fixed. I've add a doctest.\n\n---\nNew commits:",
    "created_at": "2019-08-21T12:43:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378448",
    "user": "https://github.com/bgrenet"
}
```

<a id='comment:4'></a>The bug seems indeed fixed. I've add a doctest.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378449",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/bruno/20755_bug_in_solve\"",
    "created_at": "2019-08-21T12:43:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378450",
    "user": "https://github.com/bgrenet"
}
```

Changing branch from "" to "u/bruno/20755_bug_in_solve"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378451",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378452",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378453",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20755#event-55755"
}
```
...
```json
{
    "body": "Changing branch from \"u/bruno/20755_bug_in_solve\" to \"eb0ad68ae007807828945e13e58e9865c67adf77\"",
    "created_at": "2019-08-29T20:02:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20755#issuecomment-378454",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/bruno/20755_bug_in_solve" to "eb0ad68ae007807828945e13e58e9865c67adf77"
