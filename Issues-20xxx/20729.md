...
```json
{
    "body": "<a id='comment:1'></a>Python's `doctest` module seems to suffer from the same issue. From https://docs.python.org/2/library/doctest.html#simple-usage-checking-examples-in-docstrings:\n\n> {{{\n> python -m doctest -v example.py\n> }}}\n> This will import example.py as a standalone module and run testmod() on it. Note that this may not work correctly if the file is part of a package and imports other submodules from that package.",
    "created_at": "2016-09-26T14:59:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377514",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Python's `doctest` module seems to suffer from the same issue. From https://docs.python.org/2/library/doctest.html#simple-usage-checking-examples-in-docstrings:
...
```json
{
    "body": "<a id='comment:2'></a>Maybe we should just never load the module, i.e. behave as if `in_lib` is always `True`?",
    "created_at": "2016-09-26T15:00:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377515",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Maybe we should just never load the module, i.e. behave as if `in_lib` is always `True`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377516",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>What do you think of [comment:3]? Load a file if and only if it is *not* part of a package (i.e. has no `__init__.*` file)\n\nThat would be very simple to implement and would probably do the right thing in most use cases.",
    "created_at": "2017-01-24T08:24:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377518",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>What do you think of [comment:3]? Load a file if and only if it is *not* part of a package (i.e. has no `__init__.*` file)
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/doctest_runner_breaks_loading_modules_from_packages_that_use_relative_imports\"",
    "created_at": "2017-01-24T09:16:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377519",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/doctest_runner_breaks_loading_modules_from_packages_that_use_relative_imports"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377520",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I just implemented that.\n\n---\nNew commits:",
    "created_at": "2017-01-24T09:17:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377521",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>I just implemented that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377522",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20729#event-55716"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"13d4a62814d5048884553385412b4285f3fa5fbd\"",
    "created_at": "2017-01-24T09:17:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377523",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "13d4a62814d5048884553385412b4285f3fa5fbd"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377524",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I'm honestly not sure how this will work on Python 3, where `__init__.py` is not required for packages.  But I think in Python 3 relative imports are also changed so that loading a module directly (even if it's in a package) will still work properly.   Without a specific example in mind, I suppose it's not worth worrying about right now.\n\nThis makes sense to me otherwise.",
    "created_at": "2017-01-25T14:12:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377525",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>I'm honestly not sure how this will work on Python 3, where `__init__.py` is not required for packages.  But I think in Python 3 relative imports are also changed so that loading a module directly (even if it's in a package) will still work properly.   Without a specific example in mind, I suppose it's not worth worrying about right now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377526",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377527",
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/doctest_runner_breaks_loading_modules_from_packages_that_use_relative_imports\" to \"13d4a62814d5048884553385412b4285f3fa5fbd\"",
    "created_at": "2017-01-28T17:03:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20729#issuecomment-377528",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/doctest_runner_breaks_loading_modules_from_packages_that_use_relative_imports" to "13d4a62814d5048884553385412b4285f3fa5fbd"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20729",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20729#event-55717"
}
```
