...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20581#event-272039"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20581#event-272040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20581#event-272041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20581#event-272042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20581#issuecomment-300156",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20581#issuecomment-300157",
    "user": "https://github.com/vbraun"
}
```
