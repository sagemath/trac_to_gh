...
```json
{
    "body": "<a id='comment:5'></a>\nWith 7.3 imminent we probably should fix this and no user will notice the regression...\n\n---\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[faefbec](https://git.sagemath.org/sage.git/commit?id=faefbec33a04183b7dd2bfd131c7303c8ec356c0)|`Add a warnings filter that passes Sage deprecation warnings`|",
