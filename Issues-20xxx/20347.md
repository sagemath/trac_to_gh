...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[492c20d](http://git.sagemath.org/sage.git/commit/?id=492c20d8ede348075e6f15df469b70bcce0929b6)|`Trac 20347: fixed word_problem bug in farey_symbol.`|",
    "created_at": "2016-04-06T13:40:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20347",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[d4e97c9](http://git.sagemath.org/sage.git/commit/?id=d4e97c957bb818d1f7e65c91c52aa0484fa606d7)|`Trac #20347: improved logic for _get_minus_one based on #20373, added tests.`|",
    "created_at": "2016-04-06T22:15:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20347",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[f7620df](http://git.sagemath.org/sage.git/commit/?id=f7620dffbd92e05ecbdc42bcddcc62c072d81ef2)|`Trac #20347: removed a utility function.`|",
