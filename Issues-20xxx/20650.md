...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20650#issuecomment-301189",
    "user": "https://github.com/sagetrac-rlmiller"
}
```
...
```json
{
    "body": "Changed assignee from **Rebecca Lauren Miller** to **@sagetrac-rlmiller**",
    "created_at": "2016-05-21T21:40:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/20650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20650#issuecomment-301190",
    "user": "https://github.com/sagetrac-rlmiller"
}
```

Changed assignee from **Rebecca Lauren Miller** to **@sagetrac-rlmiller**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20650#event-272895"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20650#event-272896"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20650#event-272897"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20650",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20650#event-272898"
}
```
