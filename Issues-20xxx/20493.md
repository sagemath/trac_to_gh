...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20493#event-270960"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20493#event-270961"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20493#event-270962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20493#event-270963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20493#issuecomment-298457",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20493#issuecomment-298458",
    "user": "https://github.com/kedlaya"
}
```
