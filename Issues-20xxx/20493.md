...
```json
{
    "body": "Just tacking on some nonlinear operation will just be a new prng; At that point its probably better to look into wholly different prngs. MT isn't really state of the art any more. E.g. see http://xorshift.di.unimi.it/",
...
```json
{
    "body": "I don't know enough about modern PRNGs to express a preference among them, but anything with a nonlinear projection would suffice to address this issue.",
