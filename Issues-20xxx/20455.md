...
```json
{
    "body": "<a id='comment:1'></a>For implementation reasons the rewrite happened in #21034 but the behaviour was not changed so this ticket still has to be addressed.",
    "created_at": "2016-07-27T07:03:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20455#issuecomment-296481",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>For implementation reasons the rewrite happened in #21034 but the behaviour was not changed so this ticket still has to be addressed.
...
```json
{
    "body": "<a id='comment:3'></a>This is fixed in current Pynac master.",
    "created_at": "2016-08-26T08:10:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20455#issuecomment-296482",
    "user": "https://github.com/rwst"
}
```

<a id='comment:3'></a>This is fixed in current Pynac master.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20455#issuecomment-296483",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20455#event-55323"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Since #21369 contains doctests for this, it can be closed.",
    "created_at": "2016-09-02T06:19:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20455#issuecomment-296484",
    "user": "https://github.com/rwst"
}
```

<a id='comment:4'></a>Since #21369 contains doctests for this, it can be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20455#issuecomment-296485",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20455#event-55324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20455#issuecomment-296486",
