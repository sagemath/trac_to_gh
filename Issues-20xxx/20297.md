...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20297#event-268592"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20297#event-268593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20297#event-268594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20297#event-268595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20297#issuecomment-294962",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20297#issuecomment-294963",
    "user": "https://github.com/rwst"
}
```
