...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20266#event-268260"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20266#event-268261"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20266#event-268262"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20266#event-268263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20266#issuecomment-294550",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20266#issuecomment-294551",
    "user": "https://github.com/roed314"
}
```
