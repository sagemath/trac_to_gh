...
```json
{
    "body": "<a id='comment:40'></a>\nAt last someone can review this.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[0486c05](https://git.sagemath.org/sage.git/commit?id=0486c05e0d501e2428493c7db4314df26625f200)|`Make ligsl link to the current cblas library instead of leaving it underlinked.`|",
