...
```json
{
    "body": "<a id='comment:1'></a>So should we add `-liml` in LinBox's `spkg-install`?\n\nOr patch LinBox in that way?",
    "created_at": "2016-08-08T14:38:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375464",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>So should we add `-liml` in LinBox's `spkg-install`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375465",
...
```json
{
    "body": "<a id='comment:3'></a>Third option:\n\nAdd\n\n```\n# distutils: libraries = iml\n```\nto `src/sage/libs/linbox/linbox.pxd`.",
    "created_at": "2016-08-08T19:45:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375466",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Third option:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375467",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>On the one hand, it looks like updating linbox will NOT be easier (see ticket #17635); on the other, it looks like a lot of the work has already been done.",
    "created_at": "2016-08-08T19:51:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375468",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:5'></a>On the one hand, it looks like updating linbox will NOT be easier (see ticket #17635); on the other, it looks like a lot of the work has already been done.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375469",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>#17635 is basically ready, modulo a rebasing and fixing minor platforms (32bit). I'd like to add that `libgsl` is underlinked upstream on purpose. In their opinion it is the responsibility of people downstream or writing their applications to provide a `cblas`.\n\nIt is our choice to provide extra linking. In that context I am not sure the gentoo patch as it is the way to go.\n\nThe people in the gentoo science overlay (including me) have not drunk the whole Kool-aid of their blas infrastructure when it comes to `gsl`. The reality is `gsl` should be split in `gslcblas` and `libgsl`. Then `libgsl` could just use `pkg-config` to find `cblas`. You still need to remove `libgslcblas.la` everywhere but you avoid adding a custom macro.",
    "created_at": "2016-08-08T21:04:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375470",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:7'></a>#17635 is basically ready, modulo a rebasing and fixing minor platforms (32bit). I'd like to add that `libgsl` is underlinked upstream on purpose. In their opinion it is the responsibility of people downstream or writing their applications to provide a `cblas`.
...
```json
{
    "body": "<a id='comment:8'></a>Is it still relevant now that the new `linbox` stack has been merged.",
    "created_at": "2016-10-22T22:45:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375471",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>Is it still relevant now that the new `linbox` stack has been merged.
...
```json
{
    "body": "<a id='comment:9'></a>I'm now unable to reproduce any of the issues associated with this ticket. Things implemented:\n* export export LDFLAGS=\"-Wl,--as-needed\"\n* rebuild (sage -f) `sagelib, gsl, linbox` (`gsl` was probably not necessary)\n\n`sage: from sage.rings.complex_double import CDF`\n\ndoes not fail and rebuilding `linbox` also rebuilds `iml` and `fflas_ffpack`. I don't know if using `atlas` will be a problem.",
    "created_at": "2016-10-24T15:34:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375472",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:9'></a>I'm now unable to reproduce any of the issues associated with this ticket. Things implemented:
* export export LDFLAGS="-Wl,--as-needed"
* rebuild (sage -f) `sagelib, gsl, linbox` (`gsl` was probably not necessary)
...
```json
{
    "body": "<a id='comment:10'></a>The linbox issue should be gone, but I don't know about gsl. I guess I'll have to recompile from scratch.",
    "created_at": "2016-10-24T15:46:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375473",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:10'></a>The linbox issue should be gone, but I don't know about gsl. I guess I'll have to recompile from scratch.
...
```json
{
    "body": "<a id='comment:11'></a>Well `libgsl.so` is still underlinked as upstream intended, but anything linking to libgsl should also have been properly linked to a cblas library.",
    "created_at": "2016-10-24T20:07:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375474",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:11'></a>Well `libgsl.so` is still underlinked as upstream intended, but anything linking to libgsl should also have been properly linked to a cblas library.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375475",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Yup, it's fixed. Thanks for all your work on this stuff.",
    "created_at": "2016-10-25T12:19:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375476",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:13'></a>Yup, it's fixed. Thanks for all your work on this stuff.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375477",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20646#event-55588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375478",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20646#event-55589"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20646#event-55590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375479",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Oops, I just tried to run the sage that I built 5 days ago:\n\n```\n   from sage.misc.all       import *         # takes a while\n  File \"/home/mjo/src/sage.git/local/lib/python2.7/site-packages/sage/misc/all.py\", line 89, in <module>\n    from .functional import (additive_order,\n  File \"/home/mjo/src/sage.git/local/lib/python2.7/site-packages/sage/misc/functional.py\", line 32, in <module>\n    from sage.rings.complex_double import CDF\nImportError: /home/mjo/src/sage.git/local/lib/libgsl.so.19: undefined symbol: cblas_sdsdot\n```",
    "created_at": "2016-10-30T19:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375480",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:15'></a>Oops, I just tried to run the sage that I built 5 days ago:
...
```json
{
    "body": "<a id='comment:16'></a>That's interesting. Can you post the output of \n\n```\nreadelf -d /home/mjo/src/sage.git/local/lib/python2.7/site-packages/sage/rings/complex_double.so\n```",
    "created_at": "2016-10-30T20:12:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375481",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:16'></a>That's interesting. Can you post the output of 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375482",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>I'm also using gold instead of the default BFD linker, if that turns out to matter. On gentoo the switch amounts to\n\n```\n$ sudo binutils-config --linker ld.gold\n```",
    "created_at": "2016-10-30T23:09:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375487",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:22'></a>I'm also using gold instead of the default BFD linker, if that turns out to matter. On gentoo the switch amounts to
...
```json
{
    "body": "<a id='comment:23'></a>Rebuilt `sagelib` here using `LDFLAGS=-Wl,-O1 -Wl,--as-needed` instead of `LDFLAGS=-Wl,--as-needed`, just in case; still no issue. I am using gentoo default BFD linker.",
    "created_at": "2016-10-30T23:47:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375488",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:23'></a>Rebuilt `sagelib` here using `LDFLAGS=-Wl,-O1 -Wl,--as-needed` instead of `LDFLAGS=-Wl,--as-needed`, just in case; still no issue. I am using gentoo default BFD linker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375489",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Somehow I had another comment that escaped posting :( The gold linker has a more strict interpretation of `--as-needed` and in this case `libgsl` would need to be linked to `cblas` itself.\n\nIt could be interesting to try adding `-Wl,--no-allow-shlib-undefined` as an additional `LDFLAGS`.",
    "created_at": "2016-11-01T08:44:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375490",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:25'></a>Somehow I had another comment that escaped posting :( The gold linker has a more strict interpretation of `--as-needed` and in this case `libgsl` would need to be linked to `cblas` itself.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375491",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Hum, `$(BLAS)` is currently in `gsl`'s dependency but is not in fact used.",
    "created_at": "2016-11-01T20:49:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375493",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:28'></a>Hum, `$(BLAS)` is currently in `gsl`'s dependency but is not in fact used.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375494",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375495",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375496",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375500",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>Replying to [mjo](#comment%3A35):\n> Replying to [fbissey](#comment%3A34):\n> > \n> > I'd rather link gsl in sage, the dependency is there already.\n\n> \n> If there are no hidden pitfalls, then this is simple and unobtrusive and has my vote.\n> \n\nditto\n\nor in common parlance\n\n+1",
    "created_at": "2016-11-03T18:09:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375501",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:36'></a>Replying to [mjo](#comment%3A35):
> Replying to [fbissey](#comment%3A34):
> > 
> > I'd rather link gsl in sage, the dependency is there already.
...
```json
{
    "body": "<a id='comment:37'></a>The way I outlined is indeed simple and not intrusive. Downside, `libgslcblas.so` is probably unusable. Not sure we care that much, but there should be a warning somewhere.\n\n```\n readelf -d /home/fbissey/sandbox/git-fork/sage-7.4/local/lib/libgslcblas.so\n\nDynamic section at offset 0x3ddd0 contains 28 entries:\n  Tag        Type                         Name/Value\n 0x0000000000000001 (NEEDED)             Shared library: [libopenblas.so.0]\n 0x0000000000000001 (NEEDED)             Shared library: [libm.so.6]\n 0x0000000000000001 (NEEDED)             Shared library: [libc.so.6]\n 0x000000000000000e (SONAME)             Library soname: [libgslcblas.so.0]\n 0x000000000000001d (RUNPATH)            Library runpath: [/home/fbissey/sandbox/git-fork/sage-7.4/local/lib]\n```\nIn concrete terms I am not sure which cblas you are getting when linking with it.",
    "created_at": "2016-11-04T07:17:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375502",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:37'></a>The way I outlined is indeed simple and not intrusive. Downside, `libgslcblas.so` is probably unusable. Not sure we care that much, but there should be a warning somewhere.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375503",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Probably a bad manipulation on my part then. It will be present for people not using `--as-needed` though. I'll post a branch later. I may also revamp the description a bit.",
    "created_at": "2016-11-05T20:45:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375504",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:39'></a>Probably a bad manipulation on my part then. It will be present for people not using `--as-needed` though. I'll post a branch later. I may also revamp the description a bit.
...
```json
{
    "body": "<a id='comment:40'></a>At last someone can review this.\n\n---\nNew commits:",
    "created_at": "2016-11-09T22:39:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375505",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:40'></a>At last someone can review this.
...
```json
{
    "body": "Changing branch from \"\" to \"u/fbissey/gsl_cblas_link\"",
    "created_at": "2016-11-09T22:39:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375506",
    "user": "https://github.com/kiwifb"
}
```

Changing branch from "" to "u/fbissey/gsl_cblas_link"
...
```json
{
    "body": "Changing commit from \"\" to \"0486c05e0d501e2428493c7db4314df26625f200\"",
    "created_at": "2016-11-09T22:39:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375507",
    "user": "https://github.com/kiwifb"
}
```

Changing commit from "" to "0486c05e0d501e2428493c7db4314df26625f200"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375508",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20646#event-55591"
}
```
...
```json
{
    ...
    "milestone": "sage-7.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20646#event-55592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375509",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375510",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375511",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Looks good, and I even remembered to run it this time. Thanks!",
    "created_at": "2016-11-10T12:30:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375513",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:42'></a>Looks good, and I even remembered to run it this time. Thanks!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375514",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375515",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/20646#event-55593"
}
```
...
```json
{
    "body": "Changing branch from \"u/fbissey/gsl_cblas_link\" to \"0486c05e0d501e2428493c7db4314df26625f200\"",
    "created_at": "2016-11-11T17:53:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20646#issuecomment-375517",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/fbissey/gsl_cblas_link" to "0486c05e0d501e2428493c7db4314df26625f200"
