...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,6 +1,10 @@\n-Importing `TikzPicture` module from optional [SageMath](../wikis/SageMath) package [slabbe-0.6.2](https://pypi.org/project/slabbe/) into [SageMath](../wikis/SageMath).\n+The goal of this ticket is to import the `TikzPicture` module from the optional [SageMath](../wikis/SageMath) package [slabbe](https://pypi.org/project/slabbe/) into [SageMath](../wikis/SageMath). This module has been created in 2016 and has evolved to a stable  state now and it is mature enough to go into [SageMath](../wikis/SageMath).\n \n-One example:\n+Here is a demo inside a Jupyter notebook:\n+\n+<img src=\"https://github.com/sagemath/sage/files/ticket20343/tikz-jupyter-demo.png\" width=width=600>\n+\n+More examples:\n \n ```\n sage: from sage.plot.tikzpicture import TikzPicture\n``````\n",
