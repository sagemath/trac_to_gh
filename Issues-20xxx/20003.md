...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20003#issuecomment-289051",
    "user": "https://github.com/lennartack"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Is this a bug in Flint or does Sage wrap Flint incorrectly in `factor_helper`?",
    "created_at": "2016-02-03T14:01:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20003#issuecomment-289052",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:2'></a>Is this a bug in Flint or does Sage wrap Flint incorrectly in `factor_helper`?
...
```json
{
    "body": "<a id='comment:3'></a>It seems Flint doesn't return a monic factor in case of a linear input. I attached a patch to \"fix\" it.",
    "created_at": "2016-02-04T16:12:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20003#issuecomment-289053",
    "user": "https://github.com/lennartack"
}
```

<a id='comment:3'></a>It seems Flint doesn't return a monic factor in case of a linear input. I attached a patch to "fix" it.
