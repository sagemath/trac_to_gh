...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20003#event-282639"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20003#event-282640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20003#event-282641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20003#event-282642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20003#issuecomment-286571",
    "user": "https://github.com/lennartack"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20003#issuecomment-286572",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20003#issuecomment-286573",
    "user": "https://github.com/lennartack"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20003#issuecomment-286574",
...
```json
{
    ...
    "milestone_title": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20003#event-282643"
}
```
