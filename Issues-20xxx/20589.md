...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20589#issuecomment-374360",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20589#issuecomment-374361",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20589#issuecomment-374362",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I'm looking in to this. In any case, understanding the Jupyter help system better might also help with other kernels (https://github.com/OpenDreamKit/OpenDreamKit/issues/96).",
    "created_at": "2016-05-13T12:47:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20589#issuecomment-374363",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>I'm looking in to this. In any case, understanding the Jupyter help system better might also help with other kernels (https://github.com/OpenDreamKit/OpenDreamKit/issues/96).
...
```json
{
    "body": "<a id='comment:6'></a>Possibly related to #19740?  (I.e., would this be necessary to deal with before having it as default?)",
    "created_at": "2017-03-24T22:13:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20589#issuecomment-374364",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Possibly related to #19740?  (I.e., would this be necessary to deal with before having it as default?)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20589#issuecomment-374365",
    "user": "https://github.com/nthiery"
}
```
