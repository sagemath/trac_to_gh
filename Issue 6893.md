...
```json
{
    "body": "What pieces of this patch are the relevant ones?  Most of this does look related to switching to mpl axes.",
...
```json
{
    "body": "The options stuff looked potentially interesting, and possibly the architecture for constructing a matplotlib image.",
