...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322552",
...
```json
{
    "body": "I'm also failing the confirmation. You seem to be using a special installation of Sage because the system Python is used. What's your setup/system?",
    "created_at": "2017-07-01T06:46:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322553",
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23095#event-60068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322554",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "I'm using the archlinux sagemath package, so I reported it as an archlinux bug (https://bugs.archlinux.org/task/54620). There, I was told the following:\n\nThis is caused by ecl 16.1.3. We are applying the patch from #22191 but apparently it doesn't fix all issues",
    "created_at": "2017-07-01T10:10:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322555",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322556",
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23095#event-60069"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23095#event-60070"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322557",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322558",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "The archlinux ticket was closed long ago, so I think we can close this old ticket. The PR just adds the ticket's example as a regression doctest for `eigenvectors_left` and `eigenvectors_right`.\n\n---\nNew commits:",
    "created_at": "2021-03-12T02:23:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322559",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322561",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322562",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23095#event-60071"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23095#issuecomment-322563",
