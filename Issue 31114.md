...
```json
{
    "body": "Help about how to report the problem to Maxima's developers welcome...",
    "created_at": "2021-02-06T20:48:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31114#issuecomment-443921",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "This is now bug [#3712](https://sourceforge.net/p/maxima/bugs/3712/) on Maxima's bug report system.",
    "created_at": "2021-02-07T16:51:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31114#issuecomment-443923",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "Hi, thanks to everybody for working on this. I agree w/ Stavros that there is a minor bug in Sage here, namely that \"get a numerical result for an integral\" isn't `integrate(...), numer` in Maxima, but rather most nearly equivalent would be a call to a quadpack function (`quad_qag` and friends). \n\nThe difficulties that Maxima has with floats and rationalized floats in `integrate` is/are one or more bugs and I agree they are important and need to be fixed. Thanks for the bug reports, it does help.",
    "created_at": "2021-02-07T18:25:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31114#issuecomment-443926",
...
```json
{
    "body": "Robert Dodier just mailed/posted a fix and marked the Maxima bug as solved.\n\nPossibly in a later version of Maxima ?",
    "created_at": "2021-02-16T09:00:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31114#issuecomment-443927",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31114#issuecomment-443928",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82122"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82123"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82124"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82125"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82126"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82127"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82128"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31114#event-82129"
}
```
