...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457801",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457802",
    "user": "https://github.com/mbombar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457803",
    "user": "https://github.com/mbombar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457804",
    "user": "https://github.com/mbombar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457805",
    "user": "https://github.com/mbombar"
}
```
...
```json
{
    "body": "Since Sage development has entered the release candidate phase for 9.4, I guess the milestone for this ticket should be set to 9.5.",
    "created_at": "2021-08-03T16:30:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457806",
    "user": "https://github.com/mbombar"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457807",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457809",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Cette ligne me semble inutile:\n\n```\n+        w = copy(message)\n```",
    "created_at": "2021-08-06T10:09:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457811",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457812",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "La branche rouge signale un conflit avec la derni\u00e8re version => needs-work",
    "created_at": "2021-09-15T14:36:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32093#issuecomment-457813",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85759"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85760"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85761"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85762"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85763"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32093#event-85764"
}
```
