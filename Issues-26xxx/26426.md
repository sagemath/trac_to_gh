...
```json
{
    "body": "<a id='comment:2'></a>The linker message is nasty. But in the first place you shouldn't include anything from `bits` those are implementation dependent.",
    "created_at": "2018-10-08T22:26:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392976",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>The linker message is nasty. But in the first place you shouldn't include anything from `bits` those are implementation dependent.
...
```json
{
    "body": "<a id='comment:3'></a>Well its gcc's own bits, gcc needs to know about the implementation details when it being built.\n\nXCode 10 comes with a new proprietary build system, thats probably the reason for the mac app breakage.",
    "created_at": "2018-10-09T07:01:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392977",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Well its gcc's own bits, gcc needs to know about the implementation details when it being built.
...
```json
{
    "body": "<a id='comment:4'></a>It's using gcc private internal implementation of a feature rather then the language itself. Even if you stay with gcc you are at the mercy of it breaking. There should be a switch to prevent you from including those directly, the question is not even about proprietary it is about using something that is not only not portable but it is not guaranteed stable.",
    "created_at": "2018-10-09T08:31:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392978",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>It's using gcc private internal implementation of a feature rather then the language itself. Even if you stay with gcc you are at the mercy of it breaking. There should be a switch to prevent you from including those directly, the question is not even about proprietary it is about using something that is not only not portable but it is not guaranteed stable.
...
```json
{
    "body": "<a id='comment:5'></a>I've made #26472 for the failure of the mac app to build, since that is a separate issue.",
    "created_at": "2018-10-11T20:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392979",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:5'></a>I've made #26472 for the failure of the mac app to build, since that is a separate issue.
...
```json
{
    "body": "<a id='comment:6'></a>From [sage-devel](https://groups.google.com/d/msg/sage-devel/Bl2CWkOVKc4/wmG3vV8lBgAJ): on OS X Mojave, there is no folder `/usr/include` unless you install `/Library/Developer/CommandLineTools/Packages/macOS_SDK_headers_for_macOS_10.14.pkg`. I tried building a vanilla GCC 7.2.0, and I couldn't do it until I installed this extra package.",
    "created_at": "2018-10-12T20:42:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392980",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>From [sage-devel](https://groups.google.com/d/msg/sage-devel/Bl2CWkOVKc4/wmG3vV8lBgAJ): on OS X Mojave, there is no folder `/usr/include` unless you install `/Library/Developer/CommandLineTools/Packages/macOS_SDK_headers_for_macOS_10.14.pkg`. I tried building a vanilla GCC 7.2.0, and I couldn't do it until I installed this extra package.
...
```json
{
    "body": "<a id='comment:7'></a>I'm still on OSX 10.13 and /usr/include does exist. Still can't compile GCC",
    "created_at": "2018-10-15T17:56:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392981",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>I'm still on OSX 10.13 and /usr/include does exist. Still can't compile GCC
...
```json
{
    "body": "<a id='comment:8'></a>I have a machine with OS X 10.13 and Xcode 10, and Sage builds, including the `gfortran` package. Are you trying to build Sage's GCC and use it in the Sage build?",
    "created_at": "2018-10-16T01:41:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392982",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>I have a machine with OS X 10.13 and Xcode 10, and Sage builds, including the `gfortran` package. Are you trying to build Sage's GCC and use it in the Sage build?
...
```json
{
    "body": "<a id='comment:9'></a>Yes, I'm talking about building `SAGE_INSTALL_GCC=yes make`",
    "created_at": "2018-10-16T07:02:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392983",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>Yes, I'm talking about building `SAGE_INSTALL_GCC=yes make`
...
```json
{
    "body": "<a id='comment:10'></a>Yeah, that works for me, too, or at least it has now gotten past the GCC build.",
    "created_at": "2018-10-16T15:41:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392984",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>Yeah, that works for me, too, or at least it has now gotten past the GCC build.
...
```json
{
    "body": "<a id='comment:11'></a>On a different machine running OS X 10.14 and Xcode 10.0, I see the problem in the ticket description.",
    "created_at": "2018-10-16T19:20:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392985",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>On a different machine running OS X 10.14 and Xcode 10.0, I see the problem in the ticket description.
...
```json
{
    "body": "<a id='comment:12'></a>Suprisingly, installing gcc now once succeeded on OSX 10.14 and XCode 10. So it seems to be a build race condition? Gcc does install its own `$SAGE_LOCAL/include/c++/7.2.0/bits/stl_iterator.h`",
    "created_at": "2018-11-18T14:31:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392986",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>Suprisingly, installing gcc now once succeeded on OSX 10.14 and XCode 10. So it seems to be a build race condition? Gcc does install its own `$SAGE_LOCAL/include/c++/7.2.0/bits/stl_iterator.h`
...
```json
{
    "body": "<a id='comment:13'></a>Downgrading since we don't build GCC any more for the OSX binary",
    "created_at": "2018-12-12T14:23:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392987",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>Downgrading since we don't build GCC any more for the OSX binary
...
```json
{
    "body": "<a id='comment:16'></a>Testing whether this package is still relevant, using `tox -e local-homebrew-macos-standard-gcc_spkg`.",
    "created_at": "2020-04-18T07:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392990",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:16'></a>Testing whether this package is still relevant, using `tox -e local-homebrew-macos-standard-gcc_spkg`.
...
```json
{
    "body": "<a id='comment:19'></a>I see a similar error about `mpc`. This is with a bunch of homebrew packages installed and with `./configure --with-system-gcc=no`.",
    "created_at": "2020-04-22T17:18:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392992",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:19'></a>I see a similar error about `mpc`. This is with a bunch of homebrew packages installed and with `./configure --with-system-gcc=no`.
...
```json
{
    "body": "<a id='comment:20'></a>This ticket seems outdated, as we have made a major gcc spkg upgrade since. I have opened #29580 for the new, unrelated error.",
    "created_at": "2020-04-25T18:14:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392993",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:20'></a>This ticket seems outdated, as we have made a major gcc spkg upgrade since. I have opened #29580 for the new, unrelated error.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392994",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392995",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392996",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26426#issuecomment-392997",
