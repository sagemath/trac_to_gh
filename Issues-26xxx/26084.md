...
```json
{
    "body": "<a id='comment:6'></a>\nAt a quick glance it looks good. I might prefer the old style with a light background window, but this one looks much better with a dark background and is serviceable with either.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|\n|[49259be](https://git.sagemath.org/sage.git/commit?id=49259be43ec5f1872948e1a183c4878f19ce2d2a)|`SageIpythonConfiguration.colors: Use default from SageTerminalInteractiveShell instead of forcing LightBG`|",
