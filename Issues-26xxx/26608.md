...
```json
{
    "body": "<a id='comment:2'></a>I don't know if PARI uses openblas in its multi-threaded mode but I wonder if this is related to #26585",
    "created_at": "2018-10-31T11:26:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511387",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>I don't know if PARI uses openblas in its multi-threaded mode but I wonder if this is related to #26585
...
```json
{
    "body": "<a id='comment:3'></a>Note that the code excerpts in the last lines of the backtrace are nonsense since I was compiling an older version of the docs. Here's the \"translated\" version:\n\n\n```\n  File \"sage/misc/cachefunc.pyx\", line 1005, in sage.misc.cachefunc.CachedFunction.__call__ (build/cythonized/sage/misc/cachefunc.c:6065)\n    w = self.f(*args, **kwds)\n  File \"/usr/lib/python2.7/site-packages/sage/structure/unique_representation.py\", line 1027, in __classcall__\n    instance = typecall(cls, *args, **options)\n  File \"sage/misc/classcall_metaclass.pyx\", line 496, in sage.misc.classcall_metaclass.typecall (build/cythonized/sage/misc/classcall_metaclass.c:2148)\n    return (<PyTypeObject*>type).tp_call(cls, args, kwds)\n  File \"/usr/lib/python2.7/site-packages/sage/geometry/triangulation/point_configuration.py\", line 367, in __init__\n    PointConfiguration_base.__init__(self, points, defined_affine)\n  File \"sage/geometry/triangulation/base.pyx\", line 398, in sage.geometry.triangulation.base.PointConfiguration_base.__init__ (build/cythonized/sage/geometry/triangulation/base.cpp:4135)\n    self._init_points(points)\n  File \"sage/geometry/triangulation/base.pyx\", line 456, in sage.geometry.triangulation.base.PointConfiguration_base._init_points (build/cythonized/sage/geometry/triangulation/base.cpp:4982)\n    red = matrix([ red.row(i) for i in red.pivot_rows()])\n  File \"sage/matrix/matrix2.pyx\", line 517, in sage.matrix.matrix2.Matrix.pivot_rows (build/cythonized/sage/matrix/matrix2.c:8414)\n    v = self.transpose().pivots()\n  File \"sage/matrix/matrix_integer_dense.pyx\", line 2217, in sage.matrix.matrix_integer_dense.Matrix_integer_dense.pivots (build/cythonized/sage/matrix/matrix_integer_dense.c:19162)\n    E = self.echelon_form()\n  File \"sage/matrix/matrix_integer_dense.pyx\", line 2019, in sage.matrix.matrix_integer_dense.Matrix_integer_dense.echelon_form (build/cythonized/sage/matrix/matrix_integer_dense.c:17749)\n    H_m = self._hnf_pari(flag, include_zero_rows=include_zero_rows)\n  File \"sage/matrix/matrix_integer_dense.pyx\", line 5719, in sage.matrix.matrix_integer_dense.Matrix_integer_dense._hnf_pari (build/cythonized/sage/matrix/matrix_integer_dense.c:46635)\n    sig_on()\nSignalError: Segmentation fault \n```",
    "created_at": "2018-10-31T11:27:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511388",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:3'></a>Note that the code excerpts in the last lines of the backtrace are nonsense since I was compiling an older version of the docs. Here's the "translated" version:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511389",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I'm not sure if it does, but it might.  I grepped the pari/gp source and it doesn't use `openblas_set_num_threads` directly, but something else might be.  I did see some reference to `omp_set_num_threads` but I don't think we compile with OpenMP by default in Sage.",
    "created_at": "2018-10-31T13:42:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511391",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>I'm not sure if it does, but it might.  I grepped the pari/gp source and it doesn't use `openblas_set_num_threads` directly, but something else might be.  I did see some reference to `omp_set_num_threads` but I don't think we compile with OpenMP by default in Sage.
...
```json
{
    "body": "<a id='comment:7'></a>There's also some multi-threading support in FLINT which could be problematic, but I have no idea if that's relevant in this case.",
    "created_at": "2018-10-31T13:47:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511392",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>There's also some multi-threading support in FLINT which could be problematic, but I have no idea if that's relevant in this case.
...
```json
{
    "body": "<a id='comment:8'></a>I read on the mailing list post \"It is called indirectly via matplotlib when rendering plots, see full backtrace below (btw, I had to downgrade to an old version of Sage to get a meaningful backtrace - I really dislike this trend of hiding build output, it makes it very hard to debug stuff)\"\n\nI had a very similar problem to this; it actually came from the BLAS library by way of a Numpy ufunc (I think for the \"dot\" product of a matrix in a vector, or two matrices).  I feel like I actually fixed this but now I can't remember.",
    "created_at": "2018-10-31T13:51:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511393",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>I read on the mailing list post "It is called indirectly via matplotlib when rendering plots, see full backtrace below (btw, I had to downgrade to an old version of Sage to get a meaningful backtrace - I really dislike this trend of hiding build output, it makes it very hard to debug stuff)"
...
```json
{
    "body": "<a id='comment:9'></a>Do you know some direct, specific way to reproduce this so that I can try it?",
    "created_at": "2018-10-31T13:53:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511394",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Do you know some direct, specific way to reproduce this so that I can try it?
...
```json
{
    "body": "<a id='comment:11'></a>You know what though--I'm looking at the relevant code in openblas, and `openblas_set_num_threads(1)` might actually cause it to spin up a single thread (beyond the main thread) which is actually good enough to invoke the bug I fixed.  I'm going to try to confirm that though.",
    "created_at": "2018-10-31T14:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511396",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>You know what though--I'm looking at the relevant code in openblas, and `openblas_set_num_threads(1)` might actually cause it to spin up a single thread (beyond the main thread) which is actually good enough to invoke the bug I fixed.  I'm going to try to confirm that though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511398",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511400",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Nevermind; that does not appear to be the case, I don't think.",
    "created_at": "2018-10-31T14:42:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511401",
    "user": "https://github.com/embray"
}
```

<a id='comment:15'></a>Nevermind; that does not appear to be the case, I don't think.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511402",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>ISTM PARI/GP is not even built with multi-threading enabled unless you run its `Configure` with either `--mt=pthread` or `--mt=mpi`.  On my system anyways this is not done by default...",
    "created_at": "2018-10-31T15:47:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511403",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>ISTM PARI/GP is not even built with multi-threading enabled unless you run its `Configure` with either `--mt=pthread` or `--mt=mpi`.  On my system anyways this is not done by default...
...
```json
{
    "body": "<a id='comment:18'></a>*Now* if I build PARI with `--mt=pthread` I can make a child process segfault if it tries to do some multi-threaded work.  Granted, this is partly with my own *bad* code which does some things improperly.  Now I'd be curious if\n\na) Anyone getting having this problem is building PARI with `--mt=pthread` and\n\nb) Exactly what code is being run in Sage that invokes multi-threading in PARI.",
    "created_at": "2018-10-31T15:54:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511404",
    "user": "https://github.com/embray"
}
```

<a id='comment:18'></a>*Now* if I build PARI with `--mt=pthread` I can make a child process segfault if it tries to do some multi-threaded work.  Granted, this is partly with my own *bad* code which does some things improperly.  Now I'd be curious if
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511405",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I can also make it deadlock with the right combination of evil calls.",
    "created_at": "2018-10-31T16:05:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511406",
    "user": "https://github.com/embray"
}
```

<a id='comment:20'></a>I can also make it deadlock with the right combination of evil calls.
...
```json
{
    "body": "<a id='comment:21'></a>Even when you explicitly set `nthreads` to `1` before going forth with that evilness?",
    "created_at": "2018-10-31T16:12:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511407",
    "user": "https://github.com/timokau"
}
```

<a id='comment:21'></a>Even when you explicitly set `nthreads` to `1` before going forth with that evilness?
...
```json
{
    "body": "<a id='comment:23'></a>Okay, glad you're feeling better :)\n\nLet me know if I can help.",
    "created_at": "2018-11-08T17:50:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511409",
    "user": "https://github.com/timokau"
}
```

<a id='comment:23'></a>Okay, glad you're feeling better :)
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26608#event-66027"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Totally forgot about this...",
    "created_at": "2019-01-18T13:51:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511410",
    "user": "https://github.com/embray"
}
```

<a id='comment:24'></a>Totally forgot about this...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511411",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Too bad, I also forgot about this. I'm literally right now returning from a week-long [PARI/GP workshop](https://pari.math.u-bordeaux.fr/Events/PARI2019/) where I could have discussed this.",
    "created_at": "2019-01-18T14:10:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511412",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>Too bad, I also forgot about this. I'm literally right now returning from a week-long [PARI/GP workshop](https://pari.math.u-bordeaux.fr/Events/PARI2019/) where I could have discussed this.
...
```json
{
    "body": "<a id='comment:26'></a>The alternative multiprocess doc build introduced in #27490 works as a temporary workaround. I just replaced the revert with a one-line patch to enable it unconditionally  for 8.7",
    "created_at": "2019-03-24T12:41:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511413",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:26'></a>The alternative multiprocess doc build introduced in #27490 works as a temporary workaround. I just replaced the revert with a one-line patch to enable it unconditionally  for 8.7
...
```json
{
    "body": "<a id='comment:27'></a>Removing most of the rest of my open tickets out of the 8.7 milestone, which should be closed.",
    "created_at": "2019-03-25T10:44:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511414",
    "user": "https://github.com/embray"
}
```

<a id='comment:27'></a>Removing most of the rest of my open tickets out of the 8.7 milestone, which should be closed.
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26608#event-66028"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26608#event-66029"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>see also #28242, where we enable system Pari in vanilla Sage.",
    "created_at": "2019-08-07T04:34:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511415",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:28'></a>see also #28242, where we enable system Pari in vanilla Sage.
...
```json
{
    "body": "<a id='comment:31'></a>and Sage installs `paricfg.h` with\n\n```\n#define PARI_MT_ENGINE \"single\"\n```\nWell, I can use this on #28242 to test whether we got single-threaded libpari.",
    "created_at": "2019-08-07T17:21:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511418",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:31'></a>and Sage installs `paricfg.h` with
...
```json
{
    "body": "<a id='comment:34'></a>If #26002 has any effect, the pool should have just a single thread, no?",
    "created_at": "2019-08-08T12:24:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511421",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:34'></a>If #26002 has any effect, the pool should have just a single thread, no?
...
```json
{
    "body": "<a id='comment:35'></a>In further digging, yes, I just found #26002 and that indeed pari has `pari_mt_nbthreads = 1` so maybe I'm barking up the wrong tree.  The `polint_chinese` call indeed does not use any threads in this case.",
    "created_at": "2019-08-08T12:37:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511422",
    "user": "https://github.com/embray"
}
```

<a id='comment:35'></a>In further digging, yes, I just found #26002 and that indeed pari has `pari_mt_nbthreads = 1` so maybe I'm barking up the wrong tree.  The `polint_chinese` call indeed does not use any threads in this case.
...
```json
{
    "body": "<a id='comment:36'></a>hmm, maybe it still does something with thread local variables?",
    "created_at": "2019-08-08T12:42:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511423",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:36'></a>hmm, maybe it still does something with thread local variables?
...
```json
{
    "body": "<a id='comment:37'></a>On a wild guess, I tried switching the docbuild to use my `multiprocessing.Pool` replacement from #27490 (this is on Linux), and the crashes no longer occur.\n\nThe major difference is that in `multiprocessing.Pool`, each docbuild subprocess is forked from a separate thread from the main thread, whereas in my replacement they're just forked directly from the main thread.\n\nSomehow this alone is enough to leave some structures in PARI in a bad state, and only if it was built with multithreading support in the first place (apparently).",
    "created_at": "2019-08-08T13:33:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511424",
    "user": "https://github.com/embray"
}
```

<a id='comment:37'></a>On a wild guess, I tried switching the docbuild to use my `multiprocessing.Pool` replacement from #27490 (this is on Linux), and the crashes no longer occur.
...
```json
{
    "body": "<a id='comment:38'></a>Going back to comment [comment:30], if `--mt=pthread` then a variable in PARI's `Configure`, `enable_tls=\"yes\"` is set.  This in turns leads to defining a macro in `paricfg.h` called `ENABLE_TLS`.\n\nThe only effect of `ENABLE_TLS` is in `src/headers/parisys.h`:\n\n```\n#ifdef ENABLE_TLS\n#  define THREAD __thread\n#else\n#  define THREAD\n#endif\n```\n\nSo variables in PARI declared `THREAD` use TLS in this case.  This alone could be enough to suspect strange behavior in PARI when it's forked from a thread...",
    "created_at": "2019-08-08T13:53:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511425",
    "user": "https://github.com/embray"
}
```

<a id='comment:38'></a>Going back to comment [comment:30], if `--mt=pthread` then a variable in PARI's `Configure`, `enable_tls="yes"` is set.  This in turns leads to defining a macro in `paricfg.h` called `ENABLE_TLS`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511426",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511427",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>#28356 proposes a workaround for this issue.\n\nIt won't solve the issue in general (PARI is not safe to use in arbitrary multi-threaded code), but at least it won't crash when building the docs.",
    "created_at": "2019-08-15T12:25:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511428",
    "user": "https://github.com/embray"
}
```

<a id='comment:41'></a>#28356 proposes a workaround for this issue.
...
```json
{
    "body": "<a id='comment:42'></a>Did somebody check that this problem is limited to docbuilds? Does the Sage testsuite pass (apart from doc-related tests of course)?",
    "created_at": "2019-08-26T17:30:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511429",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:42'></a>Did somebody check that this problem is limited to docbuilds? Does the Sage testsuite pass (apart from doc-related tests of course)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511430",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511431",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>Closing this ticket for now, since the immediate problem (Sage's docbuild) has been worked around by #28356.  The broader issue still should have a ticket to track it, even if it won't be resolved any time soon, so I have opened #28800.",
    "created_at": "2019-11-25T11:13:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511432",
    "user": "https://github.com/embray"
}
```

<a id='comment:45'></a>Closing this ticket for now, since the immediate problem (Sage's docbuild) has been worked around by #28356.  The broader issue still should have a ticket to track it, even if it won't be resolved any time soon, so I have opened #28800.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26608#event-66030"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26608#issuecomment-511433",
    "user": "https://github.com/embray"
}
```
