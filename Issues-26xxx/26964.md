...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[438bc7f](https://git.sagemath.org/sage.git/commit/?id=438bc7fb739b571e82674e69210f81e7ec29c5e8)|`./bootstrap, src/doc/bootstrap: Auto-generate apt-get/yum command lines`|",
    "created_at": "2020-02-09T19:30:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26964",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[3810bc9](https://git.sagemath.org/sage.git/commit/?id=3810bc9835050073f663109d576eae1157bf4f77)|`Clean and ignore the generated files`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[bdd69c3](https://git.sagemath.org/sage.git/commit/?id=bdd69c3bd85b2d33a253ef8c7edde6ca8adffb85)|`build/bin/write-dockerfile.sh: Copy src/doc/bootstrap early`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[8be072b](https://git.sagemath.org/sage.git/commit/?id=8be072b7244b342c6b70737cc36409121b70b41b)|`build/bin/write-dockerfile.sh: Copy src/doc/bootstrap early`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[e3b5fde](https://git.sagemath.org/sage.git/commit/?id=e3b5fde2de16af33fdb0624b6484104b88642ca9)|`bootstrap: Pass SAGE_ROOT to src/doc/bootstrap`|\n|[3874194](https://git.sagemath.org/sage.git/commit/?id=38741947257da00371142bd7ca4099909717cc50)|`src/doc/bootstrap: Create output dir if it does not exist (for Docker run)`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|\n|[eb7a1d9](https://git.sagemath.org/sage.git/commit/?id=eb7a1d9b9a16c40a5a30c9451d14b5e078b88007)|`build/bin/sage-print-system-package-command: Print usage message if not enough arguments provided`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|\n|[146a520](https://git.sagemath.org/sage.git/commit/?id=146a52052b48c4f97aaa6be1122f9a63d5f44e8d)|`build/bin/sage-print-system-package-command: Do not print a command if no packages are to be installed`|",
    "created_at": "2020-02-12T02:22:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26964",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[ce34ce1](https://git.sagemath.org/sage.git/commit/?id=ce34ce1fcc5e8669c9e05b758bb8576cc8afa8d1)|`Makefile: Add dependencies on build/pkgs/*.txt build/pkgs/*/distros/*.txt`|",
    "created_at": "2020-02-12T19:00:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26964",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[688c68e](https://git.sagemath.org/sage.git/commit/?id=688c68e7a4d0b17d0a8093585389c6c4f2fc8c27)|`Makefile [configure]: Add dependency on bootstrap, src/doc/bootstrap`|",
