...
<a id='comment:35'></a>Replying to [embray](#comment%3A31):
> This change
> is not good.  You seem to have brought it over from some old branch for #26856, where I also had to remove it: #26856#comment:110
...
<a id='comment:51'></a>Replying to [zerline](#comment%3A48):
> Could you point me to a documentation page for this?
> 
> (I just used https://wiki.sagemath.org/InstallingGapPackages, which recommends compiling within the Sage shell)
> 
...
<a id='comment:52'></a>Replying to [zerline](#comment%3A45):
> *after a bare ./configure --with-gaproot=../..* :
> 
> 
> 
...
<a id='comment:56'></a>Replying to [zerline](#comment%3A54):
> Replying to [dimpase](#comment%3A51):
> > Replying to [zerline](#comment%3A48):
> > > Could you point me to a documentation page for this?
> > > 
...
<a id='comment:59'></a>Replying to [dimpase](#comment%3A44):
> I don't see why we should not patch package's source.
...
```json
{
    "body": "<a id='comment:81'></a>Any comment on[comment:32](#comment%3A32) ?  This test really shouldn't be giving unpredictable results.",
...
<a id='comment:81'></a>Any comment on[comment:32](#comment%3A32) ?  This test really shouldn't be giving unpredictable results.
...
<a id='comment:90'></a>Replying to [andrew.mathas](#comment%3A89):
> I don't have a great internet connection at the moment but I can test on macosx 10.14.2 by Monday, if not earlier. This said, since this is a package can some one please tell me what needs to be tested. Is `sage -i io && sage -i macosx && make ptestlong` enough? 
