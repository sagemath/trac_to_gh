...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26490#issuecomment-509278",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>not really helpful, I guess, but\n\n```\nsage: desolve(de1, y, ics = [1,e], algorithm=\"fricas\")\n1/2*(e + e^(t^2))/t^4\n```\nworks...",
    "created_at": "2018-10-15T15:29:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26490#issuecomment-509279",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:2'></a>not really helpful, I guess, but
