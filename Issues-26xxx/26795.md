...
<a id='comment:22'></a>Replying to [jmantysalo](#comment%3A20):
> Replying to [dimpase](#comment%3A19):
> 
> > If I remove the call to `is_comparability()` the problem is gone here.
...
<a id='comment:24'></a>Replying to [jmantysalo](#comment%3A21):
> What's this:
> 
> 
> ```
...
<a id='comment:26'></a>Replying to [jmantysalo](#comment%3A21):
> What's this:
> 
> 
> ```
