...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338429"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338431"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26859",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26859#issuecomment-416454",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26859#issuecomment-416455",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338438"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26859#event-338439"
}
```
