...
```json
{
    "body": "<a id='comment:1'></a>M.I was actually removed in  #26647. Testing now whether introspection works. If yes, I'll close the ticket as resolved.",
    "created_at": "2018-12-05T08:55:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26835#issuecomment-373393",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:1'></a>M.I was actually removed in  #26647. Testing now whether introspection works. If yes, I'll close the ticket as resolved.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26835#issuecomment-373394",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26835",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26835#event-66403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26835#issuecomment-373395",
    "user": "https://github.com/nthiery"
}
```
