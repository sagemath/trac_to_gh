...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359423"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359427"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400875",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400876",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400877",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400878",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400879",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400880",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359433"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400881",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400882",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26019#event-359437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26019#issuecomment-400883",
    "user": "https://github.com/vbraun"
}
```
