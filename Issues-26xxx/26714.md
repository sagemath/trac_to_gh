...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26714#event-349231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26714#event-349232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26714#event-349233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26714#event-349234"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26714#issuecomment-414273",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26714#issuecomment-414274",
    "user": "https://github.com/dimpase"
}
```
