...
archive/attachments_021867.json:
```json
{
...
```json
{
    "body": "**Attachment:** [primecount.gdb.crash.trace](https://github.com/sagemath/sage/files/ticket26714/primecount.gdb.crash.trace)",
    "created_at": "2018-11-18T10:43:14Z",
    "issue": "https://github.com/sagemath/sage/issues/26714",
    "type": "issue_comment",
...
**Attachment:** [primecount.gdb.crash.trace](https://github.com/sagemath/sage/files/ticket26714/primecount.gdb.crash.trace)



---

archive/attachments_021868.json:
```json
{
    "asset_content_type": "application/octet-stream",
