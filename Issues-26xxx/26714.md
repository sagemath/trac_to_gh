...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513141",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [primecount.doctest.log](tarball://root/attachments/some-uuid/ticket26714/primecount.doctest.log) by tmonteil created at 2018-11-18 10:47:59",
    "created_at": "2018-11-18T10:47:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513142",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:1'></a>Attachment [primecount.doctest.log](tarball://root/attachments/some-uuid/ticket26714/primecount.doctest.log) by tmonteil created at 2018-11-18 10:47:59
...
```json
{
    "body": "<a id='comment:2'></a>It would be more appropriate to reproduce outside of Sage and make a report [upstream](https://github.com/kimwalisch/primecount).",
    "created_at": "2018-11-19T08:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513143",
    "user": "https://github.com/videlec"
}
```

<a id='comment:2'></a>It would be more appropriate to reproduce outside of Sage and make a report [upstream](https://github.com/kimwalisch/primecount).
...
```json
{
    "body": "<a id='comment:3'></a>And BTW, primecount 4.4 is out.",
    "created_at": "2018-11-19T08:09:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513144",
    "user": "https://github.com/videlec"
}
```

<a id='comment:3'></a>And BTW, primecount 4.4 is out.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513145",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>And the trace is irrelevant since primecount has not been compiled with gdb support. We only see Cython stuff. Apparently, running `cmake` with the additional option `-DCMAKE_BUILD_TYPE=Debug` should set the compiler flag properly. Could you try it?",
    "created_at": "2018-11-19T08:16:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513146",
    "user": "https://github.com/videlec"
}
```

<a id='comment:5'></a>And the trace is irrelevant since primecount has not been compiled with gdb support. We only see Cython stuff. Apparently, running `cmake` with the additional option `-DCMAKE_BUILD_TYPE=Debug` should set the compiler flag properly. Could you try it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513147",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26714#event-66177"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>at least this works at the command line now (from the git version of primecount):\n\n```\n$ uname -a\nLinux arando 4.15.0-117-generic #118-Ubuntu SMP Fri Sep 4 20:00:48 UTC 2020 i686 i686 i686 GNU/Linux\n$ primecount 1000\n168\n```",
    "created_at": "2021-11-16T18:20:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513148",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:8'></a>at least this works at the command line now (from the git version of primecount):
...
```json
{
    "body": "<a id='comment:9'></a>I'll check that the interface works, too - it will take a while to build on this old box.",
    "created_at": "2021-11-16T18:26:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513149",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:9'></a>I'll check that the interface works, too - it will take a while to build on this old box.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513150",
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26714#event-66178"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26714#event-66179"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Let's close it as outdated in view of the update ticket #25009.\n\nPortability testing (TBD) of #25009 also includes tests on several 32bit platforms.",
    "created_at": "2021-11-16T18:30:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513151",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:10'></a>Let's close it as outdated in view of the update ticket #25009.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513152",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513153",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513154",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>testing on #25009 shows that it's all good now on 32-bit, and this may be closed.",
    "created_at": "2021-11-17T16:49:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513155",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:13'></a>testing on #25009 shows that it's all good now on 32-bit, and this may be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26714#issuecomment-513156",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26714",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26714#event-66180"
}
```
