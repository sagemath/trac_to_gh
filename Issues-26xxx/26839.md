...
```json
{
    "body": "Pat, can you make the review?",
...
```json
{
    "body": "There are some numerical noise issues, see patchbot.",
...
```json
{
    "body": "#26360: Upgrade arb to 2.15.1 ?",
...
```json
{
    "body": "When I reviewed this ticket (no failures), I was using `8.5.beta6`.",
...
```json
{
    "body": "I don't think it was a good move. Tracking arb enclosure regression/improvement is worth the trouble (see eg https://github.com/fredrik-johansson/arb/issues/227).",
