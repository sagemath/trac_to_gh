...
```json
{
    ...
    "type": "issue",
    "updated_at": "2018-09-21T02:05:31Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26317#event-316633"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26317#event-316634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26317#event-316635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26317",
    "rename": {
        "from": "Modular form printing fails because modular forms cannot be evaluated at floats",
        "to": "Modular form plotting fails because modular forms (power series) cannot be evaluated at floats"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26317#event-316636"
}
```
