...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[a5c862b](https://git.sagemath.org/sage.git/commit?id=a5c862b039dce115a5bfa2eafec03b4975e912f9)|`trac #26870: fix error with map`|",
    "created_at": "2018-12-11T02:46:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26870",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[33c75cd](https://git.sagemath.org/sage.git/commit/?id=33c75cd79450f62b77938118c2ce04d576ba912b)|`trac #26870: use list comprehension`|\n|[df223f9](https://git.sagemath.org/sage.git/commit/?id=df223f97f93bc6d3abb3878a2c4161785b7770a9)|`trac #26870: not using bytes_to_str`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[9dc4d3a](https://git.sagemath.org/sage.git/commit/?id=9dc4d3a1e3f03faa2d00eaa9bc7253dce54fa8db)|`a bit of trivial cleanup for readability`|\n|[a527cea](https://git.sagemath.org/sage.git/commit/?id=a527cea57c00a6888286e525d4a6b98fff7bc861)|`improve formatting of these error messages using f-strings`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[ee621e8](https://git.sagemath.org/sage.git/commit/?id=ee621e8daf4c88e27e0a186abb9d3118b8d01eab)|`trac #26870: simplify doctest`|",
