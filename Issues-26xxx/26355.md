# Issue 26355: py3: combinat/designs: bytes-like object is required, not 'str'
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26355#event-66003"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26355#event-66004"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26355#event-66005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26355",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26355#event-66006"
}
```
