...
```json
{
    "body": "<a id='comment:1'></a>roed, caruso: I am curious to hear what you think about this. I have been stumbling upon this several times during the past years.",
    "created_at": "2018-08-21T17:25:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501687",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:1'></a>roed, caruso: I am curious to hear what you think about this. I have been stumbling upon this several times during the past years.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501688",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The problem with `im_gens` is that it's not really mathematically defined in the first place. So I wouldn't try to add more functionality to it.\n\nInstead, I would define a specific morphism class for polynomial rings. Mathematically, a ring morphism from a polynomial ring is defined by a morphism of the base together with the images of the generators. That was my plan for #25558 but I stopped working on that...",
    "created_at": "2018-08-21T20:04:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501689",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>The problem with `im_gens` is that it's not really mathematically defined in the first place. So I wouldn't try to add more functionality to it.
...
```json
{
    "body": "<a id='comment:5'></a>Looking at the ring homomorphism code brings back bad memories from #23204. Maybe I don't want to add more to morphism.pyx and homset.py as these should probably be drastically simplified if anything.",
    "created_at": "2018-08-29T02:19:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501691",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:5'></a>Looking at the ring homomorphism code brings back bad memories from #23204. Maybe I don't want to add more to morphism.pyx and homset.py as these should probably be drastically simplified if anything.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501694",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Replying to [saraedum](#comment%3A8):\n> I am not sure I understand. If k is not a prime field, then how would I would I define my map `k[x]\u2192l`?\n\n\nBy giving a map `k \u2192 l` and the image of `x`.\n\nIf `k` is not a prime finite field, then use recursion: `k = f[\u03b1]`, so `k \u2192 l` is induced by a map `f[x] \u2192 l`.",
    "created_at": "2018-08-29T11:04:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501695",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>Replying to [saraedum](#comment%3A8):
> I am not sure I understand. If k is not a prime field, then how would I would I define my map `k[x]→l`?
...
```json
{
    "body": "<a id='comment:10'></a>Sorry, my question was how to do this in Sage precisely. So, I can map `k(\u03b1)\u2192k[x]` by mapping the generator to `x`. Then I map `k[x]\u2192l[x]` by using an induced map. Finally I use the evaluation `l[x]\u2192l`. But are people really supposed to figure this out on their own?\n\nIf I understand your proposal in comment 7 above, you would like to see a shortcut to define `k[x]\u2192l` as `(k[x]).hom(\u03b1', base_morphism=k\u2192l)`. But why not go all the way and allow people to write `(k(\u03b1)).hom(\u03b1', base_morphism=k\u2192l)`?",
    "created_at": "2018-08-29T11:47:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501696",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:10'></a>Sorry, my question was how to do this in Sage precisely. So, I can map `k(α)→k[x]` by mapping the generator to `x`. Then I map `k[x]→l[x]` by using an induced map. Finally I use the evaluation `l[x]→l`. But are people really supposed to figure this out on their own?
...
```json
{
    "body": "<a id='comment:12'></a>An alternative might be to just document these things in the docstring of `hom()`.",
    "created_at": "2018-08-29T12:20:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501698",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:12'></a>An alternative might be to just document these things in the docstring of `hom()`.
...
```json
{
    "body": "<a id='comment:14'></a>A concrete example where I would like to be able to specify a base_morphism is the following:\n\n```\nsage: k = GF(2)\nsage: R.<a> = k[]\nsage: l.<a> = k.extension(a^3 + a^2 + 1)\nsage: R.<b> = l[]\nsage: m.<b> = l.extension(b^2 + b + a)\nsage: n.<z> = GF(2^6)\n\nsage: m.hom([z^4 + z^3 + 1], base_morphism=l.hom([z^5 + z^4 + z^2]))\n```",
    "created_at": "2018-08-29T15:00:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501700",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:14'></a>A concrete example where I would like to be able to specify a base_morphism is the following:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501701",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501702",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501704",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501705",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501706",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501707",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501708",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501709",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501711",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501712",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501713",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501714",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501716",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501717",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501718",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501719",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501720",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Okay, I think I've addressed Xavier's comments.",
    "created_at": "2019-09-13T13:32:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501721",
    "user": "https://github.com/roed314"
}
```

<a id='comment:26'></a>Okay, I think I've addressed Xavier's comments.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501722",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501723",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501724",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501725",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501726",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501727",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501729",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501730",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501731",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501732",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501733",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501734",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501735",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501736",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501737",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501738",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>LGTM (see also discussion on Zulip).\n\nPositive review when patchbot is happy.",
    "created_at": "2019-10-03T23:54:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501739",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:37'></a>LGTM (see also discussion on Zulip).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501741",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501742",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>I've just updated the doctest.\n\nIf you agree with my changes, please give a positive review.\n\n---\nNew commits:",
    "created_at": "2019-10-06T19:38:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501743",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:40'></a>I've just updated the doctest.
...
```json
{
    "body": "<a id='comment:41'></a>Looks good to me.",
    "created_at": "2019-10-10T19:47:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501744",
    "user": "https://github.com/roed314"
}
```

<a id='comment:41'></a>Looks good to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501745",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26105#event-65134"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501746",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26105#issuecomment-501747",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26105",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26105#event-65135"
}
```
