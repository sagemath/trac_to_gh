...
```json
{
    "body": "<a id='comment:1'></a>I don't really understand what you want. What you write here is not the same issue as the issue of `--optional=sage` that we were discussing on #26110. I don't know whether this is intentional or not. In any case: I can probably fix the issue of #26110 easily but not this ticket.",
    "created_at": "2018-08-29T20:59:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502622",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>I don't really understand what you want. What you write here is not the same issue as the issue of `--optional=sage` that we were discussing on #26110. I don't know whether this is intentional or not. In any case: I can probably fix the issue of #26110 easily but not this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502624",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502625",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502626",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I interpreted the issue of #26110 (which is also what I discussed in my sage-devel post) as: the meaning of `--optional` is really strange when you omit `sage` and in particular it causes `--optional=mypkg` tests to fail.\n\nBeing able to run optional tests without running all Sage tests (this ticket) is related, but I don't see it as the same issue.\n\nWhat I dislike about your \"solution\" in #25345 that I reverted in #26110 is that it makes the first issue (`--optional=sage` having a special meaning) even worse.",
    "created_at": "2018-08-30T13:34:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502627",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I interpreted the issue of #26110 (which is also what I discussed in my sage-devel post) as: the meaning of `--optional` is really strange when you omit `sage` and in particular it causes `--optional=mypkg` tests to fail.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502629",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502630",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Another related possibility that I've been wanting for a quite a while is to create a custom rst directive named something like `.. doctest:`.  It would be treated by Sphinx no differently than a normal verbatim block, but we could pass various options to it that can be parsed by the doctest parser, and apply those options to the entire block.\n\nThis would solve a lot of problems that we make for ourselves by having various doctest flags apply only to single lines.",
    "created_at": "2018-09-03T08:26:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502631",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>Another related possibility that I've been wanting for a quite a while is to create a custom rst directive named something like `.. doctest:`.  It would be treated by Sphinx no differently than a normal verbatim block, but we could pass various options to it that can be parsed by the doctest parser, and apply those options to the entire block.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502633",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502634",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26159#issuecomment-502635",
    "user": "https://github.com/jhpalmieri"
}
```
