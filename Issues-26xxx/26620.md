...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348225"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348226"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348228"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348229"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348230"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26620#issuecomment-413074",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-348232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26620#issuecomment-413075",
    "user": "https://github.com/embray"
}
```
