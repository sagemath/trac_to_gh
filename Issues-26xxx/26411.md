...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345787"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345790"
}
```
...
```json
{
    "body": "Changed keywords from **** to **libgap eval temporary file**",
    "created_at": "2018-10-05T11:20:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409907",
    "user": "https://github.com/simon-king-jena"
}
```

Changed keywords from **** to **libgap eval temporary file**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409908",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409909",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409910",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409911",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409912",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409913",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409914",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26411#event-345795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26411#issuecomment-409915",
    "user": "https://github.com/jdemeyer"
}
```
