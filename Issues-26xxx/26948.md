...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352148"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352150"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26948#issuecomment-418304",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26948",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352152"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352154"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-352155"
}
```
