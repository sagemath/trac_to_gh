...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[9135406](https://git.sagemath.org/sage.git/commit/?id=9135406961383c752e3a2ffc47d305070ce5baf2)|`improve determinism in Huffman codings`|\n|[9e3f7bc](https://git.sagemath.org/sage.git/commit/?id=9e3f7bc7fb03a1dba8676aa464915bf2fdbcaeb8)|`different algorithm without using heap queues`|\n|[7c2de4f](https://git.sagemath.org/sage.git/commit/?id=7c2de4ffc0fdcb9c8c40f0490845a4b1778620db)|`remove stray line in test`|\n|[d41dbe2](https://git.sagemath.org/sage.git/commit/?id=d41dbe25f3480c7853556c012bde80c15741334a)|`explicitly raise an error when trying to make a Huffman code for fewer than 2 symbols (for which the code in this class breaks)`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nI fixed the doctest\n\n---\nNew commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[1c94d3c](https://git.sagemath.org/sage.git/commit?id=1c94d3cd81846a41acbe59414957b77ce604e702)|`Merge branch 'u/embray/python3/sage-coding-source_coding-huffman' in 8.5.b2`|\n|[e913f5d](https://git.sagemath.org/sage.git/commit?id=e913f5df63139d7e1000adf3dcf7aa51deddeb1f)|`trac 26026 fix trivial failing doctest`|",
    "created_at": "2018-11-10T13:23:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26026",
    "type": "issue_comment",
