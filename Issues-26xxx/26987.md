...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518737",
...
```json
{
    "body": "<a id='comment:2'></a>Please provide a link to the full log. It is not clear whether \"many more lines\" mean more errors or not.\n\nFor this particular one I am inclined just to add more `...`\n\nI don't think Sage must produce the same output for different locales, or whatever the real reason for this discrepancy is (perhaps just a patchbot bug).",
    "created_at": "2019-01-02T03:47:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518738",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:2'></a>Please provide a link to the full log. It is not clear whether "many more lines" mean more errors or not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518739",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>full log at the bottom of\n\nhttps://patchbot.sagemath.org/log/26985/Ubuntu/18.04/x86_64/3.13.0-123-generic/44e979ad077a/2018-12-31%2020:58:39?short",
    "created_at": "2019-01-02T12:54:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518740",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>full log at the bottom of
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518741",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>is it possible to find out what exactly happens there - is it `print()` unable to output UTF-8, or GAP outputting its help in ASCII, not UTF-8? E.g. I have\n\n```\nsage: type(gap.help('SymmetricGroup', pager=False))\n<type 'unicode'>\n```\nand it prints OK, too.",
    "created_at": "2019-01-02T13:20:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518743",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:7'></a>is it possible to find out what exactly happens there - is it `print()` unable to output UTF-8, or GAP outputting its help in ASCII, not UTF-8? E.g. I have
...
```json
{
    "body": "<a id='comment:8'></a>It is most likely a question of the system's locale.  This has happened before with other random patchbots that have things like `LC_CTYPE=C` and such.  It should instead set a UTF-8 locale.  GAP will not use unicode if it does not detect a unicode locale.\n\nI think the patchbot itself should either set LC_CTYPE, or perhaps even the Sage doctest runner.  While it can be interesting to catch locale-related failures, for the sake of builds it's probably best to ensure a consistent environment, and only manipulate locales for specific regression tests for known locale-related bugs.",
    "created_at": "2019-01-02T14:10:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518744",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>It is most likely a question of the system's locale.  This has happened before with other random patchbots that have things like `LC_CTYPE=C` and such.  It should instead set a UTF-8 locale.  GAP will not use unicode if it does not detect a unicode locale.
...
```json
{
    "body": "<a id='comment:9'></a>I don't think this is a blocker since it's a system environment issue on the affected patchbots.",
    "created_at": "2019-01-02T14:10:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518745",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>I don't think this is a blocker since it's a system environment issue on the affected patchbots.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518746",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518747",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518748",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518750",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518751",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518752",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I think should suffice for now; leave other questions 'til later.\n\n---\nNew commits:",
    "created_at": "2019-01-02T14:58:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518753",
    "user": "https://github.com/embray"
}
```

<a id='comment:13'></a>I think should suffice for now; leave other questions 'til later.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518754",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518755",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518756",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518757",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518758",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26987#event-66952"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26987#issuecomment-518759",
    "user": "https://github.com/vbraun"
}
```
