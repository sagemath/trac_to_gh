...
```json
{
    ...
    "type": "issue",
    "updated_at": "2019-09-07T12:37:37Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26407#event-317625"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26407#event-317626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26407#event-317627"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26407#issuecomment-409691",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26407",
    "rename": {
        "from": "Support slicing in expansion() of p-adic elements",
        "to": "Support slicing and tuples in expansion() of p-adic elements"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26407#event-317628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26407#issuecomment-409692",
