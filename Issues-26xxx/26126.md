...
```json
{
    "body": "<a id='comment:2'></a>Can you give it a try with beta2 (uploading right now)? File system is zfs",
    "created_at": "2018-08-25T22:46:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26126#issuecomment-388829",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Can you give it a try with beta2 (uploading right now)? File system is zfs
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26126#issuecomment-388830",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26126#event-65160"
}
```
