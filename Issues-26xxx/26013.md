...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499865",
...
```json
{
    "body": "<a id='comment:3'></a>Oh, I do understand. From the [documentation for os.path.join](https://docs.python.org/2/library/os.path.html#os.path.join):\n\n```\nIf a component is an absolute path, all previous components are thrown away and joining continues from the absolute path component.\n```\nSo we need to strip `os.sep` from the left end of `filename`.",
    "created_at": "2018-08-07T16:24:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499867",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Oh, I do understand. From the [documentation for os.path.join](https://docs.python.org/2/library/os.path.html#os.path.join):
...
```json
{
    "body": "Changing branch from \"\" to \"u/jhpalmieri/spkg-uninstall-os-sep\"",
    "created_at": "2018-08-07T16:26:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499868",
    "user": "https://github.com/jhpalmieri"
}
```

Changing branch from "" to "u/jhpalmieri/spkg-uninstall-os-sep"
...
```json
{
    "body": "Changing commit from \"\" to \"b31446accb1a28c65d5dcb1a2a1976fa9349d6da\"",
    "created_at": "2018-08-08T03:49:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499869",
    "user": "https://github.com/jhpalmieri"
}
```

Changing commit from "" to "b31446accb1a28c65d5dcb1a2a1976fa9349d6da"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499870",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499871",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499872",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499873",
...
```json
{
    "body": "Changing commit from \"b31446accb1a28c65d5dcb1a2a1976fa9349d6da\" to \"40e0cfb75ef3a0a18f9ba00ad9a1eabcf5d7fc41\"",
    "created_at": "2018-08-08T03:52:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499874",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b31446accb1a28c65d5dcb1a2a1976fa9349d6da" to "40e0cfb75ef3a0a18f9ba00ad9a1eabcf5d7fc41"
...
```json
{
    "body": "<a id='comment:8'></a>Some other OSX users have pointed this issue out before, but I could never figure out why it was happening.  Let me look into this a bit more for a sec because there *shouldn't* be absolute paths in those filenames in the first place.  They should be written as relative paths.  For example I have:\n\n```\n$ cat local/var/lib/sage/installed/mpc-1.1.0\n{\n    \"package_name\": \"mpc\",\n    \"package_version\": \"1.1.0\",\n    \"install_date\": \"Thu Jul 19 08:10:31 UTC 2018\",\n    \"system_uname\": \"Linux sage-docker 3.13.0-123-generic #172-Ubuntu SMP Mon Jun 26 18:04:35 UTC 2017 x86_64 x86_64 x86_64 GNU/Linux\",\n    \"sage_version\": \"SageMath version 8.3.rc1, Release Date: 2018-07-14\",\n    \"test_result\": \"\",\n    \"files\": [\n        \"include/mpc.h\",\n        \"lib/libmpc.a\",\n        \"lib/libmpc.so\",\n        \"lib/libmpc.so.3\",\n        \"lib/libmpc.so.3.1.0\",\n        \"share/info/dir\",\n        \"share/info/mpc.info\"\n    ]\n}\n```\n\nDo you see absolute paths being written into those files?",
    "created_at": "2018-08-08T11:13:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499875",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>Some other OSX users have pointed this issue out before, but I could never figure out why it was happening.  Let me look into this a bit more for a sec because there *shouldn't* be absolute paths in those filenames in the first place.  They should be written as relative paths.  For example I have:
...
```json
{
    "body": "<a id='comment:9'></a>Unfortunately the OSX machine I used to have access to appears to be down, and everyone here is on vacation...",
    "created_at": "2018-08-08T11:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499876",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Unfortunately the OSX machine I used to have access to appears to be down, and everyone here is on vacation...
...
```json
{
    "body": "<a id='comment:10'></a>The relevant code is in `sage-spkg` (yet more reason this should probably be rewritten in Python as it is growing in complexity, though as Jeroen wrote elsewhere it would be a tedious task...).  A summarized version is as follows:\n\n```\nPREFIX=\"${SAGE_DESTDIR_LOCAL%/}/\"\nold_IFS=\"$IFS\"; IFS=$'\\n'\nfor filename in $(find \"$PREFIX\" -type f -o -type l | sort); do\n    filename=\"${filename#$PREFIX}\"\n    echo \"$filename\"\ndone\n```\n\nin the above, `$PREFIX` should end with a `/`, and `${filename#$PREFIX}` should have the effect of stripping `$PREFIX` (up to and including the final `/`) from the front of `$filename`.  But maybe there's a bug or some other subtlety with that I was unaware of.",
    "created_at": "2018-08-08T11:27:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499877",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>The relevant code is in `sage-spkg` (yet more reason this should probably be rewritten in Python as it is growing in complexity, though as Jeroen wrote elsewhere it would be a tedious task...).  A summarized version is as follows:
...
```json
{
    "body": "<a id='comment:11'></a>Another way maybe it could fail is if your `$SAGE_LOCAL` somehow had a superfluous double-slash at the end of it...?",
    "created_at": "2018-08-08T11:48:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499878",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>Another way maybe it could fail is if your `$SAGE_LOCAL` somehow had a superfluous double-slash at the end of it...?
...
```json
{
    "body": "<a id='comment:12'></a>If nothing else, something like this should do the trick.  But I think I will be rewriting a chunk of this code anyways...\n\n```diff\ndiff --git a/build/bin/sage-spkg b/build/bin/sage-spkg\nindex 125dd15..ded872f 100755\n--- a/build/bin/sage-spkg\n+++ b/build/bin/sage-spkg\n@@ -889,6 +889,13 @@ if [ -d \"$SAGE_DESTDIR\" ]; then\n     old_IFS=\"$IFS\"; IFS=$'\\n'\n     for filename in $(find \"$PREFIX\" -type f -o -type l | sort); do\n         filename=\"${filename#$PREFIX}\"\n+        # Make really sure there are still no leading slashes on the filename\n+        # (which could happen if enough superfluous slashes were added\n+        # elsewhere)\n+        while [[ \"$filename\" == /* ]]; do\n+            filename=\"${filename#/}\"\n+        done\n+\n         if [ $FIRST -eq 1 ]; then\n             FILE_LIST=\"\\\"$filename\\\"\"\n             FIRST=0\n```",
    "created_at": "2018-08-08T12:40:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499879",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>If nothing else, something like this should do the trick.  But I think I will be rewriting a chunk of this code anyways...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499880",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I'd be curious if you could figure out exactly which part is behaving differently in your bash? What happens with `filename=\"${filename#$PREFIX}`.  Not even necessarily in this script, but just in general? What does something like:\n\n```\nPREFIX=/a/\nfilename=/a/b\nfilename=${filename#$PREFIX}\necho \"$filename\"\n```\n\nIf that returns anything other than just `b` this is a bug in your bash I think.\n\n> Is there an issue with just using `lstrip(os.sep)` as my branch does?\n\n\nThe point is that shouldn't even be necessary.  It might not be a bad idea anyways just as a sanity check, though I might also issue a warning.  The intent is that these files contain a list of relative paths.  If they don't then the files are malformatted, which means the real problem is in the code producing those files (whether the bug ultimately originates from a buggy bash or not).",
    "created_at": "2018-08-08T16:23:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499881",
    "user": "https://github.com/embray"
}
```

<a id='comment:14'></a>I'd be curious if you could figure out exactly which part is behaving differently in your bash? What happens with `filename="${filename#$PREFIX}`.  Not even necessarily in this script, but just in general? What does something like:
...
```json
{
    "body": "<a id='comment:15'></a>Alternatively, it's also possible that your `find` is slipping in some superfluous slashes.",
    "created_at": "2018-08-08T16:36:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499882",
    "user": "https://github.com/embray"
}
```

<a id='comment:15'></a>Alternatively, it's also possible that your `find` is slipping in some superfluous slashes.
...
```json
{
    "body": "<a id='comment:16'></a>This seems to suggest that it is in fact the `find` at fault: https://apple.stackexchange.com/a/254224/44101",
    "created_at": "2018-08-08T16:39:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499883",
    "user": "https://github.com/embray"
}
```

<a id='comment:16'></a>This seems to suggest that it is in fact the `find` at fault: https://apple.stackexchange.com/a/254224/44101
...
```json
{
    "body": "Changing commit from \"40e0cfb75ef3a0a18f9ba00ad9a1eabcf5d7fc41\" to \"48f7cdc4f7f80041ba843b459696415cac488e55\"",
    "created_at": "2018-08-08T17:55:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499885",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "40e0cfb75ef3a0a18f9ba00ad9a1eabcf5d7fc41" to "48f7cdc4f7f80041ba843b459696415cac488e55"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499886",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Your patch works for me. Here is a new branch.",
    "created_at": "2018-08-08T17:55:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499887",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:19'></a>Your patch works for me. Here is a new branch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499888",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499889",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499890",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26013#event-64997"
}
```
...
```json
{
    "body": "Changing branch from \"u/jhpalmieri/spkg-uninstall-os-sep\" to \"48f7cdc4f7f80041ba843b459696415cac488e55\"",
    "created_at": "2018-08-11T16:55:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499891",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jhpalmieri/spkg-uninstall-os-sep" to "48f7cdc4f7f80041ba843b459696415cac488e55"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26013#issuecomment-499892",
    "user": "https://github.com/vbraun"
}
```
