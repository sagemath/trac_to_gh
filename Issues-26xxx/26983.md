# Issue 26983: GAP pexpect interface hangs when xgap is loaded

archive/issues_026746.json:
```json
{
    "body": "The pexpect interface hangs when xgap is loaded. That is known, which is why the loading of xgap should be prevented by adding it to `ExcludeFromAutoload`. Unfortunately that doesn't work in all cases, presumably when `xgap` is dependency of another package.\n\nInstead `PackagesToIgnore` should be used, which just pretends the package is not there at all.\n\nCC:  @embray @kiwifb\n\nKeywords: gap\n\nStatus: needs_info\n\nIssue created by migration from https://trac.sagemath.org/ticket/26983\n\n",
...
```json
{
    "body": "<a id='comment:1'></a>Even if I install gap without `xgap`, I get apparently related failures. For example `PermutationGroup(['(1,2,3)(4,5)', '(3,4)']).order()` will give the `\"this should never happen\"` warning that is thrown when ``@`w GAP is trying to send a Window command` and the interface hangs again.\n\nWhy don't we pass `-A` to sage and then load the necessary packages explicitly?  I see that it was done in 5e61d7b6a0da3aa53d8176fa1fb9353cc559b098 but apparently didn't end up in the final version.",
    "created_at": "2019-01-02T14:42:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518693",
    "user": "https://github.com/timokau"
}
```

<a id='comment:1'></a>Even if I install gap without `xgap`, I get apparently related failures. For example `PermutationGroup(['(1,2,3)(4,5)', '(3,4)']).order()` will give the `"this should never happen"` warning that is thrown when ``@`w GAP is trying to send a Window command` and the interface hangs again.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518695",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Does it matter, from your perspective, if some sage doctests fail depending on which GAP packages are installed?\n\nThe issue with IO is known, for example, and has a fix that just hasn't been included yet since there is no SPKG that installs the IO package.  See[comment:424](#comment%3A424):ticket:22626 and #26930",
    "created_at": "2019-01-03T18:10:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518699",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>Does it matter, from your perspective, if some sage doctests fail depending on which GAP packages are installed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518700",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518702",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518703",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518704",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66924"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518705",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66926"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66927"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66928"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518706",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Moving tickets to milestone sage-9.2 based on a review of last modification date, branch status, and severity.",
    "created_at": "2020-05-01T04:28:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518707",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:16'></a>Moving tickets to milestone sage-9.2 based on a review of last modification date, branch status, and severity.
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66930"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66931"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66932"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66933"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Moving this ticket to 9.4, as it seems unlikely that it will be merged in 9.3, which is in the release candidate stage",
    "created_at": "2021-04-02T20:21:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518708",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:18'></a>Moving this ticket to 9.4, as it seems unlikely that it will be merged in 9.3, which is in the release candidate stage
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66934"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66935"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66936"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66937"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518709",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66938"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66939"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26983#issuecomment-518710",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66940"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66941"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66942"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26983#event-66943"
}
```
