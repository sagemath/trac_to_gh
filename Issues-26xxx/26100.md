...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[db33b02](https://git.sagemath.org/sage.git/commit?id=db33b02267fec6c5aa9c7dd63986c5653ca9dd55)|`Try loading maxima.fas from the standard ecl module dir if the path set in MAXIMA_FAS doesn't exist`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[c54ebae](https://git.sagemath.org/sage.git/commit/?id=c54ebaeccbeff854ac280bcf1a963e2b150871f7)|`Don't set ECLDIR and MAXIMA_FAS by default in env.py`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[5b9d903](https://git.sagemath.org/sage.git/commit/?id=5b9d9033ec64d676b9813653ec7d4896cfb8f378)|`Use 'if MAXIMA_FAS is not None'`|",
    "created_at": "2018-08-24T17:04:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26100",
    "type": "issue_comment",
