...
```json
{
    "body": "<a id='comment:2'></a>\nThe adapted version of the free nilpotent Lie algebra construction is in the commits. I removed the parameter `free` from the method `sage.algebras.lie_algebras.nilpotent_lie_algebra.NilpotentLieAlgebra` of #26074, as the parameter seemed to be redundant.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|\n|[19c27eb](https://git.sagemath.org/sage.git/commit?id=19c27ebb9f0952df7ab9e607a94574f6b8d1c5cf)|`New subcategories of Lie algebras (nilpotent, graded, stratified) and a base class for nilpotent Lie algebras`|\n|[f58cddd](https://git.sagemath.org/sage.git/commit?id=f58cdddb0eb08c123662d55f7c1fa4cacb0380d1)|`Implementation of the construction of free nilpotent Lie algebras`|\n|[cb8a103](https://git.sagemath.org/sage.git/commit?id=cb8a1030ea0da83777e06bbf8aea9876819b2567)|`Changed doctests to use free nilpotent Lie algebras as more natural examples of graded or stratified Lie algebras`|",
    "created_at": "2018-08-17T11:59:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26076",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[a5ec3ad](https://git.sagemath.org/sage.git/commit/?id=a5ec3adf73a86bd3e2175be25c47966a85d08f13)|`Moving the axioms around for better printing.`|\n|[09b54f5](https://git.sagemath.org/sage.git/commit/?id=09b54f536e775b1f7c6b267ac25a77fbbdd52c99)|`Merge remote-tracking branch 'trac/public/lie_algebras/base_class_nilponent-26074' into u/gh-ehaka/free_nilpotent_lie_algebras-26076`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[b70bebd](https://git.sagemath.org/sage.git/commit/?id=b70bebd70696d8d22a58b422f90c701cb459f2db)|`doctest fix for changed category printing`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[664fbec](https://git.sagemath.org/sage.git/commit/?id=664fbeceb2594310cb95ffe1df434e41ceb5ebbd)|`Changing r=10 as cutoff to requiring a linear ordering.`|",
