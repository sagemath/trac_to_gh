...
```json
{
    "body": "<a id='comment:1'></a>Opinions?",
    "created_at": "2018-08-17T11:01:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501197",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>Opinions?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501198",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Duplicate of #18438?",
    "created_at": "2018-08-23T12:37:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501199",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>Duplicate of #18438?
...
```json
{
    "body": "<a id='comment:4'></a>I'll have to check out Volker's branch there.  Something like `sage-system-python` is one possible solution I considered (on that I'm still not entirely happy with but it's better than nothing).",
    "created_at": "2018-08-23T12:52:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501200",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>I'll have to check out Volker's branch there.  Something like `sage-system-python` is one possible solution I considered (on that I'm still not entirely happy with but it's better than nothing).
...
```json
{
    "body": "<a id='comment:5'></a>I'm seeing this rather frequently now. The race was there for a long time but its getting more likely to hit.",
    "created_at": "2018-08-24T21:12:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501201",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:5'></a>I'm seeing this rather frequently now. The race was there for a long time but its getting more likely to hit.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26083#event-65102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501202",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26083#event-65103"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>IF we're going to close this ticket (which is fine) the milestone / priority on the existing ticket should also be updated, and maybe link to this ticket which I believe adds more context.",
    "created_at": "2018-08-30T11:57:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26083#issuecomment-501203",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>IF we're going to close this ticket (which is fine) the milestone / priority on the existing ticket should also be updated, and maybe link to this ticket which I believe adds more context.
