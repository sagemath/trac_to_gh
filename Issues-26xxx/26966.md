...
```json
{
    "body": "<a id='comment:2'></a>I don't know if this branch is the correct approach, but it helps. If it is the correct approach, it is incomplete: at #26966, I included a list of some of the methods which need attention paid to how vertices are sorted:\n\n- product\n- join\n- disjoint_union\n- wedge\n- connected_sum\n- link\n- star\n- generated_subcomplex\n- alexander_dual\n- stellar_subdivision\n- n_skeleton\n- connected_component\n- fixed_complex\n- intersection\n- `_contractible_subcomplex`\n- `_enlarge_subcomplex`\n- `__copy__`\n\nThis list may not be complete, and the branch here only deals with a few of these.",
    "created_at": "2018-12-29T21:40:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518394",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>I don't know if this branch is the correct approach, but it helps. If it is the correct approach, it is incomplete: at #26966, I included a list of some of the methods which need attention paid to how vertices are sorted:
...
```json
{
    "body": "Changing branch from \"\" to \"u/jhpalmieri/sorting-simplicial-complexes\"",
    "created_at": "2018-12-29T21:42:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518395",
    "user": "https://github.com/jhpalmieri"
}
```

Changing branch from "" to "u/jhpalmieri/sorting-simplicial-complexes"
...
```json
{
    "body": "Changing commit from \"\" to \"b41b33c4bfc020fcfc0e6eda1110d07875f2efde\"",
    "created_at": "2018-12-30T01:31:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518396",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "b41b33c4bfc020fcfc0e6eda1110d07875f2efde"
...
```json
{
    "body": "<a id='comment:5'></a>Do you know why unsortable lists of vertices are so common in simplicial complexes? Is there a single place where these mixed `int`/`str` vertices come from?",
    "created_at": "2018-12-30T01:40:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518398",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Do you know why unsortable lists of vertices are so common in simplicial complexes? Is there a single place where these mixed `int`/`str` vertices come from?
...
```json
{
    "body": "<a id='comment:6'></a>For example, in `MooreSpace`, the obvious solution to me is to use only strings as vertices, i.e. replace `1` by `\"1\"`.",
    "created_at": "2018-12-30T01:42:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518399",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>For example, in `MooreSpace`, the obvious solution to me is to use only strings as vertices, i.e. replace `1` by `"1"`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518400",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518401",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518402",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518404",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>If the only requirement is a predictable ordering, you could have a dict mapping arbitrary vertices to integers and use that to sort.",
    "created_at": "2019-01-02T18:30:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518406",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>If the only requirement is a predictable ordering, you could have a dict mapping arbitrary vertices to integers and use that to sort.
...
```json
{
    "body": "<a id='comment:14'></a>For example, the already-existing attribute `_vertex_set` could be used for that: we could implement a `set`-like class which internally uses a `dict` to store a `vertex: index` mapping.",
    "created_at": "2019-01-02T18:36:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518407",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>For example, the already-existing attribute `_vertex_set` could be used for that: we could implement a `set`-like class which internally uses a `dict` to store a `vertex: index` mapping.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518408",
...
```json
{
    "body": "Changing commit from \"b41b33c4bfc020fcfc0e6eda1110d07875f2efde\" to \"99eec7ba0857330654daf942d89c9160981bc19b\"",
    "created_at": "2019-01-03T19:22:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518409",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b41b33c4bfc020fcfc0e6eda1110d07875f2efde" to "99eec7ba0857330654daf942d89c9160981bc19b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518411",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518412",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518413",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518414",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>1. What's the use case for trying to sort anyway? That way, you make doctests different on Python 2 and Python 3 for no good reason.\n\n2. Use dict comprehension instead of `dict((x,y) ....)` for example here:\n\n```\n        vertex_to_index = dict((vertex, i) for i, vertex\n                               in enumerate(vertices))\n```\n\n3. `self._vertex_to_index` seems redundant with `self._vertex_set`. It seems that `self._vertex_to_index` could replace `self._vertex_set`.",
    "created_at": "2019-01-03T20:12:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518415",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>1. What's the use case for trying to sort anyway? That way, you make doctests different on Python 2 and Python 3 for no good reason.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518416",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518417",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"99eec7ba0857330654daf942d89c9160981bc19b\" to \"6bb3e28d7a95cc11ec1dd7a1040fca1901d50d8d\"",
    "created_at": "2019-01-04T01:14:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518418",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "99eec7ba0857330654daf942d89c9160981bc19b" to "6bb3e28d7a95cc11ec1dd7a1040fca1901d50d8d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518419",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518420",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518421",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518422",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518424",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Any suggestions, then? I suppose we could delete all of the simplicial complex code.",
    "created_at": "2019-01-09T16:25:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518425",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:26'></a>Any suggestions, then? I suppose we could delete all of the simplicial complex code.
...
```json
{
    "body": "<a id='comment:27'></a>I could do the sort of test you gave: compare `sorted(vertices, key=str)` with `sorted(reversed(vertices), key=str)` (or using whatever key is appropriate). If this is `False`, print a warning when constructing the product of a complex with itself.\n\nI don't know of any other case in which the sorting makes a difference. For homology, for example, the facets are sorted once in the `__init__` method, and that sorting is all that is necessary.",
    "created_at": "2019-01-09T18:39:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518426",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:27'></a>I could do the sort of test you gave: compare `sorted(vertices, key=str)` with `sorted(reversed(vertices), key=str)` (or using whatever key is appropriate). If this is `False`, print a warning when constructing the product of a complex with itself.
...
```json
{
    "body": "<a id='comment:30'></a>Jeroen - this might need a novel definition for homology to work smoothly...\n\nI'd say: always sort. This \"unsortable\" insanity of py3 has already taken its toll on the progress of porting to py3.",
    "created_at": "2019-01-10T12:30:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518429",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:30'></a>Jeroen - this might need a novel definition for homology to work smoothly...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518430",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>The vertex sorting is needed but just for one thing: for the diagonal map `X -> X x X` to be defined properly. If you sort the vertices in the product incompatibly with the sorting in the original simplicial complex, you can end up with a square triangulated the wrong way, so the diagonal map is not a map of simplicial complexes. So you really do need to sort the vertices.\n\nAs Jeroen says in his last comment, the `vertex_to_index` dictionary is sufficient sorting for homology.",
    "created_at": "2019-01-10T16:06:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518431",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:32'></a>The vertex sorting is needed but just for one thing: for the diagonal map `X -> X x X` to be defined properly. If you sort the vertices in the product incompatibly with the sorting in the original simplicial complex, you can end up with a square triangulated the wrong way, so the diagonal map is not a map of simplicial complexes. So you really do need to sort the vertices.
...
```json
{
    "body": "<a id='comment:33'></a>Or maybe there is a way to use the `vertex_to_index` sorting when defining the product, although that take some work to implement. I'll have to think about that.",
    "created_at": "2019-01-10T16:09:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518432",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:33'></a>Or maybe there is a way to use the `vertex_to_index` sorting when defining the product, although that take some work to implement. I'll have to think about that.
...
```json
{
    "body": "Changing commit from \"6bb3e28d7a95cc11ec1dd7a1040fca1901d50d8d\" to \"f4a672c94202bae95cb00c07e7318211f50ca9b0\"",
    "created_at": "2019-01-11T23:09:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518433",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6bb3e28d7a95cc11ec1dd7a1040fca1901d50d8d" to "f4a672c94202bae95cb00c07e7318211f50ca9b0"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518434",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518436",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"f4a672c94202bae95cb00c07e7318211f50ca9b0\" to \"41eeaf587878efcdec3499b49353bfe1dfeb7993\"",
    "created_at": "2019-01-11T23:13:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518437",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "f4a672c94202bae95cb00c07e7318211f50ca9b0" to "41eeaf587878efcdec3499b49353bfe1dfeb7993"
...
```json
{
    "body": "<a id='comment:38'></a>By the way, a few doctests were changed from a known output to a random output or to ellipses. In these cases, the answer will depend on, for example, how the vertices are sorted in\n\n```\nvertex_to_index = {v:i for i,v in enumerate(vertices)}\n```\nwhich is more or less random. It can certainly depend on whether you are using Python 2 vs. Python 3, and at least with Python 3, it will be random.",
    "created_at": "2019-01-11T23:30:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518439",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:38'></a>By the way, a few doctests were changed from a known output to a random output or to ellipses. In these cases, the answer will depend on, for example, how the vertices are sorted in
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518441",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"41eeaf587878efcdec3499b49353bfe1dfeb7993\" to \"95f6026404128b5fb82ddc27aa741fd2c20a4978\"",
    "created_at": "2019-01-13T19:38:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518442",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "41eeaf587878efcdec3499b49353bfe1dfeb7993" to "95f6026404128b5fb82ddc27aa741fd2c20a4978"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518443",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518444",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>Retarging tickets optimistically to the next milestone.  If you are responsible for this ticket (either its reporter or owner) and don't believe you are likely to complete this ticket before the next release (8.7) please retarget this ticket's milestone to sage-pending or sage-wishlist.",
    "created_at": "2019-01-15T18:15:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518445",
    "user": "https://github.com/embray"
}
```

<a id='comment:43'></a>Retarging tickets optimistically to the next milestone.  If you are responsible for this ticket (either its reporter or owner) and don't believe you are likely to complete this ticket before the next release (8.7) please retarget this ticket's milestone to sage-pending or sage-wishlist.
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26966#event-66879"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518447",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Changing commit from \"95f6026404128b5fb82ddc27aa741fd2c20a4978\" to \"3da1d0f108449360fb575d64be78eacf89109cd3\"",
    "created_at": "2019-01-15T23:12:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518448",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "95f6026404128b5fb82ddc27aa741fd2c20a4978" to "3da1d0f108449360fb575d64be78eacf89109cd3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518449",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518450",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518451",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518452",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Great, thanks for reviewing!",
    "created_at": "2019-01-16T00:42:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518453",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:48'></a>Great, thanks for reviewing!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26966#event-66880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518454",
...
```json
{
    "body": "Changing branch from \"u/jhpalmieri/sorting-simplicial-complexes\" to \"3da1d0f108449360fb575d64be78eacf89109cd3\"",
    "created_at": "2019-01-23T15:39:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26966#issuecomment-518455",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jhpalmieri/sorting-simplicial-complexes" to "3da1d0f108449360fb575d64be78eacf89109cd3"
