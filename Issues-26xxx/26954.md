...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|\n|[2436a0e](https://git.sagemath.org/sage.git/commit/?id=2436a0e87776da0e881b1a5edebad26dfa9aef26)|`Disable isl when building gfortran to avoid inconsistently building gfortran with sage's optional isl package.`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[83dfeb9](https://git.sagemath.org/sage.git/commit/?id=83dfeb9eef485e41a7d49c041f03eb9545ea3ba9)|`Update gcc to 7.4`|\n|[8154dda](https://git.sagemath.org/sage.git/commit/?id=8154ddac0c619de1dec417c7c10463dff912ed4c)|`isl patch is in gcc 7.4`|\n|[efc63b8](https://git.sagemath.org/sage.git/commit/?id=efc63b8a5e5252c41c648815541bf6fca48f15c9)|`Disable isl when building gcc to avoid inconsistently building gcc with sage's optional isl package. See also #26735.`|",
