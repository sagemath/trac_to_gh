...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26954#event-352231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26954#event-352232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26954#event-352233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26954#event-352234"
}
```
...
```json
{
    "body": "Changed keywords from **** to **upgrade, gcc, gfortran, isl**",
...
Changed keywords from **** to **upgrade, gcc, gfortran, isl**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26954#issuecomment-418453",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26954#issuecomment-418454",
    "user": "https://github.com/vbraun"
}
```
