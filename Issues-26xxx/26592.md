...
```json
{
    "body": "<a id='comment:1'></a>The whole https://math.ccrwest.org was down for a few days. It's back up now.",
    "created_at": "2018-10-31T15:03:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511091",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>The whole https://math.ccrwest.org was down for a few days. It's back up now.
...
```json
{
    "body": "<a id='comment:2'></a>This needs some Python 3 love now though.\n\nHere's what I get with a Python3-based Sage:\n\n```\nsage: print(version())\nSageMath version 8.5.beta1, Release Date: 2018-10-27\nsage: print(sys.version)\n3.6.6 (default, Oct 27 2018, 01:34:38)\n[GCC 4.2.1 Compatible Apple LLVM 7.0.2 (clang-700.1.81)]\nsage: C = designs.best_known_covering_design_from_LJCR(7, 3, 2)\n---------------------------------------------------------------------------\nTypeError                                 Traceback (most recent call last)\n<ipython-input-1-a3d9f9e592f1> in <module>()\n----> 1 C = designs.best_known_covering_design_from_LJCR(Integer(7), Integer(3), Integer(2))\n\n/opt/s/sage/local/lib/python3.6/site-packages/sage/combinat/designs/covering_design.py in best_known_covering_design_www(v, k, t, verbose)\n    505     f.close()\n    506\n--> 507     if 'covering not in database' in s:   #not found\n    508         str = \"no (%d,%d,%d) covering design in database\\n\"%(v,k,t)\n    509         raise ValueError(str)\n\nTypeError: a bytes-like object is required, not 'str'\n```",
    "created_at": "2018-10-31T15:05:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511092",
    "user": "https://github.com/slel"
}
```

<a id='comment:2'></a>This needs some Python 3 love now though.
...
```json
{
    "body": "<a id='comment:3'></a>Feel free to repurpose the present ticket for that.",
    "created_at": "2018-10-31T15:08:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511093",
    "user": "https://github.com/slel"
}
```

<a id='comment:3'></a>Feel free to repurpose the present ticket for that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511094",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511095",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Ok, I updated the goal of this ticket as suggested.",
    "created_at": "2018-11-20T08:17:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511096",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>Ok, I updated the goal of this ticket as suggested.
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26592#event-66003"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>As suggested in #26502#comment:8, the url address apparently changed to:\n\n\u200bhttp://dmgordon.org/cover/\n\nSo we need to redo the changes that were made in #26502 in order to fix this issue.",
    "created_at": "2019-03-07T08:33:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511097",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:6'></a>As suggested in #26502#comment:8, the url address apparently changed to:
...
```json
{
    "body": "<a id='comment:8'></a>I just emailed Dan Gordon to report the various issues we are trying to tackle here:\n\n- http vs https\n- `get_cover.php` seems gone from http://ljcr.dmgordon.org/cover/\n  (`show_cover.php` returns some html-formatted string)",
    "created_at": "2019-03-07T13:53:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511099",
    "user": "https://github.com/slel"
}
```

<a id='comment:8'></a>I just emailed Dan Gordon to report the various issues we are trying to tackle here:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511101",
    "user": "https://github.com/vinklein"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>It's feasible but calling `get_cover.php` will be far cleaner.\\\\\nAnother concern for me is that without https, given that the current code call `sage_eval` on the result, this code look like an open door to inject any (sage) code you want on a sage user's computer.",
    "created_at": "2019-03-07T16:23:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511103",
    "user": "https://github.com/vinklein"
}
```

<a id='comment:12'></a>It's feasible but calling `get_cover.php` will be far cleaner.\\
Another concern for me is that without https, given that the current code call `sage_eval` on the result, this code look like an open door to inject any (sage) code you want on a sage user's computer.
...
```json
{
    "body": "<a id='comment:15'></a>* do not break the import line\n\n* OR tag the first line of the import\n\n* OR use optional=sage,internet ?",
    "created_at": "2019-03-09T06:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511106",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:15'></a>* do not break the import line
...
```json
{
    "body": "Changing branch from \"\" to \"u/vklein/26592\"",
    "created_at": "2019-03-11T09:24:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511108",
    "user": "https://github.com/vinklein"
}
```

Changing branch from "" to "u/vklein/26592"
...
```json
{
    "body": "<a id='comment:18'></a>The py2 and py3 tests pass with branch u/vklein/26592.\\\\\n\nI will now look for a way to avoid calling `sage_eval` on a internet given result.\\\\\nIt really looks like an highway for code injection to me.\n\n---\nNew commits:",
    "created_at": "2019-03-11T09:32:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511109",
    "user": "https://github.com/vinklein"
}
```

<a id='comment:18'></a>The py2 and py3 tests pass with branch u/vklein/26592.\\
...
```json
{
    "body": "Changing commit from \"\" to \"27eeb10c43f0a090de107ebd5f427ad26de3bf53\"",
    "created_at": "2019-03-11T09:32:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511110",
    "user": "https://github.com/vinklein"
}
```

Changing commit from "" to "27eeb10c43f0a090de107ebd5f427ad26de3bf53"
...
```json
{
    "body": "<a id='comment:19'></a>Constructing \"manually\" the `CoveringDesign` is not that easy because his `__init__` function has eleven named parameters with default values, that mean there is a lot of potential string format that `get_cover.php` could return.\n\nDo we know if get_cover.php always return a string in the form \"CoveringDesign(<all init parameters positionally>)\" ?",
    "created_at": "2019-03-11T14:31:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511111",
    "user": "https://github.com/vinklein"
}
```

<a id='comment:19'></a>Constructing "manually" the `CoveringDesign` is not that easy because his `__init__` function has eleven named parameters with default values, that mean there is a lot of potential string format that `get_cover.php` could return.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511112",
    "user": "https://github.com/vinklein"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26592#event-66004"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26592#event-66005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511113",
...
```json
{
    "body": "Changing branch from \"u/vklein/26592\" to \"u/slelievre/26592\"",
    "created_at": "2019-04-15T02:03:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511114",
    "user": "https://github.com/slel"
}
```

Changing branch from "u/vklein/26592" to "u/slelievre/26592"
...
```json
{
    "body": "Changing commit from \"27eeb10c43f0a090de107ebd5f427ad26de3bf53\" to \"e863721bac6eca92b83d17a220692c127dffc88d\"",
    "created_at": "2019-04-15T02:07:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511115",
    "user": "https://github.com/slel"
}
```

Changing commit from "27eeb10c43f0a090de107ebd5f427ad26de3bf53" to "e863721bac6eca92b83d17a220692c127dffc88d"
...
```json
{
    "body": "<a id='comment:24'></a>New branch based on Sage 8.8.beta2.\n\nA first commit does pep8 reformatting + updating urls.\n\nThe second commit has the actual `bytes_to_str` fix in\n`best_known_covering_design_www` and a minor\nimprovement to `is_covering`.\n\nPlease review.\n\n---\nNew commits:",
    "created_at": "2019-04-15T02:07:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511116",
    "user": "https://github.com/slel"
}
```

<a id='comment:24'></a>New branch based on Sage 8.8.beta2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511117",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>There is no point in these being in-line imports: \n\n```\n     from six.moves.urllib.request import urlopen\n-\n+    from sage.cpython.string import bytes_to_str\n```\n\nThose modules are always loaded by Sage so they might as well go at the module-level.",
    "created_at": "2019-04-16T16:18:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511118",
    "user": "https://github.com/embray"
}
```

<a id='comment:25'></a>There is no point in these being in-line imports: 
...
```json
{
    "body": "Changing commit from \"e863721bac6eca92b83d17a220692c127dffc88d\" to \"a69f4ecdf33625f037bbad1375c6b3f24a5b5f12\"",
    "created_at": "2019-04-17T08:24:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511119",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e863721bac6eca92b83d17a220692c127dffc88d" to "a69f4ecdf33625f037bbad1375c6b3f24a5b5f12"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511120",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Like this?",
    "created_at": "2019-04-17T08:24:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511121",
    "user": "https://github.com/slel"
}
```

<a id='comment:27'></a>Like this?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511123",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Or we could link to the copy archived at the Internet Archive's Wayback Machine:\n\n- https://web.archive.org/web/20170829210149/https://www.ccrwest.org/gordon/hcd.pdf",
    "created_at": "2019-04-28T08:46:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511124",
    "user": "https://github.com/slel"
}
```

<a id='comment:30'></a>Or we could link to the copy archived at the Internet Archive's Wayback Machine:
...
```json
{
    "body": "<a id='comment:31'></a>Replying to [slelievre](#comment%3A29):\n> Replying to [chapoton](#comment%3A28):\n> > This line:\n> > \n> > ```\n> > https://drive.google.com/file/d/0B6s9_JNV1EjtUFd4MkhBc0hSdVU/view\n> > ```\n> > is not something that we should link to.\n\n> \n> Other options I can see are the following:\n> \n> - Dan Gordon's publications page: https://www.dmgordon.org/Publications/\n\n\nYes, this one is better. One should also give the title (Coverings, chapter 1 of whatever)",
    "created_at": "2019-04-28T10:09:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511125",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:31'></a>Replying to [slelievre](#comment%3A29):
> Replying to [chapoton](#comment%3A28):
> > This line:
> > 
> > ```
...
```json
{
    "body": "<a id='comment:32'></a>Having my papers on google drive was the last part of my website that I hadn't updated.  I've moved them now, so that paper can now be linked to at [https://www.dmgordon.org/papers/hcd.pdf](https://www.dmgordon.org/papers/hcd.pdf).",
    "created_at": "2019-04-29T21:25:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511126",
    "user": "https://trac.sagemath.org/admin/accounts/users/dgordon"
}
```

<a id='comment:32'></a>Having my papers on google drive was the last part of my website that I hadn't updated.  I've moved them now, so that paper can now be linked to at [https://www.dmgordon.org/papers/hcd.pdf](https://www.dmgordon.org/papers/hcd.pdf).
...
```json
{
    "body": "Changing commit from \"a69f4ecdf33625f037bbad1375c6b3f24a5b5f12\" to \"1f3afa8ed60c5ab665a2d7ed3421323fe21dd6c1\"",
    "created_at": "2019-05-01T00:31:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511127",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a69f4ecdf33625f037bbad1375c6b3f24a5b5f12" to "1f3afa8ed60c5ab665a2d7ed3421323fe21dd6c1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511128",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Updated now, please review.",
    "created_at": "2019-05-01T00:32:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511129",
    "user": "https://github.com/slel"
}
```

<a id='comment:34'></a>Updated now, please review.
...
```json
{
    "body": "<a id='comment:35'></a>ok, thx",
    "created_at": "2019-05-01T06:47:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511130",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:35'></a>ok, thx
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511131",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511132",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511133",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26592#event-66006"
}
```
...
```json
{
    "body": "Changing branch from \"u/slelievre/26592\" to \"1f3afa8ed60c5ab665a2d7ed3421323fe21dd6c1\"",
    "created_at": "2019-05-06T11:56:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511134",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/slelievre/26592" to "1f3afa8ed60c5ab665a2d7ed3421323fe21dd6c1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511135",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"1f3afa8ed60c5ab665a2d7ed3421323fe21dd6c1\" to \"\"",
    "created_at": "2019-05-13T13:29:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511136",
    "user": "https://github.com/seblabbe"
}
```

Changing commit from "1f3afa8ed60c5ab665a2d7ed3421323fe21dd6c1" to ""
...
```json
{
    "body": "<a id='comment:38'></a>I think so `with urelopen(url) as...` syntax has been introduced with commit `e863721`.\\\\\n\nIt should be avoided (see [comment:16](https://trac.sagemath.org/ticket/26592#comment:16))",
    "created_at": "2019-05-13T13:58:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511138",
    "user": "https://github.com/vinklein"
}
```

<a id='comment:38'></a>I think so `with urelopen(url) as...` syntax has been introduced with commit `e863721`.\\
...
```json
{
    "body": "<a id='comment:39'></a>Open a new ticket to fix that #27821",
    "created_at": "2019-05-13T14:10:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26592#issuecomment-511139",
    "user": "https://github.com/vinklein"
}
```

<a id='comment:39'></a>Open a new ticket to fix that #27821
