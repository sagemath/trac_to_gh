...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26155#issuecomment-496275",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26155#issuecomment-496276",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26155#issuecomment-496277",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26155#issuecomment-496278",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nReplying to [jdemeyer](#comment%3A2):\n> I think the best solution would be to have a `globals` argument to `sage_eval` (defaulting to `sage.all.__dict__`) which could be set to `{}` for this specific `sage_eval` call.\n\n\nDone (code pushed to this ticket), but this seems also not the correct solution:\n\n```\nsage: F = QQ['x,y'].fraction_field()\nsage: sage_eval('1 + x/y', locals=F.gens_dict_recursive())\n(x + y)/y\nsage: sage_eval('1 + x/y', locals=F.gens_dict_recursive(), globals={})\nTraceback (most recent call last)\n...\nNameError: name 'Integer' is not defined\n```\n\n---\nNew commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[a0c5489](https://github.com/sagemath/sagetrac-mirror/commit/a0c5489e43d24b03d3bdf7cb68f125cd36cd8490)|`Trac #26155: sage_eval parameter globals`|\n|[c7aae72](https://github.com/sagemath/sagetrac-mirror/commit/c7aae72e93b34aed78d50f906957f295c802baac)|`Trac #26155: set globals={} in element_constructor of fraction_field`|",
    "created_at": "2018-08-30T07:44:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26155#issuecomment-496279",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26155#issuecomment-496280",
    "user": "https://github.com/dkrenn"
}
```
