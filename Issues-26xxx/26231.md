...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390373",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Sorry, I didn't fully read the first part of your message.  I thought for some reason you were explicitly trying to use Tkinter directly.  Regardless, the solution is still basically the same: It shouldn't be importing `_tkinter` at all unless you have some bad `PYTHONPATH` or something.  \n\nAlso maybe a `~/.config/matplotlib` setting the TkAgg backend by default?  I feel like Sage shouldn't be loading the default matplotlib config as it could conflict with other matplotlibs on the system.",
    "created_at": "2018-09-10T14:53:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390374",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>Sorry, I didn't fully read the first part of your message.  I thought for some reason you were explicitly trying to use Tkinter directly.  Regardless, the solution is still basically the same: It shouldn't be importing `_tkinter` at all unless you have some bad `PYTHONPATH` or something.  
...
```json
{
    "body": "<a id='comment:4'></a>Oddly enough, the bug appears without me manually importing tkinter. Just trying to plot a graph, on a clean sage install (compiled from the source tarball).\n\nMaybe at some point matplotlib (or some other component) tries to use tkinter to show plots?",
    "created_at": "2018-09-10T14:53:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390375",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:4'></a>Oddly enough, the bug appears without me manually importing tkinter. Just trying to plot a graph, on a clean sage install (compiled from the source tarball).
...
```json
{
    "body": "<a id='comment:5'></a>(In fact, `sage-env` does set `export MPLCONFIGDIR=\"$DOT_SAGE/matplotlib-1.5.1\"`.  Probably the `sage.env` module should do the same if `MPLCONFIGDIR` is not otherwise set.)",
    "created_at": "2018-09-10T14:55:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390376",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>(In fact, `sage-env` does set `export MPLCONFIGDIR="$DOT_SAGE/matplotlib-1.5.1"`.  Probably the `sage.env` module should do the same if `MPLCONFIGDIR` is not otherwise set.)
...
```json
{
    "body": "<a id='comment:6'></a>I have removed the `.local/matplotlib directory` (it was empty anyways), and checked that I didn't have the `PYTHONPATH` variable set. The problem persists.\n\nI also have the same feeling: for some reason Sage is trying to use tkinter to show the plots, but can't find exactly what is triggering that behaviour.\n\nIn any case, I think there are two orthogonal problems:\n\n1. Sage trying to use tkinter, when it shouldn't\n2. Importing the sage library breaks the ability to import other python libraries.",
    "created_at": "2018-09-10T15:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390377",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:6'></a>I have removed the `.local/matplotlib directory` (it was empty anyways), and checked that I didn't have the `PYTHONPATH` variable set. The problem persists.
...
```json
{
    "body": "<a id='comment:7'></a>The latter isn't a real problem; it's expected.  The former is strange but I think it's something odd on your system configuration.  Starting with the fact that you can apparently import an `_tkinter` module at all.  If you do:\n\n```\nsage -python -c 'import _tkinter; print(_tkinter)'\n```\n\nwhat does it show?",
    "created_at": "2018-09-10T15:10:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390378",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>The latter isn't a real problem; it's expected.  The former is strange but I think it's something odd on your system configuration.  Starting with the fact that you can apparently import an `_tkinter` module at all.  If you do:
...
```json
{
    "body": "<a id='comment:9'></a>Perhaps I'm wrong then. It looks like maybe Python will build the `_tkinter` module automatically if it happens to find working !Tcl/Tk libs somewhere.\n\nMaybe I would err towards *not* doing that, since it can result in inconsistent builds of Sage (some that have Tkinter, some that don't).  Unless we explicitly support it we should disable it.  Also matplotlib should be configured by Sage to use the `'agg'` backend for outputting plots.",
    "created_at": "2018-09-10T15:19:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390380",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Perhaps I'm wrong then. It looks like maybe Python will build the `_tkinter` module automatically if it happens to find working !Tcl/Tk libs somewhere.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390381",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>That makes sense to me.",
    "created_at": "2018-09-10T15:22:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390382",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:10'></a>That makes sense to me.
...
```json
{
    "body": "<a id='comment:11'></a>The `tkinter` module is part of the standard Python library and has been since the 1990s.  Thus Python builds `_tkinter` if it can find the `Tcl/Tk` library and headers, just as it does the `bz2` module or any of its other standard modules that depend on some optional library or another.  I would argue very strongly against disabling building `tkinter` for Sage.  Admittedly, we use it heavily in `SnapPy` so I am no doubt biased, but except for servers that run headless `tkinter` is usually included with Python or trivial to install.",
    "created_at": "2018-09-10T18:02:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390383",
    "user": "https://github.com/NathanDunfield"
}
```

<a id='comment:11'></a>The `tkinter` module is part of the standard Python library and has been since the 1990s.  Thus Python builds `_tkinter` if it can find the `Tcl/Tk` library and headers, just as it does the `bz2` module or any of its other standard modules that depend on some optional library or another.  I would argue very strongly against disabling building `tkinter` for Sage.  Admittedly, we use it heavily in `SnapPy` so I am no doubt biased, but except for servers that run headless `tkinter` is usually included with Python or trivial to install.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390386",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Does anyone know why Sage packages libfreetype in the first place?  Because that's probably the source of the problem here.",
    "created_at": "2018-09-11T13:05:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390389",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>Does anyone know why Sage packages libfreetype in the first place?  Because that's probably the source of the problem here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390390",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390391",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Replying to [comment:18 dunfield]:\n> Replying to [comment:17 embray]:\n> > Does anyone know why Sage packages libfreetype in the first place? \n\n> \n> Unfortunately, I believe it is a requirement of matplotlib itself.  Specifically, a dependency of `matplotlib/ft2font.so`.  It is also used by pillow/PIL.  \n\n\nProbably another good candidate for defaulting to the system lib where possible, rather than using the Sage version.",
    "created_at": "2018-09-11T15:16:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390392",
    "user": "https://github.com/embray"
}
```

<a id='comment:20'></a>Replying to [comment:18 dunfield]:
> Replying to [comment:17 embray]:
> > Does anyone know why Sage packages libfreetype in the first place? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26231#issuecomment-390393",
    "user": "https://github.com/slel"
}
```
