...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343668"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343669"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343671"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26231#issuecomment-407097",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26231#issuecomment-407098",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343673"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343674"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26231#event-343675"
}
```
