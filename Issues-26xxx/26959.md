...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339837"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339839"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339840"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339841"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339842"
}
```
...
archive/issue_events_339843.json:
```json
{
    "actor": "https://github.com/embray",
    "created_at": "2019-03-25T10:44:36Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339843"
}
```
...
archive/issue_events_339844.json:
```json
{
    "actor": "https://github.com/embray",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339844"
}
```
...
archive/issue_events_339845.json:
```json
{
    "actor": "https://github.com/embray",
    "created_at": "2021-02-16T13:39:47Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/26959",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26959#event-339846"
}
```
