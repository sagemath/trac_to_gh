...
<a id='comment:4'></a>It seems useless clutter to have each time two methods for the same thing.
...
```json
{
    "body": "<a id='comment:5'></a>Thanks for the remark. I will create a new ticket to deal with the cleaning up.",
...
<a id='comment:5'></a>Thanks for the remark. I will create a new ticket to deal with the cleaning up.
...
```json
{
    "body": "<a id='comment:6'></a>The ticket is #26259",
...
<a id='comment:6'></a>The ticket is #26259
