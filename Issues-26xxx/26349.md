...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506553",
...
```json
{
    "body": "<a id='comment:2'></a>It would seem the memory management on these objects is rather fundamentally broken.\nAlso with lines like `Y= M+M` or `Y=X+X` I am seeing similar leaking behaviour.",
    "created_at": "2018-09-28T13:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506554",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:2'></a>It would seem the memory management on these objects is rather fundamentally broken.
Also with lines like `Y= M+M` or `Y=X+X` I am seeing similar leaking behaviour.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506555",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65539"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Tested this on Sage 8.7, macOS Mojave and Ubuntu 19.04, and the problem seems to be fixed.\n\nIf someone else could confirm this on another OS (the person on ask used debian buster) then we can probably close this as wontfix.",
    "created_at": "2019-05-07T17:21:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506556",
    "user": "https://github.com/black-stones"
}
```

<a id='comment:3'></a>Tested this on Sage 8.7, macOS Mojave and Ubuntu 19.04, and the problem seems to be fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506557",
...
```json
{
    "body": "<a id='comment:4'></a>Confirmed on Ubuntu 16.04 that I am not seeing a leak.",
    "created_at": "2019-05-08T08:37:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506558",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Confirmed on Ubuntu 16.04 that I am not seeing a leak.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506559",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65540"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65541"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I'm still seeing suspicious behaviour on sage 8.8.beta3 / python3, on Fedora:\n\nIf I set a vmem limit of 10 gigabyte and execute\n\n```\nn = 1000\nX = zero_vector(GF(2), n)\nM = zero_matrix(GF(2), n, n)\n\nfor _ in range(10000000):\n    Y = M + M\n```\nsage still crashes for me (whereas a small number of iterations does run without problem).",
    "created_at": "2019-05-13T17:51:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506560",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:5'></a>I'm still seeing suspicious behaviour on sage 8.8.beta3 / python3, on Fedora:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506561",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65542"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506562",
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65544"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506563",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506564",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506565",
    "user": "https://github.com/sn-d"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506566",
    "user": "https://github.com/sn-d"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506567",
    "user": "https://github.com/sn-d"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506568",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506569",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26349#event-65546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506570",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26349#issuecomment-506571",
    "user": "https://github.com/vbraun"
}
```
