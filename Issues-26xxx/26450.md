...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket26450/cython-0.28.4.log",
    "created_at": "2018-10-09T22:55:05Z",
    "issue": "https://github.com/sagemath/sage/issues/26450",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket26450/cython-0.28.4.log",
    "user": "https://github.com/Konrad127123"
}
```
...
```json
{
    "body": "Attachment [cython-0.28.4.log](https://github.com/sagemath/sage/files/ticket26450/cython-0.28.4.log) by @Konrad127123 created at 2018-10-09 22:55:05",
    "created_at": "2018-10-09T22:55:05Z",
    "issue": "https://github.com/sagemath/sage/issues/26450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26450#issuecomment-410390",
    "user": "https://github.com/Konrad127123"
}
```

Attachment [cython-0.28.4.log](https://github.com/sagemath/sage/files/ticket26450/cython-0.28.4.log) by @Konrad127123 created at 2018-10-09 22:55:05
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26450#event-234002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26450",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26450#event-234003"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26450#issuecomment-410391",
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26450#event-234004"
}
```
