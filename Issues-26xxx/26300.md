...
```json
{
    "body": "<a id='comment:2'></a>It is a bug to raise an error in a cdef method that has no `except` value. However, not raising the error in `handle_call` does not make the side-effect disappear.",
    "created_at": "2018-09-17T12:41:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26300#issuecomment-505740",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>It is a bug to raise an error in a cdef method that has no `except` value. However, not raising the error in `handle_call` does not make the side-effect disappear.
...
```json
{
    "body": "<a id='comment:3'></a>Adding an `except` value to call_handle does have the effect that the error message changes to \"Error calling singular function\", which is not very informative. The side-effect however remains.",
    "created_at": "2018-09-17T12:44:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26300#issuecomment-505741",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>Adding an `except` value to call_handle does have the effect that the error message changes to "Error calling singular function", which is not very informative. The side-effect however remains.
...
```json
{
    "body": "<a id='comment:4'></a>I found that the line \"skipping text from `parameter`\" is printed during the line\n\n```\n         cdef bint error = iiMake_proc(self.proc_idhdl, NULL, argument_list.args)\n```\nin `LibraryCallHandler.handle_call`.\n\nIs `iiMake_proc` from libsingular? Then perhaps the side-effect is a bug in libsingular, not Sage.",
    "created_at": "2018-09-17T13:02:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26300#issuecomment-505742",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>I found that the line "skipping text from `parameter`" is printed during the line
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26300#issuecomment-505743",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I also tried to create a sequence of singular_function calls, but couldn't reproduce the side-effect. Really tricky.",
    "created_at": "2018-09-17T14:17:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26300#issuecomment-505745",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>I also tried to create a sequence of singular_function calls, but couldn't reproduce the side-effect. Really tricky.
