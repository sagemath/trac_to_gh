...
```json
{
    "body": "<a id='comment:1'></a>In order to illustrate my point, I post a code (written in pure python) which is a little bit faster than the current implementation:\n\n```\ndef my_expansion(elt):\n    if elt.valuation() != 0:\n        raise NotImplementedError\n    parent = elt.parent()\n    e = parent.absolute_e()\n    prec = elt.precision_absolute()\n    curprec = 0\n    pie = parent.uniformizer_pow(e)\n    expansion = [ ]\n    while curprec < prec:\n        poly = elt._poly_rep()\n        expansion += [ poly[i].residue() for i in range(min(e,prec-curprec)) ]\n        elt //= pie\n        curprec += e\n    return expansion\n```",
    "created_at": "2018-08-07T08:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26015#issuecomment-499897",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:1'></a>In order to illustrate my point, I post a code (written in pure python) which is a little bit faster than the current implementation:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26015#issuecomment-499898",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26015#issuecomment-499899",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Mistaken push from wrong ticket.",
    "created_at": "2019-09-13T23:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26015#issuecomment-499900",
    "user": "https://github.com/roed314"
}
```

<a id='comment:4'></a>Mistaken push from wrong ticket.
...
```json
{
    "body": "Changing branch from \"u/roed/26105_base_hom\" to \"\"",
    "created_at": "2019-09-13T23:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26015#issuecomment-499901",
    "user": "https://github.com/roed314"
}
```

Changing branch from "u/roed/26105_base_hom" to ""
