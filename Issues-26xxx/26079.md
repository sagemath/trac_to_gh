...
```json
{
    "body": "<a id='comment:2'></a>\nAn initial implementation in the commits. The Lie algebra that the quotient was created from is stored  for internal use in the `__ambient` attribute instead of `_ambient` as the latter is being used in `product_space` in `sage.categories.algebras.finite_dimensional_lie_algebras_with_basis`, which caused issues with e.g. lower central series computations for quotient Lie algebras.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|\n|[69dfbfe](https://git.sagemath.org/sage.git/commit?id=69dfbfe2257f97f1ea5fec495f3a1909558214c8)|`Preserve nilpotent category for ideals and subalgebras of nilpotent Lie algebras`|\n|[a0d60e1](https://git.sagemath.org/sage.git/commit?id=a0d60e1f775af58e648f1c062d6128a2f164217d)|`Refactored subobject computations to use lift and retract instead of value`|\n|[5957697](https://git.sagemath.org/sage.git/commit?id=59576970729d4378562773cc04af617b183b2127)|`Fix for lower central series computation of subalgebras: 'from_vector' now checks if the vector is given in the ambient or intrinsic form`|\n|[e2cdaed](https://git.sagemath.org/sage.git/commit?id=e2cdaed522396d8154a9eed6246580a886b8f366)|`Added doctest for nilpotency step computation of ideals and subalgebras`|\n|[ff672fc](https://git.sagemath.org/sage.git/commit?id=ff672fc23d93ec67f595348827cc69e2e07bcf12)|`retract to subalgebra now checks that the element is contained in the subalgebra`|\n|[2d7c007](https://git.sagemath.org/sage.git/commit?id=2d7c00706e3bc93cc85d81ef7d2f77c8632ea86a)|`Added repr_short method to ideals mimicking ring ideals`|\n|[209c755](https://git.sagemath.org/sage.git/commit?id=209c75541d4f6a4bfe7ba1c469b14a9ffe66a6e8)|`Fixed error in testing if a subalgebra or ideal is an ideal of a Lie algebra`|\n|[0be7e09](https://git.sagemath.org/sage.git/commit?id=0be7e09dbe2abba1c6d6d2accffd0362b3307f73)|`Merge remote-tracking branch 'trac/u/gh-ehaka/lie_ideals-26078' into quotients-26079`|\n|[5a23c5e](https://git.sagemath.org/sage.git/commit?id=5a23c5ec07e9afcd6a7ca02d7db09c51b4fb45b7)|`trac #26079: initial implementation of quotients of finite dimensional Lie algebras`|\n|[ead5abd](https://git.sagemath.org/sage.git/commit?id=ead5abdd0a6ee15a81c3092811d28aea61d528dc)|`trac #26079: removed unnecessary conversion from elements of the quotient to the ambient Lie algebra`|",
    "created_at": "2018-09-02T14:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26079",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[3c0251b](https://git.sagemath.org/sage.git/commit/?id=3c0251b7d734e16252e5597343e4c2ce97b3a2af)|`Merge branch 'develop' into u/gh-ehaka/quotients-26079`|\n|[115b579](https://git.sagemath.org/sage.git/commit/?id=115b5792518905e9d5f7a859c7b7d4818a34b966)|`trac #26079: fix for changed ideal baseclass and fixed nonsense doctest`|\n|[3289fc4](https://git.sagemath.org/sage.git/commit/?id=3289fc4422873912dbfe27638981f30743d55bbc)|`trac #26079: modified Lie algebra product space computation to test for Subobject category instead of the _ambient attribute`|\n|[08fc4dc](https://git.sagemath.org/sage.git/commit/?id=08fc4dc3c841ee49c85aa4ca3025fcf68d610028)|`trac #26079: removed orphaned line of code`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[e775e25](https://git.sagemath.org/sage.git/commit/?id=e775e2596a2fa39dae5b3ad304dd49d3a0329001)|`trac #26079: some effiency improvements`|",
    "created_at": "2018-09-21T05:02:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26079",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[01a3669](https://git.sagemath.org/sage.git/commit/?id=01a3669e7472ca82c3fd56e755eca0e1b08cbbc7)|`trac #26079: moved import out of __classcall__`|",
    "created_at": "2018-09-21T05:08:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26079",
    "type": "issue_comment",
