...
```json
{
    "body": "<a id='comment:8'></a>Arch Linux ships sympy 1.2 already. arojas, maybe you want to review here?",
...
<a id='comment:8'></a>Arch Linux ships sympy 1.2 already. arojas, maybe you want to review here?
...
```json
{
    "body": "<a id='comment:9'></a>Long tests pass btw.",
...
<a id='comment:9'></a>Long tests pass btw.
...
```json
{
    "body": "<a id='comment:13'></a>Why isn't `03_undeffun_sage.patch` upstreamed? Is there an upstream PR for that?",
...
<a id='comment:13'></a>Why isn't `03_undeffun_sage.patch` upstreamed? Is there an upstream PR for that?
...
```json
{
    "body": "<a id='comment:14'></a>Found it: https://github.com/sympy/sympy/pull/11858 and https://github.com/sympy/sympy/pull/13476.",
...
<a id='comment:14'></a>Found it: https://github.com/sympy/sympy/pull/11858 and https://github.com/sympy/sympy/pull/13476.
...
```json
{
    "body": "<a id='comment:16'></a>what OS is this error on?",
...
<a id='comment:16'></a>what OS is this error on?
...
```json
{
    "body": "<a id='comment:17'></a>vbraun: isn't that just an instance of #26018?",
...
<a id='comment:17'></a>vbraun: isn't that just an instance of #26018?
...
```json
{
    "body": "<a id='comment:21'></a>and meanwhile 1.3 has been released.",
...
<a id='comment:21'></a>and meanwhile 1.3 has been released.
