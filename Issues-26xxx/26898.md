...
```json
{
    "body": "<a id='comment:2'></a>Now that I've thought about it more, the number field might not be a splitting field, so it's more complicated than returning the same field.",
    "created_at": "2018-12-18T00:53:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399059",
    "user": "https://github.com/BrentBaccala"
}
```

<a id='comment:2'></a>Now that I've thought about it more, the number field might not be a splitting field, so it's more complicated than returning the same field.
...
```json
{
    "body": "<a id='comment:3'></a>I found some comments in the code suggesting that when approximations to algebraic numbers are computed, an attempt is made to use 40 extra bits of precision, but it doesn't seem like that every actually got done.\n\nI made the obvious change to actually compute 40 extra bits, and it seems to have solved my problem.\n\n---\nNew commits:",
    "created_at": "2018-12-18T22:46:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399060",
    "user": "https://github.com/BrentBaccala"
}
```

<a id='comment:3'></a>I found some comments in the code suggesting that when approximations to algebraic numbers are computed, an attempt is made to use 40 extra bits of precision, but it doesn't seem like that every actually got done.
...
```json
{
    "body": "<a id='comment:4'></a>Should the ticket be set to needs_review?",
    "created_at": "2018-12-19T08:57:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399061",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:4'></a>Should the ticket be set to needs_review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399062",
    "user": "https://github.com/BrentBaccala"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399063",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399065",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399066",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26898#issuecomment-399067",
