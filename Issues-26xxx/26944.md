...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375142",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26944#event-66736"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26944#event-66737"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26944#event-66738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375143",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375144",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26944#event-66739"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This is a nice idea except that we want that the hash to be consistent with rational numbers. More precisely we want to preserve `hash(2/3) == hash(AA(2/3))`. I don't see how the perturbation approach would work under this constraint.",
    "created_at": "2021-04-25T14:05:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375145",
    "user": "https://github.com/videlec"
}
```

<a id='comment:4'></a>This is a nice idea except that we want that the hash to be consistent with rational numbers. More precisely we want to preserve `hash(2/3) == hash(AA(2/3))`. I don't see how the perturbation approach would work under this constraint.
...
```json
{
    "body": "<a id='comment:5'></a>I agree. If we do want to preserve that property, the problem is unsolvable. (Yet another argument for not trying to drop this requirement, IMO...)",
    "created_at": "2021-04-25T15:33:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375146",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:5'></a>I agree. If we do want to preserve that property, the problem is unsolvable. (Yet another argument for not trying to drop this requirement, IMO...)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375147",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375148",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26944#issuecomment-375149",
    "user": "https://github.com/tscrim"
}
```
