...
```json
{
    "body": "I think that in the past, people have also considered using Sphinx's search capabilities in `search_doc`, to get nicely formatted results with highlighted terms, etc. I don't think there was a ticket for this, but it might be something to consider.",
...
```json
{
    "body": "Oh, I was wondering if it were possible to serve kernel-specific URLs.  That solves that.",
