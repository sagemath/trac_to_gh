...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26920#issuecomment-399460",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Another ticket has been opened to deal with the same issue: #26994. I suggest to close this one here as a duplicate since the other ticket is more advanced on understanding the issue (the issue seems related to the installation of optional package bliss).",
    "created_at": "2019-01-02T10:10:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26920#issuecomment-399461",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:3'></a>Another ticket has been opened to deal with the same issue: #26994. I suggest to close this one here as a duplicate since the other ticket is more advanced on understanding the issue (the issue seems related to the installation of optional package bliss).
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26920#event-66633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26920#issuecomment-399462",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26920#issuecomment-399463",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26920",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26920#event-66634"
}
```
