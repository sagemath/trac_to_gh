...
archive/issue_events_367278.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26707#event-367278"
}
```
...
archive/issue_events_367279.json:
```json
{
    "actor": "https://github.com/sagetrac-tmonteil",
    "created_at": "2018-11-17T12:13:49Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26707#event-367279"
}
```
...
archive/issue_events_367280.json:
```json
{
    "actor": "https://github.com/sagetrac-tmonteil",
    "created_at": "2018-11-17T12:13:49Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26707#event-367280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26707#event-367281"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26707#issuecomment-411428",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26707#issuecomment-411429",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26707#event-367282"
}
```
