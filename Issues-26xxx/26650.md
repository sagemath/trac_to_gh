...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26650#event-66093"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Retargeting some of my tickets (somewhat optimistically for now).",
    "created_at": "2018-12-28T14:10:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26650#issuecomment-512266",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>Retargeting some of my tickets (somewhat optimistically for now).
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26650#event-66094"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26650#event-66095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26650#issuecomment-512267",
    "user": "https://github.com/embray"
}
```
