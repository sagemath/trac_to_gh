...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[4fd9277](https://git.sagemath.org/sage.git/commit/?id=4fd9277148d165c889c9513d460e8ef21460a697)|`some cleanup for PolyDict.rich_compare and __richcmp__`|\n|[5fb5c76](https://git.sagemath.org/sage.git/commit/?id=5fb5c762830796187163fb00dab42c80803e1950)|`demonstrate an example where it makes sense to use PolyDict.rich_compare`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nI have corrected a typo and changed 2 http to https.\n\nThis allows many doctests to pass in Iwahori-Hecke algebras with python3.\n\n---\nNew commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[ad058d6](https://git.sagemath.org/sage.git/commit?id=ad058d69685c571cfce44c33f4ab5f26502487be)|`Merge branch 'u/embray/polydict/richcmp' in 8.5.b2`|\n|[1cfdd4c](https://git.sagemath.org/sage.git/commit?id=1cfdd4cb6b6fdf80b74fb905339027955cd5d7c2)|`trac 26279 some http details and one typo`|",
    "created_at": "2018-11-04T10:03:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26279",
    "type": "issue_comment",
