...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504355",
...
```json
{
    "body": "<a id='comment:2'></a>Hmm...strange. Let me try from a fresh session to see if I somehow unintentionally corrupted things.",
    "created_at": "2018-09-11T05:45:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504356",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>Hmm...strange. Let me try from a fresh session to see if I somehow unintentionally corrupted things.
...
```json
{
    "body": "<a id='comment:3'></a>Okay, I had one little seemingly innocuous change: I added an explicit return type `int` on the corresponding `get` method of `IntegerMatrix`. Once I removed that, it worked.",
    "created_at": "2018-09-11T05:54:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504357",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>Okay, I had one little seemingly innocuous change: I added an explicit return type `int` on the corresponding `get` method of `IntegerMatrix`. Once I removed that, it worked.
...
```json
{
    "body": "<a id='comment:4'></a>So what was going wrong is that there is a `bint is_nonzero` method which simply was `return self.get(r, c)`, and Cython could somehow not automatically convert that to a boolean check. Would that count as a Cython bug?\n\nIf it is not, I might also recycle this ticket with some Cython tweaks to `IntegerMatrix` to try and squeeze a bit more speed out of it.",
    "created_at": "2018-09-11T05:57:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504358",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>So what was going wrong is that there is a `bint is_nonzero` method which simply was `return self.get(r, c)`, and Cython could somehow not automatically convert that to a boolean check. Would that count as a Cython bug?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504360",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Yes, that is correct (well, an `int` to a `bint` to be specific).",
    "created_at": "2018-09-11T07:46:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504361",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>Yes, that is correct (well, an `int` to a `bint` to be specific).
...
```json
{
    "body": "<a id='comment:8'></a>At least, once I changed that to an explicit check != 0, it fixed the problem.",
    "created_at": "2018-09-11T07:47:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504362",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>At least, once I changed that to an explicit check != 0, it fixed the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504363",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504364",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504366",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Replying to [comment:9 Stefan]:\n> Replying to [comment:5 tscrim]:\n> > Well, there is a bug somewhere (on vanilla 8.4.beta4):\n> > \n> > ```\n> > sage: M = LinearMatroid(matrix=IntegerMatrix(4,4,matrix([[0,0,0,0],[1,1,1,1],[0,1,1,2],[0,0,1,0]])))\n> > sage: list(M.bases())\n> > [frozenset({0, 1, 2}), frozenset({0, 2, 3})]\n> > \n> > sage: Mp = LinearMatroid(matrix=GenericMatrix(4,4,matrix([[0,0,0,0],[1,1,1,1],[0,1,1,2],[0,0,1,0]])))\n> > sage: list(Mp.bases())\n> > [frozenset({0, 1, 2}), frozenset({0, 2, 3}), frozenset({1, 2, 3})]\n> > ```\n\n> \n> Most (all?) LinearMatroid methods assume that we are allowed to pivot in the matrix, and do so without leaving the ring. Maybe that's what went wrong?\n\n\nBut in the latter case, the matrix is over `ZZ`, so I would not think that is the problem.",
    "created_at": "2018-09-11T22:43:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504367",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:13'></a>Replying to [comment:9 Stefan]:
> Replying to [comment:5 tscrim]:
> > Well, there is a bug somewhere (on vanilla 8.4.beta4):
> > 
> > ```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504369",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I guess something you could do is also special case `QQ` and go directly with the C data using the `mpq` commands. It looks like the `GF(2)` and `GF(3)` matrices are already quite specialized. At least I would think that is the next most common field to work over (other than maybe `GF(4)`).",
    "created_at": "2018-09-12T08:07:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504371",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:17'></a>I guess something you could do is also special case `QQ` and go directly with the C data using the `mpq` commands. It looks like the `GF(2)` and `GF(3)` matrices are already quite specialized. At least I would think that is the next most common field to work over (other than maybe `GF(4)`).
...
```json
{
    "body": "<a id='comment:19'></a>So the solution for really converting an `int` to a `bint` in Cython is indeed adding an explicit `!= 0`.",
    "created_at": "2018-09-12T08:19:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504373",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>So the solution for really converting an `int` to a `bint` in Cython is indeed adding an explicit `!= 0`.
...
```json
{
    "body": "<a id='comment:20'></a>Should I close this ticket or do you want to recycle it?",
    "created_at": "2018-09-12T08:23:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504374",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>Should I close this ticket or do you want to recycle it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504376",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504377",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504378",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504380",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Also: if the entries are really only 0, 1 or -1 then using an `int` to store the entries wastes memory. You could use `int8_t` (8 bits) instead of `int` (typically 32 bits). I'll leave it to you to decide whether it would be worth to change that.",
    "created_at": "2018-09-13T05:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504382",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:28'></a>Also: if the entries are really only 0, 1 or -1 then using an `int` to store the entries wastes memory. You could use `int8_t` (8 bits) instead of `int` (typically 32 bits). I'll leave it to you to decide whether it would be worth to change that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504383",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"public/matroids/speedup_integer_matrix-26237\"",
    "created_at": "2018-09-13T05:46:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504384",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "" to "public/matroids/speedup_integer_matrix-26237"
...
```json
{
    "body": "Changing commit from \"\" to \"31a87a3194b9c77febb961c4821d1873a4b01b2a\"",
    "created_at": "2018-09-13T05:46:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504386",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "" to "31a87a3194b9c77febb961c4821d1873a4b01b2a"
...
```json
{
    "body": "Changing commit from \"31a87a3194b9c77febb961c4821d1873a4b01b2a\" to \"7effef06c3c1f821c1bfa3316d55e88c0026333a\"",
    "created_at": "2018-09-13T05:55:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504388",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "31a87a3194b9c77febb961c4821d1873a4b01b2a" to "7effef06c3c1f821c1bfa3316d55e88c0026333a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504389",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Done. I didn't know that. Thanks.",
    "created_at": "2018-09-13T05:55:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504390",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:33'></a>Done. I didn't know that. Thanks.
...
```json
{
    "body": "<a id='comment:34'></a>You will see that no function ever returns an `mpq_t` (or `mpz_t` or whatever). The typical calling convention is passing a return argument, for example the declaration of `mpq_add`:\n\n```\nvoid mpq_add(mpq_t sum, mpq_t addend1, mpq_t addend2)\n```",
    "created_at": "2018-09-13T05:56:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504391",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:34'></a>You will see that no function ever returns an `mpq_t` (or `mpz_t` or whatever). The typical calling convention is passing a return argument, for example the declaration of `mpq_add`:
...
```json
{
    "body": "<a id='comment:35'></a>Yea, I noticed that and so I scrapped the `get` in place of the `index` for better maintainability should the internal ordering change. However, I do have some functions where I am passing an `mpq_t`, e.g., in `pivot`, and this is not working as I would expect. Also, I had tried to do something like\n\n```\ncdef mpq_t s = self._entries[self.index(i,j)]\nmpq_add(s, s, t)\n```\nwhere `t` is some other `mpq_t`, but that wasn't working like I expected either.",
    "created_at": "2018-09-13T06:00:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504392",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:35'></a>Yea, I noticed that and so I scrapped the `get` in place of the `index` for better maintainability should the internal ordering change. However, I do have some functions where I am passing an `mpq_t`, e.g., in `pivot`, and this is not working as I would expect. Also, I had tried to do something like
...
```json
{
    "body": "<a id='comment:36'></a>Can you move \"Implement `RationalMatrix`\" to a new ticket instead?\n\nThe commits that you added here to improve `IntegerMatrix` make sense independently.",
    "created_at": "2018-09-13T07:54:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504393",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:36'></a>Can you move "Implement `RationalMatrix`" to a new ticket instead?
...
```json
{
    "body": "<a id='comment:37'></a>Replying to [comment:27 tscrim]:\n> I think this needs to be documented at the very least (which I will do here). I might also like to change the name of `IntegerMatrix` to perhaps `UnitIntegerMatrix` or `PlusMinusOneMatrix`. Thoughts?\n\n\n+1 to `PlusMinusOneMatrix`.",
    "created_at": "2018-09-13T07:55:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504394",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:37'></a>Replying to [comment:27 tscrim]:
> I think this needs to be documented at the very least (which I will do here). I might also like to change the name of `IntegerMatrix` to perhaps `UnitIntegerMatrix` or `PlusMinusOneMatrix`. Thoughts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504395",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504396",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>#26269 for the `RationalMatrix` implementation.",
    "created_at": "2018-09-13T10:39:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504397",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:39'></a>#26269 for the `RationalMatrix` implementation.
...
```json
{
    "body": "Changing commit from \"7effef06c3c1f821c1bfa3316d55e88c0026333a\" to \"fb64e43cd4e5eaa28b3156b39c7cb42909ac0075\"",
    "created_at": "2018-09-14T01:07:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504398",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "7effef06c3c1f821c1bfa3316d55e88c0026333a" to "fb64e43cd4e5eaa28b3156b39c7cb42909ac0075"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504399",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504400",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>I've split the ticket into the two parts. This part is now ready for review.",
    "created_at": "2018-09-14T01:10:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504401",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:41'></a>I've split the ticket into the two parts. This part is now ready for review.
...
```json
{
    "body": "<a id='comment:42'></a>(Essentially) Green patchbot.",
    "created_at": "2018-09-14T05:02:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504402",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:42'></a>(Essentially) Green patchbot.
...
```json
{
    "body": "<a id='comment:43'></a>So how about renaming to `PlusMinusOneMatrix`? I'd like the opinion of Stefan on that.",
    "created_at": "2018-09-14T07:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504403",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:43'></a>So how about renaming to `PlusMinusOneMatrix`? I'd like the opinion of Stefan on that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504404",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"fb64e43cd4e5eaa28b3156b39c7cb42909ac0075\" to \"3c0195bc7302b36431d1c4715582fd33ed5cc0c0\"",
    "created_at": "2018-09-16T22:47:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504405",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "fb64e43cd4e5eaa28b3156b39c7cb42909ac0075" to "3c0195bc7302b36431d1c4715582fd33ed5cc0c0"
...
```json
{
    "body": "<a id='comment:45'></a>I did the refactoring. Stefan, Rudi, any objections?",
    "created_at": "2018-09-16T22:48:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504406",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:45'></a>I did the refactoring. Stefan, Rudi, any objections?
...
```json
{
    "body": "<a id='comment:46'></a>I am happy with the new name. Don\u2019t have time for a long review.",
    "created_at": "2018-09-17T05:28:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504407",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```

<a id='comment:46'></a>I am happy with the new name. Don’t have time for a long review.
...
```json
{
    "body": "<a id='comment:47'></a>I've looked through the code and I am happy with it, so LGTM.\n\nHowever contributed to this ticket (mainly review), please insert your name in the reviewer field.",
    "created_at": "2019-03-27T14:03:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504408",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:47'></a>I've looked through the code and I am happy with it, so LGTM.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504409",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504410",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Stefan, Rudi I added you as reviewers based on our conversions above. Jeroen is obviously a reviewer for looking at the Cython code (as well as his additional useful insights).",
    "created_at": "2019-03-27T22:08:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504411",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:48'></a>Stefan, Rudi I added you as reviewers based on our conversions above. Jeroen is obviously a reviewer for looking at the Cython code (as well as his additional useful insights).
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26237#event-65311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504412",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26237#event-65312"
}
```
...
```json
{
    "body": "Changing branch from \"public/matroids/speedup_integer_matrix-26237\" to \"3c0195bc7302b36431d1c4715582fd33ed5cc0c0\"",
    "created_at": "2019-03-29T12:36:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504413",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/matroids/speedup_integer_matrix-26237" to "3c0195bc7302b36431d1c4715582fd33ed5cc0c0"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26237#issuecomment-504414",
    "user": "https://github.com/vbraun"
}
```
