...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26774#event-368016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26774#event-368017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26774#event-368018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26774#event-368019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26774#issuecomment-412392",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26774#issuecomment-412393",
    "user": "https://github.com/embray"
}
```
