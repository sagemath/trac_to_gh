...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26880#issuecomment-416687",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26880#issuecomment-416688",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26880#event-351151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26880#event-351152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26880#event-351153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26880#event-351154"
}
```
