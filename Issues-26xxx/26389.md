...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507350",
...
```json
{
    "body": "<a id='comment:2'></a>> Do you know offhand (i.e., don't spend much time on this) of a simple way I can extract out the relevant matrix >computation? This is not a minimal example, and it would be useful to get it down smaller.\n\n\nRight. But I didn't see the failure from the doctest yet, even after I installed meataxe to my installation (on mac). Do you have a specific procedure likely to encounter the failure?",
    "created_at": "2018-10-04T00:22:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507351",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:2'></a>> Do you know offhand (i.e., don't spend much time on this) of a simple way I can extract out the relevant matrix >computation? This is not a minimal example, and it would be useful to get it down smaller.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507352",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Still no failure from \n\n```\n for i in {1..100}; do sage -tp src/sage/rings/function_field/ideal.py; done\n```\non mac, after `sage -i meataxe; make`",
    "created_at": "2018-10-04T04:32:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507353",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:4'></a>Still no failure from 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507354",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507355",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [klee](#comment%3A4):\n> Still no failure from \n> \n> ```\n>  for i in {1..100}; do sage -tp src/sage/rings/function_field/ideal.py; done\n> ```\n> on mac, after `sage -i meataxe; make`\n\n\nMaybe it is not something that shows up on macs (I am running Ubuntu 16.04 LTS).",
    "created_at": "2018-10-05T10:31:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507356",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>Replying to [klee](#comment%3A4):
> Still no failure from 
> 
> ```
>  for i in {1..100}; do sage -tp src/sage/rings/function_field/ideal.py; done
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507357",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>The good thing is that it seems not to be caused by some obscure side-effect of other tests: I did\n\n```\nsage: K.<x> = FunctionField(GF(3^2)); _.<t> = PolynomialRing(K)\nsage: F.<y> = K.extension(t^3 + t^2 - x^4)\nsage: Oinf = F.maximal_order_infinite()\nsage: I = Oinf.ideal(1/x)\nsage: I.factor()\n```\nin three new Sage sessions. The first two times the test worked. The third time it failed.",
    "created_at": "2018-10-07T06:18:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507359",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>The good thing is that it seems not to be caused by some obscure side-effect of other tests: I did
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507360",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507361",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507362",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507363",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507364",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Please do not always change the ticket description. It makes me get a long mail (stating the old description but not the new one). Moreover it hides what you have actually changed (unless one clicks on the \"diff\" button).\n\nSo please, when you dig further, write a comment.",
    "created_at": "2018-10-08T09:18:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507365",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>Please do not always change the ticket description. It makes me get a long mail (stating the old description but not the new one). Moreover it hides what you have actually changed (unless one clicks on the "diff" button).
...
```json
{
    "body": "<a id='comment:17'></a>Since its optional I don't really see this as a blocker; Though if a simple bugfix materializes really soon I'd consider merging it...",
    "created_at": "2018-10-11T22:28:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507366",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>Since its optional I don't really see this as a blocker; Though if a simple bugfix materializes really soon I'd consider merging it...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507367",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507368",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Nice! So, the problem is just a corner case that was forgotten to be dealt with in my *wrapper* for SharedMeatAxe. That's a big relief. I thought it would be caused by a problem in SharedMeatAxe's memory management.",
    "created_at": "2018-10-15T11:19:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507369",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>Nice! So, the problem is just a corner case that was forgotten to be dealt with in my *wrapper* for SharedMeatAxe. That's a big relief. I thought it would be caused by a problem in SharedMeatAxe's memory management.
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/a_bug_likely_with_matrix_gfpn_dense_or_meataxe\"",
    "created_at": "2018-10-15T11:23:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507370",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/a_bug_likely_with_matrix_gfpn_dense_or_meataxe"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507371",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"828b18891f09f40960bc6a7f3aa1510cfb679391\"",
    "created_at": "2018-10-15T11:24:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507372",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "828b18891f09f40960bc6a7f3aa1510cfb679391"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507373",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507374",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>The mystery is why this bug suddenly shows up now. As far as I can tell (by looking at git history), this has been broken all the time since #12103.",
    "created_at": "2018-10-15T11:36:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507375",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>The mystery is why this bug suddenly shows up now. As far as I can tell (by looking at git history), this has been broken all the time since #12103.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507376",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Patchbot passed on sage4 which has `meataxe` installed.",
    "created_at": "2018-10-15T15:48:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507377",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>Patchbot passed on sage4 which has `meataxe` installed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507378",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507379",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>LGTM. Thank you Jeroen.",
    "created_at": "2018-10-18T17:10:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507380",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:26'></a>LGTM. Thank you Jeroen.
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/a_bug_likely_with_matrix_gfpn_dense_or_meataxe\" to \"828b18891f09f40960bc6a7f3aa1510cfb679391\"",
    "created_at": "2018-10-20T11:58:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507381",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/a_bug_likely_with_matrix_gfpn_dense_or_meataxe" to "828b18891f09f40960bc6a7f3aa1510cfb679391"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507382",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>This should be re-targeted for 8.5.",
    "created_at": "2018-10-28T14:52:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26389#issuecomment-507383",
    "user": "https://github.com/embray"
}
```

<a id='comment:28'></a>This should be re-targeted for 8.5.
