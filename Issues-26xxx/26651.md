...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[151ac1c](https://git.sagemath.org/sage.git/commit?id=151ac1caa4956bc51db4c227c38b79585165a8ee)|`py3: fix __repr__ of callable dict`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[3ec238b](https://git.sagemath.org/sage.git/commit/?id=3ec238bcdcfad77aa8bf9d5477c15feb03d1aadc)|`trac 26651 fix imports`|",
