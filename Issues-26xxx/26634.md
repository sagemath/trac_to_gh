...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336003"
}
```
...
archive/issue_events_336004.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2018-11-04T16:44:07Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336004"
}
```
...
archive/issue_events_336005.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2018-11-04T16:45:14Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336005"
}
```
...
archive/issue_events_336006.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336006"
}
```
...
archive/issue_events_336007.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2018-12-06T20:33:50Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336007"
}
```
...
archive/issue_events_336008.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336008"
}
```
...
archive/issue_events_336009.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/26634",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26634#event-336009"
}
```
