...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365727"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365728"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409526",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409527",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409528",
    "user": "https://github.com/Pavel-Sayekat"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409529",
    "user": "https://github.com/Pavel-Sayekat"
}
```
...
```json
{
    "body": "<div id=\"comment:3\" align=\"right\">comment:3</div>\n\nReplying to [@Pavel-Sayekat](#comment:2):\n> $ sudo dpkg -l gfortran\n> Desired=Unknown/Install/Remove/Purge/Hold\n> | Status=Not/Inst/Conf-files/Unpacked/halF-conf/Half-inst/trig-aWait/Trig-pend\n> |/ Err?=(none)/Reinst-required (Status,Err: uppercase=bad)\n> |                                                                                                  \n> |--------------------------------------------------------------------------------------------------\n> |/ Name                                 Version                 Architecture            Description\n> +++-====================================-=======================-=======================-=============================================================================\n> ii  gfortran                             4:6.3.0-4               armhf                   GNU Fortran 95 compiler\n> \n> Added the log and some more info.\n\nSo is it installed?",
    "created_at": "2018-10-27T20:04:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409530",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409531",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409532",
    "user": "https://github.com/Pavel-Sayekat"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409533",
    "user": "https://github.com/Pavel-Sayekat"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409534",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409535",
    "user": "https://github.com/Pavel-Sayekat"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409536",
    "user": "https://github.com/Pavel-Sayekat"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365732"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409537",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26564#event-365734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26564#issuecomment-409538",
