...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346866"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346869"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26497#issuecomment-411347",
...
```json
{
    "body": "Changed keywords from **** to **limit, maxima**",
    "created_at": "2018-10-18T06:14:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/26497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26497#issuecomment-411348",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **limit, maxima**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26497#issuecomment-411349",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346870"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346871"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346872"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26497#event-346873"
}
```
