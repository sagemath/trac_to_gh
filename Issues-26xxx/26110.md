...
```json
{
    "body": "<a id='comment:4'></a>\nRecent, yes: merged in 8.4.beta1. But the intention was to keep testing by default:\n\n- From the description at #25345: \"This patch makes the doctests that depend on the htmldocs optional, but enables those doctests by default.\" \n- From [ticket:25345#comment:23 comment 23 there]: \"This change does not disable documentation in any way. It is still enabled by default and tested by default.\"\n\nThere would have been serious objections by me and by Jeroen (see [ticket:25345#comment:24 his comment 24]) to that ticket if it changed the default testing behavior.",
