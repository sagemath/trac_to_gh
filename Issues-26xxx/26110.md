...
```json
{
    "body": "<a id='comment:2'></a>\nI think this will take care of it, but someone who knows the doctesting framework should review this (and #25345) carefully.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[8cff1a6](https://git.sagemath.org/sage.git/commit?id=8cff1a67231a1ac604d9daa5637793b0fd406f17)|`trac 26110: by default, always run tests marked \"optional - dochtml\".`|",
    "created_at": "2018-08-22T20:45:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26110",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[78b3df8](https://git.sagemath.org/sage.git/commit/?id=78b3df8b94cd36d2e907bb00b3d467c9bc2bd1d5)|`trac 26110: the make targets 'testall', 'testoptional', etc., should`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[e75f346](https://git.sagemath.org/sage.git/commit/?id=e75f3460f5b17b72af3be0c2b8308d02e13aaaae)|`Don't specify --optional for the default optional tags`|\n|[d6d4f06](https://git.sagemath.org/sage.git/commit/?id=d6d4f0643130d054edd8265bd724207a3b1cce61)|`Clarify defaults`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nI changed \"OPTIONAL_AND_EXTERNAL\" to \"TESTALL_FLAGS\". I also added a little documentation (which I should have done in my initial version).\n\n---\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[6a50903](https://git.sagemath.org/sage.git/commit?id=6a5090389bde02be3498fb05e9b18834de8eac52)|`trac 26110: a little documentation in Makefile, sage-runtests`|",
