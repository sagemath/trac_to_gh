...
```json
{
    "body": "Karl-Dieter, would you please report upstream to maxima these new details about the problem ?",
    "created_at": "2021-08-29T08:49:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26138#issuecomment-368100",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65607"
}
```
...
```json
{
    "body": "I thought this was already at https://sourceforge.net/p/maxima/bugs/3469/ ?  Sorry, I'm not very familiar with this one or what its bug is.",
    "created_at": "2021-08-30T16:56:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26138#issuecomment-368101",
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65608"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65609"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65610"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65611"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65612"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26138#event-65613"
}
```
