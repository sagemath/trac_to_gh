...
```json
{
    "body": "I have my doubts about this, but it's not inconceivable.  Like you said, it's such a noisy line I wonder if there are some false positives, e.g. from some of the doctest fixups for Python 2/3 compatibility, or something along those lines.  I'll look into it.",
