...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26946#issuecomment-517978",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26946#issuecomment-517979",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66762"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66763"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26946#issuecomment-517980",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66764"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>now returns an error in 9.6.b3 ; so maybe we can close as invalid ?",
    "created_at": "2022-03-06T20:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26946#issuecomment-517981",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>now returns an error in 9.6.b3 ; so maybe we can close as invalid ?
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26946#issuecomment-517982",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66766"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66767"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26946#issuecomment-517984",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66768"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66769"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66770"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26946#event-66771"
}
```
