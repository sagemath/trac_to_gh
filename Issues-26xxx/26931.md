...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                                                          |                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[0e6b70a](https://git.sagemath.org/sage.git/commit?id=0e6b70ad657f257bed7c97e4fbcd31c6f430f566)|`Sort key as sort_facets parameter of SimplicialComplex`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[154b615](https://git.sagemath.org/sage.git/commit/?id=154b61536b55faca6f507c688881570fdc5812f8)|`Sort key as sort_facets parameter of SimplicialComplex`|",
