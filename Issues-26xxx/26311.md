...
```json
{
    "body": "<a id='comment:2'></a>Thanks for the investigation.",
...
<a id='comment:2'></a>Thanks for the investigation.
...
```json
{
    "body": "<a id='comment:6'></a>It feels like there's been a bad habit in CPython lately of needlessly breaking support for custom numerical types.",
...
<a id='comment:6'></a>It feels like there's been a bad habit in CPython lately of needlessly breaking support for custom numerical types.
...
```json
{
    "body": "<a id='comment:8'></a>Yeesh, that thread on bpo is a mess... :(",
...
<a id='comment:8'></a>Yeesh, that thread on bpo is a mess... :(
