...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417162",
    "user": "https://github.com/evandrix"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [Sage_crash_report.txt](https://github.com/sagemath/sage/files/ticket26904/Sage_crash_report.txt) by @vbraun created at 2018-12-19 20:33:11\n\nWhat kind of hardware is this?",
    "created_at": "2018-12-19T20:33:11Z",
    "issue": "https://github.com/sagemath/sage/issues/26904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417163",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417164",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417165",
    "user": "https://github.com/evandrix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417166",
    "user": "https://github.com/evandrix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417167",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26904#issuecomment-417168",
    "user": "https://github.com/vbraun"
}
```
