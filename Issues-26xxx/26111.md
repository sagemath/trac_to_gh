...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501843",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501844",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"a17239b054dbed216feba1b1b03b50f51df196eb\"",
    "created_at": "2018-08-23T00:34:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501845",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "" to "a17239b054dbed216feba1b1b03b50f51df196eb"
...
```json
{
    "body": "Changing branch from \"\" to \"public/combinat/fast_lyndon_iter-26111\"",
    "created_at": "2018-08-23T00:34:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501846",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "" to "public/combinat/fast_lyndon_iter-26111"
...
```json
{
    "body": "<a id='comment:2'></a>Given #25262, it would be good to add a \"long\" doctest, so we can avoid performance regressions in future.",
    "created_at": "2018-08-23T03:31:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501847",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:2'></a>Given #25262, it would be good to add a "long" doctest, so we can avoid performance regressions in future.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501849",
...
```json
{
    "body": "Changing commit from \"a17239b054dbed216feba1b1b03b50f51df196eb\" to \"bbacc76e3cd1da57b7463069c49b4c1d38ae9f21\"",
    "created_at": "2018-08-23T07:27:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501850",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a17239b054dbed216feba1b1b03b50f51df196eb" to "bbacc76e3cd1da57b7463069c49b4c1d38ae9f21"
...
```json
{
    "body": "<a id='comment:6'></a>Here is a naive implementation of the iterative FKM algorithm from Ruskey's book. I couldn't get http://puma.dimai.unifi.it/17_1_2/weston.pdf to work, and I haven't checked what it's advantage would be.\n\nI won't steel the joy of timing this from you :-)\n\n```\ndef FKM_iterativ(k, n):\n    a = [0]*(n+1)\n    if n == 1:\n        yield a[:]\n    i = n;\n    while True:\n        a[i] += 1\n        for j in range(1, n-i+1):\n            a[j + i] = a[j]\n        if n == i:            \n            yield a[:]\n        i = n\n        while a[i] == k-1:\n            i -= 1\n        if i == 0:\n            break\n```",
    "created_at": "2018-08-23T19:19:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501852",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:6'></a>Here is a naive implementation of the iterative FKM algorithm from Ruskey's book. I couldn't get http://puma.dimai.unifi.it/17_1_2/weston.pdf to work, and I haven't checked what it's advantage would be.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501853",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"bbacc76e3cd1da57b7463069c49b4c1d38ae9f21\" to \"8cc9d0e9cda0a33477caf88a93be69d48bff600e\"",
    "created_at": "2018-08-24T00:13:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501854",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "bbacc76e3cd1da57b7463069c49b4c1d38ae9f21" to "8cc9d0e9cda0a33477caf88a93be69d48bff600e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501855",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Great! (sorry, I actually did think that you would enjoy the timing)\n\nOne thing I do not yet understand: on my laptop, FKM is roughly 12 times faster than the original iterator (i.e., without this ticket).\n\nI'll try this ticket now to check.",
    "created_at": "2018-08-24T08:33:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501857",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:9'></a>Great! (sorry, I actually did think that you would enjoy the timing)
...
```json
{
    "body": "<a id='comment:14'></a>Another one:\n\n```diff\ndiff --git a/src/sage/algebras/lie_algebras/free_lie_algebra.py b/src/sage/algebras/lie_algebras/free_lie_algebra.py\nindex 1d0665d225..1ef05a7f4f 100644\n--- a/src/sage/algebras/lie_algebras/free_lie_algebra.py\n+++ b/src/sage/algebras/lie_algebras/free_lie_algebra.py\n@@ -774,13 +774,13 @@ class FreeLieAlgebra(Parent, UniqueRepresentation):\n                  [x0, [[x0, x1], x1]],\n                  [x0, [x0, [x1, x2]]],\n                  [x0, [[x0, x2], x1]],\n-                 [[x0, x1], [x0, x2]],\n                  [x0, [[x0, x2], x2]],\n+                 [[x0, x1], [x0, x2]],\n                  [[[x0, x1], x1], x1],\n                  [x0, [x1, [x1, x2]]],\n                  [[x0, [x1, x2]], x1],\n-                 [[[x0, x2], x1], x1],\n                  [x0, [[x1, x2], x2]],\n+                 [[[x0, x2], x1], x1],\n                  [[x0, x2], [x1, x2]],\n                  [[[x0, x2], x2], x1],\n                  [[[x0, x2], x2], x2],\n```",
    "created_at": "2018-08-24T18:59:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501862",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:14'></a>Another one:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501863",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "Changing commit from \"8cc9d0e9cda0a33477caf88a93be69d48bff600e\" to \"7b25ddc646833c95d3d92c0fec399e3df6a7370f\"",
    "created_at": "2018-08-24T21:43:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501864",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "8cc9d0e9cda0a33477caf88a93be69d48bff600e" to "7b25ddc646833c95d3d92c0fec399e3df6a7370f"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501865",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>The change in[comment:13](#comment%3A13) is actually slower in both Python and Cython. It has something to do with how Python constructs these things internally (but I agree that it is counter-intuitive).\n\nWith[comment:12](#comment%3A12):\n\n```\nsage: LW = LyndonWords(11,6)\nsage: %time for x in LW: pass\nCPU times: user 200 ms, sys: 21.3 ms, total: 222 ms\nWall time: 201 ms\nsage: LW = LyndonWords(11,7)\nsage: %time for x in LW: pass\nCPU times: user 1.85 s, sys: 8.12 ms, total: 1.85 s\nWall time: 1.84 s\n```\nvs old\n\n```\nsage: LW = LyndonWords(11,6)\nsage: %time for x in LW: pass\nCPU times: user 475 ms, sys: 42.2 ms, total: 518 ms\nWall time: 465 ms\nsage: LW = LyndonWords(11,7)\nsage: %time for x in LW: pass\nCPU times: user 4.25 s, sys: 17.8 ms, total: 4.27 s\nWall time: 4.24 s\n```",
    "created_at": "2018-08-24T21:44:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501866",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:17'></a>The change in[comment:13](#comment%3A13) is actually slower in both Python and Cython. It has something to do with how Python constructs these things internally (but I agree that it is counter-intuitive).
...
```json
{
    "body": "Changing commit from \"7b25ddc646833c95d3d92c0fec399e3df6a7370f\" to \"b9d8ee495e9425e34c56361b694899f6aad226da\"",
    "created_at": "2018-08-25T07:50:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501868",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "7b25ddc646833c95d3d92c0fec399e3df6a7370f" to "b9d8ee495e9425e34c56361b694899f6aad226da"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501869",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Fixed and added. I also added more doctests for the other corner case of `LyndonWords(1,1)`.",
    "created_at": "2018-08-25T07:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501870",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:20'></a>Fixed and added. I also added more doctests for the other corner case of `LyndonWords(1,1)`.
...
```json
{
    "body": "<a id='comment:22'></a>You can make and push changes too. :) I am going to bed now, but can do it in the morning.",
    "created_at": "2018-08-25T13:42:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501872",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:22'></a>You can make and push changes too. :) I am going to bed now, but can do it in the morning.
...
```json
{
    "body": "Changing commit from \"b9d8ee495e9425e34c56361b694899f6aad226da\" to \"2b3f9d4ae0ef57562e87109ce08db3355dee1795\"",
    "created_at": "2018-08-25T14:54:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501873",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b9d8ee495e9425e34c56361b694899f6aad226da" to "2b3f9d4ae0ef57562e87109ce08db3355dee1795"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501874",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"2b3f9d4ae0ef57562e87109ce08db3355dee1795\" to \"0b4c68b2ba3c7e270ac8d4137c137695132fc588\"",
    "created_at": "2018-08-25T21:25:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501875",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "2b3f9d4ae0ef57562e87109ce08db3355dee1795" to "0b4c68b2ba3c7e270ac8d4137c137695132fc588"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501876",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501878",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501879",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501880",
...
```json
{
    "body": "Changing branch from \"public/combinat/fast_lyndon_iter-26111\" to \"0b4c68b2ba3c7e270ac8d4137c137695132fc588\"",
    "created_at": "2018-08-29T22:31:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26111#issuecomment-501881",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/combinat/fast_lyndon_iter-26111" to "0b4c68b2ba3c7e270ac8d4137c137695132fc588"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26111",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26111#event-65140"
}
```
