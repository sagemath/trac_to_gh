...
<a id='comment:40'></a>Replying to [comment:39 gh-thierry-FreeBSD]:
> After giac (#29541) and pynac (#29542), I tried to use a system package for ECL (lang/ecl) and Maxima (math/maxima), but without success for the moment: see #29617. To be tried again when ECL will be upgraded (#22191)!
> 
> Meanwhile, our ports must be patched:
> 
...
<a id='comment:43'></a>Replying to [comment:42 gh-thierry-FreeBSD]:
> Well, every package listed in #27330 have a corresponding package from the FreeBSD ports tree and a spkg-configure.m4 to use it!
...
```json
{
    "body": "<a id='comment:45'></a>Replying to [comment:44 gh-thierry-FreeBSD]:\n> OK, I'll do it!\n\n\nDone in #29653.",
...
<a id='comment:45'></a>Replying to [comment:44 gh-thierry-FreeBSD]:
> OK, I'll do it!
...
<a id='comment:55'></a>Replying to [comment:54 gh-thierry-FreeBSD]:
> We are done, 9.1 is in the tree:
> https://www.freshports.org/math/sage/
...
<a id='comment:61'></a>Replying to [comment:54 gh-thierry-FreeBSD]:
> We are done, 9.1 is in the tree:
> https://www.freshports.org/math/sage/
...
<a id='comment:64'></a>Replying to [comment:62 gh-thierry-FreeBSD]:
> You did the right thing!
> 
> - 12.1-RELEASE-p6 is OK
> 
