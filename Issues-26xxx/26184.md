...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[31a3e07](https://git.sagemath.org/sage.git/commit?id=31a3e07fe2a10a42886ed1a452d44f7fb3e2c7b4)|`#26184: fix regression in the wholeword=True option to the search_...() functions`|",
