...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[5a7aed4](https://github.com/sagemath/sagetrac-mirror/commit/5a7aed4361ee41cc8df0fbf4242ffd42dcf3bd8b)|<code>Trac #26097: Some fixes in ``link.py`` for py3 :</code>|",
...
```json
{
    "body": "<a id='comment:4'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[2d1ec03](https://github.com/sagemath/sagetrac-mirror/commit/2d1ec036be5eed09981bfb30ff0da56c6f4b237e)|<code>Trac #26097: Fix some doctests in ``knot.py``</code>|",
...
```json
{
    "body": "<a id='comment:16'></a>\n**Branch pushed to git repo; I updated commit sha1. This was a forced push.** New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[fb171af](https://github.com/sagemath/sagetrac-mirror/commit/fb171af717ca8e84e3061d18ed4a2c15ed3de477)|<code>Trac #26097: Some fixes in ``link.py`` for py3 :</code>|\n|[33c95fb](https://github.com/sagemath/sagetrac-mirror/commit/33c95fbf5ea95077e8d7f1d7f300556c7df034ba)|<code>Trac #26097: Fix some doctests in ``knot.py``</code>|",
    "created_at": "2018-08-29T12:55:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26097",
    "type": "issue_comment",
