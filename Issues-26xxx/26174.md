...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405687",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405688",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405689",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405690",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405691",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405692",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231872"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405693",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405694",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231874"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231875"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231876"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405696",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405697",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405698",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405699",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231879"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231880"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,8 +1,8 @@\n-edit: notebook 5.7.0 will be released soon. The ticket will be updated then.\n+This ticket updates jupyter notebook to 5.7.0.\n \n-There is a security fix in 5.6.0, per ticket:25638#comment:10\n+There was a security fix in 5.6.0, per ticket:25638#comment:10; this was already fixed by the upgrade to MathJax 2.7.4 in #25032.\n \n-[notebook](https://pypi.org/project/notebook) 5.6.0 (from 5.5.0) [tarball](https://files.pythonhosted.org/packages/cb/f9/e7b0df5cc36286ccafb7a70e23a9dcf9a1c2ee961dcd18509db3757639bf/notebook-5.6.0.tar.gz)\n+[notebook](https://pypi.org/project/notebook) 5.7.0 (from 5.5.0) [tarball](https://files.pythonhosted.org/packages/cd/41/b04ddb3020bdb55431f2a06c87ff98bf68fb27cd0c165ae6421c17d3b5cb/notebook-5.7.0.tar.gz)\n \n There are also two new dependencies:\n - [ipaddress](https://pypi.org/project/ipaddress/) 1.0.22 [tarball](https://files.pythonhosted.org/packages/97/8d/77b8cedcfbf93676148518036c6b1ce7f8e14bf07e95d7fd4ddcb8cc052f/ipaddress-1.0.22.tar.gz)\n``````\n",
    "created_at": "2018-09-19T15:41:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405700",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405701",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405702",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405703",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231881"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405704",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405705",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405706",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231883"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405707",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231885"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231886"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231887"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405708",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405709",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26174#event-231890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26174#issuecomment-405710",
