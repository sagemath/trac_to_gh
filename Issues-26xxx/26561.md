...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[4e49999](https://git.sagemath.org/sage.git/commit?id=4e49999df3d8f68567343e6ff26b39929b6adf3f)|`trac #26561: clean static_sparse_graph.pyx`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[0c0ab5e](https://git.sagemath.org/sage.git/commit/?id=0c0ab5e9387f591c738fa097881b07dd650a48f0)|`trac #26561: fix doctests in finite_semigroups.py`|",
