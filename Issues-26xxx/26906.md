...
```json
{
    "body": "<a id='comment:11'></a>Patchbot is still getting the same failures as comment:4.",
...
<a id='comment:11'></a>Patchbot is still getting the same failures as comment:4.
