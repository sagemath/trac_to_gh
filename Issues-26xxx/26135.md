...
```json
{
    "body": "<a id='comment:1'></a>Same traceback with just\n\n```\nsage: x.__pari__()\n```",
...
<a id='comment:1'></a>Same traceback with just
...
```json
{
    "body": "<a id='comment:2'></a>Same traceback with\n\n```\nsage: x.polynomial()\n```",
...
<a id='comment:2'></a>Same traceback with
...
```json
{
    "body": "<a id='comment:3'></a>culprit found and fixed, please review\n\n---\nNew commits:",
    "created_at": "2018-08-26T16:26:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26135",
    "type": "issue_comment",
...
<a id='comment:3'></a>culprit found and fixed, please review
