...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[debf39c](https://git.sagemath.org/sage.git/commit/?id=debf39c820b66c64428d1d8df3e71fbbae6d4f36)|`Rewrite using RealLazyField.`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[a7347e8](https://git.sagemath.org/sage.git/commit/?id=a7347e8722b298934de84ebda9beae16be13f28d)|`Add support for LazyRandomNumber and RLF.random() to get a random number in [0,1].`|\n|[bb2ce19](https://git.sagemath.org/sage.git/commit/?id=bb2ce193ea22d6bffc18bbab2f7f9d6c619ae63e)|`Remove random number classes, make use of random numbers added to RLF.`|",
    "created_at": "2018-12-05T16:42:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26042",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[fe54abb](https://git.sagemath.org/sage.git/commit/?id=fe54abb47eface212ab114b9f69df5a9610bdb9b)|`Removal of unnecessary lines in _coerce_map_from_`|",
    "created_at": "2018-12-05T16:55:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26042",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------|\n|[43fabba](https://git.sagemath.org/sage.git/commit/?id=43fabbabaaceb7f7afca37a26fcebcaecb7cbdc2)|`First commit`|\n|[961c60b](https://git.sagemath.org/sage.git/commit/?id=961c60b69592a414dd07e385b52ace8e2778b5ba)|`Rewrite using RealLazyField.`|\n|[580303a](https://git.sagemath.org/sage.git/commit/?id=580303a544c9a1e206fec36aaf9a3f873b8e0fe3)|`Add support for LazyRandomNumber and RLF.random() to get a random number in [0,1].`|\n|[26faf3d](https://git.sagemath.org/sage.git/commit/?id=26faf3d1d354c7816a65db45c977dbf7e1ccaee3)|`Remove random number classes, make use of random numbers added to RLF.`|\n|[58c57f9](https://git.sagemath.org/sage.git/commit/?id=58c57f91651f97ba77dbd5bc40ec0ce6f02bf441)|`Removal of unnecessary lines in _coerce_map_from_`|\n|[de1f92d](https://git.sagemath.org/sage.git/commit/?id=de1f92d197316edfba1611026da94f6d9b0adce0)|`Convert the LazyRandomNumber class to cython`|",
    "created_at": "2019-09-17T16:17:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26042",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[0e93f2f](https://git.sagemath.org/sage.git/commit/?id=0e93f2fdb2827c131f26593e1572b9f5467f8e89)|`Adjust to location change of FunctionFieldElement.`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[4a82da8](https://git.sagemath.org/sage.git/commit/?id=4a82da8237254203b4d36ac3498356cde2214edf)|`Make python3 compatible; Add \"long time\" doctest comments.`|",
