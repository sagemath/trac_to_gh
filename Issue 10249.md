...
```json
{
    "body": "#4834 would probably take care of this effect of the problem, but probably wouldn't fix the actual problem.",
    "created_at": "2010-11-11T14:32:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104323",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Tracking this down even more:\n\n\n```\nsage: V=(QQ^2).span_of_basis([[1,1]])\nsage: v=V([1,1])\nsage: w=sqrt(2)*v\nsage: 3*w\n\n\n------------------------------------------------------------\nUnhandled SIGSEGV: A segmentation fault occurred in Sage.\nThis probably occurred because a *compiled* component\nof Sage has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run Sage under gdb with 'sage -gdb' to debug this.\nSage will now terminate (sorry).\n------------------------------------------------------------\n\n```\n",
    "created_at": "2010-11-11T15:25:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104324",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "This works in Sage 4.4.4, and doesn't have anything to do with Pynac, as you now suspect.\n\n```\nsage: var('y')\ny\nsage: get_systems('diff(3*y,y)')\n['ginac']\n```\n\nbut in your example I get\n\n```\nsage: get_systems('3*x')\n[]\n```\n",
    "created_at": "2010-11-11T16:51:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104326",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104327",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Yes, I saw that.  So why don't I get that system as being used?  Maybe we are now using Ginac, after the 4.6, and shouldn't be, due to coercion?  But I have no idea - sorry.",
    "created_at": "2010-11-11T17:20:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104328",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Okay, thanks to John Palmieri testing this out on various versions of Sage, I found that reverting #9502 fixes the issue.  I'm CCing the author and reviewer of #9502.  In short, #9502 causes a segfault with the following code:\n\n\n```\nsage: V=(QQ^2).span_of_basis([[1,1]])\nsage: v=V([1,1])\nsage: x=sqrt(2)*v\nsage: 3*x # but we get a segfault when multiplying x by something\n\n\n------------------------------------------------------------\nUnhandled SIGSEGV: A segmentation fault occurred in Sage.\nThis probably occurred because a *compiled* component\nof Sage has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run Sage under gdb with 'sage -gdb' to debug this.\nSage will now terminate (sorry).\n------------------------------------------------------------\n```\n\n\nDo you guys that did #9502 know what could have caused this?",
    "created_at": "2010-11-11T17:25:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104329",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Now I'm CCing the author/reviewer of #9502.  #9502 is causing a segfault now.  Please #10250 (this ticket) for details.  Do you have any idea of what is happening to cause the segfault?",
    "created_at": "2010-11-11T18:00:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104330",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "I don't, never had issues with segfaults before... I'll look into it, but I am probably not the best person to solve this problem.",
    "created_at": "2010-11-11T18:21:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104331",
...
```json
{
    "body": "No, it's deeper than that.  __rmul__ should call the right coercion stuff so that _rmul_ is eventually called.  So far, I've traced it down to this:\n\n\n```\nsage: p=x.parent()\nsage: p.get_action(3.parent(), operator.mul,False)\n\n\n------------------------------------------------------------\nUnhandled SIGSEGV: A segmentation fault occurred in Sage.\nThis probably occurred because a *compiled* component\nof Sage has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run Sage under gdb with 'sage -gdb' to debug this.\nSage will now terminate (sorry).\n------------------------------------------------------------\n\n\n```\n",
    "created_at": "2010-11-11T23:40:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104333",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Actually, I think something is wrong with the parent:\n\n```\nsage: x.parent().an_element()\n(1, 1)\nsage: x.parent().an_element().__mul__(3)\n(0/0, 0/0)\n```\n",
    "created_at": "2010-11-12T00:08:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104334",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "I think that the appropriate action is not getting registered (which is a problem with the parent), leading to all sorts of weirdness as the coercion system tries to do things.  It can't register the action because when it asks for the action (using the get_action method of the parent), it segfaults.\n\n\n```\nsage: v.parent().get_action(3.parent(), operator.mul, False)\nLeft scalar multiplication by Integer Ring on Vector space of degree 2 and dimension 1 over Rational Field\nUser basis matrix:\n[1 1]\nsage: x.parent().get_action(3.parent(), operator.mul, False)\n\n\n------------------------------------------------------------\nUnhandled SIGSEGV: A segmentation fault occurred in Sage.\nThis probably occurred because a *compiled* component\nof Sage has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run Sage under gdb with 'sage -gdb' to debug this.\nSage will now terminate (sorry).\n------------------------------------------------------------\n\n```\n",
    "created_at": "2010-11-12T00:29:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104335",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Carefully looking at my patch at #9502, I found that I skipped one conversion. I posted a patch that restores it and gives\n\n```\nsage: sage: V=(QQ^2).span_of_basis([[1,1]])\nsage: sage: v=V([1,1])\nsage: sage: w=sqrt(2)*v\nsage: sage: 3*w\n(3*sqrt(2), 3*sqrt(2))\n```\n\nBut I don't yet understand why the single conversion is not good enough.",
    "created_at": "2010-11-12T01:35:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104336",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "We should also add a doctest to the patch.",
    "created_at": "2010-11-12T01:47:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104338",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104339",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104340",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "Ah, now I see. Thank you for the clarification, I'll write a proper patch and post it shortly.",
    "created_at": "2010-11-12T02:02:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104342",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104343",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104344",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "Instead of adding previously removed code I removed some more, now it works and is easier to understand ;-) Didn't run full library tests yet but will do it now and report if there are any issues.",
    "created_at": "2010-11-12T02:19:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104345",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104346",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "I think the new patch looks correct.  Thanks for your work on this!",
    "created_at": "2010-11-12T02:29:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104347",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Tests pass in the modules/ directory.  So if tests pass on the full test suite, please set this to positive review.\n\nThanks again!",
    "created_at": "2010-11-12T02:33:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104348",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10249#event-26333"
}
```
...
```json
{
    "body": "There will be some delay, as sage.math gets out of memory (not because of this patch ;-))",
    "created_at": "2010-11-12T02:56:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104349",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "OK, all long tests pass on mod.math, so I am switching it to \"positive review.\"",
    "created_at": "2010-11-12T03:48:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104350",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104351",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "I think we both came up with the solution independently and worked with each other on authoring and checking each other on this, so I'm putting both of us as authors and reviewers (with Andrey as the primary author and me as the primary reviewer).",
    "created_at": "2010-11-13T01:46:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104352",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10249#issuecomment-104353",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10249",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10249#event-26334"
}
```
