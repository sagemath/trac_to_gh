...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32810#issuecomment-467245",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "We have another version of `find_library` in `sage.misc.compat`, could you take a look at that?",
    "created_at": "2021-12-20T04:40:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32810",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32810#issuecomment-467246",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32810",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32810#issuecomment-467248",
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32810#event-87314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32810",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32810#issuecomment-467249",
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32810#event-87315"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32810#event-87316"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32810#event-87317"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32810#event-87318"
}
```
