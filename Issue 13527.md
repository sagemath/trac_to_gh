# Issue 13527: Fix libsingular memory management

Issue created by migration from https://trac.sagemath.org/ticket/13731

Original creator: nbruin

Original creation time: 2012-11-20 20:16:43
...
Comment by nbruin created at 2012-11-20 20:23:34
...
Comment by nbruin created at 2012-11-20 20:29:35
...
All these error point in the same direction, though: As soon as we start interacting with the singular _interpreter_ we get exposed to whatever memory management it does and we're in big trouble. Use of libsingular on more basic levels usually doesn't expose us to libsingular memory management, so no problems arise.


---

Comment by pcpa created at 2012-11-21 00:49:17
...
Comment by pcpa created at 2012-11-21 03:58:13
...
Comment by nbruin created at 2012-11-21 06:12:22
...
Comment by SimonKing created at 2012-11-21 10:54:54
...
Comment by SimonKing created at 2012-11-21 12:59:51
...
Comment by SimonKing created at 2012-11-21 13:48:54
...
Comment by SimonKing created at 2012-11-21 14:29:09
...
Comment by SimonKing created at 2012-11-21 15:28:13

Building sage-5.5.rc0 did _almost_ succeed.
...
Comment by SimonKing created at 2012-11-21 15:34:58
...
Comment by nbruin created at 2012-11-21 17:05:25
...
Comment by SimonKing created at 2012-11-22 08:01:58
...
Comment by SimonKing created at 2012-11-22 08:05:46
...
Comment by nbruin created at 2012-11-22 09:28:55
...
Comment by SimonKing created at 2012-11-22 09:53:37
...
Comment by SimonKing created at 2012-11-22 10:43:11
...
Comment by SimonKing created at 2012-11-22 10:46:25
...
That's a good news, because the absence of coercion makes life _a lot_ easier...


---

Comment by SimonKing created at 2012-11-22 10:49:49
...
Comment by SimonKing created at 2012-11-22 10:56:09
...
Comment by SimonKing created at 2012-11-22 11:02:01
...
Comment by SimonKing created at 2012-11-22 11:28:43
...
and line 667 is `return nc_mm_Mult_pp(p, q, r)`. That function is defined in `gring.h` (why in a _header_ file, by the way?). I find no indication of "free" being used there, except that it calls `r->GetNC()->p_Procs.mm_Mult_pp(...)`, and I have no idea where that method is being defined.
...
Comment by SimonKing created at 2012-11-22 14:46:07
...
Comment by SimonKing created at 2012-11-22 15:24:32
...
Comment by nbruin created at 2012-11-22 17:13:39
...
I suppose the corruption happens somewhere lower down. Incidentally, the valgrind report points to _exactly_ those two snippets. So valgrind reporting for these things is really very good.


---

Comment by SimonKing created at 2012-11-22 17:38:18
...
Comment by nbruin created at 2012-11-22 18:18:53
...
Comment by nbruin created at 2012-11-22 19:17:17
...
so `ExpSize` gets rounded _up_. If `sizeof(int)=4` and `sizeof(long)=8` then for `rN=2` we get `(rN+1)*sizeof(int)=12` and `ExpSize=16` (which, by the valgrind report, is probably exactly the case we're in). So `p_MemAdd_LengthGeneral` is definitely writing out of bounds. I think this code should simply read:
...
Comment by nbruin created at 2012-11-22 19:48:32
...
Comment by nbruin created at 2012-11-23 07:56:08
...
Comment by SimonKing created at 2012-11-23 08:43:54
...
Comment by SimonKing created at 2012-11-23 10:50:56
...
Comment by SimonKing created at 2012-11-23 10:55:19
...
Comment by nbruin created at 2012-11-23 17:43:56
...
Comment by SimonKing created at 2012-11-23 19:45:36
 ...
 * _Do *not* change the files in `src/`_! They are supposed to be identical with the official Singular 3-1-5 source files.
...
I think it will be a patch to the Singular spkg _in any case_. Waiting for Singular 3-1-6 (which will hopefully contain a fix for the memory problem) is probably no option.


---

Comment by SimonKing created at 2012-11-23 20:51:10
...
Comment by SimonKing created at 2012-11-23 21:01:09

Aha! You also changed spkg-install, so that the patches are actually _not_ applied! That is of course the reason why it didn't work.


---

Comment by nbruin created at 2012-11-23 22:20:47
...
Comment by nbruin created at 2012-11-24 00:23:53
...
Comment by nbruin created at 2012-11-24 00:58:00
...
Comment by SimonKing created at 2012-11-24 07:52:48
...
My plan is to take your Singular-malloc spkg and turn it into a "proper" spkg, in the sense that the changes that you did to the source code will become patches that are _optionally_ applied (say, if one does `export SAGE_SINGULA_MALLOC=yes`).
...
Comment by SimonKing created at 2012-11-24 08:27:10

Now I try to patch the standard Singular spkg so that one can _optionally_ use malloc. But I have two questions on how you created the singular-malloc spkg.
...
Comment by SimonKing created at 2012-11-24 08:35:02
...
Comment by SimonKing created at 2012-11-24 08:39:09
...
Comment by nbruin created at 2012-11-24 08:53:14
...
Comment by SimonKing created at 2012-11-24 09:50:49
...
That means that _all_ patches from the `patches/` directory are applied in your code, and if `make clean` is imperfect then it also means that some auto-generated (machine dependent) files are in your code.
...
Comment by nbruin created at 2012-11-24 18:21:15
...
Comment by SimonKing created at 2012-11-24 20:25:50
...
Comment by nbruin created at 2012-11-24 21:53:56
...
I think I can explain that: omalloc is written to work _on top of_ another memory manager. It doesn't call `mmap` or `sbrk` by itself. So I think this option selects which malloc is used to serve omalloc with pages.
...
The _other_ configuration options (you'll have to read up on it to be sure) deal with what services omalloc provides and how it does it.
...
Comment by SimonKing created at 2012-11-24 22:07:43

Replying to [comment:52 nbruin]:
> I think I can explain that: omalloc is written to work _on top of_ another memory manager.

So, that is `--with-malloc=...`.

> There's an option that selects whether omalloc should offer the standard 'malloc/realloc/free' interface to its own allocators.

What does that mean? If one uses omalloc, why should one _not_ want that it offers `malloc/realloc/free`?
...
I guess I am now experiencing the same that you did: If `--with-emulate-omalloc` is the _only_ change, then installing the spkg fails with
...
Comment by nbruin created at 2012-11-25 03:28:21
...
It selects whether omalloc should offer its services _under those names_, i.e., as a drop-in replacement for the standard libc memory manager. That's not what Singular does. It uses the various _omalloc_ routines, which offer extra options. Otherwise, changing Singular would have been a matter of "dropping out" the drop-in replacement. Instead we have to jump through hoops to get omalloc to use libc's malloc (or whatever drop-in replacement we want to use, like ElectricFence) behind the scenes.


---

Comment by nbruin created at 2012-11-25 03:39:58
...
Comment by SimonKing created at 2012-11-25 08:34:04
...
Comment by SimonKing created at 2012-11-25 08:59:06

Unfortunately, it does _not_ work on bsd.math: The problem appears to be that there is no malloc.h available:
...
Comment by fbissey created at 2012-11-25 09:04:40
...
Comment by fbissey created at 2012-11-25 09:06:12
...
Comment by SimonKing created at 2012-11-25 09:39:56
...
and `omMalloc.h` is created only _after_ that line. Hence I don't understand why it doesn't try to pick up `malloc/malloc.h`.


---

Comment by SimonKing created at 2012-11-25 09:41:46
...
Comment by fbissey created at 2012-11-25 09:47:30
...
Comment by SimonKing created at 2012-11-25 09:53:51
...
Comment by fbissey created at 2012-11-25 10:07:57
...
Comment by SimonKing created at 2012-11-25 11:06:44
...
Comment by SimonKing created at 2012-11-25 19:36:31
...
Comment by fbissey created at 2012-11-25 20:22:59
...
Comment by nbruin created at 2012-11-25 22:22:39
...
Comment by SimonKing created at 2012-11-26 09:36:01
...
Comment by SimonKing created at 2012-11-26 09:46:17
...
Comment by fbissey created at 2012-11-26 09:51:27
...
Comment by SimonKing created at 2012-11-26 09:59:45
...
Comment by fbissey created at 2012-11-26 10:04:34
...
Comment by SimonKing created at 2012-11-26 10:15:13
...
Comment by fbissey created at 2012-11-26 10:27:17
...
Comment by SimonKing created at 2012-11-26 10:49:29
...
Comment by SimonKing created at 2012-11-26 11:07:45
...
Comment by SimonKing created at 2012-11-26 11:53:06
...
Comment by malb created at 2012-11-26 12:16:56
...
Comment by SimonKing created at 2012-11-26 12:39:20
...
The problem with src/omalloc/configure _only_ concerns purpose 1. Hence, if directly editing src/omalloc/configure is dirty but works, then I wouldn't mind to do it, just so that it builds on osx.
...
Comment by SimonKing created at 2012-11-26 12:40:43
...
Comment by SimonKing created at 2012-11-26 14:39:56
...
Comment by nbruin created at 2012-11-26 20:48:13
...
Comment by SimonKing created at 2012-11-27 13:12:56
...
Comment by SimonKing created at 2012-11-29 13:27:18
...
Comment by SimonKing created at 2012-11-29 13:31:21
...
Comment by SimonKing created at 2012-11-29 13:37:08
...
Comment by SimonKing created at 2012-11-29 14:09:53
...
Comment by SimonKing created at 2012-11-29 22:06:51
...
The spkg is not ready for review yet (for example, SPKG.txt needs to be updated, and there are uncommited changes). But it contains two bug fixes from upstream, it builds on Linux and OSX, and one can _optionally_ build libsingular and the Singular executable based on xalloc.
...
```
  ...
  The shell prompt does not return, ctrl-C has no effect - I have to pkill all Python processes! Note that `P.<x,y>=QQ[]` alone does _not_ trigger the problem.
...
Comment by nbruin created at 2012-11-30 00:39:21
...
Comment by nbruin created at 2012-11-30 01:17:11
...
Comment by SimonKing created at 2012-11-30 06:34:06
...
Or, yet another possibility: If I am not mistaken, the bins don't really matter when omalloc is ripped out. Hence, one could perhaps simply do _nothing_ instead?
...
Comment by nbruin created at 2012-11-30 07:18:18
...
Comment by nbruin created at 2012-11-30 07:53:43
...
Comment by nbruin created at 2012-11-30 08:37:25
...
Comment by nbruin created at 2012-11-30 08:51:16
...
Comment by SimonKing created at 2012-11-30 10:09:12
...
Comment by SimonKing created at 2012-11-30 10:31:32
...
Comment by SimonKing created at 2012-11-30 10:44:41
...
Comment by SimonKing created at 2012-11-30 12:00:20
...
Comment by SimonKing created at 2012-11-30 13:36:56
...
Comment by SimonKing created at 2012-11-30 13:45:21
...
Comment by SimonKing created at 2012-11-30 14:25:49
...
Comment by SimonKing created at 2012-11-30 14:35:48
...
Comment by SimonKing created at 2012-11-30 15:43:42
...
Comment by SimonKing created at 2012-11-30 15:46:01
...
Comment by SimonKing created at 2012-11-30 17:15:57
...
Comment by nbruin created at 2012-11-30 17:36:08
...
Comment by SimonKing created at 2012-11-30 18:48:25
...
Second result: Yes, it is _incredibly_ slow!
...
Comment by SimonKing created at 2012-12-01 10:06:04
...
Comment by SimonKing created at 2012-12-01 10:52:51
...
Comment by SimonKing created at 2012-12-01 14:15:54
...
Comment by nbruin created at 2012-12-01 17:30:21
...
Comment by SimonKing created at 2012-12-01 18:15:48

Replying to [comment:114 nbruin]:
> I think running `sage -t --gdb ...` disables the timeout. If you're just testing a single file you might as well do that (in `screen` of course--it'll be a while before you check back). It's how I got thetraceback for the first heisenbug. It also leaves you immediately with an environment where you can examine the backtrace etc.

Well, I first wanted to have a "quick" overview: Is there any problematic test? Namely, on Linux, everything works just fine with MALLOC_CHECK_ (except the known problem with the graphs). And _if_ there is another crash on OSX in the quick test then I wanted to analyse it more deeply.

But the only test that did not timeout with `SAGE_TIMEOUT=1800` was a test that normally takes 3.5 seconds...

Is there any other memory checker than gmalloc that I can use on OSX, that is faster and finds _some_ of the issues that gmalloc would find?


---

Comment by nbruin created at 2012-12-01 18:20:06
...
Comment by SimonKing created at 2012-12-03 13:04:46
...
Comment by SimonKing created at 2012-12-06 07:18:27
...
Comment by nbruin created at 2012-12-06 18:16:54
...
Comment by nbruin created at 2012-12-07 21:29:35
...
Comment by SimonKing created at 2012-12-15 11:24:02
...
Comment by nbruin created at 2012-12-16 03:14:22
...
Comment by jdemeyer created at 2012-12-18 11:14:57
...
Comment by jdemeyer created at 2012-12-21 07:57:05
...
Comment by jdemeyer created at 2012-12-21 07:57:36
...
Comment by SimonKing created at 2012-12-21 10:01:23
...
Comment by SimonKing created at 2012-12-21 10:19:14
...
Comment by jdemeyer created at 2012-12-21 10:31:33
...
Comment by jdemeyer created at 2012-12-21 10:59:34
...
Comment by jdemeyer created at 2012-12-21 11:00:15
...
Comment by vbraun created at 2012-12-24 13:31:58
...
Comment by vbraun created at 2012-12-24 13:43:31
...
Comment by jdemeyer created at 2012-12-26 16:27:40
...
Comment by SimonKing created at 2012-12-26 17:38:24
...
Comment by vbraun created at 2012-12-28 11:37:19
