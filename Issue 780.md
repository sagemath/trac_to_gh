# Issue 780: [with patch, positive review] calculus integration failing due to maxima interacting when it shouldn't
...
```json
{
    ...
    "title": "[with patch, positive review] calculus integration failing due to maxima interacting when it shouldn't",
    "type": "issue",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/780#event-2149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/780",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/780#event-2150"
}
```
