...
```json
{
    "body": "You'll have our eternal gratitude if you can post a git branch with the change ;-)",
    "created_at": "2014-10-09T16:57:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223551",
    "user": "vbraun"
}
```
...
```json
{
    "body": "Certainly there should not be implemented a modified and renamed binomial function in addition to the existing monomial function. The existing should just be extended to the case of negative input.",
    "created_at": "2014-10-09T17:22:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223552",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I'm not sarcastic, just trying to nudge you into the right direction ;-)",
    "created_at": "2014-10-09T19:14:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223554",
    "user": "vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223556",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I know that there is a learning curve, but once you figure it out it is a very efficient workflow. So what I'm trying to say is: Its worthwhile to figure out how to use git.\n\n`_eval_` and `_evalf_` punt to either `_binomial_sym` (for symbolic expressions) or `sage.rings.arith.binomial` (for numbers), so both of the latter need to be changed.",
    "created_at": "2014-10-09T21:11:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223558",
    "user": "vbraun"
}
```
...
```json
{
    "body": "TFA talks about gamma functions in the abstract, so I would have thought that it matches the extension that we would all write down (and is in the wp article)... though I haven't read it ;-)",
    "created_at": "2014-10-09T21:54:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223560",
    "user": "vbraun"
}
```
...
```json
{
    "body": "Volker, acronyms are nice for those who understand. Do I have to understand 'TFA' or 'wp'?",
    "created_at": "2014-10-09T23:40:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223561",
    "user": "pluschny"
}
```
...
```json
{
    "body": "We could also have an optional keyword argument `binomial(n, k, extension='Knuth')`",
    "created_at": "2014-10-10T12:15:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223564",
    "user": "vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223568",
    "user": "darij"
}
```
...
```json
{
    "body": "As a string theorist, I approve of 1+2+3+... = -1/12 ;-)",
    "created_at": "2014-10-11T10:43:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223570",
    "user": "vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223572",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223573",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223574",
    "user": "chapoton"
}
```
...
```json
{
    "body": "I am not convinced at all by the desire (why ?) to get the usual recursion extend to all k and n. Instead, I am doing concrete and complicated hypergeometric computations right now, where I am put in trouble by the fact that sage currently says that binomial(-1,-1) is 0.\n\nBut I am worried by the different behaviour in Maxima, saying binomial(-1,-1)=0. We also have giac, that says binomial(-1,-1)=1.\n\n```\nsage: a=ZZ(-1)\nsage: a._giac_().binomial(-1)\n1\nsage: a._maxima_().binomial(-1)\n0\nsage: a.__pari__().binomial(-1)\n0\n```\n\n----\nNew commits:",
    "created_at": "2017-07-28T16:01:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223575",
    "user": "chapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223577",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223578",
    "user": "chapoton"
}
```
...
```json
{
    "body": "Well, this identity of yours stays true for all n and k>=0 if you use the floor bound.\n\nI would like to argue that not using a floor bound is correct if n > 0, but is not the good way to go if n < 0.\n\nEnough for today..",
    "created_at": "2017-07-28T20:11:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223582",
    "user": "chapoton"
}
```
...
```json
{
    "body": "From all this it seems to me the best way to resolve this issue is by providing an additional function. Deprecation can then be discussed in a new ticket. The name `C` comes to mind. Please give your naming ideas too.",
    "created_at": "2017-07-29T06:32:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223583",
    "user": "rws"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223585",
    "user": "pluschny"
}
```
...
```json
{
    "body": "OK, I thought that Frederic was referring to the other expression of the binomial in terms of the gamma function.  I was further misled by another blog post saying that Mathematica uses the iterated limit definition.\n\nSo, one question is whether sage should use\n\n```\nlimit(gamma(x0 + h) / (gamma(y0 + h)*gamma(x0-y0+h)), h=1)\n```\n\nor\n\n```\nlimit(gamma(x + 1) / (gamma(y + 1)*gamma(x-y+1)), (x,y)=(x0,y0))\n```\n\nas definition, and you are saying that the first is better, because it is works always, right?",
    "created_at": "2017-07-29T08:23:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223586",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223587",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223589",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223591",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223593",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223594",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223595",
    "user": "pluschny"
}
```
...
```json
{
    "body": "I think it is calling for trouble not to raise an error for negative integral first argument.  As much as I dislike python, I think \"explicit is better than implicit\" is a sensible rule.\n\nIf some functionality relies on `binomial(-1,-1)=1`, it will be much easier to maintain it if this stated explicitely, for example:\n\n```\ndef fun():\n    binomial = lambda x,y: binomial(x, y, extension='Gamma')\n    return binomial(-1,-1)\n```\n",
    "created_at": "2017-07-29T18:46:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223598",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223599",
    "user": "pluschny"
}
```
...
```json
{
    "body": "Darij, are you sure that Peter proposal changes the default for `k>=0`?",
    "created_at": "2017-07-29T19:29:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223601",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223602",
    "user": "darij"
}
```
...
```json
{
    "body": "As far as I can see, Peter is proposing the \"Gamma\" convention from https://arxiv.org/pdf/math/9502218.pdf.  I think that this agrees with what is roughly the \"classical\" convention in the paper whenever the latter is defined, that is `limit(gamma(x+1)/(gamma(y+1)*gamma(x-y+1)), (x,y)=(n,k))` whenever the limit exists.\n\nSo they agree in particular for `k>=0`.\n\nHowever, I still think it would be better to force users to make an explicit choice for negative integral `n`.",
    "created_at": "2017-07-29T19:47:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223603",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223605",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223607",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223609",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223611",
    "user": "pluschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16886#issuecomment-223615",
    "user": "pluschny"
}
```
