...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262489"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18471#issuecomment-254971",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18471#issuecomment-254972",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18471#issuecomment-254973",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262494"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18471#issuecomment-254974",
...
```json
{
    "body": "<div id=\"comment:4\" align=\"right\">comment:4</div>\n\nReplying to [@sagetrac-jhonrubia6](#comment:3):\n> Done in #19953\n\nConfirmed.",
    "created_at": "2016-04-25T11:18:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/18471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18471#issuecomment-254975",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18471#event-262499"
}
```
