...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263189"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18520#issuecomment-256556",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263194"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263195"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18520#issuecomment-256557",
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263197"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18520#issuecomment-256558",
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263199"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263200"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263201"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18520#issuecomment-256559",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18520#issuecomment-256560",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263204"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263205"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18520#event-263206"
}
```
