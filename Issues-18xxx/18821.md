...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18821#issuecomment-332126",
...
```json
{
    "body": "<a id='comment:1'></a>Works in sage 8.9.b7:\n\n```\nsage: F = lambda z: (2/pi)*integral((4*cos(x)^2-1)^z*sin(x)^2,x,0,pi)\nsage: \nsage: F(0)\n1\nsage: F(1)\n0\nsage: F(0.5)\n(1.161499228562 + 1.520039988172*I)/pi\n```\n\nBut symbolic integration F(1/2) get stuck inside Sympy.",
    "created_at": "2019-08-24T19:11:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18821#issuecomment-332127",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>Works in sage 8.9.b7:
