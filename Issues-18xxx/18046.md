...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18046",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18046#issuecomment-248282",
    "user": "https://github.com/sagetrac-jclaas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18046",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18046#issuecomment-248283",
    "user": "https://github.com/sagetrac-jclaas"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18046#event-238989"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18046#event-238990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18046#event-238991"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18046#event-238992"
}
```
