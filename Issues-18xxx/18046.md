...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[b025f2a](https://github.com/sagemath/sagetrac-mirror/commit/b025f2ad103c5596edde303e6bcf983ecea4d0e2)|`all features from local hack have been added, plus a warning about edge customizations`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|\n|[b3721b4](https://github.com/sagemath/sagetrac-mirror/commit/b3721b4fd42959a87ee415643a44776d2e8d83c2)|`replaced new variables with long names, replaced stopgap with NotImplementedError, fixed typo in internal type check for edge customizations`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[d2ebe22](https://github.com/sagemath/sagetrac-mirror/commit/d2ebe228caee2da94ecee214bf7a8f52004228be)|`- fixed edge_thicknesses and many styling issues`|",
