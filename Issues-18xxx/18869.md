...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18869#event-250149"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18869#event-250150"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18869#event-250151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18869#event-250152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18869#issuecomment-266808",
    "user": "https://github.com/dimpase"
}
```
