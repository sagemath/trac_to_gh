...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247288"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18650#issuecomment-262225",
    "user": "https://github.com/sagetrac-dmuthiah"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18650",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18650#event-247296"
}
```
