...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18654#issuecomment-328061",
...
```json
{
    "body": "<a id='comment:2'></a>As you have shown in the ticket description, the zero element in the free algebra can be reduced. The INTEGER zero element has nothing to do with free algebras, hence, reduction can not be provided.",
    "created_at": "2015-06-09T16:53:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18654#issuecomment-328063",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>As you have shown in the ticket description, the zero element in the free algebra can be reduced. The INTEGER zero element has nothing to do with free algebras, hence, reduction can not be provided.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18654#issuecomment-328064",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18654#issuecomment-328065",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18654#event-52309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18654#issuecomment-328066",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18654",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18654#event-52310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18654#issuecomment-328067",
