...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260746"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260749"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260752"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260753"
}
```
...
```json
{
    "body": "<div id=\"comment:57\" align=\"right\">comment:57</div>\n\nLet's make the new R version and its attendant patch a separate issue and ship the patch shown in [comment:51](#comment:51).",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260754"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260755"
}
```
...
```json
{
    "body": "<div id=\"comment:63\" align=\"right\">comment:63</div>\n\nLet's merge this. The change was first suggested [in comment 44](#comment:44), so I've made buck the author.",
    "created_at": "2015-04-26T15:45:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/18254",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260757"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18254#event-260758"
}
```
