...
```json
{
    "body": "<a id='comment:2'></a>Those are warnings, not errors. The buildbot log shows the same warnings ( http://build.sagedev.org/release/builders/%20%20fast%20Volker%20MiniMac%20%28OSX%2010.10%20x86_64%29%20full/builds/42/steps/compile_1/logs/r-project). Do you have `-Werror` or something like that in CFLAGS/CXXFLAGS/...? This looks like a problem with your environment variables.",
    "created_at": "2015-04-20T03:02:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316742",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Those are warnings, not errors. The buildbot log shows the same warnings ( http://build.sagedev.org/release/builders/%20%20fast%20Volker%20MiniMac%20%28OSX%2010.10%20x86_64%29%20full/builds/42/steps/compile_1/logs/r-project). Do you have `-Werror` or something like that in CFLAGS/CXXFLAGS/...? This looks like a problem with your environment variables.
...
```json
{
    "body": "<a id='comment:4'></a>The error I've pointed out does not show in your buildbot log.",
    "created_at": "2015-04-20T03:20:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316744",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:4'></a>The error I've pointed out does not show in your buildbot log.
...
```json
{
    "body": "<a id='comment:5'></a>On osx 10.10, `__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_9_0)` expands to `__attribute__((availability(macosx,introduced=10.10)))`, which helps explain the error message..\n\nI expect the difference is that your buildbot is not 10.10.",
    "created_at": "2015-04-20T03:34:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316745",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:5'></a>On osx 10.10, `__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_9_0)` expands to `__attribute__((availability(macosx,introduced=10.10)))`, which helps explain the error message..
...
```json
{
    "body": "<a id='comment:6'></a>I'm guessing that this has to do with Xcode, and in particular the fact that its most recent version is broken.",
    "created_at": "2015-04-20T05:50:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316746",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>I'm guessing that this has to do with Xcode, and in particular the fact that its most recent version is broken.
...
```json
{
    "body": "<a id='comment:7'></a>Sage sets `MACOSX_DEPLOYMENT_TARGET=10.9` on 10.10 to work around Apple's broken toolchain so the conditional should be false. Though the error is about what is **before** the `__OSX_AVAILABLE_STARTING`. What are the relevant lines in your Availability.h?\n\nI thought we had established that he is using Xcode < 6.3 on the mailinglist? With Xcode 6.3 he should't have gotten this far, the compilation pretty much dies immediately.",
    "created_at": "2015-04-20T12:51:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316747",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>Sage sets `MACOSX_DEPLOYMENT_TARGET=10.9` on 10.10 to work around Apple's broken toolchain so the conditional should be false. Though the error is about what is **before** the `__OSX_AVAILABLE_STARTING`. What are the relevant lines in your Availability.h?
...
```json
{
    "body": "<a id='comment:8'></a>PS: The buildbot most certainly is on OSX 10.10.3",
    "created_at": "2015-04-20T12:52:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316748",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>PS: The buildbot most certainly is on OSX 10.10.3
...
```json
{
    "body": "<a id='comment:9'></a>On a machine on which I upgraded Xcode, I run into the same problem, and that machine built Sage fine before the upgrade.",
    "created_at": "2015-04-20T14:58:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316749",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>On a machine on which I upgraded Xcode, I run into the same problem, and that machine built Sage fine before the upgrade.
...
```json
{
    "body": "<a id='comment:10'></a>Here's the gcc version you asked for:\n\n```\n$ which gcc\n/usr/bin/gcc\n\n$ gcc --version\nConfigured with: --prefix=/Applications/Xcode.app/Contents/Developer/usr --with-gxx-include-dir=/usr/include/c++/4.2.1\nApple LLVM version 6.1.0 (clang-602.0.49) (based on LLVM 3.6.0svn)\nTarget: x86_64-apple-darwin14.3.0\nThread model: posix\n```\n\nThe XCode GUI reports \"Version 6.3 (6D570)\".",
    "created_at": "2015-04-20T15:42:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316750",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:10'></a>Here's the gcc version you asked for:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316751",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316752",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I've attached the entire files just in case I've gotten it wrong, but I believe these are the relevant lines.\n\nAvailability.h:\n\n```\n162 #elif defined(__MAC_OS_X_VERSION_MIN_REQUIRED)\n163     #define __OSX_AVAILABLE_STARTING(_osx, _ios) __AVAILABILITY_INTERNAL##_osx\n```\n\nAvailabilityInternal.h:\n\n```\n5513 #define __AVAILABILITY_INTERNAL__MAC_10_10\n                  __attribute__((availability(macosx,introduced=10.10)))\n```",
    "created_at": "2015-04-20T15:47:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316753",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:11'></a>I've attached the entire files just in case I've gotten it wrong, but I believe these are the relevant lines.
...
```json
{
    "body": "<a id='comment:12'></a>Xcode 6.3 isn't going to work (#18156). Propose to close as duplicate.",
    "created_at": "2015-04-20T15:53:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316754",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>Xcode 6.3 isn't going to work (#18156). Propose to close as duplicate.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18254#event-51555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316755",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>While both these issues may be caused by xcode-6.3, they look like separate bugs, separate pieces of work to me.\n\nI upgraded my Xcode at the recommendation of one of the guys at sage days :(\nShall I downgrade to 6.2?",
    "created_at": "2015-04-20T16:08:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316756",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:14'></a>While both these issues may be caused by xcode-6.3, they look like separate bugs, separate pieces of work to me.
...
```json
{
    "body": "<a id='comment:15'></a>yes, downgrade to 6.2",
    "created_at": "2015-04-20T16:13:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316757",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:15'></a>yes, downgrade to 6.2
...
```json
{
    "body": "<a id='comment:17'></a>Did you compile from scratch (make distclean && make)?",
    "created_at": "2015-04-20T19:32:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316759",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>Did you compile from scratch (make distclean && make)?
...
```json
{
    "body": "<a id='comment:18'></a>I know you weren't asking me, but a further data point: I did not compile from scratch. On one machine, I had updated to OS X 10.10.3 and the most recent Xcode, and I got this error. On a second machine, I just updated to OS X 10.10.3 but did not update Xcode, and I was able to install R (with `sage -f r`) successfully. Now on that same machine I'm also trying a build from scratch, but from the experiments so far, it really looks like a manifestation of a problem with the most recent Xcode.\n\nNote that I have not yet tried upgrading Xcode and then downgrading it.",
    "created_at": "2015-04-20T20:13:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316760",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:18'></a>I know you weren't asking me, but a further data point: I did not compile from scratch. On one machine, I had updated to OS X 10.10.3 and the most recent Xcode, and I got this error. On a second machine, I just updated to OS X 10.10.3 but did not update Xcode, and I was able to install R (with `sage -f r`) successfully. Now on that same machine I'm also trying a build from scratch, but from the experiments so far, it really looks like a manifestation of a problem with the most recent Xcode.
...
```json
{
    "body": "<a id='comment:20'></a>Whereas I downloaded a fresh 6.7.beta1 tarball and built it successfully on the machine running OS X 10.10.3 and Xcode 6.2. On another machine on which I've installed Xcode 6.3, I may try downgrading that to see if I can build there.",
    "created_at": "2015-04-20T22:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316762",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:20'></a>Whereas I downloaded a fresh 6.7.beta1 tarball and built it successfully on the machine running OS X 10.10.3 and Xcode 6.2. On another machine on which I've installed Xcode 6.3, I may try downgrading that to see if I can build there.
...
```json
{
    "body": "<a id='comment:22'></a>Unsetting `MACOSX_DEPLOYMENT_TARGET` makes the .o file build fine...\n\nReproduction procedure:\n\n```\ncd 'local/var/tmp/sage/build/r-3.1.2.p0' && '../../../../../../sage' --sh\ncd src/src/library/grDevices/src\ngcc -std=gnu99 -I../../../../include -DNDEBUG -I../../../include -I../../../../src/include -DHAVE_CONFIG_H -I../../../../src/extra/zlib -fPIC  -g -O2   -c devQuartz.c -o devQuartz.o\n#syntax error explosion\nenv | grep MACOSX\n#MACOSX_DEPLOYMENT_TARGET=10.9\nunset MACOSX_DEPLOYMENT_TARGET\nenv | grep MACOSX\n#no output\ngcc -std=gnu99 -I../../../../include -DNDEBUG -I../../../include -I../../../../src/include -DHAVE_CONFIG_H -I../../../../src/extra/zlib -fPIC  -g -O2   -c devQuartz.c -o devQuartz.o\n#several warnings, but no error\n```",
    "created_at": "2015-04-20T23:45:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316764",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:22'></a>Unsetting `MACOSX_DEPLOYMENT_TARGET` makes the .o file build fine...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316766",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>It is running 10.10, according to \"About my Mac\" and `uname`:\n\n```\n$ uname -v\nDarwin Kernel Version 14.3.0: Mon Mar 23 11:59:05 PDT 2015; root:xnu-2782.20.48~5/RELEASE_X86_64\n```\nI have Xcode 6.2. No homebrew or anything similar. What else would you like to know?",
    "created_at": "2015-04-21T01:08:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316767",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:25'></a>It is running 10.10, according to "About my Mac" and `uname`:
...
```json
{
    "body": "<a id='comment:27'></a>Also note that xcode and clt (command line tools) are separate packages and you can easily have different versions installed...",
    "created_at": "2015-04-21T12:25:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316769",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:27'></a>Also note that xcode and clt (command line tools) are separate packages and you can easily have different versions installed...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316770",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>`@`vbraun: Where's the ticket that induced you (plural) to twiddle the `MACOSX_DEPLOYMENT_TARGET` ?",
    "created_at": "2015-04-21T17:12:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316771",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:29'></a>`@`vbraun: Where's the ticket that induced you (plural) to twiddle the `MACOSX_DEPLOYMENT_TARGET` ?
...
```json
{
    "body": "<a id='comment:31'></a>It seems like this bug has the reproduction information I was looking for: https://gcc.gnu.org/bugzilla/show_bug.cgi?id=63610\n\nBecause I was able to `make distclean && make` with no issues whatsoever, I think the libtool problem is gone, and the workaround should be removed, since it is the source of this bug at hand.",
    "created_at": "2015-04-21T17:29:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316773",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:31'></a>It seems like this bug has the reproduction information I was looking for: https://gcc.gnu.org/bugzilla/show_bug.cgi?id=63610
...
```json
{
    "body": "Changing branch from \"\" to \"u/buck/unset_macosx_deployment_target_18254\"",
    "created_at": "2015-04-21T17:52:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316775",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

Changing branch from "" to "u/buck/unset_macosx_deployment_target_18254"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316776",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316777",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>There is nothing bogus about setting an earlier MACOSX_DEPLOYMENT_TARGET, its commonly used to make binaries that **in addition** run on older versions. \n\nAutotool-based projects are supposed to ship their own copy of libtool, not use the system libtool.",
    "created_at": "2015-04-21T18:34:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316778",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:34'></a>There is nothing bogus about setting an earlier MACOSX_DEPLOYMENT_TARGET, its commonly used to make binaries that **in addition** run on older versions. 
...
```json
{
    "body": "<a id='comment:35'></a>Well... that patch is bogus then.\n\nIt's still mysterious that unsetting it \"solves\" this problem.",
    "created_at": "2015-04-21T18:47:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316779",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:35'></a>Well... that patch is bogus then.
...
```json
{
    "body": "Changing commit from \"569f12d06763baf11bf341129a9b7312a2bceb24\" to \"\"",
    "created_at": "2015-04-21T18:47:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316780",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

Changing commit from "569f12d06763baf11bf341129a9b7312a2bceb24" to ""
...
```json
{
    "body": "Changing branch from \"u/buck/unset_macosx_deployment_target_18254\" to \"\"",
    "created_at": "2015-04-21T18:47:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316781",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

Changing branch from "u/buck/unset_macosx_deployment_target_18254" to ""
...
```json
{
    "body": "<a id='comment:37'></a>Have you tried an earlier MACOSX_DEPLOYMENT_TARGET, maybe 10.8? We just have to find a combination that circumvents all bugs in Xcode...",
    "created_at": "2015-04-22T00:06:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316782",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:37'></a>Have you tried an earlier MACOSX_DEPLOYMENT_TARGET, maybe 10.8? We just have to find a combination that circumvents all bugs in Xcode...
...
```json
{
    "body": "<a id='comment:38'></a>I tried with `MACOSX_DEPLOYMENT_TARGET=10.10` and got a segfault, so I guess that bug is still around.\n\nWhy is `unset MACOSX_DEPLOYMENT_TARGET` a non-starter? \n\nI'll try 10.8...",
    "created_at": "2015-04-22T04:11:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316783",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:38'></a>I tried with `MACOSX_DEPLOYMENT_TARGET=10.10` and got a segfault, so I guess that bug is still around.
...
```json
{
    "body": "<a id='comment:39'></a>I've verified that anything other than `MACOSX_DEPLOYMENT_TARGET=10.10` throws the OP error.\n\nCan I change the if-10.10 to do an unset?",
    "created_at": "2015-04-22T04:19:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316784",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:39'></a>I've verified that anything other than `MACOSX_DEPLOYMENT_TARGET=10.10` throws the OP error.
...
```json
{
    "body": "<a id='comment:41'></a>This only reproduces with GNU gcc, not with /usr/bin/gcc.\n\ngcc bug?",
    "created_at": "2015-04-22T05:08:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316786",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:41'></a>This only reproduces with GNU gcc, not with /usr/bin/gcc.
...
```json
{
    "body": "<a id='comment:44'></a>`@`jhpalmieri That looks like the abort errors mentioned in sage-env. It says to look at #7095\n\nOne workaround is to configure R with `--with-aqua=no`, but I don't know if that's acceptable. I don't know what aqua is or what R might use it for.",
    "created_at": "2015-04-22T06:13:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316789",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:44'></a>`@`jhpalmieri That looks like the abort errors mentioned in sage-env. It says to look at #7095
...
```json
{
    "body": "<a id='comment:45'></a>I'm pretty sure that some old libtool versions still linger in third-party tarballs, so we'll need MACOSX_DEPLOYMENT_TARGET <= 10.9 for a while.",
    "created_at": "2015-04-22T12:10:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316790",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:45'></a>I'm pretty sure that some old libtool versions still linger in third-party tarballs, so we'll need MACOSX_DEPLOYMENT_TARGET <= 10.9 for a while.
...
```json
{
    "body": "<a id='comment:46'></a>Disabling aqua (=OSX gui), at least until Apple publishes a working Xcode, is fine with me.",
    "created_at": "2015-04-22T12:26:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316791",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:46'></a>Disabling aqua (=OSX gui), at least until Apple publishes a working Xcode, is fine with me.
...
```json
{
    "body": "<a id='comment:47'></a>I'm confused about the goal here. As far as I can tell, if you have Xcode 6.3, Sage won't build, and the problem won't be with `R`, but with `gcc`. If you delete Xcode 6.3 and install version 6.2 of the command-line tools, Sage will build. Is this reproducible by anyone else? If so, what problem are we trying to solve with this ticket?",
    "created_at": "2015-04-22T17:28:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316792",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:47'></a>I'm confused about the goal here. As far as I can tell, if you have Xcode 6.3, Sage won't build, and the problem won't be with `R`, but with `gcc`. If you delete Xcode 6.3 and install version 6.2 of the command-line tools, Sage will build. Is this reproducible by anyone else? If so, what problem are we trying to solve with this ticket?
...
```json
{
    "body": "<a id='comment:48'></a>You're mistaken. I've been running 6.2 this whole time.",
    "created_at": "2015-04-22T17:45:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316793",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:48'></a>You're mistaken. I've been running 6.2 this whole time.
...
```json
{
    "body": "<a id='comment:49'></a>I wish any of you were on IRC. This would all go so much more quickly.",
    "created_at": "2015-04-22T17:48:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316794",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:49'></a>I wish any of you were on IRC. This would all go so much more quickly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316795",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>There is a new R release at #18229, does it change anything?",
    "created_at": "2015-04-24T21:58:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316798",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:52'></a>There is a new R release at #18229, does it change anything?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316799",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>`--without-system-bzlib` did the trick. I also noticed that with r-3.1.2 bzip2 was not properly detected during configuration on my mac and therefore the internal copy was used in that case too.",
    "created_at": "2015-04-25T11:58:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316801",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:55'></a>`--without-system-bzlib` did the trick. I also noticed that with r-3.1.2 bzip2 was not properly detected during configuration on my mac and therefore the internal copy was used in that case too.
...
```json
{
    "body": "<a id='comment:56'></a>That works for me, too. All tests pass.",
    "created_at": "2015-04-25T19:33:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316802",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:56'></a>That works for me, too. All tests pass.
...
```json
{
    "body": "<a id='comment:57'></a>Let's make the new R version and its attendant patch a separate issue and ship the patch shown in[comment:51](#comment%3A51).",
    "created_at": "2015-04-26T03:55:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316803",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:57'></a>Let's make the new R version and its attendant patch a separate issue and ship the patch shown in[comment:51](#comment%3A51).
...
```json
{
    "body": "Changing branch from \"\" to \"u/buck/18254_osx_R_noaqua\"",
    "created_at": "2015-04-26T04:08:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316804",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

Changing branch from "" to "u/buck/18254_osx_R_noaqua"
...
```json
{
    "body": "Changing commit from \"\" to \"ad87162c8b4b7ccef0553ad66d9a6b2e112c8f48\"",
    "created_at": "2015-04-26T04:08:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316805",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

Changing commit from "" to "ad87162c8b4b7ccef0553ad66d9a6b2e112c8f48"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316806",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316807",
...
```json
{
    "body": "Changing commit from \"ad87162c8b4b7ccef0553ad66d9a6b2e112c8f48\" to \"3c5cd0f74446992a2b98f84c34043cfa181b68b4\"",
    "created_at": "2015-04-26T04:08:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316808",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "ad87162c8b4b7ccef0553ad66d9a6b2e112c8f48" to "3c5cd0f74446992a2b98f84c34043cfa181b68b4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316812",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316813",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316814",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:63'></a>Let's merge this. The change was first suggested [in comment 44](#comment%3A44), so I've made buck the author.",
    "created_at": "2015-04-26T15:45:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316815",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:63'></a>Let's merge this. The change was first suggested [in comment 44](#comment%3A44), so I've made buck the author.
...
```json
{
    "body": "<a id='comment:64'></a>Merge or close as invalid? Can you set the milestone if you actually want to merge the branch?",
    "created_at": "2015-04-27T00:16:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316816",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:64'></a>Merge or close as invalid? Can you set the milestone if you actually want to merge the branch?
...
```json
{
    "body": "<a id='comment:65'></a>Sorry. I think you set the milestone a while ago, and no one reset it to match the new branch.",
    "created_at": "2015-04-27T01:09:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316817",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:65'></a>Sorry. I think you set the milestone a while ago, and no one reset it to match the new branch.
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18254#event-51556"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18254#event-51557"
}
```
...
```json
{
    "body": "Changing branch from \"u/buck/18254_osx_R_noaqua\" to \"3c5cd0f74446992a2b98f84c34043cfa181b68b4\"",
    "created_at": "2015-04-27T04:16:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316818",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/buck/18254_osx_R_noaqua" to "3c5cd0f74446992a2b98f84c34043cfa181b68b4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18254#event-51558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18254#issuecomment-316819",
    "user": "https://github.com/vbraun"
}
```
