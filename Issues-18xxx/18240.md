...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[6785ef2](http://git.sagemath.org/sage.git/commit/?id=6785ef2000d220f511fcf3e9830b05099500ef47)|`restored wrongly removed file, and deleted one that should have gone`|",
