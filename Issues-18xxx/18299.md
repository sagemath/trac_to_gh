...
```json
{
    "body": "<a id='comment:1'></a>Deprecation... again, iterators are good in general, but harder for absolute newbies.",
    "created_at": "2015-04-28T13:41:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18299#issuecomment-258857",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Deprecation... again, iterators are good in general, but harder for absolute newbies.
...
```json
{
    "body": "<a id='comment:3'></a>I don't really want it to be an iterator, but that seemed to be the point of this ticket.  I just want to make sure there is a way to return a list easily, though this is less important than for primes per se.",
    "created_at": "2015-04-28T15:26:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18299#issuecomment-258859",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>I don't really want it to be an iterator, but that seemed to be the point of this ticket.  I just want to make sure there is a way to return a list easily, though this is less important than for primes per se.
...
```json
{
    "body": "<a id='comment:4'></a>I like `future_prime_powers()`; sounds like it would return numbers which aren't yet prime powers (but will in a few years, say)...",
    "created_at": "2015-05-06T07:34:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18299#issuecomment-258860",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>I like `future_prime_powers()`; sounds like it would return numbers which aren't yet prime powers (but will in a few years, say)...
...
```json
{
    "body": "<a id='comment:6'></a>P.S.:  For convenience, we could also add generators like `n.next_primes()`, `n.next_prime_powers()` etc.\n\n\n\n\nAnother way to avoid the `generator object at ...` would be to wrap the generators in classes, similar to `n.factor()` (although the latter doesn't do *lazy* factoring).  (We do have a `Primes` class, but e.g. not `PrimeRange` or the like.)",
    "created_at": "2015-05-06T09:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18299#issuecomment-258862",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>P.S.:  For convenience, we could also add generators like `n.next_primes()`, `n.next_prime_powers()` etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18299#issuecomment-258863",
    "user": "https://github.com/videlec"
}
```
