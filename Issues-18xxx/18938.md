...
```json
{
    "body": "<a id='comment:2'></a>This is very challenging but definitely useful.",
...
<a id='comment:2'></a>This is very challenging but definitely useful.
...
<a id='comment:5'></a>What's the proposed behavior when `by_weight==False`?
Otherwise I agree with what you propose.
...
<a id='comment:6'></a>Hellooooooooooooooo Michele,
...
```json
{
    "body": "<a id='comment:7'></a>> There is a `bidirectional_dijkstra` method in `src/sage/graphs/base/c_graph.pyx`. I don't know if it is used or not...\n\n\nIt is used in `GenericGraph.shortest_path`.\n\nNathann",
...
<a id='comment:7'></a>> There is a `bidirectional_dijkstra` method in `src/sage/graphs/base/c_graph.pyx`. I don't know if it is used or not...
...
```json
{
    "body": "<a id='comment:12'></a>> Also I'm wondering if we may have conflicts with tickets #18868 about memory allocation and #18864 on eccentricity\n\n\nThere was. I just fixed it.\n\nNathann",
...
<a id='comment:12'></a>> Also I'm wondering if we may have conflicts with tickets #18868 about memory allocation and #18864 on eccentricity
...
```json
{
    "body": "<a id='comment:13'></a>I'm not sure I understand what you have done...",
...
<a id='comment:13'></a>I'm not sure I understand what you have done...
...
```json
{
    "body": "<a id='comment:14'></a>I made #18864 a dependency of #18868. And in #18868 I handled the conflict.",
...
<a id='comment:14'></a>I made #18864 a dependency of #18868. And in #18868 I handled the conflict.
...
<a id='comment:20'></a>After performing the following changes, I'm able to compile the doc.
...
```json
{
    "body": "<a id='comment:22'></a>Finally, I have a version of the refactoring that might be reviewed. Hope you like it!",
    "created_at": "2015-07-29T14:45:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18938",
    "type": "issue_comment",
...
<a id='comment:22'></a>Finally, I have a version of the refactoring that might be reviewed. Hope you like it!
...
```json
{
    "body": "<a id='comment:26'></a>I removed the duplicate reference: now the citation refers to the other module.",
...
<a id='comment:26'></a>I removed the duplicate reference: now the citation refers to the other module.
