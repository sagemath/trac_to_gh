...
```json
{
    "body": "yes, there is an [official Python API](http://docs.mosek.com/8.0/pythonapi/intro_info.html#why-the-projectname). \n\nthey claim that \"The overhead introduced by this mapping (interface to the native C optimizer) is minimal.\"",
...
```json
{
    "body": "Sounds like no Cython programming is necessary then.",
...
```json
{
    "body": "i've started by reading Sage's SDP interface. in #23389 and #23390 i've uploaded 2 branches with some typo fixes etc for the html doc.",
