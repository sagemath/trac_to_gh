...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244901"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18484#issuecomment-257616",
    "user": "https://github.com/sagetrac-Rudi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18484#issuecomment-257617",
    "user": "https://github.com/sagetrac-Rudi"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244904"
}
```
...
```json
{
    "body": "Removed assignee **@sagetrac-Rudi**",
    "created_at": "2015-06-20T20:43:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/18484",
    "type": "issue_comment",
...
Removed assignee **@sagetrac-Rudi**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244905"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244906"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244907"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244910"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18484",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18484#event-244917"
}
```
