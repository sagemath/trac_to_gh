...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18143#issuecomment-313775",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18143#issuecomment-313776",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18143#issuecomment-313778",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Can we start by adding keyword `shape` with possible values `upper-triangular`, `lower-triangular`, `diagonal`, `symmetric` and `skew-symmetric`? For now it could raise an exception when used together with `algorithm` -option.",
    "created_at": "2015-04-15T11:27:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18143#issuecomment-313779",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:7'></a>Can we start by adding keyword `shape` with possible values `upper-triangular`, `lower-triangular`, `diagonal`, `symmetric` and `skew-symmetric`? For now it could raise an exception when used together with `algorithm` -option.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18143#issuecomment-313780",
    "user": "https://github.com/videlec"
}
```
