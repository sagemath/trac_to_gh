...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169768"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169769"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169770"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169771"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169773"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169774"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169775"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169776"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169777"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169778"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18882#event-169779"
}
```
...
archive/attachments_021379.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "gf2x-1.1.p2.log",
    "asset_url": "tarball://root/attachments/ticket18882/gf2x-1.1.p2.log",
    "created_at": "2017-06-12T15:06:49Z",
    "issue": "https://github.com/sagemath/sage/issues/18882",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket18882/gf2x-1.1.p2.log",
    "user": "https://github.com/dimpase"
}
```
