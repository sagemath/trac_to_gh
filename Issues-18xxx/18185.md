...
```json
{
    "body": "<a id='comment:1'></a>\nLast 10 new commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[66478e5](http://git.sagemath.org/sage.git/commit/?id=66478e5b80b6f4662997e25632da9ec31c87c5b9)|`trac #18067: Merged with rc2`|\n|[ebe615d](http://git.sagemath.org/sage.git/commit/?id=ebe615d21fe72e11fe909e2e1d9c3b872c3295b3)|`Code simplifications (and fix)`|\n|[85ef058](http://git.sagemath.org/sage.git/commit/?id=85ef058bf2182e306b0d147e6320e0679e45161d)|`Rename graph6-related functions (+doc)`|\n|[5fe39bc](http://git.sagemath.org/sage.git/commit/?id=5fe39bc475885494e570c4a3f1876b2750453946)|`Merge branch 'd' into CURRENT`|\n|[e251a7b](http://git.sagemath.org/sage.git/commit/?id=e251a7b5622056dee02957440d1374e8c8df063f)|`Move backend creation to the beginning of Graph.__init__ (does not pass tests)`|\n|[0e63fcb](http://git.sagemath.org/sage.git/commit/?id=0e63fcbc61703058bc6c3804d07fa0f2dbd18022)|`Fix and simplify the code (now tests pass again)`|\n|[03fb9b2](http://git.sagemath.org/sage.git/commit/?id=03fb9b21c723e4fde6a4e60e71ff92d220c1949c)|`Move backend creation to the beginning of DiGraph.__init__ (does not pass tests)`|\n|[4fbadc4](http://git.sagemath.org/sage.git/commit/?id=4fbadc4c53976e75951c4f599e3ecc5799249fc4)|`Fix and simplify the code (now tests pass again)`|\n|[8f34727](http://git.sagemath.org/sage.git/commit/?id=8f34727d48e2e5a9a1f10cfc3b1557677ce95e7d)|`Merge the last two sections of the graph constructor`|\n|[279b141](http://git.sagemath.org/sage.git/commit/?id=279b141566b69d149e89992dba2fac74399815c9)|`Merge the last two sections of the DiGraph constructor`|",
    "created_at": "2015-04-14T10:47:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18185",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[6f4dbfa](http://git.sagemath.org/sage.git/commit/?id=6f4dbfaeadc99751489890f3d351564f94593230)|`trac #18185: Code simplifications (and fix)`|\n|[b03266d](http://git.sagemath.org/sage.git/commit/?id=b03266d885055d56e0b7ae5382df76296aea3ba8)|`trac #18185: Rename graph6-related functions (+doc)`|\n|[b9cfde3](http://git.sagemath.org/sage.git/commit/?id=b9cfde3642e3b32abc5c0e67560ec6e4a564c942)|`trac #18185: Move backend creation to the beginning of Graph.__init__ (does not pass tests)`|\n|[050b916](http://git.sagemath.org/sage.git/commit/?id=050b916c1459f94a80b0c78b2331d261919c6717)|`trac #18185: Fix and simplify the code (now tests pass again)`|\n|[d5c0812](http://git.sagemath.org/sage.git/commit/?id=d5c08121837e4e87ea597584fd7bdd848c470071)|`trac #18185: Move backend creation to the beginning of DiGraph.__init__ (does not pass tests)`|\n|[313810e](http://git.sagemath.org/sage.git/commit/?id=313810ef7d807e27004f35584505cdb465b6b06c)|`trac #18185: Fix and simplify the code (now tests pass again)`|\n|[1f2e0fa](http://git.sagemath.org/sage.git/commit/?id=1f2e0fa1ea8825da328a0fa47e0740c9c1738144)|`trac #18185: Merge the last two sections of the graph constructor`|\n|[4b15f0f](http://git.sagemath.org/sage.git/commit/?id=4b15f0f7f1cebd6f858e49ae2bf952dec6a2544f)|`trac #18185: Merge the last two sections of the DiGraph constructor`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[313fd68](http://git.sagemath.org/sage.git/commit/?id=313fd688e1c4a93684872210e08f806c1a00cfde)|`trac #18185: Merged with beta1`|\n|[80456d8](http://git.sagemath.org/sage.git/commit/?id=80456d80dafe26adf7ac95e71311c767ca5e866b)|`trac 18185: missing ':'`|",
    "created_at": "2015-04-17T06:24:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18185",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[f8c9f8e](http://git.sagemath.org/sage.git/commit/?id=f8c9f8ef8662324dee8f1bc403968fa5b2d168aa)|`trac #18185: combinat decided that we can't sort vertices in DiGraph.__init__`|",
    "created_at": "2015-04-17T08:45:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18185",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[6afd117](http://git.sagemath.org/sage.git/commit/?id=6afd117df805ce5b42c8019069824ed0cd0d277f)|`trac #18185: broken import`|",
