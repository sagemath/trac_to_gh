...
```json
{
    "body": "<a id='comment:7'></a>\nI guess this is far from being optimal but it is at least very useful to me!\n\nVincent\n\n---\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[ee6506d](http://git.sagemath.org/sage.git/commit/?id=ee6506d15b2bbb976c738d6b804edf864a6ab24e)|`Trac 18158: generic __getitem__ for libgap object`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[c27056e](http://git.sagemath.org/sage.git/commit/?id=c27056e7be55c28870ff781ff431b0fe58d927d5)|`Trac 18158: more __getitem__/__len__ for libgap`|",
    "created_at": "2016-04-30T21:21:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18158",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[dbf8aea](http://git.sagemath.org/sage.git/commit/?id=dbf8aeac7bdcb1c458711b9c4d2f57a6d4fbac1c)|`Trac 18158: simplify some tests`|",
    "created_at": "2016-05-03T21:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18158",
    "type": "issue_comment",
