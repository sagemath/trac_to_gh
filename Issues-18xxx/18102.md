...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket18102/dgf-cases.txt",
    "created_at": "2015-04-01T21:04:20Z",
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket18102/dgf-cases.txt",
    "user": "https://github.com/jjermann"
}
```
...
```json
{
    "body": "Attachment [dgf-cases.txt](https://github.com/sagemath/sage/files/ticket18102/dgf-cases.txt) by @jjermann created at 2015-04-01 21:04:20\n\nGenerating series (GS), Coefficient function (CF), Dirichlet series (DS)",
    "created_at": "2015-04-01T21:04:20Z",
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-249366",
    "user": "https://github.com/jjermann"
}
```

Attachment [dgf-cases.txt](https://github.com/sagemath/sage/files/ticket18102/dgf-cases.txt) by @jjermann created at 2015-04-01 21:04:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-249367",
    "user": "https://github.com/jjermann"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18102#event-162429"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-249368",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-249369",
    "user": "https://github.com/jjermann"
}
```
