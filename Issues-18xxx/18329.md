...
<a id='comment:34'></a>Replying to [jpflori](#comment%3A33):
> Did you submit the Cython patch upstream?
...
<a id='comment:36'></a>Replying to [jpflori](#comment%3A33):
> Another question, is there any doc about this in the dev manual
...
<a id='comment:39'></a>Replying to [jpflori](#comment%3A35):
> Do you plan on opening a follow-up ticket to remove all the now superfluous boilerplate code?
...
```json
{
    "body": "<a id='comment:50'></a>Replying to [jpflori](#comment%3A35):\n> Do you plan on opening a follow-up ticket to remove all the now superfluous boilerplate code?\n\n\nOne such ticket (with not so many changes) is #18881.",
    "created_at": "2015-07-11T21:33:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18329",
    "type": "issue_comment",
...
<a id='comment:50'></a>Replying to [jpflori](#comment%3A35):
> Do you plan on opening a follow-up ticket to remove all the now superfluous boilerplate code?
