...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339348",
    "user": "https://trac.sagemath.org/admin/accounts/users/hhlorrimore"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339349",
    "user": "https://trac.sagemath.org/admin/accounts/users/hhlorrimore"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339350",
    "user": "https://trac.sagemath.org/admin/accounts/users/hhlorrimore"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339351",
    "user": "https://trac.sagemath.org/admin/accounts/users/hhlorrimore"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339352",
    "user": "https://trac.sagemath.org/admin/accounts/users/hhlorrimore"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339353",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339354",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339355",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339356",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339357",
...
```json
{
    "body": "<a id='comment:8'></a>\nYes, it's now ready for review. As this is a large ticket, Hannah suggests the following break up of the review process (which could be done by multiple people):\n\nPart 1:\n\n   `ExtensiveFormGame`\n1. `__init__` (not worrying about having a gambit Game generator)\n2. `_check_node_names_and_find_`players (as a direct result of looking at `__init__`)\n\n   `EFG_Node`, `EFG_Leaf`, `EFG_Player`:\n1. (all of their methods)\n\nPart 2:\n   `ExtensiveFormGame`\n1. `_gambit_to_`sage and all its own methods (and hence might want to look at __init and generating the game with a gambit Game)\n2. sage_to_gambit and all its own methods\n\nPart 3:\n   `ExtensiveFormGame`\n1. set_info_set\n2. remove_info_set\n3. perfect_info\n4. plot (and all its related hidden methods, i.e. `_grow_`tree, `_grow_tree_`dictionary)\n5. plot_info_sets (and all its related hidden methods i.e. `_grow_info_set_`graph, `_grow_info_set_graph_`dictionary)\n6. obtain_nash\n7. is_constant_sum",
    "created_at": "2015-08-10T06:24:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339359",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339360",
    "user": "https://github.com/drvinceknight"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339361",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339362",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339363",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339364",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18945#issuecomment-339365",
    "user": "https://github.com/bryangingechen"
}
```
