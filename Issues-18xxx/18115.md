...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18115#issuecomment-249647",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18115#issuecomment-249648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18115#issuecomment-249649",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18115#issuecomment-249650",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18115#issuecomment-249651",
    "user": "https://github.com/vbraun"
}
```
