...
```json
{
    "body": "<a id='comment:2'></a>I agree that this would be a nice addition, but we should also get a way to extend a constraint (add a variable).",
    "created_at": "2019-11-28T15:27:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18466#issuecomment-322316",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:2'></a>I agree that this would be a nice addition, but we should also get a way to extend a constraint (add a variable).
