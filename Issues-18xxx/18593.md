...
```json
{
    "body": "Fixed typo in ticket title.  ;-)",
...
```json
{
    "body": "indeed the -0.50000000000000855 middle value on AMD K10 gives a relative error of 1.53e-14, which is larger than the previous tolerance of 1e-14.",
