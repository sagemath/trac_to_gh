...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18956#event-251377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18956#event-251378"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18956#event-251379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18956#event-251380"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18956#issuecomment-268875",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18956#issuecomment-268876",
    "user": "https://github.com/sagetrac-buck"
}
```
