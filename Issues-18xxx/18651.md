...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247297"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247298"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247299"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18651#issuecomment-262226",
    "user": "https://github.com/sagetrac-dmuthiah"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18651",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18651#event-247306"
}
```
