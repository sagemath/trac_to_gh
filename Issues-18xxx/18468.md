...
```json
{
    "body": "Thought I had. I'll try to do it.\n\nThanks!",
...
```json
{
    "body": "Mistypes should be corrected now. Needing review again.",
...
```json
{
    "body": "Thanks. We'll try to rework it.",
...
```json
{
    "body": "Please add your full name in the \"Authors\" field of the ticket (otherwise the patchbot will not care about it).",
...
```json
{
    "body": "(just modifying the Authors field)",
