...
```json
{
    "body": "<a id='comment:1'></a>I propose to do the type checking only on the Dynkin diagram since there are good algorithms for checking digraph isomorphism (as indicated on the ticket):\n\n```\nsage: G = DiGraph([[1,2],[2,3],[3,1]])\nsage: H = DiGraph([[0,-1],[-1,-2],[-2,0]])\nsage: G.is_isomorphic(H, certify=True)\n(True, {1: -2, 2: 0, 3: -1})\n```\nThis is a slight variation than what is indicated on the ticket since `indecomposable_blocks` currently works by using the `connected_components` of `DiGraph`, so it avoids creating intermediary objects.",
    "created_at": "2015-06-19T23:16:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18744#issuecomment-330314",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>I propose to do the type checking only on the Dynkin diagram since there are good algorithms for checking digraph isomorphism (as indicated on the ticket):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18744#issuecomment-330315",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18744#issuecomment-330317",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
