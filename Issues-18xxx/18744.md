...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18744#event-248533"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18744#event-248534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18744#event-248535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18744#event-248536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264121",
    "user": "https://github.com/sagetrac-jonathan-judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264122",
    "user": "https://github.com/tscrim"
}
```
