...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264025",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264026",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264027",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264028",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264029",
    "user": "https://github.com/tscrim"
}
```
