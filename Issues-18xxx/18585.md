...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[421bd04](http://git.sagemath.org/sage.git/commit/?id=421bd041f4084e8da89ee27f87be0e54e79706d1)|`Add _cmp_ in class Polynomial_generic_sparse`|",
    "created_at": "2015-06-02T13:38:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18585",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[7c72ce2](http://git.sagemath.org/sage.git/commit/?id=7c72ce25d8b5a0709abbed60c7526ba63ebde8b5)|`Rewritten using lists to correct a bug`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[1726058](http://git.sagemath.org/sage.git/commit/?id=1726058568171c77880ac9d00684ffc00c0b1492)|`list(reversed(sorted(...))) replaced by .sort() and .reverse()`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[efa67dd](http://git.sagemath.org/sage.git/commit/?id=efa67ddb0813a31ae9ab25a50eb533813bbf1a4f)|`Fasten Polynomial_generic_sparse.exponents()`|\n|[c9b2091](http://git.sagemath.org/sage.git/commit/?id=c9b2091f17937e9300b4f09c9f0f20aee78d65a3)|`Add doctest`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[1bb00ff](http://git.sagemath.org/sage.git/commit/?id=1bb00ff77ab7d14dd50bf48290ed6baeba5d5646)|`sort + reverse in a single instruction`|\n|[3121374](http://git.sagemath.org/sage.git/commit/?id=3121374eed7b683bd135e9ec5086aac03c4c8eb5)|`Compare with self.base_ring().zero() instead of Python 0`|",
    "created_at": "2015-08-03T16:26:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18585",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[536a7e5](http://git.sagemath.org/sage.git/commit/?id=536a7e58103aa78b845c4faab670d5f7060d3bc8)|`Remove useless test`|\n|[c88f1b0](http://git.sagemath.org/sage.git/commit/?id=c88f1b06b429f179520c9694a62924c9889577b0)|`Add (tentative) specification`|",
