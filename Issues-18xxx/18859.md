...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[f73faeb](http://git.sagemath.org/sage.git/commit/?id=f73faeb3e2cabd8017f83267db1d21543338cbdd)|`Update docs to use \"make pkgname\" instead of \"./sage -i pkgname\"`|",
    "created_at": "2015-07-07T13:49:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18859",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nPositive because patchbot and me, we both are happy with this. The `sage -m/--make` is a feature of another ticket.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|\n|[980fd2c](http://git.sagemath.org/sage.git/commit/?id=980fd2cdbf2644b957f9669132480dc60a946a93)|`Merge branch 'u/jdemeyer/update_docs_to_use__make_pkgname__instead_of____sage__i_pkgname_' of trac.sagemath.org:sage into tmp5`|",
    "created_at": "2015-07-29T16:08:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18859",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[626113a](http://git.sagemath.org/sage.git/commit/?id=626113afdc2a3023f2ce1e83fa8d0123cbae442f)|`Update docs to use \"make pkgname\" instead of \"./sage -i pkgname\"`|",
    "created_at": "2015-08-16T21:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18859",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:46'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[4d1a42a](http://git.sagemath.org/sage.git/commit/?id=4d1a42a073280bb29c6224e1e046d97f6b3ce1c1)|`Update docs with new commands to install packages`|",
    "created_at": "2015-08-27T19:49:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18859",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[be4762d](http://git.sagemath.org/sage.git/commit/?id=be4762d5b155519e0fa1ef0752e4aa50f00636dc)|`Update docs with new commands to install packages`|",
...
```json
{
    "body": "<a id='comment:50'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[4a10ed3](http://git.sagemath.org/sage.git/commit/?id=4a10ed3ed7e7cd03c67d89e94dde0bb5ff0039ba)|`Fix wrong uses of \"sage -f\" also`|",
