...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[14952d6](http://git.sagemath.org/sage.git/commit/?id=14952d61c9d8b90e9926aa721294360ca5ba683a)|`Correct bug in `integral``|\n|[e05d331](http://git.sagemath.org/sage.git/commit/?id=e05d331aecbbca0bb661dda63a28081b1f8db472)|`Adapt `is_nilpotent` to sparse polynomials`|\n|[fcd29ce](http://git.sagemath.org/sage.git/commit/?id=fcd29ce99fdf20d8d44b3d3af20e610036d9fd2b)|`Adapt `is_unit` to sparse polynomials`|\n|[74a3147](http://git.sagemath.org/sage.git/commit/?id=74a31475fbaf43b0c7c4bdad63f39baea999d0ef)|`Adapt `padded_list` to sparse polynomials`|\n|[aa10b1f](http://git.sagemath.org/sage.git/commit/?id=aa10b1fa288cd75eafe3d84abf92ac8bfd1b2bc6)|`Adapt `norm` to sparse polynomials`|\n|[d706667](http://git.sagemath.org/sage.git/commit/?id=d706667ed575fd6b841a1eaef302c5ef453e9c0b)|`Adapt `reverse` to sparse polynomials`|\n|[1e1d21b](http://git.sagemath.org/sage.git/commit/?id=1e1d21b7a14e15ef37a6b8fca833298fbbb1f056)|`Adapt `integral` to sparse polynomials`|\n|[dbc2ba0](http://git.sagemath.org/sage.git/commit/?id=dbc2ba09385c25df46c33747075d35dc0e35eea8)|`Adapt `shift` to sparse polynomials`|\n|[19b1371](http://git.sagemath.org/sage.git/commit/?id=19b1371896d7ff71cb9eb3fa289b0d6bddb2787f)|`Adapt `newton_slopes` to sparse polynomials`|\n|[ecffcef](http://git.sagemath.org/sage.git/commit/?id=ecffcef63b5d0e298af36bd487df165bbf6a42dd)|`Adapt `truncate` to sparse polynomials`|",
    "created_at": "2015-06-03T14:24:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18600",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[390b3ea](http://git.sagemath.org/sage.git/commit/?id=390b3ea9595b5ab1a4f96af875f754b349e79686)|`integral: reviewer comments + add check=False`|\n|[809bc3e](http://git.sagemath.org/sage.git/commit/?id=809bc3ea6da046dd4bf7582c44ea8ef90319ea73)|`reverse: reviewer's comment + check=False`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[e75ab73](http://git.sagemath.org/sage.git/commit/?id=e75ab73b3b2e0bc3a40105640d0572b1b6af9cea)|`Trac #18600: simpler polynomial construction`|",
    "created_at": "2015-08-08T21:13:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18600",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[c4575ff](http://git.sagemath.org/sage.git/commit/?id=c4575ff54cbefa02da3f488021470839ffd1e347)|`Merge branch 'public/18600' of git://trac.sagemath.org/sage into t18600_sparse_polys`|\n|[6a8fb14](http://git.sagemath.org/sage.git/commit/?id=6a8fb145b6ed55a1d73dd18ebaa89bd3c4d7bccd)|`#18600: \"... so the constant term is 0\" -> \"... so that...\"`|\n|[f2b57e3](http://git.sagemath.org/sage.git/commit/?id=f2b57e3c6d4ad560d378d87bad8490f9efbb4b0b)|`#18600: Handle non integral domains for sparse poly`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[ef2d432](http://git.sagemath.org/sage.git/commit/?id=ef2d432fcd405893326e3541a1f6a1b7016f708d)|`#18600: merged two 'isinstance'`|\n|[d7038a4](http://git.sagemath.org/sage.git/commit/?id=d7038a41f5228a41fce4ed11ca9811447d57076f)|`#18600: Docstring formatting`|\n|[e021276](http://git.sagemath.org/sage.git/commit/?id=e021276b5e043e066842b4e6e3644d489626deab)|`#18600: one-liners`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[4a44486](http://git.sagemath.org/sage.git/commit/?id=4a4448604662733d1dc1ddf7e1f867e54be23af2)|`#18600: Move newton_slopes to class Polynomial`|",
    "created_at": "2015-09-09T09:03:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18600",
    "type": "issue_comment",
