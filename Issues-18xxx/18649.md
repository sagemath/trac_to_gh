...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265023"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18649#issuecomment-259703",
    "user": "https://github.com/sagetrac-dmuthiah"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265031"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18649",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18649#event-265032"
}
```
