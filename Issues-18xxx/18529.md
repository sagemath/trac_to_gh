...
```json
{
    "body": "<div id=\"comment:5\" align=\"right\">comment:5</div>\n\nFollowing [comment:113](#comment:113), the above commit reverts to Hierarchy-2 (only the first two items of it,  `ManifoldSubset` and `TopologicalManifold` are implemented in this ticket).",
