...
```json
{
    "body": "<a id='comment:7'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[5cf75a4](https://github.com/sagemath/sagetrac-mirror/commit/5cf75a4629c27cc1b85efafe217713752f82b8ea)|<code>eliminated a call to `roots`</code>|\n|[584f444](https://github.com/sagemath/sagetrac-mirror/commit/584f444a68d2afcd6eb955da5ba7b344df3e630c)|<code>Fixed bug in `AlgebraicNumber.__pow__`.</code>|",
...
```json
{
    "body": "<a id='comment:10'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[e0626dc](https://github.com/sagemath/sagetrac-mirror/commit/e0626dcabde6434cedd0c8736df198065b7a01d6)|<code>Added ``-`` and ``/`` operations using ``BFSS`` algorithm</code>|",
    "created_at": "2015-05-02T08:55:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18242",
    "type": "issue_comment",
