...
```json
{
    ...
    "type": "issue",
    "updated_at": "2015-04-21T16:23:46Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18259#event-223192"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18259#event-223193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18259#event-223194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18259#issuecomment-252889",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18259#issuecomment-252890",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18259#issuecomment-252891",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18259#issuecomment-252892",
    "user": "https://github.com/nbruin"
}
```
