...
```json
{
    "body": "<a id='comment:7'></a>\nHere is my current prototype for getting pexpect out of permutation groups, and having them use libgap exclusively.  For the large part it is quite effective at this.  This fixes (among many other examples):\n\n```\nsage: G = SymmetricGroup(3)\nsage: %prun G.one()\nsage: G.one()\n()\nsage: gap._expect is None\n```\n\nwhere previously this was invoking a GAP process through pexpect.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[618a0d4](https://git.sagemath.org/sage.git/commit?id=618a0d4e73741706067427e87b432d351a9615ee)|`Fix several predicate methods of permutation groups to use libgap.`|\n|[7a0dd0e](https://git.sagemath.org/sage.git/commit?id=7a0dd0e895399d5bc95521fc4f73486955666433)|`Use libgap for permutation group comparison.`|\n|[cc5381d](https://git.sagemath.org/sage.git/commit?id=cc5381dc4032b01255d0a3334d924abd7ce5c4b2)|`It seems these tests broke again.`|\n|[d4e81e8](https://git.sagemath.org/sage.git/commit?id=d4e81e835aa4facbc69fe2572962b38e7aada4ba)|`Use libgap in several more methods where it was trivial to make the change, and where it at least didn't break any local tests.`|\n|[2e60ebe](https://git.sagemath.org/sage.git/commit?id=2e60ebe130a6e9e02971de2c92bc50e9c5de6930)|`These tests were marked 'random output' despite the explicit calls to set_random_seed(0), which should have obviated this.`|\n|[3c8954a](https://git.sagemath.org/sage.git/commit?id=3c8954a9bb542a8dcd276de29b85a27d49aa453b)|`Use libgap for direct_product`|\n|[220c5e7](https://git.sagemath.org/sage.git/commit?id=220c5e722d94b0405a12d2e0acf0d72fbf2118ec)|`Use libgap for character_table`|\n|[5ab41fb](https://git.sagemath.org/sage.git/commit?id=5ab41fb9454bb8f668b27e724012fd0582152268)|`Some fixes to make ClassFunction work properly with libgap.`|\n|[db4eeda](https://git.sagemath.org/sage.git/commit?id=db4eeda4e8707fd3090c36f2624a61a2e0adcc63)|`Use libgap for PermutationGroup_generic._regular_subgroup_gap`|\n|[75d6b76](https://git.sagemath.org/sage.git/commit?id=75d6b764cac83c2930dff648605de98adbc506db)|`Use libgap for PermutationGroup_generic.molien_series`|",
    "created_at": "2019-06-25T13:58:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18267",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[075a48a](https://git.sagemath.org/sage.git/commit/?id=075a48a5798607663c4e7d2140d5354425807e58)|`It seems these tests broke again.`|\n|[dcc0b11](https://git.sagemath.org/sage.git/commit/?id=dcc0b1191a5c51c21b2e9937864fff333f7889d3)|`Use libgap in several more methods where it was trivial to make the change, and where it at least didn't break any local tests.`|\n|[96c55c3](https://git.sagemath.org/sage.git/commit/?id=96c55c318e44e6c74ba08c119261b3dab2787d8b)|`These tests were marked 'random output' despite the explicit calls to set_random_seed(0), which should have obviated this.`|\n|[13b0e3c](https://git.sagemath.org/sage.git/commit/?id=13b0e3cb46e61ec56c3271a3bce49b76ac6b8b36)|`Use libgap for direct_product`|\n|[6928f69](https://git.sagemath.org/sage.git/commit/?id=6928f6982e7a489d8e4c73c137bf052590cf4267)|`Use libgap for character_table`|\n|[77513fe](https://git.sagemath.org/sage.git/commit/?id=77513fee45213ebf297b59bbe7d43b4a24a6797c)|`Some fixes to make ClassFunction work properly with libgap.`|\n|[edf2a5d](https://git.sagemath.org/sage.git/commit/?id=edf2a5d7c595973e87389977b9a2abeaea9454dd)|`Use libgap for PermutationGroup_generic._regular_subgroup_gap`|\n|[6fbdbd1](https://git.sagemath.org/sage.git/commit/?id=6fbdbd1ae9afa5c5fd1b1caffa2c4b506b14c381)|`Use libgap for PermutationGroup_generic.molien_series`|\n|[42318a9](https://git.sagemath.org/sage.git/commit/?id=42318a9424b9b5b9d5332610232e113219420b3a)|`Fix minor test failure: This will now fail at trying to find a _libgap_init_ rather than a _gap_init_`|\n|[c02c2f1](https://git.sagemath.org/sage.git/commit/?id=c02c2f11a2c2228851419eb1aadd32fde75a2ad4)|`If the values passed to the ClassFunction constructor are already a libgap`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[cc64910](https://git.sagemath.org/sage.git/commit/?id=cc6491009070408c9ed5dde6317ee0ac229458ca)|`Fixed slightly different output on a few tests due to PRNG differences related`|",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|\n|[2fc1096](https://git.sagemath.org/sage.git/commit/?id=2fc1096c30f07cc21570f67e050a79030f9760c2)|`These tests were marked 'random output' despite the explicit calls to set_random_seed(0), which should have obviated this.`|\n|[b123422](https://git.sagemath.org/sage.git/commit/?id=b12342234364c7b37db9e7c72a797dd5ef9b26f1)|`Use libgap for direct_product`|\n|[f35a967](https://git.sagemath.org/sage.git/commit/?id=f35a967d4eccbbfd4c0068508240f04189b4429b)|`Use libgap for character_table`|\n|[4aacf0f](https://git.sagemath.org/sage.git/commit/?id=4aacf0fb4bf7a113ed6ad5eb871b005352147cac)|`Some fixes to make ClassFunction work properly with libgap.`|\n|[4fe1132](https://git.sagemath.org/sage.git/commit/?id=4fe1132538b4496da8e4eb46657bc4bcb0f9d83f)|`Use libgap for PermutationGroup_generic._regular_subgroup_gap`|\n|[3ef4b4b](https://git.sagemath.org/sage.git/commit/?id=3ef4b4b3263ab72f8ddb7188025d4d6e018b48f0)|`Use libgap for PermutationGroup_generic.molien_series`|\n|[9205aa6](https://git.sagemath.org/sage.git/commit/?id=9205aa69916ac7b61dc7334142acc2d5ef4199b0)|`Fix minor test failure: This will now fail at trying to find a _libgap_init_ rather than a _gap_init_`|\n|[0d0e1bb](https://git.sagemath.org/sage.git/commit/?id=0d0e1bb5c0dde84bcd05bfa727d649b3f9bf0a01)|`If the values passed to the ClassFunction constructor are already a libgap`|\n|[c8c5ecf](https://git.sagemath.org/sage.git/commit/?id=c8c5ecf3cf8ed1108b1d102169b9fa5c68edc874)|`Fixed slightly different output on a few tests due to PRNG differences related`|\n|[65f8a84](https://git.sagemath.org/sage.git/commit/?id=65f8a84b3965bf80fc3b7fb6018a1be753f3eab2)|`Update this test to still use the gap pexpect interface.`|",
