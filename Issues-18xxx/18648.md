...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265013"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18648",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18648#issuecomment-259702",
    "user": "https://github.com/sagetrac-dmuthiah"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18648",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18648#event-265022"
}
```
