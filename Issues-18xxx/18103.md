...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18103#event-239766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18103#event-239767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18103#event-239768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18103#event-239769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18103#issuecomment-249466",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18103#issuecomment-249467",
    "user": "https://github.com/videlec"
}
```
