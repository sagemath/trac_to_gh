...
```json
{
    "body": "<a id='comment:2'></a>\nBefore:\n\n```\nsage: M = matroids.named_matroids.ExtendedBinaryGolayCode()\nsage: timeit(\"M.is_graphic()\")\n5 loops, best of 3: 39.5 ms per loop\n```\nAfter:\n\n```\nsage: M = matroids.named_matroids.ExtendedBinaryGolayCode()\nsage: timeit(\"M.is_graphic()\")\n625 loops, best of 3: 1.55 ms per loop\n```\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|\n|[280018d](http://git.sagemath.org/sage.git/commit/?id=280018d529173b9ad2e78d8728dd1ec6b8705f75)|`Tweaked initializer of BinaryMatroid, improved call by BinaryMatrix.is_graphic()`|",
    "created_at": "2015-06-15T20:04:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18706",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[6d54d49](http://git.sagemath.org/sage.git/commit/?id=6d54d493a6743344aba4cd4e3dc935989870b544)|`Removed pointless code`|\n|[ea691c6](http://git.sagemath.org/sage.git/commit/?id=ea691c61c39a2ac871233e792958dccb3b9158d0)|`removed some more redundant code`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[a839d2b](http://git.sagemath.org/sage.git/commit/?id=a839d2b521195db2940402ff2f2ba78d13d8b29a)|`rewrote some versions of prepend() as it occurs in the LinearMatroid initializers`|",
