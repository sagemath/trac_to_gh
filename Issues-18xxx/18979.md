...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[75e679c](http://git.sagemath.org/sage.git/commit/?id=75e679c687019c9657188003306bbd08314919a5)|`18979: avoid Maxima on creation of symbolic matrices`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nThis patch has the following footprint:\n\n```\n           SR   Laurent poly\ndevelop   2 ms     45 us\npatched  78 us     52 us\n```\nI don't believe you would stall this again because of, say, ten microseconds?\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[2c4fa61](http://git.sagemath.org/sage.git/commit/?id=2c4fa619863baebcfe5239a2b325eabac83ed819)|`18979: avoid Maxima on creation of symbolic matrices`|",
    "created_at": "2015-09-07T14:00:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18979",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|\n|[e42f285](http://git.sagemath.org/sage.git/commit/?id=e42f2858c851693464226fad3532efedf50de3b2)|`trac 18979: apparently cython's list comprehension optimization isn't so good for lists of predictable length.`|",
    "created_at": "2015-09-07T21:57:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18979",
    "type": "issue_comment",
