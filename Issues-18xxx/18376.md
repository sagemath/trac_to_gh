...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319835",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319836",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319837",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319838",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319839",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319840",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319841",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319842",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319843",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319844",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18376#event-51813"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319845",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319846",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I noticed a few things that could be enhanced while rereading my code, and made the changes.\nThis ticket is still pending for review, and not a work in progress `:)`",
    "created_at": "2015-06-09T11:54:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319847",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:9'></a>I noticed a few things that could be enhanced while rereading my code, and made the changes.
This ticket is still pending for review, and not a work in progress `:)`
...
```json
{
    "body": "<a id='comment:10'></a>The term \"unencoding\" is absolutely logical. But assuming it is not yet settled in the literature, I propose to consider \"lift\"as an alternative to mean the same thing. It is short and friendly (and mathematish :-)",
    "created_at": "2015-06-30T01:34:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319848",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:10'></a>The term "unencoding" is absolutely logical. But assuming it is not yet settled in the literature, I propose to consider "lift"as an alternative to mean the same thing. It is short and friendly (and mathematish :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319849",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I also find it a problem not to have a proper name in the literature for reverting to the message from a codeword. Unencoding is definitely not nice, but it is very clear, where lift has a very vague meaning, which varies a lot depending on the setting. \n\nAnd suppose furthermore one day we want to deal with codes over Z4, than it would be very proper to call \"lift\" the fonction which takes a F2 codeword c2 and propose a Z4 codeword c4 which reduces to c2 mod 2.",
    "created_at": "2015-07-01T09:32:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319850",
    "user": "https://trac.sagemath.org/admin/accounts/users/danielaugot"
}
```

<a id='comment:12'></a>I also find it a problem not to have a proper name in the literature for reverting to the message from a codeword. Unencoding is definitely not nice, but it is very clear, where lift has a very vague meaning, which varies a lot depending on the setting. 
...
```json
{
    "body": "<a id='comment:14'></a>Go for \"unencode\". There seems to be no better alternative.",
    "created_at": "2015-07-03T17:34:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319851",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:14'></a>Go for "unencode". There seems to be no better alternative.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319853",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319854",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319855",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319856",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319857",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319859",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319861",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319862",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319864",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319865",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319866",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319867",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319868",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319869",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18376#event-51814"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18376#event-51815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319870",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>> - There is a function in `sage.coding.encoder` without a test. Is it the abstract `generator_matrix` that's causing it?\n\n\nYes it is:\n\n```\n    $ ./sage  -coverage src/sage/coding/encoder.py \n    ------------------------------------------------------------------------\n    SCORE src/sage/coding/encoder.py: 87.5% (7 of 8)\n\n    Missing doctests:\n        * line 268: def generator_matrix(self)\n    ------------------------------------------------------------------------\n```\n\nHow does one test an abstract method?",
    "created_at": "2015-09-17T19:15:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319871",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:28'></a>> - There is a function in `sage.coding.encoder` without a test. Is it the abstract `generator_matrix` that's causing it?
...
```json
{
    "body": "<a id='comment:31'></a>Thanks for this (very) comprehensive work.\nI'm currently updating this to latest beta, and will start working on your comments as soon as compilation completes.\n\nDavid",
    "created_at": "2015-09-18T07:17:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319874",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:31'></a>Thanks for this (very) comprehensive work.
I'm currently updating this to latest beta, and will start working on your comments as soon as compilation completes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319875",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319876",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319879",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319880",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319882",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319883",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>I presume that lazy_import was to avoid that `sage.coding.encoder` got imported, but I'm pretty sure it still does. At least, it's present in `sys.modules` and it shows up when doing `sage.coding.<tab>`.\n\nThis might be due to the line in `__init__.py` which will cause an immediate dereference of `LinearCode`, which then causes loading `encoder.py` too. But I didn't test that this is sufficient.",
    "created_at": "2015-09-24T08:45:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319884",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:39'></a>I presume that lazy_import was to avoid that `sage.coding.encoder` got imported, but I'm pretty sure it still does. At least, it's present in `sys.modules` and it shows up when doing `sage.coding.<tab>`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319885",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319886",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>I moved the line which fills the dictionary of encoders for `LinearCode` from `__init__.py` to `linear_code.py`. It will be useful to do that to avoid immediate dereference of `LinearCode`in `__init.py__` as explained in the message above.\nNote that for now, `encoder` module is still imported when Sage starts. I'll fix this (alongside with several other imports) in the follow-up ticket #19315",
    "created_at": "2015-09-30T08:26:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319887",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:41'></a>I moved the line which fills the dictionary of encoders for `LinearCode` from `__init__.py` to `linear_code.py`. It will be useful to do that to avoid immediate dereference of `LinearCode`in `__init.py__` as explained in the message above.
Note that for now, `encoder` module is still imported when Sage starts. I'll fix this (alongside with several other imports) in the follow-up ticket #19315
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18376#event-51816"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18376#event-51817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319889",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319890",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>I added a check on the generic implementation of `unencode`, which raises an explanatory exception if one tries to unencode a word of a code of dimension 0, instead of crashing poorly when trying to unencode. This is still pending for review.",
    "created_at": "2015-10-13T10:43:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319891",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:45'></a>I added a check on the generic implementation of `unencode`, which raises an explanatory exception if one tries to unencode a word of a code of dimension 0, instead of crashing poorly when trying to unencode. This is still pending for review.
...
```json
{
    "body": "<a id='comment:48'></a>I think Sage's answer is correct. Your example on bitbucket is a zero *length* (and dimension) vector space. The \"zero vector\" in that space is the empty vector.\n\nConstructing one with only zero dimension correctly shows you the zero word:\n\n```\n   sage: V = Matrix(GF(2), 0, 5).row_module()\n   sage: V.list()\n   [(0,0,0,0,0)]\n```\n\nI think that unencoding the zero vector on a zero dimensional code should return the empty vector. That seems the only sensible thing.\n\nI guess the failure with `C.list()` crashing (and possibly other stuff, like minimum distance) is another one for the pile of stuff to fix later on...",
    "created_at": "2015-10-13T12:21:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319894",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:48'></a>I think Sage's answer is correct. Your example on bitbucket is a zero *length* (and dimension) vector space. The "zero vector" in that space is the empty vector.
...
```json
{
    "body": "<a id='comment:49'></a>Oh, true enough. I'll make the change on this ticket.",
    "created_at": "2015-10-13T12:27:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319895",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:49'></a>Oh, true enough. I'll make the change on this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319897",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319898",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319899",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319900",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:53'></a>> Why is `LinearCodeGeneratorMatrixEncoder` registered on `AbstractLinearCode` and not `LinearCode`? \n\n\nMy mistake; fixed.\n\n>` encoder.py`: instanciated -> instantiated \n\n\nFixed.\n\n> `codes.encoders` now contains `lazy_import`. Should be hidden \n\n\nDone.\n\n> `AbstractLinearCode` class doc warning: perhaps \"and `F` its base ring\" should be \"and `F` is the base field of the code\". \n\n\nYes, it's less confusing like that. Done.\n\n> `encoder.encode` doc: the newly added \"`encode` is a partial function ...\" should perhaps be made slightly less strong to not confuse readers: \"`encode` might be a partial function ...\". Many encoders are going to be complete. \n\n\nThat's right. Changed it.",
    "created_at": "2015-10-13T15:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319901",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:53'></a>> Why is `LinearCodeGeneratorMatrixEncoder` registered on `AbstractLinearCode` and not `LinearCode`? 
...
```json
{
    "body": "<a id='comment:54'></a>Unencoding a zero-vector on a zero-dimensional code still explodes. You only catch the case where the *ambient space* has zero dimension as well (i.e. the code has length zero):\n\n```\nsage: G = Matrix(GF(2), 0, 5)\nsage: C = LinearCode(G)\nsage: c = C.random_element()\nsage: C.unencode(c)\n<BOOM>\n```",
    "created_at": "2015-10-13T19:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319902",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:54'></a>Unencoding a zero-vector on a zero-dimensional code still explodes. You only catch the case where the *ambient space* has zero dimension as well (i.e. the code has length zero):
...
```json
{
    "body": "<a id='comment:55'></a>I pushed an alternative fix to the zero-dimensional problem. I give the green light to the patch now. If you can accept my small amendment as is, set it to positive review :-)\n\nBest,\nJohan",
    "created_at": "2015-10-13T19:30:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319903",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:55'></a>I pushed an alternative fix to the zero-dimensional problem. I give the green light to the patch now. If you can accept my small amendment as is, set it to positive review :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319904",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319905",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319906",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319907",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319908",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    "body": "<a id='comment:58'></a>Accepted.\n\nMany thanks!\n\n---\nNew commits:",
    "created_at": "2015-10-13T19:36:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319909",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```

<a id='comment:58'></a>Accepted.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319910",
    "user": "https://trac.sagemath.org/admin/accounts/users/dlucas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319911",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18376#event-51818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18376#issuecomment-319912",
    "user": "https://github.com/vbraun"
}
```
