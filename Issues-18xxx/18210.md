...
```json
{
    "body": "<div id=\"comment:6\" align=\"right\">comment:6</div>\n\nInterestingly, neither the first snippet in the description nor the BOOM snippet in [comment:1](#comment:1) will crash on 6.7beta1/OpenSuSE. What machine/system is that, Viviane/buck/nbruin?",
