...
```json
{
    "body": "<a id='comment:3'></a>The original discussion is here: https://groups.google.com/d/msg/sage-support/7ex6McLE7AA/mvZ5Rq-D1FAJ",
    "created_at": "2015-04-15T18:47:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315387",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:3'></a>The original discussion is here: https://groups.google.com/d/msg/sage-support/7ex6McLE7AA/mvZ5Rq-D1FAJ
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315388",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I think there's more to it than that even. Using the limited-precision numerics, I get this plot:\n\n![](broken-graph-2015.png)\ufffc\ufffc\n\nIn 2012, when the exact numerics still worked, I got this graph:\n\n<img src=\"working-graph-2012.png\" width=600px>\ufffc\ufffc",
    "created_at": "2015-04-15T19:23:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315389",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:4'></a>I think there's more to it than that even. Using the limited-precision numerics, I get this plot:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315390",
...
```json
{
    "body": "<a id='comment:6'></a>Interestingly, neither the first snippet in the description nor the BOOM snippet in[comment:1](#comment%3A1) will crash on 6.7beta1/OpenSuSE. What machine/system is that, Viviane/buck/nbruin?",
    "created_at": "2015-04-16T06:49:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315391",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>Interestingly, neither the first snippet in the description nor the BOOM snippet in[comment:1](#comment%3A1) will crash on 6.7beta1/OpenSuSE. What machine/system is that, Viviane/buck/nbruin?
...
```json
{
    "body": "<a id='comment:7'></a>I'm on OS X 10.10.3",
    "created_at": "2015-04-16T17:55:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315392",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:7'></a>I'm on OS X 10.10.3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315394",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>No crash on OSX/6.7.beta1 either. Any crashes on 6.7beta1 at all?",
    "created_at": "2015-04-17T06:09:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315395",
    "user": "https://github.com/rwst"
}
```

<a id='comment:10'></a>No crash on OSX/6.7.beta1 either. Any crashes on 6.7beta1 at all?
...
```json
{
    "body": "<a id='comment:11'></a>I also get no segfault in 6.7, but the numerical issue persists.\nSeparate issue I suppose.",
    "created_at": "2015-04-18T00:31:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315396",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:11'></a>I also get no segfault in 6.7, but the numerical issue persists.
Separate issue I suppose.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315399",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315400",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>BTW this will be fixed with #16697 (needs review) because there we switched to mpmath for numerics. You can already use this in Sage via:\n\n```\nsage: from sage.libs.mpmath import utils as mpmath_utils\nsage: import mpmath\nsage: mpmath_utils.call(mpmath.gammainc, 60, 0, 30)\n1.28307801824120e74\n```\nThis ticket may be closed therefore (after the Pari devs have ack'ed the bug) as duplicate of #16697 (augmenting its description with the bug).",
    "created_at": "2015-04-20T13:13:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315401",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>BTW this will be fixed with #16697 (needs review) because there we switched to mpmath for numerics. You can already use this in Sage via:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315402",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315403",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315404",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>The upstream tickets are:\n* Pari/GP: http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1689PARI/GP\n* mpmath: https://github.com/fredrik-johansson/mpmath/issues/311\n\nThanks for the report!",
    "created_at": "2015-04-20T14:27:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315405",
    "user": "https://github.com/rwst"
}
```

<a id='comment:17'></a>The upstream tickets are:
* Pari/GP: http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1689PARI/GP
* mpmath: https://github.com/fredrik-johansson/mpmath/issues/311
...
```json
{
    "body": "<a id='comment:18'></a>No, mpmath is correct. I confused lower/upper. So, as said, use the #16697 branch or better, review it:\n\n```\nsage: gamma(60,30).n()\n1.38682990237888e80\n```",
    "created_at": "2015-04-20T14:56:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315406",
    "user": "https://github.com/rwst"
}
```

<a id='comment:18'></a>No, mpmath is correct. I confused lower/upper. So, as said, use the #16697 branch or better, review it:
...
```json
{
    "body": "<a id='comment:19'></a>I was wrong referring to #16697 because this is a different bug. This issue is still open upstream.",
    "created_at": "2015-07-29T08:33:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315407",
    "user": "https://github.com/rwst"
}
```

<a id='comment:19'></a>I was wrong referring to #16697 because this is a different bug. This issue is still open upstream.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315408",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>rws, could you please copy the relevant bits from #16697?\n\nI'm going to work to close this in coming weeks.",
    "created_at": "2015-07-29T15:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315409",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:20'></a>rws, could you please copy the relevant bits from #16697?
...
```json
{
    "body": "<a id='comment:22'></a>`@`rws: Could you expand on the \"two different bugs\" and link them (and/or create tickets for them)?\n\nAlso, could you explain why \"because it uses the gp interface\" would obscure the negative-number return value?",
    "created_at": "2015-07-30T01:13:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315411",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:22'></a>`@`rws: Could you expand on the "two different bugs" and link them (and/or create tickets for them)?
...
```json
{
    "body": "<a id='comment:24'></a>The bug reported in the OP seems gone; I can't reproduce the segfault.\nCan we change the topic of the bug to strictly about the numerical issue?\nThat seems to be what most of the discussion was about.",
    "created_at": "2015-07-30T16:33:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315413",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:24'></a>The bug reported in the OP seems gone; I can't reproduce the segfault.
Can we change the topic of the bug to strictly about the numerical issue?
That seems to be what most of the discussion was about.
...
```json
{
    "body": "<a id='comment:25'></a>`@`rws: I'll spend some time digging into this myself, and produce a pari and/or gp patch if I can, but I'm a bit lost as to where to start. Could you give some clues as to how I might pointpoint the issue, what code I should look at patching?",
    "created_at": "2015-07-30T16:34:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315414",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:25'></a>`@`rws: I'll spend some time digging into this myself, and produce a pari and/or gp patch if I can, but I'm a bit lost as to where to start. Could you give some clues as to how I might pointpoint the issue, what code I should look at patching?
...
```json
{
    "body": "<a id='comment:26'></a>In my opinion the Pari bug (which shows itself when using the GP/Pari program without Sage) should be fixed first. This means looking into the Pari code and reporting to its developers on that ticket already given in[comment:17](#comment%3A17). After that it remains to be seen what's still wrong. For completeness Sage's libpari interface is in `libs/pari`.",
    "created_at": "2015-07-31T06:00:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315415",
    "user": "https://github.com/rwst"
}
```

<a id='comment:26'></a>In my opinion the Pari bug (which shows itself when using the GP/Pari program without Sage) should be fixed first. This means looking into the Pari code and reporting to its developers on that ticket already given in[comment:17](#comment%3A17). After that it remains to be seen what's still wrong. For completeness Sage's libpari interface is in `libs/pari`.
...
```json
{
    "body": "<a id='comment:28'></a>Thanks! Building master sagemath branch now...",
    "created_at": "2016-01-16T18:30:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315417",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:28'></a>Thanks! Building master sagemath branch now...
...
```json
{
    "body": "<a id='comment:30'></a>Ah after cloning pari, it's apparent that the installed sage version is four months behind the fixing commit.\n\nI'll try to find in the docs how to get sage to install this newer version.",
    "created_at": "2016-01-17T22:29:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315419",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:30'></a>Ah after cloning pari, it's apparent that the installed sage version is four months behind the fixing commit.
...
```json
{
    "body": "<a id='comment:34'></a>While this is great work I believe you should open a separate Pari upgrade ticket for this.",
    "created_at": "2016-01-18T06:32:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315423",
    "user": "https://github.com/rwst"
}
```

<a id='comment:34'></a>While this is great work I believe you should open a separate Pari upgrade ticket for this.
...
```json
{
    "body": "<a id='comment:35'></a>`@`rws Yes I didn't anticipate this would be such work. Will do.",
    "created_at": "2016-01-18T06:44:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315424",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:35'></a>`@`rws Yes I didn't anticipate this would be such work. Will do.
...
```json
{
    "body": "<a id='comment:36'></a>Pari upgrade work migrated to #19905.",
    "created_at": "2016-01-18T06:57:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315425",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:36'></a>Pari upgrade work migrated to #19905.
...
```json
{
    "body": "<a id='comment:37'></a>I was finally able to integrate pari master-branch with sage, and while the problem is much improved, it's not fixed. Here's the graph from the original bug report, using newest pari:\n\n![](broken-graph-2016.png)\ufffc\ufffc\n\n\nThose discontinuities are false. An example bad value:\n\n```\nsage: gamma(100, 7.01)\n-2.71843697211100e151\n```\nI will report this upstream, and attach a worksheet showing more detail.",
    "created_at": "2016-01-18T22:53:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315426",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```

<a id='comment:37'></a>I was finally able to integrate pari master-branch with sage, and while the problem is much improved, it's not fixed. Here's the graph from the original bug report, using newest pari:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315427",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315428",
    "user": "https://trac.sagemath.org/admin/accounts/users/buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315431",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315432",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18210#event-51465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315433",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18210#event-51466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18210#issuecomment-315434",
