...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18192#event-241014"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18192#event-241015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18192#event-241016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18192#event-241017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18192#issuecomment-251440",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18192#issuecomment-251441",
    "user": "https://github.com/jdemeyer"
}
```
