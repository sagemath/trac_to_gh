...
```json
{
    "body": "<a id='comment:1'></a>Blindly doing `save(x.sage(),\"blah\")` is not quite right, as this would e.g. break saving/loading Python objects (something that works just fine).\n\nIdeas?",
    "created_at": "2015-07-03T10:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333014",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>Blindly doing `save(x.sage(),"blah")` is not quite right, as this would e.g. break saving/loading Python objects (something that works just fine).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333015",
...
```json
{
    "body": "<a id='comment:4'></a>Or perhaps one should do a compromise: If `self.sage()` throws an error, then we should try if the string representation is good enough to reconstruct the object. If it does then use it, otherwise throw an error upon pickling.\n\nIt would be better than nothing. But it could be quite costly to first check, for each interface element to be pickled, if the string representation is good enough.",
    "created_at": "2015-07-03T10:41:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333016",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>Or perhaps one should do a compromise: If `self.sage()` throws an error, then we should try if the string representation is good enough to reconstruct the object. If it does then use it, otherwise throw an error upon pickling.
...
```json
{
    "body": "<a id='comment:6'></a>PPPS: Both Singular and GAP can dump a complete session. I don't know if that has been wrapped in Sage's interface. But it could be useful for some. Not for pickling individual objects, though.",
    "created_at": "2015-07-03T11:01:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333018",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>PPPS: Both Singular and GAP can dump a complete session. I don't know if that has been wrapped in Sage's interface. But it could be useful for some. Not for pickling individual objects, though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333019",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333020",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333021",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Something totally different: Why is there a `.save()` and `.dumps()` method? Since `__reduce__` is implemented, `save(Foo, \"bar\")` would be the recommended way to store `Foo` in \"bar.sobj\", and `Foo.save(\"bar\")` isn't really adding anything. Can we deprecate these methods?",
    "created_at": "2015-07-03T12:28:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333022",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>Something totally different: Why is there a `.save()` and `.dumps()` method? Since `__reduce__` is implemented, `save(Foo, "bar")` would be the recommended way to store `Foo` in "bar.sobj", and `Foo.save("bar")` isn't really adding anything. Can we deprecate these methods?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333023",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/SimonKing/do_not_save___objects_we_cannot_load__\"",
    "created_at": "2015-07-03T20:57:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333024",
    "user": "https://github.com/simon-king-jena"
}
```

Changing branch from "" to "u/SimonKing/do_not_save___objects_we_cannot_load__"
...
```json
{
    "body": "Changing commit from \"\" to \"547f511ff186696ac2617c6324852c59b079c807\"",
    "created_at": "2015-07-03T21:16:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333026",
    "user": "https://github.com/simon-king-jena"
}
```

Changing commit from "" to "547f511ff186696ac2617c6324852c59b079c807"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333027",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333028",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333029",
...
```json
{
    "body": "Changing commit from \"547f511ff186696ac2617c6324852c59b079c807\" to \"2445264ab24d28344b7bb850c2bdaef446f1e65c\"",
    "created_at": "2015-07-04T14:11:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333030",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "547f511ff186696ac2617c6324852c59b079c807" to "2445264ab24d28344b7bb850c2bdaef446f1e65c"
...
```json
{
    "body": "<a id='comment:15'></a>With the new commit, many interface elements became picklable that haven't been before. Previously, elements of the r or singular or gap or pari or maxima interface would unpickle as invalid. But, as demonstrated in the new tests, now they can be pickled and unpickled.\n\nOne missing case are strings in maxima. In fact, a string in maxima is not converted to a string in Sage, but it is attempted to transform it into an expression, which for what ever reason fails.\n\nDo you know how to recognise a string in maxima? I.e., is there a command in maxima that tells whether a variable is a string?\n\nIn any case, I believe the current branch extends the pickling capabilities of interface elements considerably.",
    "created_at": "2015-07-04T14:16:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333031",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>With the new commit, many interface elements became picklable that haven't been before. Previously, elements of the r or singular or gap or pari or maxima interface would unpickle as invalid. But, as demonstrated in the new tests, now they can be pickled and unpickled.
...
```json
{
    "body": "<a id='comment:16'></a>What I don't understand is why Lisp interface does not suffer from this issue:\n\n```\nsage: x=lisp(1)\nsage: x\n1\nsage: type(x)\n<class 'sage.interfaces.lisp.LispElement'>\nsage: x.save(\"/tmp/foo\")\nsage: load(\"/tmp/foo\")\n1\nsage: y=load(\"/tmp/foo\")\nsage: y==x\nTrue\n```\nAnd in fact `/tmp/foo.sobj` is loadable in a fresh Sage session.",
    "created_at": "2015-07-04T15:20:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333032",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:16'></a>What I don't understand is why Lisp interface does not suffer from this issue:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333035",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"2445264ab24d28344b7bb850c2bdaef446f1e65c\" to \"123f29504557ae471ac9d55b0c5a6fbad587c30f\"",
    "created_at": "2015-07-04T17:20:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333036",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "2445264ab24d28344b7bb850c2bdaef446f1e65c" to "123f29504557ae471ac9d55b0c5a6fbad587c30f"
...
```json
{
    "body": "<a id='comment:20'></a>There were tests to be fixed. Actually one of the failing tests tried to make sure that the unpickled element is invalid...\n\n---\nNew commits:",
    "created_at": "2015-07-04T17:21:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333037",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>There were tests to be fixed. Actually one of the failing tests tried to make sure that the unpickled element is invalid...
...
```json
{
    "body": "<a id='comment:21'></a>I am just wondering: Should we perhaps get rid of `reduce_load`? After all, an interface is callable, and hence there is no need to have a function that calls the interface when we can do it directly.",
    "created_at": "2015-07-04T18:34:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333038",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:21'></a>I am just wondering: Should we perhaps get rid of `reduce_load`? After all, an interface is callable, and hence there is no need to have a function that calls the interface when we can do it directly.
...
```json
{
    "body": "Changing commit from \"123f29504557ae471ac9d55b0c5a6fbad587c30f\" to \"595df9606f14cffa7f8131aedb6daeaf1b08c1ce\"",
    "created_at": "2015-07-04T18:45:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333039",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "123f29504557ae471ac9d55b0c5a6fbad587c30f" to "595df9606f14cffa7f8131aedb6daeaf1b08c1ce"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333040",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333041",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"595df9606f14cffa7f8131aedb6daeaf1b08c1ce\" to \"d123d33c89ff4524ecf960d894ea07a1f0e96196\"",
    "created_at": "2015-07-05T08:16:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333042",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "595df9606f14cffa7f8131aedb6daeaf1b08c1ce" to "d123d33c89ff4524ecf960d894ea07a1f0e96196"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333043",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333044",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333046",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333047",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>I guess it would be better to ask on sage-nt or sage-algebra, since it appears to be about elliptic curves.",
    "created_at": "2015-07-09T09:22:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333048",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:27'></a>I guess it would be better to ask on sage-nt or sage-algebra, since it appears to be about elliptic curves.
...
```json
{
    "body": "<a id='comment:29'></a>PS: Or even better, we should just replace the test by \n\n```\nsage: E = gp('ellinit([1,2,3,4,5])')\nsage: loads(dumps(E)) == E\nTrue\n```\nI'll commit and push it now.",
    "created_at": "2015-07-09T09:37:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333050",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:29'></a>PS: Or even better, we should just replace the test by 
...
```json
{
    "body": "Changing commit from \"d123d33c89ff4524ecf960d894ea07a1f0e96196\" to \"bb63cd205f7150776d04f5e1e7ec02438b8dc384\"",
    "created_at": "2015-07-09T09:40:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333051",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d123d33c89ff4524ecf960d894ea07a1f0e96196" to "bb63cd205f7150776d04f5e1e7ec02438b8dc384"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333052",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333053",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333054",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333055",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333056",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"u/SimonKing/do_not_save___objects_we_cannot_load__\" to \"bb63cd205f7150776d04f5e1e7ec02438b8dc384\"",
    "created_at": "2015-07-09T21:58:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333057",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/SimonKing/do_not_save___objects_we_cannot_load__" to "bb63cd205f7150776d04f5e1e7ec02438b8dc384"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18848#issuecomment-333058",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18848",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18848#event-52680"
}
```
