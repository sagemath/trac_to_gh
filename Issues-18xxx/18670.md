...
```json
{
    "body": "The `polynomial_element.pyx` doctest still fails for me with 6.8.beta5 in exactly the same way. Although `polynomial_element.pyx` seems to have changed slightly from beta3 -> beta5, the above commit still works.",
...
```json
{
    "body": "Is fine. 1/7 patchbot runs failed but the failure is unrelated. So this is well tested too.",
    "created_at": "2015-06-26T06:07:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18670",
    "type": "issue_comment",
