...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18172#event-240709"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18172#event-240710"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18172#event-240711"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18172#event-240712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18172#issuecomment-250977",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18172#issuecomment-250978",
    "user": "https://github.com/nbruin"
}
```
