...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18902#event-250567"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18902#event-250568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18902#event-250569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18902#event-250570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18902#issuecomment-267300",
    "user": "https://github.com/rwst"
}
```
