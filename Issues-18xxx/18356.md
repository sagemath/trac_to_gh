...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[428c46c](http://git.sagemath.org/sage.git/commit/?id=428c46cb691e0caad792822906386e5178a84afe)|`Merge branch 'develop' of git://trac.sagemath.org/sage into mp1a`|\n|[1898678](http://git.sagemath.org/sage.git/commit/?id=1898678cfccd18df76b57a015c03d96fb44542ae)|`Added `composed_op` replacing `composed_sum` and `composed_product`.`|",
    "created_at": "2015-05-08T09:54:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18356",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[23f379f](http://git.sagemath.org/sage.git/commit/?id=23f379fe030f522f19b26f2866ec3160739845be)|`Added `QQxy_with_gens`; taken the `prec` argument out of `newton_sum`;`|\n|[1cb8ac6](http://git.sagemath.org/sage.git/commit/?id=1cb8ac6646694b81151c49f220c98fdbb63258c3)|`Eliminated call to big_O`|\n|[aafe62e](http://git.sagemath.org/sage.git/commit/?id=aafe62ee7fc61553a9396b8d51e3c6ae36f4ac27)|`Used `operator.add` instead of `+`.`|\n|[5f888c8](http://git.sagemath.org/sage.git/commit/?id=5f888c83095eab89acbd96ee09e067918a60c258)|`Added checks on the input polynomials.`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[1fe9b05](http://git.sagemath.org/sage.git/commit/?id=1fe9b052c8f1e49f9b0480f40dfa1937ef9f8dcf)|`eliminated `newton_sum``|",
    "created_at": "2015-05-15T09:18:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18356",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:33'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[dcb3748](http://git.sagemath.org/sage.git/commit/?id=dcb3748ffdc3748b6968cf91c188f8ab266ab626)|`Eliminated `QQxy_with_gens`; added some doctests.`|",
...
```json
{
    "body": "<a id='comment:36'></a>\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[51a3835](http://git.sagemath.org/sage.git/commit/?id=51a383569dd40e300aef748a847ae3ddeb101885)|`Trac 18356: composed_sum and composed_product for polynomials`|\n|[8c609a8](http://git.sagemath.org/sage.git/commit/?id=8c609a8a1c7cfbc34fe08984d2df82c862b006eb)|`Added `composed_op` replacing `composed_sum` and `composed_product`.`|\n|[830d9a7](http://git.sagemath.org/sage.git/commit/?id=830d9a751b2fb4378ea841abfccfb273bfdffcb4)|`Trac 18356: various improvements and bug fixes`|\n|[bef78f5](http://git.sagemath.org/sage.git/commit/?id=bef78f51e6d029356dcc4187f9e1a010e4bce3fe)|`Eliminated call to big_O`|\n|[8fcbb1a](http://git.sagemath.org/sage.git/commit/?id=8fcbb1aa00349be3048fdf78c6dac4aba038c07c)|`Used `operator.add` instead of `+`.`|\n|[896f9bd](http://git.sagemath.org/sage.git/commit/?id=896f9bdcff469a2bc86847ac38e59fb408bcc9a2)|`Added checks on the input polynomials.`|\n|[81ec213](http://git.sagemath.org/sage.git/commit/?id=81ec213e52d4b04a6d752d23d66eaa8bcd4941d1)|`eliminated `newton_sum``|\n|[f720b8b](http://git.sagemath.org/sage.git/commit/?id=f720b8bab4b30d9db69f66a13ca5822aa9514d1d)|`Trac 18356: Eliminated `QQxy_with_gens`; added some doctests.`|\n|[de9f047](http://git.sagemath.org/sage.git/commit/?id=de9f0473c60325e54f53d112bd587790f646ecff)|`Trac 18356: fix documentation`|\n|[885eb5d](http://git.sagemath.org/sage.git/commit/?id=885eb5d695818eeeed34362e37e5271960896c8b)|`Trac 18356: do not use power series ring`|",
    "created_at": "2016-01-18T19:13:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18356",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[1ec84bb](http://git.sagemath.org/sage.git/commit/?id=1ec84bb78d9e3a5a1e1c966d78e1797ec70afac0)|`Trac 18356: use _mul_trunc_ when possible`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[bfb6379](http://git.sagemath.org/sage.git/commit/?id=bfb6379a8ab8b59d37cb99204f40322b911fab90)|`Trac 18356: composed_op for any field`|",
    "created_at": "2016-01-25T04:14:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18356",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:42'></a>\nI think that the code is good to go except for a few details which I tried to fix. Please set the ticket to positive_review if you are okay with my changes.\n\n---\nNew commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[d8474c9](http://git.sagemath.org/sage.git/commit/?id=d8474c9e0885b677d9839c7478e4c371ce194cbd)|`Merge branch 'develop' into review/composed`|\n|[66ae0a0](http://git.sagemath.org/sage.git/commit/?id=66ae0a0385af66d1dbcb192e6001f21ae5f8c172)|`#18356 fix doctest`|\n|[8fa5d3b](http://git.sagemath.org/sage.git/commit/?id=8fa5d3b98d2e615dfc49dd71dda1478ac459ed69)|`#18356 improve docstring of Polynomial.composed_op()`|\n|[a4d2df6](http://git.sagemath.org/sage.git/commit/?id=a4d2df69e9dae4715093d18c991f0427b7f16bf9)|`#18536 minor improvements to Polynmomial.composed_op()`|",
    "created_at": "2016-05-18T13:03:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18356",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[b339d44](http://git.sagemath.org/sage.git/commit/?id=b339d44fa7ce5ea057a83d7552989df7c6a92e95)|`#18356 improve docstring of Polynomial.composed_op()`|\n|[c6b1c35](http://git.sagemath.org/sage.git/commit/?id=c6b1c35de85957fc501d6f34b4de6b8def0a8ea0)|`#18536 minor improvements to Polynmomial.composed_op()`|",
    "created_at": "2016-05-18T13:05:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18356",
    "type": "issue_comment",
