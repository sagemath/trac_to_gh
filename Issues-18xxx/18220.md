...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319544",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319545",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319546",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319547",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,3 +1,4 @@\n+The 'field' backend does not properly support non exact fields\n \n ```\n sage: omega = 2*RR.pi() / 5\n@@ -6,16 +7,9 @@\n sage: Polyhedron(vertices=verts, base_ring=RR)\n Traceback (most recent call last):\n ...\n-/sage/local/lib/python2.7/site-packages/sage/geometry/polyhedron/double_description_inhomogeneous.pyc in `_extract_`Vrep(self, DD)\n-    309         vertices = []\n-    310         for v in R1 + L1:\n---> 311             assert v[0] == 1\n-    312             vertices.append(v[1:])\n-    313         self.vertices = vertices\n AssertionError: \n ```\n-\n-There are also other types of wrong behavior:\n+or\n \n ```\n sage: Q = polytopes.icosahedron()\n@@ -28,3 +22,5 @@\n sage: Q_RR\n A 3-dimensional polyhedron in (Real Field with 103 bits of precision)^3 defined as the convex hull of 1 vertex and 3 rays\n ```\n+\n+We simply raise an error if somebody want to try this.\n``````\n",
    "created_at": "2017-03-06T01:12:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319548",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319549",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319550",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319551",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319552",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319553",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319554",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319555",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319556",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319557",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319558",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319559",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319561",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319562",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319563",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319564",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319565",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319566",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319567",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319568",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18220#issuecomment-319569",
    "user": "https://github.com/videlec"
}
```
