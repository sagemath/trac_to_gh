...
```json
{
    "body": "<a id='comment:1'></a>I would hate to change all my code that uses `show`, yet I think this ticket is a great idea.",
    "created_at": "2015-04-26T03:28:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243052",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:1'></a>I would hate to change all my code that uses `show`, yet I think this ticket is a great idea.
...
```json
{
    "body": "<a id='comment:3'></a>If you want to see a plot of the graph use one of the following two\n\n```\nsage: plot(g)\nsage: g.plot()\n```\nOr use `pretty_print(g)` instead of `show(g)`, though whether or not that results in a picture will depend on the user interface capabilities.",
    "created_at": "2015-04-26T16:10:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243054",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>If you want to see a plot of the graph use one of the following two
...
```json
{
    "body": "<a id='comment:4'></a>I know this has been discussed elsewhere, but since there is an actual ticket for this... What would the recommended syntax be going forward for interacts, where simply printing the plot doesn't work (as far as I recall, neither in sagenb nor in sagecell)?  That is\n\n```\n@interact\ndef _():\n    P = plot(x)\n    P\n```\nwouldn't show the plot, you need to use `show(P)` (or did need to).  This is a pretty important use case, though of course it would be nice not to have to do `show(P)`, we should still support this working for the immediate future.  (And don't say to do `P.show()`, because that's even more annoying and less likely to occur to someone new to OOP.)",
    "created_at": "2015-04-28T13:50:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243055",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>I know this has been discussed elsewhere, but since there is an actual ticket for this... What would the recommended syntax be going forward for interacts, where simply printing the plot doesn't work (as far as I recall, neither in sagenb nor in sagecell)?  That is
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243058",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Instead of `pretty_print()` or `show()`, there is an obvious third possibility: `display()` which is what IPython uses. This works in the current Sage-Jupyter notebook:\n\n```\nP = plot(sin(x))\nfrom IPython.display import display\ndisplay(P)\n```\n\nI'm not saying that Sage should use exactly the `display` function from IPython, but maybe have a Sage-specific `display` function which does what `show` currently does?",
    "created_at": "2017-03-22T11:17:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243059",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>Instead of `pretty_print()` or `show()`, there is an obvious third possibility: `display()` which is what IPython uses. This works in the current Sage-Jupyter notebook:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243061",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243063",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243065",
...
```json
{
    "body": "<a id='comment:15'></a>I think this ticket should be closed.",
    "created_at": "2017-05-31T18:43:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243066",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:15'></a>I think this ticket should be closed.
...
```json
{
    "body": "<a id='comment:16'></a>Personally, I also prefer the name `show` to `pretty_print`. The latter reminds me to much of \"printing\" and I think that displaying a plot for example isn't really \"printing\" anything. To be fair, displaying an equation as LaTeX is pretty printing. But `show`/`pretty_print` do more than that.\n\nStill, I remind my proposal to use the name `display` (instead of or in addition to `pretty_print`/`show`) simply because that's what IPython upstream uses.",
    "created_at": "2017-05-31T20:31:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243067",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>Personally, I also prefer the name `show` to `pretty_print`. The latter reminds me to much of "printing" and I think that displaying a plot for example isn't really "printing" anything. To be fair, displaying an equation as LaTeX is pretty printing. But `show`/`pretty_print` do more than that.
...
```json
{
    "body": "<a id='comment:17'></a>I think switching to `display` is also a great idea (btw GAP also uses `Display`). We would be consistent with ourselves AND jupyter...\n\nThat Mathematica uses `Show[]` is another point against as that language is known to get everything wrong ;-)\n\nThough the name display is currently not available as line magics can also be called without percent (not sure why), so the following are equivalent\n\n```\nsage: display text plain\nsage: display\nDisplay preferences:\n* graphics is not specified\n* supplemental_plot = never\n* text = plain\nsage: %display unicode_art\nsage: %display\nDisplay preferences:\n* graphics is not specified\n* supplemental_plot = never\n* text = unicode_art\n```",
    "created_at": "2017-05-31T21:06:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18302#issuecomment-243068",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>I think switching to `display` is also a great idea (btw GAP also uses `Display`). We would be consistent with ourselves AND jupyter...
