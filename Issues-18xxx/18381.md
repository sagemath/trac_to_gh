...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243553"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18381#issuecomment-255492",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18381#issuecomment-255493",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243559"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243561"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243562"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18381",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18381#event-243563"
}
```
