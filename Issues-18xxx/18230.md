...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18230#event-241497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18230#event-241498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18230#event-241499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18230#issuecomment-252302",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18230#issuecomment-252303",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18230#event-241500"
}
```
