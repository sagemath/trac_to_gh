...
```json
{
    "body": "Working on this; the main challenge is determining the level of the twisted form.",
...
```json
{
    "body": "A first version; this is still unable to compute the level in many cases.\n\n---\nNew commits:",
...
```json
{
    "body": "Calculating the level of the twisted form is still only implemented in the cases where [Atkin-Li, Theorem 3.1] applies.  However, I currently don't have time to find out if this can easily be done in greater generality, and the current implementation suffices for #18061, which depends on this ticket.",
...
```json
{
    "body": "I rebased the trac branch on top of #18479. (I hope I did this right, I'm not very good at git yet!)\n\n---\nNew commits:",
...
```json
{
    "body": "Oops, I seem to have broken something and I can't work out why -- this Git branch won't compile. Sorry, I don't know how to fix this! Any offers?",
...
```json
{
    "body": "When I try compiling this branch, it raises an error at sage/ext/interrupt/interrupt.pxd and refuses to continue.",
...
```json
{
    "body": "No, I can't reproduce this. It all works fine for me on that branch. That file should not have been touched and should not compile. Probably you best abandon your branch and start a new one pulling from the trac and try compiling again.",
...
```json
{
    "body": "I worked out the problem. The point is that the current \"develop\" branch doesn't actually build on my machine -- as is sometimes the case with unreleased betas -- and the branch at #18479 hangs off develop, not master.",
...
```json
{
    "body": "Aargh! Now it won't merge and I can't work out why! This is giving me a serious headache.",
...
```json
{
    "body": "See #18672 for a follow-up.",
