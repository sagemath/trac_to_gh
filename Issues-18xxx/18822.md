...
```json
{
    "body": "<a id='comment:2'></a>That's right. Elliptic E and F functions with argument containing inverse trig function may already appear as solution to `integral(1/sqrt(a+b*x^3), x)`.",
    "created_at": "2018-04-22T13:11:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18822#issuecomment-332129",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>That's right. Elliptic E and F functions with argument containing inverse trig function may already appear as solution to `integral(1/sqrt(a+b*x^3), x)`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18822#issuecomment-332130",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18822#issuecomment-332131",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18822#issuecomment-332132",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52621"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52622"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18822#issuecomment-332133",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52623"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52624"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52625"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52626"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52627"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52628"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52629"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18822#event-52630"
}
```
