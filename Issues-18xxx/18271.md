...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[c2942ce](http://git.sagemath.org/sage.git/commit/?id=c2942ce1b9982f0e9cc4f3158cad641cc5d3fd7e)|`Temporary commit while I figure out what went wrong`|\n|[a62fdea](http://git.sagemath.org/sage.git/commit/?id=a62fdea2dd552075e22c39dc94fe7a3fa110d538)|`18271 enhancement add Stanley's hook formula`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[226800b](http://git.sagemath.org/sage.git/commit/?id=226800b0426be738e63b74ce3758fc38d3094c9b)|`18271 Added choice of algorithm`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nThank you. I also made some reviewer tweaks, so if you're happy with my changes, then you can set a positive review.\n\n---\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[c1a07e2](http://git.sagemath.org/sage.git/commit/?id=c1a07e29756c21fba61ef02aa762bf19afd1b962)|`Tweaks to the documentation and code.`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[8e7824d](http://git.sagemath.org/sage.git/commit/?id=8e7824dc463fccee32c14818d700ea1d58de5962)|`Removing trailing whitespace.`|",
