...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251734"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18985#issuecomment-269509",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18985#issuecomment-269510",
    "user": "https://github.com/sagetrac-git"
}
```
