...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251738"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251740"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18985#issuecomment-269505",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18985#issuecomment-269506",
    "user": "https://github.com/ptigwe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251741"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18985#issuecomment-269507",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18985#issuecomment-269508",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18985#event-251742"
}
```
