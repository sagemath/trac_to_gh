...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18851#event-249924"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18851#event-249925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18851#event-249926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18851#event-249927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18851#issuecomment-266462",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18851#issuecomment-266463",
    "user": "https://github.com/vbraun"
}
```
