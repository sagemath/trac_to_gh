...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329018",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>`lambda` is a [reserved keyword](https://docs.python.org/2.7/reference/lexical_analysis.html#keywords) in Python, so just like `and` or `def` it shouldn't be used as a variable name.",
    "created_at": "2015-06-12T22:29:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329019",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>`lambda` is a [reserved keyword](https://docs.python.org/2.7/reference/lexical_analysis.html#keywords) in Python, so just like `and` or `def` it shouldn't be used as a variable name.
...
```json
{
    "body": "<a id='comment:3'></a>This ticket is about using `lambda` as a math symbol, not a Python variable name.  That's why the Python variable name in the included code snippet is not `lambda`.  It's standard mathematical practice to use `lambda` as a symbol, and Sage should support it as fully as possible.",
    "created_at": "2015-06-12T22:34:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329020",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```

<a id='comment:3'></a>This ticket is about using `lambda` as a math symbol, not a Python variable name.  That's why the Python variable name in the included code snippet is not `lambda`.  It's standard mathematical practice to use `lambda` as a symbol, and Sage should support it as fully as possible.
...
```json
{
    "body": "<a id='comment:4'></a>I maybe agree. `SR.var` doesn't particularly inject a binding into a python scope, so it doesn't necessarily need to check whether things are python identifiers.\n\nThat said, for the sanity of the system it might be a good idea to make some checks on what kind of math symbols we allow. These things tend to end up in strings to various interfaces (although we wouldn't really need to do that for maxima, but we still do). It might even be that we end up \"eval\"-ing expressions in python, in which case python identifiers shouldn't be allowed.",
    "created_at": "2015-06-13T03:47:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329021",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:4'></a>I maybe agree. `SR.var` doesn't particularly inject a binding into a python scope, so it doesn't necessarily need to check whether things are python identifiers.
...
```json
{
    "body": "<a id='comment:7'></a>> I'm not entirely sure whether lambda is one of those implicit restrictions.\n\n\nWould it be helpful to relax the restriction and see if the tests fail?\n\n> I think the standard representation we use is valid python syntax (modulo keyword clashes),\n\n\nOut of curiosity, how is \"D[0](f)(x)\" made into valid python syntax?",
    "created_at": "2015-06-14T19:36:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329024",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```

<a id='comment:7'></a>> I'm not entirely sure whether lambda is one of those implicit restrictions.
...
```json
{
    "body": "<a id='comment:8'></a>> Would it be helpful to relax the restriction and see if the tests fail?\n\n\nNo, of course not. New tests would have to be written.  Never mind that.",
    "created_at": "2015-06-14T22:29:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329025",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```

<a id='comment:8'></a>> Would it be helpful to relax the restriction and see if the tests fail?
...
```json
{
    "body": "<a id='comment:10'></a>Note also that `lambda_` does most of what you want, if I recall correctly.",
    "created_at": "2015-06-17T13:17:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18694#issuecomment-329027",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Note also that `lambda_` does most of what you want, if I recall correctly.
