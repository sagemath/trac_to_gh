...
```json
{
    "body": "<a id='comment:1'></a>This would be fixed by #31404.  Of course, this ticket should still be kept open until/unless that one is merged.",
    "created_at": "2021-02-16T13:23:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18343",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18343#issuecomment-243719",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>This would be fixed by #31404.  Of course, this ticket should still be kept open until/unless that one is merged.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18343",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18343#issuecomment-243720",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18343#event-51754"
}
```
