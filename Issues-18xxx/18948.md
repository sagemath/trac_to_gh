...
```json
{
    "body": "<a id='comment:53'></a>Replying to [comment:50 ncohen]:\n> They do. Have you found a proof of the contrary? \n\n\nYes, comment:33",
...
<a id='comment:53'></a>Replying to [comment:50 ncohen]:
> They do. Have you found a proof of the contrary? 
...
<a id='comment:55'></a>> Yes, comment:33
...
<a id='comment:73'></a>Replying to [comment:69 ncohen]:
> Let's create another ticket for that. It's unrelated to the topic of #18988..
