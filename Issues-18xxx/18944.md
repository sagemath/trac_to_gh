...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335726",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"eeefd9d2c4184a3f60f505a7851ec3ff16eb7bf0\"",
    "created_at": "2015-07-23T09:49:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335727",
    "user": "https://github.com/jm58660"
}
```

Changing commit from "" to "eeefd9d2c4184a3f60f505a7851ec3ff16eb7bf0"
...
```json
{
    "body": "Changing branch from \"\" to \"u/jmantysalo/maximal_chains\"",
    "created_at": "2015-07-23T09:49:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335728",
    "user": "https://github.com/jm58660"
}
```

Changing branch from "" to "u/jmantysalo/maximal_chains"
...
```json
{
    "body": "<a id='comment:2'></a>Nathann, some questions: 1) Can you confirm that this is right way to get maximal chains of a poset? 2) What you think about this kind of \"deprecation\", where I removed broken functionality with warning?\n\nAnd for most important part, 3) what about `chain_polytope`? This brokes doctest. Who knows if it has been broken all the time? Should I just let it be, and move (broken) old version on `maximal_chains` inside `chain_polytope`?\n\n(This is kind of child-ticket of #18941.)",
    "created_at": "2015-07-23T09:55:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335729",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:2'></a>Nathann, some questions: 1) Can you confirm that this is right way to get maximal chains of a poset? 2) What you think about this kind of "deprecation", where I removed broken functionality with warning?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335730",
...
```json
{
    "body": "<a id='comment:4'></a>As for question 3, just run `sage -t` to `posets.py`.\n\nAbout 1: How it does that on iterator? But yes, with `BooleanLattice(8)` it seems to be about 3 times slower to use the function from digraphs.",
    "created_at": "2015-07-23T11:13:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335731",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:4'></a>As for question 3, just run `sage -t` to `posets.py`.
...
```json
{
    "body": "<a id='comment:6'></a>But in any case, if we just add a check for input to be comparable elements, then `chain_polytope` will broke. It relies on this (odd / buggy?) behavior.\n\nAnd who will want \"partial maximal chains\" in first place? To compare: there is `exclude`-option in `chains()`.",
    "created_at": "2015-08-08T20:02:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335733",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:6'></a>But in any case, if we just add a check for input to be comparable elements, then `chain_polytope` will broke. It relies on this (odd / buggy?) behavior.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335734",
...
```json
{
    "body": "Changing commit from \"eeefd9d2c4184a3f60f505a7851ec3ff16eb7bf0\" to \"e6a4ae2b1f7f887b58a49af5c1607640c7821dde\"",
    "created_at": "2015-09-15T06:43:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335735",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "eeefd9d2c4184a3f60f505a7851ec3ff16eb7bf0" to "e6a4ae2b1f7f887b58a49af5c1607640c7821dde"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335736",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Also `chain_polytope()` (not only `order_complex()`) relies on this (IMO) broken `maximal_chains()` -function. Hence I made an internal copy of it with name `_max_chains()`. At least all doctests pass now. For a user perspective everything should be as before, except that `partial`-option is gone.",
    "created_at": "2015-09-15T06:46:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335737",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:8'></a>Also `chain_polytope()` (not only `order_complex()`) relies on this (IMO) broken `maximal_chains()` -function. Hence I made an internal copy of it with name `_max_chains()`. At least all doctests pass now. For a user perspective everything should be as before, except that `partial`-option is gone.
...
```json
{
    "body": "<a id='comment:9'></a>I agree with Kevin, bad input is bad input and you should not expect correct behavior. So there is no counterexample to the function working as documented, but we should raise an error when not given a saturated chain.",
    "created_at": "2015-09-16T15:10:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335738",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:9'></a>I agree with Kevin, bad input is bad input and you should not expect correct behavior. So there is no counterexample to the function working as documented, but we should raise an error when not given a saturated chain.
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18944#event-52844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335739",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335740",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335741",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335743",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>If it's easy and fast enough, then let's do it.\n\nI don't think we should remove `partial` as that just pushes useful (evident it is used in other parts of sage) functionality to a hidden place.",
    "created_at": "2015-09-16T17:51:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335744",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:13'></a>If it's easy and fast enough, then let's do it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335745",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I am still wondering about this... Other parts of Sage relies on broken or non-defined behaviour of `partial` argument. It feels bad design.",
    "created_at": "2016-07-18T10:47:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335746",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:15'></a>I am still wondering about this... Other parts of Sage relies on broken or non-defined behaviour of `partial` argument. It feels bad design.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335747",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335748",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>My guess is like you said, that it that every maximal chain must contain elements (i.e., this partial maximal chain).",
    "created_at": "2016-07-19T20:33:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335749",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:18'></a>My guess is like you said, that it that every maximal chain must contain elements (i.e., this partial maximal chain).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335750",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>So the documentation indicates that this method should find all maximal chains that beings with `partial`. Hence, a priori, we don't actually require the result when given `partial` to be a maximal chain of the poset (or at least, whether that is a requirement is vague). We might just have to actually update the documentation and maybe deal with the cases when the partial is not some interval.",
    "created_at": "2016-07-20T15:51:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335751",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:20'></a>So the documentation indicates that this method should find all maximal chains that beings with `partial`. Hence, a priori, we don't actually require the result when given `partial` to be a maximal chain of the poset (or at least, whether that is a requirement is vague). We might just have to actually update the documentation and maybe deal with the cases when the partial is not some interval.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335752",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Let us just fix the documentation.\n\n---\nNew commits:",
    "created_at": "2021-10-11T14:36:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335753",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:22'></a>Let us just fix the documentation.
...
```json
{
    "body": "Changing commit from \"e6a4ae2b1f7f887b58a49af5c1607640c7821dde\" to \"95921411b2f06f9ff6477f4f3d5e77621cc8ac52\"",
    "created_at": "2021-10-11T14:36:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335754",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "e6a4ae2b1f7f887b58a49af5c1607640c7821dde" to "95921411b2f06f9ff6477f4f3d5e77621cc8ac52"
...
```json
{
    "body": "Changing branch from \"u/jmantysalo/maximal_chains\" to \"u/chapoton/18944\"",
    "created_at": "2021-10-11T14:36:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335755",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "u/jmantysalo/maximal_chains" to "u/chapoton/18944"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335756",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335757",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18944#event-52845"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18944#event-52846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335758",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335759",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335760",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing branch from \"u/chapoton/18944\" to \"95921411b2f06f9ff6477f4f3d5e77621cc8ac52\"",
    "created_at": "2021-10-13T22:50:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335761",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/chapoton/18944" to "95921411b2f06f9ff6477f4f3d5e77621cc8ac52"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18944#event-52847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18944#issuecomment-335762",
    "user": "https://github.com/vbraun"
}
```
