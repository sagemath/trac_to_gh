...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18955#issuecomment-268862",
    "user": "https://github.com/sagetrac-buck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18955#issuecomment-268863",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18955#event-251373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18955#event-251374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18955#event-251375"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18955",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18955#event-251376"
}
```
