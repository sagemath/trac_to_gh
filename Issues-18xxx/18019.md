...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18019#event-238637"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18019#event-238638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18019#event-238639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18019#issuecomment-247692",
    "user": "https://github.com/sagetrac-akhi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18019#issuecomment-247693",
    "user": "https://github.com/sagetrac-akhi"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18019#event-238640"
}
```
