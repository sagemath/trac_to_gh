...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310522",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310523",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310524",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310525",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310526",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>When you write `b = n/res`, note that `n` is a Python int and res an element of `RIF`, so Sage has to resolve the coercion to find a common parent, which takes time. Instead, you can transform `n` to an element of `RIF` by writing instead : `b = RIF(n)/res`. The timings should decrease (Debian seems not to distribute MPFI for Perl, so i couldn't do the comparison).",
    "created_at": "2016-08-22T21:13:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310528",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:5'></a>When you write `b = n/res`, note that `n` is a Python int and res an element of `RIF`, so Sage has to resolve the coercion to find a common parent, which takes time. Instead, you can transform `n` to an element of `RIF` by writing instead : `b = RIF(n)/res`. The timings should decrease (Debian seems not to distribute MPFI for Perl, so i couldn't do the comparison).
...
```json
{
    "body": "<a id='comment:6'></a>I have made the modifications that you suggested but still Perl works much faster\\\\\nsage: load(\"test3.sage\")\n\\\\3.14159265358979323846264338328? is the mpfi number \n\\\\4.71341490746 seconds time for  1000000 divisions\n\\\\akhi`@`akhi:~$ perl test3.pl\n\\\\[3.1415926535897932384626433832793,3.1415926535897932384626433832825] is the mpfi number\n\\\\total time =  2 seconds time for  1000000 divisions",
    "created_at": "2016-08-23T08:41:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310529",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```

<a id='comment:6'></a>I have made the modifications that you suggested but still Perl works much faster\\
sage: load("test3.sage")
\\3.14159265358979323846264338328? is the mpfi number 
\\4.71341490746 seconds time for  1000000 divisions
\\akhi`@`akhi:~$ perl test3.pl
...
```json
{
    "body": "<a id='comment:7'></a>perl mpfi library is there at cpan http://search.cpan.org/~sisyphus/Math-MPFI-0.05/MPFI.pm",
    "created_at": "2016-08-23T08:46:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18019#issuecomment-310530",
    "user": "https://trac.sagemath.org/admin/accounts/users/akhi"
}
```

<a id='comment:7'></a>perl mpfi library is there at cpan http://search.cpan.org/~sisyphus/Math-MPFI-0.05/MPFI.pm
