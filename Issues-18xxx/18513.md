...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[e8caa27](http://git.sagemath.org/sage.git/commit/?id=e8caa274577da75eadd532065cac08bd71eac316)|`trac #18513: Make <package>/type file mandatory`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[066e88e](http://git.sagemath.org/sage.git/commit/?id=066e88edb1a2278184f583406bb92aa2981d60f1)|`trac #18513: Make <package>/type file mandatory`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[79a41b9](http://git.sagemath.org/sage.git/commit/?id=79a41b9cd4a69815eceafb8f14f190bb06e0fdd6)|`trac #18513: Make <package>/type file mandatory`|",
    "created_at": "2015-05-26T09:49:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18513",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[e9054a6](http://git.sagemath.org/sage.git/commit/?id=e9054a633a2cad1adf61f409cc6023d3552f9aaa)|`trac #18513: all -> none, and no output redirection`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[a77b222](http://git.sagemath.org/sage.git/commit/?id=a77b2226906dec5b8201155bd465bdf09b8021f8)|`trac #18513: simpler validity check`|",
    "created_at": "2015-05-26T13:07:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18513",
    "type": "issue_comment",
