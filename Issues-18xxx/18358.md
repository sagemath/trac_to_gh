...
```json
{
    "body": "<a id='comment:9'></a>\nHere is an experimental branch with a macro `pyobject_to_long` in `sage.misc.long`. I do not like the gestion of error but I do not know how to do better without affecting performance. Please tell me.\n\nIt is used in `Integer.__pow__` and `Rational.__pow__` as a proof of concept. And we win 20 precious nano seconds when the exponent is a small Sage Integer (~10%):\n\n```\nsage: timeit(\"2**5\", number=400000, repeat=20)\n400000 loops, best of 20: 248 ns per loop\nsage: timeit(\"(2/3)**2\", number=100000, repeat=20)\n100000 loops, best of 20: 1.1 \u00b5s per loop\n```\nagainst\n\n```\nsage: timeit(\"2**5\", number=400000, repeat=20)\n400000 loops, best of 20: 228 ns per loop\nsage: timeit(\"(2/3)**2\", number=100000, repeat=20)\n200000 loops, best of 30: 990 ns per loop\n```\n\nVincent\n\n---\nNew commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[524393b](http://git.sagemath.org/sage.git/commit/?id=524393b4aa89d93d8cc6831480e07c7350c06535)|`Trac 18290: upgrade sets and cartesian products`|\n|[6e1e22d](http://git.sagemath.org/sage.git/commit/?id=6e1e22d1ae7c494773df4b161690d707762558c7)|`Trac 18290: better doc + remove duplications`|\n|[671e6ec](http://git.sagemath.org/sage.git/commit/?id=671e6ecff8079a28f9b43fda96da29530ba454a8)|`Trac 18290: fix doctest in combinat/tutorial`|\n|[0378c4a](http://git.sagemath.org/sage.git/commit/?id=0378c4a5319972501b1d982c3670085f139c1dd4)|`Trac 18290: fix doctest in categories/enumerated_sets.py`|\n|[925b2e0](http://git.sagemath.org/sage.git/commit/?id=925b2e062bb86212916b73c831f9333f312db4b5)|`Trac 18290: fix doctests`|\n|[8e91484](http://git.sagemath.org/sage.git/commit/?id=8e9148450538c683d50c89d90acf7457feb0cc03)|`Trac 18358: macro to cast Python object to C long`|",
    "created_at": "2015-05-05T13:45:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18358",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[b6df2ee](http://git.sagemath.org/sage.git/commit/?id=b6df2eeff959f3f0ffb3d47dfe1c84a04a25ac11)|`Trac 18358: macro pyobject -> long conversion`|\n|[1e7db2e](http://git.sagemath.org/sage.git/commit/?id=1e7db2e21982c4d5097e0452bb19c5329ad1c40e)|`Trac 18358: use macro in pow for Integer/Rational`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[f67ead5](http://git.sagemath.org/sage.git/commit/?id=f67ead58cc51250037409d64205f209b2286d960)|`Trac 18358: macro pyobject -> long conversion`|\n|[98008da](http://git.sagemath.org/sage.git/commit/?id=98008da68599a8f53269811b363f5bb2bef86d27)|`Trac 18358: use macro in pow for Integer/Rational`|\n|[c7b741f](http://git.sagemath.org/sage.git/commit/?id=c7b741fc34a79e594c327ed72476a7972481fc33)|`Trac 18358: better pyobject_to_long`|\n|[e7ad72f](http://git.sagemath.org/sage.git/commit/?id=e7ad72f5a0a5e44d4d6aad5208e597201edf2be8)|`Trac 18358: use pyobject_to_long where possible`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[90453ff](http://git.sagemath.org/sage.git/commit/?id=90453ff943b693383a38c358aeb4a81a9c5da25e)|`Trac 18358: review commit`|",
    "created_at": "2015-05-11T17:21:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18358",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[6b46fee](http://git.sagemath.org/sage.git/commit/?id=6b46fee72115db82a7eedb02482b83af694247ba)|`Trac #18358: typo + remove redundant doctest`|",
    "created_at": "2015-05-13T16:15:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18358",
    "type": "issue_comment",
