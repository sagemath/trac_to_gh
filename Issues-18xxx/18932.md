...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18932#event-250986"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18932#event-250987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18932#event-250988"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18932#event-250989"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18932#issuecomment-268170",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18932#issuecomment-268171",
    "user": "https://github.com/nathanncohen"
}
```
