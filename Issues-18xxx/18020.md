...
```json
{
    "body": "<a id='comment:1'></a>This is because in dense representation, one cannot have such high-degree polynomials. This works in sparse representation though:\n\n```\nsage: R.<x> = PolynomialRing(ZZ, sparse=True)\nsage: x^(3^20)\nx^3486784401\n```\n\nSo this does not have to be fixed.",
    "created_at": "2015-04-22T08:32:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18020#issuecomment-310531",
    "user": "https://github.com/bgrenet"
}
```

<a id='comment:1'></a>This is because in dense representation, one cannot have such high-degree polynomials. This works in sparse representation though:
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18020#event-51184"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18020#issuecomment-310532",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18020#issuecomment-310533",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18020#issuecomment-310534",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18020#issuecomment-310535",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18020#event-51185"
}
```
