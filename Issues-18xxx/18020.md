...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238641"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238642"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238643"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238644"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18020#issuecomment-247702",
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18020#issuecomment-247703",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18020#event-238652"
}
```
