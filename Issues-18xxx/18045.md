...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[38c4e50](http://git.sagemath.org/sage.git/commit/?id=38c4e50b38574c6b4be2bb9dbf3cd98b1d4f6eaf)|`trac #18045: Wrong result returned by is_planar on a given embedding`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[9ee0d6e](http://git.sagemath.org/sage.git/commit/?id=9ee0d6e19ed03501a03333dfa4815f947735c0bc)|`trac #18045: Wrong result returned by is_planar on a given embedding`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[69640d6](http://git.sagemath.org/sage.git/commit/?id=69640d6f3970a97e53bcacfde4c94a457866b39f)|`trac #18045: Merged with 6.7.beta2`|\n|[110c8fa](http://git.sagemath.org/sage.git/commit/?id=110c8fa7f74010a01187f1413e2e693868cf1a66)|`trac #18045: Review`|",
    "created_at": "2015-04-26T17:45:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18045",
    "type": "issue_comment",
