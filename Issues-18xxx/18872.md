...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18872#event-250194"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18872#event-250195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18872#event-250196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18872#event-250197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18872#issuecomment-266874",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18872#issuecomment-266875",
    "user": "https://github.com/vbraun"
}
```
