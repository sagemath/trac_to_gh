...
```json
{
    "body": "<a id='comment:1'></a>maybe implemented here as `GaloisCyc`:\n\n```\nhttps://github.com/gap-system/gap/blob/master/src/cyclotom.c\n```",
    "created_at": "2021-11-23T17:16:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18207#issuecomment-256880",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>maybe implemented here as `GaloisCyc`:
