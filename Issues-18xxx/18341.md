...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18341#event-243008"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18341#event-243009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18341#event-243010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18341#event-243011"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18341",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18341#issuecomment-254730",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18341",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18341#issuecomment-254731",
    "user": "https://github.com/jdemeyer"
}
```
