...
```json
{
    "body": "<a id='comment:1'></a>Actually, the following works:\n\n```\niota = OK.hom(kappa)\niota(K.gen(0))\niota(OK.gen(0))\n```\n\nBut you can't define the morphism explicitly.",
    "created_at": "2022-02-01T20:17:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18865#issuecomment-333446",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:1'></a>Actually, the following works:
