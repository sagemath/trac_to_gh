...
```json
{
    "body": "<a id='comment:13'></a>\nThe problem here was for SageNB, which is EOL, and [SageMathCell](../wikis/SageMathCell), where we use CDN MathJax now. So I think this problem was not solved, but it is no longer relevant.",
