...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18000#event-238368"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18000#event-238369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18000#event-238370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18000#event-238371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18000",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18000#issuecomment-247219",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18000",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18000#issuecomment-247220",
    "user": "https://github.com/sagetrac-git"
}
```
