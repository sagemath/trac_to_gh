...
<a id='comment:14'></a>Replying to [wluebbe](#comment%3A13):
> What about going with Python 2.7.10 soon? It is available since 6 days. 
...
```json
{
    "body": "<a id='comment:16'></a>... and tests passed. Together with[comment:15](#comment%3A15) I guess it's a positive review.\n\nBut I had chosen the name of the class method different from the Python standard function `all()`  ;-)",
...
<a id='comment:16'></a>... and tests passed. Together with[comment:15](#comment%3A15) I guess it's a positive review.
