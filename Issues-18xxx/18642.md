...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238273"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18642#issuecomment-262087",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238279"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18642#issuecomment-262088",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18642",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18642#event-238281"
}
```
