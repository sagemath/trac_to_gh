...
```json
{
    ...
    "type": "issue",
    "updated_at": "2021-07-25T13:38:11Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18786#event-229699"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18786#event-229700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18786#event-229701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18786",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18786#issuecomment-264917",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18786",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18786#issuecomment-264918",
    "user": "https://github.com/mjungmath"
}
```
