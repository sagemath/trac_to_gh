...
```json
{
    "body": "<a id='comment:1'></a>Is this a new header that need installing?",
    "created_at": "2015-06-30T09:17:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332212",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>Is this a new header that need installing?
...
```json
{
    "body": "<a id='comment:4'></a>That's a little bit over my head because I am unfamiliar with the code but the idea sounds OK.",
    "created_at": "2015-06-30T09:29:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332215",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>That's a little bit over my head because I am unfamiliar with the code but the idea sounds OK.
...
```json
{
    "body": "<a id='comment:5'></a>Oh wait that's not building, that's from sage itself. There is definitely room for improvement in that code.",
    "created_at": "2015-06-30T09:31:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332216",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>Oh wait that's not building, that's from sage itself. There is definitely room for improvement in that code.
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/cython___command_does_not_find_ginac_wrap_h\"",
    "created_at": "2015-06-30T09:45:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332217",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/cython___command_does_not_find_ginac_wrap_h"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332218",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"5b986e49b67eece747d451a94dfe4bafbdd5399a\"",
    "created_at": "2015-06-30T09:45:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332219",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "5b986e49b67eece747d451a94dfe4bafbdd5399a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332220",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I think this fixes all instances of include files outside of `sage/ext` which were included in `.pxd` files without a full path.",
    "created_at": "2015-06-30T09:48:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332221",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>I think this fixes all instances of include files outside of `sage/ext` which were included in `.pxd` files without a full path.
...
```json
{
    "body": "<a id='comment:9'></a>I think you got everything.",
    "created_at": "2015-06-30T09:59:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332222",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:9'></a>I think you got everything.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332223",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Somehow I missed the `need_review` bit.",
    "created_at": "2015-07-02T09:25:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332224",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:10'></a>Somehow I missed the `need_review` bit.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332225",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Replying to [jdemeyer](#comment%3A3):\n> Maybe we should use distutils to implement `cython()`?\n\n\nActually, we do use `distutils`. I think the problem is really the \"preparsing\" that Sage does with the input of `cython()`.",
    "created_at": "2015-07-02T11:07:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332226",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Replying to [jdemeyer](#comment%3A3):
> Maybe we should use distutils to implement `cython()`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332227",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Well that's lucky it is being removed.",
    "created_at": "2015-07-02T11:17:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332228",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:13'></a>Well that's lucky it is being removed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332229",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18825#event-52633"
}
```
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/cython___command_does_not_find_ginac_wrap_h\" to \"5b986e49b67eece747d451a94dfe4bafbdd5399a\"",
    "created_at": "2015-07-02T22:32:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18825#issuecomment-332230",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/cython___command_does_not_find_ginac_wrap_h" to "5b986e49b67eece747d451a94dfe4bafbdd5399a"
