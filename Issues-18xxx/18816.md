...
```json
{
    "body": "<a id='comment:1'></a>Hi Arvind, I highly suspect your problem is related to [this sage-devel discussion](https://groups.google.com/forum/#!topic/sage-devel/_jY4yj9NcZc).  Is this a binary, as I assume it is?  It's interesting that you were able to update 6.2 to 6.4 on it!\n\nVolker or Jeroen, I'm wondering whether there is anything else we can do (in your experience with releasing) to avoid this kind of thing, or whether it's just not possible.  These things always seem to come up but apparently we haven't gotten the \"don't develop with binaries\" out enough - and apparently some people do experience success there.",
    "created_at": "2015-06-29T19:39:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332034",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Hi Arvind, I highly suspect your problem is related to [this sage-devel discussion](https://groups.google.com/forum/#!topic/sage-devel/_jY4yj9NcZc).  Is this a binary, as I assume it is?  It's interesting that you were able to update 6.2 to 6.4 on it!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332037",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>So much stuff already said. I seem to have been added from the start. As Jeroen said not long ago running `./sage --python local/bin/sage-location` should help greatly. In fact it should be run when you install a binary distribution no matter which platform, it should be part of the instructions. \n\nThe problem here is almost certainly that you get the include directory from `freetype2.pc` which was created on the build platform. The `sage-location` script should fix all the `.pc` files to make them refer to your new `SAGE_ROOT` directory rather than the one the binary was built on.",
    "created_at": "2015-06-29T21:38:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332038",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>So much stuff already said. I seem to have been added from the start. As Jeroen said not long ago running `./sage --python local/bin/sage-location` should help greatly. In fact it should be run when you install a binary distribution no matter which platform, it should be part of the instructions. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332039",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332042",
    "user": "https://github.com/ayyer"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>`git fetch` accesses an alredy-configured remote, so you had a whole git tree already at that point. Starting from scratch would be `git clone` as described at http://doc.sagemath.org/html/en/developer/walk_through.html#obtaining-the-sage-source-code",
    "created_at": "2015-06-30T16:31:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332043",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>`git fetch` accesses an alredy-configured remote, so you had a whole git tree already at that point. Starting from scratch would be `git clone` as described at http://doc.sagemath.org/html/en/developer/walk_through.html#obtaining-the-sage-source-code
...
```json
{
    "body": "<a id='comment:11'></a>PS: You can use `git clean -f -d -x` to get a pristine tree (akin to `make distclean`), but you really need the `-x`",
    "created_at": "2015-06-30T16:33:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332044",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>PS: You can use `git clean -f -d -x` to get a pristine tree (akin to `make distclean`), but you really need the `-x`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332047",
    "user": "https://github.com/ayyer"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Jeroen Demeyer, Arvind Ayyer, Karl-Dieter Crisman\"",
    "created_at": "2015-07-02T14:55:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332050",
    "user": "https://github.com/kcrisman"
}
```

Changing reviewer from "" to "Jeroen Demeyer, Arvind Ayyer, Karl-Dieter Crisman"
...
```json
{
    "body": "<a id='comment:17'></a>We can do that.  Moral of the story is for us to have people avoid developing with binaries...",
    "created_at": "2015-07-02T14:55:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332051",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:17'></a>We can do that.  Moral of the story is for us to have people avoid developing with binaries...
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18816#event-52610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332052",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332053",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332054",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I think there really is a bug here...",
    "created_at": "2015-07-02T15:57:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332055",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>I think there really is a bug here...
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18816#event-52611"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18816#event-52612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332056",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Okay, but we need a new title then.  Modify if this isn't accurate.",
    "created_at": "2015-07-02T17:16:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332057",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>Okay, but we need a new title then.  Modify if this isn't accurate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332059",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Relocation is no longer support anyway.",
    "created_at": "2016-04-07T17:42:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332060",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>Relocation is no longer support anyway.
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18816#event-52613"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18816#event-52614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18816#issuecomment-332061",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18816",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18816#event-52615"
}
```
