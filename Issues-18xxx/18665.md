...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247482"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18665#issuecomment-262507",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18665#issuecomment-262508",
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247486"
}
```
