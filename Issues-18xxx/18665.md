...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247489"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18665#issuecomment-262505",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18665#issuecomment-262506",
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18665#event-247490"
}
```
