...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/31572",
...
```json
{
    "body": "<a id='comment:1'></a>This is required by giac, see #30537",
    "created_at": "2021-03-28T16:05:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627820",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:1'></a>This is required by giac, see #30537
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627821",
...
```json
{
    "body": "<a id='comment:5'></a>Replying to [tornaria](#comment%3A3):\n> I think #30537#comment:45 shows an example failure (doctesting `src/sage/rings/polynomial/multi_polynomial_ideal.py`).\n\n\nThat's right.",
    "created_at": "2021-03-29T03:45:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627823",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Replying to [tornaria](#comment%3A3):
> I think #30537#comment:45 shows an example failure (doctesting `src/sage/rings/polynomial/multi_polynomial_ideal.py`).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627824",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>For the record, debian and therefore ubuntu have shipped `pari` with threads for a while now. But their pari is also statically linked. Do we have speed regression examples with the library as well as the executable?",
    "created_at": "2021-03-29T03:51:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627825",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>For the record, debian and therefore ubuntu have shipped `pari` with threads for a while now. But their pari is also statically linked. Do we have speed regression examples with the library as well as the executable?
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83007"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Perhaps giac can use single-threaded Pari, as well? It can test whether Pari is single- or multi-threaded, and use different code paths for these two scenarios.",
    "created_at": "2021-05-28T14:41:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627826",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:10'></a>Perhaps giac can use single-threaded Pari, as well? It can test whether Pari is single- or multi-threaded, and use different code paths for these two scenarios.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83008"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83009"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83010"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83011"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>FTR, upstream pari recommends compiling gp with -lto to make up for the performance loss caused by multithreading. We've been doing that in the Arch package for a while.",
    "created_at": "2021-12-21T19:29:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627828",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:15'></a>FTR, upstream pari recommends compiling gp with -lto to make up for the performance loss caused by multithreading. We've been doing that in the Arch package for a while.
...
```json
{
    "body": "<a id='comment:16'></a>Just a quick note, since I reported this I've given up and switched to pari with pthreads, since it seems just too difficult otherwise.\n\nThe mitigations I'm using are:\n- `-flto -fno-semantic-interposition`\n- link gp with static libpari\n\nSee: https://github.com/void-linux/void-packages/pull/32453",
    "created_at": "2021-12-21T19:32:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-627829",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:16'></a>Just a quick note, since I reported this I've given up and switched to pari with pthreads, since it seems just too difficult otherwise.
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83012"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83013"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83014"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-83015"
}
```
