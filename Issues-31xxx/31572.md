...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600037",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600038",
...
```json
{
    "body": "<a id='comment:5'></a>\nReplying to [tornaria](#comment%3A3):\n> I think ticket:30537#comment:45 shows an example failure (doctesting `src/sage/rings/polynomial/multi_polynomial_ideal.py`).\n\n\nThat's right.",
    "created_at": "2021-03-29T03:45:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600040",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600041",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93151"
}
```
...
archive/issue_comments_600042.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600042",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93152"
}
```
...
archive/issue_comments_600043.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600043",
...
archive/issue_comments_600044.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600044",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93153"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93154"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93155"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93156"
}
```
...
archive/issue_comments_600045.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600045",
    "user": "https://github.com/antonio-rojas"
}
```
...
archive/issue_comments_600046.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31572#issuecomment-600046",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93157"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93158"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93159"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31572#event-93160"
}
```
