...
```json
{
    "body": "We should just split off the real part to `AA`. Simple fix.\n\n---\nNew commits:",
    "created_at": "2021-05-11T00:59:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
...
```json
{
    "body": "I redid it to use `parts`, which is guaranteed to have a pair of rational numbers as output.",
