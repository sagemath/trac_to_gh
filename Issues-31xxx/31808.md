...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450588",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>We should just split off the real part to `AA`. Simple fix.\n\n---\nNew commits:",
    "created_at": "2021-05-11T00:59:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450589",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>We should just split off the real part to `AA`. Simple fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450590",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450591",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450592",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I redid it to use `parts`, which is guaranteed to have a pair of rational numbers as output.",
    "created_at": "2021-05-11T01:23:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450593",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>I redid it to use `parts`, which is guaranteed to have a pair of rational numbers as output.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450594",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450595",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31808#issuecomment-450596",
