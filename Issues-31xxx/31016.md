...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615503",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615504",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615505",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615506",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615507",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615508",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615509",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615510",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Should I add my language selection options for building the documentation?",
    "created_at": "2020-12-09T09:50:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615511",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>Should I add my language selection options for building the documentation?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615514",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>After double checking we already fixed the installation of text files. It looks like you may have been looking at an old ebuild. If not, that's something that should be updated to be current on my side.",
    "created_at": "2020-12-10T21:51:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615515",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:12'></a>After double checking we already fixed the installation of text files. It looks like you may have been looking at an old ebuild. If not, that's something that should be updated to be current on my side.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615516",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615517",
...
```json
{
    "body": "<a id='comment:14'></a>Indeed I don't have them installed! It looks like they are python files so they having an `__init__.py` file in the affected directories should fix the issue I think.",
    "created_at": "2020-12-10T22:16:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615518",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:14'></a>Indeed I don't have them installed! It looks like they are python files so they having an `__init__.py` file in the affected directories should fix the issue I think.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615519",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I should add that using `__init__.py` is my favored solution because it also means that `pycache` will be autogenerated when installing. If I ship non precompiled python files, Gentoo automated QA will be on my back to do it manually.",
    "created_at": "2020-12-10T23:54:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615521",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:17'></a>I should add that using `__init__.py` is my favored solution because it also means that `pycache` will be autogenerated when installing. If I ship non precompiled python files, Gentoo automated QA will be on my back to do it manually.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615522",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615523",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615524",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Sage development has entered the release candidate phase for 9.3. Setting a new milestone for this ticket based on a cursory review.",
    "created_at": "2021-04-07T19:29:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615525",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:21'></a>Sage development has entered the release candidate phase for 9.3. Setting a new milestone for this ticket based on a cursory review.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-80995"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-80996"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-80997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615526",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>bump to 9.6",
    "created_at": "2022-01-29T08:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615527",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:25'></a>bump to 9.6
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-80998"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-80999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615529",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615530",
    "user": "https://github.com/tobihan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615532",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Replying to [tornaria](#comment%3A26):\n>   - Running setup.py needs `PYTHONPATH=../sage-setup`, I took that from arch. Should this (and the previous bootstrap step) be documented in `README.rst`?\n\n\nNo, `sage-setup` is declared as a `build-system requires` in pkgs/sagemath-standard/pyproject.toml.m4",
    "created_at": "2022-02-05T17:04:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615533",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:30'></a>Replying to [tornaria](#comment%3A26):
>   - Running setup.py needs `PYTHONPATH=../sage-setup`, I took that from arch. Should this (and the previous bootstrap step) be documented in `README.rst`?
...
```json
{
    "body": "<a id='comment:31'></a>Replying to [tornaria](#comment%3A26):\n>   - The jupyter kernel install is bad\n\n\nSee #30306",
    "created_at": "2022-02-05T17:06:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31016#issuecomment-615534",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:31'></a>Replying to [tornaria](#comment%3A26):
>   - The jupyter kernel install is bad
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-81000"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-81001"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-81002"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31016#event-81003"
}
```
