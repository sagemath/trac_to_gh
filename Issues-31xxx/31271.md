...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits added to merge request.  I updated the commit SHA-1.  New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[07fb9bf](https://git.sagemath.org/sage.git/commit?id=07fb9bf6545961176e09561188534dce82e8882c)|`build docker image without CPU specific flags`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nNew commits added to merge request.  I updated the commit SHA-1.  New commits:\n|                                                                                                                                          |                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[0a96413](https://git.sagemath.org/sage.git/commit?id=0a96413fee4736d6a02ef04110f55e284d50e72b)|`Revert \"build docker image without CPU specific flags\"`|",
