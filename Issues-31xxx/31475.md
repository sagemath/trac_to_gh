...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -24,6 +24,18 @@\n ----------------------------------------------------------------------\n \\`\\`\\`\n \n+The previous command in the exemple block are:\n+\n+\\`\\`\\`\n+        sage: (out, err, ret) = test_executable([\"sage\", \"--optional\"])  # optional - internet\n+        sage: out.find(\"database_cremona_ellcurve\") >= 0  # optional - internet\n+        True\n+        sage: err  # optional - internet\n+        ''\n+        sage: ret  # optional - internet\n+        0\n+\\`\\`\\`\n+\n Comment: 1\n \n Summary: 1 internet doctest failing in src/sage/tests/cmdline.py\n```\n",
    "created_at": "2021-03-09T16:25:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476564",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476565",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476566",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Salut Samuel, \u00e7a ressemble \u00e0 du code qu'on avait chang\u00e9 dans un autre ticket. \u00c7a te dit quelque chose?",
    "created_at": "2021-03-09T16:30:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476567",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>Salut Samuel, ça ressemble à du code qu'on avait changé dans un autre ticket. Ça te dit quelque chose?
...
```json
{
    "body": "<a id='comment:5'></a>This can be fixed by convincing the author of the `ore_algebra` package to make a proper release on PyPI and then updating `build/pkgs/ore_algebra/requirements.txt`",
    "created_at": "2021-03-09T17:55:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476568",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>This can be fixed by convincing the author of the `ore_algebra` package to make a proper release on PyPI and then updating `build/pkgs/ore_algebra/requirements.txt`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476569",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31475#issuecomment-476570",
    "user": "https://github.com/mkoeppe"
}
```
