...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31149#event-377715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31149#event-377716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31149#event-377717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31149#issuecomment-501967",
    "user": "https://github.com/guenterrote"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31149#issuecomment-501968",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31149#issuecomment-501969",
    "user": "https://github.com/guenterrote"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31149#issuecomment-501970",
    "user": "https://github.com/slel"
}
```
