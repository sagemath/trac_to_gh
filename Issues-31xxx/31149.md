# Issue 31149: Move list of scripts and package_data from setup.py to setup.cfg
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31149#event-82226"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31149#event-82227"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31149#event-82228"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31149",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31149#event-82229"
}
```
