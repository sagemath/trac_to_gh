...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[b4bfca6](https://git.sagemath.org/sage.git/commit/?id=b4bfca6c607572ec057185b8e29137b99aba5ad4)|`only allow subface check for faces of identical combinatorial polyhedron`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[343b340](https://git.sagemath.org/sage.git/commit/?id=343b340da6be1de52b53d1473b387a8a37050f40)|`fix a variable name and add a doctest`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[17720f3](https://git.sagemath.org/sage.git/commit/?id=17720f3c5240919ec231fc2f7402aefb13b89694)|`delete duplication in doctest`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[8ed706f](https://git.sagemath.org/sage.git/commit/?id=8ed706f7cbdb539ced4ec3a780d28da8f799273b)|`assume type to safe some time`|\n|[c0c8295](https://git.sagemath.org/sage.git/commit/?id=c0c8295950d26fd59fe3a0311a9f7df7a873e05a)|`optimized code`|",
    "created_at": "2021-05-23T19:12:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31822",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[5de63be](https://git.sagemath.org/sage.git/commit/?id=5de63bee53fdefbdb1a99ed978c72db2b611410d)|`cache atom_rep and coatom_rep of combinatorial face`|",
