...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31940#issuecomment-516925",
    "user": "https://github.com/BarinderBanwait"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31940#issuecomment-516926",
    "user": "https://github.com/BarinderBanwait"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31940#event-422189"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31940#event-422190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31940#event-422191"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31940",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31940#event-422192"
}
```
