...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31610#issuecomment-628833",
    "user": "https://github.com/hadipourh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31610#issuecomment-628834",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31610#issuecomment-628835",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Hosein Hadipour\"",
    "created_at": "2021-04-06T09:54:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31610#issuecomment-628837",
    "user": "https://github.com/hadipourh"
}
```

Changing author from "" to "Hosein Hadipour"
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83185"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31610#issuecomment-628838",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83186"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83187"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83188"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83189"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83190"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83191"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83192"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31610#event-83193"
}
```
