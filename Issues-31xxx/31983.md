...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441059"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514881",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514882",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514883",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514884",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514885",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514886",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514887",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514888",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514889",
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441063"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441064"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441065"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441066"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441067"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514890",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514891",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<div id=\"comment:13\" align=\"right\">comment:13</div>\n\n> Having the developer menu on is surely very uncommon, so it's likely that most use notebooks or have a different default browser (no issue with Chrome or Firefox).\n\nThanks.\n\n> Just to update the ticket, this continues to be a problem with Safari 15.5 on Big Sur (11.6.7).\n\nSorry, I had meant to imply exactly that with my [comment:11](#comment:11),  but forgot that people can't read my mind.",
    "created_at": "2022-07-27T14:59:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/31983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31983#issuecomment-514892",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441069"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31983#event-441070"
}
```
