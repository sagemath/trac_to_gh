...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420482"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514563",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514564",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420486"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420489"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420490"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31811#event-420493"
}
```
