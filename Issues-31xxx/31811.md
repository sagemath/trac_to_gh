...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [singular-4.2.0p1+2021-04-06+sage.log](https://github.com/sagemath/sage/files/ticket31811/8a102d946fe85b434bd001a31a1c3a17.log) by @mkoeppe created at 2021-05-11 17:19:40\n\nWe also need the top-level `config.log`",
    "created_at": "2021-05-11T17:19:40Z",
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514284",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514285",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [config.log](https://github.com/sagemath/sage/files/ticket31811/config.log) by @zimmermann6 created at 2021-05-12 05:30:14\n\nReplying to [mkoeppe](#comment%3A1):\n> We also need the top-level `config.log`\n\n\nit is attached now.",
    "created_at": "2021-05-12T05:30:14Z",
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514286",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514287",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514288",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31811#issuecomment-514289",
    "user": "https://github.com/mkoeppe"
}
```
