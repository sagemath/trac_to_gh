...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412030"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31220#issuecomment-503182",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31220#issuecomment-503183",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31220",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31220#event-412039"
}
```
