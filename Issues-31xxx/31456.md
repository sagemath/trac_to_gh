...
```json
{
    "body": "<a id='comment:1'></a>See also: #17077.",
    "created_at": "2021-03-07T03:05:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625002",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>See also: #17077.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625003",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625004",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mkoeppe/add_package_regina__and_prerequisite_script_packages_\"",
    "created_at": "2021-03-07T19:37:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625005",
    "user": "https://github.com/mkoeppe"
}
```

Changing branch from "" to "u/mkoeppe/add_package_regina__and_prerequisite_script_packages_"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625006",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625007",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625008",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"a53aac87d3dea31ee029f6911567c51a89341357\"",
    "created_at": "2021-03-07T19:53:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625009",
    "user": "https://github.com/mkoeppe"
}
```

Changing commit from "" to "a53aac87d3dea31ee029f6911567c51a89341357"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625010",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The next release of Regina (6.1) will be somewhat easier to package since it will no longer depend on Boost; the current 6.0 requires both the Boost header files (IIRC more than is in the current \"Boost cropped\" required by Sage) and a couple binary Boost libraries.",
    "created_at": "2021-03-07T20:00:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625011",
    "user": "https://github.com/NathanDunfield"
}
```

<a id='comment:6'></a>The next release of Regina (6.1) will be somewhat easier to package since it will no longer depend on Boost; the current 6.0 requires both the Boost header files (IIRC more than is in the current "Boost cropped" required by Sage) and a couple binary Boost libraries.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625012",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82566"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Would it be more natural to make it depend on fully built Sage, so that it can be tested with spkg-check, by the 1-liner\n\n```\nimport regina.sageRegina; regina.sageRegina.runTests()\n```",
    "created_at": "2021-06-26T09:25:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625013",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:9'></a>Would it be more natural to make it depend on fully built Sage, so that it can be tested with spkg-check, by the 1-liner
...
```json
{
    "body": "<a id='comment:11'></a>On macOS `engine.cpython-39-darwin.so` is 52Mb - big, but nothing crazy.",
    "created_at": "2021-06-26T10:45:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625015",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:11'></a>On macOS `engine.cpython-39-darwin.so` is 52Mb - big, but nothing crazy.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625018",
...
```json
{
    "body": "Changing commit from \"a53aac87d3dea31ee029f6911567c51a89341357\" to \"6b5a5e387be6911f3e27f869a9dc1a3333b97638\"",
    "created_at": "2021-06-26T20:03:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625019",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a53aac87d3dea31ee029f6911567c51a89341357" to "6b5a5e387be6911f3e27f869a9dc1a3333b97638"
...
```json
{
    "body": "<a id='comment:16'></a>OK, this works, but can an optional package not be supported on 32-bit Linux (nor on FreeBSD, which is another platform Sage should work on)\n\nAnd, how about arm64?",
    "created_at": "2021-06-27T10:18:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625020",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:16'></a>OK, this works, but can an optional package not be supported on 32-bit Linux (nor on FreeBSD, which is another platform Sage should work on)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625021",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82567"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82568"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82569"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31456#issuecomment-625024",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82571"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82572"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82573"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31456#event-82574"
}
```
