...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399674"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31331#issuecomment-505346",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399676"
}
```
...
```json
{
    "body": "Changed keywords from **** to **ideal, variety, polynomial**",
    "created_at": "2021-02-05T20:10:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/31331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31331#issuecomment-505347",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **ideal, variety, polynomial**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399678"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31331#issuecomment-505348",
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399681"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399682"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399683"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399684"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399685"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399686"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399687"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31331#event-399688"
}
```
