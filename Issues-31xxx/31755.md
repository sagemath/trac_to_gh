...
```json
{
    "body": "<a id='comment:1'></a>Put your name in the \"Authors\" field if you contribute code to fix the issue.",
    "created_at": "2021-04-29T13:14:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31755#issuecomment-631592",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>Put your name in the "Authors" field if you contribute code to fix the issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31755#issuecomment-631593",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31755#issuecomment-631594",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83798"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83799"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83800"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83801"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83802"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83803"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31755#event-83804"
}
```
