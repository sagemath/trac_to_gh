...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438035"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31755#issuecomment-510870",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31755#issuecomment-510871",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31755#issuecomment-510872",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438039"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438040"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438041"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438042"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438043"
}
```
...
archive/issue_events_438044.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-04-01T21:16:35Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438044"
}
```
...
archive/issue_events_438045.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438045"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31755#event-438046"
}
```
