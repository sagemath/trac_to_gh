...
```json
{
    "body": "OK, the next step would be to find out whether the library does any arithmetic with these `double` values (in this case we would have to check whether they apply directed rounding correctly), or whether they only use comparisons on these `double` values.",
    "created_at": "2021-07-10T02:40:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455681",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85194"
}
```
...
```json
{
    "body": "As the boxes overestimate the true objects, a `count` result of 0 is useful.",
    "created_at": "2021-09-04T00:07:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455689",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "For `intersection`, can you propose a function for `rtree` that would help?",
    "created_at": "2021-09-04T17:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455690",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455691",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455692",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455696",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "Since I also want to take a test to check whether it performs correctly and since it has been changed under the `src` folder, for which I thought we can use it explicitly without importing any more. However, `sage` IDE shows that `name 'Rtree_based_RealSet' is not defined`.",
    "created_at": "2021-09-08T16:58:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455698",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "Also, I always have a question on how to pushing the latest changes correctly for the sagemath. Assuming there are no previous branches was uploaded for a ticket, If I want to upload a new initial branch for it, either should I merge to the latest version, for example, currently it is sage-9.5, before uploading, or is it ok to keep an old version only if we can run the code without errors?",
    "created_at": "2021-09-08T17:08:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455699",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "Yes, your current branch has a merge conflict with the current `develop`, 9.5.beta0, so it is best to merge it in, resolving the conflicts",
    "created_at": "2021-09-08T17:24:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455700",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "A comment on naming the class: For an implementation variant of a class, we would use an underscore-separated suffix: Instead of `Rtree_based_RealSet`, use `RealSet_rtree`",
    "created_at": "2021-09-08T17:30:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455702",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455704",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455705",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455706",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "A few test programs have been made for this class `RealSet_rtree()`, including `case with +-infinity`, `type returned class test`. Those test codes can be found at the end here. https://github.com/DRKWang/Data-structure-for-piecewise-linear-function/blob/main/logsfile/test%20for%20real_set_with_rtree.ipynb\n\nAs a result, I found 2 bugs, \n- one is for misplacing the `return self.__class__(*intervals)`;\n- the other is that since `floor()` and `ceil()` can not deal with `+-infinity` properly, we have to make it separately.",
    "created_at": "2021-09-11T18:46:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455707",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455709",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "The current branch defines `class RealSet_rtree` 3 times -- that's probably the first thing that should be cleaned up",
    "created_at": "2021-09-12T02:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455710",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455712",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "Don't worry about it. It's easy to clean up the commit history later",
    "created_at": "2021-09-13T01:19:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455713",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455714",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455715",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "You need to import it before using, see comment:34",
    "created_at": "2021-09-13T19:57:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455716",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455717",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455718",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455722",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    "body": "For the `rtree.intersection()` function, we can make the return objects of it either a list of boxes with an `rtree` data structure or a set of boxes without any structure. we can build a flag, like `rtree_rebuilt = true/false` to indicate the intention of it. Concretely, the boxes with an `rtree` data structure will be rebuilt by the class of `rtree` that we defined.",
    "created_at": "2021-10-11T17:53:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455723",
    "user": "https://github.com/DRKWang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455730",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455731",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455732",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455733",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85195"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455734",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31933#issuecomment-455735",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85197"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85198"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85199"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31933#event-85200"
}
```
