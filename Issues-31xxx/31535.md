...
```json
{
    "body": "Reduced the scope of the ticket",
...
```json
{
    "body": "Should be better with this branch",
...
```json
{
    "body": "Looking better now; regardless, the `Makefile` targets themselves are working as intended.",
    "created_at": "2021-12-04T01:29:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31535",
    "type": "issue_comment",
