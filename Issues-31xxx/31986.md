...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31986#issuecomment-628482",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31986#issuecomment-628483",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nFor now, if you want to try out the pynac patch on this ticket, you can merge the branch, and then `./sage -f pynac`.\n\n---\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[5e08324](https://github.com/sagemath/sagetrac-mirror/commit/5e08324b51b17a2aa1a97cea4050fa6d057eb5ff)|`trac 31986 allow long values in pynac`|",
    "created_at": "2021-06-15T18:11:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31986#issuecomment-628484",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31986#event-103076"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31986#event-103077"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31986#event-103078"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31986#event-103079"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31986#event-103080"
}
```
