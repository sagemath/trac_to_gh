...
```json
{
    "body": "<a id='comment:1'></a>There are various places where we introduce a workaround in `src/sage/rings/polynomial/multi_polynomial_sequence.py` and `src/sage/rings/pbori/pbori.pyx`.",
    "created_at": "2021-06-29T18:21:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31891#issuecomment-633801",
    "user": "https://github.com/kliem"
}
```

<a id='comment:1'></a>There are various places where we introduce a workaround in `src/sage/rings/polynomial/multi_polynomial_sequence.py` and `src/sage/rings/pbori/pbori.pyx`.
...
```json
{
    "body": "<a id='comment:2'></a>And `src/sage/crypto/mq/sr.py`.",
    "created_at": "2021-06-30T11:30:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31891#issuecomment-633802",
    "user": "https://github.com/kliem"
}
```

<a id='comment:2'></a>And `src/sage/crypto/mq/sr.py`.
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84243"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84244"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84245"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84246"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84247"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84248"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31891#event-84249"
}
```
