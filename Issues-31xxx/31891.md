...
```json
{
    "body": "There are various places where we introduce a workaround in `src/sage/rings/polynomial/multi_polynomial_sequence.py` and `src/sage/rings/pbori/pbori.pyx`.",
...
```json
{
    "body": "And `src/sage/crypto/mq/sr.py`.",
