...
```json
{
    "body": "<a id='comment:46'></a>\nLike the error message says: \"Actions jobs for this repository have been disabled by [GitHub](../wikis/GitHub) staff. If you are the repository owner, you can contact support via https://github.com/contact for more information.\"\nI had to do this for one of my repositories too in the past.",
