...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/31686",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630267",
    "user": "https://github.com/daira"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630268",
    "user": "https://github.com/daira"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630269",
    "user": "https://github.com/daira"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630271",
    "user": "https://github.com/daira"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630272",
    "user": "https://github.com/daira"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>For the general case, you can try along the lines:\n\n```\nfrom sage.structure.factorization import Factorization\np = self.characteristic()\nd = self.degree()\nx = polygen(ZZ)\nF = Factorization([(P(p).factor(), m) for P,m in (x^d-1).factor()]).expand()\n```\n\nNote that for small degrees, it might slow down things, so it might be worth benchmarking first.",
    "created_at": "2021-04-18T20:18:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630273",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:5'></a>For the general case, you can try along the lines:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630274",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630275",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Could `cyclotomic_value` help?\n\n```diff\n- F = Factorization([(P(p).factor(), m) for P, m in (x^d - 1).factor()]).expand()\n+ F = Factorization([(cyclotomic_value(n, p).factor(), 1)\n+                    for n in d.divisors()]).expand()\n```",
    "created_at": "2021-04-18T22:35:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630276",
    "user": "https://github.com/slel"
}
```

<a id='comment:7'></a>Could `cyclotomic_value` help?
...
```json
{
    "body": "<a id='comment:9'></a>Another example where taking advantage of the cyclotomic factorization does succeed with the proposed fix\n\n```\nsage: p = 1100585370631\nsage: GF(p^24)\nFinite Field in z24 of size 1100585370631^24\n```\n\nThis is a very nice proposal! Coud you submit a branch?",
    "created_at": "2021-04-20T17:53:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630278",
    "user": "https://github.com/videlec"
}
```

<a id='comment:9'></a>Another example where taking advantage of the cyclotomic factorization does succeed with the proposed fix
...
```json
{
    "body": "<a id='comment:11'></a>Replying to [slelievre](#comment%3A10):\n> Please open a ticket to allow `GF((p, d))` instead of `GF(p^d)`.\n> \n> Of course figuring out the prime and degree \n> when factoring the argument `q` of `GF(q)` as `p^d`\n> is easier than factoring general composite numbers.\n> Still it seems a waste that in `GF(p^d)` the prime power\n> is computed only to then recover the prime and degree.\n\n\nThis is #31709",
    "created_at": "2021-04-21T06:15:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630280",
    "user": "https://github.com/videlec"
}
```

<a id='comment:11'></a>Replying to [slelievre](#comment%3A10):
> Please open a ticket to allow `GF((p, d))` instead of `GF(p^d)`.
> 
> Of course figuring out the prime and degree 
> when factoring the argument `q` of `GF(q)` as `p^d`
...
```json
{
    "body": "<a id='comment:12'></a>Related:\n\n- #31434: Default to random modulus for finite field creation",
    "created_at": "2021-04-21T09:38:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630281",
    "user": "https://github.com/slel"
}
```

<a id='comment:12'></a>Related:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630283",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"public/31686\"",
    "created_at": "2021-04-21T12:53:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630284",
    "user": "https://github.com/slel"
}
```

Changing branch from "" to "public/31686"
...
```json
{
    "body": "Changing commit from \"\" to \"8704bb9d9a4391b2487b7027668047997b73f9f4\"",
    "created_at": "2021-04-21T12:53:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630285",
    "user": "https://github.com/slel"
}
```

Changing commit from "" to "8704bb9d9a4391b2487b7027668047997b73f9f4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630286",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>The other suggestion that I'd add is to use `factor_cunningham` from `sage.rings.factorint` when `p < 12`.",
    "created_at": "2021-04-21T19:59:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630289",
    "user": "https://github.com/roed314"
}
```

<a id='comment:16'></a>The other suggestion that I'd add is to use `factor_cunningham` from `sage.rings.factorint` when `p < 12`.
...
```json
{
    "body": "<a id='comment:18'></a>I did not notice any significant speed up by short cutting `d=1` or `d=2`. This ticket provides a great improvement!",
    "created_at": "2021-04-22T13:13:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630291",
    "user": "https://github.com/videlec"
}
```

<a id='comment:18'></a>I did not notice any significant speed up by short cutting `d=1` or `d=2`. This ticket provides a great improvement!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630292",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630293",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Please `@`gh-daira add your full name in the author field.",
    "created_at": "2021-04-22T13:34:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630294",
    "user": "https://github.com/slel"
}
```

<a id='comment:19'></a>Please `@`gh-daira add your full name in the author field.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630295",
    "user": "https://github.com/videlec"
}
```

Changing author from "Samuel Lelièvre" to "Daira Hopwood, Samuel Lelièvre"
...
```json
{
    "body": "<a id='comment:21'></a>(from https://github.com/daira)",
    "created_at": "2021-04-22T13:42:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630296",
    "user": "https://github.com/videlec"
}
```

<a id='comment:21'></a>(from https://github.com/daira)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630297",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Yes that's my name. Thankyou all for being so responsive to this ticket! :-)",
    "created_at": "2021-04-26T23:16:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630298",
    "user": "https://github.com/daira"
}
```

<a id='comment:23'></a>Yes that's my name. Thankyou all for being so responsive to this ticket! :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31686#event-83539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630299",
...
```json
{
    "body": "Changing branch from \"public/31686\" to \"8704bb9d9a4391b2487b7027668047997b73f9f4\"",
    "created_at": "2021-06-06T13:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31686#issuecomment-630300",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/31686" to "8704bb9d9a4391b2487b7027668047997b73f9f4"
