...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[ce1a235](https://git.sagemath.org/sage.git/commit?id=ce1a235e093aa42c0cab6a0e9a5e80e7fc92ee84)|`Add gappy as a standard SPKG and dependency of sagelib.`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[a8aab2a](https://git.sagemath.org/sage.git/commit/?id=a8aab2adfe417087af7f1ad5393ca7a61e242613)|`Initial work to convert sage.libs.gap to use gappy.`|",
    "created_at": "2021-01-27T15:32:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31297",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[45b175e](https://git.sagemath.org/sage.git/commit/?id=45b175e43621795f890204a9cdfb30b524f961fa)|`Don't use the string evaluation construction for libgap permutation`|\n|[197290f](https://git.sagemath.org/sage.git/commit/?id=197290f339ef5da0dbce0eb6afde85ad65dabd6a)|`Fix miscellaneous tests that broke due to different group iteration`|\n|[9f621e9](https://git.sagemath.org/sage.git/commit/?id=9f621e96ff870e7fba2fc1177d82a08aca6ce52f)|`Update gappy to v0.1.0a1 with some fixes for matrices and gap_function.`|\n|[4839316](https://git.sagemath.org/sage.git/commit/?id=483931628b3a4ce7ffe9e15fb28de20b5362a757)|`Miscellaneous updates to not use deprecated interfaces, particularly`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[baa0f61](https://git.sagemath.org/sage.git/commit/?id=baa0f61f86120ca2bb53e6d3a039f69239a1d0ac)|`Update gappy to v0.1.0a2 which adds MacOS and Cygwin fixes.`|",
    "created_at": "2021-02-03T20:11:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31297",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[a07f20e](https://git.sagemath.org/sage.git/commit/?id=a07f20ecee90d82914116e45b31e58b93d0e3ca1)|`Fixes needed for gappy v0.1.0a2 which did away with the libgap_soname`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[c9160c1](https://git.sagemath.org/sage.git/commit/?id=c9160c10e033565c1e2b538cb55f89f4c518ae72)|`Further rework of 45b175e43621795f890204a9cdfb30b524f961fa which`|",
...
```json
{
    "body": "<a id='comment:45'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[0ae791e](https://git.sagemath.org/sage.git/commit/?id=0ae791e6a1335d065d28448a80d072c26c257747)|`Update gappy to v0.1.3a3 with the requisite changes needed to adapt to`|",
...
```json
{
    "body": "<a id='comment:46'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[82e7e56](https://git.sagemath.org/sage.git/commit/?id=82e7e56cdea9b8d24a3465f9661189288f54cc26)|`A few minor test fixes:`|",
    "created_at": "2021-02-16T12:01:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31297",
    "type": "issue_comment",
