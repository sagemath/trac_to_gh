...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31185#event-411603"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31185#event-411604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31185#event-411605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31185#event-411606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31185#issuecomment-502692",
    "user": "https://github.com/vpetzel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31185#issuecomment-502693",
    "user": "https://github.com/vpetzel"
}
```
