...
```json
{
    "body": "<div id=\"comment:89\" align=\"right\">comment:89</div>\n\nReplying to [@tscrim](#comment:87):\n> Or how you will deal with these backwards incompatible changes.\n\nSee [comment:67](#comment:67), [comment:68](#comment:68). `ForgetfulFunctor` was broken in 2010, it has not been forgetting anything since. So I don't think there is a need to worry about scary backwards incompatible changes.",
