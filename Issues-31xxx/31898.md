...
```
The documentation of the package modular/modform_hecketriangle contains some typos in the documentation and inconsistencies regarding the official [SageMath](../wikis/SageMath) conventions. Here is the documentation of this package:
