...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84118"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [comment:6 lorenz]:\n> In fact, replacing the present generic formal composition morphisms by a smarter \"composed isogeny\" class is already work in progress.\n\n\nSee #32744.",
    "created_at": "2021-10-23T05:56:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31850#issuecomment-451035",
    "user": "https://github.com/yyyyx4"
}
```

<a id='comment:7'></a>Replying to [comment:6 lorenz]:
> In fact, replacing the present generic formal composition morphisms by a smarter "composed isogeny" class is already work in progress.
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84119"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84120"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84121"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84122"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84123"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84124"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84125"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31850#event-84126"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I think this should be resolved with #34410 (which, incidentally, needs a reviewer).",
    "created_at": "2022-09-25T09:40:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31850#issuecomment-451036",
    "user": "https://github.com/yyyyx4"
}
```

<a id='comment:11'></a>I think this should be resolved with #34410 (which, incidentally, needs a reviewer).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31850#issuecomment-451037",
    "user": "https://github.com/yyyyx4"
}
```
