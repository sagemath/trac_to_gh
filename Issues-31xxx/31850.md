...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31850#issuecomment-515044",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31850#issuecomment-515045",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31850#event-420961"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31850#event-420962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31850#event-420963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31850#event-420964"
}
```
