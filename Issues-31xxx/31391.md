...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[fa56447](https://git.sagemath.org/sage.git/commit/?id=fa564476ed346b02976ce93f7a6bb8925f37c11d)|`improve standardization of shape(s) in CrystalOfTableaux`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[e8c7fff](https://git.sagemath.org/sage.git/commit/?id=e8c7fffaad7dca4cc85ba9b254a2ccd7e4c688e2)|`remove leftover print`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[f604a4f](https://git.sagemath.org/sage.git/commit/?id=f604a4fbdeb736e1d5de4ff952ab62905be07e22)|`redo wrong commit`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[46dd5a2](https://git.sagemath.org/sage.git/commit/?id=46dd5a29b9691e87c674689bafb1eb360be3afda)|`fix leftovers`|",
    "created_at": "2021-02-17T22:17:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[93f0a80](https://git.sagemath.org/sage.git/commit/?id=93f0a80c0f5fc2ac0240ba3bf74126d621bf0839)|`fix sanity check`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[4bda411](https://git.sagemath.org/sage.git/commit/?id=4bda4113730f22710ca1d725fed78f89df48707c)|`standardize to partitions whenever possible`|",
    "created_at": "2021-02-18T07:28:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[1c94ee8](https://git.sagemath.org/sage.git/commit/?id=1c94ee8696c1327726096870fdeeb494987adc0a)|`always normalize to weight space, and test this`|\n|[178edd7](https://git.sagemath.org/sage.git/commit/?id=178edd721084cf8366a4dbbca8fa722a937bcdc7)|`raise ValueError for weights which are not dominant also in the the spin case`|",
