...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618100",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>It's nice that the extra cost of pushing pairs even when `report_distance` is `False` is compensated by the `yield from...`.\n\nWe could also report edges. It suffices to store in second the parent in the BFS instead of the distance. The extra cost of testing if `edges` is true before pushing to the queue is rather limited.",
    "created_at": "2021-01-02T17:35:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618101",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:2'></a>It's nice that the extra cost of pushing pairs even when `report_distance` is `False` is compensated by the `yield from...`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618102",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Why are you using `smallInteger` for distances ? does it really make a difference ?",
    "created_at": "2021-01-02T17:57:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618103",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:3'></a>Why are you using `smallInteger` for distances ? does it really make a difference ?
...
```json
{
    "body": "<a id='comment:4'></a>Actually, I can't measure a difference for pushing pairs or not. It doesn't seem to make a difference at all. After all it's super easy C stuff (if you try to push a tuple as a pair and hope for cython to do the right thing, that is going to make a difference in the wrong way).\n\n`yield from` is a bit fast that's it.",
    "created_at": "2021-01-02T18:22:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618104",
    "user": "https://github.com/kliem"
}
```

<a id='comment:4'></a>Actually, I can't measure a difference for pushing pairs or not. It doesn't seem to make a difference at all. After all it's super easy C stuff (if you try to push a tuple as a pair and hope for cython to do the right thing, that is going to make a difference in the wrong way).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618105",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The distance assume weight 1 for each edge.\n\nIs there any use case in having the distances and the edges? Currently `report_distance` is ignored when `edges` is true.",
    "created_at": "2021-01-02T18:40:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618106",
    "user": "https://github.com/kliem"
}
```

<a id='comment:6'></a>The distance assume weight 1 for each edge.
...
```json
{
    "body": "<a id='comment:7'></a>`smallInteger`: this is good to know\n\nreport distances and edges: we can certainly find a use case where it is useful to return both. Is it slower to push tuples instead of pairs ?",
    "created_at": "2021-01-02T18:45:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618107",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>`smallInteger`: this is good to know
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618108",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Apparently, I took the timings in some intermediate step where `report_distances=True` did not do anything. Things are slower now, but `smallInteger` is still better than `Integer`.",
    "created_at": "2021-01-02T21:06:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618109",
    "user": "https://github.com/kliem"
}
```

<a id='comment:9'></a>Apparently, I took the timings in some intermediate step where `report_distances=True` did not do anything. Things are slower now, but `smallInteger` is still better than `Integer`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618110",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618112",
...
```json
{
    "body": "Changing commit from \"890ed51eb3f334ba4363c36bbb4c2ea2c2676ffe\" to \"d0113bb2b8fd60f0d4f32e801db9a239b7998e91\"",
    "created_at": "2021-01-02T21:39:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618113",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "890ed51eb3f334ba4363c36bbb4c2ea2c2676ffe" to "d0113bb2b8fd60f0d4f32e801db9a239b7998e91"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618114",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Slighly better by simplifying things.\n\n---\nNew commits:",
    "created_at": "2021-01-02T21:40:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618115",
    "user": "https://github.com/kliem"
}
```

<a id='comment:12'></a>Slighly better by simplifying things.
...
```json
{
    "body": "<a id='comment:13'></a>I like the way you count maintain the distance. it's smart.\n\nWhat is surprising is that reporting distance takes roughly 30% more time. The only difference in the code is in the return statement.",
    "created_at": "2021-01-02T22:20:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618116",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:13'></a>I like the way you count maintain the distance. it's smart.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618117",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618118",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"d0113bb2b8fd60f0d4f32e801db9a239b7998e91\" to \"58f3405be1f4f42b27497e9fa0450e174752a4e8\"",
    "created_at": "2021-01-02T22:34:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618119",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d0113bb2b8fd60f0d4f32e801db9a239b7998e91" to "58f3405be1f4f42b27497e9fa0450e174752a4e8"
...
```json
{
    "body": "<a id='comment:17'></a>I agree. We already have a huge speedup. \n\nSome details, missing `:` (several times):\n\n```diff\n-        - ``report_distance`` -- boolean (default ``False``); if ``True``,\n+        - ``report_distance`` -- boolean (default: ``False``); if ``True``,\n```\n\n```diff\n-        - ``edges`` -- boolean (default ``False``); whether to return the edges\n+        - ``edges`` -- boolean (default: ``False``); whether to return the edges\n```",
    "created_at": "2021-01-03T09:30:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618121",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:17'></a>I agree. We already have a huge speedup. 
...
```json
{
    "body": "Changing commit from \"58f3405be1f4f42b27497e9fa0450e174752a4e8\" to \"025a4f919e897677fa259819a8569c539e53b7fd\"",
    "created_at": "2021-01-03T20:43:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618122",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "58f3405be1f4f42b27497e9fa0450e174752a4e8" to "025a4f919e897677fa259819a8569c539e53b7fd"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618123",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618124",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618125",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618126",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618127",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31154#event-81399"
}
```
...
```json
{
    "body": "Changing branch from \"u/gh-kliem/improved_distances_in_breadth_first_search\" to \"025a4f919e897677fa259819a8569c539e53b7fd\"",
    "created_at": "2021-01-17T13:45:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618128",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/gh-kliem/improved_distances_in_breadth_first_search" to "025a4f919e897677fa259819a8569c539e53b7fd"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31154#issuecomment-618129",
    "user": "https://github.com/vbraun"
}
```
