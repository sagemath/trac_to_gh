...
archive/issue_comments_635764.json:
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31958#issuecomment-635764",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_635765.json:
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,5 +11,6 @@\n - #27998 Solving a single equation for multiple variables doesn't work with assumptions\n - #29938 comparison with infinity does not take assumptions into account\n - #25972 solve does not obey assumptions for inequalities\n+- #24334 sympy symbol -> `SR` drops assumptions\n - #30793 Sage may ignore the imaginary part of variables not explicitly declared complex\n - see also https://trac.sagemath.org/wiki/symbolics\n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31958#issuecomment-635765",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84493"
}
```
...
archive/issue_comments_635766.json:
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,7 @@\n SymPy has a clean and general design for assumptions.\n https://docs.sympy.org/latest/modules/assumptions/index.html\n+\n+- https://docs.sympy.org/latest/modules/assumptions/assume.html?highlight=assumptionscontext#sympy.assumptions.assume.AssumptionsContext\n \n We should connect to it. Based on #31926 (#24171, #31931, #31938), we should be able to express everything in it that Sage's assumptions can do, so perhaps we can replace what we have in Sage completely by SymPy.\n \n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31958#issuecomment-635766",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_635767.json:
```json
{
    "body": "<a id='comment:6'></a>One issue with using sympy for the implementation is that loading it would add quite a bit to the start up time:\n\n```\n$ time ./sage -c quit\n\nreal\t0m1.620s\nuser\t0m1.249s\nsys\t0m0.450s\n$ time ./sage -c \"import sympy\"\n\nreal\t0m1.980s\nuser\t0m1.570s\nsys\t0m0.514s\n```",
    "created_at": "2021-08-30T01:15:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31958#issuecomment-635767",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>One issue with using sympy for the implementation is that loading it would add quite a bit to the start up time:
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84494"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84495"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84496"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84497"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84498"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31958#event-84499"
}
```
