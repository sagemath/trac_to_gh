...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619583",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619584",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619585",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619586",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>There are some failed doctests in `integrated_curve.py` on `__recude__`. However, I think this is the proper way to do it. Just overwrite the docstrings?",
    "created_at": "2021-01-13T20:58:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619587",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:3'></a>There are some failed doctests in `integrated_curve.py` on `__recude__`. However, I think this is the proper way to do it. Just overwrite the docstrings?
...
```json
{
    "body": "<a id='comment:4'></a>It depends on what the failures are. In this case, it seems like the best thing is to just change them.\n\nThis is probably the right solution. It feels slightly strange to weaken the type of morphism, but this doesn't make so much sense at the category level I think.",
    "created_at": "2021-01-14T05:20:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619588",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>It depends on what the failures are. In this case, it seems like the best thing is to just change them.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619589",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619590",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619591",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619592",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619593",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619594",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Even mathematically it makes more sense to restrict the categories.\n\nThis should be it. Wait for green patchbot.",
    "created_at": "2021-01-14T16:37:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619595",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:8'></a>Even mathematically it makes more sense to restrict the categories.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619596",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619597",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619598",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619599",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619600",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31233#event-81636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31233#issuecomment-619601",
    "user": "https://github.com/vbraun"
}
```
