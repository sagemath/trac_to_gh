...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket31425/gfan-0.6.2.p1.log",
    "created_at": "2021-02-22T15:56:21Z",
    "issue": "https://github.com/sagemath/sage/issues/31425",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket31425/gfan-0.6.2.p1.log",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [gfan-0.6.2.p1.log](https://github.com/sagemath/sage/files/ticket31425/gfan-0.6.2.p1.log) by @mkoeppe created at 2021-02-22 15:56:21\n\nI think we need know more about your system. ubuntu-bionic is well tested by our portability infrastructure. Did you add any packages from other package repos?",
    "created_at": "2021-02-22T15:56:21Z",
    "issue": "https://github.com/sagemath/sage/issues/31425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31425#issuecomment-507385",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31425#issuecomment-507386",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31425#issuecomment-507387",
    "user": "https://github.com/zimmermann6"
}
```
