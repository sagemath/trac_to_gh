...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[0ff9533](https://git.sagemath.org/sage.git/commit/?id=0ff95333df0cc444c284c33b3e5b5c18ba13b08b)|`forgot # optional`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[88d7a84](https://git.sagemath.org/sage.git/commit/?id=88d7a844b5bb4ff8ce556d711d5d2668537c5fed)|`fix erroneous check whether any maps are applied`|",
