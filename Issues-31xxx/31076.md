...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616608",
    "user": "https://github.com/culler"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>We could add something like this as a `configure` option such as `./configure --enable-relocatable` (to set `SAGE_LOCAL` to `/var/tmp/sage-$UUID`) - then relocatability would not have to rely on https://github.com/sagemath/binary-pkg at all.\nThe UUID would be generated by `configure` and stored in a file in `$prefix/var/lib/sage/`,\nand the `sage` script and also the build scripts would regenerate the symlink `$SAGE_LOCAL -> $prefix` whenever needed.",
    "created_at": "2020-12-19T18:39:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616610",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>We could add something like this as a `configure` option such as `./configure --enable-relocatable` (to set `SAGE_LOCAL` to `/var/tmp/sage-$UUID`) - then relocatability would not have to rely on https://github.com/sagemath/binary-pkg at all.
The UUID would be generated by `configure` and stored in a file in `$prefix/var/lib/sage/`,
and the `sage` script and also the build scripts would regenerate the symlink `$SAGE_LOCAL -> $prefix` whenever needed.
...
```json
{
    "body": "<a id='comment:4'></a>What about multiuser systems, now only a single person can use the binary? Not saying that this use case needs to be 100% supported, just needs to be discussed.\n\nYou would also need to check file ownership, otherwise it becomes trivial to trick other users into running your binaries.\n\nReally we should be pushing users towards containers, especially since rootless containers are now possible.",
    "created_at": "2020-12-20T14:37:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616611",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>What about multiuser systems, now only a single person can use the binary? Not saying that this use case needs to be 100% supported, just needs to be discussed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616613",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616615",
    "user": "https://github.com/culler"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Here is the new version of the patch (relocate2.patch), which I think should deal with the multi-user situation.\n\nTo test:\n\n\n```\n$ tar xvfj path/to/sage-9.2-Ubuntu_20.04-x86_64.tar.bz2\n$ cd SageMath ; patch -p1 < path/to/relocate2.patch ; cd ..\n$ SageMath/sage\n$ mv SageMath Sage-9.2\n$ Sage-9.2/sage\n```",
    "created_at": "2020-12-20T23:23:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616616",
    "user": "https://github.com/culler"
}
```

<a id='comment:8'></a>Here is the new version of the patch (relocate2.patch), which I think should deal with the multi-user situation.
...
```json
{
    "body": "<a id='comment:9'></a>I can give write permissions to anyone, thats not safe",
    "created_at": "2020-12-21T19:22:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616617",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>I can give write permissions to anyone, thats not safe
...
```json
{
    "body": "<a id='comment:12'></a>You could get around the problem by changing `/var/tmp/sage/%s` to `/var/tmp/sage-%s`. `/var/tmp` is sticky and so, once created by a user, it cannot be removed or moved by another user",
    "created_at": "2020-12-22T15:51:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616620",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:12'></a>You could get around the problem by changing `/var/tmp/sage/%s` to `/var/tmp/sage-%s`. `/var/tmp` is sticky and so, once created by a user, it cannot be removed or moved by another user
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616622",
    "user": "https://github.com/culler"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I don't know, I was interested in the earlier iteration of this idea exactly because it would allow to avoid patching the distributed binaries - which would open a path to codesigned binaries, which is in particular relevant for macOS.",
    "created_at": "2020-12-22T19:48:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616624",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:15'></a>I don't know, I was interested in the earlier iteration of this idea exactly because it would allow to avoid patching the distributed binaries - which would open a path to codesigned binaries, which is in particular relevant for macOS.
...
```json
{
    "body": "<a id='comment:16'></a>Expanding ~ is a shell convention and is not done on the POSIX API level. While you can find binaries in the path that way, the paths to shared libraries and hardcoded data files will point to the old location. Thats why a symlink in ~/.sage/locations cannot help. If it works you coincidentally have libraries and data files in the hardcoded location.",
    "created_at": "2020-12-22T19:51:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616625",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:16'></a>Expanding ~ is a shell convention and is not done on the POSIX API level. While you can find binaries in the path that way, the paths to shared libraries and hardcoded data files will point to the old location. Thats why a symlink in ~/.sage/locations cannot help. If it works you coincidentally have libraries and data files in the hardcoded location.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616626",
    "user": "https://github.com/culler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616627",
    "user": "https://github.com/culler"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>A warning about testing the patches attached here.  On my Ubuntu system I have installed the python-is-python3 package, so the relocate-once.py script is run with python3.  It does not work with python2 because it uses input.  So if you do not have python-is-python3 you need to change the hashbang in that script to use python3.",
    "created_at": "2020-12-23T21:32:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616629",
    "user": "https://github.com/culler"
}
```

<a id='comment:21'></a>A warning about testing the patches attached here.  On my Ubuntu system I have installed the python-is-python3 package, so the relocate-once.py script is run with python3.  It does not work with python2 because it uses input.  So if you do not have python-is-python3 you need to change the hashbang in that script to use python3.
...
```json
{
    "body": "<a id='comment:23'></a>https://github.com/sagemath/binary-pkg/pull/27",
    "created_at": "2021-01-10T01:15:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616631",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:23'></a>https://github.com/sagemath/binary-pkg/pull/27
...
```json
{
    "body": "<a id='comment:25'></a>`systemd-tempfiles` deletes files in `/var/tmp` after 30 days (atime) on Fedora. I don't have a list of all the expiration dates on different distros but anything set up for multiuser access is going to clean tempfiles periodically since users tend to create them, often without noticing.",
    "created_at": "2021-01-10T13:09:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616633",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:25'></a>`systemd-tempfiles` deletes files in `/var/tmp` after 30 days (atime) on Fedora. I don't have a list of all the expiration dates on different distros but anything set up for multiuser access is going to clean tempfiles periodically since users tend to create them, often without noticing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616635",
    "user": "https://github.com/culler"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>systemd is not what everyone runs. Assuming it is available on every Linux box is too optimistic.",
    "created_at": "2021-01-10T18:31:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616636",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:28'></a>systemd is not what everyone runs. Assuming it is available on every Linux box is too optimistic.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31076",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31076#issuecomment-616640",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81125"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81126"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81127"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81128"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81129"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81130"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81131"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81132"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31076#event-81133"
}
```
