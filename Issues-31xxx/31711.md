...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,15 @@\n-\n+```\n+sage: RR['x'].zero().roots()\n+...\n+PariError: zero polynomial in roots\n+sage: QQ['x'].zero().roots()\n+...\n+ArithmeticError: factorization of 0 is not defined\n+sage: SR['x'].zero().roots()\n+[]\n+sage: GF(3)['x'].zero().roots()\n+[]\n+```\n \n Summary: R['x'].zero().roots() raises many different errors depending on R\n \n``````\n",
    "created_at": "2021-04-21T16:29:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31711#issuecomment-480520",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31711#issuecomment-480521",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31711#issuecomment-480522",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31711#issuecomment-480523",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31711#issuecomment-480524",
    "user": "https://github.com/slel"
}
```
