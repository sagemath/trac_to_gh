...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31711#event-405085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31711#event-405086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31711#event-405087"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31711#event-405088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31711#issuecomment-513163",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31711#event-405089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31711#event-405090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31711#issuecomment-513164",
    "user": "https://github.com/slel"
}
```
