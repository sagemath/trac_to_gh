...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31847#issuecomment-514988",
    "user": "https://github.com/sagetrac-rjbarker"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31847#issuecomment-514989",
    "user": "https://github.com/sagetrac-rjbarker"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31847#event-420927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31847#event-420928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31847#event-420929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31847",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31847#event-420930"
}
```
