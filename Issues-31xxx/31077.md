...
```json
{
    "body": "<a id='comment:19'></a>\nThanks (both of you) for the encouragement. I pushed a branch.\n\n---\nNew commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[3d2a2dd](https://git.sagemath.org/sage.git/commit?id=3d2a2dd9811a7d802c2c9b795f31aa34e6469e32)|`trac 31077 don't use poly_mul_expand`|",
