...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620091",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I think this is a good opportunity to investigate possible connections to pymanopt (#30495)...",
    "created_at": "2021-01-16T17:52:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620092",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>I think this is a good opportunity to investigate possible connections to pymanopt (#30495)...
...
```json
{
    "body": "<a id='comment:3'></a>Another possible approach is to have a way to construct things lazily. So you have the charts, but all of the additional initialization and constructions would not be done until you actually do something with the chart. However, this would require a major overhaul to the manifolds implementation.",
    "created_at": "2021-01-17T01:28:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620093",
...
```json
{
    "body": "<a id='comment:4'></a>+1 for including Grassmannians (with projective spaces as special case).\n\nReplying to [mkoeppe](#comment%3A2):\n> I think this is a good opportunity to investigate possible connections to pymanopt (#30495)...\n\nCould you elaborate a little bit about this?",
    "created_at": "2021-01-17T15:20:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620094",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:4'></a>+1 for including Grassmannians (with projective spaces as special case).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620096",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Using the cluster charts (namely minors of matrices) and cluster mutations may be a good way, that would give as a bonus the positive grassmanians.",
    "created_at": "2021-01-19T17:29:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620097",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>Using the cluster charts (namely minors of matrices) and cluster mutations may be a good way, that would give as a bonus the positive grassmanians.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620098",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620100",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620101",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620102",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81688"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81689"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81690"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81691"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81692"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I must agree with Travis. The number of transition maps that need to be initialized go out of hand very quickly. A special treatment is required if we want to use projective spaces / Grassmannians even in reasonably low dimensions.\n\nOne sensible way would be to introduce lazy charts, as suggested by Travis in[comment:3](#comment%3A3). I think this is a good idea, not only for this particular problem but also in general. This could solve a lot of computational time, because sometimes it is sufficient to know what happens on a smaller set (for example dense sets). Eric, what do you think about lazy charts?",
    "created_at": "2022-01-23T20:20:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620105",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:17'></a>I must agree with Travis. The number of transition maps that need to be initialized go out of hand very quickly. A special treatment is required if we want to use projective spaces / Grassmannians even in reasonably low dimensions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620106",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620107",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620108",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31249#issuecomment-620109",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81693"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81694"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81695"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31249#event-81696"
}
```
