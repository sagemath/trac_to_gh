...
```json
{
    "body": "<a id='comment:1'></a>My hunch is that the problem lies with the management of non-atomic arguments by `binomial`, but I haven't a clue on how to explore this.\n\nSuggestions ?",
    "created_at": "2021-05-22T10:07:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633012",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:1'></a>My hunch is that the problem lies with the management of non-atomic arguments by `binomial`, but I haven't a clue on how to explore this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633013",
...
```json
{
    "body": "<a id='comment:3'></a>Contrary to what is said in the description, the \"equivalent sum obtained by shifting the summation index\" is **not** correct. In the equivalent sum, the top of the binomial coefficient needs to stay at `n-1`, not change to `n`:\n\n```\nsage: sum(t^(k)*binomial(n-1, k), k, 0, n-1)\n0\n```\nI don't know what is going on, but here is some additional data.  In this example, only `j=-1` is wrong:\n\n```\nsage: for j in range(-3, 4):\n....:     j, sum(t^k * binomial(n + j, k), k, 0, n + j)\n....:\n(-3, sum(t^k*binomial(n - 3, k), k, 0, n - 3))\n(-2, sum(t^k*binomial(n - 2, k), k, 0, n - 2))\n(-1, 0)\n(0, (t + 1)^n)\n(1, (t + 1)^(n + 1))\n(2, (t^2 + 2*t + 1)*(t + 1)^n)\n(3, (t^3 + 3*t^2 + 3*t + 1)*(t + 1)^n)\n```\nBut in this example, all of the negative values of `j` are wrong:\n\n```\nsage: for j in range(-3, 4):\n....:     j, sum(t^k * binomial(n + j, k), k, 0, n)\n....:\n(-3, (t + 1)^n)\n(-2, (t + 1)^n)\n(-1, (t + 1)^n)\n(0, (t + 1)^n)\n(1, (t + 1)^(n + 1) - t^(n + 1))\n(2, (t^2 + 2*t + 1)*(t + 1)^n - ((n + 2)*t + t^2)*t^n)\n(3, (t^3 + 3*t^2 + 3*t + 1)*(t + 1)^n \n    - 1/2*(2*(n + 3)*t^2 + 2*t^3 + (n^2 + 5*n + 6)*t)*t^n)\n```",
    "created_at": "2021-05-23T03:18:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633014",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:3'></a>Contrary to what is said in the description, the "equivalent sum obtained by shifting the summation index" is **not** correct. In the equivalent sum, the top of the binomial coefficient needs to stay at `n-1`, not change to `n`:
...
```json
{
    "body": "<a id='comment:7'></a>I apologize for the confusion that my comments have caused, and that I got us sidetracked from finding (and fixing) bugs in the sage code. Let's focus on finding the problem.",
    "created_at": "2021-05-24T06:22:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633018",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:7'></a>I apologize for the confusion that my comments have caused, and that I got us sidetracked from finding (and fixing) bugs in the sage code. Let's focus on finding the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633021",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>This is also Maxima bug [3788](https://sourceforge.net/p/maxima/bugs/3788/).",
    "created_at": "2021-05-25T22:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633023",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:11'></a>This is also Maxima bug [3788](https://sourceforge.net/p/maxima/bugs/3788/).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633024",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Thanks for making the upstream report!",
    "created_at": "2021-05-26T01:42:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633025",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:12'></a>Thanks for making the upstream report!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633026",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31844#issuecomment-633027",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84104"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84105"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84106"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84107"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84108"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84109"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31844#event-84110"
}
```
