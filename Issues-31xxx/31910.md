...
```json
{
    "body": "Just catching `PtyProcessError` in addition to `ExceptionPexpect` on our side does not seem to fix the problem.",
    "created_at": "2021-07-18T04:52:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31910#issuecomment-455368",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85121"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85122"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85123"
}
```
...
```json
{
    "body": "Just to mention that I've been using system `ptyprocess-0.7.0` (via #29665) for a few weeks without any issue.\n\nWhat's the exact issue? I haven't seen any report of what goes wrong on macos when using an updated ptyprocess.",
    "created_at": "2022-01-19T17:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31910#issuecomment-455369",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31910#issuecomment-455370",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Attachment [ptyprocess-failures.txt](tarball://root/attachments/some-uuid/ticket32147/ptyprocess-failures.txt) by @mkoeppe created at 2022-03-05 01:55:27",
    "created_at": "2022-03-05T01:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31910#issuecomment-455371",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85124"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85125"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85126"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31910#event-85127"
}
```
