...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[87e2dba](https://git.sagemath.org/sage.git/commit/?id=87e2dbaea7bf8a59d1ecb082871219e530218366)|`tox.ini: Add local-macos-nohomebrew and configuration facors macos-{10.14,10.15,11.1`}|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[1ed9302](https://git.sagemath.org/sage.git/commit/?id=1ed930292280bd3baa7cb3b72492c966fa204030)|`tox.ini: Add macos-{python3_xcode,nohomebrew}-python{3.7,3.8`}|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[0458f23](https://git.sagemath.org/sage.git/commit/?id=0458f2309b3f30a9445dd0196a130f4d41dafe44)|`tox.ini: Add macos-{python3_xcode,nohomebrew}-python{3.7,3.8`}|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[8b5b273](https://git.sagemath.org/sage.git/commit/?id=8b5b2739d107271f8477cee8cd941bec8b255827)|`build/pkgs/singular/checksums.ini: Use 4.2.0p1+2021-03-24+sage-2`|\n|[39629dd](https://git.sagemath.org/sage.git/commit/?id=39629dde5cecd74a30b102f25dfef9178546a2d0)|`Merge #31552`|\n|[1ef46d0](https://git.sagemath.org/sage.git/commit/?id=1ef46d0e96f00d9e7ba26f235950e90511aa2305)|`build/pkgs/giac: Add another patch in patches/autotools`|\n|[89f61d2](https://git.sagemath.org/sage.git/commit/?id=89f61d2acd527c659fd1a04239661c1bb172106d)|`build/pkgs/giac: Update to 1.6.0.47p3`|\n|[9d9c562](https://git.sagemath.org/sage.git/commit/?id=9d9c562060e86156064f3647e7b223054218c93d)|`Merge #31562`|",
    "created_at": "2021-03-27T03:01:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31567",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|\n|[236ea3c](https://git.sagemath.org/sage.git/commit/?id=236ea3c0219e5418d244c62d3289e13d14afeee1)|`tox.ini (macos-nohomebrew): Pass compiler configuration to configure using variables other than CC, CXX.`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|\n|[92db4e4](https://git.sagemath.org/sage.git/commit/?id=92db4e40bf40a73be4570e159c4e5b36c1955451)|`tox.ini (macos-nohomebrew): Pass compiler configuration to configure using variables other than CC, CXX.`|",
    "created_at": "2021-03-28T00:55:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31567",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[b5edde2](https://git.sagemath.org/sage.git/commit/?id=b5edde2e54cc58bd151880293e6454c3f92150fe)|`tox.ini (macos-nohomebrew): Fix typo in PILLOW_...`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[dffcdbc](https://git.sagemath.org/sage.git/commit/?id=dffcdbc75e46d08bcb1fd2ac9a5677a7a7312e2f)|`tox.ini (macos-nohomebrew): Fix up pillow build by setting ZLIB_ROOT`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[3779a25](https://git.sagemath.org/sage.git/commit/?id=3779a2525d5bbf0987a1d4ad0e42b73fb5769bc0)|`tox.ini (macos-nohomebrew): Disable more libraries to remove dependencies on homebrew`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|\n|[7ff26df](https://git.sagemath.org/sage.git/commit/?id=7ff26dfad2f33fe2d020580a01db20efea20716f)|`git grep -l SAGE_SUITESPARSE | xargs sed -i .bak s/SAGE_SUITESPARSE_LOCALINSTALL/SAGE_SUITESPARSE_PREFIX/g`|\n|[52537d1](https://git.sagemath.org/sage.git/commit/?id=52537d120927ed57ce9659683fed15c405b1d1c7)|`build/pkgs/cvxopt/spkg-install.in: Actually use the value of SAGE_SUITESPARSE_PREFIX`|\n|[ed1a089](https://git.sagemath.org/sage.git/commit/?id=ed1a089963e3215ddfe1216ad01237396364519b)|`Merge #31584`|",
    "created_at": "2021-03-30T22:56:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31567",
    "type": "issue_comment",
