...
```json
{
    "body": "<a id='comment:3'></a>Marc Culler produced a new SageMath macOS app, available for beta testing at\n\n- https://github.com/3-manifolds/Sage_macOS/releases",
...
<a id='comment:3'></a>Marc Culler produced a new SageMath macOS app, available for beta testing at
...
<a id='comment:4'></a>> Marc Culler produced a new SageMath macOS app, available for beta testing at
...
```json
{
    "body": "<a id='comment:7'></a>This can be closed.",
    "created_at": "2022-01-28T09:32:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31000",
    "type": "issue_comment",
...
<a id='comment:7'></a>This can be closed.
