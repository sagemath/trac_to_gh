...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82623"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625288",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82624"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625289",
    "user": "https://github.com/vneiger"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625291",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625293",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625294",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625295",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625296",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The second item is now handled (truncated expansion of linear system solution). It is done in full generality, supporting any matrix as input, and will either give a solution or reports that none exists. When the input matrix is square with invertible constant matrix (thus in particular ensuring the existence of a unique solution), it directly relies on Newton iteration and a Dixon-like solver; otherwise for the general case it goes through an approximant basis computation.",
    "created_at": "2021-07-31T16:35:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625297",
    "user": "https://github.com/vneiger"
}
```

<a id='comment:8'></a>The second item is now handled (truncated expansion of linear system solution). It is done in full generality, supporting any matrix as input, and will either give a solution or reports that none exists. When the input matrix is square with invertible constant matrix (thus in particular ensuring the existence of a unique solution), it directly relies on Newton iteration and a Dixon-like solver; otherwise for the general case it goes through an approximant basis computation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625298",
    "user": "https://github.com/vneiger"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625299",
    "user": "https://github.com/vneiger"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82626"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82627"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Since this seems close to finished, I suppose we can safely revert to milestone 9.4.",
    "created_at": "2021-08-02T08:47:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625305",
    "user": "https://github.com/vneiger"
}
```

<a id='comment:16'></a>Since this seems close to finished, I suppose we can safely revert to milestone 9.4.
...
```json
{
    "body": "<a id='comment:17'></a>Yes, these tasks seem to be too broad in scope for this ticket alone. I believe the goal that was set for this ticket has been met.",
    "created_at": "2021-08-02T15:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625306",
    "user": "https://github.com/ke456"
}
```

<a id='comment:17'></a>Yes, these tasks seem to be too broad in scope for this ticket alone. I believe the goal that was set for this ticket has been met.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625307",
    "user": "https://github.com/ke456"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82628"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625308",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31472#event-82630"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>It looks like this was merged as part of #31465.",
    "created_at": "2021-09-26T01:48:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31472#issuecomment-625309",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:19'></a>It looks like this was merged as part of #31465.
