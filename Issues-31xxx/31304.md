...
```json
{
    "body": "Changing branch from \"\" to \"u/mkoeppe/sage_setup_find__do_not_trip_over_editor_temp_auto_save_files\"",
    "created_at": "2021-02-02T05:17:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31304#issuecomment-613487",
    "user": "https://github.com/mkoeppe"
}
```

Changing branch from "" to "u/mkoeppe/sage_setup_find__do_not_trip_over_editor_temp_auto_save_files"
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100155"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31304#issuecomment-613488",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100156"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100157"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100158"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100159"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100160"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100161"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100162"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31304#event-100163"
}
```
