...
```json
{
    "body": "<a id='comment:4'></a>\nHere's what it would look like if we removed the limit entirely.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[cf0c05c](https://git.sagemath.org/sage.git/commit?id=cf0c05c000e965d63d649dcc8db66e0fe7f23b8f)|`Trac #31395: eliminate the --memlimit option to the doctest runner.`|",
