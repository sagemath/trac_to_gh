...
```json
{
    "body": "<a id='comment:23'></a>OK, now it depends on #31489 and should cleanly merge: the only change from #31489 is done in comment:22",
...
<a id='comment:23'></a>OK, now it depends on #31489 and should cleanly merge: the only change from #31489 is done in comment:22
