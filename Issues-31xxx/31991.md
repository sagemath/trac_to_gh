...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31991#event-422877"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31991#event-422878"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31991#event-422879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31991#event-422880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31991#issuecomment-517895",
    "user": "https://github.com/honglizhaobob"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31991#issuecomment-517896",
    "user": "https://github.com/mkoeppe"
}
```
