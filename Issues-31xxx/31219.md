...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445762",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445763",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "The next release of Regina (6.1) will be somewhat easier to package since it will no longer depend on Boost; the current 6.0 requires both the Boost header files (IIRC more than is in the current \"Boost cropped\" required by Sage) and a couple binary Boost libraries.",
    "created_at": "2021-03-07T20:00:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445764",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445765",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82566"
}
```
...
```json
{
    "body": "Would it be more natural to make it depend on fully built Sage, so that it can be tested with spkg-check, by the 1-liner\n\n```\nimport regina.sageRegina; regina.sageRegina.runTests()\n```",
    "created_at": "2021-06-26T09:25:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445766",
...
```json
{
    "body": "On macOS `engine.cpython-39-darwin.so` is 52Mb - big, but nothing crazy.",
    "created_at": "2021-06-26T10:45:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445768",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445771",
...
```json
{
    "body": "OK, this works, but can an optional package not be supported on 32-bit Linux (nor on FreeBSD, which is another platform Sage should work on)\n\nAnd, how about arm64?",
    "created_at": "2021-06-27T10:18:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445772",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445773",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445774",
    "user": "https://github.com/unhyperbolic"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82567"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82568"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82569"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445775",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82571"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82572"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82573"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31219#event-82574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445777",
    "user": "https://github.com/soehms"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31219#issuecomment-445778",
    "user": "https://github.com/mkoeppe"
}
```
