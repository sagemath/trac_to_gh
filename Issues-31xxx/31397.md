...
```json
{
    "body": "This is under discussion at \u200bhttps://tex.stackexchange.com/questions/583391/mactex-2020-error-with-report-hyperref-mathbf-in-chapter and has been proposed as a bug at \u200bhttps://github.com/latex3/latex2e/issues/501.",
...
```json
{
    "body": "This works for me (taken from one of the answers at tex.stackexchange.com).\n\n---\nNew commits:",
