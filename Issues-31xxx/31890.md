...
```json
{
    "body": "<a id='comment:1'></a>See attached crash report.",
    "created_at": "2021-06-01T08:15:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31890#issuecomment-451471",
    "user": "https://github.com/kliem"
}
```

<a id='comment:1'></a>See attached crash report.
...
```json
{
    "body": "<a id='comment:2'></a>The `sage` algorithm also fails: See attached crash report.",
    "created_at": "2021-06-01T08:19:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31890#issuecomment-451472",
    "user": "https://github.com/kliem"
}
```

<a id='comment:2'></a>The `sage` algorithm also fails: See attached crash report.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31890#issuecomment-451473",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31890#issuecomment-451474",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84236"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>See also #22467, #22495.",
    "created_at": "2021-11-26T21:07:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31890#issuecomment-451477",
    "user": "https://github.com/slel"
}
```

<a id='comment:6'></a>See also #22467, #22495.
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84237"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84238"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84239"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84240"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84241"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31890#event-84242"
}
```
