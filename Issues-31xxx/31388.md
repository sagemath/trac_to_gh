...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31388#issuecomment-506647",
    "user": "https://github.com/sagetrac-nailuj"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31388#issuecomment-506648",
    "user": "https://github.com/sagetrac-nailuj"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31388#event-414364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31388#event-414365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31388#event-414366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31388",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31388#event-414367"
}
```
