...
```json
{
    "body": "<a id='comment:5'></a>\nHere's a draft of the interface that I would find useful\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|\n|[2105731](https://git.sagemath.org/sage.git/commit?id=2105731534f0b4de12410d0d8b6a009feb449ff9)|`Polyhedron_base.{incidence_matrix,slack_matrix,combinatorial_polyhedron}: Extend interface`|",
