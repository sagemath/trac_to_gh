...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624484",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624485",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624486",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624487",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nHere's a draft of the interface that I would find useful\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|\n|[2105731](https://github.com/sagemath/sagetrac-mirror/commit/2105731534f0b4de12410d0d8b6a009feb449ff9)|`Polyhedron_base.{incidence_matrix,slack_matrix,combinatorial_polyhedron}: Extend interface`|",
    "created_at": "2021-05-19T16:59:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624488",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624489",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31800#issuecomment-624490",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102399"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102400"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102401"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102402"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102403"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102404"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31800#event-102405"
}
```
