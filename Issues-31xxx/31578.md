...
```json
{
    "body": "<a id='comment:72'></a>\nThis branch will only be useful if the system `ntl` installs a `pc` file. Let's make sure I haven't missed some corner cases.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[a265a71](https://github.com/sagemath/sagetrac-mirror/commit/a265a71c8b8f0fa8b65fa2fcd3914eb3500c0093)|`update ntl/spkg-config.m4 to use system ntl.pc, when available, to set NTL_LIBDIR`|",
...
```json
{
    "body": "<a id='comment:76'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[b81dc85](https://github.com/sagemath/sagetrac-mirror/commit/b81dc850448e6a3538d0038f556270401dc49845)|`Remove extra // in definition of NTL_LIBDIR`|",
    "created_at": "2021-05-25T15:16:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31578",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:92'></a>\nI have taken the liberty to push a related fix to this ticket here.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[99b5715](https://github.com/sagemath/sagetrac-mirror/commit/99b5715d63e87ee1b7921d7073b762c3b996376a)|`src/sage/rings/padics/padic_printing.pyx: Fix up distutils directive`|",
...
```json
{
    "body": "<a id='comment:0'></a>\nNew update works on gentoo w/o system .pc file\n\n```\n$ grep NTL build/pkgs/sage_conf/src/sage_conf.py\nNTL_INCDIR = \"///usr/include\"\nNTL_LIBDIR = \"///usr/lib\"\n```\n\nand with system .pc file\n\n```\n$ grep NTL build/pkgs/sage_conf/src/sage_conf.py\nNTL_INCDIR = \"/usr/include\"\nNTL_LIBDIR = \"/usr/lib64\"\n```\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[a934637](https://github.com/sagemath/sagetrac-mirror/commit/a934637d890ea25ed8aaf955a2a4dd1efc3d28a3)|`Merge branch 'u/mkoeppe/ntl_pkg_config' of trac.sagemath.org:sage into ntl_pkg_config`|\n|[a2ab555](https://github.com/sagemath/sagetrac-mirror/commit/a2ab555e29407ae4dfb52d345fd0443ed1cc4867)|`update: also set NTL_INCDIR using pkgconfig when system ntl.pc is available`|",
    "created_at": "2021-07-10T20:33:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31578",
    "type": "issue_comment",
