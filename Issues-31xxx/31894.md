...
```json
{
    "body": "<a id='comment:24'></a>\nWhy is a periodic chart considered non-surjective but injective? Isn't it exactly the opposite?\n\nBesides, Travis suggested that periodic charts could be considered being proper charts but glued together [ticket:31324#comment:25 #31324@comment:25]. Maybe we can somehow incorporate this here?",
