...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445161",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445162",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "Thank you for the fix. Please revert this change as it is not Sage's convention for the documentation:\n\n```diff\n-            r\"\"\"\n-            Return the symmetric form of ``self`` with ``la``.\n+            r\"\"\"Return the symmetric form of ``self`` with ``la``.\n```\nOnce that is done, you can set a positive review on my behalf.",
    "created_at": "2021-02-17T15:08:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445163",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445164",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445165",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445166",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445167",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31173#event-82341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31173#issuecomment-445168",
