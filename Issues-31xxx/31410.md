...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[e80c0b3](https://git.sagemath.org/sage.git/commit?id=e80c0b3dfac26e53a5bee24b1849c46a138d439c)|`fix _symmetric_form_matrix`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[c94efb0](https://git.sagemath.org/sage.git/commit/?id=c94efb097958ecc23f63461ae560b7c69cbcaa05)|`revert accidental removal of newline in docstring`|",
    "created_at": "2021-02-17T15:17:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31410",
    "type": "issue_comment",
