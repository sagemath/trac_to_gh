...
```json
{
    "body": "<a id='comment:12'></a>\nYes, here is what I have for now.\n\nOn each push, it builds the documentation and deploys it to netlify. Example: https://61ffda629c2d6f02653112ff--sagemath-tobias.netlify.app/\n\nHowever, what Harald says above is still true. Currently, there are symlinks in the documentation tree (to import static files), which yields to display errors. I have the same display problems locally (because I'm using WSL and Windows is not resolving the Linux symlinks). So that's something that still needs fixing. Any ideas how to remove the symlinks?\n\n---\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[4123116](https://git.sagemath.org/sage.git/commit?id=41231160aa29f8774ff6c9ba41db7f288d13341c)|`Add continuous deployment of docs`|\n|[2b989ce](https://git.sagemath.org/sage.git/commit?id=2b989cecf3c2099140c9bfa3565c348f4d6139b2)|`Why are you not showing up?`|\n|[361c95b](https://git.sagemath.org/sage.git/commit?id=361c95bd43fd6865ddfb6c35f41152e3bab9cfc6)|`Back to full workflow`|\n|[0847118](https://git.sagemath.org/sage.git/commit?id=0847118f8e759082efdb4da22605d74de72fc305)|`Fix path to build docs`|\n|[915da27](https://git.sagemath.org/sage.git/commit?id=915da279b926b8b61ee4d94fa5b93710517261f0)|`Trigger build again`|\n|[f5c91d8](https://git.sagemath.org/sage.git/commit?id=f5c91d8d5ecd7152112354d139fc140aca7e72ff)|`Absolute path not relative...`|\n|[a8db267](https://git.sagemath.org/sage.git/commit?id=a8db26733707b5158d5666119026c02695ebbe84)|`Don't comment on commit`|\n|[4421342](https://git.sagemath.org/sage.git/commit?id=442134217d16e61e6ccdc97f76f0718ec37d3e39)|`Use netlify deploy cli over api`|\n|[a94d1e8](https://git.sagemath.org/sage.git/commit?id=a94d1e8700f822f197481529c819b024cc1bbfac)|`Copy docs before deployment`|",
    "created_at": "2022-02-06T20:10:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31415",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[e0bac5f](https://git.sagemath.org/sage.git/commit/?id=e0bac5f18f19a8f4460f9063501b7e47189ef48a)|`Replace symlinks`|\n|[e7c8e46](https://git.sagemath.org/sage.git/commit/?id=e7c8e4662f84ce7d74bfeb9a56e0960cfffa2ec3)|`Don't use alias for now due to various netlify bugs`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[5f7086f](https://git.sagemath.org/sage.git/commit/?id=5f7086fffb80f397c043ac7ab6c4a63161c1972e)|`Print url in action overview`|\n|[870745e](https://git.sagemath.org/sage.git/commit/?id=870745e4a407c8b9f1381611eb36cfd5c9adce41)|`Copy only contents of folder not the folder itself`|",
    "created_at": "2022-02-07T19:22:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31415",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[b88ed5e](https://git.sagemath.org/sage.git/commit/?id=b88ed5ea81b18496edfa28fd8ee00ddfe504cbcd)|`Deploy to production on push to master`|\n|[2035054](https://git.sagemath.org/sage.git/commit/?id=2035054f3fa3c0a7e6901b74c4ca199f4236ecd4)|`Specify line break in message in the correct format`|\n|[1728782](https://git.sagemath.org/sage.git/commit/?id=17287820443c64e1b24e462d8c446c9db8f21c62)|`Correct spelling of netlify`|",
    "created_at": "2022-02-07T22:02:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31415",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------|\n|[81e7a2e](https://git.sagemath.org/sage.git/commit/?id=81e7a2ebec91b975ca779a8531ee54f1c64c51d5)|`Fix workflow`|",
    "created_at": "2022-02-07T22:15:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31415",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[3b11cd9](https://git.sagemath.org/sage.git/commit/?id=3b11cd9b7f2e4677b01db834f1477a7779f02f0d)|`Deploy to production for develop branch not master`|",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[2c97b7c](https://git.sagemath.org/sage.git/commit/?id=2c97b7cca224932d58920f0958cf2a829e556cb2)|`Only run in sagetrac-mirror repo`|",
    "created_at": "2022-02-08T23:28:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31415",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:58'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|\n|[ff8f6d2](https://git.sagemath.org/sage.git/commit/?id=ff8f6d2473d787a765ff324a26ebf955ca644b73)|`Merge branch 'develop' of https://github.com/sagemath/sage into public/build/doc_build_ci`|\n|[31665de](https://git.sagemath.org/sage.git/commit/?id=31665def57b107136a67bd3708f1c2e641cdf2de)|`Use commit sha for url`|",
