...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453047",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "Is this an upstreamable issue?",
    "created_at": "2021-06-15T10:56:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453048",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453049",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453050",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453051",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "If three.js people cannot do anything with it, then this means that by default Safari is not be working with a gazillion other js tools, something I find hard to believe.",
    "created_at": "2021-06-16T12:30:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453052",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453054",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "Attachment [safari_issue.tar.gz](tarball://root/attachments/some-uuid/ticket31983/safari_issue.tar.gz) by @mkoeppe created at 2021-08-22 20:35:10",
    "created_at": "2021-08-22T20:35:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453055",
    "user": "https://github.com/mkoeppe"
}
```

Attachment [safari_issue.tar.gz](tarball://root/attachments/some-uuid/ticket31983/safari_issue.tar.gz) by @mkoeppe created at 2021-08-22 20:35:10
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84567"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84568"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84569"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84570"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84571"
}
```
...
```json
{
    "body": "Confirming original issue.  I'm surprised this hasn't come up with the (new) MacOS app, but perhaps those users all (like me) ordinarily have the developer menu on, or only use notebooks?",
    "created_at": "2022-07-27T13:42:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453056",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453057",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "> Having the developer menu on is surely very uncommon, so it's likely that most use notebooks or have a different default browser (no issue with Chrome or Firefox).\n\n\nThanks.\n\n> Just to update the ticket, this continues to be a problem with Safari 15.5 on Big Sur (11.6.7).\n\n\nSorry, I had meant to imply exactly that with my comment:11,  but forgot that people can't read my mind.",
    "created_at": "2022-07-27T14:59:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31746#issuecomment-453058",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84572"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31746#event-84573"
}
```
