...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-93144"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-93145"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-93146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31569#issuecomment-600003",
    "user": "https://github.com/mkoeppe"
}
```
