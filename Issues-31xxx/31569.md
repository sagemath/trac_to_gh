...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-288070"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-288071"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-288072"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-288073"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-288074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31569#issuecomment-511877",
    "user": "https://github.com/mkoeppe"
}
```
