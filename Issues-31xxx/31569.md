...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-101355"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-101356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31569#event-101357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31569#issuecomment-620001",
    "user": "https://github.com/mkoeppe"
}
```
