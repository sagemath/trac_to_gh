...
```json
{
    "body": "see also old ticket #28928",
...
```json
{
    "body": "Pushed the recent suggestion. Let's see what the Bots say - if there are any unintended consequences. This may be difficult to review since the issue seems rare.\n\n---\nNew commits:",
...
```json
{
    "body": "Is this still needed after #33213?",
    "created_at": "2022-07-16T18:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31626",
    "type": "issue_comment",
...
```json
{
    "body": "comment:16 looks like the right fix. Could you update the branch please?",
