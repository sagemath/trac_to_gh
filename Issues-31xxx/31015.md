...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31015#event-409481"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31015#event-409482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31015#event-409483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/31015#event-409484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31015#issuecomment-500092",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/31015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/31015#issuecomment-500093",
    "user": "https://github.com/vbraun"
}
```
