...
```json
{
    "body": "also fails on Debian Buster\n\n```\n$ apt-cache policy sagemath\nsagemath:\n  Installed: 8.6-6\n  Candidate: 8.6-6\n  Version table:\n *** 8.6-6 500\n        500 http://deb.debian.org/debian buster/main amd64 Packages\n        100 /var/lib/dpkg/status\n```",
    "created_at": "2021-04-06T10:46:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31374#issuecomment-448298",
    "user": "https://github.com/claudeha"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31374#issuecomment-448299",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83195"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83196"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83197"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83198"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83199"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83200"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83201"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31374#event-83202"
}
```
