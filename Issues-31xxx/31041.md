...
```json
{
    "body": "Changing dependencies from \"\" to \"#31344\"",
    "created_at": "2021-02-06T02:13:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31041#issuecomment-615969",
    "user": "https://github.com/mkoeppe"
}
```

Changing dependencies from "" to "#31344"
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81055"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31041#issuecomment-615970",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Another question here is whether the whole functionality of `sage.misc.cython` (and the IPython line/cell magic %cython) should not be split out into a separate Python distribution package.",
    "created_at": "2021-05-27T21:05:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31041#issuecomment-615971",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Another question here is whether the whole functionality of `sage.misc.cython` (and the IPython line/cell magic %cython) should not be split out into a separate Python distribution package.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81056"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81057"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81058"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81059"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81060"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81061"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81062"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31041#event-81063"
}
```
