# Issue 16522: install_package() is obsolete
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16522#event-49076"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16522#event-49077"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16522#event-49078"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16522#event-49079"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16522#event-49080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16522",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16522#event-49081"
}
```
