# Issue 17267: solve() breaks substitute_function()
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17267#issuecomment-229581",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17267#issuecomment-229582",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "Wouldn't it be best to record what symbols sage is sending to maxima, and translate symbols in maxima's output back to the same things they corresponded to in the input?",
    "created_at": "2014-12-17T02:07:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17267#issuecomment-229584",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17267#issuecomment-229586",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```
