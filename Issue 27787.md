...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392122",
    "user": "https://github.com/Torrencem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392123",
    "user": "https://github.com/Torrencem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392124",
...
```json
{
    "body": "I added a check at the beginning of the function that catches this error case. The bug in FlattenMorphism looks difficult because it just uses the ring constructor, which is very generous in converting variables into other rings. This change should be enough for specialization, however\n\n---\nNew commits:",
    "created_at": "2019-06-22T23:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392128",
    "user": "https://github.com/Torrencem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392129",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392131",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "I agree. The latest commit changes from an error to just filtering them out for passing variables who's names aren't in the tower somewhere",
    "created_at": "2019-06-24T20:33:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392132",
    "user": "https://github.com/Torrencem"
}
```
...
```json
{
    "body": "Since we've decided we're not changing the Specialization Morphism call, and I've updated so it ignores anything not in the tower",
    "created_at": "2019-07-06T13:39:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392133",
    "user": "https://github.com/Torrencem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392134",
    "user": "https://github.com/Torrencem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392135",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392136",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-392137",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27787#event-69476"
}
```
