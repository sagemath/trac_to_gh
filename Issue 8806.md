...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8806#issuecomment-80668",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8806#event-21482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8806#issuecomment-80670",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8806",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8806#event-21483"
}
```
...
```json
{
    "body": "Just a very minor point to go along with Minh's potential followup ticket for the \"q\":\n\n```\nPPC              Apple Mac OS X 10.5.x, 10.6.x \n```\n\nis wrong as well, since of course Apple intentionally removed PPC support from OS X 10.6.",
    "created_at": "2010-05-03T14:56:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8806#issuecomment-80671",
