...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274446",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274447",
    "user": "https://trac.sagemath.org/admin/accounts/users/cprior"
}
```
...
```json
{
    "body": "I think your logic can be simplified somewhat: In the code case, you should use something like `generator = generator.generator_matrix()` instead. You are promised that this is a full rank matrix (that's part of the contract of that method). So the check that `basis` is as long as the rank of `generator` is not necessary here and can be moved into the `try` block for the generator matrix case. And now the computation of `basis` does not have to be done twice.\n\nBest,\nJohan",
    "created_at": "2016-03-30T07:21:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274450",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274451",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274452",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274453",
    "user": "https://trac.sagemath.org/admin/accounts/users/cprior"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274454",
    "user": "https://trac.sagemath.org/admin/accounts/users/cprior"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274455",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    "body": "Ah sorry that slipped my mind! I looked over the changes you made and they're fine, I also re-ran the doctests on the updated file just to make sure everything's okay as a third-party. I'll set the ticket to positive_review :)\n\nThanks,\nCharlie\n\nP.S. Do we need to change the milestone to sage-7.2? I branched from sage-7.2.beta1 so we shouldn't need to merge anything in.",
    "created_at": "2016-03-30T20:29:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274456",
    "user": "https://trac.sagemath.org/admin/accounts/users/cprior"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274457",
    "user": "https://trac.sagemath.org/admin/accounts/users/cprior"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19961#event-54875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19961#issuecomment-274458",
