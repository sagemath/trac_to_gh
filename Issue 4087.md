# Issue 4087: [with patch, with positive review] Improved printing of polynomials with 'negative' coefficients
...
```json
{
    ...
    "title": "[with patch, with positive review] Improved printing of polynomials with 'negative' coefficients",
    "type": "issue",
