...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9992/sage-make_relative",
...
```json
{
    "body": "Attached only so I can provide a link to this - for most practical purposes this can be ignored.",
    "created_at": "2010-09-23T23:28:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93170",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93171",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93172",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93173",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93174",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93175",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9992/trac_9992-run_sage-make_relative_conditionally.scripts.patch",
...
```json
{
    "body": "SCRIPTS repo. Changes `sage-spkg` to only run `sage-make_relative` if Sage's Python is already installed. Based on Sage 4.7.2.alpha4.",
    "created_at": "2011-10-13T12:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93176",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93177",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93178",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93179",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93180",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93181",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75304"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93182",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75306"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75307"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93183",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75308"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93184",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9992#issuecomment-93185",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9992#event-75311"
}
```
