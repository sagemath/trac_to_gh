...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9862#issuecomment-90106",
    "user": "https://github.com/sagetrac-edward-scheinerman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9862#issuecomment-90107",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9862#event-116729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9862",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9862#event-116730"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9862#event-116731"
}
```
