...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-127842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-127843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-127844"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-127845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9844#issuecomment-87964",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9844#issuecomment-87965",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9844#issuecomment-87966",
    "user": "https://github.com/nexttime"
}
```
