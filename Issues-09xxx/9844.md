...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-112682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-112683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9844#event-112684"
}
```
...
```json
{
    "body": "Changed keywords from **** to **LaTeX, documentation, PDF, Sphinx, warning**",
    "created_at": "2010-09-01T13:40:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9844#issuecomment-89885",
    "user": "https://github.com/nexttime"
}
```

Changed keywords from **** to **LaTeX, documentation, PDF, Sphinx, warning**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9844#issuecomment-89886",
    "user": "https://github.com/nexttime"
}
```
