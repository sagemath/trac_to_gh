...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83718",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012128.json:
```json
{
...
```json
{
    "body": "Attachment [ecl-10.2.1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.log) by drkirkby created at 2010-07-12 20:39:54\n\nLog of failed build on OS X using the ECL from sage-4.5.rc0. Three attempts were made to install via 'make' all failed. The last attempt, using 'sage' worked.",
    "created_at": "2010-07-12T20:39:54Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83719",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [ecl-10.2.1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.log) by drkirkby created at 2010-07-12 20:39:54
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83720",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83721",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83722",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012129.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [ecl-10.2.1.p1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p1.log) by drkirkby created at 2010-07-12 22:16:58\n\nLog of failed successful build on OS X (bsd.math) using the ecl-10.2.1.p1 produced by mpatel. This built ecl ok. The complete build of sage has not completed.",
    "created_at": "2010-07-12T22:16:58Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83723",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [ecl-10.2.1.p1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p1.log) by drkirkby created at 2010-07-12 22:16:58
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83724",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83725",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83726",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83727",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83728",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83729",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012130.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83731",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83732",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83733",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83734",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83735",
