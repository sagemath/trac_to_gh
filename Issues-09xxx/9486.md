...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sage/issues/9486",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83738",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012572.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ecl-10.2.1.p0.log",
    "asset_url": "tarball://root/attachments/ticket9486/ecl-10.2.1.p0.log",
    "created_at": "2010-07-12T20:39:54Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p0.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012573.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ecl-10.2.1.log",
    "asset_url": "tarball://root/attachments/ticket9486/ecl-10.2.1.log",
    "created_at": "2010-07-12T20:39:54Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [ecl-10.2.1.p0.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p0.log)\n\n**Attachment:** [ecl-10.2.1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.log)\n\nLog of failed build on OS X using the ECL from sage-4.5.rc0. Three attempts were made to install via 'make' all failed. The last attempt, using 'sage' worked.",
    "created_at": "2010-07-12T20:39:54Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83739",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

**Attachment:** [ecl-10.2.1.p0.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p0.log)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83740",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83741",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83742",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012574.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ecl-10.2.1.p1.log",
    "asset_url": "tarball://root/attachments/ticket9486/ecl-10.2.1.p1.log",
    "created_at": "2010-07-12T22:16:58Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p1.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [ecl-10.2.1.p1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p1.log)\n\nLog of failed successful build on OS X (bsd.math) using the ecl-10.2.1.p1 produced by mpatel. This built ecl ok. The complete build of sage has not completed.",
    "created_at": "2010-07-12T22:16:58Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83743",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

**Attachment:** [ecl-10.2.1.p1.log](https://github.com/sagemath/sage/files/ticket9486/ecl-10.2.1.p1.log)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83744",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83745",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83746",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83747",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83748",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83749",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012575.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "bsd.math+7379+9187-ptestlong.log",
    "asset_url": "tarball://root/attachments/ticket9486/1e5cd9187b97783db7f3c90ba75239e4.log",
    "created_at": "2010-07-13T09:58:08Z",
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9486/1e5cd9187b97783db7f3c90ba75239e4.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83751",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83752",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83753",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9486#event-69945"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83754",
...
```json
{
    ...
    "milestone": "sage-4.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9486#event-69946"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9486#event-69947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9486#issuecomment-83755",
