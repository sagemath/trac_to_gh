...
archive/attachments_012593.json:
```json
{
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [trac_9502_basis_parent_bug_in_FreeModule.patch](https://github.com/sagemath/sage/files/ticket9502/trac_9502_basis_parent_bug_in_FreeModule.patch)",
    "created_at": "2010-07-21T00:28:12Z",
    "issue": "https://github.com/sagemath/sage/issues/9502",
    "type": "issue_comment",
...
archive/attachments_012594.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_9502_basis_parent_bug_in_FreeModule.2.patch](https://github.com/sagemath/sage/files/ticket9502/trac_9502_basis_parent_bug_in_FreeModule.2.patch)\n\nReverted change to symbolic/ring.pyx",
    "created_at": "2010-07-24T07:40:27Z",
    "issue": "https://github.com/sagemath/sage/issues/9502",
    "type": "issue_comment",
...
**Attachment:** [trac_9502_basis_parent_bug_in_FreeModule.2.patch](https://github.com/sagemath/sage/files/ticket9502/trac_9502_basis_parent_bug_in_FreeModule.2.patch)
