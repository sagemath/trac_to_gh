...
```json
{
    "body": "<a id='comment:1'></a>The extension `.so` doesn't seem to be the problem, since apparently the loader recognizes it as a shared library.\n\nThe extension `.a` for *shared* libraries is of course a bit odd since PARI also builds a static version which typically has the same name ending with `.a`...",
    "created_at": "2010-09-24T12:24:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120340",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>The extension `.so` doesn't seem to be the problem, since apparently the loader recognizes it as a shared library.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120341",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120342",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120344",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,8 @@\n The Pari svn snapshot 12577 is failing to build properly on AIX. **If the Pari developers would like access to AIX hardware (I don't think they have it), then I can provide access to my personal RS/6000**\n \n- == Hardware and software ==\n+Reported upstream: [http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1102](http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1102)\n+\n+## Hardware and software\n * IBM [RS/6000 7025 F50](http://publib.boulder.ibm.com/infocenter/pseries/v5r3/index.jsp?topic=/com.ibm.pseries.doc/hardware_docs/rs6000_7025f50series.htm)\n * 4 x 332 MHz 32-bit PowerPC CPUs\n * 3 GB RAM\n@@ -41,6 +43,7 @@\n \n ```\n \n+\n Comment: 1\n \n Summary: Pari fails to build on AIX - using wrong extension for libraries.\n``````\n",
    "created_at": "2010-09-26T16:47:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120345",
...
```json
{
    "body": "<a id='comment:7'></a>I got this from Bill Allombert, a Pari developer:\n\n```\nCould you try to deactivate shared libraries by using\n./Configure --static\n```\n\nThat solves the problem - Pari then installs ok. I will create a patch. \n\nDave",
    "created_at": "2010-09-28T22:52:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120346",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>I got this from Bill Allombert, a Pari developer:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120347",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120348",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120349",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120350",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120351",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120352",
...
```json
{
    "body": "<a id='comment:14'></a>\"No feedback yet.\" is totally not correct here.  Most applicable would be \"Developers sort-of acknowledge the bug but don't really care enough to fix it\"",
    "created_at": "2012-06-01T21:54:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120353",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>"No feedback yet." is totally not correct here.  Most applicable would be "Developers sort-of acknowledge the bug but don't really care enough to fix it"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120354",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I believe \"-Wl,-r\" is incorrect, \"-Wl,-brtl\" may have to be added for the linking to happen, as in the linking of binary.",
    "created_at": "2012-06-02T10:52:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120355",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:15'></a>I believe "-Wl,-r" is incorrect, "-Wl,-brtl" may have to be added for the linking to happen, as in the linking of binary.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25287"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25288"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25289"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25290"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25291"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25292"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25293"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Closing as obsolete.",
    "created_at": "2018-10-17T13:04:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120357",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>Closing as obsolete.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9990#issuecomment-120358",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25294"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9990",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9990#event-25296"
}
```
