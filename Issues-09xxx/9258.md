...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118939"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118940"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118941"
}
```
...
archive/issue_events_118942.json:
```json
{
    "actor": "https://github.com/maxthemouse",
    "created_at": "2010-06-18T07:11:40Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118942"
}
```
...
archive/issue_events_118943.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118943"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118946"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9258",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9258#event-118947"
}
```
