...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128636"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128637"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128639"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128642"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128643"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128647"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128648"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,5 +19,5 @@\n \n **Upgrade path for testing the fixes: http://sage.math.washington.edu/home/jdemeyer/dist/sage-4.6.upgradetest_alpha1/**\n \n-On MacOS X, one should at the moment either do an \"in-place\" upgrade (without renaming the directory / copying the original installation) or follow the instructions given in comments below (regarding `LDSHARED`).\n+On MacOS X, one should at the moment either do an \"in-place\" upgrade (without renaming the directory / copying the original installation) or follow the instructions given in the [comment below](#comment:63) (regarding `LDSHARED`).\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128650"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -30,12 +30,12 @@\n ```\n (This package is only used on the above systems, but upgrading it triggers the rebuild of MPIR on **any** platform, which in turn causes rebuilding all packages that directly or indirectly depend on MPIR, the GMP replacement package.)\n \n-On MacOS X, one should at the moment **either** do an \"in-place\" upgrade (without renaming the directory / copying the original installation) **or** do the following **before** running `./sage -upgrade ...`:\n+On MacOS X, one should **at the moment** **either** do an \"in-place\" upgrade (without renaming the directory / copying the original installation) **or** do the following **before** running `./sage -upgrade ...`:\n \n ```sh\n $ export LDSHARED=\"gcc -bundle -undefined dynamic_lookup\"\n ```\n-(See also the [comment below](#comment:63) regarding `LDSHARED`.)\n+(See also the [comment below](#comment:63) regarding `LDSHARED`. This will no longer be necessary when the second patch to the Sage library, `trac_9896-fix_hardcoded_libdirs_in_extmod_linker_cmd-sagelib.patch`, has been merged into the upgrade path.)\n \n Do the upgrade:\n \n@@ -48,10 +48,10 @@\n \n ## To the release manager / How to merge this ticket:\n * Replace `spkg/install` by https://github.com/sagemath/sage/files/ticket9896/trac_9896-SAGE_ROOT__spkg__install.v2b.gz\n-* Apply the patch `9896_scripts_hgignore.patch` to the sage-scripts repository.\n * Replace `spkg/standard/deps` by https://github.com/sagemath/sage/files/ticket9896/trac_9896-SAGE_ROOT__spkg__standard__deps.v3.gz\n-* Apply https://github.com/sagemath/sage/files/ticket9896/trac_9896-propagate_upgrading_to_install_script-scripts_repo.patch.gz to the **scripts repository**\n+* Apply https://github.com/sagemath/sage/files/ticket9896/9896_scripts_hgignore.patch.gz to the **Sage scripts repository** (Not mandatory, but helpful.)\n+* Apply https://github.com/sagemath/sage/files/ticket9896/trac_9896-propagate_upgrading_to_install_script-scripts_repo.patch.gz to the **Sage scripts repository**\n * Apply https://github.com/sagemath/sage/files/ticket9896/trac_9896-fix_extension_module_deps-sagelib.patch.gz to the **Sage library repository**\n-* **Not yet present**: Apply the patch to `devel/sage/setup.py` to the **Sage library repository**\n+* Apply https://github.com/sagemath/sage/files/ticket9896/trac_9896-fix_hardcoded_libdirs_in_extmod_linker_cmd-sagelib.patch.gz to the **Sage library repository**\n * Run `./sage -sdist ...`\n \n``````\n",
    "created_at": "2010-10-19T10:21:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89194",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128653"
}
```
...
```json
{
    ...
    "subject": "https://github.com/nexttime",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89195",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89196",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89197",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89198",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89199",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89200",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89201",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89203",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89204",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89205",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89207",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89208",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89209",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89210",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89211",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89212",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89213",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89214",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89216",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89218",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89220",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89221",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89222",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89223",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<div id=\"comment:168\" align=\"right\">comment:168</div>\n\nReplying to [@jhpalmieri](#comment:153):\n> Anyway, I guess now I'm happy with all but one of the patches (trac_9896-fix_extension_module_deps-sagelib.patch), and someone else will have to help with that.\n\nI'll try to review this later today.",
    "created_at": "2010-10-27T09:06:12Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89224",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89225",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89227",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89228",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89231",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89232",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89233",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89234",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89235",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9896#event-128658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89236",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89237",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9896#issuecomment-89238",
    "user": "https://github.com/jhpalmieri"
}
```
