...
<a id='comment:4'></a>The patch attached to #8734 indeed fixes this problem. However there are simpler solutions, and I'm not convinced that #8734 is necessary, given that #7377 could solve this in a much cleaner way. Also see the discussion linked from comment:3:ticket:8734:
...
```json
{
    "body": "<a id='comment:12'></a>Nils, do you have any thoughts about the problem in [comment:7 comment 7ff]?",
...
<a id='comment:12'></a>Nils, do you have any thoughts about the problem in [comment:7 comment 7ff]?
