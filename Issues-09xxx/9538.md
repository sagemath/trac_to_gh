...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9538#event-112006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9538#event-112007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9538#event-112008"
}
```
...
```json
{
    "body": "<a id='comment:17'>Comment 17:</a>\nAttachment: **[trac_9538-maxima_kill.take2.patch.gz](https://github.com/sagemath/sage/files/ticket9538/trac_9538-maxima_kill.take2.patch.gz)**\n\nI uploaded an alternate patch, [attachment: trac_9538-maxima_kill.take2.patch.gz](https://github.com/sagemath/sage/files/ticket9538/trac_9538-maxima_kill.take2.patch.gz)This issues the `kill` command Robert Dodier recommended when initializing maxima. There is no need for any changes to the maxima package.",
    "created_at": "2010-10-01T16:04:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9538",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9538#issuecomment-84598",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9538#issuecomment-84599",
