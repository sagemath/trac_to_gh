...
```json
{
    "body": "<a id='comment:1'></a>I'm pretty sure this is just #8734.",
    "created_at": "2010-07-18T17:11:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109773",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>I'm pretty sure this is just #8734.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109774",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109775",
...
```json
{
    "body": "<a id='comment:5'></a>I confirm that with the #8734 patch applied to 4.5.3 (and ignoring the patch reject) it works\nfine.\n\nHowever I'm convinced by Burcin's argument. I am ready to review a patch based on this patch\napplied to Maxima.\n\nPaul",
    "created_at": "2010-09-26T08:05:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109777",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>I confirm that with the #8734 patch applied to 4.5.3 (and ignoring the patch reject) it works
fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109778",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Here is a maxima package that patches the file `share/contrib/Zeilberger/testZeilberger.mac` as suggested by Robert Dodier:\n\nhttp://sage.math.washington.edu/home/burcin/maxima-5.20.1.p1.spkg\n\nattachment:trac_9538-maxima_kill.patch adds a doctest to check the example given in the description.",
    "created_at": "2010-09-26T16:00:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109779",
    "user": "https://github.com/burcin"
}
```

<a id='comment:6'></a>Here is a maxima package that patches the file `share/contrib/Zeilberger/testZeilberger.mac` as suggested by Robert Dodier:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109780",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Robert Dodier, Burcin Erocal\"",
    "created_at": "2010-09-26T16:00:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109781",
    "user": "https://github.com/burcin"
}
```

Changing author from "" to "Robert Dodier, Burcin Erocal"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109783",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109784",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [maxima_package.patch](tarball://root/attachments/some-uuid/ticket9538/maxima_package.patch) by @burcin created at 2010-09-26 20:25:38\n\nReplying to [zimmerma](#comment%3A7):\n> Did I something wrong? How to install the patched spkg?\n\n\nI don't have any experience with the maxima spkg. I just applied the patch in attachment:maxima_package.patch. It works here, but just complains about not being able to build `maxima.fasb`:\n\n```\ncp: cannot stat `maxima.fasb': No such file or directory\n```\n\nPerhaps someone more knowledgeable can help out. Building maxima as a library is #8645.",
    "created_at": "2010-09-26T20:25:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109785",
    "user": "https://github.com/burcin"
}
```

<a id='comment:8'></a>Attachment [maxima_package.patch](tarball://root/attachments/some-uuid/ticket9538/maxima_package.patch) by @burcin created at 2010-09-26 20:25:38
...
```json
{
    "body": "<a id='comment:9'></a>maybe we should wait that #8645 is fixed and merged within Sage to review that ticket.\n\nPaul",
    "created_at": "2010-09-27T09:06:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109786",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:9'></a>maybe we should wait that #8645 is fixed and merged within Sage to review that ticket.
...
```json
{
    "body": "<a id='comment:12'></a>Nils, do you have any thoughts about the problem in [comment 7ff](#comment%3A7)?",
    "created_at": "2010-09-30T23:32:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109789",
    "user": "https://github.com/qed777"
}
```

<a id='comment:12'></a>Nils, do you have any thoughts about the problem in [comment 7ff](#comment%3A7)?
...
```json
{
    "body": "<a id='comment:13'></a>> Paul, did you happen to move or rename your Sage root directory?\n\n\nno, I did all my experiments in /tmp/sage-4.6.alpha1, where I built sage-4.6.alpha1 from source.\nI have no `SAGE_ROOT` environment variable.\n\nPaul",
    "created_at": "2010-10-01T06:53:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109790",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:13'></a>> Paul, did you happen to move or rename your Sage root directory?
...
```json
{
    "body": "<a id='comment:14'></a>Burcin, do you agree that we try Mitesh's solution from comment 10, which avoids installing a new\nMaxima spkg? If so, if someone can provide a patch, I will review it.\n\nPaul",
    "created_at": "2010-10-01T06:58:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109791",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:14'></a>Burcin, do you agree that we try Mitesh's solution from comment 10, which avoids installing a new
Maxima spkg? If so, if someone can provide a patch, I will review it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109792",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>> So far, it seems the build problem is orthogonal to the problem in the description. \n\n\nagreed, but how can we proceed in practice so that I can review this ticket?\n\nPaul",
    "created_at": "2010-10-01T07:46:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109793",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:16'></a>> So far, it seems the build problem is orthogonal to the problem in the description. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109794",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109795",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Attachment [trac_9538-maxima_kill.take2.patch](tarball://root/attachments/some-uuid/ticket9538/trac_9538-maxima_kill.take2.patch) by @burcin created at 2010-10-01 16:04:37\n\nI uploaded an alternate patch, attachment:trac_9538-maxima_kill.take2.patch. This issues the `kill` command Robert Dodier recommended when initializing maxima. There is no need for any changes to the maxima package.",
    "created_at": "2010-10-01T16:04:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109796",
    "user": "https://github.com/burcin"
}
```

<a id='comment:17'></a>Attachment [trac_9538-maxima_kill.take2.patch](tarball://root/attachments/some-uuid/ticket9538/trac_9538-maxima_kill.take2.patch) by @burcin created at 2010-10-01 16:04:37
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109797",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109798",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>ok for the last patch, which fixes the problem, and all tests pass (tested with Sage 4.4.4).\n\nPaul\n\nPS: a minor remark, is there a mechanism to update the calculus.py patch once the problem is\nfixed upstream?",
    "created_at": "2010-10-03T10:31:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109799",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:18'></a>ok for the last patch, which fixes the problem, and all tests pass (tested with Sage 4.4.4).
...
```json
{
    "body": "<a id='comment:20'></a>> If it is fixed upstream, this doctest should fail: [...]\n\n\nexcellent!\n\nPaul",
    "created_at": "2010-10-03T11:42:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109801",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:20'></a>> If it is fixed upstream, this doctest should fail: [...]
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109802",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9538#issuecomment-109803",
    "user": "https://github.com/qed777"
}
```
