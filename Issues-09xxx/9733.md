...
```json
{
    "body": "<div id=\"comment:4\" align=\"right\">comment:4</div>\n\nI repeated the tests in [comment 112](https://github.com/sagemath/sage/issues/8059#comment:112) at #8059, this time under `/dev/shm` (a fast RAM disk, I think) on sage.math.  Thirteen of 50 runs failed, all apparently caused by the `gentable*` problem, which should be fixed by [this upstream comment](http://www.singular.uni-kl.de:8002/trac/ticket/250#comment:2).\n\nThanks for filing the fixes!",
