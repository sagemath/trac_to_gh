...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89815",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_name": "complete-log-of-OpenSolaris-86-built.txt.gz",
    "asset_url": "tarball://root/attachments/ticket9840/complete-log-of-OpenSolaris-86-built.txt.gz",
    "created_at": "2010-08-30T12:13:45Z",
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9840/complete-log-of-OpenSolaris-86-built.txt.gz",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [complete-log-of-OpenSolaris-86-built.txt.gz](https://github.com/sagemath/sage/files/ticket9840/complete-log-of-OpenSolaris-86-built.txt.gz) by drkirkby created at 2010-08-30 12:13:45\n\nBuild log on OpenSolaris, when using debugging options to show text relocations.",
    "created_at": "2010-08-30T12:13:45Z",
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89816",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [complete-log-of-OpenSolaris-86-built.txt.gz](https://github.com/sagemath/sage/files/ticket9840/complete-log-of-OpenSolaris-86-built.txt.gz) by drkirkby created at 2010-08-30 12:13:45
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89817",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89818",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89819",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89820",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9840#issuecomment-89821",
