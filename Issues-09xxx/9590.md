...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109073"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109074"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109076"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109077"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109078"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109079"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9590#issuecomment-85421",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9590#issuecomment-85422",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9590",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9590#event-109081"
}
```
