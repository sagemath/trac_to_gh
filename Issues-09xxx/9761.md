...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72777"
}
```
...
```json
{
    ...
    "asset_name": "deps",
    "asset_url": "tarball://root/attachments/ticket9761/deps",
    "created_at": "2010-08-18T23:10:31Z",
    "issue": "https://github.com/sagemath/sage/issues/9761",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9761/deps",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9761/deps.diff",
    "created_at": "2010-08-18T23:10:31Z",
    "issue": "https://github.com/sagemath/sage/issues/9761",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9761/deps.diff",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket9761/deps)\n\n**Attachment:** [deps.diff](https://github.com/sagemath/sage/files/ticket9761/deps.diff)\n\nDifferences between the new 'deps' file and that in sage-4.5.3.alpha1",
    "created_at": "2010-08-18T23:10:31Z",
    "issue": "https://github.com/sagemath/sage/issues/9761",
    "type": "issue_comment",
...
**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket9761/deps)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72778"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72779"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72780"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72781"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-72783"
}
```
