...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-115272"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-115273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9761#event-115274"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9761#issuecomment-88329",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9761#issuecomment-88330",
    "user": "https://github.com/qed777"
}
```
