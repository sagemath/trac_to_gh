...
<a id='comment:1'></a>The attached patch adds a radical() function, functions Factorization.radical() and Factorization.radical_value().  It also fixes a bug in the radical of a polynomial where the content was not accounted for.
...
```json
{
    "body": "<a id='comment:4'></a>Applies well to 4.6.1.alpha1 and all tests pass.",
...
<a id='comment:4'></a>Applies well to 4.6.1.alpha1 and all tests pass.
...
```json
{
    "body": "<a id='comment:5'></a>Thanks, this is something I did in Leiden and totally forgot about.",
    "created_at": "2010-11-21T17:03:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9459",
    "type": "issue_comment",
...
<a id='comment:5'></a>Thanks, this is something I did in Leiden and totally forgot about.
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [9459.patch](tarball://root/attachments/some-uuid/ticket9459/9459.patch) by @jdemeyer created at 2011-01-12 06:32:30",
    "created_at": "2011-01-12T06:32:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9459",
    "type": "issue_comment",
...
<a id='comment:7'></a>Attachment [9459.patch](tarball://root/attachments/some-uuid/ticket9459/9459.patch) by @jdemeyer created at 2011-01-12 06:32:30
