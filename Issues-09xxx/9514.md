...
archive/attachments_012611.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_9514-random-tests-sort-functions.patch](https://github.com/sagemath/sage/files/ticket9514/trac_9514-random-tests-sort-functions.patch)\n\nThis patch fixes the problem, and also seems to fix the random_tests.py problem with #8988 (as expected).",
    "created_at": "2010-07-16T04:32:34Z",
    "issue": "https://github.com/sagemath/sage/issues/9514",
    "type": "issue_comment",
