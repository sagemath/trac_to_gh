...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117346"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117349"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9904#issuecomment-91262",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9904#issuecomment-91263",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9904",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117352"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-117354"
}
```
