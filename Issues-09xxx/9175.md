...
```json
{
    "body": "<a id='comment:1'></a>SEA.gp does not *always* fail.  often it works:\n\n```\n\nsage: E = EllipticCurve('389a').change_ring(GF(next_prime(10^15)))\nsage: E.cardinality_sea()\n999999960319827\n\n```",
    "created_at": "2010-06-07T05:16:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9175#issuecomment-102214",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>SEA.gp does not *always* fail.  often it works:
...
```json
{
    "body": "<a id='comment:2'></a>By #9343, the script sea.gp will be removed, so this will trivially be fixed.",
    "created_at": "2010-08-01T15:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9175#issuecomment-102215",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>By #9343, the script sea.gp will be removed, so this will trivially be fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9175#issuecomment-102216",
