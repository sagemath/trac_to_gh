...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9968/trac_9968.patch",
    "created_at": "2010-09-22T10:17:07Z",
    "issue": "https://github.com/sagemath/sage/issues/9968",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9968/trac_9968.patch",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Attachment [trac_9968.patch](https://github.com/sagemath/sage/files/ticket9968/trac_9968.patch) by @loefflerd created at 2010-09-22 10:17:07\n\npatch against 4.6.alpha1",
    "created_at": "2010-09-22T10:17:07Z",
    "issue": "https://github.com/sagemath/sage/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9968#issuecomment-92672",
    "user": "https://github.com/loefflerd"
}
```

Attachment [trac_9968.patch](https://github.com/sagemath/sage/files/ticket9968/trac_9968.patch) by @loefflerd created at 2010-09-22 10:17:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9968#issuecomment-92673",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9968#issuecomment-92674",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9968#issuecomment-92675",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9968#issuecomment-92676",
