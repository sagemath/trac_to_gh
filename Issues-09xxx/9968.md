...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119756",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119757",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119758",
...
```json
{
    "body": "<a id='comment:2'></a>I was a bit worried about the edge_coloring method for graphs which uses this algorithm, but it is still working after this patch is applied : no (related) failure in sage -testall ! \n\nThankssssssssss ! `:-)`\n\nNathann",
    "created_at": "2010-09-22T14:57:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119759",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>I was a bit worried about the edge_coloring method for graphs which uses this algorithm, but it is still working after this patch is applied : no (related) failure in sage -testall ! 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119760",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Perhaps we can get this into 4.6? It's hardly a massive change :-)",
    "created_at": "2010-09-28T11:47:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119761",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:3'></a>Perhaps we can get this into 4.6? It's hardly a massive change :-)
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9968#event-25154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119762",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9968#issuecomment-119763",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9968",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9968#event-25155"
}
```
