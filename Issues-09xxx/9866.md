...
```json
{
    "body": "<a id='comment:1'></a>Is this error reproducible, does it happen every time?  What happens if you run `sage -gp` on that machine?",
    "created_at": "2010-09-07T08:31:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116771",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Is this error reproducible, does it happen every time?  What happens if you run `sage -gp` on that machine?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116772",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9866#event-24845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116773",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116774",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9866#event-24846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9866#event-24847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116775",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9866#event-24848"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Nobody seems to care very much, so I'm closing this as invalid.",
    "created_at": "2011-04-06T08:01:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116776",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Nobody seems to care very much, so I'm closing this as invalid.
...
```json
{
    "body": "<a id='comment:6'></a>I have had this result in a doctest failure onOpenSolaris on more than one occasion. But it's not every reproducible. The test fails, then passes when rerun. \n\nSorry I did not comment earlier. \n\nDave",
    "created_at": "2011-04-07T21:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116777",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>I have had this result in a doctest failure onOpenSolaris on more than one occasion. But it's not every reproducible. The test fails, then passes when rerun. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116779",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116780",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116781",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9866#event-24849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116782",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116783",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9866#issuecomment-116784",
    "user": "https://github.com/roed314"
}
```
