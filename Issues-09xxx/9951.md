...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119008",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I made the mistake the other day of creating an empty file. Mercruial checked it in OK.",
    "created_at": "2010-09-19T21:53:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119009",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>I made the mistake the other day of creating an empty file. Mercruial checked it in OK.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119010",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119011",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_9951-add_non-empty_fake_init_file_to_tests_french_book.patch](tarball://root/attachments/some-uuid/ticket9951/trac_9951-add_non-empty_fake_init_file_to_tests_french_book.patch) by @nexttime created at 2010-09-20 03:44:02\n\n*Non-empty* patch is up.",
    "created_at": "2010-09-20T03:44:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119012",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>Attachment [trac_9951-add_non-empty_fake_init_file_to_tests_french_book.patch](tarball://root/attachments/some-uuid/ticket9951/trac_9951-add_non-empty_fake_init_file_to_tests_french_book.patch) by @nexttime created at 2010-09-20 03:44:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119013",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>sorry, I don't know how to review this patch. On my side, `sage -b` works with the vanilla\nsage-4.6.alpha1.",
    "created_at": "2010-09-20T07:09:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119014",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>sorry, I don't know how to review this patch. On my side, `sage -b` works with the vanilla
sage-4.6.alpha1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119015",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119017",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119018",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119019",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9951#event-25107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119020",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9951#issuecomment-119021",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9951",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9951#event-25108"
}
```
