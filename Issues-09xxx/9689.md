...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112748",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112749",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112750",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Or replace \"float\" with \"RR\", etc.",
    "created_at": "2010-08-05T23:03:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112752",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Or replace "float" with "RR", etc.
...
```json
{
    "body": "<a id='comment:5'></a>Yes, we can get this to pass, but that is just covering up a bug, as the number should never be printed as `.8813735870195429` It is a numerically correct result, but it is not printed the way one would expect a piece of software to print the number. \n \t \t\nCarl Witty is of the opinion this is either a Maxima or ECL bug\n\nhttp://groups.google.com/group/sage-devel/msg/aa318e11e84afe8d?hl=en\n\nI think its better to leave the `asinh(1.0)` case failing. It will be a constant reminder we need to get a real solution, not hack the doctest to get it to pass. \n\nUltimately, I feel the doctest has discovered a bug, which is what a good test should do. \n\nDave",
    "created_at": "2010-08-05T23:19:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112753",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>Yes, we can get this to pass, but that is just covering up a bug, as the number should never be printed as `.8813735870195429` It is a numerically correct result, but it is not printed the way one would expect a piece of software to print the number. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112754",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I created #9693 to resolve the leading zero problem and are going to copy the problem to the ECL and Maxima mailing lists, to see if we get any response. \n\nDave",
    "created_at": "2010-08-05T23:48:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112755",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>I created #9693 to resolve the leading zero problem and are going to copy the problem to the ECL and Maxima mailing lists, to see if we get any response. 
...
```json
{
    "body": "<a id='comment:8'></a>This looks fine to me and passed tests (in that file) on both 32-bit and 64-bit ubuntu.",
    "created_at": "2010-08-12T17:49:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112756",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>This looks fine to me and passed tests (in that file) on both 32-bit and 64-bit ubuntu.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112757",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112758",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112759",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112760",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112761",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9689#issuecomment-112762",
    "user": "https://github.com/qed777"
}
```
