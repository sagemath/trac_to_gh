...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102450",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102451",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102452",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Depends on #9165, #9184, #9180.",
    "created_at": "2010-06-09T06:15:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102453",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>Depends on #9165, #9184, #9180.
...
```json
{
    "body": "<a id='comment:3'></a>Why do you write above that this \"Depends on #9165\"?  There is no code there, and that is related to the Cygwin port?",
    "created_at": "2010-07-08T14:55:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102454",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Why do you write above that this "Depends on #9165"?  There is no code there, and that is related to the Cygwin port?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102456",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,6 @@\n This is related to #4475.\n+\n+See also this psage ticket:\u00a0http://code.google.com/p/purplesage/issues/detail?id=14\n \n Summary: Proveable computation of L-functions\n \n``````\n",
    "created_at": "2010-12-08T10:58:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102457",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This is done except for doctests on some functions (though it could use some optimisations too).",
    "created_at": "2011-03-27T05:20:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102458",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:8'></a>This is done except for doctests on some functions (though it could use some optimisations too).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102459",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Attachment [9193-part4-proveable.patch](tarball://root/attachments/some-uuid/ticket9193/9193-part4-proveable.patch) by @williamstein created at 2011-08-25 06:58:42\n\nAll patches apply (with a minor rebase) and mostly work.  However, there is one bug. \n\n```\nUnfortunately, this is wrong, since the coefficients of 1 and T have\nto be 0.0000?.  However, the output *is* correct to 10 bits of\nprecision, so the correct fix is just to truncate.::\n\n    sage: L = LFunction(EllipticCurve('389a'))\n    sage: L.taylor_series(RealField(10)(1), 3, proof=True)\n    -0.00002125? + 0.00001204?*T + 0.75933?*T^2 - 0.43032?*T^3 + O(T^4)\n```",
    "created_at": "2011-08-25T06:58:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102460",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:10'></a>Attachment [9193-part4-proveable.patch](tarball://root/attachments/some-uuid/ticket9193/9193-part4-proveable.patch) by @williamstein created at 2011-08-25 06:58:42
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102461",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [9193-part5-docstrings-and-prec-fix.patch](tarball://root/attachments/some-uuid/ticket9193/9193-part5-docstrings-and-prec-fix.patch) by @jdemeyer created at 2013-08-13 15:35:53",
    "created_at": "2013-08-13T15:35:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9193#issuecomment-102462",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Attachment [9193-part5-docstrings-and-prec-fix.patch](tarball://root/attachments/some-uuid/ticket9193/9193-part5-docstrings-and-prec-fix.patch) by @jdemeyer created at 2013-08-13 15:35:53
