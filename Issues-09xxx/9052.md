...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9052#event-104953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9052#event-104954"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9052#issuecomment-76568",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9052#issuecomment-76569",
    "user": "https://github.com/JohnCremona"
}
```
