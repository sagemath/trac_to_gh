...
archive/attachments_012419.json:
```json
{
...
```json
{
    "body": "**Attachment:** [install.patch](https://github.com/sagemath/sage/files/ticket9418/install.patch)\n\nPatch for the install file in the sage_scripts-4.6.1.alpha1 package.",
    "created_at": "2010-11-13T23:48:57Z",
    "issue": "https://github.com/sagemath/sage/issues/9418",
    "type": "issue_comment",
...
**Attachment:** [install.patch](https://github.com/sagemath/sage/files/ticket9418/install.patch)
...
archive/attachments_012420.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "install",
...
```json
{
    "body": "**Attachment:** [install](https://github.com/sagemath/sage/files/ticket9418/install)\n\nReplacement 'install' file",
    "created_at": "2010-11-13T23:51:31Z",
    "issue": "https://github.com/sagemath/sage/issues/9418",
    "type": "issue_comment",
...
**Attachment:** [install](https://github.com/sagemath/sage/files/ticket9418/install)
...
archive/attachments_012421.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "SPKG.txt",
...
archive/attachments_012422.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "spkg-check",
    "asset_url": "tarball://root/attachments/ticket9418/spkg-check",
    "created_at": "2010-11-14T00:36:43Z",
    "issue": "https://github.com/sagemath/sage/issues/9418",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9418/spkg-check",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_012423.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [spkg-check](https://github.com/sagemath/sage/files/ticket9418/spkg-check)\n\n**Attachment:** [spkg-install](https://github.com/sagemath/sage/files/ticket9418/spkg-install)\n\nspkg-install",
    "created_at": "2010-11-14T00:36:43Z",
    "issue": "https://github.com/sagemath/sage/issues/9418",
    "type": "issue_comment",
...
**Attachment:** [spkg-check](https://github.com/sagemath/sage/files/ticket9418/spkg-check)
...
archive/attachments_012424.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [9418_install.patch](https://github.com/sagemath/sage/files/ticket9418/9418_install.patch)\n\nAdded ticket number to file name",
    "created_at": "2010-11-14T11:07:09Z",
    "issue": "https://github.com/sagemath/sage/issues/9418",
    "type": "issue_comment",
...
**Attachment:** [9418_install.patch](https://github.com/sagemath/sage/files/ticket9418/9418_install.patch)
...
archive/attachments_012425.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "deps",
...
```json
{
    "body": "**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket9418/deps)\n\nCorectted 'deps' file, with SQLALCHEMY taken care of",
    "created_at": "2010-11-15T12:34:32Z",
    "issue": "https://github.com/sagemath/sage/issues/9418",
    "type": "issue_comment",
...
**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket9418/deps)
...
archive/attachments_012426.json:
```json
{
    "asset_content_type": "application/octet-stream",
