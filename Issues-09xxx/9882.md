...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9882#event-113180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9882#event-113181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9882#event-113182"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9882#issuecomment-90737",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9882#issuecomment-90738",
    "user": "https://github.com/mezzarobba"
}
```
