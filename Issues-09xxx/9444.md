...
archive/attachments_012519.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_9444-spkg_build_dir_t2.patch](https://github.com/sagemath/sage/files/ticket9444/trac_9444-spkg_build_dir_t2.patch)\n\nStep out of spkg/build/foo-x.y.z before deleting it.",
    "created_at": "2010-07-07T05:37:54Z",
    "issue": "https://github.com/sagemath/sage/issues/9444",
    "type": "issue_comment",
...
**Attachment:** [trac_9444-spkg_build_dir_t2.patch](https://github.com/sagemath/sage/files/ticket9444/trac_9444-spkg_build_dir_t2.patch)
