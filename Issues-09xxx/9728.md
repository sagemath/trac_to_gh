...
archive/attachments_012517.json:
```json
{
...
```json
{
    "body": "Attachment [linear_transformation_interact.patch](https://github.com/sagemath/sage/files/ticket9728/linear_transformation_interact.patch) by punchagan created at 2010-08-11 21:34:21",
    "created_at": "2010-08-11T21:34:21Z",
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87760",
    "user": "https://trac.sagemath.org/admin/accounts/users/punchagan"
}
```

Attachment [linear_transformation_interact.patch](https://github.com/sagemath/sage/files/ticket9728/linear_transformation_interact.patch) by punchagan created at 2010-08-11 21:34:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87762",
...
archive/attachments_012518.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [trac_9728_add_user_definable_matrix.patch](https://github.com/sagemath/sage/files/ticket9728/trac_9728_add_user_definable_matrix.patch) by samhop created at 2010-11-07 07:17:05\n\nadds capability for user to set the matrix defining the transformation",
    "created_at": "2010-11-07T07:17:05Z",
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87763",
    "user": "https://trac.sagemath.org/admin/accounts/users/samhop"
}
```

Attachment [trac_9728_add_user_definable_matrix.patch](https://github.com/sagemath/sage/files/ticket9728/trac_9728_add_user_definable_matrix.patch) by samhop created at 2010-11-07 07:17:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87764",
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [linear_transformation.png](https://github.com/sagemath/sage/files/ticket9728/linear_transformation.png) by mhampton created at 2011-01-12 23:13:11",
    "created_at": "2011-01-12T23:13:11Z",
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87765",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9728#issuecomment-87766",
    "user": "https://github.com/kcrisman"
}
```
