...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111282"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111294"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -7,3 +7,7 @@\n ```\n \n The docs say it should fill the region f(x)<0.\n+\n+---\n+\n+Apply: [attachment: trac_9744_v2.patch.gz](https://github.com/sagemath/sage/files/ticket9744/trac_9744_v2.patch.gz)\n``````\n",
    "created_at": "2012-02-24T02:14:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9744",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9744#issuecomment-88149",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9744",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9744#event-111298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9744#issuecomment-88150",
