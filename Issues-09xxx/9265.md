...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104578"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104580"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104581"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,3 @@\n The `CombinatorialClass` class is being deprecated.  See [Sage Combinat Roadmap](http://trac.sagemath.org/sage_trac/wiki/SageCombinatRoadMap) for more information.  This ticket will handle removing this class from sage.combinat.tableau.  See also some discussion of this on [this thread](http://groups.google.com/group/sage-combinat-devel/browse_thread/thread/1819418007f5157).\n+\n+**Apply:** [attachment: trac_9265_tableaux_categories_jb.patch.gz](https://github.com/sagemath/sage/files/ticket9265/trac_9265_tableaux_categories_jb.patch.gz)\n``````\n",
    "created_at": "2011-05-20T16:59:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9265",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104582"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104585"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104586"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,5 @@\n The `CombinatorialClass` class is being deprecated.  See [Sage Combinat Roadmap](http://trac.sagemath.org/sage_trac/wiki/SageCombinatRoadMap) for more information.  This ticket will handle removing this class from sage.combinat.tableau.  See also some discussion of this on [this thread](http://groups.google.com/group/sage-combinat-devel/browse_thread/thread/1819418007f5157).\n \n- \n+**Apply:** [attachment: trac_9265_tableaux_categories_am.patch.gz](https://github.com/sagemath/sage/files/ticket9265/trac_9265_tableaux_categories_am.patch.gz)\n \n-**Apply:** [attachment: trac_9265_tableaux_categories_am.patch.gz](https://github.com/sagemath/sage/files/ticket9265/trac_9265_tableaux_categories_am.patch.gz)\n+**Update pickles:** [attachment: pickle_jar.tar.bz2.gz](https://github.com/sagemath/sage/files/ticket9265/pickle_jar.tar.bz2.gz)\n``````\n",
...
```json
{
    "body": "Changed keywords from **** to **tableaux, combinatorics**",
    "created_at": "2012-08-16T18:41:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9265",
    "type": "issue_comment",
...
Changed keywords from **** to **tableaux, combinatorics**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104587"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104589"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104599"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9265",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104600"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104601"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9265#issuecomment-79958",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9265#issuecomment-79959",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9265",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9265#event-104607"
}
```
