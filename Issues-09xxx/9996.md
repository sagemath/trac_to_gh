...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9996#issuecomment-120402",
...
```json
{
    "body": "<a id='comment:2'></a>Can you give me the uname -m or uname -a or whatever will tell me this is an AIX machine. It's only a single line in the flint makefile to fix this.\n\nI assume it is flint 1.6.",
    "created_at": "2012-06-01T18:21:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9996#issuecomment-120403",
    "user": "https://trac.sagemath.org/admin/accounts/users/wbhart"
}
```

<a id='comment:2'></a>Can you give me the uname -m or uname -a or whatever will tell me this is an AIX machine. It's only a single line in the flint makefile to fix this.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25335"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25336"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25337"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25338"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25339"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25340"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9996#issuecomment-120404",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25342"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9996#issuecomment-120405",
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25344"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9996#issuecomment-120406",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9996",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9996#event-25346"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9996#issuecomment-120407",
