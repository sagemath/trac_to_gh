...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9138#event-106222"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9138#event-106223"
}
```
...
```json
{
    "body": "<a id='comment:67'>Comment 67:</a>\nReplying to [@jhpalmieri](#comment%3A66):\n> I wonder if the Steenrod algebra problem is due to #10052, which was merged in 4.7.1.alpha3.\n\nI wouldn't say \"due to\", since the critical tests (perhaps introduced by #10052) pass with sage-4.7.1.rc1. In fact, I already found out that [attachment: trac9138-categories_for_rings.patch.gz](https://github.com/sagemath/sage/files/ticket9138/trac9138-categories_for_rings.patch.gz) is to blame. But I don't know yet what went wrong.",
...
```json
{
    "body": "<a id='comment:82'>Comment 82:</a>\nI am currently getting doctest failures with my patches, when I start with sage-4.7.1.rc2 and some other patches.\n\nI seems likely that the errors come from [attachment: trac9138-categories_for_rings.patch.gz](https://github.com/sagemath/sage/files/ticket9138/trac9138-categories_for_rings.patch.gz), but it needs further investigation. For the moment, it needs work.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -28,8 +28,4 @@\n \n Depends on #11268, #11139, #9976, #9944, #11269\n \n-Apply \n-\n-- [attachment: trac9138-categories_for_rings.patch.gz](https://github.com/sagemath/sage/files/ticket9138/trac9138-categories_for_rings.patch.gz)\n-- [attachment: trac9138_categories_for_more_rings.patch.gz](https://github.com/sagemath/sage/files/ticket9138/trac9138_categories_for_more_rings.patch.gz)\n-- [attachment: trac9138_remove_unused_code.patch.gz](https://github.com/sagemath/sage/files/ticket9138/trac9138_remove_unused_code.patch.gz)\n+Apply [attachment: 9138_flat.patch.gz](https://github.com/sagemath/sage/files/ticket9138/9138_flat.patch.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -26,6 +26,6 @@\n \n Many other rings are not properly initialised as well. The aim of this ticket is to change that.\n \n-Apply [attachment: 9138_flat.patch.gz](https://github.com/sagemath/sage/files/ticket9138/9138_flat.patch.gz)\n+Apply [attachment: 9138_flat_new_cython.patch.gz](https://github.com/sagemath/sage/files/ticket9138/9138_flat_new_cython.patch.gz)\n \n See #11900 for a follow-up fixing some speed regressions.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9138#issuecomment-78074",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9138#issuecomment-78075",
    "user": "https://github.com/jdemeyer"
}
```
