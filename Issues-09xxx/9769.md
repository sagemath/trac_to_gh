...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114570",
    "user": "https://trac.sagemath.org/admin/accounts/users/maldun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114571",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114572",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114573",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [burcin](#comment%3A2):\n> The `__call__()` function of RR[x] doesn't conform to the generic definition. You should be able to give the parameters as a keyword argument as well. This should be made to work:\n> \n> \n> ```\n> sage: R.<x> = RR[]\n> sage: (x^2+1)(x=5)\n> 11\n> ```\n\nThis is now #17311",
    "created_at": "2014-11-10T10:01:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114574",
    "user": "https://github.com/rwst"
}
```

<a id='comment:8'></a>Replying to [burcin](#comment%3A2):
> The `__call__()` function of RR[x] doesn't conform to the generic definition. You should be able to give the parameters as a keyword argument as well. This should be made to work:
> 
> 
> ```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114575",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114576",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114577",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114578",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9769#issuecomment-114579",
