...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9694#event-114201"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9694#event-114202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9694#event-114203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9694#issuecomment-86987",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9694#issuecomment-86988",
    "user": "https://github.com/rbeezer"
}
```
