...
```json
{
    "body": "<a id='comment:24'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[6dcaebb](https://git.sagemath.org/sage.git/commit?id=6dcaebb5f95abdc78cce729bcced7dc96ee5cb1f)|`Use 'pip --isolated' and 'setup.py --no-user-cfg'`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[bf1b130](https://git.sagemath.org/sage.git/commit/?id=bf1b13041905472da8dc3fd25426ea2f64c2129a)|`Use 'pip --isolated' and 'setup.py --no-user-cfg'`|\n|[c218299](https://git.sagemath.org/sage.git/commit/?id=c21829914692175177a5a66775c015719fd450fd)|`pyzmq: Fix pip install command line`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[1ea8221](https://git.sagemath.org/sage.git/commit/?id=1ea8221f665cf3e3815b7cff7f9971aba8c9bf9c)|`Use 'pip --isolated' and 'setup.py --no-user-cfg'`|\n|[375faba](https://git.sagemath.org/sage.git/commit/?id=375faba4699c44e2be0ecceddfbca29de2770f85)|`pyzmq: Fix pip install command line`|",
