...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9693#issuecomment-86973",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout, @sagetrac-jkantor** to **@sagetrac-drkirkby**",
    "created_at": "2010-08-06T00:00:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9693#issuecomment-86974",
    "user": "https://github.com/sagetrac-drkirkby"
}
```

Changed assignee from **@jasongrout, @sagetrac-jkantor** to **@sagetrac-drkirkby**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9693#event-114201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9693#event-114202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9693",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9693#event-114203"
}
```
