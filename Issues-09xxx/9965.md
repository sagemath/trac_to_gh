...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9965#event-118303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9965#event-118304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9965#event-118305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9965",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9965#issuecomment-92665",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9965",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9965#issuecomment-92666",
    "user": "https://github.com/jdemeyer"
}
```
