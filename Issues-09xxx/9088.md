...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100396",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Fix attached.  This should be a trivial review!",
    "created_at": "2010-05-29T19:53:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100397",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Fix attached.  This should be a trivial review!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100398",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100399",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100400",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100401",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'm not exactly sure how the texture numbers get decided, but I think there is some linear order involved with their names.  Anyway, this is easy enough to fix.  We should definitely apply #9088 first because it is much more annoying, and then it would be very simple to add a reviewer patch to fix these trivialities.\n\nI'll leave this as positive review until the release manager decides what order to merge these in, though - wouldn't want to overstep his prerogative :)  then he can mark whichever one needs work thus.",
    "created_at": "2010-07-01T13:47:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100403",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>I'm not exactly sure how the texture numbers get decided, but I think there is some linear order involved with their names.  Anyway, this is easy enough to fix.  We should definitely apply #9088 first because it is much more annoying, and then it would be very simple to add a reviewer patch to fix these trivialities.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100404",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9088#issuecomment-100405",
    "user": "https://github.com/qed777"
}
```
