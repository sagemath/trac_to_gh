...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107431",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107432",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I can yet say I get doctest errors related to this spkg (with Sage 4.5.alpha4), but the complete test will take some hours... (i.e. more to come later).",
    "created_at": "2010-07-07T13:11:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107433",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>I can yet say I get doctest errors related to this spkg (with Sage 4.5.alpha4), but the complete test will take some hours... (i.e. more to come later).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107434",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I forgot to put in the patch for that. New version now at the same url.\n\nTo test sagenb packages, all you need to do is install it via `sage -f sagenb-0.8.1.spkg` and run `sage -t -sagenb`.",
    "created_at": "2010-07-07T15:14:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107436",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:5'></a>I forgot to put in the patch for that. New version now at the same url.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107437",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107438",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107439",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I don't know if this is sufficient, but after forcing reinstallation of Tim's corrected SageNB package, `./sage -t -sagenb` and `./sage -t -long -sagenb` (there seem to be no `long` tests) passed all tests, especially the (only) one that previously failed.\n\nSo I can give it a **positive review**, unless somebody tells me what further tests should be performed.\n\nI'll test it on Ubuntu 9.04 x86_64 tomorrow.",
    "created_at": "2010-07-07T17:27:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107440",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>I don't know if this is sufficient, but after forcing reinstallation of Tim's corrected SageNB package, `./sage -t -sagenb` and `./sage -t -long -sagenb` (there seem to be no `long` tests) passed all tests, especially the (only) one that previously failed.
...
```json
{
    "body": "<a id='comment:8'></a>Rebuilding the HTML documentation also succeeded (except for the missing `conf.py` in `thematic_tutorials`, which is unrelated).",
    "created_at": "2010-07-07T18:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107441",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>Rebuilding the HTML documentation also succeeded (except for the missing `conf.py` in `thematic_tutorials`, which is unrelated).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107442",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107443",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107444",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Moving to positive review. I'm about to release rc0, so this will get plenty of testing on all platforms.",
    "created_at": "2010-07-08T19:52:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107445",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:10'></a>Moving to positive review. I'm about to release rc0, so this will get plenty of testing on all platforms.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107446",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107447",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9430#issuecomment-107448",
    "user": "https://github.com/rlmill"
}
```
