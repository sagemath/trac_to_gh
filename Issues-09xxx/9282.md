...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9282#issuecomment-80099",
    "user": "https://trac.sagemath.org/admin/accounts/users/retry"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [test.log](https://github.com/sagemath/sage/files/ticket9282/test.log) by retry created at 2010-06-22 07:45:38\n\nRecompiled sage - no more problems.",
    "created_at": "2010-06-22T07:45:38Z",
    "issue": "https://github.com/sagemath/sage/issues/9282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9282#issuecomment-80100",
    "user": "https://trac.sagemath.org/admin/accounts/users/retry"
}
```
