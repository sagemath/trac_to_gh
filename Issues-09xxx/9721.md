...
```json
{
    "body": "<a id='comment:1'></a>Note that neither the M4RI library **nor the GD library** (in the second attempt) are found, so this is not directly (or exclusively) related to removing the M4RI source tree.\n\nIt seems some SCons parameters have gotten messed up during the upgrade process. I'm currently trying to reproduce this error on Linux (though frankly speaking I expect this to be Apple-specific once again...)\n\nCan someone try to reproduce this on other MacOS X boxes?",
    "created_at": "2010-08-11T02:18:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113604",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Note that neither the M4RI library **nor the GD library** (in the second attempt) are found, so this is not directly (or exclusively) related to removing the M4RI source tree.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113605",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113606",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This might be relevant http://trac.sagemath.org/sage_trac/ticket/9717#comment:5",
    "created_at": "2010-08-11T12:12:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113607",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>This might be relevant http://trac.sagemath.org/sage_trac/ticket/9717#comment:5
...
```json
{
    "body": "<a id='comment:5'></a>Is it possible that #9717, which we merged into 4.5.3.alpha1, has fixed this problem?",
    "created_at": "2010-08-17T07:14:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113608",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>Is it possible that #9717, which we merged into 4.5.3.alpha1, has fixed this problem?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113609",
...
```json
{
    "body": "<a id='comment:7'></a>Well, I was able to upgrade from the (broken) 4.5.2 to 4.5.3.alpha1 with no problems and all tests seem to be passing.  Is that good enough?",
    "created_at": "2010-08-17T19:05:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113610",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>Well, I was able to upgrade from the (broken) 4.5.2 to 4.5.3.alpha1 with no problems and all tests seem to be passing.  Is that good enough?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9721#issuecomment-113611",
    "user": "https://github.com/qed777"
}
```
