...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9619#issuecomment-85957",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9619#issuecomment-85958",
    "user": "https://github.com/sagetrac-lsampaio"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9619#event-113149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9619#event-113150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9619",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9619#event-113151"
}
```
