...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9419",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9419#issuecomment-82485",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9419",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9419#issuecomment-82486",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9419",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9419#issuecomment-82487",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [trac_9419-part2.patch](https://github.com/sagemath/sage/files/ticket9419/trac_9419-part2.patch)",
    "created_at": "2011-12-19T21:21:22Z",
    "issue": "https://github.com/sagemath/sage/issues/9419",
    "type": "issue_comment",
...
**Attachment:** [trac_9419-part2.patch](https://github.com/sagemath/sage/files/ticket9419/trac_9419-part2.patch)
...
```json
{
    "body": "**Changing work issues** from \"finance.py.patch in too many places\" to \"\".",
...
**Changing work issues** from "finance.py.patch in too many places" to "".
