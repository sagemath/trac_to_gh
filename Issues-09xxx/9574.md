...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85092",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85093",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85094",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_9574_add_files_to_scripts_hgignore.patch](https://github.com/sagemath/sage/files/ticket9574/trac_9574_add_files_to_scripts_hgignore.patch) by @dandrake created at 2010-07-23 03:13:55\n\nI've attached a patch that adds all the above files to the .hgignore file.",
    "created_at": "2010-07-23T03:13:55Z",
    "issue": "https://github.com/sagemath/sage/issues/9574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85095",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85096",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85097",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9574#issuecomment-85098",
    "user": "https://github.com/dandrake"
}
```
