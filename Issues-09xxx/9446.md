...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110613"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9446#issuecomment-83204",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9446#issuecomment-83205",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110617"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout** to **@sagetrac-mvngu**",
    "created_at": "2010-10-02T21:38:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9446",
    "type": "issue_comment",
...
Changed assignee from **@jasongrout** to **@sagetrac-mvngu**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110618"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110620"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110621"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110622"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110623"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110624"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9446",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9446#event-110626"
}
```
