...
```json
{
    "body": "<a id='comment:1'></a>This does not look like a timeout to me - at least not like one I've seen. Have you set something like the following?\n\n```\nSAGE_TIMEOUT_LONG=10000\nSAGE_TIMEOUT=1000\nexport SAGE_TIMEOUT_LONG\nexport SAGE_TIMEOUT\n```\n\nI'm just making a build on t2 myself. I'll see if I get this issue.",
    "created_at": "2010-07-07T07:10:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108038",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>This does not look like a timeout to me - at least not like one I've seen. Have you set something like the following?
...
```json
{
    "body": "<a id='comment:3'></a>The first three times I ran the test, I had a failure.  Now I've run it without a failure, too, so I'm changing the \"blocker\" status.\n\nSince it's not even reproducible, should this ticket be closed?",
    "created_at": "2010-07-07T15:49:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108040",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>The first three times I ran the test, I had a failure.  Now I've run it without a failure, too, so I'm changing the "blocker" status.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108041",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108042",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108043",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108044",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108045",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Justin Walker has [seen this problem with 4.6.alpha2](http://groups.google.com/group/sage-release/msg/fe720bce3f933171) on two OS X 10.6.4 systems (Dual Quad Xeon, Core i7):\n\n```python\nsage -t  -long devel/sage/sage/misc/trace.py\n**********************************************************************\nFile \"/Users/Sage/sage-4.6.alpha0/devel/sage-main/sage/misc/trace.py\", line 61:\n    sage: print s.before[s.before.find('-'):]\nExpected:\n    ---...\n    ipdb> c\n    2 * 5\nGot:\n    -bit mode\n    Creating SAGE_LOCAL/lib/sage-64.txt since it does not exist\n    Detected SAGE64 flag\n    Building Sage on OS X in 64-bit mode\n    ----------------------------------------------------------------------\n    | Sage Version 4.6.alpha2, Release Date: 2010-09-29                  |\n    | Type notebook() for the GUI, and license() for information.        |\n    ----------------------------------------------------------------------\n    **********************************************************************\n    *                                                                    *\n    * Warning: this is a prerelease version, and it may be unstable.     *\n    *                                                                    *\n    **********************************************************************\n    trace('print factor(10)'); print 3+97\n    s\n    c\n    sage: trace('print factor(10)'); print 3+97\n    > <string>(1)<module>()\n    \n    ipdb> s\n    --Call--\n    > /Users/Sage/sage-4.6.alpha0/local/lib/python2.6/site-packages/sage/rings/arith.py(2153)factor()\n       2152 \n    -> 2153 def factor(n, proof=None, int_=False, algorithm='pari', verbose=0, **kwds):\n       2154     \"\"\"\n    \n    ipdb> c\n    2 * 5\n    <BLANKLINE>\n```",
    "created_at": "2010-10-02T21:38:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108046",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>Justin Walker has [seen this problem with 4.6.alpha2](http://groups.google.com/group/sage-release/msg/fe720bce3f933171) on two OS X 10.6.4 systems (Dual Quad Xeon, Core i7):
...
```json
{
    "body": "<a id='comment:7'></a>I'm changing the priority of this to the default \"major\" since it was only changed to minor when it was thought to be almost a non-issue. \n\nDave",
    "created_at": "2010-10-03T05:36:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108047",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>I'm changing the priority of this to the default "major" since it was only changed to minor when it was thought to be almost a non-issue. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108049",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108050",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108051",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I've attached a patch that increases the timeout to 90 seconds.",
    "created_at": "2010-10-10T03:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108052",
    "user": "https://github.com/qed777"
}
```

<a id='comment:11'></a>I've attached a patch that increases the timeout to 90 seconds.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108053",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108055",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108056",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I did 'make NUM_THREADS=10 ptestlong' on a 4.7.rc4 build on skynet/eno and had one test failure, which passed with I ran it individually.  (So I suspect a timeout problem.)  I then applied the patch and did 'make NUM_THREADS=10 ptestlong' again, and this time all the tests passed. \n\nPositive review.",
    "created_at": "2011-05-26T15:57:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108057",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```

<a id='comment:14'></a>I did 'make NUM_THREADS=10 ptestlong' on a 4.7.rc4 build on skynet/eno and had one test failure, which passed with I ran it individually.  (So I suspect a timeout problem.)  I then applied the patch and did 'make NUM_THREADS=10 ptestlong' again, and this time all the tests passed. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108058",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9446#issuecomment-108059",
    "user": "https://github.com/jdemeyer"
}
```
