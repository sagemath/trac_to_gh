...
archive/attachments_012829.json:
```json
{
...
```json
{
    "body": "**Attachment:** [9657.patch](https://github.com/sagemath/sage/files/ticket9657/9657.patch)\n\nMercurial patch to allow cvxopt to build with gcc 4.5.0 and later",
    "created_at": "2010-08-01T07:43:53Z",
    "issue": "https://github.com/sagemath/sage/issues/9657",
    "type": "issue_comment",
...
**Attachment:** [9657.patch](https://github.com/sagemath/sage/files/ticket9657/9657.patch)
