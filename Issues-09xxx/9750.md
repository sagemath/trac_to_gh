...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88145",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88146",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88147",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [9750.patch](https://github.com/sagemath/sage/files/ticket9750/9750.patch) by @JohnCremona created at 2010-08-15 17:17:39\n\nLooks good (apart from one Sphinx warning which my reviewer patch fixes).\n\nIs there a good reference, say in the PARI reference manual, for the GRH assumptions?",
    "created_at": "2010-08-15T17:17:39Z",
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88148",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [trac_9750-review.patch](https://github.com/sagemath/sage/files/ticket9750/trac_9750-review.patch) by @JohnCremona created at 2010-08-15 17:18:22\n\nApply after previous (and both depend on #9343)",
    "created_at": "2010-08-15T17:18:22Z",
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88149",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [trac_9750-review.patch](https://github.com/sagemath/sage/files/ticket9750/trac_9750-review.patch) by @JohnCremona created at 2010-08-15 17:18:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88150",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88151",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88152",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88153",
...
```json
{
    "body": "<a id='comment:10'></a>\nAttachment [9750_v2.patch](https://github.com/sagemath/sage/files/ticket9750/9750_v2.patch) by @qed777 created at 2010-09-10 10:44:27",
    "created_at": "2010-09-10T10:44:27Z",
    "issue": "https://github.com/sagemath/sage/issues/9750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9750#issuecomment-88154",
    "user": "https://github.com/qed777"
}
```
