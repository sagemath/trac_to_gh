...
```json
{
    "body": "<a id='comment:2'></a>This can be closed when #9871 is closed. \n\nAnother relevant ticket is #9870, which should sort out many of the issues with Cliquer. \n\nDave",
    "created_at": "2010-09-13T21:57:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9833#issuecomment-116190",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>This can be closed when #9871 is closed. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9833#issuecomment-116191",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9833#event-24754"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I'm closing this ticket as a \"duplicate\" of #9871.  Please reopen it, if the Cliquer relocation error remains or reappears.",
    "created_at": "2010-09-16T21:54:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9833#issuecomment-116192",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>I'm closing this ticket as a "duplicate" of #9871.  Please reopen it, if the Cliquer relocation error remains or reappears.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9833#event-24755"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9833#issuecomment-116193",
    "user": "https://github.com/qed777"
}
```
