...
```json
{
    "body": "Changed assignee from **@aghitza** to **@jasongrout, @sagetrac-jkantor**",
    "created_at": "2013-06-14T18:32:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9263",
    "type": "issue_comment",
...
Changed assignee from **@aghitza** to **@jasongrout, @sagetrac-jkantor**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9263",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9263#event-108007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9263#event-108008"
}
```
