...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9826#event-116293"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9826#event-116294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9826#event-116295"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -62,3 +62,5 @@\n ------------------------------------------------------------\n ```\n Environment: Sage 4.5.2 on Mac OS X 10.5.8 (32 bit).\n+\n+Apply [attachment: sage-trac_9826.patch.gz](https://github.com/sagemath/sage/files/ticket9826/sage-trac_9826.patch.gz) to the sage repository.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9826#issuecomment-89664",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9826#issuecomment-89665",
