...
```json
{
    "body": "<a id='comment:2'></a>Leif: is that the only failure in all long doctests (i.e., ptestlong or similar?)\n\nIf not, I'll run ptestlong to check.",
    "created_at": "2010-09-16T09:16:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118166",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>Leif: is that the only failure in all long doctests (i.e., ptestlong or similar?)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118167",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24988"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24989"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24990"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24991"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24992"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24993"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24994"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24995"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118168",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118169",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118170",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118171",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9912#issuecomment-118172",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9912",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9912#event-24997"
}
```
