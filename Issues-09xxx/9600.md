...
```json
{
    "body": "Changed assignee from **@peterjeremy** to **@sagetrac-GeorgSWeber**",
...
Changed assignee from **@peterjeremy** to **@sagetrac-GeorgSWeber**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9600#event-112879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9600#event-112880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9600",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9600#event-112881"
}
```
