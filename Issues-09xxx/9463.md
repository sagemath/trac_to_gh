...
```json
{
    "body": "<a id='comment:1'></a>This is because of the way PARI factors number (first trial division, then perfect power checking).  See http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1074",
    "created_at": "2010-07-11T08:03:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9463",
    "type": "issue_comment",
...
<a id='comment:1'></a>This is because of the way PARI factors number (first trial division, then perfect power checking).  See http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1074
...
```json
{
    "body": "<a id='comment:3'></a>Examples take milliseconds now even on old computer, so I guess this has been fixed and can be closed.",
...
<a id='comment:3'></a>Examples take milliseconds now even on old computer, so I guess this has been fixed and can be closed.
