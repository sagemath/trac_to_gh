...
```json
{
    "body": "<a id='comment:1'></a>This is somewhat slower because Integer.__init__ has a bunch of case statements.  But the patch at #9887 speeds it up some.  If #9887 is positively reviewed, I would suggest closing this ticket.",
    "created_at": "2010-09-23T11:29:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117376",
    "user": "https://github.com/roed314"
}
```

<a id='comment:1'></a>This is somewhat slower because Integer.__init__ has a bunch of case statements.  But the patch at #9887 speeds it up some.  If #9887 is positively reviewed, I would suggest closing this ticket.
...
```json
{
    "body": "<a id='comment:2'></a>Thinking about it a bit more, we could move the \n`PyObject_HasAttrString(x, \"_integer_\")` check up in `Integer.__init__`.  It should probably be after Integer and Int, but could move above some of the other ones.",
    "created_at": "2010-10-15T08:46:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117377",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>Thinking about it a bit more, we could move the 
`PyObject_HasAttrString(x, "_integer_")` check up in `Integer.__init__`.  It should probably be after Integer and Int, but could move above some of the other ones.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117378",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117379",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117380",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117381",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This at least helps a bit (dropping from 900ns to 580ns in my tests) by avoiding a double attribute lookup that was already highlighted as undesirable in the code.\n\n---\nNew commits:",
    "created_at": "2014-03-14T22:24:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117382",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:4'></a>This at least helps a bit (dropping from 900ns to 580ns in my tests) by avoiding a double attribute lookup that was already highlighted as undesirable in the code.
...
```json
{
    "body": "<a id='comment:5'></a>Looks like we have been working on the issue at the same time! My go at it is at `u/mmezzarobba/9885-intmod_to_int`. And I get:\n* with `develop`:\n  {{{\n  sage: R = Integers(3^20); u = R(2)\n  sage: %timeit u.lift()\n  10000000 loops, best of 3: 106 ns per loop\n  sage: %timeit Integer(u)\n  1000000 loops, best of 3: 466 ns per loop\n  }}}\n* with your patch:\n  {{{\n  sage: %timeit Integer(u)\n  1000000 loops, best of 3: 327 ns per loop\n  }}}\n* with mine:\n  {{{\n  sage: %timeit Integer(u)\n  1000000 loops, best of 3: 289 ns per loop\n  }}}\nSo apparently my version is slightly faster... at least on this particular example.",
    "created_at": "2014-03-15T12:52:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117383",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:5'></a>Looks like we have been working on the issue at the same time! My go at it is at `u/mmezzarobba/9885-intmod_to_int`. And I get:
* with `develop`:
  {{{
  sage: R = Integers(3^20); u = R(2)
  sage: %timeit u.lift()
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117385",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117386",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117388",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117389",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>You are of course right. I think the hybrid version I tested was with `PyObject_GetAttrString`.\n\n---\nNew commits:",
    "created_at": "2014-03-16T09:03:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117390",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:10'></a>You are of course right. I think the hybrid version I tested was with `PyObject_GetAttrString`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117391",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117392",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Nils, any chance you can have a quick look at my second commit and set the ticket to positive review? Thanks!",
    "created_at": "2014-04-11T15:45:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117393",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:11'></a>Nils, any chance you can have a quick look at my second commit and set the ticket to positive review? Thanks!
...
```json
{
    "body": "<a id='comment:12'></a>The docstring of `set_from_pari_gen()` doesn't have the right format, it should be an indented `EXAMPLE[S]::` or `TEST[S]::` block, maybe with a line of explanation.",
    "created_at": "2014-05-05T17:19:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117394",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:12'></a>The docstring of `set_from_pari_gen()` doesn't have the right format, it should be an indented `EXAMPLE[S]::` or `TEST[S]::` block, maybe with a line of explanation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117395",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117396",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117397",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117398",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117399",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117400",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I can confirm the speedup, if doctests pass I'll give this a positive review.",
    "created_at": "2014-05-05T20:14:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117401",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:15'></a>I can confirm the speedup, if doctests pass I'll give this a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117402",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117403",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9885#event-24894"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9885#issuecomment-117404",
    "user": "https://github.com/vbraun"
}
```
