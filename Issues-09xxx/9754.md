...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_9754-random-subspaces-unimodular-matrices.patch](https://github.com/sagemath/sage/files/ticket9754/trac_9754-random-subspaces-unimodular-matrices.patch)",
    "created_at": "2010-08-17T00:10:40Z",
    "issue": "https://github.com/sagemath/sage/issues/9754",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_9754-random-subspaces-unimodular-matrix-v3.patch](https://github.com/sagemath/sage/files/ticket9754/trac_9754-random-subspaces-unimodular-matrix-v3.patch)\n\nrebased to go on top of #9802.  So apply v4 from #9720, v2 from #9803, and v2 from #9802",
    "created_at": "2010-08-30T00:45:44Z",
    "issue": "https://github.com/sagemath/sage/issues/9754",
    "type": "issue_comment",
...
**Attachment:** [trac_9754-random-subspaces-unimodular-matrix-v3.patch](https://github.com/sagemath/sage/files/ticket9754/trac_9754-random-subspaces-unimodular-matrix-v3.patch)
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [trac_9754-random-subspaces-unimodular-matrix-v4.patch](https://github.com/sagemath/sage/files/ticket9754/trac_9754-random-subspaces-unimodular-matrix-v4.patch)\n\nThere was a bug in the v3 patch making all output matrices square, which is now fixed in the v4 patch.",
    "created_at": "2010-08-30T05:04:47Z",
    "issue": "https://github.com/sagemath/sage/issues/9754",
    "type": "issue_comment",
...
archive/attachments_013036.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_9754-random-subspaces-unimodular-matrix-v5.patch](https://github.com/sagemath/sage/files/ticket9754/trac_9754-random-subspaces-unimodular-matrix-v5.patch)\n\nRevisions to random_subspaces_matrix to make to replace ``nullity`` input with ``rank``.",
    "created_at": "2010-08-30T21:40:30Z",
    "issue": "https://github.com/sagemath/sage/issues/9754",
    "type": "issue_comment",
...
**Attachment:** [trac_9754-random-subspaces-unimodular-matrix-v5.patch](https://github.com/sagemath/sage/files/ticket9754/trac_9754-random-subspaces-unimodular-matrix-v5.patch)
...
archive/attachments_013037.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_013038.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_013039.json:
```json
{
    "asset_content_type": "application/octet-stream",
