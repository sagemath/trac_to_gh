...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82069",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82070",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9393/sage-trac_9393.patch",
    "created_at": "2012-01-09T04:28:53Z",
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9393/sage-trac_9393.patch",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [sage-trac_9393.patch](https://github.com/sagemath/sage/files/ticket9393/sage-trac_9393.patch) by @orlitzky created at 2012-01-09 04:28:53\n\nThis is fixed, so I've added a doctest for it.",
    "created_at": "2012-01-09T04:28:53Z",
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82071",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82072",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82073",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82074",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9393#issuecomment-82075",
