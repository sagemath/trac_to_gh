...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9511#event-111586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9511#event-111587"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9511#event-111588"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,5 +2,5 @@\n \n PS: Givaro 3.4.x is not compatible with LinBox yet since it introduces a `Givaro` namespace.\n \n-**Install** http://sage.math.washington.edu/home/malb/spkgs/givaro-3.3.6.spkg\n-**Apply**\n+* **Install** http://sage.math.washington.edu/home/malb/spkgs/givaro-3.3.6.spkg\n+* **Apply** [attachment: trac_9511_givaro_3_3_x.patch.gz](https://github.com/sagemath/sage/files/ticket9511/trac_9511_givaro_3_3_x.patch.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,4 @@\n-Givaro 3.3.x is a requirement for LinBox 1.1.7 which fixes some issues relevant to Sage. \n+Givaro 3.6.x is a requirement for LinBox 1.3.0.\n \n-PS: Givaro 3.4.x is not compatible with LinBox yet since it introduces a `Givaro` namespace.\n-\n-* **Install** http://sage.math.washington.edu/home/malb/spkgs/givaro-3.3.6.spkg\n-* **Apply** [attachment: trac_9511_givaro_3_3_x.patch.gz](https://github.com/sagemath/sage/files/ticket9511/trac_9511_givaro_3_3_x.patch.gz)\n+* **Install** http://sage.math.washington.edu/home/malb/spkgs/givaro-3.6.0.spkg\n+* **Apply** [attachment: trac_9511_givaro_3_6_x.patch.gz](https://github.com/sagemath/sage/files/ticket9511/trac_9511_givaro_3_6_x.patch.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,6 @@\n Givaro 3.6.x is a requirement for LinBox 1.3.0.\n \n * **Install** http://sage.math.washington.edu/home/malb/spkgs/givaro-3.7.0.spkg\n-* **Apply** [attachment: trac_9511_givaro_3_6_x.patch.gz](https://github.com/sagemath/sage/files/ticket9511/trac_9511_givaro_3_6_x.patch.gz)\n+* **Apply** [attachment: trac_9511_givaro_3_7_x.patch.gz](https://github.com/sagemath/sage/files/ticket9511/trac_9511_givaro_3_7_x.patch.gz)\n \n See https://bitbucket.org/malb/givaro-spkg for SPKG Repository.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9511#issuecomment-84137",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9511#issuecomment-84138",
    "user": "https://github.com/jdemeyer"
}
```
