...
```json
{
    "body": "<a id='comment:1'></a>I've been unable to replicate this.  I've built Sage 4.5.alpha4 with SAGE_FAT_BINARY and SAGE_PARALLEL_SPKG_BUILD both set to 'yes' and everything has come out fine.  I'll try again and see what happens...",
    "created_at": "2010-07-09T04:51:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108284",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>I've been unable to replicate this.  I've built Sage 4.5.alpha4 with SAGE_FAT_BINARY and SAGE_PARALLEL_SPKG_BUILD both set to 'yes' and everything has come out fine.  I'll try again and see what happens...
...
```json
{
    "body": "<a id='comment:3'></a>Addendum: I called the script in the previous comment `go` and ran it with `nohup go &`.",
    "created_at": "2010-07-09T05:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108286",
    "user": "https://github.com/qed777"
}
```

<a id='comment:3'></a>Addendum: I called the script in the previous comment `go` and ran it with `nohup go &`.
...
```json
{
    "body": "<a id='comment:4'></a>Yes, all my builds of sage that failed were with a script.   I didn't even use nohup, but just screen.\nThe scri[pt I used is /home/wstein/buildbot. \n\nI suspect somebody screwed up the maxima spkg, obviously, and removed some workaround for building under a script.",
    "created_at": "2010-07-09T06:00:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108287",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Yes, all my builds of sage that failed were with a script.   I didn't even use nohup, but just screen.
The scri[pt I used is /home/wstein/buildbot. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108288",
...
```json
{
    "body": "<a id='comment:6'></a>I'm running my whole test cycle here:\n\n   http://sage.math.washington.edu/home/wstein/build/sage-4.5.alphastein1/\n\nbut with ecl and maxima rolled back.",
    "created_at": "2010-07-09T11:59:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108289",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>I'm running my whole test cycle here:
...
```json
{
    "body": "<a id='comment:8'></a>I've built successfully by running the same script as William: I copied \"buildbot\" to /scratch/palmieri/new and ran it to build Sage.  I tried it with SAGE64='yes' and that worked, too.  I just tried running screen and then running buildbot, and that worked, too.  I just can't reproduce this.",
    "created_at": "2010-07-09T15:06:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108290",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>I've built successfully by running the same script as William: I copied "buildbot" to /scratch/palmieri/new and ran it to build Sage.  I tried it with SAGE64='yes' and that worked, too.  I just tried running screen and then running buildbot, and that worked, too.  I just can't reproduce this.
...
```json
{
    "body": "<a id='comment:9'></a>Replying to [mpatel](#comment%3A2):\n> The four builds are [here](http://sage.math.washington.edu/home/mpatel/stmp/).\n\n\nDid you compare the build trees?",
    "created_at": "2010-07-09T15:34:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108291",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>Replying to [mpatel](#comment%3A2):
> The four builds are [here](http://sage.math.washington.edu/home/mpatel/stmp/).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108293",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I changed `cd $HOME/scratch/tmp` to `cd /mnt/usb1/scratch/mpatel/tmp` in `go` and rebuilt `sage-4.5.alpha4-j20-par` as `sage-4.5.alpha4-j20-par-mod`.  The long tests now *pass.*  Hmm...",
    "created_at": "2010-07-09T23:20:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108294",
    "user": "https://github.com/qed777"
}
```

<a id='comment:12'></a>I changed `cd $HOME/scratch/tmp` to `cd /mnt/usb1/scratch/mpatel/tmp` in `go` and rebuilt `sage-4.5.alpha4-j20-par` as `sage-4.5.alpha4-j20-par-mod`.  The long tests now *pass.*  Hmm...
...
```json
{
    "body": "<a id='comment:13'></a>David Kirkby has had some suspicions about the way the disk storing the home directories on sage.math is set up.  I wonder if that's causing the problem here.",
    "created_at": "2010-07-10T00:06:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108295",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:13'></a>David Kirkby has had some suspicions about the way the disk storing the home directories on sage.math is set up.  I wonder if that's causing the problem here.
...
```json
{
    "body": "<a id='comment:14'></a>There is definitely a problem.  I tried rebuilding with the new maxima and ecl packages (in sage-4.5.alpha4) and had a huge number of failures.   Building the same sage-4.5.alpha4, but with the older maxima and ecl packages entirely fixes the problem.\n\n> David Kirkby has had some suspicions about the way the disk storing the home directories on \n> sage.math is set up. I wonder if that's causing the problem here.\n\n\nThat could be.  If true, it definitely means that we have a serious bug in Sage -- not our filesystem.    Here's my build setup:\n\n* I make a symlink:   /home/wstein/build -> /scratch/wstein/build\n* I build in /home/wstein/build.\n\nWilliam",
    "created_at": "2010-07-10T05:04:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108296",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:14'></a>There is definitely a problem.  I tried rebuilding with the new maxima and ecl packages (in sage-4.5.alpha4) and had a huge number of failures.   Building the same sage-4.5.alpha4, but with the older maxima and ecl packages entirely fixes the problem.
...
```json
{
    "body": "<a id='comment:15'></a>I can only tell I've successfully built Sage 4.5.alpha0, alpha1 and alpha4 with a similar link in my home directory to a different local filesystem, running `make` in the directory which is a symbolic link (Ubuntu 9.04).\n\nI wonder if what Mitesh and William observed is really reproducible, or just a strange coincidence.",
    "created_at": "2010-07-10T06:20:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108297",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:15'></a>I can only tell I've successfully built Sage 4.5.alpha0, alpha1 and alpha4 with a similar link in my home directory to a different local filesystem, running `make` in the directory which is a symbolic link (Ubuntu 9.04).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108298",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I mean I cannot see any reasonable cause in Mitesh's script vs. command line procedure; John has successfully built with your `buildbot` script. Reinstalling the packages or even just moving Sage seemed to solve the problems.\n\nIt's obviously an ECL/Maxima issue, but I think either related to uncatched or badly handled filesystem errors, or ECL again messing things up in concurrent builds.\n\nSo I'm not that sure that it's the package *version*, rather than the *build circumstances*.",
    "created_at": "2010-07-10T07:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108299",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:17'></a>I mean I cannot see any reasonable cause in Mitesh's script vs. command line procedure; John has successfully built with your `buildbot` script. Reinstalling the packages or even just moving Sage seemed to solve the problems.
...
```json
{
    "body": "<a id='comment:18'></a>Replying to [was](#comment%3A16):\n> Replying to [leif](#comment%3A15):\n> > I wonder if what Mitesh and William observed is really reproducible, or just a strange coincidence.\n\n> \n> It's reproducible since:\n> \n>   (1) I can systematically reproduce it, and \n>   (2) Mitesh independently reproduced it.\n> \n> That's pretty much the definition of reproducible.\n\n\nI should have written *deterministic*.",
    "created_at": "2010-07-10T08:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108300",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:18'></a>Replying to [was](#comment%3A16):
> Replying to [leif](#comment%3A15):
> > I wonder if what Mitesh and William observed is really reproducible, or just a strange coincidence.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108302",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108304",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Given Maxima has a library interface, should Maxima not be built before the Sage library, rather than the other way around? \n\n```\nkirkby@sage:~/sage-4.5.alpha4$ ls -lrt spkg/installed | egrep \"maxima|sage-4.5.alpha4\"\n-rw-r--r-- 1 kirkby kirkby 265 2010-07-09 08:41 sage-4.5.alpha4\n-rw-r--r-- 1 kirkby kirkby 266 2010-07-09 08:51 maxima-5.20.1.p1\n```\n\nI'm going to create a 'deps' file which will ensure Maxima builds before Sage. Give that a try. \n\nDave",
    "created_at": "2010-07-10T09:38:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108306",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:23'></a>Given Maxima has a library interface, should Maxima not be built before the Sage library, rather than the other way around? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108307",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108308",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Attachment [deps.diff](tarball://root/attachments/some-uuid/ticket9460/deps.diff) by @nexttime created at 2010-07-10 10:40:17\n\nReplying to [drkirkby](#comment%3A23):\n> Given Maxima has a library interface, should Maxima not be built before the Sage library, rather than the other way around?\n\n\nIn my *sequential* build, the Sage library was built **before** Maxima, while the other way around in the *parallel* build.\n\nBoth builds passed all doctests (`ptestlong`).",
    "created_at": "2010-07-10T10:40:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108309",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:24'></a>Attachment [deps.diff](tarball://root/attachments/some-uuid/ticket9460/deps.diff) by @nexttime created at 2010-07-10 10:40:17
...
```json
{
    "body": "<a id='comment:25'></a>I haven't test this extensively, but I have the same problem with the Maxima spkg at #8731.",
    "created_at": "2010-07-11T09:50:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108310",
    "user": "https://github.com/qed777"
}
```

<a id='comment:25'></a>I haven't test this extensively, but I have the same problem with the Maxima spkg at #8731.
...
```json
{
    "body": "<a id='comment:26'></a>If we do revert ECL and Maxima, which changes from #8645 and #9264 should we backport?",
    "created_at": "2010-07-11T09:52:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108311",
    "user": "https://github.com/qed777"
}
```

<a id='comment:26'></a>If we do revert ECL and Maxima, which changes from #8645 and #9264 should we backport?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108312",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>> Then we could try just building Maxima as the last package, after all other packages have been \n> built (or even temporarily force reinstallation as the last build step just to get 4.5 working).\n\n\nThat's a really cool idea (!)",
    "created_at": "2010-07-11T13:49:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108316",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:31'></a>> Then we could try just building Maxima as the last package, after all other packages have been 
> built (or even temporarily force reinstallation as the last build step just to get 4.5 working).
...
```json
{
    "body": "<a id='comment:32'></a>I still suspect ECL for the whole mess, creating lots of `/tmp/ECLINIT??????.?` files. I'm not sure if that happens in a really safe way on a multi-user system (with lots of concurrent builds).\n\nOn the other hand, then failing *builds* would be more likely, rather than \"successful\" builds with failing doctests, but perhaps not all build failures are catched. And there have been doctest failures completely(?) unrelated to Maxima and ECL, like `pi in RR` evaluating to `False` IIRC.",
    "created_at": "2010-07-11T15:02:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108317",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:32'></a>I still suspect ECL for the whole mess, creating lots of `/tmp/ECLINIT??????.?` files. I'm not sure if that happens in a really safe way on a multi-user system (with lots of concurrent builds).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108318",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108319",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>Is it possible that those of you who have seen failures have some crap lying around in /tmp which is interfering with your build and/or doctesting?  I'm still trying to understand why some people have problems and others don't.",
    "created_at": "2010-07-11T16:16:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108320",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:35'></a>Is it possible that those of you who have seen failures have some crap lying around in /tmp which is interfering with your build and/or doctesting?  I'm still trying to understand why some people have problems and others don't.
...
```json
{
    "body": "<a id='comment:36'></a>I've reverted #8645 and #9264 in sage-4.5.rc0.",
    "created_at": "2010-07-11T19:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108321",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:36'></a>I've reverted #8645 and #9264 in sage-4.5.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108323",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>But building/testing 4.5.alpha4 in `/dev/shm` on sage.math works for me.  I did\n\n```sh\n$ cd\n$ mkdir -p /dev/shm/mpatel\n$ ln -s /dev/shm/mpatel SHM\n$ cd SHM\n$ emacs -nw go  # Replace 'cd $HOME/scratch/tmp' with 'cp $HOME/SHM' in \"go\" script above\n$ nohup go &\n```",
    "created_at": "2010-07-18T10:56:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108325",
    "user": "https://github.com/qed777"
}
```

<a id='comment:40'></a>But building/testing 4.5.alpha4 in `/dev/shm` on sage.math works for me.  I did
...
```json
{
    "body": "<a id='comment:42'></a>Does this still need to be open?",
    "created_at": "2010-08-20T15:37:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108327",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:42'></a>Does this still need to be open?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108328",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108329",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108330",
...
```json
{
    "body": "<a id='comment:45'></a>Is this still an issue?",
    "created_at": "2013-04-26T01:49:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108331",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:45'></a>Is this still an issue?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108332",
...
```json
{
    "body": "<a id='comment:50'></a>I'm guessing this ticket is obsolete.",
    "created_at": "2014-11-21T10:13:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108333",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:50'></a>I'm guessing this ticket is obsolete.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108334",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>Given that that machine is gone... sage.math is dead, long live sage.math!",
    "created_at": "2014-11-21T13:25:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108335",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:51'></a>Given that that machine is gone... sage.math is dead, long live sage.math!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9460#issuecomment-108336",
