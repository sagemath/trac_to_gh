...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9593#issuecomment-85499",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9593#issuecomment-85500",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9593#event-112789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9593#event-112790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9593#event-112791"
}
```
