...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83705",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_9484-implicit-plot3d-csg-example.patch](https://github.com/sagemath/sage/files/ticket9484/trac_9484-implicit-plot3d-csg-example.patch) by cwitty created at 2010-07-18 02:54:05\n\nI picked a slightly different example.",
    "created_at": "2010-07-18T02:54:05Z",
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83706",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83707",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83708",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83709",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83710",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83711",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9484#issuecomment-83712",
    "user": "https://github.com/kcrisman"
}
```
