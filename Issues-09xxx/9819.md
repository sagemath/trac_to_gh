...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9819#event-24690"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>To make thing worse, currently (sage 4.5.3.alpha2) GF(5)(4) is an IntegerMod_int that does not derive from FieldElement but CommutativeRingElement",
    "created_at": "2010-09-01T14:27:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115929",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:2'></a>To make thing worse, currently (sage 4.5.3.alpha2) GF(5)(4) is an IntegerMod_int that does not derive from FieldElement but CommutativeRingElement
...
```json
{
    "body": "<a id='comment:3'></a>related ticket with different proposal: #10771",
    "created_at": "2011-02-14T14:59:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115930",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:3'></a>related ticket with different proposal: #10771
...
```json
{
    ...
    "milestone": "sage-4.5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9819#event-24691"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9819#event-24692"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Is everything on this ticket fixed already? It seems that #10771 did implement `Fields.ElementMethods.gcd()` after all and its behaviour is as requested in this ticket.",
    "created_at": "2012-01-12T12:05:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115932",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:5'></a>Is everything on this ticket fixed already? It seems that #10771 did implement `Fields.ElementMethods.gcd()` after all and its behaviour is as requested in this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115933",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Yes, this ticket should be resolved as duplicated.",
    "created_at": "2012-01-12T17:32:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115934",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:7'></a>Yes, this ticket should be resolved as duplicated.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115935",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115936",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115937",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115938",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115939",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9819#issuecomment-115940",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9819",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9819#event-24693"
}
```
