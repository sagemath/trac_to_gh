...
```json
{
    "body": "Removed assignee **@sagetrac-someone**",
    "created_at": "2010-08-26T20:35:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9809",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9809#issuecomment-89479",
    "user": "https://github.com/sagetrac-tobiasljohnson"
}
```

Removed assignee **@sagetrac-someone**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9809",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9809#issuecomment-89480",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9809#event-116029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9809#event-116030"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9809#event-116031"
}
```
