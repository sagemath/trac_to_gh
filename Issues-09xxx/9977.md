...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9977#issuecomment-116953",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9977#issuecomment-116954",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9977#issuecomment-116955",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9977#issuecomment-116956",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9977#issuecomment-116957",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30013"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30014"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30015"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30016"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30017"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9977#event-30018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9977#issuecomment-116958",
    "user": "https://github.com/JohnCremona"
}
```
