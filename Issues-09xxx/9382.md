...
```json
{
    "body": "<a id='comment:1'></a>Attachment [atlas-i686-FAT.patch](tarball://root/attachments/some-uuid/ticket9382/atlas-i686-FAT.patch) by mariah created at 2010-06-29 20:18:46",
    "created_at": "2010-06-29T20:18:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106387",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```

<a id='comment:1'></a>Attachment [atlas-i686-FAT.patch](tarball://root/attachments/some-uuid/ticket9382/atlas-i686-FAT.patch) by mariah created at 2010-06-29 20:18:46
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106388",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Very likely positive review -- just need Robert Miller to try it on some 32-bit linux box.",
    "created_at": "2010-07-06T13:17:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106389",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Very likely positive review -- just need Robert Miller to try it on some 32-bit linux box.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106390",
...
```json
{
    "body": "<a id='comment:4'></a>> Looking at the patch, do I see a mismatched single quote?\n\n\nThat's what it looks like to me.  What if you just delete the quote?  Replace\n\n```\nif [ \"`uname -p`\" = \"i386\" -o \"'`uname -p`\" = \"i686\" -o `uname -p`\" = \"x86_64\" ]; then \n```\nwith\n\n```\nif [ \"`uname -p`\" = \"i386\" -o \"`uname -p`\" = \"i686\" -o `uname -p`\" = \"x86_64\" ]; then \n```\n(no single quote before the second ``uname...``).",
    "created_at": "2010-07-10T03:31:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106392",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>> Looking at the patch, do I see a mismatched single quote?
...
```json
{
    "body": "<a id='comment:5'></a>The third uname then has a mismatched double quote.",
    "created_at": "2010-07-11T21:05:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106393",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:5'></a>The third uname then has a mismatched double quote.
...
```json
{
    "body": "<a id='comment:6'></a>Apologies for my silly error.  Here is a revised patch [9382.patch](http://boxen.math.washington.edu/home/mariah/spkgs/9382.patch) and the corresponding spkg [atlas-3.8.3.p13.spkg](http://boxen.math.washington.edu/mariah/spkgs/atlas-3.8.3.p13.spkg).",
    "created_at": "2010-07-15T17:45:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106394",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```

<a id='comment:6'></a>Apologies for my silly error.  Here is a revised patch [9382.patch](http://boxen.math.washington.edu/home/mariah/spkgs/9382.patch) and the corresponding spkg [atlas-3.8.3.p13.spkg](http://boxen.math.washington.edu/mariah/spkgs/atlas-3.8.3.p13.spkg).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106395",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106397",
...
```json
{
    "body": "<a id='comment:8'></a>`uname -p` on linux returns a textual description of the CPU for me, not a canonical architecture name. It looks like this may have to be `uname -m` on Linux.\n\nOn the other hand, on solaris it looks like `uname -p` is correct.\n\nAs `td123` on IRC suggested, maybe we should just check both the results of `-m` and `-p` for these values?",
    "created_at": "2010-12-06T18:03:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106398",
    "user": "https://github.com/wjp"
}
```

<a id='comment:8'></a>`uname -p` on linux returns a textual description of the CPU for me, not a canonical architecture name. It looks like this may have to be `uname -m` on Linux.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106399",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I've done that:\n\nhttp://www.math.leidenuniv.nl/~wpalenst/sage/atlas-3.8.3.p17.spkg\n\nhttp://www.math.leidenuniv.nl/~wpalenst/sage/9382_atlas_i686_fat.patch",
    "created_at": "2011-01-08T23:30:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106400",
    "user": "https://github.com/wjp"
}
```

<a id='comment:9'></a>I've done that:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106401",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Willem: which machine and which uname outputs are you referring to in comment 8?\n\nInstead of hacking around the current atlas build script, I think it would be a good point to switch to my rewritten atlas spkg at #10226 that detects the configuration in a much cleaner way.",
    "created_at": "2011-01-09T17:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106402",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>Willem: which machine and which uname outputs are you referring to in comment 8?
...
```json
{
    "body": "<a id='comment:11'></a>Nearly every linux machine I've tried, with a few exceptions where `uname -m` and `uname -p` give the same output.\n\nExample (a 64 bit Gentoo machine):\n\n```\nmira: ~ > uname -m\nx86_64\nmira: ~ > uname -p\nIntel(R) Xeon(R) CPU X3220 @ 2.40GHz\n```",
    "created_at": "2011-01-09T17:29:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106403",
    "user": "https://github.com/wjp"
}
```

<a id='comment:11'></a>Nearly every linux machine I've tried, with a few exceptions where `uname -m` and `uname -p` give the same output.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106404",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106406",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>You're looking at an old version of the patch. The most up to date one is the SPKG in comment #9.\n\nAlso, #10226 (which also needs review) might supersede this patch.",
    "created_at": "2011-01-11T02:37:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106407",
    "user": "https://github.com/wjp"
}
```

<a id='comment:14'></a>You're looking at an old version of the patch. The most up to date one is the SPKG in comment #9.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106408",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Replying to [wjp](#comment%3A14):\n> Also, #10226 (which also needs review) might supersede this patch.\n\n\nIt does, and I think we should work on that ticket and close this one when #10226 gets merged.",
    "created_at": "2011-01-11T03:30:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106409",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:15'></a>Replying to [wjp](#comment%3A14):
> Also, #10226 (which also needs review) might supersede this patch.
...
```json
{
    "body": "<a id='comment:18'></a>Oops we are talking about `uname -m`. For this, I'm using `platform.machine()`:\n\n```python\nconf['Intel?'] = (platform.machine() in ('i386', 'i486', 'i586', 'i686', 'x86_64', \n                                         'AMD64', 'i86pc'))\nconf['IA64?']   = (platform.processor() == 'ia64')\nconf['PPC?']   = (platform.processor() == 'powerpc')\nconf['SPARC?'] = (platform.processor() == 'sparc')\n```",
    "created_at": "2011-08-03T09:07:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106412",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:18'></a>Oops we are talking about `uname -m`. For this, I'm using `platform.machine()`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106415",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106416",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106417",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Well http://gcc.gnu.org/onlinedocs/gcc-4.6.1/gcc/i386-and-x86_002d64-Options.html#i386-and-x86_002d64-Options says:\n\n```\n-mcpu=cpu-type\n    A deprecated synonym for -mtune. \n```\nThe instruction set is selected with `-march`. \n\nWe should remove the ticket from the wishlist. Jeroen will close this ticket when he gets around to it, no need to contact him.",
    "created_at": "2011-08-03T11:53:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106418",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:22'></a>Well http://gcc.gnu.org/onlinedocs/gcc-4.6.1/gcc/i386-and-x86_002d64-Options.html#i386-and-x86_002d64-Options says:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106419",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106421",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9382#issuecomment-106422",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9382#event-23135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9382",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9382#event-23136"
}
```
