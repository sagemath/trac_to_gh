...
```json
{
    "body": "<a id='comment:2'></a>In [comment:1 my case], the test passed when I ran it again.  I could not reproduce it.",
...
<a id='comment:2'></a>In [comment:1 my case], the test passed when I ran it again.  I could not reproduce it.
...
<a id='comment:5'></a>Replying to [comment:4 cschwan]:
> I remember having the same failure in free_module.py and I think its most likely caused by having not sufficient memory - everytime I run free_module.py's my system (i686 + 1GB RAM + 512 MB swap) is heavily using swap.
...
<a id='comment:7'></a>Replying to [comment:5 ddrake]:
> Replying to [comment:4 cschwan]:
> > I remember having the same failure in free_module.py and I think its most likely caused by having not sufficient memory - everytime I run free_module.py's my system (i686 + 1GB RAM + 512 MB swap) is heavily using swap.
