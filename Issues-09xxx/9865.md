...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116752",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>In [my case](#comment%3A1), the test passed when I ran it again.  I could not reproduce it.",
    "created_at": "2010-09-07T07:12:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116753",
    "user": "https://github.com/qed777"
}
```

<a id='comment:2'></a>In [my case](#comment%3A1), the test passed when I ran it again.  I could not reproduce it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116754",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I remember having the same failure in free_module.py and I think its most likely caused by having not sufficient memory - everytime I run free_module.py's my system (i686 + 1GB RAM + 512 MB swap) is heavily using swap.\n\nAlso, rebooting and running the test again made the test pass back then.",
    "created_at": "2010-09-07T07:26:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116755",
    "user": "https://trac.sagemath.org/admin/accounts/users/cschwan"
}
```

<a id='comment:4'></a>I remember having the same failure in free_module.py and I think its most likely caused by having not sufficient memory - everytime I run free_module.py's my system (i686 + 1GB RAM + 512 MB swap) is heavily using swap.
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24831"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116757",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>lol, I've just built Sage 4.5.3 on the (single-core) Pentium 4 with 768 MB RAM, and it seems I now get doctest errors due to Singular crashing while running `ptestlong` with two threads...\n\nMore to come; the test is still running.",
    "created_at": "2010-09-08T13:55:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116759",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>lol, I've just built Sage 4.5.3 on the (single-core) Pentium 4 with 768 MB RAM, and it seems I now get doctest errors due to Singular crashing while running `ptestlong` with two threads...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116760",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116761",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>P.S.: Both doctesting just these files and also `make testlong` passed without errors.\n\nI wonder if `read_nonblocking()` is the right thing to do... (One can use signals to implement timeouts if that's the reason. I haven't looked at the code.)",
    "created_at": "2010-09-09T01:57:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116762",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:10'></a>P.S.: Both doctesting just these files and also `make testlong` passed without errors.
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24832"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116763",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116764",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24834"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24835"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24836"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24837"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24838"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24839"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24840"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116765",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116766",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24842"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116767",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I think this should be fixed in the mean time.",
    "created_at": "2015-09-07T18:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116768",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>I think this should be fixed in the mean time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116769",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9865#event-24844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9865#issuecomment-116770",
