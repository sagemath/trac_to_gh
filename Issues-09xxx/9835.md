...
```json
{
    "body": "Changed assignee from **@burcin** to **@sagetrac-mhampton**",
    "created_at": "2010-09-21T13:58:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9835",
    "type": "issue_comment",
...
Changed assignee from **@burcin** to **@sagetrac-mhampton**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9835",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9835#event-116407"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9835#event-116408"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9835#event-116409"
}
```
