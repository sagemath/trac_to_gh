...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9799#event-115853"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9799#event-115854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9799#event-115855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9799#issuecomment-88983",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9799#issuecomment-88984",
    "user": "https://github.com/nexttime"
}
```
