...
```json
{
    "body": "<a id='comment:1'></a>In what version of Sage did you find this problem? \n\nWhat was your most recent build of Sage that built without this problem?",
    "created_at": "2010-06-30T10:10:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106463",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>In what version of Sage did you find this problem? 
...
```json
{
    "body": "<a id='comment:2'></a>It happened with sage-4.4.4, my latest succesful compilation was sage-4.4.1. I am under the impression that ATLAS was changed towards a more recent version (a beta) in this latest version of sage. \n\nhttp://groups.google.com/group/sage-devel/browse_thread/thread/f3fa4f8737437d7f/f4a78427d007d3d8?lnk=raot\n\nThat is the most obvious explanation to the problem, so, perhaps we should go back to the version of ATLAS used before...",
    "created_at": "2010-06-30T13:22:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106464",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:2'></a>It happened with sage-4.4.4, my latest succesful compilation was sage-4.4.1. I am under the impression that ATLAS was changed towards a more recent version (a beta) in this latest version of sage. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106466",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Don't forget, there have been others affected on archlinux, so it isn't just fedora that's affected.",
    "created_at": "2010-07-02T13:22:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106467",
    "user": "https://trac.sagemath.org/admin/accounts/users/gostrc"
}
```

<a id='comment:5'></a>Don't forget, there have been others affected on archlinux, so it isn't just fedora that's affected.
...
```json
{
    "body": "<a id='comment:7'></a>I thought I might compile a previous version, but unfortunately the previous version could not build in fedora 13 (libcrypt could not build). This bug has been fixed in sage-4.4.4, but now we have this new problem. Both sage-4.4.3 and 4.4.4 have been successfully built in fedora 12, so, unless this gets fixed soon i'll have to go back to 12.\n\nDo you know of any sage version that has been build in fedora 13?",
    "created_at": "2010-07-02T20:28:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106469",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:7'></a>I thought I might compile a previous version, but unfortunately the previous version could not build in fedora 13 (libcrypt could not build). This bug has been fixed in sage-4.4.4, but now we have this new problem. Both sage-4.4.3 and 4.4.4 have been successfully built in fedora 12, so, unless this gets fixed soon i'll have to go back to 12.
...
```json
{
    "body": "<a id='comment:8'></a>Moreover, has anybody been able to compile in fedora 13/archlinux?",
    "created_at": "2010-07-02T20:35:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106470",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:8'></a>Moreover, has anybody been able to compile in fedora 13/archlinux?
...
```json
{
    "body": "<a id='comment:9'></a>I'm adding Jaap Spies to this ticket, as I believe he has built Sage on Fedora 13. He might know what is involved in getting Sage to build. \n\nAs a general point, if you want to have a stable system with least hassle, it is often best to let others try the newest version of new software first. (Of course, if we all took that attitude, nobody would discover bugs with new systems, as nobody would install them. But genreally speaking, upgrading an operating system is not something I take lightly. \n\nDave",
    "created_at": "2010-07-02T21:01:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106471",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:9'></a>I'm adding Jaap Spies to this ticket, as I believe he has built Sage on Fedora 13. He might know what is involved in getting Sage to build. 
...
```json
{
    "body": "<a id='comment:10'></a>Fedora 13 x86_64 here on an arrandale (i5) laptop, and ATLAS does not error out in build STAGE 2-1-2. Could someone with the bug post his\n`sage-4.4.4/spkg/build/atlas-3.8.3.p12/ATLAS-build/bin/INSTALL_LOG/dMMCACHEEDGE.LOG` after an unsuccessful build? Maybe that would give us the actual error message.",
    "created_at": "2010-07-03T14:06:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106472",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>Fedora 13 x86_64 here on an arrandale (i5) laptop, and ATLAS does not error out in build STAGE 2-1-2. Could someone with the bug post his
`sage-4.4.4/spkg/build/atlas-3.8.3.p12/ATLAS-build/bin/INSTALL_LOG/dMMCACHEEDGE.LOG` after an unsuccessful build? Maybe that would give us the actual error message.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106473",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I run in 32 bits though.",
    "created_at": "2010-07-03T15:11:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106474",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:11'></a>I run in 32 bits though.
...
```json
{
    "body": "<a id='comment:12'></a>That file has no errors on it, but searching in other logs in the same folder I found that zMMSEARCH.LOG and zMVTUNE.LOG, contain many errors. Mostly 'Bad register name' errors and overwritten register errors (in spanish \"error: registro PIC \u2018bx\u2019 sobreescrito en \u2018asm\u2019\").\nI'll upload those too.",
    "created_at": "2010-07-03T15:26:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106475",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:12'></a>That file has no errors on it, but searching in other logs in the same folder I found that zMMSEARCH.LOG and zMVTUNE.LOG, contain many errors. Mostly 'Bad register name' errors and overwritten register errors (in spanish "error: registro PIC ‘bx’ sobreescrito en ‘asm’").
I'll upload those too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106476",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106478",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Yes, I mean the complete install.log. Just wait until it loops once. Upload it somewhere with enough disk space ;-)\n\nThe fastest way is to start a new shell with a different locale like this:\n\n```\n[vbraun@volker-desktop ~]$ date\n2010\u5e74  7\u6708  3\u65e5 \u571f\u66dc\u65e5 18:00:03 IST\n[vbraun@volker-desktop ~]$ LANG=en_US bash\n[vbraun@volker-desktop ~]$ date\nSat Jul  3 18:00:14 IST 2010\n```",
    "created_at": "2010-07-03T17:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106479",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:15'></a>Yes, I mean the complete install.log. Just wait until it loops once. Upload it somewhere with enough disk space ;-)
...
```json
{
    "body": "<a id='comment:16'></a>I suggests here compress the log first. \n\nDave",
    "created_at": "2010-07-03T17:28:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106480",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:16'></a>I suggests here compress the log first. 
...
```json
{
    "body": "<a id='comment:17'></a>Ok, I have already started the compilation again. I should upload the log by tomorrow morning.",
    "created_at": "2010-07-03T17:39:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106481",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:17'></a>Ok, I have already started the compilation again. I should upload the log by tomorrow morning.
...
```json
{
    "body": "<a id='comment:18'></a>Rather than attaching the log here, especially if it's large, it would be much better to post it somewhere else on a web page and just put the link here.",
    "created_at": "2010-07-03T18:25:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106482",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:18'></a>Rather than attaching the log here, especially if it's large, it would be much better to post it somewhere else on a web page and just put the link here.
...
```json
{
    "body": "<a id='comment:20'></a>ATLAS builds here ok on Fedora 13, 32 bit.\n\nJaap",
    "created_at": "2010-07-04T13:15:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106484",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:20'></a>ATLAS builds here ok on Fedora 13, 32 bit.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106485",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Replying to [drkirkby](#comment%3A21):\n> Replying to [jsp](#comment%3A20):\n> > ATLAS builds here ok on Fedora 13, 32 bit.\n> > \n> > Jaap\n> > \n\n> \n> Thank you Jaap. \n> \n> I've set this to 'worksforme', though a more accurate description would be 'works for some'. I don't believe this can remain a blocker for the next release, when there are positive confirmations it can build on both Fedora 13 and Arch Linux - the two platforms olazo mentioned were causing problems. \n> \n> I'm not dismissing the fact there may be a problem, and this may break on some installations, but it can't remain a blocker. \n> \n> I've cc'ed the 4.5 release manager (Robert Miller), in case he feels otherwise. \n> \n\n\nSadly, I agree. I'll put the log here, it's not that big once compressed (1.3 Megabytes).",
    "created_at": "2010-07-04T14:44:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106488",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:23'></a>Replying to [drkirkby](#comment%3A21):
> Replying to [jsp](#comment%3A20):
> > ATLAS builds here ok on Fedora 13, 32 bit.
> > 
> > Jaap
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106489",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [jsp](#comment%3A20):\n> ATLAS builds here ok on Fedora 13, 32 bit.\n> \n> Jaap\n> \n\n\nCould you please post your binary to sagemath.org, so it's available from the mirrors?",
    "created_at": "2010-07-04T14:48:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106490",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:24'></a>Replying to [jsp](#comment%3A20):
> ATLAS builds here ok on Fedora 13, 32 bit.
> 
> Jaap
> 
...
```json
{
    "body": "<a id='comment:25'></a>I'll take a look. BTW, was there any particular reason for creating a tar file with only one file in it? You could have simply compressed install.log. \n\nDave",
    "created_at": "2010-07-04T15:14:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106491",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:25'></a>I'll take a look. BTW, was there any particular reason for creating a tar file with only one file in it? You could have simply compressed install.log. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106494",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106495",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106496",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Attachment [error_CoreDuo32SSE3.tgz](tarball://root/attachments/some-uuid/ticket9385/error_CoreDuo32SSE3.tgz) by olazo created at 2010-07-04 16:52:40\n\nReplying to [vbraun](#comment%3A29):\n> Some questions for the OP:\n> * Is your CPU trottled?\n\n\nI guess it is, since the install.log says so (see a pervious message fro drkirkby in this ticket)\n\n>   * Were other applications open/running at build time?\n\n\nYes, should I try again with no ther applications running?\n\n>   * Upload your `/home/oscar/sage-4.4.4/spkg/build/atlas-3.8.3.p12/ATLAS-build/error_CoreDuo32SSE3.tar`\n\n\nDone.\n\nAlso, thank you very much for helping me out!",
    "created_at": "2010-07-04T16:52:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106498",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:30'></a>Attachment [error_CoreDuo32SSE3.tgz](tarball://root/attachments/some-uuid/ticket9385/error_CoreDuo32SSE3.tgz) by olazo created at 2010-07-04 16:52:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106500",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>I have just managed to compile sage in my fedora 13 32 bits computer. I am not completely sure what made the difference. I can see two differences between this and my previous atempts: \n\n1) I updated the compilers to their latest versions.\n2) I was compiling in a partition formated as ext3, this time i used a partition formated as ext4.\n3) I compiled as superuser\n\nI did not disable throttling, and I was running gnome (other than that no other resource-consuming aplications were running).\n\nSince I was the only person to have this bug, and it has now been resolved, I advice this ticket to be closed.",
    "created_at": "2010-07-13T00:09:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106504",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```

<a id='comment:36'></a>I have just managed to compile sage in my fedora 13 32 bits computer. I am not completely sure what made the difference. I can see two differences between this and my previous atempts: 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106505",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Fedora 13 had already 4 gcc updates. Part of its purpose is trying the bleeding edge for the compiler. Installing the gcc updates is definitely recommended ;-)\n\n```\nyum.log:Apr 06 16:38:57 Installed: gcc-4.4.3-12.fc13.x86_64\nyum.log:Apr 16 12:48:20 Updated: gcc-4.4.3-16.fc13.x86_64\nyum.log:Apr 23 18:16:11 Updated: gcc-4.4.3-18.fc13.x86_64\nyum.log:May 04 23:53:12 Updated: gcc-4.4.4-2.fc13.x86_64\nyum.log:Jul 06 11:03:57 Updated: gcc-4.4.4-10.fc13.x86_64\n```\nIf anyone still has problems please reopen with specific information about your compiler...",
    "created_at": "2010-07-13T00:39:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106507",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:38'></a>Fedora 13 had already 4 gcc updates. Part of its purpose is trying the bleeding edge for the compiler. Installing the gcc updates is definitely recommended ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106510",
    "user": "https://trac.sagemath.org/admin/accounts/users/tux21b"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106511",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>I'm reopening this, as it's not clear to me this issue has ever been resolved.",
    "created_at": "2010-10-18T11:42:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106512",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:43'></a>I'm reopening this, as it's not clear to me this issue has ever been resolved.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106513",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>I think it is unavoidable that that ATLAS sometimes fails to get accurate timings. Nor is it always desirable to tune it to precisely your CPU, for example if you are building a binary distribution. Therefore, I propose we add a new variable `SAGE_ATLAS_ARCH` with values\n1. `auto` - run through the tuning process\n2. `fast` - reasonably modern ~2005 cpu: sse3 on x86, Niagara SPARC, ...\n3. `base` - really old cpus\n4. A particular architecture from `ATLAS/CONFIG/ARCHS/*.tgz`, e.g. `AMD64K10h32SSE3`\nThe ATLAS spkg then should then build a configuration according to `SAGE_ATLAS_ARCH`. If it it is not set, try 2x`auto`, if that fails `fast`, and if that fails `base`.\n\nThe Fedora rpm package has pre-built configurations for various cpus and shows how to patch them into the ATLAS build system.",
    "created_at": "2010-10-23T14:29:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106514",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:44'></a>I think it is unavoidable that that ATLAS sometimes fails to get accurate timings. Nor is it always desirable to tune it to precisely your CPU, for example if you are building a binary distribution. Therefore, I propose we add a new variable `SAGE_ATLAS_ARCH` with values
1. `auto` - run through the tuning process
2. `fast` - reasonably modern ~2005 cpu: sse3 on x86, Niagara SPARC, ...
3. `base` - really old cpus
4. A particular architecture from `ATLAS/CONFIG/ARCHS/*.tgz`, e.g. `AMD64K10h32SSE3`
...
```json
{
    "body": "<a id='comment:45'></a>I've just experienced this problem on a VirtualBox virtual machine running openSUSE 11.3. ATLAS fails to build. The hardware is a Sun Ultra 27, quad core 3.33 GHz Intel Xeon. The host operating system is OpenSolaris 06/2009. \n\nDave",
    "created_at": "2010-10-28T04:36:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106515",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:45'></a>I've just experienced this problem on a VirtualBox virtual machine running openSUSE 11.3. ATLAS fails to build. The hardware is a Sun Ultra 27, quad core 3.33 GHz Intel Xeon. The host operating system is OpenSolaris 06/2009. 
...
```json
{
    "body": "<a id='comment:46'></a>My (related?) problem seems to have been solved in Sage 4.6. I've already updated my ticket: http://trac.sagemath.org/sage_trac/ticket/10051#comment:3\n\nMaybe someone here can confirm this?",
    "created_at": "2010-11-22T23:06:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106516",
    "user": "https://trac.sagemath.org/admin/accounts/users/tux21b"
}
```

<a id='comment:46'></a>My (related?) problem seems to have been solved in Sage 4.6. I've already updated my ticket: http://trac.sagemath.org/sage_trac/ticket/10051#comment:3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106518",
    "user": "https://trac.sagemath.org/admin/accounts/users/chris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106519",
    "user": "https://trac.sagemath.org/admin/accounts/users/chris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106520",
    "user": "https://trac.sagemath.org/admin/accounts/users/chris"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Attachment [install_with_system_atlas.tar.lzma](tarball://root/attachments/some-uuid/ticket9385/install_with_system_atlas.tar.lzma) by @vbraun created at 2011-08-28 23:38:40\n\nCan you try the new atlas spkg, which is included in Sage-4.7.2.alpha1 or higher? This will at the very least let you use the system-wide atlas install.",
    "created_at": "2011-08-28T23:38:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106521",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:48'></a>Attachment [install_with_system_atlas.tar.lzma](tarball://root/attachments/some-uuid/ticket9385/install_with_system_atlas.tar.lzma) by @vbraun created at 2011-08-28 23:38:40
...
```json
{
    "body": "<a id='comment:49'></a>OK. Thanks I've updated ATLAS and now the system-wide atlas install works but the ATLAS build will still go into a loop.\n\n```\n$ wget http://boxen.math.washington.edu/home/release/sage-4.7.2.alpha2/sage-4.7.2.alpha2/spkg/standard/atlas-3.8.4.spkg\n$ cp atlas-3.8.4.spkg ~/excluded/sage-4.7.1/spkg/standard/\n```\n\nchris",
    "created_at": "2011-08-29T10:16:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106522",
    "user": "https://trac.sagemath.org/admin/accounts/users/chris"
}
```

<a id='comment:49'></a>OK. Thanks I've updated ATLAS and now the system-wide atlas install works but the ATLAS build will still go into a loop.
...
```json
{
    "body": "<a id='comment:50'></a>It's not clear whether there really is a problem, I don't know any recent reports of this. Many people have *claimed* that ATLAS goes into an infinite loop, but in reality they are just too impatient to wait for ATLAS to finish compiling.",
    "created_at": "2013-05-24T12:25:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106523",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:50'></a>It's not clear whether there really is a problem, I don't know any recent reports of this. Many people have *claimed* that ATLAS goes into an infinite loop, but in reality they are just too impatient to wait for ATLAS to finish compiling.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106524",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9385#issuecomment-106525",
    "user": "https://github.com/jdemeyer"
}
```
