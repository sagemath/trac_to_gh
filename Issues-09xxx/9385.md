...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/dMMCACHEEDGE.LOG",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/zMMSEARCH.LOG",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/zMVTUNE.LOG",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/install.log.tar.gz",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/error_CoreDuo32SSE3.tgz",
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "abrt.log",
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/abrt.log",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/proc_cpuinfo",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/proc_meminfo",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9385/install_with_system_atlas.tar.lzma",
    "created_at": "2011-08-28T23:38:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9385",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.lzma",
    "user": "https://github.com/vbraun"
}
```
