...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,3 +5,5 @@\n * massively optimize reduction modulo a prime (e.g., the first interesting example I tried, I got a speedup of a factor of 500,000!  Yes half a million times faster!). \n \n Parts of this patch have been moved to #9764.\n+\n+The patches which should be merged for this ticket are [9400_maximize_at_primes.patch](https://github.com/sagemath/sage/files/ticket9400/9400_maximize_at_primes.patch) and [9400_jd_review.patch](https://github.com/sagemath/sage/files/ticket9400/9400_jd_review.patch)\n``````\n",
