...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111990",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Also, if you feel like the patch is to the point that it needs review, please change the status below to \"needs review\".",
    "created_at": "2010-07-31T18:30:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111991",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>Also, if you feel like the patch is to the point that it needs review, please change the status below to "needs review".
...
```json
{
    "body": "<a id='comment:5'></a>Thanks for the comments, which not only improved the patch but my Python knowledge as well!  I've updated the patch in the meantime.  Thanks also for guiding me through the sage patch process!\n\nSome quick comments and questions:\n\n1.  As for integration of forms, I think this is definitely doable and in fact should be dealt with before the other stuff (metric geometry, etc).\n\n2.  I'm very interesting in seeing how the authors of that mathematica package represented differential forms -- thanks for the link!\n\n3. Once I've taken a good look at the mathematica package, I'll set the patch to \"needs review\".",
    "created_at": "2010-08-01T16:55:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111992",
    "user": "https://github.com/jvkersch"
}
```

<a id='comment:5'></a>Thanks for the comments, which not only improved the patch but my Python knowledge as well!  I've updated the patch in the meantime.  Thanks also for guiding me through the sage patch process!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111994",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Oops: inside of triple-braces, things are quoted literally:\n\n```\nsage: x, y, z = var('x, y, z')\nsage: U = CoordinatePatch((x, y, z))\nsage: F = DifferentialForms(U)\nsage: form = DifferentialForm(F, 0, sin(x*y)); form\nsin(x*y)\n```",
    "created_at": "2010-08-04T14:42:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111995",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:8'></a>Oops: inside of triple-braces, things are quoted literally:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111996",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"__init__.py, documentation warnings, gens()\"",
    "created_at": "2010-08-23T16:53:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111998",
    "user": "https://github.com/nilesjohnson"
}
```

Changing work_issues from "" to "__init__.py, documentation warnings, gens()"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-111999",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112000",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>the first point is about `__init__.py`; sorry for the misformatting!",
    "created_at": "2010-08-23T16:54:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112002",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:15'></a>the first point is about `__init__.py`; sorry for the misformatting!
...
```json
{
    "body": "<a id='comment:16'></a>oh, and doctest coverage is at 100% for each of the 3 files!",
    "created_at": "2010-08-23T17:08:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112003",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:16'></a>oh, and doctest coverage is at 100% for each of the 3 files!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112007",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>It looks like the top of coordinate_patch.py is repeated around line 232.  Was that intentional?",
    "created_at": "2010-08-24T21:27:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112008",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:20'></a>It looks like the top of coordinate_patch.py is repeated around line 232.  Was that intentional?
...
```json
{
    "body": "<a id='comment:21'></a>In fact, it looks like the entire content of coordinate_patch.py is duplicated, starting around line 232 of that file.",
    "created_at": "2010-08-24T21:28:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112009",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:21'></a>In fact, it looks like the entire content of coordinate_patch.py is duplicated, starting around line 232 of that file.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112010",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112011",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112012",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112014",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Joris, could you add yourself to the [account name-real name map](http://trac.sagemath.org/sage_trac/wiki/WikiStart#AccountNamesmappedtoRealNames), when it's convenient?",
    "created_at": "2010-08-30T21:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112015",
    "user": "https://github.com/qed777"
}
```

<a id='comment:25'></a>Joris, could you add yourself to the [account name-real name map](http://trac.sagemath.org/sage_trac/wiki/WikiStart#AccountNamesmappedtoRealNames), when it's convenient?
...
```json
{
    "body": "<a id='comment:26'></a>The most recent patch looks good to me.  Doctests pass, playing around with some examples seems fine, and docs build.  However, as this is not my area, at least one other person should pass off on this (niles?).",
    "created_at": "2010-08-31T03:30:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112016",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:26'></a>The most recent patch looks good to me.  Doctests pass, playing around with some examples seems fine, and docs build.  However, as this is not my area, at least one other person should pass off on this (niles?).
...
```json
{
    "body": "<a id='comment:27'></a>This looks good to me too, although I'm not sure if this is desired behavior:\n\n```\nU = CoordinatePatch((x,y))\nF2 = DifferentialForms(U)\nq = DifferentialForm(F2,1)\nq[0] = -y\nq[1] = x\ndiff(q,y)\n```\ngives\n\n```\n0\n```\nbut it seems like diff(q,y) should give dx/\\dy.  I'm pretty rusty with my differntial forms though, I'll try to brush up.",
    "created_at": "2010-08-31T15:02:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112017",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:27'></a>This looks good to me too, although I'm not sure if this is desired behavior:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112018",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112019",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112024",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112025",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Thanks for elucidating the role of `SR`.  I don't think there is any implicit coercion anywhere of forms into `SR`, so this probably won't give any problems.\n\nReplying to [niles](#comment%3A32):\n\n> \n> For this ticket, I'd be in support of raising `NotImplementedError`s for all of the broken inherited methods, and writing a new ticket to implement those that can be.\n\n\nOK, I've updated the patch so that the methods which are not applicable raise `NotImplementedError`.  I don't know if I've done this properly though, since including all the doctests this amounts to quite a bit of additional code.",
    "created_at": "2010-09-04T21:28:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112026",
    "user": "https://github.com/jvkersch"
}
```

<a id='comment:33'></a>Thanks for elucidating the role of `SR`.  I don't think there is any implicit coercion anywhere of forms into `SR`, so this probably won't give any problems.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112028",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>Jason, I agree, I think this is in good enough shape for inclusion.  I think its important to get this sort of new functionality in as soon as possible as long as the design looks reasonable, which it does.  \n\nI think this is very exciting, its the sort of functionality that Sage is meant for, and I'm very happy to see this addition.",
    "created_at": "2010-09-05T03:13:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112029",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:36'></a>Jason, I agree, I think this is in good enough shape for inclusion.  I think its important to get this sort of new functionality in as soon as possible as long as the design looks reasonable, which it does.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112030",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112031",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Could someone please update [attachment:trac9650_differential_forms_v2.patch] with a more descriptive commit string that includes the ticket number?  For example: `#9650: Add support for differential forms`.",
    "created_at": "2010-09-05T03:57:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112032",
    "user": "https://github.com/qed777"
}
```

<a id='comment:37'></a>Could someone please update [attachment:trac9650_differential_forms_v2.patch] with a more descriptive commit string that includes the ticket number?  For example: `#9650: Add support for differential forms`.
...
```json
{
    "body": "<a id='comment:38'></a>Attachment [trac9650_differential_forms_v2.patch](tarball://root/attachments/some-uuid/ticket9650/trac9650_differential_forms_v2.patch) by @jvkersch created at 2010-09-05 07:53:00\n\nReplying to [mpatel](#comment%3A37):\n> Could someone please update [attachment:trac9650_differential_forms_v2.patch] with a more descriptive commit string that includes the ticket number?  For example: `#9650: Add support for differential forms`.\n\n\nDone -- thanks for pointing that out.",
    "created_at": "2010-09-05T07:53:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112033",
    "user": "https://github.com/jvkersch"
}
```

<a id='comment:38'></a>Attachment [trac9650_differential_forms_v2.patch](tarball://root/attachments/some-uuid/ticket9650/trac9650_differential_forms_v2.patch) by @jvkersch created at 2010-09-05 07:53:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112035",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112036",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112037",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Attachment [trac9650_differential_forms_v2-reviewer.patch](tarball://root/attachments/some-uuid/ticket9650/trac9650_differential_forms_v2-reviewer.patch) by @nilesjohnson created at 2010-09-05 17:26:05\n\nReplying to [jvkersch](#comment%3A33):\n\n> OK, I've updated the patch so that the methods which are not applicable raise `NotImplementedError`.  I don't know if I've done this properly though, since including all the doctests this amounts to quite a bit of additional code.\n\n\nThis looks great, and I agree with others on getting it included into sage soon.  There were some formatting errors in the new docstrings (need newline between `EXAMPLES::` and indented code block), and since someone else gave the positive review I just uploaded a corrected version (apply only [attachment:trac9650_differential_forms_v2-reviewer.patch]).",
    "created_at": "2010-09-05T17:26:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112038",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:42'></a>Attachment [trac9650_differential_forms_v2-reviewer.patch](tarball://root/attachments/some-uuid/ticket9650/trac9650_differential_forms_v2-reviewer.patch) by @nilesjohnson created at 2010-09-05 17:26:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112040",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9650#issuecomment-112041",
    "user": "https://github.com/qed777"
}
```
