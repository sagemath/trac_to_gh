...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78799",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78801",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78802",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78803",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78804",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_9205-doctest.patch](https://github.com/sagemath/sage/files/ticket9205/trac_9205-doctest.patch) by @loefflerd created at 2010-06-30 19:04:11\n\nReplying to [cremona](#comment%3A2):\n> Looks fine, applies to 4.4.4.alpha1 also and tests in rings/finite_rings pass.\n\n\n... but one of the doctest in sage/functions/log doesn't. Here's a tiny patch that fixes that.",
    "created_at": "2010-06-30T19:04:11Z",
    "issue": "https://github.com/sagemath/sage/issues/9205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78805",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9205#issuecomment-78806",
