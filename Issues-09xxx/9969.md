...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114475"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114483"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114484"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114485"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,7 +1,7 @@\n The patch adds fast Cython version of some more mpmath functions to sage.libs.mpmath.\n \n This ticket contains a new spkg for mpmath-0.17 and two patches\n-that need to be applied to sage itself. First 14600.patch, then docstring-fixes.patch.\n+that need to be applied to sage itself. First mpmath_update_fixed_4.6.1.patch, then truediv_fix.patch.\n \n It can be tested with:\n \n@@ -11,5 +11,5 @@\n sage: mpmath.doctests()\n ```\n 1. [http://sage.math.washington.edu/home/fredrik/mpmath-0.17.spkg](http://sage.math.washington.edu/home/fredrik/mpmath-0.17.spkg)\n-2. [attachment: 14600.patch.gz](https://github.com/sagemath/sage/files/ticket9969/14600.patch.gz)\n-3. [attachment: docstring-fixes.patch.gz](https://github.com/sagemath/sage/files/ticket9969/docstring-fixes.patch.gz)\n+2. [attachment: mpmath_update_fixed_4.6.1.patch.gz](https://github.com/sagemath/sage/files/ticket9969/mpmath_update_fixed_4.6.1.patch.gz)\n+3. [attachment: truediv_fix.patch.gz](https://github.com/sagemath/sage/files/ticket9969/truediv_fix.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92752",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92753",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92754",
    "user": "https://github.com/fredrik-johansson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92755",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114486"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114487"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92756",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92758",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92759",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114489"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114490"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92760",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92761",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92762",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92763",
    "user": "https://github.com/fredrik-johansson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92764",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9969#issuecomment-92765",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9969",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9969#event-114498"
}
```
