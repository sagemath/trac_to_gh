...
<a id='comment:1'></a>From [sage-notebok](http://groups.google.cz/group/sage-notebook/browse_thread/thread/79b7b217f4af6e36)
...
```json
{
    "body": "<a id='comment:3'></a>We use MathJaX now for the notebook! So, the ticket is no longer relevant.",
...
<a id='comment:3'></a>We use MathJaX now for the notebook! So, the ticket is no longer relevant.
