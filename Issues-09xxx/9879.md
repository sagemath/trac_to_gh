...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117166",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_9879-hold.patch](tarball://root/attachments/some-uuid/ticket9879/trac_9879-hold.patch) by @burcin created at 2010-09-12 12:17:49\n\nWith attachment:trac_9879-hold.patch and the new pynac package at #9201, one can do:\n\n```\nsage: x.add(x,(x+1), hold=True)\nx + x + (x + 1)\nsage: sin(pi, hold=True)\nsin(pi)\n```\n\nThe pynac package includes patches for #9394, #9834, #9878, #9881, #9900 as well as this ticket. See the ticket description of #9901 for the list (and order) of patches associated to the new version.",
    "created_at": "2010-09-12T12:17:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117167",
    "user": "https://github.com/burcin"
}
```

<a id='comment:1'></a>Attachment [trac_9879-hold.patch](tarball://root/attachments/some-uuid/ticket9879/trac_9879-hold.patch) by @burcin created at 2010-09-12 12:17:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117168",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117169",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Making a context for holding is now #10035.",
    "created_at": "2010-09-29T19:08:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117171",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Making a context for holding is now #10035.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117172",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117174",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117175",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117176",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117178",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>>  * Typesetting issues. There is nothing mathematically wrong with these (you can try it), but they are obviously confusing to users.  \n \nThis is now #10069.\n> \n>   * `heaviside(0) != SR(0).step()` This is already true in Sage, so we don't need to address in this ticket, but it becomes obvious when trying to simplify a 'held' expression with `step()`.\n \nThis is now #10070.\n>  * There is no way to get `Order(hold=True)` to evaluate!  Same problem with `csgn` and `step` (the latter could be fixed via the above).  This is annoying but probably they are still useful.\n \nThis is now #10071.\n>  * Big problem, which is why I didn't make log_gamma symbolic:\n \nThis is now #10072, and making `log_gamma` symbolic is #10075.\n>  * Enhancement - coth, sech, csch and their arc-guys basically already are purely symbolic and hold doesn't do much for them.  For instance:\n \nThis is now #10074.\n> \n>   * Here is something where I was able to make it work in the doctests, but honestly don't know what is going on.\n \nThis is now #10073.",
    "created_at": "2010-10-05T13:59:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117179",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>>  * Typesetting issues. There is nothing mathematically wrong with these (you can try it), but they are obviously confusing to users.  
...
```json
{
    "body": "<a id='comment:9'></a>> Do you mind putting your \"real\" name in the \"reviewer\" list, and then adding yourself to the long list of Trac users on the main Trac page?  Thanks - that helps a lot; otherwise I'm not sure how we'd track you down.\n\n\nOkay, I found your name on an email from Burcin on sage-devel - hope you don't mind :)  But you should still add yourself to the list on the main page.  Thanks!",
    "created_at": "2010-10-05T15:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117180",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>> Do you mind putting your "real" name in the "reviewer" list, and then adding yourself to the long list of Trac users on the main Trac page?  Thanks - that helps a lot; otherwise I'm not sure how we'd track you down.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117181",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117182",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Speaking of these doc issues, when reading through the doc in symbolic/expression.pyx I realized that there were some pre-existing problems in the html documentation.  This is now #10080.\n\n11 out of 12 consecutive tickets all as followups from one ticket... this must be a good ticket ;)  Or at least well-proofread, since nearly all of these things have nothing to do with the ticket per se, but were discovered while reviewing it.",
    "created_at": "2010-10-06T01:47:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117183",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:11'></a>Speaking of these doc issues, when reading through the doc in symbolic/expression.pyx I realized that there were some pre-existing problems in the html documentation.  This is now #10080.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117184",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9879#event-24886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9879",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9879#issuecomment-117185",
    "user": "https://github.com/qed777"
}
```
