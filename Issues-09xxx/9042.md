...
```json
{
    "body": "<a id='comment:2'></a>This won't solve the problem, but you could try changing the line in spkg-install to \n\n```\npython setup.py install --no-cython-compile\n```\n\nAnd see if you can then compile anything else.",
    "created_at": "2010-05-25T05:59:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99512",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>This won't solve the problem, but you could try changing the line in spkg-install to 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99513",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Again, this was due to Python being misconfigured. As I pointed out earlier, you need -m64 in OPT. New spkg at\n\nhttp://sage/home/robertwb/python-2.6.4.p8.spkg",
    "created_at": "2010-05-25T08:20:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99514",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>Again, this was due to Python being misconfigured. As I pointed out earlier, you need -m64 in OPT. New spkg at
...
```json
{
    "body": "<a id='comment:4'></a>Thank you. That revised package solves the problem, though I can't see what you have patched! I don't see any -m64 or $OPT added or removed from spkg-install or any entry in SPKG.txt as to what has changed. \n\nAlso, there is an unwanted file. \n\n```\ndrkirkby@hawk:~/sage-4.4.2/spkg/standard/python-2.6.4.p8$ hg status\n? spkg-install~\n```\n\n\nBut Cython does now build.\n\n```\nWriting /export/home/drkirkby/sage-4.4.2/local/lib/python2.6/site-packages/Cython-0.12.1-py2.6.egg-info\n\nreal    0m26.832s\nuser    0m25.819s\nsys     0m0.919s\nSuccessfully installed cython-0.12.1\nNow cleaning up tmp files.\nrm: Cannot remove any directory in the path of the current working directory\n/export/home/drkirkby/sage-4.4.2/spkg/build/cython-0.12.1\nMaking Sage/Python scripts relocatable...\nMaking script relocatable\nFinished installing cython-0.12.1.spkg\n```\n\nDave",
    "created_at": "2010-05-25T15:17:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99515",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>Thank you. That revised package solves the problem, though I can't see what you have patched! I don't see any -m64 or $OPT added or removed from spkg-install or any entry in SPKG.txt as to what has changed. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99516",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99517",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99518",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>You may also be interested in #9047 which will prevent me (and others) from checking in garbage.",
    "created_at": "2010-05-25T18:58:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99520",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>You may also be interested in #9047 which will prevent me (and others) from checking in garbage.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99521",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Robert Bradsure\"",
    "created_at": "2010-05-26T06:27:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99522",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing author from "" to "Robert Bradsure"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99523",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99524",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99525",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99526",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99527",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99528",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>To give proper credit, I'm closing this as if I've merged the changes here. See #9295.",
    "created_at": "2010-06-25T15:51:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99529",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:11'></a>To give proper credit, I'm closing this as if I've merged the changes here. See #9295.
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -32,7 +32,7 @@\n \n ```\n drkirkby@hawk:~/sage-4.4.2$ file local/bin/python\n-local/bin/python:\tELF 64-bit LSB executable AMD64 Version 1, dynamically linked, not stripped\n+local/bin/python: ELF 64-bit LSB executable AMD64 Version 1, dynamically linked, not stripped\n ```\n \n We can see a few modules did not build\n@@ -96,7 +96,7 @@\n The -m64 flag is not being used in the compile line shown, but Python was built 64-bit, so I suspect the issue is related to a mix of 32-bit and 64-bit code. \n \n ## Other OpenSolaris issues\n-Some other problems which are failing to allow Sage to build 64-bit on OpenSolaris are listed at #9026.\n+Some other problems which are failing to allow Sage to build 64-bit on OpenSolaris are listed at #9026. \n \n Summary: Cython fails to build in OpenSolaris x64\n \n``````\n",
    "created_at": "2015-09-06T16:04:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9042#issuecomment-99530",
