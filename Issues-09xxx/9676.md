...
```json
{
    "body": "This adds a [RandomTree](../wikis/RandomTree) constructor to the graphs class. Users can type g=graphs.RandomTree(n) to create a new random tree with n vertices named 0 through n-1. \n\n**Assignee:** @jasongrout, @nathanncohen, @rlmill\n\n**Author:** Ed Scheinerman\n\n**Reviewer:** Nathann Cohen\n\n**Merged:** sage-4.6.alpha1\n\nIssue created by migration from https://trac.sagemath.org/ticket/9676\n\n",
...
```
This adds a [RandomTree](../wikis/RandomTree) constructor to the graphs class. Users can type g=graphs.RandomTree(n) to create a new random tree with n vertices named 0 through n-1. 
...
```json
{
    "body": "<a id='comment:2'></a>\nDear all,\nI have uploaded a new version of the [RandomTree](../wikis/RandomTree) constructor. The algorithm is an inverse Prufer code method. We generate an (n-2)-long sequence of random values in {0,...,n-1} and use that to build a tree. Looking forward to seeing if this new version passes muster.\nEd",
    "created_at": "2010-08-10T23:12:26Z",
    "issue": "https://github.com/sagemath/sage/issues/9676",
    "type": "issue_comment",
...
```json
{
    "body": "New, improved, repaired [RandomTree](../wikis/RandomTree) graph constructor",
...
New, improved, repaired [RandomTree](../wikis/RandomTree) graph constructor
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [trac_9676.patch](https://github.com/sagemath/sage/files/ticket9676/trac_9676.patch)\n\nCommit string edited as requested.",
    "created_at": "2010-09-06T00:42:07Z",
    "issue": "https://github.com/sagemath/sage/issues/9676",
    "type": "issue_comment",
