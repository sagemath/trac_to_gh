...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9645#event-113487"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9645#event-113488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9645#event-113489"
}
```
...
```json
{
    "body": "Changed assignee from **@malb** to **duleorlovic**",
...
Changed assignee from **@malb** to **duleorlovic**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9645#issuecomment-86314",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9645#issuecomment-86315",
