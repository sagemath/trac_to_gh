...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9528#event-111856"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9528#event-111857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9528#event-111858"
}
```
...
```json
{
    "body": "<a id='comment:13'>Comment 13:</a>\nUpgrading from 4.4.4 to 4.5 works for me on sage.math with [attachment: install.2.gz](https://github.com/sagemath/sage/files/ticket9528/install.2.gz).  The long doctests pass.  This is with `MAKE=\"-j12\"` and `SAGE_PARALLEL_SPKG_BUILD=\"yes\"`.  A separate, completely serial upgrade with MAKE unset is still running.\n\nStarting with \"4.5\" on sage.math, I copied [attachment: install.2.gz](https://github.com/sagemath/sage/files/ticket9528/install.2.gz) to `spkg/` and made a new source distribution with `sage -sdist 4.5.1`.  This builds with `MAKE=\"-j20\"` and `SAGE_PARALLEL_SPKG_BUILD=\"yes\"`.  The long doctests pass.  Another build with just `MAKE=\"-j16\"` is still running.\n\nThanks again for fixing this.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9528#issuecomment-84351",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9528#issuecomment-84352",
