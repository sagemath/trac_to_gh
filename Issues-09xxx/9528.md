...
```json
{
    "body": "**Attachment:** [create-pipestatus.sh](https://github.com/sagemath/sage/files/ticket9528/create-pipestatus.sh)\n\nBash script to create specific version of \"pipestatus\" in $SAGE_ROOT/spkg",
    "created_at": "2010-07-17T13:56:28Z",
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "issue_comment",
...
**Attachment:** [create-pipestatus.sh](https://github.com/sagemath/sage/files/ticket9528/create-pipestatus.sh)
...
```json
{
    "body": "**Attachment:** [install](https://github.com/sagemath/sage/files/ticket9528/install)\n\nthis should be put as SAGE_ROOT/spkg/install",
    "created_at": "2010-07-17T14:59:10Z",
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "issue_comment",
...
**Attachment:** [install](https://github.com/sagemath/sage/files/ticket9528/install)
...
```json
{
    "body": "**Attachment:** [create-pipestatus-v2.sh](https://github.com/sagemath/sage/files/ticket9528/create-pipestatus-v2.sh)\n\nCreates a slightly improved version of pipestatus, no changes to the script code itself",
    "created_at": "2010-07-17T15:00:40Z",
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "issue_comment",
...
**Attachment:** [create-pipestatus-v2.sh](https://github.com/sagemath/sage/files/ticket9528/create-pipestatus-v2.sh)
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9528/install.2",
    "created_at": "2010-07-17T21:17:56Z",
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9528/install.2",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "**Attachment:** [install.2](https://github.com/sagemath/sage/files/ticket9528/install.2)\n\n**Attachment:** [install.diff](https://github.com/sagemath/sage/files/ticket9528/install.diff)\n\nDiff of `spkg/install` vs \"4.5\".",
    "created_at": "2010-07-17T21:17:56Z",
    "issue": "https://github.com/sagemath/sage/issues/9528",
    "type": "issue_comment",
...
**Attachment:** [install.2](https://github.com/sagemath/sage/files/ticket9528/install.2)
