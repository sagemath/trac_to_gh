...
```json
{
    "body": "Changed assignee from **@gvol** to **@sagetrac-mhampton**",
...
Changed assignee from **@gvol** to **@sagetrac-mhampton**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9873#event-116907"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9873#event-116908"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9873",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9873#event-116909"
}
```
