...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111521"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111522"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111523"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111524"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9763#event-111526"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9763#issuecomment-88342",
    "user": "https://github.com/cousteaulecommandant"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9763#issuecomment-88343",
    "user": "https://github.com/cousteaulecommandant"
}
```
