...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[04464c7](http://git.sagemath.org/sage.git/commit/?id=04464c7ef6a6f3867850fb538f417c485871c45c)|`remove duplicates from list of S-units`|",
    "created_at": "2014-04-18T00:39:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9341",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[8767cc4](http://git.sagemath.org/sage.git/commit/?id=8767cc4af62dfc9f13e8c4aac373cc511075d02f)|`more robust fix to the multiple entries in S-unit list`|",
    "created_at": "2014-04-18T22:25:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9341",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[c3d928c](http://git.sagemath.org/sage.git/commit/?id=c3d928cab2b6157d14e876b2c8f32d6200ad17dd)|`move the fix to the helper function _S_class_group_and_units`|",
    "created_at": "2014-04-18T22:28:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9341",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[0eca7aa](http://git.sagemath.org/sage.git/commit/?id=0eca7aaad766a59cebbc648726526ecf202b3e3e)|`minor docstring fix`|",
