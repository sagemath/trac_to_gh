...
```json
{
    "body": "<a id='comment:1'></a>The attached patch fixes that spelling error. (Note there are other similar errors in the source\nfiles, but that one is directly visible to the user.)",
    "created_at": "2010-06-05T12:27:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9149",
    "type": "issue_comment",
...
<a id='comment:1'></a>The attached patch fixes that spelling error. (Note there are other similar errors in the source
files, but that one is directly visible to the user.)
...
```json
{
    "body": "<a id='comment:2'></a>Thanks for this.",
    "created_at": "2010-06-05T15:21:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9149",
    "type": "issue_comment",
...
<a id='comment:2'></a>Thanks for this.
