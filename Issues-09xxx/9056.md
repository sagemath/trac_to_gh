...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101734"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101737"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101738"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101741"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76753",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76754",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76755",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76756",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76757",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76758",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76759",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101744"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76760",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76761",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76762",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76763",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76764",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76765",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:18'>Comment 18:</a>\nReplying to [@mwhansen](#comment%3A17):\n> Things look good to me.  Could I get a quick review of the patch I just posted.  Without this, llt.py times out.\n\nOn my copy of 4.4.4.alpha0, with [attachment: trac_9056_semirings_category-nb.patch.gz](https://github.com/sagemath/sage/files/ticket9056/trac_9056_semirings_category-nb.patch.gz) applied, I got the timeout without your reviewer patch, and it takes about 8 seconds with your patch. I don't like disabling our doctest coverage, but this seems reasonable. Positive review to your reviewer patch. I'm leaving this as needs_review; Mike, you can change this if everything else is okay.",
    "created_at": "2010-06-09T03:29:16Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76766",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76767",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76768",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9056#event-101751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76769",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76770",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76771",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9056#issuecomment-76772",
    "user": "https://github.com/nthiery"
}
```
