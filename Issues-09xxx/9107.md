...
```json
{
    "body": "<a id='comment:75'></a>\nGosh, it turned out that using `\\setlistdepth{275}` was not sufficient\nanymore: I had to use `\\setlistdepth{2000}`! This meant the problem\nwould just keep going to be worst and worst with time.\n\nSo I investigated a further and got lucky this time: if we replace\nlist by trivlist in the customized Verbatim defined by `sphinx.sty`,\nthen our documenation compiles smoothly, without even using enumitem.\n\nI proposed this fix upstream:\n\nhttps://bitbucket.org/birkenfeld/sphinx/issue/777/latex-output-too-deeply-nested\n\nFor the time being, I tweaked our conf.py to redefine and fix sphinx's\nVerbatim.\n\nOk, now there just remains to check that all tests pass, and this will\nbe a needs review.\n\nCheers,\n                              Nicolas\n\n---\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[727bd6a](https://github.com/sagemath/sagetrac-mirror/commit/727bd6a3ce1c577295a5fd421c257ae89618e989)|`#9107: Enable nesting of a nested class into a nested class`|\n|[213e3b1](https://github.com/sagemath/sagetrac-mirror/commit/213e3b1a612b7e34933432fdd01d0d3f61fe7016)|`#9107: Fix one cross reference in the documentation of a functorial construction`|\n|[66b7e72](https://github.com/sagemath/sagetrac-mirror/commit/66b7e72505a6683f246535083f071a3963b11104)|`#9107: fix a docstring (missing example and raw)`|\n|[891c3fa](https://github.com/sagemath/sagetrac-mirror/commit/891c3fad654e89e6b96bcf8f79114f631c8b7bba)|`#9107: monkey patch a fix for deeply nested pdflatex compilation error until it's merged upstream (Sphinx #777)`|",
    "created_at": "2014-06-13T09:24:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9107",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:78'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[ed2c704](https://github.com/sagemath/sagetrac-mirror/commit/ed2c7047aab14dce0abbf22eb531fa0667179982)|`#9107: updated doctests now that the name of deeply nested classes is finaly correct`|",
    "created_at": "2014-06-13T19:43:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9107",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:81'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[8b14e05](https://github.com/sagemath/sagetrac-mirror/commit/8b14e051c933f2ec2ae9891efbf329e7f0f2cba4)|`#9107: improved description of Sphinx's patch nested.patch`|",
