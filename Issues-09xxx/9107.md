...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102438"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102439"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102449"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102450"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102451"
}
```
...
```json
{
    "body": "<a id='comment:55'>Comment 55:</a>\nHow can one test [attachment: categories.tex.gz](https://github.com/sagemath/sage/files/ticket9107/categories.tex.gz)? I can not run pdflatex on it, because it can't find `sphinxmanual.cls`. Where do I get this file (and probably other files) from?",
...
```json
{
    "body": "<a id='comment:62'>Comment 62:</a>\nAttachment: **[categories.pdf.gz](https://github.com/sagemath/sage/files/ticket9107/categories.pdf.gz)**\n\nWell, it does compile, but it does not work. Look at the ugly output in [attachment: categories.pdf.gz](https://github.com/sagemath/sage/files/ticket9107/categories.pdf.gz).",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102452"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102453"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102454"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77391",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77392",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77393",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77394",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77395",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77396",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102456"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77397",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77398",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77399",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77400",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77401",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77402",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77403",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77404",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77405",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77406",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77407",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102460"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9107#event-102461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77408",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77409",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9107#issuecomment-77410",
    "user": "https://github.com/fchapoton"
}
```
