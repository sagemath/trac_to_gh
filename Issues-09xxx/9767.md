...
```json
{
    "body": "<a id='comment:1'></a>Dave, be warned: You'll hate me if I should review this (`spkg-install`, `patches/Makefile`).",
    "created_at": "2010-09-04T04:29:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9767#issuecomment-114553",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Dave, be warned: You'll hate me if I should review this (`spkg-install`, `patches/Makefile`).
...
```json
{
    "body": "<a id='comment:2'></a>Also note that the upstream directory (`src/`) is **not vanilla**.",
    "created_at": "2010-09-04T05:23:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9767#issuecomment-114554",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>Also note that the upstream directory (`src/`) is **not vanilla**.
...
```json
{
    "body": "<a id='comment:3'></a>I realise this is a duplicate of #9521",
    "created_at": "2010-09-04T07:51:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9767#issuecomment-114555",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>I realise this is a duplicate of #9521
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9767#issuecomment-114556",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
