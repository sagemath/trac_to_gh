...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9493#event-111323"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9493#event-111324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9493#event-111325"
}
```
...
```json
{
    "body": "Changed keywords from **** to **ecl gmp cygwin spkg**",
    "created_at": "2014-04-13T19:27:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9493",
    "type": "issue_comment",
...
Changed keywords from **** to **ecl gmp cygwin spkg**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9493#issuecomment-83838",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9493#issuecomment-83839",
    "user": "https://github.com/vbraun"
}
```
