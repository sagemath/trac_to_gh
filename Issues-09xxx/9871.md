...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73880"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90233",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90234",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "rename": {
        "from": "Update Cliquer to 1.21 and get the library buiilding properly on Solaris.",
        "to": "Update Cliquer to the latest version (1.21) and get the library buiilding properly on Solaris."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90235",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73883"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73884"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73885"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90236",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_name": "9871-update-cliquer-and-add-Solaris-fix.patch",
    "asset_url": "tarball://root/attachments/ticket9871/9871-update-cliquer-and-add-Solaris-fix.patch",
    "created_at": "2010-09-08T02:01:29Z",
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9871/9871-update-cliquer-and-add-Solaris-fix.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [9871-update-cliquer-and-add-Solaris-fix.patch](https://github.com/sagemath/sage/files/ticket9871/9871-update-cliquer-and-add-Solaris-fix.patch)\n\nMercurial patch. Note, the patched Makefile was not under revision control before, so the patch is quite big.",
    "created_at": "2010-09-08T02:01:29Z",
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90237",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

**Attachment:** [9871-update-cliquer-and-add-Solaris-fix.patch](https://github.com/sagemath/sage/files/ticket9871/9871-update-cliquer-and-add-Solaris-fix.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90238",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90239",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90240",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73887"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90241",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90242",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90243",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90244",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90245",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90246",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90247",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "rename": {
        "from": "Update Cliquer to the latest version (1.21) and get the library buiilding properly on Solaris.",
        "to": "Change compiler flags on Solaris to build without text relocations."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90248",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73890"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90249",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90250",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch",
    "asset_url": "tarball://root/attachments/ticket9871/9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch",
    "created_at": "2010-09-13T21:12:44Z",
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9871/9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch](https://github.com/sagemath/sage/files/ticket9871/9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch)\n\nSimple patch which *replaces* the earlier patch.",
    "created_at": "2010-09-13T21:12:44Z",
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90251",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

**Attachment:** [9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch](https://github.com/sagemath/sage/files/ticket9871/9871-simpler-patch-to-ONLY-solve-Solaris-problems.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73892"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73893"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90252",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90253",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73894"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73895"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90254",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9871#issuecomment-90255",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73896"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73897"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73898"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73899"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73900"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73901"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9871",
    "rename": {
        "from": "Change compiler flags on Solaris to build without text relocations.",
        "to": "Change Cliquer compiler flags on Solaris to build without text relocations."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9871#event-73902"
}
```
