...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9870#event-116839"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9870#event-116840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9870#event-116841"
}
```
...
```json
{
    "body": "Changed assignee from **GeorgSWeber** to **@nexttime**",
...
Changed assignee from **GeorgSWeber** to **@nexttime**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9870#issuecomment-90254",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9870#issuecomment-90255",
    "user": "https://github.com/sagetrac-jpflori"
}
```
