...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120684"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120687"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120688"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9406#issuecomment-80442",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9406",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-120691"
}
```
