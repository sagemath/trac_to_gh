...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112653"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112658"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112659"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9841#issuecomment-89869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9841#issuecomment-89870",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9841",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9841#event-112661"
}
```
