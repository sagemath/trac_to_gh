...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9731#issuecomment-113847",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_9731.patch](tarball://root/attachments/some-uuid/ticket9731/trac_9731.patch) by @nathanncohen created at 2010-08-12 03:50:55",
    "created_at": "2010-08-12T03:50:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9731#issuecomment-113848",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:1'></a>Attachment [trac_9731.patch](tarball://root/attachments/some-uuid/ticket9731/trac_9731.patch) by @nathanncohen created at 2010-08-12 03:50:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9731#issuecomment-113849",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9731#issuecomment-113850",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>By the way, those showed up with sage-4.6.1.alpha2 plus the patches here, if that is relevant.",
    "created_at": "2010-11-26T17:12:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9731#issuecomment-113851",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>By the way, those showed up with sage-4.6.1.alpha2 plus the patches here, if that is relevant.
...
```json
{
    "body": "<a id='comment:4'></a>Not only that, but once the yaml export is removed the graphml docstring does not pass because of stupid edge labels set by default (if you write a file without any edge label, the one you get has its endpoints as labels) with weird 'u' before the vertices' name... O_o\n\nNathann",
    "created_at": "2010-11-29T19:15:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9731#issuecomment-113852",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Not only that, but once the yaml export is removed the graphml docstring does not pass because of stupid edge labels set by default (if you write a file without any edge label, the one you get has its endpoints as labels) with weird 'u' before the vertices' name... O_o
