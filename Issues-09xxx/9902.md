...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9902#issuecomment-117958",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9902#issuecomment-117959",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Andrey, I wrote this patch a while a go to be able to extend the base field of the toric coordinate ring. It might be useful...",
    "created_at": "2010-12-20T19:16:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9902#issuecomment-117960",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Andrey, I wrote this patch a while a go to be able to extend the base field of the toric coordinate ring. It might be useful...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9902#issuecomment-117961",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9902#issuecomment-117962",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24942"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24943"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24944"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24945"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24946"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24947"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9902#event-24948"
}
```
