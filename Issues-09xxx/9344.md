...
```json
{
    "body": "Attachment [matrices.patch](https://github.com/sagemath/sage/files/ticket9344/matrices.patch) by @lftabera created at 2010-06-26 10:14:08",
    "created_at": "2010-06-26T10:14:08Z",
    "issue": "https://github.com/sagemath/sage/issues/9344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9344#issuecomment-81398",
    "user": "https://github.com/lftabera"
}
```

Attachment [matrices.patch](https://github.com/sagemath/sage/files/ticket9344/matrices.patch) by @lftabera created at 2010-06-26 10:14:08
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9344#issuecomment-81399",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9344#issuecomment-81400",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Attachment [trac_9344-matrix_constructor_bug.patch](https://github.com/sagemath/sage/files/ticket9344/trac_9344-matrix_constructor_bug.patch) by @loefflerd created at 2010-06-30 08:56:04\n\napply this patch -- identical code but with more informative hg header information",
    "created_at": "2010-06-30T08:56:04Z",
    "issue": "https://github.com/sagemath/sage/issues/9344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9344#issuecomment-81401",
    "user": "https://github.com/loefflerd"
}
```

Attachment [trac_9344-matrix_constructor_bug.patch](https://github.com/sagemath/sage/files/ticket9344/trac_9344-matrix_constructor_bug.patch) by @loefflerd created at 2010-06-30 08:56:04
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9344#issuecomment-81402",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9344#issuecomment-81403",
