...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115906",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The patch fixes this.  It catches all bases which pass the is_field() test, after testing for the special types (rational, number fields, finite fields, etc).  So it gives better functionality for elliptic curves over RR, CC, QQbar, functions fields, ...",
    "created_at": "2010-08-27T09:08:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115907",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>The patch fixes this.  It catches all bases which pass the is_field() test, after testing for the special types (rational, number fields, finite fields, etc).  So it gives better functionality for elliptic curves over RR, CC, QQbar, functions fields, ...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115908",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>That is fine. All test pass on my 4.5.2. Thanks John.\n\nChris.",
    "created_at": "2010-08-31T19:01:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115909",
    "user": "https://github.com/categorie"
}
```

<a id='comment:2'></a>That is fine. All test pass on my 4.5.2. Thanks John.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115910",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115911",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115912",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9816#issuecomment-115913",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9816",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9816#event-24667"
}
```
