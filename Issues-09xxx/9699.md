...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112884",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112885",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_9699.patch](tarball://root/attachments/some-uuid/ticket9699/trac_9699.patch) by @rlmill created at 2010-08-07 11:58:53",
    "created_at": "2010-08-07T11:58:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112886",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:2'></a>Attachment [trac_9699.patch](tarball://root/attachments/some-uuid/ticket9699/trac_9699.patch) by @rlmill created at 2010-08-07 11:58:53
...
```json
{
    "body": "<a id='comment:3'></a>I wonder if the default for `barycentric` shouldn't be True instead of False. It looks a bit nicer that way, so why not make it the default?",
    "created_at": "2010-08-07T12:00:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112887",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>I wonder if the default for `barycentric` shouldn't be True instead of False. It looks a bit nicer that way, so why not make it the default?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112888",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112889",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112890",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Well, if such an option is the default, shouldn't we just replace the actual code with it ? As these barycentric coordinates are as valid as the previous ones in the general case, I except the code used by barycentric = False never to be used again... `:-p`\n\nWhat about just replacing the current code to compute barycentric coordinates, and add this information as notes in the documentation ?\n\nNathann",
    "created_at": "2010-09-05T07:49:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112891",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>Well, if such an option is the default, shouldn't we just replace the actual code with it ? As these barycentric coordinates are as valid as the previous ones in the general case, I except the code used by barycentric = False never to be used again... `:-p`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112892",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112893",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112894",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112896",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112897",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112898",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112900",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112901",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112902",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112903",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112904",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112905",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112906",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112908",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112909",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112910",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112911",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112912",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112913",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [trac_9699_5.patch](tarball://root/attachments/some-uuid/ticket9699/trac_9699_5.patch) by fidelbarrera created at 2010-11-27 04:33:49\n\nReplying to [rlm](#comment%3A17): \n> Jeroen is right. You should replace things like `0.866025403784` with `0.86...` so that numerical issues don't crop up. \n\n\nReplaced things like `0.866025403784` with `0.86...`.\n\nPlease see trac_9699_5.patch instead of previous versions.",
    "created_at": "2010-11-27T04:33:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112914",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```

<a id='comment:18'></a>Attachment [trac_9699_5.patch](tarball://root/attachments/some-uuid/ticket9699/trac_9699_5.patch) by fidelbarrera created at 2010-11-27 04:33:49
...
```json
{
    "body": "<a id='comment:19'></a>Okay, I tested all long doctests on a 64 bit Linux machine, and all passed. I also tested long doctests in `sage/graphs` on a 32 bit Linux machine, and again all tests pass. Things look good.",
    "created_at": "2010-11-28T16:32:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112915",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:19'></a>Okay, I tested all long doctests on a 64 bit Linux machine, and all passed. I also tested long doctests in `sage/graphs` on a 32 bit Linux machine, and again all tests pass. Things look good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112916",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112917",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>It seems I pressed submit too soon. Indeed all tests pass on the 64 bit system.\n\nHowever on the 32-bit system, things seem to freeze at the following test:\n\n```\nTrying:\n    g = graphs.BalancedTree(Integer(3),Integer(4))###line 2658:_sage_    >>> g = graphs.BalancedTree(3,4)\nExpecting nothing\nok\nTrying:\n    g.set_planar_positions(test=True)###line 2659:_sage_    >>> g.set_planar_positions(test=True)\nExpecting:\n    True\n```",
    "created_at": "2010-11-28T16:59:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9699#issuecomment-112918",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:20'></a>It seems I pressed submit too soon. Indeed all tests pass on the 64 bit system.
