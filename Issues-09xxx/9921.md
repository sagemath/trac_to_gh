...
```json
{
    "body": "<a id='comment:1'></a>The current website for nose is: http://code.google.com/p/python-nose/",
    "created_at": "2010-09-16T17:33:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118343",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>The current website for nose is: http://code.google.com/p/python-nose/
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118344",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Yes, I'm thinking (according to guidelines) optional for now, standard after a probationary period.",
    "created_at": "2010-09-16T18:56:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118346",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>Yes, I'm thinking (according to guidelines) optional for now, standard after a probationary period.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118347",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Whether or not it should be standard, I agree that we need to at least have it optional so that it becomes more 'Sage-ic' (totally not the right adjective, but I'm groping here) to test several fundamental python packages from within Sage.  Also, it is needed to test some potential other packages, such as Brian (#9675), which is where I originally found out about this.",
    "created_at": "2010-09-17T00:28:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118348",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Whether or not it should be standard, I agree that we need to at least have it optional so that it becomes more 'Sage-ic' (totally not the right adjective, but I'm groping here) to test several fundamental python packages from within Sage.  Also, it is needed to test some potential other packages, such as Brian (#9675), which is where I originally found out about this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118351",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>> > [...] However, I think some changes should be made in order to fit the structure of Sage packages: all the code should be in a directory named src/, it lacks the .hg folder, the .hgignore and SPKG.txt files, etc. [...]\n\n> \n> ? Of course we first have to produce an spkg, be it optional or (later) standard.\n> \n> Or did I miss something?\n\n\nNo, I think that uri was perhaps misunderstanding jason's directions to use nose outside of Sage to be a suggestion for how it would become a Sage package.  No harm done in reminding us of the official rules, though :)",
    "created_at": "2010-09-20T02:51:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118352",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>> > [...] However, I think some changes should be made in order to fit the structure of Sage packages: all the code should be in a directory named src/, it lacks the .hg folder, the .hgignore and SPKG.txt files, etc. [...]
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118353",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Ok, we should concatenate the lines with `&&` to make it more robust...",
    "created_at": "2010-09-20T03:04:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118354",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:11'></a>Ok, we should concatenate the lines with `&&` to make it more robust...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118355",
    "user": "https://trac.sagemath.org/admin/accounts/users/uri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118356",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I tried using nose, and it was very interesting.  Tested Brian on two different boxes, and then tested both numpy and scipy on OS X 10.6 - discovered no errors on the first, and a fair number on the second!  So I think that there should be no doubt this could go straight to optional if an spkg was made.\n\nI couldn't do\n\n```\nimport matplotlib\nmatplotlib.test()\n```\nbecause for some reason our matplotlib doesn't have this method.\n\nMuch less importantly, I should also point out that on OS X `wget` is not a builtin, though I have an alias `curl -O` that seems to accomplish the same purpose.  I just downloaded and double-clicked, actually :)",
    "created_at": "2010-09-21T01:25:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118357",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>I tried using nose, and it was very interesting.  Tested Brian on two different boxes, and then tested both numpy and scipy on OS X 10.6 - discovered no errors on the first, and a fair number on the second!  So I think that there should be no doubt this could go straight to optional if an spkg was made.
...
```json
{
    "body": "<a id='comment:15'></a>Nose is now on Github: [https://github.com/nose-devs/nose](https://github.com/nose-devs/nose).",
    "created_at": "2012-05-26T20:11:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118358",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:15'></a>Nose is now on Github: [https://github.com/nose-devs/nose](https://github.com/nose-devs/nose).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118359",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I've posted an spkg. It builds well enough for me, but I haven't actually used it to test anything except for itself (in spkg-check).",
    "created_at": "2012-06-14T23:18:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118360",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:17'></a>I've posted an spkg. It builds well enough for me, but I haven't actually used it to test anything except for itself (in spkg-check).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118361",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118362",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118363",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [trac_9921-nose-scripts.patch](tarball://root/attachments/some-uuid/ticket9921/trac_9921-nose-scripts.patch) by @jhpalmieri created at 2012-06-14 23:20:18",
    "created_at": "2012-06-14T23:20:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118364",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:18'></a>Attachment [trac_9921-nose-scripts.patch](tarball://root/attachments/some-uuid/ticket9921/trac_9921-nose-scripts.patch) by @jhpalmieri created at 2012-06-14 23:20:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118365",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>By the way, version 1.1.2 was the most recent version for which I could find a tar ball. Or we could use the version from github; would that be better?",
    "created_at": "2012-06-14T23:24:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118366",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:19'></a>By the way, version 1.1.2 was the most recent version for which I could find a tar ball. Or we could use the version from github; would that be better?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118367",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I've now also prepared a version from git. This one fails its own self tests, though ;)",
    "created_at": "2012-06-14T23:33:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118368",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:21'></a>I've now also prepared a version from git. This one fails its own self tests, though ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118369",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118370",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>> I've now also prepared a version from git. This one fails its own self tests, though ;)\n\nInteresting!\n\nYou can try using it with the brian optional spkg, and I believe numpy and mpl also use this?",
    "created_at": "2012-06-15T01:50:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118371",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>> I've now also prepared a version from git. This one fails its own self tests, though ;)
...
```json
{
    "body": "<a id='comment:23'></a>ipython also uses nose.",
    "created_at": "2012-06-15T04:08:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118372",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:23'></a>ipython also uses nose.
...
```json
{
    "body": "<a id='comment:24'></a>I tried running self-tests with numpy, using `python -c 'import numpy; numpy.test()'`. The good news: tests ran. The bad news: some tests failed. More bad news: this exited with a return code of zero, so it's hard to tell (within spkg-check, for example), that tests failed. I have the same issue with IPython.",
    "created_at": "2012-06-15T17:13:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118373",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:24'></a>I tried running self-tests with numpy, using `python -c 'import numpy; numpy.test()'`. The good news: tests ran. The bad news: some tests failed. More bad news: this exited with a return code of zero, so it's hard to tell (within spkg-check, for example), that tests failed. I have the same issue with IPython.
...
```json
{
    "body": "<a id='comment:25'></a>So is that a problem with nose or a problem with the numpy/ipython test suites?  Sounds like nose is ready from this point of view :)",
    "created_at": "2012-06-15T17:17:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118374",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:25'></a>So is that a problem with nose or a problem with the numpy/ipython test suites?  Sounds like nose is ready from this point of view :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118375",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118376",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118377",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>I have also reviewed this ticket, since I think it is important to have it. The matplotlib error is really a bug (or at least laxness) in matplotlib. If we waited for nosetest to be included until all spkg's pass, we would wait until the cows come home.\n\nIf nobody objects, I will set this to positive review by next week.",
    "created_at": "2013-01-24T12:47:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118379",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:28'></a>I have also reviewed this ticket, since I think it is important to have it. The matplotlib error is really a bug (or at least laxness) in matplotlib. If we waited for nosetest to be included until all spkg's pass, we would wait until the cows come home.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118380",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118381",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118382",
...
```json
{
    "body": "<a id='comment:31'></a>spkg is put on the servers.",
    "created_at": "2013-01-30T16:31:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118383",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:31'></a>spkg is put on the servers.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118384",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9921#issuecomment-118385",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9921",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9921#event-25013"
}
```
