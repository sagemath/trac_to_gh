...
```json
{
    "body": "<div id=\"comment:34\" align=\"right\">comment:34</div>\n\n> 1. Apply the patch at the ticket to the scripts repository (in SAGE_ROOT/local/bin):[https://github.com/sagemath/sage/files/ticket9210/trac-9210-rewrite-sage-location.patch.gz](https://github.com/sagemath/sage/files/ticket9210/trac-9210-rewrite-sage-location.patch.gz)\n\nThe link is wrong but the text is right; https://github.com/sagemath/sage/files/ticket9210/trac-9210-rewrite-sage-location.patch.gz",
