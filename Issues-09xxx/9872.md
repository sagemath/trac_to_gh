...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9872#event-73903"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9872#event-73904"
}
```
...
```json
{
    ...
    "asset_name": "polybori-0.6.4.p6.spkg.patch",
    "asset_url": "tarball://root/attachments/ticket9872/polybori-0.6.4.p6.spkg.patch",
    "created_at": "2010-09-13T15:17:01Z",
    "issue": "https://github.com/sagemath/sage/issues/9872",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9872/polybori-0.6.4.p6.spkg.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9872#event-73905"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9872#event-73906"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9872#event-73907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9872",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9872#event-73908"
}
```
