...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                         |                      |\n|---------------------------------------------------------------------------------------------------------|----------------------|\n|[bb227b6](http://git.sagemath.org/sage.git/commit/?id=bb227b6)|`#9706: review patch.`|\n|[51fcd6b](http://git.sagemath.org/sage.git/commit/?id=51fcd6b)|`trac 9706: Propose new class structure`|\n|[4677a15](http://git.sagemath.org/sage.git/commit/?id=4677a15)|`Symbolic Chebyshev polynomials: reviewer patch`|\n|[75d1e43](http://git.sagemath.org/sage.git/commit/?id=75d1e43)|`trac 9706: Collective patch. Bugfixes, extensions, optimizations, documentation, doctests for chebyshev_T, chebyshev_U and base class for ortho polys`|",
