...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113152"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9620#issuecomment-85968",
    "user": "https://github.com/RBKreckel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9620#issuecomment-85969",
    "user": "https://github.com/RBKreckel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113156"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113159"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113160"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113161"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9620#event-113162"
}
```
