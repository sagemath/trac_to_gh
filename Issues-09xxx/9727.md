...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9727#issuecomment-87789",
    "user": "https://github.com/sagetrac-edward-scheinerman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9727#issuecomment-87790",
    "user": "https://github.com/sagetrac-edward-scheinerman"
}
```
...
```json
{
    "body": "Assignee: **@sagetrac-edward-scheinerman**",
...
Assignee: **@sagetrac-edward-scheinerman**
...
```json
{
    "body": "Removed assignee **@sagetrac-edward-scheinerman**",
...
Removed assignee **@sagetrac-edward-scheinerman**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9727",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9727#event-114828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9727#event-114829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9727#event-114830"
}
```
