# Issue 9974: The current (rather old) version of GnuTLS fails to install on AIX 5.3
...
```json
{
    ...
    "type": "issue",
    "updated_at": "2012-10-05T09:13:27Z",
    "url": "https://github.com/sagemath/sage/issues/9974",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-129996"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-129997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-129998"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-129999"
}
```
...
```json
{
    ...
    "created_at": "2010-09-24T15:51:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9974#issuecomment-90955",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-130000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-130001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9974#issuecomment-90956",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9974#issuecomment-90957",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-130002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-130003"
}
```
