...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9649#issuecomment-86317",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [9649.patch](https://github.com/sagemath/sage/files/ticket9649/9649.patch) by @robertwb created at 2010-07-31 19:00:35\n\nThis is obviously code that went in before the referee process :).",
    "created_at": "2010-07-31T19:00:35Z",
    "issue": "https://github.com/sagemath/sage/issues/9649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9649#issuecomment-86318",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9649#issuecomment-86319",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9649#issuecomment-86320",
    "user": "https://github.com/qed777"
}
```
