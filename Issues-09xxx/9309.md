...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108552"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9309#issuecomment-80337",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9309#issuecomment-80338",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108558"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9309",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9309#event-108560"
}
```
