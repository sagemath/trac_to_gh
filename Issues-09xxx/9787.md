...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[68ce711](http://git.sagemath.org/sage.git/commit/?id=68ce711a9ab7f5d0a972d8b6443e1fece4bc49e9)|`Trac 9787: use conversion into the base ring, clarify documentation`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[b73cd8b](http://git.sagemath.org/sage.git/commit/?id=b73cd8b97cc96c2c4373c91633aeed7ba7f8d9de)|`Trac 9787: add doctest`|",
