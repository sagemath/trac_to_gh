...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77214",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77215",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77216",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [64-bit-gap.patch](https://github.com/sagemath/sage/files/ticket9098/64-bit-gap.patch)\n\nMercurial patch which enables gap to build 64-bit on Solaris 10 and OpenSolaris",
    "created_at": "2010-06-14T21:13:46Z",
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77217",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

**Attachment:** [64-bit-gap.patch](https://github.com/sagemath/sage/files/ticket9098/64-bit-gap.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77218",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77219",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77220",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9098#issuecomment-77221",
