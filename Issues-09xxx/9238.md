...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9238#event-107669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9238#event-107670"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,8 +1,8 @@\n Ready for testing, but requires two steps.  Starting with a clean Sage 4.6.2: \n \n \n-1. patch for Jmol at the command line. See [#9232](https://github.com/sagemath/sage/issues/9232).\n-2. Apply the patch trac_9238_interactive_js.patch in attachments (below).\n+1. Patch and spkg for Jmol at the command line. See [#9232](https://github.com/sagemath/sage/issues/9232).\n+2. Apply [and [attachment: trac_9238-add-help.patch.gz](https://github.com/sagemath/sage/files/ticket9238/trac_9238-add-help.patch.gz)(https://github.com/sagemath/sage/files/ticket9238/2e66c82b5b51f4c86b9f489b1e70a2e8.gz).\n \n I have addressed the following issues (let me know if I've missed anything): \n \n@@ -16,32 +16,9 @@\n \n Happy testing and thank you to those who do test!\n \n-You can try an older version without going through patching by following the instructions below (the newer patched version is better).\n \n-If you are using Sage > 4.5 you can get the latest .spkg here:\n-\n-```\n-./sage -f http://www.uwosh.edu/faculty_staff/gutow/Jmol_for_SageNoteBook-1.1.4.spkg\n-```\n-\n-```\n-(or sage -f http://www.uwosh.edu/faculty_staff/gutow/Jmol_for_SageNoteBook-1.1.4.spkg)\n-```\n-If you are using <= Sage 4.5  the below should still work, but is outdated.  The newer package above will not work on older Sage because of changes in the notebook architecture.\n-\n-To test, do:\n-\n-```\n-sage -f http://www.uwosh.edu/faculty_staff/gutow/Jmol_for_SageNoteBook-1.1.2.spkg\n-```\n-or\n-\n-```\n-./sage -f http://www.uwosh.edu/faculty_staff/gutow/Jmol_for_SageNoteBook-1.1.2.spkg\n-```\n-depending on your command line syntax.\n-\n-This will change the Jmol files, jmol_lib.js and notebook_lib.js (current as of Sage 4.4.3), so you might want to do it in a test Sage installation.\n+---\n+Older description:\n \n Adds the following features to the notebook:\n \n``````\n",
...
```json
{
    "body": "<a id='comment:5'>Comment 5:</a>\nAfter #9232, apply [and [attachment: trac_9238-add-help.patch.gz](https://github.com/sagemath/sage/files/ticket9238/trac_9238-add-help.patch.gz)(https://github.com/sagemath/sage/files/ticket9238/2e66c82b5b51f4c86b9f489b1e70a2e8.gz).",
    "created_at": "2011-03-23T20:54:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,7 +6,7 @@\n \n \n 1. Patch and spkg for Jmol at the command line. See [#9232](https://github.com/sagemath/sage/issues/9232).\n-2. Apply [and [attachment: trac_9238-add-help.patch.gz](https://github.com/sagemath/sage/files/ticket9238/trac_9238-add-help.patch.gz)(https://github.com/sagemath/sage/files/ticket9238/2e66c82b5b51f4c86b9f489b1e70a2e8.gz). These are best applied using the hg_sagenb.apply(...) command within sage.\n+2. Apply [[attachment: trac_9238-add-help.patch.gz](https://github.com/sagemath/sage/files/ticket9238/trac_9238-add-help.patch.gz) and [attachment: trac_9238_jmol_lib_async.patch.gz](https://github.com/sagemath/sage/files/ticket9238/trac_9238_jmol_lib_async.patch.gz)(https://github.com/sagemath/sage/files/ticket9238/45ce25171f8d57c6f3df922f305d3ad2.gz). These are best applied using the hg_sagenb.apply(...) command within sage.\n \n I have addressed the following issues (let me know if I've missed anything): \n \n@@ -15,8 +15,13 @@\n \n * Fix so that the advanced controls are hidden when the applet is asleep (no accidental calls to nonexistent applets).\n * Fix to issue of not properly loading all applets when a worksheet  with a lot of applets is reopened (please check this one carefully). \n+* Fixes to vocabulary and labels to make things clearer.\n+* Hidden the  div with the State in it.  (Still there b/c I hope to be able to  recreate the way the user left it on close, rather than starting fresh  each time.)\n+* Fix to loading pages with many Jmols hanging. (FF on MacOS just doesn't work reliably or reproducibly so I put up a warning and suggest they switch to Chrome).\n+* Workaround for bug in MacOS Safari that causes hang when trying to get a static image to sleep an applet if more than 9 applets in a worksheet (I believe this is a memory leak problem).\n+* Tested extensively on Linux with FF and Chromium and on MacOS with Safari, Chrome and FF.\u00a0 Works well with both linux browsers and with Chrome on MacOS.\u00a0 MacOS/Safari is usable, MacOS FF is not.\n \n-* Fixes to vocabulary and labels to make things clearer. *Hidden the  div with the State in it.  (Still there b/c I hope to be able to  recreate the way the user left it on close, rather than starting fresh  each time.)\n+**Needs testing on windows! **\n \n Happy testing and thank you to those who do test!\n \n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9238#issuecomment-79581",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9238#issuecomment-79582",
    "user": "https://github.com/kcrisman"
}
```
