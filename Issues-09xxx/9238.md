...
archive/attachments_012081.json:
```json
{
...
archive/attachments_012082.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:73'></a>\n**Attachment:** [hide-advanced-jmol-controls.patch](https://github.com/sagemath/sage/files/ticket9238/hide-advanced-jmol-controls.patch)\n\nI attached a patch which adds an \"Advanced Controls\" button under the 3d applet which toggles the controls to the right.",
    "created_at": "2011-03-01T04:35:01Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [spt-attempt.diff](https://github.com/sagemath/sage/files/ticket9238/spt-attempt.diff)\n\nFor reference only - do not apply.",
    "created_at": "2011-03-15T15:15:53Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
**Attachment:** [spt-attempt.diff](https://github.com/sagemath/sage/files/ticket9238/spt-attempt.diff)
...
```json
{
    "body": "**Attachment:** [trac_9238-add-help.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238-add-help.patch)\n\nApply this as well",
    "created_at": "2011-03-23T20:52:27Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
**Attachment:** [trac_9238-add-help.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238-add-help.patch)
...
```json
{
    "body": "**Changing work issues** from \"pop-out windows not working when too many applets open\" to \"reduce awake applets, remove pull-down menu\".",
...
**Changing work issues** from "pop-out windows not working when too many applets open" to "reduce awake applets, remove pull-down menu".
...
```json
{
    "body": "**Changing work issues** from \"reduce awake applets, remove pull-down menu\" to \"reduce awake applets, remove pull-down menu, move 'on' checkbox\".",
...
**Changing work issues** from "reduce awake applets, remove pull-down menu" to "reduce awake applets, remove pull-down menu, move 'on' checkbox".
...
```json
{
    "body": "**Attachment:** [trac_9238_jmol_lib_async.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238_jmol_lib_async.patch)\n\nfix to async load of many jmols and workaround for Safari bug (memory leak?)",
    "created_at": "2011-03-28T00:55:15Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
**Attachment:** [trac_9238_jmol_lib_async.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238_jmol_lib_async.patch)
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_9238_memory_IE.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238_memory_IE.patch)",
    "created_at": "2011-03-29T07:03:57Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"reduce awake applets, remove pull-down menu, move 'on' checkbox\" to \"get advanced tools working in IE\".",
...
**Changing work issues** from "reduce awake applets, remove pull-down menu, move 'on' checkbox" to "get advanced tools working in IE".
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_9238_nice_IE_warnings.patch",
    "asset_url": "tarball://root/attachments/ticket9238/trac_9238_nice_IE_warnings.patch",
    "created_at": "2011-04-02T19:26:41Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9238/trac_9238_nice_IE_warnings.patch",
    "user": "https://github.com/gutow"
}
```
...
archive/attachments_012093.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_9238_nice_IE_warnings.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238_nice_IE_warnings.patch)\n\n**Attachment:** [Trac_9238_script_extension.patch](https://github.com/sagemath/sage/files/ticket9238/Trac_9238_script_extension.patch)\n\nFix to script file extension to work with new Jmol from command line",
    "created_at": "2011-04-02T19:26:41Z",
    "issue": "https://github.com/sagemath/sage/issues/9238",
    "type": "issue_comment",
...
**Attachment:** [trac_9238_nice_IE_warnings.patch](https://github.com/sagemath/sage/files/ticket9238/trac_9238_nice_IE_warnings.patch)
...
```json
{
    "body": "**Changing work issues** from \"get advanced tools working in IE\" to \"\".",
...
**Changing work issues** from "get advanced tools working in IE" to "".
