...
archive/attachments_011933.json:
```json
{
...
archive/attachments_011934.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_011935.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_9128-sphinx_links_all-fh.patch](https://github.com/sagemath/sage/files/ticket9128/trac_9128-sphinx_links_all-fh.patch)",
    "created_at": "2012-02-20T17:31:06Z",
    "issue": "https://github.com/sagemath/sage/issues/9128",
    "type": "issue_comment",
...
archive/attachments_011936.json:
```json
{
    "asset_content_type": "application/octet-stream",
