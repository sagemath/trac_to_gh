...
archive/attachments_013345.json:
```json
{
...
```json
{
    "body": "**Attachment:** [9917-makes-changes-to-dpp.c.patch](https://github.com/sagemath/sage/files/ticket9917/9917-makes-changes-to-dpp.c.patch)\n\nMakes acouple of changes to the file dpp.c, which will remove a couple of compiler warnings which looked potentially harmful.",
    "created_at": "2010-09-17T00:04:57Z",
    "issue": "https://github.com/sagemath/sage/issues/9917",
    "type": "issue_comment",
...
**Attachment:** [9917-makes-changes-to-dpp.c.patch](https://github.com/sagemath/sage/files/ticket9917/9917-makes-changes-to-dpp.c.patch)
...
archive/attachments_013346.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [9917-non-empty-patch-file.patch](https://github.com/sagemath/sage/files/ticket9917/9917-non-empty-patch-file.patch)\n\nSomehow the previous patch file I made was empty - this corrects that.",
    "created_at": "2010-09-17T07:15:09Z",
    "issue": "https://github.com/sagemath/sage/issues/9917",
    "type": "issue_comment",
...
**Attachment:** [9917-non-empty-patch-file.patch](https://github.com/sagemath/sage/files/ticket9917/9917-non-empty-patch-file.patch)
