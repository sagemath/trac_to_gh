...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101603"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101606"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101610"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101614"
}
```
...
```json
{
    "body": "<a id='comment:10'>Comment 10:</a>\nThanks! That was quick. :)\n\nI suggest to replace the check\n\n```\nif not isinstance(entries, list):\n```\nwith\n\n```\nif not isinstance(entries, (list, tuple)):\n```\ninstead of accepting `ValueError`s as well.\n\n[attachment: trac_9049_bug_in_matrices_from_tuples.take2.patch.gz](https://github.com/sagemath/sage/files/ticket9049/trac_9049_bug_in_matrices_from_tuples.take2.patch.gz) includes this alternative approach.\n\nPlease switch this to `positive_review` if you agree with my changes.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-76522",
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101619"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-101620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-76523",
