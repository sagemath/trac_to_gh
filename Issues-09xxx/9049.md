...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114049"
}
```
...
```json
{
    ...
    "event": "assigned",
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "subject": "https://github.com/sagetrac-cynthia-vinzant",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114050"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,6 +11,8 @@\n This produces the following error message:\n           \t\n \n+\n+```\n Traceback (click to the left of this block for traceback)\n ...\n ValueError: Length must be equal to the degree of this number field\n@@ -18,24 +20,22 @@\n Traceback (most recent call last):\n   File \"<stdin>\", line 1, in <module>\n   File \"_sage_input_11.py\", line 10, in <module>\n-    exec compile(u'open(\"___code___.py\",\"w\").write(\"# -*- coding: utf-8 -*-\n-n\" + _support_.preparse_worksheet_cell(base64.b64decode(\"Uy48dD49UG9seW5vbWlhbFJpbmcoUVEpCkYuPHE+PVFRLmV4dGVuc2lvbih0XjQrMSkKUi48eCx5Pj1Qb2x5bm9taWFsUmluZyhGKQpJPVIuaWRlYWwoeCx5XjQrMSkKSS52YXJpZXR5KCk=\"),globals())+\"\n-n\"); execfile(os.path.abspath(\"___code___.py\"))\n+    exec compile(u'open(\"___code___.py\",\"w\").write(\"# -*- coding: utf-8 -*-\\\\n\" + _support_.preparse_worksheet_cell(base64.b64decode(\"Uy48dD49UG9seW5vbWlhbFJpbmcoUVEpCkYuPHE+PVFRLmV4dGVuc2lvbih0XjQrMSkKUi48eCx5Pj1Qb2x5bm9taWFsUmluZyhGKQpJPVIuaWRlYWwoeCx5XjQrMSkKSS52YXJpZXR5KCk=\"),globals())+\"\\\\n\"); execfile(os.path.abspath(\"___code___.py\"))\n   File \"\", line 1, in <module>\n     \n   File \"/tmp/tmpZcwb0q/___code___.py\", line 7, in <module>\n     exec compile(u'I.variety()\n   File \"\", line 1, in <module>\n     \n-  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/polynomial/multi_polynomial_ideal.py\", line 407, in `__call__`\n+  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/polynomial/multi_polynomial_ideal.py\", line 407, in __call__\n     return self.f(self._instance, *args, **kwds)\n   File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/polynomial/multi_polynomial_ideal.py\", line 2094, in variety\n     TI = self.triangular_decomposition('singular:triangLfak')\n-  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/polynomial/multi_polynomial_ideal.py\", line 407, in `__call__`\n+  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/polynomial/multi_polynomial_ideal.py\", line 407, in __call__\n     return self.f(self._instance, *args, **kwds)\n   File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/polynomial/multi_polynomial_ideal.py\", line 901, in triangular_decomposition\n     is_groebner = self.basis_is_groebner()\n-  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/misc/cachefunc.py\", line 322, in `__call__`\n+  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/misc/cachefunc.py\", line 322, in __call__\n     return self._cachedmethod._instance_call(self._instance, *args, **kwds)\n   File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/misc/cachefunc.py\", line 466, in _instance_call\n     cache[key] = self._cachedfunc.f(inst, *args, **kwds)\n@@ -43,7 +43,7 @@\n     F = matrix(R, 1, self.ngens(), self.gens())\n   File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/matrix/constructor.py\", line 652, in matrix\n     return matrix_space.MatrixSpace(ring, nrows, ncols, sparse=sparse)(entries)\n-  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/matrix/matrix_space.py\", line 405, in `__call__`\n+  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/matrix/matrix_space.py\", line 405, in __call__\n     return self.matrix(entries, copy=copy, coerce=coerce, rows=rows)\n   File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/matrix/matrix_space.py\", line 1136, in matrix\n     return self.__matrix_class(self, entries=x, copy=copy, coerce=coerce) \n@@ -52,8 +52,10 @@\n   File \"parent.pyx\", line 854, in sage.structure.parent.Parent.__call__ (sage/structure/parent.c:6332)\n   File \"coerce_maps.pyx\", line 82, in sage.structure.coerce_maps.DefaultConvertMap_unique._call_ (sage/structure/coerce_maps.c:3108)\n   File \"coerce_maps.pyx\", line 77, in sage.structure.coerce_maps.DefaultConvertMap_unique._call_ (sage/structure/coerce_maps.c:3010)\n-  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/number_field/number_field.py\", line 1023, in `_element_constructor_`\n+  File \"/usr/local/sage2/local/lib/python2.6/site-packages/sage/rings/number_field/number_field.py\", line 1023, in _element_constructor_\n     raise ValueError, \"Length must be equal to the degree of this number field\"\n ValueError: Length must be equal to the degree of this number field\n \n \n+```\n+\n``````\n",
    "created_at": "2010-05-26T01:21:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74656",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74657",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74658",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74659",
    "user": "https://github.com/sagetrac-cynthia-vinzant"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74660",
    "user": "https://github.com/syazdani77"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74661",
    "user": "https://github.com/sagetrac-cynthia-vinzant"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114052"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74662",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74663",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114054"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74664",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74665",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74666",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74667",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74668",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74669",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74670",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74671",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74672",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74673",
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114063"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9049#event-114064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9049#issuecomment-74674",
