...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114014"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114020"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114021"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91811",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9942#event-114024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91812",
    "user": "https://github.com/jdemeyer"
}
```
