...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91762",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91763",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91764",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91765",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91766",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9942/trac_9942-chomp.patch",
    "created_at": "2011-01-11T00:24:38Z",
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9942/trac_9942-chomp.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [trac_9942-chomp.patch](https://github.com/sagemath/sage/files/ticket9942/trac_9942-chomp.patch) by mhampton created at 2011-01-11 00:24:38\n\nLooks good and all tests pass on OS X 10.5, 10.6, and linux (64-bit Ubuntu 10.04, intel i7 860).  So I think I can give this a positive review.",
    "created_at": "2011-01-11T00:24:38Z",
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91767",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91768",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9942#issuecomment-91769",
    "user": "https://github.com/jdemeyer"
}
```
