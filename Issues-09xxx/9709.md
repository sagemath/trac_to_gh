...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125647"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125650"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9709#issuecomment-85475",
    "user": "https://github.com/sagetrac-rlindner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9709#issuecomment-85476",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9709#issuecomment-85477",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9709#issuecomment-85478",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9709",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9709#event-125656"
}
```
