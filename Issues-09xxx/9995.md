...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104868",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [config.log](tarball://root/attachments/some-uuid/ticket9995/config.log) by drkirkby created at 2010-10-06 07:14:10\n\nThis is quite easy to fix - Python just needs to configure option `--with-gcc=\"$CC\"` added. See attached patch.",
    "created_at": "2010-10-06T07:14:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104869",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>Attachment [config.log](tarball://root/attachments/some-uuid/ticket9995/config.log) by drkirkby created at 2010-10-06 07:14:10
...
```json
{
    "body": "<a id='comment:2'></a>I'll attach the patch later!!",
    "created_at": "2010-10-06T07:21:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104870",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>I'll attach the patch later!!
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25323"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25324"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25325"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25326"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25327"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25328"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25329"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104871",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104872",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25330"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25331"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104873",
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25332"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104874",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9995#issuecomment-104875",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9995",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9995#event-25334"
}
```
