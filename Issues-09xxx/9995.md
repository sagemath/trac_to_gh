...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9995#issuecomment-93191",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9995/config.log",
    "created_at": "2010-10-06T07:14:10Z",
    "issue": "https://github.com/sagemath/sage/issues/9995",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9995/config.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [config.log](https://github.com/sagemath/sage/files/ticket9995/config.log) by drkirkby created at 2010-10-06 07:14:10\n\nThis is quite easy to fix - Python just needs to configure option `--with-gcc=\"$CC\"` added. See attached patch.",
    "created_at": "2010-10-06T07:14:10Z",
    "issue": "https://github.com/sagemath/sage/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9995#issuecomment-93192",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9995#issuecomment-93193",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9995#issuecomment-93194",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9995#issuecomment-93195",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9995#issuecomment-93196",
