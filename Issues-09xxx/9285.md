...
<a id='comment:6'></a>With #11187, on my laptop (see comment:4) I get
...
```json
{
    "body": "<a id='comment:7'></a>With Gap3 in Sage, it took 6m20s to go through E<sub>8</sub> on my laptop (serially, comment:4):\n\n```\ngap> i:=0;;\ngap> W:=CoxeterGroup(\"E\",7);;\ngap> ForEachElement(W,function(x)i:=i+1;end);\n```",
...
<a id='comment:7'></a>With Gap3 in Sage, it took 6m20s to go through E<sub>8</sub> on my laptop (serially, comment:4):
