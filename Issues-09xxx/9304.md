...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104491",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104492",
...
```json
{
    "body": "<a id='comment:3'></a>What would be a good way to test this for review?",
    "created_at": "2010-10-12T11:35:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104494",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>What would be a good way to test this for review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104495",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104496",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104498",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104499",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"William Stein, David Loeffler\"",
    "created_at": "2010-10-12T13:20:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104500",
    "user": "https://github.com/JohnCremona"
}
```

Changing author from "" to "William Stein, David Loeffler"
...
```json
{
    "body": "<a id='comment:6'></a>That's weird: it really shouldn't work without the patch! If I run that command in a clean 4.6.alpha3 build, I get the same DeprecationWarning but it's followed by `ImportError: No module named integer_mod_ring`. Did you try running it *before* installing either patch? \n\nIf you install William's patch, build, and then qpop it and build again, the file it re-creates will still be lurking in your build directory. If that's the case try switching to a clean branch to see the `ImportError`.",
    "created_at": "2010-10-12T13:37:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104501",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:6'></a>That's weird: it really shouldn't work without the patch! If I run that command in a clean 4.6.alpha3 build, I get the same DeprecationWarning but it's followed by `ImportError: No module named integer_mod_ring`. Did you try running it *before* installing either patch? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104502",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104504",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104505",
...
```json
{
    "body": "<a id='comment:9'></a>Merged alternative patch",
    "created_at": "2010-11-01T10:06:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104506",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>Merged alternative patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9304#issuecomment-104507",
    "user": "https://github.com/jdemeyer"
}
```
