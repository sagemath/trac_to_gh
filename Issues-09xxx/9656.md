...
archive/attachments_012824.json:
```json
{
...
archive/attachments_012825.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_9556-code-blocks-kerning.patch](https://github.com/sagemath/sage/files/ticket9656/trac_9556-code-blocks-kerning.patch)\n\nForces Firefox to recompute span width after jsMath text processing.",
    "created_at": "2010-08-19T12:56:27Z",
    "issue": "https://github.com/sagemath/sage/issues/9656",
    "type": "issue_comment",
...
**Attachment:** [trac_9556-code-blocks-kerning.patch](https://github.com/sagemath/sage/files/ticket9656/trac_9556-code-blocks-kerning.patch)
...
archive/attachments_012826.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "beforepatch.png",
    "asset_url": "tarball://root/attachments/ticket9656/beforepatch.png",
    "created_at": "2010-09-17T11:32:31Z",
    "issue": "https://github.com/sagemath/sage/issues/9656",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9656/beforepatch.png",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
archive/attachments_012827.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_012828.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [trac_9556-code-blocks-kerning.2.patch](https://github.com/sagemath/sage/files/ticket9656/trac_9556-code-blocks-kerning.2.patch)\n\nThanks for noting that. I didn't notice. Here's another, simpler, patch.",
    "created_at": "2010-09-18T02:44:41Z",
    "issue": "https://github.com/sagemath/sage/issues/9656",
    "type": "issue_comment",
