...
<a id='comment:1'></a>In 1.4, the docstring is now
...
<a id='comment:2'></a>This still looks wrong for a rectangular matrix, just based on the dimensions of the matrices.  The .H is an improvement, though.  I couldn't find anything any better in the NumPy docs online.
...
<a id='comment:3'></a>Remember that multiplication of numpy arrays is *not* matrix multiplication.  Matrix multiplication is through np.dot().
...
```json
{
    "body": "<a id='comment:5'></a>Okay, I agree the docs are misleading because full_matrices defaults to True.  I've written the numpy mailing list: http://mail.scipy.org/pipermail/numpy-discussion/2011-January/054722.html",
...
<a id='comment:5'></a>Okay, I agree the docs are misleading because full_matrices defaults to True.  I've written the numpy mailing list: http://mail.scipy.org/pipermail/numpy-discussion/2011-January/054722.html
