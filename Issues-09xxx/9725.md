...
{
    "assignees": [],
    "body": "Create a German translation of the Sage Tutorial.\n\n**Apply:**\n1. [attachment: trac_9725.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725.patch.gz)\n2. [attachment: trac_9725B.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725B.patch.gz)\n3. [attachment: trac_9725C.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725C.patch.gz)\n4. [attachment: 9725_TESTDIRS.patch.gz](https://github.com/sagemath/sage/files/ticket9725/9725_TESTDIRS.patch.gz) to the SAGE_ROOT repository\n\nAssignee: **phil**\n\nCC:  @haraldschilly\n\nKeywords: **Documentation Tutorial German**\n\nReviewer: **Volker Braun**\n\nAuthor: **Philipp Schneider, Michael Mardaus**\n\nMerged: **sage-4.7.1.alpha2**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/9725_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111017"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111020"
}
```
...
```json
{
    "body": "Changed assignee from **mvngu** to **phil**",
    "created_at": "2010-08-12T01:12:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_comment",
...
Changed assignee from **mvngu** to **phil**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111023"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111024"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111025"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111026"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111027"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,3 @@\n Create a German translation of the Sage Tutorial.\n+\n+The translated files are in the [attachment: tutorial-de.tgz.gz](https://github.com/sagemath/sage/files/ticket9725/tutorial-de.tgz.gz) archive. \n``````\n",
    "created_at": "2011-05-11T13:58:18Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111029"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,3 @@\n Create a German translation of the Sage Tutorial.\n \n-The translated files are in the [attachment: tutorial-de.tgz.gz](https://github.com/sagemath/sage/files/ticket9725/tutorial-de.tgz.gz) archive. \n+Apply [attachment: trac_9725.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725.patch.gz)\n``````\n",
    "created_at": "2011-05-11T18:44:42Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111030"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111034"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n Create a German translation of the Sage Tutorial.\n \n-Apply [attachment: trac_9725.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725.patch.gz)\n+**Apply:**\n+1. [attachment: trac_9725.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725.patch.gz)\n+2. [attachment: 9725_TESTDIRS.patch.gz](https://github.com/sagemath/sage/files/ticket9725/9725_TESTDIRS.patch.gz) to the SAGE_ROOT repository\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,4 +2,5 @@\n \n **Apply:**\n 1. [attachment: trac_9725.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725.patch.gz)\n-2. [attachment: 9725_TESTDIRS.patch.gz](https://github.com/sagemath/sage/files/ticket9725/9725_TESTDIRS.patch.gz) to the SAGE_ROOT repository\n+2. [attachment: trac_9725B.patch.gz](https://github.com/sagemath/sage/files/ticket9725/trac_9725B.patch.gz)\n+3. [attachment: 9725_TESTDIRS.patch.gz](https://github.com/sagemath/sage/files/ticket9725/9725_TESTDIRS.patch.gz) to the SAGE_ROOT repository\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111046"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9725#issuecomment-87782",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9725#event-111048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9725#issuecomment-87783",
