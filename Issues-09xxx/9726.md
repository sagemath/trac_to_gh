...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114808"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87784",
    "user": "https://github.com/sagetrac-gauravluthra"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87785",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114812"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114813"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87786",
...
```json
{
    "body": "<a id='comment:4'>Comment 4:</a>\nAttachment: **[trac_9726-srsa.patch.gz](https://github.com/sagemath/sage/files/ticket9726/trac_9726-srsa.patch.gz)**\n\nThe patch [is the same as [attachment: srsa.patch.gz](https://github.com/sagemath/sage/files/ticket9726/srsa.patch.gz)(https://github.com/sagemath/sage/files/ticket9726/6b88849e917a812c98db42a77c6c8a29.gz), but here are the crucial differences:\n\n* Put the ticket number in the commit message.\n* Get rid of Windows newline convention. Use Unix style end of line characters.",
    "created_at": "2010-08-12T12:35:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87787",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87788",
    "user": "https://github.com/sagetrac-gauravluthra"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87789",
    "user": "https://github.com/wdjoyner"
}
```
