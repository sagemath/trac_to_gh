...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87782",
    "user": "https://github.com/sagetrac-gauravluthra"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9726#issuecomment-87783",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114815"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9726#event-114816"
}
```
