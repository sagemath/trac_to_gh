...
```json
{
    "body": "<div id=\"comment:2\" align=\"right\">comment:2</div>\n\nThe patch here *may* cause a problem with building the PDF reference manual.  Please see [this comment](https://github.com/sagemath/sage/issues/8030#comment:10) at #8030.",
