...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100617",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_9102-docstring-strong-generating-system.patch](tarball://root/attachments/some-uuid/ticket9102/trac_9102-docstring-strong-generating-system.patch) by @rbeezer created at 2010-05-31 03:37:29",
    "created_at": "2010-05-31T03:37:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100618",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>Attachment [trac_9102-docstring-strong-generating-system.patch](tarball://root/attachments/some-uuid/ticket9102/trac_9102-docstring-strong-generating-system.patch) by @rbeezer created at 2010-05-31 03:37:29
...
```json
{
    "body": "<a id='comment:2'></a>The patch here *may* cause a problem with building the PDF reference manual.  Please see [comment:ticket:8030:10 this comment] at #8030.",
    "created_at": "2010-06-03T09:17:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100619",
    "user": "https://github.com/qed777"
}
```

<a id='comment:2'></a>The patch here *may* cause a problem with building the PDF reference manual.  Please see [comment:ticket:8030:10 this comment] at #8030.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100620",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100622",
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [jasonbhill](#comment%3A5):\n> While looking at the amssymb issue, I came across a problem elsewhere in what has been added to the docstring.\n> \n> \"``base_of_group`` is a list of the  positions on which ``self`` acts,\"\n> \n> This is not correct. The base of a permutation group G is defined as a list L of points in the domain of the action such that no element of G fixes all points of L.\n> \n> http://en.wikipedia.org/wiki/Base_(group_theory)\n> \n> Computationally, this is equivalent to requiring no strong generator to fix all points of the base, and hence the size of a base corresponds directly to the length of the stabilizer chain given by the Schreier-Sims algorithm. (In fact, this algorithm yields a base and the strong generating system relative to that specific base.)\n> \n> The assertion that the base is not unique is correct, but the specific base used must correspond to the stabilizer chain constructed from a strong generating set. Otherwise, the information of the strong generating set is of less computational value.\n> \n> For instance, a symmetric group of degree n has base of size n-1. So, S_5 on points [1..5] has bases [1,2,4,5], [1,2,3,4], etc., depending on the SGS. At the same time, any cyclic group has a base of size 1.\n> \n> You may of course artificially inflate the base and it will still follow the definition, but then anyone using the strong generating set for calculations (MANY invariants of a group follow from this) must recalculate the base and this will often result in a different SGS.",
    "created_at": "2010-06-05T14:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100625",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:7'></a>Replying to [jasonbhill](#comment%3A5):
> While looking at the amssymb issue, I came across a problem elsewhere in what has been added to the docstring.
> 
> "``base_of_group`` is a list of the  positions on which ``self`` acts,"
> 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100626",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100628",
    "user": "https://trac.sagemath.org/admin/accounts/users/jasonbhill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100630",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100631",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100632",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100633",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100635",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100637",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100638",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Version 3 patch only changes two \\leqslant to simply \\leq since the Sage/TeX/PDF documentation build complains about the former version of an inequality symbol.  I can't verify this right now, since the PDF version won't get past some `UniqueRepresentation.__classcall__` stuff that I think is known.\n\nSince the v1 patch is merged, this replicates the effect of the v2 patch.  So apply *only* the v3 patch to 4.5.alpha3 to get everything back together.  Sorry for the confusion.\n\nRob",
    "created_at": "2010-07-06T04:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100639",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:15'></a>Version 3 patch only changes two \leqslant to simply \leq since the Sage/TeX/PDF documentation build complains about the former version of an inequality symbol.  I can't verify this right now, since the PDF version won't get past some `UniqueRepresentation.__classcall__` stuff that I think is known.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100640",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100641",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100642",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Apply v3 only.",
    "created_at": "2010-07-06T08:07:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100643",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:16'></a>Apply v3 only.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100644",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100645",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100646",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Belated note: With #9331 and V3, the PDF reference manual builds for me.",
    "created_at": "2010-07-06T08:34:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100647",
    "user": "https://github.com/qed777"
}
```

<a id='comment:18'></a>Belated note: With #9331 and V3, the PDF reference manual builds for me.
...
```json
{
    "body": "<a id='comment:19'></a>Misha:  thanks for the check.\n\nRobert: thanks for seeing that this needed some work and the review.\n\nRob",
    "created_at": "2010-07-06T15:58:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9102#issuecomment-100648",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:19'></a>Misha:  thanks for the check.
