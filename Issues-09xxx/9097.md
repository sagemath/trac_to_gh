...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100553",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [c_lib.patch](tarball://root/attachments/some-uuid/ticket9097/c_lib.patch) by drkirkby created at 2010-06-14 17:30:05\n\nThis is not a complete fix which enables the library to build, but it adds the flag -m64 on all platforms except OS X. (On OS X the flag is already added, but along with some other flags which I don't understand, and for now are best left). \n\nDave",
    "created_at": "2010-06-14T17:30:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100554",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>Attachment [c_lib.patch](tarball://root/attachments/some-uuid/ticket9097/c_lib.patch) by drkirkby created at 2010-06-14 17:30:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100555",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100556",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100557",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100560",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100561",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [sage_clib64.patch](tarball://root/attachments/some-uuid/ticket9097/sage_clib64.patch) by @kiwifb created at 2010-07-01 09:41:01\n\nNote that the space in\n\n```\nLINKFLAGS=\" -single_module -flat_namespace -undefined dynamic_lookup\"\n```\nis on purpose as scons concatenate strings. We don't want to end\nup with \"-m64-single_module\".",
    "created_at": "2010-07-01T09:41:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100562",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>Attachment [sage_clib64.patch](tarball://root/attachments/some-uuid/ticket9097/sage_clib64.patch) by @kiwifb created at 2010-07-01 09:41:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100563",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Fran\u00e7ois Bissey, David Kirkby\"",
    "created_at": "2010-07-04T21:26:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100564",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing reviewer from "" to "François Bissey, David Kirkby"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100565",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100566",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Since this touch the OSX build as well do we have a tester for OSX \nthat could try it? 32/64 bit should be irrelevant.",
    "created_at": "2010-07-05T10:04:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100568",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>Since this touch the OSX build as well do we have a tester for OSX 
that could try it? 32/64 bit should be irrelevant.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100569",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100570",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9097#issuecomment-100571",
    "user": "https://github.com/rlmill"
}
```
