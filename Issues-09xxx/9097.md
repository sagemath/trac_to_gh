...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9097#issuecomment-77216",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9097#issuecomment-77217",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105649"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-drkirkby** to **@kiwifb**",
    "created_at": "2010-07-01T01:38:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9097",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-drkirkby** to **@kiwifb**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9097",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9097#event-105653"
}
```
