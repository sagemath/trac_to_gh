...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104261"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104262"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104263"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104264"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104265"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104267"
}
```
...
```json
{
    "body": "<a id='comment:9'>Comment 9:</a>\nPynac package with the changes required by [attachment: trac_9240-factorial_evaluation.patch.gz](https://github.com/sagemath/sage/files/ticket9240/trac_9240-factorial_evaluation.patch.gz) is at #11415.",
    "created_at": "2011-05-31T15:16:01Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9240",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9240#issuecomment-79612",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104270"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9240",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9240#event-104271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9240#issuecomment-79613",
