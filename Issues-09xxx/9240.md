...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103540",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The patch applies cleanly to 4.4.4.alpha0, fixes the problem and includes some nice tests. I would give this a positive review, except that I really don't know the Pynac integration code. \n\nOh, and you say \"For Sage, factorial(x) is only defined if x is a non-negative integer\", but (with a clean 4.4.4.alpha0), it's defined the same way as Maxima:\n\n```\nsage: factorial(5)\n120\nsage: factorial(1/2)\n1/2*sqrt(pi)\nsage: factorial(1/21)\ngamma(22/21)\n```",
    "created_at": "2010-06-15T05:32:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103541",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:1'></a>The patch applies cleanly to 4.4.4.alpha0, fixes the problem and includes some nice tests. I would give this a positive review, except that I really don't know the Pynac integration code. 
...
```json
{
    "body": "<a id='comment:4'></a>See also [this thread](http://trac.sagemath.org/sage_trac/ticket/9240), where it came up again.",
    "created_at": "2010-12-02T02:26:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103544",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>See also [this thread](http://trac.sagemath.org/sage_trac/ticket/9240), where it came up again.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103545",
...
```json
{
    "body": "<a id='comment:5'></a>I suppose this needs review.",
    "created_at": "2011-05-10T19:13:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103546",
    "user": "https://github.com/burcin"
}
```

<a id='comment:5'></a>I suppose this needs review.
...
```json
{
    "body": "<a id='comment:6'></a>For some reason, the patchbot isn't applying this patch, but it does apply cleanly and pass doctests in 4.7.rc1. (On 64-bit Ubuntu 10.10)\n\nLooking at it again, I might recommend that in the TESTS, the first few examples be moved, since they already work and aren't testing to see if the problem in this ticket has been fixed. Only the `full_simplify()` tests are, strictly speaking, relevant to this ticket.",
    "created_at": "2011-05-11T00:12:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103547",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:6'></a>For some reason, the patchbot isn't applying this patch, but it does apply cleanly and pass doctests in 4.7.rc1. (On 64-bit Ubuntu 10.10)
...
```json
{
    "body": "<a id='comment:7'></a>That's a good point, Dan.  It's not bad to add them, but they should be added to the doc for gamma.  A friendly reviewer patch from ddrake would probably be sufficient for this :)",
    "created_at": "2011-05-11T00:29:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103548",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>That's a good point, Dan.  It's not bad to add them, but they should be added to the doc for gamma.  A friendly reviewer patch from ddrake would probably be sufficient for this :)
...
```json
{
    "body": "Changing author from \"\" to \"Tom Coates\"",
    "created_at": "2011-05-11T00:29:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103549",
    "user": "https://github.com/kcrisman"
}
```

Changing author from "" to "Tom Coates"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103550",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103551",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103552",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_9240-factorial_evaluation.patch](tarball://root/attachments/some-uuid/ticket9240/trac_9240-factorial_evaluation.patch) by @burcin created at 2011-05-24 19:20:03\n\nattachment:trac_9240-factorial_evaluation.patch adds further doctests and fixes for the evaluation of factorials. It should be applied after attachment:trac_9240_full_simplify_gamma.patch.\n\nMy changes depend on a small patch to pynac, where I somehow used && instead of bitwise and. This patch can be obtained from: \n\nhttps://bitbucket.org/burcin/pynac-patches/src/c3c5b3b8b1eb/bitwise.patch\n\nThis ticket now depends on a new pynac release, which should be coming soon.",
    "created_at": "2011-05-24T19:20:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103553",
    "user": "https://github.com/burcin"
}
```

<a id='comment:8'></a>Attachment [trac_9240-factorial_evaluation.patch](tarball://root/attachments/some-uuid/ticket9240/trac_9240-factorial_evaluation.patch) by @burcin created at 2011-05-24 19:20:03
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103554",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103555",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Pynac package with the changes required by attachment:trac_9240-factorial_evaluation.patch is at #11415.",
    "created_at": "2011-05-31T15:16:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103556",
    "user": "https://github.com/burcin"
}
```

<a id='comment:9'></a>Pynac package with the changes required by attachment:trac_9240-factorial_evaluation.patch is at #11415.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103557",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Can you explain why the change from && to & was necessary?  I don't know much CPP.   Would there be a difference between bitwise 'and' and 'and' when the outputs are boolean?  Or maybe they are not boolean.  \n\nThanks!",
    "created_at": "2011-06-08T22:01:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103558",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Can you explain why the change from && to & was necessary?  I don't know much CPP.   Would there be a difference between bitwise 'and' and 'and' when the outputs are boolean?  Or maybe they are not boolean.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103561",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103562",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103563",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103565",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9240#issuecomment-103566",
    "user": "https://github.com/jdemeyer"
}
```
