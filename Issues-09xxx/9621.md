...
<a id='comment:2'></a>Bear with me as this is my first action on the ticket system :-)
...
<a id='comment:3'></a>Attachment [trac-9621_permgroup_sylow_subgroup_with_simplification.patch](tarball://root/attachments/some-uuid/ticket9621/trac-9621_permgroup_sylow_subgroup_with_simplification.patch) by @simon-king-jena created at 2010-07-30 13:11:55
...
<a id='comment:4'></a>Ah, embarrassing; I had seen that mistake, but must have forgotten to remake the patch or something :-) 
...
<a id='comment:5'></a>Apply trac-9621_permgroup_sylow_subgroup_with_simplification.patch
...
```json
{
    "body": "<a id='comment:7'></a>I think this can be closed as I fixed this problem in #10334.",
...
<a id='comment:7'></a>I think this can be closed as I fixed this problem in #10334.
