...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121533"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121536"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121537"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121538"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121539"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121540"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121541"
}
```
...
```json
{
    "body": "<div id=\"comment:36\" align=\"right\">comment:36</div>\n\nCan someone (Thomas?) please update a patch or the spkg with the suggested improvements?\n\nThe main remaining potential blockers to releasing 4.6 are this ticket and the other problem Florent Hivert reported on [sage-release](http://groups.google.com/group/sage-release/browse_thread/thread/bb636656e2153332) (cf. [comment 16ff](https://github.com/sagemath/sage/issues/10097#comment:16) at #10097).\n\nI'll investigate the latter later today.",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121542"
}
```
...
```json
{
    ...
    "title_was": "Improve/fix readline workarounds for Arch Linux and openSUSE, again broken on OpenSuSE 11.2 and 11.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9530",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121549"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121550"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121551"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121552"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9530#event-121553"
}
```
