...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100583",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Another thing to try would be the ECL spkg from #8951 and the Maxima spkg from #8731.",
    "created_at": "2010-05-31T03:56:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100584",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>Another thing to try would be the ECL spkg from #8951 and the Maxima spkg from #8731.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100585",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I should have added that in order to get ECL to build, I had added the option\n\n```\n--with-dffi=no\n```\n\nWithout that option ECL will not build. With the option, ECL builds ok, but Maxima does not. \n\nI have tried compiling with position independant code, by adding -fPIC to the CFLAGS, but that did not help. \n\nDave",
    "created_at": "2010-06-18T22:14:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100586",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>I should have added that in order to get ECL to build, I had added the option
...
```json
{
    "body": "<a id='comment:5'></a>More data: maxima failed with a 64-bit build in fulvia (Solaris on x86), but seems to have succeeded with a 64-bit build on t2 (Solaris on sparc).  The 32-bit build on fulvia succeeded, but some of the output is different than on other platforms, causing some doctest failures:\n\n```\nsage -t  -long devel/sage/sage/symbolic/expression.pyx\n**********************************************************************\nFile \"/home/palmieri/fulvia/sage-4.5.2.rc0/devel/sage-main/sage/symbolic/expression.pyx\", line 498\\\n3:\n    sage: maxima('sinh(1.0)')\nExpected:\n    1.175201193643801\nGot:\n    1.175201193643802\n**********************************************************************\nFile \"/home/palmieri/fulvia/sage-4.5.2.rc0/devel/sage-main/sage/symbolic/expression.pyx\", line 508\\\n8:\n    sage: maxima('asinh(1.0)')\nExpected:\n    0.881373587019543\nGot:\n    .8813735870195429\n**********************************************************************\n```\n(This is a somewhat hacked build: R didn't build, so it is missing completely.  I don't think that would have anything to do with this failure.)",
    "created_at": "2010-08-04T04:00:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100587",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>More data: maxima failed with a 64-bit build in fulvia (Solaris on x86), but seems to have succeeded with a 64-bit build on t2 (Solaris on sparc).  The 32-bit build on fulvia succeeded, but some of the output is different than on other platforms, causing some doctest failures:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100590",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100591",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [SPARC-reloaction-errors.txt](tarball://root/attachments/some-uuid/ticket9099/SPARC-reloaction-errors.txt) by drkirkby created at 2011-04-02 11:53:25\n\nThis has been fixed by the upgrade to ECL on #10766, so this can be closed as fixed in sage-4.7.alpha1. \n\nDave",
    "created_at": "2011-04-02T11:53:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100592",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:9'></a>Attachment [SPARC-reloaction-errors.txt](tarball://root/attachments/some-uuid/ticket9099/SPARC-reloaction-errors.txt) by drkirkby created at 2011-04-02 11:53:25
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100593",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9099#issuecomment-100594",
    "user": "https://github.com/jdemeyer"
}
```
