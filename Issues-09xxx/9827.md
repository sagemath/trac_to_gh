...
```json
{
    "body": "<a id='comment:12'></a>\nNew commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[0c8ae85](http://git.sagemath.org/sage.git/commit/?id=0c8ae85ed98466fb0fcde477d021c8d9f3b93581)|`trac #9827 simple fix`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[019dda0](http://git.sagemath.org/sage.git/commit/?id=019dda08c66a4fd4deea44ff5e87714ac2ba3575)|`trac #9827 typo`|",
