...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9845/lcalc-20100428-1.23.p2-p4.diff",
...
```json
{
    "body": "Diff between the p2 (#9592) and Mike's p4 spkg - for review/reference.",
    "created_at": "2010-09-02T23:41:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9845",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9845/lcalc-20100428-1.23.p2-p4.2.diff",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9845/lcalc-20100428-1.23.p4-p5.diff",
...
```json
{
    "body": "Diff between p4 and p5 - for review/reference.",
    "created_at": "2010-09-19T16:42:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9845",
    "type": "issue_comment",
