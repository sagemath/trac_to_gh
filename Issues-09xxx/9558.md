...
```json
{
    "body": "Changed assignee from **@aghitza** to **@sagetrac-sage-combinat**",
    "created_at": "2010-07-30T15:31:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9558#issuecomment-84827",
    "user": "https://github.com/jbandlow"
}
```

Changed assignee from **@aghitza** to **@sagetrac-sage-combinat**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9558#issuecomment-84828",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9558#event-112267"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9558#event-112268"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9558#event-112269"
}
```
