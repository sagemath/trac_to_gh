...
```json
{
    ...
    "type": "issue",
    "updated_at": "2010-11-02T00:46:24Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106739"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106741"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106742"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106743"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106744"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106746"
}
```
...
```json
{
    "body": "**Attachment:** [convert.py.diff.gz](https://github.com/sagemath/sage/files/ticket9808/convert.py.diff.gz)\n\nchanges to networkx, which have to be applied",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106748"
}
```
...
**Attachment:** [spkg-install.gz](https://github.com/sagemath/sage/files/ticket9808/spkg-install.gz)
...
```json
{
    ...
    "milestone_title": "sage-4.5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106749"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106752"
}
```
...
```json
{
    "body": "**Attachment:** [spkg-install.2.gz](https://github.com/sagemath/sage/files/ticket9808/spkg-install.2.gz)\n\nnew replacement for scipy",
...
**Attachment:** [spkg-install.2.gz](https://github.com/sagemath/sage/files/ticket9808/spkg-install.2.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106753"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106754"
}
```
...
<a id='comment:157'>**Comment 157:**</a>
Replying to [@nexttime](#comment%3A156):
> Touching `$SAGE_LOCAL/lib/python/site-packages/Cython/Includes/numpy.pxd` could also help.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106755"
}
```
...
```json
{
    "body": "**Attachment:** [numpy-spkg-install.diff.gz](https://github.com/sagemath/sage/files/ticket9808/numpy-spkg-install.diff.gz)\n\nChanges of the spkg-install from the upgrade to 1.3.x to 1.5.0 (changes that were applied to 1.4.1 are also contained)",
...
**Attachment:** [numpy-spkg-install.diff.gz](https://github.com/sagemath/sage/files/ticket9808/numpy-spkg-install.diff.gz)
...
```json
{
    "body": "**Attachment:** [scipy-spkg-install.diff.gz](https://github.com/sagemath/sage/files/ticket9808/scipy-spkg-install.diff.gz)\n\ndiff of the spkg-install of scipy from 0.7.p5 to 0.8",
...
**Attachment:** [scipy-spkg-install.diff.gz](https://github.com/sagemath/sage/files/ticket9808/scipy-spkg-install.diff.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106757"
}
```
...
```json
{
    "body": "**Attachment:** [9808-Fortran-issues-in-SciPy.patch.gz](https://github.com/sagemath/sage/files/ticket9808/9808-Fortran-issues-in-SciPy.patch.gz)\n\nSets F77, F90 and F95 so SciPy really does use the Fortran compiler we want. Setting FC alone is insufficient.",
...
**Attachment:** [9808-Fortran-issues-in-SciPy.patch.gz](https://github.com/sagemath/sage/files/ticket9808/9808-Fortran-issues-in-SciPy.patch.gz)
...
<a id='comment:209'>**Comment 209:**</a>
Replying to [@jhpalmieri](#comment%3A207):
> In a build from scratch on fulvia (with the previous version of the scipy package), I see these failures:
...
```json
{
    "body": "**Attachment:** [trac_9808-numpy.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808-numpy.patch.gz)\n\nfor reference only: diff between old numpy 1.5.0 spkg and new one",
...
**Attachment:** [trac_9808-numpy.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808-numpy.patch.gz)
...
<a id='comment:253'>**Comment 253:**</a>
Replying to [@jasongrout](#comment%3A250):
> Replying to [drkirkby](#comment%3A249):
> > I think the best thing is we ask on the SciPy mailing list. I assume there is one - there is one for Numpy. None of us appear to know how to fix this properly, 
> > 
...
<a id='comment:266'>**Comment 266:**</a>
Replying to [@kiwifb](#comment%3A264):
> Better use plain 'uname' as it should return Darwin for you if I am not mistaken.
...
<a id='comment:269'>**Comment 269:**</a>
Replying to [@kiwifb](#comment%3A265):
> So I looked at the special build instructions and right now they should be amended to
> 
> ```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106758"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106759"
}
```
...
<a id='comment:276'>**Comment 276:**</a>
**Attachment:** [gnu-changes.patch.gz](https://github.com/sagemath/sage/files/ticket9808/gnu-changes.patch.gz)
...
```json
{
    "body": "**Attachment:** [last-spkg-install-changes.patch.gz](https://github.com/sagemath/sage/files/ticket9808/last-spkg-install-changes.patch.gz)\n\nFor reference only - OS X 10.6 fix in spkg-install",
...
**Attachment:** [last-spkg-install-changes.patch.gz](https://github.com/sagemath/sage/files/ticket9808/last-spkg-install-changes.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106760"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106761"
}
```
...
<a id='comment:282'>**Comment 282:**</a>
Replying to [@jhpalmieri](#comment%3A279):
> I built this on a unix box (eno), an OS X 10.6 box, an OpenSolaris box (hawk), and a Solaris on x86 box (fulvia).  (By "built", I mean I built from scratch based on Sage 4.6.alpha3, replacing the numpy and scipy packages with the ones on this ticket, and I also applied the doctest patch.)
> 
> - On some machines, the doctest patch didn't apply cleanly: the patch to doc/en/faq/faq-usage.rst didn't apply, because it seems to already have been applied.  Maybe the tar file for 4.6.alpha3 changed?  The patch didn't apply cleanly on the machines where I downloaded it more recently.
...
```json
{
    "body": "**Attachment:** [trac_9808_numpy_doctest_change.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808_numpy_doctest_change.patch.gz)\n\nChanged doctests for numpy-1.5.0 due to output changes in numpy",
...
**Attachment:** [trac_9808_numpy_doctest_change.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808_numpy_doctest_change.patch.gz)
...
```json
{
    "body": "<a id='comment:6'>**Comment 6:**</a>\n**Attachment:** [trac_9808_changed_doctests.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808_changed_doctests.patch.gz)\n\nOk better solution: new name no probs anymore =)",
...
```json
{
    "body": "**Attachment:** [trac_9808-scipy.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808-scipy.patch.gz)\n\nfor reference only: diff between old scipy 0.8 spkg and new one",
...
**Attachment:** [trac_9808-scipy.patch.gz](https://github.com/sagemath/sage/files/ticket9808/trac_9808-scipy.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106765"
}
```
...
<a id='comment:297'>**Comment 297:**</a>
Replying to [@kcrisman](#comment%3A296):
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106766"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106768"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9808",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9808#event-106769"
}
```
...
<a id='comment:303'>**Comment 303:**</a>
Replying to [@jhpalmieri](#comment%3A266):
> Replying to [@kiwifb](#comment%3A264):
> > Better use plain 'uname' as it should return Darwin for you if I am not mistaken.
