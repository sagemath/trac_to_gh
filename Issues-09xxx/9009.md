...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9009/mercurial-64-bit.patch",
    "created_at": "2010-05-23T11:41:19Z",
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9009/mercurial-64-bit.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [mercurial-64-bit.patch](https://github.com/sagemath/sage/files/ticket9009/mercurial-64-bit.patch) by drkirkby created at 2010-05-23 11:41:19\n\nMercurial patch to allow to build 64-bit on any operating system, not just OS X",
    "created_at": "2010-05-23T11:41:19Z",
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76027",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [mercurial-64-bit.patch](https://github.com/sagemath/sage/files/ticket9009/mercurial-64-bit.patch) by drkirkby created at 2010-05-23 11:41:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76028",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76029",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76030",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76031",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76032",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76033",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9009#issuecomment-76034",
