...
archive/attachments_011702.json:
```json
{
...
```json
{
    "body": "**Attachment:** [mercurial-64-bit.patch](https://github.com/sagemath/sage/files/ticket9009/mercurial-64-bit.patch)\n\nMercurial patch to allow to build 64-bit on any operating system, not just OS X",
    "created_at": "2010-05-23T11:41:19Z",
    "issue": "https://github.com/sagemath/sage/issues/9009",
    "type": "issue_comment",
...
**Attachment:** [mercurial-64-bit.patch](https://github.com/sagemath/sage/files/ticket9009/mercurial-64-bit.patch)
