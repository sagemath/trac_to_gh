...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116689",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>`libecl.so` was just an example - do this on **all** libraries.",
    "created_at": "2010-09-07T08:47:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116691",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>`libecl.so` was just an example - do this on **all** libraries.
...
```json
{
    "body": "<a id='comment:4'></a>I just noticed something else - this is using the wrong python:\n\n```\n/usr/local/lib/libpython2.6.a: could not read symbols: Bad value\n```\n\nI've seen this problem before - see #9209. In fact, perhaps this should be marked as a duplicate of #9209. \n\nDave",
    "created_at": "2010-09-07T08:50:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116692",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>I just noticed something else - this is using the wrong python:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116694",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>And I can confirm that `/usr/local/lib` doesn't have any Python libraries in it on the machine I tested.",
    "created_at": "2010-09-07T14:20:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116695",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:7'></a>And I can confirm that `/usr/local/lib` doesn't have any Python libraries in it on the machine I tested.
...
```json
{
    "body": "<a id='comment:9'></a>Should this be a blocker for releasing 4.5.3? It's a pretty serious issue when copies of python in /usr/local are sometimes screwing up building Sage on two supported platforms (Solaris 10 and Redhat Linux).",
    "created_at": "2010-09-07T18:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116697",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:9'></a>Should this be a blocker for releasing 4.5.3? It's a pretty serious issue when copies of python in /usr/local are sometimes screwing up building Sage on two supported platforms (Solaris 10 and Redhat Linux).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116698",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9864#event-24827"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I've changed the milestone to 4.6, as I'll release 4.5.3 later today.",
    "created_at": "2010-09-07T21:58:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116699",
    "user": "https://github.com/qed777"
}
```

<a id='comment:11'></a>I've changed the milestone to 4.6, as I'll release 4.5.3 later today.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116700",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116701",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>From the [Installation Guide](http://www.sagemath.org/doc/installation/source.html#environment-variables):\n\n SAGE_BINARY_BUILD - used by the pil package. If set to \u201cyes\u201d, then force Sage to use the versions of libjpeg, libtiff and libpng from $SAGE_ROOT/local/lib. Otherwise, allow the use of the system\u2019s versions of these libraries.",
    "created_at": "2010-09-08T01:10:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116702",
    "user": "https://github.com/qed777"
}
```

<a id='comment:14'></a>From the [Installation Guide](http://www.sagemath.org/doc/installation/source.html#environment-variables):
...
```json
{
    "body": "<a id='comment:16'></a>Btw, `s/2008/2009/` in the changelog for p1 and p2. ;-)",
    "created_at": "2010-09-08T02:33:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116704",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:16'></a>Btw, `s/2008/2009/` in the changelog for p1 and p2. ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116706",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Georg Weber [has suggested on sage-release](http://groups.google.com/group/sage-release/browse_thread/thread/4dbd239d7e9d7b0c/d409f9a25b8891fd#d409f9a25b8891fd) that we set `SAGE_BINARY_BUILD='yes'` by default.  Thoughts?",
    "created_at": "2010-09-11T22:29:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116707",
    "user": "https://github.com/qed777"
}
```

<a id='comment:19'></a>Georg Weber [has suggested on sage-release](http://groups.google.com/group/sage-release/browse_thread/thread/4dbd239d7e9d7b0c/d409f9a25b8891fd#d409f9a25b8891fd) that we set `SAGE_BINARY_BUILD='yes'` by default.  Thoughts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116708",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116710",
...
```json
{
    "body": "<a id='comment:23'></a>Are there any comments about the proposal by Niles?",
    "created_at": "2010-10-09T05:38:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116711",
    "user": "https://github.com/qed777"
}
```

<a id='comment:23'></a>Are there any comments about the proposal by Niles?
...
```json
{
    "body": "<a id='comment:24'></a>Niles' suggestion seems optimal, however I do not have enough time at the moment (this week and the next) to think hard about it.",
    "created_at": "2010-10-09T13:49:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116712",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:24'></a>Niles' suggestion seems optimal, however I do not have enough time at the moment (this week and the next) to think hard about it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116713",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>For what it's worth, in Tachyon's `spkg-install`, there's an example of retrying an spkg installation after an initial failure:\n\n```sh\nif [ $UNAME = \"Linux\" ]; then\n    GCCVERSION=`gcc -dumpversion`\n    case $GCCVERSION in\n      4.2.4* | 4.3*)\n        export GCCFIX=\"-fno-crossjumping -fno-reorder-blocks\";;\n      *);;\n    esac\n    make linux-thr\n    if [ $? -ne 0 ]; then\n        echo \"Maybe your system is 64-bit; trying again.\"\n        if [ `uname -m` = \"ia64\" ]; then\n          echo \"ia64\"\n          make linux-ia64-thr\n        else\n          echo \"64-bit arch\"\n          make linux-64-thr\n        fi\n    fi\n    finished\nfi\n```\n(If it's possible to avoid doing this with Tachyon, we can open a new ticket for it.)",
    "created_at": "2010-10-18T02:06:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116714",
    "user": "https://github.com/qed777"
}
```

<a id='comment:25'></a>For what it's worth, in Tachyon's `spkg-install`, there's an example of retrying an spkg installation after an initial failure:
...
```json
{
    "body": "<a id='comment:26'></a>I'm changing the milestone to 4.6.1.  Of course, the next release manager is welcome to change the priority.",
    "created_at": "2010-10-19T02:20:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116715",
    "user": "https://github.com/qed777"
}
```

<a id='comment:26'></a>I'm changing the milestone to 4.6.1.  Of course, the next release manager is welcome to change the priority.
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9864#event-24828"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9864#event-24829"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>I've added a [RHEL 5.5 builder on Jon Hanke's machine rosemary](http://build.sagemath.org/sage/builders/RHEL%205.5-64%20(rosemary)).  The zeroth build [failed on PIL](http://build.sagemath.org/sage/builders/RHEL%205.5-64%20(rosemary)/builds/0/steps/shell_2/logs/pil).",
    "created_at": "2010-11-12T08:39:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116716",
    "user": "https://github.com/qed777"
}
```

<a id='comment:27'></a>I've added a [RHEL 5.5 builder on Jon Hanke's machine rosemary](http://build.sagemath.org/sage/builders/RHEL%205.5-64%20(rosemary)).  The zeroth build [failed on PIL](http://build.sagemath.org/sage/builders/RHEL%205.5-64%20(rosemary)/builds/0/steps/shell_2/logs/pil).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116718",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116719",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116720",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Leif Leonhardy, Mitesh Patel\"",
    "created_at": "2010-11-26T11:14:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116721",
    "user": "https://github.com/qed777"
}
```

Changing author from "" to "Leif Leonhardy, Mitesh Patel"
...
```json
{
    "body": "<a id='comment:30'></a>Attachment [trac_9864-PIL_library_path.patch](tarball://root/attachments/some-uuid/ticket9864/trac_9864-PIL_library_path.patch) by @qed777 created at 2010-11-26 11:14:12\n\nI've added a spkg link to the description and attached an SPKG patch.  The main changes:\n\n* Comment out the `/usr/local/lib` line [comment:15 pointed out by Leif].\n* Use `patch` to apply the patch.\n\nThe package installs successfully and the long doctests pass for me on bsd (OSX 10.6-32), eno (Fedora 13-64), hawk (OpenSolaris 06.2009-32), redhawk (Ubuntu 10-64), rosemary (RHEL 5.5-64), and sage.math (Ubuntu 8-64).",
    "created_at": "2010-11-26T11:14:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116722",
    "user": "https://github.com/qed777"
}
```

<a id='comment:30'></a>Attachment [trac_9864-PIL_library_path.patch](tarball://root/attachments/some-uuid/ticket9864/trac_9864-PIL_library_path.patch) by @qed777 created at 2010-11-26 11:14:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116723",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"make patches #9419-compliant\"",
    "created_at": "2010-11-28T15:17:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116724",
    "user": "https://github.com/jdemeyer"
}
```

Changing work_issues from "" to "make patches #9419-compliant"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116725",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116727",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>New package works fine on 64-bit Gentoo Linux, 32-bit Gentoo Linux, 32-bit OS X PPC.  So from a functionality point of view, this package gets a positive review from me.  I don't think I'm able to review the actual code though.",
    "created_at": "2010-11-29T20:23:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116728",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:33'></a>New package works fine on 64-bit Gentoo Linux, 32-bit Gentoo Linux, 32-bit OS X PPC.  So from a functionality point of view, this package gets a positive review from me.  I don't think I'm able to review the actual code though.
...
```json
{
    "body": "<a id='comment:34'></a>I'm having issues with PIL 1.1.6p2 (the release version) not finding its JPEG libraries. These are located in /usr/lib64 on CentOS 5.5 / OpenSuse, however the default library path only considers /usr/lib. Adding /usr/lib64 as a library path fixes the problem in my stand-alone PIL build. I'm not quite sure how to patch the setup.py in SAGE to add this path by default.\n\nThe following part of the log shows the problem (or the lack of a jpeg_decoder function in PIL.Image.core)\n\n---\nPIL 1.1.6 BUILD SUMMARY\n\n---\nversion       1.1.6\nplatform      linux2 2.6.4 (r264:75706, Oct  4 2010, 14:47:23)\n              [GCC 4.3.4]\n\n---\n*** TKINTER support not available\n*** JPEG support not available\n--- ZLIB (PNG/ZIP) support ok\n--- FREETYPE2 support ok\n\n---",
    "created_at": "2010-11-30T15:56:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116729",
    "user": "https://trac.sagemath.org/admin/accounts/users/Koen"
}
```

<a id='comment:34'></a>I'm having issues with PIL 1.1.6p2 (the release version) not finding its JPEG libraries. These are located in /usr/lib64 on CentOS 5.5 / OpenSuse, however the default library path only considers /usr/lib. Adding /usr/lib64 as a library path fixes the problem in my stand-alone PIL build. I'm not quite sure how to patch the setup.py in SAGE to add this path by default.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116732",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116734",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116737",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116739",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116740",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116741",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Attachment [trac_9864-remove_duplicate_usr_local_lib_dir-v2-spkg.patch](tarball://root/attachments/some-uuid/ticket9864/trac_9864-remove_duplicate_usr_local_lib_dir-v2-spkg.patch) by @nexttime created at 2010-12-01 03:36:37",
    "created_at": "2010-12-01T03:36:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116742",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:44'></a>Attachment [trac_9864-remove_duplicate_usr_local_lib_dir-v2-spkg.patch](tarball://root/attachments/some-uuid/ticket9864/trac_9864-remove_duplicate_usr_local_lib_dir-v2-spkg.patch) by @nexttime created at 2010-12-01 03:36:37
...
```json
{
    "body": "<a id='comment:45'></a>Replying to [comment:43 leif]:\n> Does **not** fix the `.../lib64` issue; this should IMHO go onto another ticket.\n\n\nI've opened http://trac.sagemath.org/sage_trac/ticket/10359 to address that issue.",
    "created_at": "2010-12-01T03:53:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116743",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:45'></a>Replying to [comment:43 leif]:
> Does **not** fix the `.../lib64` issue; this should IMHO go onto another ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116744",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116745",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116746",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116747",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116748",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Positive review implicit by #10359.",
    "created_at": "2010-12-05T11:57:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116749",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:48'></a>Positive review implicit by #10359.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9864#event-24830"
}
```
...
```json
{
    "body": "<a id='comment:49'></a>Thanks, Leif!",
    "created_at": "2010-12-07T02:31:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9864#issuecomment-116750",
    "user": "https://github.com/qed777"
}
```

<a id='comment:49'></a>Thanks, Leif!
