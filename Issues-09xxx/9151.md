...
```json
{
    "body": "Attachment [atlas_pthread.patch](https://github.com/sagemath/sage/files/ticket9151/atlas_pthread.patch) by kilian created at 2010-06-05 17:25:08\n\nenables multi-threaded build in atlas-3.8.3.p12.spkg",
    "created_at": "2010-06-05T17:25:08Z",
    "issue": "https://github.com/sagemath/sage/issues/9151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9151#issuecomment-78123",
    "user": "https://trac.sagemath.org/admin/accounts/users/kilian"
}
```

Attachment [atlas_pthread.patch](https://github.com/sagemath/sage/files/ticket9151/atlas_pthread.patch) by kilian created at 2010-06-05 17:25:08
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9151#issuecomment-78124",
    "user": "https://trac.sagemath.org/admin/accounts/users/kilian"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9151#issuecomment-78125",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9151#issuecomment-78126",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
