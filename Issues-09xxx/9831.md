...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89701",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9831#event-73556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89702",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9831/trac_9831_Permutation_list_check.patch",
    "created_at": "2010-11-07T04:00:29Z",
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9831/trac_9831_Permutation_list_check.patch",
...
```json
{
    "body": "Attachment [trac_9831_Permutation_list_check.patch](https://github.com/sagemath/sage/files/ticket9831/trac_9831_Permutation_list_check.patch) by nharris created at 2010-11-07 04:00:29",
    "created_at": "2010-11-07T04:00:29Z",
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89703",
    "user": "https://trac.sagemath.org/admin/accounts/users/nharris"
}
```

Attachment [trac_9831_Permutation_list_check.patch](https://github.com/sagemath/sage/files/ticket9831/trac_9831_Permutation_list_check.patch) by nharris created at 2010-11-07 04:00:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89704",
    "user": "https://trac.sagemath.org/admin/accounts/users/nharris"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9831#event-73557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89705",
    "user": "https://trac.sagemath.org/admin/accounts/users/nharris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89706",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89707",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9831/trac_9831_Permutation_input_repair.patch",
    "created_at": "2011-12-31T01:55:18Z",
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9831/trac_9831_Permutation_input_repair.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [trac_9831_Permutation_input_repair.patch](https://github.com/sagemath/sage/files/ticket9831/trac_9831_Permutation_input_repair.patch) by brunellus created at 2011-12-31 01:55:18\n\nNow, I would like to send this to review, because I see no more error (maybe I overlooked some?). But the original patch refuses to apply -- I guess it's because codebase shifted somehow in last year. Is this a problem I should correct?",
    "created_at": "2011-12-31T01:55:18Z",
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89708",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9831#event-73558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9831#event-73559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9831#issuecomment-89709",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9831#event-73560"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9831#event-73561"
}
```
