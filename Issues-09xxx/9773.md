...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114635",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114637",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114638",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Will this interact at all with the class `CombinatorialFreeModule`?  I don't know what the long term plans are, or even if there are any, for connecting this with `FreeModule`, but the combinatorial version has some nice features.\n\nAlso, how do you define **R** or **Q** as additive abelian groups with this setup?",
    "created_at": "2010-08-21T00:39:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114639",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Will this interact at all with the class `CombinatorialFreeModule`?  I don't know what the long term plans are, or even if there are any, for connecting this with `FreeModule`, but the combinatorial version has some nice features.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114640",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a># To the release manager\n\nPlease close #9694 when this ticket is merged.",
    "created_at": "2010-08-23T09:58:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114642",
    "user": "https://github.com/qed777"
}
```

<a id='comment:6'></a># To the release manager
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114643",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Code is stablizing in draft 2 patch, and I'm starting to write the doctests.  Still uncertain about `__call__` and now its interactions with `__contains__`.\n\nThere are liberal comments in the code and the `units_modn` module has a rather complete demo of functionality.",
    "created_at": "2010-09-02T04:23:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114644",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:7'></a>Code is stablizing in draft 2 patch, and I'm starting to write the doctests.  Still uncertain about `__call__` and now its interactions with `__contains__`.
...
```json
{
    "body": "<a id='comment:8'></a>Question: does this patch solve #10181?\n\nPaul Zimmermann",
    "created_at": "2010-10-28T09:29:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114645",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:8'></a>Question: does this patch solve #10181?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114646",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114648",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Justin - no documentation to speak of, but look at the derived classes to get a feel for how this might work.\n\nAny insights or ideas you might have would be helpful before I try to finish this off later this spring.\n\nRob",
    "created_at": "2011-03-23T20:55:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114649",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:12'></a>Justin - no documentation to speak of, but look at the derived classes to get a feel for how this might work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114652",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Just replaced the patch.  Realized the `_user_to_optimized()` method needed to be in the parent class, not the element class.  Then had some partial success getting `_element_constructor()` to work, but it still fails on subgroups - `.smith_form_gens()` for FGP modules is the suspect.\n\nTest suite on the elliptic curve example was testing the wrong instance - as corrected one test fails, so it is commented out, but should be experimented with to determine root cause.",
    "created_at": "2012-07-16T04:05:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114653",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:15'></a>Just replaced the patch.  Realized the `_user_to_optimized()` method needed to be in the parent class, not the element class.  Then had some partial success getting `_element_constructor()` to work, but it still fails on subgroups - `.smith_form_gens()` for FGP modules is the suspect.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114655",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>draft-6 patch is darn close to functional.  Lots of doctests, all passing.  Lots of code pushed up to abstract class.  Much more to do on docstrings.\n\nOne **real** edit in `FGP_Module` code.  Remainder are stray print statements to be cleaned up.",
    "created_at": "2012-08-08T03:56:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114656",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:17'></a>draft-6 patch is darn close to functional.  Lots of doctests, all passing.  Lots of code pushed up to abstract class.  Much more to do on docstrings.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114657",
...
```json
{
    "body": "<a id='comment:19'></a>Replying to [AlexGhitza](#comment%3A18):\n> Just a quick note to say that I've played with draft-6 a bit (mainly with the `UnitsModmGroup`), and I very much like it.  Thanks for all the work you've put into this (and the patience!).\n\n\nThanks very much, Alex, for the encouragement.  Still lots of docstrings to work on, but making (slow) progress, since classes started recently.  Soon.  ;-)",
    "created_at": "2012-08-30T21:20:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114658",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:19'></a>Replying to [AlexGhitza](#comment%3A18):
> Just a quick note to say that I've played with draft-6 a bit (mainly with the `UnitsModmGroup`), and I very much like it.  Thanks for all the work you've put into this (and the patience!).
...
```json
{
    "body": "<a id='comment:20'></a>any progress on this? Which info is needed?\n\nPaul",
    "created_at": "2013-01-08T08:27:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114659",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:20'></a>any progress on this? Which info is needed?
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24495"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Update: v6 patch will compain about one hunk not applying - just ignore it, it is no longer needed.  \n\nOn 5.12: compiles and passes all tests.\n\nBasically I think the code is solid on this one, but it needs extensive work to fully document and doctest.  And then it would be a big effort to slowly integrate in.",
    "created_at": "2013-11-09T05:51:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114660",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:22'></a>Update: v6 patch will compain about one hunk not applying - just ignore it, it is no longer needed.  
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24496"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24497"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24498"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24499"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24500"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9773#event-24501"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Hey Rob, what's the status here?  If one (say, me) were to have a student who knows some algebra and is a solid programmer, could they finish up what is remaining?  Could be really useful stuff.",
    "created_at": "2015-02-12T15:03:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114661",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:26'></a>Hey Rob, what's the status here?  If one (say, me) were to have a student who knows some algebra and is a solid programmer, could they finish up what is remaining?  Could be really useful stuff.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9773#issuecomment-114662",
