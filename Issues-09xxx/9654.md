...
```json
{
    "body": "<a id='comment:11'></a>\nThis appears to be a simple fix for this issue. Do I need to add anything more than the doctest?\n\n---\nNew commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[842fc8c](https://git.sagemath.org/sage.git/commit?id=842fc8c66d6d6d913cec560ba227b798a1af4bfc)|`Add rgbcolor option to implict_plot`|\n|[ea98638](https://git.sagemath.org/sage.git/commit?id=ea98638e7b5d15b9f5b32f50144d576b339c8145)|`Add doctest for fix`|",
    "created_at": "2016-07-04T20:47:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9654",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nReplying to [paulmasson](#comment%3A13):\n> I've updated the branch to raise a `ValueError` for conflicting input, as well as added a doctest.\n\n\nThanks. Looks good.\n\n> The error in `plot.py` appears to arise from this line:\n> \n> \n> ```\n> @rename_keyword(color='rgbcolor')\n> ```\n> \n> Once we agree on how to handle the two arguments here, I can remove that line and update the code accordingly.\n\n\nWhich error where? I don't see any doctest failures.\n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[0129681](https://git.sagemath.org/sage.git/commit?id=01296816efffbc15c9ba8613f2c48f1aa3295d90)|`Add ValueError and doctest`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[5764c22](http://git.sagemath.org/sage.git/commit/?id=5764c22a5859baea5c1825a2cbbb2837775b0db2)|`Additional doctest`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[667d19c](http://git.sagemath.org/sage.git/commit/?id=667d19c5fe3c2221b61cf684fd37c617807c8f4f)|`Remove white space`|",
    "created_at": "2016-07-08T19:49:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9654",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[ade94e7](http://git.sagemath.org/sage.git/commit/?id=ade94e77c55217abb89050f6726aea1599005bf0)|`Add rgbcolor option to implict_plot`|\n|[eefad25](http://git.sagemath.org/sage.git/commit/?id=eefad2541be8b80919548da81b6b61c959a7667f)|`Fix merge conflict`|",
    "created_at": "2016-07-08T20:49:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9654",
    "type": "issue_comment",
