...
```json
{
    "body": "<a id='comment:1'></a>This would be good to work too, if we can fix the above.\n\n```\npts = [(1,2)] \nR.<x>=QQ[] \nf = R.lagrange_polynomial(pts) \nf.plot(0,7) \n<boom because integers have no .plot() method>\n```",
    "created_at": "2010-08-24T15:20:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9795#issuecomment-115149",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>This would be good to work too, if we can fix the above.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24575"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24576"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24577"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24578"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24579"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24580"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9795#event-24581"
}
```
