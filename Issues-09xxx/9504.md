...
```json
{
    "body": "Changing work_issues from \"\" to \"documentation and quotients\"",
    "created_at": "2010-07-15T07:44:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109003",
    "user": "https://github.com/novoselt"
}
```

Changing work_issues from "" to "documentation and quotients"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109004",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109005",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109007",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I don't know yet what to do with quotients, but can we change the representation of sublattices to, for example,\n\n```\nsage: L = ToricLattice(3, \"L\")\nsage: L.submodule_with_basis([(3,2,1),(1,2,3)])\nSublattice <L(3, 2, 1), L(1, 2, 3)> of 3-d lattice L\nsage: L.submodule([(3,2,1)])\n1-d sublattice of 3-d lattice L\n```\nPatch is attached.",
    "created_at": "2010-07-21T04:50:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109008",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>I don't know yet what to do with quotients, but can we change the representation of sublattices to, for example,
...
```json
{
    "body": "<a id='comment:5'></a>Yes, of course, I actually was going to do something like that but forgot. \n\nI would prefer not to have different `_repr_` and `_latex_` for the second class - can we always show `basis()` no matter how it was obtained?",
    "created_at": "2010-07-21T05:03:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109009",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:5'></a>Yes, of course, I actually was going to do something like that but forgot. 
...
```json
{
    "body": "<a id='comment:6'></a>My thinking was that only if you use `submodule_with_basis` then you are actually interested in the precise form of the basis. In both cases, the LaTeX representation is the same (lack of imagination on my part, perhaps :-)\n\nOf course there is something to be said for uniform output, too. I could live with that as well...",
    "created_at": "2010-07-21T14:04:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109010",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>My thinking was that only if you use `submodule_with_basis` then you are actually interested in the precise form of the basis. In both cases, the LaTeX representation is the same (lack of imagination on my part, perhaps :-)
...
```json
{
    "body": "<a id='comment:7'></a>I was thinking that it is nice for distinguishing different sublattices. While \"3-d lattice N\" is almost unique (exactly unique if the user didn't meddle with dual and LaTeX names), \"1-d sublattice of 3-d lattice N\" is not as descriptive. And I think that in most cases users don't use `_with_basis`, but they may get such sublattices as output of other functions. In this case it may be strange that sometimes there is a basis and sometimes there isn't.\n\nIt will indeed be more uniform with free submodules behaviour. They actually put a special line indicating whether it is a user basis or the echelonized one. I find their output to be too long and taking too many lines, also that's my personal taste and I don't propose changing it.",
    "created_at": "2010-07-21T14:37:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109011",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:7'></a>I was thinking that it is nice for distinguishing different sublattices. While "3-d lattice N" is almost unique (exactly unique if the user didn't meddle with dual and LaTeX names), "1-d sublattice of 3-d lattice N" is not as descriptive. And I think that in most cases users don't use `_with_basis`, but they may get such sublattices as output of other functions. In this case it may be strange that sometimes there is a basis and sometimes there isn't.
...
```json
{
    "body": "<a id='comment:10'></a>I like your proposal. I think it would be faster to simply derive from `FGP_Module`, but I agree that an independent `ToricLattice_quotient` would integrate better with the other `ToricLattice`s.",
    "created_at": "2010-07-24T14:56:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109014",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>I like your proposal. I think it would be faster to simply derive from `FGP_Module`, but I agree that an independent `ToricLattice_quotient` would integrate better with the other `ToricLattice`s.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109016",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109017",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I'm happy with a different string `_repr_()` in the case with torsion, but I would prefer \n\n```\nsage: Q/subQ\nQuotient with torsion of 3-d lattice N by Sublattice <N(1, 2, 3), N(0, 3, 6)>\n```\nto make it clear that the quotient is not **pure** torsion.",
    "created_at": "2010-08-05T19:27:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109018",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>I'm happy with a different string `_repr_()` in the case with torsion, but I would prefer 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109019",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109020",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109023",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109024",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I've updated the reviewer patch accordingly. Now the coordinate vectors work as expected:\n\n```\nsage: N = ToricLattice(3)\nsage: Ns = N.submodule([N(1,1,1), N(1,2,3)])\nsage: Q = N.quotient(Ns, positive_point=N(0,0,-1))\nsage: Q.gen(0)\nN[0, 0, -1]\nsage: Q.gen(0).vector()\n(1,)\nsage: Q(0,0,-1)\nN[0, 0, -1]\nsage: Q(0,0,-1).vector()\n(1,)\nsage: q1 = Q(1,0,0)\nsage: q1\nN[1, 0, 0]\nsage: q1.vector()\n(-1,)\n```",
    "created_at": "2010-08-10T21:46:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109027",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:18'></a>I've updated the reviewer patch accordingly. Now the coordinate vectors work as expected:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109028",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>There was one more bug in the check that `positive_dual_point` is in the right lattice, now it works correctly including the Chow group computations that depend on it.",
    "created_at": "2010-08-11T01:40:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109029",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:20'></a>There was one more bug in the check that `positive_dual_point` is in the right lattice, now it works correctly including the Chow group computations that depend on it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109030",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109031",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Attachment [trac_9504_last_changes.patch](tarball://root/attachments/some-uuid/ticket9504/trac_9504_last_changes.patch) by @novoselt created at 2010-08-11 05:50:01\n\nI made `coordinate_vector/vector` to return a vector rather than tuple and fixed a couple of typos. I think now it is ready to be switched to \"positive review\" and I am moving on to the next one!",
    "created_at": "2010-08-11T05:50:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109032",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:21'></a>Attachment [trac_9504_last_changes.patch](tarball://root/attachments/some-uuid/ticket9504/trac_9504_last_changes.patch) by @novoselt created at 2010-08-11 05:50:01
...
```json
{
    "body": "<a id='comment:22'></a>I agree with your changes! What confused me was that the docstring of `FGP_Module_class.coordinate_vector` does say that it returns a tuple, but alas, it does return a vector. I'll attach an updated patch to fix this docstring, too. Feel free to set positive review...",
    "created_at": "2010-08-13T19:38:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109033",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:22'></a>I agree with your changes! What confused me was that the docstring of `FGP_Module_class.coordinate_vector` does say that it returns a tuple, but alas, it does return a vector. I'll attach an updated patch to fix this docstring, too. Feel free to set positive review...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109034",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109035",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Attachment [trac_9504_last_changes.2.patch](tarball://root/attachments/some-uuid/ticket9504/trac_9504_last_changes.2.patch) by @novoselt created at 2010-08-13 21:23:25\n\nFor the release manager: apply all patches in the order listed, but only the second version of the very last one.",
    "created_at": "2010-08-13T21:23:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109036",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:23'></a>Attachment [trac_9504_last_changes.2.patch](tarball://root/attachments/some-uuid/ticket9504/trac_9504_last_changes.2.patch) by @novoselt created at 2010-08-13 21:23:25
...
```json
{
    "body": "<a id='comment:24'></a>Please update [attachment:trac_9504_change_sublattice_repr.patch] with a more descriptive commit string.",
    "created_at": "2010-08-15T09:09:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109037",
    "user": "https://github.com/qed777"
}
```

<a id='comment:24'></a>Please update [attachment:trac_9504_change_sublattice_repr.patch] with a more descriptive commit string.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109038",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109039",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Attachment [trac_9504_change_sublattice_repr.patch](tarball://root/attachments/some-uuid/ticket9504/trac_9504_change_sublattice_repr.patch) by @vbraun created at 2010-08-15 14:46:50\n\nI've added the customary commit message to the patch. I'll set this ticket back to positive review since only metadata was changed.\n\nApply patches in this order:\n\n* trac_9504_add_support_for_toric_sublattices.patch\n* trac_9504_change_sublattice_repr.patch\n* trac_9504_add_support_for_quotients_of_toric_lattices.patch\n* trac_9504_reviewer_changes.patch\n* trac_9504_last_changes.2.patch",
    "created_at": "2010-08-15T14:46:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109040",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:25'></a>Attachment [trac_9504_change_sublattice_repr.patch](tarball://root/attachments/some-uuid/ticket9504/trac_9504_change_sublattice_repr.patch) by @vbraun created at 2010-08-15 14:46:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109041",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109042",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9504#issuecomment-109043",
    "user": "https://github.com/qed777"
}
```
