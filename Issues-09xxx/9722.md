...
```json
{
    "body": "<a id='comment:1'></a>Georg, if I've correctly guessed your trac name, could you please update the [Sage trac account name-real name map](http://trac.sagemath.org/sage_trac/wiki/WikiStart#AccountNamesmappedtoRealNames)?",
    "created_at": "2010-08-11T01:36:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113613",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>Georg, if I've correctly guessed your trac name, could you please update the [Sage trac account name-real name map](http://trac.sagemath.org/sage_trac/wiki/WikiStart#AccountNamesmappedtoRealNames)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113614",
...
```json
{
    "body": "<a id='comment:5'></a>> There's already a [new PARI Sage package underway](http://trac.sagemath.org/sage_trac/ticket/9343#comment:171), which is afaik intended to get merged into Sage 4.6, but I don't believe you want to wait for that.\n\n\nI'm not doing numerical calculations right now, but I'm trying to spread sage here (eth z\u00fcrich), which is a bit difficult if it does not built ;-), some of us are using it for teaching, the semester starts in middle of September, would be great to fix it until then,\n\nbtw, this bug exists since version after 4.3.4, which was the last which built correctly,\nI reported it two times before, but was ignored (once a workaround was given)),\n\nGeorg",
    "created_at": "2010-08-11T17:23:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113617",
    "user": "https://trac.sagemath.org/admin/accounts/users/ggrafendorfer"
}
```

<a id='comment:5'></a>> There's already a [new PARI Sage package underway](http://trac.sagemath.org/sage_trac/ticket/9343#comment:171), which is afaik intended to get merged into Sage 4.6, but I don't believe you want to wait for that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113620",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I've uploaded a patch to fix the second (i.e. the linker) error. Yet only tested on Ubuntu; *should* work for Fedora 13...\n\n```\n### pari-2.3.5.p3 (Leif Leonhardy, August 11th 2010)\n * #9722: Explicitly link against libstdc++ if FLTK is used, to support\n   Fedora 13.\n * TODO/FIXME: On Fedora 13, PARI tries to use FLTK even if just the\n   library (as opposed to the required developer) package of FLTK is\n   installed.\n```",
    "created_at": "2010-08-11T18:18:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113621",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>I've uploaded a patch to fix the second (i.e. the linker) error. Yet only tested on Ubuntu; *should* work for Fedora 13...
...
```json
{
    "body": "<a id='comment:11'></a>ggrafendorfer: could you please try to see if the problem is there when you compile PARI/GP by itself?  That is, download [http://pari.math.u-bordeaux.fr/pub/pari/unix/pari-2.3.5.tar.gz](http://pari.math.u-bordeaux.fr/pub/pari/unix/pari-2.3.5.tar.gz), do `./Configure && make` and see what happens.  If you can, please try it both with fltk-devel uninstalled and installed.  If it doesn't compile like that, it should be reported upstream.",
    "created_at": "2010-08-11T21:23:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113623",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>ggrafendorfer: could you please try to see if the problem is there when you compile PARI/GP by itself?  That is, download [http://pari.math.u-bordeaux.fr/pub/pari/unix/pari-2.3.5.tar.gz](http://pari.math.u-bordeaux.fr/pub/pari/unix/pari-2.3.5.tar.gz), do `./Configure && make` and see what happens.  If you can, please try it both with fltk-devel uninstalled and installed.  If it doesn't compile like that, it should be reported upstream.
...
```json
{
    "body": "<a id='comment:12'></a>If it helps, I don't mind merging an intermediate / incremental PARI package in the 4.5.3 series.\n\nLeif, I can make your package available on sage.math.  Since it's ~2 MB, just send it to me by email.\n\nAlthough I haven't tried it myself, it might be easier to set up and use [spkg-upload](http://code.google.com/p/spkg-upload/).",
    "created_at": "2010-08-11T22:44:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113624",
    "user": "https://github.com/qed777"
}
```

<a id='comment:12'></a>If it helps, I don't mind merging an intermediate / incremental PARI package in the 4.5.3 series.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113625",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113626",
    "user": "https://trac.sagemath.org/admin/accounts/users/ggrafendorfer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113628",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>P.S.: Btw, we **do** (unconditionally) configure PARI with `--graphic=none`...\n\n(Although the user can set `PARI_EXTRA_OPTS` to pass additional configuration options; cf. my trivial work-around above.)",
    "created_at": "2010-08-16T19:01:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113630",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:17'></a>P.S.: Btw, we **do** (unconditionally) configure PARI with `--graphic=none`...
...
```json
{
    "body": "<a id='comment:18'></a>Should we reply to the PARI developers with Leif's points?\n\nFor now, can we bypass PARI's FLTK checks altogether because/when we use `--graphic=none`?",
    "created_at": "2010-08-19T09:11:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113631",
    "user": "https://github.com/qed777"
}
```

<a id='comment:18'></a>Should we reply to the PARI developers with Leif's points?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113632",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>s/build FLTK/build using FLTK/",
    "created_at": "2010-08-19T09:31:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113633",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:20'></a>s/build FLTK/build using FLTK/
...
```json
{
    "body": "<a id='comment:22'></a>Georg, could you perhaps attach (upload) the two logfiles you sent to the PARI developers here, too?",
    "created_at": "2010-08-19T09:48:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113635",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:22'></a>Georg, could you perhaps attach (upload) the two logfiles you sent to the PARI developers here, too?
...
```json
{
    "body": "<a id='comment:23'></a>Georg, could you please check your environment settings?\n\n```sh\nuser@host$ printenv | grep fltk\n```\n\nI found PARI not resetting/initializing variables presumably intended to be locally used only...",
    "created_at": "2010-08-19T10:50:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113636",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:23'></a>Georg, could you please check your environment settings?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113637",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113638",
    "user": "https://trac.sagemath.org/admin/accounts/users/ggrafendorfer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113639",
    "user": "https://trac.sagemath.org/admin/accounts/users/ggrafendorfer"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Replying to [ggrafendorfer](#comment%3A25):\n> Replying to [leif](#comment%3A22):\n> > Georg, could you perhaps attach (upload) the two logfiles you sent to the PARI developers here, too?\n\n> \n> done\n\n\nThanks, does the same happen if you run `./Configure --graphic=none`?",
    "created_at": "2010-08-19T15:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113642",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:27'></a>Replying to [ggrafendorfer](#comment%3A25):
> Replying to [leif](#comment%3A22):
> > Georg, could you perhaps attach (upload) the two logfiles you sent to the PARI developers here, too?
...
```json
{
    "body": "<a id='comment:29'></a>Attachment [log_with_fltk-devel_--graphic=none](tarball://root/attachments/some-uuid/ticket9722/log_with_fltk-devel_--graphic=none) by @nexttime created at 2010-08-19 16:54:03\n\nReplying to [ggrafendorfer](#comment%3A28):\n> Replying to [leif](#comment%3A27):\n> > Thanks, does the same happen if you run `./Configure --graphic=none`?\n\n> \n> yes, I'll attach the log file,\n\n\nLOL, that's because you *don't* have *X11* development packages installed! :)\n\n`config/get_fltk`:\n\n```sh\nif test -z \"$with_fltk\"; then\n  case \"$which_graphic_lib\" in\n    fltk) with_fltk=yes;;\n  esac\n  if test -z \"$X11\"; then with_fltk=yes; fi\nfi\n...\n```\n\nPARI is really funny. I'll fix *all three* issues and upload a second patch here later...",
    "created_at": "2010-08-19T16:54:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113644",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:29'></a>Attachment [log_with_fltk-devel_--graphic=none](tarball://root/attachments/some-uuid/ticket9722/log_with_fltk-devel_--graphic=none) by @nexttime created at 2010-08-19 16:54:03
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113645",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Whatever you do, it would be good to report these issues upstream.  The PARI developers usually accept patches which fix bugs (although they are sometimes slow).  \n\nI haven't followed up on this ticket so much, but does the new version (see #9343) also need patching?",
    "created_at": "2010-08-19T17:38:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113646",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:30'></a>Whatever you do, it would be good to report these issues upstream.  The PARI developers usually accept patches which fix bugs (although they are sometimes slow).  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113647",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>I'd like to release 4.5.3.rc0 by Monday, 23 August, and if all goes well, 4.5.3 by the end of next week.  Since the necessary changes here aren't trivial --- we'd need to test them on \"all\" platforms --- I suggest that we fix this ticket in the new PARI spkg at #9343, which I'll merge into 4.6.alpha0.  This presumes that #9343, #9591, and #9592 will be ready.  I'll send a message to sage-devel about their status.",
    "created_at": "2010-08-21T08:50:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113649",
    "user": "https://github.com/qed777"
}
```

<a id='comment:33'></a>I'd like to release 4.5.3.rc0 by Monday, 23 August, and if all goes well, 4.5.3 by the end of next week.  Since the necessary changes here aren't trivial --- we'd need to test them on "all" platforms --- I suggest that we fix this ticket in the new PARI spkg at #9343, which I'll merge into 4.6.alpha0.  This presumes that #9343, #9591, and #9592 will be ready.  I'll send a message to sage-devel about their status.
...
```json
{
    "body": "<a id='comment:34'></a>Georg, could you look at [comment:ticket:9343:294 Jeroen's comment] at #9343 and let us know any results?",
    "created_at": "2010-08-21T21:25:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113650",
    "user": "https://github.com/qed777"
}
```

<a id='comment:34'></a>Georg, could you look at [comment:ticket:9343:294 Jeroen's comment] at #9343 and let us know any results?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113652",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113654",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113656",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113657",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113658",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>I've attached a [diff between the p3 and the p4-preview spkg](http://trac.sagemath.org/sage_trac/raw-attachment/ticket/9722/trac_9722-pari-2.3.5.p3-p4.patch), in case anybody is interested... ;-)\n\nNote that this currently is just a diff, not a proper Mercurial patch (\"changeset\").",
    "created_at": "2010-08-23T04:57:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113660",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:39'></a>I've attached a [diff between the p3 and the p4-preview spkg](http://trac.sagemath.org/sage_trac/raw-attachment/ticket/9722/trac_9722-pari-2.3.5.p3-p4.patch), in case anybody is interested... ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113661",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113663",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113664",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113665",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113666",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113667",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113669",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113670",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113671",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>I get a build failure with `PARI_EXTRA_OPTS=--graphic=x11` on sage.math.  I've put the log [here](http://sage.math.washington.edu/home/mpatel/trac/9722/sage.math--graphic=x11.log).",
    "created_at": "2010-08-23T13:44:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113672",
    "user": "https://github.com/qed777"
}
```

<a id='comment:48'></a>I get a build failure with `PARI_EXTRA_OPTS=--graphic=x11` on sage.math.  I've put the log [here](http://sage.math.washington.edu/home/mpatel/trac/9722/sage.math--graphic=x11.log).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113675",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113676",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113677",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113678",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113679",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:56'></a>The p4 package installs cleanly with various legal settings for `PARI_EXTRA_OPTS` on bsd, redhawk, sage, and t2.math.  The long doctests then pass on redhawk and sage.math.  I'm now running the tests on bsd and t2.",
    "created_at": "2010-08-23T14:54:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113681",
    "user": "https://github.com/qed777"
}
```

<a id='comment:56'></a>The p4 package installs cleanly with various legal settings for `PARI_EXTRA_OPTS` on bsd, redhawk, sage, and t2.math.  The long doctests then pass on redhawk and sage.math.  I'm now running the tests on bsd and t2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113682",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>Attachment [trac_9722-combined.patch](tarball://root/attachments/some-uuid/ticket9722/trac_9722-combined.patch) by @nexttime created at 2010-08-23 15:07:33\n\nReplying to [leif](#comment%3A45):\n> Replying to [leif](#comment%3A44):\n> > (I've so far only tested the spkg on top of Sage 4.5.3.alpha0 and 4.5.3.alpha1.)\n\n> \n> Also installed without problems on Sage 4.5.2, now running `ptest`.\n\n\n* Passed `make ptest` with Sage 4.5.2, Ubuntu 9.04 x86 (P4 Prescott, gcc 4.3.3).\n* Passed `make test` with Sage 4.5.3.alpha1, Ubuntu 9.04 x86_64 (Core2, gcc 4.3.3).\n* Passed `make ptestlong` with Sage 4.5.3.alpha1, Fedora 13 x86_64 (Core2, gcc 4.4.4).",
    "created_at": "2010-08-23T15:07:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113683",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:57'></a>Attachment [trac_9722-combined.patch](tarball://root/attachments/some-uuid/ticket9722/trac_9722-combined.patch) by @nexttime created at 2010-08-23 15:07:33
...
```json
{
    "body": "<a id='comment:58'></a>Replying to [leif](#comment%3A45):\n\nbuilding sage 4.5.3.alpha1 from scratch works fine now on fedora 13,\n\nthanks, Georg",
    "created_at": "2010-08-23T17:14:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113684",
    "user": "https://trac.sagemath.org/admin/accounts/users/ggrafendorfer"
}
```

<a id='comment:58'></a>Replying to [leif](#comment%3A45):
...
```json
{
    "body": "<a id='comment:59'></a>Built .p4 successfully with all possible options for --graphic on a x86_64 Gentoo Linux system.\n\nThe patch looks messy though, it might be non-trivial to port to #9343.",
    "created_at": "2010-08-23T19:03:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113685",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:59'></a>Built .p4 successfully with all possible options for --graphic on a x86_64 Gentoo Linux system.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113688",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "Changing reviewer from \"Jeroen Demeyer\" to \"Jeroen Demeyer, Mitesh Patel\"",
    "created_at": "2010-08-23T22:13:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113689",
    "user": "https://github.com/qed777"
}
```

Changing reviewer from "Jeroen Demeyer" to "Jeroen Demeyer, Mitesh Patel"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113690",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9722#issuecomment-113691",
    "user": "https://github.com/qed777"
}
```
