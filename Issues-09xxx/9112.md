...
```json
{
    "body": "<a id='comment:2'></a>I'm not sure if printing the maximum entry is the best way to do it.  Once CombinatorialClasses are Parents, then that information will be accessible from the parent.",
    "created_at": "2010-06-01T23:06:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100870",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>I'm not sure if printing the maximum entry is the best way to do it.  Once CombinatorialClasses are Parents, then that information will be accessible from the parent.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100871",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100873",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100874",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>By the way, how do you remove an attached file? I didn't put the trac number in the filename. This is my first time contributing.",
    "created_at": "2010-06-01T23:47:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100875",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```

<a id='comment:6'></a>By the way, how do you remove an attached file? I didn't put the trac number in the filename. This is my first time contributing.
...
```json
{
    "body": "<a id='comment:8'></a>Cool, thanks a lot.\n\nI'll fix those things and post the new patch.",
    "created_at": "2010-06-02T00:07:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100877",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```

<a id='comment:8'></a>Cool, thanks a lot.
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_9112_tableau_py.patch](tarball://root/attachments/some-uuid/ticket9112/trac_9112_tableau_py.patch) by @hughrthomas created at 2010-06-02 17:53:49",
    "created_at": "2010-06-02T17:53:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100878",
    "user": "https://github.com/hughrthomas"
}
```

<a id='comment:9'></a>Attachment [trac_9112_tableau_py.patch](tarball://root/attachments/some-uuid/ticket9112/trac_9112_tableau_py.patch) by @hughrthomas created at 2010-06-02 17:53:49
...
```json
{
    "body": "<a id='comment:10'></a>Hi, I'm interested in helping with this; either in terms of a review or helping with the code.  What is the status right now?  There are patches posted, but they are not marked as needing review.  Is more work being done?",
    "created_at": "2010-06-15T15:06:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100879",
    "user": "https://github.com/jbandlow"
}
```

<a id='comment:10'></a>Hi, I'm interested in helping with this; either in terms of a review or helping with the code.  What is the status right now?  There are patches posted, but they are not marked as needing review.  Is more work being done?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100881",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100882",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Replying to [QuantumKing](#comment%3A14):\n\n> I've allowed for the user to give `PlusInfinity` as well as anything that has type `PlusInfinity`\n> as an infinite max_entry.\n\n\nJust curious, do you know of anything that has type `PlusInfinity` other than `PlusInfinity`?  This check looks redundant to me...",
    "created_at": "2010-06-18T16:08:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100885",
    "user": "https://github.com/jbandlow"
}
```

<a id='comment:15'></a>Replying to [QuantumKing](#comment%3A14):
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [QuantumKing](#comment%3A16):\n\nI think you want `oo is PlusInfinity()` (note the parentheses).  Does that behave like you expect?",
    "created_at": "2010-06-18T21:43:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100887",
    "user": "https://github.com/jbandlow"
}
```

<a id='comment:17'></a>Replying to [QuantumKing](#comment%3A16):
...
```json
{
    "body": "<a id='comment:19'></a>Replying to [jbandlow](#comment%3A17):\n\nNevermind. That works just fine. If the user were to call that they would get an error saying max_entry must be an integer. I'll upload a replacement.",
    "created_at": "2010-06-19T22:35:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100889",
    "user": "https://trac.sagemath.org/admin/accounts/users/QuantumKing"
}
```

<a id='comment:19'></a>Replying to [jbandlow](#comment%3A17):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100890",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Attachment [trac_9112_folded.patch](tarball://root/attachments/some-uuid/ticket9112/trac_9112_folded.patch) by @jbandlow created at 2010-06-28 13:52:53\n\nThanks Eric, positive review!  Nice work.  I've uploaded a patch which folds all the other changes together, to make things easier on the release manager. It contains nothing new.",
    "created_at": "2010-06-28T13:52:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100891",
    "user": "https://github.com/jbandlow"
}
```

<a id='comment:20'></a>Attachment [trac_9112_folded.patch](tarball://root/attachments/some-uuid/ticket9112/trac_9112_folded.patch) by @jbandlow created at 2010-06-28 13:52:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100892",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100893",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>The patch `trac_9112_folded_untabified.patch` uses tabs for indentation, which is against sage coding conventions. I have uploaded a version with spaces instead of tabs.",
    "created_at": "2010-06-30T17:20:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100894",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:21'></a>The patch `trac_9112_folded_untabified.patch` uses tabs for indentation, which is against sage coding conventions. I have uploaded a version with spaces instead of tabs.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100895",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100896",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9112#issuecomment-100897",
    "user": "https://github.com/qed777"
}
```
