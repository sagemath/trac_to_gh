...
```json
{
    "body": "Changed assignee from **@sagetrac-sage-combinat** to **@sagetrac-QuantumKing**",
...
Changed assignee from **@sagetrac-sage-combinat** to **@sagetrac-QuantumKing**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9112#event-105854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9112#event-105855"
}
```
