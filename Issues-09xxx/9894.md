...
```json
{
    "body": "**Changing work issues** from \"tests should work independent of the data the user has on his/her system\" to \"bug in find_relations on some systems; tests should work independent of the data the user has on his/her system\".",
...
**Changing work issues** from "tests should work independent of the data the user has on his/her system" to "bug in find_relations on some systems; tests should work independent of the data the user has on his/her system".
...
```json
{
    "body": "**Changing work issues** from \"bug in find_relations on some systems; tests should work independent of the data the user has on his/her system\" to \"Is the code independent of the computer's newline character?\".",
    "created_at": "2010-09-12T20:43:11Z",
    "issue": "https://github.com/sagemath/sage/issues/9894",
    "type": "issue_comment",
...
**Changing work issues** from "bug in find_relations on some systems; tests should work independent of the data the user has on his/her system" to "Is the code independent of the computer's newline character?".
...
```json
{
    "body": "**Changing work issues** from \"Is the code independent of the computer's newline character?\" to \"Fix problems on t2. Is the code independent of the computer's newline character?\".",
    "created_at": "2010-09-13T07:27:58Z",
    "issue": "https://github.com/sagemath/sage/issues/9894",
    "type": "issue_comment",
...
**Changing work issues** from "Is the code independent of the computer's newline character?" to "Fix problems on t2. Is the code independent of the computer's newline character?".
...
```json
{
    "body": "**Changing work issues** from \"Fix problems on t2. Is the code independent of the computer's newline character?\" to \"Is the code independent of the computer's newline character?\".",
...
**Changing work issues** from "Fix problems on t2. Is the code independent of the computer's newline character?" to "Is the code independent of the computer's newline character?".
...
```json
{
    "body": "**Changing work issues** from \"Is the code independent of the computer's newline character?\" to \"\".",
...
**Changing work issues** from "Is the code independent of the computer's newline character?" to "".
...
archive/attachments_013302.json:
```json
{
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "osx.log",
    "asset_url": "tarball://root/attachments/ticket9894/osx.log",
    "created_at": "2011-07-20T00:33:29Z",
    "issue": "https://github.com/sagemath/sage/issues/9894",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9894/osx.log",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Changing work issues** from \"fix doc tests\" to \"fix documentation\".",
    "created_at": "2011-07-21T10:53:02Z",
    "issue": "https://github.com/sagemath/sage/issues/9894",
    "type": "issue_comment",
...
**Changing work issues** from "fix doc tests" to "fix documentation".
...
```json
{
    "body": "**Changing work issues** from \"fix documentation\" to \"\".",
    "created_at": "2011-07-21T12:35:11Z",
    "issue": "https://github.com/sagemath/sage/issues/9894",
    "type": "issue_comment",
...
**Changing work issues** from "fix documentation" to "".
...
```json
{
    "body": "**Changing work issues** from \"make it work with the latest Sage version; perhaps 2.1.2\" to \"\".",
    "created_at": "2012-02-09T20:40:11Z",
    "issue": "https://github.com/sagemath/sage/issues/9894",
    "type": "issue_comment",
...
**Changing work issues** from "make it work with the latest Sage version; perhaps 2.1.2" to "".
