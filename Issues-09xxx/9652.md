...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109890"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109891"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109892"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109893"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109894"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109895"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109896"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109898"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86435",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "Changed assignee from **@aghitza** to **@koffie**",
    "created_at": "2010-09-11T08:53:24Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86436",
    "user": "https://github.com/koffie"
}
```

Changed assignee from **@aghitza** to **@koffie**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86437",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86438",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109905"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86439",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86440",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86441",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86442",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109907"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109908"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86443",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109910"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86444",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109912"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86445",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86446",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86447",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9652#event-109915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9652#issuecomment-86448",
    "user": "https://github.com/qed777"
}
```
