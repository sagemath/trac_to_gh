...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111865",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The error message could of course be a bit more friendly, for example:\n\n  *\"**Please** correct this by moving Sage (or renaming some directories) first.\"*",
    "created_at": "2010-07-30T05:53:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111871",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>The error message could of course be a bit more friendly, for example:
...
```json
{
    "body": "<a id='comment:8'></a>An alternative, perhaps simpler, but \"less efficient\" test for spaces would be:\n\n```sh\n    [ `echo \"X${SAGE_ROOT}X\" | wc -w` -ne 1 ]\n```\n(This one catches leading and trailing blanks, too, like the shell function in the patch when called properly. But we usually have leading and trailing slashs/path separators in `$SAGE_ROOT` anyway.)",
    "created_at": "2010-07-30T07:50:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111872",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>An alternative, perhaps simpler, but "less efficient" test for spaces would be:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111874",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111876",
...
```json
{
    "body": "Changing work_issues from \"\" to \"Update README.txt, put info on download page(s)\"",
    "created_at": "2010-07-30T16:05:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111877",
    "user": "https://github.com/nexttime"
}
```

Changing work_issues from "" to "Update README.txt, put info on download page(s)"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111878",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111879",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Oh, perhaps the Makefile or `spkg/install` should get some early check, too.",
    "created_at": "2010-07-30T16:28:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111880",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:13'></a>Oh, perhaps the Makefile or `spkg/install` should get some early check, too.
...
```json
{
    "body": "<a id='comment:14'></a>Well, it's possible to add anything somewhere on the webpage, but I think it doesn't look good, or is professional, to list bugs on a download page (especially because it is never read just like the readme).\n\nI don't know the exact problem, but I'm for adding a check at the \"sage\" script itself -- ahh, i've just seen that above -- and to the early scripts when starting to build sage.",
    "created_at": "2010-07-30T16:42:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111881",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:14'></a>Well, it's possible to add anything somewhere on the webpage, but I think it doesn't look good, or is professional, to list bugs on a download page (especially because it is never read just like the readme).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111884",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111885",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Thanks, Leif.  I'd like to focus, for now, on releasing 4.5.3 and then on the PARI upgrade for 4.6.alpha0.  I'll try to work on this ticket after 4.5.3 is out.",
    "created_at": "2010-08-20T08:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111886",
    "user": "https://github.com/qed777"
}
```

<a id='comment:21'></a>Thanks, Leif.  I'd like to focus, for now, on releasing 4.5.3 and then on the PARI upgrade for 4.6.alpha0.  I'll try to work on this ticket after 4.5.3 is out.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111887",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111888",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Btw: If you want to have fun, try *compiling* Sage with `-O2` contained in `$SAGE_ROOT`.\n\n(It's `libgcrypt` that fails IIRC.)",
    "created_at": "2010-08-20T11:24:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111889",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:22'></a>Btw: If you want to have fun, try *compiling* Sage with `-O2` contained in `$SAGE_ROOT`.
...
```json
{
    "body": "<a id='comment:23'></a>This looks good to me; positive review for \"trac_9644-first_aid_for_spaces_in_SAGE_ROOT-scripts_repo.patch\". Trying to get Sage to work with spaces in the path can go on another ticket.  Meanwhile, I'm attaching a patch for the installation guide.",
    "created_at": "2010-09-21T21:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111890",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>This looks good to me; positive review for "trac_9644-first_aid_for_spaces_in_SAGE_ROOT-scripts_repo.patch". Trying to get Sage to work with spaces in the path can go on another ticket.  Meanwhile, I'm attaching a patch for the installation guide.
...
```json
{
    "body": "Changing reviewer from \"\" to \"John Palmieri, David Kirkby\"",
    "created_at": "2010-09-21T22:32:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111891",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing reviewer from "" to "John Palmieri, David Kirkby"
...
```json
{
    "body": "<a id='comment:24'></a>John's happy with Leif's patch. I'm happy with John's changes to the installation guide. So positive review.",
    "created_at": "2010-09-21T22:32:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111892",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:24'></a>John's happy with Leif's patch. I'm happy with John's changes to the installation guide. So positive review.
...
```json
{
    "body": "Changing author from \"\" to \"John Palmieri, Leif Leonhardy\"",
    "created_at": "2010-09-21T22:32:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111893",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing author from "" to "John Palmieri, Leif Leonhardy"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111894",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Thanks, everyone, for working on this.",
    "created_at": "2010-09-21T22:33:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111895",
    "user": "https://github.com/qed777"
}
```

<a id='comment:25'></a>Thanks, everyone, for working on this.
...
```json
{
    "body": "<a id='comment:27'></a>How about this?",
    "created_at": "2010-09-21T23:31:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111897",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:27'></a>How about this?
...
```json
{
    "body": "<a id='comment:28'></a>Thanks, very good.",
    "created_at": "2010-09-21T23:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111898",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:28'></a>Thanks, very good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111900",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111901",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111904",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Could someone please update the commit strings of the \"installation\" and \"ref\" patches to be a bit more descriptive and restore the positive review?",
    "created_at": "2010-09-29T07:01:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111906",
    "user": "https://github.com/qed777"
}
```

<a id='comment:34'></a>Could someone please update the commit strings of the "installation" and "ref" patches to be a bit more descriptive and restore the positive review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111907",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111908",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>Here are new commit strings.  Can we restore the positive review now?",
    "created_at": "2010-09-29T16:48:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111909",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:36'></a>Here are new commit strings.  Can we restore the positive review now?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111910",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111911",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111912",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111913",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>I've updated some Wiki pages a while ago.\n\nHarald said we shouldn't \"announce bugs\" on the download pages; I think a simple comment on where to currently not install Sage shouldn't be interpreted as such.",
    "created_at": "2010-09-29T21:49:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111914",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:39'></a>I've updated some Wiki pages a while ago.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111915",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9644",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9644#issuecomment-111916",
    "user": "https://github.com/qed777"
}
```
