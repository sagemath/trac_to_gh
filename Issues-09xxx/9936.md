...
```json
{
    "body": "The attachment [attachment:trac_9936-symbolic-functions.patch] adds the module `sage.symbolic.function_factory` to the reference manual, under the calculus chapter.",
...
```json
{
    "body": "Indeed, `calculus.rst` seems like the right place to put this.  The patch applies cleanly, and the documentation compiles without warnings; the html output looks good too, so positive review",
    "created_at": "2010-09-21T16:58:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9936",
    "type": "issue_comment",
