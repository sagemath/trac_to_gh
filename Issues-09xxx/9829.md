...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-127654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-127655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-127656"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-127657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9829",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9829#issuecomment-87823",
    "user": "https://github.com/qed777"
}
```
