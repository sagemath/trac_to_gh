...
```json
{
    "body": "<a id='comment:1'></a>See [/sage/misc/preparser.py`@`13719#L1209](../tree/master//sage/misc/preparser.py`@`13719#L1209) for the input transformation.",
    "created_at": "2010-08-28T01:23:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9829",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9829#issuecomment-101149",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>See [/sage/misc/preparser.py`@`13719#L1209](../tree/master//sage/misc/preparser.py`@`13719#L1209) for the input transformation.
