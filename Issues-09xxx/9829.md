...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-116343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-116344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9829#event-116345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9829",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9829#issuecomment-89738",
    "user": "https://github.com/qed777"
}
```
