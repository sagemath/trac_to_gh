...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9899#issuecomment-91213",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9899#issuecomment-91214",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9899#event-117290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9899#event-117291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9899",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9899#event-117292"
}
```
