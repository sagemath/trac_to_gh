...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9206#issuecomment-78807",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9206/trac_9206.patch",
    "created_at": "2010-07-07T20:12:53Z",
    "issue": "https://github.com/sagemath/sage/issues/9206",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9206/trac_9206.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_9206.patch](https://github.com/sagemath/sage/files/ticket9206/trac_9206.patch) by @williamstein created at 2010-07-07 20:12:53\n\nI didn't write the attached patch, but I polished it up, so it would be good if somebody else could sign off on this.  I'm OK with it, as is.",
    "created_at": "2010-07-07T20:12:53Z",
    "issue": "https://github.com/sagemath/sage/issues/9206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9206#issuecomment-78808",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9206#issuecomment-78809",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9206#issuecomment-78810",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9206#issuecomment-78811",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9206#issuecomment-78812",
    "user": "https://github.com/qed777"
}
```
