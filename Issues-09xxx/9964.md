...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9964#issuecomment-119678",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9964#issuecomment-119679",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9964#issuecomment-119681",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I was a little too fast.  If an object has a `_pari_` method and a `_pari_init_` method, the `_pari_` method takes precedence, right?  So it doesn't hurt to have both (where `_pari_init` is then only used for Gp).",
    "created_at": "2010-09-24T16:41:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9964#issuecomment-119682",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>I was a little too fast.  If an object has a `_pari_` method and a `_pari_init_` method, the `_pari_` method takes precedence, right?  So it doesn't hurt to have both (where `_pari_init` is then only used for Gp).
...
```json
{
    "body": "<a id='comment:6'></a>Also note that currently no single object has a `_gp_` or `_gp_init_` method.",
    "created_at": "2010-09-24T16:45:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9964#issuecomment-119683",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Also note that currently no single object has a `_gp_` or `_gp_init_` method.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9964#issuecomment-119684",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25138"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25139"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25140"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25141"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25142"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25143"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9964#event-25144"
}
```
