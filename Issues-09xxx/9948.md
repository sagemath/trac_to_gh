...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118941",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25095"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#12203\"",
    "created_at": "2011-12-20T16:07:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118942",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#12203"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118943",
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25096"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25097"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25098"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25099"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25100"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25101"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>This seems to have been fixed in the meantime.  In Sage 6.2.beta6:\n\n```\nsage: gp(pAdicField(5)(0))\n0\nsage: pari(pAdicField(5)(0))\n0\n```\nI propose to close this as invalid/worksforme/whatever...",
    "created_at": "2014-04-10T23:30:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118944",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:6'></a>This seems to have been fixed in the meantime.  In Sage 6.2.beta6:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118945",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118946",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Yes, seems fixed.",
    "created_at": "2014-04-11T08:09:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118947",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Yes, seems fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118948",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118949",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9948#event-25102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9948#issuecomment-118950",
