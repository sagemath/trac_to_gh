...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9272#issuecomment-79964",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9272#issuecomment-79965",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9272#issuecomment-79966",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9272#issuecomment-79967",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9272/trac_9272-only-optional-case-insensitive.patch",
    "created_at": "2010-06-20T22:55:27Z",
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9272/trac_9272-only-optional-case-insensitive.patch",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_9272-only-optional-case-insensitive.patch](https://github.com/sagemath/sage/files/ticket9272/trac_9272-only-optional-case-insensitive.patch) by @rlmill created at 2010-06-20 22:55:27\n\nLooks good to me!",
    "created_at": "2010-06-20T22:55:27Z",
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9272#issuecomment-79968",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9272#issuecomment-79969",
    "user": "https://github.com/rlmill"
}
```
