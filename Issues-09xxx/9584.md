...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108992"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108995"
}
```
...
```json
{
    "body": "Changed keywords from **** to **generic_graph, generic graph, time-out, time out**",
...
Changed keywords from **** to **generic_graph, generic graph, time-out, time out**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108996"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-108999"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-109000"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9584",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9584#event-109001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9584#issuecomment-85366",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9584#issuecomment-85367",
    "user": "https://github.com/qed777"
}
```
