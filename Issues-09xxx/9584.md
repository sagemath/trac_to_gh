...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9584/TICKET_UNRELATED-ncadoctest-flush_output_in_verbose_mode-scripts_repo.patch",
...
```json
{
    "body": "As the name says... Apply to scripts repo.",
    "created_at": "2010-07-24T20:28:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9584",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9584/trac_9584-generic_graph.patch",
