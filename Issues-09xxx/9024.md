...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76170",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [tachyon-64-bit-Solaris-fix.patch](https://github.com/sagemath/sage/files/ticket9024/tachyon-64-bit-Solaris-fix.patch) by drkirkby created at 2010-05-23 22:27:23\n\nMercurial patch to allow to build 64-bit on Solaris (both SPARC and x64)",
    "created_at": "2010-05-23T22:27:23Z",
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76171",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [tachyon-64-bit-Solaris-fix.patch](https://github.com/sagemath/sage/files/ticket9024/tachyon-64-bit-Solaris-fix.patch) by drkirkby created at 2010-05-23 22:27:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76172",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76173",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76174",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76175",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76176",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9024#issuecomment-76177",
    "user": "https://github.com/mwhansen"
}
```
