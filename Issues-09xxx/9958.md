...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114269"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114275"
}
```
...
```json
{
    "body": "<a id='comment:86'>Comment 86:</a>\nI am wrong! Not maxima or pari, there is a patch for it in [attachment: trac_9958-fixing_numericalnoise-part1.patch.gz](https://github.com/sagemath/sage/files/ticket9958/trac_9958-fixing_numericalnoise-part1.patch.gz). So it looks like that bit may not be applied properly.",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114276"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114277"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114278"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114281"
}
```
...
```json
{
    "body": "<a id='comment:1'>Comment 1:</a>\nActually, you should have a look at what I did for both of these in [and [attachment: trac_9958-suffix_trees-variations.patch.gz](https://github.com/sagemath/sage/files/ticket9958/trac_9958-suffix_trees-variations.patch.gz)(https://github.com/sagemath/sage/files/ticket9958/793cb41808b913234a5510aeb2ef9683.gz). If you could give your opinion on the patches or if you want to submit patches of your own it would be appreciated.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114287"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,7 +19,7 @@\n \n Fixes #1159\n \n-**New spkg**: [http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg](http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg)\n+**New spkg**: [http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg](http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg) (diff for reviewing: [attachment: python-2.7.2.p0.diff.gz](https://github.com/sagemath/sage/files/ticket9958/python-2.7.2.p0.diff.gz))\n \n **New matplotlib spkg** (required): [http://sage.math.washington.edu/home/jason/matplotlib-1.0.1.p1.spkg](http://sage.math.washington.edu/home/jason/matplotlib-1.0.1.p1.spkg).  (but see also #11915 to upgrade matplotlib).\n \n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,7 +19,7 @@\n \n Fixes #1159\n \n-**New spkg**: [http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg](http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg) (diff for reviewing: [attachment: python-2.7.2.p0.diff.gz](https://github.com/sagemath/sage/files/ticket9958/python-2.7.2.p0.diff.gz))\n+**New spkg**: [http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg](http://spkg-upload.googlecode.com/files/python-2.7.2.p0.spkg) (diff for reviewing (without deleted files): [attachment: python-2.7.2.p0.diff.gz](https://github.com/sagemath/sage/files/ticket9958/python-2.7.2.p0.diff.gz))\n \n **New matplotlib spkg** (required): [http://sage.math.washington.edu/home/jason/matplotlib-1.0.1.p1.spkg](http://sage.math.washington.edu/home/jason/matplotlib-1.0.1.p1.spkg).  (but see also #11915 to upgrade matplotlib).\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114291"
}
```
...
```json
{
    "body": "<a id='comment:6'>Comment 6:</a>\n[attachment: 9958_combinat.patch.gz](https://github.com/sagemath/sage/files/ticket9958/9958_combinat.patch.gz) is the only non-trivial change I guess, but has been discussed well in the comments on this ticket.  Potentially, the `trie_type_dict()` test might yield other results, but we can still change the test in that case.  Anyway, that method is nowhere called in the Sage library.",
...
```json
{
    "body": "<a id='comment:277'>Comment 277:</a>\nReplying to [@jdemeyer](#comment%3A276):\n> [attachment: 9958_combinat.patch.gz](https://github.com/sagemath/sage/files/ticket9958/9958_combinat.patch.gz) is the only non-trivial change I guess, but has been discussed well in the comments on this ticket.  Potentially, the `trie_type_dict()` test might yield other results, but we can still change the test in that case.  Anyway, that method is nowhere called in the Sage library.\n\nI didn't notice you had listed this particular patch. Why not use [attachment: trac_9958-suffix_trees-variations-sl.patch.gz](https://github.com/sagemath/sage/files/ticket9958/trac_9958-suffix_trees-variations-sl.patch.gz) from S\u00e9bastien Labb\u00e9 instead? It is more foolproof.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9958",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9958#event-114293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9958#issuecomment-92484",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9958#issuecomment-92485",
    "user": "https://github.com/jdemeyer"
}
```
