...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9984#issuecomment-94712",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76966"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76967"
}
```
...
```json
{
    ...
    "asset_name": "ecm-6.2.1.p2.log",
    "asset_url": "tarball://root/attachments/some-uuid/ticket9984/ecm-6.2.1.p2.log",
    "created_at": "2013-08-13T15:35:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9984",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9984#issuecomment-94713",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76968"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76969"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76970"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76971"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76972"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76973"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76974"
}
```
...
```json
{
    ...
    "label": "wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9984#issuecomment-94714",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9984#issuecomment-94715",
...
```json
{
    ...
    "label": "wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76977"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76978"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9984",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9984#event-76980"
}
```
