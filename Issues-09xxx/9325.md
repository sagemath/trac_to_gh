...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-108758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-80652",
    "user": "https://github.com/sagetrac-dpoetzsch"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-108759"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-80653",
    "user": "https://github.com/sagetrac-dpoetzsch"
}
```
