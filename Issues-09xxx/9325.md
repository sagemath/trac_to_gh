...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119841"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119842"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-dpoetzsch",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119843"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-dpoetzsch",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-119845"
}
```
