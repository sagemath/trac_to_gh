...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109974",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109975",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>To be better save than sorry, the `spkg-install` script of rpy should call `python setup.py --prefix=$SAGE_HOME` etc.",
    "created_at": "2010-07-19T21:34:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109976",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:3'></a>To be better save than sorry, the `spkg-install` script of rpy should call `python setup.py --prefix=$SAGE_HOME` etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109977",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109978",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109979",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I have never seen this error recently, so I guess it is fixed.",
    "created_at": "2013-12-19T12:01:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109980",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I have never seen this error recently, so I guess it is fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109981",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9551#issuecomment-109982",
