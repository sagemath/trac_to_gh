...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105736"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105737"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105739"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9357#issuecomment-81567",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105742"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9357#issuecomment-81568",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9357",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9357#event-105744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9357#issuecomment-81569",
    "user": "https://github.com/qed777"
}
```
