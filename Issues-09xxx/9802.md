...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115891"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115892"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115893"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115894"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9802",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9802#issuecomment-88988",
    "user": "https://github.com/sagetrac-bwonderly"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115895"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9802",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9802#issuecomment-88989",
    "user": "https://github.com/sagetrac-bwonderly"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115896"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115898"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9802",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9802#event-115899"
}
```
