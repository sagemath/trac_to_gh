...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76166",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76167",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "**Attachment:** [trac_9021-build_64-bit_gdmodule_on_solaris.patch](https://github.com/sagemath/sage/files/ticket9021/trac_9021-build_64-bit_gdmodule_on_solaris.patch)\n\nModifies `patches/Setup.py` to honor `$SAGE64`. Testing is up to you!",
    "created_at": "2010-05-24T17:53:23Z",
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76168",
    "user": "https://github.com/nexttime"
}
```

**Attachment:** [trac_9021-build_64-bit_gdmodule_on_solaris.patch](https://github.com/sagemath/sage/files/ticket9021/trac_9021-build_64-bit_gdmodule_on_solaris.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76169",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76170",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76171",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76172",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76173",
