...
```json
{
    "body": "<a id='comment:2'></a>Oh, the \"usual\" method of setting/modifying `CFLAGS` et al. in `spkg-install` *should* work, too.",
    "created_at": "2010-05-23T23:14:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99176",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>Oh, the "usual" method of setting/modifying `CFLAGS` et al. in `spkg-install` *should* work, too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99177",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I've uploaded a Mercurial patch that modifies `patches/Setup.py` as suggested above.\n\nNote that `patches/Setup.py.patch` isn't used by `spkg-install`, so I haven't updated that.\n\nThe patch has to be tested before bumping to p8 (and updating `SPKG.txt`, which already lacks some modification history).",
    "created_at": "2010-05-24T18:06:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99178",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>I've uploaded a Mercurial patch that modifies `patches/Setup.py` as suggested above.
...
```json
{
    "body": "<a id='comment:4'></a>For other OpenSolaris issues, see #9026",
    "created_at": "2010-05-24T18:25:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99179",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>For other OpenSolaris issues, see #9026
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99180",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99182",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9021#issuecomment-99183",
    "user": "https://github.com/jdemeyer"
}
```
