...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76146",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76147",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9021/trac_9021-build_64-bit_gdmodule_on_solaris.patch",
    "created_at": "2010-05-24T17:53:23Z",
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9021/trac_9021-build_64-bit_gdmodule_on_solaris.patch",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Attachment [trac_9021-build_64-bit_gdmodule_on_solaris.patch](https://github.com/sagemath/sage/files/ticket9021/trac_9021-build_64-bit_gdmodule_on_solaris.patch) by @nexttime created at 2010-05-24 17:53:23\n\nModifies `patches/Setup.py` to honor `$SAGE64`. Testing is up to you!",
    "created_at": "2010-05-24T17:53:23Z",
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76148",
    "user": "https://github.com/nexttime"
}
```

Attachment [trac_9021-build_64-bit_gdmodule_on_solaris.patch](https://github.com/sagemath/sage/files/ticket9021/trac_9021-build_64-bit_gdmodule_on_solaris.patch) by @nexttime created at 2010-05-24 17:53:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76149",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76150",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76151",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76152",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9021#event-65288"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9021#event-65289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9021#issuecomment-76153",
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9021#event-65290"
}
```
