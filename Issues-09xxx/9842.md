...
```json
{
    "body": "<a id='comment:1'></a>I just ran this code on sage 4.6 on both a linux machine (sage.math) and my machine, which is MAC OS 10.6 64 bit. And it seems to be working fine.",
    "created_at": "2011-01-08T01:12:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116335",
    "user": "https://trac.sagemath.org/admin/accounts/users/gagansekhon"
}
```

<a id='comment:1'></a>I just ran this code on sage 4.6 on both a linux machine (sage.math) and my machine, which is MAC OS 10.6 64 bit. And it seems to be working fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116336",
    "user": "https://trac.sagemath.org/admin/accounts/users/gagansekhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9842#event-24776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116337",
    "user": "https://trac.sagemath.org/admin/accounts/users/gagansekhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9842#event-24777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116338",
    "user": "https://trac.sagemath.org/admin/accounts/users/gagansekhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9842#event-24778"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116339",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116340",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116341",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Fixed in sage-4.6, probably because of the Singular update.",
    "created_at": "2011-01-08T05:11:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116342",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>Fixed in sage-4.6, probably because of the Singular update.
...
```json
{
    "body": "<a id='comment:5'></a>This would have possibly involved PolyBori (not singular), or something involving coercion that doesn't involve external libraries (?).",
    "created_at": "2011-01-08T19:08:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9842#issuecomment-116343",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>This would have possibly involved PolyBori (not singular), or something involving coercion that doesn't involve external libraries (?).
