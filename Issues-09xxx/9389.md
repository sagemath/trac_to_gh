...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106608",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106609",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Can you see if it still crashes after applying the patch at #9266?",
    "created_at": "2010-06-30T11:28:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106610",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>Can you see if it still crashes after applying the patch at #9266?
...
```json
{
    "body": "<a id='comment:4'></a>> Can you see if it still crashes after applying the patch at #9266?\n\n\nIt still crashes on my machine after applying the patch.",
    "created_at": "2010-06-30T15:09:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106611",
    "user": "https://github.com/arminstraub"
}
```

<a id='comment:4'></a>> Can you see if it still crashes after applying the patch at #9266?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106612",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I checked and this actually doesn't have anything to do with elliptic curves; it's exposing a bug in residue fields of number field ideals. Some playing around with the Sage debugger reveals that the second example fails when trying to do the following:\n\n```\nsage: K.<a> = NumberField(x^4-32*x^2+324)                                                \nsage: I = K.ideal(3, 1/24*a^3 - 1/4*a^2 - 7/12*a + 3)\nsage: R = PolynomialRing(I.residue_field(), 'x')\nsage: R([23/36*a^3 + a^2 + 1/18*a + 1, 0, 7/18*a^3 + 3/4*a^2 + 1/18*a + 1/2, 1]) # boom!\n/storage/masiao/sage-4.5.alpha1/local/bin/sage-sage: line 206: 14086 Aborted                 sage-ipython \"$@\" -i\n```",
    "created_at": "2010-07-02T22:24:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106614",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:7'></a>I checked and this actually doesn't have anything to do with elliptic curves; it's exposing a bug in residue fields of number field ideals. Some playing around with the Sage debugger reveals that the second example fails when trying to do the following:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106615",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106616",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Is someone working on this? Here is a trivial example in 4.5.3:\n\n```\nsage: K.<a> = QuadraticField(5)\nsage: E = EllipticCurve(K,[1,2*a])\nsage: E.local_data(K.ideal(2))\n```\n\nBoom. Similarly:\n\n```\nsage: K.<a> = QuadraticField(5)\nsage: R = PolynomialRing(K.ring_of_integers().residue_field(K.ideal(2)), 'x')\nsage: R([1/2*a])\n```",
    "created_at": "2010-10-27T08:26:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106617",
    "user": "https://trac.sagemath.org/admin/accounts/users/jgaski"
}
```

<a id='comment:8'></a>Is someone working on this? Here is a trivial example in 4.5.3:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106619",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Good work!  Let's hope ylchapuy provides a fix;  otherwise this can be used as a workaround.",
    "created_at": "2010-10-28T08:38:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106622",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:12'></a>Good work!  Let's hope ylchapuy provides a fix;  otherwise this can be used as a workaround.
...
```json
{
    "body": "<a id='comment:14'></a>In fact those tests should probably go in `polynomial_ring_constructor.py`, in the _single_variate function. The init function for PolynomialRing_Field would then be the generic case.",
    "created_at": "2010-10-28T13:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106624",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:14'></a>In fact those tests should probably go in `polynomial_ring_constructor.py`, in the _single_variate function. The init function for PolynomialRing_Field would then be the generic case.
...
```json
{
    "body": "<a id='comment:16'></a>Works for me with sage-4.7.2.alpha3.",
    "created_at": "2011-10-09T11:11:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106626",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>Works for me with sage-4.7.2.alpha3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106627",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9389#issuecomment-106628",
    "user": "https://github.com/jdemeyer"
}
```
