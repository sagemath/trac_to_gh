...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108487",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108488",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108489",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>leif's updated spkg: [polybori-0.6.4.p2.spkg](http://sage.math.washington.edu/home/schilly/sage/spkg/polybori-0.6.4.p2.spkg)",
    "created_at": "2010-07-11T10:04:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108490",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:2'></a>leif's updated spkg: [polybori-0.6.4.p2.spkg](http://sage.math.washington.edu/home/schilly/sage/spkg/polybori-0.6.4.p2.spkg)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108491",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I replaced thePolyBoRi SPKG in Sage 4.5.alpha4 with the one linked above and built Sage from scratch without problems. All doctests also pass on sage.math. I checked the install log andPolyBoRi reports M4RI found (and wouldn't build without Boost anyway).",
    "created_at": "2010-07-11T18:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108492",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>I replaced thePolyBoRi SPKG in Sage 4.5.alpha4 with the one linked above and built Sage from scratch without problems. All doctests also pass on sage.math. I checked the install log andPolyBoRi reports M4RI found (and wouldn't build without Boost anyway).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108493",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It seems that we can install PolyBoRi in parallel with, e.g.,\n\n```sh\n$ env MAKEOPTS=\"-j20\" ./sage -f http://sage.math.washington.edu/home/schilly/sage/spkg/polybori-0.6.4.p2.spkg\n```\nBut I haven't tested this extensively.",
    "created_at": "2010-08-07T11:04:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108494",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>It seems that we can install PolyBoRi in parallel with, e.g.,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108495",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108496",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108497",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108498",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108499",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Karl-Dieter (kcrisman) has just reported on sage-release updating from 4.5.2 to 4.5.3.alpha0 failed on MacOS X 10.6 because this new PolyBoRi package failed to build:\n\n```\n...\nChecking for C library m4ri... no\nChecking for C header file gd.h... yes\nChecking for C library gd... no\nSymlinking to M4RI/m4ri ...\nOSError: [Errno 2] No such file or directory:\n  File \"/Users/.../sage-4.5.2/spkg/build/polybori-0.6.4.p2/src/\npolybori-0.6.4/SConstruct\", line 421:\n    os.symlink('.', m4ri_inc)\nError building PolyBoRi.\n \nreal\t0m1.425s\nuser\t0m0.860s\nsys\t0m0.473s\nsage: An error occurred while installing polybori-0.6.4.p2\n...\n```\n\nI'll open a new ticket for that shortly (unless someone else is faster).",
    "created_at": "2010-08-10T22:01:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108500",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>Karl-Dieter (kcrisman) has just reported on sage-release updating from 4.5.2 to 4.5.3.alpha0 failed on MacOS X 10.6 because this new PolyBoRi package failed to build:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9472#issuecomment-108501",
    "user": "https://github.com/qed777"
}
```
