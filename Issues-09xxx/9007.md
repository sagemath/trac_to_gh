...
```json
{
    "body": "<a id='comment:1'></a>This appears to be a bug in gcc 4.3.4. At the suggestion of the iconv developers, I used another version of gcc. I used 4.4.4 which seems to build this ok. \n\nThis ticket can be closed.",
    "created_at": "2010-05-22T08:05:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9007#issuecomment-98979",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>This appears to be a bug in gcc 4.3.4. At the suggestion of the iconv developers, I used another version of gcc. I used 4.4.4 which seems to build this ok. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9007#issuecomment-98980",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9007#issuecomment-98981",
