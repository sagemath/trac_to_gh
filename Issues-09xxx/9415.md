...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9415#event-110091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9415#event-110092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9415#issuecomment-82418",
    "user": "https://github.com/sagetrac-rkirov"
}
```
