...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98882",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This should be tested both on a PPC Mac and some Intel or AMD architecture.  Works for me :)",
    "created_at": "2010-05-26T02:13:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98883",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>This should be tested both on a PPC Mac and some Intel or AMD architecture.  Works for me :)
...
```json
{
    "body": "<a id='comment:2'></a>How is the \"expected\" value arrived at? It is just what someone happened to get on their computer, or was it evaluated to high precision in a different way?",
    "created_at": "2010-06-23T00:55:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98884",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>How is the "expected" value arrived at? It is just what someone happened to get on their computer, or was it evaluated to high precision in a different way?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98886",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>England vs Slovenia kicks off in 10 minutes. After the game I'll review this. It looks simple enough, and you have convinced me there is no point worrying unduly about the exact number. \n\nDave",
    "created_at": "2010-06-23T13:50:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98887",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>England vs Slovenia kicks off in 10 minutes. After the game I'll review this. It looks simple enough, and you have convinced me there is no point worrying unduly about the exact number. 
...
```json
{
    "body": "<a id='comment:7'></a>I'm happy to give this a positive. We know what result it was producing, and your fix should allow that to pass. I can't possibly see how this can make the situation any worst, even in the **very** unlikely even it does not cure the problem. \n\nI've tested on SPARC (Solaris 10) and x86 (Linux) processors. \n\n## Linux (sage.math) with Intel Xeon processor\n\n```\nsage -t  \"devel/sage/sage/plot/plot3d/parametric_surface.pyx\"\n\t [11.3 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 11.3 seconds\nkirkby@sage:~/sage-4.4.3$ uname -a\nLinux sage.math.washington.edu 2.6.24-26-server #1 SMP Tue Dec 1 18:26:43 UTC 2009 x86_64 GNU/Linux\n```\n\n## 'redstart' Solaris 10 with Sun UltraSPARC III+ processors\n\n```\ndrkirkby@redstart:~/sage-4.4.4.alpha1$ ./sage -t  \"devel/sage/sage/plot/plot3d/parametric_surface.pyx\"\nsage -t  \"devel/sage/sage/plot/plot3d/parametric_surface.pyx\"\n\t [33.6 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 33.6 seconds\n```",
    "created_at": "2010-06-23T17:17:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98889",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>I'm happy to give this a positive. We know what result it was producing, and your fix should allow that to pass. I can't possibly see how this can make the situation any worst, even in the **very** unlikely even it does not cure the problem. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98890",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98891",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98893",
...
```json
{
    "body": "<a id='comment:10'></a>This ticket seems the same as #9516...",
    "created_at": "2010-07-22T02:52:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98894",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:10'></a>This ticket seems the same as #9516...
...
```json
{
    "body": "<a id='comment:11'></a>Karl-Dieter (or release manager): can you fix the User field in your patch? It looks like you didn't set a username in your hgrc.",
    "created_at": "2010-07-22T02:55:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98895",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:11'></a>Karl-Dieter (or release manager): can you fix the User field in your patch? It looks like you didn't set a username in your hgrc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98897",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Sorry, I didn't think of that.  I created this patch on a PPC Mac, and it's one I don't ordinarily use for Sage developing and hence didn't have an hgrc file.  I'll try to fix that momentarily.  Otherwise all my patches have my usual email address on them.",
    "created_at": "2010-07-22T12:33:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98898",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>Sorry, I didn't think of that.  I created this patch on a PPC Mac, and it's one I don't ordinarily use for Sage developing and hence didn't have an hgrc file.  I'll try to fix that momentarily.  Otherwise all my patches have my usual email address on them.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98899",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Hopefully this will address the issue!",
    "created_at": "2010-07-22T12:36:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98900",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:15'></a>Hopefully this will address the issue!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98901",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98902",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9002#issuecomment-98903",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9002#event-22030"
}
```
