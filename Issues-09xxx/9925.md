...
<a id='comment:22'></a>Replying to [comment:20 mpatel]:
> Karl-Dieter Crisman reported this error on [sage-release](http://groups.google.com/group/sage-release/browse_thread/thread/6bb037c1f4a1ace9/baa93cd5c1dc489f#baa93cd5c1dc489f):
...
```json
{
    "body": "<a id='comment:28'></a>I've opened #10081 as a 4.6 blocker for the problem in [comment:20 comment 20].",
...
<a id='comment:28'></a>I've opened #10081 as a 4.6 blocker for the problem in [comment:20 comment 20].
