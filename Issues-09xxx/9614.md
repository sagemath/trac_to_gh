...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111381",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>My proposed changes are attached. I've changed 'sage -bdist' to create an empty file spkg/standard/.from_bdist. \"sage -sdist\" looks for that file, and exits if it finds it. It prints some instructions as it fails; I think the instructions are correct, but please check to make sure.\n\nWe could try to have -sdist download the necessary files and put them in, but that would require always having a downloadable source for many versions of Sage on the web, and wouldn't do any good to someone working without a net connection. Telling the user how to fix the problem seems more effective in this case.",
    "created_at": "2010-07-28T02:16:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111382",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:1'></a>My proposed changes are attached. I've changed 'sage -bdist' to create an empty file spkg/standard/.from_bdist. "sage -sdist" looks for that file, and exits if it finds it. It prints some instructions as it fails; I think the instructions are correct, but please check to make sure.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111383",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111384",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111385",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111386",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I've made that mistake before and I wished that sage-sdist would have complained. This fix looks good to me! Applies fine on Sage-4.6.2.alpha3.",
    "created_at": "2011-02-01T01:20:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111387",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>I've made that mistake before and I wished that sage-sdist would have complained. This fix looks good to me! Applies fine on Sage-4.6.2.alpha3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111388",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111389",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9614#issuecomment-111390",
    "user": "https://github.com/jdemeyer"
}
```
