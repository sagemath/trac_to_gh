...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113950"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113953"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113956"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113957"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113959"
}
```
...
```json
{
    "body": "<a id='comment:6'>Comment 6:</a>\nI'm okay with your changes, S\u00e9bastien.\n\nApply patches in this order:\n\n1. [attachment: trac9938.patch.gz](https://github.com/sagemath/sage/files/ticket9938/trac9938.patch.gz)\n2. [attachment: trac9938-review-sl.patch.gz](https://github.com/sagemath/sage/files/ticket9938/trac9938-review-sl.patch.gz)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113960"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113961"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9938#issuecomment-91760",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113962"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9938",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9938#event-113963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9938#issuecomment-91761",
    "user": "https://github.com/qed777"
}
```
