...
```json
{
    "body": "Attachment [trac_9846_parallel_help.patch](https://github.com/sagemath/sage/files/ticket9846/trac_9846_parallel_help.patch) by @a-andre created at 2011-01-07 10:07:24",
    "created_at": "2011-01-07T10:07:24Z",
    "issue": "https://github.com/sagemath/sage/issues/9846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9846#issuecomment-89868",
    "user": "https://github.com/a-andre"
}
```

Attachment [trac_9846_parallel_help.patch](https://github.com/sagemath/sage/files/ticket9846/trac_9846_parallel_help.patch) by @a-andre created at 2011-01-07 10:07:24
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9846#issuecomment-89869",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9846#issuecomment-89870",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9846#issuecomment-89871",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9846#issuecomment-89872",
    "user": "https://github.com/jdemeyer"
}
```
