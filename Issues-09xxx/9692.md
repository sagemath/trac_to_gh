...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125290"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9692#issuecomment-85072",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9692",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125294"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9692",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9692#issuecomment-85073",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9692#event-125295"
}
```
