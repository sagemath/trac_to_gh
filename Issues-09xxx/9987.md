...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9987#issuecomment-93155",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9987#issuecomment-93156",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9987#event-118731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9987#event-118732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9987",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9987#event-118733"
}
```
