...
```json
{
    "body": "Attachment [trac_9045.patch](https://github.com/sagemath/sage/files/ticket9045/trac_9045.patch) by @rlmill created at 2010-05-25 16:45:39",
    "created_at": "2010-05-25T16:45:39Z",
    "issue": "https://github.com/sagemath/sage/issues/9045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9045#issuecomment-76431",
    "user": "https://github.com/rlmill"
}
```

Attachment [trac_9045.patch](https://github.com/sagemath/sage/files/ticket9045/trac_9045.patch) by @rlmill created at 2010-05-25 16:45:39
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9045#event-65511"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9045#event-65512"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9045#event-65513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9045#issuecomment-76432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9045#issuecomment-76433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9045#issuecomment-76434",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9045#event-65514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9045#event-65515"
}
```
