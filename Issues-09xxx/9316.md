...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104685",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104687",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104688",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I won't say positive review 100% because someone who knows all the ins and outs should have a quick look at it.    But it works as advertised.  I do wonder if there need to be two separate tests for \n\n```\n\nsage -t  \"devel/sage/sage/calculus/calculus.py\"             \n*** *** Error: TIMED OUT! PROCESS KILLED! *** ***\n*** *** Error: TIMED OUT! *** ***\n\t [556.2 s]\n```\nor if one could immediately sys.exit(5) instead of having two separate timeout messages?  Or this may be a feature - one for the process, one for the file.",
    "created_at": "2010-06-23T14:28:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104689",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>I won't say positive review 100% because someone who knows all the ins and outs should have a quick look at it.    But it works as advertised.  I do wonder if there need to be two separate tests for 
...
```json
{
    "body": "<a id='comment:5'></a>I'm still suspicious that the \"File not found\" error I got with BSD.py (#9273)is anything to do with a timeout problem. Why should a test take 205 seconds on one occasion and over 10000 seconds on another?",
    "created_at": "2010-06-25T06:38:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104690",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>I'm still suspicious that the "File not found" error I got with BSD.py (#9273)is anything to do with a timeout problem. Why should a test take 205 seconds on one occasion and over 10000 seconds on another?
...
```json
{
    "body": "<a id='comment:6'></a>I'd be ok with directly doing a `sys.exit(5)`, I think. Or maybe removing the `print` statements from after the `kill` calls, and only leave the `print` with the `sys.exit(5)` at the end in place.\n\nAnother thing in there that doesn't seem to make much sense is the '`err`' string, which never seems to be set, but still is used in one of the `KeyboardInterrupt` checks.",
    "created_at": "2010-06-25T08:35:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104691",
    "user": "https://github.com/wjp"
}
```

<a id='comment:6'></a>I'd be ok with directly doing a `sys.exit(5)`, I think. Or maybe removing the `print` statements from after the `kill` calls, and only leave the `print` with the `sys.exit(5)` at the end in place.
...
```json
{
    "body": "<a id='comment:7'></a>I submitted a new patch that uses exit code 6 instead of 5, since it turns out 5 is used internally by `sage-ptest`.",
    "created_at": "2010-06-27T11:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104692",
    "user": "https://github.com/wjp"
}
```

<a id='comment:7'></a>I submitted a new patch that uses exit code 6 instead of 5, since it turns out 5 is used internally by `sage-ptest`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104693",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104694",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I removed the second print statement so there is no longer a double TIMED OUT message, and rebased the patch to apply after #8641 and #9243.",
    "created_at": "2010-07-06T21:04:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104695",
    "user": "https://github.com/wjp"
}
```

<a id='comment:8'></a>I removed the second print statement so there is no longer a double TIMED OUT message, and rebased the patch to apply after #8641 and #9243.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104696",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104697",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104698",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104699",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Related tickets: #9224, #9225.  Suggestions are welcome!",
    "created_at": "2010-07-07T03:40:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104700",
    "user": "https://github.com/qed777"
}
```

<a id='comment:10'></a>Related tickets: #9224, #9225.  Suggestions are welcome!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104701",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104702",
...
```json
{
    "body": "<a id='comment:13'></a>Merged attachment:scripts9316_timeout_rebased.patch in 4.5.2.alpha1.",
    "created_at": "2010-07-22T07:59:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104703",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:13'></a>Merged attachment:scripts9316_timeout_rebased.patch in 4.5.2.alpha1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9316#issuecomment-104704",
    "user": "https://github.com/dandrake"
}
```
