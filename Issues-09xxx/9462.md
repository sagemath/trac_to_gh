...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9462#issuecomment-83423",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket9462/trac_9462_duplicate_decl.patch",
    "created_at": "2010-07-09T09:37:12Z",
    "issue": "https://github.com/sagemath/sage/issues/9462",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9462/trac_9462_duplicate_decl.patch",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_9462_duplicate_decl.patch](https://github.com/sagemath/sage/files/ticket9462/trac_9462_duplicate_decl.patch) by @wjp created at 2010-07-09 09:37:12",
    "created_at": "2010-07-09T09:37:12Z",
    "issue": "https://github.com/sagemath/sage/issues/9462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9462#issuecomment-83424",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9462#issuecomment-83425",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9462#issuecomment-83426",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9462#issuecomment-83427",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9462#issuecomment-83428",
