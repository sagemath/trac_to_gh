...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76742",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_9058.patch](https://github.com/sagemath/sage/files/ticket9058/trac_9058.patch) by lsampaio created at 2010-10-06 12:48:59\n\nI verified the patch and I believe it is ok to be merged.",
    "created_at": "2010-10-06T12:48:59Z",
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76743",
    "user": "https://trac.sagemath.org/admin/accounts/users/lsampaio"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76744",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76745",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76746",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76747",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76748",
    "user": "https://trac.sagemath.org/admin/accounts/users/lsampaio"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9058#issuecomment-76749",
    "user": "https://github.com/qed777"
}
```
