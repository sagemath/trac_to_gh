...
archive/attachments_012487.json:
```json
{
...
archive/attachments_012488.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_9434-VERSION.txt.v2.patch](https://github.com/sagemath/sage/files/ticket9434/trac_9434-VERSION.txt.v2.patch)\n\nversion 2: replaces earlier patch. scripts repo",
    "created_at": "2010-11-11T21:00:41Z",
    "issue": "https://github.com/sagemath/sage/issues/9434",
    "type": "issue_comment",
...
**Attachment:** [trac_9434-VERSION.txt.v2.patch](https://github.com/sagemath/sage/files/ticket9434/trac_9434-VERSION.txt.v2.patch)
...
```json
{
    "body": "**Attachment:** [9434_no_UTC.patch](https://github.com/sagemath/sage/files/ticket9434/9434_no_UTC.patch)\n\nReviewer scripts patch, apply on top of previous",
    "created_at": "2010-11-26T22:42:45Z",
    "issue": "https://github.com/sagemath/sage/issues/9434",
    "type": "issue_comment",
...
**Attachment:** [9434_no_UTC.patch](https://github.com/sagemath/sage/files/ticket9434/9434_no_UTC.patch)
...
```json
{
    "body": "**Attachment:** [trac_9434-VERSION-update.patch](https://github.com/sagemath/sage/files/ticket9434/trac_9434-VERSION-update.patch)\n\nscripts repo; apply on top of other patches",
    "created_at": "2010-12-16T21:26:11Z",
    "issue": "https://github.com/sagemath/sage/issues/9434",
    "type": "issue_comment",
...
**Attachment:** [trac_9434-VERSION-update.patch](https://github.com/sagemath/sage/files/ticket9434/trac_9434-VERSION-update.patch)
...
```json
{
    "body": "**Attachment:** [trac_9434-os.path.join.patch](https://github.com/sagemath/sage/files/ticket9434/trac_9434-os.path.join.patch)\n\nscripts repo; this patch is optional, so reviewing it should have lower priority",
    "created_at": "2010-12-16T21:27:08Z",
    "issue": "https://github.com/sagemath/sage/issues/9434",
    "type": "issue_comment",
...
**Attachment:** [trac_9434-os.path.join.patch](https://github.com/sagemath/sage/files/ticket9434/trac_9434-os.path.join.patch)
