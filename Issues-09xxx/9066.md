...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100049",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This also improves the copyright situation, for which reason I have added robertwb and was to this, in case they have any emendations to it.  I figured they were mostly responsible, though :)\n\nAlso, I'm not sure what purpose the ruler functions serve.  They were never documented before, and do not show up anywhere else in the HG repository than in this file!  So one could remove them if they were intended for something else that is now handled elsewhere; either way is fine.",
    "created_at": "2010-05-27T15:13:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100050",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>This also improves the copyright situation, for which reason I have added robertwb and was to this, in case they have any emendations to it.  I figured they were mostly responsible, though :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100051",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100052",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100053",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100054",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>>  * Use the new style of raising exceptions, e.g. use `TypeError` as if it's a function, not a statement. This new style is more consistent with Python 3.x. When it comes time to switch to using Python 3.x, there would be less work involved in making the transition to Python 3.x.\n \nOkay, as long as this still works in Python 2.6 or whatever.\n>  * Put exception tests into a `TESTS` block.\n \nOk.\n>  * Fix up docstring in `bezier3d` so it renders nicely in the reference manual.\n \nI'm a minimalist about this sort of thing, as you know :)\n>  * Some miscellaneous typo fixes.\n \nSo did we say `3-D` and not `3D`?  I purposely put `3D` because I thought that was the default... I never know.",
    "created_at": "2010-06-15T13:21:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100056",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>>  * Use the new style of raising exceptions, e.g. use `TypeError` as if it's a function, not a statement. This new style is more consistent with Python 3.x. When it comes time to switch to using Python 3.x, there would be less work involved in making the transition to Python 3.x.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100057",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Docs look nice when built, passes tests.  Let's get this in!",
    "created_at": "2010-06-15T13:32:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100058",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Docs look nice when built, passes tests.  Let's get this in!
...
```json
{
    "body": "<a id='comment:6'></a>I'm not exactly sure how the texture numbers get decided, but I think there is some linear order involved with their names.  Anyway, this is easy enough to fix.  We should definitely apply this one first because it is much more annoying, and then it would be very simple to add a reviewer patch to #9088 to fix these trivialities.",
    "created_at": "2010-07-01T13:46:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100060",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>I'm not exactly sure how the texture numbers get decided, but I think there is some linear order involved with their names.  Anyway, this is easy enough to fix.  We should definitely apply this one first because it is much more annoying, and then it would be very simple to add a reviewer patch to #9088 to fix these trivialities.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100061",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100062",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Unfortunately I am not a queueing expert, so in order to fix this I will have to add yet another doctest fix patch.  Is that okay with the release managers?",
    "created_at": "2010-07-22T12:39:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100063",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Unfortunately I am not a queueing expert, so in order to fix this I will have to add yet another doctest fix patch.  Is that okay with the release managers?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100064",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100065",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100066",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>This should do it.  Hopefully a release manager can very easily review this.  Apply in order doc, reviewer, then doctest-fix.",
    "created_at": "2010-07-22T13:32:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100067",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>This should do it.  Hopefully a release manager can very easily review this.  Apply in order doc, reviewer, then doctest-fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100068",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100069",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100070",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Merged all three patches in 4.5.2.alpha1.",
    "created_at": "2010-07-23T00:10:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100071",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:12'></a>Merged all three patches in 4.5.2.alpha1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9066#issuecomment-100072",
    "user": "https://github.com/dandrake"
}
```
