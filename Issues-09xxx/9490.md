...
```json
{
    "body": "<a id='comment:1'></a>See also #9445, where Justin reports a failure (though not a crash) of this test on OS X. \n\nDave",
    "created_at": "2010-07-13T15:00:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9490#issuecomment-108788",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>See also #9445, where Justin reports a failure (though not a crash) of this test on OS X. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9490#issuecomment-108790",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This can be closed, it was a patch (#8617) new to the 4.5 series which caused this problem, and Robert removed it before releasing 4.5. So this fortunately never appeared in a Sage release. \n\nUsing sage-4.5.1 on a Sun Blade 1000 (dual 900 MHz UltraSPARC III+, 2 GB RAM), I get:\n\n```\n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 24542.2 seconds\n\ndrkirkby@redstart:~/sage-4.5.1$ uname -a\nSunOS redstart 5.10 Generic sun4u sparc SUNW,Sun-Blade-1000\ndrkirkby@redstart:~/sage-4.5.1$ cat /etc/release\n                         Solaris 10 3/05 s10_74L2a SPARC\n           Copyright 2005 Sun Microsystems, Inc.  All Rights Reserved.\n                        Use is subject to license terms.\n                            Assembled 22 January 2005\ndrkirkby@redstart:~/sage-4.5.1$ \n```",
    "created_at": "2010-07-21T12:54:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9490#issuecomment-108791",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>This can be closed, it was a patch (#8617) new to the 4.5 series which caused this problem, and Robert removed it before releasing 4.5. So this fortunately never appeared in a Sage release. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9490#issuecomment-108792",
