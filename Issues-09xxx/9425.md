...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120988"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120989"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120991"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120992"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-GeorgSWeber",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120993"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9425#issuecomment-80726",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9425#issuecomment-80727",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120995"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9425#issuecomment-80728",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9425#issuecomment-80729",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9425",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9425#event-120998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9425#issuecomment-80730",
    "user": "https://github.com/qed777"
}
```
