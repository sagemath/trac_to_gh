...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9166#issuecomment-78255",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9166#issuecomment-78256",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9166#issuecomment-78257",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9166#issuecomment-78258",
    "user": "https://trac.sagemath.org/admin/accounts/users/retry"
}
```
...
```json
{
    ...
    "asset_name": "test.log",
    "asset_url": "tarball://root/attachments/ticket9166/test.log",
    "created_at": "2010-08-11T23:29:55Z",
    "issue": "https://github.com/sagemath/sage/issues/9166",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9166/test.log",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9166#issuecomment-78260",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9166#event-66799"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9166#event-66800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9166",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9166#event-66801"
}
```
