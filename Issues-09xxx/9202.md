...
<a id='comment:5'></a>Replying to [drkirkby](#comment%3A2):
...
<a id='comment:18'></a>Replying to [jason](#comment%3A7):
> This spkg probably also solves #5873.
