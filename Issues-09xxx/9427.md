...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110267"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110273"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82607",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82608",
    "user": "https://github.com/sagetrac-whuss"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82609",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82610",
    "user": "https://github.com/sagetrac-whuss"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110274"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82611",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82612",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82613",
    "user": "https://github.com/hemmecke"
}
```
...
```json
{
    "body": "<a id='comment:9'>Comment 9:</a>\nSo the ascii output for plusInfinity is \"+ infinity\" and the `_fricas_init_()` method in [attachment: fricas_infinity.patch.gz](https://github.com/sagemath/sage/files/ticket9427/fricas_infinity.patch.gz) works as intended.\n\nWilfried, will you have time to revise the patch? Note that when #9880 is merged (almost) all symbolics patches will need to be rebased.",
    "created_at": "2011-05-10T18:33:06Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82614",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110276"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110277"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110278"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110279"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110280"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110281"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110282"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110283"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82615",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82616",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82617",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82618",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82619",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82620",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82621",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82622",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82623",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82624",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82625",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110287"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110288"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9427#issuecomment-82626",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9427",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9427#event-110291"
}
```
