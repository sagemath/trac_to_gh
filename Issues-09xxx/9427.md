...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107321",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_9427-fricas-integrate.patch](tarball://root/attachments/some-uuid/ticket9427/trac_9427-fricas-integrate.patch) by whuss created at 2010-07-05 08:51:37",
    "created_at": "2010-07-05T08:51:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107322",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```

<a id='comment:1'></a>Attachment [trac_9427-fricas-integrate.patch](tarball://root/attachments/some-uuid/ticket9427/trac_9427-fricas-integrate.patch) by whuss created at 2010-07-05 08:51:37
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107323",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107324",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107325",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [fricas_infinity.patch](tarball://root/attachments/some-uuid/ticket9427/fricas_infinity.patch) by whuss created at 2010-07-05 15:11:20\n\nReplying to [burcin](#comment%3A2):\n>  * the conversion of different infinities on line 95-103 should be moved to the `_fricas_init_()` method of the corresponding classes. Then this would work:\n>  \n>  ```\n\n> sage: infinity._fricas_init_()\n> \"%plusInfinity\"\n> }}}\n\nI tried this (see fricas_infinity.patch), but for some reason that I don't understand the output of\n_fricas_init_() changes into something which is not a valid fricas expression.\n\n{{{\nsage: oo._fricas_init_()\n'%plusInfinity'\n}}}\n\nbut\n\n{{{\nsage: oo._fricas_()\n+ infinity\n}}}\n\nI have no idea what is going on here.",
    "created_at": "2010-07-05T15:11:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107327",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```

<a id='comment:3'></a>Attachment [fricas_infinity.patch](tarball://root/attachments/some-uuid/ticket9427/fricas_infinity.patch) by whuss created at 2010-07-05 15:11:20
...
```json
{
    "body": "<a id='comment:4'></a>Is \"algorithm\" the most appropiate word here? To me, Fricas, Aximom, Maxima etc are software packages, not algorithms. They implement many differerent algorithms.\n\nI'm not a mathmatician, but certainly my mathematical training would never have suggested that Fricas was an algorithm. \n\nI would have thought something like\n\n```\nintegrate(f(x), x, use=\"fricas\") \nintegrate(f(x), x, software=\"fricas\") \nintegrate(f(x), x, method=\"fricas\") \n```\n\nwould be better than \n\n```\nintegrate(f(x), x, algorithm=\"fricas\") \n```\n\nI don't claim any of my choices are optimal, but I think all of them are better than \"algorithm\". \n\nDave",
    "created_at": "2010-07-06T23:34:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107328",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>Is "algorithm" the most appropiate word here? To me, Fricas, Aximom, Maxima etc are software packages, not algorithms. They implement many differerent algorithms.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107329",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Replying to [whuss](#comment%3A3):\n> Replying to [burcin](#comment%3A2):\n> >  * the conversion of different infinities on line 95-103 should be moved to the `_fricas_init_()` method of the corresponding classes. Then this would work:\n\n  {{{\n  sage: infinity._fricas_init_()\n  \"%plusInfinity\"\n  }}}\n> \n> I tried this (see fricas_infinity.patch), but for some reason that I don't understand the output of\n> _fricas_init_() changes into something which is not a valid fricas expression.\n> \n\n {{{\n sage: oo._fricas_init_()\n '%plusInfinity'\n }}}\n> \n> but\n> \n> \n> ```\n> sage: oo._fricas_()\n> + infinity\n> ```\n> \n> I have no idea what is going on here.\n\n\nThis seems to be how fricas prints `%plusInfinity`. Ralf, can you help us with this?",
    "created_at": "2011-05-10T17:21:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107330",
    "user": "https://github.com/burcin"
}
```

<a id='comment:6'></a>Replying to [whuss](#comment%3A3):
> Replying to [burcin](#comment%3A2):
> >  * the conversion of different infinities on line 95-103 should be moved to the `_fricas_init_()` method of the corresponding classes. Then this would work:
...
```json
{
    "body": "<a id='comment:9'></a>So the ascii output for plusInfinity is \"+ infinity\" and the `_fricas_init_()` method in attachment:fricas_infinity.patch works as intended.\n\nWilfried, will you have time to revise the patch? Note that when #9880 is merged (almost) all symbolics patches will need to be rebased.",
    "created_at": "2011-05-10T18:33:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107333",
    "user": "https://github.com/burcin"
}
```

<a id='comment:9'></a>So the ascii output for plusInfinity is "+ infinity" and the `_fricas_init_()` method in attachment:fricas_infinity.patch works as intended.
...
```json
{
    "body": "<a id='comment:15'></a>I have made a git branch with the attached files, rebased on 6.5.b2\n\n---\nNew commits:",
    "created_at": "2014-12-07T17:00:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107335",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:15'></a>I have made a git branch with the attached files, rebased on 6.5.b2
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107336",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107337",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107338",
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [burcin](#comment%3A2):\n>  * Similarly, I suggest moving the code for converting the result back to the `_sage_()` method of the fricas interface.\n \nI know this is how Sympy does it but I think such a decision is up to the Fricas developers.",
    "created_at": "2015-02-02T10:08:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107339",
    "user": "https://github.com/rwst"
}
```

<a id='comment:17'></a>Replying to [burcin](#comment%3A2):
>  * Similarly, I suggest moving the code for converting the result back to the `_sage_()` method of the fricas interface.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107340",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107341",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107342",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>This looks good and tests OK in `symbolic` and `rings`.",
    "created_at": "2015-02-02T10:41:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107343",
    "user": "https://github.com/rwst"
}
```

<a id='comment:19'></a>This looks good and tests OK in `symbolic` and `rings`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107344",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107345",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107346",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107347",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9427#issuecomment-107348",
    "user": "https://github.com/vbraun"
}
```
