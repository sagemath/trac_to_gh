...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114966"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114971"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114972"
}
```
...
```json
{
    "body": "Changed keywords from **** to **doctest scripts**",
    "created_at": "2010-10-25T08:00:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
...
Changed keywords from **** to **doctest scripts**
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114973"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114974"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114975"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114976"
}
```
...
```json
{
    "actor": "https://github.com/sagetrac-forextrading11",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114977"
}
```
...
```json
{
    ...
    "user": "https://github.com/sagetrac-forextrading11"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114983"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114984"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114985"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114988"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114989"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114991"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114994"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -29,3 +29,7 @@\n Sometimes I feel that trac tickets get held up for unnecessary long periods due to a reviewer being over pedantic and wanting things outside the scope of the original ticket, which would be better put on another ticket. \n \n (Dave)\n+\n+---\n+\n+Apply only [attachment: trac_9739.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739.patch.gz).\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114995"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114996"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -32,4 +32,8 @@\n \n ---\n \n-Apply only [attachment: trac_9739.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739.patch.gz).\n+Apply \n+\n+- [attachment: trac_9739.v2.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739.v2.patch.gz) to the scripts repository\n+- [attachment: trac_9739-graphviz.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739-graphviz.patch.gz) to the Sage library\n+\n``````\n",
    "created_at": "2011-09-10T20:59:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -34,6 +34,6 @@\n \n Apply \n \n-- [attachment: trac_9739.v2.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739.v2.patch.gz) to the scripts repository\n+- [attachment: trac_9739.v3.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739.v3.patch.gz) to the scripts repository\n - [attachment: trac_9739-graphviz.patch.gz](https://github.com/sagemath/sage/files/ticket9739/trac_9739-graphviz.patch.gz) to the Sage library\n \n``````\n",
    "created_at": "2011-09-11T01:15:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88025",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88026",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88027",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88028",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-114999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9739#event-115000"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88029",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88030",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88031",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88032",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88033",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88034",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88035",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88036",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88037",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88038",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88039",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88040",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88041",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88042",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88043",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88044",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9739#issuecomment-88045",
    "user": "https://github.com/jdemeyer"
}
```
