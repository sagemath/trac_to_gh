...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111346",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111347",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111348",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I think the problem with the original docstring is that the backslashes are not escaped, so perhaps Sphinx interprets the `\\n`s as newline characters and sees\n\n```python\n        \"\"\"                                                                     \n        Returns the string s with Matlab's answer prompt removed.               \n                                                                                \n        EXAMPLES::                                                              \n                                                                                \n            sage: s = '                                                         \nans =                                                                           \n                                                                                \n     2                                                                          \n'                                                                               \n            sage: matlab.strip_answer(s)                                        \n            '     2'                                                            \n        \"\"\"\n```\nNot using a raw string but replacing the `\\n`s with `\\\\n`s should also work.",
    "created_at": "2010-07-27T08:44:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111350",
    "user": "https://github.com/qed777"
}
```

<a id='comment:3'></a>I think the problem with the original docstring is that the backslashes are not escaped, so perhaps Sphinx interprets the `\n`s as newline characters and sees
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111351",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111353",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111354",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111355",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9608#issuecomment-111356",
    "user": "https://github.com/qed777"
}
```
