...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94372",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket9971/boehm_gc-7.1.p6.log.nfg.txt",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94373",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94374",
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "gcc",
    "asset_url": "tarball://root/attachments/some-uuid/ticket9971/gcc",
...
```json
{
    "body": "gcc script, which calls the real gcc after some delay",
    "created_at": "2010-09-23T00:14:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94375",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94376",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94377",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94378",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76812"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76813"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76814"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94379",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76816"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94380",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76818"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76819"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9971#event-76821"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9971#issuecomment-94381",
