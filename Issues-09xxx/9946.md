...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118888",
...
```json
{
    "body": "<a id='comment:1'></a>Fran\u00e7ois has posted a patch at #9733 for the libfac problem.  We could merge it into a new singular-3-1-1-4.p3.spkg here.",
    "created_at": "2010-09-19T06:03:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118889",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>François has posted a patch at #9733 for the libfac problem.  We could merge it into a new singular-3-1-1-4.p3.spkg here.
...
```json
{
    "body": "<a id='comment:3'></a>Patch attached with a slightly more descriptive name.",
    "created_at": "2010-09-19T06:08:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118890",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>Patch attached with a slightly more descriptive name.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118891",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118893",
...
```json
{
    "body": "<a id='comment:7'></a>I was thinking of similar testing w.r.t. `spkg/standard/deps`, i.e. inter-spkg dependencies, where adding (not necessarily random) `sleep` would suffice, especially to the build (time) of packages that get early and almost instantly built.\n\nFor Makefiles, IMHO careful reading (and / or a \"makefile-lint\") would be better, which is obviously harder [to implement]. Unfortunately, the steps actually taken in a build also heavily depend on the system and its configuration, so I expect it to be undecidable in general. Nevertheless, one could catch at least *some* missing dependencies without \"brute-force\" trial and error.",
    "created_at": "2010-09-19T13:33:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118894",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>I was thinking of similar testing w.r.t. `spkg/standard/deps`, i.e. inter-spkg dependencies, where adding (not necessarily random) `sleep` would suffice, especially to the build (time) of packages that get early and almost instantly built.
...
```json
{
    "body": "<a id='comment:8'></a>P.S.: For `deps`, I'd prefer *generating* it from *formal* (dependency) specs given in (or for) the spkgs, like every proper package system / installer does. These usually also include specs of the required *versions*.\n\nSorry, a bit off-ticket-topic.",
    "created_at": "2010-09-19T13:46:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118895",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>P.S.: For `deps`, I'd prefer *generating* it from *formal* (dependency) specs given in (or for) the spkgs, like every proper package system / installer does. These usually also include specs of the required *versions*.
...
```json
{
    "body": "<a id='comment:9'></a>Is there already a spkg around? (Sorry, I was out of office and off.)\nI put one with fbissey's patch here:\nhttp://sage.math.washington.edu/home/dreyer/spkg/singular-3-1-1-4.p3.spkg",
    "created_at": "2010-09-21T03:13:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118896",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:9'></a>Is there already a spkg around? (Sorry, I was out of office and off.)
I put one with fbissey's patch here:
http://sage.math.washington.edu/home/dreyer/spkg/singular-3-1-1-4.p3.spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118897",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>By all means someone review this, as I expect it fixes the bug. \n\nWithin the next 24 hours I will have implemented a random delay in front of gcc and will build this a few hundred times with random delays. That might help discover any more similar issues, if they exist. \n\nDave",
    "created_at": "2010-09-21T09:55:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118898",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:11'></a>By all means someone review this, as I expect it fixes the bug. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118900",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118901",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Dave, if you don't want to mess around with `/dev/urandom` (and `hd`?), you could use the pid of a subshell (`rand_raw=`sh -c 'echo $$'``) as the source for a pseudo random number (perhaps \"recursively\", i.e. the pid of the nth subshell where n is itself a pseudo-random number), and feed that to\n\n```sh\nsleep `expr $base + $rand_raw % $modulus \\* $scale`\n```\n\nPlain `rand_raw` is of course bad on an otherwise idle system, also depending on how long you sleep.",
    "created_at": "2010-09-21T11:15:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118902",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:15'></a>Dave, if you don't want to mess around with `/dev/urandom` (and `hd`?), you could use the pid of a subshell (`rand_raw=`sh -c 'echo $$'``) as the source for a pseudo random number (perhaps "recursively", i.e. the pid of the nth subshell where n is itself a pseudo-random number), and feed that to
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118903",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [nanosleep.c](tarball://root/attachments/some-uuid/ticket9946/nanosleep.c) by @nexttime created at 2010-09-21 12:02:14\n\nDave, I've attached a [minimalistic C implementation](http://trac.sagemath.org/sage_trac/raw-attachment/ticket/9946/nanosleep.c) of a command `nanosleep <nanoseconds>`.",
    "created_at": "2010-09-21T12:02:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118904",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:16'></a>Attachment [nanosleep.c](tarball://root/attachments/some-uuid/ticket9946/nanosleep.c) by @nexttime created at 2010-09-21 12:02:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118905",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Replying to [leif](#comment%3A12):\n> The changelog lacks an entry for the p3.\n\nI fixed that (typical late-night copy&paste mistake)\n\nhttp://sage.math.washington.edu/home/dreyer/spkg/singular-3-1-1-4.p3.spkg \n(same location as above)",
    "created_at": "2010-09-21T13:03:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118907",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:18'></a>Replying to [leif](#comment%3A12):
> The changelog lacks an entry for the p3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118908",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118911",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118912",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>I had a bit of a shock this morning. Instead of my computer running flat out building Singular, it was relatively idle. This suggested the Singular processes had died. But luckily it was not an error. The loop had a limit of 100, so they had all finished. \n\nSo I've now built this version of Singular 500 times, with random delays before calling gcc. \n\n* 100 times with a mean delay of 500 ms (maximum 1 second)\n* 100 times with a mean delay of 50 ms (maximum 100 ms)\n* 100 times with a mean delay of 5 ms (maximum 10 ms)\n* 100 times with a mean delay of 500 us (maximum 1 ms)\n* 100 times with a mean delay of 50 us. (maximum 100 us) \n\n**IF** there are any further problems found, then I don't know how we go about testing for them. At least random testing has not discovered them. \n\nSo positive review. \n\nDave",
    "created_at": "2010-09-22T07:31:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118913",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:23'></a>I had a bit of a shock this morning. Instead of my computer running flat out building Singular, it was relatively idle. This suggested the Singular processes had died. But luckily it was not an error. The loop had a limit of 100, so they had all finished. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118914",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Francois Bissey, Alexander Dreyer\"",
    "created_at": "2010-09-22T07:31:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118915",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing author from "" to "Francois Bissey, Alexander Dreyer"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118916",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>`@`Dave: Thanks a lot for the extensive tests! (Also in the name of the Singular-Team).\n\nAll the newly found dependencies will be added upstream. Some of them are in fact not only unexpected, but also they were not intended that way. (In fact these are bugs, which will be fixed.)",
    "created_at": "2010-09-22T07:40:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118917",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:24'></a>`@`Dave: Thanks a lot for the extensive tests! (Also in the name of the Singular-Team).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118918",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118920",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9946#event-25092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118921",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118922",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9946#issuecomment-118923",
