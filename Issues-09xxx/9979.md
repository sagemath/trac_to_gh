...
```json
{
    "body": "<a id='comment:1'></a>Yes, if we only (properly) build a shared library rather than the executable, we don't need it.\n\nThis will some day be fixed by #9870 I guess.\n\nYou could nevertheless report this upstream. (I think Cliquer should at least check for the presence of `getopt.h`.)",
    "created_at": "2010-09-24T12:10:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9979#issuecomment-104737",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Yes, if we only (properly) build a shared library rather than the executable, we don't need it.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25207"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25208"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25209"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25212"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25213"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25214"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9979#issuecomment-104738",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9979#issuecomment-104739",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9979#issuecomment-104740",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25216"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25217"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9979#issuecomment-104741",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9979#event-25218"
}
```
