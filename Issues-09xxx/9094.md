...
```json
{
    "body": "Changed assignee from **@aghitza** to **@mminzlaff**",
    "created_at": "2011-03-22T05:15:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9094",
    "type": "issue_comment",
...
Changed assignee from **@aghitza** to **@mminzlaff**
...
```json
{
    "body": "Changed assignee from **@mminzlaff** to **@aghitza**",
...
Changed assignee from **@mminzlaff** to **@aghitza**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9094#event-105618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9094",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9094#event-105619"
}
```
