...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122503"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122504"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122505"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122506"
}
```
...
```json
{
    "body": "<div id=\"comment:5\" align=\"right\">comment:5</div>\n\nThe patch level for the new spkg should be 2, since we used p1 for #9665.  This should fix the \"already installed\" problem reported by John Cremona in [comment 180](https://github.com/sagemath/sage/issues/9343#comment:180) at #9343.",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122507"
}
```
...
```json
{
    "body": "<div id=\"comment:16\" align=\"right\">comment:16</div>\n\nReplying to [@sagetrac-drkirkby](#comment%3A15):\n> Replying to [@nexttime](#comment%3A14):\n> > Replying to [@sagetrac-drkirkby](#comment%3A12):\n> > > I've changed the title and description a bit, to reflect the fact that #9343 is **not** Pari 2.4.3. \n> > \n> > \n> > You should perhaps have updated the spkg link to point to John Cremona's new p2 spkg, too. ;-) \n> \n> I don't know where it is. In any case, it should not be a .p2, since the current one in Sage is lcalc-20100428-1.23.p0.spkg, to a revision should be called lcalc-20100428-1.23.p1.spkg.\n\nBrowser cache issue?\n\nSee [#9592 comment:10](https://github.com/sagemath/sage/issues/9592#comment:10) (where)\n\nand [#9592 comment:5](https://github.com/sagemath/sage/issues/9592#comment:5) (why).\n\n(lcalc-20100428-1.23.p1.spkg from #9665 was merged into Sage 4.5.2.rc1)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9592",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9592#event-122514"
}
```
