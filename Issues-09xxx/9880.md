...
```json
{
    "body": "Changed assignee from **@burcin** to **@jpflori**",
...
Changed assignee from **@burcin** to **@jpflori**
...
```json
{
    "body": "Changed assignee from **@jpflori** to **@burcin**",
...
Changed assignee from **@jpflori** to **@burcin**
