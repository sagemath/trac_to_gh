...
{
    "assignees": [],
    "body": "Here is a short example found by Burcin and reproducing the bug:\n\n```\nb = [var('b_%s'%i) for i in range(4)]\n\nprecomp = (2^b_2 + 2)*(2^b_1 + 2^(-b_1) + 2^b_1*2^b_0 - 2^b_1*2^(-b_0)\n- 2^(-b_1)*2^b_0 - 2^(-b_1)*2^(-b_0) + 2^b_0 + 2^(-b_0) - 9) + (2^b_1 +\n2^(-b_1) + 2^b_1*2^b_0 - 2^b_1*2^(-b_0) - 2^(-b_1)*2^b_0 -\n2^(-b_1)*2^(-b_0) + 2^b_0 + 2^(-b_0) - 9)/2^b_2\n\nrepl_dict = {b_0: b_0, b_3: b_1, b_2: b_3, b_1: b_2}\nP = precomp.substitute(repl_dict)\nP.expand() \n```\nThis is already being discussed here: http://groups.google.com/group/sage-support/browse_thread/thread/7c85f02c76012722\n\nThe following patches are for the Sage library to enable access to the PyNaC order and randomly test that it is a SWO:\n\nInstall the package from here: http://boxen.math.washington.edu/home/jpflori/spkg/pynac-0.3.0.spkg\n\nThen apply \n1. [attachment: trac_9880_pynac_order-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order-sage_5_10_beta2.patch.gz)\n2. [attachment: trac_9880_randomized_testing-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing-sage_5_10_beta2.patch.gz)\n3. [attachment: trac_9880-doctest_for_9046-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-sage_5_10_beta2.patch.gz)\n4. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n5. [attachment: trac_9880-fix_doctests-sage_5_10_beta2.take3.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta2.take3.patch.gz)\n6. [attachment: trac_9880-review.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-review.patch.gz)\n\n\n\nDepends on #13213\nDepends on #9890\nDepends on #14550\n\nAssignee: **@burcin**\n\nCC:  @kcrisman @zimmermann6\n\nKeywords: **pynac spkg**\n\nReviewer: **Burcin Erocal, Jean-Pierre Flori**\n\nAuthor: **Burcin Erocal, Jean-Pierre Flori, Volker Braun**\n\nMerged: **sage-5.11.beta0**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/9880_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-116997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-116998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-116999"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117001"
}
```
...
```json
{
    "body": "Changed assignee from **@burcin** to **@sagetrac-jpflori**",
...
Changed assignee from **@burcin** to **@sagetrac-jpflori**
...
```json
{
    "body": "Changed assignee from **@sagetrac-jpflori** to **@burcin**",
...
Changed assignee from **@sagetrac-jpflori** to **@burcin**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117003"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -13,3 +13,10 @@\n P.expand() \n ```\n This is already being discussed here: http://groups.google.com/group/sage-support/browse_thread/thread/7c85f02c76012722\n+\n+The following patches are for the Sage library to enable access to the PyNaC order and randomly test that it is a SWO:\n+\n+Apply \n+[attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz), \n+[attachment: trac_9880_pynac_order.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.patch.gz), [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -18,5 +18,5 @@\n \n Apply \n [attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz), \n-[attachment: trac_9880_pynac_order.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.patch.gz), [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n+[attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz), [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n \n``````\n",
...
```json
{
    "body": "<div id=\"comment:42\" align=\"right\">Comment 42</div>\n\nI changed the structure of the order classes a little. New patches are available in my pynac queue:\n\nhttps://bitbucket.org/burcin/pynac-patches/src\n\n[attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz) should be applied to access these functions from Sage.",
    "created_at": "2011-06-15T03:50:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -18,5 +18,6 @@\n \n Apply \n [attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz), \n-[attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz), [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n+[attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz), [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz),\n+[attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n \n``````\n",
    "created_at": "2011-06-16T19:50:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -17,7 +17,8 @@\n The following patches are for the Sage library to enable access to the PyNaC order and randomly test that it is a SWO:\n \n Apply \n-[attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz), \n-[attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz), [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz),\n-[attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n-\n+1. [attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz)\n+2. [attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz)\n+3. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n+4. [attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n+5. [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,3 +22,5 @@\n 3. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n 4. [attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n 5. [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz)\n+6. [attachment: trac_9880-fix_comparison.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison.patch.gz)\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -23,4 +23,4 @@\n 4. [attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n 5. [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz)\n 6. [attachment: trac_9880-fix_comparison.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison.patch.gz)\n-\n+7. [attachment: trac_9880-fix_doctests_symbolic.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.patch.gz)\n``````\n",
    "created_at": "2011-06-18T03:14:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -16,11 +16,13 @@\n \n The following patches are for the Sage library to enable access to the PyNaC order and randomly test that it is a SWO:\n \n-Apply \n+First build Pynac with patches from Burcin pynac queue https://bitbucket.org/burcin/pynac-patches and [attachment: numerics.patch](https://github.com/sagemath/sage/files/ticket9880/numerics.patch.gz) applied and install it.\n+\n+Then apply \n 1. [attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz)\n 2. [attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz)\n 3. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n 4. [attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n 5. [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz)\n-6. [attachment: trac_9880-fix_comparison.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison.patch.gz)\n-7. [attachment: trac_9880-fix_doctests_symbolic.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.patch.gz)\n+6. [attachment: trac_9880-fix_comparison-p1.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.patch.gz)\n+7. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n``````\n",
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "title_is": "Pynac comparison functions do not provide a SWO",
    "title_was": "Segfault in PyNaC 0.2.0.p4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117004"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -26,3 +26,5 @@\n 5. [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz)\n 6. [attachment: trac_9880-fix_comparison-p1.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.patch.gz)\n 7. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n+8. [attachment: trac_9880-fix_doctests_symbolic.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.patch.gz)\n+9. [attachment: trac_9880-fix_doctests-be.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.patch.gz)\n``````\n",
...
```json
{
    "body": "Changed dependencies from **12068** to **#12068**",
...
Changed dependencies from **12068** to **#12068**
...
```json
{
    "body": "<div id=\"comment:68\" align=\"right\">Comment 68</div>\n\nThis fixes #9046 as well. I attached [attachment: trac_9880-doctest_for_9046.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046.patch.gz) to add the example there as a doctest.\n\nWe don't need [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz) since that was merged in #12950, so I removed it from the patches listed in the description.\n\nNaturally the doctest patches, the last two in the list, have bitrotted. The rest seems to apply fine, though I only tried with 5.0.beta13.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -16,16 +16,16 @@\n \n The following patches are for the Sage library to enable access to the PyNaC order and randomly test that it is a SWO:\n \n-First build Pynac with patches from Burcin pynac queue https://bitbucket.org/burcin/pynac-patches and [attachment: numerics.patch](https://github.com/sagemath/sage/files/ticket9880/numerics.patch.gz) applied and install it.\n+First build Pynac with patches from Burcin's pynac queue https://bitbucket.org/burcin/pynac-patches applied and install it.\n \n Then apply \n 1. [attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz)\n 2. [attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz)\n 3. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n 4. [attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n-5. [attachment: trac_9880_pynac_infinities.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_infinities.patch.gz)\n-6. [attachment: trac_9880-fix_comparison-p1.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.patch.gz)\n-7. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n+5. [attachment: trac_9880-fix_comparison-p1.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.patch.gz)\n+6. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n+7. [attachment: trac_9880-doctest_for_9046.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046.patch.gz)\n 8. [attachment: trac_9880-fix_doctests_symbolic.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.patch.gz)\n 9. [attachment: trac_9880-fix_doctests-be.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.patch.gz)\n \n``````\n",
    "created_at": "2012-07-10T09:28:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    "body": "Changed dependencies from **#12068** to none",
...
Changed dependencies from **#12068** to none
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,14 +19,12 @@\n First build Pynac with patches from Burcin's pynac queue https://bitbucket.org/burcin/pynac-patches applied and install it.\n \n Then apply \n-1. [attachment: trac_9880_fix_import.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_fix_import.patch.gz)\n-2. [attachment: trac_9880_pynac_order.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.patch.gz)\n-3. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n-4. [attachment: trac_9880-stable_operands.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.patch.gz)\n-5. [attachment: trac_9880-fix_comparison-p1.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.patch.gz)\n-6. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n-7. [attachment: trac_9880-doctest_for_9046.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046.patch.gz)\n-8. [attachment: trac_9880-fix_doctests_symbolic.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.patch.gz)\n-9. [attachment: trac_9880-fix_doctests-be.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.patch.gz)\n+1. [attachment: trac_9880_pynac_order.take2.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.rebased-5.5.rc0.patch.gz)\n+2. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n+3. [attachment: trac_9880-stable_operands.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.rebased-5.5.rc0.patch.gz)\n+4. [attachment: trac_9880-fix_comparison-p1.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.rebased-5.5.rc0.patch.gz)\n+5. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n+6. [attachment: trac_9880-doctest_for_9046.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046.patch.gz)\n+7. [attachment: trac_9880-fix_doctests_symbolic.take2.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.rebased-5.5.rc0.patch.gz)\n+8. [attachment: trac_9880-fix_doctests-be.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.rebased-5.5.rc0.patch.gz)\n \n-Last patch depends on #12068\n``````\n",
    "created_at": "2012-11-21T21:26:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -24,7 +24,7 @@\n 3. [attachment: trac_9880-stable_operands.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.rebased-5.5.rc0.patch.gz)\n 4. [attachment: trac_9880-fix_comparison-p1.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.rebased-5.5.rc0.patch.gz)\n 5. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n-6. [attachment: trac_9880-doctest_for_9046.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046.patch.gz)\n-7. [attachment: trac_9880-fix_doctests_symbolic.take2.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.rebased-5.5.rc0.patch.gz)\n-8. [attachment: trac_9880-fix_doctests-be.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.rebased-5.5.rc0.patch.gz)\n+6. [attachment: trac_9880-doctest_for_9046-rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-rebased-5.9.patch.gz)\n+7. [attachment: trac_9880-fix_doctests_symbolic.take2.rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.rebased-5.9.patch.gz)\n+8. [attachment: trac_9880-fix_doctests-be.rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.rebased-5.9.patch.gz)\n \n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -16,7 +16,7 @@\n \n The following patches are for the Sage library to enable access to the PyNaC order and randomly test that it is a SWO:\n \n-First build Pynac with patches from Burcin's pynac queue https://bitbucket.org/burcin/pynac-patches applied and install it.\n+Install the (test) package from here: http://sage.math.washington.edu/home/burcin/pynac/pynac-0.3.0.spkg\n \n Then apply \n 1. [attachment: trac_9880_pynac_order.take2.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.rebased-5.5.rc0.patch.gz)\n@@ -26,5 +26,6 @@\n 5. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n 6. [attachment: trac_9880-doctest_for_9046-rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-rebased-5.9.patch.gz)\n 7. [attachment: trac_9880-fix_doctests_symbolic.take2.rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.rebased-5.9.patch.gz)\n-8. [attachment: trac_9880-fix_doctests-be.rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be.rebased-5.9.patch.gz)\n+8. [attachment: trac_9880-fix_doctests-be-rebased-5.9-on_13213.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be-rebased-5.9-on_13213.patch.gz)\n+9. [attachment: trac_9880-more_doctests-be.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-more_doctests-be.patch.gz)\n \n``````\n",
    "created_at": "2013-05-09T16:28:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117005"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117006"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,13 +19,10 @@\n Install the (test) package from here: http://sage.math.washington.edu/home/burcin/pynac/pynac-0.3.0.spkg\n \n Then apply \n-1. [attachment: trac_9880_pynac_order.take2.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order.take2.rebased-5.5.rc0.patch.gz)\n-2. [attachment: trac_9880_randomized_testing.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing.patch.gz)\n-3. [attachment: trac_9880-stable_operands.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-stable_operands.rebased-5.5.rc0.patch.gz)\n-4. [attachment: trac_9880-fix_comparison-p1.rebased-5.5.rc0.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_comparison-p1.rebased-5.5.rc0.patch.gz)\n-5. [attachment: trac_9880-fix_variables_ordering.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_variables_ordering.patch.gz)\n-6. [attachment: trac_9880-doctest_for_9046-rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-rebased-5.9.patch.gz)\n-7. [attachment: trac_9880-fix_doctests_symbolic.take2.rebased-5.9.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests_symbolic.take2.rebased-5.9.patch.gz)\n-8. [attachment: trac_9880-fix_doctests-be-rebased-5.9-on_13213.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-be-rebased-5.9-on_13213.patch.gz)\n-9. [attachment: trac_9880-more_doctests-be.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-more_doctests-be.patch.gz)\n+1. [attachment: trac_9880_pynac_order-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order-sage_5_10_beta2.patch.gz)\n+2. [attachment: trac_9880_randomized_testing-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing-sage_5_10_beta2.patch.gz)\n+3. [attachment: trac_9880-doctest_for_9046-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-sage_5_10_beta2.patch.gz)\n+4. [attachment: trac_9880-fix_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta2.patch.gz)\n+5. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n \n+\n``````\n",
    "created_at": "2013-05-10T17:11:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,7 +22,7 @@\n 1. [attachment: trac_9880_pynac_order-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order-sage_5_10_beta2.patch.gz)\n 2. [attachment: trac_9880_randomized_testing-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing-sage_5_10_beta2.patch.gz)\n 3. [attachment: trac_9880-doctest_for_9046-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-sage_5_10_beta2.patch.gz)\n-4. [attachment: trac_9880-fix_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta2.patch.gz)\n+4. [attachment: trac_9880-fix_doctests-sage_5_10_beta2.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta2.take2.patch.gz)\n 5. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n \n \n``````\n",
    "created_at": "2013-05-23T11:13:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90699",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,7 +22,8 @@\n 1. [attachment: trac_9880_pynac_order-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_pynac_order-sage_5_10_beta2.patch.gz)\n 2. [attachment: trac_9880_randomized_testing-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing-sage_5_10_beta2.patch.gz)\n 3. [attachment: trac_9880-doctest_for_9046-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-sage_5_10_beta2.patch.gz)\n-4. [attachment: trac_9880-fix_doctests-sage_5_10_beta2.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta2.take2.patch.gz)\n-5. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n+4. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n+5. [attachment: trac_9880-fix_doctests-sage_5_10_beta5.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta5.patch.gz)\n+6. [attachment: trac_9880-review.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-review.patch.gz)\n \n \n``````\n",
    "created_at": "2013-05-27T13:26:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90700",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90701",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90702",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90703",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90704",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90705",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90706",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117008"
}
```
...
```json
{
    "body": "Changed keywords from **pynac** to **pynac spkg**",
    "created_at": "2013-05-27T19:40:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90707",
    "user": "https://github.com/sagetrac-jpflori"
}
```

Changed keywords from **pynac** to **pynac spkg**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90708",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90709",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117009"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117010"
}
```
...
```json
{
    "body": "Changed dependencies from **#13213** to **#13213, #14550**",
    "created_at": "2013-05-28T20:29:24Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90710",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90711",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90712",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n 2. [attachment: trac_9880_randomized_testing-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing-sage_5_10_beta2.patch.gz)\n 3. [attachment: trac_9880-doctest_for_9046-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-sage_5_10_beta2.patch.gz)\n 4. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n-5. [attachment: trac_9880-fix_doctests-sage_5_10_beta5.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta5.patch.gz)\n+5. [attachment: trac_9880-fix_doctests-sage_5_10_beta5.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta5.take2.patch.gz)\n 6. [attachment: trac_9880-review.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-review.patch.gz)\n \n \n``````\n",
    "created_at": "2013-05-29T08:07:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90713",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n 2. [attachment: trac_9880_randomized_testing-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880_randomized_testing-sage_5_10_beta2.patch.gz)\n 3. [attachment: trac_9880-doctest_for_9046-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-doctest_for_9046-sage_5_10_beta2.patch.gz)\n 4. [attachment: trac_9880-add_doctests-sage_5_10_beta2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-add_doctests-sage_5_10_beta2.patch.gz)\n-5. [attachment: trac_9880-fix_doctests-sage_5_10_beta5.take2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta5.take2.patch.gz)\n+5. [attachment: trac_9880-fix_doctests-sage_5_10_beta2.take2.2.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-fix_doctests-sage_5_10_beta2.take2.2.patch.gz)\n 6. [attachment: trac_9880-review.patch](https://github.com/sagemath/sage/files/ticket9880/trac_9880-review.patch.gz)\n \n \n``````\n",
    "created_at": "2013-05-29T09:29:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90714",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90715",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117016"
}
```
...
```json
{
    "body": "Changed dependencies from **#13213, #14550** to **#13213, #9890, #14550**",
    "created_at": "2013-05-29T12:33:25Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90716",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90717",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90718",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9880#issuecomment-90719",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9880#event-117020"
}
```
