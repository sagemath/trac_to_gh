...
```json
{
    "body": "Attachment [trac_9778_latex_prefixes_units.patch](https://github.com/sagemath/sage/files/ticket9778/trac_9778_latex_prefixes_units.patch) by @cousteaulecommandant created at 2010-08-21 20:46:48\n\nAdds `LaTeX` symbols and `SI` prefixes to the units module",
    "created_at": "2010-08-21T20:46:48Z",
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88609",
    "user": "https://github.com/cousteaulecommandant"
}
```

Attachment [trac_9778_latex_prefixes_units.patch](https://github.com/sagemath/sage/files/ticket9778/trac_9778_latex_prefixes_units.patch) by @cousteaulecommandant created at 2010-08-21 20:46:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88610",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88611",
    "user": "https://github.com/cousteaulecommandant"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88612",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88613",
    "user": "https://github.com/kcrisman"
}
```
