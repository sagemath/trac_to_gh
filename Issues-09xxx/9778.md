...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-115534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-115535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-115536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88655",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-88656",
    "user": "https://github.com/kcrisman"
}
```
