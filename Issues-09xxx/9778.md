...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-126777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-126778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-126779"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-126780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-86740",
    "user": "https://github.com/cousteaulecommandant"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9778#event-126781"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-86741",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-86742",
    "user": "https://github.com/cousteaulecommandant"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-86743",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9778#issuecomment-86744",
    "user": "https://github.com/kcrisman"
}
```
