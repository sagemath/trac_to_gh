...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115914",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>On seconds thoughts, this is a portability issue in general, not one specific to HP-UX. So changing the component back. \n\nDave",
    "created_at": "2010-09-13T12:17:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115915",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>On seconds thoughts, this is a portability issue in general, not one specific to HP-UX. So changing the component back. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115916",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24668"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24669"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24670"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24671"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24672"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24673"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115917",
...
```json
{
    "body": "<a id='comment:7'></a>There is no longer a \"blas\" package.",
    "created_at": "2015-09-08T12:45:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115918",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>There is no longer a "blas" package.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24675"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115919",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115920",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9817#event-24677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9817#issuecomment-115921",
