...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120599"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120600"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80403",
    "user": "https://github.com/sagetrac-adam"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120601"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80404",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80405",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80406",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120604"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80407",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80408",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120606"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120608"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80409",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80410",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120609"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120610"
}
```
...
```json
{
    "body": "Changed keywords from **Elliptic Curves, L-series** to **Elliptic Curves, L-series, dokchitser**",
    "created_at": "2013-09-21T12:12:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80411",
    "user": "https://github.com/fchapoton"
}
```

Changed keywords from **Elliptic Curves, L-series** to **Elliptic Curves, L-series, dokchitser**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120611"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120612"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120613"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120614"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120615"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120616"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120617"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80412",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120619"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80413",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80414",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80415",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80416",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80417",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80418",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changed keywords from **Elliptic Curves, L-series, dokchitser** to **Elliptic Curves, lseries, dokchitser**",
    "created_at": "2019-03-09T07:32:18Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9402#issuecomment-80419",
    "user": "https://github.com/fchapoton"
}
```

Changed keywords from **Elliptic Curves, L-series, dokchitser** to **Elliptic Curves, lseries, dokchitser**
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9402#event-120621"
}
```
