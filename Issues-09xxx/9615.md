...
archive/attachments_012758.json:
```json
{
...
```json
{
    "body": "**Attachment:** [9615.patch](https://github.com/sagemath/sage/files/ticket9615/9615.patch)",
    "created_at": "2010-07-28T12:00:01Z",
    "issue": "https://github.com/sagemath/sage/issues/9615",
    "type": "issue_comment",
...
**Attachment:** [9615.patch](https://github.com/sagemath/sage/files/ticket9615/9615.patch)
...
archive/attachments_012759.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [9615.2.patch](https://github.com/sagemath/sage/files/ticket9615/9615.2.patch)\n\nTicket number and somewhat more general comment in commit string.  Apply only this patch.",
    "created_at": "2010-07-28T23:08:06Z",
    "issue": "https://github.com/sagemath/sage/issues/9615",
    "type": "issue_comment",
...
archive/attachments_012761.json:
```json
{
    "asset_content_type": "application/octet-stream",
