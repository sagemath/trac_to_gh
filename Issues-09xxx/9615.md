...
```json
{
    "body": "Changed assignee from **@sagetrac-mvngu** to **@rishikesha**",
    "created_at": "2010-07-28T12:05:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/9615",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-mvngu** to **@rishikesha**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9615#event-113097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9615#event-113098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9615",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9615#event-113099"
}
```
