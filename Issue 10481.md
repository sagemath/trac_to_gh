...
```json
{
    "body": "Remove assignee vdelecroix.",
...
```json
{
    "body": "Set assignee to vdelecroix.",
...
```json
{
    "body": "Attachment [trac_10534-generation_of_subsets_and_set_partitions.2.patch](tarball://root/attachments/some-uuid/ticket10534/trac_10534-generation_of_subsets_and_set_partitions.2.patch) by vdelecroix created at 2012-07-20 11:37:21",
...
Attachment [trac_10534-generation_of_subsets_and_set_partitions.2.patch](tarball://root/attachments/some-uuid/ticket10534/trac_10534-generation_of_subsets_and_set_partitions.2.patch) by vdelecroix created at 2012-07-20 11:37:21
...
```json
{
    "body": "Attachment [trac_10534-generation_of_subsets_and_set_partitions.3.patch](tarball://root/attachments/some-uuid/ticket10534/trac_10534-generation_of_subsets_and_set_partitions.3.patch) by chapoton created at 2012-08-31 19:29:07",
...
Attachment [trac_10534-generation_of_subsets_and_set_partitions.3.patch](tarball://root/attachments/some-uuid/ticket10534/trac_10534-generation_of_subsets_and_set_partitions.3.patch) by chapoton created at 2012-08-31 19:29:07
