...
```json
{
    "body": "It is my intention to dig into the source code of CGSuite and begin to implement this. I already know fairly well the structure of the CGSuite game class, and with that, >, <, incomparable and looking into the canonical form methods this would  give coherent basic functionality for CGT.",
    "created_at": "2015-03-11T19:43:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17665#issuecomment-236096",
    "user": "brett"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17665#issuecomment-236097",
    "user": "brett"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17665#issuecomment-236099",
    "user": "brett"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17665#issuecomment-236100",
    "user": "kcrisman"
}
```
...
```json
{
    "body": "My gut says no, but I honestly don't know.  I'll post on sage-devel... okay, [here](https://groups.google.com/forum/#!topic/sage-devel/wGPPx52-WRU).",
    "created_at": "2015-03-18T01:50:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17665#issuecomment-236102",
    "user": "kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17665#issuecomment-236105",
    "user": "brett"
}
```
