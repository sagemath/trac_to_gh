...
```sage
sage: ShiftedTableau([This is the Trac macro *1,4,5* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1,4,5-macro))
[This is the Trac macro *1, 4, 5* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1, 4, 5-macro)
```
...
...
ValueError: [This is the Trac macro *1, 4, 5* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1, 4, 5-macro) is not an element of Shifted tableaux of shape [3].
```
