...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31332#event-83000"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31332#issuecomment-447585",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31332#event-83001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31332#event-83002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31332#issuecomment-447586",
    "user": "https://github.com/mkoeppe"
}
```
