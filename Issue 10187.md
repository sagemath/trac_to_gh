...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/10187",
...
```json
{
    "body": "I pointed out the executable stack problem of mpir a while ago. They inherited from gmp actually. In actual fact that should be fixed in mpir. In Gentoo we have a patch but we don't know if it removes the executable stack on all cpu models that are affected.",
    "created_at": "2010-10-29T22:32:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103342",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103343",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "I agree that it needs fixing in mpir. The libgcrypt, for example, ships with an `m4/noexecstack.m4` macro. That would be a good starting point for fixing up mpir's autotools, I think.",
    "created_at": "2010-10-29T23:31:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103344",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103346",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103347",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Yes. Or pass `--noexecstack` to gcc. For the official mpir patch I would suggest to use the aforementioned `noexecstack.m4` which checks that the linker understands the `noexecstack` option.\n\nI'm not sure if sticking it unconditionally into the spkg-install is the way to go. I think its supported since gcc-3.4, so that *probably* covers all gcc versions that can compile Sage. Not sure about Solaris...",
    "created_at": "2010-10-31T19:33:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103348",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103349",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103351",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103352",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103353",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Attachment [mpir-spkg-install.diff](tarball://root/attachments/some-uuid/ticket10188/mpir-spkg-install.diff) by @vbraun created at 2010-11-06 21:54:56\n\nI have updated the mpir-1.2.2.p2.spkg to use the LDFLAGS method instead of the exectstack tool.",
    "created_at": "2010-11-06T21:54:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103354",
    "user": "https://github.com/vbraun"
}
```

Attachment [mpir-spkg-install.diff](tarball://root/attachments/some-uuid/ticket10188/mpir-spkg-install.diff) by @vbraun created at 2010-11-06 21:54:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103355",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103356",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103358",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "The spkg from #8664 will not be merged in sage-4.6.1. We should still pull in the spkg from this package and replace it in sage-4.6.2 with the one from #8664.",
    "created_at": "2010-11-23T17:40:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103359",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103360",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103361",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10187#event-10306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103362",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10187#issuecomment-103363",
    "user": "https://github.com/nexttime"
}
```
