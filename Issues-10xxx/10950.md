...
<a id='comment:32'></a>Replying to [comment:26 jdemeyer]:
> Replying to [comment:25 vdelecroix]:
> > Instead of `hash(self.get_unsafe(i, j))` what about introducing `self._entry_hash(i, j)`?
