...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135649",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135650",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I've reported it upstream at http://www.singular.uni-kl.de:8002/trac/ticket/313",
    "created_at": "2011-02-04T01:06:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135651",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>I've reported it upstream at http://www.singular.uni-kl.de:8002/trac/ticket/313
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10739#event-27675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135652",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135653",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Upstream agrees that the changes are correct, although they want to introduce a new label because it is also used for binary packages. Since we have our own labels for binary distributions, we can just use the original workaround until the next upstream release.\n\nI've made an updated singular spkg. Franco, can you test it?\n\nI also tried to upgrade Singular to 3-1-2, but found that rather complicated since the location of many headers moved.",
    "created_at": "2011-02-04T17:58:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135654",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Upstream agrees that the changes are correct, although they want to introduce a new label because it is also used for binary packages. Since we have our own labels for binary distributions, we can just use the original workaround until the next upstream release.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135655",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135656",
...
```json
{
    "body": "<a id='comment:6'></a>You can force-install (-f) the spkg from the command line via\n\n```\nsage -f http://www.stp.dias.ie/~vbraun/Sage/spkg/singular-3-1-1-4.p4.spkg\n```",
    "created_at": "2011-02-04T20:09:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135657",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>You can force-install (-f) the spkg from the command line via
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135658",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>you can do that too, just put the new singular spkg in `$SAGE_ROOT/spkg/standard`. The build will use the newest version in that directory. But considering that this is just a small build fix I don't think that its necessary to go through a completely fresh build...",
    "created_at": "2011-02-04T20:26:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135659",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>you can do that too, just put the new singular spkg in `$SAGE_ROOT/spkg/standard`. The build will use the newest version in that directory. But considering that this is just a small build fix I don't think that its necessary to go through a completely fresh build...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135660",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135662",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135663",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I agree that this is a good opportunity to debug #9310; I'll mark this as positive review and move the conversation to #9310.",
    "created_at": "2011-02-05T03:27:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135664",
    "user": "https://github.com/saliola"
}
```

<a id='comment:11'></a>I agree that this is a good opportunity to debug #9310; I'll mark this as positive review and move the conversation to #9310.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10739#event-27676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135665",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10739#issuecomment-135666",
    "user": "https://github.com/jdemeyer"
}
```
