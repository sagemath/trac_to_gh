...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10465#event-125186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10465#event-125187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10465#event-125188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10465#issuecomment-100146",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10465#issuecomment-100147",
    "user": "https://github.com/rbeezer"
}
```
