...
```json
{
    "body": "Patch updated with more documentation: more comments within code, a new doctest, more explanation about what's expected of the input graph to `kruskal()`.",
...
```json
{
    "body": "Update patch to use the set data structure during the process of removing multiple edges.",
...
```json
{
    "body": "Positive review to this patch ! It passes \"testall -long\", and is a very nice piece of work (plus the beginning of a new module) `:-)`\n\nThank you very much for your patience, Minh ! `:-)`\n\nNathann",
    "created_at": "2010-12-27T19:52:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10433",
    "type": "issue_comment",
...
```json
{
    "body": "The fixing about the results of a search for \"tree\" in the doc has been fixed elsewhere ! \n\nHere is a rebased version of the patch !\n\nNathann",
...
```json
{
    "body": "Attachment [trac-10433-rebased-4.6.2.alpha0.patch](tarball://root/attachments/some-uuid/ticket10433/trac-10433-rebased-4.6.2.alpha0.patch) by @jdemeyer created at 2011-01-19 22:23:28",
