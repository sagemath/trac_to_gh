...
```json
{
    "body": "<a id='comment:1'></a>Has anyone else seen this problem, possibly on other machines?",
    "created_at": "2010-10-06T05:16:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10082#issuecomment-106285",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>Has anyone else seen this problem, possibly on other machines?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10082#issuecomment-106287",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10082#issuecomment-106288",
...
```json
{
    "body": "<a id='comment:4'></a>I've now also seen the problem in the description on menas.  For me, it seems the `math` module is installed, since I can run `./sage -python` and `import` it, at least, without problems.\n\nIs this a parallel build problem?  Reinstalling the package serially works.\n\nCould we do better than sleep for an arbitrary three seconds?",
    "created_at": "2010-10-07T22:48:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10082#issuecomment-106289",
    "user": "https://github.com/qed777"
}
```

<a id='comment:4'></a>I've now also seen the problem in the description on menas.  For me, it seems the `math` module is installed, since I can run `./sage -python` and `import` it, at least, without problems.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10082#issuecomment-106290",
    "user": "https://github.com/qed777"
}
```
