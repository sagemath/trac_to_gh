...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10273#issuecomment-126161",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Sorry for the noise, it was already mentionned here: #7952\n\nHowever the patch to maxima was not included yet.",
    "created_at": "2010-11-15T16:46:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10273#issuecomment-126162",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>Sorry for the noise, it was already mentionned here: #7952
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10273#issuecomment-126163",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10273#issuecomment-126164",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10273",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10273#event-26417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10273#event-26418"
}
```
