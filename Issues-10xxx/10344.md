...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10344#issuecomment-127878",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This is fixed by #11763, which brings sanity to coercion as a side-effect:\n\n```\nsage: Polyhedron(vertices=[vector(RR, [1/2, 3/4]), vector(RR, [4, 5])])\nA 1-dimensional polyhedron in RDF^2 defined as the convex hull of 2 vertices\n```",
    "created_at": "2012-05-24T22:37:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10344#issuecomment-127880",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>This is fixed by #11763, which brings sanity to coercion as a side-effect:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10344#issuecomment-127881",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10344#event-26600"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10344#issuecomment-127882",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10344#issuecomment-127883",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10344#issuecomment-127884",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10344",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10344#event-26601"
}
```
