...
```json
{
    "body": "<a id='comment:1'></a>More fundamentally, a (Krull) dimension should not be negative, should it?",
    "created_at": "2012-11-13T11:24:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135048",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```

<a id='comment:1'></a>More fundamentally, a (Krull) dimension should not be negative, should it?
...
```json
{
    "body": "<a id='comment:2'></a>Well I don't mind denoting the dimension of the emtpy set at -1. Or, in this case, the supremum of the lengths of the elements of the empty set. Its of course more a matter of definition...",
    "created_at": "2012-11-13T17:35:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135049",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Well I don't mind denoting the dimension of the emtpy set at -1. Or, in this case, the supremum of the lengths of the elements of the empty set. Its of course more a matter of definition...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135051",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135052",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The problem *could* be caused by the fact that `neglex` is not a \"monomial order\" in the usual sense, as it is not Well-founded:\n\n```\nsage: R.<x,y> = PolynomialRing(QQ, order='neglex')\nsage: 1 > x > x^2 > x^3 > x^4\nTrue\n```\n\nThis clearly is an infinite descending chain.",
    "created_at": "2012-11-14T09:07:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135053",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```

<a id='comment:5'></a>The problem *could* be caused by the fact that `neglex` is not a "monomial order" in the usual sense, as it is not Well-founded:
...
```json
{
    "body": "<a id='comment:6'></a>Thats definitely the problem, but how to fix it?",
    "created_at": "2012-11-14T10:29:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135054",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>Thats definitely the problem, but how to fix it?
...
```json
{
    "body": "<a id='comment:11'></a>I concur that \"neglex\" should not be allowed as a term order on a *polynomial ring*. Instead, we can have `LocalPolynomialRing` or something similar that interfaces somehow with this functionality in singular.\n\nThis looks like an abuse of terminology on the side of Singular. Probably one that is algorithmically very advantageous for them, but you clearly need to work very carefully with these rings, because there are now \"units\" in the ring for which the inverse is not expressible in the representation used:\n\n```\nsage: R.<x,y>=PolynomialRing(QQ,order='neglex')\nsage: (1+x).is_unit()\nTrue\nsage: 1/(1+x)\n1\nsage: (1+x) * (1/(1+x))\n1 + x\n```\n\nI am sure the functionality in singular is very useful, but we can't expose it in the way we're doing here.",
    "created_at": "2015-02-19T17:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135059",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:11'></a>I concur that "neglex" should not be allowed as a term order on a *polynomial ring*. Instead, we can have `LocalPolynomialRing` or something similar that interfaces somehow with this functionality in singular.
...
```json
{
    "body": "<a id='comment:13'></a>See new discussion about this on [sage-devel](https://groups.google.com/forum/#!topic/sage-devel/nDoUXqpJ6OU).",
    "created_at": "2020-04-13T07:15:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10708#issuecomment-135060",
    "user": "https://github.com/soehms"
}
```

<a id='comment:13'></a>See new discussion about this on [sage-devel](https://groups.google.com/forum/#!topic/sage-devel/nDoUXqpJ6OU).
