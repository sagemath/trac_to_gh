...
```json
{
    "body": "Changed assignee from **@sagetrac-GeorgSWeber** to **@kiwifb**",
    "created_at": "2010-10-07T22:40:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10092",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-GeorgSWeber** to **@kiwifb**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10092",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10092#event-120338"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10092#event-120339"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10092#event-120340"
}
```
