...
archive/attachments_013736.json:
```json
{
...
```json
{
    "body": "**Changing work issues** from \"Going over margins\" to \"\".",
    "created_at": "2010-11-12T07:05:56Z",
    "issue": "https://github.com/sagemath/sage/issues/10146",
    "type": "issue_comment",
...
**Changing work issues** from "Going over margins" to "".
...
archive/attachments_013737.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "STE.pdf",
...
archive/attachments_013738.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Changing work issues** from \"spacing before/after sagecommandline\" to \"update spkg to the latest version of SageTeX\".",
...
**Changing work issues** from "spacing before/after sagecommandline" to "update spkg to the latest version of SageTeX".
...
```json
{
    "body": "**Changing work issues** from \"update spkg to the latest version of SageTeX\" to \"\".",
    "created_at": "2011-06-16T16:55:47Z",
    "issue": "https://github.com/sagemath/sage/issues/10146",
    "type": "issue_comment",
...
**Changing work issues** from "update spkg to the latest version of SageTeX" to "".
