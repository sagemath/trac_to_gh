...
```json
{
    ...
    "type": "issue",
    "updated_at": "2011-04-05T12:00:26Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120810"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120811"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120812"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120813"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120814"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120815"
}
```
...
```json
{
    "body": "**Attachment:** [trac_10836-primitive.patch.gz](https://github.com/sagemath/sage/files/ticket10836/trac_10836-primitive.patch.gz)",
...
**Attachment:** [trac_10836-primitive.patch.gz](https://github.com/sagemath/sage/files/ticket10836/trac_10836-primitive.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120816"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120817"
}
```
...
```json
{
    "body": "**Attachment:** [trac_10836.patch.gz](https://github.com/sagemath/sage/files/ticket10836/trac_10836.patch.gz)\n\napply only this patch",
...
**Attachment:** [trac_10836.patch.gz](https://github.com/sagemath/sage/files/ticket10836/trac_10836.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120818"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120819"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120825"
}
```
...
```json
{
    "body": "<a id='comment:18'>**Comment 18:**</a>\n**Attachment:** [trac_10836.2.patch.gz](https://github.com/sagemath/sage/files/ticket10836/trac_10836.2.patch.gz)\n\nHad to fix one tiny thing for the note to look right.  Positive review.\n\nApply only [attachment:trac_10836.2.patch](https://github.com/sagemath/sage/files/ticket10836/trac_10836.2.patch).",
    "created_at": "2011-03-25T13:50:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10836",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120829"
}
```
...
```json
{
    "body": "**Attachment:** [10836_additional.patch.gz](https://github.com/sagemath/sage/files/ticket10836/10836_additional.patch.gz)",
...
**Attachment:** [10836_additional.patch.gz](https://github.com/sagemath/sage/files/ticket10836/10836_additional.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10836",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10836#event-120835"
}
```
