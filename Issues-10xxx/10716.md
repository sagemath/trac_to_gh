...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124733"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124737"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,5 @@\n Multivariate polynomials over the Singular interface have several degree methods but not a weighted_degree function, often used in certain branches of discrete mathematics. This should be implemented.\n+\n+**Apply**\n+1. [attachment: trac_10716_adding_weighted_degree_v2.patch.gz](https://github.com/sagemath/sage/files/ticket10716/trac_10716_adding_weighted_degree_v2.patch.gz)\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,4 @@\n Multivariate polynomials over the Singular interface have several degree methods but not a weighted_degree function, often used in certain branches of discrete mathematics. This should be implemented.\n \n-**Apply**\n-1. [attachment: trac_10716_adding_weighted_degree_v2.patch.gz](https://github.com/sagemath/sage/files/ticket10716/trac_10716_adding_weighted_degree_v2.patch.gz)\n+**Apply** [attachment: trac_10716_adding_weighted_degree_v2.patch.gz](https://github.com/sagemath/sage/files/ticket10716/trac_10716_adding_weighted_degree_v2.patch.gz)\n \n``````\n",
    "created_at": "2011-04-29T13:36:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10716",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124741"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n Multivariate polynomials over the Singular interface have several degree methods but not a weighted_degree function, often used in certain branches of discrete mathematics. This should be implemented.\n \n-**Apply** [attachment: trac_10716_adding_weighted_degree_v2.patch.gz](https://github.com/sagemath/sage/files/ticket10716/trac_10716_adding_weighted_degree_v2.patch.gz)\n+**Apply** [attachment: trac_10716_adding_weighted_degree_alternative.patch.gz](https://github.com/sagemath/sage/files/ticket10716/trac_10716_adding_weighted_degree_alternative.patch.gz)\n \n``````\n",
    "created_at": "2013-02-20T15:50:43Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10716",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124742"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124743"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124744"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124745"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124746"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124752"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124753"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124754"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124755"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124757"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124758"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124759"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124760"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10716",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10716#event-124762"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10716#issuecomment-104942",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10716#issuecomment-104943",
    "user": "https://github.com/kcrisman"
}
```
