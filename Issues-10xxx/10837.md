...
{
    "assignees": [],
    "body": "Three new methods for matrices and vectors over RDF/CDF, directly wrapping functions from `NumPy/SciPy`.\n\n---\n\n**Apply:**\n\n1. [attachment: trac_10837-norms-condition-CDF-v2.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-v2.patch.gz)\n2. [attachment: trac_10837-norms-condition-CDF-edits-v3.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v3.patch.gz)\n3. [attachment: trac-10837-norms-condition-CDF-review-v2.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac-10837-norms-condition-CDF-review-v2.patch.gz)\n4. [attachment: trac_10837-numerical-noise-solaris.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-numerical-noise-solaris.patch.gz)\n\n\nDepends on #10839\n\nAssignee: **@jasongrout, @williamstein**\n\nCC:  mhampton @vbraun @haraldschilly @haikona mraum\n\nKeywords: **matrix, condition, norm**\n\nAuthor: **Rob Beezer, Martin Raum**\n\nReviewer: **Simon Spicer, Martin Raum, Rob Beezer, Jeroen Demeyer**\n\nMerged: **sage-4.7.2.alpha4**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/10837_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10837#event-131040"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10837#event-131041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10837#event-131042"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,3 @@\n Three new methods for matrices and vectors over RDF/CDF, directly wrapping functions from `NumPy/SciPy`.\n \n-Apply trac_10837-norms-condition-CDF.patch, trac_10837-norms-condition-CDF-edits-v2.patch\n+Apply [and [attachment: trac_10837-norms-condition-CDF-edits-v2.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v2.patch.gz)(https://github.com/sagemath/sage/files/ticket10837/8704839e25094e57cc4e95305cdafce2.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,3 @@\n Three new methods for matrices and vectors over RDF/CDF, directly wrapping functions from `NumPy/SciPy`.\n \n-Apply [and [attachment: trac_10837-norms-condition-CDF-edits-v2.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v2.patch.gz)(https://github.com/sagemath/sage/files/ticket10837/8704839e25094e57cc4e95305cdafce2.gz)\n+Apply [and [attachment: trac_10837-norms-condition-CDF-edits-v3.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v3.patch.gz)(https://github.com/sagemath/sage/files/ticket10837/8704839e25094e57cc4e95305cdafce2.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,11 @@\n Three new methods for matrices and vectors over RDF/CDF, directly wrapping functions from `NumPy/SciPy`.\n \n-Apply [and [attachment: trac_10837-norms-condition-CDF-edits-v3.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v3.patch.gz)(https://github.com/sagemath/sage/files/ticket10837/8704839e25094e57cc4e95305cdafce2.gz)\n+---\n+\n+**Depends on:**\n+\n+**Apply:**\n+1. [attachment: trac_10837-norms-condition-CDF.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF.patch.gz)\n+2. [attachment: trac_10837-norms-condition-CDF-edits-v3.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v3.patch.gz)\n+\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,6 +6,6 @@\n \n 1. [attachment: trac_10837-norms-condition-CDF.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF.patch.gz)\n 2. [attachment: trac_10837-norms-condition-CDF-edits-v3.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-edits-v3.patch.gz)\n-3. [attachment: trac_10837-norms-condition-CDF-review.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-review.patch.gz)\n-4. [attachment: trac_10837-norms-condition-CDF-review2.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-norms-condition-CDF-review2.patch.gz)\n+3. [attachment: trac-10837-norms-condition-CDF-review.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac-10837-norms-condition-CDF-review.patch.gz)\n+4. [attachment: trac-10837-norms-condition-CDF-review2.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac-10837-norms-condition-CDF-review2.patch.gz)\n \n``````\n",
    "created_at": "2011-08-14T11:06:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10837",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:44'>Comment 44:</a>\nPositive review for [attachment: trac_10837-numerical-noise-solaris.patch.gz](https://github.com/sagemath/sage/files/ticket10837/trac_10837-numerical-noise-solaris.patch.gz).  I haven't tested it on Solaris, but that will happen later.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10837#issuecomment-107047",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10837#issuecomment-107048",
    "user": "https://github.com/jdemeyer"
}
```
