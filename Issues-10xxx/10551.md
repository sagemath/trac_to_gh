...
```json
{
    "body": "<a id='comment:2'></a>What was the command used to create that graphic?",
...
<a id='comment:2'></a>What was the command used to create that graphic?
...
<a id='comment:3'></a>Replying to [gbe](#comment%3A2):
> What was the command used to create that graphic?
...
```json
{
    "body": "<a id='comment:4'></a>This appears to be fixed now. It can be closed after adding doctests.",
...
<a id='comment:4'></a>This appears to be fixed now. It can be closed after adding doctests.
