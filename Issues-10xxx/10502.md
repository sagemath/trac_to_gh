...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10502#event-26931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10502#issuecomment-130112",
    "user": "https://github.com/eviatarbach"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Maybe `sage.combinat.finite_state_machine.Automaton` is of interest for this implementation.",
    "created_at": "2014-04-23T17:58:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10502#issuecomment-130113",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:3'></a>Maybe `sage.combinat.finite_state_machine.Automaton` is of interest for this implementation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10502#issuecomment-130114",
