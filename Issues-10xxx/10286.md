...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10286#event-123302"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10286#event-123303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10286#event-123304"
}
```
...
```json
{
    "body": "<a id='comment:5'>Comment 5:</a>\nThe patch [attachment: trac_10286_call_jmol_correctly.patch.gz](https://github.com/sagemath/sage/files/ticket10286/trac_10286_call_jmol_correctly.patch.gz) will be used on #9232 instead.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10286#issuecomment-98018",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10286#issuecomment-98019",
