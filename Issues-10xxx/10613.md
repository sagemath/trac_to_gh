...
```json
{
    "body": "<a id='comment:1'></a>If you leave out the dimensions (which would be inferred from the vector), it is possible to build a matrix from a vector.\n\n```\nsage: w=vector(QQ, [1,2,3])\nsage: A = Matrix(QQ, w); A\n[1 2 3]\nsage: A.parent()\nFull MatrixSpace of 1 by 3 dense matrices over Rational Field\n```",
    "created_at": "2011-01-13T01:41:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10613#issuecomment-133259",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>If you leave out the dimensions (which would be inferred from the vector), it is possible to build a matrix from a vector.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27321"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27322"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27323"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27324"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27325"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27326"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10613#issuecomment-133260",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10613#issuecomment-133261",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10613",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27328"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27329"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10613#event-27330"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Fixed in #24742",
    "created_at": "2018-03-01T16:20:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10613#issuecomment-133262",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Fixed in #24742
