...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10670#event-128432"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10670#event-128433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10670#event-128434"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,5 +11,9 @@\n P.mobius_function_matrix().change_ring(ZZ).parent()\n Full MatrixSpace of 5 by 5 sparse matrices over Integer Ring\n ```\n+The patch just does this by default.\n \n-The patch just does this be default.\n+\n+Apply:\n+\n+* [attachment: trac_10670_integral_mobius_matrix_for_posets-fc.patch.gz](https://github.com/sagemath/sage/files/ticket10670/trac_10670_integral_mobius_matrix_for_posets-fc.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10670#issuecomment-104412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10670#issuecomment-104413",
    "user": "https://github.com/jdemeyer"
}
```
