...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134667",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134668",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134669",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134671",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134672",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134673",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I've updated the spkg to call `ranlib libtachyon.a`. For some inexplicable reason, the tachyon makefile defaults to not running ranlib. This seems to break at least some Xcode versions.\n\nI've tested the change on my Fedora 14 box, bsd.math (OSX) and t2.math (Solaris). In all cases ranlib works as expected. Not sure why tachyon defaults to not using it...\n\nwdj: This should now definitely fix the \"ld: in ../compile/macosx/libtachyon.a, archive has no table of contents\" bug. Please confirm.",
    "created_at": "2011-01-24T21:45:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134674",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>I've updated the spkg to call `ranlib libtachyon.a`. For some inexplicable reason, the tachyon makefile defaults to not running ranlib. This seems to break at least some Xcode versions.
...
```json
{
    "body": "<a id='comment:4'></a>It looks like you updated \"Make-arch\" without updating \"Make-arch.patch\".  Also, is it too drastic to turn ranlib on everywhere, when it used to be off everywhere?  Would it be better just to turn it on for macosx? Or maybe just undo the changes for various platforms at #5281 where you removed all of the `RANLIB = ...` lines?",
    "created_at": "2011-01-24T23:52:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134675",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>It looks like you updated "Make-arch" without updating "Make-arch.patch".  Also, is it too drastic to turn ranlib on everywhere, when it used to be off everywhere?  Would it be better just to turn it on for macosx? Or maybe just undo the changes for various platforms at #5281 where you removed all of the `RANLIB = ...` lines?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134676",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134677",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134678",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134679",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134680",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134681",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134682",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10681#issuecomment-134683",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10681#event-27533"
}
```
