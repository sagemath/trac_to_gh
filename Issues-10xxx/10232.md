...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10232#issuecomment-97226",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "title_was": "MIP backends should perform bounds checks",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10232#event-122531"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10232#event-122532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10232",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10232#event-122533"
}
```
