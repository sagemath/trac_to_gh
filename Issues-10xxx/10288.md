...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126433",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126435",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>In the gentoo ebuild cooked initially by Christopher, we pass CXX, COMPILE, LINK and LINKGUI to make. So we have a make invocation that looks like this:\n\n```\nmake -j1 CXX=${cxxcompiler) COMPILE=\"${cxxcompiler) ${CXXFLAGS}\" \\\n         LINK=\"$(cxxcompiler) ${LDFLAGS}\" LINKGUI=\"$(cxxcompiler) ${LDFLAGS}\"\n```\nOf course you need to add the target on specific platform. Finally I am not sure\nwe need LINKGUI since it is for producing a wxwidget apps and it has its own target\naccording to the compilation instructions. That is you need target=wxunx on unix like systems.",
    "created_at": "2010-11-19T08:28:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126436",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>In the gentoo ebuild cooked initially by Christopher, we pass CXX, COMPILE, LINK and LINKGUI to make. So we have a make invocation that looks like this:
...
```json
{
    "body": "<a id='comment:7'></a>Oops, that bit of code needs to be:\n\n```\nif [ \"x$SAGE64\" = xyes ] ; then\n   CXXFLAGS=\"$CXXFLAGS CXXFLAG64\"\nfi\n```\n\n\nwhich will addend -m64 (or another flag if needed) to CXXFLAGS on 64-bit builds.",
    "created_at": "2010-11-19T15:13:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126438",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>Oops, that bit of code needs to be:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126439",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126440",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126441",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I've posted an updated spkg and accompanying patch.  This may not be done as efficiently as possible, but it builds for me on OS X 10.6, OpenSolaris on x86 (hawk), and sage.math, all of which with SAGE64 unset and then again SAGE64 set.  I have yet to test it on the skynet machines.",
    "created_at": "2010-11-19T22:22:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126442",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>I've posted an updated spkg and accompanying patch.  This may not be done as efficiently as possible, but it builds for me on OS X 10.6, OpenSolaris on x86 (hawk), and sage.math, all of which with SAGE64 unset and then again SAGE64 set.  I have yet to test it on the skynet machines.
...
```json
{
    "body": "<a id='comment:10'></a>By the way, if you want to install and test it, if the spkg seems to install okay, you can execute the following commands in Sage.  The first homology computation should be a lot faster than the second; I'm showing timings on my 2-year-old iMac:\n\n```\nsage: S3 = simplicial_complexes.Sphere(3)\nsage: X = S3.product(S3)\nsage: time X.homology()\nCPU times: user 0.03 s, sys: 0.02 s, total: 0.05 s\nWall time: 0.48 s\n{0: 0, 1: 0, 2: 0, 3: Z x Z, 4: 0, 5: 0, 6: Z}\nsage: time X.homology(algorithm='no_chomp')\nCPU times: user 15.71 s, sys: 0.17 s, total: 15.87 s\nWall time: 16.31 s\n{0: 0, 1: 0, 2: 0, 3: Z x Z, 4: 0, 5: 0, 6: Z}\n```",
    "created_at": "2010-11-20T00:54:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126443",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>By the way, if you want to install and test it, if the spkg seems to install okay, you can execute the following commands in Sage.  The first homology computation should be a lot faster than the second; I'm showing timings on my 2-year-old iMac:
...
```json
{
    "body": "<a id='comment:11'></a>The new patch for the scripts repo adds the CHomP binaries \"homsimpl\", \"homchain\", and \"homcubes\" to SAGE_ROOT/local/bin/.hgignore.",
    "created_at": "2010-11-20T19:36:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126444",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>The new patch for the scripts repo adds the CHomP binaries "homsimpl", "homchain", and "homcubes" to SAGE_ROOT/local/bin/.hgignore.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126445",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [trac_10288-scripts-hgignore.patch](tarball://root/attachments/some-uuid/ticket10288/trac_10288-scripts-hgignore.patch) by drkirkby created at 2010-11-21 00:34:23\n\nIs there a new .spkg to test? The one in the link given in the description lack anything to handle the SAGE64=yes case.",
    "created_at": "2010-11-21T00:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126446",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:12'></a>Attachment [trac_10288-scripts-hgignore.patch](tarball://root/attachments/some-uuid/ticket10288/trac_10288-scripts-hgignore.patch) by drkirkby created at 2010-11-21 00:34:23
...
```json
{
    "body": "<a id='comment:14'></a>Sorry about the grammar in my last comment. There are too many spelling/grammatical errors to even start to address them individually!",
    "created_at": "2010-11-21T00:39:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126448",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:14'></a>Sorry about the grammar in my last comment. There are too many spelling/grammatical errors to even start to address them individually!
...
```json
{
    "body": "<a id='comment:15'></a>I updated the spkg when I posted the new patch, so it does deal with 64-bit issues.  (In general, if I update the patch here, I should also have updated the spkg.)  I can also make the change to SPKG.txt.",
    "created_at": "2010-11-21T00:59:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126449",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>I updated the spkg when I posted the new patch, so it does deal with 64-bit issues.  (In general, if I update the patch here, I should also have updated the spkg.)  I can also make the change to SPKG.txt.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126450",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [trac_10288.patch](tarball://root/attachments/some-uuid/ticket10288/trac_10288.patch) by @jhpalmieri created at 2010-11-21 01:10:59\n\nOkay, I've changed SPKG.txt a little, as Dave suggested.",
    "created_at": "2010-11-21T01:10:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126451",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>Attachment [trac_10288.patch](tarball://root/attachments/some-uuid/ticket10288/trac_10288.patch) by @jhpalmieri created at 2010-11-21 01:10:59
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126452",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126455",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126456",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126457",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126458",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Although experimental packages don't need a review, I filled in the author and reviewer fields, since this has undergone a review. \n\nDave",
    "created_at": "2010-11-21T08:53:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126459",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:21'></a>Although experimental packages don't need a review, I filled in the author and reviewer fields, since this has undergone a review. 
...
```json
{
    "body": "<a id='comment:22'></a>.hgignore patch will be merged",
    "created_at": "2010-12-02T16:08:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126460",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>.hgignore patch will be merged
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126461",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10288#event-26465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10288#issuecomment-126462",
    "user": "https://github.com/jdemeyer"
}
```
