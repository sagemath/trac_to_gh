...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131111"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131112"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131114"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91949",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91950",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91951",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91952",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91953",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91954",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131116"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91956",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91957",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91958",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91959",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91960",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91961",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91962",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<div id=\"comment:14\" align=\"right\">comment:14</div>\n\nReplying to [@nilesjohnson](#comment:12):\n> I applied this patch, and the one at #10053.  With these, sage passes all (`-long`) doctests (linux, with Red Hat Enterprise).  Note that the remaining issue, [comment 9](https://github.com/sagemath/sage/issues/10041#comment:9) above, appears because this patch addresses comparison only for coordinate patches, not differential form algebras or differential form elements.  Since these *are* addressed by #10053, this ticket can get positive review when that one does.\n\n\n#10053 now has positive review.",
    "created_at": "2010-10-11T21:33:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91963",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91964",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91965",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10041#event-131120"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10041#issuecomment-91966",
    "user": "https://github.com/qed777"
}
```
