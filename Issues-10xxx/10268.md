...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126074",
    "user": "https://trac.sagemath.org/admin/accounts/users/bgoodri"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_10268_enhance_simplify_rational.patch](tarball://root/attachments/some-uuid/ticket10268/trac_10268_enhance_simplify_rational.patch) by bgoodri created at 2010-11-15 15:52:28",
    "created_at": "2010-11-15T15:52:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126075",
    "user": "https://trac.sagemath.org/admin/accounts/users/bgoodri"
}
```

<a id='comment:1'></a>Attachment [trac_10268_enhance_simplify_rational.patch](tarball://root/attachments/some-uuid/ticket10268/trac_10268_enhance_simplify_rational.patch) by bgoodri created at 2010-11-15 15:52:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126076",
    "user": "https://trac.sagemath.org/admin/accounts/users/bgoodri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126078",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126079",
    "user": "https://trac.sagemath.org/admin/accounts/users/bgoodri"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Ben Goodrich\"",
    "created_at": "2010-11-16T16:12:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126080",
    "user": "https://github.com/burcin"
}
```

Changing author from "" to "Ben Goodrich"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126082",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26396"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26397"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26398"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26399"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26400"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26401"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10268#event-26402"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Pynac's `normal()` was made accessible by `Expression` in #12068, so this patch can take advantage of it. The gcd error can be worked around optionally with Pynac-0.6.7 and libgiac if it is installed (#20742). This speeds up the GCD by an order of mag versus Pynac and two orders of mag versus pexpect-Maxima.",
    "created_at": "2016-06-11T13:42:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10268#issuecomment-126088",
    "user": "https://github.com/rwst"
}
```

<a id='comment:16'></a>Pynac's `normal()` was made accessible by `Expression` in #12068, so this patch can take advantage of it. The gcd error can be worked around optionally with Pynac-0.6.7 and libgiac if it is installed (#20742). This speeds up the GCD by an order of mag versus Pynac and two orders of mag versus pexpect-Maxima.
