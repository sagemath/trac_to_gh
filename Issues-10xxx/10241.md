...
```json
{
    "body": "**Attachment:** [install](https://github.com/sagemath/sage/files/ticket10241/install)\n\nUnified diff, for review purposes only. The install file is not in a repository",
    "created_at": "2010-11-09T21:59:54Z",
    "issue": "https://github.com/sagemath/sage/issues/10241",
    "type": "issue_comment",
...
**Attachment:** [install](https://github.com/sagemath/sage/files/ticket10241/install)
...
archive/attachments_013887.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [install.diff](https://github.com/sagemath/sage/files/ticket10241/install.diff)",
    "created_at": "2010-11-09T22:02:28Z",
    "issue": "https://github.com/sagemath/sage/issues/10241",
    "type": "issue_comment",
