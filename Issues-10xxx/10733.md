...
```json
{
    "body": "<a id='comment:1'></a>NOTE: The patches in this ticket require #10734 to be applied first.",
    "created_at": "2011-02-03T01:45:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135490",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:1'></a>NOTE: The patches in this ticket require #10734 to be applied first.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135491",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>There are no doctests to illustrate the new functionality added by this patch.",
    "created_at": "2011-03-21T19:16:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135492",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>There are no doctests to illustrate the new functionality added by this patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135493",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135495",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I replaced the patch by a new version. In the new version, I copied the test twice, so it's always run for 100x100 matrices (5% density) and optionally (long) run for 1000x1000 matrices (1% density).\n\nThe test for 100x100 matrices takes about 0.1 s, so it's ok. I think it's still a useful test since it runs the algorithm switching to dense at several different columns.\n\nThe test for 1000x1000 takes about 25 s (I changed the modulus from 97 to 997) and it's still optional (long). Is that too long for a \"long\" test?",
    "created_at": "2011-03-24T04:01:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135496",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:5'></a>I replaced the patch by a new version. In the new version, I copied the test twice, so it's always run for 100x100 matrices (5% density) and optionally (long) run for 1000x1000 matrices (1% density).
...
```json
{
    "body": "<a id='comment:6'></a>PS: 500x500  with 1% density takes about 5s, so we may want to replace the 1000x1000 test by a 500x500 test (and still make it long time optional).",
    "created_at": "2011-03-24T04:02:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135497",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:6'></a>PS: 500x500  with 1% density takes about 5s, so we may want to replace the 1000x1000 test by a 500x500 test (and still make it long time optional).
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10733#event-27649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135498",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135500",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Comment: I haven't run the full test suite yet -- will report back later...",
    "created_at": "2011-04-08T06:29:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135502",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>Comment: I haven't run the full test suite yet -- will report back later...
...
```json
{
    "body": "<a id='comment:12'></a>Test suite run and it fully passes for me.   Gonzalo (say) needs to review patch 4 and then this can get a positive review.",
    "created_at": "2011-04-08T15:37:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135503",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:12'></a>Test suite run and it fully passes for me.   Gonzalo (say) needs to review patch 4 and then this can get a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135504",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135506",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>For the record, this is what I think could be used for mod2 sparse via dense:\n\n```\n   dense = self.dense_matrix()\n   dense.echelonize()\n   self.set_block_unsafe(0, 0, dense)\n```\nThe last step does the conversion from dense to sparse, and it's way faster than calling dense.matrix_sparse(), but it's still slow.",
    "created_at": "2011-04-08T18:34:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135507",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:14'></a>For the record, this is what I think could be used for mod2 sparse via dense:
...
```json
{
    "body": "<a id='comment:16'></a>Note that the \"switch_density=0\" case is already tested by the doctests so there's no need to add another doctest after patch 06.",
    "created_at": "2011-04-08T19:26:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135509",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:16'></a>Note that the "switch_density=0" case is already tested by the doctests so there's no need to add another doctest after patch 06.
...
```json
{
    "body": "<a id='comment:17'></a>Positive review (on the two extra little patches added, hence everything)!",
    "created_at": "2011-04-08T19:43:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135510",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:17'></a>Positive review (on the two extra little patches added, hence everything)!
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10733#event-27650"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10733#event-27651"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10733#event-27652"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10733#event-27653"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Moving the milestone since this depends on a non-positively-reviewed ticket.",
    "created_at": "2011-04-20T15:06:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135511",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>Moving the milestone since this depends on a non-positively-reviewed ticket.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#10734\"",
    "created_at": "2011-05-27T07:51:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135512",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#10734"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135513",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-feature",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10733#event-27654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135514",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135515",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135516",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135517",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135518",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135519",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>apply trac_10733.01-echelon_better_verbose, trac_10733.02-echelon_make_faster, trac_10733.03-documentation, trac_10733.04-referee_refactor_to_support_p2.2.patch, trac_10733.05-doctest_mod2.patch, trac_10733.06-fastpath_for_strictly_dense_method.patch",
    "created_at": "2011-06-15T12:55:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135521",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:23'></a>apply trac_10733.01-echelon_better_verbose, trac_10733.02-echelon_make_faster, trac_10733.03-documentation, trac_10733.04-referee_refactor_to_support_p2.2.patch, trac_10733.05-doctest_mod2.patch, trac_10733.06-fastpath_for_strictly_dense_method.patch
...
```json
{
    "body": "<a id='comment:24'></a>Please fill in your real name as Reviewer.",
    "created_at": "2012-07-27T20:44:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135522",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>Please fill in your real name as Reviewer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135523",
...
```json
{
    "body": "Changing reviewer from \"\" to \"William Stein, Gonzalo Tornar\u00eda\"",
    "created_at": "2013-12-20T17:58:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135524",
    "user": "https://github.com/vbraun"
}
```

Changing reviewer from "" to "William Stein, Gonzalo Tornaría"
...
```json
{
    "body": "<a id='comment:26'></a>I'm setting this to needs works since its not a git branch.",
    "created_at": "2015-03-12T23:55:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135525",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:26'></a>I'm setting this to needs works since its not a git branch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10733#issuecomment-135526",
    "user": "https://github.com/vbraun"
}
```
