...
```json
{
    "body": "Here's a patch; it seemed like the simplest thing to do.  This way the \"pivots\" method returns a copy of the list of pivots, not the mutable list itself.",
...
```json
{
    "body": "Okay, here's a new patch.  This should return tuples for pivots.  Also, everywhere pivots get cached, tuples should be cached, not lists.  (This way, when the cached value is retrieved, converting it to a tuple, just to be on the safe side, is really fast: try doing `a = tuple(range(1000)); timeit('tuple(a)')`.)\n\nAll doctests pass on sage.math.",
    "created_at": "2011-03-22T21:31:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10752",
    "type": "issue_comment",
