...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129546"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129548"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129549"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105472",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105473",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129552"
}
```
...
```json
{
    "body": "Changed keywords from **** to **matrix pivots**",
    "created_at": "2011-03-21T22:22:41Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105474",
    "user": "https://github.com/jhpalmieri"
}
```

Changed keywords from **** to **matrix pivots**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105475",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105476",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105477",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105478",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105479",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105480",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105481",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105482",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105483",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105484",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105485",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10752#issuecomment-105486",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10752#event-129560"
}
```
