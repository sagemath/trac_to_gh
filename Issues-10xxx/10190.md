...
```json
{
    ...
    "type": "issue",
    "updated_at": "2014-03-19T04:38:29Z",
    "url": "https://github.com/sagemath/sage/issues/10190",
...
```json
{
    ...
    "created_at": "2010-10-30T09:34:52Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "milestone_number": null,
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133589"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133592"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94504",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94505",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,5 @@\n Add a new chapter to the Developer's Guide on advanced uses of Mercurial.\n+\n+See the following URL for the rebuilt Developer's Guide after applying the patch [attachment: trac-10190_advanced-mercurial.patch](https://github.com/sagemath/sage/files/ticket10190/trac-10190_advanced-mercurial.patch.gz) to Sage 4.6.rc0:\n+\n+http://mvngu.googlecode.com/hg/10190-mercurial/index.html\n``````\n",
    "created_at": "2010-10-30T12:45:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94506",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94507",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94508",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94509",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94510",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94511",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94512",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94513",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94514",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133598"
}
```
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "title_is": "developer's guide: warnings & notes about commit message, cloning and setting the text editor",
    "title_was": "developer's guide: new chapter \"Advanced Mercurial Usage\"",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133599"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94515",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94516",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "Attachment: **[trac-10190_mercurial.patch.gz](https://github.com/sagemath/sage/files/ticket10190/trac-10190_mercurial.patch.gz)**",
    "created_at": "2010-11-01T11:32:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94517",
    "user": "https://github.com/sagetrac-mvngu"
}
```

Attachment: **[trac-10190_mercurial.patch.gz](https://github.com/sagemath/sage/files/ticket10190/trac-10190_mercurial.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94518",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94519",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94520",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94521",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94522",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94523",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133601"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94524",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94525",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133602"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133603"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133604"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133606"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133607"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94526",
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94527",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10190#issuecomment-94528",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10190",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10190#event-133615"
}
```
