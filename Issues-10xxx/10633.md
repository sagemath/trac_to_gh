...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10633#event-123652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10633#event-123653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10633#event-123654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10633#issuecomment-103677",
    "user": "https://github.com/kcrisman"
}
```
