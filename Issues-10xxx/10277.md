...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/10277",
...
```json
{
    "body": "<a id='comment:1'></a>(1) The performance comparison to Mathematica is invalid since Mathematica only returns a pseudoprime, and for that (proof=False), sage is actually much faster than Mathematica already.\n\n(2) On both 32 and 64-bit Linux I can not reproduce this. \n\n```\n\nsage: random_prime(2^40+1,lbound=12)\n477618500201\nsage: sys.maxint\n2147483647\n```\n\nAnd reading the source code I can't see what this has to do with prime_pi.  I'm tempted to mark this ticket invalid if there isn't further info.",
    "created_at": "2010-11-16T07:11:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10277",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10277#issuecomment-109727",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>(1) The performance comparison to Mathematica is invalid since Mathematica only returns a pseudoprime, and for that (proof=False), sage is actually much faster than Mathematica already.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10277",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10277#event-26424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10277",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10277#issuecomment-109728",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>prime_pi was being called as a result of a bug in the patch at #10112. Since that patch has never been committed to Sage, it is indeed an invalid bug report. I'm closing it as invalid.",
    "created_at": "2010-11-17T02:20:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10277",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10277#issuecomment-109729",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>prime_pi was being called as a result of a bug in the patch at #10112. Since that patch has never been committed to Sage, it is indeed an invalid bug report. I'm closing it as invalid.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10277#event-26425"
}
```
