...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10662#event-128324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10662#event-128325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10662#event-128326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10662#issuecomment-104166",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10662#issuecomment-104167",
    "user": "https://github.com/nthiery"
}
```
