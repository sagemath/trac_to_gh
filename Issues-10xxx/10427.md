...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128529",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128530",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Here is a new version of the patch.  I've added a comment about rm being necessary.  I didn't want to make Solaris a special case, because other systems like HP UX may have the same problem, and we might as well have code that works as widely as possible.",
    "created_at": "2010-12-05T22:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128531",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Here is a new version of the patch.  I've added a comment about rm being necessary.  I didn't want to make Solaris a special case, because other systems like HP UX may have the same problem, and we might as well have code that works as widely as possible.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128532",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Other comments: I'm not touch sage-sage beyond what's required for this ticket, regardless of the state of the rest of that file.\n\nAny issues with devel/sage/spkg-install should be dealt with elsewhere.\n\nFinally, this intentionally misses one instance of quoting at the end of sage-build, since the quotes were added by the patch at #10303.",
    "created_at": "2010-12-05T22:41:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128533",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Other comments: I'm not touch sage-sage beyond what's required for this ticket, regardless of the state of the rest of that file.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128534",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128535",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128536",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The \"sage-clone\" in the commit message should read \"sage -clone\" (which refers to `sage-sage`'s option; `sage-clone` is a Python script).\n\nApplies cleanly on Sage 4.6.1.alpha2, positive review.\n\nFeel free to change the comment etc. if you like, I'll then review again.",
    "created_at": "2010-12-06T01:46:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128537",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>The "sage-clone" in the commit message should read "sage -clone" (which refers to `sage-sage`'s option; `sage-clone` is a Python script).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128538",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128539",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128540",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128541",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128542",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128543",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10427#event-26709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128545",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10427#issuecomment-128546",
    "user": "https://github.com/jdemeyer"
}
```
