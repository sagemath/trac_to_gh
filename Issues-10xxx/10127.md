...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10127#issuecomment-95131",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10127#issuecomment-95132",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10127#issuecomment-95133",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10127#issuecomment-95134",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_10127_free_module_basis_key_initialisation-nb.patch](https://github.com/sagemath/sage/files/ticket10127/trac_10127_free_module_basis_key_initialisation-nb.patch) by nborie created at 2010-10-15 14:20:48\n\nTest and Doc are ok!\n\nMore important than the patch, thanks for giving this precise description of the problem...\n\nI give this patch a positive review.",
    "created_at": "2010-10-15T14:20:48Z",
    "issue": "https://github.com/sagemath/sage/issues/10127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10127#issuecomment-95135",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10127#issuecomment-95136",
