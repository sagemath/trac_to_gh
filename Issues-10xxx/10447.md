...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-124966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-124967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-124968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-99940",
    "user": "https://github.com/sagetrac-jrp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-99941",
    "user": "https://github.com/sagetrac-jrp"
}
```
