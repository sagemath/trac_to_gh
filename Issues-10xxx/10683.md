...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10683#event-128702"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10683#event-128703"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10683#event-128704"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,4 +4,4 @@\n \n Depends #10536\n \n-Apply trac_10683-hermitian_inner_product-v2.patch, trac_10683-vector-products-docs-v2.patch\n+Apply [attachment: trac_10683-hermitian_inner_product-v2.patch.gz](https://github.com/sagemath/sage/files/ticket10683/trac_10683-hermitian_inner_product-v2.patch.gz) and [attachment: trac_10683-vector-products-docs-v2.patch.gz](https://github.com/sagemath/sage/files/ticket10683/trac_10683-vector-products-docs-v2.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10683#issuecomment-104673",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10683#issuecomment-104674",
    "user": "https://github.com/rbeezer"
}
```
