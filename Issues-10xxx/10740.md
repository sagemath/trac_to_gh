...
```json
{
    "body": "<a id='comment:1'></a>See also [this ask.sagemath.org question](http://ask.sagemath.org/question/1823/).  It would be nice for someone to implement e.g. `axes_arrows=True` or even `axes_arrows=[True,False]` for the different directions or something.",
    "created_at": "2012-10-02T00:32:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10740#issuecomment-117638",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>See also [this ask.sagemath.org question](http://ask.sagemath.org/question/1823/).  It would be nice for someone to implement e.g. `axes_arrows=True` or even `axes_arrows=[True,False]` for the different directions or something.
...
```json
{
    "body": "<a id='comment:3'></a>See also this [ask.sagemath.org question](http://ask.sagemath.org/question/2632/how-can-i-add-arrows-at-the-end-of-sage-plot-axis)",
    "created_at": "2013-06-01T11:24:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10740#issuecomment-117639",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:3'></a>See also this [ask.sagemath.org question](http://ask.sagemath.org/question/2632/how-can-i-add-arrows-at-the-end-of-sage-plot-axis)
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27677"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27678"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27679"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27680"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27681"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27682"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10740#event-27683"
}
```
