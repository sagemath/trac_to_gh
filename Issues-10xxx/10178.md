...
```json
{
    "body": "<a id='comment:1'></a>I can confirm this by doing a print preview using Firefox. A work around is to collapse the side bar. You can do this by clicking on the slim bar that divides the side bar to the left and the documentation to the right. Then do a print preview again using Firefox; the reported problem should then be fixed. As this ticket now stands, I'm inclined to think it can be closed as invalid.",
    "created_at": "2010-10-27T14:22:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10178#issuecomment-124037",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>I can confirm this by doing a print preview using Firefox. A work around is to collapse the side bar. You can do this by clicking on the slim bar that divides the side bar to the left and the documentation to the right. Then do a print preview again using Firefox; the reported problem should then be fixed. As this ticket now stands, I'm inclined to think it can be closed as invalid.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10178#issuecomment-124038",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26057"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26058"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26059"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26060"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26061"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26062"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10178#event-26063"
}
```
