...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10774#event-129857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10774#event-129858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10774#event-129859"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10774#issuecomment-105781",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10774#issuecomment-105782",
    "user": "https://github.com/jdemeyer"
}
```
