...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122627"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10239#issuecomment-97318",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122629"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout** to **@jasongrout, @sagetrac-jkantor**",
    "created_at": "2010-11-08T21:11:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10239#issuecomment-97319",
    "user": "https://github.com/jdemeyer"
}
```

Changed assignee from **@jasongrout** to **@jasongrout, @sagetrac-jkantor**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10239",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10239#event-122636"
}
```
