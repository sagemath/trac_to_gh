...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10852#event-131274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10852#event-131275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10852#event-131276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10852#issuecomment-107225",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10852#issuecomment-107226",
    "user": "https://github.com/sagetrac-stumpc5"
}
```
