...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119805",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119806",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119807",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Please document the `latex_prefix` argument to `CombinatorialFreeModule`.  See #9370 for one suggestion.  (If you could merge this ticket with #9370, that would be great, too.)",
    "created_at": "2011-02-25T23:56:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119808",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Please document the `latex_prefix` argument to `CombinatorialFreeModule`.  See #9370 for one suggestion.  (If you could merge this ticket with #9370, that would be great, too.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119809",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10852#event-28092"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>The patch is folded into #9370, so this ticket is obsolete.\n\nChristian",
    "created_at": "2011-03-12T12:28:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119810",
    "user": "https://trac.sagemath.org/admin/accounts/users/stumpc5"
}
```

<a id='comment:4'></a>The patch is folded into #9370, so this ticket is obsolete.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10852#issuecomment-119811",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10852#event-28093"
}
```
