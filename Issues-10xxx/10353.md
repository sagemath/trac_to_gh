...
archive/attachments_014054.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac10353-db-removal.patch](https://github.com/sagemath/sage/files/ticket10353/trac10353-db-removal.patch)\n\nthis patch remove reference to zodb from the sage library",
    "created_at": "2013-01-04T10:16:48Z",
    "issue": "https://github.com/sagemath/sage/issues/10353",
    "type": "issue_comment",
...
**Attachment:** [trac10353-db-removal.patch](https://github.com/sagemath/sage/files/ticket10353/trac10353-db-removal.patch)
...
archive/attachments_014055.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:14'></a>\n**Attachment:** [trac10353-sage_root.patch](https://github.com/sagemath/sage/files/ticket10353/trac10353-sage_root.patch)\n\nPatch updated.",
    "created_at": "2013-01-07T10:07:52Z",
    "issue": "https://github.com/sagemath/sage/issues/10353",
    "type": "issue_comment",
