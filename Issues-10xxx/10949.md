...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10949#issuecomment-108501",
    "user": "https://github.com/sagetrac-weaam"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10949#issuecomment-108502",
    "user": "https://github.com/sagetrac-weaam"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-132482"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-132483"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-132484"
}
```
