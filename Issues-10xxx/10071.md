...
```json
{
    "body": "<a id='comment:1'></a>This is related to #10034, which is about making it possible for *all* held functions to be evaluated without using Maxima or `n()`.  This ticket, however, is about three held functions which can't even be evaluated with Maxima and `n()`, much less Pynac natively.",
    "created_at": "2010-10-06T14:30:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10071#issuecomment-121899",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>This is related to #10034, which is about making it possible for *all* held functions to be evaluated without using Maxima or `n()`.  This ticket, however, is about three held functions which can't even be evaluated with Maxima and `n()`, much less Pynac natively.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25626"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25627"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25628"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25629"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25630"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25631"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10071#event-25632"
}
```
