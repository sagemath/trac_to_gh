...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-119030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-119031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-119032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-93350",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-93351",
    "user": "https://github.com/sagetrac-nborie"
}
```
