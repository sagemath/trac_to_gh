...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99133",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99134",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_10346_eigenvectors_right.patch](https://github.com/sagemath/sage/files/ticket10346/trac_10346_eigenvectors_right.patch) by @jvkersch created at 2010-11-27 05:57:27\n\nThis seems to be in the vein of #6934, so I'm CC-ing the authors/reviewers of that patch.",
    "created_at": "2010-11-27T05:57:27Z",
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99135",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99136",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99137",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99138",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99139",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10346#issuecomment-99140",
