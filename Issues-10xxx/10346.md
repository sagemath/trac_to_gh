...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127885",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127886",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127887",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_10346_eigenvectors_right.patch](tarball://root/attachments/some-uuid/ticket10346/trac_10346_eigenvectors_right.patch) by @jvkersch created at 2010-11-27 05:57:27\n\nThis seems to be in the vein of #6934, so I'm CC-ing the authors/reviewers of that patch.",
    "created_at": "2010-11-27T05:57:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127888",
    "user": "https://github.com/jvkersch"
}
```

<a id='comment:1'></a>Attachment [trac_10346_eigenvectors_right.patch](tarball://root/attachments/some-uuid/ticket10346/trac_10346_eigenvectors_right.patch) by @jvkersch created at 2010-11-27 05:57:27
...
```json
{
    "body": "<a id='comment:2'></a>No \"r\" in beezer.  ;-)\n\nCorrected and may review this soon.",
    "created_at": "2010-12-02T07:12:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127889",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:2'></a>No "r" in beezer.  ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127890",
    "user": "https://github.com/jvkersch"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Looks real good.  Not sure how we missed not doing that as well when the left eigenvectors got straightened out.  Thanks for the contribution.\n\nApplies to 4.6.1.alpha2, passes all tests, HTML documentation looks good, behaves as advertised.  So, positive review.",
    "created_at": "2010-12-03T18:24:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127891",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:5'></a>Looks real good.  Not sure how we missed not doing that as well when the left eigenvectors got straightened out.  Thanks for the contribution.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127892",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127893",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10346#event-26609"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10346#event-26610"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10346#event-26611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127894",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10346#issuecomment-127895",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10346",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10346#event-26612"
}
```
