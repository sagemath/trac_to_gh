...
```json
{
    "body": "<a id='comment:1'></a>\nThe pointer _entries remains uninitialised for empty matrices but the m4ri function\u00a0`_mzd_mul_`naive does address it. \u00a0The attached patch fixes this.",
    "created_at": "2011-04-06T16:59:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10858",
    "type": "issue_comment",
