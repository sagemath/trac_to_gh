...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10325#issuecomment-100292",
    "user": "https://github.com/vbraun"
}
```
...
archive/attachments_013510.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_10325_make_toric_CohomologyRing_unique.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket10325/trac_10325_make_toric_CohomologyRing_unique.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10325#issuecomment-100293",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10325#event-80771"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10325#event-80772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10325#event-80773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10325#issuecomment-100294",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10325#issuecomment-100295",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10325#issuecomment-100296",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10325#event-80774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10325",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10325#event-80775"
}
```
