...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10424#event-124631"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10424#event-124632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10424#event-124633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10424#issuecomment-99651",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10424#issuecomment-99652",
    "user": "https://github.com/jdemeyer"
}
```
