...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139401",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139402",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139403",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The patch solves the bug. It also changes the output of is_gamma0_equiv. Now, we give back all of the matrix , not just the upper left entry.\nThe patch does not change the output of _is_equiv in boundary.py of modular_symbols.\n\nThe disadvantage is that the computations may be slightly slower, but only by a few gcd calculations at worst. On the other hand I believe that the output now is much more useful for the user.",
    "created_at": "2011-03-13T22:49:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139404",
    "user": "https://github.com/categorie"
}
```

<a id='comment:1'></a>The patch solves the bug. It also changes the output of is_gamma0_equiv. Now, we give back all of the matrix , not just the upper left entry.
The patch does not change the output of _is_equiv in boundary.py of modular_symbols.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139405",
...
```json
{
    "body": "<a id='comment:4'></a>I will do these changes. Would you think it better if the optional argument had three values like False, True, \"matrix\" and would give back None, an integer, a matrix respectively ? This would maintain the backwards compatibility.",
    "created_at": "2011-03-16T10:26:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139407",
    "user": "https://github.com/categorie"
}
```

<a id='comment:4'></a>I will do these changes. Would you think it better if the optional argument had three values like False, True, "matrix" and would give back None, an integer, a matrix respectively ? This would maintain the backwards compatibility.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139408",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139409",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139410",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139413",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139414",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139415",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10926#event-28285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139416",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10926#event-28286"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10926",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10926#issuecomment-139417",
    "user": "https://github.com/jdemeyer"
}
```
