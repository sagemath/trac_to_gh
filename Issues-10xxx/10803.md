...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10803#event-130353"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10803#event-130354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10803#event-130355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10803#issuecomment-106360",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10803#issuecomment-106361",
    "user": "https://github.com/jdemeyer"
}
```
