...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10960#event-132645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10960#event-132646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10960#event-132647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10960#issuecomment-108716",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10960#issuecomment-108717",
    "user": "https://github.com/orlitzky"
}
```
