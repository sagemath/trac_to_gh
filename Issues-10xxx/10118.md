...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116684"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116688"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,8 @@\n As the subject says. See this [sage-devel](http://groups.google.com/group/sage-devel/browse_thread/thread/8bad71b8a6a8382e) thread for some background on why we need to upgrade [Sphinx](http://sphinx.pocoo.org/).\n+\n+**Apply:**\n+\n+1. Prerequisite: #9850.\n+2. The upgraded Sphinx package at http://sage.math.washington.edu/home/mvngu/spkg/standard/sphinx/sphinx-1.0.4.p0.spkg. For reference, my patch for that spkg is [attachment: trac-10118_sphinx-spkg.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sphinx-spkg.patch.gz), but do not apply that patch; it's already applied to the upgraded spkg.\n+3. Apply [attachment: trac-10118_sage-lib.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sage-lib.patch.gz) to the Sage library.\n+4. Apply [attachment: trac-10118_sagenb.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sagenb.patch.gz) to the Sage notebook library.\n``````\n",
    "created_at": "2010-11-08T17:12:27Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
...
```json
{
    "body": "Changed keywords from **** to **sphinx spkg**",
...
Changed keywords from **** to **sphinx spkg**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116692"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,6 +2,10 @@\n \n **Apply:** (starting from sage-4.6.1.alpha1)\n \n-1. The upgraded Sphinx package at [http://sage.math.washington.edu/home/jdemeyer/spkg/sphinx-1.0.4.p1.spkg](http://sage.math.washington.edu/home/jdemeyer/spkg/sphinx-1.0.4.p1.spkg) (or [http://sage.math.washington.edu/home/jdemeyer/spkg/sphinx-1.0.4.p2.spkg](http://sage.math.washington.edu/home/jdemeyer/spkg/sphinx-1.0.4.p2.spkg) which uses *patch* and depends on #9418).\n-2. Apply [attachment: trac-10118_sage-lib.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sage-lib.patch.gz) to the Sage library.\n-3. Apply [attachment: trac-10118_sagenb.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sagenb.patch.gz) to the Sage notebook library.\n+1. The patch package [http://sage.math.washington.edu/home/jdemeyer/spkg/patch-2.5.9.spkg](http://sage.math.washington.edu/home/jdemeyer/spkg/patch-2.5.9.spkg) (see #9418)\n+2. The Sphinx package at [http://sage.math.washington.edu/home/jdemeyer/spkg/sphinx-1.0.4.p3.spkg](http://sage.math.washington.edu/home/jdemeyer/spkg/sphinx-1.0.4.p3.spkg)\n+3. Apply [attachment: trac-10118_sage-lib.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sage-lib.patch.gz) to the Sage library.\n+4. Apply [attachment: 10118_sphinx_sagelib.patch.gz](https://github.com/sagemath/sage/files/ticket10118/10118_sphinx_sagelib.patch.gz) to the Sage library.\n+5. Apply [attachment: trac-10118_sagenb.patch.gz](https://github.com/sagemath/sage/files/ticket10118/trac-10118_sagenb.patch.gz) to the Sage notebook library.\n+\n+See also #10290 (Upgrade Pygments to version 1.3.1) for syntax highlighting to work properly.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95069",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95070",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95071",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95072",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95073",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95074",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95076",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95077",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95078",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95079",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95080",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95081",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116697"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10118#event-116698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95082",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10118#issuecomment-95083",
    "user": "https://github.com/nexttime"
}
```
