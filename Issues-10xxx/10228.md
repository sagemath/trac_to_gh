...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97144",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97146",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97147",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_10228-review-optimize_delta.patch](https://github.com/sagemath/sage/files/ticket10228/trac_10228-review-optimize_delta.patch) by mraum created at 2010-11-06 09:26:47\n\nEverything passes fine. I only adapted the documentation (adding missing ') and I changed the exception to by Python 3 compatible. If your are fine with all these minor changes, give this a positive review.",
    "created_at": "2010-11-06T09:26:47Z",
    "issue": "https://github.com/sagemath/sage/issues/10228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97148",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97149",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97150",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10228#issuecomment-97151",
