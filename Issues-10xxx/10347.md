...
<a id='comment:6'></a>Replying to [comment:5 hthomas]:
...
<a id='comment:7'></a>Replying to [comment:4 stumpc5]:
> Replying to [comment:3 chapoton]:
> 
> > Then the buildbot will be more happy.
...
<a id='comment:13'></a>Replying to [comment:11 hthomas]:
...
<a id='comment:16'></a>Replying to [comment:15 hthomas]:
...
<a id='comment:19'></a>Replying to [comment:18 hthomas]:
...
<a id='comment:27'></a>Replying to [comment:26 hthomas]:
...
<a id='comment:29'></a>Replying to [comment:28 hthomas]:
> I have confused matters by uploading a second patch.  I meant it to replace my other patch.  I don't see how to remove attached patches, or I would fix this.  (Nor could I easily find an explanation in the documentation.)  How do you do it?
