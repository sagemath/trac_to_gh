...
```json
{
    "body": "<a id='comment:1'></a>The patch in #9826 fixes this.",
    "created_at": "2011-04-11T18:05:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10901",
    "type": "issue_comment",
...
<a id='comment:1'></a>The patch in #9826 fixes this.
...
```json
{
    "body": "<a id='comment:2'></a>In the meantime, this seems to've been fixed already:\n\n```\nsage: sage: f.roots(RR)\n---------------------------------------------------------------------------\nTypeError                                 Traceback (most recent call last)\n...\nTypeError: Cannot evaluate symbolic expression to a numeric value.\n```",
    "created_at": "2012-02-29T15:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10901",
    "type": "issue_comment",
...
<a id='comment:2'></a>In the meantime, this seems to've been fixed already:
...
<a id='comment:4'></a>I confirm that the issue is resolved.
