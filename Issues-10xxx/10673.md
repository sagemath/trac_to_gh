...
```json
{
    "body": "Changed assignee from **@sagetrac-sage-combinat** to **@nthiery**",
...
Changed assignee from **@sagetrac-sage-combinat** to **@nthiery**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10673#event-128520"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10673#event-128521"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10673#event-128522"
}
```
