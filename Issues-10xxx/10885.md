...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10885#event-131653"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10885#event-131654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10885#event-131655"
}
```
...
```json
{
    "body": "<a id='comment:14'>Comment 14:</a>\nIn the commit message of [attachment: trac10855-efficiency_improvment_bug_correction.patch.gz](https://github.com/sagemath/sage/files/ticket10885/trac10855-efficiency_improvment_bug_correction.patch.gz), the ticket number should be fixed.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10885#issuecomment-107536",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10885#issuecomment-107537",
    "user": "https://github.com/jdemeyer"
}
```
