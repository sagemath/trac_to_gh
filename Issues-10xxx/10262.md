...
```json
{
    "body": "<a id='comment:2'></a>FWIW, I've found when building on Solaris with a special library for memory allocation, which allows leaks to be detected, before I got to the \n\n```\nsage: \n```\n\nthere was already memory leaked. I think it was only 14 bytes, but once I did a few calculations, more showed up. I think there are quite a few in Sage. Of course, some are more serious than others, but whatever the amount of memory leaked, it shows there's a coding error. \n\nDave",
    "created_at": "2010-11-14T04:17:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-125996",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>FWIW, I've found when building on Solaris with a special library for memory allocation, which allows leaks to be detected, before I got to the 
...
```json
{
    "body": "<a id='comment:3'></a>As I mentioned on the thread, I tracked this down to a call from the coercion system to create an element of the parent.  The coercion system did this when it was trying to figure out the action of the number on the vector:\n\nThe problem seems to stem from the lines\n\n```\n     cdef Element x = X.an_element()\n     cdef Element y = Y.an_element()\n```\n\ninside of the `detect_element_action` function in `coerce_actions.pyx`.  Notice:\n\n```\nsage: v=vector(range(10000))\nsage: get_memory_usage()\n206.84765625\nsage: w=v.parent().an_element()\nsage: get_memory_usage()\n3321.14453125 \n```",
    "created_at": "2010-11-14T04:35:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-125997",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>As I mentioned on the thread, I tracked this down to a call from the coercion system to create an element of the parent.  The coercion system did this when it was trying to figure out the action of the number on the vector:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-125998",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Why is this a blocker?",
    "created_at": "2010-11-18T13:30:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-125999",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Why is this a blocker?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126000",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126001",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This might also be related to #10570 since that ticket shows that there are call stack frames in the coerce_actions framework which stay alive for some reason.",
    "created_at": "2011-01-08T01:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126002",
    "user": "https://github.com/koffie"
}
```

<a id='comment:7'></a>This might also be related to #10570 since that ticket shows that there are call stack frames in the coerce_actions framework which stay alive for some reason.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126003",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>sorry uploaded a patch to the wrong ticket",
    "created_at": "2011-03-23T20:23:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126004",
    "user": "https://github.com/koffie"
}
```

<a id='comment:9'></a>sorry uploaded a patch to the wrong ticket
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10262#event-26382"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10262#event-26383"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10262#event-26384"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Turns out there is already a more polished version of the fix I was suggesting at #13304.",
    "created_at": "2014-03-16T12:41:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126006",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:13'></a>Turns out there is already a more polished version of the fix I was suggesting at #13304.
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10262#event-26385"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10262#event-26386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126007",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"13304\"",
    "created_at": "2014-03-16T14:30:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126008",
    "user": "https://github.com/dimpase"
}
```

Changing dependencies from "" to "13304"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126009",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>perhaps this ticket should at least provide a doctest that this issue is fixed by #13304?",
    "created_at": "2014-03-16T14:30:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126010",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:15'></a>perhaps this ticket should at least provide a doctest that this issue is fixed by #13304?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126011",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126012",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126013",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10262#event-26387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10262#issuecomment-126014",
