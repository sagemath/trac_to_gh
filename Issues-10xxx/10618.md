...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10618/sandpile-2.3.patch",
...
```json
{
    "body": "adds module to graphs folder and the all.py in graphs",
    "created_at": "2011-01-13T04:36:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10618",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10618/trac_10618_sandpiles.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10618/trac_10618_sandpiles.2.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10618/trac_10618_sandpiles.3.patch",
