...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10156/10156_doc.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10156/10156_scripts.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10156/10156_upgrade.patch",
...
```json
{
    "body": "Additional scripts patch: rename makefile to Makefile during upgrade",
    "created_at": "2010-11-10T08:39:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10156",
    "type": "issue_comment",
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "install",
    "asset_url": "tarball://root/attachments/some-uuid/ticket10156/install",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket10156/install.patch",
