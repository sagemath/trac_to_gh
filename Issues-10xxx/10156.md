...
{
    "assignees": [],
    "body": "This ticket has a few patches which should be applied when renaming `makefile` to `Makefile`.  See also #9799.\n\nApply:\n1. [attachment: 10156_doc.patch.gz](https://github.com/sagemath/sage/files/ticket10156/10156_doc.patch.gz)\n2. [attachment: 10156_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket10156/10156_scripts.patch.gz)\n3. [attachment: install.patch.gz](https://github.com/sagemath/sage/files/ticket10156/install.patch.gz)\n\nCC:  @jhpalmieri @nexttime\n\nKeywords: **scripts makefile**\n\nAuthor: **Jeroen Demeyer, John Palmieri**\n\nReviewer: **Volker Braun**\n\nMerged: **sage-4.6.1.alpha1**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/10156_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10156#event-121290"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10156#event-121291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10156#event-121292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10156#issuecomment-95713",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10156#issuecomment-95714",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
