...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10018#event-119146"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10018#event-119147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10018#event-119148"
}
```
...
```json
{
    "body": "<a id='comment:24'>Comment 24:</a>\nI can't reproduce it either.  I don't really see the point of trying to find out why this bug existed, since #9678 essentially rewrote the whole error-handling code.\n\nWhat is the status of [attachment: 10018_pari_sig_retry.patch.gz](https://github.com/sagemath/sage/files/ticket10018/10018_pari_sig_retry.patch.gz)?  Assuming that this bug has indeed disappeared, is the patch still relevant for the general plan to improve the PARI error handling mechanism (cf. #9640, #14894)?",
    "created_at": "2013-09-09T18:55:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10018",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'>Comment 26:</a>\nI don't have much time to think of this now, but [attachment: 10018_pari_sig_retry.patch\u200b.gz](https://github.com/sagemath/sage/files/ticket10018/462f78503961afbac8c94b1a2fccdfe6.gz) is indeed changing the PARI error handling mechanism. Let's first look at #9640 and then at this patch.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10018#issuecomment-93492",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10018#issuecomment-93493",
    "user": "https://github.com/jdemeyer"
}
```
