...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116587"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116599"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116605"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,6 +36,6 @@\n Dave \n \n Apply\n-1. [attachment: trac_10112.patch]\n-2. [attachment: trac_10112-replacement-extra.patch]\n+1. [attachment: trac_10112.patch.gz](https://github.com/sagemath/sage/files/ticket10112/trac_10112.patch.gz)\n+2. [attachment: trac_10112-replacement-extra.patch.gz](https://github.com/sagemath/sage/files/ticket10112/trac_10112-replacement-extra.patch.gz)\n to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116608"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -38,4 +38,5 @@\n Apply\n 1. [attachment: trac_10112.patch.gz](https://github.com/sagemath/sage/files/ticket10112/trac_10112.patch.gz)\n 2. [attachment: trac_10112-replacement-extra.patch.gz](https://github.com/sagemath/sage/files/ticket10112/trac_10112-replacement-extra.patch.gz)\n+3. [attachment: trac_10112-ascii.patch.gz](https://github.com/sagemath/sage/files/ticket10112/trac_10112-ascii.patch.gz)\n to the Sage library.\n``````\n",
    "created_at": "2011-11-11T22:48:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10112#issuecomment-94977",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10112#issuecomment-94978",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116609"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10112#event-116610"
}
```
