...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10135#issuecomment-95352",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10135#issuecomment-95353",
    "user": "https://github.com/sagetrac-brunellus"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10135#event-120976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10135#event-120977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10135",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10135#event-120978"
}
```
