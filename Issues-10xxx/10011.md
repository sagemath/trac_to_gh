...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10011/trac_10011-make_sage-update_flush_output-scripts_repo.patch",
    "created_at": "2010-09-25T03:00:48Z",
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10011/trac_10011-make_sage-update_flush_output-scripts_repo.patch",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Attachment [trac_10011-make_sage-update_flush_output-scripts_repo.patch](https://github.com/sagemath/sage/files/ticket10011/trac_10011-make_sage-update_flush_output-scripts_repo.patch) by @nexttime created at 2010-09-25 03:00:48\n\nApply to scripts repo. Based on Sage 4.6.alpha1.",
    "created_at": "2010-09-25T03:00:48Z",
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10011#issuecomment-93331",
    "user": "https://github.com/nexttime"
}
```

Attachment [trac_10011-make_sage-update_flush_output-scripts_repo.patch](https://github.com/sagemath/sage/files/ticket10011/trac_10011-make_sage-update_flush_output-scripts_repo.patch) by @nexttime created at 2010-09-25 03:00:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10011#issuecomment-93332",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10011#issuecomment-93333",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10011#issuecomment-93334",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10011#issuecomment-93335",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10011#issuecomment-93336",
    "user": "https://github.com/jdemeyer"
}
```
