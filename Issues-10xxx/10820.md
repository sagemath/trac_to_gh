...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sage/issues/10820",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10820/spkg-install.patch",
    "created_at": "2011-02-22T05:37:41Z",
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10820/spkg-install.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "Attachment [spkg-install.patch](https://github.com/sagemath/sage/files/ticket10820/spkg-install.patch) by Snark created at 2011-02-22 05:37:41\n\nPatch to make tachyon work on ARM (to apply to spkg-install)",
    "created_at": "2011-02-22T05:37:41Z",
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106612",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

Attachment [spkg-install.patch](https://github.com/sagemath/sage/files/ticket10820/spkg-install.patch) by Snark created at 2011-02-22 05:37:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106613",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106614",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83972"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106615",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106616",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83973"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83974"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106617",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83975"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106618",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106619",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106620",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83977"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83978"
}
```
...
archive/attachments_014175.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "tachyon-0.98.9_for_ARM",
    "asset_url": "tarball://root/attachments/ticket10820/tachyon-0.98.9_for_ARM",
    "created_at": "2011-03-13T11:05:51Z",
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10820/tachyon-0.98.9_for_ARM",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "Attachment [tachyon-0.98.9_for_ARM](https://github.com/sagemath/sage/files/ticket10820/tachyon-0.98.9_for_ARM) by Snark created at 2011-03-13 11:05:51\n\nMercurial patch",
    "created_at": "2011-03-13T11:05:51Z",
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106621",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

Attachment [tachyon-0.98.9_for_ARM](https://github.com/sagemath/sage/files/ticket10820/tachyon-0.98.9_for_ARM) by Snark created at 2011-03-13 11:05:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106622",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83979"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83980"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83981"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106623",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106624",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10820#event-83985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106625",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106626",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10820#issuecomment-106627",
