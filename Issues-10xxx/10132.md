...
```json
{
    "body": "Changed assignee from **@sagetrac-mhampton** to **@sagetrac-mikarm**",
...
Changed assignee from **@sagetrac-mhampton** to **@sagetrac-mikarm**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,3 @@\n This patch aims to implement a class for embedded surfaces in the three dimensional euclidean space described by a parametrization. Its focus on the computation of metric invariants (first and second fundamental forms, Gaussian curvature, ...) and more involved geometry (geodesics, ...).\n \n-Apply trac_10132_revised_sage-5.10.patch\n-\n-Tested under sage-5.10\n+Apply [attachment: trac_10132_revised_sage-5.10.patch](https://github.com/sagemath/sage/files/ticket10132/trac_10132_revised_sage-5.10.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10132#event-120933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10132#event-120934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10132",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10132#event-120935"
}
```
