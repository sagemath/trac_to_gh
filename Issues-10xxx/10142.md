...
```json
{
    "body": "Sorry for the delay... I'll be just a few more days (at most). I've been very busy on another project. I know this qualifies as spam... but I want you to know I do intend to provide more information.",
...
```json
{
    "body": "To release manager: Just FYI that this was closed by the OP.\n\nI guess we really need that new config for the actions!",
