...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95471",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95472",
    "user": "https://github.com/sagetrac-mister-wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-121070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-121071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-121072"
}
```
