...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95427",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95428",
    "user": "https://trac.sagemath.org/admin/accounts/users/mister.wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95429",
    "user": "https://trac.sagemath.org/admin/accounts/users/mister.wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95430",
    "user": "https://github.com/kcrisman"
}
```
