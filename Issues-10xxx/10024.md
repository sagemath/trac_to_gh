...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120784",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120785",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120786",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120787",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10024#event-25418"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Patch fixes `load`/`dump` and adds comparisons, for example, `P<=Q` means `P` is a not-necessarily-strict subpolyhedron of `Q`.",
    "created_at": "2010-10-24T18:59:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120788",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Patch fixes `load`/`dump` and adds comparisons, for example, `P<=Q` means `P` is a not-necessarily-strict subpolyhedron of `Q`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120789",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120791",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120792",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10024#event-25419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120793",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10024#issuecomment-120794",
    "user": "https://github.com/jdemeyer"
}
```
