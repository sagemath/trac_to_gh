...
```json
{
    "body": "**Attachment:** [install](https://github.com/sagemath/sage/files/ticket10572/install)\n\nspkg/install with the wrapper spkg added",
    "created_at": "2011-01-10T03:39:54Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
**Attachment:** [install](https://github.com/sagemath/sage/files/ticket10572/install)
...
```json
{
    "body": "**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket10572/deps)\n\ndiff for spkg/install",
    "created_at": "2011-01-10T03:41:13Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket10572/deps)
...
```json
{
    "body": "**Attachment:** [gccwrapper-install.patch](https://github.com/sagemath/sage/files/ticket10572/gccwrapper-install.patch)\n\ndiff for spkg/standard/deps",
    "created_at": "2011-01-10T03:41:29Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
**Attachment:** [gccwrapper-install.patch](https://github.com/sagemath/sage/files/ticket10572/gccwrapper-install.patch)
...
archive/attachments_014354.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [gccwrapper-deps.patch](https://github.com/sagemath/sage/files/ticket10572/gccwrapper-deps.patch)",
    "created_at": "2011-01-11T10:26:36Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_10572_gccwrapper_root.patch](https://github.com/sagemath/sage/files/ticket10572/trac_10572_gccwrapper_root.patch)\n\nPatch to SAGE_ROOT repo (use only this patch)",
    "created_at": "2011-05-29T00:19:01Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
**Attachment:** [trac_10572_gccwrapper_root.patch](https://github.com/sagemath/sage/files/ticket10572/trac_10572_gccwrapper_root.patch)
...
archive/attachments_014356.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_014357.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:59'></a>\n**Attachment:** [path.patch](https://github.com/sagemath/sage/files/ticket10572/path.patch)\n\nDone, added to repo & spkg in the ticket.",
    "created_at": "2013-07-29T13:30:12Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
archive/attachments_014358.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_10572-sage_orig_path.patch](https://github.com/sagemath/sage/files/ticket10572/trac_10572-sage_orig_path.patch)\n\nCygwin path patch",
    "created_at": "2014-01-08T16:44:12Z",
    "issue": "https://github.com/sagemath/sage/issues/10572",
    "type": "issue_comment",
...
**Attachment:** [trac_10572-sage_orig_path.patch](https://github.com/sagemath/sage/files/ticket10572/trac_10572-sage_orig_path.patch)
