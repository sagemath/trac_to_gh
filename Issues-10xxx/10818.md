...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106491",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83915"
}
```
...
archive/attachments_014168.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "signal-handling.patch",
    "asset_url": "tarball://root/attachments/ticket10818/signal-handling.patch",
    "created_at": "2011-02-21T22:36:02Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10818/signal-handling.patch",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [signal-handling.patch](https://github.com/sagemath/sage/files/ticket10818/signal-handling.patch) by @nbruin created at 2011-02-21 22:36:02\n\nWith the patch, we can indeed interrupt ECL. We should try to do some more critical stuff and see if ECL can get in an inconsistent state due to this (I expect it can). Example session:\n\n```\nsage: from sage.libs.ecl import *\nsage: ecl_eval(\"(setf i 0)\")\n<ECL: 0>\nsage: inf_loop=ecl_eval(\"(defun infinite() (loop (incf i)))\")\nsage: inf_loop()\nKeyboardInterrupt: \nsage: ecl_eval(\"i\")\n<ECL: 5337027>\nsage: ecl_eval(\"(infinite)\")\nKeyboardInterrupt: \nsage: ecl_eval(\"i\")\n<ECL: 15518182>\n```",
    "created_at": "2011-02-21T22:36:02Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106492",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106493",
    "user": "https://github.com/nbruin"
}
```
...
archive/attachments_014169.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "siginttest.c",
    "asset_url": "tarball://root/attachments/ticket10818/siginttest.c",
    "created_at": "2011-02-24T06:01:34Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10818/siginttest.c",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Attachment [siginttest.c](https://github.com/sagemath/sage/files/ticket10818/siginttest.c) by @nbruin created at 2011-02-24 06:01:34",
    "created_at": "2011-02-24T06:01:34Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106494",
    "user": "https://github.com/nbruin"
}
```

Attachment [siginttest.c](https://github.com/sagemath/sage/files/ticket10818/siginttest.c) by @nbruin created at 2011-02-24 06:01:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106495",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106496",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83917"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106497",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106498",
    "user": "https://github.com/nbruin"
}
```
...
archive/attachments_014170.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "handlerswap.p2.patch",
    "asset_url": "tarball://root/attachments/ticket10818/handlerswap.p2.patch",
    "created_at": "2011-02-25T22:50:56Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10818/handlerswap.p2.patch",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106500",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106501",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106502",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106504",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106505",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106506",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106507",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,4 +11,4 @@\n \n When testing this patch, absolutely test it to **sage-4.7.alpha1 or later** since interrupts were completely rewritten (see #9678).\n \n-Apply [attachment:handlerswap.p2.patch](https://github.com/sagemath/sage/files/ticket10818/handlerswap.p2.patch)\n+Apply [attachment:10818_handlerswap.p3.patch](https://github.com/sagemath/sage/files/ticket10818/10818_handlerswap.p3.patch)\n``````\n",
    "created_at": "2011-03-30T12:14:31Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106508",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106509",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106510",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106511",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106512",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106513",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106514",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106515",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106516",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83919"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106517",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106518",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106519",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83921"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106520",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83923"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83924"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83925"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83926"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "10818_handlerswap.p3.patch",
    "asset_url": "tarball://root/attachments/ticket10818/10818_handlerswap.p3.patch",
    "created_at": "2011-04-08T08:41:49Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10818/10818_handlerswap.p3.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>\nAttachment [10818_handlerswap.p3.patch](https://github.com/sagemath/sage/files/ticket10818/10818_handlerswap.p3.patch) by @jdemeyer created at 2011-04-08 08:41:49\n\nReplying to [jpflori](#comment%3A22):\n> Therefore I put something C-ish (but too complicated I agree) in there.\n\nNow I added an `abort()` which is certainly C-ish.",
    "created_at": "2011-04-08T08:41:49Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106521",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106522",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83927"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83928"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106523",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106524",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106525",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83931"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83932"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106526",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106527",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106528",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83934"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83935"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106529",
    "user": "https://github.com/jdemeyer"
}
```
...
archive/attachments_014172.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "10818_handlerswap.p4.patch",
    "asset_url": "tarball://root/attachments/ticket10818/10818_handlerswap.p4.patch",
    "created_at": "2011-04-18T15:11:05Z",
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10818/10818_handlerswap.p4.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106531",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106532",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106533",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106534",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106535",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106536",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83936"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83937"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10818#issuecomment-106537",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10818",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10818#event-83939"
}
```
