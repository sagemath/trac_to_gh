...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123360",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123361",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123364",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>You are right, discard the first paragraph above, but the second one becomes even more relevant then ;-)",
    "created_at": "2010-10-24T15:48:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123366",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:6'></a>You are right, discard the first paragraph above, but the second one becomes even more relevant then ;-)
...
```json
{
    "body": "<a id='comment:7'></a>\"Translations do change the restricted automorphism group.\" I think you missed NOT.",
    "created_at": "2010-10-24T16:13:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123367",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:7'></a>"Translations do change the restricted automorphism group." I think you missed NOT.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123369",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123371",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Ah, now that makes sense! I guess I just have an issue with `_is_zero` because I looked at the source code of it for some polyhedron (which happened to be exact) using `??` and saw `x == 0` without paying too much attention to the details. The `Polyhedron` class itself does not have such a method at all. Is really speed-crucial to set it to a lambda-expression instead of having an honest method with if-check for the type of the field each time? (For the purposes of this ticket 2 is resolved.)",
    "created_at": "2010-10-25T17:37:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123373",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:11'></a>Ah, now that makes sense! I guess I just have an issue with `_is_zero` because I looked at the source code of it for some polyhedron (which happened to be exact) using `??` and saw `x == 0` without paying too much attention to the details. The `Polyhedron` class itself does not have such a method at all. Is really speed-crucial to set it to a lambda-expression instead of having an honest method with if-check for the type of the field each time? (For the purposes of this ticket 2 is resolved.)
...
```json
{
    "body": "<a id='comment:12'></a>I'm planning to make `_is_zero`, `_is_nonneg` and `_is_positive` into overloaded methods when I split up `Polyhedron` into different backends. But first I wanted to commit the outstanding patches I have.\n\nI'm not sure that labeling the edges with the number of lattice points restricts to the lattice Euclidean group automatically. Can't you still map a minimal 2-d triangle, say, to one with an interior point (but no lattice point on the edges)? Thats of course not a counterexample, but its not clear to me that that might not happen on faces of higher-dimensional polyhedra...\n\nUpdated patch for 1. and 3. is attached. I've also added a `combinatorial_automorphism_group()` method to compare with.",
    "created_at": "2010-10-26T13:02:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123374",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>I'm planning to make `_is_zero`, `_is_nonneg` and `_is_positive` into overloaded methods when I split up `Polyhedron` into different backends. But first I wanted to commit the outstanding patches I have.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123375",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123376",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>You are right, it is not that easy to make this algorithm work for lattice-preserving automorphisms. Let's save this for later ;-)\n\nThe latest patch looks and works fine, positive review!",
    "created_at": "2010-10-30T02:14:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123377",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:13'></a>You are right, it is not that easy to make this algorithm work for lattice-preserving automorphisms. Let's save this for later ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123378",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10148#event-25933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123379",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10148#event-25934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123380",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>\"Euclidean group\" should be \"affine group\", see #20063.",
    "created_at": "2016-02-16T13:06:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10148#issuecomment-123381",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>"Euclidean group" should be "affine group", see #20063.
