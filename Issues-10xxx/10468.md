...
```json
{
    "body": "<a id='comment:3'></a>Please set milestone.",
...
<a id='comment:3'></a>Please set milestone.
...
```json
{
    "body": "<a id='comment:4'></a>Since it has a positive review, I choose the next possible milestone.",
...
<a id='comment:4'></a>Since it has a positive review, I choose the next possible milestone.
...
```json
{
    "body": "<a id='comment:7'></a>Will the patch be merged, after meanwhile 5 weeks?",
...
<a id='comment:7'></a>Will the patch be merged, after meanwhile 5 weeks?
