...
```json
{
    "body": "**Changing work issues** from \"several doctests need to be patched due to  changes in output format/term order\" to \"domain issue, error handling in nintegral\".",
    "created_at": "2012-03-01T16:14:18Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
...
**Changing work issues** from "several doctests need to be patched due to  changes in output format/term order" to "domain issue, error handling in nintegral".
...
```json
{
    "body": "**Changing work issues** from \"domain issue, error handling in nintegral\" to \"spkg-check\".",
    "created_at": "2012-03-06T13:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
...
**Changing work issues** from "domain issue, error handling in nintegral" to "spkg-check".
...
```json
{
    "body": "**Changing work issues** from \"spkg-check\" to \"\".",
    "created_at": "2012-03-06T16:50:41Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
...
**Changing work issues** from "spkg-check" to "".



---

archive/attachments_014502.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_10682-reviewer.patch](https://github.com/sagemath/sage/files/ticket10682/trac_10682-reviewer.patch)\n\nReviewer patch, formatting issues",
    "created_at": "2012-03-06T16:51:27Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
...
archive/attachments_014503.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_10682-spkg-dp.patch](https://github.com/sagemath/sage/files/ticket10682/trac_10682-spkg-dp.patch)\n\nspkg diff from author, for review only",
    "created_at": "2012-03-06T17:14:19Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
...
**Attachment:** [trac_10682-spkg-dp.patch](https://github.com/sagemath/sage/files/ticket10682/trac_10682-spkg-dp.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104611",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104612",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104613",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104614",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
archive/attachments_014504.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac10682_1.patch](https://github.com/sagemath/sage/files/ticket10682/trac10682_1.patch)\n\nSage library patch to go with the new spkg",
    "created_at": "2012-03-08T11:21:59Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104615",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104616",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104617",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104618",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104619",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104620",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104621",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104622",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104623",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104624",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_10682-spkg.patch](https://github.com/sagemath/sage/files/ticket10682/trac_10682-spkg.patch)\n\nOk that was an error from my part, some TABS were actually needed in spkg-install.\nThis is fixed now.\nI've also swpped two lines in the sage tree patch.\nI'll upload a fixed version in a moment.",
    "created_at": "2012-03-09T09:55:13Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104625",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "**Attachment:** [trac_10682-reviewer-local.patch](https://github.com/sagemath/sage/files/ticket10682/trac_10682-reviewer-local.patch)\n\nReviewer patch",
    "created_at": "2012-03-09T10:20:56Z",
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104626",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104627",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104628",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104629",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104630",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10682#issuecomment-104631",
    "user": "https://github.com/jdemeyer"
}
```
