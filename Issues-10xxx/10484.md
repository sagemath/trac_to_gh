...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100539",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100540",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100541",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100542",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100543",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10484/trac_10484-crt_bug.2.patch",
    "created_at": "2010-12-16T20:08:31Z",
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10484/trac_10484-crt_bug.2.patch",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_10484-crt_bug.2.patch](https://github.com/sagemath/sage/files/ticket10484/trac_10484-crt_bug.2.patch) by @loefflerd created at 2010-12-16 20:08:31\n\nHere's a new patch using Integer. Sorry, I meant to overwrite the original patch -- apply only the second one.",
    "created_at": "2010-12-16T20:08:31Z",
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100544",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100545",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100546",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10484#issuecomment-100547",
    "user": "https://github.com/jdemeyer"
}
```
