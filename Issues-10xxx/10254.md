...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-134662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-134663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-134664"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-134665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10254#issuecomment-95570",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10254#issuecomment-95571",
    "user": "https://github.com/lftabera"
}
```
