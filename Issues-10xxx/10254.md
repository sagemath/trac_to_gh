...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-118709"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-118710"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10254#event-118711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10254#issuecomment-97540",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10254#issuecomment-97541",
    "user": "https://github.com/lftabera"
}
```
