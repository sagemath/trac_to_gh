...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137274",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>So... what should we do here?  I think that maybe the best thing is to find more ways in various reference and tutorial sources to say \"use RDF for speed\", but I don't know how realistic that is.  Anyway, not a bug, so setting to \"needs info\".",
    "created_at": "2013-02-04T17:44:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137275",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>So... what should we do here?  I think that maybe the best thing is to find more ways in various reference and tutorial sources to say "use RDF for speed", but I don't know how realistic that is.  Anyway, not a bug, so setting to "needs info".
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10815#event-27905"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10815#event-27906"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10815#event-27907"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10815#event-27908"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10815#event-27909"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137276",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137277",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>May also be effected by #15912.",
    "created_at": "2014-03-15T11:03:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137278",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>May also be effected by #15912.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#15944\"",
    "created_at": "2014-03-15T13:37:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137279",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

Changing dependencies from "" to "#15944"
...
```json
{
    "body": "<a id='comment:7'></a>`@`rws: this is not related to printing, but to the fact that `RR` privides emulated floating-point arithmetics (by MPFR), which is inherently slower than CPU implementation provided by `RDF`. Moreover, some optimized libraries (like atlas) require CPU doubles to work with, and are not used in such a case.\n\nI was the one surprised by Frederic's timings. As `@`kcrisman, i think there is still an issue about misleadingly using `RR` as the default implementation of real floating point (which seems to come from its generic name).\n\nThis documentation issue should be fixed by the forthcomig tutorial #15944.",
    "created_at": "2014-03-15T13:37:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137280",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:7'></a>`@`rws: this is not related to printing, but to the fact that `RR` privides emulated floating-point arithmetics (by MPFR), which is inherently slower than CPU implementation provided by `RDF`. Moreover, some optimized libraries (like atlas) require CPU doubles to work with, and are not used in such a case.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137281",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10815#issuecomment-137282",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10815",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10815#event-27910"
}
```
