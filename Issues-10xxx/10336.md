...
```json
{
    "body": "<a id='comment:1'></a>Originally there was no code to compute face lattices of non-strictly convex cones, but with your recent modifications it will be easy to fix.\n\nPlotting code that I wrote will not immediately work for such cases anyway, but again it should not be terribly difficult to fix, I just was more concerned with plotting fans.\n\nWill work on it!\n\nP.S. Since it was due to `NotImplemented`, I consider this ticket an enhancement ;-)",
    "created_at": "2010-11-26T18:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127668",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:1'></a>Originally there was no code to compute face lattices of non-strictly convex cones, but with your recent modifications it will be easy to fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127669",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127670",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127672",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I attached the first development version. `face_lattice` should work for any cone now and there are a few small corrections in other places. Definitely needs more work!-)",
    "created_at": "2010-11-26T22:59:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127673",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:3'></a>I attached the first development version. `face_lattice` should work for any cone now and there are a few small corrections in other places. Definitely needs more work!-)
...
```json
{
    "body": "Changing work_issues from \"\" to \"fix faces and add plotting\"",
    "created_at": "2010-11-26T22:59:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127674",
    "user": "https://github.com/novoselt"
}
```

Changing work_issues from "" to "fix faces and add plotting"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127675",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127676",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Great! Done! Refreshed patch should deal fine with faces in all cases, all old doctests pass and I added a couple for non-strictly convex cones - there was an issue originally for \"totally non-strictly conex\" cones like a plane, that's why there is `DiGraph(1)` in `Hasse_diagram`.\n\nRegarding the plots. Let's take, e.g. a half-plane generated by vectors (1,0), (1,1), (0,1), (-1,0). I propose that its plot will look exactly like the plot of the fan with these generators except that two middle vectors will be plotted as generators, but there will be no rays in their direction extending to the boundary of the plot (labels still will be places on the boundary out of colored regions). The label for the half-plane itself will be randomly placed between two consecutive generators - this way it will be inside and will not get crossed by one of the internal generators.",
    "created_at": "2010-11-27T02:49:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127677",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:5'></a>Great! Done! Refreshed patch should deal fine with faces in all cases, all old doctests pass and I added a couple for non-strictly convex cones - there was an issue originally for "totally non-strictly conex" cones like a plane, that's why there is `DiGraph(1)` in `Hasse_diagram`.
...
```json
{
    "body": "<a id='comment:6'></a>OK, it remains to make the default \"round\" mode work and reposition labels of non-strictly convex 2-d walls.",
    "created_at": "2010-11-27T05:42:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127678",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:6'></a>OK, it remains to make the default "round" mode work and reposition labels of non-strictly convex 2-d walls.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127679",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127681",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127682",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127683",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127684",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Made user's `radius` more important (new code block in `ToricPlotter.__init__`), so that it is possible to make it small even if it cuts off some generators.",
    "created_at": "2010-11-28T20:24:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127685",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:8'></a>Made user's `radius` more important (new code block in `ToricPlotter.__init__`), so that it is possible to make it small even if it cuts off some generators.
...
```json
{
    "body": "<a id='comment:9'></a>Depends on #9972.",
    "created_at": "2010-12-05T19:09:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127686",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:9'></a>Depends on #9972.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127687",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Nice! Tested against sage-4.6.1alpha3",
    "created_at": "2010-12-20T12:34:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127688",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>Nice! Tested against sage-4.6.1alpha3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127689",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127690",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10336#issuecomment-127691",
    "user": "https://github.com/jdemeyer"
}
```
