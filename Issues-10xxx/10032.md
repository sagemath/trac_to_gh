...
```json
{
    "body": "<a id='comment:1'></a>Another big improvement would be making all of the plot files start with the user commands, rather than the behind-the-scenes objects.",
    "created_at": "2010-10-01T03:12:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120907",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Another big improvement would be making all of the plot files start with the user commands, rather than the behind-the-scenes objects.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120908",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120909",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120910",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Well, I meant a switch just for these files, not a system-wide switch.",
    "created_at": "2010-10-01T15:01:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120911",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>Well, I meant a switch just for these files, not a system-wide switch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120912",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120913",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25438"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25439"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25440"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25441"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25442"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25443"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10032#event-25444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120914",
...
```json
{
    "body": "<a id='comment:12'></a>I am interested in working on this. How do I start?",
    "created_at": "2016-11-24T15:20:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120915",
    "user": "https://trac.sagemath.org/admin/accounts/users/souravsingh"
}
```

<a id='comment:12'></a>I am interested in working on this. How do I start?
...
```json
{
    "body": "<a id='comment:14'></a>Removing the \"beginner\" tag from old tickets. Some could be returned to beginner-friendly status by adding a comment about what needs to be done. Some others might be easy for an experienced developer to finish.",
    "created_at": "2020-05-27T02:55:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120917",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:14'></a>Removing the "beginner" tag from old tickets. Some could be returned to beginner-friendly status by adding a comment about what needs to be done. Some others might be easy for an experienced developer to finish.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10032#issuecomment-120918",
    "user": "https://github.com/DaveWitteMorris"
}
```
