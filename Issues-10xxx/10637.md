...
```json
{
    "body": "Changed assignee from **@jasongrout, @qed777, @williamstein** to **@sagetrac-pang**",
...
Changed assignee from **@jasongrout, @qed777, @williamstein** to **@sagetrac-pang**
...
```json
{
    "body": "Changed assignee from **@sagetrac-pang** to **@jasongrout, @qed777, @williamstein**",
    "created_at": "2011-04-08T10:48:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10637",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-pang** to **@jasongrout, @qed777, @williamstein**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10637#event-128006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10637#event-128007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10637",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10637#event-128008"
}
```
