...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10927#event-144842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10927#event-144843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10927#event-144844"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10927#event-144845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10927#event-144846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10927#issuecomment-106079",
    "user": "https://github.com/RalphieBoy"
}
```
