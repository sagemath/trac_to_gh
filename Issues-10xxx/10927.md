...
```json
{
    ...
    "rename": {
        "from": "An object's element list should be immutable",
        "to": "[needs review] An object's element list should be immutable"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10927#event-41395"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10927#issuecomment-137229",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10927#issuecomment-137230",
