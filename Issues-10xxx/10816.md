...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106448",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106449",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106450",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10816/trac_10816_remove_cyclic_import.patch",
    "created_at": "2011-02-22T10:49:25Z",
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10816/trac_10816_remove_cyclic_import.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_10816_remove_cyclic_import.patch](https://github.com/sagemath/sage/files/ticket10816/trac_10816_remove_cyclic_import.patch) by @vbraun created at 2011-02-22 10:49:25\n\nRemoving the circular import fixes this for me. The bug was probably introduced in #10525, so it would be nice if we could push the patch into Sage-4.6.2. Its really uncontroversial.",
    "created_at": "2011-02-22T10:49:25Z",
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106451",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106452",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106453",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106454",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106455",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106456",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10816#issuecomment-106457",
    "user": "https://github.com/jdemeyer"
}
```
