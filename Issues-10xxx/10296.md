...
```json
{
    "body": "**Changing work issues** from \"make gap restart after quitting or crashing\" to \"\".",
    "created_at": "2011-04-13T09:38:05Z",
    "issue": "https://github.com/sagemath/sage/issues/10296",
    "type": "issue_comment",
...
**Changing work issues** from "make gap restart after quitting or crashing" to "".
...
archive/attachments_013962.json:
```json
{
...
archive/attachments_013963.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac10296_singular_overhead.patch](https://github.com/sagemath/sage/files/ticket10296/trac10296_singular_overhead.patch)\n\nModify garbage collection in Singular interface, which reduces the overhead. Synchronization of Gap interface.",
    "created_at": "2011-08-01T15:57:50Z",
    "issue": "https://github.com/sagemath/sage/issues/10296",
    "type": "issue_comment",
