...
```json
{
    "body": "Attachment [trac_10296-restart_if_needed.patch](tarball://root/attachments/some-uuid/ticket10296/trac_10296-restart_if_needed.patch) by @mwhansen created at 2011-12-18 14:41:55\n\nI've added a patch which makes this change.  Let's get this in.",
...
```json
{
    "body": "Attachment [trac10296_singular_overhead_combined.patch](tarball://root/attachments/some-uuid/ticket10296/trac10296_singular_overhead_combined.patch) by @simon-king-jena created at 2012-03-03 14:40:27\n\nOops, I only had a single backtick around `EOFError` -- hence, it would be typeset as `LaTeX`. So, I have updated my patch, with double backticks around `EOFError`.",
