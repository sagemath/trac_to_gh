...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130117",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This can be done by adding to `main()` in `ipy_user_conf.py`:\n\n```\n\n    import os\n    if os.environ['TERM'] == 'dumb':\n        o.autoindent = 0\n```\n\nI plan to wait until after #12167 to fix this.",
    "created_at": "2012-12-27T17:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130118",
    "user": "https://github.com/gvol"
}
```

<a id='comment:2'></a>This can be done by adding to `main()` in `ipy_user_conf.py`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130119",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130120",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130121",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130122",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130123",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Does it actually merge?\n\nAlso, wouldn't the same hold for plain IPython? Maybe its better to fix the default upstream?",
    "created_at": "2015-04-13T17:44:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130124",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>Does it actually merge?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130125",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10504#event-26932"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Can you link to the upstream ticket when you open it? IPython uses github as issue tracker.",
    "created_at": "2015-04-14T08:56:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130126",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>Can you link to the upstream ticket when you open it? IPython uses github as issue tracker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130127",
...
```json
{
    "body": "<a id='comment:7'></a>let us close that",
    "created_at": "2016-04-16T18:37:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130128",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>let us close that
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130129",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10504#event-26933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10504#issuecomment-130130",
    "user": "https://github.com/vbraun"
}
```
