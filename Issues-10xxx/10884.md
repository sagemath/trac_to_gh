...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10884#event-131653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10884#event-131654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10884#event-131655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10884#issuecomment-107512",
    "user": "https://github.com/sagetrac-dsm"
}
```
