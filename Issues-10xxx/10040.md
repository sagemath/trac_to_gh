...
```json
{
    "body": "<a id='comment:1'></a>Are there good reasons to keep the verbose non-error output?\n\nSmaller logs would also help with #3524.",
    "created_at": "2010-09-30T10:11:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121183",
    "user": "https://github.com/qed777"
}
```

<a id='comment:1'></a>Are there good reasons to keep the verbose non-error output?
...
```json
{
    "body": "<a id='comment:2'></a>I think Leif said the verbose output could be useful to find packages which have unnecessary files in them. But personally I think that issue should be resolved when packages are reviewed. I've not objections to adding an environment variable to control it, but it's more work than a one-character patch!\n\nAs you say, it would also help with buildbot too. \n\nDave",
    "created_at": "2010-10-22T11:11:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121184",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>I think Leif said the verbose output could be useful to find packages which have unnecessary files in them. But personally I think that issue should be resolved when packages are reviewed. I've not objections to adding an environment variable to control it, but it's more work than a one-character patch!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121185",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121186",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Perhaps (on another ticket) we should also address the almost useless *\"copying ...\"* messages that afaik originate from distutils. These make up another fair amount of the logs.",
    "created_at": "2010-10-22T11:39:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121187",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>Perhaps (on another ticket) we should also address the almost useless *"copying ..."* messages that afaik originate from distutils. These make up another fair amount of the logs.
...
```json
{
    "body": "<a id='comment:5'></a>Are you two happy with just removing the 'v', and not bothering with an environment variable? I certainly am. If so, let's create a patch. \n\nAnything to cut down the log size is a good thing, so feel free to create a ticket for this other issue. \n\nDave",
    "created_at": "2010-10-22T11:42:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121188",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>Are you two happy with just removing the 'v', and not bothering with an environment variable? I certainly am. If so, let's create a patch. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121189",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_10040-untar_non-verbosely_by_default-sage_scripts.patch](tarball://root/attachments/some-uuid/ticket10040/trac_10040-untar_non-verbosely_by_default-sage_scripts.patch) by @nexttime created at 2010-10-22 12:06:06\n\nI've attached a patch to `sage-spkg` that honors `SAGE_SPKG_LIST_FILES=yes`, and calls `tar` without \"v\" otherwise.",
    "created_at": "2010-10-22T12:06:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121190",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>Attachment [trac_10040-untar_non-verbosely_by_default-sage_scripts.patch](tarball://root/attachments/some-uuid/ticket10040/trac_10040-untar_non-verbosely_by_default-sage_scripts.patch) by @nexttime created at 2010-10-22 12:06:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121191",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121192",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Btw, #9799 is also related (in case of build errors), since without that running `make` will also attempt to build the documentation regardless if the build succeeded or not, and obscure (and unnecessarily grow) the log or even \"hide\" the build error.\n\n(Build errors do not always cause failures in building the documentation, so it might look as if the whole build succeeded, which probably William meant by *\"leading to all kinds of confusion\"*.)",
    "created_at": "2010-10-22T12:58:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121193",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>Btw, #9799 is also related (in case of build errors), since without that running `make` will also attempt to build the documentation regardless if the build succeeded or not, and obscure (and unnecessarily grow) the log or even "hide" the build error.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121194",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121195",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Oh, the *\"copying ...\"* messages appear to be a distutils **bug**; `distutils.file_util.copy_file()` has a `verbose` (default: 0) parameter, but doesn't use it!\n\nIf I change it to the following:\n\n```python\n    ...\n    if verbose: # added just this line\n        if os.path.basename(dst) == os.path.basename(src):\n            log.info(\"%s %s -> %s\", action, src, dir)\n        else:\n            log.info(\"%s %s -> %s\", action, src, dst)\n    ...\n```\nthe *\"copying ...\"* messages vanish at least for mpmath (I only tried that so far).\n\nOpinions? (before I open a ticket for that)",
    "created_at": "2010-10-22T17:35:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121197",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:10'></a>Oh, the *"copying ..."* messages appear to be a distutils **bug**; `distutils.file_util.copy_file()` has a `verbose` (default: 0) parameter, but doesn't use it!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121198",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121200",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Add a patch to document the new environment variable\"",
    "created_at": "2010-10-23T14:19:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121203",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing work_issues from "" to "Add a patch to document the new environment variable"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121204",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121205",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121206",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Changing work_issues from \"Add a patch to document the new environment variable\" to \"\"",
    "created_at": "2010-10-23T16:41:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121207",
    "user": "https://github.com/nexttime"
}
```

Changing work_issues from "Add a patch to document the new environment variable" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121208",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>What does the s.t. standard for, in the sentence *Since some spkgs contain a huge number of files s.t. the log files  get very large and harder to search (and listing the contained* ? \n\nIt's not obvious to me, so either I'm think or perhaps it wont be obvious to others too. \n\nI agree the installation guide is outdated, but was keen it did not get even more outdated! \n\nI was happy to just omit -v, but if we are going to have the option to configure it, we should document it. I would have been quite happy not to have the option myself. \n\nDave",
    "created_at": "2010-10-23T18:02:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121209",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:18'></a>What does the s.t. standard for, in the sentence *Since some spkgs contain a huge number of files s.t. the log files  get very large and harder to search (and listing the contained* ? 
...
```json
{
    "body": "<a id='comment:19'></a>I think \"s.t.\" stands for \"such that\".  Maybe that sentence could be rephrased as\n\n```\nSince some spkgs contain a huge number of files, the log files can \nget very large and hard to search (and listing the contained files is\nusually not very valuable), so this is turned off by default.\n```",
    "created_at": "2010-10-23T18:26:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121210",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:19'></a>I think "s.t." stands for "such that".  Maybe that sentence could be rephrased as
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121211",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121212",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Attachment [trac_10040-document_SAGE_SPKG_LIST_FILES-sage_library.patch](tarball://root/attachments/some-uuid/ticket10040/trac_10040-document_SAGE_SPKG_LIST_FILES-sage_library.patch) by @nexttime created at 2010-10-23 19:52:28\n\nReplying to [leif](#comment%3A20):\n> Of course I can change that.\n\n\nReluctantly did that.",
    "created_at": "2010-10-23T19:52:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121213",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>Attachment [trac_10040-document_SAGE_SPKG_LIST_FILES-sage_library.patch](tarball://root/attachments/some-uuid/ticket10040/trac_10040-document_SAGE_SPKG_LIST_FILES-sage_library.patch) by @nexttime created at 2010-10-23 19:52:28
...
```json
{
    "body": "<a id='comment:22'></a>ping (before it rottens) ;-)\n\nI'm working on a lot of further changes to (not only) `sage-spkg`...",
    "created_at": "2010-11-03T07:31:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121214",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:22'></a>ping (before it rottens) ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121215",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Suppressing the *copying...* messages sounds good to me.  Should we have an option to enable them?\n\nShould we use suppress \"tarbosity\" in `sage-bdist`, too?",
    "created_at": "2010-11-03T11:01:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121216",
    "user": "https://github.com/qed777"
}
```

<a id='comment:23'></a>Suppressing the *copying...* messages sounds good to me.  Should we have an option to enable them?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121217",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10040#event-25496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121218",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121219",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Have you considered simply remove the `v` option to `tar` without environment variables?  I don't really like adding another (pointless) environment variable.",
    "created_at": "2010-11-04T08:58:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121220",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:26'></a>Have you considered simply remove the `v` option to `tar` without environment variables?  I don't really like adding another (pointless) environment variable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121221",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121222",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121224",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121226",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121227",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121229",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121230",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121231",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121232",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10040#issuecomment-121233",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10040",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10040#event-25497"
}
```
