...
```json
{
    "body": "Changed assignee from **@nexttime** to **@sagetrac-drkirkby**",
...
Changed assignee from **@nexttime** to **@sagetrac-drkirkby**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10040#event-119535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10040#event-119536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10040",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10040#event-119537"
}
```
