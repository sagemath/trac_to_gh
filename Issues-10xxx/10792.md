...
{
    "assignees": [],
    "body": "New version of numpy is out: 1.5.1\n\nSPKG: http://spkg-upload.googlecode.com/files/numpy-1.5.1.spkg\n\nApply:\n1. [attachment: trac-10792-riemann-complexwarnings.patch.gz](https://github.com/sagemath/sage/files/ticket10792/trac-10792-riemann-complexwarnings.patch.gz)\n2. [attachment: trac_10792-fix_riemann_doctest.patch.gz](https://github.com/sagemath/sage/files/ticket10792/trac_10792-fix_riemann_doctest.patch.gz)\n\nCC:  evanandel @kcrisman\n\nAuthor: **Fran\u00e7ois Bissey, Jason Grout**\n\nReviewer: **David Kirkby, Karl-Dieter Crisman, Ethan Van Andel**\n\nMerged: **sage-4.7.alpha2**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/10792_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125860"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125862"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125863"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125867"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n New version of numpy is out: 1.5.1\n \n-New spkg at  http://spkg-upload.googlecode.com/files/numpy-1.5.1.spkg\n+SPKG: http://spkg-upload.googlecode.com/files/numpy-1.5.1.spkg\n+\n+Apply: [attachment: trac-10792-riemann-complexwarnings.patch.gz](https://github.com/sagemath/sage/files/ticket10792/trac-10792-riemann-complexwarnings.patch.gz)\n``````\n",
    "created_at": "2011-03-04T01:35:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10792",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125871"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,4 +2,4 @@\n \n SPKG: http://spkg-upload.googlecode.com/files/numpy-1.5.1.spkg\n \n-Apply: [attachment: trac-10792-riemann-complexwarnings.patch.gz](https://github.com/sagemath/sage/files/ticket10792/trac-10792-riemann-complexwarnings.patch.gz)\n+Apply: [attachment: trac-10792-riemann-complexwarnings.patch.gz](https://github.com/sagemath/sage/files/ticket10792/trac-10792-riemann-complexwarnings.patch.gz) and [attachment: trac_10792-fix_riemann_doctest.patch.gz](https://github.com/sagemath/sage/files/ticket10792/trac_10792-fix_riemann_doctest.patch.gz)\n``````\n",
    "created_at": "2011-03-16T23:20:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10792",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125872"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10792#issuecomment-106105",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10792#event-125875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10792#issuecomment-106106",
    "user": "https://github.com/jdemeyer"
}
```
