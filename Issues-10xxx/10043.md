...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10043#event-119561"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10043#event-119562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10043#event-119563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10043#issuecomment-94029",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10043#issuecomment-94030",
    "user": "https://github.com/jdemeyer"
}
```
