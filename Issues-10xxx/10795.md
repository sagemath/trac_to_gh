...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125911"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125917"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125918"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125919"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125920"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10795",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125922"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125925"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,3 +12,7 @@\n ```\n \n Besides a bugfix this patch will upgrade the documentation to make it clear how this routine works over the complex numbers.  In particular, `SciPy` routines are using a Hermitian inner product - documentation upgrade will reflect that.\n+\n+**Apply**:\n+1.  [attachment: trac_10795-QR-decomposition-double-dense.patch.gz](https://github.com/sagemath/sage/files/ticket10795/trac_10795-QR-decomposition-double-dense.patch.gz)\n+2.  [attachment: trac_10795-QR-decomposition-numerical.patch.gz](https://github.com/sagemath/sage/files/ticket10795/trac_10795-QR-decomposition-numerical.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125930"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10795",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10795",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125941"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125942"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10795#issuecomment-106179",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125946"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10795#issuecomment-106180",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10795",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10795#event-125948"
}
```
