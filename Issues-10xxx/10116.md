...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10116#issuecomment-122669",
    "user": "https://trac.sagemath.org/admin/accounts/users/victor"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10116#issuecomment-122671",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25792"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25793"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25794"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25795"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25796"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25797"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10116#event-25798"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The lack of a sparse SVD can kill this in another way:\n\n```\nsage: A = matrix(RDF, 1, 1, [[1]], sparse=True)\nsage: A.norm()\n...\nAttributeError: 'sage.matrix.matrix_generic_sparse.Matrix_generic_sparse' object has no attribute 'SVD'\n```",
    "created_at": "2021-11-21T19:48:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10116#issuecomment-122672",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:8'></a>The lack of a sparse SVD can kill this in another way:
