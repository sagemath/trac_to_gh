...
```json
{
    "body": "<a id='comment:2'></a>I cannot reproduce the error with sage 4.7.1, now it catches a maxima error.\n\nHowever, I have no idea how to add a doctest to this issue.",
    "created_at": "2011-09-13T13:23:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10223",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10223#issuecomment-103857",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:2'></a>I cannot reproduce the error with sage 4.7.1, now it catches a maxima error.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26215"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26216"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26217"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26218"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26219"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Confirmed with the sage-6.2 binary installation.",
    "created_at": "2014-05-14T08:44:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10223",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10223#issuecomment-103858",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>Confirmed with the sage-6.2 binary installation.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26220"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10223#event-26221"
}
```
