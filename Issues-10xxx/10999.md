...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142076",
...
```json
{
    "body": "<a id='comment:2'></a>I have found the problem, in lines 190-199 in ell_rational_field.py.  It copies the points from the database curve in a way which does not change te curve those points lie on.\n\nPatch on its way!",
    "created_at": "2011-03-24T19:37:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142077",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>I have found the problem, in lines 190-199 in ell_rational_field.py.  It copies the points from the database curve in a way which does not change te curve those points lie on.
...
```json
{
    "body": "<a id='comment:3'></a>I'm testing the whole library now and will ask for reviews if that goes ok.",
    "created_at": "2011-03-24T20:43:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142078",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>I'm testing the whole library now and will ask for reviews if that goes ok.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142079",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142080",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142081",
    "user": "https://trac.sagemath.org/admin/accounts/users/weigandt"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Looks good. The tests pass.",
    "created_at": "2011-03-25T01:06:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142082",
    "user": "https://trac.sagemath.org/admin/accounts/users/weigandt"
}
```

<a id='comment:5'></a>Looks good. The tests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142083",
    "user": "https://trac.sagemath.org/admin/accounts/users/weigandt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142084",
...
```json
{
    "body": "<a id='comment:7'></a>It would appear that I have made a serious error. I did run doctests, and they passed. I will admit to the possibility of having made a rookie mistake and tested the wrong copy of sage on my machine. \n\nAnother possible explanation is that I didn't have the large Cremona database installed when I applied the patch. So I applied the patch THEN installed the database and it seems the doctests passed under those circumstances.\n\nI'm running to tests again to see what happened.",
    "created_at": "2011-03-28T14:46:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142086",
    "user": "https://trac.sagemath.org/admin/accounts/users/weigandt"
}
```

<a id='comment:7'></a>It would appear that I have made a serious error. I did run doctests, and they passed. I will admit to the possibility of having made a rookie mistake and tested the wrong copy of sage on my machine. 
...
```json
{
    "body": "<a id='comment:8'></a>Jamie, let me take another look at this.",
    "created_at": "2011-03-29T01:43:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142087",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>Jamie, let me take another look at this.
...
```json
{
    "body": "<a id='comment:9'></a>OK, fixed.  There was a simple indentation error in the patch so removing 3 spaces did the trick.  The patch did work OK on Sage+large database but not without the large database.  Luckily I still had a 4.6.rc1 lying around without the database installed so I could test on that as well as on 4.7.alpha2 + database.  (There's no way of uninstalling the database!)\n\nI'm now doing full test of entire library with and without the database, and will post a new patch when done.",
    "created_at": "2011-03-29T02:05:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142088",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>OK, fixed.  There was a simple indentation error in the patch so removing 3 spaces did the trick.  The patch did work OK on Sage+large database but not without the large database.  Luckily I still had a 4.6.rc1 lying around without the database installed so I could test on that as well as on 4.7.alpha2 + database.  (There's no way of uninstalling the database!)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142089",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>OK, please re-review this one.  As I said, the difference between the previous patch and this one is just one indentation.\n\nIn order to test this one should test against a Sage installation with and without the spkg database_cremona_ellcurve.  I have done that (full test of entire library).",
    "created_at": "2011-03-29T02:34:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142090",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:10'></a>OK, please re-review this one.  As I said, the difference between the previous patch and this one is just one indentation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142091",
...
```json
{
    "body": "<a id='comment:11'></a>sage 4.7 without database spkg without patch:\n\n```\nsage: E=EllipticCurve('389a1')\nsage: E.gens()\n[(-1 : 1 : 1), (0 : -1 : 1)]\n```\nsage 4.7 without database spkg with patch:\n\n```\nsage: E=EllipticCurve('389a1')\nsage: E.gens()\n...\nAttributeError: 'EllipticCurve_rational_field' object has no attribute '_EllipticCurve_rational_field__gens'\n```",
    "created_at": "2011-06-09T09:45:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142092",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:11'></a>sage 4.7 without database spkg without patch:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142093",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142094",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [trac_10999-gens.patch](tarball://root/attachments/some-uuid/ticket10999/trac_10999-gens.patch) by @JohnCremona created at 2011-06-09 14:43:14\n\nI have fixed that problem (which was a real problem, not just a rebase).  Please retest!  I did test the whole library before and after installing the optional database.",
    "created_at": "2011-06-09T14:43:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142095",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:12'></a>Attachment [trac_10999-gens.patch](tarball://root/attachments/some-uuid/ticket10999/trac_10999-gens.patch) by @JohnCremona created at 2011-06-09 14:43:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142096",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142097",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142098",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10999#issuecomment-142099",
    "user": "https://github.com/jdemeyer"
}
```
