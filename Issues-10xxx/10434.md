...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99746",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10434/trac-10434_doctests.patch",
    "created_at": "2010-12-06T15:31:18Z",
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10434/trac-10434_doctests.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac-10434_doctests.patch](https://github.com/sagemath/sage/files/ticket10434/trac-10434_doctests.patch) by mvngu created at 2010-12-06 15:31:18\n\nIn Sage 4.6.1.alpha3, I cannot/don't know how to reproduce the following:\n\n```\nsage: integrate(sqrt(x + sqrt(x)), x).simplify_full() \n1/12*sqrt(sqrt(x) + 1)*((8*x - 3)*x^(1/4) + 2*x^(3/4)) - 1/8*log(sqrt(sqrt(x) + 1) - x^(1/4)) + 1/8*log(sqrt(sqrt(x) + 1) + x^(1/4))\n```\n\nI left out the remaining doctests from [attachment:https://github.com/sagemath/sage/files/ticket8624/trac-8624-abs-integration.patch](https://github.com/sagemath/sage/files/ticket10434/f32116fbd1d8e285ae93278afbf64105.patch) because those, I think, haven't resulted in failures.",
    "created_at": "2010-12-06T15:31:18Z",
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99747",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99748",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99749",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99750",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99751",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99752",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99753",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10434#issuecomment-99754",
    "user": "https://github.com/kcrisman"
}
```
