...
archive/attachments_014912.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_10970_do_not_generate_pipestatus.patch",
    "asset_url": "tarball://root/attachments/ticket10970/trac_10970_do_not_generate_pipestatus.patch",
    "created_at": "2011-03-21T18:25:33Z",
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10970/trac_10970_do_not_generate_pipestatus.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "**Attachment:** [trac_10970_do_not_generate_pipestatus.patch](https://github.com/sagemath/sage/files/ticket10970/trac_10970_do_not_generate_pipestatus.patch)\n\nPatch to SAGE_ROOT repo",
    "created_at": "2011-03-21T18:25:33Z",
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109753",
    "user": "https://github.com/vbraun"
}
```

**Attachment:** [trac_10970_do_not_generate_pipestatus.patch](https://github.com/sagemath/sage/files/ticket10970/trac_10970_do_not_generate_pipestatus.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85561"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85562"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109754",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109755",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85564"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109756",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109758",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109759",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85566"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85567"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109761",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109762",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109763",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109764",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85569"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109765",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109766",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109767",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109768",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109769",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109770",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,2 +1,6 @@\n The `$SAGE_ROOT/spkg/install` has a here document that creates `pipestatus`. With the sage root repository, this is no longer needed as `pipestatus` is tracked by the repository. The patch removes it from `$SAGE_ROOT/spkg/install`.\n \n+---\n+\n+Apply [attachment:trac_10970_do_not_generate_pipestatus.patch](https://github.com/sagemath/sage/files/ticket10970/trac_10970_do_not_generate_pipestatus.patch) to the Sage **root repository** (in `$SAGE_ROOT`).\n+\n``````\n",
    "created_at": "2011-09-08T22:55:27Z",
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109771",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109772",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109773",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109774",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109775",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85571"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85572"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10970#issuecomment-109776",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -2,7 +2,7 @@\n \n ---\n \n-Apply [attachment:trac_10970_do_not_generate_pipestatus.patch](https://github.com/sagemath/sage/files/ticket10970/trac_10970_do_not_generate_pipestatus.patch) to the Sage **root repository** (in `$SAGE_ROOT`).\n+Apply [and [attachment:trac_10970-error-msg.patch](https://github.com/sagemath/sage/files/ticket10970/d1e56b5cad27b1a2bcf60394843debb4.patch](https://github.com/sagemath/sage/files/ticket10970/03ac2cbcc0c0c1868a5884d4289c11d6.patch)) to the Sage **root repository** (in `$SAGE_ROOT`).\n \n ---\n \n``````\n",
...
archive/attachments_014913.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_10970-error-msg.patch",
    "asset_url": "tarball://root/attachments/ticket10970/trac_10970-error-msg.patch",
    "created_at": "2011-10-04T20:52:11Z",
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10970/trac_10970-error-msg.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Attachment:** [trac_10970-error-msg.patch](https://github.com/sagemath/sage/files/ticket10970/trac_10970-error-msg.patch)\n\napply on top of other patch",
    "created_at": "2011-10-04T20:52:11Z",
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_comment",
...
**Attachment:** [trac_10970-error-msg.patch](https://github.com/sagemath/sage/files/ticket10970/trac_10970-error-msg.patch)
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85573"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85574"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85575"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85576"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85577"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85578"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85579"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85580"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10970",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85581"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10970#event-85582"
}
```
