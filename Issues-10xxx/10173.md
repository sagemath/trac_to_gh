...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95964",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95965",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95966",
    "user": "https://github.com/wjp"
}
```
...
archive/attachments_013282.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "10173_pbori_coercion.patch",
    "asset_url": "tarball://root/attachments/ticket10173/10173_pbori_coercion.patch",
    "created_at": "2011-01-09T02:08:20Z",
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10173/10173_pbori_coercion.patch",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [10173_pbori_coercion.patch](https://github.com/sagemath/sage/files/ticket10173/10173_pbori_coercion.patch) by @wjp created at 2011-01-09 02:08:20\n\nI attached a patch that changes the exception raised to a TypeError as this seems to be more consistent with the rest of sage.",
    "created_at": "2011-01-09T02:08:20Z",
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95967",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95968",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77239"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77240"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77241"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77242"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77243"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95969",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95970",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10173#event-77245"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10173#issuecomment-95971",
    "user": "https://github.com/jdemeyer"
}
```
