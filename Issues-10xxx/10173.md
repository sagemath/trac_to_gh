...
```json
{
    "body": "<a id='comment:1'></a>The following code already triggers the bug(?),\n\n```\nsage: R = BooleanPolynomialRing(256,'x')\nsage: S = PolynomialRing(GF(2),256,'y')\nsage: R(S.gen(8))\n```",
    "created_at": "2011-01-09T00:41:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123896",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

<a id='comment:1'></a>The following code already triggers the bug(?),
...
```json
{
    "body": "<a id='comment:2'></a>That's something different I think. In the reported bug a failing coercion is being reported while it should probably just be returning False.\n\nCompare with:\n\n```\nsage: R.<x,y> = ZZ[]\nsage: S.<z> = ZZ[]\nsage: z in R\nFalse\n```\n\nvs\n\n```\nsage: R(z)\n*kaboom*\n```",
    "created_at": "2011-01-09T01:24:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123897",
    "user": "https://github.com/wjp"
}
```

<a id='comment:2'></a>That's something different I think. In the reported bug a failing coercion is being reported while it should probably just be returning False.
...
```json
{
    "body": "<a id='comment:3'></a>The reason for this seems to be that `sage.rings.polynomial.pbori.BooleanPolynomialRing.__contains__` tries a coercion and only catches `TypeError`, while the failing coercion raises a `ValueError` (in `sage.rings.polynomial.pbori.BooleanPolynomialRing._coerce_c_impl` ).",
    "created_at": "2011-01-09T01:41:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123898",
    "user": "https://github.com/wjp"
}
```

<a id='comment:3'></a>The reason for this seems to be that `sage.rings.polynomial.pbori.BooleanPolynomialRing.__contains__` tries a coercion and only catches `TypeError`, while the failing coercion raises a `ValueError` (in `sage.rings.polynomial.pbori.BooleanPolynomialRing._coerce_c_impl` ).
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [10173_pbori_coercion.patch](tarball://root/attachments/some-uuid/ticket10173/10173_pbori_coercion.patch) by @wjp created at 2011-01-09 02:08:20\n\nI attached a patch that changes the exception raised to a TypeError as this seems to be more consistent with the rest of sage.",
    "created_at": "2011-01-09T02:08:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123899",
    "user": "https://github.com/wjp"
}
```

<a id='comment:4'></a>Attachment [10173_pbori_coercion.patch](tarball://root/attachments/some-uuid/ticket10173/10173_pbori_coercion.patch) by @wjp created at 2011-01-09 02:08:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123900",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Patch applies cleanly, and doctest passes both before and after application.\n\nRunning\n\n```\nsage: R = BooleanPolynomialRing(256,'x')\nsage: LR = [R.gen(i) for i in range(256)]\nsage: S = PolynomialRing(GF(2),256,'y')\nsage: S.gen(8) in LR\n```\nnow returns false as expected.\n\nRunning\n\n```\nsage: R = BooleanPolynomialRing(256,'x')\nsage: S = PolynomialRing(GF(2),256,'y')\nsage: R(S.gen(8))\n```\nstill blows up, but with a TypeError instead of a ValueError now. This is the correct behavior (I believe) for\n\n```\nR(S.gen(8)\n```\nin this situation.",
    "created_at": "2011-01-09T02:26:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123901",
    "user": "https://trac.sagemath.org/admin/accounts/users/gbe"
}
```

<a id='comment:5'></a>Patch applies cleanly, and doctest passes both before and after application.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123902",
    "user": "https://trac.sagemath.org/admin/accounts/users/gbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123903",
    "user": "https://trac.sagemath.org/admin/accounts/users/gbe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10173#event-26036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123905",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123906",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10173#event-26037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-123907",
    "user": "https://github.com/jdemeyer"
}
```
