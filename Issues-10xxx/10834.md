...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10834#issuecomment-106929",
    "user": "https://github.com/sagetrac-pernici"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10834#issuecomment-106930",
    "user": "https://github.com/sagetrac-pernici"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10834#event-131006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10834#event-131007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10834",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10834#event-131008"
}
```
