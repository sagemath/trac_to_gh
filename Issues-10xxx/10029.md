...
```json
{
    "body": "<a id='comment:1'></a>This patch needs some work.  See the discussion at the bottom of #9822 for a bug report.",
...
<a id='comment:1'></a>This patch needs some work.  See the discussion at the bottom of #9822 for a bug report.
...
<a id='comment:3'></a>Here is the bug report (repeated on this ticket for clarity and completeness)
...
```json
{
    "body": "<a id='comment:4'></a>this a very old ticket about the deprecated sagenb. Can we close ?",
    "created_at": "2020-03-28T09:57:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10029",
    "type": "issue_comment",
...
<a id='comment:4'></a>this a very old ticket about the deprecated sagenb. Can we close ?
