...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10581#event-127128"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10581#event-127129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10581#event-127130"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10581#issuecomment-103022",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10581#issuecomment-103023",
    "user": "https://github.com/JohnCremona"
}
```
