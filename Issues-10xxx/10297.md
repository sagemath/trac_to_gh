...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10297/trac_10297-morphism.patch",
    "created_at": "2010-11-20T18:59:30Z",
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10297/trac_10297-morphism.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [trac_10297-morphism.patch](https://github.com/sagemath/sage/files/ticket10297/trac_10297-morphism.patch) by @JohnCremona created at 2010-11-20 18:59:30\n\napplies to 4.6.1.alpha1",
    "created_at": "2010-11-20T18:59:30Z",
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10297#issuecomment-98363",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [trac_10297-morphism.patch](https://github.com/sagemath/sage/files/ticket10297/trac_10297-morphism.patch) by @JohnCremona created at 2010-11-20 18:59:30
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10297#issuecomment-98364",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10297#event-78670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10297#issuecomment-98365",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10297#event-78671"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10297#event-78672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10297#issuecomment-98366",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10297#issuecomment-98367",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10297#event-78673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10297#event-78674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10297#issuecomment-98368",
