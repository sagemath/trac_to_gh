...
```json
{
    ...
    "asset_name": "compilation_msg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket10437/compilation_msg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10437#issuecomment-101389",
    "user": "https://trac.sagemath.org/admin/accounts/users/Christyves"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10437#issuecomment-101390",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10437#issuecomment-101391",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10437",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10437#event-81517"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10437#event-81518"
}
```
...
```json
{
    ...
    "milestone": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10437#event-81519"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10437#event-81520"
}
```
