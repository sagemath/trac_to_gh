...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10285#event-123289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10285#event-123290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10285#event-123291"
}
```
...
```json
{
    "body": "Changed assignee from **GeorgSWeber** to **Snark**",
...
Changed assignee from **GeorgSWeber** to **Snark**
...
```json
{
    "body": "Changed assignee from **Snark** to **GeorgSWeber**",
    "created_at": "2010-11-23T20:32:19Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10285",
    "type": "issue_comment",
...
Changed assignee from **Snark** to **GeorgSWeber**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10285#issuecomment-98003",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10285#issuecomment-98004",
    "user": "https://github.com/sagetrac-jpflori"
}
```
