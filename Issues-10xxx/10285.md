...
```json
{
    "body": "Changed assignee from **@sagetrac-GeorgSWeber** to **@SnarkBoojum**",
...
Changed assignee from **@sagetrac-GeorgSWeber** to **@SnarkBoojum**
...
```json
{
    "body": "Changed assignee from **@SnarkBoojum** to **@sagetrac-GeorgSWeber**",
    "created_at": "2010-11-23T20:32:19Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10285",
    "type": "issue_comment",
...
Changed assignee from **@SnarkBoojum** to **@sagetrac-GeorgSWeber**
