...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10312#event-123709"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10312#event-123710"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10312#event-123711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10312#issuecomment-98640",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10312#issuecomment-98641",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10312#issuecomment-98642",
    "user": "https://github.com/zimmermann6"
}
```
