...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139968",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139969",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139970",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Amazing speed getting this up!  Shouldn't \"((?:abs(?:solute)?)\" be \"((?:abs(?:olute)?)\" ?",
    "created_at": "2011-03-17T13:45:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139971",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>Amazing speed getting this up!  Shouldn't "((?:abs(?:solute)?)" be "((?:abs(?:olute)?)" ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139973",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139974",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [10952-tol-doc.patch](tarball://root/attachments/some-uuid/ticket10952/10952-tol-doc.patch) by @robertwb created at 2011-03-18 06:31:46\n\nThanks for the comments, new patches attached.",
    "created_at": "2011-03-18T06:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139975",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:4'></a>Attachment [10952-tol-doc.patch](tarball://root/attachments/some-uuid/ticket10952/10952-tol-doc.patch) by @robertwb created at 2011-03-18 06:31:46
...
```json
{
    "body": "<a id='comment:7'></a>Yes, it would (though you do have to explicitly annotate the test with a tolerance, and if Python 2.7 consistently gives, e.g., 3.4 then we should change the doctest rather than make it fuzzy.)",
    "created_at": "2011-04-24T04:58:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139977",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>Yes, it would (though you do have to explicitly annotate the test with a tolerance, and if Python 2.7 consistently gives, e.g., 3.4 then we should change the doctest rather than make it fuzzy.)
...
```json
{
    "body": "<a id='comment:8'></a>In trying to review this ticket, I applied 10952-tol-bin.patch in the local/bin directory of a skynet/taurus (x86_64-Linux-nehalem) build of sage-4.7.rc2.  I next did 'sage -b'.  Yet I get\n\n```\nsage: print \"The answers are\", 1.5, 2, 1e-12 # tol 1e-3\nThe answers are 1.50000000000000 2 1.00000000000000e-12\n```\n\nAm I missing something?",
    "created_at": "2011-05-13T14:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139978",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```

<a id='comment:8'></a>In trying to review this ticket, I applied 10952-tol-bin.patch in the local/bin directory of a skynet/taurus (x86_64-Linux-nehalem) build of sage-4.7.rc2.  I next did 'sage -b'.  Yet I get
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139979",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Another nitpicky: the doc patch misspells \"arithmetic\".  Definitely not big enough to stop a positive review, but also not big enough to be worth my effort in making a new patch right now.",
    "created_at": "2011-05-14T00:32:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139981",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:10'></a>Another nitpicky: the doc patch misspells "arithmetic".  Definitely not big enough to stop a positive review, but also not big enough to be worth my effort in making a new patch right now.
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [10952-tol-doc.2.patch](tarball://root/attachments/some-uuid/ticket10952/10952-tol-doc.2.patch) by @robertwb created at 2011-05-14 00:36:56\n\nArgh. Fixed.",
    "created_at": "2011-05-14T00:36:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139982",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:11'></a>Attachment [10952-tol-doc.2.patch](tarball://root/attachments/some-uuid/ticket10952/10952-tol-doc.2.patch) by @robertwb created at 2011-05-14 00:36:56
...
```json
{
    "body": "<a id='comment:12'></a>Thanks!  If we had a github pull system, or a system where I could edit the patch inline, I would have fixed it.",
    "created_at": "2011-05-14T00:39:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139983",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:12'></a>Thanks!  If we had a github pull system, or a system where I could edit the patch inline, I would have fixed it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139984",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139985",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139986",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139987",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>That *person* would be the release manager.  He would be the only one able (or supposed to) merge into the master branch.\n\nOn the other hand, given our problems with finding release managers who could do the entire release process, maybe sharing the burden to commit patches to master wouldn't be a bad idea.",
    "created_at": "2011-05-14T15:02:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139988",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:14'></a>That *person* would be the release manager.  He would be the only one able (or supposed to) merge into the master branch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139990",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139991",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139992",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>True. It doesn't work with print (or other non-expression statements). I've created #11336 to generalize it. \n\nI think that this is still plenty useful even with that limitation, and don't know when I'll have more time to work on it--we could either get this in and start using it now or hold off until has time to write a more complete implementation at some later date (which I'd like to get to someday, but that someday list is long...)",
    "created_at": "2011-05-16T19:38:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139993",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:16'></a>True. It doesn't work with print (or other non-expression statements). I've created #11336 to generalize it. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139994",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139995",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139996",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139997",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139998",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Which patches have to be applied?",
    "created_at": "2011-05-17T15:33:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-139999",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>Which patches have to be applied?
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10952#event-28395"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I think the documentation should be expanded a bit to show less trivial examples, for example complex numbers or polynomials with non-exact coefficients.",
    "created_at": "2011-05-17T15:48:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140000",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>I think the documentation should be expanded a bit to show less trivial examples, for example complex numbers or polynomials with non-exact coefficients.
...
```json
{
    "body": "<a id='comment:20'></a>Also matrices",
    "created_at": "2011-05-17T15:48:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140001",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>Also matrices
...
```json
{
    "body": "<a id='comment:21'></a>Attachment [trac_10952-reviewer-docs.patch](tarball://root/attachments/some-uuid/ticket10952/trac_10952-reviewer-docs.patch) by @rbeezer created at 2011-08-22 06:24:44\n\nI have added an \"Apply\" list for this ticket.\n\nMy patch fixes one typo in the documentation (a missing ]).\n\nI have added some non-trivial tests.\n\nJeroen:\n\n1.  abs() for a matrix computes the determinant.  Not useful for testing.\n\n2.  Is there a class of polynomials with numerical coefficients?  Does it have abs() defined on it?\n\nI am working on this as a high-priority ticket for Bug Days 32.\n\nRob",
    "created_at": "2011-08-22T06:24:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140002",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:21'></a>Attachment [trac_10952-reviewer-docs.patch](tarball://root/attachments/some-uuid/ticket10952/trac_10952-reviewer-docs.patch) by @rbeezer created at 2011-08-22 06:24:44
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140003",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140004",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140006",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140007",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140008",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140009",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140010",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140011",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Reviewer documentation v2 patch cleans up the mess.\n\nI used `10^16` intentionally.  The tolerance feature does *arithmetic* with the \noutput, so does not have to identically match as text.  Maybe that deserves a comment?\n\nRob",
    "created_at": "2011-08-24T07:08:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140012",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:24'></a>Reviewer documentation v2 patch cleans up the mess.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140013",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140014",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Reviewer documentation v3 patch adds a comment about intended output being of any form, fixes some missing quotes and expands a bit more on how this works.  Passes tests, so should be ready for review.",
    "created_at": "2011-08-24T16:15:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140015",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:25'></a>Reviewer documentation v3 patch adds a comment about intended output being of any form, fixes some missing quotes and expands a bit more on how this works.  Passes tests, so should be ready for review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140016",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Nice.  Game changer!!!!   Sweet.  It's about time.  Great work!  W00t.  FTW.  Frickin' awesome.",
    "created_at": "2011-08-24T16:38:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140017",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:26'></a>Nice.  Game changer!!!!   Sweet.  It's about time.  Great work!  W00t.  FTW.  Frickin' awesome.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140018",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140019",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140020",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>Shouldn't the code only be included if the doctests actually contain `# tol ...`?\n\n`( +[0-9.e+-]+)?` hardly matches what we want btw.\n\n\n\n\n\nI've put this onto the 1337 ticket (#11337).",
    "created_at": "2011-09-08T23:48:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140021",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:29'></a>Shouldn't the code only be included if the doctests actually contain `# tol ...`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140022",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140024",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140025",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140026",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>But `float(1ee7)` raises an error.  Why would we want to match that?\n\nRe the issue of raising tolerance, I hope that referees will keep an eye on that sort of thing.  Dave Kirkby, for example, is a strong advocate of not arbitrarily raising tolerance.",
    "created_at": "2011-09-09T05:01:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140027",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:32'></a>But `float(1ee7)` raises an error.  Why would we want to match that?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140028",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>I've fixed the issue with blanklines terminating example blocks. As for the regular expression for floats, I don't see any need to make it more complicated--I'd rather match miss-typed numbers and raise an error than silently ignore them. If you feel strongly, this could be changed.\n\nReferees should keep an eye on precision. This is back to my philosophy that a computer should run doctests and a human read the code (though we could add a patchbot plugin to flag drops in precision). It's not a new issue--we've been using \"...\" for quite a while now which is less flexible and more dangerous (as it can match more than just a single number).",
    "created_at": "2011-09-09T05:26:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140029",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:33'></a>I've fixed the issue with blanklines terminating example blocks. As for the regular expression for floats, I don't see any need to make it more complicated--I'd rather match miss-typed numbers and raise an error than silently ignore them. If you feel strongly, this could be changed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140030",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140031",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>How about emitting the extra code only if `# tol ...` is used at all in the file?\n\nThat's a simple `\"\"\"... %s ...\"\"\" % (tolerance_code if uses_tol else \"\")`.",
    "created_at": "2011-09-09T05:48:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140032",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:35'></a>How about emitting the extra code only if `# tol ...` is used at all in the file?
...
```json
{
    "body": "<a id='comment:36'></a>You're talking about the `check_with_tolerance` function and helpers. One could add a variable to keep track of this and conditionally emit it; not sure if the added complexity is worth the tiny savings.",
    "created_at": "2011-09-09T06:15:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140033",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:36'></a>You're talking about the `check_with_tolerance` function and helpers. One could add a variable to keep track of this and conditionally emit it; not sure if the added complexity is worth the tiny savings.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140037",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140038",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140040",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140041",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140042",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140043",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140044",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140045",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10952#event-28396"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>I'd like to draw the attention of folks here to[comment:7](#comment%3A7):ticket:12493.  Apparently one can't do `only-optional` tests along with `tol` tests at the same time.   My guess is that not too many people use `only-optional` and the `tol` stuff is pretty new.\n\nIn fact, I only found one occurrence in 5.0.beta3.  Can that be right?  This has been in Sage for months!\n\n```\nsage: search_src(\" tol \",\"#\")\nsymbolic/integration/integral.py:587:        sage: error.numerical_approx() # abs tol 10e-10\n```\nAnyway, even if my analysis is wrong (let's hope it's easier than that), I figure the people here can give a quick diagnosis of #12493.",
    "created_at": "2012-02-10T20:06:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140046",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:44'></a>I'd like to draw the attention of folks here to[comment:7](#comment%3A7):ticket:12493.  Apparently one can't do `only-optional` tests along with `tol` tests at the same time.   My guess is that not too many people use `only-optional` and the `tol` stuff is pretty new.
...
```json
{
    "body": "<a id='comment:45'></a>Actually,[comment:8](#comment%3A8):ticket:12493 is even better!  Optional and tol don't play well together.",
    "created_at": "2012-02-10T20:07:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10952#issuecomment-140047",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:45'></a>Actually,[comment:8](#comment%3A8):ticket:12493 is even better!  Optional and tol don't play well together.
