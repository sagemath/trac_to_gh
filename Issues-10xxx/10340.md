...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127779",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127780",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The error occurs because PolyBori -- when eliminating some variables from the system -- attempts to create a ring with zero variables. This also explains why your second system works.\n\nI removed that check from our wrapper, but that doesn't only makes the code fail later. Michael, should PolyBoRi support rings with zero variables or not? In either case I think this is a bug in the upstream code. \n\nIn the process of looking into this I noticed that the error message was wrong. I fixed that in the attached patch.\n\nPS: The author field is used to indicate who wrote the patch to fix the issue.",
    "created_at": "2010-11-26T16:09:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127781",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>The error occurs because PolyBori -- when eliminating some variables from the system -- attempts to create a ring with zero variables. This also explains why your second system works.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127782",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127783",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This issue is fixed, I just tried it with 4.8. I suggest to close it.",
    "created_at": "2012-03-24T12:35:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127784",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>This issue is fixed, I just tried it with 4.8. I suggest to close it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127785",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127786",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Duplicate of #12655 (maybe even fixed earlier).\nAbusing \"positive review\".",
    "created_at": "2012-06-25T09:38:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127787",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:5'></a>Duplicate of #12655 (maybe even fixed earlier).
Abusing "positive review".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127788",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127789",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127790",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10340#event-26594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10340#event-26595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10340#issuecomment-127791",
