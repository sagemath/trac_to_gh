...
```json
{
    "body": "<a id='comment:1'></a>This is related with #10295 and #10296.",
    "created_at": "2010-11-20T09:20:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126528",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>This is related with #10295 and #10296.
...
```json
{
    "body": "<a id='comment:3'></a>This may also be relevant: http://groups.google.com/group/linux.kernel/browse_thread/thread/5a2b00e35b0864a7",
    "created_at": "2010-11-20T18:17:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126530",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>This may also be relevant: http://groups.google.com/group/linux.kernel/browse_thread/thread/5a2b00e35b0864a7
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126531",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126532",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126533",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>(Change in owner was not intended.)",
    "created_at": "2010-11-24T00:33:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126534",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:7'></a>(Change in owner was not intended.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10294#issuecomment-126535",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26475"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26476"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26477"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26478"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26479"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26480"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10294#event-26481"
}
```
