...
```json
{
    "body": "<a id='comment:2'></a>Have you tried building Sage with `SAGE_BINARY_BUILD=yes`? (See the [http://sagemath.org/doc/installation/source.html#environment-variables installation guide and the pil spkg.) That fixes some problems like this for me. It would be nice to not have to do this, of course...",
    "created_at": "2012-03-06T03:54:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10059#issuecomment-105985",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Have you tried building Sage with `SAGE_BINARY_BUILD=yes`? (See the [http://sagemath.org/doc/installation/source.html#environment-variables installation guide and the pil spkg.) That fixes some problems like this for me. It would be nice to not have to do this, of course...
...
```json
{
    "body": "<a id='comment:3'></a>No, I haven't.  On the other hand, I don't have one of those other tickets installed anyway.",
    "created_at": "2012-03-06T03:59:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10059#issuecomment-105986",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>No, I haven't.  On the other hand, I don't have one of those other tickets installed anyway.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25560"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25561"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25562"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25563"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25564"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25565"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10059#issuecomment-105987",
...
```json
{
    "body": "<a id='comment:8'></a>We use now Pillow instead of PIL; Its likely that this is fixed. I haven't seen such an issue on the build bot. \n\nI suggest to close it as fixed.",
    "created_at": "2014-08-11T11:19:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10059#issuecomment-105988",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>We use now Pillow instead of PIL; Its likely that this is fixed. I haven't seen such an issue on the build bot. 
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25567"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25568"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I haven't seen it for a long time either, so I suggest we close it and open a new one as well if it comes up again, since it won't be quite the same.",
    "created_at": "2014-08-14T13:54:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10059#issuecomment-105989",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>I haven't seen it for a long time either, so I suggest we close it and open a new one as well if it comes up again, since it won't be quite the same.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10059#event-25569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10059#issuecomment-105990",
    "user": "https://github.com/vbraun"
}
```
