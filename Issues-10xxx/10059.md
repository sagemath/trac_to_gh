...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10059#event-119824"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10059#event-119825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10059#event-119826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10059#issuecomment-94279",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10059#issuecomment-94280",
    "user": "https://github.com/kcrisman"
}
```
