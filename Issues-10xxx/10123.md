...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122803",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I'll take care of this and will produce a package for someone to review.",
    "created_at": "2010-10-12T13:27:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122804",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>I'll take care of this and will produce a package for someone to review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122805",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122807",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10123#event-25832"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10123#event-25833"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10123#event-25834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122808",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122809",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Obsolete because it is contained in ATLAS now (and should be removed by #15685)",
    "created_at": "2014-01-18T11:28:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122810",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Obsolete because it is contained in ATLAS now (and should be removed by #15685)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122811",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10123#event-25835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10123#issuecomment-122812",
