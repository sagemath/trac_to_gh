...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10030#event-119307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10030#event-119308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10030#event-119309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10030#issuecomment-93612",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10030#issuecomment-93613",
    "user": "https://github.com/jdemeyer"
}
```
