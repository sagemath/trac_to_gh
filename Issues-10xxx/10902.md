...
```json
{
    "body": "<div id=\"comment:19\" align=\"right\">Comment 19</div>\n\nfor the proof thingy you'll also need to apply the patch from this ticket, i.e.,[attachment: trac_10902_factor_fixed.patch](https://github.com/sagemath/sage/files/ticket10902/trac_10902_factor_fixed.patch.gz)",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-131883"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-131884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-131885"
}
```
