...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121601"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121606"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121607"
}
```
...
```json
{
    "body": "**Changing work issues** from \"spkg fails to build\" to \"Proof=... still present\".",
    "created_at": "2011-09-30T09:18:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_comment",
...
**Changing work issues** from "spkg fails to build" to "Proof=... still present".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10902#issuecomment-107707",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10902#issuecomment-107708",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "**Changing work issues** from \"Proof=... still present\" to \"\".",
    "created_at": "2012-04-13T16:42:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10902#issuecomment-107709",
    "user": "https://github.com/malb"
}
```

**Changing work issues** from "Proof=... still present" to "".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10902#issuecomment-107710",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10902#issuecomment-107711",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121616"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121617"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121618"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121619"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10902",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10902#event-121620"
}
```
