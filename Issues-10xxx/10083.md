...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10083/python-2.6.4.p10.log",
    "created_at": "2010-10-06T07:35:19Z",
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10083/python-2.6.4.p10.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [python-2.6.4.p10.log](https://github.com/sagemath/sage/files/ticket10083/python-2.6.4.p10.log) by drkirkby created at 2010-10-06 07:35:19\n\nInstall log for Python. This is based on a patched python package, which gets around the problem at #9995. This package is not yet part of Sage.",
    "created_at": "2010-10-06T07:35:19Z",
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10083#issuecomment-94529",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [python-2.6.4.p10.log](https://github.com/sagemath/sage/files/ticket10083/python-2.6.4.p10.log) by drkirkby created at 2010-10-06 07:35:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10083#issuecomment-94530",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10083#issuecomment-94531",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76258"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76259"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76260"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76261"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76262"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76263"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76264"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76265"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76266"
}
```
...
```json
{
    ...
    "label": "wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10083#issuecomment-94532",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10083#issuecomment-94533",
...
```json
{
    ...
    "label": "wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76269"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76270"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10083",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10083#event-76271"
}
```
