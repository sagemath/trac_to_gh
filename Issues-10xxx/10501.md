...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130066",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130067",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Three files caused doctest errors on a full run with only the necessary changes in sage/matrix.  I've made changes in these other places to fix those failures, and the affected files now pass their tests.  I'm running the full suite right now.\n\nI've cc'ed folks who I think might be able to double-check that no complications have crept in.  If you want to sneak a quick look at the patch, here's a quick guide:\n\nMinh, David:  sage/crypto/classical.py,  inverse_key() for a Hill Cryptosystem\n\nGonzalo:  sage/quadratic_forms/quadratic_form_ternary_Tornaria.py,  adjoints of a form\n\nWilliam:  sage/quadratic_forms/quadratic_form.py,  adjoint_primitive()",
    "created_at": "2010-12-20T22:57:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130068",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>Three files caused doctest errors on a full run with only the necessary changes in sage/matrix.  I've made changes in these other places to fix those failures, and the affected files now pass their tests.  I'm running the full suite right now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130070",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130074",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130075",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>> > Did someone seriously implement `m.conjugate_transpose()` as a shortcut for `m.conjugate().transpose()`? =)\n\n> \n\nIt's not as bad as you think, because tab-completion doesn't work on `m.conjugate()`, though it would be awesome if Sage could magically know that...\n\nRob, so what does the latest version of your book do?",
    "created_at": "2012-12-12T03:58:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130076",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>> > Did someone seriously implement `m.conjugate_transpose()` as a shortcut for `m.conjugate().transpose()`? =)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130077",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26917"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26918"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26919"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26920"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26921"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26922"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26923"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26924"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26925"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I want to revive this ticket. So here is the needed patch.\n\nOne thing not found in Rob's original patch is alias `adjoint_classical` of `adjugate`. The alias is used in quadratic form code in Sage.\n\n---\nNew commits:",
    "created_at": "2018-10-05T10:23:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130078",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:14'></a>I want to revive this ticket. So here is the needed patch.
...
```json
{
    "body": "Changing branch from \"\" to \"u/klee/10501\"",
    "created_at": "2018-10-05T10:23:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130079",
    "user": "https://github.com/kwankyu"
}
```

Changing branch from "" to "u/klee/10501"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130080",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130081",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"0669f64d384d8b42838d590a41a6bf9fcb115979\"",
    "created_at": "2018-10-05T10:23:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130082",
    "user": "https://github.com/kwankyu"
}
```

Changing commit from "" to "0669f64d384d8b42838d590a41a6bf9fcb115979"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130083",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130084",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130085",
...
```json
{
    "body": "Changing commit from \"0669f64d384d8b42838d590a41a6bf9fcb115979\" to \"43ab6df581d54a2d627c030443a9320c6a7dee8e\"",
    "created_at": "2018-10-12T06:33:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130086",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0669f64d384d8b42838d590a41a6bf9fcb115979" to "43ab6df581d54a2d627c030443a9320c6a7dee8e"
...
```json
{
    "body": "Changing commit from \"43ab6df581d54a2d627c030443a9320c6a7dee8e\" to \"08eee094dd63965b8aadf3a38b2f3fe620910a9b\"",
    "created_at": "2018-10-12T07:07:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130087",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "43ab6df581d54a2d627c030443a9320c6a7dee8e" to "08eee094dd63965b8aadf3a38b2f3fe620910a9b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130088",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"08eee094dd63965b8aadf3a38b2f3fe620910a9b\" to \"d1bbfb1bd29c9cfb688d24d9a71e92ce98148513\"",
    "created_at": "2018-10-13T02:59:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130089",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "08eee094dd63965b8aadf3a38b2f3fe620910a9b" to "d1bbfb1bd29c9cfb688d24d9a71e92ce98148513"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130090",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130091",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"d1bbfb1bd29c9cfb688d24d9a71e92ce98148513\" to \"2f1597566c868739e748599aa5e8b2c2eb59775e\"",
    "created_at": "2018-10-16T04:31:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130092",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d1bbfb1bd29c9cfb688d24d9a71e92ce98148513" to "2f1597566c868739e748599aa5e8b2c2eb59775e"
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26926"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26927"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I wholeheartedly agree with \"adjugate\". When I see \"adjoint\", I look up the definition. When I see \"adjugate\", I immediately know what is meant.\n\nPushed a little commit to improve the documentation. IMHO, this is an easy ticket to review: just run all doctests. If they work, then it's fine.\n\n---\nNew commits:",
    "created_at": "2019-01-16T17:59:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130093",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:21'></a>I wholeheartedly agree with "adjugate". When I see "adjoint", I look up the definition. When I see "adjugate", I immediately know what is meant.
...
```json
{
    "body": "Changing branch from \"u/klee/10501\" to \"public/ticket/10501\"",
    "created_at": "2019-01-16T17:59:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130094",
    "user": "https://github.com/darijgr"
}
```

Changing branch from "u/klee/10501" to "public/ticket/10501"
...
```json
{
    "body": "Changing commit from \"2f1597566c868739e748599aa5e8b2c2eb59775e\" to \"b4994c43854ebbece7186b7b7b5cd132873f9939\"",
    "created_at": "2019-01-16T17:59:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130095",
    "user": "https://github.com/darijgr"
}
```

Changing commit from "2f1597566c868739e748599aa5e8b2c2eb59775e" to "b4994c43854ebbece7186b7b7b5cd132873f9939"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130096",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130097",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"b4994c43854ebbece7186b7b7b5cd132873f9939\" to \"356285df8e0ede0f6d2ccc02559744004528b744\"",
    "created_at": "2019-01-17T04:45:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130098",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b4994c43854ebbece7186b7b7b5cd132873f9939" to "356285df8e0ede0f6d2ccc02559744004528b744"
...
```json
{
    "body": "<a id='comment:23'></a>Squashed and rebased to sage 8.6. In addition, refined some docstrings and comments.",
    "created_at": "2019-01-17T04:49:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130099",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:23'></a>Squashed and rebased to sage 8.6. In addition, refined some docstrings and comments.
...
```json
{
    "body": "<a id='comment:24'></a>If klee and darij are both agreed that each other's respective contributions are sufficient, then you can jointly set to positive review (sometimes Authors are 1, 2 and Reviewers are 2, 1).\n\nI do wonder whether some of the py3 things like\n\n```diff\n-                raise TypeError(\"Oops!  The matrix must have \" + str(n) + \" rows. =(\")\n+                raise TypeError(\"the matrix must have {} rows\".format(n))\n```\nare necessary on this ticket, since it makes it a little more of a patch bomb.\n\nAlso, don't we typically test deprecations (and then remove when deprecation is done)?",
    "created_at": "2019-01-17T12:43:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130100",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:24'></a>If klee and darij are both agreed that each other's respective contributions are sufficient, then you can jointly set to positive review (sometimes Authors are 1, 2 and Reviewers are 2, 1).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130101",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130104",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"356285df8e0ede0f6d2ccc02559744004528b744\" to \"bf44252756d2f663acc479c1a345c1913716a1f6\"",
    "created_at": "2019-01-18T02:20:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130105",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "356285df8e0ede0f6d2ccc02559744004528b744" to "bf44252756d2f663acc479c1a345c1913716a1f6"
...
```json
{
    "body": "<a id='comment:29'></a>Anything else to do?",
    "created_at": "2019-01-22T11:57:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130106",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:29'></a>Anything else to do?
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26928"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26929"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>The new version looks good to me. If complete doctests pass (anyone please check), please make this a positive_review.\n\n(I should not be listed as author; my changes were trivial.)",
    "created_at": "2019-01-22T12:18:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130107",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:30'></a>The new version looks good to me. If complete doctests pass (anyone please check), please make this a positive_review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130108",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130109",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "Changing branch from \"public/ticket/10501\" to \"bf44252756d2f663acc479c1a345c1913716a1f6\"",
    "created_at": "2019-02-04T23:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130110",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/ticket/10501" to "bf44252756d2f663acc479c1a345c1913716a1f6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10501#event-26930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10501#issuecomment-130111",
    "user": "https://github.com/vbraun"
}
```
