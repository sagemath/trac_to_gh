...
archive/attachments_013782.json:
```json
{
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [trac_10175_anti_symmetric_product_characters.2.patch](https://github.com/sagemath/sage/files/ticket10175/trac_10175_anti_symmetric_product_characters.2.patch)\n\nRediffed for sage-4.8.alpha4",
    "created_at": "2011-12-15T20:04:21Z",
    "issue": "https://github.com/sagemath/sage/issues/10175",
    "type": "issue_comment",
...
archive/attachments_013783.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_10175_anti_symmetric_product_characters.patch](https://github.com/sagemath/sage/files/ticket10175/trac_10175_anti_symmetric_product_characters.patch)\n\nUpdated patch",
    "created_at": "2012-01-08T23:56:49Z",
    "issue": "https://github.com/sagemath/sage/issues/10175",
    "type": "issue_comment",
...
**Attachment:** [trac_10175_anti_symmetric_product_characters.patch](https://github.com/sagemath/sage/files/ticket10175/trac_10175_anti_symmetric_product_characters.patch)
