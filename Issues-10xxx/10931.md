...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-127874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-127875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10931#issuecomment-108343",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-127876"
}
```
...
```json
{
    "body": "Changed assignee from **sage-combinat** to **@mantepse**",
    "created_at": "2011-03-14T10:31:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10931#issuecomment-108344",
    "user": "https://github.com/mantepse"
}
```

Changed assignee from **sage-combinat** to **@mantepse**
