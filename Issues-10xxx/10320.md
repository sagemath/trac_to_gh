...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10320#issuecomment-100271",
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10320#event-80746"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10320",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10320#event-80747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10320#event-80748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10320#event-80749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10320",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10320#issuecomment-100272",
    "user": "https://github.com/jplab"
}
```
