...
```json
{
    "body": "<a id='comment:1'></a>In principle, it is ready, but there are some issues building documentation, I'll resolve them shortly.\n\nThe patch looks big, but half of it is documentation and the other half doctests adjustments ;-)",
    "created_at": "2010-12-16T04:49:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129446",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:1'></a>In principle, it is ready, but there are some issues building documentation, I'll resolve them shortly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129447",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"documentation build\"",
    "created_at": "2010-12-16T04:49:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129448",
    "user": "https://github.com/novoselt"
}
```

Changing work_issues from "" to "documentation build"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129449",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129452",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129453",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129454",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129456",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129457",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I still don't get why we can't break up the huge equation if *none* of the backends renders it correctly. Saying that its not your problem is a cop out, jsmath will never be 100% compatible with LaTeX. \n\nIn any case, functionally its fine and I'll give it a positive review. If Andrey changes his mind and wants a readable documentation then he's welcome to update it.",
    "created_at": "2011-01-13T08:51:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129458",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>I still don't get why we can't break up the huge equation if *none* of the backends renders it correctly. Saying that its not your problem is a cop out, jsmath will never be 100% compatible with LaTeX. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129459",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129460",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>#10624 reports the documentation problem.",
    "created_at": "2011-01-13T17:16:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129461",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:8'></a>#10624 reports the documentation problem.
...
```json
{
    "body": "<a id='comment:9'></a>In the notebook all 4 equations end up on one very long line. At least on Chrome the text is then as wide as the equation line, which is a good deal wider than my screen. I can zoom out until the equation fits, but then the text is tiny.",
    "created_at": "2011-01-13T17:29:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129462",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>In the notebook all 4 equations end up on one very long line. At least on Chrome the text is then as wide as the equation line, which is a good deal wider than my screen. I can zoom out until the equation fits, but then the text is tiny.
...
```json
{
    "body": "<a id='comment:10'></a>This is exactly why I try to fight long lines in examples and their output...\n\nI opened\nhttp://groups.google.com/group/sage-devel/browse_thread/thread/5af60a53b2618833#\nand if there will be no solution I'll think again about breaking the block into pieces.",
    "created_at": "2011-01-13T17:52:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129463",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:10'></a>This is exactly why I try to fight long lines in examples and their output...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129464",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10479#issuecomment-129465",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10479",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10479#event-26831"
}
```
