...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132617",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27202"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27203"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27204"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27205"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27206"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27207"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27208"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Works with 8.2.beta8\n\n```\nsage: V2 = VectorSpace(GF(2), 2, inner_product_matrix =\n....: matrix.diagonal(GF(2), [1,1]))\nsage: deepcopy(V2)\nAmbient quadratic space of dimension 2 over Finite Field of size 2\nInner product matrix:\n[1 0]\n[0 1]\n```",
    "created_at": "2018-03-20T12:45:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132618",
    "user": "https://github.com/simonbrandhorst"
}
```

<a id='comment:6'></a>Works with 8.2.beta8
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132619",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27209"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27210"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>adding a doctest\n\n---\nNew commits:",
    "created_at": "2018-04-15T12:12:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132620",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>adding a doctest
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132621",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27211"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132622",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132623",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Add your name as an author and you have it.",
    "created_at": "2018-04-18T14:04:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132624",
    "user": "https://github.com/simonbrandhorst"
}
```

<a id='comment:9'></a>Add your name as an author and you have it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132625",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132626",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132627",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>thanx",
    "created_at": "2018-04-18T14:05:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132628",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:10'></a>thanx
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132629",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10577#event-27213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10577#issuecomment-132630",
    "user": "https://github.com/vbraun"
}
```
