...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10078#event-120115"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10078#event-120116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10078#event-120117"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10078#issuecomment-94528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10078#issuecomment-94529",
    "user": "https://github.com/sagetrac-mvngu"
}
```
