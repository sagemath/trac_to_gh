...
```json
{
    "body": "<a id='comment:1'></a>Question: will this confused people who have never seen a dict before?  After all, that is a large part of who is using this functionality (based on sage-support requests).",
    "created_at": "2010-11-04T20:13:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10213#issuecomment-108714",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Question: will this confused people who have never seen a dict before?  After all, that is a large part of who is using this functionality (based on sage-support requests).
...
```json
{
    "body": "<a id='comment:2'></a>Also, it possibly breaks a lot of existing code.  There should be some thought put in before this happens.",
    "created_at": "2010-11-04T22:53:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10213#issuecomment-108715",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>Also, it possibly breaks a lot of existing code.  There should be some thought put in before this happens.
...
```json
{
    "body": "<a id='comment:3'></a>+1 to thinking.  I think it probably warrants a different function name than solve, or maybe just a different syntax for calling solve.\n\nI don't think it will confuse people who haven't seen a dict.  The output would look like this:\n\n[{x: 3, y: 4}, {x: 1, y: 5}]\n\nwhich I think is very understandable.",
    "created_at": "2010-11-05T02:59:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10213#issuecomment-108716",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>+1 to thinking.  I think it probably warrants a different function name than solve, or maybe just a different syntax for calling solve.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26179"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26180"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26181"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26182"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26183"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26184"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10213#event-26185"
}
```
