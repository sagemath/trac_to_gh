...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128293",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128294",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128295",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128296",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_10359-pil-1.1.6.p3-p4.spkg.patch](tarball://root/attachments/some-uuid/ticket10359/trac_10359-pil-1.1.6.p3-p4.spkg.patch) by @nexttime created at 2010-12-01 06:17:09\n\n**New spkg: http://spkg-upload.googlecode.com/files/pil-1.1.6.p4.spkg**\n\n**md5sum:** `73c8f01c0cd6923f7636147b350a6c70  pil-1.1.6.p4.spkg`",
    "created_at": "2010-12-01T06:17:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128297",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Attachment [trac_10359-pil-1.1.6.p3-p4.spkg.patch](tarball://root/attachments/some-uuid/ticket10359/trac_10359-pil-1.1.6.p3-p4.spkg.patch) by @nexttime created at 2010-12-01 06:17:09
...
```json
{
    "body": "<a id='comment:3'></a>I have tested the updated package on CentOS 5.5 and OpenSuse 11.2; it is now able to successfully locate libjpeg and it enables JPEG support properly.",
    "created_at": "2010-12-01T14:29:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128299",
    "user": "https://trac.sagemath.org/admin/accounts/users/Koen"
}
```

<a id='comment:3'></a>I have tested the updated package on CentOS 5.5 and OpenSuse 11.2; it is now able to successfully locate libjpeg and it enables JPEG support properly.
...
```json
{
    "body": "<a id='comment:5'></a>Authors: do you think it makes sense to include this as it is in the next alpha?",
    "created_at": "2010-12-02T23:23:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128300",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Authors: do you think it makes sense to include this as it is in the next alpha?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128301",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128302",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I would not do any of this on Solaris. The run-time linker should take the library from the correct directory, based on whether it's 32-bit or 64-bit. It would be \n\n`/lib/`isainfo -n`/`\n\nwhere for all modern machines, `isainfo -n` will return either `sparcv9` or `amd64`\n\nIs there some equivalent of `isainfo -n` which exists on Linux, and so one would not have code that is depends on the distribution? \n\nDave",
    "created_at": "2010-12-03T03:10:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128303",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:8'></a>I would not do any of this on Solaris. The run-time linker should take the library from the correct directory, based on whether it's 32-bit or 64-bit. It would be 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128304",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128305",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Clearly its dumb of PIL to look in any particular hard-coded directory to see whether libjpeg is available. The only correct way (TM) is to build a test program and see if it compiles, as the autotools would do. We do have a configurable library search path precisely so that `configure` does not need to know the location of each library. Did you file an upstream bug report?\n\nThat being said, the band-aid of having a better hard-coded directory is probably the best we can do until upstream fixes their broken `setup.py`.",
    "created_at": "2010-12-03T13:01:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128306",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>Clearly its dumb of PIL to look in any particular hard-coded directory to see whether libjpeg is available. The only correct way (TM) is to build a test program and see if it compiles, as the autotools would do. We do have a configurable library search path precisely so that `configure` does not need to know the location of each library. Did you file an upstream bug report?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128307",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128308",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128309",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128310",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128312",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10359#event-26649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10359#issuecomment-128313",
    "user": "https://github.com/jdemeyer"
}
```
