...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127081",
    "user": "https://github.com/mguaypaq"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127083",
    "user": "https://github.com/mguaypaq"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Mathieu Guay-Paquet\"",
    "created_at": "2010-11-21T05:52:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127084",
    "user": "https://github.com/mguaypaq"
}
```

Changing author from "" to "Mathieu Guay-Paquet"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127086",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127087",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127088",
    "user": "https://github.com/mguaypaq"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I thought the use of a mutable default was safe, since it is always copied, never modified. But since there's an idiom against this, I'm happy to comply! And thanks for fixing the documentation issues.\n\nPositive review for the reviewer patch.",
    "created_at": "2010-11-23T00:07:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127089",
    "user": "https://github.com/mguaypaq"
}
```

<a id='comment:3'></a>I thought the use of a mutable default was safe, since it is always copied, never modified. But since there's an idiom against this, I'm happy to comply! And thanks for fixing the documentation issues.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10304#event-26517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127090",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10304#issuecomment-127091",
    "user": "https://github.com/jdemeyer"
}
```
