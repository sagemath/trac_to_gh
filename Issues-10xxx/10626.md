...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10626#issuecomment-103530",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10626/trac_10626-smith-form-integer-sparse.patch",
    "created_at": "2011-01-13T20:22:47Z",
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10626/trac_10626-smith-form-integer-sparse.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_10626-smith-form-integer-sparse.patch](https://github.com/sagemath/sage/files/ticket10626/trac_10626-smith-form-integer-sparse.patch) by @rbeezer created at 2011-01-13 20:22:47\n\nPatch mirrors docstring for dense matrices and just ships off a dense version of the matrix to that code.  `matrix/matrix_integer_sparse.pyx` is not included into the documentation, so I've added that chore to my list.",
    "created_at": "2011-01-13T20:22:47Z",
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10626#issuecomment-103531",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10626#issuecomment-103532",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10626#issuecomment-103533",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10626#issuecomment-103534",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10626#issuecomment-103535",
