...
```json
{
    "body": "In #26887 I will create new class with this name. Once this is done, it will be able to handle Polytopes and Lattice Polytopes. I don't know about cones.",
