...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10558#issuecomment-102629",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10558/M97sage4.3.png",
    "created_at": "2011-01-04T17:17:21Z",
    "issue": "https://github.com/sagemath/sage/issues/10558",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10558/M97sage4.3.png",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "Attachment [M97sage4.3.png](https://github.com/sagemath/sage/files/ticket10558/M97sage4.3.png) by @koffie created at 2011-01-04 17:17:21\n\nnice graphical version of cprofile output",
    "created_at": "2011-01-04T17:17:21Z",
    "issue": "https://github.com/sagemath/sage/issues/10558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10558#issuecomment-102630",
    "user": "https://github.com/koffie"
}
```

Attachment [M97sage4.3.png](https://github.com/sagemath/sage/files/ticket10558/M97sage4.3.png) by @koffie created at 2011-01-04 17:17:21
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10558/M97sage4.6.png",
    "created_at": "2011-01-04T17:56:44Z",
    "issue": "https://github.com/sagemath/sage/issues/10558",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10558/M97sage4.6.png",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [M97sage4.6.png](https://github.com/sagemath/sage/files/ticket10558/M97sage4.6.png) by @koffie created at 2011-01-04 17:56:44\n\nIt got slower by the bugfix in ticket #8612. The slower code is actually needed to garantee the correct result. This ticket should be closed.",
    "created_at": "2011-01-04T17:56:44Z",
    "issue": "https://github.com/sagemath/sage/issues/10558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10558#issuecomment-102631",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10558#issuecomment-102632",
