...
```json
{
    "body": "<a id='comment:1'></a>A failure of ATLAS to build has been seen by a number of people, on different systems. We need to keep an eye on this. \n\nDave",
    "created_at": "2010-10-01T22:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121464",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>A failure of ATLAS to build has been seen by a number of people, on different systems. We need to keep an eye on this. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121465",
    "user": "https://trac.sagemath.org/admin/accounts/users/tux21b"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121466",
    "user": "https://trac.sagemath.org/admin/accounts/users/tux21b"
}
```
...
```json
{
    "actor": "https://trac.sagemath.org/admin/accounts/users/tux21b",
    "created_at": "2010-11-22T23:04:22Z",
    "event": "closed",
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10051#event-25539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121468",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121470",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10051#event-25540"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The unmodified ATLAS source code only builds static libraries. We later produce shared ones from the static libraries. But your failure was before the static libraries were built. \n\nI thought one would get less problems like this if the system is lightly loaded, but I have seen comments to suggest the problem goes away when the machine is more heavily loaded.  \n\nI've seen this problem every time I try to create a virtual machine with VirtualBox on my system (quad core 3.33 GHz). But when the machine is just running the host operating system (OpenSolaris) it's ok. But a Linux guess always fails to build. \n\nDave",
    "created_at": "2010-11-23T00:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121472",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>The unmodified ATLAS source code only builds static libraries. We later produce shared ones from the static libraries. But your failure was before the static libraries were built. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121473",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10051#event-25541"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121474",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10051#event-25542"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121475",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Assuming this is fixed, for example by #10508.",
    "created_at": "2013-05-24T12:28:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10051#issuecomment-121476",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>Assuming this is fixed, for example by #10508.
