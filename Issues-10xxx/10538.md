...
```json
{
    "body": "I have added a review patch, but I haven't put anything in it yet.  \n\ncheers,\n\nHugh",
...
```json
{
    "body": "I think that what I have now posted in the review patch for #10538 (on the combinat server) makes the patch compatible with the changes I have introduced in reviewing #10527.  (It also pointed out some mistakes in my \"corrections\" to #10527...)  In particular, all doctests are passing for me.  If you find anything that is not working, please let me know; I will try to get it so everything is running properly for Sage Days 40.",
...
```json
{
    "body": "With an eye towards startup time, can all these new modules be imported on demand?",
...
```json
{
    "body": "I rebased the patches according to the new lazy import in #10527.",
...
```json
{
    "body": "Replying to [comment:27 gmoose05]:\n> Christian, please delete my old  (39.1 KB) patch and keep my (35.4 KB) patch in its place.  I no longer had permissions to replace my old patch.\n\n\nDone.",
...
```json
{
    "body": "I uploaded a new version of the patch with all missing doctests added. Let's see what the patchbot says...",
...
```json
{
    "body": "Okay, I had another look and made some last minor changes in the documentation -- I think it is ready to go once we can convince the patchbot to give us a green light!",
...
```json
{
    "body": "There is a minor issue in qmu_save: it does not work whenever the quiver has 0<m!=n frozen vertices.\nPlease include the attached patch.",
