...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10778#issuecomment-105848",
    "user": "https://github.com/sagetrac-gborguly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10778#issuecomment-105849",
...
```json
{
    "body": "Changed assignee from **@sagetrac-mvngu, @haraldschilly** to **@sagetrac-mvngu**",
...
Changed assignee from **@sagetrac-mvngu, @haraldschilly** to **@sagetrac-mvngu**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10778#event-129926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10778#event-129927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10778",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10778#event-129928"
}
```
