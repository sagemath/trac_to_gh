...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10556#event-126756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10556#event-126757"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10556#event-126758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10556#issuecomment-102664",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10556#issuecomment-102665",
    "user": "https://github.com/kcrisman"
}
```
