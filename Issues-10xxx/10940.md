...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10940#event-132321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10940#event-132322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10940#event-132323"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **kohel**",
...
Changed assignee from **@williamstein** to **kohel**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10940#issuecomment-108437",
    "user": "https://github.com/sagetrac-kohel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10940#issuecomment-108438",
    "user": "https://github.com/jdemeyer"
}
```
