...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121255",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121256",
...
```json
{
    "body": "<a id='comment:2'></a>Probably something has changed in roots(algorithm='numpy') between 4.6.alpha1 and 4.6.alpha2.\nWas numpy upgraded? Is the 4.6.alpha2 source available somewhere?\n\nPaul",
    "created_at": "2010-10-01T06:45:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121257",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>Probably something has changed in roots(algorithm='numpy') between 4.6.alpha1 and 4.6.alpha2.
Was numpy upgraded? Is the 4.6.alpha2 source available somewhere?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121262",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>> I just created a noddy C program on my OpenSolaris machine where this failed. \n\n\nwhat did fail? You got the expected result.\n\nPaul",
    "created_at": "2010-10-02T19:52:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121263",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:8'></a>> I just created a noddy C program on my OpenSolaris machine where this failed. 
...
```json
{
    "body": "<a id='comment:9'></a>Another datapoint.  On OS X 10.4 on PPC, I get\n\n```\nExpected:\n    doctest... UserWarning: NumPy does not support arbitrary precision arithmetic.  The roots found will likely have less precision than you expect.\n    [(-1.7724538509055158819194275565678253769874572753906250000000, 1), (1.7724538509055158819194275565678253769874572753906250000000, 1)]\nGot:\n    doctest:1: UserWarning: NumPy does not support arbitrary precision arithmetic.  The roots found will likely have less precision than you expect.\n    [(-1.7724538509055161039640324815991334617137908935546875000000, 1), (1.7724538509055158819194275565678253769874572753906250000000, 1)]\n```\nin Sage 4.6.alpha2",
    "created_at": "2010-10-04T16:49:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121264",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>Another datapoint.  On OS X 10.4 on PPC, I get
...
```json
{
    "body": "<a id='comment:10'></a>Karl-Dieter, please could you isolate the problem (see instructions in comment 4)? In particular we need to know if the problem lies in NumPy itself, or in the RR<->NumPy conversion.\n\nPaul",
    "created_at": "2010-10-04T17:00:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121265",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:10'></a>Karl-Dieter, please could you isolate the problem (see instructions in comment 4)? In particular we need to know if the problem lies in NumPy itself, or in the RR<->NumPy conversion.
...
```json
{
    "body": "<a id='comment:13'></a>thank you Karl-Dieter for your help. It is much appreciated. On my computer I get more digits\nif I print elements of `ext_rts1` separately:\n\n```\nsage: ext_rts1[0]\n-1.7724538509055159\nsage: ext_rts1[1]\n1.7724538509055159\n```\nwhich shows that they are exactly opposite:\n\n```\nsage: ext_rts1[0]+ext_rts1[1]\n0.0\n```\nSimilarly I get:\n\n```\nsage: rts[0]\n-1.77245385091\nsage: rts[1]\n1.77245385091\nsage: rts[0]+rts[1]\n0\n```\nWhat do you get for the above commands?\n\nPaul",
    "created_at": "2010-10-04T18:27:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121268",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:13'></a>thank you Karl-Dieter for your help. It is much appreciated. On my computer I get more digits
if I print elements of `ext_rts1` separately:
...
```json
{
    "body": "<a id='comment:15'></a>Up to a sign, I get the same thing on fulvia:\n\n```\nsage: ext_rts1[0]\n-1.7724538509055159\nsage: ext_rts1[1]\n1.7724538509055161\nsage: ext_rts1[0] + ext_rts1[1]\n2.2204460492503131e-16\nsage: rts[0] + rts[1]\n2.2204460492503130808472633361816406250000000000000000000000e-16\n```\nI think the doctest is new between 4.6.alpha1 and 4.6.alpha2, as well as the warning message about NumPy not supporting arbitrary precision arithmetic.",
    "created_at": "2010-10-04T19:55:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121270",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>Up to a sign, I get the same thing on fulvia:
...
```json
{
    "body": "<a id='comment:16'></a>thanks Karl-Dieter and John. This clearly shows this is an upstream (numpy) problem.\nDoes anybody know how to report the problem upstream? The numpy SPKG.txt file says that\n*Josh* Kantor is the maintainer, but on trac.sagemath.org I can only see *Jeff* Kantor.\n\nPaul",
    "created_at": "2010-10-04T20:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121271",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:16'></a>thanks Karl-Dieter and John. This clearly shows this is an upstream (numpy) problem.
Does anybody know how to report the problem upstream? The numpy SPKG.txt file says that
*Josh* Kantor is the maintainer, but on trac.sagemath.org I can only see *Jeff* Kantor.
...
```json
{
    "body": "Changing work_issues from \"\" to \"report upstream (numpy)\"",
    "created_at": "2010-10-04T20:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121272",
    "user": "https://github.com/zimmermann6"
}
```

Changing work_issues from "" to "report upstream (numpy)"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121273",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>> Was this doctest added in alpha2? \n\n\nyes, see #8054.\n\nPaul",
    "created_at": "2010-10-04T20:08:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121274",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:17'></a>> Was this doctest added in alpha2? 
...
```json
{
    "body": "<a id='comment:18'></a>With respect to upstream, it's worth pointing out that we are a couple releases behind.  Eventually John or I might be able to try this with the numpy 1.5.0 that is now on Trac # something, but it's possible it's already fixed there, so you may want to try the latest numpy and see about that first.",
    "created_at": "2010-10-04T20:12:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121275",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>With respect to upstream, it's worth pointing out that we are a couple releases behind.  Eventually John or I might be able to try this with the numpy 1.5.0 that is now on Trac # something, but it's possible it's already fixed there, so you may want to try the latest numpy and see about that first.
...
```json
{
    "body": "<a id='comment:19'></a>> so you may want to try the latest numpy and see about that first\n\n\nunfortunately I cannot reproduce the original problem on my computer, thus trying the latest\nnumpy will surely work for me, but will not help resolving that issue.\n\nPaul",
    "created_at": "2010-10-04T20:29:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121276",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:19'></a>> so you may want to try the latest numpy and see about that first
...
```json
{
    "body": "<a id='comment:20'></a>I downloaded the new numpy skpg from #9808 and I've installed it on fulvia.  Now I'm running `sage -ba`, and then I'll rerun the doctest here.",
    "created_at": "2010-10-04T20:35:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121277",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:20'></a>I downloaded the new numpy skpg from #9808 and I've installed it on fulvia.  Now I'm running `sage -ba`, and then I'll rerun the doctest here.
...
```json
{
    "body": "<a id='comment:21'></a>Well, that didn't work (\"ImportError: ld.so.1: python: fatal: relocation error:\").  So I'll try again, building everything from scratch.",
    "created_at": "2010-10-04T20:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121278",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:21'></a>Well, that didn't work ("ImportError: ld.so.1: python: fatal: relocation error:").  So I'll try again, building everything from scratch.
...
```json
{
    "body": "<a id='comment:22'></a>Dave kindly opened an account for me on his computer. I did investigate: the problem lies in\nthe eigvals routine from numpy, which itself calls the dgeev routine from lapack. I am stuck there,\nsince the dgeev routine is quite complex. Again, the maintainers of the lapack spkg are Josh Kantor\nand William.\n\nPaul",
    "created_at": "2010-10-04T21:31:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121279",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:22'></a>Dave kindly opened an account for me on his computer. I did investigate: the problem lies in
the eigvals routine from numpy, which itself calls the dgeev routine from lapack. I am stuck there,
since the dgeev routine is quite complex. Again, the maintainers of the lapack spkg are Josh Kantor
and William.
...
```json
{
    "body": "<a id='comment:27'></a>I note someone added a work issues *report upstream (numpy)*. Is that still appropiate? Has that been done? \n\nhttp://projects.scipy.org/numpy\n\nis the place to do it if this is an upstream bug. I've just created a bug report there myself http://projects.scipy.org/numpy/ticket/1625 for the Numpy issue at #9808.",
    "created_at": "2010-10-05T22:46:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121284",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:27'></a>I note someone added a work issues *report upstream (numpy)*. Is that still appropiate? Has that been done? 
...
```json
{
    "body": "<a id='comment:28'></a>> I'm not sure what I am supposed to get with this - what is wrong with 0.0?\n\n\nI also got sometimes 0.0, instead of the expected values array([ 1.77245385, -1.77245385]).\n\nThanks Dave for reporting the problem upstream.\n\nPaul",
    "created_at": "2010-10-06T05:48:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121285",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:28'></a>> I'm not sure what I am supposed to get with this - what is wrong with 0.0?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121286",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"report upstream\"",
    "created_at": "2010-10-06T10:50:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121288",
    "user": "https://github.com/zimmermann6"
}
```

Changing work_issues from "" to "report upstream"
...
```json
{
    "body": "<a id='comment:30'></a>> I have NOT reported this upstream.\n\n\nsorry. I understand the bug, but don't know NumPy good enough to isolate it as a NumPy bug.\n\nPaul",
    "created_at": "2010-10-06T10:50:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121289",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:30'></a>> I have NOT reported this upstream.
...
```json
{
    "body": "<a id='comment:32'></a>my guess is that `lapack_routine` modifies in place the array `wr` of zeros,\nand that `res=wr.astype(result_t)` recovers the modified array.\n\nPaul",
    "created_at": "2010-10-06T15:07:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121291",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:32'></a>my guess is that `lapack_routine` modifies in place the array `wr` of zeros,
and that `res=wr.astype(result_t)` recovers the modified array.
...
```json
{
    "body": "<a id='comment:34'></a>on Dave's machine with sage-4.6.alpha2 I get:\n\n```\nsage: roots = eigvals(A)\nsage: roots[0]\n-1.7724538509055159\nsage: roots[1]\n1.7724538509055161\n```\nNote the different last digits, the positive root should print `1.7724538509055159`.\n\nOn a Core 2 I get the same results as in comment 33.\n\nPaul",
    "created_at": "2010-10-06T15:22:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121293",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:34'></a>on Dave's machine with sage-4.6.alpha2 I get:
...
```json
{
    "body": "<a id='comment:35'></a>Yes, and I get something similar in Comment 14.  My question is that I would like to see what you get for `res[0]` and `res[1]` on a machine where it supposedly works, because on my 10.6 Mac (where `roots` is correct) I also get `0.0` for those, just like on the machine where `roots` is incorrect.  I hope this clarifies what I meant.",
    "created_at": "2010-10-06T16:47:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121294",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:35'></a>Yes, and I get something similar in Comment 14.  My question is that I would like to see what you get for `res[0]` and `res[1]` on a machine where it supposedly works, because on my 10.6 Mac (where `roots` is correct) I also get `0.0` for those, just like on the machine where `roots` is incorrect.  I hope this clarifies what I meant.
...
```json
{
    "body": "<a id='comment:36'></a>I cannot reproduce the non-zero values I once got for res[0] and res[1], I now always get 0.0.\nIt must be something related to the Sage-NumPy interface. Someone more fluent with NumPy should\nlook at this. Otherwise I will try to investigate more next week.\n\nPaul",
    "created_at": "2010-10-06T20:07:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121295",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:36'></a>I cannot reproduce the non-zero values I once got for res[0] and res[1], I now always get 0.0.
It must be something related to the Sage-NumPy interface. Someone more fluent with NumPy should
look at this. Otherwise I will try to investigate more next week.
...
```json
{
    "body": "<a id='comment:37'></a>Has anyone had chance to look at this? It is marked as a blocker for 4.6, so is quite important this is squashed soon. \n\n\nDave",
    "created_at": "2010-10-09T09:25:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121296",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:37'></a>Has anyone had chance to look at this? It is marked as a blocker for 4.6, so is quite important this is squashed soon. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121298",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>Dave, you might try to recompile the lapack spkg with `-O0` instead of the default\n`-O3`.\n\nPaul",
    "created_at": "2010-10-12T09:18:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121304",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:46'></a>Dave, you might try to recompile the lapack spkg with `-O0` instead of the default
`-O3`.
...
```json
{
    "body": "<a id='comment:50'></a>I created #10123 to update lapack. It does not look like it will solve this problem, so it's not huge urgency. I'll take care of that. \n\nDave",
    "created_at": "2010-10-12T13:25:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121308",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:50'></a>I created #10123 to update lapack. It does not look like it will solve this problem, so it's not huge urgency. I'll take care of that. 
...
```json
{
    "body": "<a id='comment:51'></a>I made a mistake. Lapack is building ok, but once ATLAS built, it would have copied the lapack from my global ATLAS install. Hence this was not a correct build. I thought it was a bit quick, as a full build with ATLAS takes 2-3 hours, where this built in 20 minutes or so. \n\nI'm rebuilding now. \n\nDave",
    "created_at": "2010-10-12T13:36:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121309",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:51'></a>I made a mistake. Lapack is building ok, but once ATLAS built, it would have copied the lapack from my global ATLAS install. Hence this was not a correct build. I thought it was a bit quick, as a full build with ATLAS takes 2-3 hours, where this built in 20 minutes or so. 
...
```json
{
    "body": "<a id='comment:52'></a>For lapack, see also #10121: a cleaned up version of the current spkg.",
    "created_at": "2010-10-12T14:41:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121310",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:52'></a>For lapack, see also #10121: a cleaned up version of the current spkg.
...
```json
{
    "body": "<a id='comment:59'></a>I've just recompiled LAPACK with `-march=native -mfpmath=sse` (by adding this in the `sage_fortran` script) on the Pentium4 Prescott (which has SSE3)... with that, the difference vanishes.\n\nI still wonder what happens on PowerPC CPUs.",
    "created_at": "2010-10-17T16:07:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121317",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:59'></a>I've just recompiled LAPACK with `-march=native -mfpmath=sse` (by adding this in the `sage_fortran` script) on the Pentium4 Prescott (which has SSE3)... with that, the difference vanishes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121320",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:66'></a>Would it help to try building with the Intel Fortran Compiler?  It appears to be [free on Linux for non-commercial use](http://software.intel.com/en-us/articles/non-commercial-software-download/), but I haven't tried to download and install it.  Or are we disallowed from using it, because Sage might be used commercially?",
    "created_at": "2010-10-17T22:14:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121324",
    "user": "https://github.com/qed777"
}
```

<a id='comment:66'></a>Would it help to try building with the Intel Fortran Compiler?  It appears to be [free on Linux for non-commercial use](http://software.intel.com/en-us/articles/non-commercial-software-download/), but I haven't tried to download and install it.  Or are we disallowed from using it, because Sage might be used commercially?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121325",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:67'></a>I'd still like to resolve this before we release 4.6.\n\nAre there any objections to Leif's suggestion to use tagged 32-bit and 64-bit results?  Or, if tagging doesn't cover all reported cases, to using dots (`...`)?",
    "created_at": "2010-10-17T23:41:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121326",
    "user": "https://github.com/qed777"
}
```

<a id='comment:67'></a>I'd still like to resolve this before we release 4.6.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121328",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121329",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121330",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:69'></a>Attachment [trac_10042_xsquare_pi.patch](tarball://root/attachments/some-uuid/ticket10042/trac_10042_xsquare_pi.patch) by @dimpase created at 2010-10-18 06:31:49\n\nReplying to [dimpase](#comment%3A68):\n> Replying to [mpatel](#comment%3A67):\n> > I'd still like to resolve this before we release 4.6.\n> > \n> > Are there any objections to Leif's suggestion to use tagged 32-bit and 64-bit results?  Or, if tagging doesn't cover all reported cases, to using dots (`...`)?\n\n> \n> Well, do we agree now that this is a purely doctest problem? (mhansen (changeset 14950, trac #8054) \n> has put too many digits there...)\n> \n\n\nI've just attached the patch that puts the ellipses to the right places, so that the doctest passes on Macosx 10.5 PPC",
    "created_at": "2010-10-18T06:31:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121331",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:69'></a>Attachment [trac_10042_xsquare_pi.patch](tarball://root/attachments/some-uuid/ticket10042/trac_10042_xsquare_pi.patch) by @dimpase created at 2010-10-18 06:31:49
...
```json
{
    "body": "<a id='comment:70'></a>thanks Dima for giving the instructions on how to test DGEEV. I'll give it a try.\n\nPaul",
    "created_at": "2010-10-18T06:37:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121332",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:70'></a>thanks Dima for giving the instructions on how to test DGEEV. I'll give it a try.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121335",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121336",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121337",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:73'></a>P.S.: Despite the positive review for Dima's patch, I appreciate Paul tracking this further down. \n\nI wouldn't consider this a real LAPACK bug, but wonder if it's \"intentional\". It's quite weird anyway, though one should IMHO in general not expect to get symmetric results here; I think it's mostly *our example* that makes this perhaps more surprising.",
    "created_at": "2010-10-18T09:10:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121338",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:73'></a>P.S.: Despite the positive review for Dima's patch, I appreciate Paul tracking this further down. 
...
```json
{
    "body": "<a id='comment:75'></a>This might end up being \"Report upstream to Intel!!\" Some of you may be old enough to remember the bug in the Intel i486 for floating point code. I had one hell of a struggle with Dell to get the CPU replaced. Intel sent me a 38 page document explaining why the bug was not of concern to most of the scientific community. Even Intel were reluctant to replace the CPU, but I finally got it replaced. \n\nDave",
    "created_at": "2010-10-18T09:18:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121340",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:75'></a>This might end up being "Report upstream to Intel!!" Some of you may be old enough to remember the bug in the Intel i486 for floating point code. I had one hell of a struggle with Dell to get the CPU replaced. Intel sent me a 38 page document explaining why the bug was not of concern to most of the scientific community. Even Intel were reluctant to replace the CPU, but I finally got it replaced. 
...
```json
{
    "body": "<a id='comment:80'></a>I've reported to Kaveh Ghazi (a GCC developer) the strange behaviour of comment 78. If/when I get\nan answer, I will report it here.\n\nPaul",
    "created_at": "2010-10-18T21:17:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121345",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:80'></a>I've reported to Kaveh Ghazi (a GCC developer) the strange behaviour of comment 78. If/when I get
an answer, I will report it here.
...
```json
{
    "body": "<a id='comment:82'></a>Replying to [zimmerma](#comment%3A81):\n> Replying to [zimmerma](#comment%3A80):\n> > I've reported to Kaveh Ghazi (a GCC developer) the strange behaviour of comment 78. If/when I get\n> > an answer, I will report it here.\n\n> \n> cf http://gcc.gnu.org/bugzilla/show_bug.cgi?id=46080 to follow the GCC issue. However I'm not sure\n> this is related to this ticket. Does Lapack use single precision (i.e., the C float type)?\n> \n\n\nLapack has routines for both single and double precision (names starting with S and D, respectively)\n\nDmitrii\n\n> Paul",
    "created_at": "2010-10-19T11:28:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121347",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:82'></a>Replying to [zimmerma](#comment%3A81):
> Replying to [zimmerma](#comment%3A80):
> > I've reported to Kaveh Ghazi (a GCC developer) the strange behaviour of comment 78. If/when I get
> > an answer, I will report it here.
...
```json
{
    "body": "<a id='comment:83'></a>> Lapack has routines for both single and double precision (names starting with S and D, respectively) \n\n\nthus since the Lapack issue is with `dgeev`, it might be independent from the GCC float\nissue. However, since the GCC issue is marked as a regression from 4.4, somebody with an older\nversion of GCC might try to recompile Lapack with it on the machines where one got different\nabsolute values.\n\nPaul",
    "created_at": "2010-10-19T11:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121348",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:83'></a>> Lapack has routines for both single and double precision (names starting with S and D, respectively) 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121351",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10042#issuecomment-121352",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10042",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10042#event-25499"
}
```
