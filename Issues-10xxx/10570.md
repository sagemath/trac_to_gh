...
```json
{
    "body": "<a id='comment:1'></a>ps. The unnecessary frames are there since at least sage 4.4.4",
    "created_at": "2011-01-08T00:39:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132421",
    "user": "https://github.com/koffie"
}
```

<a id='comment:1'></a>ps. The unnecessary frames are there since at least sage 4.4.4
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_10570.patch](tarball://root/attachments/some-uuid/ticket10570/trac_10570.patch) by @koffie created at 2011-03-22 01:19:43",
    "created_at": "2011-03-22T01:19:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132424",
    "user": "https://github.com/koffie"
}
```

<a id='comment:4'></a>Attachment [trac_10570.patch](tarball://root/attachments/some-uuid/ticket10570/trac_10570.patch) by @koffie created at 2011-03-22 01:19:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132425",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>After applying the two-patch series at #10548, this patch tests fine whether or not the last line is commented out -- that is, the issue itself seems to be fixed by #10548 independently.\n\nI will merge this patch into your doctest patch at #10548 and upload it there.",
    "created_at": "2011-03-24T22:35:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132426",
    "user": "https://github.com/kini"
}
```

<a id='comment:5'></a>After applying the two-patch series at #10548, this patch tests fine whether or not the last line is commented out -- that is, the issue itself seems to be fixed by #10548 independently.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132427",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132428",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132429",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132430",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>There is now only the factorial remaining, but now for a different reason then before:\n\nsage: import gc\nsage: import inspect\nsage: l1=gc.get_objects()\nsage: frames=[x for x in l1 if inspect.isframe(x)]\nsage: len(frames)\n9\nsage: l=objgraph.find_backref_chain(frames[8],inspect.ismodule,max_depth=15,extra_ignore=[id(frames)])\nsage: map(type,l)\n[<type 'module'>, <type 'dict'>, <class 'sage.combinat.species.stream.Stream_class'>, <type 'dict'>, <type 'generator'>, <type 'frame'>]",
    "created_at": "2011-03-24T22:44:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132431",
    "user": "https://github.com/koffie"
}
```

<a id='comment:6'></a>There is now only the factorial remaining, but now for a different reason then before:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132432",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132433",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132434",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10570#event-27166"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132435",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132436",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I don't consider the remaining frame corresponding to the factorial generator a bug. It is there because appearantly someone thinks that the factorial generator should be available as a generator instead of a function in some module.",
    "created_at": "2011-03-24T23:31:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132437",
    "user": "https://github.com/koffie"
}
```

<a id='comment:8'></a>I don't consider the remaining frame corresponding to the factorial generator a bug. It is there because appearantly someone thinks that the factorial generator should be available as a generator instead of a function in some module.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132439",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132440",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132441",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10570#issuecomment-132442",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10570",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10570#event-27167"
}
```
