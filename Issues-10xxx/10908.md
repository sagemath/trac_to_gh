# Issue 10908: Make `sage -upgrade` more developer-friendly by removing merging
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10908#event-28546"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10908#event-28547"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10908#event-28548"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10908#event-28549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10908#event-28550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10908",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10908#event-28551"
}
```
