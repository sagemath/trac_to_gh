...
```json
{
    "body": "<a id='comment:18'></a>\nThis is just a port of the changes I had before to the git workflow.  I haven't yet tried to fix anything.\n\n---\nNew commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[ec5e1a9](http://git.sagemath.org/sage.git/commit/?id=ec5e1a9755740e75f777e7c8184c2797d74f51d0)|`Ignore files from XCode`|\n|[dcb6660](http://git.sagemath.org/sage.git/commit/?id=dcb66604cff05ea491dd29367d441229277153b1)|`Added files from new XCode`|\n|[6eebbcd](http://git.sagemath.org/sage.git/commit/?id=6eebbcd29a9d936a0c4ee8aac8ce1795be2a0b07)|`Fixed a warning`|\n|[eb13458](http://git.sagemath.org/sage.git/commit/?id=eb134581fc1b354948e99e150e6c5fdd63cd9120)|`Ensure that Sage is read/write`|\n|[1fba3ee](http://git.sagemath.org/sage.git/commit/?id=1fba3ee752aafb924a113edd81634f6d6e7dd2ee)|`Added services`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[64b7938](http://git.sagemath.org/sage.git/commit/?id=64b793848e4e392673804335c4284d673f43a952)|`Added documentation for services`|",
    "created_at": "2014-06-03T05:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10555",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[3f07cd4](http://git.sagemath.org/sage.git/commit/?id=3f07cd438c5ebdeeb2c29e7c7aeed4349bb4de3b)|`Added message in the case that no output is produced`|\n|[db6993e](http://git.sagemath.org/sage.git/commit/?id=db6993e81e7f0f4b47bac04d9734941da4be3440)|`Fixed improper unpacking of spkg files`|\n|[a3d7c9e](http://git.sagemath.org/sage.git/commit/?id=a3d7c9ee4e47ba4faf3172ef768e35df730df56f)|`Remove spkg creation services since it's not really useful`|\n|[32e2be3](http://git.sagemath.org/sage.git/commit/?id=32e2be30ea99f035db6a3675869d162f6ba0a89b)|`Allow running doctests for py and pyx files`|\n|[9ba2de3](http://git.sagemath.org/sage.git/commit/?id=9ba2de3cc00ccb2269c5a2348117dc3d824d06ff)|`Fixed services for files with spaces (and other special characters)`|",
