...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10002#issuecomment-93252",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10002/10002_remove_gp.patch",
    "created_at": "2010-11-11T20:37:14Z",
    "issue": "https://github.com/sagemath/sage/issues/10002",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10002/10002_remove_gp.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Attachment [10002_remove_gp.patch](https://github.com/sagemath/sage/files/ticket10002/10002_remove_gp.patch) by @jdemeyer created at 2010-11-11 20:37:14",
    "created_at": "2010-11-11T20:37:14Z",
    "issue": "https://github.com/sagemath/sage/issues/10002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10002#issuecomment-93253",
    "user": "https://github.com/jdemeyer"
}
```

Attachment [10002_remove_gp.patch](https://github.com/sagemath/sage/files/ticket10002/10002_remove_gp.patch) by @jdemeyer created at 2010-11-11 20:37:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10002#issuecomment-93254",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10002#issuecomment-93255",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10002#issuecomment-93256",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10002#issuecomment-93257",
    "user": "https://github.com/jdemeyer"
}
```
