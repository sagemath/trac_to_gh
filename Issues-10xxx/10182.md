...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124136",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124137",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124138",
    "user": "https://trac.sagemath.org/admin/accounts/users/damek"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>All instances of \"#long\" should be changed to \"# long time\". Here is a list of all places that need changing:\n\n```\n[mvngu@sage plot]$ pwd\n/dev/shm/mvngu/sage-4.6.1.alpha0/devel/sage-main/sage/plot\n[mvngu@sage plot]$ grep '#long' plot.py  \n            sage: sum([plot(z*sin(x), 0, 10).plot3d(z) for z in range(6)]) #long\n            sage: p = polar_plot(maple_leaf, -pi/4, 3*pi/2, color=\"red\",plot_points=1000) #long\n            sage: p.show(gridlines=( [-3,-2.75,..,3], xrange(-1,5,2) )) #long\n```\n\nThis is using Sage 4.6.1.alpha0.",
    "created_at": "2010-11-05T04:13:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124139",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:3'></a>All instances of "#long" should be changed to "# long time". Here is a list of all places that need changing:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124140",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124141",
    "user": "https://trac.sagemath.org/admin/accounts/users/damek"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124142",
    "user": "https://trac.sagemath.org/admin/accounts/users/damek"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>NB I deliberately put just one instance on this ticket and the others at #10183 (at mvngu's suggestion possibly?!) to make this ticket a one-liner for a beginner.\n\nIf the newst patch fixes lots more, that's great -- but then #10183 needs changing or even closing too.",
    "created_at": "2010-11-05T09:24:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124143",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>NB I deliberately put just one instance on this ticket and the others at #10183 (at mvngu's suggestion possibly?!) to make this ticket a one-liner for a beginner.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124145",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124146",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Sorry for my confusing post above;  it certainly makes sense to fix all three instances in this one file, which is exactly what the third patch does.\n\nI checked that the patch applies cleanly to 4.6.1.alpha0 (it does) and that the before & after timings are similar to those reported by Benjamin.\n\nI did not test any other files;  since no actual code was touched that is not necessary.\n\nHence a positive review!  I am putting \"damek\" as author as I don't know his/her real name (it is not at http://trac.sagemath.org/sage_trac) and Benjamin Jones as reviewer.",
    "created_at": "2010-11-07T17:58:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124147",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>Sorry for my confusing post above;  it certainly makes sense to fix all three instances in this one file, which is exactly what the third patch does.
...
```json
{
    "body": "Changing author from \"\" to \"damek\"",
    "created_at": "2010-11-07T17:58:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124148",
    "user": "https://github.com/JohnCremona"
}
```

Changing author from "" to "damek"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124149",
    "user": "https://trac.sagemath.org/admin/accounts/users/damek"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Benjamin,\n\nWould you also like to review patch 10183? It is very similar to this patch. \n\nDamek",
    "created_at": "2010-11-07T18:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124150",
    "user": "https://trac.sagemath.org/admin/accounts/users/damek"
}
```

<a id='comment:9'></a>Benjamin,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124151",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10182#event-26077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10182#issuecomment-124152",
    "user": "https://github.com/jdemeyer"
}
```
