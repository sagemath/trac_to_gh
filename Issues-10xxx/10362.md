...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_10362-vector-constructor-documentation.patch](tarball://root/attachments/some-uuid/ticket10362/trac_10362-vector-constructor-documentation.patch) by @rbeezer created at 2010-12-02 04:14:22",
    "created_at": "2010-12-02T04:14:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128361",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>Attachment [trac_10362-vector-constructor-documentation.patch](tarball://root/attachments/some-uuid/ticket10362/trac_10362-vector-constructor-documentation.patch) by @rbeezer created at 2010-12-02 04:14:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128362",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128363",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128364",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10362#event-26658"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Looks like a nice improvement, except that dictionary-related parts seem to be weird, but this is addressed by another ticket.\n\nIn the original patch \"INPUT\" is \"glued\" to the numbered list above, so I indented the list to separate them. Also, I like when \"OUTPUT\" block looks the same as \"INPUT\" and in this particular case it really makes sense, I think, because the output description is so long. So I have added a blank line as well.\n\nIf you agree with the changes, please switch to positive review!",
    "created_at": "2010-12-03T00:28:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128365",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:4'></a>Looks like a nice improvement, except that dictionary-related parts seem to be weird, but this is addressed by another ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128366",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128368",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128369",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10362#issuecomment-128370",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10362",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10362#event-26659"
}
```
