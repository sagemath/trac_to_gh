# Issue 10189: developer's guide: warnings & notes about commit message, cloning and setting the text editor
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10189#event-26097"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10189#event-26098"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10189#event-26099"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10189#event-26100"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10189#event-26101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10189",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10189#event-26102"
}
```
