...
<a id='comment:2'></a>Replying to [rbeezer](#comment%3A1):
...
<a id='comment:3'></a>Replying to [rbeezer](#comment%3A2):
> This might work better if it just called the `random_element()` method for vector spaces.  I'm going to move this to "needs work" until I get a chance to investigate.
...
<a id='comment:6'></a>Attachment [trac_10477-random-vector-constructor-v2.patch](tarball://root/attachments/some-uuid/ticket10477/trac_10477-random-vector-constructor-v2.patch) by @rbeezer created at 2011-03-10 19:06:26
...
```json
{
    "body": "<a id='comment:7'></a>Fair enough, it's best to be consistent with the other constructors.  With the new patch, the code works well and passed long doctests.  Positive review.",
    "created_at": "2011-03-12T12:24:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10477",
    "type": "issue_comment",
...
<a id='comment:7'></a>Fair enough, it's best to be consistent with the other constructors.  With the new patch, the code works well and passed long doctests.  Positive review.
