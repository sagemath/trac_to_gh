...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_10535-column-matrix_constructor.patch](tarball://root/attachments/some-uuid/ticket10535/trac_10535-column-matrix_constructor.patch) by @rbeezer created at 2010-12-31 00:06:29",
...
<a id='comment:1'></a>Attachment [trac_10535-column-matrix_constructor.patch](tarball://root/attachments/some-uuid/ticket10535/trac_10535-column-matrix_constructor.patch) by @rbeezer created at 2010-12-31 00:06:29
...
```json
{
    "body": "<a id='comment:2'></a>This looks  good to me. I don't know why the patchbot couldn't apply the patch; it works fine for me in 4.6.1.rc0. Positive review here.",
...
<a id='comment:2'></a>This looks  good to me. I don't know why the patchbot couldn't apply the patch; it works fine for me in 4.6.1.rc0. Positive review here.
