...
```json
{
    "body": "<a id='comment:1'></a>I pointed out the executable stack problem of mpir a while ago. They inherited from gmp actually. In actual fact that should be fixed in mpir. In Gentoo we have a patch but we don't know if it removes the executable stack on all cpu models that are affected.",
    "created_at": "2010-10-29T22:32:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124401",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>I pointed out the executable stack problem of mpir a while ago. They inherited from gmp actually. In actual fact that should be fixed in mpir. In Gentoo we have a patch but we don't know if it removes the executable stack on all cpu models that are affected.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124402",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I agree that it needs fixing in mpir. The libgcrypt, for example, ships with an `m4/noexecstack.m4` macro. That would be a good starting point for fixing up mpir's autotools, I think.",
    "created_at": "2010-10-29T23:31:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124403",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>I agree that it needs fixing in mpir. The libgcrypt, for example, ships with an `m4/noexecstack.m4` macro. That would be a good starting point for fixing up mpir's autotools, I think.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124405",
...
```json
{
    "body": "<a id='comment:7'></a>Yes. Or pass `--noexecstack` to gcc. For the official mpir patch I would suggest to use the aforementioned `noexecstack.m4` which checks that the linker understands the `noexecstack` option.\n\nI'm not sure if sticking it unconditionally into the spkg-install is the way to go. I think its supported since gcc-3.4, so that *probably* covers all gcc versions that can compile Sage. Not sure about Solaris...",
    "created_at": "2010-10-31T19:33:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124407",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>Yes. Or pass `--noexecstack` to gcc. For the official mpir patch I would suggest to use the aforementioned `noexecstack.m4` which checks that the linker understands the `noexecstack` option.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124408",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124410",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124411",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124412",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [mpir-spkg-install.diff](tarball://root/attachments/some-uuid/ticket10188/mpir-spkg-install.diff) by @vbraun created at 2010-11-06 21:54:56\n\nI have updated the mpir-1.2.2.p2.spkg to use the LDFLAGS method instead of the exectstack tool.",
    "created_at": "2010-11-06T21:54:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124413",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>Attachment [mpir-spkg-install.diff](tarball://root/attachments/some-uuid/ticket10188/mpir-spkg-install.diff) by @vbraun created at 2010-11-06 21:54:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124414",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124415",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124416",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124417",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Although both the commit message and the changelog entry lack a back-reference to this ticket, positive review.\n\nI think we can safely (and should) merge this into 4.6.1, since unfortunately the MPIR upgrade (#8664) is again delayed by trouble with the necessary GMP-ECM upgrade (#5847) for a couple of reasons (mainly weird MacOS X PPC issues).",
    "created_at": "2010-11-23T11:12:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124418",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:13'></a>Although both the commit message and the changelog entry lack a back-reference to this ticket, positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124419",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>The spkg from #8664 will not be merged in sage-4.6.1. We should still pull in the spkg from this package and replace it in sage-4.6.2 with the one from #8664.",
    "created_at": "2010-11-23T17:40:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124420",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:15'></a>The spkg from #8664 will not be merged in sage-4.6.1. We should still pull in the spkg from this package and replace it in sage-4.6.2 with the one from #8664.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124421",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124422",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124423",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10188#event-26094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124424",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Just for the record:\n\nThis is now fixed in MPIR 2.2.0, released today.",
    "created_at": "2010-12-02T18:21:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10188#issuecomment-124425",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:19'></a>Just for the record:
