...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123908",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123909",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [relative_norm.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.patch) by @lftabera created at 2010-10-26 13:52:25\n\nThis will also improve the trace in the important case where the field is the base field.\n\nI think I would call self.base_ring() instead of self.parent().base_field()\n\nI wonder if this can be further improved. For example if base equals self.parent() the returning 1x1 matrix should be instantaneous (although this is  a very corner case).\n\nAlso, you need to add a doctest for the change.",
    "created_at": "2010-10-26T13:52:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123910",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:1'></a>Attachment [relative_norm.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.patch) by @lftabera created at 2010-10-26 13:52:25
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,21 +2,25 @@\n \n However it's dog slow.\n \n+```\n sage: K.<v>=NumberField(x^4 + 514*x^2 + 64321)\n sage: L.<w>,e=K.galois_closure(map=True)\n sage: R.<r,v>=L.relativize(e)\n sage: time _=r.norm(K)\n CPU times: user 0.44 s, sys: 0.00 s, total: 0.44 s\n Wall time: 0.45 s\n+```\n \n The attached patch changes the matrix() method to identify the base field as a trivial case, so that r.norm(K) computes the relative norm quickly:\n \n+```\n sage: K.<v>=NumberField(x^4 + 514*x^2 + 64321)\n sage: L.<w>,e=K.galois_closure(map=True)\n sage: R.<r,v>=L.relativize(e)\n sage: time _=r.norm(K)\n CPU times: user 0.00 s, sys: 0.00 s, total: 0.00 s\n Wall time: 0.00 s\n+```\n \n Summary: relative norm in relative number fields is slow\n \n``````\n",
    "created_at": "2010-10-26T13:55:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123911",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123912",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [relative_norm.3.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.3.patch) by @emmanuelthome created at 2010-10-26 14:44:17\n\nReplying to [comment:1 lftabera]:\n> This will also improve the trace in the important case where the field is the base field.\n\n\nyes indeed.\n \n> I think I would call self.base_ring() instead of self.parent().base_field()\n\n\ndone\n\n> I wonder if this can be further improved. For example if base equals self.parent() the returning 1x1 matrix should be instantaneous (although this is  a very corner case).\n\n\nindeed. I considered at first it wasn't worth the trouble, but it's so ridiculously expensive that the 1-line additional diff is worth it, I believe.\n\n> Also, you need to add a doctest for the change.\n\n\nSure, done. However there's no difference in functionality beyond speed.\n\nE.",
    "created_at": "2010-10-26T14:44:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123913",
    "user": "https://github.com/emmanuelthome"
}
```

<a id='comment:3'></a>Attachment [relative_norm.3.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.3.patch) by @emmanuelthome created at 2010-10-26 14:44:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123915",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123916",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123917",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>You are right, sorry for the buggy code. That one should be better.",
    "created_at": "2010-10-27T09:20:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123918",
    "user": "https://github.com/emmanuelthome"
}
```

<a id='comment:5'></a>You are right, sorry for the buggy code. That one should be better.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123919",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10174#event-26038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123920",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123921",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123923",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123924",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123925",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123926",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10174#event-26039"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10174#issuecomment-123927",
    "user": "https://github.com/jdemeyer"
}
```
