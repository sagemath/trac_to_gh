...
archive/attachments_013776.json:
```json
{
...
archive/attachments_013777.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [relative_norm.2.patch](https://github.com/sagemath/sage/files/ticket10174/relative_norm.2.patch)",
    "created_at": "2010-10-26T14:28:05Z",
    "issue": "https://github.com/sagemath/sage/issues/10174",
    "type": "issue_comment",
...
**Attachment:** [relative_norm.2.patch](https://github.com/sagemath/sage/files/ticket10174/relative_norm.2.patch)



---

archive/attachments_013778.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [relative_norm.5.patch](https://github.com/sagemath/sage/files/ticket10174/relative_norm.5.patch)",
    "created_at": "2010-10-27T09:19:01Z",
    "issue": "https://github.com/sagemath/sage/issues/10174",
    "type": "issue_comment",
...
**Attachment:** [relative_norm.5.patch](https://github.com/sagemath/sage/files/ticket10174/relative_norm.5.patch)
...
archive/attachments_013781.json:
```json
{
    "asset_content_type": "application/octet-stream",
