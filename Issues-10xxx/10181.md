...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10181#issuecomment-97765",
...
```json
{
    ...
    "asset_name": "subgroups.sage",
    "asset_url": "tarball://root/attachments/some-uuid/ticket10181/subgroups.sage",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10181#issuecomment-97766",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10181#issuecomment-97767",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10181#issuecomment-97768",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79208"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79209"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79212"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79213"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79214"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10181#event-79215"
}
```
