...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124799",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124800",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10201#event-26139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124801",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124802",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Better yet is to directly add William's writings to the Developer's Guide. That's better than providing a link to his blog post. Hence, I'm moving this ticket to \"needs work\".",
    "created_at": "2010-11-03T05:48:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124803",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:2'></a>Better yet is to directly add William's writings to the Developer's Guide. That's better than providing a link to his blog post. Hence, I'm moving this ticket to "needs work".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124805",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Your patch seems very sensible to me. It is hard to judge exactly how someone reading this for the first time -- with all the awesomeness of Sage and the development process looming above him -- will read this, but with the explicit wording of \"detailed information\", it seems ok.\n\nI can see your point regarding the walk-through, and with fresh eyes, I think actually the Developer's Guide is well structured on this point as it is. An elegant merger of the current Reviewing Patches and William's blog is the way to go in the long run then.\n \nShould this patch just get the green light then? And then at some later point, a Trac will be opened on merging William's blog entry directly and removing the link added by this trac.",
    "created_at": "2010-11-05T08:29:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124809",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:6'></a>Your patch seems very sensible to me. It is hard to judge exactly how someone reading this for the first time -- with all the awesomeness of Sage and the development process looming above him -- will read this, but with the explicit wording of "detailed information", it seems ok.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124812",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124813",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10201#event-26140"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-124814",
    "user": "https://github.com/jdemeyer"
}
```
