...
```json
{
    "body": "<div id=\"comment:15\" align=\"right\">Comment 15</div>\n\nReplying to [@sagetrac-fschulze](#comment%3A14):\n> Replying to [@sagetrac-fschulze](#comment%3A13):\n> > Looks fine. Tested with sage-4.8.alpha6. The patch still applies and new spkg builds and passes it's own testsuit. All (long) doctests pass.\n\n> \n> Also #11354 is taken into account in the new spkg.\n\nThanks for the quick re-review!",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10993#event-133270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10993#event-133271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10993",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10993#event-133272"
}
```
