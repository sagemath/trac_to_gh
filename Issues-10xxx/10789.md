...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10789#issuecomment-105947",
    "user": "https://github.com/katestange"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-83501"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-83502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-83503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10789#issuecomment-105948",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-83504"
}
```
