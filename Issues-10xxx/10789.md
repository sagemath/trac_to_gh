...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10789#issuecomment-107561",
    "user": "https://github.com/katestange"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-85465"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-85466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-85467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10789#issuecomment-107562",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-85468"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10789#event-85469"
}
```
