...
<a id='comment:15'></a>François, does the new version work for you? (Now I don't get any fuzz for both patches.)
...
<a id='comment:30'></a>Replying to [novoselt](#comment%3A29):
> Marshall, what's your opinion on the order topic?
...
<a id='comment:57'></a>Replying to [dimpase](#comment%3A56):
> How hard would it be to set up PPL to do Vrepresentation and Hrepresentation of Polyhedron?
