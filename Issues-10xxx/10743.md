...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10743#event-129429"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10743#event-129430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10743#event-129431"
}
```
...
```json
{
    "body": "<a id='comment:10'>Comment 10:</a>\nAttachment: **[trac_10743-reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket10743/trac_10743-reviewer.patch.gz)**\n\nApply [attachment: trac_10743-ecl-iter_p1.patch.gz](https://github.com/sagemath/sage/files/ticket10743/trac_10743-ecl-iter_p1.patch.gz)\n\nIf it doesn't screw up #7377 applying properly (which it shouldn't, as #7377 only touches ecl.pyx in one small place far from here), also apply [attachment: trac_10743-reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket10743/trac_10743-reviewer.patch.gz)\n\nIf for some reason it does cause problems, please open a new ticket for this minor improvement.",
    "created_at": "2011-03-15T19:05:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10743",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10743#issuecomment-105338",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10743#issuecomment-105339",
    "user": "https://github.com/jdemeyer"
}
```
