...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121040"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121050"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -46,4 +46,4 @@\n ```\n which causes an error if `sage-env` is called rather than sourced (which makes no sense and therefore *is* indeed an error), with an \"appropriate\" error message since such an interpreter certainly does not exist.\n \n-Apply trac_10469.v3.patch to local/bin\n+Apply [attachment: trac_10469.v4.patch.gz](https://github.com/sagemath/sage/files/ticket10469/trac_10469.v4.patch.gz) to `local/bin` and change permissions of `local/bin/sage-env` to 0644.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121052"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -34,16 +34,6 @@\n \n ---\n \n-Also, we should replace the useless\n+Also, we should change the permissions of `sage-env` to non-executable (it must be *sourced*, not executed).\n \n-```sh\n-#!/usr/bin/env bash\n-```\n-at its top by (e.g.)\n-\n-```sh\n-#!/this/script/must/be/sourced\n-```\n-which causes an error if `sage-env` is called rather than sourced (which makes no sense and therefore *is* indeed an error), with an \"appropriate\" error message since such an interpreter certainly does not exist.\n-\n-Apply trac_10469.v5[1].patch to local/bin\n+Apply [attachment: trac_10469.v5[1].patch.gz](https://github.com/sagemath/sage/files/ticket10469/1b0dcad478a52da28b2ddd1425612bfb.gz) to local/bin\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121055"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121057"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10469",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10469#event-121058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10469#issuecomment-100227",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10469#issuecomment-100228",
    "user": "https://github.com/jdemeyer"
}
```
