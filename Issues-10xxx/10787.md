...
<a id='comment:2'></a>Yes, lets close #10786 and work on this here.
...
```json
{
    "body": "<a id='comment:3'></a>Hilarious.  Another reason not to like ask.sagemath.org.  Yes, do close #10786 as long as you feel like this one's not too big.  \n\nIncidentally, +1 on finding a fix for arrays in the notebook!",
...
<a id='comment:3'></a>Hilarious.  Another reason not to like ask.sagemath.org.  Yes, do close #10786 as long as you feel like this one's not too big.  
...
```json
{
    "body": "<a id='comment:4'></a>See related #11362 which could probably be fixed in the same pass (perhaps once `MathJax` is added into the notebook).",
...
<a id='comment:4'></a>See related #11362 which could probably be fixed in the same pass (perhaps once `MathJax` is added into the notebook).
