...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124894"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124895"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124896"
}
```
...
```json
{
    "body": "Changed assignee from **mhampton** to **@jasongrout, @williamstein**",
    "created_at": "2010-12-08T15:31:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
...
Changed assignee from **mhampton** to **@jasongrout, @williamstein**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10442#issuecomment-99868",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10442#issuecomment-99869",
