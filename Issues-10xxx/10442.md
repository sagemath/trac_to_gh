...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124898"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124901"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10442#issuecomment-99864",
...
```json
{
    "body": "Changed assignee from **@sagetrac-mhampton** to **@jasongrout, @williamstein**",
    "created_at": "2010-12-08T15:31:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10442#issuecomment-99865",
    "user": "https://github.com/novoselt"
}
```

Changed assignee from **@sagetrac-mhampton** to **@jasongrout, @williamstein**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10442#issuecomment-99866",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10442#event-124902"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10442#issuecomment-99867",
