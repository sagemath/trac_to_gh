...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10442#issuecomment-106720",
...
```json
{
    "body": "<a id='comment:1'></a>This is sad, but I have no idea why this is happening and would claim that this is an error related to general tachyon code, since jmol plots work fine and look exactly the same, as they should.\n\nTachyon also handles alpha on a totally different scale, our default 0.4 looks awful (but works great in both jmol and matplotlib with similar effect).",
    "created_at": "2010-12-08T15:31:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10442#issuecomment-106721",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:1'></a>This is sad, but I have no idea why this is happening and would claim that this is an error related to general tachyon code, since jmol plots work fine and look exactly the same, as they should.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10442#issuecomment-106722",
    "user": "https://github.com/novoselt"
}
```
