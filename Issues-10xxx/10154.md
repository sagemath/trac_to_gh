...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10154#issuecomment-95609",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10154#issuecomment-95610",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_10154-MPLCONFIGDIR-doc.patch](https://github.com/sagemath/sage/files/ticket10154/trac_10154-MPLCONFIGDIR-doc.patch) by mariah created at 2011-06-23 18:41:01\n\nApplied patch, rebuilt documentation with 'sage -docbuild installation html' and I see that the new documentation is installed.  It looks like it makes sense. Positive review!",
    "created_at": "2011-06-23T18:41:01Z",
    "issue": "https://github.com/sagemath/sage/issues/10154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10154#issuecomment-95611",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10154#issuecomment-95612",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10154#issuecomment-95613",
