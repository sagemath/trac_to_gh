...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10771#event-129800"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10771#event-129801"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10771#event-129802"
}
```
...
```json
{
    "body": "Changed assignee from **@aghitza** to **dsm**",
    "created_at": "2011-02-25T12:04:18Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/10771",
    "type": "issue_comment",
...
Changed assignee from **@aghitza** to **dsm**
...
```json
{
    "body": "Changed assignee from **dsm** to **@aghitza**",
...
Changed assignee from **dsm** to **@aghitza**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10771#issuecomment-105719",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10771#issuecomment-105720",
    "user": "https://github.com/jdemeyer"
}
```
