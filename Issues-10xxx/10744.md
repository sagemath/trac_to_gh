...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10744#event-129442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10744#event-129443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10744#event-129444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10744#issuecomment-105340",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10744#issuecomment-105341",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10744#issuecomment-105342",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10744#issuecomment-105343",
    "user": "https://github.com/benjaminfjones"
}
```
