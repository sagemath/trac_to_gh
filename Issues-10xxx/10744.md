...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10744#event-129445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10744#event-129446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10744#event-129447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10744#issuecomment-105338",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10744#issuecomment-105339",
    "user": "https://github.com/benjaminfjones"
}
```
