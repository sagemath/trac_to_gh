...
```json
{
    "body": "<a id='comment:1'></a>This came up when I tried to resolve #10888. But I found a different way of dealing with it there: I changed the troublesome occurriencies of ii) by i).",
    "created_at": "2011-03-16T15:09:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10946#issuecomment-121119",
    "user": "https://github.com/categorie"
}
```

<a id='comment:1'></a>This came up when I tried to resolve #10888. But I found a different way of dealing with it there: I changed the troublesome occurriencies of ii) by i).
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28353"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28354"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28355"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28356"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28357"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28358"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28359"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28360"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10946#event-28361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10946#issuecomment-121120",
