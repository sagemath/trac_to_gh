...
archive/attachments_014106.json:
```json
{
...
archive/attachments_014107.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:31'></a>\n**Attachment:** [trac_10446_schuetzenberger_involution-as.patch](https://github.com/sagemath/sage/files/ticket10446/trac_10446_schuetzenberger_involution-as.patch)\n\nReplying to [jdemeyer](#comment%3A30):\n> Could you remove the following part from the commit message, which doesn't really serve any purpose:\n\n\nDone. I left the first sentence since it does serve a purpose.",
    "created_at": "2011-04-13T22:43:43Z",
    "issue": "https://github.com/sagemath/sage/issues/10446",
    "type": "issue_comment",
