...
```json
{
    "body": "Attachment [gfan-0.4plus.p1-p2.diff](tarball://root/attachments/some-uuid/ticket12760/gfan-0.4plus.p1-p2.diff) by leif created at 2012-03-27 19:20:25\n\nDiff between the previous spkg in Sage and my new p2 spkg. For reference / review only.",
...
Attachment [gfan-0.4plus.p1-p2.diff](tarball://root/attachments/some-uuid/ticket12760/gfan-0.4plus.p1-p2.diff) by leif created at 2012-03-27 19:20:25
...
```json
{
    "body": "Attachment [gfan-0.4plus.p2-p3.diff](tarball://root/attachments/some-uuid/ticket12760/gfan-0.4plus.p2-p3.diff) by leif created at 2012-04-06 00:07:05\n\nDiff between my p2 and my p3 spkg.  For reference / review only.",
...
Attachment [gfan-0.4plus.p2-p3.diff](tarball://root/attachments/some-uuid/ticket12760/gfan-0.4plus.p2-p3.diff) by leif created at 2012-04-06 00:07:05
