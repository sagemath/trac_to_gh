# Issue 3057: [with patch, positive review] MPolynomialRing_generic type-checks to determine commutativity
...
```json
{
    ...
    "title": "[with patch, positive review] MPolynomialRing_generic type-checks to determine commutativity",
    "type": "issue",
