...
```json
{
    "body": "I see now that there is something very strange going on:\n\n```\nsage: type(exp(x).polynomial())\n<class 'sage.rings.polynomial.multi_polynomial_libsingular.MPolynomial_libsingular'>\nsage: type(sin(x).polynomial())\n<class 'sage.rings.polynomial.multi_polynomial_element.MPolynomial_polydict'>\n```\n",
    "created_at": "2022-12-14T09:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34609#issuecomment-489243",
    "user": "mantepse"
}
```
