...
Well, I go for a variation of the first solution you proposed: simplifying as much as possible the interface with igraph. In particular, I have removed the graph name, and vertex and edge attributes are provided by the user in "igraph-style" ([http://igraph.org/python/doc/igraph.Graph-class.html#__init__](http://igraph.org/python/doc/igraph.Graph-class.html#__init__)(http://igraph.org/python/doc/igraph.Graph-class.html#__init__)). There are several examples on how to do it in my new code.
