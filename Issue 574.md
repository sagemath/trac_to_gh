...
```json
{
    "body": "I think this is due to confusion in the many ways of representing state. We should come up with a list of all the ways state can be represented/inputted, and make sure all functions can accept that kind of state. \n\n- Robert",
    "created_at": "2007-09-03T16:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-2981",
    "user": "robertwb"
}
```
...
```json
{
    "body": "Changing assignee from wdj to robertwb.",
    "created_at": "2007-09-03T16:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-2982",
    "user": "robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-2983",
    "user": "robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-2984",
    "user": "robertwb"
}
```
