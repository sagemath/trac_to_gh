...
```json
{
    ...
    "title": "Singular: degneglex order differs from definition in Sage",
    "type": "issue",
...
```json
{
    "body": "You are probably aware of this: a \"local\" monomial ordering is not actually a monomial ordering in the sense of groebner bases on polynomial rings. You can use them to compute in local rings, but then you're computing in a local rings; not a polynomial ring.",
    "created_at": "2020-05-02T20:17:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416615",
...
```json
{
    "body": "Indeed, I found this a bit odd, too, but it is not just a local ordering, but a local ordering together with the weight vector `(1,1,1)`; see [extra weight vectors](https://www.singular.uni-kl.de/Manual/4-1-2/sing_956.htm#SEC1008). Thus, the comparison is done first by weighted degree, which turns this ordering into a well-ordering, as far as I understand.",
    "created_at": "2020-05-02T20:25:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416616",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416617",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416618",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416619",
...
```json
{
    "body": "I have also fixed the conversion of `degneglex` orders in the Singular pexpect interface, which would otherwise have caused issues.",
    "created_at": "2020-05-02T23:25:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416620",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416621",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "I have a naive question on the maths behind this - what's being computed? That's not a Grobner basis, right?\n\nI think Singular's docs are also quite unclear on this point, they don't provide any obvious references to what one gets if this order is selected.",
    "created_at": "2020-05-27T00:18:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416622",
...
```json
{
    "body": "Yes, it does compute Gr\u00f6bner bases. The ordering `degneglex` as defined by Sage is equivalent to `degrevlex` up to permutation of the variables, namely by mapping `(x_1,\u2026,x_n)` to `(x_n,\u2026,x_1)`. This is what is checked in the doctest I added.\n\nThe weight vector `a(1,..,1)` in the ordering has the effect that monomials are first compared by weighted degree, in this case standard degree. Then, for monomials of the same degree, the ordering `ls` is used for the comparison.",
    "created_at": "2020-05-27T14:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416623",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "I ask, as the link in comment:1 to Singular manual mentions K[x]_(x), but without saying why.",
    "created_at": "2020-05-27T22:16:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416624",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416625",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416626",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416627",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416629",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "but do see #29832 - where I conjecture what goes wrong.",
    "created_at": "2020-06-10T17:02:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416630",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29398#event-75727"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29398#issuecomment-416631",
