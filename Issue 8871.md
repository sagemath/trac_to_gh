...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/8871",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8871#issuecomment-81416",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8871#issuecomment-81417",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```
...
```json
{
    "body": "A better method for \"centered\" would be to find the lattice points in the interior of G (already implemented in Polyhedra?), then find the lattice points in the facets of G that I want to include, then take the union of these sets.\n\nTo Do: how to list the facets as Polyhedra, and choose the d (=dimension) of them that I want to include?",
    "created_at": "2010-05-05T15:18:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8871#issuecomment-81418",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```
