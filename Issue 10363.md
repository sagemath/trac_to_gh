...
```json
{
    "body": "Attachment [trac_10364-zero-vector-constructor.patch](tarball://root/attachments/some-uuid/ticket10364/trac_10364-zero-vector-constructor.patch) by @rbeezer created at 2010-12-02 04:15:10",
    "created_at": "2010-12-02T04:15:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106396",
    "user": "https://github.com/rbeezer"
}
```

Attachment [trac_10364-zero-vector-constructor.patch](tarball://root/attachments/some-uuid/ticket10364/trac_10364-zero-vector-constructor.patch) by @rbeezer created at 2010-12-02 04:15:10
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106397",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106398",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106401",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106402",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106404",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106405",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "Hmmm, indeed, it is necessary to do extra checks to construct zero vectors instead of something else. Let it be as is then!",
    "created_at": "2010-12-03T19:47:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106406",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "Attachment [trac_10364-zero-vector-constructor-v2.patch](tarball://root/attachments/some-uuid/ticket10364/trac_10364-zero-vector-constructor-v2.patch) by @rbeezer created at 2010-12-03 21:11:29\n\nReplying to [comment:8 novoselt]:\n> Hmmm, indeed, it is necessary to do extra checks to construct zero vectors instead of something else. Let it be as is then!\n\n\nSounds good.  Thanks.\n\nStandalone v2 patch just fixes up the documentation - call formats and output block only.  Thanks for your help with these.\n\nRob",
    "created_at": "2010-12-03T21:11:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106407",
    "user": "https://github.com/rbeezer"
}
```

Attachment [trac_10364-zero-vector-constructor-v2.patch](tarball://root/attachments/some-uuid/ticket10364/trac_10364-zero-vector-constructor-v2.patch) by @rbeezer created at 2010-12-03 21:11:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106408",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "The new patch looks good and passes all tests!",
    "created_at": "2010-12-03T22:34:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106409",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106410",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106411",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10363#event-26661"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10363#event-26662"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10363#event-26663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106412",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/10363#event-26664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10363#issuecomment-106413",
    "user": "https://github.com/jdemeyer"
}
```
