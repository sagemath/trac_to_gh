# Issue 29102: Fix NTL spkg-configure.m4 so it rejects NTLs built with NTL_THREADS
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29102#event-74697"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29102#event-74698"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29102#event-74699"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29102#event-74700"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29102#event-74701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29102",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29102#event-74702"
}
```
