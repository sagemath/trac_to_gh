...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443643",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443644",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443645",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443646",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443647",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443648",
    "user": "embray"
}
```
...
```json
{
    "body": "Travis, I'm curious about your take on this, especially on the impact to permutation groups, since this partly reverts #25609, which I see you worked on.  AFAICT this makes some minor performance improvements in construction of permutation groups from Sage -> GAP, but might be a little slower for going from GAP -> Sage.",
    "created_at": "2021-02-03T13:39:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443649",
    "user": "embray"
}
```
...
```json
{
    "body": "Big +1 on this work (but I know too little about GAP to review)",
    "created_at": "2021-02-03T18:12:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443650",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443651",
    "user": "git"
}
```
...
```json
{
    "body": "A quick remark on `install-requires`: For prerelease versions, it's best to use the exact version; version ranges may not work (see\nhttps://trac.sagemath.org/ticket/30913#comment:81), \nso it should be `gappy ==0.1.0a0`",
    "created_at": "2021-02-03T21:08:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443652",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443654",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443655",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443656",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443657",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443658",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443659",
    "user": "vdelecroix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443660",
    "user": "vdelecroix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443661",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443662",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443664",
    "user": "vdelecroix"
}
```
...
```json
{
    "body": "Just for the record, another idea I considered is providing an interface to gappy to allow it to replace the base class for objects returned by it, sort of like how Sage Parents have an Element attribute, it would be possible to subclass `gappy.Gap` and provide a different base class.  This would also have a mechanism for instantiating the correct subclass of the base class (e.g. `GapPermutation` or `GapElement_Permutation`).\n\nHowever, I don't know that this has much of a use case outside of Sage.  For now I'm working on a more disruptive approach inspired by the cypari2 conversion to just use gappy more directly and do away with `GapElement`.",
    "created_at": "2021-02-05T15:29:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443666",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443667",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443668",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443669",
    "user": "vdelecroix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443670",
    "user": "vdelecroix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443672",
    "user": "vdelecroix"
}
```
...
```json
{
    "body": "Thanks, you are right, of course.",
    "created_at": "2021-02-06T18:15:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443673",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "On the other hand `Element.__getattribute__` already dispatches fairly dynamically via `getattr_from_category`, so...",
    "created_at": "2021-02-06T18:21:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443674",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443675",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443676",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443677",
    "user": "embray"
}
```
...
```json
{
    "body": "TIL: The coercion model does in fact already support a `_sage_` magic method, though it wasn't so easy for me to find: https://doc.sagemath.org/html/en/reference/coercion/sage/structure/coerce.html?highlight=_sage_#sage.structure.coerce.CoercionModel.canonical_coercion\n\nAdding this to `GapObj` makes it work:\n\n\n```\nsage: one = libgap(1)                                                                                                                                                                            \nsage: one._sage_()                                                                                                                                                                               \n1\nsage: R.<x> = PolynomialRing(ZZ)                                                                                                                                                                 \nsage: x = R.gen()                                                                                                                                                                                \nsage: x(one)                                                                                                                                                                                     \n1\nsage: a, b = coercion_model.canonical_coercion(one, x)                                                                                                                                           \nsage: type(a)                                                                                                                                                                                    \n<class 'sage.rings.polynomial.polynomial_integer_dense_flint.Polynomial_integer_dense_flint'>\nsage: type(b)                                                                                                                                                                                    \n<class 'sage.rings.polynomial.polynomial_integer_dense_flint.Polynomial_integer_dense_flint'>\n```\n\n\nI wonder why pari_gen doesn't support this too.",
    "created_at": "2021-02-08T11:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443679",
    "user": "embray"
}
```
...
```json
{
    "body": "Hrm, the problem with the above example though is that with `GapElement` the result of evaluating a polynomial on a `GapElement` is another `GapElement`, whereas here it just converts it to the appropriate Sage type and evaluates the polynomial on that.",
    "created_at": "2021-02-08T12:04:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443680",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443681",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443682",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443683",
    "user": "dimpase"
}
```
...
```json
{
    "body": "let's do this the other way: #31404",
    "created_at": "2021-03-24T10:49:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443684",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31060#issuecomment-443685",
    "user": "embray"
}
```
