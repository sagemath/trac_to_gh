...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/30461",
...
```json
{
    ...
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30461#event-79940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434267",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30461#event-79941"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30461#event-79942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434268",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434271",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434272",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434274",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434275",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434276",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434277",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434278",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434279",
    "user": "https://github.com/DisneyHogg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434280",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Looks good to me; checked the resulting HTML typesetting as well.",
    "created_at": "2021-06-23T22:08:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434281",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Missing continuation prompts:\n\n```diff\n         sage: L2 = [((r + 1)/2, 1/(1 - r^2)/Pdif(r)^2)\n-                    for r, _ in RR['x'](P).roots()]\n+        ....:       for r, _ in RR['x'](P).roots()]\n         sage: all((a[0] - b[0]).abs() < 1e-15 and (a[1] - b[1]).abs() < 1e-9\n-                  for a, b in zip(L1, L2))\n+        ....:     for a, b in zip(L1, L2))\n```\nIf you fix that, set back to positive review on my behalf.",
    "created_at": "2021-06-27T22:41:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434282",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434283",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434284",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434285",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434286",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434287",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434288",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434289",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30461#issuecomment-434290",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30461",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30461#event-79943"
}
```
