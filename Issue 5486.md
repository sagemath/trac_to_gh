# Issue 5486: [with patch, positive review] fix bug in variety() for MPolynomialIdeals
...
```json
{
    ...
    "title": "[with patch, positive review] fix bug in variety() for MPolynomialIdeals",
    "type": "issue",
...
```json
{
    "body": "Attachment [variety_bugfix.patch](tarball://root/attachments/some-uuid/ticket5486/variety_bugfix.patch) by @johnperry-math created at 2009-03-25 17:41:30\n\ndoctests pass; changes make sense",
    "created_at": "2009-03-25T17:41:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5486#issuecomment-42499",
    "user": "https://github.com/johnperry-math"
}
```

Attachment [variety_bugfix.patch](tarball://root/attachments/some-uuid/ticket5486/variety_bugfix.patch) by @johnperry-math created at 2009-03-25 17:41:30
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5486#issuecomment-42500",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5486#issuecomment-42501",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5486#event-12824"
}
```
