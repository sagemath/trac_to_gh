...
```
sage: %timeit qexp_eta(ZZ[This is the Trac macro *'q'* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#'q'-macro),10)
625 loops, best of 3: 1.41 ms per loop
sage: %timeit qexp_eta(ZZ[This is the Trac macro *'q'* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#'q'-macro),100)
25 loops, best of 3: 21.4 ms per loop
sage: %timeit qexp_eta(ZZ[This is the Trac macro *'q'* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#'q'-macro),1000)
