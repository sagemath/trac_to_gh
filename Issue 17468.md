...
```
sage: V = GF(2)^2
sage: W = V.subspace([This is the Trac macro *1, 0* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1, 0-macro))
...
Basis matrix:
[1 0]
sage: y = matrix(GF(2), [This is the Trac macro *0* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0-macro))
sage: y*W
