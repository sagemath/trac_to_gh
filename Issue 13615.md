...
```
sage: arrow2d(path=[This is the Trac macro ** that was inherited from the migration called with arguments (1,1),)](https://trac.sagemath.org/wiki/WikiMacros#-macro))
```
