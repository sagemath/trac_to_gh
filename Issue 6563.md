...
```json
{
    ...
    "title": "[with patch; needs review] Singular fails to install header files, since it fails to find install-sh",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-53526",
    "user": "mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-53527",
    "user": "mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-53528",
    "user": "mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-53529",
    "user": "@jdemeyer"
}
```
