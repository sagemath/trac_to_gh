...
```json
{
    "body": "Attachment [tachyon-example.dat](tarball://root/attachments/some-uuid/ticket7232/tachyon-example.dat) by leif created at 2013-03-08 01:47:05\n\nTachyon input file for the example given in the ticket's description.  (Plain text)",
...
Attachment [tachyon-example.dat](tarball://root/attachments/some-uuid/ticket7232/tachyon-example.dat) by leif created at 2013-03-08 01:47:05
...
```json
{
    "body": "Attachment [tachyon-doctest.490.dat](tarball://root/attachments/some-uuid/ticket7232/tachyon-doctest.490.dat) by leif created at 2013-03-08 07:51:06\n\nTachyon input file generated by the example in `sage/plot/plot3d/tachyon.py`, around line 490 (as of Sage 5.8.beta3).  (Plain text)",
...
Attachment [tachyon-doctest.490.dat](tarball://root/attachments/some-uuid/ticket7232/tachyon-doctest.490.dat) by leif created at 2013-03-08 07:51:06
