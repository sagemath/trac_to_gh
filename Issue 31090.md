...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/31090",
...
```json
{
    ...
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443569",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82034"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82035"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82036"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82037"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82038"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82039"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443570",
...
```json
{
    "body": "Actually, the recommended way to obtain units and S-units with the new version of pari is with the function bnfunits (not to be confused with bnfsunit). This is what the Sage code does, except that it then tries to expand the units. In gp that would be something like:\n\n```\nnf = nfsplitting(x^5-463);\nbnf = bnfinit(nf,1);\nU = bnfunits(bnf);\n[nffactorback(bnf,u) | u <- U[1]]\n```\n\nApplying nffactoback to the huge factored forms often results in overflows. If one insists on having expanded forms for the units, one should use bnf.fu instead, which computes the product in a more clever way.",
    "created_at": "2022-08-12T11:33:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443574",
    "user": "https://github.com/AurelPage"
}
```
...
```json
{
    "body": "Thanks for the useful comments, Aurel.   I don't think we want to (at least, not on this ticket) create a new class for factored-units, though I know that they can be much more compact than when expanded (I first heard Buchmann talk about this in 1994, just before ANTS 1).",
    "created_at": "2022-08-15T13:08:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443575",
...
```json
{
    "body": "> I don't think that any of this has much to do with passing a precision parameter.\n\n\nI agree. It turns out that I misidentified the problem and gave this ticket a poor name.",
    "created_at": "2022-08-18T13:33:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443579",
    "user": "https://github.com/davidlowryduda"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82040"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31090#event-82041"
}
```
...
```json
{
    "body": "Sorry, my wording was clumsy. What I meant is that as long as there is no support for product representations, it is better to use bnfsunit. This should allow the above example to run successfully.\n\nIf in the future this support gets implemented, then bnfunits will become useful.",
    "created_at": "2022-09-06T20:24:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443583",
    "user": "https://github.com/AurelPage"
}
```
...
```json
{
    "body": "OK, I understand.  I have put my branch on the ticket (not yet merged with most recent develop branch), but I will not have time to do more with this until around 19 Sept.\n\n---\nNew commits:",
    "created_at": "2022-09-07T08:37:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443584",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "The commit I uploaded (034cb84) was based on a beta from a couple of weeks ago, so I am rebasing it on 9.7.rc0 and will update the commit when I have done that and tested that it still works.",
    "created_at": "2022-09-07T13:38:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443585",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443586",
...
```json
{
    "body": "OK, same edits but rebased onto 9.7.rc0",
    "created_at": "2022-09-07T15:45:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31090#issuecomment-443587",
    "user": "https://github.com/JohnCremona"
}
```
