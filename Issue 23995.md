...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336302",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336303",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336305",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336306",
    "user": "@egourgoulhon"
}
```
...
```json
{
    "body": "LGTM as far as I can tell. Ralf, do you have any comments/suggestions?",
    "created_at": "2017-11-17T21:48:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336307",
    "user": "@tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336309",
    "user": "@rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336310",
    "user": "@rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336311",
    "user": "@egourgoulhon"
}
```
...
```json
{
    "body": "> If I understand correctly (which is not guaranteed...), this would change the ordering of simplification.\n\nDepends on the type of walker which is depth-first with any `ExpressionTreeWalker` as I understand, so the outcome would be actually the same.",
    "created_at": "2017-11-19T07:18:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336312",
    "user": "@rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336313",
    "user": "@egourgoulhon"
}
```
...
```json
{
    "body": "The recursion is provided by the superclasses of the walker.",
    "created_at": "2017-11-20T09:48:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336314",
    "user": "@rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336315",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336317",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336318",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336319",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336320",
    "user": "git"
}
```
...
```json
{
    "body": "The last commit gets rid of any string manipulation in `SimplifySqrtReal` and `SimplifyAbsTrig`, following the suggestion in comment:13.",
    "created_at": "2017-11-21T10:45:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336321",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336322",
    "user": "@egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336324",
    "user": "@rll2021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23995#issuecomment-336326",
    "user": "@vbraun"
}
```
