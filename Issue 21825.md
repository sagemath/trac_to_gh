...
-        if [ $? -ne 0 ]; then
-            exit 1
+        if [This is the Trac macro *$INSTALL_OPTIONS == *"-info"* * that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#$INSTALL_OPTIONS == *"-info"* -macro); then
