# Issue 12117: pass algorithm argument to custom numeric evaluation methods
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12117#event-32853"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12117#event-32854"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12117#event-32855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12117",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12117#event-32856"
}
```
