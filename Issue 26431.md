...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26431#issuecomment-371612",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26431#event-66113"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26431#issuecomment-371613",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26431#issuecomment-371614",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26431#event-66114"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26431#event-66115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26431#issuecomment-371615",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "See also: #29018 - Improve documentation of m4/sage_spkg_configure.m4",
    "created_at": "2020-01-16T01:42:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26431#issuecomment-371616",
...
```json
{
    "body": "#30543 adds basic documentation and a recommendation to create these files, but details on how to write `m4` scripts would still be welcome.",
    "created_at": "2020-09-09T22:39:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26431#issuecomment-371617",
