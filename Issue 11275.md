...
```json
{
    ...
    "title": "python spkg build fails on Ubuntu 11.04 derivative Mint 11",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124195",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124196",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124198",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124200",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124202",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124204",
    "user": "pipedream"
}
```
...
```json
{
    "body": "Attachment [11447-python-mint11b.patch](tarball://root/attachments/some-uuid/ticket11447/11447-python-mint11b.patch) by kcrisman created at 2011-06-09 12:40:46\n\n> I'm not sure he has a trac account (for reviewing).\n\nWhat I meant was that you could put his name down as a reviewer, assuming you do not have actual access to a Mint machine and neither does David.",
    "created_at": "2011-06-09T12:40:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124205",
    "user": "kcrisman"
}
```
...
```json
{
    "body": "Bill Odefey reports that the new spkg worked for him again on Linux Mint 11.",
    "created_at": "2011-06-09T16:55:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124206",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124208",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "Looking at `/etc/issue` is a *very bad* way of checking the system.  This is a file which is sometimes customized by system administrators.  You should try to understand *why* Python doesn't build on such a system and check for the true cause.",
    "created_at": "2011-06-14T21:02:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124209",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124212",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124213",
    "user": "medlock"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124215",
    "user": "medlock"
}
```
...
```json
{
    "body": "Attachment [deb-setup.diff](tarball://root/attachments/some-uuid/ticket11447/deb-setup.diff) by medlock created at 2011-06-17 04:39:02\n\nReplying to [comment:14 medlock]:\n> Replying to [comment:13 medlock]:\n> > ...\n> > The solution that's in Python 2.7 and in Debian's patches to Python 2.6 (patch deb-setup.diff attached) is to use `dpkg-architecture -qDEB_HOST_MULTIARCH`.  These packages use this command to set the library paths correctly.\n> > \n> > This requires that the optional package dpkg-dev is installed.  A wrapper should probably be written that complains if `lsb_release -i` is (Debian|Ubuntu|Mint) and `dpkg-architecture` is not present, otherwise the build will fail without the user knowing why...\n> \n> All this can get ripped out when Sage upgrades to Python 2.7, where this issue is fixed...\n\nSee also [http://lists.debian.org/debian-devel/2011/06/msg00431.html](http://lists.debian.org/debian-devel/2011/06/msg00431.html).",
    "created_at": "2011-06-17T04:39:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124216",
    "user": "medlock"
}
```

Attachment [deb-setup.diff](tarball://root/attachments/some-uuid/ticket11447/deb-setup.diff) by medlock created at 2011-06-17 04:39:02
...
```json
{
    "body": "Attachment [11447-Python-Debian-multiarch.patch](tarball://root/attachments/some-uuid/ticket11447/11447-Python-Debian-multiarch.patch) by medlock created at 2011-06-17 23:17:12\n\nPatch to python-2.6.4.p10.spkg to fix multiarch build.  Solution copied from Python 2.7.",
    "created_at": "2011-06-17T23:17:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124218",
    "user": "medlock"
}
```

Attachment [11447-Python-Debian-multiarch.patch](tarball://root/attachments/some-uuid/ticket11447/11447-Python-Debian-multiarch.patch) by medlock created at 2011-06-17 23:17:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124220",
    "user": "pipedream"
}
```
...
```json
{
    "body": "Looks good to me. This does mean -lcrypt in Setup.dist is uncommented on all\nsystems, Debian or not, Linux or not. Does that have unintended side effects?",
    "created_at": "2011-06-18T10:09:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124221",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124223",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124224",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124226",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124227",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124228",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124229",
    "user": "medlock"
}
```
...
```json
{
    "body": "I will test the new package on the buildbots and give positive_review if these are successful.",
    "created_at": "2011-07-05T07:36:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124230",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124231",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124232",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124233",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124234",
    "user": "leif"
}
```
...
```json
{
    "body": "It would be great if the patch included a suggestion to \"sudo apt-get install dpkg-dev\" if it is not installed.",
    "created_at": "2011-07-05T08:01:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124235",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124236",
    "user": "pipedream"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124237",
    "user": "leif"
}
```
...
```json
{
    "body": "Replying to [comment:30 pipedream]:\n> It would be great if the patch included a suggestion to \"sudo apt-get install dpkg-dev\" if it is not installed.\n\nPatch is on the way...\n\nCannot really test it myself though, as I have no newer Debian here.",
    "created_at": "2011-07-05T09:07:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124238",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124239",
    "user": "leif"
}
```
...
```json
{
    "body": "Ooops, I just noticed the output of `command -v dpkg` is not redirected. But IMHO negligible.",
    "created_at": "2011-07-05T10:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124241",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124242",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124243",
    "user": "leif"
}
```
...
```json
{
    "body": "Messy in various places, but at least it improves over the existing version, so positive_review.",
    "created_at": "2011-07-07T09:50:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124244",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124245",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124246",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124247",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124248",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11275#issuecomment-124249",
    "user": "jdemeyer"
}
```
