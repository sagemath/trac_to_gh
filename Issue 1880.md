# Issue 1880: [with trivial patch, positive review] Sage 2.10: qqbar numerical doctest failure
...
```json
{
    ...
    "title": "[with trivial patch, positive review] Sage 2.10: qqbar numerical doctest failure",
    "type": "issue",
