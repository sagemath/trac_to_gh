...
```json
{
    "body": "Attachment [noncongruence_example.sage](tarball://root/attachments/some-uuid/ticket11709/noncongruence_example.sage) by hmonien created at 2011-08-25 08:32:34",
...
Attachment [noncongruence_example.sage](tarball://root/attachments/some-uuid/ticket11709/noncongruence_example.sage) by hmonien created at 2011-08-25 08:32:34
...
```json
{
    "body": "Attachment [fun_gamma_3.png](tarball://root/attachments/some-uuid/ticket11709/fun_gamma_3.png) by hmonien created at 2011-08-31 07:32:04",
...
Attachment [fun_gamma_3.png](tarball://root/attachments/some-uuid/ticket11709/fun_gamma_3.png) by hmonien created at 2011-08-31 07:32:04
...
```json
{
    "body": "Attachment [fun_gamma0_11.png](tarball://root/attachments/some-uuid/ticket11709/fun_gamma0_11.png) by hmonien created at 2011-08-31 07:32:18",
...
Attachment [fun_gamma0_11.png](tarball://root/attachments/some-uuid/ticket11709/fun_gamma0_11.png) by hmonien created at 2011-08-31 07:32:18
...
```json
{
    "body": "Attachment [fun_gamma0_23.png](tarball://root/attachments/some-uuid/ticket11709/fun_gamma0_23.png) by hmonien created at 2011-08-31 07:32:49",
...
Attachment [fun_gamma0_23.png](tarball://root/attachments/some-uuid/ticket11709/fun_gamma0_23.png) by hmonien created at 2011-08-31 07:32:49
...
Attachment [pairing.png](tarball://root/attachments/some-uuid/ticket11709/pairing.png) by hmonien created at 2011-08-31 07:38:46
...
```json
{
    "body": "Attachment [trac-11709_farey_symbol.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol.patch) by hmonien created at 2011-09-01 20:08:20\n\nChanges as discussed. Hope for the best ... .",
...
Attachment [trac-11709_farey_symbol.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol.patch) by hmonien created at 2011-09-01 20:08:20
...
```json
{
    "body": "Attachment [trac_11709-add_hpp_files_to_manifest.reviewer.patch](tarball://root/attachments/some-uuid/ticket11709/trac_11709-add_hpp_files_to_manifest.reviewer.patch) by leif created at 2011-09-18 05:54:50\n\nCrucial six-character patch. Otherwise Sage won't build from scratch. Independent of the other patch; apply to the Sage library.",
...
Attachment [trac_11709-add_hpp_files_to_manifest.reviewer.patch](tarball://root/attachments/some-uuid/ticket11709/trac_11709-add_hpp_files_to_manifest.reviewer.patch) by leif created at 2011-09-18 05:54:50
...
```json
{
    "body": "Attachment [trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch](tarball://root/attachments/some-uuid/ticket11709/trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch) by leif created at 2011-09-19 15:30:16\n\nApply on top of the other patch(es), to the Sage library.",
...
Attachment [trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch](tarball://root/attachments/some-uuid/ticket11709/trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch) by leif created at 2011-09-19 15:30:16
...
```json
{
    "body": "Attachment [farey.patch](tarball://root/attachments/some-uuid/ticket11709/farey.patch) by hmonien created at 2012-01-11 19:05:27\n\nThis patch replaces in one file all the previous patches",
...
Attachment [farey.patch](tarball://root/attachments/some-uuid/ticket11709/farey.patch) by hmonien created at 2012-01-11 19:05:27
...
Attachment [trac-11709_farey_symbol-sage-4.8.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-4.8.patch) by hmonien created at 2012-03-02 17:51:47
...
```json
{
    "body": "Attachment [trac-11709_farey_symbol-sage-5.0.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-5.0.patch) by davidloeffler created at 2012-03-09 17:33:34\n\nIGNORE THIS -- uploaded by mistake",
...
Attachment [trac-11709_farey_symbol-sage-5.0.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-5.0.patch) by davidloeffler created at 2012-03-09 17:33:34
...
```json
{
    "body": "Attachment [trac_11709-review.patch](tarball://root/attachments/some-uuid/ticket11709/trac_11709-review.patch) by davidloeffler created at 2012-03-09 17:33:58\n\nReviewer patch; apply over the rebased v5.0 patch",
...
Attachment [trac_11709-review.patch](tarball://root/attachments/some-uuid/ticket11709/trac_11709-review.patch) by davidloeffler created at 2012-03-09 17:33:58
