...
```json
{
    "body": "Attachment [mpir-2.1.3.p4-p5.diff](tarball://root/attachments/some-uuid/ticket11896/mpir-2.1.3.p4-p5.diff) by leif created at 2011-10-05 03:18:45\n\nDiff between the p4 (from #8664) and the p5 spkg. For reference / review only.",
...
Attachment [mpir-2.1.3.p4-p5.diff](tarball://root/attachments/some-uuid/ticket11896/mpir-2.1.3.p4-p5.diff) by leif created at 2011-10-05 03:18:45
