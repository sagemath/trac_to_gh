# Issue 12261: Make zn_poly respect the CC environment variable, work around GCC 4.7.0 bug on ia64 (and clean up the spkg)
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12261#event-33419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12261",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12261#event-33420"
}
```
