...
```json
{
    "body": "Fixed by removing `glpk-4.9.spkg` from the [experimental packages](http://www.sagemath.org/packages/experimental/) repository.",
    "created_at": "2010-02-14T16:40:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8247#issuecomment-72949",
    "user": "mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8247#issuecomment-72950",
    "user": "mvngu"
}
```
