# Issue 18330: LatticePoset: add maximal_sublattices()
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18330#event-52164"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18330#event-52165"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18330#event-52166"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18330",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18330#event-52167"
}
```
