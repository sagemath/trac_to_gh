# Issue 5256: [with patch, positive review] coherent handling of trivial matrices (depend on #5244, #5242).
...
```json
{
    ...
    "title": "[with patch, positive review] coherent handling of trivial matrices (depend on #5244, #5242).",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5256",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5256#event-12206"
}
```
