# Issue 2375: [with patch, positive review] Sage 2.10.3.rc1: graph_isom.py doctest failure in PermutationGroup
...
```json
{
    ...
    "title": "[with patch, positive review] Sage 2.10.3.rc1: graph_isom.py doctest failure in PermutationGroup",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-15989",
...
```json
{
    "body": "Attachment [2375-fix.patch](tarball://root/attachments/some-uuid/ticket2375/2375-fix.patch) by @rlmill created at 2008-03-03 21:36:52",
    "created_at": "2008-03-03T21:36:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-15990",
    "user": "https://github.com/rlmill"
}
```

Attachment [2375-fix.patch](tarball://root/attachments/some-uuid/ticket2375/2375-fix.patch) by @rlmill created at 2008-03-03 21:36:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-15991",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "Attachment [2375-fix2.patch](tarball://root/attachments/some-uuid/ticket2375/2375-fix2.patch) by @jasongrout created at 2008-03-03 23:02:42\n\nlooks good to me.",
    "created_at": "2008-03-03T23:02:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-15992",
    "user": "https://github.com/jasongrout"
}
```

Attachment [2375-fix2.patch](tarball://root/attachments/some-uuid/ticket2375/2375-fix2.patch) by @jasongrout created at 2008-03-03 23:02:42
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-15993",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2375#event-5612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-15994",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
