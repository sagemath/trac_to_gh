# Issue 24299: find_local_maximum/minimum() fails with expressions containing complex numbers
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24299#event-61873"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24299#event-61874"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24299#event-61875"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24299#event-61876"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24299#event-61877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24299",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24299#event-61878"
}
```
