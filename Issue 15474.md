...
sage: M = DiscreteHiddenMarkovModel([This is the Trac macro *1.0* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1.0-macro), [This is the Trac macro *0.1, 0.9* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0.1, 0.9-macro), [1.0])
sage: import pickle
