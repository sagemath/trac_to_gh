...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15474#event-46119"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15474#event-46120"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15474#event-46121"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15474#event-46122"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15474#event-46123"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15474#issuecomment-199663",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15474#issuecomment-199664",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    "body": "Btw. I could not find your name on https://trac.sagemath.org/wiki, you might want to add it there.",
    "created_at": "2016-11-17T06:46:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15474#issuecomment-199665",
...
```json
{
    "body": "I tweaked the docstring a bit. If you are fine with this, feel free to set it to positive review yourself.\n\n---\nNew commits:",
    "created_at": "2016-11-17T07:05:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15474#issuecomment-199666",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15474#issuecomment-199667",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15474#event-46124"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15474#issuecomment-199668",
