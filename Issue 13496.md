...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/13496",
...
```json
{
    "body": "The code says the example is a hyperbolic Dynkin diagram and appears on p. 57 of Kac's Infinite Dimension Lie algebras, in exercise 4.9.  In Chapter 4, Kac is not assuming his (generalized) Cartan matrices are symmetrizable, which is probably at the root of the problem.",
    "created_at": "2012-11-11T06:12:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13496#issuecomment-166273",
    "user": "https://github.com/hughrthomas"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38334"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38335"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38336"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38337"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38338"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38339"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13496#event-38340"
}
```
...
```json
{
    "body": "can the described behaviour be qualified as 'mathematically wrong answer'?",
    "created_at": "2016-07-09T10:40:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13496#issuecomment-166274",
...
```json
{
    "body": "How I have always seen Dynkin diagrams, no assumption of symmetrizability is required, which is a different condition than crystallographic condition. So in a way, this is about getting our conventions decided.",
    "created_at": "2016-07-09T16:06:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13496#issuecomment-166275",
...
```json
{
    "body": "I agree with Travis that the current usage of an_instance() doesn't make any sense and should be removed.  I hadn't grasped exactly what was happening.  \n\nI have no opinion about the right way to implement a feature which would give example(s) of Dynkin diagrams.",
    "created_at": "2016-07-10T20:54:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13496#issuecomment-166279",
    "user": "https://github.com/hughrthomas"
}
```
