# Issue 28567: Minkowski sum of regular polgons fails for backend field
...
```json
{
    ...
    "title": "Minkowski sum of regular polgons fails for backend field",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28567#issuecomment-402868",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28567",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28567#issuecomment-402869",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28567",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28567#issuecomment-402870",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28567#event-72789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28567",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28567#event-72790"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28567",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28567#issuecomment-402871",
