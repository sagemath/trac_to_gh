...
==============================================================
   ...
   680                                                       D = DiGraph(dict([This is the Trac macro *Integer* that was inherited from the migration called with arguments (i),data[i)](https://trac.sagemath.org/wiki/WikiMacros#Integer-macro) for i in range(len(data))]),
