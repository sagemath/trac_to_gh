...
```json
{
    "body": "While Sage already has `falling_factorial` and `rising_factorial` functions they are not symbolic, i.e. cannot be used as part of symbolic expressions. This prevents working with hypergeometric expressions and implementation of e.g. Gosper's algorithm.\n\nIssue created by migration from https://trac.sagemath.org/ticket/19461\n\n",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263414",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263415",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19224#event-53718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263416",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263417",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263418",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263419",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19224#event-53719"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19224#event-53720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263420",
    "user": "https://github.com/arminstraub"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263421",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263422",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263423",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19224#issuecomment-263424",
    "user": "https://github.com/rwst"
}
```
