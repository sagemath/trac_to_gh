...
Original creation time: 2017-06-08 11:55:06

CC:  jason fbissey slelievre
...
Comment by jdemeyer created at 2017-06-08 13:32:03
...
Comment by jdemeyer created at 2017-07-04 13:41:40
...
Comment by git created at 2017-07-04 15:12:34
...
Comment by fbissey created at 2017-11-07 23:17:51
...
Expected:
    Interactive function <function trapezoid_integration at ...> with 7 widgets
      ...
      interval_g: Grid(value=[This is the Trac macro *0, 8* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 8-macro), description=u'keyboard: ', children=(Label(value=u'keyboard: '), VBox(children=(EvalText(value=u'0'),)), VBox(children=(EvalText(value=u'8'),))))
...
Got:
    Interactive function <function trapezoid_integration at 0x7f143bc73ed8> with 7 widgets
      ...
      interval_g: Grid(value=[This is the Trac macro *0, 8* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 8-macro), children=(Label(value=u'keyboard: '), VBox(children=(EvalText(value=u'0', layout=Layout(max_width=u'5em')),)), VBox(children=(EvalText(value=u'8', layout=Layout(max_width=u'5em')),))))
...
Expected:
    Interactive function <function simpson_integration at ...> with 7 widgets
      ...
      interval_g: Grid(value=[This is the Trac macro *0, 10* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 10-macro), description=u'keyboard: ', children=(Label(value=u'keyboard: '), VBox(children=(EvalText(value=u'0'),)), VBox(children=(EvalText(value=u'10'),))))
      output_form: ToggleButtons(value='traditional', options=['traditional', 'table', 'none'], description=u'Computations form')
...
Got:
    Interactive function <function simpson_integration at 0x7f143bb8d320> with 7 widgets
      ...
      interval_g: Grid(value=[This is the Trac macro *0, 10* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 10-macro), children=(Label(value=u'keyboard: '), VBox(children=(EvalText(value=u'0', layout=Layout(max_width=u'5em')),)), VBox(children=(EvalText(value=u'10', layout=Layout(max_width=u'5em')),))))
      output_form: ToggleButtons(description=u'Computations form', options=('traditional', 'table', 'none'), value='traditional')
    Function <script type="math/tex">f(x)=x \sin\left(x\right) + x + 1</script>
    Integral value to seven decimal places is: <script type="math/tex">\displaystyle\int_{0.00}^{10.00} {f(x) \, \mathrm{d}x} = 67.846694</script>
    <BLANKLINE>
...
Expected:
    Manual interactive function <function riemann_sum at ...> with 9 widgets
      ...
      interval_g: Grid(value=[This is the Trac macro *0, 2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 2-macro), description=u'keyboard: ', children=(Label(value=u'keyboard: '), VBox(children=(EvalText(value=u'0'),)), VBox(children=(EvalText(value=u'2'),))))
...
Got:
    Manual interactive function <function riemann_sum at 0x7f143bb8d5f0> with 9 widgets
      ...
      interval_g: Grid(value=[This is the Trac macro *0, 2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 2-macro), children=(Label(value=u'keyboard: '), VBox(children=(EvalText(value=u'0', layout=Layout(max_width=u'5em')),)), VBox(children=(EvalText(value=u'2', layout=Layout(max_width=u'5em')),))))
      hr2: HTMLText(value=u'<hr>')
      list_table: Checkbox(value=False, description=u'List table')
    <small>Adjust your data and click Update button. Click repeatedly for another random values.</small>
...
Comment by slelievre created at 2017-12-18 12:32:06
...
Comment by jason created at 2017-12-18 20:19:06
...
Comment by jason created at 2017-12-28 00:35:10
...
Comment by git created at 2018-01-24 11:00:51
...
Comment by jdemeyer created at 2018-01-24 11:21:40
...
Comment by fbissey created at 2018-02-13 03:38:59
...
Comment by vbraun created at 2018-02-15 00:21:19
...
Comment by fbissey created at 2018-02-15 00:22:58
...
Comment by fbissey created at 2018-02-15 00:29:34
...
Comment by jdemeyer created at 2018-02-15 06:30:17
...
Comment by vbraun created at 2018-02-16 23:39:01
