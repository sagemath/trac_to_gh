...
```json
{
    "body": "One solution would be to have a special case of null pointer for empty rows.  All code (e.g., echelon form) would have to be changed to take this special case into account.  That would resolve this problem. \n\nI wrote the mpq sparse matrix class for computing presentations of modular symbols spaces, and in that situation there are no zero rows, so this wasn't a problem for me.",
    "created_at": "2012-05-25T17:17:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12176",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12176#issuecomment-141600",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33064"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33065"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33066"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33067"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33068"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33069"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12176#event-33070"
}
```
