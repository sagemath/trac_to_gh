...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28200#issuecomment-397777",
...
```json
{
    "body": "I agree--the libgap interface in Sage used to display `null` when calling GAP functions with return value, which was also against the spirit of GAP's REPL.  Nobody complained about this being changed.\n\nSimilarly I think this should be fixed in the R interface, even if it's technically a backwards-incompatible change (but the existing behavior is not desirable so...)",
    "created_at": "2019-09-18T12:34:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28200#issuecomment-397778",
...
```json
{
    "body": "Though with 8.9rc0 out this should probably wait.",
    "created_at": "2019-09-18T12:35:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28200#issuecomment-397779",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71182"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28200#issuecomment-397780",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71183"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71184"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28200#issuecomment-397781",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71185"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71186"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71187"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28200#issuecomment-397782",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71189"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71190"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71191"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71192"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71193"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71194"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71195"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71196"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71197"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28200#event-71198"
}
```
