...
```sh
[This is the Trac macro *-z "$SAGE_SRC" * that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#-z "$SAGE_SRC" -macro) && SAGE_SRC="${SAGE_ROOT}/devel/sage"

[This is the Trac macro *-z "$SAGE_SHARE" * that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#-z "$SAGE_SHARE" -macro) && SAGE_SHARE="${SAGE_LOCAL}/share"
```
