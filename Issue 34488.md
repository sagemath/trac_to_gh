...
```json
{
    ...
    "title": "M.characteristic_polynomial() produces polynomial with scrambled parent when its variable exists in M's parent",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34488#issuecomment-487721",
...
```json
{
    "body": "I think that Sage is acting as it should, so we should close this ticket as invalid.",
    "created_at": "2022-11-06T05:35:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34488#issuecomment-487722",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34488#event-89777"
}
```
...
```json
{
    "body": "Well, I can agree on the current behavior of `M.characteristic_polynomial()`, ie. when the variable is not specified, but not on the case `M.characteristic_polynomial(y)`. In the latter case, I specifically request to create a polynomial in existing variable `y` in `K`, and expect the result be the same as`(y*identity_matrix(2) - M).det()` by definition of the characteristic polynomial, which is the element of `K` if computed by this formula. However, `M.characteristic_polynomial(y)` produces something else.",
    "created_at": "2022-11-06T08:37:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34488#issuecomment-487723",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34488#event-89778"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34488#event-89779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34488#issuecomment-487729",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34488#issuecomment-487731",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34488#issuecomment-487733",
    "user": "https://github.com/nbruin"
}
```
