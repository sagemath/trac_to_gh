...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3690#event-8461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3690",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3690#event-8462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3690#issuecomment-26099",
...
```json
{
    "body": "The issue is no longer relevant since we have switched to using Sphinx and ReST for the documentation.",
    "created_at": "2009-08-13T19:41:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3690#issuecomment-26100",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
