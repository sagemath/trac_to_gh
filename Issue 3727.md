...
```json
{
    "body": "an additional place to include that link would be at the end of a stack trace output. so, that there is an active call for submitting this particlar problem.\n\nincluding the stack trace automatically is not possible, but i added an additional input field for stack traces.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3727#issuecomment-26455",
    "user": "TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3727#issuecomment-26456",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3727#issuecomment-26457",
    "user": "mabshoff"
}
```
