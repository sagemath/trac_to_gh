# Issue 30979: tox.ini (local): Add environment variables to skip system package installs and other steps, add mechanism for a local interactive shell
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30979#event-81594"
}
```
