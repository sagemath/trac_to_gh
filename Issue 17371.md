...
```json
{
    ...
    "title": "Allow use of principal value of integral if it's right",
    "type": "issue",
...
```json
{
    "body": "Fixed in [Maxima bug 2880](https://sourceforge.net/p/maxima/bugs/2880/), apparently.",
    "created_at": "2018-05-24T01:09:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17371#issuecomment-231243",
    "user": "https://github.com/kcrisman"
}
```
