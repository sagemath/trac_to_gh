# Issue 25732: Randomly appearing failure in schemes/elliptic_curves/padics.py
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363120",
    "user": "@timokau"
}
```
...
```json
{
    "body": "I'm not entirely sure to what extent the failure is really random. It might be deterministic but occur only under a very precise set of conditions.",
    "created_at": "2018-07-29T22:01:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363121",
    "user": "@jdemeyer"
}
```
...
```json
{
    "body": "A possible cannon-to-shoot-a-mosquito solution might be #25971.",
    "created_at": "2018-07-29T22:28:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363122",
    "user": "@jdemeyer"
}
```
...
```json
{
    "body": "I cannot reproduce on my desktop PC, even though that is executing the exact same build script in a sandbox with the exact same dependencies. It looks like I can reproduce deterministically on my laptop. Unfortunately that takes forever to run the whole testsuite...",
    "created_at": "2018-07-30T19:59:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363123",
    "user": "@timokau"
}
```
...
```json
{
    "body": "It looks like this was actually triggered by the `rc2 -> rc3` upgrade for me, *not* the singular update. I didn't test the rc upgrade individually and assumed the singular update would be at fault because the rc upgrade only contained a couple of bug fixes.",
    "created_at": "2018-07-31T16:02:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363124",
    "user": "@timokau"
}
```
...
```json
{
    "body": "Although looking at the diff, I can't see anything that might cause this. All the changes in `build` can be ignored. So the only things remaining are\n\n- marking a couple of tests as known bugs\n- update the version metadata\n- add a stopgap to DuadicCodeEvenPair and DuadicCodeOddPair",
    "created_at": "2018-07-31T16:06:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363125",
    "user": "@timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363126",
    "user": "@jdemeyer"
}
```
...
```json
{
    "body": "Then what can we do about it? All I can say is that it pretty reliably (2 times in a row) happens after the upgrade and pretty reliable doesn't happen (3 times in a row) before.",
    "created_at": "2018-07-31T19:15:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363127",
    "user": "@timokau"
}
```
...
```json
{
    "body": "Looks like only integer arithmetic is involved; Might be a corrupted mpir limb in the pool due to a preceeding interrupt test. Where exactly the interrupt hits depends on may external factors...",
    "created_at": "2018-08-05T08:56:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363128",
    "user": "@vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25732#issuecomment-363130",
    "user": "@jdemeyer"
}
```
