...
```json
{
    "body": "Positive review !!! You changed the definition to have d ( integer ) represent an unique distance, and not range(distance), which is not the best for my usage, but clearly the best for Sage and for comprehension. Good idea.\n\nI created ticket #7540 about the difference in speed, which is an oddness we must fix ...\n\nPositive review, excellent patch !\n\nNathann",
    "created_at": "2009-11-27T12:18:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7533",
    "type": "issue_comment",
