...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126173",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126174",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "3. I think copying elementwise is necessary since the lhs and rhs matrices have potentially different storage order. In particular for sparse matrices, the echelon form is computed with dense matrices and then copied back to a sparse matrix.\n\nIt seems like `hermite_form()` is supposed to be an alias for `echelon_form()`. But sparse matrices don't have a `hermite_form()` method? I'll update the patch to fix that and also your points 1 & 2.",
    "created_at": "2011-07-01T08:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126175",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126176",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126177",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Attachment [trac_11558_echelon_form_with_transformation.patch](tarball://root/attachments/some-uuid/ticket11558/trac_11558_echelon_form_with_transformation.patch) by @vbraun created at 2011-07-01 10:16:04\n\nI've added more documentation. Some matrix backends don't support `echelon_form(transformation=True)`, so eventually we should compute the transformation matrix from the pivots if necessary. I'll leave that for later :-)",
    "created_at": "2011-07-01T10:16:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126178",
    "user": "https://github.com/vbraun"
}
```

Attachment [trac_11558_echelon_form_with_transformation.patch](tarball://root/attachments/some-uuid/ticket11558/trac_11558_echelon_form_with_transformation.patch) by @vbraun created at 2011-07-01 10:16:04
...
```json
{
    "body": "Applies, builds, passes obvious tests on 4.7.1.alpha3.  And looks good.\n\nI'll run full tests overnight and then flip this to positive review.\n\nRob",
    "created_at": "2011-07-11T03:51:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126179",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126180",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "Passes all long tests on 4.7.1.alpha3, so positive review.  Thanks for cleaning this up.",
    "created_at": "2011-07-11T19:10:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126181",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11386#event-11474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11386#issuecomment-126182",
