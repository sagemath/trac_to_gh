# Issue 15750: Python 3 preparation: Change syntax of octal integer literals
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15750#event-47017"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15750#event-47018"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15750#event-47019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15750",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15750#event-47020"
}
```
