...
```json
{
    "body": "Patch looks very good, and applies fine to 4.5.2.rc0.  Testing now..",
...
```json
{
    "body": "... and all passed (entire Sage library but without -long).",
    "created_at": "2010-08-04T01:48:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2508",
    "type": "issue_comment",
...
```json
{
    "body": "Could someone update the patch with a more descriptive commit string?",
    "created_at": "2010-08-07T05:03:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2508",
    "type": "issue_comment",
