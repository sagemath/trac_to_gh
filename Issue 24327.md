...
```
    ...
    sage: L1 = IntegralLattice(matrix([This is the Trac macro *4* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#4-macro)))
    sage: g1 = L1.discriminant_group().gens()[0]
    sage: glue = [This is the Trac macro *2*g1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2*g1-macro)
