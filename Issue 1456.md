# Issue 1456: [with patch, with positive review] gaussian_binomial bug
...
```json
{
    ...
    "title": "[with patch, with positive review] gaussian_binomial bug",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1456",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1456#event-3717"
}
```
