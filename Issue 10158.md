...
```json
{
    "body": "Attachment [trac_10159-matplotlib.patch](tarball://root/attachments/some-uuid/ticket10159/trac_10159-matplotlib.patch) by leif created at 2010-10-23 23:33:20\n\nOk.\n\nAlso, `raise` is more adequate there, since one cannot assert the only possible `OSError` is `EEXIST`, so it's less confusing now.\n\n(I still can't force errors.)",
    "created_at": "2010-10-23T23:33:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10158",
    "type": "issue_comment",
...
Attachment [trac_10159-matplotlib.patch](tarball://root/attachments/some-uuid/ticket10159/trac_10159-matplotlib.patch) by leif created at 2010-10-23 23:33:20
