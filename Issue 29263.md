# Issue 29263: Install all Python packages via pip wheel (or setup.py bdist_wheel), store wheels in $SAGE_LOCAL/var/lib/sage/wheels
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29263#event-75232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29263",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29263#event-75233"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29263#event-75234"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29263#event-75235"
}
```
