...
sage: C = Poset([list(B7) + [1337], B7.cover_relations() + [This is the Trac macro *127, 1337* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#127, 1337-macro)])
