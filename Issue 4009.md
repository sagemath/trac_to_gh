# Issue 4009: [with spkg, positive review] OSX 10.4/5: build R without the aqua support
...
```json
{
    ...
    "title": "[with spkg, positive review] OSX 10.4/5: build R without the aqua support",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4009#issuecomment-28877",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4009#event-9179"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4009#issuecomment-28878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4009#issuecomment-28879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
