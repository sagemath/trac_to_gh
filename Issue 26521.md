# Issue 26521: Fix gap_root doctest
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372510",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372511",
...
```json
{
    "body": "Sure, why not. I didn't remember that some of my distro friend just use `GAP_ROOT_DIR`. I just consider it irrelevant and I hope gap-4.10 will make all that stuff just go away. I'll basically patch sage-on-gentoo so `_guess_gap_root` becomes the new `gap_root` and remove the warning.\n\nBut really that stuff was always stinky and if you want to know that variable you should just ask gap itself. My opinion.",
    "created_at": "2018-11-25T19:54:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372512",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372513",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "I agree, it would be nice if that wouldn't be necessary at all. Thanks for the quick review.",
    "created_at": "2018-11-25T20:39:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372514",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372515",
...
```json
{
    "body": "I think the code in `gap_root` should also check--just in case--that `GAP_ROOT_DIR` is of a type that's compatible with `os.path.exists` in the first place, or at least have a fallback if not. I realize the existing code didn't do that either, but as long as we're fixing things might as well make it more robust.  Perhaps:\n\n```python\ntry:\n    if os.path.isdir(GAP_ROOT_DIR):\n        return GAP_ROOT_DIR\nexcept TypeError:\n    pass\n\nreturn _guess_gap_root()\n```\n\nThat would provide a reasonable fallback at least if `GAP_ROOT_DIR` is not actually a directory or a path-like type.  Beyond that the onus is on the user for `GAP_ROOT_DIR` to actually be a sensible GAP root :)",
    "created_at": "2018-11-26T09:37:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372517",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "In the `except TypeError` it might also be worth outputting a warning with the `warnings` module since the user should know if they're giving a bogus `GAP_ROOT_DIR`.  But since we have a reasonable fallback it shouldn't necessarily be an error either.",
    "created_at": "2018-11-26T09:38:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372518",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372519",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "As I already mentioned, as far as I am concerned in sage-on-gentoo anything with `GAP_ROOT_DIR` is just removed. It has never been that useful as far as I am concerned. I hope that #22626 will provide us with an easy way to just ditch it.\n\nMay be I should just put my act together and provide an alternative to the whole thing that just interrogate the configured gap for `gap_root`. That would be more robust and potentially allow the use of an external gap more easily.",
    "created_at": "2018-11-26T09:47:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372520",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Even if `GAP_ROOT_DIR` wouldn't be needed anymore, I'd still need a way to tell sage which `gap` binary to use. Currently the path is hardcoded. Ideally it would just use whatever is in `PATH`, but I guess sage wants to prefer its own SPKG.",
    "created_at": "2018-11-26T09:56:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372521",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372522",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372523",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372524",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "True. The only way that could go wrong is if the Sage installation itself were broken.  Theoretically a user can set a bogus `$SAGE_LOCAL`, but in that case we would also want to die much earlier.  Right now I don't think such a case is well handled but the place for that would be `sage.env`.",
    "created_at": "2018-11-26T14:48:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372525",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372526",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Fine for me.  I would break up the one really long line, but I'm not going to fuss over it.",
    "created_at": "2018-11-26T14:49:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372527",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26521#event-66235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372528",
...
```json
{
    "body": "I don't know why I added myself to the authors list.  It wasn't intentional.",
    "created_at": "2018-11-28T08:08:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372529",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Turns out I didn't really improve the situation for myself here. Now `_guess_gap_root` is always tested as it should. But the implementation assumes that gap is located in `SAGE_LOCAL`, which is not the case (which is why that guessing routine isn't used in the first place).\n\nI guess I'm just going to patch it for now.",
    "created_at": "2018-12-02T22:29:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372530",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "I guess `_guess_gap_root()`'s tests should not be run in the case where `_guess_gap_root()` would not be used in the first place (this is one example of why I have a problem with writing doctests for every minor internal utility function).\n\nI do want to do more work later on making Sage work well with a system GAP, which will be that much better with GAP 4.10 installs that provide libgap.  Then we'll revisit this.",
    "created_at": "2019-01-08T14:06:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372531",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26521#issuecomment-372532",
    "user": "https://github.com/timokau"
}
```
