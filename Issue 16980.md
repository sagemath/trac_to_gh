...
```json
{
    "body": "Or maybe this is just how Gap's errors are handled?  Seems to be sandwiching the Python error.",
    "created_at": "2014-10-24T20:34:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16980#issuecomment-224816",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16980#issuecomment-224817",
...
```json
{
    "body": "Worth a shot, anyway.  I don't actually use this functionality very much; it would be good to have a unified framework for handling GAP errors, and I know very little about GAP errors.  But ideally it's not just minimal generating set that would be fixed and have a clearer error message.\n\nMaybe it's enough to put the error message at the END of the Python-generated message.  ?",
    "created_at": "2015-01-29T16:59:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16980#issuecomment-224818",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "The whole thing is produced by GAP, so I don't see any value in moving the message somewhere. I think that it is really a somehow bigger problem, how to handle GAP errors properly generally. \nReplying to [comment:3 kcrisman]:\n> Worth a shot, anyway.  I don't actually use this functionality very much; it would be good to have a unified framework for handling GAP errors, and I know very little about GAP errors.  But ideally it's not just minimal generating set that would be fixed and have a clearer error message.\n> \n> Maybe it's enough to put the error message at the END of the Python-generated message.  ?",
    "created_at": "2015-01-29T17:10:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16980#issuecomment-224819",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
