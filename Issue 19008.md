...
```json
{
    "body": "Attachment [sage_crash_PziaWp.log](tarball://root/attachments/some-uuid/ticket19245/sage_crash_PziaWp.log) by chapoton created at 2015-09-24 18:53:30\n\nSmaller case, still crashing in 6.9.beta7:\n\n```\nsage: br = PolynomialRing(ZZ,\"a,x1,x2\")\nsage: br.inject_variables()\nsage: dct = {x1:a, x2:0}\nsage: matrix(br,[[x2]]).subs(dct)\n```\n",
...
Attachment [sage_crash_PziaWp.log](tarball://root/attachments/some-uuid/ticket19245/sage_crash_PziaWp.log) by chapoton created at 2015-09-24 18:53:30
