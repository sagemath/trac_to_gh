...
```json
{
    ...
    "title": "Add make option to use prebuild wheels from pypi",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463884",
    "user": "@mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463885",
    "user": "@tobiasdiez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463886",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463887",
    "user": "@dimpase"
}
```
