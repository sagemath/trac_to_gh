...
```json
{
    "body": "<a id='comment:8'></a>\nI made some remarks on [GitLab](../wikis/GitLab). Looking forward to comments at https://gitlab.com/sagemath/sage/merge_requests/38.",
