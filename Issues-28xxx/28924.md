...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28924#issuecomment-454344",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28924#issuecomment-454345",
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256813"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28924#issuecomment-454346",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28924#issuecomment-454347",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256815"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256816"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256817"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28924",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28924#event-256819"
}
```
