...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548240",
    "user": "https://github.com/LaisRast"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"public/28256\"",
    "created_at": "2019-07-24T20:03:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548241",
    "user": "https://github.com/LaisRast"
}
```

Changing branch from "" to "public/28256"
...
```json
{
    "body": "Changing commit from \"\" to \"28bf771a9af366e08fc3a1771e5ef266208a6947\"",
    "created_at": "2019-07-24T20:03:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548242",
    "user": "https://github.com/LaisRast"
}
```

Changing commit from "" to "28bf771a9af366e08fc3a1771e5ef266208a6947"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548243",
    "user": "https://github.com/LaisRast"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Please have in mind that the check should also work for non-fulldimensional polyhedra (e.g. Simplex).\n\nUnfortunately, git.sagemath is down at the moment, so I don't see your code.",
    "created_at": "2019-07-24T20:47:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548244",
    "user": "https://github.com/kliem"
}
```

<a id='comment:2'></a>Please have in mind that the check should also work for non-fulldimensional polyhedra (e.g. Simplex).
...
```json
{
    "body": "<a id='comment:3'></a>Never mind.",
    "created_at": "2019-07-24T20:48:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548245",
    "user": "https://github.com/kliem"
}
```

<a id='comment:3'></a>Never mind.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548246",
    "user": "https://github.com/LaisRast"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Instead of testing whether the matrix is square, I would check first thing that `n_facets` equals `n_vertices` (incidence matrix does take some time).\n\nThe approach seems somewhat hacky. How about taking the `vertex_facet_graph` and checking that it is isomorphic to its reverse (I assume that isomorphism does distinct directions, didn't ckeck).",
    "created_at": "2019-07-24T22:03:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548247",
    "user": "https://github.com/kliem"
}
```

<a id='comment:5'></a>Instead of testing whether the matrix is square, I would check first thing that `n_facets` equals `n_vertices` (incidence matrix does take some time).
...
```json
{
    "body": "<a id='comment:6'></a>> The approach seems somewhat hacky. How about taking the `vertex_facet_graph` and checking that it is isomorphic to its reverse (I assume that isomorphism does distinct directions, didn't ckeck).\n\n\nI'd rather qualify this as a clever algorithm. This gets rid of automorphisms of the polytope directly while you will have to deal with them in the oriented graphs. The complexity should be exactly the same and most likely equivalent, because adding the special vertex is equivalent to specify the orientation.\n\nNow, I do not know how isomorphism of graphs is preparsing things, but most likely there is something dealing with bipartite graphs.",
    "created_at": "2019-07-25T07:39:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548248",
    "user": "https://github.com/jplab"
}
```

<a id='comment:6'></a>> The approach seems somewhat hacky. How about taking the `vertex_facet_graph` and checking that it is isomorphic to its reverse (I assume that isomorphism does distinct directions, didn't ckeck).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548249",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548250",
    "user": "https://github.com/LaisRast"
}
```
...
```json
{
    "body": "Changing commit from \"28bf771a9af366e08fc3a1771e5ef266208a6947\" to \"11041eb15ace7bc597935488a535f951731eedc6\"",
    "created_at": "2019-07-25T09:44:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548251",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "28bf771a9af366e08fc3a1771e5ef266208a6947" to "11041eb15ace7bc597935488a535f951731eedc6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548252",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>This looks good to me now (remember that I haven't tested this on a computer).",
    "created_at": "2019-07-25T11:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548253",
    "user": "https://github.com/kliem"
}
```

<a id='comment:10'></a>This looks good to me now (remember that I haven't tested this on a computer).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548254",
...
```json
{
    "body": "<a id='comment:11'></a>The pyflakes plugin complains. But apparently it only complains about lines that aren't touched by the patch and thus shouldn't be a problem for this ticket.\n\nTests on a patchbot pass. And the code and docs look good to me. I believe this can constitute a positive review.",
    "created_at": "2019-07-25T16:38:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548255",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>The pyflakes plugin complains. But apparently it only complains about lines that aren't touched by the patch and thus shouldn't be a problem for this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548256",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Shouldn't this method be called `is_combinatorially_self_dual` to distinguish the tested property from geometric self duality (self polarity)?",
    "created_at": "2019-07-26T16:13:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548257",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:12'></a>Shouldn't this method be called `is_combinatorially_self_dual` to distinguish the tested property from geometric self duality (self polarity)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548258",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548259",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548260",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>> Btw, potentially there is also the method `is_combinatorially_dual(self, other)`. Here, specifying 'combinatorially' is even more important. One should name this ticket's method consistently. (Even though checking for self polarity is probably not worth a method.)\n\n\nA compact polyhedron is always dual to another one using polarity. So this name is incomplete, the self is important there.",
    "created_at": "2019-07-28T13:55:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548261",
    "user": "https://github.com/jplab"
}
```

<a id='comment:16'></a>> Btw, potentially there is also the method `is_combinatorially_dual(self, other)`. Here, specifying 'combinatorially' is even more important. One should name this ticket's method consistently. (Even though checking for self polarity is probably not worth a method.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548262",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548263",
    "user": "https://github.com/LaisRast"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548265",
...
```json
{
    "body": "Changing branch from \"public/28256\" to \"11041eb15ace7bc597935488a535f951731eedc6\"",
    "created_at": "2019-07-29T21:54:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28256#issuecomment-548266",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/28256" to "11041eb15ace7bc597935488a535f951731eedc6"
