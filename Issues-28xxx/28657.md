...
```json
{
    "body": "<a id='comment:2'></a>\nHere is an attempt. It probably needs work, but please test it.\n\n---\nNew commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[2d00060](https://git.sagemath.org/sage.git/commit?id=2d00060bd4f4b5a85df580ed4c08ebc11f282898)|`trac 28657: build Sage when there is no 'python' present.`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[8905fe6](https://git.sagemath.org/sage.git/commit/?id=8905fe639777a452c9cfa4d53b14267a07b1f7bb)|`trac 28657: build Sage when there is no 'python' present.`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[d4835fc](https://git.sagemath.org/sage.git/commit/?id=d4835fc864600883bb7a710f4196495d9a07aab8)|`trac 28657: build Sage when there is no 'python' present.`|\n|[f04cb28](https://git.sagemath.org/sage.git/commit/?id=f04cb2891c6990fe0888f72546518b2e57bba369)|`trac 28657: use sage-python instead of sage-python23 when possible.`|\n|[7a27daa](https://git.sagemath.org/sage.git/commit/?id=7a27daaaac2f1107cd2d7e80b669ad0c35e09d85)|`trac 28657: use sage-python or sage-system-python instead of sage-python23`|",
