...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549876",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549877",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549878",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Sorry for nitpicking, but why are you removing many more digits than implied by the tolerances you are replacing?",
    "created_at": "2019-08-18T12:25:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549879",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:2'></a>Sorry for nitpicking, but why are you removing many more digits than implied by the tolerances you are replacing?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549881",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> Maybe. But we are talking about polynomial roots, and, on top of that, very simple ones. To me it would be the sign of a serious problem if they were not accurate essentially to the last digit.\n\n\nWell the motivation for this ticket is that it's generally *not* accurate to the last digit. That's just an inherent limitation of floating point calculation. For example, on aarch64 I see differences in the 16th significant digit just because of architecture differences.",
    "created_at": "2019-08-18T14:45:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549882",
    "user": "https://github.com/timokau"
}
```

<a id='comment:5'></a>> Maybe. But we are talking about polynomial roots, and, on top of that, very simple ones. To me it would be the sign of a serious problem if they were not accurate essentially to the last digit.
...
```json
{
    "body": "Changing commit from \"22c18a9b771574799c1ee35d37ed99d3be4e09b6\" to \"de9601db303150a0d66c3e3233862919548f8f04\"",
    "created_at": "2019-08-18T16:52:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549884",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "22c18a9b771574799c1ee35d37ed99d3be4e09b6" to "de9601db303150a0d66c3e3233862919548f8f04"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549885",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Fair enough. I've amended the commit to include 14 digits after the point (though I'm not entirely sure `#abs tol 1e-14` is supposed to be digits after the point or total significant digits).",
    "created_at": "2019-08-18T16:55:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549886",
    "user": "https://github.com/timokau"
}
```

<a id='comment:8'></a>Fair enough. I've amended the commit to include 14 digits after the point (though I'm not entirely sure `#abs tol 1e-14` is supposed to be digits after the point or total significant digits).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549887",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Okay so apparently it means the *difference* between the actual result and the one in the test can't exceed 1e-14, which makes sense. So my changes should be correct.",
    "created_at": "2019-08-18T17:00:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549888",
    "user": "https://github.com/timokau"
}
```

<a id='comment:10'></a>Okay so apparently it means the *difference* between the actual result and the one in the test can't exceed 1e-14, which makes sense. So my changes should be correct.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549889",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549890",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Author name should be the actual name, not trac username",
    "created_at": "2019-08-19T22:11:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549891",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>Author name should be the actual name, not trac username
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549892",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549893",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549894",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549895",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28346#event-70797"
}
```
...
```json
{
    "body": "Changing branch from \"u/gh-timokau/polynomial_element_precision\" to \"de9601db303150a0d66c3e3233862919548f8f04\"",
    "created_at": "2019-08-21T22:27:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28346#issuecomment-549896",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/gh-timokau/polynomial_element_precision" to "de9601db303150a0d66c3e3233862919548f8f04"
