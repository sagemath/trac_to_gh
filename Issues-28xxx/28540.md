...
```json
{
    "body": "<a id='comment:5'></a>\nSee #28414 for a situation where the fix from this ticket actually solves a problem.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|\n|[2e0d11e](https://git.sagemath.org/sage.git/commit?id=2e0d11e758f4565b718f4cdf8f957fa6ef6b8d7d)|`Pass unpickling options to pickle.load, default encoding 'latin1'. Accept both str and bytes in mtx_unpickle`|\n|[8c105cd](https://git.sagemath.org/sage.git/commit?id=8c105cdcada53eed019bba4f4d26cf7fe7e72c22)|`Make str_to_bytes/bytes_to_str accept both str and bytes input.`|\n|[c8a0748](https://git.sagemath.org/sage.git/commit?id=c8a074883997bfdd5afde3065c4a33002914999b)|`Add tests for #28444`|\n|[89ac77a](https://git.sagemath.org/sage.git/commit?id=89ac77aa44fd3bab4399791fa72e088a52058a8e)|`Fix keyword for py3-only test`|\n|[3693024](https://git.sagemath.org/sage.git/commit?id=36930248d6df66a94fe8a86d411e9105595eb8e9)|`Fix doc strings in sage.misc.persist`|\n|[f0828ee](https://git.sagemath.org/sage.git/commit?id=f0828eea650db44b6a5fd6c8f16a8382ff82f04a)|`Add a comment regarding the expected data type for an unpickle helper`|\n|[ba41ebe](https://git.sagemath.org/sage.git/commit?id=ba41ebee5b46fb2fb72eae988678ab0579309dc5)|`Fix two typos in a comment`|\n|[4a33e77](https://git.sagemath.org/sage.git/commit?id=4a33e7797f668270f0a60bb95c0c26cfa3400c55)|`Allow names of type bytes, str and unicode in lookup_global`|",
