...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28800#issuecomment-559164",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Macaulay2 does have these problems with Pari, AFAIK. They are thinking of removing Pari from their dependencies all together due to this.",
    "created_at": "2019-11-25T12:18:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28800#issuecomment-559165",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:3'></a>Macaulay2 does have these problems with Pari, AFAIK. They are thinking of removing Pari from their dependencies all together due to this.
...
```json
{
    "body": "<a id='comment:6'></a>one way around this difficulty is to use `spawn`, not `fork`, in `multiprocessing`, something that is available in Python 3.7 and later.\nOne just calls\n\n```python\nmultiprocessing.set_start_method('spawn')\n```\nsomewhere early enough.\n\nThis alone is not enough, one needs to rework various things due to spawn pickling the environment.",
    "created_at": "2020-08-23T10:08:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28800#issuecomment-559168",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:6'></a>one way around this difficulty is to use `spawn`, not `fork`, in `multiprocessing`, something that is available in Python 3.7 and later.
One just calls
...
```json
{
    "body": "<a id='comment:7'></a>Yeah, setting `set_start_method('spawn')` globally would wreak havoc, though might be useful in some careful cases.  I think this specific issue would be better addressed with improvements to how PARI manages its thread-local state.",
    "created_at": "2020-08-31T13:49:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28800#issuecomment-559169",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>Yeah, setting `set_start_method('spawn')` globally would wreak havoc, though might be useful in some careful cases.  I think this specific issue would be better addressed with improvements to how PARI manages its thread-local state.
