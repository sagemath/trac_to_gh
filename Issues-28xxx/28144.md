...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-382990"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-382991"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-382992"
}
```
...
```json
{
    ...
    "title_was": "Sage + TikZ",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-382993"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-382994"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28144",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-382995"
}
```
