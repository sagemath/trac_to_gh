...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-354770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-354771"
}
```
...
```json
{
    ...
    "title_was": "Sage + TikZ",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-354772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-354773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28144",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-354774"
}
```
