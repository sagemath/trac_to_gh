...
```json
{
    "body": "<a id='comment:1'></a>Most excellent! This a feature I wouldn't have thought to add any time soon, so thanks for putting this together. Thanks also for keeping the coding style consistent in the template.\n\nBefore setting this to positive review, I'm curious about the handling of sizes of points. As I recall I divided the size coming from Sage by 100 simply to produce something about the right visual size. Did you remove that factor for pretty much the same reason or is there more to it?\n\nCCing Eric in the event he'd like to comment on the behavior of the new projection.",
    "created_at": "2019-07-08T21:20:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544939",
    "user": "https://github.com/paulmasson"
}
```

<a id='comment:1'></a>Most excellent! This a feature I wouldn't have thought to add any time soon, so thanks for putting this together. Thanks also for keeping the coding style consistent in the template.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544940",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544941",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544942",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544943",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>After looking at the code some more, we don't need to test whether the `projection` value is supported in the JavaScript template, since that's already being done in Python. Please remove that test and warning from the `createCamera()` function.\n\nPlease also indent the second line evaluating the variable `adjust` (currently line 344) at bit more for legibility. Thanks!",
    "created_at": "2019-07-09T21:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544945",
    "user": "https://github.com/paulmasson"
}
```

<a id='comment:3'></a>After looking at the code some more, we don't need to test whether the `projection` value is supported in the JavaScript template, since that's already being done in Python. Please remove that test and warning from the `createCamera()` function.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544946",
    "user": "https://trac.sagemath.org/admin/accounts/users/galois"
}
```
...
```json
{
    "body": "Changing commit from \"a8f67ef5a8669a01ab76e349fcd43f3758be6703\" to \"a65cef683dff2921328833eeb0413fe6912c0305\"",
    "created_at": "2019-07-10T00:11:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544947",
    "user": "https://trac.sagemath.org/admin/accounts/users/galois"
}
```

Changing commit from "a8f67ef5a8669a01ab76e349fcd43f3758be6703" to "a65cef683dff2921328833eeb0413fe6912c0305"
...
```json
{
    "body": "<a id='comment:5'></a>No problem, I've pushed a couple changes that address both of those points, and I did a quick sanity check re-running a few of my plots to make sure everything's still working fine.\n\nReplying to [paulmasson](#comment%3A3):\n> After looking at the code some more, we don't need to test whether the `projection` value is supported in the JavaScript template, since that's already being done in Python. Please remove that test and warning from the `createCamera()` function.\n> \n> Please also indent the second line evaluating the variable `adjust` (currently line 344) at bit more for legibility. Thanks!",
    "created_at": "2019-07-10T00:15:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544948",
    "user": "https://github.com/jcamp0x2a"
}
```

<a id='comment:5'></a>No problem, I've pushed a couple changes that address both of those points, and I did a quick sanity check re-running a few of my plots to make sure everything's still working fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544950",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544951",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28130#event-69816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544952",
...
```json
{
    "body": "Changing branch from \"u/galois/mrs/28/threejs-orthographic\" to \"a65cef683dff2921328833eeb0413fe6912c0305\"",
    "created_at": "2019-07-11T18:54:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544953",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/galois/mrs/28/threejs-orthographic" to "a65cef683dff2921328833eeb0413fe6912c0305"
...
```json
{
    "body": "Changing commit from \"a65cef683dff2921328833eeb0413fe6912c0305\" to \"\"",
    "created_at": "2019-07-11T19:46:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28130#issuecomment-544955",
    "user": "https://github.com/embray"
}
```

Changing commit from "a65cef683dff2921328833eeb0413fe6912c0305" to ""
