...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits added to merge request.  I updated the commit SHA-1.  New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[f8c6f68](https://git.sagemath.org/sage.git/commit?id=f8c6f688754929a982a4772ffdbdeca0cb7febbd)|`Fix some whitespace problems`|\n|[a65cef6](https://git.sagemath.org/sage.git/commit?id=a65cef683dff2921328833eeb0413fe6912c0305)|`Remove redundant projection check and warning from template`|",
