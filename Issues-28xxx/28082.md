...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543986",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543988",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543989",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Replying to [fbissey](#comment%3A1):\n> there may be another bug on track about C++ support in distutils.\n\n\nIndeed, there is #7028. See also https://bugs.python.org/issue1222585. Apparently, Gentoo includes that patch.\n\nThere are discussions about this starting atticket: ticket:12426#comment:114#comment:12426 andticket: ticket:23341#comment:8#comment:23341.",
    "created_at": "2019-07-01T17:26:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543990",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543991",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The problem is not that `gcc` is used instead of `g++`. The problem is that `-std=c++11` is missing from the compiler flags. That looks like an upstream bug.",
    "created_at": "2019-07-02T21:11:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543992",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>The problem is not that `gcc` is used instead of `g++`. The problem is that `-std=c++11` is missing from the compiler flags. That looks like an upstream bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543993",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543994",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>But if `giacpy_sage` was using CXX instead of CC it would automatically get that flag. That being said, yes that flag should be added upstream. But I am not sure what happens when you use `gcc -std=c++11`, I think you'll get a message that this is a g++ option not a gcc one.",
    "created_at": "2019-07-02T21:14:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543995",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>But if `giacpy_sage` was using CXX instead of CC it would automatically get that flag. That being said, yes that flag should be added upstream. But I am not sure what happens when you use `gcc -std=c++11`, I think you'll get a message that this is a g++ option not a gcc one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543996",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543997",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I just had a look and `pplpy` exhibit the same behavior. g++ is only used when linking. gcc is used for compilation. `pplpy` doesn't seem to be hit by trouble coming from the c++11 standard and is successfully compiled.",
    "created_at": "2019-07-03T08:29:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-543999",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:12'></a>I just had a look and `pplpy` exhibit the same behavior. g++ is only used when linking. gcc is used for compilation. `pplpy` doesn't seem to be hit by trouble coming from the c++11 standard and is successfully compiled.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544000",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544002",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Actually, `conf[\"CXXFLAGS\"]` is defined within `setup.py` of giacpy_sage, so it does not seem like environment variables have an effect on this. In fact, I suppose it would be preferable to set this within `setup.py`, since then giacpy_sage can be installed like any package, i.e. independently from `spkg-install`. This works for me:\n\n```diff\n--- a/setup.py\n+++ b/setup.py\n@@ -9,7 +9,7 @@ from distutils.extension import Extension\n from Cython.Build import cythonize\n\n\n-conf = {'CXXFLAGS' : [], 'LDFLAGS' : []}\n+conf = {'CXXFLAGS' : ['-std=c++11'], 'LDFLAGS' : []}\n\n libraries=['giac']\n library_dirs=[SAGE_LOCAL+'/lib']\n```",
    "created_at": "2019-07-19T22:27:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544003",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:16'></a>Actually, `conf["CXXFLAGS"]` is defined within `setup.py` of giacpy_sage, so it does not seem like environment variables have an effect on this. In fact, I suppose it would be preferable to set this within `setup.py`, since then giacpy_sage can be installed like any package, i.e. independently from `spkg-install`. This works for me:
...
```json
{
    "body": "<a id='comment:17'></a>looks like an upstream bug, one should not ignore CXXFLAGS.",
    "created_at": "2019-08-02T09:59:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544004",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:17'></a>looks like an upstream bug, one should not ignore CXXFLAGS.
...
```json
{
    "body": "<a id='comment:18'></a>I am not completely sure about this. Does `conf` override anything mentioned in it or is it just default if they are not defined?",
    "created_at": "2019-08-02T10:02:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544005",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:18'></a>I am not completely sure about this. Does `conf` override anything mentioned in it or is it just default if they are not defined?
...
```json
{
    "body": "<a id='comment:19'></a>Looks to me as if it is getting my FLAGS from the compilation lines I am seeing.",
    "created_at": "2019-08-02T10:07:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544006",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:19'></a>Looks to me as if it is getting my FLAGS from the compilation lines I am seeing.
...
```json
{
    "body": "Changing author from \"\" to \"frederichan\"",
    "created_at": "2019-08-02T15:48:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544008",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

Changing author from "" to "frederichan"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544009",
    "user": "https://github.com/frederichan-IMJPRG"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544010",
    "user": "https://github.com/frederichan-IMJPRG"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"public/trac28082\"",
    "created_at": "2019-08-02T15:48:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544011",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

Changing branch from "" to "public/trac28082"
...
```json
{
    "body": "Changing commit from \"1537fe511be36572f9faf097a5f203ab5b829253\" to \"1e9ce5eba2453eb2f42f9f85150baf5f23249497\"",
    "created_at": "2019-08-02T15:52:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544012",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "1537fe511be36572f9faf097a5f203ab5b829253" to "1e9ce5eba2453eb2f42f9f85150baf5f23249497"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544013",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544014",
    "user": "https://github.com/frederichan-IMJPRG"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544015",
    "user": "https://github.com/frederichan-IMJPRG"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>a proper fix should not hardcode the value of -std= parameter. Rather it should infer it from what it is for giac, or you might create an ABI mismatch.",
    "created_at": "2019-08-02T16:00:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544016",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:24'></a>a proper fix should not hardcode the value of -std= parameter. Rather it should infer it from what it is for giac, or you might create an ABI mismatch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544018",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544019",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544020",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Dima and I have had another look at this. The underlying problem seems to be that Sage sets `CXX` to something like `g++ -std=gnu++11`, but distutils invokes a C compiler which is just `gcc`, so the `-std=gnu++11` flag is not passed in the compile command.\n\nSolving this by setting `extra_compile_args` to `-std=c++11` is correct in the sense that this is also what is done elsewhere in Sage to overcome this problem, for example in `sage/libs/polybori/decl.pxd` and `sage/libs/pynac/pynac.pxd`. With the new giacpy_sage version, everything seems to work, so I am setting this to positive.",
    "created_at": "2019-10-07T03:28:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544021",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:27'></a>Dima and I have had another look at this. The underlying problem seems to be that Sage sets `CXX` to something like `g++ -std=gnu++11`, but distutils invokes a C compiler which is just `gcc`, so the `-std=gnu++11` flag is not passed in the compile command.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544022",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544023",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544024",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing branch from \"public/trac28082\" to \"1e9ce5eba2453eb2f42f9f85150baf5f23249497\"",
    "created_at": "2019-10-10T21:42:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544025",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/trac28082" to "1e9ce5eba2453eb2f42f9f85150baf5f23249497"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28082#issuecomment-544026",
    "user": "https://github.com/vbraun"
}
```
