...
```json
{
    "body": "I was intending to do that. Nevermind, I am happy you think the idea is worthwhile.",
...
```json
{
    "body": "That's curious to say the least. I thought you needed a system python to start the sage build from scratch?\n\nAlso can you share the segfault? There may be interesting clues in there.",
...
```json
{
    "body": "Needs rebasing with 9.0.beta5. Just when I was ready to test :(",
...
```json
{
    "body": "The segfaulting behavior is most curious. From what you say it sounds like some memory context may be at play. Much more complex than just this ticket.",
...
```json
{
    "body": "Basic testing with python2 and python3 OK. I believe the segfault mentioned here is unrelated and may deserve wider scrutiny on sage-devel because it is definitely on the weirder side of things.",
    "created_at": "2019-11-12T01:05:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28709",
    "type": "issue_comment",
...
```json
{
    "body": "I agree it's weird, but since it's on a virtual machine that's a little flaky already, I don't know how seriously to take it.",
