...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[6b64d68](https://git.sagemath.org/sage.git/commit/?id=6b64d6823de85fbc44032c8660cce3373e2f00ef)|`correct AC_CHECK/PATH_PROG call, refactor`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[03ded4b](https://git.sagemath.org/sage.git/commit/?id=03ded4b7dfe4eaa5091aee8b10a27519ef3a0cb0)|`add forgotten test (arrgh!)`|",
