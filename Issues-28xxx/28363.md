...
```json
{
    "body": "<a id='comment:2'></a>python has already been added to `build/pkgs/{debian,arch,conda,fedora}.txt` in #29053.\n\n#26964 will generate the command lines in the manual.",
...
<a id='comment:2'></a>python has already been added to `build/pkgs/{debian,arch,conda,fedora}.txt` in #29053.
...
```json
{
    "body": "<a id='comment:3'></a>Outdated, can be closed.",
...
<a id='comment:3'></a>Outdated, can be closed.
