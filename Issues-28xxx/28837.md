...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396121"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396124"
}
```
...
```json
{
    "body": "Changed keywords from **flow polytopes** to **flow polytopes, multi-digraphs, digraphs, linear programming, combinatorial optimization**",
    "created_at": "2019-12-03T14:11:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449790",
    "user": "https://github.com/jonasfrede"
}
```

Changed keywords from **flow polytopes** to **flow polytopes, multi-digraphs, digraphs, linear programming, combinatorial optimization**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449791",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449792",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449793",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449794",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449795",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449796",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449797",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449798",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449799",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449801",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449802",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449803",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449804",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449805",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449806",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-449807",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-396133"
}
```
