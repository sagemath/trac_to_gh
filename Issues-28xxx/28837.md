...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-452663",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28837#issuecomment-452664",
    "user": "https://github.com/jonasfrede"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-377898"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-377899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-377900"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28837",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28837#event-377901"
}
```
