...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551801",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551802",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551803",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551804",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551805",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551806",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551807",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551808",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551809",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551810",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>\nReplying to [dimpase](#comment%3A7):\n> I don't understand how this is \"a developer thing\". For actually carrying out computations orderings are essential, and for different tasks the user might want to choose a different order. So it should not be hidden from the user.\n\n\nNote that `_singular_ringorder_column` is an attribute of `TermOrder`.  A `TermOrder` object is to specify ordering of monomials of a multi-variate *polynomial ring* of Sage. For a (non-developer) user of `TermOrder`, an attribute that is concerned with ordering of monomials of *free modules over the underlying Singular ring* is irrelevant.\n\nIf someday we add a new class `ModuleTermOrder` for free modules over polynomial rings, then it would internally set `_singular_ringorder_column` of the `TermOrder` of the polynomial ring. Then a user is just concerned with the `ModuleTermOrder` object, but not directly with `_singular_ringorder_`column`.",
    "created_at": "2019-08-28T07:43:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551811",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551812",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551813",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551814",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551815",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551816",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551817",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551818",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551819",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551820",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551821",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28389#issuecomment-551822",
    "user": "https://github.com/vbraun"
}
```
