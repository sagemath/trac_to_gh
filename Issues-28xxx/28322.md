...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-396373",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>still the exact same issue with 9.0.rc1 (and every time I try to build zn_poly on this machine)\n\nso I \"git rm\" the patch, build zn_poly, and then \"git stash\" to restore the patch",
    "created_at": "2020-01-01T12:34:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-396374",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>still the exact same issue with 9.0.rc1 (and every time I try to build zn_poly on this machine)
...
```json
{
    "body": "<a id='comment:4'></a>Still can't reproduce.  Something is weird on your system in how it's ordering files.",
    "created_at": "2020-01-06T15:07:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-396375",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>Still can't reproduce.  Something is weird on your system in how it's ordering files.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-396376",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This should be obviated by #28959.",
    "created_at": "2020-01-06T15:16:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28322#issuecomment-396377",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>This should be obviated by #28959.
