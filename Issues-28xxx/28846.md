...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429854",
    "user": "https://github.com/JeremyMarrez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429855",
    "user": "https://github.com/JeremyMarrez"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [AubryMarrezValibouze_Fuzzy_Ang_2017_12_18_HAL.pdf](tarball://root/attachments/some-uuid/ticket28846/AubryMarrezValibouze_Fuzzy_Ang_2017_12_18_HAL.pdf) by @JeremyMarrez created at 2019-12-05 15:40:57",
    "created_at": "2019-12-05T15:40:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429856",
    "user": "https://github.com/JeremyMarrez"
}
```

<a id='comment:1'></a>Attachment [AubryMarrezValibouze_Fuzzy_Ang_2017_12_18_HAL.pdf](tarball://root/attachments/some-uuid/ticket28846/AubryMarrezValibouze_Fuzzy_Ang_2017_12_18_HAL.pdf) by @JeremyMarrez created at 2019-12-05 15:40:57
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429857",
    "user": "https://github.com/JeremyMarrez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429858",
    "user": "https://github.com/JeremyMarrez"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429859",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72941"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429860",
...
```json
{
    "body": "<a id='comment:5'></a>there's no branch",
    "created_at": "2020-08-27T04:11:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429861",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>there's no branch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429862",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72943"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429863",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72945"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72946"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28846#issuecomment-429864",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72947"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72948"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72949"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72950"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72951"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72952"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72953"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28846#event-72954"
}
```
