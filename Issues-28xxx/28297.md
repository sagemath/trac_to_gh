...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[2c361d6](https://git.sagemath.org/sage.git/commit?id=2c361d60beff36e1bb3ef7530be72a100818abd7)|`trivial optimization in addition of num field elts`|",
    "created_at": "2019-07-31T07:33:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28297",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[c14daea](https://git.sagemath.org/sage.git/commit/?id=c14daead9d7c25722c96c9b08476e36b5d8efdd5)|`trivial opts in basic arithmetic with number field elements`|",
    "created_at": "2019-07-31T16:02:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28297",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[8f93f0a](https://git.sagemath.org/sage.git/commit/?id=8f93f0a0101e22038333519c3d2c453e6cce7151)|`trivial opts in basic arithmetic with number field elements`|",
    "created_at": "2019-08-18T11:25:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28297",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[c71c660](https://git.sagemath.org/sage.git/commit/?id=c71c660a3e5c89ea081ac8161a4ee8cb05bc6e79)|`trivial opts in basic arithmetic with number field elements`|",
