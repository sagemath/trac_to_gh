...
```json
{
    "body": "<a id='comment:5'></a>Perhaps it would be simpler to keep the python2 and python3 versions as separate pkgs? (build/pkgs/sphinx vs build/pkgs/python2-sphinx)",
    "created_at": "2019-07-15T06:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546513",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:5'></a>Perhaps it would be simpler to keep the python2 and python3 versions as separate pkgs? (build/pkgs/sphinx vs build/pkgs/python2-sphinx)
...
```json
{
    "body": "<a id='comment:7'></a>That follows some model of binary distros, and I am OK with that. Implementation will have some kinks as it relies on the relationship between the folder name, the name of the package for dependencies and the name of the source tarball. I would say the latest is the hardest bit to implement - dependencies not so much, it is just tedious work.",
    "created_at": "2019-07-15T07:48:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546515",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:7'></a>That follows some model of binary distros, and I am OK with that. Implementation will have some kinks as it relies on the relationship between the folder name, the name of the package for dependencies and the name of the source tarball. I would say the latest is the hardest bit to implement - dependencies not so much, it is just tedious work.
...
```json
{
    "body": "Changing branch from \"\" to \"public/ticket/28190\"",
    "created_at": "2019-07-17T12:27:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546517",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "" to "public/ticket/28190"
...
```json
{
    "body": "<a id='comment:9'></a>as a kind of provocation, here is a sketch of tentative..\n\n---\nNew commits:",
    "created_at": "2019-07-17T12:27:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546518",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:9'></a>as a kind of provocation, here is a sketch of tentative..
...
```json
{
    "body": "Changing commit from \"\" to \"ecb7133e0357c8693c63efad85998df2500b713d\"",
    "created_at": "2019-07-17T12:27:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546519",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "" to "ecb7133e0357c8693c63efad85998df2500b713d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546520",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546521",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546522",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>As mentioned by Samuel on the mailing list, there is a distinct situation where we might want to upgrade packages to Python3 before the transition py2 -> py3: the jupyter notebook. It is not exactly covered by the ticket description.\n\nMore concretely, we could\n- python3 install the modules: `jupyter_core`, `jupyter_client`, `traitlets`, `decorator`, `enum34`, `pyzmq`, `dateutil`\n- remove python2 installation of `jupyter_core` and `jupyter_client` (and dead dependencies)\n- run the jupyter notebook under python3\n\nQuestion: would that really be useful?",
    "created_at": "2019-07-17T13:40:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546523",
    "user": "https://github.com/videlec"
}
```

<a id='comment:13'></a>As mentioned by Samuel on the mailing list, there is a distinct situation where we might want to upgrade packages to Python3 before the transition py2 -> py3: the jupyter notebook. It is not exactly covered by the ticket description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546524",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546525",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546526",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28190#event-70059"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I don't think there should be a rush to upgrade to Python 3.8.  With the first Python 3-based release just out, let's give it a little breathing room for things to shake out, as I'm sure it will still be a rocky transition for some users at first (hopefully not too much so though).",
    "created_at": "2020-01-06T13:26:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546528",
    "user": "https://github.com/embray"
}
```

<a id='comment:18'></a>I don't think there should be a rush to upgrade to Python 3.8.  With the first Python 3-based release just out, let's give it a little breathing room for things to shake out, as I'm sure it will still be a rocky transition for some users at first (hopefully not too much so though).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546529",
...
```json
{
    "body": "<a id='comment:19'></a>It seems we are dropping Python2 support after 9.1. See #29141 for the reference to the discussion on sage-devel.\n\nI propose to close this ticket, in favor of #28000: Remove python 2 support",
    "created_at": "2020-03-31T14:48:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546530",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:19'></a>It seems we are dropping Python2 support after 9.1. See #29141 for the reference to the discussion on sage-devel.
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28190#event-70060"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28190#event-70061"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I agree, let us move forward.",
    "created_at": "2020-03-31T18:05:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546531",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:20'></a>I agree, let us move forward.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28190#event-70062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28190#issuecomment-546532",
    "user": "https://github.com/fchapoton"
}
```
