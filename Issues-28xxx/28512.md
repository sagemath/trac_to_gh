...
```json
{
    "body": "maybe Sage could provide a method to save polynomials in a file, so that we can read them back efficiently (as balanced expressions, or dicts, ...)",
...
```json
{
    "body": "Is this a regression, or can this be reproduced in Sage 8.8?  Otherwise it should probably be postponed until the next milestone.",
...
```json
{
    "body": "as indicated in the description, this is with Sage 8.8. It is probably there since the beginning of Sage, which probably means only few people play with large polynomials within Sage...",
...
```json
{
    "body": "great! I confirm the nice speedup. A minor typo: \"look\" should be \"loop\".",
...
```json
{
    "body": "> So my proposal would be to go with the code on this ticket. \n\n\nagreed. I give a positive review.",
    "created_at": "2019-10-03T08:24:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28512",
    "type": "issue_comment",
