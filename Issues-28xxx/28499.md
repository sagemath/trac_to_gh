...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372962"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447176",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447177",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372966"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447178",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447179",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447180",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447181",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447182",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447183",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447184",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447185",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372968"
}
```
...
```json
{
    "body": "Changed keywords from **** to **py3**",
    "created_at": "2019-09-15T13:33:27Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447186",
    "user": "https://github.com/videlec"
}
```

Changed keywords from **** to **py3**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372969"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447187",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447188",
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372970"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372971"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447189",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28499#issuecomment-447190",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372972"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28499",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28499#event-372973"
}
```
