...
```json
{
    "body": "<a id='comment:3'></a>\nNot a very elegant fix but I think that's just the limitations of SPKGs. So, this looks good to me. I cannot test it because I have no Python 3 [SageMath](../wikis/SageMath) installed. If you're confident that this works, feel free to set this to positive review.",
...
```json
{
    "body": "<a id='comment:5'></a>\nOr wait for #28041 and [GitLab](../wikis/GitLab) CI will test it automatically.",
