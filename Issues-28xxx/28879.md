...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[e5c91db](https://git.sagemath.org/sage.git/commit/?id=e5c91dbb4d313d43f05cf3d33fc1758ac089613d)|`update pkgconfig to v1.5.1. See trac #28883`|\n|[1720b38](https://git.sagemath.org/sage.git/commit/?id=1720b38cdca1aa6c436a4b579545c227d3a313fc)|`a bare minumim openblas config`|\n|[925266b](https://git.sagemath.org/sage.git/commit/?id=925266bfb2e8446e4fadd09eea86d7c04534eed6)|`use openblas.pc for blas and lapack, don't require atlas is to be used`|\n|[b89df80](https://git.sagemath.org/sage.git/commit/?id=b89df80e245766884e59d78accfe809e240ad2ba)|`move blas handling to build/pkgs/`|\n|[6341576](https://git.sagemath.org/sage.git/commit/?id=634157628ac3f7292e7065eae462bb6b80db7aed)|`create cblas.pc link, too, not only blas and lapack`|\n|[3a95431](https://git.sagemath.org/sage.git/commit/?id=3a95431674d81d946926d0553d0f70b0d77654a4)|`spkg-configure for gsl`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[137c972](https://git.sagemath.org/sage.git/commit/?id=137c97252c15455b1d0e8c8d81929b4a21e722b2)|`typo in variable name`|",
    "created_at": "2019-12-14T23:21:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28879",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[2bc86cd](https://git.sagemath.org/sage.git/commit/?id=2bc86cd701014b1bdcc0c7d5055c5d323962fbd2)|`install and modify gsl.pc to use cblas`|",
    "created_at": "2019-12-20T18:38:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28879",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:36'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[c13be38](https://git.sagemath.org/sage.git/commit/?id=c13be388d0e6ce1dbd719d64a7a71ff2f87cc82e)|`add extension '' to -i in sed calls`|",
    "created_at": "2019-12-21T01:10:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28879",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[310ba06](https://git.sagemath.org/sage.git/commit/?id=310ba06411ee413379c1ce3ca75b595ac83e8b0b)|`get SED into config.status`|",
...
```json
{
    "body": "<a id='comment:45'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[f9d6966](https://git.sagemath.org/sage.git/commit/?id=f9d6966f63a12991b81dce40ba69887cd9dacaa3)|`get rid of -i option of sed`|",
    "created_at": "2019-12-21T15:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28879",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[9d9e046](https://git.sagemath.org/sage.git/commit/?id=9d9e0465310b67352105644e7e26eabb2684c84b)|`fix a crucial typo in edited gsl.pc`|",
...
```json
{
    "body": "<a id='comment:53'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[c031c9e](https://git.sagemath.org/sage.git/commit/?id=c031c9ea33b2e6210d571b6939c5faf2e0ed4f84)|`use openblas.pc for blas and lapack, don't require atlas is to be used`|\n|[b49f79e](https://git.sagemath.org/sage.git/commit/?id=b49f79eca2bde8ce3ce134dbdc7f01172bd9293c)|`move blas handling to build/pkgs/`|\n|[81bf522](https://git.sagemath.org/sage.git/commit/?id=81bf522a5a417e236f9b9ee4f05256126b5b47cb)|`create cblas.pc link, too, not only blas and lapack`|\n|[244f954](https://git.sagemath.org/sage.git/commit/?id=244f9545e970dda46f609434b658d02c8fb2573b)|`spkg-configure for gsl`|\n|[efd642f](https://git.sagemath.org/sage.git/commit/?id=efd642f346bbfb3eb8f1c8ca468b0293add4f8c1)|`typo in variable name`|\n|[641e3fa](https://git.sagemath.org/sage.git/commit/?id=641e3fae1fa51e8b25c025d2ab1c37f13f4cfee6)|`install and modify gsl.pc to use cblas`|\n|[51bc622](https://git.sagemath.org/sage.git/commit/?id=51bc6229a1d89c7d82ddad4bbf4cc8709f7ad9f4)|`add extension '' to -i in sed calls`|\n|[13a5434](https://git.sagemath.org/sage.git/commit/?id=13a54341d819e383bd0de58b1c3427fb50e06a09)|`get SED into config.status`|\n|[ac32b13](https://git.sagemath.org/sage.git/commit/?id=ac32b133c2f86798f3ed18d709a8609147b07119)|`get rid of -i option of sed`|\n|[a180599](https://git.sagemath.org/sage.git/commit/?id=a18059933c6b6ecfe4e98a7c8e1ca6de3dc223c8)|`fix a crucial typo in edited gsl.pc`|",
