...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28889#issuecomment-453853",
    "user": "https://github.com/maltekliemann"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28889#issuecomment-453854",
    "user": "https://github.com/maltekliemann"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28889#event-378665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28889#event-378666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28889#event-378667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28889",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28889#event-378668"
}
```
