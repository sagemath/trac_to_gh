...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388737"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388740"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441481",
    "user": "https://github.com/nheir"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441482",
    "user": "https://github.com/nheir"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441483",
    "user": "https://github.com/nheir"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441484",
    "user": "https://github.com/nheir"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388741"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441485",
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388742"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441486",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388744"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388747"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441487",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441488",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441489",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28326#event-388751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28326#issuecomment-441490",
    "user": "https://github.com/vbraun"
}
```
