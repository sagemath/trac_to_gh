...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28433#issuecomment-447297",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28433#issuecomment-447298",
    "user": "https://trac.sagemath.org/admin/accounts/users/Dicolevrai"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-255995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28433",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-255996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28433#issuecomment-447299",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-255997"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-255998"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-255999"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-256000"
}
```
