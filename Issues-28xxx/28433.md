...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-371967"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-371968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28433#issuecomment-445896",
    "user": "https://github.com/sagetrac-Dicolevrai"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-371969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-371970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28433#issuecomment-445897",
    "user": "https://github.com/fchapoton"
}
```
