...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28433#issuecomment-445683",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28433#issuecomment-445684",
    "user": "https://trac.sagemath.org/admin/accounts/users/Dicolevrai"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-251577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28433",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-251578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28433#issuecomment-445685",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-251579"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-251580"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28433#event-251581"
}
```
