...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28882#event-378515"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28882#event-378516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28882#event-378517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28882#event-378518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28882#issuecomment-453704",
    "user": "https://github.com/SagnikDey92"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28882#issuecomment-453705",
    "user": "https://github.com/vbraun"
}
```
