...
```json
{
    "body": "<a id='comment:2'></a>\nThis probably needs to be cleaned up a lot.\nIs it going in a good direction?\nOn my side, all tests in graphs seem to succeed.\n\n---\nNew commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[47a3897](https://git.sagemath.org/sage.git/commit?id=47a3897ead68a87329f38e729508462af5472392)|`moved duplicate of sparse graph into the cgraph structure`|",
    "created_at": "2019-12-21T00:50:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28904",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[7d70aaf](https://git.sagemath.org/sage.git/commit/?id=7d70aafae5b56c1d440256bf4a1ed63af43291a0)|`make class final`|",
    "created_at": "2019-12-21T10:32:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28904",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nNew commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[d72d0ab](https://git.sagemath.org/sage.git/commit?id=d72d0ab78713a9eb349b282d2e9cfdf712c9debe)|`moved duplicate of sparse graph into the cgraph structure`|\n|[64c9493](https://git.sagemath.org/sage.git/commit?id=64c949321b61352f991bca2aefdfb59732898d55)|`make class final`|",
    "created_at": "2020-01-07T19:30:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28904",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[81e99e6](https://git.sagemath.org/sage.git/commit/?id=81e99e641b7ea36d16dcdd30dd6db9e01bb35d1e)|`lots of small improvements`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[f4423f0](https://git.sagemath.org/sage.git/commit/?id=f4423f08ba37e8d5478f1564f574b8bb64a212ba)|`small optimizations`|",
    "created_at": "2020-01-07T21:26:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28904",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[545eeaf](https://git.sagemath.org/sage.git/commit/?id=545eeaf0ec04c8f5a470802030c7c9d3840c4425)|`replaced self._cg by the correct object to avoid type casting warnings`|\n|[4af81b4](https://git.sagemath.org/sage.git/commit/?id=4af81b4339f574584e3f86a49cb597cae9002741)|`small improvements in `del_arc_...``|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[bfd25a9](https://git.sagemath.org/sage.git/commit/?id=bfd25a908e6e13da8280b98794424669c291e1b5)|`removed attribute _cg_rev from CGraphBackend`|",
    "created_at": "2020-01-14T08:21:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28904",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nNew commits:\n|                                                                                                                                          |                                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[fd1d8de](https://git.sagemath.org/sage.git/commit?id=fd1d8deea5f9c2fc22a4029b94eb336af531e90a)|`Merge branch 'public/28904-reb' of git://trac.sagemath.org/sage into public/28904-reb2`|\n|[bb68006](https://git.sagemath.org/sage.git/commit?id=bb6800647355b586e4c821a7273312297cae603a)|`more consistent INPUT blocks`|\n|[a46e717](https://git.sagemath.org/sage.git/commit?id=a46e717377c1cd020b5bda37922cf8ff42e914a6)|`method `is_directed` and remove unused list l`|",
    "created_at": "2020-08-12T10:19:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28904",
    "type": "issue_comment",
