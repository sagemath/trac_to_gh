...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336008"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336015"
}
```
...
```json
{
    "body": "<a id='comment:23'>**Comment 23:**</a>\n**Attachment:** [threejs-r100.tar.gz.gz](https://github.com/sagemath/sage/files/ticket28007/threejs-r100.tar.gz.gz)",
    "created_at": "2019-06-18T19:55:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28007",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336017"
}
```
...
```json
{
    "body": "<a id='comment:29'>**Comment 29:**</a>\n**Attachment:** [threejs-r105.tar.gz.gz](https://github.com/sagemath/sage/files/ticket28007/threejs-r105.tar.gz.gz)\n\nNot a problem, dealing with backwards incompatibility is always annoying. Update re-added.\n\n---\n**New commits:**\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/4a69f3bacfbc7c0864ab4097080773bfe6590422\">4a69f3b</a></td><td><code>Update threejs to r105</code></td></tr></table>\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336019"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336020"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28007",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28007#event-336023"
}
```
