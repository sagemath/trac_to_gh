...
```json
{
    "body": "<a id='comment:4'></a>\nIs there some other way we can work around the [GitHub](../wikis/GitHub) Actions problem? Afaik it's considered bad (though common) practice to run processes inside containers as root.",
