...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423852",
    "user": "https://github.com/rburing"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>> All the questions were rhetorical. In my experience (and in the posted threads), the user doesn't know, because it isn't clear. Sage would be less confusing without this syntax (in its current form).\n\n\nSo, is this ticket suggesting to remove the syntax? If so, I'm not convinced a ticket is the right place to have such a discussion.\n\nDo you realize how much user code it would break? Maybe you should lay out your plan more clearly on sage-devel.",
    "created_at": "2019-08-30T22:39:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423855",
    "user": "https://github.com/defeo"
}
```

<a id='comment:4'></a>> All the questions were rhetorical. In my experience (and in the posted threads), the user doesn't know, because it isn't clear. Sage would be less confusing without this syntax (in its current form).
...
```json
{
    "body": "<a id='comment:6'></a>> Note that callable symbolic expressions serve a very definite purpose and are therefore not going away. The preparse trick of defining them `f(x)=...` is magic but incredibly useful for giving compact illustrations in educational settings, and that syntax doesn't seem to be a source for confusion anyway (other than that people don't get much of a cue that this is not a python built-in feature -- but letting people look at `preparse(\"...\")` quickly illustrates what's going on.\n\n\nThanks for a very well-organized resume of the issues at stake, Nils.",
    "created_at": "2019-09-01T02:24:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423857",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>> Note that callable symbolic expressions serve a very definite purpose and are therefore not going away. The preparse trick of defining them `f(x)=...` is magic but incredibly useful for giving compact illustrations in educational settings, and that syntax doesn't seem to be a source for confusion anyway (other than that people don't get much of a cue that this is not a python built-in feature -- but letting people look at `preparse("...")` quickly illustrates what's going on.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423858",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423860",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71140"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423861",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71141"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71142"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71143"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71144"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71145"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423862",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Suggestion: make this a meta-ticket and track each item\nin its own ticket.\n\n9. Derivative confusion.\n\n```\nsage: f(t) = (t, t^2, t^3)\n\nsage: f\nt |--> (t, t^2, t^3)\nsage: f(t)\n(t, t^2, t^3)\n\nsage: f.parent()\nVector space of dimension 3 over Callable function ring with argument t\nsage: f(t).parent()\nVector space of dimension 3 over Symbolic Ring\n\nsage: f1 = f(t).derivative(t)\nsage: f1\n(1, 2*t, 3*t^2)\nsage: f1.parent()\nVector space of dimension 3 over Symbolic Ring\n\nsage: g(t) = f(t).derivative(t)\nTraceback (most recent call last)\n...\nTypeError: unable to convert (1, 2*t, 3*t^2) to a symbolic expression\n\nsage: h = f.derivative()\nsage: h\n[    t |--> 1]\n[  t |--> 2*t]\n[t |--> 3*t^2]\nsage: h.parent()\nFull MatrixSpace of 3 by 1 dense matrices\nover Callable function ring with argument t\n```\n\n10. Newline confusion. See #11621, #19088, #30953.\n\n```\nsage: f(t) = (t,\n....:         t^2,\n....:         t^3)\n  File \"<ipython-input-46-d381d3086d21>\", line 2\n    t**Integer(2),\n    ^\nSyntaxError: invalid syntax\n```",
    "created_at": "2021-04-03T19:33:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423863",
    "user": "https://github.com/slel"
}
```

<a id='comment:13'></a>Suggestion: make this a meta-ticket and track each item
in its own ticket.
...
```json
{
    "body": "<a id='comment:14'></a>For item 7, see #32008.",
    "created_at": "2021-07-06T00:13:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423864",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:14'></a>For item 7, see #32008.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71147"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423865",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423866",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423867",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423868",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71149"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28434#issuecomment-423869",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71151"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71152"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71153"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28434#event-71154"
}
```
