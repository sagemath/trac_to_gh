...
```json
{
    "body": "<a id='comment:2'></a>I like this idea a lot. I propose to add the same keyword argument to the `union` method of a `HyperplaneArrangement` to preserve the order when adding a hyperplane or an arrangement to the current ordered one.",
    "created_at": "2019-11-04T07:15:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28602#issuecomment-400105",
    "user": "https://trac.sagemath.org/admin/accounts/users/nailuj"
}
```

<a id='comment:2'></a>I like this idea a lot. I propose to add the same keyword argument to the `union` method of a `HyperplaneArrangement` to preserve the order when adding a hyperplane or an arrangement to the current ordered one.
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71912"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28602#issuecomment-400106",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71913"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28602#issuecomment-400107",
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71915"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28602#issuecomment-400108",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71917"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71918"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71919"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71920"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71921"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71922"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71923"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71924"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71925"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28602#event-71926"
}
```
