...
```json
{
    "body": "<a id='comment:1'></a>It looks like this was a bug which was just fixed upstream: I can reproduce the bug in gp version 2.11.1, but I get the correct answer in 2.11.2 (which is what I originally tried). So a simple Pari update should suffice.",
    "created_at": "2019-11-22T21:06:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558982",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:1'></a>It looks like this was a bug which was just fixed upstream: I can reproduce the bug in gp version 2.11.1, but I get the correct answer in 2.11.2 (which is what I originally tried). So a simple Pari update should suffice.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558983",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>See #28424 for a Pari upgrade ticket that would resolve this issue.",
    "created_at": "2019-11-25T00:59:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558984",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:2'></a>See #28424 for a Pari upgrade ticket that would resolve this issue.
...
```json
{
    "body": "<a id='comment:3'></a>#28424 is somewhat exploratory to check for broken stuff. Of course we have gone on the pari git branch in the past when Jeroen was after new features.\n\nBut #28424 shouldn't prevent you from making this ticket an upgrade to 2.11.2 to fix your issue. If that make fell you better most sage-on-distros are probably already using 2.11.2 without reported side effects (apart from getting the right answer in the problem pointed out by this ticket - I know I do in sage-on-gentoo).",
    "created_at": "2019-12-03T20:49:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558985",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>#28424 is somewhat exploratory to check for broken stuff. Of course we have gone on the pari git branch in the past when Jeroen was after new features.
...
```json
{
    "body": "<a id='comment:4'></a>OK, so let's make this a ticket to upgrade Pari to 2.11.2. Unfortunately, updating an spkg falls outside of my expertise; but it should be trivial for someone more familiar with the build system.",
    "created_at": "2019-12-04T07:36:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558986",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:4'></a>OK, so let's make this a ticket to upgrade Pari to 2.11.2. Unfortunately, updating an spkg falls outside of my expertise; but it should be trivial for someone more familiar with the build system.
...
```json
{
    "body": "<a id='comment:5'></a>I have made #28840 for the upgrade to pari 2.11.2",
    "created_at": "2019-12-04T12:21:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558987",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>I have made #28840 for the upgrade to pari 2.11.2
...
```json
{
    "body": "<a id='comment:6'></a>Now that #28840 is in, it would be nice to add the example from this ticket\nas a doctest in Sage's documentation. Something like:\n\n```\nCheck that :trac:`28789` is fixed::\n\n    sage: P.<x> = PolynomialRing(GF(3))\n    sage: u = x^10 + x^9 + x^8 + x\n    sage: C = HyperellipticCurve(u)\n    sage: C.frobenius_polynomial()\n    x^8 + 2*x^7 + 6*x^6 + 9*x^5 + 18*x^4 + 27*x^3 + 54*x^2 + 54*x + 81\n```",
    "created_at": "2019-12-09T05:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558988",
    "user": "https://github.com/slel"
}
```

<a id='comment:6'></a>Now that #28840 is in, it would be nice to add the example from this ticket
as a doctest in Sage's documentation. Something like:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558989",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558990",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558991",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558992",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558993",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558994",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Agreed! I doctested both `frobenius_polynomial` and `frobenius_polynomial_pari`.\n\n---\nNew commits:",
    "created_at": "2019-12-11T15:44:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558995",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:8'></a>Agreed! I doctested both `frobenius_polynomial` and `frobenius_polynomial_pari`.
...
```json
{
    "body": "<a id='comment:9'></a>ok, good to go. Thanks",
    "created_at": "2019-12-11T19:49:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558996",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:9'></a>ok, good to go. Thanks
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558997",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558998",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-558999",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28789#event-72724"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-559000",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Possibly related problem reported on sage-support with Sage 9.0:\n\n- https://groups.google.com/d/topic/sage-support/JpbRY1HLEE8/discussion",
    "created_at": "2020-01-10T18:49:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-559001",
    "user": "https://github.com/slel"
}
```

<a id='comment:11'></a>Possibly related problem reported on sage-support with Sage 9.0:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-559002",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28789#issuecomment-559003",
    "user": "https://github.com/slel"
}
```
