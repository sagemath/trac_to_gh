...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28324#issuecomment-444310",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28324#issuecomment-444311",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28324#event-370499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28324#event-370500"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28324#event-370501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28324#event-370502"
}
```
