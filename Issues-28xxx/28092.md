...
```json
{
    "body": "<a id='comment:2'></a>\nFor lack of better understanding what's going on with DHCP, I've tried disabling DHCP on the server and assigning a static IP.  I don't know if that means [OpenStack](../wikis/OpenStack) will then try to give that IP to another instance or what, but we'll see what happens...",
