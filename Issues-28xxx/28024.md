...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[60083cd](https://git.sagemath.org/sage.git/commit/?id=60083cdc3f8191fb01f7119accc38652ea5095ef)|`28024: change wording, fractional field -> fraction field`|\n|[2085e58](https://git.sagemath.org/sage.git/commit/?id=2085e58305e8c2834e7827c10263fc6ac6058934)|`28024: Add specialization variable sanity check`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[3164c13](https://git.sagemath.org/sage.git/commit/?id=3164c13280ed1394a1ea3d8529a41299fcc622cc)|`28024: Change error case to ignore unapplicable variables`|",
