...
```json
{
    "body": "<a id='comment:2'></a>At least, we need a way to avoid the call to `D.dict()`. Any expert in matrix module to help here ?",
    "created_at": "2019-12-11T18:03:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560467",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:2'></a>At least, we need a way to avoid the call to `D.dict()`. Any expert in matrix module to help here ?
...
```json
{
    "body": "<a id='comment:3'></a>Does it help to tag those tests with `# optional -- memlimit`?\n\nBy the way: what is the platform? How much memory? Does it depend on one of the external packages? How can I reproduce this?",
    "created_at": "2019-12-11T21:21:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560468",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Does it help to tag those tests with `# optional -- memlimit`?
...
```json
{
    "body": "<a id='comment:5'></a>I can reproduce the issue on my laptop and my desktop (both running Ubuntu 16.06 with SageMath version 9.0.beta9, Release Date: 2019-12-08).",
    "created_at": "2019-12-17T21:23:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560470",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:5'></a>I can reproduce the issue on my laptop and my desktop (both running Ubuntu 16.06 with SageMath version 9.0.beta9, Release Date: 2019-12-08).
...
```json
{
    "body": "<a id='comment:7'></a>How much RAM do those machines have? And on the machines where it fails, does it help if you tag the doctests with `# optional -- memlimit` or `# high mem`? (I'm not sure about the last one, but that's what it says in `sage-runtests`. I found no instances of doctests tagged with `# high mem` in the Sage libary.)",
    "created_at": "2019-12-17T23:45:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560472",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>How much RAM do those machines have? And on the machines where it fails, does it help if you tag the doctests with `# optional -- memlimit` or `# high mem`? (I'm not sure about the last one, but that's what it says in `sage-runtests`. I found no instances of doctests tagged with `# high mem` in the Sage libary.)
...
```json
{
    "body": "<a id='comment:8'></a>Note that since I can't find \"high mem\" in the Sage source code, I doubt this is the right syntax. (The doctesting framework has to search for something when matching the tag with the behavior, and `git grep \"high.*mem\" src` doesn't return any promising hits.) \n\n`@`embray, do you know the right syntax for marking a test with a memory cap? `# optional - memlimit` (as is used in `sage/doctest/test.py` and a few other places) or `# high mem` (as it says in sage-runtests) or something else?",
    "created_at": "2019-12-17T23:53:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560473",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>Note that since I can't find "high mem" in the Sage source code, I doubt this is the right syntax. (The doctesting framework has to search for something when matching the tag with the behavior, and `git grep "high.*mem" src` doesn't return any promising hits.) 
...
```json
{
    "body": "<a id='comment:9'></a>This ticket is in fact for the same issue than #25465. I did not remember it.",
    "created_at": "2019-12-20T12:04:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560474",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:9'></a>This ticket is in fact for the same issue than #25465. I did not remember it.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28865#event-73001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28865#event-73002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560475",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560476",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"David Coudert, Erik Bray\"",
    "created_at": "2019-12-24T23:52:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560477",
    "user": "https://github.com/slel"
}
```

Changing reviewer from "" to "David Coudert, Erik Bray"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28865#issuecomment-560478",
    "user": "https://github.com/jhpalmieri"
}
```
