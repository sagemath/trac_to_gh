...
```json
{
    "body": "<a id='comment:20'></a>\nPatch attached, finally.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[a4b4143](https://git.sagemath.org/sage.git/commit?id=a4b41430c128349b54c4871a893f6e0f21b0fe96)|`Updated Cygwin patch for PARI 2.13.1 and added additional patch`|",
