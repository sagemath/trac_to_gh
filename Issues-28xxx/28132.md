...
```json
{
    "body": "<a id='comment:1'></a>How should I understand this? Would it be possible to profile `import sage.libs.pari` to see in detail what's taking all that time? For example, if it's the `virtual_memory_limit()` call, we could try to do something about that.\n\nOn Linux, `import sage.libs.pari` takes about 35ms, which is 2 orders of magnitude faster than on Windows.",
    "created_at": "2019-07-08T09:13:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544967",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>How should I understand this? Would it be possible to profile `import sage.libs.pari` to see in detail what's taking all that time? For example, if it's the `virtual_memory_limit()` call, we could try to do something about that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544968",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>It seems the main culprit, not *too* surprisingly, is `paristack_setsize` with a large `sizemax`.  If it's smaller, or if `rsize == vsize`, initialization takes mere milliseconds.\n\n*Why* it's so slow I'm not sure.  It could be a limitation of Cygwin or even Windows, though I do find it a bit strange.\n\nWould it be possible, say, to start out with a very small pari stack, and then increase it later only when needed (or even do something like run a thread in the background to take care of that)?",
    "created_at": "2019-07-08T15:18:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544971",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>It seems the main culprit, not *too* surprisingly, is `paristack_setsize` with a large `sizemax`.  If it's smaller, or if `rsize == vsize`, initialization takes mere milliseconds.
...
```json
{
    "body": "<a id='comment:7'></a>I feel a blast from the past... the whole point of `parisizemax` is precisely to avoid resizing the stack on the fly. The idea is to allocate a large \"virtual\" stack with the intention of using only a small part of it, but having the possibility of using it all if needed.\n\nBefore `parisizemax` existed, I recall that Sage used to have a mechanism to retry failed PARI computations if it detected that the PARI stack overflowed. But thanks to `parisizemax`, we got rid of that hack. I'm not looking forward to putting that back.",
    "created_at": "2019-07-08T19:04:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544972",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>I feel a blast from the past... the whole point of `parisizemax` is precisely to avoid resizing the stack on the fly. The idea is to allocate a large "virtual" stack with the intention of using only a small part of it, but having the possibility of using it all if needed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544973",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544974",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The problem is that you can't know how much PARI stack you need in advance. If you're halfway a computation and suddenly the stack turns out to be too small, then what do you do?",
    "created_at": "2019-07-09T10:55:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544975",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>The problem is that you can't know how much PARI stack you need in advance. If you're halfway a computation and suddenly the stack turns out to be too small, then what do you do?
...
```json
{
    "body": "<a id='comment:10'></a>After a bit of experimenting I found the awful truth, which is that on Cygwin (at least the current version I'm on (3.13.0-170)) the time taken for an anonymous `mmap` and `munmap` scales logarithmically (with munmap typically taking ~twice as long for some reason).\n\nOn Linux both are more-or-less instant no matter the size.\n\n![](cygwin_mmap.png)",
    "created_at": "2019-07-09T10:57:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544976",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>After a bit of experimenting I found the awful truth, which is that on Cygwin (at least the current version I'm on (3.13.0-170)) the time taken for an anonymous `mmap` and `munmap` scales logarithmically (with munmap typically taking ~twice as long for some reason).
...
```json
{
    "body": "<a id='comment:11'></a>Thanks for that. Does it depend on the flags, in particular `MAP_NORESERVE`?",
    "created_at": "2019-07-09T10:59:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544977",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Thanks for that. Does it depend on the flags, in particular `MAP_NORESERVE`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544978",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544979",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544980",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544981",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>One thing that would be helpful is if the cypari interface had an easy way (as a method on the `Pari` class if possible) to resize the stack sizemax allocation later.  I know in principle it's already possible by manually re-calling `Pari.__init__`, but a more dedicated method would be clearer.\n\nThat way I could so something like start with a smaller stack (just for startup), but then resize it after Sage's initial startup is complete (how exactly that would work I'm not exactly sure yet; possibly in a thread...).",
    "created_at": "2019-07-09T12:54:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544982",
    "user": "https://github.com/embray"
}
```

<a id='comment:15'></a>One thing that would be helpful is if the cypari interface had an easy way (as a method on the `Pari` class if possible) to resize the stack sizemax allocation later.  I know in principle it's already possible by manually re-calling `Pari.__init__`, but a more dedicated method would be clearer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544984",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544985",
...
```json
{
    "body": "<a id='comment:19'></a>I forgot all about this issue.  It should just require a simple patch to PARI.",
    "created_at": "2021-03-10T15:33:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544986",
    "user": "https://github.com/embray"
}
```

<a id='comment:19'></a>I forgot all about this issue.  It should just require a simple patch to PARI.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544987",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Patch attached, finally.\n\n---\nNew commits:",
    "created_at": "2021-08-18T16:23:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544988",
    "user": "https://github.com/embray"
}
```

<a id='comment:20'></a>Patch attached, finally.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544989",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/embray/ticket-28132\"",
    "created_at": "2021-08-18T16:23:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544990",
    "user": "https://github.com/embray"
}
```

Changing branch from "" to "u/embray/ticket-28132"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544991",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"a4b41430c128349b54c4871a893f6e0f21b0fe96\"",
    "created_at": "2021-08-18T16:23:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544992",
    "user": "https://github.com/embray"
}
```

Changing commit from "" to "a4b41430c128349b54c4871a893f6e0f21b0fe96"
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69818"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Note, I have not tested this due to not having at the moment an up-to-date Cygwin build.  I hope to try it soon.",
    "created_at": "2021-08-18T16:26:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544993",
    "user": "https://github.com/embray"
}
```

<a id='comment:21'></a>Note, I have not tested this due to not having at the moment an up-to-date Cygwin build.  I hope to try it soon.
...
```json
{
    "body": "<a id='comment:22'></a>Seems to work, but based on the testing slelievre and I have done this patch might not be necessary anymore.  It doesn't seem that pari is as significant a startup time contributor as it used to be, and this patch doesn't seem to make a whole lot of difference.\n\nI don't know if it's something cypari2 does differently, or it could be improvements in cygwin's mmap, or even changes in Windows that have sped this up.",
    "created_at": "2021-08-20T16:11:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544994",
    "user": "https://github.com/embray"
}
```

<a id='comment:22'></a>Seems to work, but based on the testing slelievre and I have done this patch might not be necessary anymore.  It doesn't seem that pari is as significant a startup time contributor as it used to be, and this patch doesn't seem to make a whole lot of difference.
...
```json
{
    "body": "<a id='comment:24'></a>Some more startup related tickets:\n\n- https://trac.sagemath.org/query?order=id&desc=1&summary=~startup&status=!closed",
    "created_at": "2021-08-21T15:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544996",
    "user": "https://github.com/slel"
}
```

<a id='comment:24'></a>Some more startup related tickets:
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69819"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28132#issuecomment-544997",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69821"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69822"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69823"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28132#event-69824"
}
```
