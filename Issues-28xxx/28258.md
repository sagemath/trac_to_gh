...
```json
{
    "body": "<a id='comment:2'></a>Tangent: why is `--serial` not listed in the options when I run `sage -t -h`? Are there other undocumented Sage doctesting options?",
...
<a id='comment:2'></a>Tangent: why is `--serial` not listed in the options when I run `sage -t -h`? Are there other undocumented Sage doctesting options?
...
```json
{
    "body": "<a id='comment:4'></a>The attached branch fixes the problem to my satisfaction.  It can never be fully \"fixed\" as what we're dealing with here is a fundamental limitation of !Windows/Cygwin.  But we can *mitigate* the problem and this does so well.  See the commit message for more details.\n\n---\nNew commits:",
    "created_at": "2019-11-13T17:38:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28258",
    "type": "issue_comment",
...
<a id='comment:4'></a>The attached branch fixes the problem to my satisfaction.  It can never be fully "fixed" as what we're dealing with here is a fundamental limitation of !Windows/Cygwin.  But we can *mitigate* the problem and this does so well.  See the commit message for more details.
