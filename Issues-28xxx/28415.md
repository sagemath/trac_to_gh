...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371695"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445646",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445647",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371697"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445648",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445649",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445650",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    "body": "Changed keywords from **** to **integration, education**",
    "created_at": "2019-08-28T09:56:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445651",
    "user": "https://github.com/miguelmarco"
}
```

Changed keywords from **** to **integration, education**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445652",
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371700"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445653",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445654",
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371702"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371703"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371704"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371705"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445655",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445656",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445657",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445658",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445659",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445660",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445661",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371706"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371707"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371708"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445662",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371710"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28415#issuecomment-445663",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371712"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371713"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371714"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28415#event-371715"
}
```
