...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397977",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    "body": "Attachment [tmp_i3tnbr7x.png](tarball://root/attachments/some-uuid/ticket28449/tmp_i3tnbr7x.png) by @antonio-rojas created at 2019-09-03 15:55:47",
    "created_at": "2019-09-03T15:55:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397978",
    "user": "https://github.com/antonio-rojas"
}
```

Attachment [tmp_i3tnbr7x.png](tarball://root/attachments/some-uuid/ticket28449/tmp_i3tnbr7x.png) by @antonio-rojas created at 2019-09-03 15:55:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397979",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397980",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71249"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71250"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397981",
...
```json
{
    "body": "There is a temporary fix at #29547: disable the plot labels, since those are causing warnings with matplotlib 3 (in addition to causing the terrible parts of the picture). I tried the same commands going back to Sage 8.4, and I still see the same bad output, so I don't know when (or if) this ever worked.\n\nCc'ing tscrim, in case he has any ideas of who might be able to find a better fix.",
    "created_at": "2020-04-22T02:43:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397982",
...
```json
{
    "body": "Changing component from graphics to combinatorics.",
    "created_at": "2020-04-22T02:43:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397983",
    "user": "https://github.com/jhpalmieri"
}
```

Changing component from graphics to combinatorics.
...
```json
{
    "body": "An unrelated problem (but in case you test another crystal): #29548",
    "created_at": "2020-04-22T02:59:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397985",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397987",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397988",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397989",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "Changing component from combinatorics to packages: standard.",
    "created_at": "2020-04-26T06:10:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397990",
    "user": "https://github.com/DaveWitteMorris"
}
```

Changing component from combinatorics to packages: standard.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71251"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71252"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71253"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71254"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28212#issuecomment-397992",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71255"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71256"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71257"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71258"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71259"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71260"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71261"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28212#event-71262"
}
```
