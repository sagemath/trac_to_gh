...
```json
{
    "body": "<a id='comment:2'></a>Attachment [eclib-flush.patch](tarball://root/attachments/some-uuid/ticket28454/eclib-flush.patch) by @jhpalmieri created at 2019-09-04 22:00:55",
    "created_at": "2019-09-04T22:00:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551781",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Attachment [eclib-flush.patch](tarball://root/attachments/some-uuid/ticket28454/eclib-flush.patch) by @jhpalmieri created at 2019-09-04 22:00:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551782",
...
```json
{
    "body": "<a id='comment:5'></a>In the \"Report upstream\" box there should be an option \"developers do not know whether it is a bug or not\"!  Right now I neither acknowledge that there is a bug in eclib nor deny it.  Anyway, I think that the author of a library has the right to issue warnings, and it is surely a Sage problem if a warning in a dependent library is triggered under python2 but not under python3?",
    "created_at": "2019-09-05T09:00:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551784",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>In the "Report upstream" box there should be an option "developers do not know whether it is a bug or not"!  Right now I neither acknowledge that there is a bug in eclib nor deny it.  Anyway, I think that the author of a library has the right to issue warnings, and it is surely a Sage problem if a warning in a dependent library is triggered under python2 but not under python3?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551785",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551786",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Thanks, that is helpful -- my guess is that the warning message is being created in an earlier doctest but only appearing in this one.  That code in mrank1.cc is only run when doing 2-descent on elliptic curves with no 2-torsion.  So the next step would be to manually run some subset of the doctests in that file interface.py.\n\nI'll make myself a new python3 build and see if I can get to the bottom of this.",
    "created_at": "2019-09-05T18:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551787",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>Thanks, that is helpful -- my guess is that the warning message is being created in an earlier doctest but only appearing in this one.  That code in mrank1.cc is only run when doing 2-descent on elliptic curves with no 2-torsion.  So the next step would be to manually run some subset of the doctests in that file interface.py.
...
```json
{
    "body": "<a id='comment:8'></a>Note that it is also platform-specific: I don't see it on OS X, for example. It is conceivable that it depends on a combination of the OS and the processor, or it could just be the OS. It makes it (along with a few other Python 3 failures) annoying to debug and fix.",
    "created_at": "2019-09-05T18:27:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551788",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>Note that it is also platform-specific: I don't see it on OS X, for example. It is conceivable that it depends on a combination of the OS and the processor, or it could just be the OS. It makes it (along with a few other Python 3 failures) annoying to debug and fix.
...
```json
{
    "body": "<a id='comment:9'></a>And of course, I am happy to test things on my virtual machine. Let me know how I can help.",
    "created_at": "2019-09-05T19:42:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551789",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>And of course, I am happy to test things on my virtual machine. Let me know how I can help.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551792",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551793",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551794",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>The tarball in comment 14 is looking good (to me).  After installing it in a python2 Sage I only needed to adjust one doctest in this file interface.py: line 359 now says\n\n```\nRuntimeError: A 2-descent did not complete successfully.\n```\n\nI have not yet done any python3 testing.",
    "created_at": "2019-09-09T16:36:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551795",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:15'></a>The tarball in comment 14 is looking good (to me).  After installing it in a python2 Sage I only needed to adjust one doctest in this file interface.py: line 359 now says
...
```json
{
    "body": "<a id='comment:16'></a>It looks good to me, too, at least as far as the doctests in `libs/eclib/` are concerned: I just see the one problem you mentioned. This is with Python 3.\n\nI think I will still prepare a patch for the old version, since it's easy to do, and if we end up not needing it and going straight to your new version, that's fine with me.",
    "created_at": "2019-09-09T18:28:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551796",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>It looks good to me, too, at least as far as the doctests in `libs/eclib/` are concerned: I just see the one problem you mentioned. This is with Python 3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551797",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/jhpalmieri/eclib-flush\"",
    "created_at": "2019-09-09T18:50:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551798",
    "user": "https://github.com/jhpalmieri"
}
```

Changing branch from "" to "u/jhpalmieri/eclib-flush"
...
```json
{
    "body": "Changing commit from \"\" to \"ad86cbe9689b2488f481a9295f5c25e5a3e69d7a\"",
    "created_at": "2019-09-09T18:55:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551799",
    "user": "https://github.com/jhpalmieri"
}
```

Changing commit from "" to "ad86cbe9689b2488f481a9295f5c25e5a3e69d7a"
...
```json
{
    "body": "<a id='comment:19'></a>Okay, done. I think I need you to decide whether to use the patch or wait for a new version, since I don't know your timeline. If a new release won't be ready within a week or so, I would suggest using the patch. I'd certainly rather do that than have you feel under any time pressure to produce a new release. (Full Python 3 support, with all tests passing, is very close, and I want to make progress quickly when possible.)\n\n---\nNew commits:",
    "created_at": "2019-09-09T18:55:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551800",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:19'></a>Okay, done. I think I need you to decide whether to use the patch or wait for a new version, since I don't know your timeline. If a new release won't be ready within a week or so, I would suggest using the patch. I'd certainly rather do that than have you feel under any time pressure to produce a new release. (Full Python 3 support, with all tests passing, is very close, and I want to make progress quickly when possible.)
...
```json
{
    "body": "<a id='comment:20'></a>The other good news is that because of this ticket, I realized that the same non-flushing problem causes another Python 3 doctest failure (#28334), which I had no idea how to diagnose before.",
    "created_at": "2019-09-09T19:09:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551801",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:20'></a>The other good news is that because of this ticket, I realized that the same non-flushing problem causes another Python 3 doctest failure (#28334), which I had no idea how to diagnose before.
...
```json
{
    "body": "Changing branch from \"u/jhpalmieri/eclib-flush\" to \"u/cremona/28454\"",
    "created_at": "2019-09-10T11:11:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551802",
    "user": "https://github.com/JohnCremona"
}
```

Changing branch from "u/jhpalmieri/eclib-flush" to "u/cremona/28454"
...
```json
{
    "body": "Changing author from \"\" to \"John Cremona, John Palmieri\"",
    "created_at": "2019-09-10T11:11:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551803",
    "user": "https://github.com/JohnCremona"
}
```

Changing author from "" to "John Cremona, John Palmieri"
...
```json
{
    "body": "Changing commit from \"ad86cbe9689b2488f481a9295f5c25e5a3e69d7a\" to \"6ab659a47a1318932020dc2edec2dbb7eefc9295\"",
    "created_at": "2019-09-10T11:11:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551804",
    "user": "https://github.com/JohnCremona"
}
```

Changing commit from "ad86cbe9689b2488f481a9295f5c25e5a3e69d7a" to "6ab659a47a1318932020dc2edec2dbb7eefc9295"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551805",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Ticket #28472 has an eclib upgrade.  No reason why the patch here cannot be merged first.",
    "created_at": "2019-09-10T18:23:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551807",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:22'></a>Ticket #28472 has an eclib upgrade.  No reason why the patch here cannot be merged first.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551808",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>I get a doctest failure with Python 3 on debian: similar, but the output is flushed almost (but not quite) immediately, so the message appears in the doctest after the one where it should:\n\n```\nFile \"src/sage/libs/eclib/interface.py\", line 368, in sage.libs.eclib.interface.mwrank_EllipticCurve.?\nFailed example:\n    E.two_descent(verbose=False)\nExpected:\n    True\nGot:\n    Attempt to round -0.2617840677e25 to a long int fails, aborting!\n    True\n**********************************************************************\n1 item had failures:\n   1 of   6 in sage.libs.eclib.interface.mwrank_EllipticCurve.?\n    [192 tests, 1 failure, 7.16 s]\n----------------------------------------------------------------------\nsage -t --warn-long 206.6 src/sage/libs/eclib/interface.py  # 1 doctest failed\n----------------------------------------------------------------------\n```",
    "created_at": "2019-09-10T18:54:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551809",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>I get a doctest failure with Python 3 on debian: similar, but the output is flushed almost (but not quite) immediately, so the message appears in the doctest after the one where it should:
...
```json
{
    "body": "<a id='comment:24'></a>(No breach of etiquette at all, by the way. I just want to get the problem fixed.)",
    "created_at": "2019-09-10T19:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551810",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:24'></a>(No breach of etiquette at all, by the way. I just want to get the problem fixed.)
...
```json
{
    "body": "<a id='comment:25'></a>Strange.  I'll double check that I put in all the flushes, and perhaps insert some more before as well as after each library call.",
    "created_at": "2019-09-10T21:12:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551811",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:25'></a>Strange.  I'll double check that I put in all the flushes, and perhaps insert some more before as well as after each library call.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551812",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551813",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28454#event-71281"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>I agree. I'm marking this as a duplicate.",
    "created_at": "2019-09-11T18:38:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551814",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:27'></a>I agree. I'm marking this as a duplicate.
...
```json
{
    "body": "<a id='comment:28'></a>(deleting the branch so it doesn't get merged by accident)",
    "created_at": "2019-09-12T21:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551815",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:28'></a>(deleting the branch so it doesn't get merged by accident)
...
```json
{
    "body": "Changing branch from \"u/cremona/28454\" to \"\"",
    "created_at": "2019-09-12T21:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551816",
    "user": "https://github.com/jhpalmieri"
}
```

Changing branch from "u/cremona/28454" to ""
...
```json
{
    "body": "Changing commit from \"6ab659a47a1318932020dc2edec2dbb7eefc9295\" to \"\"",
    "created_at": "2019-09-12T21:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551817",
    "user": "https://github.com/jhpalmieri"
}
```

Changing commit from "6ab659a47a1318932020dc2edec2dbb7eefc9295" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551818",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28454#event-71282"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>I know this is closed, but can you reproduce the issue if you run the tests with `--memlimit=0`?",
    "created_at": "2019-09-18T11:28:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551819",
    "user": "https://github.com/embray"
}
```

<a id='comment:30'></a>I know this is closed, but can you reproduce the issue if you run the tests with `--memlimit=0`?
...
```json
{
    "body": "<a id='comment:31'></a>`./sage -t --memlimit=0 src/sage/lib/eclib/interface.py` fails the same way.",
    "created_at": "2019-09-18T16:59:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28454",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28454#issuecomment-551820",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:31'></a>`./sage -t --memlimit=0 src/sage/lib/eclib/interface.py` fails the same way.
