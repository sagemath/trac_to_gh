...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28123#issuecomment-440502",
    "user": "https://github.com/ttajakka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28123#issuecomment-440503",
    "user": "https://github.com/ttajakka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28123#event-367479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28123#event-367480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28123#event-367481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28123",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28123#event-367482"
}
```
