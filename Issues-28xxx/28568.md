...
```
`macaulay2._install_hints` should return a string providing information about how to set up Macaulay2 to work with [SageMath](../wikis/SageMath). See `gap3._install_hints` for a detailed example of how this works.
