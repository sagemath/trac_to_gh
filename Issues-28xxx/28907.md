...
archive/issue_events_348179.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348179"
}
```
...
archive/issue_events_348180.json:
```json
{
    "actor": "https://github.com/mwageringel",
    "created_at": "2019-12-22T20:14:27Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348180"
}
```
...
archive/issue_events_348181.json:
```json
{
    "actor": "https://github.com/mwageringel",
    "created_at": "2019-12-22T20:14:27Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348181"
}
```
...
archive/issue_events_348182.json:
```json
{
    "actor": "https://github.com/mwageringel",
    "created_at": "2019-12-22T20:14:27Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348186"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28907",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28907#event-348187"
}
```
