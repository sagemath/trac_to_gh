...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[358d626](https://git.sagemath.org/sage.git/commit/?id=358d626e4cdbaf19983f04bf6492c7ce1d44c218)|`Trac #28354: Better handling of unhandled exceptions from pexpect when`|",
    "created_at": "2019-08-15T07:45:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28354",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[200623e](https://git.sagemath.org/sage.git/commit/?id=200623eb276a2c7c9f20550883128b4465cb3edc)|`Trac #28354: Better handling of unhandled exceptions from pexpect when`|",
    "created_at": "2019-08-15T07:47:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28354",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|\n|[f0c2d6e](https://git.sagemath.org/sage.git/commit/?id=f0c2d6eca5b1971f41da9a12303c699d59fc715b)|`Move definition of expect_eof before anything that can raise an exception in the try/except`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[78f92f6](https://git.sagemath.org/sage.git/commit/?id=78f92f6678eb468764701c2386dbe7bc06d22562)|`Trac #28354: Better handling of unhandled exceptions from pexpect when`|",
    "created_at": "2019-08-16T09:16:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28354",
    "type": "issue_comment",
