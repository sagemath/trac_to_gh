...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[0a70975](https://git.sagemath.org/sage.git/commit?id=0a7097544f8a6fd8eb9037df37269f475f1fb01e)|`default_mip_solver, get_solver: Handle default solver = a callable`|",
