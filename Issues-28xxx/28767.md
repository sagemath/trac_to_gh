...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28767#issuecomment-402386",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [openblas-0.3.6.p0.log](tarball://root/attachments/some-uuid/ticket28767/openblas-0.3.6.p0.log) by @zimmermann6 created at 2019-11-19 10:07:55\n\nduplicate of #28768",
    "created_at": "2019-11-19T10:07:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28767#issuecomment-402387",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>Attachment [openblas-0.3.6.p0.log](tarball://root/attachments/some-uuid/ticket28767/openblas-0.3.6.p0.log) by @zimmermann6 created at 2019-11-19 10:07:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28767",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28767#event-72591"
}
```
