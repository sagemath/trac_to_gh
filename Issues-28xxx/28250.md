...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/28250",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28250#issuecomment-548130",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Python-level multi-threading is basically not supported in Sage except for code that doesn't need to use subsystems like GAP or PARI.  See in fact the very recent discussion at https://github.com/OpenDreamKit/OpenDreamKit/issues/60\n\nI'm tempted to close this ticket as \"wontfix\", not because it wouldn't be desirable to fix this, but more to do with the fact that it's a known issue.",
    "created_at": "2019-09-04T09:35:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28250#issuecomment-548131",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>Python-level multi-threading is basically not supported in Sage except for code that doesn't need to use subsystems like GAP or PARI.  See in fact the very recent discussion at https://github.com/OpenDreamKit/OpenDreamKit/issues/60
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28250#event-70326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28250#issuecomment-548132",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I won't object against a \"wontfix\", perhaps we could add some documentation somewhere mentioning the issue.",
    "created_at": "2019-09-04T13:32:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28250#issuecomment-548133",
    "user": "https://github.com/edgarcosta"
}
```

<a id='comment:4'></a>I won't object against a "wontfix", perhaps we could add some documentation somewhere mentioning the issue.
...
```json
{
    "body": "<a id='comment:5'></a>I agree, though it's hard to know where, or exactly what to document.  That's worth thinking about though.",
    "created_at": "2019-09-04T14:33:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28250#issuecomment-548134",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>I agree, though it's hard to know where, or exactly what to document.  That's worth thinking about though.
