...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-369390"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-369391"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-369392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-369393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-443253",
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-369394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-369395"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-443254",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-443255",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-443256",
    "user": "https://github.com/embray"
}
```
