...
```json
{
    "body": "<a id='comment:4'></a>m4ri(e) now may come from \"the system\": #28342\n\nDo you build m4ri(e), or use one from Homebrew (or something like this)?",
    "created_at": "2020-01-09T06:22:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562982",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>m4ri(e) now may come from "the system": #28342
...
```json
{
    "body": "<a id='comment:5'></a>Assuming you use Sage's m4ri(e): Try doing internal tests of m4ri and m4rie:\n\n```\nSAGE_CHECK=yes ./sage -f m4ri\nSAGE_CHECK=yes ./sage -f m4rie\n```\nand see whether you manage to get errors there.",
    "created_at": "2020-01-09T06:25:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562983",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:5'></a>Assuming you use Sage's m4ri(e): Try doing internal tests of m4ri and m4rie:
...
```json
{
    "body": "<a id='comment:7'></a>Should be fixed by the new patch on #29026 \nPlease verify it fixes the issue.",
    "created_at": "2020-01-20T09:58:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562985",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:7'></a>Should be fixed by the new patch on #29026 
Please verify it fixes the issue.
...
```json
{
    "body": "<a id='comment:8'></a>Yes, #29026 got rid of the problem in my testing (like it did for #28944). I tried a few hundred times, and never got `False` or an error. Thank you!",
    "created_at": "2020-01-21T03:17:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562986",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:8'></a>Yes, #29026 got rid of the problem in my testing (like it did for #28944). I tried a few hundred times, and never got `False` or an error. Thank you!
...
```json
{
    "body": "<a id='comment:9'></a>Looks good to me, too. Let's close this as a duplicate of #29026.",
    "created_at": "2020-01-21T05:11:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562987",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>Looks good to me, too. Let's close this as a duplicate of #29026.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562988",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562989",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562990",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28970#issuecomment-562991",
