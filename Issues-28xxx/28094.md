...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [decomposition.tex](tarball://root/attachments/some-uuid/ticket28094/decomposition.tex) by @BrentBaccala created at 2019-10-10 02:02:08\n\nLast 10 new commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[d247e7d](https://git.sagemath.org/sage.git/commit?id=d247e7ddd39108a8f460106feb0b471b7f48244e)|`Trac #28094: constructor creates FunctionField_integral's if conditions are right`|\n|[fc0f191](https://git.sagemath.org/sage.git/commit?id=fc0f19152179174cf44aa5c32b938d39423a81cc)|`Trac #28094: add new decomposition method to FunctionFieldMaximalOrder_polymod`|\n|[de8ff74](https://git.sagemath.org/sage.git/commit?id=de8ff744b5ef0659c434369a6d2ef909aa9bdb49)|`Trac #28094: add class FunctionFieldHigherDerivation_charzero`|\n|[0ade7d0](https://git.sagemath.org/sage.git/commit?id=0ade7d081db29df0926fdbd5e2356e58c598ca1e)|`Trac #28094: introduce classes FunctionField_charzero,`|\n|[efefd59](https://git.sagemath.org/sage.git/commit?id=efefd59dbedd83c5a6ec3b48d1e201b7b3366efb)|`Trac #28094: remove FunctionFieldCompletion_global, use`|\n|[2f918fb](https://git.sagemath.org/sage.git/commit?id=2f918fb6b14be70fa709a6f4e88cd01cde5cf38b)|`Trac #28094: move `valuation` method to superclass so that elements`|\n|[46f0857](https://git.sagemath.org/sage.git/commit?id=46f0857c5f1b543ed4419bb3dbdebeedbec43051)|`Trac #28094: move `different` method to superclass`|\n|[e52cae0](https://git.sagemath.org/sage.git/commit?id=e52cae0bdbda461ae45679379f3ef1db0825d6ca)|`Trac #28094: update decomposition algorithm (mostly the description)`|\n|[c689837](https://git.sagemath.org/sage.git/commit?id=c6898372e017de1b9c10a4ce3a46eb39fe1e8bf1)|`remove QQbar from the test suite, because QQbar won't work with this`|\n|[b0862a9](https://git.sagemath.org/sage.git/commit?id=b0862a94a9601814bd0d6fd941baae6e2cc2ed2d)|`Merge tag '9.0.beta0' into public/28094`|",
    "created_at": "2019-10-10T02:02:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[865d513](https://git.sagemath.org/sage.git/commit/?id=865d513907819a415a2135b48d11f638aea021de)|`Trac #28094: construct extension fields when forming residue fields,`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[e32b3a1](https://git.sagemath.org/sage.git/commit/?id=e32b3a1974ab30c396819160c7ce7e89a1c426a7)|`Trac #28094: wrap ring normalization code in a decorator that allows`|\n|[478f1a9](https://git.sagemath.org/sage.git/commit/?id=478f1a9bdf14a93af9c75b5a57890fb44a9004fb)|`Trac #28094: add some examples to showcase function fields over QQ`|\n|[5cfd3d7](https://git.sagemath.org/sage.git/commit/?id=5cfd3d71b98d7261efe73056e8918204ac1dd9aa)|`Trac #28094: Move _inversion_isomorphism from FunctionField_global to superclass FunctionField_polymod`|\n|[6e9b58f](https://git.sagemath.org/sage.git/commit/?id=6e9b58faf623a5bd83a20fc8703995ffa3e8658c)|`Trac #28094: update a failing doctest`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[4e584b5](https://git.sagemath.org/sage.git/commit/?id=4e584b5c3779bf2723ab8b543d6efe762030d1ec)|`Trac #28094: a slight patch since QQbar isn't considered a NumberField`|",
    "created_at": "2019-10-11T16:46:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[623ba60](https://git.sagemath.org/sage.git/commit/?id=623ba602c679d742b3ba3a9a876e78c5c4a5c2dd)|`Trac #28094: add some doctests for function fields over QQ and NumberField's`|\n|[49c3aec](https://git.sagemath.org/sage.git/commit/?id=49c3aec301f0439f18f66413f0c16d1360f32584)|`Trac #28094: move method `higher_derivative` to superclass FunctionFieldElement`|",
    "created_at": "2019-10-24T19:53:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[76cd59e](https://git.sagemath.org/sage.git/commit/?id=76cd59e3f6e077980248314e33de020c5647da81)|`Trac #28094: add more doctests for characteristic zero`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[85d5640](https://git.sagemath.org/sage.git/commit/?id=85d564040b0e8b1d4d34381f409e6cd6873f6095)|`Trac #28094: add more characteristic zero doctests`|\n|[bb6d83c](https://git.sagemath.org/sage.git/commit/?id=bb6d83c7d979df945de62bdfb2d7a62b16eb5167)|`Trac #28094: documentation indicates that advanced calculations now available`|",
    "created_at": "2019-10-27T18:09:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[a72c518](https://git.sagemath.org/sage.git/commit/?id=a72c5188a801af2bc6a2225365bb5f76c5d2730f)|`Merge tag '9.0.beta3' into public/28094`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[07b6a0c](https://git.sagemath.org/sage.git/commit/?id=07b6a0c20a26c08aaf16c192830cd095128ae2a7)|`Merge tag '9.0.beta4' into public/28094`|",
    "created_at": "2019-11-04T22:20:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[55b65b0](https://git.sagemath.org/sage.git/commit/?id=55b65b045d435f89ffc5d150fa447438f5590a1e)|`Trac #28094: improve _singular_normal()`|\n|[0f55dd2](https://git.sagemath.org/sage.git/commit/?id=0f55dd243c79f198a0efa5e6d9f3069088c29d84)|`Trac #28094: address issues raised in tscrim's[comment:12](#comment%3A12)`|\n|[c6af97a](https://git.sagemath.org/sage.git/commit/?id=c6af97a280d859d5e655ca77f389f02c517de305)|`Trac #28094: move `places_above` from FunctionField_global to`|\n|[71f5f18](https://git.sagemath.org/sage.git/commit/?id=71f5f18f8f56796ba929142c90300d39b6f0c5ac)|`Trac #28094: major bug fix.  Correctly calculate residue fields`|\n|[a96e079](https://git.sagemath.org/sage.git/commit/?id=a96e079ce57ae5f9d878f77dc2fad28349d4c0e0)|`Trac #28094: bug fix.  Correctly compute residue fields and`|\n|[5f162a4](https://git.sagemath.org/sage.git/commit/?id=5f162a448cb708fed40bebc1345fd656f918aed3)|`Trac #28094: add a basic test case for func fields over QQbar`|\n|[9465800](https://git.sagemath.org/sage.git/commit/?id=9465800b60cd5a047a1f00f5d713526d7dbcc181)|`Merge tag '9.0.beta7' into public/28094`|\n|[f9bab18](https://git.sagemath.org/sage.git/commit/?id=f9bab18e403c62f5f66d591e11008bd6a0c134c5)|`Trac #28094: pass list (not generator) to FiniteDimensionalAlgebra`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[c831ab1](https://git.sagemath.org/sage.git/commit/?id=c831ab155ac956b14c62ac627bf06f3bc8b6501d)|`Trac #28094: replace some code accidently dropped in 06ba5dac`|\n|[87fe147](https://git.sagemath.org/sage.git/commit/?id=87fe1472c7da2912d4ff68c1cc42b4fe3a8447b4)|`Trac #28094: add klee's doctest that caught the problem fixed by c831ab15`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[d36e58b](https://git.sagemath.org/sage.git/commit/?id=d36e58bc3c4773980c6ab6c21c16fd0aaba5bd2b)|`Trac #28094: add Brent Baccala as author to some files where`|\n|[790cf8b](https://git.sagemath.org/sage.git/commit/?id=790cf8b26d69c68b1d233a7201baed3dbacf1b20)|`Trac #28094: update documentation to reflect improved support`|\n|[5d26c7d](https://git.sagemath.org/sage.git/commit/?id=5d26c7d3075da6c6e489c0879b500c5f3716ed9d)|`Trac #28094: change an error message to better reflect its cause`|\n|[06f81e2](https://git.sagemath.org/sage.git/commit/?id=06f81e28e1d7c7f4babfa2db1a3d2e2725bde0a8)|`Trac #28094: add more examples and test cases for characteristic zero`|\n|[492a667](https://git.sagemath.org/sage.git/commit/?id=492a6677006eedd3a7205add2d363f0424edfb1c)|`Merge tag '9.0.beta9' into public/28094`|",
    "created_at": "2019-12-10T05:36:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[6760fd4](https://git.sagemath.org/sage.git/commit/?id=6760fd41d1676cbef776396b9ea28487e8524871)|`Lots of clean-ups`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[77dbf93](https://git.sagemath.org/sage.git/commit/?id=77dbf93d3116cf33e090d79607803d96c349e68b)|`Recover normalization algorithm for global function fields`|",
    "created_at": "2019-12-19T12:03:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28094",
    "type": "issue_comment",
