...
<a id='comment:14'></a>I've addressed all of the issues from[comment:12](#comment%3A12) and have fixed a serious bug that I uncovered with some more testing.
...
<a id='comment:17'></a>Replying to [klee](#comment%3A15):
