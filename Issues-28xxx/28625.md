...
<a id='comment:4'></a>Running f_vector twice on truncated_dodecahedron will ignore the error and create a wrong f_vector
...
```json
{
    "body": "<a id='comment:7'></a>It looks good now.",
...
<a id='comment:7'></a>It looks good now.
...
```json
{
    "body": "<a id='comment:9'></a>missing author name",
...
<a id='comment:9'></a>missing author name
...
<a id='comment:11'></a>Just a comment. I have no idea where this was added due to the 1000 tickets:
...
<a id='comment:14'></a>Replying to [jipilab](#comment%3A13):
> Replying to [gh-kliem](#comment%3A12):
> > Replying to [jipilab](#comment%3A11):
> > > Just a comment. I have no idea where this was added due to the 1000 tickets:
> > > 
