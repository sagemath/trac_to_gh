# Issue 28672: Allow overriding "when building, check that user isn't root" for use in Docker containers with configure --enable-build-as-root
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28672#event-73151"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28672#event-73152"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28672#event-73153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28672",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28672#event-73154"
}
```
