...
```json
{
    "body": "<a id='comment:2'></a>At this point I'm not even certain it has anything to with libgap.  That's just the context in which this first started appearing for me.  It could also be a CPython bug.",
    "created_at": "2019-07-03T14:24:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544495",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>At this point I'm not even certain it has anything to with libgap.  That's just the context in which this first started appearing for me.  It could also be a CPython bug.
...
```json
{
    "body": "<a id='comment:3'></a>Sometimes I forget that on Linux we run the tests by default with `--memlimit=3300` which sets `RLIMIT_AS`.\n\nI wonder if that's all it is.",
    "created_at": "2019-07-03T14:43:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544496",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>Sometimes I forget that on Linux we run the tests by default with `--memlimit=3300` which sets `RLIMIT_AS`.
...
```json
{
    "body": "<a id='comment:6'></a>One little thing we can do that happens to be good-enough for this case, it seems, is to further limit the amount of workspace Pari allocates by default, just when running the test suite.\n\nSince many tests won't require that much memory for Pari this seems sensible.\n\nIn the case of this particular test the other issue is just reducing the amount of memory used when instantiating large Tableaux classes.  I have opened #28114 for that.",
    "created_at": "2019-07-04T14:39:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544499",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>One little thing we can do that happens to be good-enough for this case, it seems, is to further limit the amount of workspace Pari allocates by default, just when running the test suite.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544500",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544501",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/embray/ticket-28106\"",
    "created_at": "2019-07-04T14:39:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544502",
    "user": "https://github.com/embray"
}
```

Changing branch from "" to "u/embray/ticket-28106"
...
```json
{
    "body": "Changing commit from \"\" to \"52b922ff9310b8ef5cda788e11a4cb7be5fe4895\"",
    "created_at": "2019-07-04T14:39:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544503",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "52b922ff9310b8ef5cda788e11a4cb7be5fe4895"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544504",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I am a little split on this. I agree that we don't really need it for the doctests, but I don't like making the behavior different than what is done within a Sage session. Or is there something special with Cygwin and/or the doctest framework going on here?",
    "created_at": "2019-07-08T13:20:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544505",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>I am a little split on this. I agree that we don't really need it for the doctests, but I don't like making the behavior different than what is done within a Sage session. Or is there something special with Cygwin and/or the doctest framework going on here?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544507",
...
```json
{
    "body": "<a id='comment:10'></a>I'm also hitting this on the buildbot, unsurprisingly.\n\nIMHO its reasonable to provide less memory specifically for doctests, if only to encourage authors to limit resource usage when writing tests.",
    "created_at": "2019-07-13T09:40:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544508",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>I'm also hitting this on the buildbot, unsurprisingly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544509",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544511",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I still see this on my Fedora desktop, as I run tests with `--long` on. There seems to be something Fedora-specific here.",
    "created_at": "2019-07-13T12:09:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544512",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>I still see this on my Fedora desktop, as I run tests with `--long` on. There seems to be something Fedora-specific here.
...
```json
{
    "body": "<a id='comment:13'></a>Can we just reduce `StandardTableaux(50)` to something smaller here?\n\nThis is on Debian fwiw.",
    "created_at": "2019-07-13T12:12:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544513",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>Can we just reduce `StandardTableaux(50)` to something smaller here?
...
```json
{
    "body": "<a id='comment:14'></a>hmm, but it is fast (for me, on Debian 10):\n\n```\nsage: timeit(\"StandardTableaux(50).cardinality()\")\n5 loops, best of 3: 169 \u03bcs per loop\n```\nIt is not constructing this huge set for sure...",
    "created_at": "2019-07-13T12:31:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544514",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:14'></a>hmm, but it is fast (for me, on Debian 10):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544515",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>The current branch does not work as intended because `DOCTEST_MODE` is not set yet when Pari is initialized. Perhaps it could be set earlier on, in sage-runtests?",
    "created_at": "2019-07-24T09:31:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544516",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:16'></a>The current branch does not work as intended because `DOCTEST_MODE` is not set yet when Pari is initialized. Perhaps it could be set earlier on, in sage-runtests?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544517",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Hmm...I thought I had some reason for not doing that when I looked at it for[comment:15](#comment%3A15), but the logic all seems to checkout. There is one small behavior change: If it was given a finite iterator before, it would know it is a finite enumerated set, but now that doesn't happen (infinite iterators would loop forever before)\n\n```\nsage: iter([1,2,3,4,5]) in FiniteEnumeratedSets()\nFalse\n```\nSo I think that is a safe change.",
    "created_at": "2019-07-26T20:23:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544518",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:18'></a>Hmm...I thought I had some reason for not doing that when I looked at it for[comment:15](#comment%3A15), but the logic all seems to checkout. There is one small behavior change: If it was given a finite iterator before, it would know it is a finite enumerated set, but now that doesn't happen (infinite iterators would loop forever before)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544519",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I opened #28273 implementing this. I created a new ticket for this, as Erik's approach tried here is justified in its own right.\n\nReplying to [tscrim](#comment%3A20):\n> I mean the same input will result in a different object being created (i.e., the behavior) with your branch if it was given an iterator/generator. You are not just changing things that affect only `DisjointUnionEnumeratedSets`. The `family` change in `facade_sets` can affect many other things. Granted, doing things this way is arguably safer, but I am just pointing out a difference here.\n\n\nOk, I see. Indeed the change in `facade_sets` could affect other things \u2013 though within the Sage library it should not affect anything, as `_facade_for` is always a tuple, currently. This assumption could easily break in the future though, so I think it is safer to do things as in #28273, which does not touch facade_sets.py at all.",
    "created_at": "2019-07-28T13:20:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544521",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:21'></a>I opened #28273 implementing this. I created a new ticket for this, as Erik's approach tried here is justified in its own right.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544524",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"52b922ff9310b8ef5cda788e11a4cb7be5fe4895\" to \"c6ff771f9f11e131fc55e3db6e17b778c67407d6\"",
    "created_at": "2019-08-02T12:56:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544525",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "52b922ff9310b8ef5cda788e11a4cb7be5fe4895" to "c6ff771f9f11e131fc55e3db6e17b778c67407d6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544526",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>I rebased the branch on current develop, and added a fix to ensure that pari was not being initialized so much earlier than intended during import of the doctest sub-package.",
    "created_at": "2019-08-02T12:57:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544527",
    "user": "https://github.com/embray"
}
```

<a id='comment:25'></a>I rebased the branch on current develop, and added a fix to ensure that pari was not being initialized so much earlier than intended during import of the doctest sub-package.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544528",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Now there are several doctest failures as a result of the reduced Pari stack size, see the patchbot, so I am setting back to needs work. I have only had a brief look, but some of them seem hard to solve.\n\nAlso, considering that relying on a specific load order could be a bit fragile, would it be possible to add a doctest or an assertion to check that Pari is loaded after `DOCTEST_MODE` is set?",
    "created_at": "2019-08-05T18:39:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544529",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:26'></a>Now there are several doctest failures as a result of the reduced Pari stack size, see the patchbot, so I am setting back to needs work. I have only had a brief look, but some of them seem hard to solve.
...
```json
{
    "body": "<a id='comment:27'></a>Replying to [gh-mwageringel](#comment%3A26):\n> Also, considering that relying on a specific load order could be a bit fragile, would it be possible to add a doctest or an assertion to check that Pari is loaded after `DOCTEST_MODE` is set?\n\n\nI thought about that but I'm not sure exactly a good way to do that.  It might be necessary to add some kind of pari_initialized flag.",
    "created_at": "2019-08-06T12:53:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544530",
    "user": "https://github.com/embray"
}
```

<a id='comment:27'></a>Replying to [gh-mwageringel](#comment%3A26):
> Also, considering that relying on a specific load order could be a bit fragile, would it be possible to add a doctest or an assertion to check that Pari is loaded after `DOCTEST_MODE` is set?
...
```json
{
    "body": "<a id='comment:28'></a>I wonder what the absolute minimum PARI stack size needed is.  We shouldn't go below that, sure, but it's not really clear what the limit is here...",
    "created_at": "2019-08-06T13:01:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544531",
    "user": "https://github.com/embray"
}
```

<a id='comment:28'></a>I wonder what the absolute minimum PARI stack size needed is.  We shouldn't go below that, sure, but it's not really clear what the limit is here...
...
```json
{
    "body": "<a id='comment:29'></a>Pari initialisation has 2 parameters, one is stack size, another some kind of \u201cminimal prime\u201d. I had to deal with it my recent branch on #28242...",
    "created_at": "2019-08-06T13:43:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544532",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:29'></a>Pari initialisation has 2 parameters, one is stack size, another some kind of “minimal prime”. I had to deal with it my recent branch on #28242...
...
```json
{
    "body": "<a id='comment:31'></a>Replying to [embray](#comment%3A22):\n> Therefore the large vmem allocation normally allowed for PARI's initial stack needs to be scaled back that much more when running the doctests in order to leave room for other things.\n\n\nI don't like adding yet another special case for doctests. Why not simply increase the 3300 MB memory limit a bit?",
    "created_at": "2019-08-06T15:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544534",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>Replying to [embray](#comment%3A22):
> Therefore the large vmem allocation normally allowed for PARI's initial stack needs to be scaled back that much more when running the doctests in order to leave room for other things.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544536",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544537",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>Its also the only bound on actual ram usage during tests, and we should try to keep that manageable especially since tests tend to be run in parallel and cpu core count is increasing faster than ram prices are declining. Also, something <= 4gb is going to be the upper bound on 32-bit anyways.",
    "created_at": "2019-08-13T09:42:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544538",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:35'></a>Its also the only bound on actual ram usage during tests, and we should try to keep that manageable especially since tests tend to be run in parallel and cpu core count is increasing faster than ram prices are declining. Also, something <= 4gb is going to be the upper bound on 32-bit anyways.
...
```json
{
    "body": "<a id='comment:38'></a>Why aren't we just doing the obvious thing and increasing the limit from 3300MB to 3400MB? There is nothing magical about that 3300MB limit, it's mostly an arbitrary number.",
    "created_at": "2019-09-04T18:49:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544541",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:38'></a>Why aren't we just doing the obvious thing and increasing the limit from 3300MB to 3400MB? There is nothing magical about that 3300MB limit, it's mostly an arbitrary number.
...
```json
{
    "body": "<a id='comment:39'></a>Sure, I obviously wouldn't mind increasing the limit.  I just wonder how sustainable that is.  Perhaps a few more tests should be marked `# optional - memlimit` if this becomes a frequent problem.\n\nIt also makes me wonder if there aren't memory leaks that should be investigated.",
    "created_at": "2019-09-18T12:27:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544542",
    "user": "https://github.com/embray"
}
```

<a id='comment:39'></a>Sure, I obviously wouldn't mind increasing the limit.  I just wonder how sustainable that is.  Perhaps a few more tests should be marked `# optional - memlimit` if this becomes a frequent problem.
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69707"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Ticket retargeted after milestone closed",
    "created_at": "2019-12-30T14:48:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544543",
    "user": "https://github.com/embray"
}
```

<a id='comment:40'></a>Ticket retargeted after milestone closed
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69708"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69709"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69710"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544544",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69712"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69713"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Ticket #31395 removed `memlimit` for doctests.",
    "created_at": "2021-04-06T11:16:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544545",
    "user": "https://github.com/slel"
}
```

<a id='comment:44'></a>Ticket #31395 removed `memlimit` for doctests.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69714"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544546",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544547",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544548",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544549",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28106#event-69716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28106#issuecomment-544550",
    "user": "https://github.com/mkoeppe"
}
```
