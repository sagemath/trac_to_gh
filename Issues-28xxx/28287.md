...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548846",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Also I'll note that, in the process of trying to test this manually, I got bitten by [this issue](https://groups.google.com/d/msg/sage-devel/xjADjJJChtU/jzicLwjAFQAJ) again, which I see now that we never made a ticket for.  I'll go do that now.",
    "created_at": "2019-07-30T09:29:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548847",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>Also I'll note that, in the process of trying to test this manually, I got bitten by [this issue](https://groups.google.com/d/msg/sage-devel/xjADjJJChtU/jzicLwjAFQAJ) again, which I see now that we never made a ticket for.  I'll go do that now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548849",
...
```json
{
    "body": "<a id='comment:5'></a>One more example for `alarm` being messed up with `sage -t`:\n\nhttps://groups.google.com/d/msg/sage-devel/wqnilUCLsT4/4riK4FnhDQAJ\n\nIn sage/rings/integer.pyx the alarm interrupts takes much longer than they should take, when using `sage -t`.",
    "created_at": "2019-07-30T11:11:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548850",
    "user": "https://github.com/kliem"
}
```

<a id='comment:5'></a>One more example for `alarm` being messed up with `sage -t`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548851",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548852",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548853",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548854",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548855",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548856",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548857",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Thanks, I think maybe that's the best for now.  Writing a test like this to work reliably is hard, and unless there's a specific *regression* to test related to interruptability I don't know that such tests add much value.\n\nIf you do want to have one, it has to be a case where it for sure won't return unless interrupted.",
    "created_at": "2019-08-02T09:07:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548858",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>Thanks, I think maybe that's the best for now.  Writing a test like this to work reliably is hard, and unless there's a specific *regression* to test related to interruptability I don't know that such tests add much value.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28287#event-70590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548859",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28287#issuecomment-548860",
    "user": "https://github.com/vbraun"
}
```
