...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28287#event-370021"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28287#event-370022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28287#event-370023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28287#event-370024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28287#issuecomment-443851",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28287#issuecomment-443852",
