...
{
    "assignees": [],
    "body": "<div id=\"comment:0\"></div>\n\nOn my machine where the system NTL is used, the optional package barvinok fails to build (Sage version 8.9.beta8). The relevant\n- [Sage config.log](https://github.com/sagemath/sage/files/ticket28406/config.log)\n- [barvinok-0.41.1.log\u200b](https://github.com/sagemath/sage/files/ticket28406/barvinok-0.41.1.log)\n- [barvinok config.log](https://github.com/sagemath/sage/files/ticket28406/barvinok-config.log)\n\n\nCC:  @dimpase @antonio-rojas\n\nComponent: **packages: optional**\n\nReviewer: **Dima Pasechnik**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/28406_\n\n",
