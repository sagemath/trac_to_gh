...
```json
{
    "body": "<a id='comment:8'></a>If I read comment:6 correctly, you should be able to install an update to NTL that fixes the issue.",
...
<a id='comment:8'></a>If I read comment:6 correctly, you should be able to install an update to NTL that fixes the issue.
