# Issue 28152: Support constructing Singular ring with ring order with 'c' or 'C'
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28152#event-70976"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28152#event-70977"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28152#event-70978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28152",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28152#event-70979"
}
```
