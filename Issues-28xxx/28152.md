...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28152#issuecomment-440962",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28152#issuecomment-440963",
    "user": "https://github.com/hensc"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28152#event-367850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28152#event-367851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28152#event-367852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28152",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28152#event-367853"
}
```
