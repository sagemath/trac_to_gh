...
```json
{
    "body": "<a id='comment:4'></a>Singular's deg function calls `p_LDeg` [(source)](https://github.com/Singular/Sources/blob/Release-4-1-2/Singular/iparith.cc#L3866), so we should use that instead. This eliminates the need to explicitly loop over the monomials.",
    "created_at": "2020-01-06T19:00:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562649",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:4'></a>Singular's deg function calls `p_LDeg` [(source)](https://github.com/Singular/Sources/blob/Release-4-1-2/Singular/iparith.cc#L3866), so we should use that instead. This eliminates the need to explicitly loop over the monomials.
...
```json
{
    "body": "<a id='comment:6'></a>> Note that the \"loop\" thing is not necessary. So this will speed up things.\n\n\nThis is wrong. I forgot that the monomial ordering might be incompatible with degrees. Anyway, this part needs to be optimized as this would affect the overall performance of polynomial arithmetic of Sage...",
    "created_at": "2020-01-07T11:22:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562651",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:6'></a>> Note that the "loop" thing is not necessary. So this will speed up things.
...
```json
{
    "body": "<a id='comment:7'></a>The bug in Singular about the wrong `OrdSgn` value was reported in \n\nhttps://www.singular.uni-kl.de/forum/viewtopic.php?f=10&t=2899",
    "created_at": "2020-01-08T02:13:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562652",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:7'></a>The bug in Singular about the wrong `OrdSgn` value was reported in 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562653",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/klee/28954\"",
    "created_at": "2020-01-13T04:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562654",
    "user": "https://github.com/kwankyu"
}
```

Changing branch from "" to "u/klee/28954"
...
```json
{
    "body": "Changing commit from \"\" to \"b8f53f72e817e78722ad1b40d70aa9071426700b\"",
    "created_at": "2020-01-13T04:03:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562655",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "b8f53f72e817e78722ad1b40d70aa9071426700b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562656",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562657",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"b8f53f72e817e78722ad1b40d70aa9071426700b\" to \"7ccd0d206c574b696481f161e364b46b67fd2ef9\"",
    "created_at": "2020-01-13T04:05:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562658",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b8f53f72e817e78722ad1b40d70aa9071426700b" to "7ccd0d206c574b696481f161e364b46b67fd2ef9"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562662",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>> I would prefer the present branch and bear with the bug until Singular gets the regular upgrade. \n\n\nNow I prefer using `p_LDeg'!",
    "created_at": "2020-01-15T15:13:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562664",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:16'></a>> I would prefer the present branch and bear with the bug until Singular gets the regular upgrade. 
...
```json
{
    "body": "Changing commit from \"7ccd0d206c574b696481f161e364b46b67fd2ef9\" to \"896d628d5e3de70e01afac79f484c2fc22687b0e\"",
    "created_at": "2020-01-16T02:57:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562665",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "7ccd0d206c574b696481f161e364b46b67fd2ef9" to "896d628d5e3de70e01afac79f484c2fc22687b0e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562666",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562667",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562668",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"896d628d5e3de70e01afac79f484c2fc22687b0e\" to \"06c2c54e251d6dc69dbb01f36c18990881e8c808\"",
    "created_at": "2020-01-16T03:12:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562669",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "896d628d5e3de70e01afac79f484c2fc22687b0e" to "06c2c54e251d6dc69dbb01f36c18990881e8c808"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562671",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562672",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"06c2c54e251d6dc69dbb01f36c18990881e8c808\" to \"0100ac05053ca466fadabc168577971d11e2e97d\"",
    "created_at": "2020-01-17T02:52:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562673",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "06c2c54e251d6dc69dbb01f36c18990881e8c808" to "0100ac05053ca466fadabc168577971d11e2e97d"
...
```json
{
    "body": "<a id='comment:22'></a>Replying to [gh-mwageringel](#comment%3A20):\n> Replying to [klee](#comment%3A14):\n> > If we do not wait the regular upgrade of Singular, the upstream fix should go to the Singular package of Sage, as a patch (and be removed when the regular upgrade arrives). I guess this is not a good thing to do.\n\n> \n> Ok, if we use `p_LDeg`, we do not actually need the upstream fix.\n\n\nRight.\n \n> Could you add a doctest for the example in the ticket description, please? Also, I think we should keep one example of a matrix ordering with zeros in the first row, in order to document the fact that standard grading is now used in that case.\n\n\nDone.\n\n> Finally, the imports `p_Deg, p_Totaldegree, p_WTotaldegree, p_WDegree` are not used anymore and could be removed.\n\n\nDone.",
    "created_at": "2020-01-17T02:54:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562674",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:22'></a>Replying to [gh-mwageringel](#comment%3A20):
> Replying to [klee](#comment%3A14):
> > If we do not wait the regular upgrade of Singular, the upstream fix should go to the Singular package of Sage, as a patch (and be removed when the regular upgrade arrives). I guess this is not a good thing to do.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562675",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562676",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "Changing branch from \"u/klee/28954\" to \"0100ac05053ca466fadabc168577971d11e2e97d\"",
    "created_at": "2020-01-20T21:18:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562677",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/klee/28954" to "0100ac05053ca466fadabc168577971d11e2e97d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28954#event-73331"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28954#issuecomment-562678",
    "user": "https://github.com/vbraun"
}
```
