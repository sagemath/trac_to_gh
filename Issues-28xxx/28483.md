...
```json
{
    "body": "Attachment [sage_build.log](tarball://root/attachments/some-uuid/ticket28483/sage_build.log) by tmonteil created at 2019-09-13 13:23:49\n\nDid you try `make doc-clean` as suggested ?",
...
Attachment [sage_build.log](tarball://root/attachments/some-uuid/ticket28483/sage_build.log) by tmonteil created at 2019-09-13 13:23:49
...
```json
{
    "body": "What if you set `SAGE_NUM_THREADS=1` in your environment?",
