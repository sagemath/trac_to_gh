...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561254",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28892#event-73098"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28892#event-73099"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28892#event-73100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561255",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561256",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561257",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>`backports_ssl_match_hostname` was removed in #29754, so I have narrowed the ticket to `certifi`.\n\n`tornado` is updated in #26919.\nIt should be checked what the situation with `certifi` is in the new version.",
    "created_at": "2020-08-13T17:19:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561258",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>`backports_ssl_match_hostname` was removed in #29754, so I have narrowed the ticket to `certifi`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561259",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Also matplotlib 3.3.1 (#30358) wants `certifi`.",
    "created_at": "2020-08-14T20:51:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561260",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Also matplotlib 3.3.1 (#30358) wants `certifi`.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28892#event-73101"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28892#event-73102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561261",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>It looks like we could comment out the dependency in matplotlib, too, but I'm not volunteering to do it so I rescind the suggestion.",
    "created_at": "2020-08-14T21:28:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561262",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:6'></a>It looks like we could comment out the dependency in matplotlib, too, but I'm not volunteering to do it so I rescind the suggestion.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561263",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561264",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28892#event-73103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28892#issuecomment-561265",
    "user": "https://github.com/embray"
}
```
