...
```json
{
    "body": "<a id='comment:1'></a>- If the doc does not build, just use \"make build\" instead of \"make\"\n\n- You can already compile and use sage with python3, as explained on top of #15530",
    "created_at": "2019-07-07T14:38:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28128#issuecomment-419301",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>- If the doc does not build, just use "make build" instead of "make"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28128#issuecomment-419302",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28128#event-69809"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28128#issuecomment-419303",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28128#event-69810"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28128#event-69811"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28128#event-69812"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28128#event-69813"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This is likely outdated now that we have switched to Python 3.",
    "created_at": "2020-06-14T19:38:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28128#issuecomment-419304",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>This is likely outdated now that we have switched to Python 3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28128#issuecomment-419305",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28128#issuecomment-419306",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28128",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28128#event-69814"
}
```
