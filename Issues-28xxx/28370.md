...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550234",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550235",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I just think that #28321 is to blame (Python 3 issue)",
    "created_at": "2019-08-20T08:38:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550236",
    "user": "https://github.com/videlec"
}
```

<a id='comment:2'></a>I just think that #28321 is to blame (Python 3 issue)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550237",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>You mean that it would be a duplicate? i.e. that the backend is fine?",
    "created_at": "2019-08-20T08:53:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550238",
    "user": "https://github.com/jplab"
}
```

<a id='comment:3'></a>You mean that it would be a duplicate? i.e. that the backend is fine?
...
```json
{
    "body": "<a id='comment:4'></a>It is probably not a problem with the backend.",
    "created_at": "2019-08-20T08:57:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550239",
    "user": "https://github.com/videlec"
}
```

<a id='comment:4'></a>It is probably not a problem with the backend.
...
```json
{
    "body": "<a id='comment:5'></a>I confirm that it is solved with #28321... however, the fact that errors are not raised in the constructor is a bug in itself. In the example I wrote in the ticket description, I obtain a polytope `P` which is simply wrong. It is to my mind much better to get an error rather than false results.",
    "created_at": "2019-08-20T11:37:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550240",
    "user": "https://github.com/videlec"
}
```

<a id='comment:5'></a>I confirm that it is solved with #28321... however, the fact that errors are not raised in the constructor is a bug in itself. In the example I wrote in the ticket description, I obtain a polytope `P` which is simply wrong. It is to my mind much better to get an error rather than false results.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550241",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550242",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28370#event-70876"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550243",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550244",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550245",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28370#issuecomment-550246",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28370",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28370#event-70877"
}
```
