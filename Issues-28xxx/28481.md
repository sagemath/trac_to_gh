...
```json
{
    "body": "LGTM if patch bot is happy",
...
```json
{
    "body": "By the way, the patchbot reported small issues (pyflakes + one method not documented)",
...
```json
{
    "body": "I think I fixed the doctest and pyflakes errors.  Setting to Needs Review so that the patchbot can check.  I haven't addressed Xavier's most recent comments yet....",
