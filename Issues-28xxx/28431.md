...
```json
{
    "body": "Changing stopgaps from \"\" to \"use `algorithm='sympy'` in the integrate call\"",
    "created_at": "2019-08-30T17:56:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551345",
    "user": "https://github.com/gutow"
}
```

Changing stopgaps from "" to "use `algorithm='sympy'` in the integrate call"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551346",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I believe I have isolated this to maxima or how Sage is using it.\n\nIncorrect:\n\n```\n>integrate(1/(a-b*n),a, algorithm='maxima')\nlog(b*n - a)\n```\n\nCorrect:\n\n```\n>integrate(1/(a-b*n),a, algorithm='sympy')\nlog(-b*n + a)\n```",
    "created_at": "2019-08-30T17:56:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551347",
    "user": "https://github.com/gutow"
}
```

<a id='comment:1'></a>I believe I have isolated this to maxima or how Sage is using it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551348",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551350",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I think that `integrate(1/(x-a), x)` should actually be `log(abs(x-a))`, because for `x < a` the expression `log(x-a)` doesn't make much sense, does it?",
    "created_at": "2019-11-20T19:26:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551352",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:4'></a>I think that `integrate(1/(x-a), x)` should actually be `log(abs(x-a))`, because for `x < a` the expression `log(x-a)` doesn't make much sense, does it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551354",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551355",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [charpent](#comment%3A6):\n\nTo illustrate, compare:\n\n```\nsage: integrate(1/x, x, -3, -1)\n-log(3)\nsage: integrate(1/x, x, -3, 1)\n---------------------------------------------------------------------------\nRuntimeError                              Traceback (most recent call last)\n\n[ Snip... ]\n\nValueError: Integral is divergent.\n```",
    "created_at": "2019-11-20T20:57:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551356",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:8'></a>Replying to [charpent](#comment%3A6):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551357",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Sorry about my mistake, I thought that we were playing in the reals.",
    "created_at": "2019-11-20T21:32:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551358",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:10'></a>Sorry about my mistake, I thought that we were playing in the reals.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551361",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>So Sage needs to be clear about what conditions the solution holds for. It should also work correctly if forced to use real numbers and get the sign correct without a hidden constant of integration. If Maxima can handle this Sage should too.",
    "created_at": "2019-11-21T00:44:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551362",
    "user": "https://github.com/gutow"
}
```

<a id='comment:14'></a>So Sage needs to be clear about what conditions the solution holds for. It should also work correctly if forced to use real numbers and get the sign correct without a hidden constant of integration. If Maxima can handle this Sage should too.
...
```json
{
    "body": "<a id='comment:15'></a>Thinking on this a little more, another option that does not hide a mysterious choice of integration constants, such as log(-1), would be to provide multiple valid integrations. I'm thinking of behavior something like this:\n\n```\n>(1/(a-b)).integrate(a)\n   [log(a-b),log(b-a)]\n```\nas when reporting other results with multiple valid solutions. This would leave the user to pick the correct one for their situation. If they are limited to real numbers then they would pick the version that provides positive input to the log function.\n\nI am not sure about how this generalizes.",
    "created_at": "2019-12-03T02:48:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551363",
    "user": "https://github.com/gutow"
}
```

<a id='comment:15'></a>Thinking on this a little more, another option that does not hide a mysterious choice of integration constants, such as log(-1), would be to provide multiple valid integrations. I'm thinking of behavior something like this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551364",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551365",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71116"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551366",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71117"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71118"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71119"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71120"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I'm not even sure this is an error, but at any rate this is not critical, given that (up to integration constants and branch choice) this is correct.\n\nAs to documentation, there are a few places where we do mention this (IIRC).  We haven't apologized for it, and I don't think we have to, but it's certainly true that it's confusing, and adding to the documentation in some *visible* places would be salutary.",
    "created_at": "2021-03-25T12:34:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551367",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>I'm not even sure this is an error, but at any rate this is not critical, given that (up to integration constants and branch choice) this is correct.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551368",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Also, to Jonathan's suggestion, it seems like making the context in[comment:6](#comment%3A6) more advertised would be useful.  But since neither Sympy nor Maxima add the absolute value, I'm not sure if that aspect is really 'fixable'.",
    "created_at": "2021-03-25T12:40:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551369",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>Also, to Jonathan's suggestion, it seems like making the context in[comment:6](#comment%3A6) more advertised would be useful.  But since neither Sympy nor Maxima add the absolute value, I'm not sure if that aspect is really 'fixable'.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551370",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>That may be true, but if Maxima and Sympy don't, I'm not sure how we can :(",
    "created_at": "2021-03-25T15:27:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551371",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:24'></a>That may be true, but if Maxima and Sympy don't, I'm not sure how we can :(
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71121"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28431#event-71122"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Could open an issue with https://github.com/sympy/sympy expressing this feature request.",
    "created_at": "2021-03-25T16:16:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28431#issuecomment-551372",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:25'></a>Could open an issue with https://github.com/sympy/sympy expressing this feature request.
