...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431590",
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28940#event-73290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431591",
...
```json
{
    "body": "<a id='comment:4'></a>Author: field is for the full name of the (intended, or real) author of the branch with the fix.",
    "created_at": "2020-08-27T13:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431593",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>Author: field is for the full name of the (intended, or real) author of the branch with the fix.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28940#event-73291"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28940#event-73292"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>this is basically a duplicate of #28941",
    "created_at": "2020-08-31T22:03:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431594",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:5'></a>this is basically a duplicate of #28941
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431595",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431596",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28940#issuecomment-431597",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28940",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28940#event-73293"
}
```
