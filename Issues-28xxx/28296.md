...
```json
{
    "body": "<a id='comment:1'></a>This doctest is not supposed to take more than a second\n\n```\n    sage: alarm(1.0)\n    sage: z2 = QQbar.polynomial_root(p4, ival)\n    sage: cancel_alarm()\n```\nShould I increase to 5?",
    "created_at": "2019-07-30T22:32:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-548996",
    "user": "https://github.com/videlec"
}
```

<a id='comment:1'></a>This doctest is not supposed to take more than a second
...
```json
{
    "body": "<a id='comment:2'></a>Did you try running it on a raspberry pi, for example? I understand why you would want to test for speed regressions, but this isn't a good way of doing it.  \n\nThe doctest framework has already an overall speed factor of the machine, collected from previous runs. It is used for the \"slow doctest\" warning. At the very least this shoud be taken into account. For failed tests it should also display the actual time taken, not just crash in an AlarmInterrupt.",
    "created_at": "2019-07-31T07:07:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-548997",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Did you try running it on a raspberry pi, for example? I understand why you would want to test for speed regressions, but this isn't a good way of doing it.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-548998",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Sure. The point that I'm trying to make is that, at least for now, you have to be *very* conservative with the upper time limit in a doctest.",
    "created_at": "2019-07-31T09:24:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-548999",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>Sure. The point that I'm trying to make is that, at least for now, you have to be *very* conservative with the upper time limit in a doctest.
...
```json
{
    "body": "Changing commit from \"\" to \"d7174fffce47efc9230e9408dc502b2cfe16e111\"",
    "created_at": "2019-07-31T09:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549000",
    "user": "https://github.com/videlec"
}
```

Changing commit from "" to "d7174fffce47efc9230e9408dc502b2cfe16e111"
...
```json
{
    "body": "Changing branch from \"\" to \"public/28296\"",
    "created_at": "2019-07-31T09:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549001",
    "user": "https://github.com/videlec"
}
```

Changing branch from "" to "public/28296"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549002",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549003",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549004",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549005",
...
```json
{
    "body": "Changing commit from \"d7174fffce47efc9230e9408dc502b2cfe16e111\" to \"12c0b209f9215c8c303253900b75d9f7613e9682\"",
    "created_at": "2019-07-31T09:28:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549006",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d7174fffce47efc9230e9408dc502b2cfe16e111" to "12c0b209f9215c8c303253900b75d9f7613e9682"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549007",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549008",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549009",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549011",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Hiding it behind a # optional - benchmark (or so) sounds like a good solution. If you make a ticket I'll review it ;-)",
    "created_at": "2019-08-02T14:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549012",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>Hiding it behind a # optional - benchmark (or so) sounds like a good solution. If you make a ticket I'll review it ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28296#event-70635"
}
```
...
```json
{
    "body": "Changing branch from \"public/28296\" to \"12c0b209f9215c8c303253900b75d9f7613e9682\"",
    "created_at": "2019-08-03T23:51:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549013",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/28296" to "12c0b209f9215c8c303253900b75d9f7613e9682"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28296#issuecomment-549014",
    "user": "https://github.com/vbraun"
}
```
