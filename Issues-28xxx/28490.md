...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28490#event-372846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28490#event-372847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28490#event-372848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28490#event-372849"
}
```
...
```json
{
    "body": "Changed keywords from **** to **preparser, py3**",
...
Changed keywords from **** to **preparser, py3**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28490#issuecomment-447096",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28490#issuecomment-447097",
