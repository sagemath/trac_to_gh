...
```json
{
    "body": "<a id='comment:2'></a>\nIs this the right approach? We could put a `try ... except` block instead: something like\n\n```\ntry:\n    x = builtins.round(x, ndigits)\nexcept TypeError:\n    x = builtins.round(float(x), ndigits)\n```\n\n---\nNew commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[4f88c7c](https://git.sagemath.org/sage.git/commit?id=4f88c7cb57778eac0e25eb8d555318aac97d8a79)|`trac 28035: py3 fix for \"round\" function in misc/functional.py`|",
    "created_at": "2019-06-21T04:48:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28035",
    "type": "issue_comment",
