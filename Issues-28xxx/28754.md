...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394933"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394936"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448641",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448642",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<div id=\"comment:3\" align=\"right\">comment:3</div>\n\nReplying to [@isuruf](#comment:1):\n> Does `python -c 'from sage.all import *'` work?\n\nYes.",
    "created_at": "2019-11-18T02:02:06Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448643",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448644",
...
```json
{
    ...
    "milestone_title": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394937"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448645",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394939"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394940"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394941"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448647",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394943"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28754#issuecomment-448648",
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394946"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394947"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394948"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394949"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394950"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394951"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28754#event-394952"
}
```
