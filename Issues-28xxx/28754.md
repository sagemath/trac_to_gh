...
```json
{
    "body": "<a id='comment:1'></a>Does `python -c 'from sage.all import *'` work?",
    "created_at": "2019-11-17T23:05:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558250",
    "user": "https://github.com/isuruf"
}
```

<a id='comment:1'></a>Does `python -c 'from sage.all import *'` work?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558251",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Replying to [isuruf](#comment%3A1):\n> Does `python -c 'from sage.all import *'` work?\n\nYes.",
    "created_at": "2019-11-18T02:02:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558252",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>Replying to [isuruf](#comment%3A1):
> Does `python -c 'from sage.all import *'` work?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558253",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558254",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72558"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72559"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72560"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72561"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558255",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558256",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72562"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72563"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The cysignals problems you mention may be related to the notes [here](https://pyjulia.readthedocs.io/en/latest/limitations.html#ctrl-c-does-not-work-terminates-the-whole-python-process).",
    "created_at": "2021-02-15T22:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28754",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28754#issuecomment-558257",
    "user": "https://github.com/roed314"
}
```

<a id='comment:9'></a>The cysignals problems you mention may be related to the notes [here](https://pyjulia.readthedocs.io/en/latest/limitations.html#ctrl-c-does-not-work-terminates-the-whole-python-process).
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72564"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72565"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72566"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72567"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72568"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72569"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72570"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28754#event-72571"
}
```
