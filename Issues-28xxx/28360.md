...
```json
{
    "body": "As can be seen on https://jupyter.org/, JupyterLab has recently reached v1.0 and become the standard jupyter notebook. While [SageMath](../wikis/SageMath) does have JupyterLab, it's stuck back at v0.33. Hence it would be nice to see an update.\n\n*First ticket on sage so let me know if I've done something wrong*\n\n**CC:**  @egourgoulhon @embray @slel\n\n**Keywords:** jupyter, jupyterlab, upgrade\n\nIssue created by migration from https://trac.sagemath.org/ticket/28360\n\n",
...
```
As can be seen on https://jupyter.org/, JupyterLab has recently reached v1.0 and become the standard jupyter notebook. While [SageMath](../wikis/SageMath) does have JupyterLab, it's stuck back at v0.33. Hence it would be nice to see an update.
...
```json
{
    "body": "<a id='comment:2'></a>\nWell, with SageMath 8.9.beta6 (Python 3 version), running\n\n```\nsage -pip install jupyterlab\n```\ninstalls JupyterLab 1.0.6. \nThen \n\n```\nsage -n jupyterlab\n```\nseems to work nice.\n\nOn the other side, with the Python 2.7 version of [SageMath](../wikis/SageMath) 8.9.beta6, only the version 0.33.12 of JupyterLab is installed. Could it be that JupyterLab 1.0 is available for Python 3 only ?",
    "created_at": "2019-08-17T10:02:37Z",
    "issue": "https://github.com/sagemath/sage/issues/28360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28360#issuecomment-444700",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28360#issuecomment-444701",
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28360#event-250908"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28360",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28360#event-250909"
}
```
