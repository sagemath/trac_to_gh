...
```json
{
    "body": "<a id='comment:12'></a>\nNew commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[b6833f7](https://git.sagemath.org/sage.git/commit?id=b6833f76d36f665bf26343415c8f5f955b1bb46c)|`Trac #28695: Make mismatch between compiler and AS/LD a fatal error.`|\n|[ca7013b](https://git.sagemath.org/sage.git/commit?id=ca7013b61464c3516db1554534f6f01f2b6514ad)|`Trac #28695: These settings (if they are even needed at all) should use`|",
