# Issue 28185: Change keyword argument 'verbose' to 'check' in CoordChange.set_inverse() and set the default to True
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28185",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28185#event-71094"
}
```
