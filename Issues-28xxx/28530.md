...
```json
{
    "body": "<a id='comment:8'></a>\nThanks for the diagnostic! Could you check how the branch works for you?\n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[ad10a8f](https://git.sagemath.org/sage.git/commit?id=ad10a8f105bc4a45d2de93d26af2b0a624ae9992)|`do not accept NaN in QQbar`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[ee0447e](https://git.sagemath.org/sage.git/commit/?id=ee0447ecc2af520609766eb4f0cfbed5d904fe46)|`regression doctest for ticket 28530`|",
