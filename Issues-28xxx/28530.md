...
```json
{
    "body": "It is worse than this. If you enter a second time the same polynomial (over K), do the base ring change one more time then it works!",
...
```json
{
    "body": "Thanks for the diagnostic! Could you check how the branch works for you?\n\n---\nNew commits:",
...
```json
{
    "body": "It works well, also with the computation that lead me to this ticket. Thank you for the fix. I hope it does not cause infinite loops.\n\nTests have passed on my end.",
