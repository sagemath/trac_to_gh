...
```json
{
    "body": "<a id='comment:3'></a>Possible dup: #27708",
...
<a id='comment:3'></a>Possible dup: #27708
...
```json
{
    "body": "<a id='comment:4'></a>Proposing to close this one as a duplicate",
...
<a id='comment:4'></a>Proposing to close this one as a duplicate
