...
```json
{
    "body": "<a id='comment:1'></a>Ticket #26002 might be related, as the same error is mentioned there. The affected doctest was added in #8573 and is meant to check for memory leaks. Is this actually a memory leak?",
    "created_at": "2019-07-10T21:30:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28162#issuecomment-393934",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:1'></a>Ticket #26002 might be related, as the same error is mentioned there. The affected doctest was added in #8573 and is meant to check for memory leaks. Is this actually a memory leak?
...
```json
{
    "body": "<a id='comment:2'></a>The real cause seems to be `MemoryError: failed to allocate 33554432 * 24 bytes`\n\nIs this a machine with few RAM?",
    "created_at": "2019-07-11T09:53:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28162#issuecomment-393935",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>The real cause seems to be `MemoryError: failed to allocate 33554432 * 24 bytes`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28162#issuecomment-393936",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28162#event-69945"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Oh, good point. The machine has plenty of RAM, but I had not realized that this is another incarnation of #28106 where the `memlimit` is hit during doctests. Raising it just a bit from 3300 to 3400 makes the test pass.\n\nThis ticket can be closed as duplicate \u2013 my bad. Thank you for the help.",
    "created_at": "2019-07-11T18:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28162#issuecomment-393937",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:3'></a>Oh, good point. The machine has plenty of RAM, but I had not realized that this is another incarnation of #28106 where the `memlimit` is hit during doctests. Raising it just a bit from 3300 to 3400 makes the test pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28162#event-69946"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28162#issuecomment-393938",
