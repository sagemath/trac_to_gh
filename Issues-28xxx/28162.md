...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28162#event-367981"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28162#event-367982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28162#event-367983"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28162#event-367984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28162#issuecomment-441248",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28162#issuecomment-441249",
    "user": "https://github.com/mwageringel"
}
```
