...
```json
{
    "body": "Ticket #26002 might be related, as the same error is mentioned there. The affected doctest was added in #8573 and is meant to check for memory leaks. Is this actually a memory leak?",
...
```json
{
    "body": "The real cause seems to be `MemoryError: failed to allocate 33554432 * 24 bytes`\n\nIs this a machine with few RAM?",
...
```json
{
    "body": "Oh, good point. The machine has plenty of RAM, but I had not realized that this is another incarnation of #28106 where the `memlimit` is hit during doctests. Raising it just a bit from 3300 to 3400 makes the test pass.\n\nThis ticket can be closed as duplicate \u2013 my bad. Thank you for the help.",
    "created_at": "2019-07-11T18:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28162",
    "type": "issue_comment",
