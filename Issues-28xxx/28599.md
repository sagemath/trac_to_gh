...
{
    "assignees": [],
    "body": "On sage 8.9 with python3, we get:\n\n```\nsage: polytopes.regular_polygon(16)\nTraceback (most recent call last):\n...\nRecursionError: maximum recursion depth exceeded while calling a Python object\n```\n\nand \n\n```\nsage: polytopes.regular_polygon(20)\nTraceback (most recent call last):\n...\nAssertionError:\n```\n\nThe full traceback of the AssertionError is in the first comment.\n\nCC:  @LaisRast @kliem @fchapoton\n\nKeywords: **polytopes**\n\nBranch/Commit: **[public/28599](https://github.com/sagemath/sagetrac-mirror/tree/public/28599) @ [`631b94b`](https://github.com/sagemath/sagetrac-mirror/commit/631b94b7ed3fd8da9ba96991991e80427f0dd0a6)**\n\nComponent: **geometry**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/28599_\n\n",
    ...
    "url": "https://github.com/sagemath/sage/issues/28599",
...
```json
{
    ...
    "created_at": "2019-10-13T11:28:01Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "milestone_number": null,
    "milestone_title": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394626"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445828",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445829",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445830",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "Branch: **[public/28599](https://github.com/sagemath/sagetrac-mirror/tree/public/28599)**",
    "created_at": "2019-11-26T10:33:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445832",
    "user": "https://github.com/kliem"
}
```

Branch: **[public/28599](https://github.com/sagemath/sagetrac-mirror/tree/public/28599)**
...
```json
{
    "body": "Commit: **[`631b94b`](https://github.com/sagemath/sagetrac-mirror/commit/631b94b7ed3fd8da9ba96991991e80427f0dd0a6)**",
    "created_at": "2019-11-26T10:33:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445833",
    "user": "https://github.com/kliem"
}
```

Commit: **[`631b94b`](https://github.com/sagemath/sagetrac-mirror/commit/631b94b7ed3fd8da9ba96991991e80427f0dd0a6)**
...
```json
{
    ...
    "milestone_title": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445834",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445835",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445836",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394632"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445837",
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394634"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28599#issuecomment-445838",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394636"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394637"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394639"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394640"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394641"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394643"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394644"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28599#event-394645"
}
```
