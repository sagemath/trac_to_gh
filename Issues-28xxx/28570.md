...
```json
{
    "body": "<a id='comment:5'></a>\nTrying to fix one of the problems.\n\n---\nNew commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[8ef9966](https://git.sagemath.org/sage.git/commit?id=8ef9966171213db2b23bc87bd7e9e1a824947566)|`trac 28570 fix one of the problems`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[8c59623](https://git.sagemath.org/sage.git/commit/?id=8c5962392dc769db108d4e0c3d29400ee42286a4)|`trac 28570 fixing the slowness problem`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[56ff2bb](https://git.sagemath.org/sage.git/commit/?id=56ff2bbdc8e0e83f6128aee294ee2e07a334932f)|`trac 28570 proper handling of Mat(ZZ)`|",
