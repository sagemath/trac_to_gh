...
```json
{
    "body": "<a id='comment:16'></a>\nI think that once your Dockerfile goes through, you just need to add your branch to `build-from-clean`, pull your image from the [GitLab](../wikis/GitLab) registry and push it to Docker Hub.",
