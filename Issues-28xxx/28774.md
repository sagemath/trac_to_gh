...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[af2d160](https://git.sagemath.org/sage.git/commit?id=af2d160c09ada2503ac39dca015908afa98bb7ec)|`embed quadratic field into algebraic (real) numbers`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[d20ed43](https://git.sagemath.org/sage.git/commit/?id=d20ed43b6ca85a79c32232e19c6b9427dcb4987c)|`fixed some failing tests`|\n|[a4a7348](https://git.sagemath.org/sage.git/commit/?id=a4a7348c66cf5838878641729ce3f768f1a47282)|`fixing some tests`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nThis is the best I can come up with.\n\nTo my understanding coercion of two number fields is only possible, if they are both embedded into `AA` (or `QQbar` with #28778) or if there is an embedding (discovered by `_internal_coerce_map_from`).\n\nRaising an error or a warning does not work, as it is being suppressed.\n\nThis depends on #28778 now, as this fixes an error (along the way), where the pushout of two number fields embedded into `RLF` is `AA`. This ticket relies on the method `_pushout_` to return `None` in this case.\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[b4b2cf1](https://git.sagemath.org/sage.git/commit?id=b4b2cf10f5e5ad6b88825ad7ab7ba82a3400a854)|`pushout for number fields with compatible embeddings`|\n|[d46d6bb](https://git.sagemath.org/sage.git/commit?id=d46d6bbbe80fdbf6bd367e2f0793b9482f644bd4)|`remove unneeded test`|\n|[9a1bce3](https://git.sagemath.org/sage.git/commit?id=9a1bce35034c4292eee9ecb8a56a19ce8bc75f94)|`small mistake in docstests`|\n|[8e70251](https://git.sagemath.org/sage.git/commit?id=8e7025115e4d2d203d67779d559ad3072c06073d)|`defining the pushout for number fields just for AA and QQbar`|\n|[0d1fc2d](https://git.sagemath.org/sage.git/commit?id=0d1fc2dcf4ee746f385a20231478b6c9a71068fd)|`Merge branch 'public/28778-bis' of git://trac.sagemath.org/sage into public/28774-new`|\n|[ad8d632](https://git.sagemath.org/sage.git/commit?id=ad8d63235dc488da8a0a38e55e07ce434f763734)|`printed a message pointing towards composite fields`|",
    "created_at": "2019-12-06T20:35:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28774",
    "type": "issue_comment",
