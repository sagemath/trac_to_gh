...
```json
{
    "body": "<a id='comment:3'></a>\nThat pull request was merged on September 4th, 2019, and sagetex-3.4 was released the following November. Sometime between then and now, the sagetex package was upgraded in [SageMath](../wikis/SageMath) to v3.4, so this should be fixed.",
    "created_at": "2020-04-04T17:50:15Z",
    "issue": "https://github.com/sagemath/sage/issues/28091",
    "type": "issue_comment",
