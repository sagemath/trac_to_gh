...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[f5b5d4f](https://git.sagemath.org/sage.git/commit?id=f5b5d4f6490d2227e76ef5e2447022f1e3f9016f)|`trac 28673: when installing IPython, do not create a symlink in spkg-install`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[d2873c2](https://git.sagemath.org/sage.git/commit/?id=d2873c2af9f2e36f7249bcf3d9a0d05e83601cb9)|`trac 28673: when installing IPython, do not create a symlink in spkg-install`|",
