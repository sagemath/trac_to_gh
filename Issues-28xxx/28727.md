...
```json
{
    "body": "<a id='comment:5'></a>\nThis is an improvement, but it does not solve the problem.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[b2a393f](https://git.sagemath.org/sage.git/commit?id=b2a393fc631523f6ed5b9e000ee7ce1802dfb716)|`trac 28727: update nose/spkg-install, try to fix nose/spkg-check`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[e665d59](https://git.sagemath.org/sage.git/commit/?id=e665d5980d215ed4784d389257ae0ebb504284b4)|`trac 28727: update nose/spkg-install, try to fix nose/spkg-check`|",
