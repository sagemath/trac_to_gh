...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546780",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546781",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546782",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546783",
    "user": "https://github.com/bgrenet"
}
```

<a id='comment:3'></a>I've made a very quick try: Instead of using the plain old Euclidean algorithm, one can use the so-called subresultant algorithm. This algorithm is already provided for UFDs so I tried to branch this algorithms for fields also. The resulting timings are still bad, but slightly less so:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546785",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I think that exact algorithm should raise an error with non-approximate base ring.",
    "created_at": "2019-07-15T12:07:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546787",
    "user": "https://github.com/videlec"
}
```

<a id='comment:7'></a>I think that exact algorithm should raise an error with non-approximate base ring.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546788",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546789",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70075"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70076"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70077"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70078"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70079"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28199#issuecomment-546790",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70081"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70082"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70083"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70084"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70085"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70086"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70087"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28199#event-70088"
}
```
