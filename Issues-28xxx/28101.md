...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[277e1d9](https://git.sagemath.org/sage.git/commit?id=277e1d9c0bfda86ed92be31d5f9641a420825475)|`update giac to version 1.5.0-61`|",
    "created_at": "2019-07-03T23:47:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28101",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[1fda15e](https://git.sagemath.org/sage.git/commit/?id=1fda15e3882261d366bcc8eb2940130c77727962)|`use \"tex.h\" rather than <tex.h> in #include`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[0be07f5](https://git.sagemath.org/sage.git/commit/?id=0be07f536d21b0c1cc2cabb72ce9fab398a8a6ee)|`more verbosity in a long optional test`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[132f560](https://git.sagemath.org/sage.git/commit/?id=132f5606bae42317f6643737f47700e4031f22d5)|`update giac to 1.5.0-63`|",
    "created_at": "2019-07-15T21:57:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28101",
    "type": "issue_comment",
