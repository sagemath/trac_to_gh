...
```json
{
    "body": "<a id='comment:1'></a>Do you know how reliably break Sage so that `./sage -f sagenb` will break as above?",
    "created_at": "2019-09-18T10:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553232",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>Do you know how reliably break Sage so that `./sage -f sagenb` will break as above?
...
```json
{
    "body": "<a id='comment:2'></a>You could do almost anything really--e.g. remove a module that's imported at startup.  The last two times I saw this come up it's because the sqlite3 module for Python didn't build (something which should also be checked; that's #27705).",
    "created_at": "2019-09-18T10:23:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553233",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>You could do almost anything really--e.g. remove a module that's imported at startup.  The last two times I saw this come up it's because the sqlite3 module for Python didn't build (something which should also be checked; that's #27705).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553234",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I have added the change in[comment:4](#comment%3A4) to the branch in #28710.",
    "created_at": "2019-11-10T11:28:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553236",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:5'></a>I have added the change in[comment:4](#comment%3A4) to the branch in #28710.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28513#event-71510"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553237",
...
```json
{
    "body": "<a id='comment:6'></a>The package used as an example in the description has been removed.\nShould this same problem surface for any other packages, its dependencies should be changed as discussed here.\nLet's close this.",
    "created_at": "2020-09-23T18:03:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553238",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>The package used as an example in the description has been removed.
Should this same problem surface for any other packages, its dependencies should be changed as discussed here.
Let's close this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553239",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553240",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553241",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28513#event-71511"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28513#issuecomment-553242",
