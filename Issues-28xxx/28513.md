...
```json
{
    "body": "<a id='comment:5'></a>I have added the change in comment:4 to the branch in #28710.",
...
<a id='comment:5'></a>I have added the change in comment:4 to the branch in #28710.
