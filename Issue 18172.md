...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244810",
...
```json
{
    "body": "I fixed a number of cases where Symbolic Ring was being returned by changing how the conversion was being done and not doing the (unnecessary) division in the [0,1] case.\n\nThere are still some obscure cases where we can't get back from the Symbolic Ring. Such as certain maps where the coordinate ring is a function field over QQbar.\n----\nNew commits:",
    "created_at": "2015-05-12T17:49:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244811",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244812",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244813",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244814",
...
```json
{
    "body": "In the very same same functions, both the `if` block and the if `code` have these definition\n\n```\n        x = self.domain().gen(0)\n        y = self.domain().gen(1)\n        F = self._polys\n        f = F\n        PHI = 1 \n```\n\ncould you move it before?",
    "created_at": "2015-05-13T20:55:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244815",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244816",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244817",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244818",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244820",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244821",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244822",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    "body": "Those changes are made and I added a comment about Maxima. I had forgotten about the TESTS section. I've added those examples there and improved one of the EXAMPLES.",
    "created_at": "2015-05-14T15:27:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244823",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244824",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244825",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244827",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244828",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18172#event-51872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18172#issuecomment-244829",
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18172#event-51873"
}
```
