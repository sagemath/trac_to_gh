...
```json
{
    "body": "So it interrupts as desired?",
    "created_at": "2021-05-27T20:12:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31631",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31631#issuecomment-451232",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "https://github.com/sebasguts/JuPyMake/commits/master has some changes that we don't have in our package yet. I don't remember the details at this point",
    "created_at": "2021-05-27T20:16:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31631",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31631#issuecomment-451234",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "We may also want to take a look at what the Julia integration of polymake (in OSCAR) does regarding interrupts.",
    "created_at": "2021-05-27T21:00:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31631",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31631#issuecomment-451235",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31631",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31631#issuecomment-451236",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84165"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84166"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84167"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84168"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84169"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84170"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31631#event-84171"
}
```
