...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290857",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290859",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290860",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290861",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "I am all for extra features and functionality, especially implemented by others, as long as it does not severely harm \"usual\" usage. Constructing Minkowski sum of cones when adding a couple of vectors does not sound reasonable to me as it is a very expensive operation for non-trivial cones.",
    "created_at": "2016-08-19T02:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290863",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290864",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56649"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56650"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21018#issuecomment-290865",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56652"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56653"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56654"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56655"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56656"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56657"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56658"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56659"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56660"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21018#event-56661"
}
```
