...
```json
{
    "body": "I'll actually upload the patches when I'm on a stable enough connection to do so...",
...
Attachment [4276-nf-coerce4.patch](tarball://root/attachments/some-uuid/ticket4276/4276-nf-coerce4.patch) by @JohnCremona created at 2008-10-22 20:04:07
...
```json
{
    "body": "Thanks very much, ncalexan, for taking over refereeing of this patch. I don't have the background to review something like this (my initial attempts above made me realise that) and I was worried that other more qualified people would now assume I had it under control.",
...
```json
{
    "body": "I've rebased against 3.2.1. Still building, but I'm off to bed.",
...
```json
{
    "body": "4276-nf-coerce-fixes.patch does also fix the doctest failure for me, so we finally have no more doctest failures with this and the two patches from #3623 applied.\n\nCheers,\n\nMichael",
...
```json
{
    "body": "Yes, that is a bug. I wasn't considering all the roots in the ambient field, which I now see is necessary.",
...
```json
{
    "body": "For the record: With 4276-nf-coerce-fixes3.patch applied on top of the other patches and my 3.2.2.alpha1 merge tree all doctests pass.\n\nCheers,\n\nMichael",
...
```json
{
    "body": "After a chat in IRC with Nick I have merged 4276-nf-coerce-fixes3.patch in Sage 3.2.2.alpha1\n\nCheers,\n\nMichael",
...
```json
{
    "body": "Yes, I'm thinking a separate ticket too. This is a monstrously huge ticket already.",
...
```json
{
    "body": "I am giving this a positive review in Nick's name (sue me :)), so that it can be officially merge.\n\nCheers,\n\nMichael",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4276",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4276#event-4521"
}
```
...
```json
{
    "body": "Nick: Obviously if anything goes wrong I am the one to blame here :)\n\nCheers,\n\nMichael",
...
```json
{
    "body": "That is fine with me.  I am confidently hoping that everything I used to do with number fields will still work, with no noticeable performance cost, and that some new things are possible which used not to be.\n\nDo the docstrings for the new code contain some hint of the new capabilities?  As the number of patches has grown rather it is not so easy to tell...\n\nOnward and upward!",
...
```json
{
    "body": "Yes, there is documentation and examples.",
