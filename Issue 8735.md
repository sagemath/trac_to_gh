...
```json
{
    "body": "For the info: I got a all test passed on sage.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8735",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8735#event-8905"
}
```
