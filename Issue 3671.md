...
```json
{
    "body": "Clement's patch fixes the issue for me by selecting another default algorithm. An install which failed the doctest roughly 2% of the time now passes the ssmod.py doctest 500 times.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-19T04:23:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25946",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "This can be fixed by patching Linbox's charpoly to use another default algorithm. Should it be fixed by Clement we can switch it back.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-19T14:05:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25948",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "An updated spkg which only adds the fix posted by Clement is available at\n\nhttp://sage.math.washington.edu/home/mabshoff/release-cycles-3.0.6/alpha1/linbox-1.1.6rc0.p0.spkg\n\nCheers,\n\nMichael",
    "created_at": "2008-07-21T07:57:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25949",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25950",
    "user": "@williamstein"
}
```
...
```json
{
    "body": "Merged linbox-1.1.6rc0.p1.spkg in Sage 3.0.6.rc0",
    "created_at": "2008-07-21T14:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25951",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25952",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25953",
    "user": "@ClementPernet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25954",
    "user": "@ClementPernet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25956",
    "user": "@ClementPernet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25957",
    "user": "@ClementPernet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25958",
    "user": "@ClementPernet"
}
```
...
```json
{
    "body": "This ticket was accidentally reopened. The linbox.spkg update is now #3828.\n\nCheers,\n\nMichael",
    "created_at": "2008-08-12T23:59:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25959",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3671#issuecomment-25960",
    "user": "mabshoff"
}
```
