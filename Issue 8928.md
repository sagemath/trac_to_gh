...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21791"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21792"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21793"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21794"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21795"
}
```
...
```json
{
    "body": "FYI, I came across this while working on #14901.",
    "created_at": "2014-06-17T18:04:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8928#issuecomment-82110",
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21796"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8928#event-21797"
}
```
...
```json
{
    "body": "This works for me in Sage 6.4beta0. The problem seems to have been fixed, even though `sage.categories.modules.Modules.ElementMethods.__mul__` appears to be unchanged.",
    "created_at": "2014-08-17T20:31:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8928#issuecomment-82111",
