...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475778",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475779",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475780",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "So what I was thinking is based on this excellent video I found - https://www.coursera.org/lecture/concurrent-programming-in-java/demonstration-parallelization-of-boruvkas-minimum-spanning-tree-algorithm-yaOEz?utm_source=link&utm_medium=page_share&utm_content=vlp&utm_campaign=top_button\n\nThis is done in Java, but the concepts are clear to me. I am planning to implement mutex locks in Cython and use them in a similar manner.\n\nDo you think this will work?",
    "created_at": "2022-04-13T06:26:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475781",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475782",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475784",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "In cython parallel code, you cannot use anything that requires the `GIL`. So no `dict`, no `DisjointSet_of_hashables` etc. So there is a bit of work to be done with the data structures.",
    "created_at": "2022-04-13T14:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475785",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "For starters, I will try to remove all Python objects from the section that I want to Cythonize. For example, for `dict` I can use `map` from C++, for `list` I can use a `vector`, again from C++, or a `numpy` array. \n\n`DisjointSet_of_hashtables` might require more thought, but I think implementing an equivalent class in C++ should be helpful.\n\nWhat do you say about this approach? Also, can you guide me to some resources on using C++ in Cython?",
    "created_at": "2022-04-13T15:27:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475786",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "Also, one minor thing. How do you recompile Sage code after making a change in Sage source code?",
    "created_at": "2022-04-13T15:40:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475787",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "Replying to [comment:8 gh-adarsh-kishore786]:\n> Also, one minor thing. How do you recompile Sage code after making a change in Sage source code?\n\n`sage -b`.\n\nFor python changes with `--enable-editable`, even restarting will be fine.",
    "created_at": "2022-04-13T16:21:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475788",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475789",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "And if I only want to build a specific file, like `spanning_tree.pyx` and not the whole Sage?",
    "created_at": "2022-04-13T16:26:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475790",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475792",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475795",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "So just as an example, I wrote the `DisjointSet` data structure in C++. https://github.com/adarsh-kishore786/Programming/tree/main/Cython/DisjointSets\n\nI plan to Cythonize it to see if it at least works, and then I can do an equivalent thing in Sage's codebase.\n\nWhat do you think of it?",
    "created_at": "2022-04-14T08:49:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475796",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "Also, before you start implementing a data structure, I would be curious on what we need:\n\n- How are vertices merged?\n- How are the edges from regions stored? (Not sure if regions is the correct word.)\n- How do we find a minimal edge.",
    "created_at": "2022-04-14T09:22:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475798",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475800",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "There is no need to implement a parallel algorithm in sage for educational purpose, I believe. Everything in sage has to be maintained and without use cases, this would be a burden.",
    "created_at": "2022-04-14T10:44:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475802",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475803",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475804",
    "user": "https://github.com/adarsh-kishore786"
}
```
...
```json
{
    "body": "Don't understand me wrong. I'm a big fan of parallelization and very curious, whether this can make a difference here. But I also think parallelization should be a last resort.",
    "created_at": "2022-04-14T12:05:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33466#issuecomment-475805",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33466#event-88592"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33466#event-88593"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33466#event-88594"
}
```
