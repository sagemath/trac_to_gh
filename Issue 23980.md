...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23980#issuecomment-335996",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "It would be convenient if Python somehow had a hook to deal with unraisable exceptions. But it doesn't: it just deletes the exception and there is (AFAIK) no way to figure out that it did that.",
    "created_at": "2018-03-20T13:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23980#issuecomment-335997",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23980#issuecomment-335999",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23980#issuecomment-336000",
    "user": "nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23980#issuecomment-336001",
    "user": "jdemeyer"
}
```
