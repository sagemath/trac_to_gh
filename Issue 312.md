...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/312#issuecomment-1491",
    "user": "@williamstein"
}
```
...
```json
{
    "body": "This bug report actually doesn't make any sense, or is the result of confusion about what latex is.",
    "created_at": "2007-08-19T02:05:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/312#issuecomment-1492",
    "user": "@williamstein"
}
```
