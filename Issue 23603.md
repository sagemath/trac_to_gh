...
```json
{
    ...
    "title": "Doctest failures in ell_number_field.py with optional packages",
    "type": "issue",
...
```json
{
    "body": "These can all just be changed to match the output.  There is nothing more serious here than using +P instead of -P as a generator of an infinite cyclic group, and similarly for rank 2.  I went through all these making similar changes when testing #8829, and now they seem to have changed again (or gone back).\n\nFor testing only, we could obviously have tests which did not reply on a specific set of Z-module generators being output.  But we want to show examples for the documentation too, and these really do want actual points output.  It's a universal problem.",
    "created_at": "2017-09-12T14:43:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330274",
...
```json
{
    "body": "I don't understand your comment Vincent!  I was not suggesting such a thing, only that the output of E.gens() and similar often change when some underlying package (such as pari) changes.",
    "created_at": "2017-09-12T14:51:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330275",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330276",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "The problem is that here the output depends on whether or not the optional package `database_cremona_ellcurve` is installed. So *with* that package, you get one output and *without* that package, you get a different output. The difference boils down to\n\n```\nsage: EllipticCurve(\"37a1\")._compute_gens(proof=True, use_database=True)\n([(0 : 0 : 1)], True)\nsage: EllipticCurve(\"37a1\")._compute_gens(proof=True, use_database=False)\n([(0 : -1 : 1)], True)\n```\n",
    "created_at": "2017-09-12T14:56:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330277",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330278",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Even if you do not do this today, do you have a suggestion for fixing it?",
    "created_at": "2017-09-12T15:06:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330280",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "Yes my suggestion was in Comment 10, i.e. don't get gens from the database.",
    "created_at": "2017-09-12T15:10:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330281",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Taking a step back: Sage generates a \"mini\" Cremona database as standard package, containing only curves of conductor up to 10000. That mini database does not contain the generators of the curves. Should it?",
    "created_at": "2017-09-12T15:40:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330282",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330283",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330284",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330285",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330287",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "This one should be easy since all the installation does is move one file into local/share/cremona.  Checking that made me see that despite what I said above, I had just tested this file on a Sage build with no optional database installed -- and all tests passed; but the version was beta3.  I am now building beta5 in there before continuing.",
    "created_at": "2017-09-12T18:47:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330288",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330289",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330290",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330291",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330295",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330296",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Yes, I agree. This works now.",
    "created_at": "2017-09-18T08:47:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330298",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330299",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23603#issuecomment-330300",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23603",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23603#event-22110"
}
```
