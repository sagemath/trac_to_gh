...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111968",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111969",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [11110-remove-unwanted-file.patch](https://github.com/sagemath/sage/files/ticket11110/11110-remove-unwanted-file.patch) by drkirkby created at 2011-04-01 10:19:44\n\nSince the file was not in the repository, it just had to be deleted and a new package created, which is here:\n\n\nhttp://boxen.math.washington.edu/home/kirkby/patches/libpng-1.2.35.p3.spkg",
    "created_at": "2011-04-01T10:19:44Z",
    "issue": "https://github.com/sagemath/sage/issues/11110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111970",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111971",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111972",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111973",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11110#issuecomment-111974",
