...
{
    "assignees": [],
    "body": "The attached patch provides a recursive algorithm that lists Sidon g-sets with elements of to a natural number N.\n\n**Apply:**\n\n1. [attachment: trac-11624-sidon_sets-v2.patch.gz](https://github.com/sagemath/sage/files/ticket11624/trac-11624-sidon_sets-v2.patch.gz)\n2. [attachment: trac-11624-sidon_sets-review2.patch.gz](https://github.com/sagemath/sage/files/ticket11624/trac-11624-sidon_sets-review2.patch.gz)\n\nAssignee: **sage-combinat**\n\nAuthor: **Martin Raum**\n\nReviewer: **Nicolas Borie**\n\nMerged: **sage-4.7.2.alpha2**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/11624_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142248"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121797",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121798",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121799",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121800",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121801",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121802",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121803",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142254"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121804",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121805",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121806",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142255"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11624#event-142256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11624#issuecomment-121807",
    "user": "https://github.com/jdemeyer"
}
```
