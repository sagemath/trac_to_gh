...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[a76a510](http://git.sagemath.org/sage.git/commit/?id=a76a510)|`Implement division_field() for elliptic curves`|\n|[c50eb3e](http://git.sagemath.org/sage.git/commit/?id=c50eb3e)|`No need to specify caller_name in verbose()`|\n|[6df69b6](http://git.sagemath.org/sage.git/commit/?id=6df69b6)|`Add comments, small cosmetic changes`|\n|[9e2dd44](http://git.sagemath.org/sage.git/commit/?id=9e2dd44)|`Make q monic before computing cubic resolvent`|\n|[9b5558e](http://git.sagemath.org/sage.git/commit/?id=9b5558e)|`Implement splitting fields for number fields`|",
    "created_at": "2014-01-03T17:06:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11905",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[d6a7f3c](http://git.sagemath.org/sage.git/commit/?id=d6a7f3c)|`Implement division_field() for elliptic curves`|\n|[776795d](http://git.sagemath.org/sage.git/commit/?id=776795d)|`Do polynomial consistency check only for minimal dm`|\n|[df52508](http://git.sagemath.org/sage.git/commit/?id=df52508)|`Further improvements to splitting_field()`|\n|[c50eb3e](http://git.sagemath.org/sage.git/commit/?id=c50eb3e)|`No need to specify caller_name in verbose()`|\n|[6df69b6](http://git.sagemath.org/sage.git/commit/?id=6df69b6)|`Add comments, small cosmetic changes`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[387216c](http://git.sagemath.org/sage.git/commit/?id=387216c)|`Implement division_field() for elliptic curves`|\n|[776795d](http://git.sagemath.org/sage.git/commit/?id=776795d)|`Do polynomial consistency check only for minimal dm`|\n|[df52508](http://git.sagemath.org/sage.git/commit/?id=df52508)|`Further improvements to splitting_field()`|\n|[c50eb3e](http://git.sagemath.org/sage.git/commit/?id=c50eb3e)|`No need to specify caller_name in verbose()`|\n|[6df69b6](http://git.sagemath.org/sage.git/commit/?id=6df69b6)|`Add comments, small cosmetic changes`|",
    "created_at": "2014-01-03T22:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11905",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[810ceec](http://git.sagemath.org/sage.git/commit/?id=810ceec)|`Implement division_field() for elliptic curves`|\n|[776795d](http://git.sagemath.org/sage.git/commit/?id=776795d)|`Do polynomial consistency check only for minimal dm`|\n|[df52508](http://git.sagemath.org/sage.git/commit/?id=df52508)|`Further improvements to splitting_field()`|\n|[c50eb3e](http://git.sagemath.org/sage.git/commit/?id=c50eb3e)|`No need to specify caller_name in verbose()`|\n|[6df69b6](http://git.sagemath.org/sage.git/commit/?id=6df69b6)|`Add comments, small cosmetic changes`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[3661e44](http://git.sagemath.org/sage.git/commit/?id=3661e4443e6b11438e5adcc62e9beb66e5092ac2)|`Implement division_field() for elliptic curves`|\n|[ca46e2b](http://git.sagemath.org/sage.git/commit/?id=ca46e2b875ef53b46457a90338b1599ec63ecb9f)|`Do polynomial consistency check only for minimal dm`|\n|[7830eab](http://git.sagemath.org/sage.git/commit/?id=7830eab7c0363400780ab606ae8e86e948dbe014)|`Further improvements to splitting_field()`|",
    "created_at": "2014-01-05T22:35:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11905",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[9b406d0](http://git.sagemath.org/sage.git/commit/?id=9b406d0b3bb48f8431b6fe0b99116fbaf9a66d7c)|`Implement division_field() for elliptic curves`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[4d450f1](http://git.sagemath.org/sage.git/commit/?id=4d450f1b3438b26c11ee5e6f0fa517f8c9a73042)|`Implement division_field() for elliptic curves`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[8b96090](http://git.sagemath.org/sage.git/commit/?id=8b96090cc593f5906573af49409d7e1c9521aa63)|`Implement division_field() for elliptic curves`|",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[05c57d2](http://git.sagemath.org/sage.git/commit/?id=05c57d2a031f34ac4d95ca5a13448c92206f0f41)|`Implement division_field() for elliptic curves`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[bb38871](http://git.sagemath.org/sage.git/commit/?id=bb388718023f3eaeec59d97673152996c53f9efb)|`division_field(): use map_coefficients() and add more examples`|",
    "created_at": "2014-01-06T12:39:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11905",
    "type": "issue_comment",
