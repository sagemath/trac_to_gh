...
```json
{
    "body": "<a id='comment:4'></a>It appears I have it completely broken in regarding to signal handling now. The attached log session is what I found. Running simple doctests does not test this behavior indeed. In the attached session log, the <<<<<< comment >>>>>>> lines are about what I pressed or typed when the console was not echoing.",
    "created_at": "2011-08-28T23:06:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159414",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```

<a id='comment:4'></a>It appears I have it completely broken in regarding to signal handling now. The attached log session is what I found. Running simple doctests does not test this behavior indeed. In the attached session log, the <<<<<< comment >>>>>>> lines are about what I pressed or typed when the console was not echoing.
...
```json
{
    "body": "<a id='comment:5'></a>Just looking at what's happening in sage-on-gentoo. We give a bit more freedom about what user can enable or not. I don't see the problem on my machine where I have boehm-gc compiled with threads but ecl without. However there was a report on bugzilla this morning of someone getting\n\n```\n$ LC_ALL=C sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nsage: var('i n')\n(i, n)\nsage: sum(4*i+1, i, 1, n)\n/usr/bin/sage-sage: line 230:  8666 Power failure           sage-ipython \"$@\" -i\n```\nWhich appear to me to be very similar to what you describe, I'll write again when I get more info from this user.",
    "created_at": "2011-08-29T01:59:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159415",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>Just looking at what's happening in sage-on-gentoo. We give a bit more freedom about what user can enable or not. I don't see the problem on my machine where I have boehm-gc compiled with threads but ecl without. However there was a report on bugzilla this morning of someone getting
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159418",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159419",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159422",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159423",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Paulo C\u00e9sar Pereira de Andrade\"",
    "created_at": "2011-08-29T06:38:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159424",
    "user": "https://github.com/nbruin"
}
```

Changing author from "" to "Paulo César Pereira de Andrade"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159425",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159426",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>The attached patch fixes something for non-standard Sage configurations. The change cannot possibly affect standard sage configurations negatively because we really do not want a separate signal handling thread in ECL (that messes thing up in exactly the way the author was observing). So: positive review from me.\n\nThanks to Paulo for tracking this down.",
    "created_at": "2011-08-29T06:41:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159427",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:12'></a>The attached patch fixes something for non-standard Sage configurations. The change cannot possibly affect standard sage configurations negatively because we really do not want a separate signal handling thread in ECL (that messes thing up in exactly the way the author was observing). So: positive review from me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159428",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Sorry, the patch is \u00a0formatted for the procedure I use to rpmbuild sagemath. I am not much used to mercurial... Based on log, it should be something like \"hg import -p4 sage-4.7.1-ecl_module.patch\".\n\nI will edit the patch to look like patches from raw mode view of commits to hg.sagemath.org, and add a description to the \"patch header\".",
    "created_at": "2011-08-29T08:25:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159430",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```

<a id='comment:14'></a>Sorry, the patch is  formatted for the procedure I use to rpmbuild sagemath. I am not much used to mercurial... Based on log, it should be something like "hg import -p4 sage-4.7.1-ecl_module.patch".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159431",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159432",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159433",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [11752_ecl-nothread.patch](tarball://root/attachments/some-uuid/ticket11752/11752_ecl-nothread.patch) by @nbruin created at 2011-08-29 16:04:41\n\nThanks! Patch applied but it still didn't quite look like a \"mercurial\" patch (things like date and author missing) so I reexported the patch with \"hg export qtip\". I hope this patch is OK.",
    "created_at": "2011-08-29T16:04:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159434",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:15'></a>Attachment [11752_ecl-nothread.patch](tarball://root/attachments/some-uuid/ticket11752/11752_ecl-nothread.patch) by @nbruin created at 2011-08-29 16:04:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159435",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Looks good to me too. Hopefully it will go in the next alpha.",
    "created_at": "2011-08-29T19:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159436",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:17'></a>Looks good to me too. Hopefully it will go in the next alpha.
...
```json
{
    "body": "<a id='comment:18'></a>Please use proper URLs (in this case to the raw attachment) or trac wiki mark-up (\"`[attachment:here_comes_the_filename]`\") when referring to patches (or spkgs) in the description.\n\nAlso, an attachment comment *\"Apply only this patch.\"* can make life easier.",
    "created_at": "2011-09-08T10:02:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159437",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:18'></a>Please use proper URLs (in this case to the raw attachment) or trac wiki mark-up ("`[attachment:here_comes_the_filename]`") when referring to patches (or spkgs) in the description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159438",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159439",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11752#issuecomment-159440",
    "user": "https://github.com/nexttime"
}
```
