...
<a id='comment:3'></a>Replying to [comment:2 pcpa]:
> The patch allows sage to load the ecl/maxima module and at least the (few) doctests I run did work correctly.
...
<a id='comment:9'></a>Replying to [comment:8 pcpa]:
