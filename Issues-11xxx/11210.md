...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11210#event-135502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11210#event-135503"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11210#event-135504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11210#issuecomment-113964",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11210#issuecomment-113965",
    "user": "https://github.com/kcrisman"
}
```
