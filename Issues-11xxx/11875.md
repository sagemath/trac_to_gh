...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162136",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162137",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Some more testing suggests that the above crash occurs for any group of index > 2 containing the element \n\n```\n[-1 1]\n[-1 0].\n```",
    "created_at": "2011-10-01T17:24:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162139",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:4'></a>Some more testing suggests that the above crash occurs for any group of index > 2 containing the element 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162141",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162142",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11875#event-31383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162143",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162144",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11875#event-31384"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11875#event-31385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162145",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11875#issuecomment-162146",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11875",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11875#event-31386"
}
```
