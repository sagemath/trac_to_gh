...
```json
{
    ...
    "asset_name": "trac11815_format_must_preserve_embedding.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket11815/trac11815_format_must_preserve_embedding.patch",
