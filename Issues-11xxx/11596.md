...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121188",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121189",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121190",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [trac-11596-copy-cache-data.patch](https://github.com/sagemath/sage/files/ticket11596/trac-11596-copy-cache-data.patch) by @jasongrout created at 2011-12-04 01:02:52\n\nNot tested; definitely needs work",
    "created_at": "2011-12-04T01:02:52Z",
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121191",
    "user": "https://github.com/jasongrout"
}
```

Attachment [trac-11596-copy-cache-data.patch](https://github.com/sagemath/sage/files/ticket11596/trac-11596-copy-cache-data.patch) by @jasongrout created at 2011-12-04 01:02:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121192",
...
```json
{
    "body": "Attachment [trac_11596-immutable.patch](https://github.com/sagemath/sage/files/ticket11596/trac_11596-immutable.patch) by @jhpalmieri created at 2011-12-04 01:19:39\n\na different take",
    "created_at": "2011-12-04T01:19:39Z",
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121193",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [trac_11596-immutable.patch](https://github.com/sagemath/sage/files/ticket11596/trac_11596-immutable.patch) by @jhpalmieri created at 2011-12-04 01:19:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121194",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11596#issuecomment-121195",
    "user": "https://github.com/jasongrout"
}
```
