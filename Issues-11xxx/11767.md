...
```json
{
    "body": "<a id='comment:1'></a>In case you provide a patch, you could also fix this:\n\n```\n        # embeddings uses only real arithmetic i nthe iteraion, and is\n```\n(And remove the superfluous semicolon from `eps = R(1)>>(prec2);` twice.)",
    "created_at": "2011-08-31T22:54:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159876",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>In case you provide a patch, you could also fix this:
...
```json
{
    "body": "<a id='comment:2'></a>I do not claim to understand the `<` versus `<=` issue, since I do not know the algorithm in question.  But I can attach a patch with this fix, which fixes the problem, has an example to illustrate that the problem is fixed, and fixes the typos leif mentions above.  Perhaps this will be easy for John Cremona to referee.",
    "created_at": "2011-09-01T04:01:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159877",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>I do not claim to understand the `<` versus `<=` issue, since I do not know the algorithm in question.  But I can attach a patch with this fix, which fixes the problem, has an example to illustrate that the problem is fixed, and fixes the typos leif mentions above.  Perhaps this will be easy for John Cremona to referee.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159878",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159879",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> I'm glad this function is useful, by the way -- there is no other \n> software which can take complex elliptic logs!\n\n\nThanks -- it's absolutely *critical* for my research right now!",
    "created_at": "2011-09-03T17:10:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159882",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>> I'm glad this function is useful, by the way -- there is no other 
> software which can take complex elliptic logs!
...
```json
{
    "body": "<a id='comment:6'></a>another typo in that file:\n\n```\n...the the returned value z...\n```\nPaul",
    "created_at": "2011-09-14T12:59:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159883",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:6'></a>another typo in that file:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159884",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Paul, thanks.  I trust your knowledge of binary floating point issues as being much better than my own.  Are you saying that even with your patch the termination condition may never hold and hence we loop forever?\n\nBearing in mind that I already doubled the precision (prec2 = 2*prec)  should we perhaps change `1-2^(-prec2)` to ` 1-2^(-prec2+1)`?  If that would mean that termination is then guaranteed?",
    "created_at": "2011-09-14T14:06:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159886",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>Paul, thanks.  I trust your knowledge of binary floating point issues as being much better than my own.  Are you saying that even with your patch the termination condition may never hold and hence we loop forever?
...
```json
{
    "body": "<a id='comment:9'></a>John, if you change `eps` to `2^(-prec2+1)` instead of `2^(-prec2)` then the case\nwhere `r = 1 - 2^(-prec2)` will also terminate with the < condition. But the case where\n`r = 1 + 2^(-prec2+1)` will still loop.\n\nIf the target precision is `prec` and you compute internally with `2*prec` bits, then\n`eps` could be `2^(-prec)`, no?\n\nPaul",
    "created_at": "2011-09-14T14:51:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159887",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:9'></a>John, if you change `eps` to `2^(-prec2+1)` instead of `2^(-prec2)` then the case
where `r = 1 - 2^(-prec2)` will also terminate with the < condition. But the case where
`r = 1 + 2^(-prec2+1)` will still loop.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159888",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159890",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159891",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [trac_11767b.patch](tarball://root/attachments/some-uuid/ticket11767/trac_11767b.patch) by @zimmermann6 created at 2011-09-15 08:58:43\n\nJohn, thank you for your feedback. I've now uploaded a new patch `trac_11767b.patch` which\nshould be applied solely. William, please could you review that ticket?\n\nPaul",
    "created_at": "2011-09-15T08:58:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159892",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:13'></a>Attachment [trac_11767b.patch](tarball://root/attachments/some-uuid/ticket11767/trac_11767b.patch) by @zimmermann6 created at 2011-09-15 08:58:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159893",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"John Cremona, Leif Leonhardy\"",
    "created_at": "2011-09-15T10:37:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159895",
    "user": "https://github.com/nexttime"
}
```

Changing reviewer from "" to "John Cremona, Leif Leonhardy"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159896",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159897",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Oh, the superfluous semicolons survived Paul's patch, but I don't mind.",
    "created_at": "2011-09-15T10:43:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159898",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:16'></a>Oh, the superfluous semicolons survived Paul's patch, but I don't mind.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159900",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159903",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159904",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159905",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159906",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>I knew I should not have opened my mouth... Attached is a second patch. Don't ask me to make a\nunified patch, I prefer to spend my time on other tickets.\n\nPaul",
    "created_at": "2011-09-15T13:13:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159907",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:23'></a>I knew I should not have opened my mouth... Attached is a second patch. Don't ask me to make a
unified patch, I prefer to spend my time on other tickets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159908",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159910",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159911",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Can someone (William?) give this a final positive review?\n\nIf this happens within a few hours, I can still merge it into Sage 4.7.2.alpha3.",
    "created_at": "2011-09-18T05:16:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159912",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:27'></a>Can someone (William?) give this a final positive review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159913",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>final positive review.",
    "created_at": "2011-09-18T14:56:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159914",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:28'></a>final positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159915",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11767#event-30950"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159916",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11767#issuecomment-159917",
    "user": "https://github.com/nexttime"
}
```
