...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29178"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>In case you decide to continue working on Galois representations, please be so kind to wait for #11905 first.",
    "created_at": "2014-01-05T22:00:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11270#issuecomment-121136",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>In case you decide to continue working on Galois representations, please be so kind to wait for #11905 first.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29179"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29180"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29181"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29182"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29183"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11270#event-29184"
}
```
