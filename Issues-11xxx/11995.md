...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11995#event-148337"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11995#event-148338"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11995#event-148339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11995#issuecomment-129627",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11995#issuecomment-129628",
    "user": "https://github.com/jdemeyer"
}
```
