...
```json
{
    "body": "<a id='comment:1'></a>Note that there's already a p10 (#11550), and trivial outstanding changes to that (#11645).",
    "created_at": "2011-08-08T13:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156890",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Note that there's already a p10 (#11550), and trivial outstanding changes to that (#11645).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156891",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156892",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156893",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156894",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156895",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156896",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Note that (almost*) all files are installed with some `install` script or program (not consistently making use of `-m ...` though as far as I can see), so changing file permissions in `src/` isn't really appropriate or may not be sufficient.\n\n---\n*There are actually a few (at least one) instances where `cp` is used.",
    "created_at": "2011-08-08T20:52:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156898",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>Note that (almost*) all files are installed with some `install` script or program (not consistently making use of `-m ...` though as far as I can see), so changing file permissions in `src/` isn't really appropriate or may not be sufficient.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156899",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>P.S.: The created Singular scripts in `local/bin/` use `$*` instead of `\"$`@`\"`.",
    "created_at": "2011-08-08T21:02:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156900",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>P.S.: The created Singular scripts in `local/bin/` use `$*` instead of `"$`@`"`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156901",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156902",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>This doesn't work (i.e., doesn't solve the issue), since `cp` is required (by POSIX) to respect the `umask` unless `-p` is used (which we don't, see above).\n\nAlso, `janet.{cc,h}` are still executable in the upstream sources, and at least for me all headers still get installed with `-rwxr-xr-x`.\n\nWhile you're at it (`spkg-install`), I think you should also add copying the `help.cnf` file (which is as noted missing in our \"manual\" installations).",
    "created_at": "2011-08-08T21:46:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156903",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>This doesn't work (i.e., doesn't solve the issue), since `cp` is required (by POSIX) to respect the `umask` unless `-p` is used (which we don't, see above).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156904",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156905",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Instead of using `cp -p`, you could of course also `chmod` them afterwards, or simply change the `umask` before copying.\n\nIn principle, we could (or should?) set the `umask` in `sage-spkg`.",
    "created_at": "2011-08-08T21:53:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156906",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:11'></a>Instead of using `cp -p`, you could of course also `chmod` them afterwards, or simply change the `umask` before copying.
...
```json
{
    "body": "<a id='comment:12'></a>Actually, the problem with `singular.{hlp,idx}` is not my `umask`, but that the files already existed (and don't get deleted prior to reinstallation), so their permissions didn't get changed.\n\nAnyway, using `cp -p` would solve this.",
    "created_at": "2011-08-08T22:20:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156907",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:12'></a>Actually, the problem with `singular.{hlp,idx}` is not my `umask`, but that the files already existed (and don't get deleted prior to reinstallation), so their permissions didn't get changed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156908",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156909",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156910",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156913",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156914",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156915",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156916",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156917",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156918",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I hate to spoil this party, but where was the p10?  Even `SPKG.txt` doesn't mention one.  \n\nNot sure if this means 'needs work', but at least 'needs info'!",
    "created_at": "2011-08-09T14:33:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156919",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>I hate to spoil this party, but where was the p10?  Even `SPKG.txt` doesn't mention one.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156920",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156921",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156922",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156923",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>I believe kcrisman's comment should not affect the positive review...",
    "created_at": "2011-08-09T17:19:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156924",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>I believe kcrisman's comment should not affect the positive review...
...
```json
{
    "body": "<a id='comment:25'></a>I have posted a p12 at ticket #11645.",
    "created_at": "2011-08-09T17:20:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156925",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>I have posted a p12 at ticket #11645.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156926",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Followup p13 (based on #11645) at #11550.",
    "created_at": "2011-08-09T18:42:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156927",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:27'></a>Followup p13 (based on #11645) at #11550.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156928",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11663#event-30620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11663#issuecomment-156929",
    "user": "https://github.com/jdemeyer"
}
```
