...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155645",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155646",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155647",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155648",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155649",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nI think I've got it.\n\nThis seems to happen iff a random prime happens to be chosen twice.  For example, if you modify `_extend_moduli_to_height_`c to always reuse a prime if more than one is needed, this always happens.  The same bug seems to exist in `_extend_moduli_to_`count as well.\n\nThe problem seems to be that in `_new_random_`prime, there's a test which doesn't do what it's trying to do:\n\n```\n    cdef mod_int `_new_random_`prime(self):\n        # choose a new random prime\n        cdef Py_ssize_t i\n        cdef mod_int p\n        while True:\n            p = random_prime(self._u_bound, lbound =self._l_bound)\n            for i in range(self.n):\n                if p == self.moduli[i]:\n                    break\n            else:\n                return p\n```\n\nIIUC, the \"for i in range(self.n)\" loop is attempting to avoid the problem of repeated primes, but this only works if p is added to self.moduli immediately after it's returned.  In the case of  `_extend_moduli_to_height_`c, this isn't true; the addition is delayed until a later extend_with_primes call, so the above check decides that the prime isn't reused, we get repeated moduli, and the multiplication breaks.\n\nOr even more obviously:\n\n```\nsage: from sage.ext.multi_modular import MultiModularBasis_base\nsage: mm = MultiModularBasis_base(1)\nsage: mm._extend_moduli_to_count(1000)\n1000\nsage: len(mm), len(set(mm))\n(1000, 843)\n```\n\nISTM either we can remove the check-for-duplicate code from `_new_random_`prime and do it externally, or we can add an argument and pass it the \"accumulated\" primes as we build them elsewhere so it can avoid duplicates there too.  I prefer the first.  Should I work up a patch?",
    "created_at": "2011-05-21T06:28:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155650",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155651",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155653",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155654",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155656",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155657",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155658",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155660",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155661",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155662",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155663",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155664",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155665",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155666",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_name": "11358.sage",
    "asset_url": "tarball://root/attachments/some-uuid/ticket11358/11358.sage",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155667",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155668",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155669",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155670",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155671",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>\n> So I think that two of the three _extend methods still don't give results that I'd expect.\n\n\nI have fixed the patch. There was one case where I didn't update use of `_new_random_`prime correctly.",
    "created_at": "2012-03-21T19:30:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155672",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155673",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155674",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155675",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155676",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11358#event-35014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155677",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155678",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155679",
    "user": "https://github.com/jdemeyer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11358-wstein.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket11358/trac_11358-wstein.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-155680",
    "user": "https://github.com/jdemeyer"
}
```
