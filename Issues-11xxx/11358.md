...
```json
{
    "body": "<a id='comment:1'></a>This also fails on Sage 4.6.2 under Red Hat Enterprise Linux (binary install, x86_64 GNU/Linux)",
    "created_at": "2011-05-20T13:57:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149822",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```

<a id='comment:1'></a>This also fails on Sage 4.6.2 under Red Hat Enterprise Linux (binary install, x86_64 GNU/Linux)
...
```json
{
    "body": "<a id='comment:2'></a>Looking at the function mpz_crt_vec_tail() in sage/ext/multi_modular.pyx, it appears that three of the last five lines:\n\n```\ncdef Integer zz\nzz = PY_NEW(Integer)\nmpz_set(zz.value, self.half_product)\n```\nare redundant, because the variable zz is never used.  (NB I am unfamiliar with both Cython and GMP, so I may be wrong here.)  But why is this code there?  Is it supposed to be doing something else?",
    "created_at": "2011-05-20T15:27:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149823",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```

<a id='comment:2'></a>Looking at the function mpz_crt_vec_tail() in sage/ext/multi_modular.pyx, it appears that three of the last five lines:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149825",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Replying to [tomc](#comment%3A4):\n> I don't think that this is correct.  By running the code repeatedly, I found examples without zero columns.\n\n\nOK, just saw that in IRC and thought I'd capture it.\n\nI'm curious to see what the root cause is here!\n\nRob",
    "created_at": "2011-05-20T20:26:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149826",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:5'></a>Replying to [tomc](#comment%3A4):
> I don't think that this is correct.  By running the code repeatedly, I found examples without zero columns.
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [dsm](#comment%3A6):\n\nGood catch!  I agree.\n\n> ISTM either we can remove the check-for-duplicate code from _new_random_prime and do it externally, or we can add an argument and pass it the \"accumulated\" primes as we build them elsewhere so it can avoid duplicates there too.  I prefer the first.  Should I work up a patch?\n\n\nI prefer the first too.  Please write a patch and then I will review it.",
    "created_at": "2011-05-21T13:20:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149828",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```

<a id='comment:8'></a>Replying to [dsm](#comment%3A6):
...
```json
{
    "body": "<a id='comment:9'></a>Okay, here's my first attempt.  Because another function calls _new_random_prime assuming that it correctly avoids duplication I had to change my intended approach a bit, but it should work.  \n\nTwo other minor changes:\n\n(1) as mentioned above, mpz_crt_vec_tail() has what looks to me like vestigial code, and I've removed it.\n\n(2) the documentation for replace_prime_c claimed that it would replace a prime with a greater prime, but made no efforts to ensure the \"greater than\" part.  I've changed the doc accordingly.",
    "created_at": "2011-05-21T17:13:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149829",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```

<a id='comment:9'></a>Okay, here's my first attempt.  Because another function calls _new_random_prime assuming that it correctly avoids duplication I had to change my intended approach a bit, but it should work.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149830",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Thanks.  I'll review this.",
    "created_at": "2011-05-21T17:49:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149831",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```

<a id='comment:10'></a>Thanks.  I'll review this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149833",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149835",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149836",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149838",
    "user": "https://trac.sagemath.org/admin/accounts/users/tomc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149841",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149842",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149843",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Attachment [11358.sage](tarball://root/attachments/some-uuid/ticket11358/11358.sage) by @williamstein created at 2012-03-21 18:21:52\n\nI've posted a patch trac_11358-wstein.patch that fixes the bug.  The solution is definitely much better than what was proposed 10 years ago.  You can run the attached 11358.sage to check that the exact bug cited here doesn't happen.  But better is to see the new doctests which get to the heart of the matter.",
    "created_at": "2012-03-21T18:21:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149844",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:20'></a>Attachment [11358.sage](tarball://root/attachments/some-uuid/ticket11358/11358.sage) by @williamstein created at 2012-03-21 18:21:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149845",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>The patch does seem to eliminate the original bug for me, but there's still some strangeness for different _extend methods:\n\n```\n\nsage: set_random_seed(0)\nsage: from sage.ext.multi_modular import MultiModularBasis_base\nsage: m = MultiModularBasis_base(0);\nsage: m._extend_moduli(100)\nsage: len(m), len(set(m))\n(101, 99)\nsage: [k for k in m if list(m).count(k) > 1]\n[30859, 3217, 30859, 3217]\n\n```\n\n```\n\nsage: set_random_seed(1)\nsage: from sage.ext.multi_modular import MultiModularBasis_base\nsage: m = MultiModularBasis_base(0);\nsage: m._extend_moduli_to_count(100)\n100\nsage: len(m), len(set(m))\n(100, 97)\nsage: [k for k in m if list(m).count(k) > 1]\n[4001, 5309, 23293, 4001, 23293, 5309]\n```\n\nSo I think that two of the three _extend methods still don't give results that I'd expect.",
    "created_at": "2012-03-21T19:19:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149846",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```

<a id='comment:21'></a>The patch does seem to eliminate the original bug for me, but there's still some strangeness for different _extend methods:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149847",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149848",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>> So I think that two of the three _extend methods still don't give results that I'd expect.\n\n\nI have fixed the patch. There was one case where I didn't update use of _new_random_prime correctly.",
    "created_at": "2012-03-21T19:30:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149849",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:22'></a>> So I think that two of the three _extend methods still don't give results that I'd expect.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149851",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149852",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149853",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11358#event-29469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149854",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149855",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149856",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Attachment [trac_11358-wstein.patch](tarball://root/attachments/some-uuid/ticket11358/trac_11358-wstein.patch) by @jdemeyer created at 2012-04-02 15:30:54\n\nRebased patch by removing a hunk which just added a newline.",
    "created_at": "2012-04-02T15:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11358#issuecomment-149857",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:26'></a>Attachment [trac_11358-wstein.patch](tarball://root/attachments/some-uuid/ticket11358/trac_11358-wstein.patch) by @jdemeyer created at 2012-04-02 15:30:54
