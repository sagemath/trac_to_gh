...
archive/attachments_015844.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [example.tex](https://github.com/sagemath/sage/files/ticket11583/example.tex)",
    "created_at": "2011-07-08T16:43:22Z",
    "issue": "https://github.com/sagemath/sage/issues/11583",
    "type": "issue_comment",
...
archive/attachments_015845.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [dot-sagetex-dot-sage.patch](https://github.com/sagemath/sage/files/ticket11583/dot-sagetex-dot-sage.patch)\n\nAbove a separate patch to fix example.sage to example.sagetex.sage in the file example.tex.",
    "created_at": "2011-11-16T19:12:09Z",
    "issue": "https://github.com/sagemath/sage/issues/11583",
    "type": "issue_comment",
