...
```json
{
    "body": "Attachment [newton_basins.spyx](tarball://root/attachments/some-uuid/ticket11837/newton_basins.spyx) by @kcrisman created at 2011-09-23 03:28:25\n\nVERY rough draft of eventual file - not a Mercurial patch",
    "created_at": "2011-09-23T03:28:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161390",
    "user": "https://github.com/kcrisman"
}
```

Attachment [newton_basins.spyx](tarball://root/attachments/some-uuid/ticket11837/newton_basins.spyx) by @kcrisman created at 2011-09-23 03:28:25
...
```json
{
    "body": "Attachment [cubicbasin.png](tarball://root/attachments/some-uuid/ticket11837/cubicbasin.png) by @kcrisman created at 2011-09-23 03:31:55\n\nWhat you get with this slow implementation - at least it works!",
    "created_at": "2011-09-23T03:31:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161392",
    "user": "https://github.com/kcrisman"
}
```

Attachment [cubicbasin.png](tarball://root/attachments/some-uuid/ticket11837/cubicbasin.png) by @kcrisman created at 2011-09-23 03:31:55
...
```json
{
    "body": "<a id='comment:2'></a>The [attachment:cubicbasin.png picture] is of the fractal associated with `(x^2-1)(x-I)`. The code is\n\n```\nbasin_plot([-1,i,1],(-3,3),(-3,3),plot_points=100,figsize=7)\n```\nNote that the documentation in the spyx file is all wrong.  This is VERY rough, as noted above. \n\nFeedback welcome!",
    "created_at": "2011-09-23T03:33:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161393",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>The [attachment:cubicbasin.png picture] is of the fractal associated with `(x^2-1)(x-I)`. The code is
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161395",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161396",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161398",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This is great work, Simon.  I'll try it out over the weekend.  All of these ideas make a lot of sense, but it would have taken me many, many hours of stumbling to do things like this.  The only one I did after I posted last night was to make `counter` an int :)\n\nEven the list of roots all being complex doubles is **very** sensible and should have occurred to me immediately, but never did - and I wouldn't have know how to Cythonize that in any case, I only knew about the most basic Cython types.  There are all kinds of optimizations in this code of that kind, and I doubt I would have ever gotten there on my own.  But it makes a GREAT case study in how to use Cython, because there are so many places things are improved.  \n\nThanks.",
    "created_at": "2011-09-23T14:57:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161400",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>This is great work, Simon.  I'll try it out over the weekend.  All of these ideas make a lot of sense, but it would have taken me many, many hours of stumbling to do things like this.  The only one I did after I posted last night was to make `counter` an int :)
...
```json
{
    "body": "Attachment [Betterfractal.png](tarball://root/attachments/some-uuid/ticket11837/Betterfractal.png) by @kcrisman created at 2011-09-23 15:40:30\n\nWith Simon's improvements",
    "created_at": "2011-09-23T15:40:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161401",
    "user": "https://github.com/kcrisman"
}
```

Attachment [Betterfractal.png](tarball://root/attachments/some-uuid/ticket11837/Betterfractal.png) by @kcrisman created at 2011-09-23 15:40:30
...
```json
{
    "body": "Attachment [WithIterations.png](tarball://root/attachments/some-uuid/ticket11837/WithIterations.png) by @kcrisman created at 2011-09-23 17:32:21\n\nWith Simon's Cython and naive keeping track of iterations needed to converge",
    "created_at": "2011-09-23T17:32:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161403",
    "user": "https://github.com/kcrisman"
}
```

Attachment [WithIterations.png](tarball://root/attachments/some-uuid/ticket11837/WithIterations.png) by @kcrisman created at 2011-09-23 17:32:21
...
```json
{
    "body": "<a id='comment:11'></a>Outch! I just saw that my code had a bug: In the loop for `counter`, I had `for counter from 0<=counter<20`, and *additionally* I had `counter += 1`. So, both my and your new spyx file need to be modified.",
    "created_at": "2011-09-23T18:20:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161405",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>Outch! I just saw that my code had a bug: In the loop for `counter`, I had `for counter from 0<=counter<20`, and *additionally* I had `counter += 1`. So, both my and your new spyx file need to be modified.
...
```json
{
    "body": "Attachment [newton_basins_more_cython.spyx](tarball://root/attachments/some-uuid/ticket11837/newton_basins_more_cython.spyx) by @simon-king-jena created at 2011-09-23 18:24:24\n\nPut more cython into the basins",
    "created_at": "2011-09-23T18:24:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161406",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [newton_basins_more_cython.spyx](tarball://root/attachments/some-uuid/ticket11837/newton_basins_more_cython.spyx) by @simon-king-jena created at 2011-09-23 18:24:24
...
```json
{
    "body": "<a id='comment:12'></a>Just updated my patch. I hope that this change does not alter the pictures too much.",
    "created_at": "2011-09-23T18:25:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161407",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>Just updated my patch. I hope that this change does not alter the pictures too much.
...
```json
{
    "body": "<a id='comment:13'></a>Here is another slowness of the current code: `varia._sub_(root).abs()`, which needs to compute a square root. But in order to find out whether `varia._sub_(root).abs()<2/3`, we could more easily test whether the sum of the squares of real and imaginary part is smaller than `4/3`.",
    "created_at": "2011-09-23T19:38:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161408",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>Here is another slowness of the current code: `varia._sub_(root).abs()`, which needs to compute a square root. But in order to find out whether `varia._sub_(root).abs()<2/3`, we could more easily test whether the sum of the squares of real and imaginary part is smaller than `4/3`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161409",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Attachment [newton_basins_with_iterations_and_double.spyx.txt](tarball://root/attachments/some-uuid/ticket11837/newton_basins_with_iterations_and_double.spyx.txt) by @simon-king-jena created at 2011-09-23 19:46:02\n\nNaive keeping track of iterations, using a simplified distance test",
    "created_at": "2011-09-23T19:46:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161410",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [newton_basins_with_iterations_and_double.spyx.txt](tarball://root/attachments/some-uuid/ticket11837/newton_basins_with_iterations_and_double.spyx.txt) by @simon-king-jena created at 2011-09-23 19:46:02
...
```json
{
    "body": "<a id='comment:14'></a>Thanks for catching that!",
    "created_at": "2011-09-23T19:46:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161411",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>Thanks for catching that!
...
```json
{
    "body": "<a id='comment:15'></a>I have attached [attachment:newton_basins_with_iterations_and_double.spyx.txt]. I am sorry that I have not been aware of Windows' automatic name extension (I don't usually write texts under windows), and also I hope that it did not use any fancy format.\n\nAlso I just noticed that the first line of the file contains %cython - of course that needs to be removed if you want to attach it.\n\nAnyway. The trick is to define `self.cutoff = 4./9`, and to use a temporary `cdef ComplexDoubleElement diff = varia._sub_(root)`, so that `(diff._complex.dat[0]**2 + diff._complex.dat[1]**2) < self.cutoff` is fairly cheap.\n\nHere are the data on sagenb:\n\n```\n%time\nbasin_plot([-1,1,3],(-.2,.1),(-.1,.1),plot_points=1000,figsize=7)\nCPU time: 15.59 s,  Wall time: 15.60 s\n```\nThe same computation with the first \"iteration\" code takes `CPU time: 24.15 s,  Wall time: 24.17 s`.",
    "created_at": "2011-09-23T19:56:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161412",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>I have attached [attachment:newton_basins_with_iterations_and_double.spyx.txt]. I am sorry that I have not been aware of Windows' automatic name extension (I don't usually write texts under windows), and also I hope that it did not use any fancy format.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161413",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Possibly also related: a \"pure Python\" GPU (I guess?) implementation by \"kriskda\" on [github](https://github.com/kriskda/BasinsOfAttraction).",
    "created_at": "2013-06-06T16:15:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161414",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:17'></a>Possibly also related: a "pure Python" GPU (I guess?) implementation by "kriskda" on [github](https://github.com/kriskda/BasinsOfAttraction).
...
```json
{
    "body": "<a id='comment:18'></a>Probably related: #23257",
    "created_at": "2017-06-26T16:45:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161415",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>Probably related: #23257
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161416",
...
```json
{
    "body": "<a id='comment:20'></a>Tickets are never abandoned, only forgotten ... that is great news.  If you would like to, we would appreciate a \"formal\" review of the code and attaching it as a branch.  Basically, one wants someone to verify that the code is correct and that things work, and especially that there are sufficient tests and examples for people to use.\n\nSimon, if you're listening, thoughts?  No one person has to vouch for the entire package, it can be a review of previous people's work too.",
    "created_at": "2018-05-24T17:53:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161418",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:20'></a>Tickets are never abandoned, only forgotten ... that is great news.  If you would like to, we would appreciate a "formal" review of the code and attaching it as a branch.  Basically, one wants someone to verify that the code is correct and that things work, and especially that there are sufficient tests and examples for people to use.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11837#issuecomment-161419",
    "user": "https://github.com/simon-king-jena"
}
```
