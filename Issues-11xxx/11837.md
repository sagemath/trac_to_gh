...
```json
{
    ...
    "type": "issue",
    "updated_at": "2018-05-24T19:58:43Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11837#event-134418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11837#event-134419"
}
```
...
```json
{
    "body": "**Attachment:** [cubicbasin.png.gz](https://github.com/sagemath/sage/files/ticket11837/cubicbasin.png.gz)\n\nWhat you get with this slow implementation - at least it works!",
...
**Attachment:** [cubicbasin.png.gz](https://github.com/sagemath/sage/files/ticket11837/cubicbasin.png.gz)
...
```json
{
    "body": "**Attachment:** [Betterfractal.png.gz](https://github.com/sagemath/sage/files/ticket11837/Betterfractal.png.gz)\n\nWith Simon's improvements",
...
**Attachment:** [Betterfractal.png.gz](https://github.com/sagemath/sage/files/ticket11837/Betterfractal.png.gz)
...
```json
{
    "body": "**Attachment:** [WithIterations.png.gz](https://github.com/sagemath/sage/files/ticket11837/WithIterations.png.gz)\n\nWith Simon's Cython and naive keeping track of iterations needed to converge",
...
**Attachment:** [WithIterations.png.gz](https://github.com/sagemath/sage/files/ticket11837/WithIterations.png.gz)
...
```json
{
    "body": "**Attachment:** [newton_basins_more_cython.spyx.gz](https://github.com/sagemath/sage/files/ticket11837/newton_basins_more_cython.spyx.gz)\n\nPut more cython into the basins",
