...
<a id='comment:25'></a>Here is something else that Mike Hansen mentioned on [a sage-devel thread](http://groups.google.com/group/sage-devel/browse_thread/thread/3fb9d33037670185) I also linked to in comment:4.
