...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157163",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>When working on this ticket, I also found a potentially serious bug, which is that the parameters `assume_disc_small` and `maximize_at_primes` of a number field were both lost upon pickling and unpickling. This ticket fixes that.   We used to have this bug:\n\n```\nsage: K.<a> = NumberField(x^3-2, assume_disc_small=True, maximize_at_primes=[2], latex_name='\\\\alpha', embedding=2^(1/3))\nsage: K._assume_disc_small\nTrue\nsage: K._maximize_at_primes\n[2]\nsage: L = loads(dumps(K))\nsage: L._assume_disc_small\nFalse\nsage: L._maximize_at_primes  # None\n```\n\nAttached patch fixes that.",
    "created_at": "2011-08-09T16:30:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157164",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>When working on this ticket, I also found a potentially serious bug, which is that the parameters `assume_disc_small` and `maximize_at_primes` of a number field were both lost upon pickling and unpickling. This ticket fixes that.   We used to have this bug:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157165",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157166",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157167",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I should comment on UniqueFactory and UniqueRepresentation (from sage.structure.unique*).   I made some attempt to use it, but decided against it for *this patch*.   The main reason is that I want to fully maintain backward compatibility with old pickled objects, since there are a lot of pickled number field elements in the wild, and that is really opaque using UniqueRepresentation.   (Also, I am concerned using UniqueRepresentation has some efficiency issues in terms of size and later changing how pickling works, since every time you pickle an object it wraps it in its own wrapper around other stuff, leading to another level of abstraction.)  I don't claim that the current approach is the easiest to maintain in the long run -- in fact, it got broke before by bad patches.  But in this new patch, I've added a ton of comments and a big warning to help prevent this in the future.",
    "created_at": "2011-08-09T17:22:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157168",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>I should comment on UniqueFactory and UniqueRepresentation (from sage.structure.unique*).   I made some attempt to use it, but decided against it for *this patch*.   The main reason is that I want to fully maintain backward compatibility with old pickled objects, since there are a lot of pickled number field elements in the wild, and that is really opaque using UniqueRepresentation.   (Also, I am concerned using UniqueRepresentation has some efficiency issues in terms of size and later changing how pickling works, since every time you pickle an object it wraps it in its own wrapper around other stuff, leading to another level of abstraction.)  I don't claim that the current approach is the easiest to maintain in the long run -- in fact, it got broke before by bad patches.  But in this new patch, I've added a ton of comments and a big warning to help prevent this in the future.
...
```json
{
    "body": "<a id='comment:5'></a>I also applied the patch to sage-4.7.2.alpha1 and ran \"make ptestlong\" with complete success.",
    "created_at": "2011-08-09T17:58:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157169",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>I also applied the patch to sage-4.7.2.alpha1 and ran "make ptestlong" with complete success.
...
```json
{
    "body": "<a id='comment:7'></a>It turns out that this ticket is also related with #10667. Since #10667 (among other things) extends caching of homsets, the non-uniqueness of number fields then yields actual coercion errors.",
    "created_at": "2011-09-06T06:29:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157171",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>It turns out that this ticket is also related with #10667. Since #10667 (among other things) extends caching of homsets, the non-uniqueness of number fields then yields actual coercion errors.
...
```json
{
    "body": "<a id='comment:9'></a>One problem bugging me at #10667 remains: If one calls the method `point_exact` from sage.schemes.elliptic_curves.heegner with the option `optimize=True` then a non-unique absolute number field (namely `Number Field in a with defining polynomial x^12 + 4*x^11 + 56*x^10 + 170*x^9 + 1130*x^8 + 2564*x^7 + 10791*x^6 + 18054*x^5 + 51340*x^4 + 57530*x^3 + 102986*x^2 + 53724*x + 35001`) emerges.\n\nIf I can fix it then I'll post a patch here, not at #10667.",
    "created_at": "2011-09-06T07:01:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157173",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>One problem bugging me at #10667 remains: If one calls the method `point_exact` from sage.schemes.elliptic_curves.heegner with the option `optimize=True` then a non-unique absolute number field (namely `Number Field in a with defining polynomial x^12 + 4*x^11 + 56*x^10 + 170*x^9 + 1130*x^8 + 2564*x^7 + 10791*x^6 + 18054*x^5 + 51340*x^4 + 57530*x^3 + 102986*x^2 + 53724*x + 35001`) emerges.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157175",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157179",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157180",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157181",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157182",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11670#event-30636"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11670#event-30637"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11670#event-30638"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/saraedum/ticket/11670\"",
    "created_at": "2014-04-08T09:08:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157183",
    "user": "https://github.com/saraedum"
}
```

Changing branch from "" to "u/saraedum/ticket/11670"
...
```json
{
    "body": "<a id='comment:20'></a>With the branch I just pushed, I got rid of ``_set_structure``. The structure of a number field is now always set when it is created. I know that unpickling of old objects is currently broken, I'm working on a fix. Anyway, maybe somebody already wants to have a look at what I have done so far? Any comments would be appreciated.\n\nShould I now add old number field pickles to the pickle jar? I could not find out how to do this from the reference manual. Or is this somehow done automagically?\n\n---\nNew commits:",
    "created_at": "2014-04-08T09:14:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157184",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:20'></a>With the branch I just pushed, I got rid of ``_set_structure``. The structure of a number field is now always set when it is created. I know that unpickling of old objects is currently broken, I'm working on a fix. Anyway, maybe somebody already wants to have a look at what I have done so far? Any comments would be appreciated.
...
```json
{
    "body": "Changing commit from \"\" to \"cab3fe1eb4c425f0028b221494f95a03199f2936\"",
    "created_at": "2014-04-08T09:14:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157185",
    "user": "https://github.com/saraedum"
}
```

Changing commit from "" to "cab3fe1eb4c425f0028b221494f95a03199f2936"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157187",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157188",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157189",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "Changing commit from \"cab3fe1eb4c425f0028b221494f95a03199f2936\" to \"70702aa690a31cc36b9febe36462c67ebd57dcee\"",
    "created_at": "2014-04-09T14:52:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157190",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "cab3fe1eb4c425f0028b221494f95a03199f2936" to "70702aa690a31cc36b9febe36462c67ebd57dcee"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157191",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157192",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157194",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157196",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157197",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157198",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>With your changes, Sage doesn't complain anymore if the user does not specify the name of the generator, but silently names it \"a\":\n\n```\nsage: K = NumberField(x^2 + 1); K\nNumber Field in a with defining polynomial x^2 + 1\n```\nI don't like this; since the name is part of the defining data, I think we should insist on the user specifying the name.  If you think this should be changed, I think it is better to create a new ticket so this interface issue can be discussed separately from the technical changes made in this ticket.",
    "created_at": "2014-04-10T11:31:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157201",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:33'></a>With your changes, Sage doesn't complain anymore if the user does not specify the name of the generator, but silently names it "a":
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157202",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"70702aa690a31cc36b9febe36462c67ebd57dcee\" to \"8e968244cb356aaa863eb6a3caff46c74d48f182\"",
    "created_at": "2014-04-10T11:56:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157203",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "70702aa690a31cc36b9febe36462c67ebd57dcee" to "8e968244cb356aaa863eb6a3caff46c74d48f182"
...
```json
{
    "body": "Changing branch from \"u/saraedum/ticket/11670\" to \"u/pbruin/11670-NumberField_unique\"",
    "created_at": "2014-04-10T17:25:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157205",
    "user": "https://github.com/pjbruin"
}
```

Changing branch from "u/saraedum/ticket/11670" to "u/pbruin/11670-NumberField_unique"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157206",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Changing commit from \"8e968244cb356aaa863eb6a3caff46c74d48f182\" to \"9b4deffd7823cc4e71c6122b99615d765bd9d87f\"",
    "created_at": "2014-04-10T17:25:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157207",
    "user": "https://github.com/pjbruin"
}
```

Changing commit from "8e968244cb356aaa863eb6a3caff46c74d48f182" to "9b4deffd7823cc4e71c6122b99615d765bd9d87f"
...
```json
{
    "body": "<a id='comment:36'></a>Thanks.  I made a reviewer patch to fix some typos, formatting and Python 3 compatibility things; I changed the error message for `name=None` back to what it was to fix one failing doctest.\n\nI would be happy give this a positive review, but I think it is better if Simon or someone else with expertise in this area takes a quick look at it as well.",
    "created_at": "2014-04-10T17:25:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157208",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:36'></a>Thanks.  I made a reviewer patch to fix some typos, formatting and Python 3 compatibility things; I changed the error message for `name=None` back to what it was to fix one failing doctest.
...
```json
{
    "body": "Changing work_issues from \"\" to \"merge conflicts with 6.2\u03b28\"",
    "created_at": "2014-04-15T08:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157209",
    "user": "https://github.com/mezzarobba"
}
```

Changing work_issues from "" to "merge conflicts with 6.2β8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157210",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157211",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"9b4deffd7823cc4e71c6122b99615d765bd9d87f\" to \"8b06ff7d7fef13bd3746a1524bc5744242f1a75e\"",
    "created_at": "2014-04-22T16:08:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157212",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "9b4deffd7823cc4e71c6122b99615d765bd9d87f" to "8b06ff7d7fef13bd3746a1524bc5744242f1a75e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157213",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157214",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157215",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>OK, let's not leave this to bitrot.  As an additional test, I checked that #11669 (which depends on this ticket) still works correctly, and it does.",
    "created_at": "2014-05-02T13:57:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157216",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:40'></a>OK, let's not leave this to bitrot.  As an additional test, I checked that #11669 (which depends on this ticket) still works correctly, and it does.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157217",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11670#event-30639"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11670#event-30640"
}
```
...
```json
{
    "body": "Changing branch from \"u/pbruin/11670-NumberField_unique\" to \"8b06ff7d7fef13bd3746a1524bc5744242f1a75e\"",
    "created_at": "2014-05-06T22:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157218",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/pbruin/11670-NumberField_unique" to "8b06ff7d7fef13bd3746a1524bc5744242f1a75e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11670#event-30641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11670#issuecomment-157219",
    "user": "https://github.com/vbraun"
}
```
