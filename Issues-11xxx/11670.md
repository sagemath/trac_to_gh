...
```json
{
    "body": "<a id='comment:20'></a>\nWith the branch I just pushed, I got rid of ``_set_structure``. The structure of a number field is now always set when it is created. I know that unpickling of old objects is currently broken, I'm working on a fix. Anyway, maybe somebody already wants to have a look at what I have done so far? Any comments would be appreciated.\n\nShould I now add old number field pickles to the pickle jar? I could not find out how to do this from the reference manual. Or is this somehow done automagically?\n\n---\nNew commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[c9b7129](http://git.sagemath.org/sage.git/commit/?id=c9b7129c203f9c73c3959257ac0470c62cd68432)|`Removed number field's _set_structure() which breaks caching`|\n|[16aa7ec](http://git.sagemath.org/sage.git/commit/?id=16aa7ec42263cc6767a6e898e2ea125248a5491b)|`Create number fields in a factory to make sure they are unique parents.`|\n|[835c817](http://git.sagemath.org/sage.git/commit/?id=835c817cae746755cf8c46fc5c996fb0f7ff1a6f)|`Implemented NumberFieldStructure classes to improve caching of (absolute) number fields.`|\n|[3a11836](http://git.sagemath.org/sage.git/commit/?id=3a11836185f41fbce189ae979ecc6ee0028ab985)|`Made assume_disc_small part of the key for the number field cache (as it used to be).`|\n|[cab3fe1](http://git.sagemath.org/sage.git/commit/?id=cab3fe1eb4c425f0028b221494f95a03199f2936)|`added missing docstrings to number field factories`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[71532de](http://git.sagemath.org/sage.git/commit/?id=71532de7b9e7a1b4c22d367cdae3c3c4d1fb2840)|`Hash function for absolute number fields.`|\n|[af58e0c](http://git.sagemath.org/sage.git/commit/?id=af58e0cdc9101bfad57b7effa24d93d3fb257b48)|`Fixed unpickling of absolute number fields`|\n|[7bb5b88](http://git.sagemath.org/sage.git/commit/?id=7bb5b8880beabf606cb71900f7abbf36c45ccc3f)|`Added a test case to verify that pickling preserves the structure of a relative number field.`|\n|[622b238](http://git.sagemath.org/sage.git/commit/?id=622b238987f2ff84618050028ea4a42d8842cfc7)|`Pickling is broken for relative number fields. The structure of a number field is lost. Added a doctest to document this behaviour.`|\n|[9e8de67](http://git.sagemath.org/sage.git/commit/?id=9e8de679c62d695aa277da171a9099f65944b036)|`Relative and absolute number fields defined by the same (absolute) polynomial should not be equal.`|\n|[0581f37](http://git.sagemath.org/sage.git/commit/?id=0581f379070c7ceade3d573e96bdf8d2cdc8186c)|`A number field's structure() may define conversion maps between number fields`|\n|[baeeb5c](http://git.sagemath.org/sage.git/commit/?id=baeeb5c72004174bd26517d291f872fc21724dcd)|`fixed a pickling test case`|\n|[70702aa](http://git.sagemath.org/sage.git/commit/?id=70702aa690a31cc36b9febe36462c67ebd57dcee)|`Fixed a hash doctest.`|",
    "created_at": "2014-04-09T14:52:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11670",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[8b06ff7](http://git.sagemath.org/sage.git/commit/?id=8b06ff7d7fef13bd3746a1524bc5744242f1a75e)|`Merge branch 'develop' into ticket/11670-NumberField_unique`|",
