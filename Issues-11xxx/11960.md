...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165023",
...
```json
{
    ...
    "milestone": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11960#event-31661"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I think matrix_of_frobenius is only failing because the short Weierstrass equation has bad reduction at 3. If you manually write down a Weierstrass equation of the form `y^2 = P(x)` with good reduction at 3, everything works:\n\n```\nsage: E = EllipticCurve('83a1')\nsage: E\nElliptic Curve defined by y^2 + x*y + y = x^3 + x^2 + x over Rational Field\nsage: pr.<x> = PolynomialRing(QQ)\nsage: a = x^3 + x^2 + x\nsage: b = x + 1\nsage: C = HyperellipticCurve(a + b^2/4)\nsage: C.matrix_of_frobenius(3)\n[                                2*3 + 3^5 + 2*3^6 + 3^8 + 3^11 + 2*3^12 + 2*3^13 + 2*3^14 + 2*3^15 + 3^16 + 3^18 + 3^19 + O(3^20)               2*3 + 2*3^2 + 2*3^3 + 2*3^7 + 3^8 + 2*3^9 + 2*3^10 + 2*3^11 + 2*3^13 + 3^14 + 3^15 + 2*3^16 + 3^17 + 3^19 + O(3^20)]\n[2*3 + 3^2 + 2*3^5 + 3^6 + 2*3^7 + 2*3^9 + 3^10 + 3^11 + 3^12 + 3^13 + 2*3^14 + 2*3^15 + 2*3^16 + 2*3^17 + 2*3^18 + 3^19 + O(3^20)                     2 + 2*3^2 + 2*3^3 + 2*3^4 + 3^5 + 2*3^7 + 3^8 + 2*3^9 + 2*3^10 + 3^11 + 3^16 + 2*3^17 + 3^18 + 3^19 + O(3^20)]\n```",
    "created_at": "2016-03-21T16:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165024",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:2'></a>I think matrix_of_frobenius is only failing because the short Weierstrass equation has bad reduction at 3. If you manually write down a Weierstrass equation of the form `y^2 = P(x)` with good reduction at 3, everything works:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165025",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>For the record, PARI also has code which does this.",
    "created_at": "2016-03-21T17:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165026",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>For the record, PARI also has code which does this.
...
```json
{
    "body": "<a id='comment:5'></a>Would it make sense to have `EllipticCurve.matrix_of_frobenius` call out to `HyperellipticCurve.matrix_of_frobenius` and then have the triage among different code options be handled there?",
    "created_at": "2016-05-05T01:09:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165027",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:5'></a>Would it make sense to have `EllipticCurve.matrix_of_frobenius` call out to `HyperellipticCurve.matrix_of_frobenius` and then have the triage among different code options be handled there?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165028",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165029",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Added a fix following the suggestion above to call the hyperelliptic code, passing in a Weierstrass equation that has good reduction at 3.\n\n---\nNew commits:",
    "created_at": "2017-07-18T16:43:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165030",
    "user": "https://github.com/jbalakrishnan"
}
```

<a id='comment:8'></a>Added a fix following the suggestion above to call the hyperelliptic code, passing in a Weierstrass equation that has good reduction at 3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165031",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165032",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165033",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165034",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165035",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165036",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165037",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11960#event-31662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11960#issuecomment-165038",
    "user": "https://github.com/vbraun"
}
```
