...
```json
{
    "body": "<a id='comment:19'></a>\nWhich patch is to be applied?  Just the last one - [attachment:trac_11528_matrix_delete_rows_columns.patch](https://github.com/sagemath/sage/files/ticket11528/trac_11528_matrix_delete_rows_columns.patch) - or all three?  Just be sure to modify the ticket description (click \"Modify Ticket\" to see a surprise, all the stuff that *used* to be obviously visible, sigh).",
