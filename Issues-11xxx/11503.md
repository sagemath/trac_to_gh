...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140041"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140043"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout, @qed777, @williamstein** to **@gutow**",
...
Changed assignee from **@jasongrout, @qed777, @williamstein** to **@gutow**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,4 +9,4 @@\n ```\n 2. Some patches are necessary to notebook paths and the plot3d code\n    1. for flask [attachment: trac_11503_path_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_path_fix.patch.gz)\n-   2. for plot3d package\u00a0\n+   2. for plot3d package\u00a0[attachment: trac_11503_cmd_line_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_cmd_line_fix.patch.gz)\n``````\n",
    "created_at": "2011-06-16T16:38:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140052"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,6 +9,5 @@\n ```\n   (which lives at [this location](http://www.uwosh.edu/faculty_staff/gutow/Jmol-12.0.45.p2.spkg))\n \n-2. Some patches are necessary to notebook paths and the plot3d code\n-   1. for flask [attachment: trac_11503_path_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_path_fix.patch.gz)\n-   2. for plot3d package [attachment: trac_11503_cmd_line_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_cmd_line_fix.patch.gz)\n+2. A patch is necessary to notebook pathsfor flask [attachment: trac_11503_path_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_path_fix.patch.gz)\n+\n``````\n",
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140058"
}
```
...
```json
{
    "body": "<a id='comment:16'>Comment 16:</a>\nAttachment: **[trac11503.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac11503.patch.gz)**\n\nI've looked over the spkg, and modulo my fixes to `spkg-install`, I can give it a positive review. My changes are in [attachment: trac11503.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac11503.patch.gz) and I have a spkg with those changes at http://sagenb.kaist.ac.kr/~drake/Jmol-12.0.45.p3.spkg. It's identical to Jonathan's version except for the changes in [attachment: trac11503.patch..gz](https://github.com/sagemath/sage/files/ticket11503/trac11503.patch..gz)\n\nJason, you volunteered to look it over, but that shouldn't stop anyone else. :)",
    "created_at": "2012-01-11T07:13:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,9 +5,8 @@\n 1. install this .spkg\n \n ```\n-./sage -f \"http://www.uwosh.edu/faculty_staff/gutow/Jmol-12.0.45.p2.spkg\n+./sage -f \"http://sagenb.kaist.ac.kr/~drake/Jmol-12.0.45.p3.spkg\"\n ```\n-  (which lives at [this location](http://www.uwosh.edu/faculty_staff/gutow/Jmol-12.0.45.p2.spkg))\n+  (which lives at  [this location](http://sagenb.kaist.ac.kr/~drake/Jmol-12.0.45.p3.spkg))\n \n-2. A patch is necessary to notebook pathsfor flask [attachment: trac_11503_path_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_path_fix.patch.gz)\n-\n+2. A patch is necessary to notebook paths for flask [attachment: trac_11503_path_fix.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac_11503_path_fix.patch.gz)\n``````\n",
...
```json
{
    "body": "<a id='comment:17'>Comment 17:</a>\nDan's changes look good to me (obviously much more experience writing these scripts than I have:))\u00a0I suggest we try Dan's .spkg for the review and have changed the description to reflect this.\n\nJonathan\n\nReplying to [@dandrake](#comment%3A16):\n\n> I've looked over the spkg, and modulo my fixes to `spkg-install`, I can give it a positive review. My changes are in [attachment: trac11503.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac11503.patch.gz) and I have a spkg with those changes at http://sagenb.kaist.ac.kr/~drake/Jmol-12.0.45.p3.spkg. It's identical to Jonathan's version except for the changes in [attachment: trac11503.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac11503.patch.gz)Jason, you volunteered to look it over, but that shouldn't stop anyone else. :)",
    "created_at": "2012-01-11T14:21:03Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140062"
}
```
...
```json
{
    "body": "<a id='comment:23'>Comment 23:</a>\nSo I think what needs to be done at this point is:\n\n1. Make the jmol spkg not start with a capital letter (simple rename of the spkg file)\n\n2. Apply the [attachment: trac-11503-jmol-spkg.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac-11503-jmol-spkg.patch.gz) to the sage root repository, make an sdist, put the jmol spkg in there, and try building.  In essence, review the changes to the sage root repository.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140064"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,4 +9,6 @@\n ```\n   (which lives at  [this location](http://sagenb.kaist.ac.kr/~drake/Jmol-12.0.45.p3.spkg))\n \n+2. Apply [attachment: trac-11503-jmol-spkg.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac-11503-jmol-spkg.patch.gz) to the sage root repository.\n+\n The necessary patch for sagenb has already been merged with the master sagenb branch: https://github.com/sagemath/sagenb/pull/28\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140065"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140066"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140067"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140068"
}
```
...
```json
{
    "body": "<a id='comment:36'>Comment 36:</a>\nTo review this ticket, this is what is left:\n\n* My and jdemeyer's changes to the spkg (reformatting SPKG.txt, basically)\n* the [attachment: trac-11503-jmol-commandline.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac-11503-jmol-commandline.patch.gz) that fixes command-line jmol",
...
```json
{
    "body": "<a id='comment:38'>Comment 38:</a>\nSince jmol doesn't use setuptools, it should be listed normally between the dependencies.  My new [attachment: trac-11503-jmol-spkg.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac-11503-jmol-spkg.patch.gz) does this.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140070"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119035",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119036",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119037",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119038",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119039",
...
```json
{
    "body": "<a id='comment:46'>Comment 46:</a>\nThe attachment [attachment: trac-11503-jmol-spkg.2.patch.gz](https://github.com/sagemath/sage/files/ticket11503/trac-11503-jmol-spkg.2.patch.gz) has been rebased to sage-5.0beta11. Compiling it now (along with #11874 and the patches to `SAGE_ROOT` from #11080).",
    "created_at": "2012-04-02T08:57:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119040",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119041",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140073"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119042",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119043",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119044",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119045",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119046",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119047",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119048",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119049",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119050",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140077"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119051",
    "user": "https://github.com/gutow"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140079"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119052",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119053",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140081"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140082"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119054",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119055",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119056",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140083"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140084"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119057",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119058",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119059",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11503#issuecomment-119060",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11503#event-140093"
}
```
