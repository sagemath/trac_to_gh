...
Replying to [@kcrisman](https://github.com/sagemath/sage/issues/11635#comment:0):
> and includes its own version of libtool (or rather the tools needed to generate it on the fly).
