...
```json
{
    "body": "<a id='comment:3'></a>This happens with plot too:\n\n```\nplot(lambda x: x*1+(1-x)*(1+1e-13),(x,0,1))\n```",
    "created_at": "2011-11-01T22:12:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142517",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>This happens with plot too:
...
```json
{
    "body": "<a id='comment:4'></a>It appears that the major locator is giving back bad values (i.e., somehow it is giving back [0,1,2] as the major tickmarks, which is then trimmed down to just 1, giving the minor locator error since there is only one major tickmark).\n\nI think the problem is somewhere in matplotlib.ticker.MaxNLocator.bin_boundaries function, but I'm not sure.",
    "created_at": "2011-11-01T22:33:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142518",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>It appears that the major locator is giving back bad values (i.e., somehow it is giving back [0,1,2] as the major tickmarks, which is then trimmed down to just 1, giving the minor locator error since there is only one major tickmark).
...
```json
{
    "body": "<a id='comment:5'></a>My test cases are:\n\n```\nsage: list_plot([0,0+1e-14]) # works\n\nsage: list_plot([1,1+1e-14]) # doesn't work\n\n```",
    "created_at": "2011-11-01T22:34:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142519",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>My test cases are:
...
```json
{
    "body": "<a id='comment:6'></a>I think the next step would be to try to replicate it using only matplotlib.  If we can do that, we can move the bug report upstream.",
    "created_at": "2011-11-01T22:35:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142520",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>I think the next step would be to try to replicate it using only matplotlib.  If we can do that, we can move the bug report upstream.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142521",
...
```json
{
    "body": "<a id='comment:8'></a>I think we can bump this up:\n\n```\nimport pylab\npylab.plot([0, 1], [0, 1e-14])\npylab.savefig(\"works.png\")\npylab.close()\npylab.plot([0, 1], [1, 1+1e-14])\npylab.savefig(\"fails.png\")\npylab.close()\n```\n\nreproduces the problem in mpl 1.2.x.",
    "created_at": "2012-05-25T19:27:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142522",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```

<a id='comment:8'></a>I think we can bump this up:
...
```json
{
    "body": "<a id='comment:9'></a>Great; if you can post to the matplotlib mailing list and post the thread URL here, that would be great.",
    "created_at": "2012-05-25T19:30:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142523",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:9'></a>Great; if you can post to the matplotlib mailing list and post the thread URL here, that would be great.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142524",
...
```json
{
    "body": "<a id='comment:11'></a>I'll contact matplotlib-devel and see what they think of the problem.",
    "created_at": "2012-05-25T21:58:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142525",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:11'></a>I'll contact matplotlib-devel and see what they think of the problem.
...
```json
{
    "body": "<a id='comment:12'></a>Interesting: the example I gave in the description works in 5.1beta0 (64-bit Linux), but the y-axis doesn't have any labels. The plot is correct for the given data, though.",
    "created_at": "2012-05-25T22:47:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142526",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:12'></a>Interesting: the example I gave in the description works in 5.1beta0 (64-bit Linux), but the y-axis doesn't have any labels. The plot is correct for the given data, though.
...
```json
{
    "body": "<a id='comment:17'></a>everything works in 6.6.rc0",
    "created_at": "2015-03-21T21:03:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142527",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:17'></a>everything works in 6.6.rc0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142528",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142529",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11973",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11973#issuecomment-142530",
