...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -8,3 +8,4 @@\n 0\n ```\n \n+Apply: https://github.com/sagemath/sage/files/ticket11300/trac_11300-get_part_partition-jb.2.patch\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -8,4 +8,4 @@\n 0\n ```\n \n-Apply: https://github.com/sagemath/sage/files/ticket11300/trac_11300-get_part_partition-jb.2.patch\n+Apply: [trac_11300-get_part_partition-jb.2.patch](https://github.com/sagemath/sage/files/ticket11300/trac_11300-get_part_partition-jb.2.patch)\n``````\n",
