...
```json
{
    "body": "Here is a branch implementing this. This was tested with Macaulay2 version 1.12 and 1.13 using\n\n```\n./sage -t --long --optional=sage,macaulay2 $(grep -i \"optional.*macaulay2\" -r src/sage -l | paste -sd \" \" -)\n```\n\n---\nNew commits:",
    "created_at": "2019-07-15T21:00:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11217",
    "type": "issue_comment",
...
```json
{
    "body": "looks good, works and pass the tests => positive review\n\nMaybe one should send \"sageDescribe\" to upstream ?",
...
```json
{
    "body": "Thanks. I opened https://github.com/Macaulay2/M2/issues/967 about this.",
