...
```json
{
    "body": "Changed assignee from **@sagetrac-sage-combinat** to **@wdjoyner**",
...
Changed assignee from **@sagetrac-sage-combinat** to **@wdjoyner**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11324#event-137261"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11324#event-137262"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11324#event-137263"
}
```
