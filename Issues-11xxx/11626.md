...
```json
{
    "body": "<a id='comment:1'></a>Does #1173 solve this (it uses mpmath)?  It's certainly possible there to do `erf(2).n(54)` or such, not sure about your syntax as I don't have a Sage install with this patch currently.  But this should do it.\n\n---\n\nYou are certainly correct about searching Trac.  Sorry that neither this ticket nor #1173 can address that :)",
    "created_at": "2011-08-01T16:39:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156219",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Does #1173 solve this (it uses mpmath)?  It's certainly possible there to do `erf(2).n(54)` or such, not sure about your syntax as I don't have a Sage install with this patch currently.  But this should do it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156220",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is then now part of #1173.   Putting this as duplicate.\n\nTo release manager: positive review as duplicate.",
    "created_at": "2011-08-18T14:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156221",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>This is then now part of #1173.   Putting this as duplicate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156222",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11626#event-30502"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Paul Zimmermann, Karl-Dieter Crisman\"",
    "created_at": "2011-08-18T14:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156223",
    "user": "https://github.com/kcrisman"
}
```

Changing reviewer from "" to "Paul Zimmermann, Karl-Dieter Crisman"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156224",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11626#event-30503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11626#issuecomment-156225",
