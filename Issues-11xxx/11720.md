...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30814"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30815"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30816"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Git doesn't do anything special for bzipped files, in particular space usage will grow with the size of the pickle jar.\n\nHow about we distribute the pickle jar like any other database, as a tarball with a dummy `build/pkg/pickle_jar`?",
    "created_at": "2014-05-03T08:12:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11720#issuecomment-158750",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>Git doesn't do anything special for bzipped files, in particular space usage will grow with the size of the pickle jar.
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30817"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30818"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30819"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11720",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30821"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Duplicate of #10768.",
    "created_at": "2017-03-08T13:19:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11720#issuecomment-158751",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Duplicate of #10768.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30822"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11720#event-30823"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11720#issuecomment-158752",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11720#issuecomment-158753",
...
```json
{
    "body": "<a id='comment:8'></a>Sorry, this branch was intended for a ticket #17720 (typo).",
    "created_at": "2021-01-29T02:56:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11720#issuecomment-158754",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:8'></a>Sorry, this branch was intended for a ticket #17720 (typo).
