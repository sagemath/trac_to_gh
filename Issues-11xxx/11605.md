...
archive/attachments_015904.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_11605-pari_spkg-install_fixes.spkg.patch](https://github.com/sagemath/sage/files/ticket11605/trac_11605-pari_spkg-install_fixes.spkg.patch)\n\nSPKG patch. Contains both the changes from here and #10240. Apply to pari-2.4.3.alpha.p5 if at all.",
    "created_at": "2011-07-16T15:45:47Z",
    "issue": "https://github.com/sagemath/sage/issues/11605",
    "type": "issue_comment",
...
**Attachment:** [trac_11605-pari_spkg-install_fixes.spkg.patch](https://github.com/sagemath/sage/files/ticket11605/trac_11605-pari_spkg-install_fixes.spkg.patch)
...
archive/attachments_015905.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_11605_combined_with_10240.spkg.patch](https://github.com/sagemath/sage/files/ticket11605/trac_11605_combined_with_10240.spkg.patch)\n\nDiff between the p5 and the p7. For reference / review.",
    "created_at": "2011-07-16T15:47:43Z",
    "issue": "https://github.com/sagemath/sage/issues/11605",
    "type": "issue_comment",
...
**Attachment:** [trac_11605_combined_with_10240.spkg.patch](https://github.com/sagemath/sage/files/ticket11605/trac_11605_combined_with_10240.spkg.patch)
