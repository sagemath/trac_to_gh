...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150446",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150447",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150448",
...
```json
{
    "body": "<a id='comment:2'></a>Um, I don't really understand the documentation of the first (private) function. Could you please expand/rewrite it a bit?-) In particular the INPUT section is a bit confusing given that there are two parameters and one of them is already called cone.\n\nAs a possible optimization\n\n```\nreturn ToricVariety(Fan(cones))\n```\ncan be replaced with\n\n```\nreturn ToricVariety(Fan(discard_faces(cones), check=False))\n```\nwhere `discard_faces` is added to the fan module by #11200.",
    "created_at": "2011-05-30T02:31:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150449",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:2'></a>Um, I don't really understand the documentation of the first (private) function. Could you please expand/rewrite it a bit?-) In particular the INPUT section is a bit confusing given that there are two parameters and one of them is already called cone.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150450",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150451",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"documentation clarification\"",
    "created_at": "2011-06-17T18:50:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150452",
    "user": "https://github.com/novoselt"
}
```

Changing work_issues from "" to "documentation clarification"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150453",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150454",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I've added some documentation and a reference to [CLS].",
    "created_at": "2011-06-29T19:47:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150455",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>I've added some documentation and a reference to [CLS].
...
```json
{
    "body": "<a id='comment:7'></a>For the record - I have not abandoned this patch ;-) I would be happier if the default was to construct the fan of the orbit closure in the honest quotient lattice. I suspect Volker has not done it this way because it just does not work. Well, I am trying to make it work, since it will be yet another step in the direction of the full support of quotients and sublattices. I think they should be freely usable everywhere where lattices can be used, because, well, they are lattices as well ;-)",
    "created_at": "2011-07-11T13:07:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150458",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:7'></a>For the record - I have not abandoned this patch ;-) I would be happier if the default was to construct the fan of the orbit closure in the honest quotient lattice. I suspect Volker has not done it this way because it just does not work. Well, I am trying to make it work, since it will be yet another step in the direction of the full support of quotients and sublattices. I think they should be freely usable everywhere where lattices can be used, because, well, they are lattices as well ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150459",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11385#event-29554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150461",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150462",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150464",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150465",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150466",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150467",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11385#issuecomment-150468",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11385",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11385#event-29555"
}
```
