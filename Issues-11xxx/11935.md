...
```json
{
    ...
    "type": "issue",
    "updated_at": "2013-08-01T07:30:29Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135991"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135993"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135995"
}
```
...
```json
{
    "body": "**Attachment:** [trac11935_weak_pickling_by_construction.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac11935_weak_pickling_by_construction.patch.gz)\n\nUse a weak form of \"pickling by construction\" for parent and element classes of categories",
...
**Attachment:** [trac11935_weak_pickling_by_construction.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac11935_weak_pickling_by_construction.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135996"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135997"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135998"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-135999"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136003"
}
```
...
```json
{
    "body": "**Attachment:** [trac11935_named_class.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac11935_named_class.patch.gz)\n\nRefactor parent/element class creation: Use _make_named_class",
...
**Attachment:** [trac11935_named_class.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac11935_named_class.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136004"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136005"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136013"
}
```
...
```json
{
    "body": "**Attachment:** [trac11935_share_on_base_category.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac11935_share_on_base_category.patch.gz)",
...
**Attachment:** [trac11935_share_on_base_category.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac11935_share_on_base_category.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136017"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11935-weak_pickling_by_construction-review-ts.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac_11935-weak_pickling_by_construction-review-ts.patch.gz)",
...
**Attachment:** [trac_11935-weak_pickling_by_construction-review-ts.patch.gz](https://github.com/sagemath/sage/files/ticket11935/trac_11935-weak_pickling_by_construction-review-ts.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136019"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136020"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11935",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11935#event-136023"
}
```
