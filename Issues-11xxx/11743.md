...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11743#event-144121"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11743#event-144122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11743#event-144123"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11743#issuecomment-124280",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11743#issuecomment-124281",
    "user": "https://github.com/jdemeyer"
}
```
