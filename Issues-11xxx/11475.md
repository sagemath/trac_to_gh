...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139592"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139596"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -89,4 +89,6 @@\n \n Finally, I have introduced the `legendres_formula` method, which takes two arguments, `x` and `a`, and returns the number of positive integers less than `x` that are not divisible by the first `a` primes. This function is core to all combinatorial methods for computing the prime counting function, so I figured that I would make this publicly accessible now that I have clean code.\n \n-Apply trac_11475v2.patch\n+---\n+\n+Apply only [attachment: trac_11475v2.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v2.patch.gz).\n``````\n",
    "created_at": "2011-06-15T20:35:12Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -91,4 +91,4 @@\n \n ---\n \n-Apply only [attachment: trac_11475v4.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v4.patch.gz).\n+Apply only [attachment: trac_11475v5.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v5.patch.gz).\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139598"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -91,4 +91,4 @@\n \n ---\n \n-Apply only [attachment: trac_11475v5.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v5.patch.gz).\n+Apply only [attachment: trac_11475v6.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v6.patch.gz).\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139599"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139604"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -81,14 +81,14 @@\n 625 loops, best of 3: 343 ns per loop\n ```\n \n-This doesn't cost very much memory, since everything is stored as 32-bit ints, but `prime_range` is currently built on top of pari, which poses a number of problems, but the primary concern is that it is a memory hog when sieving to a large upper bound (important for plotting purposes).\n+This doesn't cost very much memory, since everything is stored as 32-bit ints, but `prime_range()` is currently built on top of PARI, which poses a number of problems, but the primary concern is that it is a memory hog when sieving to a large upper bound (important for plotting purposes).\n \n-I know that this implementation starts to fail to give correct output on 64-bit systems somewhere between `9.5*10**15` and `9.75*10**15`, for issues that I have been unable to determine. I have limited input to be `< 2**49`, which I am fairly confident is safe, as I have done a fair bit of testing in this range trying to debug this issue (despite it taking hours per call). I would appreciate testing on 32-bit platforms.\n+An earlier version of this implementation started to fail to give correct output on 64-bit systems somewhere between `9.5*10**15` and `9.75*10**15`, for issues that I had previously been unable to determine, so I had initially limited input to be `< 2**49`, which I am fairly confident is safe, as I have done a fair bit of testing in this range trying to debug this issue (despite it taking hours per call). I would appreciate testing on 32-bit platforms.\n \n A lot of the speed of this algorithm relies on the `__cached_count` method, which is essentially a binary search (with a simple adjustment in the beginning that takes advantage of the density of the primes). This is the fastest type of binary search I know of, but if anyone knows of a way to speed it up, it could have a significant effect. (Thanks to Yann for his suggestion)\n \n-Finally, I have introduced the `legendres_formula` method, which takes two arguments, `x` and `a`, and returns the number of positive integers not larger than `x` that are not divisible by -- i.e. co-prime to -- each of the first `a` primes. This function is core to all combinatorial methods for computing the prime counting function, so I figured that I would make this publicly accessible now that I have clean code.\n+Finally, I have introduced the `legendres_formula` method, which takes two arguments, `x` and `a`, and returns the number of positive integers not larger than `x` that are not divisible by any -- i.e. co-prime to each -- of the first `a` primes. This function is core to all combinatorial methods for computing the prime counting function, so I figured that I would make this publicly accessible now that I have clean code.\n \n ---\n \n-Apply only [attachment: trac_11475v6.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v6.patch.gz).\n+Apply only [attachment: trac_11475v8.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v8.patch.gz).\n``````\n",
    "created_at": "2011-06-24T13:54:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -91,4 +91,4 @@\n \n ---\n \n-Apply only [attachment: trac_11475v8.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v8.patch.gz).\n+Apply only [attachment: trac_11475v9.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v9.patch.gz).\n``````\n",
    "created_at": "2011-06-28T10:33:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118577",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118578",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118579",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118580",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118581",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118582",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118583",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118584",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118585",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -91,4 +91,4 @@\n \n ---\n \n-Apply only [attachment: trac_11475v9.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v9.patch.gz).\n+Apply only [attachment: trac_11475v10.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v10.patch.gz).\n``````\n",
    "created_at": "2011-07-04T11:55:16Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118586",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118587",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -91,4 +91,8 @@\n \n ---\n \n-Apply only [attachment: trac_11475v10.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v10.patch.gz).\n+Apply\n+1. [attachment: trac_11475v10.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475v10.patch.gz)\n+2. [attachment: trac_11475-v10_reviewer_1.sagelib.patch.gz](https://github.com/sagemath/sage/files/ticket11475/trac_11475-v10_reviewer_1.sagelib.patch.gz)\n+to the **Sage library**.\n+\n``````\n",
    "created_at": "2011-07-08T15:22:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118588",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118589",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118591",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118592",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118593",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118594",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139608"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118595",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118596",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118597",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118598",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118599",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118600",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118601",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118602",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118603",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118604",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118605",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118606",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118607",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118608",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139617"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139618"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139619"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118609",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118610",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118611",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139621"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139622"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118612",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118613",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118614",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118615",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118616",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139623"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139624"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118617",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118618",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118619",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118620",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118621",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139626"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139627"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139628"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118622",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11475#issuecomment-118623",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-139633"
}
```
