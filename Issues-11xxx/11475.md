...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128842"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128853"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -81,14 +81,14 @@\n 625 loops, best of 3: 343 ns per loop\n ```\n \n-This doesn't cost very much memory, since everything is stored as 32-bit ints, but `prime_range` is currently built on top of pari, which poses a number of problems, but the primary concern is that it is a memory hog when sieving to a large upper bound (important for plotting purposes).\n+This doesn't cost very much memory, since everything is stored as 32-bit ints, but `prime_range()` is currently built on top of PARI, which poses a number of problems, but the primary concern is that it is a memory hog when sieving to a large upper bound (important for plotting purposes).\n \n-I know that this implementation starts to fail to give correct output on 64-bit systems somewhere between `9.5*10**15` and `9.75*10**15`, for issues that I have been unable to determine. I have limited input to be `< 2**49`, which I am fairly confident is safe, as I have done a fair bit of testing in this range trying to debug this issue (despite it taking hours per call). I would appreciate testing on 32-bit platforms.\n+An earlier version of this implementation started to fail to give correct output on 64-bit systems somewhere between `9.5*10**15` and `9.75*10**15`, for issues that I had previously been unable to determine, so I had initially limited input to be `< 2**49`, which I am fairly confident is safe, as I have done a fair bit of testing in this range trying to debug this issue (despite it taking hours per call). I would appreciate testing on 32-bit platforms.\n \n A lot of the speed of this algorithm relies on the `__cached_count` method, which is essentially a binary search (with a simple adjustment in the beginning that takes advantage of the density of the primes). This is the fastest type of binary search I know of, but if anyone knows of a way to speed it up, it could have a significant effect. (Thanks to Yann for his suggestion)\n \n-Finally, I have introduced the `legendres_formula` method, which takes two arguments, `x` and `a`, and returns the number of positive integers not larger than `x` that are not divisible by -- i.e. co-prime to -- each of the first `a` primes. This function is core to all combinatorial methods for computing the prime counting function, so I figured that I would make this publicly accessible now that I have clean code.\n+Finally, I have introduced the `legendres_formula` method, which takes two arguments, `x` and `a`, and returns the number of positive integers not larger than `x` that are not divisible by any -- i.e. co-prime to each -- of the first `a` primes. This function is core to all combinatorial methods for computing the prime counting function, so I figured that I would make this publicly accessible now that I have clean code.\n \n ---\n \n-Apply only [attachment:trac_11475v6.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v6.patch).\n+Apply only [attachment:trac_11475v8.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v8.patch).\n``````\n",
    "created_at": "2011-06-24T13:54:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -91,4 +91,4 @@\n \n ---\n \n-Apply only [attachment:trac_11475v8.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v8.patch).\n+Apply only [attachment:trac_11475v9.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v9.patch).\n``````\n",
    "created_at": "2011-06-28T10:33:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -91,4 +91,4 @@\n \n ---\n \n-Apply only [attachment:trac_11475v9.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v9.patch).\n+Apply only [attachment:trac_11475v10.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v10.patch).\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -91,4 +91,8 @@\n \n ---\n \n-Apply only [attachment:trac_11475v10.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v10.patch).\n+Apply\n+1. [attachment:trac_11475v10.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475v10.patch)\n+2. [attachment:trac_11475-v10_reviewer_1.sagelib.patch](https://github.com/sagemath/sage/files/ticket11475/trac_11475-v10_reviewer_1.sagelib.patch)\n+to the **Sage library**.\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128865"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128866"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128868"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128869"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128870"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128871"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128872"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128873"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128874"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128875"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128876"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128877"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128878"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128880"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11475#event-128882"
}
```
