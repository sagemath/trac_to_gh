...
<a id='comment:20'></a>Replying to [comment:19 davidloeffler]:
> I'm not happy with this:
...
```json
{
    "body": "<a id='comment:23'></a>Replying to [comment:22 davideklund]:\n> Maybe these two methods should give consistent results.\n\n\nyes (go ahead)",
...
<a id='comment:23'></a>Replying to [comment:22 davideklund]:
> Maybe these two methods should give consistent results.
...
```json
{
    "body": "<a id='comment:26'></a>Replying to [comment:22 davideklund]:\n> Maybe these two methods should give consistent results.\n\n\nThanks, they do now. So the ticket needs review again.",
...
<a id='comment:26'></a>Replying to [comment:22 davideklund]:
> Maybe these two methods should give consistent results.
...
```json
{
    "body": "<a id='comment:27'></a>Replying to [comment:26 mstreng]:\n> Replying to [comment:22 davideklund]:\n> > Maybe these two methods should give consistent results.\n\n> \n> Thanks, they do now. So the ticket needs review again.\n\n\nOk, nice. I'm on it!",
...
<a id='comment:27'></a>Replying to [comment:26 mstreng]:
> Replying to [comment:22 davideklund]:
> > Maybe these two methods should give consistent results.
...
<a id='comment:30'></a>Replying to [comment:29 davideklund]:
> I'm not sure what this means or how to get rid off the fuzz.
...
<a id='comment:31'></a>Replying to [comment:30 mstreng]:
...
<a id='comment:33'></a>Replying to [comment:32 davideklund]:
> Here are two more beginner questions related to these patches: 
...
<a id='comment:36'></a>Replying to [comment:35 davideklund]:
> I only have two small comments on the patches:
...
<a id='comment:38'></a>Replying to [comment:35 davideklund]:
> This all looks good. If the other reviewers agree, we can change the status to positive review.
...
```json
{
    "body": "<a id='comment:40'></a>Replying to [comment:39 davideklund].\n\nThanks!",
...
<a id='comment:40'></a>Replying to [comment:39 davideklund].
