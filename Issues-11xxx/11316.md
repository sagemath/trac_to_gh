...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148647",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148648",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I think that using a method is a preferred way to get a property of an object rather than using an attribute, in Sage. So the attribute \"blocks\" of TermOrder is now a method. Use \n\nt.blocks()\n\ninstead of \n\nt.blocks\n\nPerhaps this change will require a deprecation warning. I am not sure how to do this for attributes.",
    "created_at": "2011-05-09T09:48:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148649",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:1'></a>I think that using a method is a preferred way to get a property of an object rather than using an attribute, in Sage. So the attribute "blocks" of TermOrder is now a method. Use 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148650",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148652",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>* the patch does not apply cleanly against 4.7.rc2, but the failure is minor: only an update of a docstring in `pbori.pyx` fails.\n  * Doctests do not pass for 4.7.rc2:\n   * `pbori.pyx` I didn't fix the patch to apply cleanly, hence was to be expected that this one fails.\n   * `sage_object.pyx` the patch seems to break pickling\n\nSo, the only real issue seems to be pickling.",
    "created_at": "2011-05-18T12:33:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148653",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>* the patch does not apply cleanly against 4.7.rc2, but the failure is minor: only an update of a docstring in `pbori.pyx` fails.
  * Doctests do not pass for 4.7.rc2:
   * `pbori.pyx` I didn't fix the patch to apply cleanly, hence was to be expected that this one fails.
   * `sage_object.pyx` the patch seems to break pickling
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148654",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148656",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148657",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148658",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148659",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>There was a bug in the matrix order of Sage, which did not allow negative integers in the matrix. This is fixed in the current patch.",
    "created_at": "2011-05-20T08:12:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148660",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:7'></a>There was a bug in the matrix order of Sage, which did not allow negative integers in the matrix. This is fixed in the current patch.
...
```json
{
    "body": "<a id='comment:10'></a>Perhaps, this is a good way of dealing with this:\n\n```python\ndef __getattr__(self,'name'):\n    if name == \"_weights\": # I don't think it works for double underscore attributes?\n        self._weights = None\n        return self._weights\n    else:\n        raise AttributeError(\"'TermOrder' has no attribute '%s'\"%name)\n```",
    "created_at": "2011-05-21T10:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148662",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>Perhaps, this is a good way of dealing with this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148663",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I kept double underscores in the new patch. I don't know why Martin do not like double underscore attributes. Do you think single underscore attributes are generally preferable over double ones? Or is it just for fixing unpickling problem.",
    "created_at": "2011-05-29T05:13:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148664",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:11'></a>I kept double underscores in the new patch. I don't know why Martin do not like double underscore attributes. Do you think single underscore attributes are generally preferable over double ones? Or is it just for fixing unpickling problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148665",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>For record,\n\nhttps://groups.google.com/forum/#!topic/sage-devel/z2r5ag-j1WY",
    "created_at": "2011-05-29T05:35:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148666",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:12'></a>For record,
...
```json
{
    "body": "<a id='comment:13'></a>Re double underscores: they make inheriting from an object harder, since a subclass cannot easily access \"_weights\". We seem to have a bias in Sage towards single underscores.",
    "created_at": "2011-05-29T07:52:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148667",
    "user": "https://github.com/malb"
}
```

<a id='comment:13'></a>Re double underscores: they make inheriting from an object harder, since a subclass cannot easily access "_weights". We seem to have a bias in Sage towards single underscores.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148672",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I just noticed that the second patch also changes old names: The old attribute `blocks` is renamed `__blocks` in the second patch, and there is a new method `blocks`. Hence, what used to be an attribute became a method.\n\nEven worse: An old pickle may contain the old attribute `block`. When reading it, wouldn't that attribute `block` override the new method `block` (unless one has an appropriate `__setattr__`, of course)?\n\nThat said, I do think that `block` should better be the name of a method and not of a plain attribute. \n\nAnd again, the question (addressed to all of you) is whether the reason for these changes is sufficient. There *is* a reason, but the changes make backward compatibility needlessly complicated IMHO.",
    "created_at": "2011-05-30T20:21:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148676",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:21'></a>I just noticed that the second patch also changes old names: The old attribute `blocks` is renamed `__blocks` in the second patch, and there is a new method `blocks`. Hence, what used to be an attribute became a method.
...
```json
{
    "body": "<a id='comment:22'></a>I haven't read the patch carefully, so I can't address any specific points, but I am OK with a major refactoring of the `TermOrder` class.\n\nOf course, we still need to ensure that old pickles can be accessed without problems. I would be happier if this patch went in with at least a minor version change (for example 4.8) and got a mention for breaking backward compatibility (of the term order API) in the release notes.",
    "created_at": "2011-05-30T20:59:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148677",
    "user": "https://github.com/burcin"
}
```

<a id='comment:22'></a>I haven't read the patch carefully, so I can't address any specific points, but I am OK with a major refactoring of the `TermOrder` class.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148680",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Singular conversion with negative degree weights\"",
    "created_at": "2011-05-31T15:47:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148681",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Singular conversion with negative degree weights"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148683",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>... and the reason for the error is that the the string representation of polynomials does not correctly deal with polynomials of negative degree:\n\n```\nsage: str(N.gens())\n'(0*a, 0*b, 0*c)'\n```\nThat should be '(a, b, c)'.\n\nLooking at `a._repr_`, I see that in fact Singular is to blame. And indeed, in Singular we have\n\n```\n> ring r = 0,(a,b,c),Wp(-1,2,-3);\n> b;\n0b\n> ring r = 0,(a,b,c),Wp(1,2,0);\n// ** redefining r **\n> b;\n0b\n```\n\nSo, there is a bug in Singular that should be reported upstream.\n\nNevertheless, I think it should be addressed here, namely by stating in the documentation that the weights have to be positive integral. I can do that in a reviewer patch, if you like.",
    "created_at": "2011-05-31T15:59:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148684",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:26'></a>... and the reason for the error is that the the string representation of polynomials does not correctly deal with polynomials of negative degree:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148685",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Singular states in its documentation that [the degrees for wp need to be positive integral](http://www.singular.uni-kl.de/Manual/latest/sing_743.htm#IDX289). So, they may not acknowledge that it is a bug. But I will try.",
    "created_at": "2011-05-31T16:01:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148686",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:27'></a>Singular states in its documentation that [the degrees for wp need to be positive integral](http://www.singular.uni-kl.de/Manual/latest/sing_743.htm#IDX289). So, they may not acknowledge that it is a bug. But I will try.
...
```json
{
    "body": "<a id='comment:28'></a>Or it can be solved on the side of Sage. Namely, while Singular does not allow the weighted order `wp(1,2,0)`, it *does* allow to provide the `dp` order with an additional weight vector, and this weight vector can contain negative numbers:\n\n```\n> ring r = 0,(a,b,c),(a(1,-2,0),dp);\n> a,b,c;  // so, printing in Singular is correct\na b c\n> deg(b);  // and the given degrees are used\n-2\n> deg(c);\n0\n```\n\nCouldn't we change the method `TermOrder.singular_str()`, such that `(a(...),dp)` is used if there is any non-positive weight?",
    "created_at": "2011-05-31T16:09:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148687",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:28'></a>Or it can be solved on the side of Sage. Namely, while Singular does not allow the weighted order `wp(1,2,0)`, it *does* allow to provide the `dp` order with an additional weight vector, and this weight vector can contain negative numbers:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148689",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Attachment [trac_11316.4.patch](tarball://root/attachments/some-uuid/ticket11316/trac_11316.4.patch) by @kwankyu created at 2011-06-01 01:12:29\n\nI correct my mistake:\n\n`wp`, that is, `wdegrevlex` term order is supposed to define so-called global term order in Sage as well as Singular. Therefore negative integers are not allowed in weights.",
    "created_at": "2011-06-01T01:12:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148690",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:30'></a>Attachment [trac_11316.4.patch](tarball://root/attachments/some-uuid/ticket11316/trac_11316.4.patch) by @kwankyu created at 2011-06-01 01:12:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148692",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148693",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148694",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148695",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Note a related ticket: #11431, which extends the capabilities of conversion from Singular to Sage. It makes use of weighted/matrix/block term orders. So, thank you for implementing it!",
    "created_at": "2011-06-06T11:42:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148697",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:33'></a>Note a related ticket: #11431, which extends the capabilities of conversion from Singular to Sage. It makes use of weighted/matrix/block term orders. So, thank you for implementing it!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11316#event-29310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148698",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148699",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148700",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11316#event-29311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148701",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148702",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148704",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148705",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Or perhaps I was too quick. After all, one of the patches changes sage/libs/singular/ring.pyx, and it is imaginable that this has an effect on singular.\n\nI have no recent working Sage version on my t2 account. Could you please test whether the line \n\n```\nsage: singular.eval('ring r1 = (9,x),(a,b,c,d,e,f),(M((1,2,3,0)),wp(2,3),lp)')\n```\nworks without and with the patch applied?",
    "created_at": "2011-06-15T06:35:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148707",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:38'></a>Or perhaps I was too quick. After all, one of the patches changes sage/libs/singular/ring.pyx, and it is imaginable that this has an effect on singular.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148708",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148709",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148710",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148711",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>As much as I understand, the ticket here is independent from #11431, right?\n\nIt turned out that the Solaris problem pointed out by Jeroen exists in a fresh sage-4.7.1.rc1 installation on mark. In particular, the problem was definitely not introduced by the patch here.",
    "created_at": "2011-08-03T18:33:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148712",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:42'></a>As much as I understand, the ticket here is independent from #11431, right?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148713",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148714",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>For the reason pointed out in my previous post, I think it is alright to reinstate the positive review.",
    "created_at": "2011-08-03T18:34:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148715",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:43'></a>For the reason pointed out in my previous post, I think it is alright to reinstate the positive review.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11316#event-29312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11316#event-29313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148716",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11316#issuecomment-148717",
    "user": "https://github.com/jdemeyer"
}
```
