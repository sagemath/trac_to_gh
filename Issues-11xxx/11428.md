...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11428#issuecomment-130556",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Patch's up.\n\nWith it, this works\n\n```\nsage: tan.set_latex_name(r'\\tg')\nsage: latex(tan)\n\\tg\nsage: tan.set_name('tg')\nsage: tan\ntg\n```\nbut this doesn't\n\n```\nsage: tan(x)\ntan(x)\nsage: latex(tan(x))\n\\tan\\left(x\\right)\n```",
    "created_at": "2011-06-05T06:36:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11428#issuecomment-130557",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>Patch's up.
...
```json
{
    "body": "<a id='comment:3'></a>For reference for anyone implementing this correctly, in [this thread on sage-support](https://groups.google.com/forum/?fromgroups=#!topic/sage-support/wkzIydg95k8), Burcin recommends \n\n```\nIt needs to go through the \nregistry of functions stored in Pynac and update the name or the \nprinting functions there.\n```",
    "created_at": "2012-11-27T15:02:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11428#issuecomment-130558",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>For reference for anyone implementing this correctly, in [this thread on sage-support](https://groups.google.com/forum/?fromgroups=#!topic/sage-support/wkzIydg95k8), Burcin recommends 
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29675"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29676"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29677"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29678"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29679"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29680"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11428#event-29681"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>See also #20888",
    "created_at": "2016-06-27T08:17:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11428#issuecomment-130559",
    "user": "https://github.com/rwst"
}
```

<a id='comment:8'></a>See also #20888
