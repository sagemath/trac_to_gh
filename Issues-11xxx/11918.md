...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163735",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163736",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>sage.supp is part of the optional valgrind package which BTW is out of date.\n\n\nAccording to http://groups.google.com/group/sage-devel/browse_thread/thread/1657cccac33c9dd7\n  The suppression file gets rid of a bunch of annoying issues introduced by zlib and Cython.\n\nIs this still necessary?",
    "created_at": "2011-10-26T18:12:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163737",
    "user": "https://github.com/a-andre"
}
```

<a id='comment:3'></a>sage.supp is part of the optional valgrind package which BTW is out of date.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163738",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163739",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>P.S.: Thanks for bringing this ticket back to my mind.  We recently had some discussion on the IRC regarding the spkg, but I completely forgot about the ticket... ;-)",
    "created_at": "2011-10-26T18:52:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163740",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>P.S.: Thanks for bringing this ticket back to my mind.  We recently had some discussion on the IRC regarding the spkg, but I completely forgot about the ticket... ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163741",
...
```json
{
    "body": "<a id='comment:9'></a>Until this ticket is fixed, I've attached [attachment:sage.supp], which might help people with using valgrind in the mean time. File should be at\n`$SAGE_LOCAL/lib/valgrind/sage.supp` to be picked up. NOTE: This is `sage-liberal.supp` from the spkg.",
    "created_at": "2012-08-30T21:03:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163742",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:9'></a>Until this ticket is fixed, I've attached [attachment:sage.supp], which might help people with using valgrind in the mean time. File should be at
`$SAGE_LOCAL/lib/valgrind/sage.supp` to be picked up. NOTE: This is `sage-liberal.supp` from the spkg.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163745",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163746",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31510"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Ping! Is anybody inclined to fix this? Sorry that my knowledge of valgrind is too limited for doing this myself.",
    "created_at": "2013-08-15T07:55:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163747",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>Ping! Is anybody inclined to fix this? Sorry that my knowledge of valgrind is too limited for doing this myself.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31511"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31512"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31513"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31514"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31515"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31516"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>This has been fixed with #15586.",
    "created_at": "2014-10-12T21:02:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163748",
    "user": "https://github.com/a-andre"
}
```

<a id='comment:19'></a>This has been fixed with #15586.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31517"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163749",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11918#event-31519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163750",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11918#issuecomment-163751",
    "user": "https://github.com/vbraun"
}
```
