...
Attachment [trac11791_fast_hash_metaclass.patch](tarball://root/attachments/some-uuid/ticket11794/trac11791_fast_hash_metaclass.patch) by @simon-king-jena created at 2011-09-13 07:37:04
...
```json
{
    "body": "I slightly modified the patch: One doc string needed an additional `::` for making the html reference look nice.\n\nFor the patchbot:\n\nApply trac11794_fast_hash_metaclass.patch",
...
```json
{
    "body": "> Looks like you have done a lot of hard work here ! Thanks ! I might review it more or less soon. \n\n\nThat old joke still makes me laugh.\n\nNathann",
    "created_at": "2015-08-15T20:29:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11794",
    "type": "issue_comment",
...
```json
{
    "body": "> Well, it had no branch anyway, and it depends on a ticket that needs work.\n\n\nYep.\n\nI hate to see work wasted. Sorry `:-/`\n\nNathann",
