...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149806",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149807",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_11357-fix_gsl_doctest.patch](tarball://root/attachments/some-uuid/ticket11357/trac_11357-fix_gsl_doctest.patch) by @kiwifb created at 2011-05-23 19:32:15\n\nIn a case of scratch my back I will check your spkg and you can check my patch.",
    "created_at": "2011-05-23T19:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149808",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>Attachment [trac_11357-fix_gsl_doctest.patch](tarball://root/attachments/some-uuid/ticket11357/trac_11357-fix_gsl_doctest.patch) by @kiwifb created at 2011-05-23 19:32:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149809",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149810",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"David Kirkby, Fran\u00e7ois Bissey\"",
    "created_at": "2011-05-23T19:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149811",
    "user": "https://github.com/kiwifb"
}
```

Changing author from "" to "David Kirkby, François Bissey"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149812",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>So far it looks good, I installed it on my x86 box and rebuild an earlier sage-4.7,\nI am not too hot about tests on that machine anymore (minimum 4 hours, long test 6 to 7) but I'll do a full test on OSX 10.5.8 later today.",
    "created_at": "2011-05-23T21:42:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149813",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>So far it looks good, I installed it on my x86 box and rebuild an earlier sage-4.7,
I am not too hot about tests on that machine anymore (minimum 4 hours, long test 6 to 7) but I'll do a full test on OSX 10.5.8 later today.
...
```json
{
    "body": "<a id='comment:4'></a>I'm happy with your doctest patch. I built Sage 4.7.rc4 using gcc 4.6.0 on a Sun Ultra 27 running OpenSolaris 06/2009. The following two tests failed, but passed after the patch was installed. \n\n```\ndrkirkby@hawk:~/sage-4.7.rc4$ ./sage -t  -long -force_lib devel/sage/sage/gsl/probability_distribution.pyx\nsage -t -long -force_lib \"devel/sage/sage/gsl/probability_distribution.pyx\"\n\t [2.5 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 2.5 seconds\ndrkirkby@hawk:~/sage-4.7.rc4$ ./sage -t  -long -force_lib devel/sage/sage/gsl/interpolation.pyx\nsage -t -long -force_lib \"devel/sage/sage/gsl/interpolation.pyx\"\n\t [2.1 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 2.1 seconds\n```\n\nIf you are happy with my GSL package, then this can be set to positive review. \n\nOnce merged, #10000 can be closed too. \n\nDave",
    "created_at": "2011-05-23T23:25:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149814",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>I'm happy with your doctest patch. I built Sage 4.7.rc4 using gcc 4.6.0 on a Sun Ultra 27 running OpenSolaris 06/2009. The following two tests failed, but passed after the patch was installed. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149815",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"David Kirkby, Fran\u00e7ois Bissey\"",
    "created_at": "2011-05-23T23:25:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149816",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Changing reviewer from "" to "David Kirkby, François Bissey"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149817",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It's all satisfactory to me on OS X 10.5.8. Positive review.",
    "created_at": "2011-05-24T04:38:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149818",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>It's all satisfactory to me on OS X 10.5.8. Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149819",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11357#event-29468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149820",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11357#issuecomment-149821",
    "user": "https://github.com/jdemeyer"
}
```
