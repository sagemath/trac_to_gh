...
```json
{
    "body": "<a id='comment:3'></a>P.S.: If it's just the `.pyc` files, you may cure your installation by simply removing them; they'll get recompiled the next time Python executes their respective `.py` files.\n\n(I of course don't consider this a solution to the general problem, but it also would be helpful to know whether there are further files which still contain the old location *and* hinder Sage from starting up without the symbolic link from its original location. AFAIK there'll always remain some \"harmless\" `RPATH`s in shared libraries pointing to the old location.)",
    "created_at": "2011-08-11T09:31:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157419",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>P.S.: If it's just the `.pyc` files, you may cure your installation by simply removing them; they'll get recompiled the next time Python executes their respective `.py` files.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157420",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>In the file `SAGE_ROOT/local/lib/python/site-packages/easy-install.pth`, there should be a line containing \"sagenb\".  Is the path there relative (`../../../../devel/sagenb`) or absolute?  If it's absolute, what happens if you replace it with the relative path I gave?",
    "created_at": "2011-08-11T16:14:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157421",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>In the file `SAGE_ROOT/local/lib/python/site-packages/easy-install.pth`, there should be a line containing "sagenb".  Is the path there relative (`../../../../devel/sagenb`) or absolute?  If it's absolute, what happens if you replace it with the relative path I gave?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157422",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157425",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157426",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Can someone report this upstream, to Rado?",
    "created_at": "2011-08-11T16:41:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157427",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:11'></a>Can someone report this upstream, to Rado?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157428",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I don't understand python's setuptools, but I haven't hardcoded the path anywhere. My guess is that doing \"python setup.py develop\" does that. Once flask becomes a proper spkg this should go away (hopefully).",
    "created_at": "2011-08-11T17:44:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157429",
    "user": "https://trac.sagemath.org/admin/accounts/users/rkirov"
}
```

<a id='comment:13'></a>I don't understand python's setuptools, but I haven't hardcoded the path anywhere. My guess is that doing "python setup.py develop" does that. Once flask becomes a proper spkg this should go away (hopefully).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157430",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>There is actually absolutely no difference between rkirov-flask/spkg-dist and sagenb-main/spkg-dist. So, this problem will probably \"magically go away\" once rkirov-flask is actually packaged.",
    "created_at": "2011-08-11T18:37:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157432",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:15'></a>There is actually absolutely no difference between rkirov-flask/spkg-dist and sagenb-main/spkg-dist. So, this problem will probably "magically go away" once rkirov-flask is actually packaged.
...
```json
{
    "body": "<a id='comment:18'></a>This is still a problem with sage-4.7.2 + jasongrout-flask.",
    "created_at": "2011-12-01T12:55:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157434",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:18'></a>This is still a problem with sage-4.7.2 + jasongrout-flask.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11678#event-30666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157435",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157436",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157437",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>sagenb has long ago been merged. And this ticket is pointless now.",
    "created_at": "2012-12-11T16:44:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157438",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:21'></a>sagenb has long ago been merged. And this ticket is pointless now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11678#issuecomment-157439",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11678",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11678#event-30667"
}
```
