...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11674#event-142997"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11674#event-142998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11674#event-142999"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout, jkantor** to **mister.wardrop**",
    "created_at": "2011-08-10T10:27:51Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11674",
    "type": "issue_comment",
...
Changed assignee from **@jasongrout, jkantor** to **mister.wardrop**
...
```json
{
    "body": "Changed assignee from **mister.wardrop** to **@jasongrout, jkantor**",
...
Changed assignee from **mister.wardrop** to **@jasongrout, jkantor**
...
```json
{
    "body": "Removed assignee **@jasongrout, jkantor**",
    "created_at": "2011-09-01T15:40:21Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11674",
    "type": "issue_comment",
...
Removed assignee **@jasongrout, jkantor**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11674#issuecomment-122708",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11674#issuecomment-122709",
    "user": "https://github.com/nexttime"
}
```
