...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133953"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133956"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133957"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133959"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133960"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133961"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133966"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,17 +1,23 @@\n Given the creation of the Sage root repo (see #9433), the repository in `SAGE_ROOT/spkg/base` should be combined with it.\n \n-1) remove everything but the tar archives from spkg/base\n+1) apply [attachment: 11073_root.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root.patch.gz) to the root repo\n+\n+2)\n \n ```\n cd $SAGE_ROOT/spkg/base\n-rm -rf .hg .hgignore *-install README.txt sage-* test*sh stdint.h_Solaris9\n+rm -rf .hg* stdint.h_Solaris9\n+hg add *-install\n+mkdir ../bin\n+mv *.py sage-* *.sh text-* ../bin\n+cd ../bin\n+hg add . *\n+hg commit -m \"Trac #11073: Move base repository to root repository\"\n ```\n \n-2) apply [attachment: trac_11073_remove_base_repo.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_remove_base_repo.patch.gz) to the root repo\n+4) apply [attachment: trac_11073_stop_copying_stuff.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_stop_copying_stuff.patch.gz) to the root repo\n \n-3) apply [attachment: trac_11073_stop_copying_stuff.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_stop_copying_stuff.patch.gz) to the root repo\n-\n-4) apply [attachment: trac_11073_stubs_for_base.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_stubs_for_base.patch.gz) to the scripts repo\n+5) apply [attachment: trac_11073_stubs_for_base.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_stubs_for_base.patch.gz) to the scripts repo\n \n Some notes about files formerly in the spkg/base repository:\n * `stdint.h_Solaris9`: deleted\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -15,9 +15,17 @@\n hg commit -m \"Trac #11073: Move base repository to root repository\"\n ```\n \n-4) apply [attachment: trac_11073_stop_copying_stuff.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_stop_copying_stuff.patch.gz) to the root repo\n+4) apply [attachment: 11073_stop_copying_stuff.v2.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_stop_copying_stuff.v2.patch.gz) to the root repo\n \n-5) apply [attachment: trac_11073_stubs_for_base.patch.gz](https://github.com/sagemath/sage/files/ticket11073/trac_11073_stubs_for_base.patch.gz) to the scripts repo\n+5)\n+\n+```\n+cd $SAGE_ROOT/local/bin\n+hg remove sage-env sage-make_relative sage-spkg\n+hg commit -m \"Trac #11073: Move various scripts to spkg/bin\"\n+```\n+\n+5) apply [attachment: 11073_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_scripts.patch.gz) to the scripts repo\n \n The file `stdint.h_Solaris9` is not used and therefore deleted.\n \n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -15,7 +15,7 @@\n hg commit -m \"Trac #11073: Move base repository to root repository\"\n ```\n \n-4) apply [attachment: 11073_stop_copying_stuff.v2.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_stop_copying_stuff.v2.patch.gz) to the root repo\n+4) apply [attachment: 11073_root_part2.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root_part2.patch.gz) to the root repo\n \n 5)\n \n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133967"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133970"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -15,7 +15,7 @@\n hg commit -m \"Trac #11073: Move base repository to root repository\"\n ```\n \n-4) apply [attachment: 11073_root_part2.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root_part2.patch.gz) to the root repo\n+4) apply [attachment: 11073_root_after.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root_after.patch.gz) to the root repo\n \n 5)\n \n``````\n",
...
```json
{
    "body": "<a id='comment:38'>Comment 38:</a>\nIn root-spkg-install, line 18, from [attachment: 11073_root_after.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root_after.patch.gz), should the last character be deleted?\n\n```\nrm -rf .hg* json_bundle.py stdint.h_Solaris9 sage-* text-* *.sh ) \n```",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -15,7 +15,7 @@\n hg commit -m \"Trac #11073: Move base repository to root repository\"\n ```\n \n-4) apply [attachment: 11073_root_after.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root_after.patch.gz) to the root repo\n+4) apply [and [attachment: 11073_root_part2.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_root_part2.patch.gz)(https://github.com/sagemath/sage/files/ticket11073/914f074235d6637c0b9d559a27d4b076.gz) to the root repo\n \n 5)\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133971"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133983"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133984"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133985"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133988"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133989"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133991"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133995"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111305",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111306",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111307",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111308",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111309",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111310",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111311",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111312",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111313",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111314",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111315",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111316",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-133999"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-134000"
}
```
...
```json
{
    "body": "<a id='comment:95'>Comment 95:</a>\nReplying to [@jhpalmieri](#comment%3A94):\n> The file `SAGE_ROOT/data/extcode/sage/ext/mac-app/start-sage.sh` will have to be changed.\n\nI fixed precisely that error in [attachment: 11073_extcode.patch.gz](https://github.com/sagemath/sage/files/ticket11073/11073_extcode.patch.gz).  I assume you have an older version without that patch?",
    "created_at": "2012-01-20T08:25:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111317",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111318",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111319",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111320",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111321",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111322",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111323",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111324",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111325",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111326",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111327",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111328",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11073#issuecomment-111329",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-134001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11073",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11073#event-134002"
}
```
