...
```json
{
    "body": "<a id='comment:36'></a>No, I'm not sure about this - it seems to work the way we want, and as described in [comment:33 your comment]. Never mind.",
...
<a id='comment:36'></a>No, I'm not sure about this - it seems to work the way we want, and as described in [comment:33 your comment]. Never mind.
