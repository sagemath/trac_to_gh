...
```json
{
    "body": "<a id='comment:5'></a>I guess the point of this ticket is to define symbolic function in Sage to represent exponential integrals, etc. The symbolic function class handles adding stuff to the conversion table automatically.\n\nCan we replace this ticket with several beginner tickets? One for each function we are missing.",
    "created_at": "2011-05-25T19:15:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145106",
    "user": "https://github.com/burcin"
}
```

<a id='comment:5'></a>I guess the point of this ticket is to define symbolic function in Sage to represent exponential integrals, etc. The symbolic function class handles adding stuff to the conversion table automatically.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145107",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>By the way, adding this will really be a great help.  Sage has so many of the things almost anybody needs, but if you have to use mpmath or GSL or R or something else directly, it sort of makes Sage a moot point.  The idea is having a one-stop shop.",
    "created_at": "2011-06-08T20:46:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145110",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>By the way, adding this will really be a great help.  Sage has so many of the things almost anybody needs, but if you have to use mpmath or GSL or R or something else directly, it sort of makes Sage a moot point.  The idea is having a one-stop shop.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145112",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145113",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145115",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28887"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145116",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I attached a very simple patch to #11513. Now we can write the check for zero as:\n\n```\ndef is_zero(z):\n    if isinstance(z, Expression):\n        return z._is_numerically_zero()\n    else:\n        return not z\n```\n\nIt would be nice if we could simplify this further, but I need to go and do other things now. :)",
    "created_at": "2011-06-17T00:22:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145121",
    "user": "https://github.com/burcin"
}
```

<a id='comment:17'></a>I attached a very simple patch to #11513. Now we can write the check for zero as:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145123",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>In the patch, I'm added a function to `sage/functions/special.py`. But with the six new functions, this is going to be *a lot* of code in the one file. \n\nI was thinking of moving the six new functions to a new file `sage/functions/exp_integral.py`. Any thoughts? If that seems like a good idea, does it also make sense to move the exp integrals that already exist in Sage to the same place (e.g. `exponential_integral_1` lives now in `sage/functions/transcendental.py`.",
    "created_at": "2011-07-02T20:59:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145124",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:19'></a>In the patch, I'm added a function to `sage/functions/special.py`. But with the six new functions, this is going to be *a lot* of code in the one file. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145125",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>> I was thinking of moving the six new functions to a new file `sage/functions/exp_integral.py`. Any thoughts? If that seems like a good idea, does it also make sense to move the exp integrals that already exist in Sage to the same place (e.g. `exponential_integral_1` lives now in `sage/functions/transcendental.py`.\n\n\nYes, absolutely.  The functions/ folder needs to be reorganized, though obviously this is lower priority.  Make sure that it still shows up in the reference manual, that all imports work fine, etc.  But these functions are all supposed to be accessed through the top level namespace anyway, so this is a great idea to make it easier to organize.",
    "created_at": "2011-07-03T03:18:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145126",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:20'></a>> I was thinking of moving the six new functions to a new file `sage/functions/exp_integral.py`. Any thoughts? If that seems like a good idea, does it also make sense to move the exp integrals that already exist in Sage to the same place (e.g. `exponential_integral_1` lives now in `sage/functions/transcendental.py`.
...
```json
{
    "body": "<a id='comment:21'></a>I've uploaded a new partial patch for the ticket. I wanted to post this now before I finish the patch so people can comment on the consolidation of exponential functions in the new file `sage/functions/exp_integral.py`  and/or anything else. \n\nIf the basic organisation looks good, I'll finish up adding the remaining exponential integrals and upload a new patch.",
    "created_at": "2011-08-23T03:25:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145127",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:21'></a>I've uploaded a new partial patch for the ticket. I wanted to post this now before I finish the patch so people can comment on the consolidation of exponential functions in the new file `sage/functions/exp_integral.py`  and/or anything else. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145128",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145129",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145131",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Ok, I've created a new ticket #11885 to fix the issue with `mpmath.utils.call` and uploaded a patch there. I'll upload the finished patch for #11143 that depends on it later this afternoon.",
    "created_at": "2011-09-30T19:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145134",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:26'></a>Ok, I've created a new ticket #11885 to fix the issue with `mpmath.utils.call` and uploaded a patch there. I'll upload the finished patch for #11143 that depends on it later this afternoon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145135",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>The patch just uploaded should be feature complete. I've checked the documentation, checked that the doctests pass, and checked that ``make ptestlong`` completes without errors on Mac OS X 10.6.8 and also debian linux squeeze. The patch is based on sage-4.7.2.alpha3.",
    "created_at": "2011-10-06T04:12:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145136",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:28'></a>The patch just uploaded should be feature complete. I've checked the documentation, checked that the doctests pass, and checked that ``make ptestlong`` completes without errors on Mac OS X 10.6.8 and also debian linux squeeze. The patch is based on sage-4.7.2.alpha3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145137",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145138",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>There were a few doctests failing in sage/misc/sagedoc.py that I missed. The patch just uploaded now *really* doesn't break anything according to `make ptestlong`.\n\nThere are some strange doctests in sagedoc.py, especially the recursive ones. I fixed doctests that need changing when a pynac function is added to the Sage library and then, because I changed a docstring in that file, another doctest failed. Phew..",
    "created_at": "2011-10-06T15:42:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145139",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:29'></a>There were a few doctests failing in sage/misc/sagedoc.py that I missed. The patch just uploaded now *really* doesn't break anything according to `make ptestlong`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145140",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Impressive work.  No guarantees that I'll be able to look through this long patch with a fine-tooth comb anytime soon, but this will be a great addition - I really like `Ci` and `Si` being in.  \n\n```\n    \\operatorname{li}(x) = \\int_0^z \\frac{dt}{\\ln(t)} = \\operatorname{Ei}(\\ln(x)) \n```\n?? What happened to the x in the middle?  \n\nAlso, what relation does this function bear to `Li` (I assume it's the `\\int_0` as opposed to `\\int_2`, if I recall correctly), and why is that not mentioned?  See #7357.  I have to say that the names of the functions are ... very long.  Is there a problem with the fairly standard `Li` and `li`?\n\nSee also #3401, though I don't know if that is *directly* relevant for this particular set of functions.",
    "created_at": "2011-10-09T01:29:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145141",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:30'></a>Impressive work.  No guarantees that I'll be able to look through this long patch with a fine-tooth comb anytime soon, but this will be a great addition - I really like `Ci` and `Si` being in.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145142",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Sorry for the double comment. I remembered the rational for the common prefix. Burcin point out that once a user knows about one exponential integral function, they can type:`exp_integral<tab>` and see the list of all of them. That wouldn't be possible if the names are just the standard mathematical notation li, Li, En, Ei, etc..",
    "created_at": "2011-10-09T02:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145144",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:33'></a>Sorry for the double comment. I remembered the rational for the common prefix. Burcin point out that once a user knows about one exponential integral function, they can type:`exp_integral<tab>` and see the list of all of them. That wouldn't be possible if the names are just the standard mathematical notation li, Li, En, Ei, etc..
...
```json
{
    "body": "<a id='comment:34'></a>That second comment about tab-completion makes sense.  I just think it would be helpful to have easy-to-find aliases as well.  [Here](http://reference.wolfram.com/mathematica/guide/ErrorAndExponentialIntegralFunctions.html) are Mathematica's names.  I understand the concern about the standard notation, but it *is* standard, and I would never think to look for log integral under `exp_integral<tab>`, if you catch my drift - and I do know it can be written as one. \n\nSorry about the comments on the other tickets about naming conventions - feel free to ignore those, I read this update last.",
    "created_at": "2011-10-10T02:21:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145145",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:34'></a>That second comment about tab-completion makes sense.  I just think it would be helpful to have easy-to-find aliases as well.  [Here](http://reference.wolfram.com/mathematica/guide/ErrorAndExponentialIntegralFunctions.html) are Mathematica's names.  I understand the concern about the standard notation, but it *is* standard, and I would never think to look for log integral under `exp_integral<tab>`, if you catch my drift - and I do know it can be written as one. 
...
```json
{
    "body": "<a id='comment:35'></a>I see your point. How about the following names:\n\n* `exp_integral_e`\n* `exp_integral_e1`\n* `exp_integral_ei`\n* `log_integral` (for li)\n* `log_integral_offset` for (Li)\n* `cos_integral`\n* `sin_integral`\n* `sinh_integral`\n* `cosh_integral`\n\n... and maybe aliases for the usual mathematical names: `li, Li, En, Ei, E1, si, ci, shi, chi` ? Perhaps that would be too many new names in the global name space?",
    "created_at": "2011-10-11T22:25:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145146",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:35'></a>I see your point. How about the following names:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145148",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145149",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145150",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -130,4 +130,4 @@\n \n Depends on #11513 and #11885.\n \n-Apply [attachment:trac_11143.patch] to the Sage library.\n+Apply [attachment:trac_11143_v2.patch] to the Sage library.\n``````\n",
    "created_at": "2012-02-22T22:21:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145151",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Since all the dependencies have been merged I thought I would rebase this ticket and make the outstanding changes from the last comment. I've changed the names of the functions in the new module `sage/functions/exp_integral.py` according to my proposal in comment [comment:36] and added top-level aliases `li, si, ci, shi, chi`.",
    "created_at": "2012-02-22T22:21:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145152",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:37'></a>Since all the dependencies have been merged I thought I would rebase this ticket and make the outstanding changes from the last comment. I've changed the names of the functions in the new module `sage/functions/exp_integral.py` according to my proposal in comment [comment:36] and added top-level aliases `li, si, ci, shi, chi`.
...
```json
{
    "body": "<a id='comment:39'></a>I can fix the latex issues if you haven't started already. I have the afternoon off.",
    "created_at": "2012-03-09T20:54:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145154",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:39'></a>I can fix the latex issues if you haven't started already. I have the afternoon off.
...
```json
{
    "body": "<a id='comment:40'></a>I don't know that there *are* any LaTeX issues; the example above was with Sage 4.8!  I suppose you can try that example with this patch to see.  \n\nI only commented to remind myself that we should have `Si` and not `si`, in line with Maple and with Mathematica's documentation on the 'usual' name for this function (though not its command).   It keeps this patch on my mind.  If there is something wrong, though, you can definitely fix it!",
    "created_at": "2012-03-09T20:57:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145155",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:40'></a>I don't know that there *are* any LaTeX issues; the example above was with Sage 4.8!  I suppose you can try that example with this patch to see.  
...
```json
{
    "body": "<a id='comment:41'></a>Apply trac_11143_v2.patch\n\n(for patchbot)",
    "created_at": "2012-03-26T15:31:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145156",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:41'></a>Apply trac_11143_v2.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145157",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"rebase to 5.0.beta10\"",
    "created_at": "2012-03-26T18:06:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145158",
    "user": "https://github.com/loefflerd"
}
```

Changing work_issues from "" to "rebase to 5.0.beta10"
...
```json
{
    "body": "<a id='comment:42'></a>This patch doesn't apply to the current Sage beta -- see patchbot logs.",
    "created_at": "2012-03-26T18:06:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145159",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:42'></a>This patch doesn't apply to the current Sage beta -- see patchbot logs.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145160",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>Attachment [trac_11143_v2.2.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143_v2.2.patch) by @benjaminfjones created at 2012-03-26 20:08:39\n\nReplying to [davidloeffler](#comment%3A42):\n> This patch doesn't apply to the current Sage beta -- see patchbot logs.\n\n\nThanks for updating the ticket description. I've rebased my patch to 5.0.beta10.",
    "created_at": "2012-03-26T20:08:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145161",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:43'></a>Attachment [trac_11143_v2.2.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143_v2.2.patch) by @benjaminfjones created at 2012-03-26 20:08:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145162",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145164",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -128,6 +128,4 @@\n \n ---\n \n-Depends on #11513 and #11885.\n-\n-Apply [attachment:trac_11143_v2.patch] to the Sage library.\n+Apply [attachment:trac_11143_v2.3.patch] to the Sage library.\n``````\n",
    "created_at": "2012-04-06T18:51:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145165",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145166",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>while looking in the sources for the old name `expintegral_e` I found the following\ninstance:\n\n```\nsage: search_src(\"expintegral_e\")\nfunctions/exp_integral.py:393:        x*log_integral(x) - expintegral_ei(2*log(x))\nsage: expintegral_ei?\nObject `expintegral_ei` not found.\n```\nThat should be fixed too.\n\nPaul\n\nPS: the patch applied cleanly to 5.0, thus I removed the \"rebase to 5.0.beta10\" work issue",
    "created_at": "2012-05-25T09:03:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145167",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:47'></a>while looking in the sources for the old name `expintegral_e` I found the following
instance:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145168",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "Changing work_issues from \"rebase to 5.0.beta10\" to \"define expintegral_ei\"",
    "created_at": "2012-05-25T09:03:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145169",
    "user": "https://github.com/zimmermann6"
}
```

Changing work_issues from "rebase to 5.0.beta10" to "define expintegral_ei"
...
```json
{
    "body": "Changing work_issues from \"define expintegral_ei\" to \"\"",
    "created_at": "2012-05-25T17:57:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145171",
    "user": "https://github.com/benjaminfjones"
}
```

Changing work_issues from "define expintegral_ei" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145172",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145173",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>This is really great.  I've checked a number of things against Wolfram Alpha, doc has lots of great examples, excellent work.  Great catches, Doug.\n\nWe can now completely remove `exp_int`, because it was deprecated over two years ago.\n\nSee #3401 for making the offset log integral symbolic as well.  William would really like this.",
    "created_at": "2012-05-26T17:26:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145175",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:51'></a>This is really great.  I've checked a number of things against Wolfram Alpha, doc has lots of great examples, excellent work.  Great catches, Doug.
...
```json
{
    "body": "<a id='comment:52'></a>Okay, I've reported the issue with Maxima using the wrong branch for `Shi` at [this bug tracker ticket](https://sourceforge.net/tracker/?func=detail&aid=3529992&group_id=4933&atid=104933).\n\n```\n(%i30) float(expintegral_shi(1/2));\n(%o30) 3.141592653589793*%i+0.506996749819667\n```",
    "created_at": "2012-05-26T18:07:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145176",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:52'></a>Okay, I've reported the issue with Maxima using the wrong branch for `Shi` at [this bug tracker ticket](https://sourceforge.net/tracker/?func=detail&aid=3529992&group_id=4933&atid=104933).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145178",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:54'></a>Attachment [trac_11143_v2.5.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143_v2.5.patch) by @benjaminfjones created at 2012-05-26 20:14:05\n\nThe new patch should take care of dsm's (1), (2), (3) and kcrisman's `exp_int` removal. Please test the new automatic simplification code in `log_integral` and `exponential_integral_1`.\n\nPatchbot: apply [This is the Trac macro *attachment:trac_11143_v2.5.patch* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#attachment:trac_11143_v2.5.patch-macro)",
    "created_at": "2012-05-26T20:14:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145179",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:54'></a>Attachment [trac_11143_v2.5.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143_v2.5.patch) by @benjaminfjones created at 2012-05-26 20:14:05
...
```json
{
    "body": "<a id='comment:56'></a>For the record, I think we should try as much as possible to return outputs with the same parent as the input (whenever this makes sense). For `li(int(0))` we should get `int(0)`, for `li(Integer(0))` we should get `Integer(0)`, etc..",
    "created_at": "2012-05-27T02:08:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145181",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:56'></a>For the record, I think we should try as much as possible to return outputs with the same parent as the input (whenever this makes sense). For `li(int(0))` we should get `int(0)`, for `li(Integer(0))` we should get `Integer(0)`, etc..
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -128,4 +128,4 @@\n \n ---\n \n-Apply [attachment:trac_11143_v2.3.patch] to the Sage library.\n+Apply [attachment:trac_11143_v2.5.patch] to the Sage library.\n``````\n",
    "created_at": "2012-05-27T04:27:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145182",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145184",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:58'></a>Looks good to me.  I've attached a little referee patch.",
    "created_at": "2012-05-28T19:34:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145185",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:58'></a>Looks good to me.  I've attached a little referee patch.
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -128,4 +128,6 @@\n \n ---\n \n-Apply [attachment:trac_11143_v2.5.patch] to the Sage library.\n+Apply to the Sage library:\n+1. [attachment:trac_11143_v2.5.patch]\n+2. [attachment:trac-11143-ref.patch]\n``````\n",
    "created_at": "2012-05-28T20:18:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145186",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:59'></a>Thanks! I'll update the ticket description.",
    "created_at": "2012-05-28T20:18:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145187",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:59'></a>Thanks! I'll update the ticket description.
...
```json
{
    "body": "<a id='comment:60'></a>The reviewer patch introduces an erroneous hunk with a backtick in a random line.",
    "created_at": "2012-05-28T20:31:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145188",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:60'></a>The reviewer patch introduces an erroneous hunk with a backtick in a random line.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145189",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145190",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145191",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28888"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145194",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:65'></a>This is a tiny thing due to the Lambert W function, #11888.  I'll upload a clean one to beta6 momentarily.",
    "created_at": "2012-06-28T13:17:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145195",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:65'></a>This is a tiny thing due to the Lambert W function, #11888.  I'll upload a clean one to beta6 momentarily.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145196",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145197",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145198",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:66'></a>Attachment [trac_11143-v2.5-rebased.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143-v2.5-rebased.patch) by @kcrisman created at 2012-06-28 13:24:31\n\nPatchbot:\n\nApply to the Sage library:\n1. [attachment:trac_11143-v2.5-rebased.patch]\n2. [attachment:trac-11143-ref.2.patch]\n\nThis should be fine.",
    "created_at": "2012-06-28T13:24:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145199",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:66'></a>Attachment [trac_11143-v2.5-rebased.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143-v2.5-rebased.patch) by @kcrisman created at 2012-06-28 13:24:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145200",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:68'></a>I am not sure what is going on here.  Testing this by hand works, testing it in the doctest doesn't.  It's definitely the main patch that causes this.\n\nI had a few semi-educated guesses, but they didn't seem to work.  I'll keep digging.",
    "created_at": "2012-06-28T17:32:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145202",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:68'></a>I am not sure what is going on here.  Testing this by hand works, testing it in the doctest doesn't.  It's definitely the main patch that causes this.
...
```json
{
    "body": "<a id='comment:69'></a>> Okay, I've reported the issue with Maxima using the wrong branch for `Shi` at [this bug tracker ticket](https://sourceforge.net/tracker/?func=detail&aid=3529992&group_id=4933&atid=104933).\n> \n> ```\n> (%i30) float(expintegral_shi(1/2));\n> (%o30) 3.141592653589793*%i+0.506996749819667\n> ```\n\n\n\nIncidentally, this is apparently now fixed.  Is this something we should test for (not in this ticket) as well, since we use mpmath for it?  I really hate how there is no link on the Maxima bugtracker as to the actual change in the code.  Makes it harder for new folks to jump in.",
    "created_at": "2012-06-28T17:39:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145203",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:69'></a>> Okay, I've reported the issue with Maxima using the wrong branch for `Shi` at [this bug tracker ticket](https://sourceforge.net/tracker/?func=detail&aid=3529992&group_id=4933&atid=104933).
> 
> ```
> (%i30) float(expintegral_shi(1/2));
> (%o30) 3.141592653589793*%i+0.506996749819667
...
```json
{
    "body": "<a id='comment:70'></a>Aagh!  It *was* what I originally thought - that we just have too many serials now.  But I kept on testing the wrong occurrences of this code.\n\nPatch coming up should fix this *and* at least postpone the agony the next time we add functions...",
    "created_at": "2012-06-28T17:58:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145204",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:70'></a>Aagh!  It *was* what I originally thought - that we just have too many serials now.  But I kept on testing the wrong occurrences of this code.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145205",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145206",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:71'></a>Attachment [trac_11143-pynac-serials.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143-pynac-serials.patch) by @kcrisman created at 2012-06-28 18:06:16\n\nPatchbot:\n\nApply to the Sage library:\n1. [attachment:trac_11143-v2.5-rebased.patch]\n2. [attachment:trac-11143-ref.2.patch]\n3. [attachment:trac_11143-pynac-serials.patch]\n\n---\n\nI feel like the latest patch is from an obscure enough piece of code that it could need review.  On the other hand, it is a pretty trivial patch in other ways and only changes doctests.  I'll put positive review for now, but feel free to change it back if you feel otherwise, Jeroen; I'm sure burcin or benjaminfjones would be able to sign off on it pretty quickly otherwise.",
    "created_at": "2012-06-28T18:06:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145207",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:71'></a>Attachment [trac_11143-pynac-serials.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143-pynac-serials.patch) by @kcrisman created at 2012-06-28 18:06:16
...
```json
{
    "body": "<a id='comment:72'></a>The patch to the doctests in `sage/symbolic/pnyac.pyx` look (and tests) fine. I suspected it would be something like this, but didn't have the time earlier to track it down. Thanks!",
    "created_at": "2012-06-29T02:30:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145208",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:72'></a>The patch to the doctests in `sage/symbolic/pnyac.pyx` look (and tests) fine. I suspected it would be something like this, but didn't have the time earlier to track it down. Thanks!
...
```json
{
    "body": "<a id='comment:74'></a>Replying to [kcrisman](#comment%3A69):\n\n```\n> > (%i30) float(expintegral_shi(1/2));\n> > (%o30) 3.141592653589793*%i+0.506996749819667\n```\n> Is this something we should test for?\n\n\nyes please!\n\nPaul",
    "created_at": "2012-06-29T15:31:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145210",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:74'></a>Replying to [kcrisman](#comment%3A69):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145211",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145212",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145213",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:76'></a>Switching the deprecation to the new syntax.",
    "created_at": "2012-06-30T18:49:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145214",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:76'></a>Switching the deprecation to the new syntax.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145215",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:77'></a>The new patch is just rediffed to apply on top of #13109. Switching back to positive review.",
    "created_at": "2012-06-30T19:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145216",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:77'></a>The new patch is just rediffed to apply on top of #13109. Switching back to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145217",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -129,6 +129,6 @@\n ---\n \n Apply to the Sage library:\n-1. [attachment:trac_11143-v2.5-rebased.patch]\n+1. [attachment:trac_11143-v2.5-rebased.2.patch]\n 2. [attachment:trac-11143-ref.2.patch]\n 3. [attachment:trac_11143-pynac-serials.patch]\n``````\n",
    "created_at": "2012-06-30T19:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145218",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28890"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145219",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:79'></a>The authors of #11475 thought its a good idea to remove trailing whitespace in random places, which broke this patch. Rediffed for sage-5.2.beta1.",
    "created_at": "2012-07-08T11:37:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145220",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:79'></a>The authors of #11475 thought its a good idea to remove trailing whitespace in random places, which broke this patch. Rediffed for sage-5.2.beta1.
...
```json
{
    "body": "<a id='comment:80'></a>What is this pending?  If #11475 has been unmerged, then is there an appropriate patch that can be merged in Sage 5.3, since 5.2.rc0 is out?",
    "created_at": "2012-07-19T20:29:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145221",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:80'></a>What is this pending?  If #11475 has been unmerged, then is there an appropriate patch that can be merged in Sage 5.3, since 5.2.rc0 is out?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145222",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:81'></a>AND the patchbot says it doesn't work.  So there.  Let's see if this works:\n\nApply to the Sage library:\n1. [attachment:trac_11143-v2.5-rebased.patch]\n2. [attachment:trac-11143-ref.2.patch]\n3. [attachment:trac_11143-pynac-serials.patch]",
    "created_at": "2012-07-20T02:11:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145223",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:81'></a>AND the patchbot says it doesn't work.  So there.  Let's see if this works:
...
```json
{
    "body": "<a id='comment:82'></a>All tests in sage/calculus, sage/symbolic, and sage/functions pass against 5.2.beta1.  If patchbot later says it's ok, then I think this is ok.  Puttting to Sage 5.3.",
    "created_at": "2012-07-20T02:18:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145224",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:82'></a>All tests in sage/calculus, sage/symbolic, and sage/functions pass against 5.2.beta1.  If patchbot later says it's ok, then I think this is ok.  Puttting to Sage 5.3.
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28892"
}
```
...
```json
{
    ...
    "milestone": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28893"
}
```
...
```json
{
    "body": "<a id='comment:83'></a>It was put to sage-pending because of #13109 (which is now merged).",
    "created_at": "2012-07-20T06:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145225",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:83'></a>It was put to sage-pending because of #13109 (which is now merged).
...
```json
{
    "body": "<a id='comment:85'></a>Hey Ben, question.  Which `Li/li` is Maxima using with its conversion?  I think that `expintegral_li` actually correspond to `Li` (#3401), not the `li` provided here, though the integral of `log_integral` does seem right...  Also, while looking at this I noticed that\n\n```\n\\operatorname{li}(x) = \\int_0^z \\frac{dt}{\\ln(t)} = \\operatorname{Ei}(\\ln(x))\n```\nprobably should have a `x` not a `z` in the integral bound.",
    "created_at": "2012-07-27T20:22:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145227",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:85'></a>Hey Ben, question.  Which `Li/li` is Maxima using with its conversion?  I think that `expintegral_li` actually correspond to `Li` (#3401), not the `li` provided here, though the integral of `log_integral` does seem right...  Also, while looking at this I noticed that
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145228",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145230",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145231",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:87'></a>The rebased patch applies on sage-5.2.rc1. Switching this back to positive review",
    "created_at": "2012-07-28T04:00:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145232",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:87'></a>The rebased patch applies on sage-5.2.rc1. Switching this back to positive review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145233",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145234",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145236",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:89'></a>Fixed the failing doctest (for the reviewer: this only changed lines 1300--1301 in `sage/functions/exp_integral.py`).",
    "created_at": "2012-08-03T05:22:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145237",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:89'></a>Fixed the failing doctest (for the reviewer: this only changed lines 1300--1301 in `sage/functions/exp_integral.py`).
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -129,6 +129,6 @@\n ---\n \n Apply to the Sage library:\n-1. [attachment:trac_11143-v2.5-rebased.2.patch]\n+1. [attachment:trac_11143-v2.5-rebased.3.patch]\n 2. [attachment:trac-11143-ref.2.patch]\n 3. [attachment:trac_11143-pynac-serials.patch]\n``````\n",
    "created_at": "2012-08-03T05:22:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145238",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145239",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145240",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:90'></a>Wouldn't a *relative* tolerance be better than an absolute one?  With the absolute tolerance, the fourth value can essentially be anything.",
    "created_at": "2012-08-10T20:46:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145241",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:90'></a>Wouldn't a *relative* tolerance be better than an absolute one?  With the absolute tolerance, the fourth value can essentially be anything.
...
```json
{
    "body": "<a id='comment:91'></a>Yes, you're right. I'll change that.",
    "created_at": "2012-08-11T02:08:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145242",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:91'></a>Yes, you're right. I'll change that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145243",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145244",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:92'></a>Attachment [trac_11143-v2.5-rebased.4.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143-v2.5-rebased.4.patch) by @benjaminfjones created at 2012-08-11 03:35:31",
    "created_at": "2012-08-11T03:35:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145245",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:92'></a>Attachment [trac_11143-v2.5-rebased.4.patch](tarball://root/attachments/some-uuid/ticket11143/trac_11143-v2.5-rebased.4.patch) by @benjaminfjones created at 2012-08-11 03:35:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145246",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:93'></a>Patchbot, please kindly apply:\n* [attachment:trac_11143-v2.5-rebased.4.patch]\n* [attachment:trac-11143-ref.2.patch]\n* [attachment:trac_11143-pynac-serials.patch]\nto the Sage library.\n\nThank you in advance.",
    "created_at": "2012-08-12T23:31:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145247",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:93'></a>Patchbot, please kindly apply:
* [attachment:trac_11143-v2.5-rebased.4.patch]
* [attachment:trac-11143-ref.2.patch]
* [attachment:trac_11143-pynac-serials.patch]
to the Sage library.
...
```json
{
    "body": "<a id='comment:94'></a>I'm happy with the changes to that line.  I haven't re-checked the whole patch again, but I thrust that you didn't change anything else.",
    "created_at": "2012-08-13T10:15:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145248",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:94'></a>I'm happy with the changes to that line.  I haven't re-checked the whole patch again, but I thrust that you didn't change anything else.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145249",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145250",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145251",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11143#event-28894"
}
```
...
```json
{
    "body": "<a id='comment:97'></a>See #14766 for a followup.",
    "created_at": "2013-06-18T17:38:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11143#issuecomment-145252",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:97'></a>See #14766 for a followup.
