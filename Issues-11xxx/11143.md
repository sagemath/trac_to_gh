...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130437"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130438"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130439"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130441"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130442"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -125,3 +125,9 @@\n ```\n \n * Notes: `kelliptic(z)` needs a conversion to `elliptic_kc` in Sage and `parabolic_cylinder_d (v,z)` does not seem to be exposed at top level. It can be evaluated by mpmath.\n+\n+---\n+\n+Depends on #11513 and #11885.\n+\n+Apply [attachment: trac_11143.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130447"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -130,4 +130,4 @@\n \n Depends on #11513 and #11885.\n \n-Apply [attachment: trac_11143.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143.patch.gz) to the Sage library.\n+Apply [attachment: trac_11143_v2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.patch.gz) to the Sage library.\n``````\n",
    "created_at": "2012-02-22T22:21:08Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130451"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -128,6 +128,4 @@\n \n ---\n \n-Depends on #11513 and #11885.\n-\n-Apply [attachment: trac_11143_v2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.patch.gz) to the Sage library.\n+Apply [attachment: trac_11143_v2.3.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.3.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130453"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130454"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130455"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -128,4 +128,4 @@\n \n ---\n \n-Apply [attachment: trac_11143_v2.3.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.3.patch.gz) to the Sage library.\n+Apply [attachment: trac_11143_v2.5.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.5.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130456"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130457"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -128,4 +128,6 @@\n \n ---\n \n-Apply [attachment: trac_11143_v2.5.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.5.patch.gz) to the Sage library.\n+Apply to the Sage library:\n+1. [attachment: trac_11143_v2.5.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.5.patch.gz)\n+2. [attachment: trac-11143-ref.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac-11143-ref.patch.gz)\n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130458"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130463"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -129,5 +129,5 @@\n ---\n \n Apply to the Sage library:\n-1. [attachment: trac_11143_v2.5.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143_v2.5.patch.gz)\n+1. [attachment: trac_11143-v2.5-rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-v2.5-rebased.patch.gz)\n 2. [attachment: trac-11143-ref.2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac-11143-ref.2.patch.gz)\n``````\n",
    "created_at": "2012-06-28T13:24:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130471"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -129,6 +129,6 @@\n ---\n \n Apply to the Sage library:\n-1. [attachment: trac_11143-v2.5-rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-v2.5-rebased.patch.gz)\n+1. [attachment: trac_11143-v2.5-rebased.2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-v2.5-rebased.2.patch.gz)\n 2. [attachment: trac-11143-ref.2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac-11143-ref.2.patch.gz)\n 3. [attachment: trac_11143-pynac-serials.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-pynac-serials.patch.gz)\n``````\n",
    "created_at": "2012-06-30T19:02:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130473"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130481"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -129,6 +129,6 @@\n ---\n \n Apply to the Sage library:\n-1. [attachment: trac_11143-v2.5-rebased.2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-v2.5-rebased.2.patch.gz)\n+1. [attachment: trac_11143-v2.5-rebased.3.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-v2.5-rebased.3.patch.gz)\n 2. [attachment: trac-11143-ref.2.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac-11143-ref.2.patch.gz)\n 3. [attachment: trac_11143-pynac-serials.patch.gz](https://github.com/sagemath/sage/files/ticket11143/trac_11143-pynac-serials.patch.gz)\n``````\n",
    "created_at": "2012-08-03T05:22:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130485"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130486"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130489"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11143#issuecomment-113080",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11143#event-130491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11143#issuecomment-113081",
    "user": "https://github.com/kcrisman"
}
```
