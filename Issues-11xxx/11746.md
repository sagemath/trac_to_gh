...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11746#issuecomment-159283",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11746",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11746#event-30898"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This dup surely wouldn't happen if we were sitting right next to each other (which we are)! :-)",
    "created_at": "2011-08-25T17:35:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11746#issuecomment-159284",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This dup surely wouldn't happen if we were sitting right next to each other (which we are)! :-)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11746#event-30899"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11746#issuecomment-159285",
