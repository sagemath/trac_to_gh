...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139516"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139520"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139521"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139522"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139523"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139524"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,5 +6,5 @@\n \n New spkg: [http://sage.math.washington.edu/home/robertwb/cython/spkg/cython-0.15.1.spkg](http://sage.math.washington.edu/home/robertwb/cython/spkg/cython-0.15.1.spkg)\n \n-Apply [attachment: 11761-cython-0.15.patch.gz](https://github.com/sagemath/sage/files/ticket11761/11761-cython-0.15.patch.gz) to the Sage library.\n+Apply [attachment: 11761-cython-0.15-rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11761/11761-cython-0.15-rebased.patch.gz) to the Sage library.\n \n``````\n",
    "created_at": "2011-10-31T12:26:41Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11761",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139527"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139530"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139531"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139532"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139533"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139535"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139536"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139537"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11761#issuecomment-124679",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11761#event-139540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11761#issuecomment-124680",
