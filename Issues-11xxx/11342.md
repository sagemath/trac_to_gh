...
{
    "assignees": [],
    "body": "If an attribute of a parent or element can not be found by inspecting the method resolution order, `__getattr__` is invoked. It tries to obtain the attribute from the parent class or the element class of the category of the parent. If it can not be found, the attribute error is raised using a Cython function `sage.structure.parent.raise_attribute_error`.\n\nI see several ways to make both `__getattr__` and `sage.structure.parent.raise_attribute_error` a lot faster. Details will be given in the comments.\n\nBecause of one doctest in `sage.categories.primer`, it is needed that the category of polynomial rings is properly initialised. Therefore:\n\nDepends on #9944\n\nApply \n\n* [attachment: trac11342-attribute_error_message.rebased.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz)\n* [attachment: trac_11342_fix_pari_initialization.patch](https://github.com/sagemath/sage/files/ticket11342/trac_11342_fix_pari_initialization.patch.gz)\n* [attachment: trac_11342_fix_pari_ring.patch](https://github.com/sagemath/sage/files/ticket11342/trac_11342_fix_pari_ring.patch.gz)\n* [attachment: trac_11342_crypto_fixes.patch](https://github.com/sagemath/sage/files/ticket11342/trac_11342_crypto_fixes.patch.gz)\n* [attachment: trac11342_test_parent_on_getattr.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342_test_parent_on_getattr.patch.gz)\n\n\nDepends on #9944\n\nCC:  @jdemeyer\n\nKeywords: **getattr parent element**\n\nComponent: **performance**\n\nAuthor: **Simon King, Volker Braun**\n\nReviewer: **Jeroen Demeyer, Volker Braun, Simon King**\n\nMerged: **sage-4.7.2.alpha3**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/11342_\n\n",
    ...
    "type": "issue",
    "updated_at": "2011-09-17T04:44:34Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151325"
}
```
...
```json
{
    "body": "Attachment: **[trac11342-faster_getattr.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-faster_getattr.patch.gz)**\n\nMake attribute access faster on elements and parents",
    "created_at": "2011-05-17T09:07:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114258",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment: **[trac11342-faster_getattr.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-faster_getattr.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114259",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114260",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114261",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114262",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n Because of one doctest in `sage.categories.primer`, it is needed that the category of polynomial rings is properly initialised. Therefore:\n \n Depends on #9944\n-\n+Apply [attachment: trac11342-AttributeErrorMessage.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342-AttributeErrorMessage.patch.gz)\n``````\n",
    "created_at": "2011-05-22T07:15:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114264",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114265",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114266",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114267",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114268",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114269",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114270",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114271",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114272",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114273",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114274",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114275",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114276",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114277",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114278",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114280",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<div id=\"comment:17\" align=\"right\">comment:17</div>\n\nAttachment: **[trac11342-attribute_error_message.rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz)**\n\nI had to rebase the patch, since it only applied with fuzz 1 against sage-4.7.1.rc1.\n\nStill needs review.\n\nApply trac11342-attribute_error_message.rebased.patch",
    "created_at": "2011-08-01T16:16:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114281",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,4 +6,4 @@\n \n Depends on #9944\n \n-Apply [attachment: trac11342-AttributeErrorMessage.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342-AttributeErrorMessage.patch.gz)\n+Apply [attachment: trac11342-attribute_error_message.rebased.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz)\n``````\n",
    "created_at": "2011-08-01T16:16:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114282",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114283",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114284",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151328"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114285",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114286",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114287",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114288",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114289",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114290",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114291",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114292",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114293",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114294",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114295",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114296",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114297",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114298",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114299",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114300",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114301",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114302",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114303",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,4 +6,5 @@\n \n Depends on #9944\n \n-Apply [attachment: trac11342-attribute_error_message.rebased.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz)\n+Apply [attachment: trac11342-attribute_error_message.rebased.patch](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz), [attachment: trac_11342_fix_pari_initialization.patch](https://github.com/sagemath/sage/files/ticket11342/trac_11342_fix_pari_initialization.patch.gz)\n+\n``````\n",
    "created_at": "2011-08-22T21:45:06Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114304",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114305",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114306",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114307",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114308",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114309",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114310",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<div id=\"comment:43\" align=\"right\">comment:43</div>\n\nAttachment: **[trac_11342_fix_pari_initialization.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac_11342_fix_pari_initialization.patch.gz)**\n\nI've added the sig_on/sig_off in the patch.",
    "created_at": "2011-08-24T04:19:43Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114311",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114312",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114313",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<div id=\"comment:46\" align=\"right\">comment:46</div>\n\nReplying to [@vbraun](#comment:45):\n> Ok I looked at `sage/rings/pari_ring.py` and it makes my eyes bleed... The elements don't call `RingElement.__init__` so their parent is not set. Also, should use `UniqueRepresentation`. But is anybody using that module?\n\nI guess, implicitly we are using it all: As we have seen, some pari objects are generated when sage starts. And you are right, it is evident that sage/rings/pari_ring.py has been written long time ago...\n\nDo you think we should attempt to bring it up to date *here*? Or do it on a different ticket and just use the work-around provided by [attachment: trac_11342_fix_pari_initialization.patch](https://github.com/sagemath/sage/files/ticket11342/trac_11342_fix_pari_initialization.patch.gz)?\n\nIf we fix it here: Did you already start with it? Otherwise, I'd do it myself.",
    "created_at": "2011-08-24T08:37:28Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114314",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114315",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114316",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114318",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment: **[trac_11342_crypto_fixes.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac_11342_crypto_fixes.patch.gz)**\n\nInitial patch",
    "created_at": "2011-08-24T16:30:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114319",
    "user": "https://github.com/vbraun"
}
```

Attachment: **[trac_11342_crypto_fixes.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac_11342_crypto_fixes.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114320",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114321",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114322",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114323",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114324",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114325",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114326",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114327",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment: **[trac11342_test_parent_on_getattr.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342_test_parent_on_getattr.patch.gz)**\n\nTest whether self._parent is None, before requestin self._parent._category",
    "created_at": "2011-08-25T08:21:43Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114328",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment: **[trac11342_test_parent_on_getattr.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342_test_parent_on_getattr.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114329",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114330",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114331",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151331"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151332"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114332",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114333",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changed reviewer from **Jeroen Demeyer, Volker Braun** to **Jeroen Demeyer, Volker Braun, Simon King**",
    "created_at": "2011-09-12T01:46:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114334",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114335",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-151334"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-114336",
    "user": "https://github.com/nexttime"
}
```
