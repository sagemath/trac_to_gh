...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133058"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n Because of one doctest in `sage.categories.primer`, it is needed that the category of polynomial rings is properly initialised. Therefore:\n \n Depends on #9944\n-\n+Apply [attachment: trac11342-AttributeErrorMessage.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-AttributeErrorMessage.patch.gz)\n``````\n",
    "created_at": "2011-05-22T07:15:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,4 +6,4 @@\n \n Depends on #9944\n \n-Apply [attachment: trac11342-AttributeErrorMessage.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-AttributeErrorMessage.patch.gz)\n+Apply [attachment: trac11342-attribute_error_message.rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz)\n``````\n",
    "created_at": "2011-08-01T16:16:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133060"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,4 +6,5 @@\n \n Depends on #9944\n \n-Apply [attachment: trac11342-attribute_error_message.rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac11342-attribute_error_message.rebased.patch.gz)\n+Apply [[attachment: trac_11342_fix_pari_initialization.patch.gz](https://github.com/sagemath/sage/files/ticket11342/trac_11342_fix_pari_initialization.patch.gz)(https://github.com/sagemath/sage/files/ticket11342/61fcc5147b0fd50a2f74d24af7aa4cc5.gz)\n+\n``````\n",
    "created_at": "2011-08-22T21:45:06Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133062"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-116487",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11342#event-133066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11342#issuecomment-116488",
    "user": "https://github.com/nexttime"
}
```
