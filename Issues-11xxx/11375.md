...
archive/attachments_015469.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_11375.patch](https://github.com/sagemath/sage/files/ticket11375/trac_11375.patch)\n\nrebased for sage-4.7.1",
    "created_at": "2011-08-16T18:45:56Z",
    "issue": "https://github.com/sagemath/sage/issues/11375",
    "type": "issue_comment",
...
**Attachment:** [trac_11375.patch](https://github.com/sagemath/sage/files/ticket11375/trac_11375.patch)
...
archive/attachments_015470.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [trac_11375-rewrite.patch](https://github.com/sagemath/sage/files/ticket11375/trac_11375-rewrite.patch)\n\nIn the docstring, there should be a blank line after `INPUT:` and `OUTPUT:` (if you use an item list, which you do).",
    "created_at": "2012-01-05T07:45:54Z",
    "issue": "https://github.com/sagemath/sage/issues/11375",
    "type": "issue_comment",
...
archive/attachments_015471.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [trac_11375-rewrite.2.patch](https://github.com/sagemath/sage/files/ticket11375/trac_11375-rewrite.2.patch)\n\njdmeyer -- good now?",
    "created_at": "2012-01-07T04:32:37Z",
    "issue": "https://github.com/sagemath/sage/issues/11375",
    "type": "issue_comment",
...
**Attachment:** [trac_11375-rewrite.3.patch](https://github.com/sagemath/sage/files/ticket11375/trac_11375-rewrite.3.patch)
...
```json
{
    "body": "<a id='comment:11'></a>\n**Attachment:** [trac_11375-rewrite.4.patch](https://github.com/sagemath/sage/files/ticket11375/trac_11375-rewrite.4.patch)\n\nI'll change it to you want just for consistency with most Sage code (but I still don't see that it is invalid).",
    "created_at": "2012-01-13T16:33:17Z",
    "issue": "https://github.com/sagemath/sage/issues/11375",
    "type": "issue_comment",
...
archive/attachments_015474.json:
```json
{
    "asset_content_type": "application/octet-stream",
