...
```json
{
    "body": "<a id='comment:6'></a>Since there doesn't seem to be a consensus on whether this is a bug yet, setting to 'needs info'.",
    "created_at": "2011-08-19T13:55:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156677",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Since there doesn't seem to be a consensus on whether this is a bug yet, setting to 'needs info'.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156678",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I think it's acceptable that digits=1 shows some strange behavior. I believe it should at least be documented, so I wrote a patch at #12120 to do so. Btw. should we assert that digits is not 0? Otherwise this should be added at #12120 as well.",
    "created_at": "2011-12-05T10:48:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156679",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:7'></a>I think it's acceptable that digits=1 shows some strange behavior. I believe it should at least be documented, so I wrote a patch at #12120 to do so. Btw. should we assert that digits is not 0? Otherwise this should be added at #12120 as well.
...
```json
{
    "body": "<a id='comment:8'></a>At this point I'm wondering whether this is just a dup of #12120.  Or should it be considered a bug of some sort?",
    "created_at": "2012-07-20T15:43:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156680",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>At this point I'm wondering whether this is just a dup of #12120.  Or should it be considered a bug of some sort?
...
```json
{
    "body": "<a id='comment:9'></a>As I said before, I don't think this is a bug since it is documented now. So from my point of view this can be closed.",
    "created_at": "2012-07-20T16:02:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156681",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:9'></a>As I said before, I don't think this is a bug since it is documented now. So from my point of view this can be closed.
...
```json
{
    "body": "<a id='comment:10'></a>Ok.  And the original reporter should probably also weigh in...",
    "created_at": "2012-07-20T16:12:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156682",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Ok.  And the original reporter should probably also weigh in...
...
```json
{
    "body": "<a id='comment:11'></a>There seems to be a consensus that this behaviour is acceptable, so feel free to close.",
    "created_at": "2012-07-20T17:08:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156683",
    "user": "https://github.com/eviatarbach"
}
```

<a id='comment:11'></a>There seems to be a consensus that this behaviour is acceptable, so feel free to close.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Karl-Dieter Crisman, Julian Rueth, Eviatar Bach\"",
    "created_at": "2012-07-20T17:27:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156684",
    "user": "https://github.com/kcrisman"
}
```

Changing reviewer from "" to "Karl-Dieter Crisman, Julian Rueth, Eviatar Bach"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156685",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156686",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Please fill in your real name as Author.",
    "created_at": "2012-07-27T20:42:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156687",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>Please fill in your real name as Author.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156688",
    "user": "https://github.com/eviatarbach"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11647#event-30568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156689",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11647#issuecomment-156690",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11647#event-30569"
}
```
