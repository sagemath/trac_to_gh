...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11023#event-133541"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11023#event-133542"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11023#event-133543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11023",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11023#issuecomment-110785",
    "user": "https://github.com/sagetrac-weigandt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11023",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11023#issuecomment-110786",
    "user": "https://github.com/sagetrac-weigandt"
}
```
