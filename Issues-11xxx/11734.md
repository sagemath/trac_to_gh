...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-158998",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159000",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159001",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I do not fully understand your patch. How does it differ from simply taking out the call to sage_getargspec and moving it into a lambda? (see my attached patch)\n\nBtw. On my install of sage-4.7.2alpha2 the doctest described in *Bugfix* does not fail.",
    "created_at": "2011-08-24T17:08:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159002",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:3'></a>I do not fully understand your patch. How does it differ from simply taking out the call to sage_getargspec and moving it into a lambda? (see my attached patch)
...
```json
{
    "body": "<a id='comment:6'></a>PS: Even though the example from my previous post does not fail on your machine (for reasons that I don't understand), it did fail for me. Hence, I think it would make sense to include that example into your patch (you can of course simply copy the example from my patch).",
    "created_at": "2011-08-24T18:00:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159005",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>PS: Even though the example from my previous post does not fail on your machine (for reasons that I don't understand), it did fail for me. Hence, I think it would make sense to include that example into your patch (you can of course simply copy the example from my patch).
...
```json
{
    "body": "<a id='comment:7'></a>I ran the doctests without long and they passed. Let me try to build the reference manual.",
    "created_at": "2011-08-24T18:11:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159006",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:7'></a>I ran the doctests without long and they passed. Let me try to build the reference manual.
...
```json
{
    "body": "<a id='comment:8'></a>The reference manual seems ok. For example I get *complete_primary_decomposition(algorithm='sy')* which is a method with the *    `@`libsingular_standard_options* decorator.",
    "created_at": "2011-08-24T19:21:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159007",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:8'></a>The reference manual seems ok. For example I get *complete_primary_decomposition(algorithm='sy')* which is a method with the *    `@`libsingular_standard_options* decorator.
...
```json
{
    "body": "<a id='comment:9'></a>I can confirm that the doc tests pass. I can also confirm that your patch provides a similar (small) positive side effect (comparable to what I stated on my patch) on startuptime and memory consumption.\n\nPlease add the above \"bugfix\" example to your patch. In the author field, please replace my name by yours.",
    "created_at": "2011-08-24T19:34:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159008",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>I can confirm that the doc tests pass. I can also confirm that your patch provides a similar (small) positive side effect (comparable to what I stated on my patch) on startuptime and memory consumption.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159009",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159010",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159012",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159014",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159015",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159016",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I'm not sure if I misunderstand what you mean to say with 'significantly' but the average startuptime does actually improve with that patch. (I would provide some data but can't reach the machine where that data is stored right now)",
    "created_at": "2011-08-25T07:17:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159017",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:15'></a>I'm not sure if I misunderstand what you mean to say with 'significantly' but the average startuptime does actually improve with that patch. (I would provide some data but can't reach the machine where that data is stored right now)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159020",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Attachment [trac11734_sage_wraps_no_sourceread_lambda.patch](tarball://root/attachments/some-uuid/ticket11734/trac11734_sage_wraps_no_sourceread_lambda.patch) by @simon-king-jena created at 2011-08-25 09:41:39\n\nWith the new patch, all tests pass, and for the reasons mentioned previously it is a positive review.",
    "created_at": "2011-08-25T09:41:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159022",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>Attachment [trac11734_sage_wraps_no_sourceread_lambda.patch](tarball://root/attachments/some-uuid/ticket11734/trac11734_sage_wraps_no_sourceread_lambda.patch) by @simon-king-jena created at 2011-08-25 09:41:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159023",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159024",
...
```json
{
    "body": "<a id='comment:22'></a>For the patchbot:\n\nApply trac11734_sage_wraps_no_sourceread_lambda.patch",
    "created_at": "2011-09-13T09:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159025",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:22'></a>For the patchbot:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159026",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159027",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11734#event-30866"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159028",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159029",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>I've attached a `*.proper.patch`, which is identical except that I removed the \"garbage\" before \"`# HG changeset patch`\", i.e., I deleted the first line \"`exporting patch:`\", since Jeroen's current merger rejects such patches.\n\nFor now, please make sure all your patches start with \"`# HG changeset patch`\", i.e., have it on the first line without any preceding messages or whatever.\n\nI've relaxed that in *my version* of the merger, but Jeroen and maybe others are likely to use his more restrictive one.",
    "created_at": "2011-09-28T17:01:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11734#issuecomment-159030",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:24'></a>I've attached a `*.proper.patch`, which is identical except that I removed the "garbage" before "`# HG changeset patch`", i.e., I deleted the first line "`exporting patch:`", since Jeroen's current merger rejects such patches.
