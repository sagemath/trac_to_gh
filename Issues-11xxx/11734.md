...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139139"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139144"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,6 +4,5 @@\n \n My patch introduces some lightweight classes, that simply store a reference to an object (e.g., the to-be-wrapped function) and return the sources or source lines or the argument list *only when called*.\n \n-Apply:\n+Apply only [attachment: trac11734_sage_wraps_no_sourceread_lambda.patch.gz](https://github.com/sagemath/sage/files/ticket11734/trac11734_sage_wraps_no_sourceread_lambda.patch.gz) to the Sage library.\n \n-[attachment: trac11734_sage_wraps_no_sourceread_lambda.patch.gz](https://github.com/sagemath/sage/files/ticket11734/trac11734_sage_wraps_no_sourceread_lambda.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11734#event-139146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11734#issuecomment-124116",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11734#issuecomment-124117",
    "user": "https://github.com/nexttime"
}
```
