...
```json
{
    "body": "<a id='comment:1'></a>still true with Sage 5.5: got CPU 2.16s with `R = IntegerModRing(P*q)`, CPU 12.52s with `R=GF(q)`.\n\nPaul",
    "created_at": "2013-01-08T08:43:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156245",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>still true with Sage 5.5: got CPU 2.16s with `R = IntegerModRing(P*q)`, CPU 12.52s with `R=GF(q)`.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11628#event-30505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156247",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Here is a patch; now testing...",
    "created_at": "2013-11-22T12:12:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156248",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:4'></a>Here is a patch; now testing...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156249",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [11628-FiniteField_base-cache-factored_order.patch](tarball://root/attachments/some-uuid/ticket11628/11628-FiniteField_base-cache-factored_order.patch) by @pjbruin created at 2013-11-22 12:54:40\n\nWith the patch, the `GF(q)` version is now slightly faster on my system.\n\nThe line that this patch removes in `finite_field_prime_modn.py` was redundant because `FiniteField_prime_modn` inherits `factored_order()` from `FiniteField_base`, not from `IntegerModRing`.",
    "created_at": "2013-11-22T12:54:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156250",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:5'></a>Attachment [11628-FiniteField_base-cache-factored_order.patch](tarball://root/attachments/some-uuid/ticket11628/11628-FiniteField_base-cache-factored_order.patch) by @pjbruin created at 2013-11-22 12:54:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156251",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156252",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156253",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11628#issuecomment-156254",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11628",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11628#event-30506"
}
```
