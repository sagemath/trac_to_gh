...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121780",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121781",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121782",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121783",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121784",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [11628-FiniteField_base-cache-factored_order.patch](https://github.com/sagemath/sage/files/ticket11628/11628-FiniteField_base-cache-factored_order.patch) by @pjbruin created at 2013-11-22 12:54:40\n\nWith the patch, the `GF(q)` version is now slightly faster on my system.\n\nThe line that this patch removes in `finite_field_prime_modn.py` was redundant because `FiniteField_prime_modn` inherits `factored_order()` from `FiniteField_base`, not from `IntegerModRing`.",
    "created_at": "2013-11-22T12:54:40Z",
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121785",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121786",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11628#issuecomment-121787",
    "user": "https://github.com/jdemeyer"
}
```
