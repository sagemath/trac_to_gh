...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11447#event-139155"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11447#event-139156"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11447#event-139157"
}
```
...
```json
{
    "body": "Changed assignee from **GeorgSWeber** to **@pipedream**",
...
Changed assignee from **GeorgSWeber** to **@pipedream**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -8,7 +8,7 @@\n \n **md5sum:** `5bc63c1814fc7ae34f4fed5a8fffe380  python-2.6.4.p11.spkg`\n \n-(With Jan Medlock's patch of June 17th applied.)\n+(With Jan Medlock's patch of June 17th applied, **but not yet** [attachment: trac_11447-give_hint_on_dpkg-dev.patch.gz](https://github.com/sagemath/sage/files/ticket11447/trac_11447-give_hint_on_dpkg-dev.patch.gz).)\n \n ---\n \n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11447#issuecomment-118056",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11447#issuecomment-118057",
    "user": "https://github.com/jdemeyer"
}
```
