...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -9,5 +9,5 @@\n 2. #11553\n \n **Apply:**\n-1. [attachment:trac_11556-linear-transformations-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v3.patch)\n+1. [attachment:trac_11556-linear-transformations-v4.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v4.patch)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,4 +10,5 @@\n \n **Apply:**\n 1. [attachment:trac_11556-linear-transformations-v4.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v4.patch)\n+2. [attachment:trac_11556-linear-transformations-edits.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-edits.patch)\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,5 +10,5 @@\n \n **Apply:**\n 1. [attachment:trac_11556-linear-transformations-v4.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v4.patch)\n-2. [attachment:trac_11556-linear-transformations-edits.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-edits.patch)\n+2. [attachment:trac_11556-linear-transformations-edits-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-edits-v3.patch)\n \n``````\n",
    "created_at": "2011-08-20T13:48:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11556",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,6 +1,6 @@\n-This patch builds vector space morphisms, aka linear transformations, from free module morphisms.  This allows for a few specialized methods, such as an easier test for invertibility (check the rank of a matrix representation).  But it is mostly about (a) a \"linear transformation\" constructor for beginners' use, (b) lots of documentation, (c) specialized output routines, so it is clear when a morphism runs between two vecto5r space (not just two free modules).\n+This patch builds vector space morphisms, aka linear transformations, from free module morphisms.  This allows for a few specialized methods, such as an easier test for invertibility (check the rank of a matrix representation).  But it is mostly about (a) a \"linear transformation\" constructor for beginners' use, (b) lots of documentation, (c) specialized output routines, so it is clear when a morphism runs between two vector spaces (not just two free modules).\n \n-(c) required lots of doctest changes.  When the example was complicated and involved two vector spaces, I usually changed the output to match the new format for the new morphisms.  When teh example was simple, I tried to \"roll it back\" to involve two free modules, to fully exercise that code.\n+(c) required lots of doctest changes.  When the example was complicated and involved two vector spaces, I usually changed the output to match the new format for the new morphisms.  When the example was simple, I tried to \"roll it back\" to involve two free modules, to fully exercise that code.\n \n Additionally, there were a lot of doctests with matrices of the wrong size, reversing domain and codomain, that managed to pass due to the bug listed in #10793.  Tighter controls here required fixing a lot of these.\n \n@@ -8,7 +8,10 @@\n 1. #11552\n 2. #11553\n \n+---\n+\n **Apply:**\n 1. [attachment:trac_11556-linear-transformations-v4.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v4.patch)\n-2. [attachment:trac_11556-linear-transformations-edits-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-edits-v3.patch)\n+2. [attachment:trac-11556-linear-transformations-edits-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac-11556-linear-transformations-edits-v3.patch)\n+to the Sage library.\n \n``````\n",
    "created_at": "2011-09-08T14:57:16Z",
    "issue": "https://github.com/sagemath/sage/issues/11556",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,7 +11,7 @@\n ---\n \n **Apply:**\n-1. [attachment:trac_11556-linear-transformations-v4.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v4.patch)\n+1. [attachment:trac_11556-linear-transformations-v5.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v5.patch)\n 2. [attachment:trac-11556-linear-transformations-edits-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac-11556-linear-transformations-edits-v3.patch)\n to the Sage library.\n \n``````\n",
    "created_at": "2011-09-14T04:23:41Z",
    "issue": "https://github.com/sagemath/sage/issues/11556",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,7 +11,8 @@\n ---\n \n **Apply:**\n-1. [attachment:trac_11556-linear-transformations-v5.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v5.patch)\n-2. [attachment:trac-11556-linear-transformations-edits-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac-11556-linear-transformations-edits-v3.patch)\n+1. [attachment:trac_11556-linear-transformations-v5.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v5.patch) (there will be a reject that is taken care of in the next patch)\n+2. [attachment:trac_11556-linear-transformations-v5-rebase.patch](https://github.com/sagemath/sage/files/ticket11556/trac_11556-linear-transformations-v5-rebase.patch)\n+3. [attachment:trac-11556-linear-transformations-edits-v3.patch](https://github.com/sagemath/sage/files/ticket11556/trac-11556-linear-transformations-edits-v3.patch)\n to the Sage library.\n \n``````\n",
