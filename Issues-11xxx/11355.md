...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-147483",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42668"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42669"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42670"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42671"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42672"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42673"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-147484",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-147485",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42676"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42677"
}
```
...
```json
{
    ...
    "label": "component: user interface",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-42678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-147486",
    "user": "https://github.com/johanrosenkilde"
}
```
