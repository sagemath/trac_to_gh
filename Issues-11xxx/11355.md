...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-34999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-155616",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35000"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35001"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35002"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35003"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35004"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35005"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35006"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-155617",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-155618",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35008"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35009"
}
```
...
```json
{
    ...
    "label": "component: user interface",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11355#event-35010"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11355#issuecomment-155619",
    "user": "https://github.com/johanrosenkilde"
}
```
