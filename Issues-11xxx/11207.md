...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146249",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [cubegroup-error.log](tarball://root/attachments/some-uuid/ticket11207/cubegroup-error.log) by @jdemeyer created at 2011-04-16 09:43:31\n\nDoes this machine have adequate swap space?  I would guess that 1GB should be sufficient RAM provided there is some swap available.",
    "created_at": "2011-04-16T09:43:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146250",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Attachment [cubegroup-error.log](tarball://root/attachments/some-uuid/ticket11207/cubegroup-error.log) by @jdemeyer created at 2011-04-16 09:43:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146251",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146252",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29031"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29032"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29033"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29034"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29035"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29036"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146254",
...
```json
{
    "body": "<a id='comment:10'></a>maybe we can close this one as obsolete ?",
    "created_at": "2020-10-13T11:21:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146255",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:10'></a>maybe we can close this one as obsolete ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146256",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29038"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29039"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I think so.  Dave did a lot of great testing for us so I am pretty sure this wasn't completely isolated, but without any further info and obviously with a 10.10 machine I think that saying it is obsolete makes sense.",
    "created_at": "2020-10-13T11:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146257",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:11'></a>I think so.  Dave did a lot of great testing for us so I am pretty sure this wasn't completely isolated, but without any further info and obviously with a 10.10 machine I think that saying it is obsolete makes sense.
...
```json
{
    "body": "<a id='comment:12'></a>ok, thanks. Closing now",
    "created_at": "2020-10-13T13:16:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146258",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:12'></a>ok, thanks. Closing now
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11207#event-29040"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146259",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11207#issuecomment-146260",
