...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/11665",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156945",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156946",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>New spkg is up.",
    "created_at": "2011-08-08T16:08:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156947",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>New spkg is up.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156948",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156951",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156952",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Do you understand why the Sphinx installation process says \"Adding docutils 0.7 to easy-install.pth file\" but doesn't actually do anything?\n\nOtherwise, I'm happy with the changes, except that the list of prerequisites in SPKG.txt should be changed (or explained, if it should stay as is).  The issue with docutils and easy-install.pth can be deferred to another ticket, if it even needs to be addressed at all.  (Sphinx seems to work, so I don't know how important it is.)",
    "created_at": "2011-08-16T20:45:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156953",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>Do you understand why the Sphinx installation process says "Adding docutils 0.7 to easy-install.pth file" but doesn't actually do anything?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156954",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156955",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156956",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Okay.  Once you upgrade the list of prerequisites, I'll give this a positive review.  It doesn't sound like it's necessary to open a follow-up ticket on docutils and easy-install.pth.",
    "created_at": "2011-08-16T21:29:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156957",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>Okay.  Once you upgrade the list of prerequisites, I'll give this a positive review.  It doesn't sound like it's necessary to open a follow-up ticket on docutils and easy-install.pth.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156958",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156960",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156961",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>P.S.: I still wonder whether we should delete previously built Sage documentation at all, and if so, of which branch(es).\n\nI believe doing so has more potential of annoyance than not doing so.",
    "created_at": "2011-08-16T23:59:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156962",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:13'></a>P.S.: I still wonder whether we should delete previously built Sage documentation at all, and if so, of which branch(es).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156963",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156964",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>That's a bit misleading.  Building the entire reference manual in one piece takes more memory, for example, than building it in chunks \u2014 it doesn't scale up well \u2014 so building with two threads should use less memory, even with both threads combined, than building before the patches at #6495.  This is especially true when building in LaTeX format, it seems to me.  Based on my anecdotal experiences: building, say, the PDF version of the reference manual was pretty painful before the patches on my home computer: it slowed other things down noticeably.  Building after the patches is more pleasant.\n\n(I didn't write the description at #6495, for what that's worth.)",
    "created_at": "2011-08-17T01:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156967",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:18'></a>That's a bit misleading.  Building the entire reference manual in one piece takes more memory, for example, than building it in chunks — it doesn't scale up well — so building with two threads should use less memory, even with both threads combined, than building before the patches at #6495.  This is especially true when building in LaTeX format, it seems to me.  Based on my anecdotal experiences: building, say, the PDF version of the reference manual was pretty painful before the patches on my home computer: it slowed other things down noticeably.  Building after the patches is more pleasant.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156968",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156969",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>The current spkg gets a positive review.",
    "created_at": "2011-08-17T05:04:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156970",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:20'></a>The current spkg gets a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156971",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11665#issuecomment-156972",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11665",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11665#event-30622"
}
```
