...
```json
{
    ...
    "user": "https://trac.sagemath.org/admin/accounts/users/Pap"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160240",
    "user": "https://trac.sagemath.org/admin/accounts/users/Pap"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Does it look like #10035 is what you are asking for?  I'm not sure whether these are dups, though it seems like they might be.",
    "created_at": "2011-09-08T00:56:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160242",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Does it look like #10035 is what you are asking for?  I'm not sure whether these are dups, though it seems like they might be.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11776#event-30981"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160243",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160244",
...
```json
{
    "body": "<a id='comment:6'></a>I also agree that this is a duplicate of #10035.",
    "created_at": "2013-04-07T17:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160245",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:6'></a>I also agree that this is a duplicate of #10035.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160246",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160247",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11776#issuecomment-160248",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11776",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11776#event-30982"
}
```
