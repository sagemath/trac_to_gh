...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/11501",
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_11501_ldap_auth.patch](tarball://root/attachments/some-uuid/ticket11501/trac_11501_ldap_auth.patch) by @dimpase created at 2011-08-01 08:27:09\n\nthey say I have to build ldap 2.13 from source on MacOSX 10.6, otherwise ldap doesn't work.\nsee http://stackoverflow.com/questions/6475118/python-ldap-os-x-10-6-and-python-2-6",
    "created_at": "2011-08-01T08:27:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152667",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:5'></a>Attachment [trac_11501_ldap_auth.patch](tarball://root/attachments/some-uuid/ticket11501/trac_11501_ldap_auth.patch) by @dimpase created at 2011-08-01 08:27:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152668",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152671",
    "user": "https://trac.sagemath.org/admin/accounts/users/rmartinjak"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>One more thing that we just noticed: our LDAP has case-insensitive login names, resulting in nb creating separate sws directories for, say, user bond007, if he logs in as  BOND007, or as Bond007, or as bond07.\n\nThis has to be a feature of ldapauth, to canonise login names in some way for such LDAP (our is an AD Windows thing).",
    "created_at": "2011-08-22T04:50:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152672",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>One more thing that we just noticed: our LDAP has case-insensitive login names, resulting in nb creating separate sws directories for, say, user bond007, if he logs in as  BOND007, or as Bond007, or as bond07.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152673",
...
```json
{
    "body": "<a id='comment:14'></a>This is now basically happening upstream.  See [this pull request](https://github.com/sagemath/sagenb/pull/46), apparently unrelated to anything here, and the continuation of this material at [this fork](https://github.com/rmartinjak/sagenb/tree/ldap) by rmartinjak.",
    "created_at": "2012-06-20T16:58:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152674",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>This is now basically happening upstream.  See [this pull request](https://github.com/sagemath/sagenb/pull/46), apparently unrelated to anything here, and the continuation of this material at [this fork](https://github.com/rmartinjak/sagenb/tree/ldap) by rmartinjak.
...
```json
{
    "body": "<a id='comment:15'></a>Correction: the pull request is based on rmartinjak's patch from this ticket, though it was done by someone else (Konstantin Podshumok, who also submitted a nice gettext cleanup and Russian translation).\n\nPersonally I am wondering what happened to ijstokes's list of concerns, all of which seem very reasonable to me.",
    "created_at": "2012-06-20T19:07:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152675",
    "user": "https://github.com/kini"
}
```

<a id='comment:15'></a>Correction: the pull request is based on rmartinjak's patch from this ticket, though it was done by someone else (Konstantin Podshumok, who also submitted a nice gettext cleanup and Russian translation).
...
```json
{
    "body": "<a id='comment:16'></a>Looking at [rmartinjak's current \"ldap\" branch on sagenb](https://github.com/rmartinjak/sagenb/compare/94947d0...ldap), it seems that some of ijstokes's comments have been addressed... `OpenIDUserManager` now inherits from `ExtAuthUserManager` rather than vice versa, for example. So apparently the patch here is out of date.",
    "created_at": "2012-06-20T19:20:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152676",
    "user": "https://github.com/kini"
}
```

<a id='comment:16'></a>Looking at [rmartinjak's current "ldap" branch on sagenb](https://github.com/rmartinjak/sagenb/compare/94947d0...ldap), it seems that some of ijstokes's comments have been addressed... `OpenIDUserManager` now inherits from `ExtAuthUserManager` rather than vice versa, for example. So apparently the patch here is out of date.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152677",
    "user": "https://trac.sagemath.org/admin/accounts/users/rmartinjak"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Note from this thread https://groups.google.com/forum/?fromgroups#!topic/sage-support/6DmaZW8cY98\nThat python-dev needs to be installed (on Ubuntu) to use the instructions in this ticket else import crypto fails.",
    "created_at": "2012-08-03T13:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152678",
    "user": "https://github.com/pipedream"
}
```

<a id='comment:18'></a>Note from this thread https://groups.google.com/forum/?fromgroups#!topic/sage-support/6DmaZW8cY98
That python-dev needs to be installed (on Ubuntu) to use the instructions in this ticket else import crypto fails.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11501#event-29965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152679",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>This is now clearly a duplicate of #14330, or depends on it, or something like that.",
    "created_at": "2013-06-14T19:40:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152680",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:19'></a>This is now clearly a duplicate of #14330, or depends on it, or something like that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152681",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11501#event-29966"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11501#event-29967"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#14430\"",
    "created_at": "2013-06-14T19:41:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152682",
    "user": "https://github.com/kcrisman"
}
```

Changing dependencies from "" to "#14430"
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11501#event-29968"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11501#event-29969"
}
```
...
```json
{
    "body": "Changing dependencies from \"#14430\" to \"\"",
    "created_at": "2013-06-18T07:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152683",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "#14430" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152684",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing author from \"Robin Martinjak\" to \"\"",
    "created_at": "2013-06-18T07:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152685",
    "user": "https://github.com/jdemeyer"
}
```

Changing author from "Robin Martinjak" to ""
...
```json
{
    "body": "Changing reviewer from \"\" to \"Robin Martinjak\"",
    "created_at": "2013-06-18T07:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152686",
    "user": "https://github.com/jdemeyer"
}
```

Changing reviewer from "" to "Robin Martinjak"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11501#issuecomment-152687",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11501",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11501#event-29970"
}
```
