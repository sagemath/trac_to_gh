...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141631"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127234",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127235",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127236",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:2'>Comment 2:</a>\nReplying to [@rbeezer](#comment%3A1):\n> This was built on an alpha3 prerelease, I trust it will be OK on a real alpha3 (which I am about to build right now).\n\nTwo hunks do not apply because of (the late) [attachment: ticket:11595:trac_11595-fix_noisy_zero_doctest_errors.reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket11897/972d1ebb980a405f0b18e20a4333acb2.gz).\n\n\nOtherwise looks fine, but perhaps Karl-Dieter should rerun the tests on his famous favorite machine.",
    "created_at": "2011-10-05T15:50:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127237",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141637"
}
```
...
```json
{
    "body": "<a id='comment:3'>Comment 3:</a>\nDo you also open a follup-up ticket to #7852?\n\n[attachment: ticket:7852:trac_7852-adjust_noisy_zero_term_threshold_for_polys.reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket11897/d4bd699b59f9d964626b5202bdb3fedd.gz) wasn't enough for his machine. (I later increased epsilon from 1.0e-15 to 2.5e-15 in one example to make `bsd.math` happy, but he gets 2.6645352591e-15.)",
    "created_at": "2011-10-05T16:05:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127238",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127239",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127240",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127241",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127242",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,3 +2,8 @@\n \n See sage-release discussion:\n http://groups.google.com/group/sage-release/msg/e885e53316c6880f\n+\n+---\n+\n+Apply only [attachment: trac_11897-doctest-RDF-eigenmatrix.rebased.patch.gz](https://github.com/sagemath/sage/files/ticket11897/trac_11897-doctest-RDF-eigenmatrix.rebased.patch.gz) to the Sage library.\n+\n``````\n",
    "created_at": "2011-10-05T21:00:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127243",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127244",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127245",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127246",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127247",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127248",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127249",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127250",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127251",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141642"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127252",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127253",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127254",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141645"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127255",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127256",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127257",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141646"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11897#event-141647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11897#issuecomment-127258",
