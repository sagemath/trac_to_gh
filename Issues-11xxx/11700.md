# Issue 11700: Discriminant and resultant of RDF polynomials fails
...
```json
{
    "body": "the problem is already in resultant\n\n```\nsage: x.resultant(x)\n```",
    "created_at": "2013-08-04T19:21:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11700#issuecomment-132095",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11700#issuecomment-132096",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11700#event-31366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11700",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11700#event-31367"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11700#event-31368"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11700#event-31369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11700#issuecomment-132097",
    "user": "https://github.com/jdemeyer"
}
```
