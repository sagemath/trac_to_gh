...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11286#issuecomment-148009",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [solve2.sage](tarball://root/attachments/some-uuid/ticket11286/solve2.sage) by @rbeezer created at 2011-05-04 01:34:08",
    "created_at": "2011-05-04T01:34:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11286#issuecomment-148010",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>Attachment [solve2.sage](tarball://root/attachments/some-uuid/ticket11286/solve2.sage) by @rbeezer created at 2011-05-04 01:34:08
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11286#issuecomment-148011",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>For QQ and other infinite exact fields, naive Gauss elimination is not a good strategy all together, as it can lead to an exponential blowup of coefficients.",
    "created_at": "2011-05-04T10:30:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11286#issuecomment-148012",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:2'></a>For QQ and other infinite exact fields, naive Gauss elimination is not a good strategy all together, as it can lead to an exponential blowup of coefficients.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11286#issuecomment-148013",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11286#issuecomment-148014",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29243"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29244"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29245"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29246"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29247"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29248"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11286#event-29249"
}
```
