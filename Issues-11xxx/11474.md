...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[f7f3755](http://git.sagemath.org/sage.git/commit/?id=f7f37555460bcf62c657cba260f7151a9d5c6576)|`Trac 11474: fix doctest that depended on the extended Cremona database`|",
