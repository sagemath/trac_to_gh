...
```
The `t0GEN()`, `t1GEN()`,... system in the PARI interface is broken by design.  Apply [attachment:demonstrate_11868.patch](https://github.com/sagemath/sage/files/ticket11868/demonstrate_11868.patch) to see the bug in action.
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126317",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126318",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126319",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11868/demonstrate_11868.patch",
    "created_at": "2011-09-29T09:11:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11868/demonstrate_11868.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [demonstrate_11868.patch](https://github.com/sagemath/sage/files/ticket11868/demonstrate_11868.patch) by @jdemeyer created at 2011-09-29 09:11:31",
    "created_at": "2011-09-29T09:11:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126320",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126321",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126322",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95283"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11868/trac_11868-t0GEN.patch",
    "created_at": "2013-11-24T02:26:28Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN.patch",
...
```json
{
    "body": "Attachment [trac_11868-t0GEN.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN.patch) by @pjbruin created at 2013-11-24 02:26:28\n\neliminate global GEN variables",
    "created_at": "2013-11-24T02:26:28Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126323",
    "user": "https://github.com/pjbruin"
}
```

Attachment [trac_11868-t0GEN.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN.patch) by @pjbruin created at 2013-11-24 02:26:28
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -7,3 +7,7 @@\n 2. Apart from the first non-`self` argument, there should be another argument which is a \"complicated\" Python type (e.g. a number field element).\n \n As work-around, it is easy to defeat condition 2 by converting arguments to pari before calling the function.\n+\n+This problem can be solved by using only local variables instead of `t0GEN` etc.\n+\n+Apply: [attachment:trac_11868-t0GEN.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN.patch)\n``````\n",
    "created_at": "2013-11-24T02:28:27Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126324",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126325",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126326",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126327",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126328",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126329",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126330",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95286"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95287"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126331",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126332",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126333",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126334",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126335",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11868/trac_11868-remove_workarounds.patch",
    "created_at": "2013-11-24T22:13:30Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11868/trac_11868-remove_workarounds.patch",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>\nAttachment [trac_11868-remove_workarounds.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-remove_workarounds.patch) by @pjbruin created at 2013-11-24 22:13:30",
    "created_at": "2013-11-24T22:13:30Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126336",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,4 +10,4 @@\n \n This problem can be solved by using only local variables instead of `t0GEN` etc.\n \n-Apply: [attachment:trac_11868-t0GEN.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN.patch)\n+Apply: [[attachment:trac_11868-remove_workarounds.patch](https://github.com/sagemath/sage/files/ticket11868/8b84addb0c3daa70712aa6a681413ffa.patch](https://github.com/sagemath/sage/files/ticket11868/b5452a4f6a4059fba210ae73477d73e2.patch),)\n``````\n",
    "created_at": "2013-11-24T22:13:30Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126337",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126338",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11868/trac_11868-get_nf.patch",
    "created_at": "2013-11-25T00:26:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11868/trac_11868-get_nf.patch",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Attachment [trac_11868-get_nf.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-get_nf.patch) by @pjbruin created at 2013-11-25 00:26:31\n\neliminate the gen.get_nf() method",
    "created_at": "2013-11-25T00:26:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126339",
    "user": "https://github.com/pjbruin"
}
```

Attachment [trac_11868-get_nf.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-get_nf.patch) by @pjbruin created at 2013-11-25 00:26:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126340",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,4 +10,4 @@\n \n This problem can be solved by using only local variables instead of `t0GEN` etc.\n \n-Apply: [[attachment:trac_11868-remove_workarounds.patch](https://github.com/sagemath/sage/files/ticket11868/8b84addb0c3daa70712aa6a681413ffa.patch](https://github.com/sagemath/sage/files/ticket11868/b5452a4f6a4059fba210ae73477d73e2.patch),)\n+Apply: [[attachment:trac_11868-remove_workarounds.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-remove_workarounds.patch), [attachment:trac_11868-get_nf.patch](https://github.com/sagemath/sage/files/ticket11868/8b84addb0c3daa70712aa6a681413ffa.patch](https://github.com/sagemath/sage/files/ticket11868/3437d61cf2af9ca28e0fa2aa0ca290c6.patch),)\n``````\n",
    "created_at": "2013-11-25T00:27:27Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126341",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126342",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126343",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126344",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126345",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126346",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126347",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11868/trac_11868-t0GEN_new.patch",
    "created_at": "2013-11-25T18:33:06Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN_new.patch",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Attachment [trac_11868-t0GEN_new.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN_new.patch) by @pjbruin created at 2013-11-25 18:33:06\n\neliminate global GEN variables",
    "created_at": "2013-11-25T18:33:06Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126348",
    "user": "https://github.com/pjbruin"
}
```

Attachment [trac_11868-t0GEN_new.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN_new.patch) by @pjbruin created at 2013-11-25 18:33:06
...
```json
{
    "body": "<a id='comment:22'></a>\n[replaces [attachment:trac_11868-t0GEN.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-t0GEN.patch) and [attachment:trac_11868-get_nf.patch](https://github.com/sagemath/sage/files/ticket11868/aba7373855af75ac5927a4d7d845baaa.patch](https://github.com/sagemath/sage/files/ticket11868/506ab8760401ce0fa3a4287384ff3a76.patch))\n\nApply trac_11868-t0GEN_new.patch, trac_11868-remove_workarounds.patch",
    "created_at": "2013-11-25T18:36:04Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126349",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,4 +10,4 @@\n \n This problem can be solved by using only local variables instead of `t0GEN` etc.\n \n-Apply: [[attachment:trac_11868-remove_workarounds.patch](https://github.com/sagemath/sage/files/ticket11868/trac_11868-remove_workarounds.patch), [attachment:trac_11868-get_nf.patch](https://github.com/sagemath/sage/files/ticket11868/8b84addb0c3daa70712aa6a681413ffa.patch](https://github.com/sagemath/sage/files/ticket11868/3437d61cf2af9ca28e0fa2aa0ca290c6.patch),)\n+Apply: [[attachment:trac_11868-remove_workarounds.patch](https://github.com/sagemath/sage/files/ticket11868/e8e8e75780e7e1ef0ab588dd9ba24923.patch](https://github.com/sagemath/sage/files/ticket11868/987f1f496b332597452cfb3f4ebaa121.patch),)\n``````\n",
    "created_at": "2013-11-25T18:36:04Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126350",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95288"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126351",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126352",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126353",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>\nI added some small changes, see [attachment:11868_pari_extra.patch](https://github.com/sagemath/sage/files/ticket11868/11868_pari_extra.patch). It's not strictly a reviewer patch, since many changes are unrelated to this ticket but just small things I observed while checking your patch.",
    "created_at": "2013-11-26T14:02:18Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126354",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126355",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126356",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126357",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126358",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126359",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126360",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126361",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126362",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126363",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126364",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126365",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11868#issuecomment-126366",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11868/11868_pari_extra.patch",
    "created_at": "2013-11-27T21:30:38Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11868/11868_pari_extra.patch",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>\nAttachment [11868_pari_extra.patch](https://github.com/sagemath/sage/files/ticket11868/11868_pari_extra.patch) by @pjbruin created at 2013-11-27 21:30:38\n\nExcellent, I'm happy with the current state.",
    "created_at": "2013-11-27T21:30:38Z",
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95290"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95291"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11868",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11868#event-95293"
}
```
