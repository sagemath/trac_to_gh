...
```json
{
    "body": "Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.",
...
```json
{
    "body": "Attachment [sage-doctest.txt](tarball://root/attachments/some-uuid/ticket11753/sage-doctest.txt) by @ppurka created at 2011-09-06 02:45:38\n\nReplying to [comment:4 dimpase]:\n> Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.\n\nUpdated the patch with doctests.",
