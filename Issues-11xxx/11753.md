...
```json
{
    "body": "<a id='comment:1'></a>Thanks for catching this.   I'll try to take a look at this sometime, though not immediately.  cc:ing a couple of other people who might be interested.    \n\nA few comments: \n* Is this new behavior always desirable?  \n* Might we want to catch this in plot, rather than 'fixing' misc?\n* Are there any other places this might cause problems?  (E.g., do all doctests pass with this?)\n\nI don't know the answers to these questions; this might really be the right fix, but I just want to be careful.",
    "created_at": "2011-08-31T03:11:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159441",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Thanks for catching this.   I'll try to take a look at this sometime, though not immediately.  cc:ing a couple of other people who might be interested.    
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159442",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159443",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attached patch which patches srange() and xsrange() in devel/sage/sage/misc/misc.py and setup_for_eval_on_grid() in devel/sage/sage/plot/misc.py\n\nIn all the functions, the patch will now raise an error instead of silently failing.\n\nThe plot() command (and also plot3d()) both now give the a more meaningful error if the endpoint and startpoints in the range are the same.",
    "created_at": "2011-09-01T12:58:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159444",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:3'></a>Attached patch which patches srange() and xsrange() in devel/sage/sage/misc/misc.py and setup_for_eval_on_grid() in devel/sage/sage/plot/misc.py
...
```json
{
    "body": "<a id='comment:4'></a>Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.",
    "created_at": "2011-09-05T19:06:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159445",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159446",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159447",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [sage-doctest.txt](tarball://root/attachments/some-uuid/ticket11753/sage-doctest.txt) by @ppurka created at 2011-09-06 02:45:38\n\nReplying to [dimpase](#comment%3A4):\n> Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.\n\nUpdated the patch with doctests.",
    "created_at": "2011-09-06T02:45:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159448",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:5'></a>Attachment [sage-doctest.txt](tarball://root/attachments/some-uuid/ticket11753/sage-doctest.txt) by @ppurka created at 2011-09-06 02:45:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159449",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159450",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [ppurka](#comment%3A5):\n> Replying to [dimpase](#comment%3A4):\n> > Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.\n\n> Updated the patch with doctests.\n\nin misc.py, can't you do `map(len,ranges)` rather than fortranic `[len(r) for r in ranges]` ?",
    "created_at": "2011-09-06T05:09:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159451",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:7'></a>Replying to [ppurka](#comment%3A5):
> Replying to [dimpase](#comment%3A4):
> > Please add `plot(x,3,3)` to the appropriate doctest, to show that the patch really does the trick.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159452",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159453",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159454",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159456",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159457",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159458",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [11753-fix_div_by_zero.patch](tarball://root/attachments/some-uuid/ticket11753/11753-fix_div_by_zero.patch) by @dimpase created at 2011-09-20 14:59:47\n\nReplying to [ppurka](#comment%3A11):\n> Replying to [dimpase](#comment%3A10):\n> > The condition `step == 0` you check looks worrisome. From a glance over the code it's not clear whether `step` cannot be a float, and if it is a float, then such a test does not make much sense.\n\n> \n> Should be fixed now.\n\n\nEver written \"real\" numerical code?\n\n`min(range_steps) == float(0)` won't fly. You need something like `min(range_steps)<C*sys.float_info.epsilon`, for `C`\nsomething like 2 or 10...",
    "created_at": "2011-09-20T14:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159459",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>Attachment [11753-fix_div_by_zero.patch](tarball://root/attachments/some-uuid/ticket11753/11753-fix_div_by_zero.patch) by @dimpase created at 2011-09-20 14:59:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159460",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159461",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159462",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159463",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"P. Purkayastha\"",
    "created_at": "2011-09-27T19:10:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159464",
    "user": "https://github.com/nexttime"
}
```

Changing author from "" to "P. Purkayastha"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159465",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159466",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159467",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159468",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11753#issuecomment-159469",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11753",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11753#event-30909"
}
```
