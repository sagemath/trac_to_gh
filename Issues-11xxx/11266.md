...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147648",
...
```json
{
    "body": "<a id='comment:4'></a>As a possible interim step, you could just make a context handler that does the .png() and .dev_off() commands, so something like this would work:\n\n```\nfrom contextlib import contextmanager\n\n@contextmanager\ndef r_graphics(r):\n    r.png()\n    yield\n    r.dev_off()\n\nwith r_graphics(r):\n    r.boxplot()\n    r.some_other_plot()\n```",
    "created_at": "2011-04-28T20:21:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147650",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>As a possible interim step, you could just make a context handler that does the .png() and .dev_off() commands, so something like this would work:
...
```json
{
    "body": "<a id='comment:6'></a>I like your class!",
    "created_at": "2011-05-01T01:25:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147652",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>I like your class!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147653",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>(I mention the above points to carry on design discussion, not to disparage the ideas.  I really am curious how the class is better than just defining a new custom function, and if the caching effort is worth it.)",
    "created_at": "2011-05-01T03:44:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147656",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:10'></a>(I mention the above points to carry on design discussion, not to disparage the ideas.  I really am curious how the class is better than just defining a new custom function, and if the caching effort is worth it.)
...
```json
{
    "body": "<a id='comment:11'></a>Using the Google summer of code project, it may be very easy for us to have a Sage Graphics object that does R stuff.  For example, see http://rpy2-gsoc.blogspot.com/2010/08/all-good-things.html, where he talks about having R draw onto a matplotlib canvas in a not-yet-released rpy2 version.",
    "created_at": "2011-05-01T03:50:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147657",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:11'></a>Using the Google summer of code project, it may be very easy for us to have a Sage Graphics object that does R stuff.  For example, see http://rpy2-gsoc.blogspot.com/2010/08/all-good-things.html, where he talks about having R draw onto a matplotlib canvas in a not-yet-released rpy2 version.
...
```json
{
    "body": "<a id='comment:12'></a>I think you're right about using a function call rather than a class.\n\nSo is the final conclusion:\n\n1. Wait for rpy2\n\n2. Put the contextmanager solution into sage documents\n\n3. Possibly put up some guides on how to do things in sage/R?\n\nShould we change the ticket to a documentation ticket?",
    "created_at": "2011-05-02T04:00:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147658",
    "user": "https://trac.sagemath.org/admin/accounts/users/JoalHeagney"
}
```

<a id='comment:12'></a>I think you're right about using a function call rather than a class.
...
```json
{
    "body": "<a id='comment:13'></a>Hah. Finally found the tutorial I was looking for.\n\nAny chance this can be added to the documentation for R?\n\n[http://www.sagenb.org/home/pub/2232/](http://www.sagenb.org/home/pub/2232/)",
    "created_at": "2011-05-02T04:37:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147659",
    "user": "https://trac.sagemath.org/admin/accounts/users/JoalHeagney"
}
```

<a id='comment:13'></a>Hah. Finally found the tutorial I was looking for.
...
```json
{
    "body": "<a id='comment:15'></a>I'm not sure if we rpy or rpy2.  That's why I originally said \"rpy(2?)\".  At one time, I looked at upgrading to rpy2, but I'm not sure if the work was ever finished.",
    "created_at": "2011-05-02T15:05:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147661",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:15'></a>I'm not sure if we rpy or rpy2.  That's why I originally said "rpy(2?)".  At one time, I looked at upgrading to rpy2, but I'm not sure if the work was ever finished.
...
```json
{
    "body": "<a id='comment:17'></a>We don't use rpy?  That's news to me.  I was pretty sure we used rpy, but you're the expert here.",
    "created_at": "2011-05-02T15:36:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147663",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:17'></a>We don't use rpy?  That's news to me.  I was pretty sure we used rpy, but you're the expert here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147664",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29167"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29168"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29169"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29170"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29171"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29172"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11266#event-29173"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>I believe William has this working without such things in SMC.",
    "created_at": "2014-10-28T19:10:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11266#issuecomment-147665",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:23'></a>I believe William has this working without such things in SMC.
