...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11206#issuecomment-113874",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11206/rubik-error.log",
    "created_at": "2011-04-15T19:21:07Z",
    "issue": "https://github.com/sagemath/sage/issues/11206",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11206/rubik-error.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [rubik-error.log](https://github.com/sagemath/sage/files/ticket11206/rubik-error.log) by drkirkby created at 2011-04-15 19:21:07",
    "created_at": "2011-04-15T19:21:07Z",
    "issue": "https://github.com/sagemath/sage/issues/11206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11206#issuecomment-113875",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11206#issuecomment-113876",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87544"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11206#issuecomment-113877",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11206#issuecomment-113878",
...
```json
{
    ...
    "label": "component: doctest coverage",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87547"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87548"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87549"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87550"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87551"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87552"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87553"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87554"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87555"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11206#event-87556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11206#issuecomment-113879",
