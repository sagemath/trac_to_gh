...
```json
{
    "body": "<a id='comment:1'></a>In fact, the file part of what we use doesn't even seem to be necessary.  The option we need is `print.eval=TRUE`.\n\n```\nsage: r.eval('source(file=\"/Users/.../48141//interface//tmp48141\",local=TRUE)')\n''\nsage: r.eval('source(file=\"/Users/.../48141//interface//tmp48141\",print.eval=TRUE)')\n'[1] 1 2 3'\n```",
    "created_at": "2011-06-07T02:57:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11436#issuecomment-151347",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>In fact, the file part of what we use doesn't even seem to be necessary.  The option we need is `print.eval=TRUE`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11436#issuecomment-151349",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_11436.patch](tarball://root/attachments/some-uuid/ticket11436/trac_11436.patch) by @kcrisman created at 2011-06-07 03:09:31\n\nPossible patch uploaded.  Probably needs more documentation, but it fixed my problem locally so I'm going to bed.  Suggestions welcome.",
    "created_at": "2011-06-07T03:09:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11436#issuecomment-151350",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Attachment [trac_11436.patch](tarball://root/attachments/some-uuid/ticket11436/trac_11436.patch) by @kcrisman created at 2011-06-07 03:09:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11436#issuecomment-151351",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11436#issuecomment-151352",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>See [this sage-devel thread](http://groups.google.com/group/sage-devel/browse_thread/thread/969ae6a98e0b74b6) for what I believe is this same problem.",
    "created_at": "2012-05-21T13:18:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11436#issuecomment-151353",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>See [this sage-devel thread](http://groups.google.com/group/sage-devel/browse_thread/thread/969ae6a98e0b74b6) for what I believe is this same problem.
