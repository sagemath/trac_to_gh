...
```json
{
    "body": "<div id=\"comment:31\" align=\"right\">Comment 31</div>\n\nReplying to [@sagetrac-cdsousa](#comment%3A30):\n> I've tested new readline-6.2.p0.spkg in an updated Arch Linux with Sage 4.7.1. Everything seems ok.\n> \n> I was not completely sure of what should be tested, but sage, sage --sh and sage --notebook run ok.\n\nOk, thanks.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11882#event-146351"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11882#event-146352"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11882#event-146353"
}
```
