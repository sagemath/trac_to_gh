...
<a id='comment:2'></a>Oh yes, this seems to catch all situations where we could run into this.
...
```json
{
    "body": "<a id='comment:7'></a>Just to work around some deficiency of my current script...",
    "created_at": "2011-09-24T12:20:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11830",
    "type": "issue_comment",
...
<a id='comment:7'></a>Just to work around some deficiency of my current script...
