...
```json
{
    "body": "Apply:\n\n- [attachment:trac_11121-hgrc.data-extcode.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.data-extcode.patch) to data/extcode\n- [attachment:trac_11121-hgrc.devel-sage.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sage.patch) to Sage library\n- [attachment:trac_11121-hgrc.devel-sagenb.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sagenb.patch) to sagenb\n- [attachment:trac_11121-hgrc.local-bin-mode0755.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin-mode0755.patch) to scripts repo\n- [attachment:trac_11121-scripts-sage-clone.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-scripts-sage-clone.patch) also to scripts repo\n- [attachment:trac_11121-root-repo.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-root-repo.patch) to root repository\n\n---\n\nAs above. See some discussion at [sage-devel](http://groups.google.com/group/sage-devel/browse_thread/thread/f5a9c012f6299a9e).\n\nThis would involve making the Mercurial spkg install an hgrc at $SAGE_LOCAL/etc/mercurial/hgrc as well as adding lines to .hg/hgrc in the major repositories in the sage distribution (`.`, `data/extcode`, `devel/sage/`, `devel/sagenb/`, and `local/bin/`). I exclude `examples` and `spkg/base` because they are scheduled to be gotten rid of (#7494 and #11073 respectively).\n\nDepends on #10594\n\n**CC:**  @gvol\n\n**Keywords:** mercurial git diff patches sd31\n\n**Author:** Keshav Kini, John Palmieri\n\n**Reviewer:** John Palmieri, Keshav Kini\n\n**Merged:** sage-4.7.2.alpha2\n\nIssue created by migration from https://trac.sagemath.org/ticket/11121\n\n",
...
```json
{
    ...
    "rename": {
        "from": "Mercurial spkg should install an hgrc which turns on git-style diffs",
        "to": "Sage should use git-style diffs everywhere possible."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112473",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112474",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112475",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86919"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "rename": {
        "from": "Sage should use git-style diffs everywhere possible.",
        "to": "Set up good defaults for sage's mercurial"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112476",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112477",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112478",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86921"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112479",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112480",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86923"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86924"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86925"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112481",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112482",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "asset_name": "trac_11121-hgrc.data-extcode.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.data-extcode.patch",
    "created_at": "2011-04-05T08:09:27Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.data-extcode.patch",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "Attachment [trac_11121-hgrc.data-extcode.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.data-extcode.patch) by @kini created at 2011-04-05 08:09:27\n\napply to $SAGE_ROOT/data/extcode",
    "created_at": "2011-04-05T08:09:27Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112483",
    "user": "https://github.com/kini"
}
```

Attachment [trac_11121-hgrc.data-extcode.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.data-extcode.patch) by @kini created at 2011-04-05 08:09:27
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-hgrc.devel-sagenb.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.devel-sagenb.patch",
    "created_at": "2011-04-05T08:13:08Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sagenb.patch",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "Attachment [trac_11121-hgrc.devel-sagenb.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sagenb.patch) by @kini created at 2011-04-05 08:13:08\n\napply to $SAGE_ROOT/devel/sagenb",
    "created_at": "2011-04-05T08:13:08Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112484",
    "user": "https://github.com/kini"
}
```

Attachment [trac_11121-hgrc.devel-sagenb.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sagenb.patch) by @kini created at 2011-04-05 08:13:08
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-hgrc.local-bin.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.local-bin.patch",
    "created_at": "2011-04-05T08:13:34Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin.patch",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "Attachment [trac_11121-hgrc.local-bin.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin.patch) by @kini created at 2011-04-05 08:13:34\n\napply to $SAGE_ROOT/local/bin",
    "created_at": "2011-04-05T08:13:34Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112485",
    "user": "https://github.com/kini"
}
```

Attachment [trac_11121-hgrc.local-bin.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin.patch) by @kini created at 2011-04-05 08:13:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112486",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112487",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112488",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112489",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112490",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112491",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112492",
    "user": "https://github.com/kini"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-hgrc.sage.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.sage.patch",
    "created_at": "2011-04-06T17:25:21Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.sage.patch",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "Attachment [trac_11121-hgrc.sage.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.sage.patch) by @kini created at 2011-04-06 17:25:21\n\napply to $SAGE_ROOT",
    "created_at": "2011-04-06T17:25:21Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112493",
    "user": "https://github.com/kini"
}
```

Attachment [trac_11121-hgrc.sage.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.sage.patch) by @kini created at 2011-04-06 17:25:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112494",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112495",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112496",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112497",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112498",
    "user": "https://github.com/kini"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-hgrc.devel-sage.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.devel-sage.patch",
    "created_at": "2011-06-14T00:27:07Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sage.patch",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "Attachment [trac_11121-hgrc.devel-sage.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sage.patch) by @kini created at 2011-06-14 00:27:07\n\napply to $SAGE_ROOT/devel/sage",
    "created_at": "2011-06-14T00:27:07Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112499",
    "user": "https://github.com/kini"
}
```

Attachment [trac_11121-hgrc.devel-sage.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sage.patch) by @kini created at 2011-06-14 00:27:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112500",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112501",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112502",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112503",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112504",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112505",
    "user": "https://github.com/kini"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-hgrc.mercurial-spkg.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.mercurial-spkg.patch",
    "created_at": "2011-06-14T03:55:34Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.mercurial-spkg.patch",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "Attachment [trac_11121-hgrc.mercurial-spkg.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.mercurial-spkg.patch) by @kini created at 2011-06-14 03:55:34\n\ndon't use this, I'll upload a full spkg",
    "created_at": "2011-06-14T03:55:34Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112506",
    "user": "https://github.com/kini"
}
```

Attachment [trac_11121-hgrc.mercurial-spkg.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.mercurial-spkg.patch) by @kini created at 2011-06-14 03:55:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112507",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112508",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112509",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112510",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86927"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86928"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112511",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112512",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112513",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112514",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112515",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11121#issuecomment-112516",
    "user": "https://github.com/kini"
}
```
...
archive/attachments_014569.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-root-repo.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-root-repo.patch",
    "created_at": "2011-07-02T05:40:26Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-root-repo.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [trac_11121-root-repo.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-root-repo.patch) by @jhpalmieri created at 2011-07-02 05:40:26\n\napply to $SAGE_ROOT",
    "created_at": "2011-07-02T05:40:26Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
...
Attachment [trac_11121-root-repo.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-root-repo.patch) by @jhpalmieri created at 2011-07-02 05:40:26
...
archive/attachments_014570.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-scripts-sage-clone.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-scripts-sage-clone.patch",
    "created_at": "2011-07-05T21:53:08Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-scripts-sage-clone.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [trac_11121-scripts-sage-clone.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-scripts-sage-clone.patch) by @jhpalmieri created at 2011-07-05 21:53:08\n\nscripts repo",
    "created_at": "2011-07-05T21:53:08Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
...
Attachment [trac_11121-scripts-sage-clone.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-scripts-sage-clone.patch) by @jhpalmieri created at 2011-07-05 21:53:08
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,14 +1,13 @@\n-Apply trac_11121-hgrc.data-extcode.patch to data/extcode\n+Apply:\n \n-Apply trac_11121-hgrc.devel-sage.patch to devel/sage\n-\n-Apply trac_11121-hgrc.devel-sagenb.patch to devel/sagenb\n-\n-Apply trac_11121-hgrc.local-bin.patch to local/bin\n+- [attachment:trac_11121-hgrc.data-extcode.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.data-extcode.patch) to data/extcode\n+- [attachment:trac_11121-hgrc.devel-sage.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sage.patch) to Sage library\n+- [attachment:trac_11121-hgrc.devel-sagenb.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.devel-sagenb.patch) to sagenb\n+- [attachment:trac_11121-hgrc.local-bin.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin.patch) to scripts repo\n+- [attachment:trac_11121-scripts-sage-clone.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-scripts-sage-clone.patch) also to scripts repo\n+- [attachment:trac_11121-root-repo.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-root-repo.patch) to root repository\n \n Install [http://sage.math.washington.edu/home/keshav/files/mercurial-1.8.4.spkg](http://sage.math.washington.edu/home/keshav/files/mercurial-1.8.4.spkg), which fixes #11120 and #10594 as well\n-\n-Apply trac_11121-root-repo.patch to the root repository\n \n ---\n \n``````\n",
    "created_at": "2011-07-05T21:55:59Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86929"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86930"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11121#event-86932"
}
```
...
```json
{
    "body": "Same as [attachment:trac_11121-hgrc.local-bin.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin.patch) but keeping the file mode 0755",
...
Same as [attachment:trac_11121-hgrc.local-bin.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin.patch) but keeping the file mode 0755
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11121-hgrc.local-bin-mode0755.patch",
    "asset_url": "tarball://root/attachments/ticket11121/trac_11121-hgrc.local-bin-mode0755.patch",
    "created_at": "2011-08-23T13:47:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin-mode0755.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:63'></a>\nAttachment [trac_11121-hgrc.local-bin-mode0755.patch](https://github.com/sagemath/sage/files/ticket11121/trac_11121-hgrc.local-bin-mode0755.patch) by @jdemeyer created at 2011-08-23 13:47:50",
    "created_at": "2011-08-23T13:47:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11121",
    "type": "issue_comment",
