...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143190",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143191",
...
```json
{
    "body": "<a id='comment:4'></a>This week, I compiled sage-4.7.1.rc0 and installed the new flask Sage notebook following instructions from : http://code.google.com/r/rkirov-flask/. I also followed the section `Adding stock Jmol` plus the patch `trac_11078.patch`. This made Jmol to work from the notebook : Great!\n\nBut, from the command line, with the patch `trac_11078.patch` a command like `sphere()` opens Jmol but Jmol stays all black. I had to mimic the modifications done in #11503 on the same file `sage/plot/plot3d/base.pyx` to make Jmol works properly from the command line.\n\nS\u00e9bastien",
    "created_at": "2011-07-25T19:50:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143192",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>This week, I compiled sage-4.7.1.rc0 and installed the new flask Sage notebook following instructions from : http://code.google.com/r/rkirov-flask/. I also followed the section `Adding stock Jmol` plus the patch `trac_11078.patch`. This made Jmol to work from the notebook : Great!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143193",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143194",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143195",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_11078.patch](tarball://root/attachments/some-uuid/ticket11078/trac_11078.patch) by @jasongrout created at 2011-12-31 16:38:17\n\nI updated the patch with the changes from #11503.  With the flask notebook, sphere() works both from the command line and from the notebook.\n\nI'm setting as needs review to have one other person double-check this patch works as intended, though I guess I might qualify as the only needed reviewer.  Basically, what I did here was just rebase the patch at #11503.",
    "created_at": "2011-12-31T16:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143196",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>Attachment [trac_11078.patch](tarball://root/attachments/some-uuid/ticket11078/trac_11078.patch) by @jasongrout created at 2011-12-31 16:38:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143197",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143198",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This looks great to me!",
    "created_at": "2012-01-06T03:34:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143199",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>This looks great to me!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143200",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143201",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143202",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143203",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143204",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143205",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Unmerging this from sage-5.2 due to the serious security issue at #13270.",
    "created_at": "2012-07-23T06:50:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143206",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>Unmerging this from sage-5.2 due to the serious security issue at #13270.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143207",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143208",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143209",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143210",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143211",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11078#issuecomment-143212",
    "user": "https://github.com/jdemeyer"
}
```
