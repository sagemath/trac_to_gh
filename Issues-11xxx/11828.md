...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11828#event-145469"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11828#event-145470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11828#event-145471"
}
```
...
```json
{
    "body": "Changed assignee from **@loefflerd** to **Alligadi**",
    "created_at": "2011-09-21T20:23:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11828",
    "type": "issue_comment",
...
Changed assignee from **@loefflerd** to **Alligadi**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11828#issuecomment-125902",
    "user": "https://github.com/sagetrac-Alligadi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11828#issuecomment-125903",
    "user": "https://github.com/sagetrac-Alligadi"
}
```
