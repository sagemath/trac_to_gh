...
archive/attachments_015451.json:
```json
{
...
archive/attachments_015452.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_015453.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_11360-cubegroup-ts.patch](https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup-ts.patch)",
    "created_at": "2013-07-26T08:35:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
