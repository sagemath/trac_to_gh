...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116747",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116748",
...
archive/attachments_014915.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11360-cubegroup.patch",
    "asset_url": "tarball://root/attachments/ticket11360/trac_11360-cubegroup.patch",
    "created_at": "2011-08-03T17:17:55Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup.patch",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_11360-cubegroup.patch](https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup.patch) by @wdjoyner created at 2011-08-03 17:17:55\n\nReplying to [robertwb](#comment%3A1):\n> This could be easily fixed by implementing `CubeGroup._gap_init_()`. \n\n\nIs the attached patch what you had in mind?\n\n> Generically, one could implement this in terms of gens() if it's not already there.\n",
    "created_at": "2011-08-03T17:17:55Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116749",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89320"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116750",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116751",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89321"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89322"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116752",
    "user": "https://github.com/wdjoyner"
}
```
...
archive/attachments_014916.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11360-cubegroup2.patch",
    "asset_url": "tarball://root/attachments/ticket11360/trac_11360-cubegroup2.patch",
    "created_at": "2011-09-10T18:51:02Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup2.patch",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac_11360-cubegroup2.patch](https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup2.patch) by @wdjoyner created at 2011-09-10 18:51:02\n\nReplying to [robertwb](#comment%3A3):\n> Yes, that works. You should elide the commented-out lines and the \"Stored in the ``self._gap_string`` attribute\" comment is also incorrect and should probably just be omitted. \n> \n\n\n\nDone. See attached.\n\n\n> I'm still curious as to why this is a group and has a ._group attribute, but that's probably for another ticket.\n",
    "created_at": "2011-09-10T18:51:02Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116753",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89323"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116754",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89325"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116755",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116756",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116757",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116758",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116759",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89327"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89328"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89329"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116761",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116762",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89331"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89332"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89333"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89334"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116763",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116764",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89335"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116765",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116766",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89337"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89338"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89339"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89340"
}
```
...
archive/attachments_014917.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11360-cubegroup-ts.patch",
    "asset_url": "tarball://root/attachments/ticket11360/trac_11360-cubegroup-ts.patch",
    "created_at": "2013-07-26T08:35:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup-ts.patch",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Attachment [trac_11360-cubegroup-ts.patch](https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup-ts.patch) by @tscrim created at 2013-07-26 08:35:58",
    "created_at": "2013-07-26T08:35:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11360#issuecomment-116767",
    "user": "https://github.com/tscrim"
}
```

Attachment [trac_11360-cubegroup-ts.patch](https://github.com/sagemath/sage/files/ticket11360/trac_11360-cubegroup-ts.patch) by @tscrim created at 2013-07-26 08:35:58
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89341"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89342"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89343"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89344"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11360",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11360#event-89346"
}
```
