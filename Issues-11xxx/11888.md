...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146439"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146442"
}
```
...
```json
{
    "body": "Changed keywords from **lambert_w symbolics conversion maxima** to **lambert_w symbolics conversion maxima sd35.5**",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146443"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -35,3 +35,10 @@\n ```\n \n `mpmath` can evaluate the `lambert_w` function, so it should be easy to add a new symbolic function to Sage that will fix this issue. \n+\n+---\n+\n+Apply:\n+\n+1. [attachment: trac_11888.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888.patch.gz) to `$SAGE_ROOT/devel/sage`\n+2. [attachment: trac_11888-doctests.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888-doctests.patch.gz) to `$SAGE_ROOT/devel/sage`\n``````\n",
    "created_at": "2012-01-10T11:39:21Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146445"
}
```
...
```json
{
    "body": "<div id=\"comment:21\" align=\"right\">Comment 21</div>\n\nI fixed the doctests and added lambert_w to the symbol table. I verified that all tests pass including the random_tests.py ones. The patch [attachment: trac_11888_v3.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v3.patch.gz) is ready for review.",
...
```json
{
    "body": "Changed work issues from **add second parameter, RDF/CDF stuff** to none",
    "created_at": "2012-02-11T22:07:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146447"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -40,5 +40,4 @@\n \n Apply:\n \n-1. [attachment: trac_11888.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888.patch.gz) to `$SAGE_ROOT/devel/sage`\n-2. [attachment: trac_11888-doctests.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888-doctests.patch.gz) to `$SAGE_ROOT/devel/sage`\n+1. [attachment: trac_11888_v3.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v3.patch.gz) to `$SAGE_ROOT/devel/sage`\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -40,4 +40,6 @@\n \n Apply:\n \n-1. [attachment: trac_11888_v3.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v3.patch.gz) to `$SAGE_ROOT/devel/sage`\n+* Patches at #9130 \n+* [attachment: trac_11888_v4.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v4.patch.gz) to `$SAGE_ROOT/devel/sage`\n+* [attachment: trac_11888-random-tests.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888-random-tests.patch.gz) to `$SAGE_ROOT/devel/sage`\n``````\n",
    "created_at": "2012-02-12T20:51:25Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
...
```json
{
    "body": "Changed reviewer from **Keshav Kini, Karl-Dieter Crisman, Fredrik Johansson** to **Keshav Kini, Karl-Dieter Crisman, Fredrik Johansson, Burcin Erocal**",
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "title_is": "Sage is missing the lambert_w function",
    "title_was": "Sage is missing the lambert_w function conversion from Maxima",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146450"
}
```
...
```json
{
    "body": "Changed dependencies from **#9130** to **#12507**",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -40,6 +40,5 @@\n \n Apply:\n \n-* Patches at #9130 \n-* [attachment: trac_11888_v4.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v4.patch.gz) to `$SAGE_ROOT/devel/sage`\n-* [attachment: trac_11888-random-tests.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888-random-tests.patch.gz) to `$SAGE_ROOT/devel/sage`\n+* Patch at #12507\n+* [attachment: trac_11888_v5.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v5.patch.gz) to `$SAGE_ROOT/devel/sage`\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146453"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146454"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146455"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146456"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -40,5 +40,4 @@\n \n Apply:\n \n-* Patch at #12507\n-* [attachment: trac_11888_v5.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v5.patch.gz) to `$SAGE_ROOT/devel/sage`\n+* [attachment: trac_11888_v7.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v7.patch.gz) to `$SAGE_ROOT/devel/sage`\n``````\n",
    "created_at": "2012-03-19T20:00:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -40,4 +40,4 @@\n \n Apply:\n \n-* [attachment: trac_11888_v7.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v7.patch.gz) to `$SAGE_ROOT/devel/sage`\n+* [attachment: trac_11888_v7.2.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v7.2.patch.gz) to `$SAGE_ROOT/devel/sage`\n``````\n",
...
```json
{
    "body": "Changed dependencies from **#12507** to none",
...
```json
{
    "body": "<div id=\"comment:42\" align=\"right\">Comment 42</div>\n\nI removed #12507 from dependencies since it was merged in 5.0.beta5 and now the patchbot is getting confused trying to apply #12507 to 5.0.beta12 before testing.\n\nI verified that [attachment: trac_11888_v7.2.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v7.2.patch.gz) applies cleanly to 5.0.beta12 and I'm rerunning a patchbot instance on it.",
    "created_at": "2012-04-07T22:47:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127039",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127040",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127041",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127042",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127043",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127044",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127045",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Changed keywords from **lambert_w symbolics conversion maxima sd35.5** to **lambert_w symbolics conversion maxima sd35.5 sd40.5**",
    "created_at": "2012-05-25T18:10:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127046",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127047",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127048",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127049",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127050",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127051",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<div id=\"comment:55\" align=\"right\">Comment 55</div>\n\nNew patch is ready for review. I hope this can be the final revision! \n\nPatchbot: apply [attachment: trac_11888_v8.patch](https://github.com/sagemath/sage/files/ticket11888/trac_11888_v8.patch.gz) to $SAGE_ROOT/devel/sage",
    "created_at": "2012-05-27T18:33:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127052",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127053",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127054",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127055",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127056",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127057",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146457"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146458"
}
```
...
```json
{
    "body": "Changed reviewer from **Keshav Kini, Karl-Dieter Crisman, Fredrik Johansson, Burcin Erocal** to **Keshav Kini, Karl-Dieter Crisman, Fredrik Johansson, Burcin Erocal, Douglas McNeil**",
    "created_at": "2012-05-27T22:09:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127058",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127059",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    "body": "Changed reviewer from **Keshav Kini, Karl-Dieter Crisman, Fredrik Johansson, Burcin Erocal, Douglas McNeil** to **Keshav Kini, Karl-Dieter Crisman, Fredrik Johansson, Burcin Erocal, Douglas McNeil, William Stein**",
    "created_at": "2012-05-27T22:18:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127060",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146460"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127061",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127062",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127063",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127064",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11888#event-146466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11888#issuecomment-127065",
