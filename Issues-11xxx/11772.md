...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139688"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139692"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,3 +2,7 @@\n It should be easy to check that the rank is greater than min(nrows,ncols) and throw a ValueError with a meaningful message.\n \n A patch, which also fixes a similar small fly in random_subspaces_matrix, is attached.\n+\n+**Apply**:\n+1.  [attachment: trac_11772-v2.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772-v2.patch.gz)\n+2.  [attachment: trac_11772-doctests.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772-doctests.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139696"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,7 +2,8 @@\n It should be easy to check that the rank is greater than min(nrows,ncols) and throw a ValueError with a meaningful message.\n \n A patch, which also fixes a similar small fly in random_subspaces_matrix, is attached.\n+The cumulative patch incorporates more doctests, the fix for rank==1 problem described in the comments, and puts a cup on the number of iterations in various while loops, so that they fail meaningfully.\n \n **Apply**:\n-1.  [attachment: trac_11772-v2.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772-v2.patch.gz)\n-2.  [attachment: trac_11772-doctests.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772-doctests.patch.gz)\n+1.  [attachment: trac_11772.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772.patch.gz)\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139698"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139701"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,5 +5,5 @@\n The cumulative patch incorporates more doctests, the fix for rank==1 problem described in the comments, and puts a cup on the number of iterations in various while loops, so that they fail meaningfully.\n \n **Apply**:\n-1.  [attachment: trac_11772.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772.patch.gz)\n+1.  [attachment: trac_11772.2.patch.gz](https://github.com/sagemath/sage/files/ticket11772/trac_11772.2.patch.gz)\n \n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139702"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139703"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139704"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139707"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11772#issuecomment-125036",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11772",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11772#event-139709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11772#issuecomment-125037",
