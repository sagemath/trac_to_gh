...
```json
{
    ...
    "type": "issue",
    "updated_at": "2017-09-14T12:02:53Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130246"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130248"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130253"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11559_fix_Chow_group.2.patch.gz](https://github.com/sagemath/sage/files/ticket11559/trac_11559_fix_Chow_group.2.patch.gz)\n\nRebased for Sage-5.1.beta0",
...
```json
{
    "body": "**Attachment:** [trac_11559_hasattr_vertex_fc.patch.gz](https://github.com/sagemath/sage/files/ticket11559/trac_11559_hasattr_vertex_fc.patch.gz)",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -8,3 +8,8 @@\n Reordering this to first compare `self.vertex == other.vertex` speeds it up dramatically.\n \n Patch has some other fixes. Changes the chow group to use sparse matrices.\n+\n+Apply:\n+\n+- [attachment:trac_11559_fix_Chow_group.2.patch](https://github.com/sagemath/sage/files/ticket11559/trac_11559_fix_Chow_group.2.patch)\n+- [attachment:trac_11559_hasattr_vertex_fc.patch](https://github.com/sagemath/sage/files/ticket11559/trac_11559_hasattr_vertex_fc.patch)\n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130254"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130255"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -12,4 +12,5 @@\n Apply:\n \n - [attachment:trac_11559_fix_Chow_group.2.patch](https://github.com/sagemath/sage/files/ticket11559/trac_11559_fix_Chow_group.2.patch)\n+- [attachment:trac_11559_fixdoctest.patch](https://github.com/sagemath/sage/files/ticket11559/trac_11559_fixdoctest.patch)\n - [attachment:trac_11559_hasattr_vertex_fc.patch](https://github.com/sagemath/sage/files/ticket11559/trac_11559_hasattr_vertex_fc.patch)\n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130256"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130257"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130258"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130259"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130261"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130262"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130263"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130264"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130265"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130267"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130268"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130269"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130270"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130273"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130274"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130277"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130278"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11559#event-130279"
}
```
