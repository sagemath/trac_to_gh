...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110672",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110674",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n One of the patches at #9960 did a lot of clean-up to the file sage-spkg: quoting environment variables, replacing tabs with spaces, etc.  Since those changes were not related to the issue at #9960, I've split them off and put them here instead.  The main change of any content is to look at the file SPKG.txt rather than SAGE.txt when the \"-info\" flag is passed so sage-spkg.\n \n Apply:\n-1. [attachment:trac_11021-sage-spkg-cleanup-v2.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2.patch)\n+1. [attachment:trac_11021-sage-spkg-cleanup-v2.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2.patch) to scripts repo\n``````\n",
    "created_at": "2011-06-18T02:40:48Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110675",
    "user": "https://trac.sagemath.org/admin/accounts/users/ltw"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110676",
    "user": "https://trac.sagemath.org/admin/accounts/users/ltw"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110677",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110678",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110679",
    "user": "https://trac.sagemath.org/admin/accounts/users/ltw"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110680",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110681",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110682",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110683",
    "user": "https://trac.sagemath.org/admin/accounts/users/ltw"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110684",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86096"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110685",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110686",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch",
    "created_at": "2011-07-06T22:40:04Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch)\n\nSCRIPTS repo. Version 2 simply rebased to Sage 4.7.1.alpha4.",
    "created_at": "2011-07-06T22:40:04Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110687",
    "user": "https://github.com/nexttime"
}
```

**Attachment:** [trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch)
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,3 @@\n-One of the patches at #9960 did a lot of clean-up to the file sage-spkg: quoting environment variables, replacing tabs with spaces, etc.  Since those changes were not related to the issue at #9960, I've split them off and put them here instead.  The main change of any content is to look at the file SPKG.txt rather than SAGE.txt when the \"-info\" flag is passed so sage-spkg.\n+One of the patches at #9960 did a lot of clean-up to the file `sage-spkg`: quoting environment variables, replacing tabs with spaces, etc., also adding comments and TODOs.  Since those changes were not related to the issue at #9960, I've split them off and put them here instead.  The main change of any content is to look at the file `SPKG.txt` rather than `SAGE.txt` when the \"`-info`\" flag is passed so `sage-spkg` (through `sage -info ...`). Also, warnings and error messages are now redirected to `stderr`.\n \n-Apply:\n-1. [attachment:trac_11021-sage-spkg-cleanup-v2.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2.patch) to scripts repo\n+Apply **only** [attachment:trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch) to the **scripts repo**.\n``````\n",
    "created_at": "2011-07-06T22:52:54Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110688",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "**Changing work issues** from \"Rebase to 4.7.1.alpha4\" to \"\".",
    "created_at": "2011-07-06T22:52:54Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110689",
    "user": "https://github.com/nexttime"
}
```

**Changing work issues** from "Rebase to 4.7.1.alpha4" to "".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110690",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86098"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86099"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110691",
    "user": "https://github.com/nexttime"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11021-export_BUILD_in_sage-env.scripts.patch",
    "asset_url": "tarball://root/attachments/ticket11021/trac_11021-export_BUILD_in_sage-env.scripts.patch",
    "created_at": "2011-07-07T04:49:36Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/trac_11021-export_BUILD_in_sage-env.scripts.patch",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11021/trac_11021-support_and_document_sage_-info_in_sage-sage.scripts.patch",
    "created_at": "2011-07-07T04:49:36Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/trac_11021-support_and_document_sage_-info_in_sage-sage.scripts.patch",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11021-export_BUILD_in_sage-env.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-export_BUILD_in_sage-env.scripts.patch)\n\n**Attachment:** [trac_11021-support_and_document_sage_-info_in_sage-sage.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-support_and_document_sage_-info_in_sage-sage.scripts.patch)\n\nSCRIPTS repo. Implements/supports & documents \"sage -info ...\" in sage-sage; minor fixes. Based on Sage 4.7.1.alpha4.",
    "created_at": "2011-07-07T04:49:36Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110692",
    "user": "https://github.com/nexttime"
}
```

**Attachment:** [trac_11021-export_BUILD_in_sage-env.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-export_BUILD_in_sage-env.scripts.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11021#issuecomment-110693",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,3 +1,12 @@\n One of the patches at #9960 did a lot of clean-up to the file `sage-spkg`: quoting environment variables, replacing tabs with spaces, etc., also adding comments and TODOs.  Since those changes were not related to the issue at #9960, I've split them off and put them here instead.  The main change of any content is to look at the file `SPKG.txt` rather than `SAGE.txt` when the \"`-info`\" flag is passed so `sage-spkg` (through `sage -info ...`). Also, warnings and error messages are now redirected to `stderr`.\n \n-Apply **only** [attachment:trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch) to the **scripts repo**.\n+Apparently support for `sage -info ...` was removed at some point (or never existed); the patch to `sage-sage` fixes that.\n+\n+The patch to `sage-env` fixes a bug caused or enabled by #10469, which through the patch to `sage-spkg` now becomes more visible and potentially worse.\n+\n+Apply\n+1. [attachment:trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch)\n+2. [attachment:trac_11021-support_and_document_sage_-info_in_sage-sage.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-support_and_document_sage_-info_in_sage-sage.scripts.patch)\n+3. [attachment:trac_11021-export_BUILD_in_sage-env.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-export_BUILD_in_sage-env.scripts.patch)\n+to the **scripts repo**.\n+\n``````\n",
    "created_at": "2011-07-07T05:18:18Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86100"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86101"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11021/trac_11021-additional_changes_to_sage-spkg.scripts.patch",
    "created_at": "2011-07-07T13:13:24Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/trac_11021-additional_changes_to_sage-spkg.scripts.patch",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>\n**Attachment:** [trac_11021-additional_changes_to_sage-spkg.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-additional_changes_to_sage-spkg.scripts.patch)\n\nNew patch is up now.",
    "created_at": "2011-07-07T13:13:24Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -15,5 +15,6 @@\n \n Apply\n 1. [attachment:trac_11021-fix_sage.misc.install_package.sagelib.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-fix_sage.misc.install_package.sagelib.patch)\n+2. [attachment:trac_11021-sage-library-referee.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-library-referee.patch)\n to the **Sage library**.\n \n``````\n",
...
```json
{
    "body": "<a id='comment:24'></a>\nI'm utterly tired of the message \"Warning: Attempted to overwrite SAGE_ROOT environment variable\".  Can we apply this patch to `sage-env`:\n\n```diff\ndiff --git a/sage-env b/sage-env\n--- a/sage-env\n+++ b/sage-env\n@@ -50,7 +50,7 @@ if [ \"$SAGE_ROOT\" = \"\" ]; then\n else\n     if [ -f \"$SAGE_ROOT\"/sage -a -d \"$SAGE_ROOT\"/spkg ]; then\n         # SAGE_ROOT points to a sage installation as expected\n-        if [ \"$SAGE_ROOT\" != \"$GUESSED_SAGE_ROOT\" ]; then\n+        if [ -n \"$GUESSED_SAGE_ROOT\" -a \"$SAGE_ROOT\" != \"$GUESSED_SAGE_ROOT\" ]; then\n             echo \"Warning: Attempted to overwrite SAGE_ROOT environment variable\"\n         fi\n     else\n```\nThat will eliminate some of its occurrences.\n\nMeanwhile, I'm happy with [and [attachment:trac_11021-export_BUILD_in_sage-env.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-export_BUILD_in_sage-env.scripts.patch).  [attachment:trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-sage-spkg-cleanup-v2-rebased_to_4.7.1.alpha4.patch) also looks good, and anyway I think it's just a rebased version of a patch which already had a positive review.  This leaves [attachment:trac_11021-additional_changes_to_sage-spkg.scripts.patch](https://github.com/sagemath/sage/files/ticket11021/644de11c2a26632bf6570f3d6f5fa706.patch](https://github.com/sagemath/sage/files/ticket11021/4affb6437113ccd6c836442ccd4a3c11.patch)).  I'll try to work on that, and anyone else who wants to is welcome.",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86102"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86103"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86104"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86105"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11021/trac_11021-fix_sage.misc.install_package.sagelib.patch",
    "created_at": "2012-08-29T19:38:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/trac_11021-fix_sage.misc.install_package.sagelib.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11021-fix_sage.misc.install_package.sagelib.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-fix_sage.misc.install_package.sagelib.patch)\n\nPatch for the Sage library",
    "created_at": "2012-08-29T19:38:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
...
**Attachment:** [trac_11021-fix_sage.misc.install_package.sagelib.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-fix_sage.misc.install_package.sagelib.patch)
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11021/11021_spkg.patch",
    "created_at": "2012-08-30T06:52:51Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/11021_spkg.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Attachment:** [11021_spkg.patch](https://github.com/sagemath/sage/files/ticket11021/11021_spkg.patch)",
    "created_at": "2012-08-30T06:52:51Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
...
**Attachment:** [11021_spkg.patch](https://github.com/sagemath/sage/files/ticket11021/11021_spkg.patch)
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,6 +1,7 @@\n **Apply**\n 1. [attachment:trac_11021-fix_sage.misc.install_package.sagelib.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-fix_sage.misc.install_package.sagelib.patch)\n to the **Sage library**.\n+1. [attachment:11021_spkg.patch](https://github.com/sagemath/sage/files/ticket11021/11021_spkg.patch) to `SAGE_ROOT`.\n \n ---\n \n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86106"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11021/trac_11021-root.patch",
    "created_at": "2012-09-03T17:11:30Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11021/trac_11021-root.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11021-root.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-root.patch)\n\nroot repo",
    "created_at": "2012-09-03T17:11:30Z",
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_comment",
...
**Attachment:** [trac_11021-root.patch](https://github.com/sagemath/sage/files/ticket11021/trac_11021-root.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11021",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11021#event-86108"
}
```
