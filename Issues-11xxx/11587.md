...
```json
{
    "body": "Attachment [trac_11587.patch](tarball://root/attachments/some-uuid/ticket11587/trac_11587.patch) by boothby created at 2011-08-25 08:51:12\n\nlooks good, works good",
...
```json
{
    "body": "Attachment [trac_11587-rmhardcode.proper.patch](tarball://root/attachments/some-uuid/ticket11587/trac_11587-rmhardcode.proper.patch) by @nexttime created at 2011-09-28 17:51:13\n\nI've attached one replacement patch which just adds the \"`# User ...`\" line the original patch is lacking.",
...
```json
{
    "body": "Attachment [trac_11587-fix_speed_regression.patch](tarball://root/attachments/some-uuid/ticket11587/trac_11587-fix_speed_regression.patch) by @loefflerd created at 2011-10-16 18:41:50",
