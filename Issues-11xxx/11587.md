...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136923"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136930"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136931"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136939"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -23,6 +23,8 @@\n \n Apply [attachment: trac_11587-docfixes.patch.gz](https://github.com/sagemath/sage/files/ticket11587/trac_11587-docfixes.patch.gz) to the Sage library.\n \n+Apply [attachment: trac_11587-rmhardcode.patch.gz](https://github.com/sagemath/sage/files/ticket11587/trac_11587-rmhardcode.patch.gz) to the Sage library.\n+\n Apply [attachment: trac_11587-depfix.patch.gz](https://github.com/sagemath/sage/files/ticket11587/trac_11587-depfix.patch.gz) to Sage root.\n \n ---\n``````\n",
    "created_at": "2011-09-15T22:37:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11587",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11587",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136941"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136942"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136943"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11587",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136948"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136949"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11587#event-136950"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11587#issuecomment-121060",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11587#issuecomment-121061",
    "user": "https://github.com/JohnCremona"
}
```
