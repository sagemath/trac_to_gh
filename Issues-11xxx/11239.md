...
```json
{
    "body": "<a id='comment:18'></a>\nAnyway, the coercion framework is already called in the previous test so efficiency is already potentially screwed up.\n\nI've just made a git branch from the patch.\nOtherwise looks good to me, positive review.\n\n---\nNew commits:\n|                                                                                                         |                                                            |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[236effb](http://git.sagemath.org/sage.git/commit/?id=236effb)|`Trac 11239: fix coercion of polynomials over finite fields`|\n|[e46d9bf](http://git.sagemath.org/sage.git/commit/?id=e46d9bf)|`Trac 11239: fix coercion of polynomials over finite fields, first step`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[dbe7209](http://git.sagemath.org/sage.git/commit/?id=dbe7209abde689a03b288511db1aa8b6fa991e9c)|`remove unused declaration from polynomial_ring_homomorphism.pxd`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                          |                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[61c565b](http://git.sagemath.org/sage.git/commit/?id=61c565b7beccc1466bdac4d17fab755cbf5f9c9c)|`distinguish between sparse and dense in PolynomialRingHomomorphism_from_base`|",
    "created_at": "2014-03-03T15:14:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11239",
    "type": "issue_comment",
