...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131447"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131453"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,3 +22,6 @@\n \n NotImplementedError:\n ```\n+\n+Apply: [attachment: trac_11239-polynomial_coercion_preliminary.patch.gz](https://github.com/sagemath/sage/files/ticket11239/trac_11239-polynomial_coercion_preliminary.patch.gz)\n+\n``````\n",
    "created_at": "2013-08-05T17:56:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11239",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -23,5 +23,5 @@\n NotImplementedError:\n ```\n \n-Apply: [attachment: trac_11239-polynomial_coercion_preliminary.patch.gz](https://github.com/sagemath/sage/files/ticket11239/trac_11239-polynomial_coercion_preliminary.patch.gz)\n+Apply: [[attachment: trac_11239-polynomial_zz_pex.patch.gz](https://github.com/sagemath/sage/files/ticket11239/trac_11239-polynomial_zz_pex.patch.gz)(https://github.com/sagemath/sage/files/ticket11239/06d94ee1685e8452f888926e22f481b5.gz)\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131454"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131455"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131456"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131457"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131461"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131462"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11239#issuecomment-114453",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11239#issuecomment-114454",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11239",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11239#event-131477"
}
```
