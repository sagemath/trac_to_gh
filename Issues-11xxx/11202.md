...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11202#issuecomment-113895",
    "user": "https://github.com/sagetrac-ltw"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11202#issuecomment-113896",
    "user": "https://github.com/sagetrac-ltw"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11202#event-135424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11202#event-135425"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11202#event-135426"
}
```
