...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160951",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I see your point about bots, though afaik that would only affect the sage patch buildbot. I'll cc Robert, maybe he can tell us how his bot checks freshness.\n\nOrdinary users don't download patches from trac on a regular basis, thats why I don't think there is any bandwidth issue. The problem with the `~/.wgetrc` bandaid is that you often don't know whether you are behind a transparent proxy. Sage developers regularly work away from their home institutions / in coffee shops, and who knows what is being cached.",
    "created_at": "2011-09-18T15:54:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160952",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>I see your point about bots, though afaik that would only affect the sage patch buildbot. I'll cc Robert, maybe he can tell us how his bot checks freshness.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160953",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>P.S.: The best way to bypass proxies or disable caching is to use HTTPS; unfortunately Sage's trac doesn't support it...",
    "created_at": "2011-09-18T17:16:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160954",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>P.S.: The best way to bypass proxies or disable caching is to use HTTPS; unfortunately Sage's trac doesn't support it...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160955",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160956",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160957",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I looked at the squid logs today and it confirms what I said: Squid considers the `.../raw-attachment/...` resources to be always fresh and returns the cached values without revalidating them.",
    "created_at": "2011-09-19T11:50:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160959",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>I looked at the squid logs today and it confirms what I said: Squid considers the `.../raw-attachment/...` resources to be always fresh and returns the cached values without revalidating them.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160963",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160964",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160965",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31135"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31136"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31137"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31138"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31139"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Maybe this can be closed, now that we have switched to git ?",
    "created_at": "2014-06-17T12:02:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160967",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:19'></a>Maybe this can be closed, now that we have switched to git ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160968",
...
```json
{
    "body": "<a id='comment:20'></a>I agree, gave it positive review so Volker can close it.",
    "created_at": "2014-06-17T13:23:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160969",
    "user": "https://github.com/koffie"
}
```

<a id='comment:20'></a>I agree, gave it positive review so Volker can close it.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31140"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31141"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Well, while the switch to git alleviates the situation, it doesn't mean we no longer attach files to trac tickets.  Anyway, those perhaps get rarely updated in-place.",
    "created_at": "2014-06-17T13:33:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160970",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>Well, while the switch to git alleviates the situation, it doesn't mean we no longer attach files to trac tickets.  Anyway, those perhaps get rarely updated in-place.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11813#issuecomment-160971",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11813",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11813#event-31142"
}
```
