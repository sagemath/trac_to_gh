...
```json
{
    "body": "<a id='comment:1'></a>The patch works exactly as it is announced in the ticket description. One can now (on top of sage-4.7.2.alpha2) do:\n\n```\nsage: C = Rings()\nsage: from sage.misc.sageinspect import sage_getsource\nsage: print sage_getsource(C.parent_class)  #indirect doctest\nclass ParentMethods:\n    def is_field(self):\n        raise NotImplementedError\n<BLANKLINE>\n    def bracket(self, x, y):\n...\n```\n\nUnfortunately,\n\n```\nsage: P = JackPolynomialsP(QQ); P.rename(\"JackP\")\nsage: P.element_class??\n```\ndoes not work yet. So, the search for definitions should also include the `__base__` attribute of a class.",
    "created_at": "2011-09-01T10:08:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159918",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>The patch works exactly as it is announced in the ticket description. One can now (on top of sage-4.7.2.alpha2) do:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159919",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159920",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Perhaps it would work to get it in sage-4.7.2, not only sage-5.0?",
    "created_at": "2011-09-01T10:53:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159922",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>Perhaps it would work to get it in sage-4.7.2, not only sage-5.0?
...
```json
{
    "body": "<a id='comment:4'></a>I just found one thing that doesn't work, yet.\n\nWith\n\n```\nsage: C = Rings()\nsage: HC = C.hom_category()\n```\nneither `HC??` nor `edit(HC,'vim')` do what one would wish.",
    "created_at": "2011-09-01T11:42:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159923",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>I just found one thing that doesn't work, yet.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159924",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159925",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Introspection of `Rings().hom_category()` works and is doctested with the updated patch. Back to \"needs review\".",
    "created_at": "2011-09-01T12:05:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159926",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Introspection of `Rings().hom_category()` works and is doctested with the updated patch. Back to "needs review".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159927",
...
```json
{
    "body": "<a id='comment:9'></a>Fails to apply to vanilla sage-4.7.2.alpha2. Dependencies?",
    "created_at": "2011-09-19T09:37:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159930",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>Fails to apply to vanilla sage-4.7.2.alpha2. Dependencies?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159931",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Sorry, you are right. It does apply. Must have forgotten to pop all patches %-)",
    "created_at": "2011-09-19T10:47:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159933",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>Sorry, you are right. It does apply. Must have forgotten to pop all patches %-)
...
```json
{
    "body": "<a id='comment:13'></a>What is the patchbot complaining about? It states that it fails to apply, but I find it is fine with 4.7.2-alpha3-prerelease.",
    "created_at": "2011-09-30T08:02:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159934",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>What is the patchbot complaining about? It states that it fails to apply, but I find it is fine with 4.7.2-alpha3-prerelease.
...
```json
{
    "body": "<a id='comment:14'></a>Any reviewer for that ticket? I think introspection is a nice thing to have in more generality...",
    "created_at": "2011-10-26T19:08:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159935",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:14'></a>Any reviewer for that ticket? I think introspection is a nice thing to have in more generality...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159936",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Make it independent of #11900\"",
    "created_at": "2011-10-29T06:35:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159937",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Make it independent of #11900"
...
```json
{
    "body": "<a id='comment:15'></a>It turns out that a combination of this ticket with #11900 yields a problem. I'll try to rewrite the patch here, so that it doesn't matter whether #11900 is applied or not.",
    "created_at": "2011-10-29T06:35:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159938",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>It turns out that a combination of this ticket with #11900 yields a problem. I'll try to rewrite the patch here, so that it doesn't matter whether #11900 is applied or not.
...
```json
{
    "body": "<a id='comment:16'></a>Done! Using the new patch, the doc tests of sage/misc/sageinspect.py pass regardless whether #11900 is applied or not.",
    "created_at": "2011-10-29T07:25:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159939",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>Done! Using the new patch, the doc tests of sage/misc/sageinspect.py pass regardless whether #11900 is applied or not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159940",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159941",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>If #12876 is applied then one of the tests introduced here gives an unexpected result: We test against a particular code snipped, that changes with #12876.\n\nHence, I'll rewrite the test so that it expects only those parts of the code that do not change.",
    "created_at": "2012-05-02T19:24:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159943",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>If #12876 is applied then one of the tests introduced here gives an unexpected result: We test against a particular code snipped, that changes with #12876.
...
```json
{
    "body": "<a id='comment:19'></a>With the second patch, the doctest becomes independent of whether or not #12876 is applied.\n\nApply trac11768_source_of_dynamic_class.patch trac11768_docfix.patch",
    "created_at": "2012-05-03T10:04:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159944",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:19'></a>With the second patch, the doctest becomes independent of whether or not #12876 is applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159945",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>By the way: feel free to steal this little fix which I did take the time not push through ...:\n\nhttp://combinat.sagemath.org/patches/file/tip/sage_inspect_for_classes-nt.patch",
    "created_at": "2012-05-04T20:22:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159947",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:21'></a>By the way: feel free to steal this little fix which I did take the time not push through ...:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159948",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159949",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Any review for better access to source code in the category framework?",
    "created_at": "2012-08-13T13:08:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159950",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:24'></a>Any review for better access to source code in the category framework?
...
```json
{
    "body": "<a id='comment:25'></a>Looks good. You might want to pick classes for doctests that are not moving targets in the combinat queue, though ;-)  How about `sage/structure/sage_object.py` or something else thats buried deep down and unlikely to change.",
    "created_at": "2012-11-27T10:45:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159951",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:25'></a>Looks good. You might want to pick classes for doctests that are not moving targets in the combinat queue, though ;-)  How about `sage/structure/sage_object.py` or something else thats buried deep down and unlikely to change.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159952",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>To my surprise, the patch does *not* solve the introspection problem mentioned in my previous post, even if Cython code is used.\n\nI think to make it work interactively should be moved on a different ticket. So, for now, I suggest to create a test class in sage.misc.sageinspect.",
    "created_at": "2012-11-27T16:46:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159955",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:29'></a>To my surprise, the patch does *not* solve the introspection problem mentioned in my previous post, even if Cython code is used.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159957",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Replying to [nthiery](#comment%3A31):\n> Thanks for your work on finalizing this. What about putting the example in a new separate file.\n> What about putting the test class in a separate file like sage.misc.sageinspect_test.py that would only be imported in the doctest?\n\n\nVolker and Florent, do you agree with Nicolas that a separate file would be better?",
    "created_at": "2012-11-28T10:16:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159959",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:32'></a>Replying to [nthiery](#comment%3A31):
> Thanks for your work on finalizing this. What about putting the example in a new separate file.
> What about putting the test class in a separate file like sage.misc.sageinspect_test.py that would only be imported in the doctest?
...
```json
{
    "body": "<a id='comment:33'></a>If you can't find an appropriate class to test it with then I'm fine with an extra file. I would suggest something in `sage/tests`, though. Maybe `sage/tests/sageinspect.py`. The file can also test itself so it would really be a test (ooh my head hurts now).",
    "created_at": "2012-11-28T10:41:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159960",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:33'></a>If you can't find an appropriate class to test it with then I'm fine with an extra file. I would suggest something in `sage/tests`, though. Maybe `sage/tests/sageinspect.py`. The file can also test itself so it would really be a test (ooh my head hurts now).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159961",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159962",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"import location for nested test class\"",
    "created_at": "2012-11-30T14:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159964",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "import location for nested test class"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159965",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Oops, I just notice that in one test I still try to import the testclass from sage.structure.parent. Needs a rather trivial fix...",
    "created_at": "2012-11-30T14:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159966",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:37'></a>Oops, I just notice that in one test I still try to import the testclass from sage.structure.parent. Needs a rather trivial fix...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159967",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159968",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159969",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Should now be fixed!\n\nApply trac11768_source_of_dynamic_class.patch",
    "created_at": "2012-11-30T14:50:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159970",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:38'></a>Should now be fixed!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159971",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159972",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159973",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159974",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11768#issuecomment-159975",
    "user": "https://github.com/jdemeyer"
}
```
