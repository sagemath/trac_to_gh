...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125903",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>As I've just discovered a lot of wonderfull point counting methods have been implemented in PARI using the new finite fields structures.\nThis includes SEA over non prime fields and Harley's algo over binary fields and (although I've not tested them yet) will without doubt make this ticket and #11448 completely disgusting and useless.",
    "created_at": "2012-09-06T20:41:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125904",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>As I've just discovered a lot of wonderfull point counting methods have been implemented in PARI using the new finite fields structures.
This includes SEA over non prime fields and Harley's algo over binary fields and (although I've not tested them yet) will without doubt make this ticket and #11448 completely disgusting and useless.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30216"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30217"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30218"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30219"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30220"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30221"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30222"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30223"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30224"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Superseded by #16931 and new PARI/GP functionalities.",
    "created_at": "2016-08-17T07:55:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125907",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:9'></a>Superseded by #16931 and new PARI/GP functionalities.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125908",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125909",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11548#event-30225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125910",
...
```json
{
    "body": "<a id='comment:11'></a>Determined to be invalid/duplicate/wontfix (closing as \"wontfix\" as a catch-all resolution).",
    "created_at": "2016-08-30T13:32:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11548#issuecomment-125911",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>Determined to be invalid/duplicate/wontfix (closing as "wontfix" as a catch-all resolution).
