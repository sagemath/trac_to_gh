...
{
    "assignees": [],
    "body": "Wraps the  `schur()` function from `SciPy`.\n\n**Apply:**\n1. [attachment: trac_11027-schur-decomposition-v3.patch.gz](https://github.com/sagemath/sage/files/ticket11027/trac_11027-schur-decomposition-v3.patch.gz)\n2. [attachment: trac_11027-schur-decomposition-doctest-v2.patch.gz](https://github.com/sagemath/sage/files/ticket11027/trac_11027-schur-decomposition-doctest-v2.patch.gz)\n\n\nAssignee: **@jasongrout, @williamstein**\n\nCC:  @jasongrout @kcrisman\n\nAuthor: **Rob Beezer**\n\nReviewer: **Martin Raum, John Palmieri, Jeroen Demeyer**\n\nMerged: **sage-4.7.1.alpha3**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/11027_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129220"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129221"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129225"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129226"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11027",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129233"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,6 @@\n Wraps the  `schur()` function from `SciPy`.\n \n-Apply trac_11027-schur-decomposition-v2.patch\n+**Apply:**\n+1. [attachment: trac_11027-schur-decomposition-v2.patch.gz](https://github.com/sagemath/sage/files/ticket11027/trac_11027-schur-decomposition-v2.patch.gz)\n+2. [attachment: trac_11027-schur-decomposition-doctest.patch.gz](https://github.com/sagemath/sage/files/ticket11027/trac_11027-schur-decomposition-doctest.patch.gz)\n+\n``````\n",
    "created_at": "2011-04-12T05:11:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11027",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129235"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129239"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129240"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129241"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11027",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129244"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129246"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129248"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129250"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11027#issuecomment-110950",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11027",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11027#event-129252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11027#issuecomment-110951",
    "user": "https://github.com/rbeezer"
}
```
