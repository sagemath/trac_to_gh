...
Attachment [trac_11027-schur-decomposition.patch](tarball://root/attachments/some-uuid/ticket11027/trac_11027-schur-decomposition.patch) by mraum created at 2011-03-26 00:57:57
...
Attachment [trac_11027-schur-decomposition-v2.patch](tarball://root/attachments/some-uuid/ticket11027/trac_11027-schur-decomposition-v2.patch) by @rbeezer created at 2011-03-31 19:03:58
...
```json
{
    "body": "Unmerging this in sage-4.7.alpha5...",
    "created_at": "2011-04-11T19:13:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11027",
    "type": "issue_comment",
...
```json
{
    "body": "I've replaced the \"doctest\" patch with a new one.  With two lines now.",
...
```json
{
    "body": "This now works on Solaris, OS X, sage.math.",
    "created_at": "2011-04-13T18:48:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11027",
    "type": "issue_comment",
...
```json
{
    "body": "Okay, I have looked at [attachment:trac_11027-schur-decomposition-doctest-v2.patch] and it makes sense.  In fact, the new patch is cleaner than the old one.  Since the main patch is already positively reviewed, this gives... positive_review!",
