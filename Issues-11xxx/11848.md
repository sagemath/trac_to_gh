# Issue 11848: bug in zero_matrix rewrite in matrix_space.py
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11848#event-31879"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11848#event-31880"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11848#event-31881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11848",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11848#event-31882"
}
```
