...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11657#event-142720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11657#event-142721"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11657#event-142722"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,3 +11,6 @@\n ```\n \n I didn't realize that the special case of the zero vector is incredibly slow for the `vector` function.  This needs to be fixed. \n+\n+**Apply**:\n+1.  [attachment: trac_11657-zero-vector-speedup.patch.gz](https://github.com/sagemath/sage/files/ticket11657/trac_11657-zero-vector-speedup.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11657#issuecomment-122291",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11657#issuecomment-122292",
