...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125576",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125577",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -2,6 +2,10 @@\n the tracebacks are not very informative: they refer to <string> instead\n of to the file name, and give no line numbers or code snippets. This\n makes it hard to find out where the error is.\n+\n+The patch fixes this for attach, but not for load (because of efficiency reasons).\n+\n+Apply [attachment:trac_11812-traceback_attach.patch](https://github.com/sagemath/sage/files/ticket11812/trac_11812-traceback_attach.patch)\n \n Example:\n \n@@ -55,40 +59,6 @@\n called from functions named \"foo\" for a line that could cause a division\n by zero... \n \n-The cause of the problem was pinpointed by Conrado PLG and he gives the following fix:\n-\n-Search preparser.py for `elif fpath.endswith('.sage')` and change to the code below:\n-\n-```\n-    elif fpath.endswith('.sage'):\n-        s = preparse_file(open(fpath).read())\n-        f = open(fpath + '.py', 'w')\n-        f.write(s)\n-        f.close()\n-        execfile(fpath + '.py', globals) \n-```\n-\n-After that change, the traceback contains the information that I want:\n-\n-```\n-/Users/marcostreng/tmp/foo.sage.py in foo()\n-     10 def foo():\n-     11      # lots of lines of code\n-     12      a = Bar()\n----> 13      a.function_with_common_name()\n-     14      # lots of lines of code\n-\n-/Users/marcostreng/tmp/foo.sage.py in function_with_common_name(self)\n-      3      def function_with_common_name(self):\n-      4          # lots of lines of code\n-----> 5          _sage_const_1 /_sage_const_0 \n-      6          # lots of lines of code\n-      7 \n-```\n-\n-For an explanation of why this works, and for a discussion of what would be the best way to fix this, see\n+More details:\n [http://groups.google.com/group/sage-devel/browse_thread/thread/761f69944e21efd4](http://groups.google.com/group/sage-devel/browse_thread/thread/761f69944e21efd4)\n \n-Of course a patch should also include a doctest to prevent all this from happening again.\n-\n-\n``````\n",
    "created_at": "2011-09-22T14:35:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125578",
    "user": "https://github.com/mstreng"
}
```
...
archive/attachments_015673.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11812-traceback_attach.patch",
    "asset_url": "tarball://root/attachments/ticket11812/trac_11812-traceback_attach.patch",
    "created_at": "2011-09-22T14:35:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11812/trac_11812-traceback_attach.patch",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_11812-traceback_attach.patch](https://github.com/sagemath/sage/files/ticket11812/trac_11812-traceback_attach.patch) by @mstreng created at 2011-09-22 14:35:50",
    "created_at": "2011-09-22T14:35:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125579",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125580",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94675"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94676"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125581",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125582",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,7 +5,9 @@\n \n The patch fixes this for attach, but not for load (because of efficiency reasons).\n \n-Apply [attachment:trac_11812-traceback_attach.patch](https://github.com/sagemath/sage/files/ticket11812/trac_11812-traceback_attach.patch)\n+Apply [attachment:11812.patch](https://github.com/sagemath/sage/files/ticket11812/11812.patch)\n+\n+---\n \n Example:\n \n``````\n",
    "created_at": "2011-10-07T14:56:00Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125583",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94678"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94679"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125584",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125585",
    "user": "https://github.com/mstreng"
}
```
...
archive/attachments_015674.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "11812.patch",
    "asset_url": "tarball://root/attachments/ticket11812/11812.patch",
    "created_at": "2011-10-10T10:54:17Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11812/11812.patch",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125587",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94680"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125588",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125589",
    "user": "https://github.com/mstreng"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "11812.2.patch",
    "asset_url": "tarball://root/attachments/ticket11812/11812.2.patch",
    "created_at": "2011-10-16T13:45:03Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11812/11812.2.patch",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "Attachment [11812.2.patch](https://github.com/sagemath/sage/files/ticket11812/11812.2.patch) by @mstreng created at 2011-10-16 13:45:03",
    "created_at": "2011-10-16T13:45:03Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125590",
    "user": "https://github.com/mstreng"
}
```

Attachment [11812.2.patch](https://github.com/sagemath/sage/files/ticket11812/11812.2.patch) by @mstreng created at 2011-10-16 13:45:03
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125591",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125592",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125593",
    "user": "https://github.com/mstreng"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "11812.3.patch",
    "asset_url": "tarball://root/attachments/ticket11812/11812.3.patch",
    "created_at": "2011-10-16T16:25:43Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11812/11812.3.patch",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>\nAttachment [11812.3.patch](https://github.com/sagemath/sage/files/ticket11812/11812.3.patch) by @mstreng created at 2011-10-16 16:25:43\n\nAll tests pass!!",
    "created_at": "2011-10-16T16:25:43Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125594",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94682"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94683"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94684"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125595",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125596",
    "user": "https://trac.sagemath.org/admin/accounts/users/johanbosman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94686"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125597",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>\nReplying to [johanbosman](#comment%3A14):\n\nThanks!",
    "created_at": "2011-10-18T08:57:04Z",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125598",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125599",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94688"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94689"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125600",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125601",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-94691"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125602",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125603",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125604",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125605",
    "user": "https://github.com/mstreng"
}
```
