...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145206"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125627",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125628",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,6 +2,10 @@\n the tracebacks are not very informative: they refer to <string> instead\n of to the file name, and give no line numbers or code snippets. This\n makes it hard to find out where the error is.\n+\n+The patch fixes this for attach, but not for load (because of efficiency reasons).\n+\n+Apply [attachment: trac_11812-traceback_attach.patch.gz](https://github.com/sagemath/sage/files/ticket11812/trac_11812-traceback_attach.patch.gz)\n \n Example:\n \n@@ -55,40 +59,6 @@\n called from functions named \"foo\" for a line that could cause a division\n by zero... \n \n-The cause of the problem was pinpointed by Conrado PLG and he gives the following fix:\n-\n-Search preparser.py for `elif fpath.endswith('.sage')` and change to the code below:\n-\n-```\n-    elif fpath.endswith('.sage'):\n-        s = preparse_file(open(fpath).read())\n-        f = open(fpath + '.py', 'w')\n-        f.write(s)\n-        f.close()\n-        execfile(fpath + '.py', globals) \n-```\n-\n-After that change, the traceback contains the information that I want:\n-\n-```\n-/Users/marcostreng/tmp/foo.sage.py in foo()\n-     10 def foo():\n-     11      # lots of lines of code\n-     12      a = Bar()\n----> 13      a.function_with_common_name()\n-     14      # lots of lines of code\n-\n-/Users/marcostreng/tmp/foo.sage.py in function_with_common_name(self)\n-      3      def function_with_common_name(self):\n-      4          # lots of lines of code\n-----> 5          _sage_const_1 /_sage_const_0 \n-      6          # lots of lines of code\n-      7 \n-```\n-\n-For an explanation of why this works, and for a discussion of what would be the best way to fix this, see\n+More details:\n [http://groups.google.com/group/sage-devel/browse_thread/thread/761f69944e21efd4](http://groups.google.com/group/sage-devel/browse_thread/thread/761f69944e21efd4)\n \n-Of course a patch should also include a doctest to prevent all this from happening again.\n-\n-\n``````\n",
    "created_at": "2011-09-22T14:35:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125629",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125630",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125631",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125632",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125633",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,7 +5,9 @@\n \n The patch fixes this for attach, but not for load (because of efficiency reasons).\n \n-Apply [attachment: trac_11812-traceback_attach.patch.gz](https://github.com/sagemath/sage/files/ticket11812/trac_11812-traceback_attach.patch.gz)\n+Apply [attachment: 11812.patch.gz](https://github.com/sagemath/sage/files/ticket11812/11812.patch.gz)\n+\n+---\n \n Example:\n \n``````\n",
    "created_at": "2011-10-07T14:56:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125634",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125635",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125636",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125638",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125639",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125640",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125641",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125642",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125643",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125644",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125645",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125647",
    "user": "https://github.com/sagetrac-johanbosman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145220"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145221"
}
```
...
```json
{
    "body": "Changed keywords from **** to **load attach traceback**",
    "created_at": "2011-10-18T08:57:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125648",
    "user": "https://github.com/mstreng"
}
```

Changed keywords from **** to **load attach traceback**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125649",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125650",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145223"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145224"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125651",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125652",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11812#event-145225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125653",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125654",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125655",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11812#issuecomment-125656",
    "user": "https://github.com/mstreng"
}
```
