...
```json
{
    "body": "<a id='comment:1'></a>Haha. First step is perhaps to create a symbolic link from `plat-linux3` to `plat-linux2`. And then overwrite `sys.platform` for the moment for other packages... ;-)",
    "created_at": "2011-07-24T05:08:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156149",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Haha. First step is perhaps to create a symbolic link from `plat-linux3` to `plat-linux2`. And then overwrite `sys.platform` for the moment for other packages... ;-)
...
```json
{
    "body": "<a id='comment:3'></a>Well, the impact seems to be less hard, as `sys.platform` appears to be a constant of the Python installation determined at *compile time*.\n\nSo any Python installation / binary package built on a 2.x kernel should work seamlessly on a 3.x one.\n\nStill funny to read the discussion at the Python BTS.",
    "created_at": "2011-07-24T08:05:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156151",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Well, the impact seems to be less hard, as `sys.platform` appears to be a constant of the Python installation determined at *compile time*.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156152",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This is now \"fixed\" by upstream by only using `linux2`, even on Linux 3.",
    "created_at": "2013-05-16T07:41:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156153",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>This is now "fixed" by upstream by only using `linux2`, even on Linux 3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156154",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11619#event-30477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156155",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11619#issuecomment-156156",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11619#event-30478"
}
```
