...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113306",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113307",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11186#event-87403"
}
```
...
```json
{
    "body": "Attachment [11186_missing_parenthesis_multi_singular.patch](https://github.com/sagemath/sage/files/ticket11186/11186_missing_parenthesis_multi_singular.patch) by @johanrosenkilde created at 2011-04-13 14:25:29\n\nPatches sage.libs.singular.polynomial.pyx",
    "created_at": "2011-04-13T14:25:29Z",
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113308",
    "user": "https://github.com/johanrosenkilde"
}
```

Attachment [11186_missing_parenthesis_multi_singular.patch](https://github.com/sagemath/sage/files/ticket11186/11186_missing_parenthesis_multi_singular.patch) by @johanrosenkilde created at 2011-04-13 14:25:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113309",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11186#event-87404"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11186#event-87405"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113310",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113311",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11186#event-87406"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113312",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11186#event-87407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11186#event-87408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11186#issuecomment-113313",
    "user": "https://github.com/jdemeyer"
}
```
