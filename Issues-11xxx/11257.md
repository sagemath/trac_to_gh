...
archive/attachments_015273.json:
```json
{
...
```json
{
    "body": "<a id='comment:17'></a>\n**Attachment:** [trac_11257_avoid_coercion_power_zero-nb.patch](https://github.com/sagemath/sage/files/ticket11257/trac_11257_avoid_coercion_power_zero-nb.patch)\n\nI just added a one method for EtaGroup... With the categories for all(more) ring from Simon, all tests should pass...",
    "created_at": "2012-02-07T02:10:44Z",
    "issue": "https://github.com/sagemath/sage/issues/11257",
    "type": "issue_comment",
