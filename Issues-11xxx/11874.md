...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146150"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146152"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146154"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146155"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146156"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146159"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146160"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146161"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,9 @@\n The version of Twisted currently used in Sage is old and obsolete; moreover it is buggy, as our extensive tests involving running  labs for 120 students show. The crashes of the notebook webapp go away after the upgrade to twisted 11.\n \n-The new package is at [http://sage.math.washington.edu/home/jason/twisted-11.0.0.spkg](http://sage.math.washington.edu/home/jason/twisted-11.0.0.spkg)\n+The twisted package is now included in the flask sagenb (#11080), so this ticket just has the patch to remove the twisted spkg.\n \n-This belongs to the new Sage notebook at [http://code.google.com/r/jasongrout-flask-sagenb/](http://code.google.com/r/jasongrout-flask-sagenb/)\n+See http://groups.google.com/group/sage-devel/browse_thread/thread/98c53d17166da1b9 for the sage-devel vote.\n+\n+**apply**: [attachment: trac-11874-remove-twisted.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.patch.gz) to the sage root repository, and remove the twisted spkg from the standard spkgs.\n+\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146162"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146163"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146164"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146165"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146166"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146168"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,6 +4,4 @@\n \n See http://groups.google.com/group/sage-devel/browse_thread/thread/98c53d17166da1b9 for the sage-devel vote.\n \n-**apply**: [attachment: trac-11874-remove-twisted.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.patch.gz) to the sage root repository, and remove the twisted spkg from the standard spkgs.\n-\n-\n+**apply**: [attachment: trac-11874-remove-twisted.3.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.3.patch.gz) to the sage root repository, and remove the twisted spkg from the standard spkgs.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146169"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,4 +4,4 @@\n \n See http://groups.google.com/group/sage-devel/browse_thread/thread/98c53d17166da1b9 for the sage-devel vote.\n \n-**apply**: [attachment: trac-11874-remove-twisted.3.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.3.patch.gz) to the sage root repository, and remove the twisted spkg from the standard spkgs.\n+**apply**: [attachment: trac-11874-remove-twisted.2.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.2.patch.gz) to the sage root repository, and remove the twisted spkg from the standard spkgs.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146172"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146173"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146175"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,4 +4,7 @@\n \n See http://groups.google.com/group/sage-devel/browse_thread/thread/98c53d17166da1b9 for the sage-devel vote.\n \n-**apply**: [attachment: trac-11874-remove-twisted.3.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.3.patch.gz) to the sage root repository, and **remove** the **twisted** spkg from the standard spkgs.\n+**apply**: [attachment: trac-11874-remove-twisted.3.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.3.patch.gz) to the sage root repository,  **remove** the **twisted** spkg from the standard spkgs, and\n+**replace** the **sage-***** spkg in  the standard spkgs by [this one](http://web.spms.ntu.edu.sg/~dima/tmp/sage-5.0.beta8.spkg).\n+\n+(or you can patch the `sage-***.spkg` with the attached patch) \n``````\n",
    "created_at": "2012-03-16T07:56:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,10 +1,11 @@\n The version of Twisted currently used in Sage is old and obsolete; moreover it is buggy, as our extensive tests involving running  labs for 120 students show. The crashes of the notebook webapp go away after the upgrade to twisted 11.\n \n-The twisted package is now included in the flask sagenb (#11080), so this ticket just has the patch to remove the twisted spkg.\n+The twisted package is now included in the flask sagenb (#11080), so this ticket just removes the twisted spkg.\n \n See http://groups.google.com/group/sage-devel/browse_thread/thread/98c53d17166da1b9 for the sage-devel vote.\n \n-**apply**: [attachment: trac-11874-remove-twisted.3.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.3.patch.gz) to the sage root repository,  **remove** the **twisted** spkg from the standard spkgs, and\n-**replace** the **sage-***** spkg in  the standard spkgs by [this one](http://web.spms.ntu.edu.sg/~dima/tmp/sage-5.0.beta8.spkg).\n+**apply**:\n+1. [attachment: trac-11874-remove-twisted.3.patch.gz](https://github.com/sagemath/sage/files/ticket11874/trac-11874-remove-twisted.3.patch.gz) to the sage root repository\n+2. [attachment: sage-spkg-11874.patch.gz](https://github.com/sagemath/sage/files/ticket11874/sage-spkg-11874.patch.gz) to the Sage library.\n \n-(or you can patch the `sage-***.spkg` with the attached patch) \n+And **remove** the twisted spkg from the standard spkgs.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146183"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126556",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126557",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126558",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146185"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126559",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126560",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126561",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126562",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126563",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126564",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126565",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126566",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126567",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126568",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126569",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126570",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126571",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126572",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146190"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146191"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126573",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126574",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126575",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126576",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126577",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126578",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146192"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126579",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146194"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126580",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126581",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126582",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126583",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11874#event-146206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11874#issuecomment-126584",
