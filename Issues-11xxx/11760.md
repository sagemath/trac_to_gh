...
archive/attachments_016131.json:
```json
{
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch](https://github.com/sagemath/sage/files/ticket11760/trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch)\n\nCouldn't resist to also do some clean-up.\n\nActual (trivial) fix starting on line 178.",
    "created_at": "2011-10-09T14:04:42Z",
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_comment",
...
archive/attachments_016132.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_11760-additional_improvements_to_pkgconfig_funs.optional.scripts.patch](https://github.com/sagemath/sage/files/ticket11760/trac_11760-additional_improvements_to_pkgconfig_funs.optional.scripts.patch)\n\nSCRIPTS repo. Optional improvements to `{initialize,update}_pkgconfig_files()`. Apply on top of other patch..",
    "created_at": "2011-10-09T22:45:09Z",
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_comment",
...
**Attachment:** [trac_11760-additional_improvements_to_pkgconfig_funs.optional.scripts.patch](https://github.com/sagemath/sage/files/ticket11760/trac_11760-additional_improvements_to_pkgconfig_funs.optional.scripts.patch)
...
archive/attachments_016133.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_11760-cumulative_diff_of_both_patches.diff](https://github.com/sagemath/sage/files/ticket11760/trac_11760-cumulative_diff_of_both_patches.diff)\n\nCumulative diff of both patches against Sage 4.7.2.alpha3. For review only.",
    "created_at": "2011-10-09T23:10:44Z",
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_comment",
...
**Attachment:** [trac_11760-cumulative_diff_of_both_patches.diff](https://github.com/sagemath/sage/files/ticket11760/trac_11760-cumulative_diff_of_both_patches.diff)
