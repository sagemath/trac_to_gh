...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139507"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139510"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -8,4 +8,7 @@\n \n In the long run, `sage-location` shouldn't (have to) deal with `.pc` files at all, but we IMHO need a **quick fix** until we have a better, more general solution to *all* issues with `pkg-config`. (There are a couple of other issues; cf. for example #10202, #9668, #11687, #11681.) Therefore *this* ticket isn't intended to fix any of the other issues.\n \n+---\n \n+Apply [attachment: trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11760/trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch.gz) to the Sage **scripts repository**.\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139511"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,5 +10,8 @@\n \n ---\n \n-Apply [attachment: trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11760/trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch.gz) to the Sage **scripts repository**.\n+Apply\n+1. [attachment: trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11760/trac_11760-avoid_multiple_defs_of_SAGE_ROOT.scripts.patch.gz)\n+2. **optionally** [attachment: trac_11760-additional_improvements_to_pkgconfig_funs.optional.scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11760/trac_11760-additional_improvements_to_pkgconfig_funs.optional.scripts.patch.gz)\n+to the Sage **scripts repository**.\n \n``````\n",
    "created_at": "2011-10-09T22:51:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11760#event-139515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11760#issuecomment-124643",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11760#issuecomment-124644",
    "user": "https://github.com/jhpalmieri"
}
```
