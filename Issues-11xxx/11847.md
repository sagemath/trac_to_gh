...
```json
{
    "body": "Changing dependencies from \"\" to \"sage 4.7.2\"",
    "created_at": "2011-09-25T18:58:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161567",
    "user": "https://github.com/johnperry-math"
}
```

Changing dependencies from "" to "sage 4.7.2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161568",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161569",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This patch adds a note and a test to `degree()` to inform the user of the behavior. It also adds a new function, `total_degree_ungraded()`, which returns the total degree without respect to a grading. Doctests pass for me on sage 4.7.2alpha2.\n\nThis patch and should perhaps include more, but I thought it best to see what others thought.\n\nPS: I removed malb from cc: after noticing that he was made the owner. So I suspect he is being notified anyway. I'm not real sure how notifications work, or who should be cc'd; I thought that everyone who commented on this topic in sage-devel should get some notification, and I knew Martin had worked on this code, too. Sorry if some of you are getting unwanted spam. :-(",
    "created_at": "2011-09-25T19:06:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161570",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:2'></a>This patch adds a note and a test to `degree()` to inform the user of the behavior. It also adds a new function, `total_degree_ungraded()`, which returns the total degree without respect to a grading. Doctests pass for me on sage 4.7.2alpha2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161572",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I would never change the behavior of degree(),degrees(),total_degree(), which should return the standard things as Simon said, except of course bug fixes.\n\nFor exponent(), exponents(), total_exponents(), I would expect\n\n```\nsage: f=x^3+x*y+1\nsage: f.exponent(x)\n[3,1,1]\nsage: f.exponents()\n[(3,0),(1,1),(0,0)]\nsage: f.total_exponent()\n[3,2,0]\nsage: f.exponent()\n[3,2,0]\nsage: g=x*y\nsage: g.exponent(x) % convenient behavior for a monomial\n1\nsage: g.exponents()\n(1,1)\nsage: g.total_exponent()\n2\nsage: g.exponent()\n2\n```\n\nThen even in a polynomial ring with the default grading, the two sets of methods will play different roles.\n\nI would object names mixing \"degree\" and \"exponent\" in any way.",
    "created_at": "2011-09-26T06:13:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161573",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:5'></a>I would never change the behavior of degree(),degrees(),total_degree(), which should return the standard things as Simon said, except of course bug fixes.
...
```json
{
    "body": "<a id='comment:6'></a>We could also add a keyword \"use_grading\" to the degree methods.\n\nNote that whathever we do, we should not do the combination of:\n\n```\nsage: f.exponent(x)\n[3,1,1]\nsage: g.exponent(x) % convenient behavior for a monomial\n1\n```\n\nSuch a function will be very hard to use since this behaviour will make you write ugly code like:\n\n\n```\ndeg = f.exponent()\nif f.is_monomial():\n    do_something(f)\nelse:\n    do_something_else(f)\n```",
    "created_at": "2011-09-26T06:44:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161574",
    "user": "https://github.com/koffie"
}
```

<a id='comment:6'></a>We could also add a keyword "use_grading" to the degree methods.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161575",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161576",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161577",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I've attached a patch that implements this with a keyword (`std_grading`). The `total_degree_exponents()` method has disappeared, and `degree()` also accepts the keyword.",
    "created_at": "2011-09-26T18:24:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161578",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:10'></a>I've attached a patch that implements this with a keyword (`std_grading`). The `total_degree_exponents()` method has disappeared, and `degree()` also accepts the keyword.
...
```json
{
    "body": "<a id='comment:11'></a>Whoops -- I had forgotten to refresh the mercurial queue... new patch in a second.",
    "created_at": "2011-09-26T18:25:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161579",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:11'></a>Whoops -- I had forgotten to refresh the mercurial queue... new patch in a second.
...
```json
{
    "body": "<a id='comment:12'></a>*bump* any chance of a review?",
    "created_at": "2011-11-10T11:55:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161580",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:12'></a>*bump* any chance of a review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161582",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [trac11847_distinguish_ungraded_totaldegree.patch](tarball://root/attachments/some-uuid/ticket11847/trac11847_distinguish_ungraded_totaldegree.patch) by @johnperry-math created at 2011-11-14 20:04:41\n\nI was unaware that 4.8.alpha1 was out... have to pay better attention to `sage-devel`.\n\nNew patch works on my installation of 4.8.alpha1. Thanks!",
    "created_at": "2011-11-14T20:04:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161583",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:14'></a>Attachment [trac11847_distinguish_ungraded_totaldegree.patch](tarball://root/attachments/some-uuid/ticket11847/trac11847_distinguish_ungraded_totaldegree.patch) by @johnperry-math created at 2011-11-14 20:04:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161584",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161585",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161586",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161587",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>applies cleanly && doctests pass && reads good.",
    "created_at": "2011-11-14T22:02:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161588",
    "user": "https://github.com/malb"
}
```

<a id='comment:15'></a>applies cleanly && doctests pass && reads good.
...
```json
{
    "body": "<a id='comment:16'></a>What is there to be reported upstream?",
    "created_at": "2011-11-16T14:15:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161589",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>What is there to be reported upstream?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161590",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161591",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11847#event-31241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161593",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11847#issuecomment-161594",
    "user": "https://github.com/jdemeyer"
}
```
