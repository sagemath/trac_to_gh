...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11432#event-29688"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11432#event-29689"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11432#event-29690"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I was wrong. When (3 years ago!) I opened the ticket, I failed to realize that one can evaluate a quadratic form on a matrix, and indeed this is what the lll() (rightly) does. I am closing the ticket.",
    "created_at": "2014-03-27T14:51:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11432#issuecomment-130645",
    "user": "https://github.com/mmasdeu"
}
```

<a id='comment:3'></a>I was wrong. When (3 years ago!) I opened the ticket, I failed to realize that one can evaluate a quadratic form on a matrix, and indeed this is what the lll() (rightly) does. I am closing the ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11432#issuecomment-130646",
    "user": "https://github.com/mmasdeu"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11432#event-29691"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11432#event-29692"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11432",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11432#event-29693"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11432#issuecomment-130647",
