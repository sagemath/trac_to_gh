...
```json
{
    "body": "<a id='comment:2'></a>What about `._.DS_Store` files?",
...
<a id='comment:2'></a>What about `._.DS_Store` files?
...
```json
{
    "body": "<a id='comment:5'></a>Okay, these patches ignore those files, too.",
...
<a id='comment:5'></a>Okay, these patches ignore those files, too.
...
<a id='comment:8'></a>> > We could add those too.  What are they?  I haven't found any documentation for them anywhere.
...
```json
{
    "body": "<a id='comment:9'></a>(I didn't read it as snarky, for what that's worth, but I may be missing part of the back story...)",
...
<a id='comment:9'></a>(I didn't read it as snarky, for what that's worth, but I may be missing part of the back story...)
