...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140130"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140131"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140134"
}
```
...
```json
{
    "body": "<a id='comment:8'>Comment 8:</a>\napply [attachment: 11800.patch.gz](https://github.com/sagemath/sage/files/ticket11800/11800.patch.gz)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140138"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,11 +1,11 @@\n The function that lists the points on a hyperelliptic curve assumes that the point [0, 1, 0] is always valid. This is wrong and creates the following bug:\n \n ```\n-sage: R.<x> = GF(67)[]\n-sage: H = HyperellipticCurve(24*x^2 + 33*x + 43)\n+sage: R.<x> = GF(7)[]\n+sage: H = HyperellipticCurve(3*x^2 + 5*x + 1)\n sage: H.points()\n ...\n-TypeError: Coordinates [0, 1, 0] do not define a point on Hyperelliptic Curve over Finite Field of size 67 defined by y^2 = 24*x^2 + 33*x + 43\n+TypeError: Coordinates [0, 1, 0] do not define a point on Hyperelliptic Curve over Finite Field of size 7 defined by y^2 = 3*x^2 + 5*x + 1\n ```\n \n-Apply [attachment: 11800.patch.gz](https://github.com/sagemath/sage/files/ticket11800/11800.patch.gz)\n+Apply [attachment: trac_11800_allow_conics.patch.gz](https://github.com/sagemath/sage/files/ticket11800/trac_11800_allow_conics.patch.gz)\n``````\n",
    "created_at": "2011-12-21T11:08:16Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11800",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11800",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11800#event-140146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11800#issuecomment-125541",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11800#issuecomment-125542",
    "user": "https://github.com/mstreng"
}
```
