...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136486"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136489"
}
```
...
```json
{
    "body": "Changed keywords from **** to **lrcalc, symmetric functions**",
    "created_at": "2012-05-10T02:58:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
...
Changed keywords from **** to **lrcalc, symmetric functions**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,10 @@\n #10333 implements an interface to lrcalc, using an optional spkg.\n According to the vote on http://groups.google.com/group/sage-devel/browse_thread/thread/2e7114375f6f88a5/, there is a consensus on making lrcalc a standard spkg, after a one release probation period in order to follow the official rule.\n \n+\n+- Add [lrcalc-1.1.6beta.spkg](https://github.com/sagemath/sage/files/ticket10333/lrcalc-1.1.6beta.spkg.gz) as a standard spkg\n+\n+- Apply: [attachment: trac_10333-lrcalc-final.patch.gz](https://github.com/sagemath/sage/files/ticket11563/trac_10333-lrcalc-final.patch.gz)\n+\n+\n+Apply \n``````\n",
    "created_at": "2012-05-10T02:58:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136490"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136500"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136503"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136506"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136507"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136508"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,7 @@\n #10333 implements an interface to lrcalc, using an optional spkg.\n According to the vote on http://groups.google.com/group/sage-devel/browse_thread/thread/2e7114375f6f88a5/, there is a consensus on making lrcalc a standard spkg, after a one release probation period in order to follow the official rule.\n \n-- Add [lrcalc-1.1.6beta.p0.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/lrcalc-1.1.6beta.p0.spkg) as a standard spkg\n+1. **spkg**: add [lrcalc-1.1.6beta.p0.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/lrcalc-1.1.6beta.p0.spkg) as standard spkg.\n+2. **apply** [attachment: trac_11563-lrcalc_standard_package-nt.patch.gz](https://github.com/sagemath/sage/files/ticket11563/trac_11563-lrcalc_standard_package-nt.patch.gz) to the Sage library.\n+3. **apply** [attachment: https://github.com/sagemath/sage/files/ticket11563/trac_11563-lrcalc-sageroot-nt.patch.gz.gz](https://github.com/sagemath/sage/files/ticket11563/b8ca366d2c4a170f734a73f241118c77.gz) to `SAGE_ROOT`.\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136510"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120371",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120372",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120373",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120374",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120375",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120376",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120377",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120378",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120379",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120380",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120381",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,4 +4,4 @@\n 1. **spkg**: add [lrcalc-1.1.6beta.p0.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/lrcalc-1.1.6beta.p0.spkg) as standard spkg.\n 2. **apply** [attachment: trac_11563-lrcalc_standard_package-nt.patch.gz](https://github.com/sagemath/sage/files/ticket11563/trac_11563-lrcalc_standard_package-nt.patch.gz) to the Sage library.\n 3. **apply** [attachment: trac_11563-lrcalc-sageroot-nt.patch.gz](https://github.com/sagemath/sage/files/ticket11563/trac_11563-lrcalc-sageroot-nt.patch.gz) to `SAGE_ROOT`.\n-\n+4. **apply** [attachment: trac_11563-scripts-hgignore.patch.gz](https://github.com/sagemath/sage/files/ticket11563/trac_11563-scripts-hgignore.patch.gz) to local/bin.\n``````\n",
    "created_at": "2012-07-13T02:26:19Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120382",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120383",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120384",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120385",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120386",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120387",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120388",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120389",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120390",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120391",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120392",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120393",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120394",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136520"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11563#event-136521"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120395",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11563#issuecomment-120396",
    "user": "https://github.com/jdemeyer"
}
```
