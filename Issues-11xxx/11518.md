...
```json
{
    "body": "<a id='comment:2'></a>Note that [https://www.math.ucdavis.edu/~latte/](https://www.math.ucdavis.edu/~latte/) now has the most up to date \"latest version, LattE integrale, has the ability to directly compute integrals of polynomial functions over polytopes and in particular to do volume computations.\"",
    "created_at": "2013-06-03T14:09:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153049",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>Note that [https://www.math.ucdavis.edu/~latte/](https://www.math.ucdavis.edu/~latte/) now has the most up to date "latest version, LattE integrale, has the ability to directly compute integrals of polynomial functions over polytopes and in particular to do volume computations."
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11518#event-30068"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This ticket is obsolete, and superseded by #15180.",
    "created_at": "2013-09-09T06:33:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153050",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>This ticket is obsolete, and superseded by #15180.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153051",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153052",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11518#event-30069"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11518#event-30070"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153053",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153054",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11518#event-30071"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Zafeirakis Zafeirakopoulos\"",
    "created_at": "2013-10-05T09:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11518#issuecomment-153055",
    "user": "https://github.com/jdemeyer"
}
```

Changing reviewer from "" to "Zafeirakis Zafeirakopoulos"
