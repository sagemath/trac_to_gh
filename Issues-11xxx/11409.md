...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127910"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127912"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n Check whether the files in `SAGE_ROOT/devel/sage/sage/server/notebook` are still used.  If not, remove them.\n \n See also #9237, #9552.\n+\n+Apply [and [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/f6381de168aeeabd1f4a31b59051a3ca.patch](https://github.com/sagemath/sage/files/ticket11409/f56e999f9ee03923bfb6630edb4dba17.patch))\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -2,4 +2,7 @@\n \n See also #9237, #9552.\n \n-Apply [and [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/f6381de168aeeabd1f4a31b59051a3ca.patch](https://github.com/sagemath/sage/files/ticket11409/f56e999f9ee03923bfb6630edb4dba17.patch))\n+**Apply**:\n+1. [attachment:11409_remove_notebook_dir.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_notebook_dir.patch)\n+2. [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)\n+3. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,4 +5,5 @@\n **Apply**:\n 1. [attachment:11409_remove_notebook_dir.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_notebook_dir.patch)\n 2. [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)\n-3. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n+3. [attachment:11409_remove_server_simple.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_server_simple.patch)\n+4. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,7 +5,6 @@\n See also #9237, #9552.\n \n **Apply**:\n-1. [attachment:11409_remove_notebook_dir.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_notebook_dir.patch)\n+1. [attachment:11409_remove_dirs.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_dirs.patch)\n 2. [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)\n-3. [attachment:11409_remove_server_simple.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_server_simple.patch)\n-4. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n+3. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -8,3 +8,4 @@\n 1. [attachment:11409_remove_dirs.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_dirs.patch)\n 2. [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)\n 3. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n+4. [attachment:11409_sagenb.patch](https://github.com/sagemath/sage/files/ticket11409/11409_sagenb.patch) to the sagenb repository *devel/sagenb*\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,11 +1,12 @@\n-The old Sage notebook (as part of the Sage library) has been superseded by the sagenb spkg.  The following directories contain old files for the Sage notebook and should be removed:\n-* `SAGE_ROOT/devel/sage/sage/server/notebook`\n-* `SAGE_ROOT/devel/sage/sage/server/simple`\n+The old Sage notebook (as part of the Sage library) has been superseded by the sagenb spkg.  The following files are from the old notebook and should be removed:\n+* `SAGE_ROOT/devel/sage/sage/server/introspect.py`\n+* `SAGE_ROOT/devel/sage/sage/server/notebook/*`\n+* `SAGE_ROOT/devel/sage/sage/server/simple/*`\n \n See also #9237, #9552.\n \n **Apply**:\n-1. [attachment:11409_remove_dirs.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_dirs.patch)\n+1. [attachment:11409_remove_files.patch](https://github.com/sagemath/sage/files/ticket11409/11409_remove_files.patch) (this simply removes the above files and directories)\n 2. [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)\n 3. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n 4. [attachment:11409_sagenb.patch](https://github.com/sagemath/sage/files/ticket11409/11409_sagenb.patch) to the sagenb repository *devel/sagenb*\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127915"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127916"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127917"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127918"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127920"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>\nRebased [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,8 +11,8 @@\n \n **Apply**:\n 1. `cd sage/server && hg remove introspect.py notebook simple && hg commit -m \"Trac #11409: Remove old notebook files\"` # I prefer this shell command to a patch because there are no chances of a merge conflict\n-2. [attachment:11409.patch](https://github.com/sagemath/sage/files/ticket11409/11409.patch)\n-3. [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to the scripts repository *local/bin*\n+2. [attachment:trac_11409.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409.patch)\n+3. [attachment:trac_11409-scripts.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409-scripts.patch) to the scripts repository *local/bin*\n 4. [attachment:11409_sagenb.patch](https://github.com/sagemath/sage/files/ticket11409/11409_sagenb.patch) to the sagenb repository *devel/sagenb*\n \n ---\n``````\n",
...
```json
{
    "body": "<a id='comment:30'></a>\n**Attachment:** [trac_11409-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11409/trac_11409-scripts.patch.gz)\n\nI had to modify [attachment:11409_scripts.patch](https://github.com/sagemath/sage/files/ticket11409/11409_scripts.patch) to get `sage -n` to work.",
    "created_at": "2012-12-06T02:48:24Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11409",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127921"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127922"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,7 +11,7 @@\n \n **Apply**:\n 1. `cd sage/server && hg remove introspect.py notebook simple && hg commit -m \"Trac #11409: Remove old notebook files\"` # I prefer this shell command to a patch because there are no chances of a merge conflict\n-2. [attachment:trac_11409.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409.patch)\n+2. [attachment:trac_11409-rebased.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409-rebased.patch)\n 3. [attachment:trac_11409-scripts.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409-scripts.patch) to the scripts repository *local/bin*\n 4. [attachment:11409_sagenb.patch](https://github.com/sagemath/sage/files/ticket11409/11409_sagenb.patch) to the sagenb repository *devel/sagenb*\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -12,8 +12,7 @@\n **Apply**:\n 1. `cd sage/server && hg remove introspect.py notebook simple && hg commit -m \"Trac #11409: Remove old notebook files\"` # I prefer this shell command to a patch because there are no chances of a merge conflict\n 2. [attachment:trac_11409-rebased.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409-rebased.patch)\n-3. [attachment:trac_11409-scripts.patch](https://github.com/sagemath/sage/files/ticket11409/trac_11409-scripts.patch) to the scripts repository *local/bin*\n-4. [attachment:11409_sagenb.patch](https://github.com/sagemath/sage/files/ticket11409/11409_sagenb.patch) to the sagenb repository *devel/sagenb*\n+3. [attachment:11409_sagenb.patch](https://github.com/sagemath/sage/files/ticket11409/11409_sagenb.patch) to the sagenb repository *devel/sagenb*\n \n ---\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127923"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127924"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127930"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127931"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127932"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11409",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11409#event-127933"
}
```
