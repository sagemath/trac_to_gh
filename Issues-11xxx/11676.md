...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132029"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n As pointed out here: #11660 and here: #11664 archives have to be world-readable. sage-pkg does not enforce this.\n \n ## Current patch for Sage's local/bin repository\n-https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.1.patch.gz\n+[attachment:https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.1.patch.gz](https://github.com/sagemath/sage/files/ticket11676/e5d48429e6512a1011567f01419fbd3a.gz)\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n As pointed out here: #11660 and here: #11664 archives have to be world-readable. sage-pkg does not enforce this.\n \n ## Current patch for Sage's local/bin repository\n-[attachment:https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.1.patch.gz](https://github.com/sagemath/sage/files/ticket11676/e5d48429e6512a1011567f01419fbd3a.gz)\n+[attachment:https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.2.patch.gz](https://github.com/sagemath/sage/files/ticket11676/1395684d1463cef120e4199687c1a917.gz)\n``````\n",
    "created_at": "2011-08-17T14:17:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132033"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11676#event-132039"
}
```
