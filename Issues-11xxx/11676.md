...
archive/attachments_015986.json:
```json
{
...
archive/attachments_015987.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:9'></a>\n**Attachment:** [sage-pkg-tarmode.1.patch](https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.1.patch)",
    "created_at": "2011-08-10T22:31:37Z",
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [sage-pkg-tarmode.2.patch](https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.2.patch)\n\nMaking enforcement optional, also fixing Darwin",
    "created_at": "2011-08-17T14:14:55Z",
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_comment",
...
**Attachment:** [sage-pkg-tarmode.2.patch](https://github.com/sagemath/sage/files/ticket11676/sage-pkg-tarmode.2.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11676#issuecomment-122712",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11676#issuecomment-122713",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11676#issuecomment-122714",
    "user": "https://github.com/alexanderdreyer"
}
```
