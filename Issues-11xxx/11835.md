...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161326",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11835#event-31207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161328",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161329",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161331",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161332",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161335",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161336",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161337",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161338",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11835#event-31208"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11835#event-31209"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Never use\n\n```\nexcept:\n```\nbut catch specific exceptions instead. If you must use a catch-all, use\n\n```\nexcept StandardError:\n```",
    "created_at": "2013-05-29T12:38:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161339",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Never use
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161340",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161341",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161342",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Changed the error jdemeyer found.",
    "created_at": "2013-05-29T14:58:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161343",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```

<a id='comment:13'></a>Changed the error jdemeyer found.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161344",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>[attachment:trac_11835-TernaryQF_4.patch] needs a proper commit message (alternatively, simply change the first patch and remove the fourth).",
    "created_at": "2013-05-30T13:11:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161345",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>[attachment:trac_11835-TernaryQF_4.patch] needs a proper commit message (alternatively, simply change the first patch and remove the fourth).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161346",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161347",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [trac_11835-TernaryQF.patch](tarball://root/attachments/some-uuid/ticket11835/trac_11835-TernaryQF.patch) by gdrama created at 2013-05-30 17:19:00",
    "created_at": "2013-05-30T17:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161348",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```

<a id='comment:16'></a>Attachment [trac_11835-TernaryQF.patch](tarball://root/attachments/some-uuid/ticket11835/trac_11835-TernaryQF.patch) by gdrama created at 2013-05-30 17:19:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161349",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11835#event-31210"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161350",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161351",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>What was the rationale for adding\n\n```\nfrom __builtin__ import max\n```\n\nThat seems unneeded and also slower than using plain `max()`.",
    "created_at": "2016-11-24T15:20:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11835#issuecomment-161352",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>What was the rationale for adding
