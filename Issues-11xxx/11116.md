...
```json
{
    "body": "<a id='comment:1'></a>#7029 is semi-related to this.",
    "created_at": "2011-04-02T12:52:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144413",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>#7029 is semi-related to this.
...
```json
{
    "body": "<a id='comment:2'></a>That's interesting you get this backtrace. That looks so familiar, I thought it wouldn't happen on a vanilla sage install.\n[https://github.com/cschwan/sage-on-gentoo/issues#issue/40](https://github.com/cschwan/sage-on-gentoo/issues#issue/40)",
    "created_at": "2011-04-02T22:11:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144414",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>That's interesting you get this backtrace. That looks so familiar, I thought it wouldn't happen on a vanilla sage install.
[https://github.com/cschwan/sage-on-gentoo/issues#issue/40](https://github.com/cschwan/sage-on-gentoo/issues#issue/40)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144415",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144416",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144418",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144419",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>That's why the fact you get it is so interesting. Patching glibc solved everyone's problem in gentoo but it may be that this is just a work around. Or may be it is more complex than that: the problem will only happen if a combination of elements are not behaving like they should.\n\nNote it has been observed to happen after update that are seemingly unrelated to sage packages. Which suggests that there is indeed a complex mix leading to the failure. Fixing any one components of the mix is probably enough to prevent the problem altogether.",
    "created_at": "2011-04-03T05:01:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144420",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>That's why the fact you get it is so interesting. Patching glibc solved everyone's problem in gentoo but it may be that this is just a work around. Or may be it is more complex than that: the problem will only happen if a combination of elements are not behaving like they should.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144423",
    "user": "https://github.com/gagern"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>The issue from sage-on-gentoo seem to have disappeared on one of my machines. I am not completely sure if Gentoo included Martin's patch already or if pynac-0.2.3 shipped in sage-4.7.1_alpha4 is responsible. It is probably worth giving 4.7.1_alpha4 a dpin.",
    "created_at": "2011-07-07T02:15:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144425",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:13'></a>The issue from sage-on-gentoo seem to have disappeared on one of my machines. I am not completely sure if Gentoo included Martin's patch already or if pynac-0.2.3 shipped in sage-4.7.1_alpha4 is responsible. It is probably worth giving 4.7.1_alpha4 a dpin.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144430",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I wonder if the patch at #11043 might help.",
    "created_at": "2011-07-23T17:54:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144431",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:19'></a>I wonder if the patch at #11043 might help.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144432",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28822"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28823"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28824"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28825"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28826"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28827"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28828"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28829"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28830"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Outdated, should be closed",
    "created_at": "2020-07-08T16:51:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144434",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:26'></a>Outdated, should be closed
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144435",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144436",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144437",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11116#issuecomment-144438",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11116",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11116#event-28831"
}
```
