...
```json
{
    "body": "<a id='comment:1'></a>Attachment [11277.patch](tarball://root/attachments/some-uuid/ticket11277/11277.patch) by @jdemeyer created at 2011-04-30 16:52:50",
...
<a id='comment:1'></a>Attachment [11277.patch](tarball://root/attachments/some-uuid/ticket11277/11277.patch) by @jdemeyer created at 2011-04-30 16:52:50
...
<a id='comment:2'></a>Applies, builds, passes tests.  However, I do not have a configuration where it was failing.
...
<a id='comment:4'></a>If the platform is getting an error, why should the test be disabled? That seems to defeat the object of a test to me. 
