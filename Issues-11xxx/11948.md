...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11948#issuecomment-128814",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11948#issuecomment-128815",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout, @sagetrac-jkantor** to **@jdemeyer**",
...
Changed assignee from **@jasongrout, @sagetrac-jkantor** to **@jdemeyer**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11948#event-147608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11948#event-147609"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11948",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11948#event-147610"
}
```
