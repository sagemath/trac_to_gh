...
```json
{
    "body": "Changed assignee from **@sagetrac-drkirkby** to **@williamstein**",
    "created_at": "2011-08-19T01:38:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11706",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-drkirkby** to **@williamstein**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11706#event-143565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11706#event-143566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11706",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11706#event-143567"
}
```
