...
```json
{
    "body": "<a id='comment:14'></a>I think this needs to be improved a bit.  In particular the new code is only really useful if we can specify the desired precision (of the output), see[comment:3](#comment%3A3).  I'm trying to do this now.",
...
<a id='comment:14'></a>I think this needs to be improved a bit.  In particular the new code is only really useful if we can specify the desired precision (of the output), see[comment:3](#comment%3A3).  I'm trying to do this now.
