...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154580",
    "user": "https://trac.sagemath.org/admin/accounts/users/Kamhamea"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154581",
    "user": "https://trac.sagemath.org/admin/accounts/users/Kamhamea"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154582",
...
```json
{
    "body": "Changing author from \"\" to \"Mato Nagel\"",
    "created_at": "2011-07-05T13:33:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154584",
    "user": "https://github.com/kcrisman"
}
```

Changing author from "" to "Mato Nagel"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154585",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154586",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I added two notebook worksheets to test these new probability distributions.\n\n!http://www.sagenb.org/home/pub/2887 \n!http://www.sagenb.org/home/pub/2886/ \n",
    "created_at": "2011-07-06T06:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154588",
    "user": "https://trac.sagemath.org/admin/accounts/users/Kamhamea"
}
```

<a id='comment:4'></a>I added two notebook worksheets to test these new probability distributions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154589",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11572#issuecomment-154591",
    "user": "https://trac.sagemath.org/admin/accounts/users/Kamhamea"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30335"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30336"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30337"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30338"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30339"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30340"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11572#event-30341"
}
```
