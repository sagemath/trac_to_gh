...
```json
{
    "body": "I saw this demo'ed at Sage Days 30.  It's really nice.  I'll give the patch as look once it appears.",
...
```json
{
    "body": "Takes now 17 seconds to test on my machine (35s with long test).",
...
```json
{
    "body": "I had a bit of time to look through the patch.  Looks great!  I still need to do a thorough test of the new features and all, so will try to get to that soon.\n\nWould Franco let you bring the real physical puzzle to Seattle for SD 31?\n\nRob",
...
```json
{
    "body": "> Would Franco let you bring the real physical puzzle to Seattle for SD 31?\n\n\nSure! I'll ask. And will try not to forget it!\n\nS\u00e9bastien",
...
```json
{
    "body": "I have been working on it again yesterday. I will update the patches again quite soon. Do not review until then.\n\nSebastien",
    "created_at": "2011-06-14T08:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11379",
    "type": "issue_comment",
...
```json
{
    "body": "Great. So I will upload the patches later tonight! I still have some cleaning to make.",
...
```json
{
    "body": "In a new patch I just uploaded which applies on top of two others, I fixed a color issue for when pieces are reusable. Sorry, I had the idea for the fix when I woke up. Now, I stop working on it!",
...
```json
{
    "body": "Attachment [trac_11379_color_issue-sl.patch](tarball://root/attachments/some-uuid/ticket11379/trac_11379_color_issue-sl.patch) by @seblabbe created at 2011-06-16 01:17:12\n\nOk, so I can't stop working on it apparently. I added the possibility of making an animation. I also fixed the problem that showed up during my quick demo.\n\nNeeds review!",
...
Attachment [trac_11379_color_issue-sl.patch](tarball://root/attachments/some-uuid/ticket11379/trac_11379_color_issue-sl.patch) by @seblabbe created at 2011-06-16 01:17:12
...
Attachment [trac_11379-reviewer-docs.patch](tarball://root/attachments/some-uuid/ticket11379/trac_11379-reviewer-docs.patch) by @rbeezer created at 2011-07-11 03:26:39
...
```json
{
    "body": "I don't know how to speak to the buildbot. Maybe the commas between patches name are needed? I am trying.\n\nMore info is here : http://wiki.sagemath.org/buildbot",
...
Attachment [trac_11379_quantamino-total-sl.patch](tarball://root/attachments/some-uuid/ticket11379/trac_11379_quantamino-total-sl.patch) by @rbeezer created at 2011-07-25 03:46:55
...
```json
{
    "body": "The commit message of [attachment:trac_11379_corrections-sl.patch] should be changed since it contains a reference to a mercurial queue.",
    "created_at": "2011-08-17T20:36:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11379",
    "type": "issue_comment",
...
```json
{
    "body": "I consolidated the commit strings ont eh one patch, and had to use a new name for the file, since I do not have the privileges to replace it.\n\nRob",
...
```json
{
    "body": "**Any** Segmentation Fault, documented or not, is a bug.  So I think this really points to a problem with the original patch.  See #11814 for a follow-up.",
