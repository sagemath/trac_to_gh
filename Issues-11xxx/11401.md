...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11401#event-138469"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11401#event-138470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11401#event-138471"
}
```
...
```json
{
    "body": "<a id='comment:15'>Comment 15:</a>\nPlease use proper URLs, or in this case, trac wiki mark-up (\"`[attachment: here_comes_the_filename.gz](https://github.com/sagemath/sage/files/ticket11401/here_comes_the_filename.gz)`\") to reference attached patches in the description.",
    "created_at": "2011-09-08T15:45:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11401#issuecomment-117442",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11401#issuecomment-117443",
    "user": "https://github.com/nexttime"
}
```
