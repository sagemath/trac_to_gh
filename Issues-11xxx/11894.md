...
```json
{
    "body": "<a id='comment:7'></a>> Points 2 and 3 have in my opinion been answered in comment:1.  Point 1 (the result could be simplified more nicely) is something that should be done in Maxima (simplify certain sums of two polygamma functions to trigonometric functions), so I think it shouldn't be an obstacle to closing this ticket.\n\nYes, that was essentially my point then.  In principle that could be another ticket but I'm not worried about it.",
...
<a id='comment:7'></a>> Points 2 and 3 have in my opinion been answered in comment:1.  Point 1 (the result could be simplified more nicely) is something that should be done in Maxima (simplify certain sums of two polygamma functions to trigonometric functions), so I think it shouldn't be an obstacle to closing this ticket.
