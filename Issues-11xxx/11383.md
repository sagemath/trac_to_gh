...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150383",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150384",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>how picky do we want a comparison to be?  Should it be more of a perceptive comparison (similar colors evaluate to True) or more of a numerically exact comparison (the colors must be _exactly_ the same to evaluate to True)?",
    "created_at": "2011-06-15T03:40:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150385",
    "user": "https://trac.sagemath.org/admin/accounts/users/ryan"
}
```

<a id='comment:3'></a>how picky do we want a comparison to be?  Should it be more of a perceptive comparison (similar colors evaluate to True) or more of a numerically exact comparison (the colors must be _exactly_ the same to evaluate to True)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150386",
    "user": "https://trac.sagemath.org/admin/accounts/users/ryan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150387",
    "user": "https://trac.sagemath.org/admin/accounts/users/ryan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150388",
    "user": "https://trac.sagemath.org/admin/accounts/users/ryan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150390",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150392",
    "user": "https://trac.sagemath.org/admin/accounts/users/ryan"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Another reason to be picky is the already present hashing behavior. Very close colors get different hashing value, so we want those color not to be equal. Otherwise we must change the hash method which is not a good idea I think.\n\n```\nsage: hash(Color((1,0,0)))          \n188337232                           \nsage: hash(Color((1.0,0,0)))        \n188338128                           \nsage: hash(Color((1.0,0.0,0)))      \n188337616                           \nsage: hash(Color((1.0,0.0,0.0)))    \n188337616                           \nsage: hash(Color('red'))            \n188337360                           \nsage: hash(Color((0.99999,0.0,0.0)))\n188614128                                                           \n```\n\nFrom the [Python Language Reference](http://docs.python.org/reference/datamodel.html#object.__hash__) : *\"The only required property is that objects which compare equal have the same hash value\"*.",
    "created_at": "2011-06-15T15:56:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150393",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:7'></a>Another reason to be picky is the already present hashing behavior. Very close colors get different hashing value, so we want those color not to be equal. Otherwise we must change the hash method which is not a good idea I think.
...
```json
{
    "body": "<a id='comment:8'></a>Color hashing is already broken in terms of any possible sane equality comparison:\n\n```python\nsage: c = Color('red')\nsage: hash(c)\n87590352\nsage: hash(Color('red'))\n87590672\nsage: hash(Color('red'))\n87590224\nsage: \n```\n\nSomething else to note: Sage is not SAGE, it is Sage! Please help to eradicate SAGE from the codebase rather than introducing new instances of it! :P",
    "created_at": "2011-06-15T17:11:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150394",
    "user": "https://github.com/kini"
}
```

<a id='comment:8'></a>Color hashing is already broken in terms of any possible sane equality comparison:
...
```json
{
    "body": "<a id='comment:9'></a>>Color hashing is already broken in terms of any possible sane equality comparison: \n\n\nOh! Interesting!",
    "created_at": "2011-06-15T17:22:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150395",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:9'></a>>Color hashing is already broken in terms of any possible sane equality comparison: 
...
```json
{
    "body": "<a id='comment:10'></a>Ping - anyone doing anything with this?",
    "created_at": "2011-10-08T04:29:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150396",
    "user": "https://github.com/kini"
}
```

<a id='comment:10'></a>Ping - anyone doing anything with this?
...
```json
{
    "body": "<a id='comment:12'></a>I think that redefining __hash__ would work.  Is there an example where the already published patch fails.  I don't understand how comparing the hashes is better than directly comparing `xx._Color__rgb==tt._Color__rgb`\n\n```\nsage: a,b\n(0.8216543768062763, 0.3482611655758555)\nsage: print a,b\n0.821654376806 0.348261165576\nsage: b = a-.000000000000000000001\nsage: b\n0.821654376806276\nsage: a\n0.8216543768062763\nsage: a==b\nTrue\nsage: xx = Color((a,b,0))\nsage: tt = Color((b,a,0))\nsage: xx==tt\nTrue\nsage: hash(xx)==hash(tt)\nFalse\nsage: hash(xx._Color__rgb)==hash(tt._Color__rgb)\nTrue\n```",
    "created_at": "2012-01-10T22:01:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150398",
    "user": "https://trac.sagemath.org/admin/accounts/users/ryan"
}
```

<a id='comment:12'></a>I think that redefining __hash__ would work.  Is there an example where the already published patch fails.  I don't understand how comparing the hashes is better than directly comparing `xx._Color__rgb==tt._Color__rgb`
...
```json
{
    "body": "<a id='comment:13'></a>As suggested, I added a new `__hash__` method (including doctests) that uses `__rgb` just like `__eq__` and did some minor code improvements in the original patch. Note that this is a rather \"picky\" approach, e.g. \n\n```\nsage: Color((0.99999,0.0,0.0)) == Color((1,0,0))\nFalse\n```\n\nAll tests pass (in Sage 5.0.beta11 under Mac OS X 10.5.8/Intel), so I think this works fine. \n\nBy the way (`@`kini), the issue with green is that\n\n```\nsage: Color('green').rgb()\n(0.0, 0.5019607843137255, 0.0)\n```\n\nso this is bound not be equal to `Color((0,1,0))`. `Color('lime')` is RGB green.",
    "created_at": "2012-04-04T05:10:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150399",
    "user": "https://trac.sagemath.org/admin/accounts/users/poeschko"
}
```

<a id='comment:13'></a>As suggested, I added a new `__hash__` method (including doctests) that uses `__rgb` just like `__eq__` and did some minor code improvements in the original patch. Note that this is a rather "picky" approach, e.g. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150400",
    "user": "https://trac.sagemath.org/admin/accounts/users/poeschko"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I noticed that these patches don't define a `__ne__` operator, and so the `!=` operator doesn't work.\n\n```\nsage: Color('blue') != Color('blue')\nTrue\n```\nI'm working on a patch to fix this.",
    "created_at": "2012-04-18T23:39:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150401",
    "user": "https://github.com/itaibn"
}
```

<a id='comment:14'></a>I noticed that these patches don't define a `__ne__` operator, and so the `!=` operator doesn't work.
...
```json
{
    "body": "<a id='comment:15'></a>Now I notice that the `__eq__` function returns an error when comparing a `Color` with something that isn't a `Color`. I don't think that is the intended behaviour.",
    "created_at": "2012-04-19T03:30:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150402",
    "user": "https://github.com/itaibn"
}
```

<a id='comment:15'></a>Now I notice that the `__eq__` function returns an error when comparing a `Color` with something that isn't a `Color`. I don't think that is the intended behaviour.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150403",
    "user": "https://github.com/itaibn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150404",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150405",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [trac_11383.patch](tarball://root/attachments/some-uuid/ticket11383/trac_11383.patch) by @a-andre created at 2012-05-04 18:02:23\n\nPatch is needed for #12904.",
    "created_at": "2012-05-04T18:02:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150406",
    "user": "https://github.com/a-andre"
}
```

<a id='comment:16'></a>Attachment [trac_11383.patch](tarball://root/attachments/some-uuid/ticket11383/trac_11383.patch) by @a-andre created at 2012-05-04 18:02:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150407",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150410",
    "user": "https://github.com/itaibn"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Okay.  Any opinions on the `Color('red') > Color('red')` issue?  I feel like this is pretty much the same issue as the original ticket, though perhaps not as likely to be useful in \"production\" code.",
    "created_at": "2012-05-07T12:50:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150411",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:20'></a>Okay.  Any opinions on the `Color('red') > Color('red')` issue?  I feel like this is pretty much the same issue as the original ticket, though perhaps not as likely to be useful in "production" code.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Itai Bar-Natan, Karl-Dieter Crisman, Andr\u00e9 Apitzch, Jan P\u00f6schko\"",
    "created_at": "2012-05-07T12:50:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150412",
    "user": "https://github.com/kcrisman"
}
```

Changing reviewer from "" to "Itai Bar-Natan, Karl-Dieter Crisman, André Apitzch, Jan Pöschko"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150413",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>> Okay.  Any opinions on the `Color('red') > Color('red')` issue?  I feel like this is pretty much the same issue as the original ticket, though perhaps not as likely to be useful in \"production\" code.\n  \nI've made a followup to this at #12999.  Assuming everything still applies, I think it's better to have this in than quibble.`",
    "created_at": "2012-05-24T23:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150414",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>> Okay.  Any opinions on the `Color('red') > Color('red')` issue?  I feel like this is pretty much the same issue as the original ticket, though perhaps not as likely to be useful in "production" code.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150415",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Tests on this pass.  If kini really wants to run full doctests he is welcome to.",
    "created_at": "2012-05-24T23:24:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150416",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>Tests on this pass.  If kini really wants to run full doctests he is welcome to.
...
```json
{
    "body": "<a id='comment:23'></a>patchbot: apply trac_11383.patch\n\n(The above should cause a couple patchbots to test this correctly, and fully, on 5.0 and 5.1.beta0.)",
    "created_at": "2012-05-24T23:26:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150417",
    "user": "https://github.com/kini"
}
```

<a id='comment:23'></a>patchbot: apply trac_11383.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150418",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11383#event-29552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150419",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11383#issuecomment-150420",
    "user": "https://github.com/jdemeyer"
}
```
