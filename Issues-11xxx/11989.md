...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129463",
    "user": "https://trac.sagemath.org/admin/accounts/users/gostrc"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11989/sage472output.txt.bz2",
    "created_at": "2011-11-03T22:43:33Z",
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11989/sage472output.txt.bz2",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sage472output.txt.bz2](https://github.com/sagemath/sage/files/ticket11989/sage472output.txt.bz2) by @nexttime created at 2011-11-03 22:43:33\n\nDid you search sage-devel?\n\nFor example, take a look at [this thread](http://groups.google.com/group/sage-devel/browse_thread/thread/32710f229fbd129b/43d2fc054d3a3cc6#43d2fc054d3a3cc6).",
    "created_at": "2011-11-03T22:43:33Z",
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129464",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129465",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129466",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129467",
    "user": "https://trac.sagemath.org/admin/accounts/users/gostrc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129468",
    "user": "https://trac.sagemath.org/admin/accounts/users/gostrc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129469",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11989#issuecomment-129470",
    "user": "https://github.com/jdemeyer"
}
```
