...
```json
{
    "body": "**Attachment:** [trac11943_mro_for_all_super_categories_lazy_hook.patch](https://github.com/sagemath/sage/files/ticket11943/trac11943_mro_for_all_super_categories_lazy_hook.patch)\n\nOrder the super categories of a category according to Python's mro. Internally replace (all_)super_categories by lazy attributes, to prevent a regression. Use `_subcategory_hook_`",
    "created_at": "2012-04-06T17:10:39Z",
    "issue": "https://github.com/sagemath/sage/issues/11943",
    "type": "issue_comment",
