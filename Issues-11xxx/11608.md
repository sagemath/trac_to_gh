...
{
    "assignees": [],
    "body": "As the summary says, this patch improves eigenvalues of matrices with double-precision floating-point entries.\n\n1. Uses SciPy's `eigh` routine for symmetric and Hermitian matrices.\n2. Allows grouping of \"equal\" eigenvalues, based on a tolerance parameter.\n\n**Apply:**\n1. [attachment: trac_11608-eigenvalues-symmetric-multiplicity-rebase.patch.gz](https://github.com/sagemath/sage/files/ticket11608/trac_11608-eigenvalues-symmetric-multiplicity-rebase.patch.gz)\n2. [attachment: trac_11608-eigenvalues-symmetric-multiplicity-update-v2.patch.gz](https://github.com/sagemath/sage/files/ticket11608/trac_11608-eigenvalues-symmetric-multiplicity-update-v2.patch.gz)\n\nAssignee: **@jasongrout, @williamstein**\n\nCC:  @jasongrout\n\nKeywords: **sd40.5**\n\nReviewer: **Volker Braun**\n\nAuthor: **Rob Beezer**\n\nMerged: **sage-5.1.beta4**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/11608_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11608#event-142036"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11608#event-142037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11608#event-142038"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,3 +2,6 @@\n \n 1. Uses SciPy's `eigh` routine for symmetric and Hermitian matrices.\n 2. Allows grouping of \"equal\" eigenvalues, based on a tolerance parameter.\n+\n+**Apply:**\n+1. [attachment: trac_11608-eigenvalues-symmetric-multiplicity.patch.gz](https://github.com/sagemath/sage/files/ticket11608/trac_11608-eigenvalues-symmetric-multiplicity.patch.gz)\n``````\n",
    "created_at": "2011-07-18T02:48:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11608",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,3 +5,4 @@\n \n **Apply:**\n 1. [attachment: trac_11608-eigenvalues-symmetric-multiplicity-rebase.patch.gz](https://github.com/sagemath/sage/files/ticket11608/trac_11608-eigenvalues-symmetric-multiplicity-rebase.patch.gz)\n+2. [attachment: trac_11608-eigenvalues-symmetric-multiplicity-update.patch.gz](https://github.com/sagemath/sage/files/ticket11608/trac_11608-eigenvalues-symmetric-multiplicity-update.patch.gz)\n``````\n",
    "created_at": "2012-05-05T04:32:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11608",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11608#issuecomment-121573",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11608#issuecomment-121574",
    "user": "https://github.com/jdemeyer"
}
```
