...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158393",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158394",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>P.S.: `sage-env` should also get changed when guessing `SAGE_ROOT` (cf. also #11687).",
    "created_at": "2011-08-18T20:59:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158395",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>P.S.: `sage-env` should also get changed when guessing `SAGE_ROOT` (cf. also #11687).
...
```json
{
    "body": "<a id='comment:5'></a>I mean we should also simplify / use `pwd -P` in `sage-env`'s\n\n```sh\n\n# GUESS SAGE_ROOT from pwd\nSAVEDIR=\"`pwd`\"\nif [ -f sage -a -d spkg ]; then\n    GUESSED_SAGE_ROOT=\"`pwd`\"\nelse\n    if [ -f ../../sage -a -d ../../spkg ]; then\n        cd ../../\n        GUESSED_SAGE_ROOT=\"`pwd`\"\n    else\n        GUESSED_SAGE_ROOT=\"\"\n    fi\nfi\ncd \"$SAVEDIR\"\n```\n\nSorry, currently doing four things at the same time. 8/",
    "created_at": "2011-08-18T21:06:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158396",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:5'></a>I mean we should also simplify / use `pwd -P` in `sage-env`'s
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158397",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158398",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I attach a shell script which should be portable (however, I have not yet tested this) and behaves like \"readlink -f\" if combined with `( cd $dir && pwd )`.  I guess this would solve all problems mentioned here.  I still have to think about the best way of using this from `$SAGE_ROOT/sage`.",
    "created_at": "2011-08-19T14:12:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158400",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>I attach a shell script which should be portable (however, I have not yet tested this) and behaves like "readlink -f" if combined with `( cd $dir && pwd )`.  I guess this would solve all problems mentioned here.  I still have to think about the best way of using this from `$SAGE_ROOT/sage`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158401",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158402",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Yesterday after reading some of this, I posted a question on #5852: has the main obstacle there been resolved?  The relevant code in sage-doctest seems to resolve all symbolic links in the various paths before comparing them, so whatever we do elsewhere shouldn't cause problems with doctesting.",
    "created_at": "2011-08-19T16:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158403",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:12'></a>Yesterday after reading some of this, I posted a question on #5852: has the main obstacle there been resolved?  The relevant code in sage-doctest seems to resolve all symbolic links in the various paths before comparing them, so whatever we do elsewhere shouldn't cause problems with doctesting.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11707#event-30769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158405",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158406",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Let's move the whole discussion to #5852.",
    "created_at": "2011-08-19T17:32:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11707#issuecomment-158407",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>Let's move the whole discussion to #5852.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11707#event-30770"
}
```
