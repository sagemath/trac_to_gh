...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157132",
    "user": "https://trac.sagemath.org/admin/accounts/users/jan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157133",
    "user": "https://trac.sagemath.org/admin/accounts/users/jan"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This has been fixed by #12780.\n\n```\nsage: var('a b')\n(a, b)\nsage: A = abs((a+i*b))^2\nsage: A.simplify_radical()\nabs(a + I*b)^2\nsage: imag(A)\n0\nsage: imag(A.simplify_full())\n0\n```\nPatch probably coming up.  This would also be dealt with by #12737, but that is orthogonal to having fixed the domain issues.",
    "created_at": "2013-06-12T19:33:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157135",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>This has been fixed by #12780.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157136",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157137",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Two minor things, can you use `a,b = SR.var('a,b')` to create the variables? That will eliminate one line of unrelated output. And just a style preference, since sage outputs the complex unit as `I`, I think it's a tiny bit more consistent to use that for input as well, but I'll take it either way.",
    "created_at": "2013-06-14T15:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157138",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:5'></a>Two minor things, can you use `a,b = SR.var('a,b')` to create the variables? That will eliminate one line of unrelated output. And just a style preference, since sage outputs the complex unit as `I`, I think it's a tiny bit more consistent to use that for input as well, but I'll take it either way.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157139",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157141",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157142",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157143",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11668#issuecomment-157144",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11668",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11668#event-30631"
}
```
