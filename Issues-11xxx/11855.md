...
<a id='comment:1'></a>Huh, it's already there.
...
<a id='comment:2'></a>Attachment [trac_11855-hilbert_function.patch](tarball://root/attachments/some-uuid/ticket11855/trac_11855-hilbert_function.patch) by @burcin created at 2011-09-27 13:54:10
...
```json
{
    "body": "<a id='comment:5'></a>The patch adds a second hilbert_series function instead of the changing the one that exists already. Also, the old one has some advantages over this new one: `@`require field, more extensive docs, test whether the ideal is homogeneous.",
...
<a id='comment:5'></a>The patch adds a second hilbert_series function instead of the changing the one that exists already. Also, the old one has some advantages over this new one: `@`require field, more extensive docs, test whether the ideal is homogeneous.
...
```json
{
    "body": "<a id='comment:7'></a>Sorry for the misprints in my previous post. \"hilber_series\" and \"hilbert_serie\" should have been \"hilbert_series\"...",
...
<a id='comment:7'></a>Sorry for the misprints in my previous post. "hilber_series" and "hilbert_serie" should have been "hilbert_series"...
...
<a id='comment:12'></a>Let us close this old one. Conversion is easy:
