...
```json
{
    "body": "<a id='comment:1'></a>Agreed that this is a place we need better work.  It's been fairly low priority, as you can see.  Ideas?  Hensel's Lemma?",
    "created_at": "2011-03-26T03:03:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142780",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Agreed that this is a place we need better work.  It's been fairly low priority, as you can see.  Ideas?  Hensel's Lemma?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142782",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142783",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142785",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I did a rebase but also have managed to mess up my 4.7.1.rc[01] builds while testing other tickets, so no guarantees...\n\nThe code seems to assume that the expressions is a polynomial (in one or more variables), so there should definitely be a more efficient way to do the enumeration of solutions modulo prime powers -- this should be a linear (algebra mod p) problem once the solutions mod p are known, right?",
    "created_at": "2011-08-02T16:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142786",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>I did a rebase but also have managed to mess up my 4.7.1.rc[01] builds while testing other tickets, so no guarantees...
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11036#event-28663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142787",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142788",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142789",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142790",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142791",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142792",
    "user": "https://github.com/haikona"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Looks fine; can't find any bugs, tests work, speedups as advertised. Revised patch works with 4.7.2alpha2.",
    "created_at": "2011-08-23T00:42:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142793",
    "user": "https://github.com/haikona"
}
```

<a id='comment:6'></a>Looks fine; can't find any bugs, tests work, speedups as advertised. Revised patch works with 4.7.2alpha2.
...
```json
{
    "body": "Changing author from \"\" to \"Douglas McNiel, Maarten Derickx\"",
    "created_at": "2011-08-23T00:42:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142794",
    "user": "https://github.com/haikona"
}
```

Changing author from "" to "Douglas McNiel, Maarten Derickx"
...
```json
{
    "body": "<a id='comment:7'></a>If there were things I missed -- either preexisting bugs I didn't notice or bugs I introduced -- then we should probably add doctests to make sure they stay fixed.",
    "created_at": "2011-08-23T01:01:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142795",
    "user": "https://trac.sagemath.org/admin/accounts/users/dsm"
}
```

<a id='comment:7'></a>If there were things I missed -- either preexisting bugs I didn't notice or bugs I introduced -- then we should probably add doctests to make sure they stay fixed.
...
```json
{
    "body": "<a id='comment:8'></a>the bugs I fixed where all in the existing doctests, I don't know how you got the timings because the code wasn't working at all",
    "created_at": "2011-08-23T04:16:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142796",
    "user": "https://github.com/koffie"
}
```

<a id='comment:8'></a>the bugs I fixed where all in the existing doctests, I don't know how you got the timings because the code wasn't working at all
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142797",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142798",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142799",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142800",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11036#event-28664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11036#issuecomment-142801",
    "user": "https://github.com/nexttime"
}
```
