...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145543",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This should also fix the problem at #10655.",
    "created_at": "2011-04-10T23:20:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145544",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>This should also fix the problem at #10655.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145545",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145547",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145549",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145550",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145551",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145552",
...
```json
{
    "body": "<a id='comment:10'></a>This looks very good, and I'm excited to get it in. I do see one tiny problem: in the `ffmpeg()` function, line 524, you import `have_program` but don't use it -- that's the job of `self._have_ffmpeg()`. So I think you can delete line 524.\n\nFix that up, and I think this gets a positive review.",
    "created_at": "2011-05-02T07:14:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145553",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:10'></a>This looks very good, and I'm excited to get it in. I do see one tiny problem: in the `ffmpeg()` function, line 524, you import `have_program` but don't use it -- that's the job of `self._have_ffmpeg()`. So I think you can delete line 524.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145554",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [trac_11170-animate.patch](tarball://root/attachments/some-uuid/ticket11170/trac_11170-animate.patch) by @jhpalmieri created at 2011-05-02 18:53:42\n\nReplying to [comment:10 ddrake]:\n> This looks very good, and I'm excited to get it in. I do see one tiny problem: in the `ffmpeg()` function, line 524, you import `have_program` but don't use it -- that's the job of `self._have_ffmpeg()`. So I think you can delete line 524.\n\n\nDone -- here's a new patch.  I also rebased it against 4.7.rc1 -- there were some changes to the same parts of the installation guide, so the old version wasn't applying cleanly.",
    "created_at": "2011-05-02T18:53:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145555",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>Attachment [trac_11170-animate.patch](tarball://root/attachments/some-uuid/ticket11170/trac_11170-animate.patch) by @jhpalmieri created at 2011-05-02 18:53:42
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145556",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Nice work. Let's get this in.",
    "created_at": "2011-05-03T03:02:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145557",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:12'></a>Nice work. Let's get this in.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145558",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145559",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11170#event-28952"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145560",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I'm not sure that it's a good idea to make ffmpeg the default animation method. The code I posted recently on #11313 results in a 835Kb .gif file with the ImageMagick method, but a **40MB** .gif from ffmpeg! This would seem to bode ill for sagenb.org's bandwidth... Not to mention the ffmpeg animation breaks the aspect ratio.",
    "created_at": "2011-08-04T07:43:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145561",
    "user": "https://github.com/kini"
}
```

<a id='comment:14'></a>I'm not sure that it's a good idea to make ffmpeg the default animation method. The code I posted recently on #11313 results in a 835Kb .gif file with the ImageMagick method, but a **40MB** .gif from ffmpeg! This would seem to bode ill for sagenb.org's bandwidth... Not to mention the ffmpeg animation breaks the aspect ratio.
...
```json
{
    "body": "<a id='comment:15'></a>I think you're right.  We should open another ticket and fix this.",
    "created_at": "2011-08-04T14:57:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145562",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>I think you're right.  We should open another ticket and fix this.
...
```json
{
    "body": "<a id='comment:16'></a>See #11650.",
    "created_at": "2011-08-04T17:03:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11170#issuecomment-145563",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>See #11650.
