...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n+On a 64-bit Gentoo Linux system running sage-4.7.2.alpha2:\n+\n ```\n sage: from sage.combinat.matrices.dancing_links import dlx_solver\n sage: rows = []\n@@ -40,6 +42,45 @@\n ------------------------------------------------------------------------\n ```\n \n+Note that this behaviour is actually documented in `sage/combinat/tiling.py`:\n+\n+```\n+    def is_suitable(self):\n+        r\"\"\"\n+        Return whether the volume of the box is equal to sum of the volume\n+        of the polyominoes and the number of rows sent to the DLX solver is\n+        larger than zero.\n+\n+        If these conditions are not verified, then the problem is not suitable\n+        in the sense that there are no solution.\n+\n+        .. NOTE::\n+\n+            The DLX solver throws a Segmentation Fault when the\n+            number of rows is zero::\n+\n+                sage: from sage.combinat.matrices.dancing_links import dlx_solver\n+                sage: rows = []\n+                sage: x = dlx_solver(rows)\n+                sage: x.search()        # not tested\n+                BOOM !!!\n+```\n+\n+For sage-on-gentoo, there is an assertion failure:\n+\n+```\n+sage:  x = dlx_solver(rows)\n+python2.7: sage/combinat/matrices/dancing_links_c.h:217: void dancing_links::setup_columns(): Assertion `nr_columns > 0' failed.\n+/usr/lib64/libcsage.so(print_backtrace+0x24)[0x7fea73a945f7]\n+/usr/lib64/libcsage.so(sigdie+0x1d)[0x7fea73a94687]\n+/usr/lib64/libcsage.so(sage_signal_handler+0x157)[0x7fea73a94822]\n+/lib64/libpthread.so.0(+0xfee0)[0x7fea79206ee0]\n+/lib64/libc.so.6(gsignal+0x35)[0x7fea78ea5ee5]\n+/lib64/libc.so.6(abort+0x186)[0x7fea78ea7896]\n+/lib64/libc.so.6(__assert_fail+0xf5)[0x7fea78e9e7a5]\n+/usr/lib64/python2.7/site-packages/sage/combinat/matrices/dancing_links.so(+0x855d)[0x7fea4e73255d]\n+```\n+\n Comment: 1\n \n Summary: Segmentation fault in dlx_solver\n``````\n",
    "created_at": "2011-09-19T14:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160973",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160975",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31144"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31145"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31146"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31147"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31148"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31149"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I just pushed a branch (based on 6.6.rc2) where the segmentation fault is catch using sig_on and sig_off. \n\nDo we want to also solve the segmentation fault itself in this ticket?\n\n---\nNew commits:",
    "created_at": "2015-07-24T13:03:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160976",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:10'></a>I just pushed a branch (based on 6.6.rc2) where the segmentation fault is catch using sig_on and sig_off. 
...
```json
{
    "body": "Changing commit from \"\" to \"8ee8dd81d654d6d68baa335b15251a2427c3dc8e\"",
    "created_at": "2015-07-24T13:03:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160977",
    "user": "https://github.com/seblabbe"
}
```

Changing commit from "" to "8ee8dd81d654d6d68baa335b15251a2427c3dc8e"
...
```json
{
    "body": "Changing branch from \"\" to \"u/slabbe/11814\"",
    "created_at": "2015-07-24T13:03:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160978",
    "user": "https://github.com/seblabbe"
}
```

Changing branch from "" to "u/slabbe/11814"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160979",
...
```json
{
    "body": "Changing commit from \"8ee8dd81d654d6d68baa335b15251a2427c3dc8e\" to \"25741dfc1c52709faa59042024248824247275f4\"",
    "created_at": "2015-07-24T13:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160980",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "8ee8dd81d654d6d68baa335b15251a2427c3dc8e" to "25741dfc1c52709faa59042024248824247275f4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160981",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Also: add your author name please.",
    "created_at": "2015-07-24T13:52:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160982",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>Also: add your author name please.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160983",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"25741dfc1c52709faa59042024248824247275f4\" to \"35f074c4a0a48af5583582e25fe76d0483ca7778\"",
    "created_at": "2015-07-25T07:40:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160984",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "25741dfc1c52709faa59042024248824247275f4" to "35f074c4a0a48af5583582e25fe76d0483ca7778"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160985",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160986",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160987",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160988",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Why needs_work?",
    "created_at": "2015-07-25T09:21:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160989",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>Why needs_work?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160990",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"35f074c4a0a48af5583582e25fe76d0483ca7778\" to \"549575955408f4ca4c8c24341c6c8149d14e4a1d\"",
    "created_at": "2015-07-25T09:33:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160991",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "35f074c4a0a48af5583582e25fe76d0483ca7778" to "549575955408f4ca4c8c24341c6c8149d14e4a1d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160992",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160993",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>I also removed the `dumps` method which was broken and useless:\n\n```\nsage: x = dlx_solver([])                                                \nsage: x.dumps()                                          \nTraceback (most ...\n...              \nAttributeError: 'list' object has no attribute 'dumps'   \n```\n\nI was about to remove `make_dlxwrapper` from the sage namespace, but decided it belongs to another ticket.",
    "created_at": "2015-07-25T09:44:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160994",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:22'></a>I also removed the `dumps` method which was broken and useless:
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31150"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160995",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>The initialization of `self.rows` is a pure Python-level initialization, so I recommend to move it to `__init__` instead of `__cinit__`.",
    "created_at": "2015-07-25T10:10:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160996",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>The initialization of `self.rows` is a pure Python-level initialization, so I recommend to move it to `__init__` instead of `__cinit__`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160997",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing branch from \"u/slabbe/11814\" to \"u/jdemeyer/11814\"",
    "created_at": "2015-07-25T10:40:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160998",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "u/slabbe/11814" to "u/jdemeyer/11814"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-160999",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>I took the opportunity to fix the initialization even more and really clean up the whole file.\n\n---\nNew commits:",
    "created_at": "2015-07-25T11:02:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161000",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:26'></a>I took the opportunity to fix the initialization even more and really clean up the whole file.
...
```json
{
    "body": "Changing commit from \"549575955408f4ca4c8c24341c6c8149d14e4a1d\" to \"392b62c70d342679c41799e0b45857c537ad8a8e\"",
    "created_at": "2015-07-25T11:02:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161001",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "549575955408f4ca4c8c24341c6c8149d14e4a1d" to "392b62c70d342679c41799e0b45857c537ad8a8e"
...
```json
{
    "body": "<a id='comment:27'></a>Great! I was feeling those `Py_INCREF` were not necessary and old fashion. You were the good guy to clean/update that part. I removed the `cimport Integer` which was unused.\n\nThere is one doctest failing in `combinat/tiling.py` because of the `__str__ -> __repr__` change. I did not fix the doctest because I wonder if showing a list of list is really what we want for the `__repr__`? Maybe a repr saying `Dancing links of 34 rows` would be better together with a method `rows` returning the rows?\n\n---\nNew commits:",
    "created_at": "2015-07-25T11:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161002",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:27'></a>Great! I was feeling those `Py_INCREF` were not necessary and old fashion. You were the good guy to clean/update that part. I removed the `cimport Integer` which was unused.
...
```json
{
    "body": "Changing commit from \"392b62c70d342679c41799e0b45857c537ad8a8e\" to \"3a3dd8be8ff50d04bc84dc60401ea9af11871af6\"",
    "created_at": "2015-07-25T11:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161003",
    "user": "https://github.com/seblabbe"
}
```

Changing commit from "392b62c70d342679c41799e0b45857c537ad8a8e" to "3a3dd8be8ff50d04bc84dc60401ea9af11871af6"
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/11814\" to \"u/slabbe/11814\"",
    "created_at": "2015-07-25T11:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161004",
    "user": "https://github.com/seblabbe"
}
```

Changing branch from "u/jdemeyer/11814" to "u/slabbe/11814"
...
```json
{
    "body": "<a id='comment:28'></a>Note: I started to fix the repr thing. Will push something soon.",
    "created_at": "2015-07-25T11:21:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161005",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:28'></a>Note: I started to fix the repr thing. Will push something soon.
...
```json
{
    "body": "<a id='comment:29'></a>I would prefer to see the rows in `__repr__`, so maybe `Dancing links of 2 rows [0,1,2], [0,2]`.\n\nNote: the only reason I changed it is because it looked strange to me that the class had a `__str__` method but not a `__repr__`.",
    "created_at": "2015-07-25T11:44:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161006",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>I would prefer to see the rows in `__repr__`, so maybe `Dancing links of 2 rows [0,1,2], [0,2]`.
...
```json
{
    "body": "Changing commit from \"3a3dd8be8ff50d04bc84dc60401ea9af11871af6\" to \"56c74ed227fb8def88644a7e2371bd33701d8f28\"",
    "created_at": "2015-07-25T11:47:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161007",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "3a3dd8be8ff50d04bc84dc60401ea9af11871af6" to "56c74ed227fb8def88644a7e2371bd33701d8f28"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161008",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>There is a doctest failure in `src/sage/games/quantumino.py` related to the printing.",
    "created_at": "2015-07-25T11:56:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161010",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:32'></a>There is a doctest failure in `src/sage/games/quantumino.py` related to the printing.
...
```json
{
    "body": "Changing commit from \"56c74ed227fb8def88644a7e2371bd33701d8f28\" to \"e2b82a4b7b035d84955c3c15a41cd740fc050eaf\"",
    "created_at": "2015-07-25T12:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161011",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "56c74ed227fb8def88644a7e2371bd33701d8f28" to "e2b82a4b7b035d84955c3c15a41cd740fc050eaf"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161012",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Just to say that I agree with the changes made by Jeroen in this ticket.",
    "created_at": "2015-07-25T12:16:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161013",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:34'></a>Just to say that I agree with the changes made by Jeroen in this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161014",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161015",
...
```json
{
    "body": "<a id='comment:37'></a>S\u00e9bastien, I won't have time in the coming month to look at this. If other people want to fix and to review, go ahead...",
    "created_at": "2015-07-27T07:41:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161017",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:37'></a>Sébastien, I won't have time in the coming month to look at this. If other people want to fix and to review, go ahead...
...
```json
{
    "body": "<a id='comment:39'></a>You need to compile Python and everything that links to it, the only sure way is starting with make distclean imho.",
    "created_at": "2015-07-27T19:57:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161019",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:39'></a>You need to compile Python and everything that links to it, the only sure way is starting with make distclean imho.
...
```json
{
    "body": "Changing commit from \"e2b82a4b7b035d84955c3c15a41cd740fc050eaf\" to \"dcdfd06c1e924a72a49cf0c13929930ddcb61e08\"",
    "created_at": "2015-07-28T19:13:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161020",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e2b82a4b7b035d84955c3c15a41cd740fc050eaf" to "dcdfd06c1e924a72a49cf0c13929930ddcb61e08"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161021",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161022",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161023",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"u/slabbe/11814\" to \"dcdfd06c1e924a72a49cf0c13929930ddcb61e08\"",
    "created_at": "2015-07-29T09:22:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161024",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/slabbe/11814" to "dcdfd06c1e924a72a49cf0c13929930ddcb61e08"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11814#issuecomment-161025",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11814",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11814#event-31152"
}
```
