...
```json
{
    "body": "Attachment [pwittvectors.patch](tarball://root/attachments/some-uuid/ticket11457/pwittvectors.patch) by @roed314 created at 2013-02-05 07:12:54\n\nIt looks like the newest patch is formatted fine.\n\nDoes coercion from the integers into a ring of Witt Vectors work right?  What is the image of p?",
