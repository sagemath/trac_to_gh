...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140371",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I forgot to copy-and-paste two lines from the example...",
    "created_at": "2011-10-03T16:49:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140372",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>I forgot to copy-and-paste two lines from the example...
...
```json
{
    "body": "<a id='comment:2'></a>It seems that the approach \"make `NCPolynomialRing_plural` a subclass of `MPolynomialRing_libsingular`\" is easy.\n\nHowever, that change is so small that I tend to include it where I really need it: In #11878. So, this should be closed.",
    "created_at": "2011-10-03T21:02:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140373",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>It seems that the approach "make `NCPolynomialRing_plural` a subclass of `MPolynomialRing_libsingular`" is easy.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140374",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140375",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>There is a function called `is_sage_wrapper_for_singular_ring` in the plural patch.\nThe comment says that it's broken (for whatever reason).\nShouldn't it be the right place for this check?",
    "created_at": "2011-10-04T06:33:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140376",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```

<a id='comment:3'></a>There is a function called `is_sage_wrapper_for_singular_ring` in the plural patch.
The comment says that it's broken (for whatever reason).
Shouldn't it be the right place for this check?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140377",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11892#issuecomment-140378",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31429"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31430"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31431"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31432"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31433"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31434"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11892#event-31435"
}
```
