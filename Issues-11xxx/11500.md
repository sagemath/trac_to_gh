...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-139997"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-139998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-139999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118940",
    "user": "https://github.com/sagetrac-travis"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118941",
    "user": "https://github.com/kcrisman"
}
```
