...
```json
{
    "body": "I cannot reproduce this. Could you run it with set_verbose at least 2 to see where it hangs ? I don't know which line uses KASH...",
...
```json
{
    "body": "Attachment [11936.patch](tarball://root/attachments/some-uuid/ticket11936/11936.patch) by johanbosman created at 2011-11-08 15:03:46\n\nKash does not support Galois group computations if the degree is larger than 23.  I've attached a patch that avoids this.",
    "created_at": "2011-11-08T15:03:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11936",
    "type": "issue_comment",
...
Attachment [11936.patch](tarball://root/attachments/some-uuid/ticket11936/11936.patch) by johanbosman created at 2011-11-08 15:03:46
...
```json
{
    "body": "Added the dependency #11937 to pass doctest.",
