...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143646",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [11081-install-from-source.patch](tarball://root/attachments/some-uuid/ticket11081/11081-install-from-source.patch) by @jhpalmieri created at 2011-03-29 14:47:29",
    "created_at": "2011-03-29T14:47:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143647",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>Attachment [11081-install-from-source.patch](tarball://root/attachments/some-uuid/ticket11081/11081-install-from-source.patch) by @jhpalmieri created at 2011-03-29 14:47:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143650",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143651",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> >  * A minor note should be added that gfortran is not provided by Xcode on OS X, but that Sage provides a suitable Fortran compiler for OS X.\n \n> \n> I can add that, though the current documentation does say in this very file:\n> \n> *On Mac OS X, you are not required to have a Fortran compiler on your system. The Sage source distribution is shipped with a Fortran compiler for Mac OS X. This Fortran compiler is used, unless you specify another Fortran compiler via the variable SAGE_FORTRAN.*\n\n\nIs it anywhere near where your thing is?  My concern was people on OS X thinking they needed to get/had gfortran.\n\n> >  * Even for my ancient < 1 GHz Emac (probably from around 2003), it takes less than a minute for Sage to start up the first time (though it's close!).  I think it is more reasonable to say \"starting the first time may take more than a few seconds; a few platforms will take longer for reason X\" where it is clear that reason X is something about the platform, not Sage.\n \n> \n> I hear plenty of complaints on sage-devel of Sage taking a very long time to start. \n\n\nThey mean >5 sec, or >2 sec. on a fresh cache.  Not minutes.  Anyway, there are very few systems, I think, where 'minutes' is the right word, and we don't want to scare people.\n\n> >  * \"**Note from David Kirkby.** \" - is that going to look ok in the docs?  Maybe instead using the \".. note:\" syntax...\n \n> \n> In my opinion it looked ok, but perhaps I'm biased. I don't know how to use the *note syntax*. I wanted to make this quite prominent, as I think its a pretty important point. We are documenting how to do something that any decent system administer knows one should never do. \n\nI haven't looked at it in the doc yet, so we'll see when we get there.",
    "created_at": "2011-04-01T18:13:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143652",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>> >  * A minor note should be added that gfortran is not provided by Xcode on OS X, but that Sage provides a suitable Fortran compiler for OS X.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143653",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Line 131 in the new file: it is false that PARI needs `perl` (it might have been true some time in the past, I don't know).  Only the PARI/GP *documentation* (not installed or used by default) needs `perl`.\n\nLine 752 in the new file: the comment about PARI's galois data files is also completely outdated and should be removed.\n\nBy the way, \"starting the first time can take a few minutes\" is totally true when you have a slow disk on a busy system (e.g. sage.math.washington.edu)",
    "created_at": "2011-04-01T20:51:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143654",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Line 131 in the new file: it is false that PARI needs `perl` (it might have been true some time in the past, I don't know).  Only the PARI/GP *documentation* (not installed or used by default) needs `perl`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143655",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143656",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143657",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143658",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143660",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143661",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143662",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [11081-install-from-source-Additional-information.patch](tarball://root/attachments/some-uuid/ticket11081/11081-install-from-source-Additional-information.patch) by drkirkby created at 2011-04-04 01:49:34",
    "created_at": "2011-04-04T01:49:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143663",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:13'></a>Attachment [11081-install-from-source-Additional-information.patch](tarball://root/attachments/some-uuid/ticket11081/11081-install-from-source-Additional-information.patch) by drkirkby created at 2011-04-04 01:49:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143665",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143666",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143668",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143670",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I'll attach another patch in a couple of minutes, using the *comment* as suggested by John. I also noticed another typo, and a couple of very minor changes.",
    "created_at": "2011-04-04T22:45:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143671",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:19'></a>I'll attach another patch in a couple of minutes, using the *comment* as suggested by John. I also noticed another typo, and a couple of very minor changes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143672",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143673",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143674",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I'm marking this for \"needs review\" now.",
    "created_at": "2011-04-04T22:49:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143675",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:20'></a>I'm marking this for "needs review" now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143676",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143677",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143678",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Attachment [11081-dont-use_GCC_4_3_2.patch](tarball://root/attachments/some-uuid/ticket11081/11081-dont-use_GCC_4_3_2.patch) by drkirkby created at 2011-04-05 23:33:12\n\nI changed the supported version of gcc to say not to use gcc 4.3.2, as apparently this mis-compiles MPIR according to Bill Hart who is an MPIR developer.",
    "created_at": "2011-04-05T23:33:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143679",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:21'></a>Attachment [11081-dont-use_GCC_4_3_2.patch](tarball://root/attachments/some-uuid/ticket11081/11081-dont-use_GCC_4_3_2.patch) by drkirkby created at 2011-04-05 23:33:12
...
```json
{
    "body": "<a id='comment:22'></a>David, there are so many bad versions of gcc miscompiling various packages that it's pointless to start making a list.  Better state something along the lines of \"(Version 4.0.1 or later, but preferably a recent version)\"",
    "created_at": "2011-04-06T07:18:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143680",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>David, there are so many bad versions of gcc miscompiling various packages that it's pointless to start making a list.  Better state something along the lines of "(Version 4.0.1 or later, but preferably a recent version)"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143681",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143682",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>PARI does not build with:\n1. gcc 4.4.1 (#10120)\n2. gcc 4.5.1 on Itanium (#9897, [http://gcc.gnu.org/bugzilla/show_bug.cgi?id=46044](http://gcc.gnu.org/bugzilla/show_bug.cgi?id=46044))",
    "created_at": "2011-04-06T08:00:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143683",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>PARI does not build with:
1. gcc 4.4.1 (#10120)
2. gcc 4.5.1 on Itanium (#9897, [http://gcc.gnu.org/bugzilla/show_bug.cgi?id=46044](http://gcc.gnu.org/bugzilla/show_bug.cgi?id=46044))
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143684",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143685",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Attachment [11081-use-recent-gcc.patch](tarball://root/attachments/some-uuid/ticket11081/11081-use-recent-gcc.patch) by drkirkby created at 2011-04-06 08:08:50",
    "created_at": "2011-04-06T08:08:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143686",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:25'></a>Attachment [11081-use-recent-gcc.patch](tarball://root/attachments/some-uuid/ticket11081/11081-use-recent-gcc.patch) by drkirkby created at 2011-04-06 08:08:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143687",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>OK, I dropped mention of that specific version, and made a general comment to use a recent one, but noted that particular versions have failed on specific platforms. \n\nIt would be good if there was a version which worked on every platform.",
    "created_at": "2011-04-06T08:10:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143688",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:27'></a>OK, I dropped mention of that specific version, and made a general comment to use a recent one, but noted that particular versions have failed on specific platforms. 
...
```json
{
    "body": "<a id='comment:28'></a>Does anyone feel able to give this a positive review? I'm sure this whole section could be cleaned up further, but I think this is a substantial improvement over what we currently have. \n\nDave",
    "created_at": "2011-04-06T22:13:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143689",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:28'></a>Does anyone feel able to give this a positive review? I'm sure this whole section could be cleaned up further, but I think this is a substantial improvement over what we currently have. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143690",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143691",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>Attachment [11081_all.patch](tarball://root/attachments/some-uuid/ticket11081/11081_all.patch) by @jdemeyer created at 2011-04-07 13:56:53",
    "created_at": "2011-04-07T13:56:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143692",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>Attachment [11081_all.patch](tarball://root/attachments/some-uuid/ticket11081/11081_all.patch) by @jdemeyer created at 2011-04-07 13:56:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143694",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143695",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143696",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11081#event-28755"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143697",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11081#issuecomment-143698",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
