...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145377",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The attached patch is ready for review.  It does *nothing* but changed the docstring for the order_of_vanishing function, by deleting the offending and incorrect paragraph, and a related incorrect doctest.  I also added a rank 2 and rank 3 doctest to replace having deleted a rank 2 doctest.",
    "created_at": "2011-04-09T18:26:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145378",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>The attached patch is ready for review.  It does *nothing* but changed the docstring for the order_of_vanishing function, by deleting the offending and incorrect paragraph, and a related incorrect doctest.  I also added a rank 2 and rank 3 doctest to replace having deleted a rank 2 doctest.
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_11163.patch](tarball://root/attachments/some-uuid/ticket11163/trac_11163.patch) by @loefflerd created at 2011-04-10 08:06:13\n\nYes, this looks fine. (However: William, would you mind using the more specific trac ticket categories \"elliptic curves\", \"modular forms\", etc, rather than just bunging everything in \"number theory\"?)",
    "created_at": "2011-04-10T08:06:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145379",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:2'></a>Attachment [trac_11163.patch](tarball://root/attachments/some-uuid/ticket11163/trac_11163.patch) by @loefflerd created at 2011-04-10 08:06:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145380",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145381",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145382",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145383",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145385",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11163#event-28931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11163#issuecomment-145386",
    "user": "https://github.com/jdemeyer"
}
```
