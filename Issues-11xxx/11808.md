...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31094"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31095"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31096"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31097"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31098"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31099"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11808#issuecomment-138793",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31101"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11808#issuecomment-138794",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31103"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31104"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Updating ticket description after #18036 was merged in 9.3.beta2.\n\nThis, which was failing in the original report, now works:\n\n```\nsage: MPC(1) + i\n1.00000000000000 + 1.00000000000000*I\n```\nbut this still fails:\n\n```\nsage: MPC(1) + SR(i)\n```",
    "created_at": "2021-04-29T11:05:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11808#issuecomment-138795",
    "user": "https://github.com/slel"
}
```

<a id='comment:7'></a>Updating ticket description after #18036 was merged in 9.3.beta2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11808#issuecomment-138796",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31105"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31106"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31107"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31108"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31109"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31110"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31111"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11808#event-31112"
}
```
