...
```json
{
    "body": "<a id='comment:2'></a>leif -- I have no proposal, I just want *something*, anything, that actually works, so I can get back to work.",
    "created_at": "2011-08-12T17:12:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157466",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>leif -- I have no proposal, I just want *something*, anything, that actually works, so I can get back to work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157467",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157469",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Just noticed `sage/misc/cython.py` is more complicated than I expected (and not fully up-to-date, e.g. w.r.t. `cython`'s `--cplus` option, which isn't used yet), but adding at least support for C99 should be easy.\n\nWill give it a try...\n\nAny nice Cython examples to test with?",
    "created_at": "2011-08-12T20:36:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157470",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>Just noticed `sage/misc/cython.py` is more complicated than I expected (and not fully up-to-date, e.g. w.r.t. `cython`'s `--cplus` option, which isn't used yet), but adding at least support for C99 should be easy.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157471",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157472",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [test.spyx](tarball://root/attachments/some-uuid/ticket11680/test.spyx) by @malb created at 2011-08-22 06:20:28\n\nHi, I've addeded cflags which are just passed to extra_compile_args. I only fixed enough things in cython.py such that the attached test.spyx works, e.g. I didn't fix adding `--cplus` etc.",
    "created_at": "2011-08-22T06:20:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157473",
    "user": "https://github.com/malb"
}
```

<a id='comment:7'></a>Attachment [test.spyx](tarball://root/attachments/some-uuid/ticket11680/test.spyx) by @malb created at 2011-08-22 06:20:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157474",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157477",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I was refereeing the patch and fixed a doctest failure in it (?).  Then I decided I wanted that .pyx file in my original input in a doctest, and setup infrastructure to do that, and did it.   So the new patch (which is merged with yours, with both our names) is longer than your original patch.  Since I'm happy with yours, if you (=malb) can review this (especially my new code), then it is reviewed.",
    "created_at": "2011-08-23T09:38:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157479",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:12'></a>I was refereeing the patch and fixed a doctest failure in it (?).  Then I decided I wanted that .pyx file in my original input in a doctest, and setup infrastructure to do that, and did it.   So the new patch (which is merged with yours, with both our names) is longer than your original patch.  Since I'm happy with yours, if you (=malb) can review this (especially my new code), then it is reviewed.
...
```json
{
    "body": "<a id='comment:13'></a>Patch looks good but I wonder whether we should support replacing `<SAGE_ROOT>` with `SAGE_ROOT` not only in tests but in general. It'd make pyx files more portable.",
    "created_at": "2011-08-23T20:39:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157480",
    "user": "https://github.com/malb"
}
```

<a id='comment:13'></a>Patch looks good but I wonder whether we should support replacing `<SAGE_ROOT>` with `SAGE_ROOT` not only in tests but in general. It'd make pyx files more portable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157481",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I am happy with this version if you are.",
    "created_at": "2011-08-23T20:55:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157482",
    "user": "https://github.com/malb"
}
```

<a id='comment:14'></a>I am happy with this version if you are.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157483",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157484",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157485",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>When #11761 gets approved, we can move using `# distutils: language = c++` which is understood by Cython and can be used to specify any Extension options. See http://wiki.cython.org/enhancements/distutils_preprocessing",
    "created_at": "2011-09-01T17:58:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157486",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:18'></a>When #11761 gets approved, we can move using `# distutils: language = c++` which is understood by Cython and can be used to specify any Extension options. See http://wiki.cython.org/enhancements/distutils_preprocessing
...
```json
{
    "body": "<a id='comment:19'></a>Shouldn't we make this ticket depend on #11761 then and adapt it accordingly? It doesn't seem to be a good idea to change the syntax that often?",
    "created_at": "2011-09-05T18:39:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157487",
    "user": "https://github.com/malb"
}
```

<a id='comment:19'></a>Shouldn't we make this ticket depend on #11761 then and adapt it accordingly? It doesn't seem to be a good idea to change the syntax that often?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157488",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"William Stein, Leif Leonhardy\"",
    "created_at": "2011-09-05T19:05:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157489",
    "user": "https://github.com/nexttime"
}
```

Changing reviewer from "" to "William Stein, Leif Leonhardy"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157490",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157491",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11680#event-30678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157492",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Revisiting this, I don't think the `TESTS` dictionary and the `import_test()` function should be part of the module itself at all, as they provide no functionality. (I actually reviewed an earlier version of the patch.)\n\nThey should either be part of *the docstring* as an -- of course longer -- example, or somewhere in `sage/tests/`.\n\n\n\n\nW.r.t. the temporary files:\n\nI think it is a more general problem that Cython apparently puts temporary files into the current working directory, just mangling the original path, and, secondly, not deleting them afterwards.\n\nI'm pretty sure I've seen similar files sporadically occurring without ever getting deleted in previous releases (i.e., e.g. last year).",
    "created_at": "2011-10-01T18:37:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157494",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:24'></a>Revisiting this, I don't think the `TESTS` dictionary and the `import_test()` function should be part of the module itself at all, as they provide no functionality. (I actually reviewed an earlier version of the patch.)
...
```json
{
    "body": "<a id='comment:25'></a>P.S.: But John's suggestion is IMHO -- perhaps as a temporary fix only -- ok here (in that it should fix the issue in an easy way), since using `sage.server.support.cython_import()` *for this purpose* is simply an abuse of that function... ;-)\n\nMaybe we should also use `create_local_c_file=False`; I guess that also suppresses the HTML counterpart.",
    "created_at": "2011-10-01T18:50:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157495",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:25'></a>P.S.: But John's suggestion is IMHO -- perhaps as a temporary fix only -- ok here (in that it should fix the issue in an easy way), since using `sage.server.support.cython_import()` *for this purpose* is simply an abuse of that function... ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157496",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>We definitely want `create_local_c_file=False`, not just `annotate=False`, because there are c files being created as well.  I've created #11887 to deal with this.",
    "created_at": "2011-10-01T19:44:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157497",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:27'></a>We definitely want `create_local_c_file=False`, not just `annotate=False`, because there are c files being created as well.  I've created #11887 to deal with this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11680#issuecomment-157498",
    "user": "https://github.com/nexttime"
}
```
