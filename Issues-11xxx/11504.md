...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11504#event-140094"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11504#event-140095"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11504#event-140096"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11504#issuecomment-119090",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11504#issuecomment-119091",
    "user": "https://github.com/nexttime"
}
```
