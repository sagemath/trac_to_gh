...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148306",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148307",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148308",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The patch rectifies the defects.  It also incorporates enhancements for both class groups and S-class groups.\n\nIn particular:\n\nThe computation of S-class groups is made faster when the ideals in S are all principal.\n\nThe computation of ideal_class_logs is speeded up by setting a pari flag.\n\nThe code for S-class groups is made more compatible with that for class groups.",
    "created_at": "2011-06-03T07:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148309",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```

<a id='comment:1'></a>The patch rectifies the defects.  It also incorporates enhancements for both class groups and S-class groups.
...
```json
{
    "body": "<a id='comment:2'></a>Looks good to me, and applies fine to 4.7.1.alpha1 and all tests pass.\n\nI've added rlm to the CC list since I think he implemented this originally, and hope he'll take a look too.",
    "created_at": "2011-06-03T13:52:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148310",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>Looks good to me, and applies fine to 4.7.1.alpha1 and all tests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148311",
...
```json
{
    "body": "<a id='comment:4'></a>Let's give it a positive review, since I clearly thought it deserved that 5 weeks ago!\nMarco, you can add your name as reviewer if appropriate.",
    "created_at": "2011-07-05T16:04:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148312",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>Let's give it a positive review, since I clearly thought it deserved that 5 weeks ago!
Marco, you can add your name as reviewer if appropriate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148313",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148314",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11304#event-29284"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Replying to [mstreng](#comment%3A3):\n> Replying to [cremona](#comment%3A2):\n> > Looks good to me, and applies fine to 4.7.1.alpha1 and all tests pass.\n> > \n> > I've added rlm to the CC list since I think he implemented this originally, and hope he'll take a look too.\n\n> \n> As Robert doesn't seem to reply, do you want to give this a positive review, or have someone else review it too?\n\n\nSorry for the delay, but I can add that the changes here look good to me too.",
    "created_at": "2011-07-24T06:07:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148315",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:6'></a>Replying to [mstreng](#comment%3A3):
> Replying to [cremona](#comment%3A2):
> > Looks good to me, and applies fine to 4.7.1.alpha1 and all tests pass.
> > 
> > I've added rlm to the CC list since I think he implemented this originally, and hope he'll take a look too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11304#event-29285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148316",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11304#issuecomment-148317",
    "user": "https://github.com/jdemeyer"
}
```
