...
```json
{
    "body": "**Attachment:** [trac_11244_reenable_deprecationwarnings_in_python27.patch](https://github.com/sagemath/sage/files/ticket11244/trac_11244_reenable_deprecationwarnings_in_python27.patch)\n\nnew patch to restore deprecation warnings in python 2.7 (now in git format)",
    "created_at": "2011-04-24T03:52:02Z",
    "issue": "https://github.com/sagemath/sage/issues/11244",
    "type": "issue_comment",
...
archive/attachments_015256.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_015257.json:
```json
{
    "asset_content_type": "application/octet-stream",
