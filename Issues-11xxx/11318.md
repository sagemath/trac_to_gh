...
```json
{
    "body": "<a id='comment:1'></a>See #6670 for a related ticket: it implements group algebras using `CombinatorialFreeModule`, so it accomplishes some of what's being discussed here.  By the way, with `G.algebra(R)`, I don't like the way elements are printed (using \"B[...]\") \u2014 it's not a very standard way to write elements in a group algebra.",
    "created_at": "2011-08-02T16:59:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11318#issuecomment-121920",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>See #6670 for a related ticket: it implements group algebras using `CombinatorialFreeModule`, so it accomplishes some of what's being discussed here.  By the way, with `G.algebra(R)`, I don't like the way elements are printed (using "B[...]") — it's not a very standard way to write elements in a group algebra.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11318#issuecomment-121921",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11318#issuecomment-121922",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29315"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29316"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29317"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29318"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29319"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29320"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11318#event-29321"
}
```
