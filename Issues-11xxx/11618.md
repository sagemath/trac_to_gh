...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134739",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134740",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>The attached patch fixes the inconsistency and adds a doctest for the case given.\n\nI've removed superfluous parentheses (and white space) and also converted some tabs to spaces. (I thought the merge script would reject patches introducing new tabs after all got converted a while ago.)",
    "created_at": "2011-07-22T06:01:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134741",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>The attached patch fixes the inconsistency and adds a doctest for the case given.
...
```json
{
    "body": "<a id='comment:3'></a>Hmmm,\n\n```python\nans = [ {x: self.parent().var('r1')} ]\n```\nwould perhaps have been a bit more readable...",
    "created_at": "2011-07-22T06:18:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134742",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Hmmm,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134743",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_11618-fix_solution_dict_for_infinitely_many_solutions.sagelib.patch](tarball://root/attachments/some-uuid/ticket11618/trac_11618-fix_solution_dict_for_infinitely_many_solutions.sagelib.patch) by @nexttime created at 2011-07-22 19:29:11\n\nReplying to [comment:3 leif]:\n> [...] would perhaps have been a bit more readable.\n\n\nI've updated the patch to directly construct the solution dictionary.\n\n(Leif doesn't work without coffee.)\n\n---\n\nHey patchbot, apply: [attachment:trac_11618-fix_solution_dict_for_infinitely_many_solutions.sagelib.patch]!",
    "created_at": "2011-07-22T19:29:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134744",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>Attachment [trac_11618-fix_solution_dict_for_infinitely_many_solutions.sagelib.patch](tarball://root/attachments/some-uuid/ticket11618/trac_11618-fix_solution_dict_for_infinitely_many_solutions.sagelib.patch) by @nexttime created at 2011-07-22 19:29:11
...
```json
{
    "body": "<a id='comment:5'></a>The dependency I've added is (more or less) just for the patchbot. (#8553 was merged into Sage 4.7.1.alpha2.)",
    "created_at": "2011-07-22T20:01:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134745",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:5'></a>The dependency I've added is (more or less) just for the patchbot. (#8553 was merged into Sage 4.7.1.alpha2.)
...
```json
{
    "body": "<a id='comment:6'></a>Thanks for posting this patch - I'll try to take a look at this (relatively) soon, as it looks straightforward.",
    "created_at": "2011-07-29T19:10:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134746",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Thanks for posting this patch - I'll try to take a look at this (relatively) soon, as it looks straightforward.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134747",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134748",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Patch looks good.  Performs as advertised.   Thanks!",
    "created_at": "2011-08-01T18:37:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134749",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>Patch looks good.  Performs as advertised.   Thanks!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11618#issuecomment-134750",
