...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129577",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,3 +19,7 @@\n \n See also [The Tragedy of Bash](http://uselessuseofcat.com/?p=346).\n \n+---\n+\n+Apply [attachment: trac_11993-fix_sage_--version.scripts.patch.gz](https://github.com/sagemath/sage/files/ticket11993/trac_11993-fix_sage_--version.scripts.patch.gz) to the Sage **scripts** repository.\n+\n``````\n",
    "created_at": "2011-11-05T07:50:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129578",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129579",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129580",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129581",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129582",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129583",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148307"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129584",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129585",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129586",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129587",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129588",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148312"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129589",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129590",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11993#event-148315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11993#issuecomment-129591",
    "user": "https://github.com/jdemeyer"
}
```
