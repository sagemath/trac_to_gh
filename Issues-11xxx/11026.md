...
```json
{
    "body": "<a id='comment:13'></a>\nI just rebased this, because of a slight change when `sage-env` was moved.  Shouldn't have any other new notebook problems, see [comment:12](#comment%3A12):ticket:10556. Now it's time to look at it!\n\nDependencies include #13121, where #8473 will eventually live.\n\nApply [attachment:trac_11026-extcode-rebase.patch] to the extcode repository.",
    "created_at": "2012-07-06T00:06:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
