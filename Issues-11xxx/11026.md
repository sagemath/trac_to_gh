...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n \n ---\n \n-Apply [attachment: trac_11026-extcode.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) to the extcode repository.\n+Apply [attachment: trac_11026-extcode.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) and [attachment: trac_11026-extcode.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) to the extcode repository.\n``````\n",
...
```json
{
    "body": "<div id=\"comment:57\" align=\"right\">Comment 57</div>\n\nReplying to [@sagetrac-nkirchner](#comment%3A56):\n> With the extcode patch and the fix-parse-error patch, Sage.app:\n> \n> * starts and stops the server properly,\n> * handles .txt, .txt.zip, and .sws files properly when they are opened from Finder,\n> * hasn't started the server twice in my testing.\n\nYippee!",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n \n ---\n \n-Apply [attachment: trac_11026-extcode.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) and [attachment: trac_11026-extcode.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) to the extcode repository.\n+Apply [attachment: trac_11026-extcode.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) and [attachment: trac_11026-fix-parse-error.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-fix-parse-error.patch.gz) to the extcode repository.\n``````\n",
...
```json
{
    "body": "<div id=\"comment:74\" align=\"right\">Comment 74</div>\n\nI am happy with [attachment: trac_11026-plist-strings.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-plist-strings.patch.gz) and [attachment: trac_11026-warnings.patch](https://github.com/sagemath/sage/files/ticket11026/trac_11026-warnings.patch.gz).",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-133614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-133615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-133616"
}
```
