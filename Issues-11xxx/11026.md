...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129193"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129201"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,6 @@\n With #8473 we have the necessary support for uploading files.  This allows the Mac app to support double clicking of sws files.  Also able to be opened are txt and zip files.\n+\n+\n+---\n+\n+Apply [attachment: trac_11026-extcode-rebase.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode-rebase.patch.gz) to the extcode repository.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129205"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n \n ---\n \n-Apply [attachment: trac_11026-extcode-rebase.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode-rebase.patch.gz) to the extcode repository.\n+Apply [attachment: trac_11026-extcode.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) to the extcode repository.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129207"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n \n ---\n \n-Apply [attachment: trac_11026-extcode.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) to the extcode repository.\n+Apply [attachment: trac_11026-extcode-rebase.2.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode-rebase.2.patch.gz) to the extcode repository.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129211"
}
```
...
```json
{
    "body": "Changed reviewer from **Karl-Dieter Crisman** to **Karl-Dieter Crisman, Nicholas Kirchner**",
    "created_at": "2013-01-10T17:22:42Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
...
Changed reviewer from **Karl-Dieter Crisman** to **Karl-Dieter Crisman, Nicholas Kirchner**
...
```json
{
    "body": "Changed dependencies from **#8473, #13121** to none",
...
Changed dependencies from **#8473, #13121** to none
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n \n ---\n \n-Apply [attachment: trac_11026-extcode.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz) to the extcode repository.\n+Apply [and [attachment: trac_11026-extcode.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz)(https://github.com/sagemath/sage/files/ticket11026/9e9fb296680bb15e2cd06c40348606d7.gz) to the extcode repository.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110878",
    "user": "https://github.com/sagetrac-nkirchner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110879",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110880",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110881",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110882",
    "user": "https://github.com/sagetrac-nkirchner"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n \n ---\n \n-Apply [and [attachment: trac_11026-extcode.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-extcode.patch.gz)(https://github.com/sagemath/sage/files/ticket11026/9e9fb296680bb15e2cd06c40348606d7.gz) to the extcode repository.\n+Apply [and [attachment: trac_11026-fix-parse-error.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-fix-parse-error.patch.gz)(https://github.com/sagemath/sage/files/ticket11026/9e9fb296680bb15e2cd06c40348606d7.gz) to the extcode repository.\n``````\n",
    "created_at": "2013-01-31T15:17:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110883",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110884",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110885",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110886",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110887",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110888",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110889",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Changed reviewer from **Karl-Dieter Crisman, Nicholas Kirchner** to **Karl-Dieter Crisman, Nicholas Kirchner, John Palmieri**",
    "created_at": "2013-02-12T20:54:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110890",
    "user": "https://github.com/kcrisman"
}
```

Changed reviewer from **Karl-Dieter Crisman, Nicholas Kirchner** to **Karl-Dieter Crisman, Nicholas Kirchner, John Palmieri**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110891",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110892",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110893",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110894",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110895",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110896",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110897",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:74'>Comment 74:</a>\nI am happy with [and [attachment: trac_11026-warnings.patch.gz](https://github.com/sagemath/sage/files/ticket11026/trac_11026-warnings.patch.gz)(https://github.com/sagemath/sage/files/ticket11026/4e83b209b18d1e23efdb798487be29a0.gz).",
    "created_at": "2013-02-12T22:29:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110898",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110899",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110900",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129216"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11026#event-129219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11026#issuecomment-110901",
