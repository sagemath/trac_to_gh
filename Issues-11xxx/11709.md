...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158478",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158479",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158481",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158482",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158483",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I verified this against Magma and everything is OK. While doing so, I noticed that the documentation of coset_reps should mention that you compute the left transversal.\n\nI felt a bit pity that GammaH is currently not implemented in C++, and for this it is much slower. If you feel like it, please go ahead and implement it. Otherwise, we will open a follow up ticket, that describes this task.",
    "created_at": "2011-08-22T13:18:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158484",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:5'></a>I verified this against Magma and everything is OK. While doing so, I noticed that the documentation of coset_reps should mention that you compute the left transversal.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158485",
    "user": "https://github.com/monien"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I have implemented the changes by Martin Raum - including the C++ version of GammaH. \u00a0I have added a number of doctests for SL2Z, Gamma1 and GammaH.\u00a0\n\nThe only undocumented feature is the possibility to define arbitrary subgroups of SL2Z by a helper class. I include an example \"noncongruence_example.sage\". How can that be doctested?\n\nOtherwise the patch should be ready to go.",
    "created_at": "2011-08-25T08:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158486",
    "user": "https://github.com/monien"
}
```

<a id='comment:6'></a>I have implemented the changes by Martin Raum - including the C++ version of GammaH.  I have added a number of doctests for SL2Z, Gamma1 and GammaH. 
...
```json
{
    "body": "<a id='comment:8'></a>Added an example for noncongruence groups in \"noncongruence_example.py\" (including a reference to a paper investigating this example - published 2010). Added a doctest of the noncongruence generators.",
    "created_at": "2011-08-25T09:53:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158488",
    "user": "https://github.com/monien"
}
```

<a id='comment:8'></a>Added an example for noncongruence groups in "noncongruence_example.py" (including a reference to a paper investigating this example - published 2010). Added a doctest of the noncongruence generators.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158489",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>With very minor changes, which I have done myself, this can get a positive review. There is only one thing, that I am sceptical about. For sl2z you changed the definition for *= and /=. I wonder why, because the old definition was correct and the new one seems not.",
    "created_at": "2011-08-25T18:03:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158490",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:9'></a>With very minor changes, which I have done myself, this can get a positive review. There is only one thing, that I am sceptical about. For sl2z you changed the definition for *= and /=. I wonder why, because the old definition was correct and the new one seems not.
...
```json
{
    "body": "<a id='comment:10'></a>Added a few checks for user code. The user subgroup is now check for a !__contains!__ member and if this member returns bool. Removed some unnecessary code: the rep member of farey_symbol etc.. Cleaned up the code for the special case of SL2Z which now gives the correct coset and generators.\n\nRevised the SL2Z.hpp file: changed member function get_a(), get_b() ... to a(), b(), c(), ... . Is the definition of SL2Z *= and /= correct now?\n\nAdded two file sage/plot/hyperbolic_arc.py and sage/plot/hyperbolic_triangle.py for plots in the hyperbolic plane.\n\nAdded member fundamental_domain() to\u00a0FareySymbol\u00a0which plots the fundamental domain.",
    "created_at": "2011-08-28T10:27:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158491",
    "user": "https://github.com/monien"
}
```

<a id='comment:10'></a>Added a few checks for user code. The user subgroup is now check for a !__contains!__ member and if this member returns bool. Removed some unnecessary code: the rep member of farey_symbol etc.. Cleaned up the code for the special case of SL2Z which now gives the correct coset and generators.
...
```json
{
    "body": "<a id='comment:11'></a>Added hyperbolic_arc and hyperbolic_triangle to documentation in sage.plot. Fixed const in SL2Z.cpp. Pruned the documentation so that sage --docbuild --jsmath reference html actually works. I am still not happy with the treatment of linebreaks in the documentation ... . It would be nice to add at least one plot of a fundamental domain, i.e. Gamma0(23), \u00a0to the documentation.",
    "created_at": "2011-08-29T09:29:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158492",
    "user": "https://github.com/monien"
}
```

<a id='comment:11'></a>Added hyperbolic_arc and hyperbolic_triangle to documentation in sage.plot. Fixed const in SL2Z.cpp. Pruned the documentation so that sage --docbuild --jsmath reference html actually works. I am still not happy with the treatment of linebreaks in the documentation ... . It would be nice to add at least one plot of a fundamental domain, i.e. Gamma0(23),  to the documentation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158493",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158494",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158495",
    "user": "https://github.com/monien"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [pairing.png](tarball://root/attachments/some-uuid/ticket11709/pairing.png) by @monien created at 2011-08-31 07:38:46\n\nThe documentation for\u00a0FareySymbol\u00a0is now seriously enhanced. It includes several figures which are not included in the patch (since it does not handle binary files) but included separately. The png files should go to the directory doc/en/reference/media/modular/arithgroup which of course has to be created.",
    "created_at": "2011-08-31T07:38:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158496",
    "user": "https://github.com/monien"
}
```

<a id='comment:12'></a>Attachment [pairing.png](tarball://root/attachments/some-uuid/ticket11709/pairing.png) by @monien created at 2011-08-31 07:38:46
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [trac-11709_farey_symbol.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol.patch) by @monien created at 2011-09-01 20:08:20\n\nChanges as discussed. Hope for the best ... .",
    "created_at": "2011-09-01T20:08:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158498",
    "user": "https://github.com/monien"
}
```

<a id='comment:14'></a>Attachment [trac-11709_farey_symbol.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol.patch) by @monien created at 2011-09-01 20:08:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [trac-11709_farey_symbol-v6.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-v6.patch) by mraum created at 2011-09-01 22:01:22\n\nYes, finally this work gets a positive review. The only change I made is to adapt the commit message to comply with the standards.",
    "created_at": "2011-09-01T22:01:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:15'></a>Attachment [trac-11709_farey_symbol-v6.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-v6.patch) by mraum created at 2011-09-01 22:01:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158501",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158502",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158503",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Please leave the *Dependencies* field empty if the ticket doesn't depend on any other.",
    "created_at": "2011-09-08T12:49:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158504",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:16'></a>Please leave the *Dependencies* field empty if the ticket doesn't depend on any other.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158505",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158506",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11709#event-30773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158507",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158508",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attached a reviewer patch such that building Sage from scratch will work.",
    "created_at": "2011-09-18T06:04:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158509",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:18'></a>Attached a reviewer patch such that building Sage from scratch will work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158510",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158511",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158513",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Follow-up ticket: #11875",
    "created_at": "2011-09-30T19:26:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158514",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:20'></a>Follow-up ticket: #11875
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158515",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158516",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158517",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11709#event-30774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158518",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158519",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11709#event-30775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158521",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158523",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158525",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Sorry, \"if G is even and has no torsion\" is nonsense -- I meant \"if G is even and has no elliptic points\", i.e.~if the projective image of G is torsionfree.",
    "created_at": "2012-03-02T15:36:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158526",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:27'></a>Sorry, "if G is even and has no torsion" is nonsense -- I meant "if G is even and has no elliptic points", i.e.~if the projective image of G is torsionfree.
...
```json
{
    "body": "<a id='comment:28'></a>Attachment [trac-11709_farey_symbol-sage-4.8.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-4.8.patch) by @monien created at 2012-03-02 17:51:47\n\nI added some code to \"init_generators\" to fix both problems. I agree that it would be good to rewire the generators of the top-level arithmetic subgroup class. It would be even better to implement Webers O(n) algorithm for generators of the congruence subgroups to \"farey.cpp\" (requires some work).",
    "created_at": "2012-03-02T17:51:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158527",
    "user": "https://github.com/monien"
}
```

<a id='comment:28'></a>Attachment [trac-11709_farey_symbol-sage-4.8.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-4.8.patch) by @monien created at 2012-03-02 17:51:47
...
```json
{
    "body": "<a id='comment:29'></a>My concern on the mailing list was that there are binary files (png images) in the patch. There should never be any binary files included ever. \nIncluding the plot commands itself would be nice, though.",
    "created_at": "2012-03-02T18:16:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158528",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:29'></a>My concern on the mailing list was that there are binary files (png images) in the patch. There should never be any binary files included ever. 
Including the plot commands itself would be nice, though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158531",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158533",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Sorry, \"(while still falling back to the old code when necessary)\" should have been \"(while having an option to fall back to the old code)\" -- it's never necessary!",
    "created_at": "2012-03-06T15:55:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158534",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:33'></a>Sorry, "(while still falling back to the old code when necessary)" should have been "(while having an option to fall back to the old code)" -- it's never necessary!
...
```json
{
    "body": "<a id='comment:35'></a>I just realised that the patch breaks a line in William's old 2008 Bordeaux slides which are included as part of the documentation. The slides complain about Farey symbols not being implemented, so I've added a comment explaining that they are now implemented and changed the doctest.",
    "created_at": "2012-03-06T16:37:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158536",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:35'></a>I just realised that the patch breaks a line in William's old 2008 Bordeaux slides which are included as part of the documentation. The slides complain about Farey symbols not being implemented, so I've added a comment explaining that they are now implemented and changed the doctest.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158537",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>I found out what was wrong. This G is a lifting to SL2Z of the unique index 2 subgroup of PL2Z, which is handled separately as a special case in the code. The updated reviewer patch I've just uploaded fixes this, so these two special cases are both handled correctly.",
    "created_at": "2012-03-06T18:12:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158539",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:37'></a>I found out what was wrong. This G is a lifting to SL2Z of the unique index 2 subgroup of PL2Z, which is handled separately as a special case in the code. The updated reviewer patch I've just uploaded fixes this, so these two special cases are both handled correctly.
...
```json
{
    "body": "<a id='comment:38'></a>Apply trac-11709_farey_symbol-sage-5.0.patch, trac_11709-review.patch\n\n(for the patchbot)",
    "created_at": "2012-03-07T08:23:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158540",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:38'></a>Apply trac-11709_farey_symbol-sage-5.0.patch, trac_11709-review.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158541",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158542",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158543",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158545",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>Everything is OK with the changes. I should remark that I am not so happy with including -I as a generator in case the SL(2,Z) subgroup passed to Farey symbols makes this necessary. To me Farey symbols have to to with SL(2, Z) as much as SL(2, Z) has to do with its metaplectic cover. But since -I in PSL is just I, it is not wrong. I just think it's not very clean.\n\nI made one single change. Following the discussion at sage-devel, I removed all fundamental domain pictures. I kept the one for pairings, though, because it seems necessary to understand what is meant by [(0,5), ...].\n\nIf you are OK with this, please give this a positive review.",
    "created_at": "2012-03-11T13:23:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158546",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:41'></a>Everything is OK with the changes. I should remark that I am not so happy with including -I as a generator in case the SL(2,Z) subgroup passed to Farey symbols makes this necessary. To me Farey symbols have to to with SL(2, Z) as much as SL(2, Z) has to do with its metaplectic cover. But since -I in PSL is just I, it is not wrong. I just think it's not very clean.
...
```json
{
    "body": "<a id='comment:42'></a>Attachment [trac-11709_farey_symbol-sage-5.0-without_png.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-5.0-without_png.patch) by mraum created at 2012-03-11 13:24:18",
    "created_at": "2012-03-11T13:24:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158547",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:42'></a>Attachment [trac-11709_farey_symbol-sage-5.0-without_png.patch](tarball://root/attachments/some-uuid/ticket11709/trac-11709_farey_symbol-sage-5.0-without_png.patch) by mraum created at 2012-03-11 13:24:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158548",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>OK, I can live with that.\n\nApply trac-11709_farey_symbol-sage-5.0-without_png.patch, trac_11709-review.patch",
    "created_at": "2012-03-11T13:48:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158549",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:43'></a>OK, I can live with that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158550",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>The mess you get when you print a list of SL2Z elements, as in many of the doctests here, bothered me enough that I found a fix: see #12658. Any takers for a review?",
    "created_at": "2012-03-12T23:01:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158551",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:44'></a>The mess you get when you print a list of SL2Z elements, as in many of the doctests here, bothered me enough that I found a fix: see #12658. Any takers for a review?
...
```json
{
    "body": "<a id='comment:46'></a>You may be right, but let's have a separate ticket for that: I don't want the code here to wait any longer before it goes in!",
    "created_at": "2012-03-13T17:35:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158553",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:46'></a>You may be right, but let's have a separate ticket for that: I don't want the code here to wait any longer before it goes in!
...
```json
{
    "body": "<a id='comment:47'></a>Okay then - done!",
    "created_at": "2012-03-13T21:04:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158554",
    "user": "https://github.com/monien"
}
```

<a id='comment:47'></a>Okay then - done!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158555",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11709#event-30776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158556",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11709#issuecomment-158557",
    "user": "https://github.com/jdemeyer"
}
```
