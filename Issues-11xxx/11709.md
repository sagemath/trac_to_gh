...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,3 +10,8 @@\n The calculation of the generators, coset representation and genus of Gamma(32)  takes 62.5 seconds on my laptop. Try this with Magma ... .\n \n sage: time FareySymbol(Gamma(32)) FareySymbol(Congruence Subgroup Gamma(32)) Time: CPU 62.50 s, Wall: 62.52 s\n+\n+\n+**Apply:**\n+1. [attachment:trac-11709_farey_symbol-v6.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-v6.patch)\n+\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -18,7 +18,8 @@\n \n ---\n \n-Apply only\n+Apply\n 1. [attachment:trac-11709_farey_symbol-v6.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-v6.patch)\n+2. [attachment:trac_11709-add_hpp_files_to_manifest.reviewer.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-add_hpp_files_to_manifest.reviewer.patch)\n to the Sage library.\n \n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -20,6 +20,7 @@\n \n Apply\n 1. [attachment:trac-11709_farey_symbol-v6.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-v6.patch)\n-2. [attachment:trac_11709-add_hpp_files_to_manifest.reviewer.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-add_hpp_files_to_manifest.reviewer.patch)\n+2. [attachment:trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch)\n+3. [attachment:trac_11709-add_hpp_files_to_manifest.reviewer.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-add_hpp_files_to_manifest.reviewer.patch)\n to the Sage library.\n \n``````\n",
    "created_at": "2011-09-19T15:41:15Z",
    "issue": "https://github.com/sagemath/sage/issues/11709",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -19,8 +19,4 @@\n ---\n \n Apply\n-1. [attachment:trac-11709_farey_symbol-v6.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-v6.patch)\n-2. [attachment:trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-tag_file_containing_non-ascii_chars.reviewer.patch)\n-3. [attachment:trac_11709-add_hpp_files_to_manifest.reviewer.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-add_hpp_files_to_manifest.reviewer.patch)\n-to the Sage library.\n-\n+1. [attachment:trac-11709_farey_symbol-sage-4.8.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-sage-4.8.patch)\n``````\n",
    "created_at": "2012-03-02T15:26:11Z",
    "issue": "https://github.com/sagemath/sage/issues/11709",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -19,4 +19,5 @@\n ---\n \n Apply\n-1. [attachment:trac-11709_farey_symbol-sage-4.8.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-sage-4.8.patch)\n+1. [attachment:trac-11709_farey_symbol-sage-5.0.patch](https://github.com/sagemath/sage/files/ticket11709/trac-11709_farey_symbol-sage-5.0.patch)\n+2. [attachment:trac_11709-review.patch](https://github.com/sagemath/sage/files/ticket11709/trac_11709-review.patch)\n``````\n",
    "created_at": "2012-03-06T16:37:48Z",
    "issue": "https://github.com/sagemath/sage/issues/11709",
    "type": "issue_comment",
