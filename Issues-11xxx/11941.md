...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164494",
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31602"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Well, in general we do *not* want to do this.  It's been discussed ad nauseam [many](http://groups.google.com/group/sage-support/browse_thread/thread/66d45649ca8c1cc3?pli=1)  [times](http://ask.sagemath.org/question/260/fractional-power-to-negative-number), and the sense is that:\n* Similar programs don't necessarily do this\n* `(-1)^(1/3)` is not really `-1` but a primitive complex root of `-1`.  \n\nThis ticket is about the fact that Maxima returns three solutions to the equation, but when we do the `assume(x,'real')` they *all* mysteriously vanish!",
    "created_at": "2011-11-17T14:18:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164496",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Well, in general we do *not* want to do this.  It's been discussed ad nauseam [many](http://groups.google.com/group/sage-support/browse_thread/thread/66d45649ca8c1cc3?pli=1)  [times](http://ask.sagemath.org/question/260/fractional-power-to-negative-number), and the sense is that:
* Similar programs don't necessarily do this
* `(-1)^(1/3)` is not really `-1` but a primitive complex root of `-1`.  
...
```json
{
    "body": "<a id='comment:4'></a>Here's what maple does:\n\n```\n> solve( x^3+1= 0, x);\n                                     1/2               1/2\n                    -1, 1/2 - 1/2 I 3   , 1/2 + 1/2 I 3\n```\n\nI wonder why maxima is returning `(-1)^(1/3)`. Maybe we should ask the Maxima developers.",
    "created_at": "2011-11-17T16:05:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164497",
    "user": "https://github.com/burcin"
}
```

<a id='comment:4'></a>Here's what maple does:
...
```json
{
    "body": "<a id='comment:5'></a>> I wonder why maxima is returning `(-1)^(1/3)`. Maybe we should ask the Maxima developers.\n\n\n\nNo, no!  See this example from the description:\n\n```\n(%i2) display2d:false;\n\n(%o2) false\n(%i3) solve(x^3+1=0,x);\n\n(%o3) [x = -(sqrt(3)*%i-1)/2,x = (sqrt(3)*%i+1)/2,x = -1]\n```\nWe are somehow getting the `(-1)^(1/3)` by doing something nonstandard in Maxima, apparently.   But their vanilla thing is just right.",
    "created_at": "2011-11-17T16:12:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164498",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>> I wonder why maxima is returning `(-1)^(1/3)`. Maybe we should ask the Maxima developers.
...
```json
{
    "body": "<a id='comment:6'></a>It seems that sage sets domain: complex (I was made aware of this by burcin in IRC). You do get this result as follows:\n\n```\n(%i8) domain:complex;\n\n(%o8) complex\n(%i9) solve(x^3+1=0,x);\n\n(%o9) [x = ((-1)^(1/3)*sqrt(3)*%i-(-1)^(1/3))/2,\n       x = -((-1)^(1/3)*sqrt(3)*%i+(-1)^(1/3))/2,x = (-1)^(1/3)]\n```",
    "created_at": "2011-11-17T16:15:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164499",
    "user": "https://github.com/mboratko"
}
```

<a id='comment:6'></a>It seems that sage sets domain: complex (I was made aware of this by burcin in IRC). You do get this result as follows:
...
```json
{
    "body": "<a id='comment:7'></a>Ugh, all my comments have screwed up formatting. I wish I could edit them (can I?). I should have been:\n\n```\n\n(%i8) domain:complex;\n\n(%o8) complex\n(%i9) solve(x^3+1=0,x);\n\n(%o9) [x = ((-1)^(1/3)*sqrt(3)*%i-(-1)^(1/3))/2,\n       x = -((-1)^(1/3)*sqrt(3)*%i+(-1)^(1/3))/2,x = (-1)^(1/3)]\n\n```",
    "created_at": "2011-11-17T16:16:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164500",
    "user": "https://github.com/mboratko"
}
```

<a id='comment:7'></a>Ugh, all my comments have screwed up formatting. I wish I could edit them (can I?). I should have been:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164503",
    "user": "https://github.com/mboratko"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31603"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31604"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Attachment [trac_11941.patch](tarball://root/attachments/some-uuid/ticket11941/trac_11941.patch) by @jdemeyer created at 2013-08-13 15:35:53",
    "created_at": "2013-08-13T15:35:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164504",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>Attachment [trac_11941.patch](tarball://root/attachments/some-uuid/ticket11941/trac_11941.patch) by @jdemeyer created at 2013-08-13 15:35:53
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31605"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31606"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31607"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31608"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31609"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31610"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>You need to set \"needs review\" if you want someone to look at your code. I'll do that now.",
    "created_at": "2015-01-31T09:05:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164505",
    "user": "https://github.com/rwst"
}
```

<a id='comment:14'></a>You need to set "needs review" if you want someone to look at your code. I'll do that now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164506",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164507",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164508",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>As Karl-Dieter says in comment:8 it is not desirable to switch back and forth with Maxima domain commands, so I don't think your patch is the right way to solve it, esp. since you don't get the right result, either. Presumably the failure of assumption should be reported upstream.",
    "created_at": "2015-03-11T17:22:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164509",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>As Karl-Dieter says in comment:8 it is not desirable to switch back and forth with Maxima domain commands, so I don't think your patch is the right way to solve it, esp. since you don't get the right result, either. Presumably the failure of assumption should be reported upstream.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164510",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>As found in #22017 SymPy gets it right. If SymPy is better than Maxima with symbolic polynomial roots then I think we should switch to SymPy for the special case.",
    "created_at": "2016-12-05T06:51:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164511",
    "user": "https://github.com/rwst"
}
```

<a id='comment:16'></a>As found in #22017 SymPy gets it right. If SymPy is better than Maxima with symbolic polynomial roots then I think we should switch to SymPy for the special case.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31611"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11941#event-31612"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Note that sympy also incorporates assumptions into the solver:\n\n```python\nIn [2]: x = var('x', real=True)\n\nIn [3]: solve(Eq(x**3, -8))\nOut[3]: [-2]\n```",
    "created_at": "2016-12-05T07:19:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164512",
    "user": "https://github.com/pelegm"
}
```

<a id='comment:17'></a>Note that sympy also incorporates assumptions into the solver:
...
```json
{
    "body": "<a id='comment:18'></a>Switching to SymPy would also depend on something like #22024.",
    "created_at": "2016-12-05T07:39:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164513",
    "user": "https://github.com/rwst"
}
```

<a id='comment:18'></a>Switching to SymPy would also depend on something like #22024.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164515",
...
```json
{
    "body": "<a id='comment:21'></a>As pointed out [comment:6 earlier], this is due to `domain:complex`:\n\n```\nMaxima 5.39.0 http://maxima.sourceforge.net\nusing Lisp ECL 16.1.2\nDistributed under the GNU Public License. See the file COPYING.\nDedicated to the memory of William Schelter.\nThe function bug_report() provides bug reporting information.\n(%i1) domain:complex;\n(%o1)                               complex\n(%i2) solve(x^3+1=0,x);\n                1/3                   1/3\n           (- 1)    sqrt(3) %i - (- 1)\n(%o2) [x = ------------------------------, \n                         2\n                                       1/3                   1/3\n                                  (- 1)    sqrt(3) %i + (- 1)              1/3\n                            x = - ------------------------------, x = (- 1)   ]\n                                                2\n```",
    "created_at": "2017-11-14T15:45:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164516",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>As pointed out [comment:6 earlier], this is due to `domain:complex`:
...
```json
{
    "body": "<a id='comment:22'></a>And if you can figure out how to deal with this - in Maxima or elsewhere - please do!   I don't think this was ever reported upstream.",
    "created_at": "2017-11-14T15:46:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164517",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>And if you can figure out how to deal with this - in Maxima or elsewhere - please do!   I don't think this was ever reported upstream.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164518",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164520",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164522",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Replying to [comment:26 charpent]:\n> {{{\n> sage: [mreal(mrhs(t)) for t in msolve(x^3+1==0,x)]\n> [true, false, false]\n> }}}\n\n\nIs that root really real? In what domain is Maxima at that point?",
    "created_at": "2017-11-16T06:56:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164523",
    "user": "https://github.com/rwst"
}
```

<a id='comment:28'></a>Replying to [comment:26 charpent]:
> {{{
> sage: [mreal(mrhs(t)) for t in msolve(x^3+1==0,x)]
> [true, false, false]
> }}}
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11941#issuecomment-164524",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
