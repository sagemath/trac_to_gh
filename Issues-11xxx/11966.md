...
```json
{
    "body": "<div id=\"comment:26\" align=\"right\">comment:26</div>\n\nI [tested this](#comment:18) on a number of systems (not OS X 10.4 PPC, though) without the new ECL package, and it worked just fine.  So except for testing on OS X 10.4 PPC, I think it makes sense to merge it independently of ECL.",
