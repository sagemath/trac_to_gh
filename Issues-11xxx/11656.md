...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11656#event-142707"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11656#event-142708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11656#event-142709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11656#issuecomment-122275",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11656#issuecomment-122276",
    "user": "https://github.com/burcin"
}
```
