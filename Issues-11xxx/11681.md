...
```json
{
    "body": "<a id='comment:2'></a>The counterpart of \"chrpath\" on OS X is called \"install_name_tool\", FWIW.",
    "created_at": "2011-08-13T14:51:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157500",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:2'></a>The counterpart of "chrpath" on OS X is called "install_name_tool", FWIW.
...
```json
{
    "body": "<a id='comment:3'></a>Alexander, just curious:\n\nHow does your `$SAGE_ROOT/local/lib/pkgconfig/libpng12.pc` file look like (especially the first line)?",
    "created_at": "2011-08-13T16:55:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157501",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Alexander, just curious:
...
```json
{
    "body": "<a id='comment:4'></a>(**Any** definition of `SAGE_ROOT` in `local/lib/pkgconfig/*.pc` can and should be removed.)",
    "created_at": "2011-08-13T17:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157502",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>(**Any** definition of `SAGE_ROOT` in `local/lib/pkgconfig/*.pc` can and should be removed.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157503",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>> Unfortunately, the correction of the paths in `.pc` files (as performed by `sage-location`) isn't fully reliable at the moment, as the first example above shows.\n\n\nAs you know, this causes problems elsewhere as well.  Is there a way to grep through this particular one and find all the places this is a problem?",
    "created_at": "2011-08-17T16:30:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157504",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>> Unfortunately, the correction of the paths in `.pc` files (as performed by `sage-location`) isn't fully reliable at the moment, as the first example above shows.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30679"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30680"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30681"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30682"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30683"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30684"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30685"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Is this still an issue?",
    "created_at": "2015-01-22T20:00:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157505",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:11'></a>Is this still an issue?
...
```json
{
    "body": "<a id='comment:12'></a>Obsolete by the new binary packaging.",
    "created_at": "2016-04-11T10:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157506",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>Obsolete by the new binary packaging.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157507",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157508",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30686"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157509",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Really, are you sure there no \"buildbot\" or \"buildslave\" things?   I note that we still occasionally get such questions on ask.sagemath.",
    "created_at": "2016-04-11T14:28:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157510",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>Really, are you sure there no "buildbot" or "buildslave" things?   I note that we still occasionally get such questions on ask.sagemath.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157511",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11681#issuecomment-157512",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11681#event-30688"
}
```
