...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11789#issuecomment-125333",
    "user": "https://github.com/sagetrac-FrankPolte"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11789#issuecomment-125334",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11789#event-144863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11789#event-144864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11789#event-144865"
}
```
