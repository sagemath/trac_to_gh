...
```json
{
    ...
    "user": "https://trac.sagemath.org/admin/accounts/users/FrankPolte"
}
```
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160538",
    "user": "https://trac.sagemath.org/admin/accounts/users/FrankPolte"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160539",
...
```json
{
    "body": "<a id='comment:4'></a>Sorry here my answer again better to read:\n\n\u00a0For me that doesn't worked. The problem was. that couchdb uses a  special module called: HTTPSConnection which is juat there if SSL was  directly compiled into the python-kernel. Installing OpenSSL or other  SSL-packages doesn't helped me at all.\n\nAnd: Yes there should be  wiki- or docu-page to easy_install! \nIt was a real pain for me to get it running.   \nBtw. couchdb and other database modules are quite useful to get the  result out of the box into other systems like web server or get data  from them. I think this is really nice. But there is no need for  creating spkg files if easy_install is working fine, especially for  wrappers like couchdb.",
    "created_at": "2011-09-11T13:50:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160541",
    "user": "https://trac.sagemath.org/admin/accounts/users/FrankPolte"
}
```

<a id='comment:4'></a>Sorry here my answer again better to read:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160542",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I see. I just imported couchdb without the ssl and _ssl packages. But now it's working for me anyway. I will give the link to this trac in the wiki as well. Your way is easier and my is more python-couchdb-native, everybody should decide for his/her-self.",
    "created_at": "2011-09-12T00:26:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160544",
    "user": "https://trac.sagemath.org/admin/accounts/users/FrankPolte"
}
```

<a id='comment:6'></a>I see. I just imported couchdb without the ssl and _ssl packages. But now it's working for me anyway. I will give the link to this trac in the wiki as well. Your way is easier and my is more python-couchdb-native, everybody should decide for his/her-self.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160545",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11789#event-31019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11789#event-31020"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Seems this can be closed then.",
    "created_at": "2012-09-03T13:30:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160546",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Seems this can be closed then.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160547",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>FrankPolte: leif was not saying that you must import ssl and _ssl before importing couchdb. He was just demonstrating that one can import ssl and _ssl, and then demonstrating that one can import couchdb. So his way is not more \"python-couchdb-native\". I think there was just some weirdness on your system which eventually happened to go away.",
    "created_at": "2012-09-05T10:07:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11789#issuecomment-160548",
    "user": "https://github.com/kini"
}
```

<a id='comment:8'></a>FrankPolte: leif was not saying that you must import ssl and _ssl before importing couchdb. He was just demonstrating that one can import ssl and _ssl, and then demonstrating that one can import couchdb. So his way is not more "python-couchdb-native". I think there was just some weirdness on your system which eventually happened to go away.
