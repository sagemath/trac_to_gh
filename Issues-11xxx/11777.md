...
```json
{
    "body": "A strange problem maybe cause by a coercion problem when coercing from a number field into a p-adic field. Upon printing, repr_spec (reps. repr_gen if in 'bars' mode) ends up receiving an element whose call `_ext_p_`list(True) returns an empty list which causes some errors to be raised. Reproducing source code below.\n\n**Assignee:** @roed314\n\n**CC:**  @roed314\n\n**Keywords:** padics, repr_spec, repr_gen, rd2, padicIMA\n\n**Status:** needs_work\n\nIssue created by migration from https://trac.sagemath.org/ticket/11777\n\n",
...
```
A strange problem maybe cause by a coercion problem when coercing from a number field into a p-adic field. Upon printing, repr_spec (reps. repr_gen if in 'bars' mode) ends up receiving an element whose call `_ext_p_`list(True) returns an empty list which causes some errors to be raised. Reproducing source code below.
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165950",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165951",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165952",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165953",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165954",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165955",
    "user": "https://trac.sagemath.org/admin/accounts/users/johanbosman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165956",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165957",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165958",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165959",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165960",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165961",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165962",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165963",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165964",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165965",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165966",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36617"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36618"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36619"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36620"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36621"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36622"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11777#event-36623"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11777#issuecomment-165967",
    "user": "https://github.com/roed314"
}
```
