...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136761"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136764"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136765"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136766"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136768"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136769"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136772"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136774"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136775"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136778"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -40,3 +40,7 @@\n         obj.save(filename, **kwds)\n ```\n \n+---\n+\n+Apply [attachment: trac_11577-jhp.patch.gz](https://github.com/sagemath/sage/files/ticket11577/trac_11577-jhp.patch.gz).\n+\n``````\n",
    "created_at": "2011-07-24T03:23:27Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11577",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136779"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136780"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136781"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136782"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -42,5 +42,5 @@\n \n ---\n \n-Apply [attachment: trac_11577-jhp.patch.gz](https://github.com/sagemath/sage/files/ticket11577/trac_11577-jhp.patch.gz).\n+Apply [attachment: trac_11577-jhp.v2.patch.gz](https://github.com/sagemath/sage/files/ticket11577/trac_11577-jhp.v2.patch.gz).\n \n``````\n",
    "created_at": "2011-08-18T22:59:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11577",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136783"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136784"
}
```
...
```json
{
    "body": "Changed keywords from **** to **.sobj**",
    "created_at": "2011-08-19T01:21:28Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11577#issuecomment-120828",
    "user": "https://github.com/nexttime"
}
```

Changed keywords from **** to **.sobj**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11577",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11577#event-136786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11577#issuecomment-120829",
    "user": "https://github.com/jdemeyer"
}
```
