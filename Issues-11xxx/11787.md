...
```json
{
    ...
    "body": "#7570 should have been implemented by doing a len()==0 test, rather than a direct comparison to empty lists/dicts/etc.  That allows things like numpy arrays, etc.\n\nI guess technically, numpy arrays aren't documented as being supported by list_plot, for example, so this might technically be an enhancement.\n\nSee http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n\n---\nApply only [attachment: trac_11787-allow_numpy_arrays.2.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.2.patch.gz) to `devel/sage`\n\nCC:  @kcrisman @ppurka\n\nBranch/Commit: **[u/lftabera/ticket/11787_numpyarray](https://github.com/sagemath/sagetrac-mirror/tree/u/lftabera/ticket/11787_numpyarray) @ [`8c1320a`](https://github.com/sagemath/sagetrac-mirror/commit/8c1320a8b7f8034423c7b0cb6fcb97d12bb900b8)**\n\nReviewer: **Luis Felipe Tabera Alonso**\n\nAuthor: **Punarbasu Purkayastha**\n\nComponent: **graphics**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/11787_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158497"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158501"
}
```
...
```json
{
    ...
    "subject": "https://github.com/jasongrout",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158502"
}
```
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "title_is": "error in creating graphics with numpy arrays",
    "title_was": "empty graphics objects",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123110",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123111",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123112",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123113",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,3 +3,6 @@\n I guess technically, numpy arrays aren't documented as being supported by list_plot, for example, so this might technically be an enhancement.\n \n See http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n+\n+---\n+Apply [attachment: trac_11787-allow_numpy_arrays.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.patch.gz) to `devel/sage`\n``````\n",
    "created_at": "2012-11-23T13:41:28Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123114",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123115",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158506"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123116",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123117",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123118",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158507"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123119",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Changed work issues from **Fix for ndarrays** to none",
    "created_at": "2013-03-09T11:35:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123120",
    "user": "https://github.com/ppurka"
}
```

Changed work issues from **Fix for ndarrays** to none
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158510"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123121",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123122",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123123",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123124",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123125",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158512"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n See http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n \n ---\n-Apply [attachment: trac_11787-allow_numpy_arrays.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.patch.gz) to `devel/sage`\n+Apply [attachment: trac_11787-allow_numpy_arrays.2.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.2.patch.gz) to `devel/sage`\n``````\n",
    "created_at": "2013-04-19T16:02:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123126",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123127",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123128",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123129",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n See http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n \n ---\n-Apply [attachment: trac_11787-allow_numpy_arrays.2.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.2.patch.gz) to `devel/sage`\n+Apply [attachment: trac_11787-allow_numpy_arrays.2.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.2.patch.gz), [attachment: trac_11787-heegner.patch](https://github.com/sagemath/sage/files/ticket11787/trac_11787-heegner.patch.gz) to `devel/sage`\n``````\n",
    "created_at": "2013-05-10T08:50:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123130",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123131",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123132",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123133",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123134",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123135",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123136",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123138",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123139",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123140",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123141",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158520"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123142",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123143",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123144",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158521"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158522"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123145",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158523"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123146",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158526"
}
```
...
```json
{
    "body": "Commit: **[`8c1320a`](https://github.com/sagemath/sagetrac-mirror/commit/8c1320a8b7f8034423c7b0cb6fcb97d12bb900b8)**",
    "created_at": "2013-12-21T12:07:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123147",
    "user": "https://github.com/sagetrac-git"
}
```

Commit: **[`8c1320a`](https://github.com/sagemath/sagetrac-mirror/commit/8c1320a8b7f8034423c7b0cb6fcb97d12bb900b8)**
...
```json
{
    "body": "<div id=\"comment:29\"></div>\n\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/8c1320a\"><code>8c1320a</code></a></td><td><code>Fixing Whitespace errors</code></td></tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/603ea72\"><code>603ea72</code></a></td><td><code>allow numpy arrays in list_plot, line, points</code></td></tr></table>\n",
    "created_at": "2013-12-21T12:07:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123148",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158527"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-158530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-123150",
    "user": "https://github.com/kcrisman"
}
```
