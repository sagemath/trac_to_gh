...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144805"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144806"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144807"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144808"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144810"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,3 +3,6 @@\n I guess technically, numpy arrays aren't documented as being supported by list_plot, for example, so this might technically be an enhancement.\n \n See http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n+\n+---\n+Apply [attachment: trac_11787-allow_numpy_arrays.patch.gz](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.patch.gz) to `devel/sage`\n``````\n",
    "created_at": "2012-11-23T13:41:28Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144811"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144812"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144813"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144814"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144815"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125300",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125301",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125302",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125303",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125304",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144817"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144818"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n See http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n \n ---\n-Apply [attachment: trac_11787-allow_numpy_arrays.patch.gz](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.patch.gz) to `devel/sage`\n+Apply [attachment: trac_11787-allow_numpy_arrays.2.patch.gz](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.2.patch.gz) to `devel/sage`\n``````\n",
    "created_at": "2013-04-19T16:02:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125305",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144819"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125306",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125307",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125308",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n See http://groups.google.com/group/sage-support/browse_thread/thread/fb53b9d908acfb4 for a discussion of this bug.\n \n ---\n-Apply [attachment: trac_11787-allow_numpy_arrays.2.patch.gz](https://github.com/sagemath/sage/files/ticket11787/trac_11787-allow_numpy_arrays.2.patch.gz) to `devel/sage`\n+Apply [[attachment: trac_11787-heegner.patch.gz](https://github.com/sagemath/sage/files/ticket11787/trac_11787-heegner.patch.gz)(https://github.com/sagemath/sage/files/ticket11787/2e494a469b9e3c9cddda530c549443b1.gz) to `devel/sage`\n``````\n",
    "created_at": "2013-05-10T08:50:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125309",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125310",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144822"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125311",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144824"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125312",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125313",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125314",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125315",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125316",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125317",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125318",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125319",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125320",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125321",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125322",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125323",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144827"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125324",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125325",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125326",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125327",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125328",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11787#event-144836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11787#issuecomment-125329",
    "user": "https://github.com/kcrisman"
}
```
