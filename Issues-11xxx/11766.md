# Issue 11766: Finite fields defined by Conway polynomials: conversion of elements into subfields
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11766#event-31579"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11766#event-31580"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11766#event-31581"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11766#event-31582"
}
```
