...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159864",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159865",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Note that fast_callable(f, CDF) will produce a much faster evaluating expression.",
    "created_at": "2011-09-02T07:29:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159866",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>Note that fast_callable(f, CDF) will produce a much faster evaluating expression.
...
```json
{
    "body": "<a id='comment:2'></a>From Robert Bradshaw: \"Ugh. I didn't write that version of the code, but yes, it, it'll blow\nthe stack. (Incidentally, I remember running into very similar issues\nto #11767 refereeing some similar code over the reals...)\"",
    "created_at": "2011-09-27T01:31:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159867",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>From Robert Bradshaw: "Ugh. I didn't write that version of the code, but yes, it, it'll blow
the stack. (Incidentally, I remember running into very similar issues
to #11767 refereeing some similar code over the reals...)"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159869",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159870",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [11766-fast-callable-stack-smash-4.8nofuzz.patch](tarball://root/attachments/some-uuid/ticket11766/11766-fast-callable-stack-smash-4.8nofuzz.patch) by @jdemeyer created at 2012-03-20 22:31:10",
    "created_at": "2012-03-20T22:31:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159872",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Attachment [11766-fast-callable-stack-smash-4.8nofuzz.patch](tarball://root/attachments/some-uuid/ticket11766/11766-fast-callable-stack-smash-4.8nofuzz.patch) by @jdemeyer created at 2012-03-20 22:31:10
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159873",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159874",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11766#event-30949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11766#issuecomment-159875",
    "user": "https://github.com/jdemeyer"
}
```
