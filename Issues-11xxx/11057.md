...
```json
{
    "body": "<a id='comment:1'></a>Mathematical mistake. ``a`` is a unit in $QQ(a,b)$ so it's not part of the GCD. This ticket is not an issue / defect.",
    "created_at": "2011-04-01T18:33:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11057#issuecomment-142886",
    "user": "https://github.com/cswiercz"
}
```

<a id='comment:1'></a>Mathematical mistake. ``a`` is a unit in $QQ(a,b)$ so it's not part of the GCD. This ticket is not an issue / defect.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11057#issuecomment-142887",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11057",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11057#event-28702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11057#issuecomment-142888",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11057#event-28703"
}
```
