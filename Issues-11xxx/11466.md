...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11466#issuecomment-124343",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_11466-turning_number-abm.patch](tarball://root/attachments/some-uuid/ticket11466/trac_11466-turning_number-abm.patch) by abmasse created at 2011-06-13 01:55:43\n\nI just uploaded a patch providing the function turning_number() for square grid paths. This is clearly generalizable to other word paths alphabets, but I don't feel like writing it right now, since I don't need it.\n\nNeeds review!",
    "created_at": "2011-06-13T01:55:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11466#issuecomment-124344",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:1'></a>Attachment [trac_11466-turning_number-abm.patch](tarball://root/attachments/some-uuid/ticket11466/trac_11466-turning_number-abm.patch) by abmasse created at 2011-06-13 01:55:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11466#issuecomment-124345",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11466#issuecomment-124346",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29816"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29817"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29818"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29819"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29820"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29821"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11466#event-29822"
}
```
