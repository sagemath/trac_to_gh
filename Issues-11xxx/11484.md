...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11484#event-29899"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11484#event-29900"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11484#event-29901"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>You need to specify *which package* is problematic, otherwise this ticket will need to be closed as invalid because it's too vague.",
    "created_at": "2013-12-29T23:37:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11484#issuecomment-152345",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>You need to specify *which package* is problematic, otherwise this ticket will need to be closed as invalid because it's too vague.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11484#issuecomment-152346",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11484#issuecomment-152347",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11484#issuecomment-152348",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11484#issuecomment-152349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11484",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11484#event-29902"
}
```
