...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11094#event-134246"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11094#event-134247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11094#event-134248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11094#issuecomment-111869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11094#issuecomment-111870",
    "user": "https://github.com/sagetrac-mvngu"
}
```
