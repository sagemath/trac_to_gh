...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154984",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154985",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154986",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Note: The docstring in this patch is invalid ReST, i.e., the bulleted list is misformated.  This is the case for dozens (!) of the docstrings in this file.  Fixing this should be done later as a single separate patch.",
    "created_at": "2011-07-05T22:33:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154987",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Note: The docstring in this patch is invalid ReST, i.e., the bulleted list is misformated.  This is the case for dozens (!) of the docstrings in this file.  Fixing this should be done later as a single separate patch.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_11578.patch](tarball://root/attachments/some-uuid/ticket11578/trac_11578.patch) by @williamstein created at 2011-07-05 22:34:07",
    "created_at": "2011-07-05T22:34:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154988",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Attachment [trac_11578.patch](tarball://root/attachments/some-uuid/ticket11578/trac_11578.patch) by @williamstein created at 2011-07-05 22:34:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154989",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Positive review from Dan Shumow (original author of the code): \"Looks good to me. -D\"",
    "created_at": "2011-07-05T22:56:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154990",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Positive review from Dan Shumow (original author of the code): "Looks good to me. -D"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154991",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Comment (about the comment and examples added):  I have code (written by Kimi Tsukazaki) which checks properly that a given kernel polynomial is genuine, which I have been meaning to make into a patch for a long time.  It is not very cheap to run though, so we would need to have a \"check=False\" parameter.",
    "created_at": "2011-07-06T08:49:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154992",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>Comment (about the comment and examples added):  I have code (written by Kimi Tsukazaki) which checks properly that a given kernel polynomial is genuine, which I have been meaning to make into a patch for a long time.  It is not very cheap to run though, so we would need to have a "check=False" parameter.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Dan Shumow\"",
    "created_at": "2011-07-22T17:16:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154994",
    "user": "https://github.com/jdemeyer"
}
```

Changing reviewer from "" to "Dan Shumow"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154995",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154996",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11578#event-30367"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11578#issuecomment-154997",
    "user": "https://github.com/jdemeyer"
}
```
