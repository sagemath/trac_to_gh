...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11980#event-148082"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11980#event-148083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11980#event-148084"
}
```
...
```json
{
    "body": "Changed keywords from **** to **sd35 hyperelliptic curve**",
...
Changed keywords from **** to **sd35 hyperelliptic curve**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11980#issuecomment-129423",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11980#issuecomment-129424",
    "user": "https://github.com/vbraun"
}
```
