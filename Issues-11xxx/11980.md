...
```json
{
    "body": "<a id='comment:12'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>534116bImprove naive point counting and implement zeta_function.</tr><tr>fc7a569First bunch of fixes and missing examples.</tr><tr>55cdcf3Refactor point counting code for hyperelliptic curves.</tr><tr>86261b1Improve count_points</tr><tr>a1f9becMerge remote-tracking branch 'origin/build_system' into build_system</tr><tr>4cb7db9Merge remote-tracking branch 'origin' into build_system</tr></table>\n",
