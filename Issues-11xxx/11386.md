...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11386#issuecomment-117240",
    "user": "https://github.com/sagetrac-DanielRecoskie"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-DanielRecoskie** to **@nthiery**",
    "created_at": "2011-05-27T19:44:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/11386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11386#issuecomment-117241",
    "user": "https://github.com/nthiery"
}
```

Changed assignee from **@sagetrac-DanielRecoskie** to **@nthiery**
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11386#event-138276"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11386#event-138277"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11386#event-138278"
}
```
