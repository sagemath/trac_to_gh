...
```json
{
    "body": "Another option is to parse all but the literals, and it should then be syntactically valid Python code (\"fast\" to check), and then throw the literals in there. This might be a better representation to raise syntax errors from as well.",
...
```json
{
    "body": "Here's another example by Tom Boothby:\n\n```\nclass 0: \n    def 0(0): \n        return 0\n```",
...
```json
{
    "body": "Fro some reason this doesn't apply, apparently.",
    "created_at": "2014-12-09T02:56:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11542",
    "type": "issue_comment",
...
```json
{
    "body": "Conflict due to [a2598e1](http://git.sagemath.org/sage.git/commit/?id=a2598e19b38f600b41d554bd585ed65d20b613ec) which moved the code to a different package. I rebased the code to 6.5.beta2 by applying the patch to the new file using `patch --merge`.",
    "created_at": "2014-12-09T14:14:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11542",
    "type": "issue_comment",
