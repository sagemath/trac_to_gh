...
```json
{
    "body": "<a id='comment:2'></a>> which isn't portable; one should use the shell built-in command -v ....\n\n\nOr use the function `have_program` from `sage.misc.sage_ostools`, which in turn uses `command -v`.",
    "created_at": "2011-07-15T18:11:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155677",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>> which isn't portable; one should use the shell built-in command -v ....
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155679",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155681",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>John perhaps knows better from where this (rather plain Python) script is or can be called; it actually (currently) just requires `SAGE_ROOT` to be set (otherwise an exception is raised, which is a bit odd by itself).\n\nI haven't found something like `sage -install_scripts` though.\n\nAlso, not all `sage -<program>` instances need to have a corresponding `$SAGE_ROOT/local/bin/<program>`; at least the filename might differ.",
    "created_at": "2011-07-15T19:34:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155682",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>John perhaps knows better from where this (rather plain Python) script is or can be called; it actually (currently) just requires `SAGE_ROOT` to be set (otherwise an exception is raised, which is a bit odd by itself).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155683",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I noticed this issue, too, and wrote a patch for it.  I think that since this is in a file in the Sage library, we may assume that it is used while Sage is running, so all of the appropriate environment variables are set.\n\nAnyway, here's one attempt at a patch.",
    "created_at": "2011-07-15T19:49:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155684",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>I noticed this issue, too, and wrote a patch for it.  I think that since this is in a file in the Sage library, we may assume that it is used while Sage is running, so all of the appropriate environment variables are set.
...
```json
{
    "body": "<a id='comment:9'></a>The following is from README.txt in the root directory:\n\n```\n6. OPTIONAL: Start Sage and run the command\n\n       install_scripts(\"/usr/local/bin/\")   # change /usr/local/bin/\n\n   Type \"install_scripts?\" in Sage for more details about what this\n   command does.\n```",
    "created_at": "2011-07-15T20:05:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155685",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```

<a id='comment:9'></a>The following is from README.txt in the root directory:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155686",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>P.P.S.: I'd also move the `close()` right before `\"Created script ...\"`.",
    "created_at": "2011-07-15T21:07:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155689",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:12'></a>P.P.S.: I'd also move the `close()` right before `"Created script ..."`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155690",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155691",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Ah, found it.  Bad variable names, I think: it's too easy to confuse these.\n\n```python\n>>> import os\n>>> os.pathsep\n':'\n>>> os.path.sep\n'/'\n```",
    "created_at": "2011-07-15T21:25:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155692",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:14'></a>Ah, found it.  Bad variable names, I think: it's too easy to confuse these.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155693",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155695",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155696",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155698",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155699",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155700",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155701",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155702",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155704",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "created_at": "2011-07-23T16:37:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155705",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155706",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155707",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155708",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155709",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155710",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Ok, `have_program()` still runs `command -v ...` with an environment just containing `PATH` if the `path` parameter isn't `None`, but that's a minor issue.\n\nIt's better than the previous version and much better than the original (and of course fixes the issue of this ticket), so **positive review**.",
    "created_at": "2011-08-05T06:06:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155712",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:25'></a>Ok, `have_program()` still runs `command -v ...` with an environment just containing `PATH` if the `path` parameter isn't `None`, but that's a minor issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155713",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Ah, forgot one thing:\n\nTo save one process (yet another shell), we should have written:\n\n```sh\n#!/bin/sh\nexec sage -CMD \"$@\"\n```\nOr even with two dashs... ;-)",
    "created_at": "2011-08-05T06:15:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155714",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:26'></a>Ah, forgot one thing:
...
```json
{
    "body": "<a id='comment:28'></a>Yeah, looks good.",
    "created_at": "2011-08-10T19:25:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155716",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:28'></a>Yeah, looks good.
...
```json
{
    "body": "<a id='comment:29'></a>Attachment [trac_11602-install-scripts.v4.patch](tarball://root/attachments/some-uuid/ticket11602/trac_11602-install-scripts.v4.patch) by @jhpalmieri created at 2011-08-10 19:31:08\n\nOkay, here's a new patch incorporating exactly those changes.  I'm leaving the ticket as \"positive review\", so if you're happy with the new patch, please change the description of the ticket (\"Apply ...\") to refer to \"v4\" instead of \"v3\".",
    "created_at": "2011-08-10T19:31:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155717",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:29'></a>Attachment [trac_11602-install-scripts.v4.patch](tarball://root/attachments/some-uuid/ticket11602/trac_11602-install-scripts.v4.patch) by @jhpalmieri created at 2011-08-10 19:31:08
...
```json
{
    "body": "<a id='comment:30'></a>Positive review also for version 4.",
    "created_at": "2011-08-10T21:49:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155718",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:30'></a>Positive review also for version 4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155719",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155720",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11602#event-30432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11602#issuecomment-155721",
    "user": "https://github.com/jdemeyer"
}
```
