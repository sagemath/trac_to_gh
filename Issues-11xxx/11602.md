...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137172"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137173"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137175"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137185"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -23,3 +23,8 @@\n https://groups.google.com/forum/#!msg/sage-devel/oeFrvqWiP_s/o8mKO-4OAKkJ\n \n It seems that the solution is to make install_scripts write \"$@\" instead of $* .\n+\n+---\n+\n+Apply [attachment: trac_11602-install-scripts.v2.patch.gz](https://github.com/sagemath/sage/files/ticket11602/trac_11602-install-scripts.v2.patch.gz).\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -26,5 +26,5 @@\n \n ---\n \n-Apply [attachment: trac_11602-install-scripts.v2.patch.gz](https://github.com/sagemath/sage/files/ticket11602/trac_11602-install-scripts.v2.patch.gz).\n+Apply [attachment: trac_11602-install-scripts.v3.patch.gz](https://github.com/sagemath/sage/files/ticket11602/trac_11602-install-scripts.v3.patch.gz).\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11602#issuecomment-121413",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11602",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11602#event-137189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11602#issuecomment-121414",
