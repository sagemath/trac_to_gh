...
archive/attachments_015615.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_11456_doctests.patch](https://github.com/sagemath/sage/files/ticket11456/trac_11456_doctests.patch)\n\npatch for extcode to convert number fields and their elements to Sage",
    "created_at": "2011-07-01T14:13:43Z",
    "issue": "https://github.com/sagemath/sage/issues/11456",
    "type": "issue_comment",
...
**Attachment:** [trac_11456_doctests.patch](https://github.com/sagemath/sage/files/ticket11456/trac_11456_doctests.patch)
...
archive/attachments_015616.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
**Attachment:** [trac_11456_extcode.patch](https://github.com/sagemath/sage/files/ticket11456/trac_11456_extcode.patch)
...
archive/attachments_015617.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_11456_sage.patch](https://github.com/sagemath/sage/files/ticket11456/trac_11456_sage.patch)\n\nThe file trac_11456_doctests.patch can be removed.",
    "created_at": "2011-07-01T14:25:06Z",
    "issue": "https://github.com/sagemath/sage/issues/11456",
    "type": "issue_comment",
