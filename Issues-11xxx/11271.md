...
```json
{
    "body": "<a id='comment:2'></a>That was pretty illegible.  Let me try again:\n\n\"Professor Stein,\n\nIn relation to your recently-opened ticket about Sage's elliptic curve galois representation code (http://trac.sagemath.org/sage_trac/ticket/11271): not only is is_surjective's docstring wrong, but non_surjective()'s docstring is also wrong. It says the function can be inconclusive at 2, but in fact it calls is_surjective(), which is always right at 2 and 3 since it determines the size of the Galois group of the p-division polynomial. Probably someone wrote that before the special cases for 2 and 3 in is_surjective() had been implemented.\n\nI don't yet have a trac account to report this, or I would've just opened a ticket. (I've requested an account.) But since you opened the ticket, I thought you might like to know of this bug as well.\n\nAlso, regarding the other ticket (implementing the algorithm in Zywina's paper): I've already written code that takes care of some (easy) cases in the paper, and is pretty fast compared to the existing is_surjective. (Specifically, just checking for surjectivity mod 8, 9 by first checking mod 2, 4, 3 in appropriate cases with a view to determining whether a curve is a Serre curve.) If you haven't already written it, I can clean it up and send it to you. I'm also willing to help further.\n\n-David Pathakjee\n\n\"",
    "created_at": "2011-05-11T03:35:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147698",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>That was pretty illegible.  Let me try again:
...
```json
{
    "body": "<a id='comment:3'></a>Not long after writing that, I was able to get a trac account and reported this as #11276.\n\nReplying to [was](#comment%3A2):\n> That was pretty illegible.  Let me try again:\n> \n> \"Professor Stein,\n> \n> In relation to your recently-opened ticket about Sage's elliptic curve galois representation code (http://trac.sagemath.org/sage_trac/ticket/11271): not only is is_surjective's docstring wrong, but non_surjective()'s docstring is also wrong. It says the function can be inconclusive at 2, but in fact it calls is_surjective(), which is always right at 2 and 3 since it determines the size of the Galois group of the p-division polynomial. Probably someone wrote that before the special cases for 2 and 3 in is_surjective() had been implemented.\n> \n> I don't yet have a trac account to report this, or I would've just opened a ticket. (I've requested an account.) But since you opened the ticket, I thought you might like to know of this bug as well.\n> \n> Also, regarding the other ticket (implementing the algorithm in Zywina's paper): I've already written code that takes care of some (easy) cases in the paper, and is pretty fast compared to the existing is_surjective. (Specifically, just checking for surjectivity mod 8, 9 by first checking mod 2, 4, 3 in appropriate cases with a view to determining whether a curve is a Serre curve.) If you haven't already written it, I can clean it up and send it to you. I'm also willing to help further.\n> \n> -David Pathakjee\n> \n> \"",
    "created_at": "2011-05-11T03:44:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147699",
    "user": "https://trac.sagemath.org/admin/accounts/users/dpathakjee"
}
```

<a id='comment:3'></a>Not long after writing that, I was able to get a trac account and reported this as #11276.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11271#event-29185"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/wuthrich/ticket/11271\"",
    "created_at": "2013-12-30T00:26:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147700",
    "user": "https://github.com/categorie"
}
```

Changing branch from "" to "u/wuthrich/ticket/11271"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147701",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147702",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"c3ae100155d686452e326d0dc4662a1c7378e61c\"",
    "created_at": "2013-12-30T00:38:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147703",
    "user": "https://github.com/categorie"
}
```

Changing commit from "" to "c3ae100155d686452e326d0dc4662a1c7378e61c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147707",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147709",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147710",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147711",
...
```json
{
    "body": "Changing commit from \"c3ae100155d686452e326d0dc4662a1c7378e61c\" to \"4c57ec058d7033b233b60b35993fb1e55d6982d1\"",
    "created_at": "2013-12-30T21:07:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147712",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "c3ae100155d686452e326d0dc4662a1c7378e61c" to "4c57ec058d7033b233b60b35993fb1e55d6982d1"
...
```json
{
    "body": "<a id='comment:13'></a>I did not see your new changes until after posting my comments.  I expect to  be happy with them and will just check...",
    "created_at": "2013-12-30T21:13:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147714",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:13'></a>I did not see your new changes until after posting my comments.  I expect to  be happy with them and will just check...
...
```json
{
    "body": "<a id='comment:14'></a>...done.   I am happy with the last commit which addresses the points I made (at least, the valid ones).  Good!",
    "created_at": "2013-12-30T21:16:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147715",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:14'></a>...done.   I am happy with the last commit which addresses the points I made (at least, the valid ones).  Good!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147716",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147717",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>If you plan to continue working on Galois representations, please be aware that I am working on #11905 (which also touches that code and conflicts with this patch).",
    "created_at": "2014-01-04T13:01:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147718",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>If you plan to continue working on Galois representations, please be aware that I am working on #11905 (which also touches that code and conflicts with this patch).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11271#event-29186"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11271#issuecomment-147719",
