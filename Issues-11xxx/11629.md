...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11629#issuecomment-121788",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11629",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11629#issuecomment-121789",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11629",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11629#issuecomment-121790",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11629",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11629#issuecomment-121791",
    "user": "https://github.com/loefflerd"
}
```
