...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/11878",
...
```json
{
    "body": "<a id='comment:1'></a>It turns out that the code for the quotients from #4539 did not work properly, because comparison of elements of g-algebras did not take into account the relations.",
    "created_at": "2011-09-30T09:51:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11878#issuecomment-162164",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>It turns out that the code for the quotients from #4539 did not work properly, because comparison of elements of g-algebras did not take into account the relations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11878#issuecomment-162166",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11878#issuecomment-162167",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>If one goes for the second approach, one should use the occasion and refactor the code of `sage.rings.polynomial.plural`, so that g-algebras and their elements will be defined in separate modules.",
    "created_at": "2011-10-04T06:47:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11878#issuecomment-162169",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>If one goes for the second approach, one should use the occasion and refactor the code of `sage.rings.polynomial.plural`, so that g-algebras and their elements will be defined in separate modules.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31389"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31390"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31391"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31392"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31393"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31394"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11878#event-31395"
}
```
