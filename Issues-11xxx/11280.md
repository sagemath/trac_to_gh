...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147905",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147908",
    "user": "https://trac.sagemath.org/admin/accounts/users/logix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147909",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Replying to [logix](#comment%3A4):\n\nI updated the patch to handle cases of Xcode's major version less than 3.\nPlease test (I tested the script as much as I could, but I don't have a very old Xcode around)",
    "created_at": "2011-05-04T09:45:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147910",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:6'></a>Replying to [logix](#comment%3A4):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147911",
...
```json
{
    "body": "<a id='comment:9'></a>If this Xcode version checking is performed, then the version of prereq needs to be incremented to 0.9, otherwise we are going to have different code with the same version number. That means creating a new tar file (prereq-0.8.tar), and changing the TARGET at the top of prereq-0.9-install to:\n\n```\nTARGET=prereq-0.9\n```\n\nAlso, I think the bit of code following:\n\n```\n    if [ $XCODE_VERS_MAJOR -gt 2 ]; then\n        echo \"You are using XCode version \" $XCODE_VERS\n        echo \"WARNING: You are strongly advised to install Apple's latest XCode 3,\"\n        echo \"unless you already have it. You can download this from \"\n        echo \"http://developer.apple.com/xcode/\"\n    fi\n```\n\nshould make it clear **not** to install Xcode 4. Although the message says to use the latest Xcode 3, someone reading it is likely to interpret that as to just upgrade. \n\nAlso, why use the -e option to sed? That's for when you want to specify the name of a script. If you put the script inline, as you have done here, the -e can be removed. \n\nDave",
    "created_at": "2011-05-06T09:10:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147913",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:9'></a>If this Xcode version checking is performed, then the version of prereq needs to be incremented to 0.9, otherwise we are going to have different code with the same version number. That means creating a new tar file (prereq-0.8.tar), and changing the TARGET at the top of prereq-0.9-install to:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147914",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147915",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147916",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147918",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147919",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147920",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147921",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147923",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147924",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147925",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147926",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147927",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147928",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147930",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147931",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>OK, here comes the updated thing, ready to be tested.",
    "created_at": "2011-05-07T04:40:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147932",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:22'></a>OK, here comes the updated thing, ready to be tested.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147933",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147934",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>This looks good to me. I can't test it on an OS X system with the different Xcode versions, so I'm relying on the assumption that the method for determinding the version is OK on Os X. But the script has a new version number, has the right permissions and extracts the right tar file. \n\nDave",
    "created_at": "2011-05-07T13:49:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147935",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:23'></a>This looks good to me. I can't test it on an OS X system with the different Xcode versions, so I'm relying on the assumption that the method for determinding the version is OK on Os X. But the script has a new version number, has the right permissions and extracts the right tar file. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147936",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11280#event-29215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147937",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147938",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>As a result of this closure, #8566 can be marked as closed and fixed. \n\nDave",
    "created_at": "2011-05-09T08:44:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11280#issuecomment-147939",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:25'></a>As a result of this closure, #8566 can be marked as closed and fixed. 
