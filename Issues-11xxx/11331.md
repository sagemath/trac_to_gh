...
```json
{
    "body": "Changing assignee from GeorgSWeber to @alexanderdreyer.",
    "created_at": "2011-05-12T15:40:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148980",
...
```json
{
    "body": "<a id='comment:1'></a>Can you try the package for PolyBoRi 0.7.1 from #11261? Unfortunately, I do not have access to that platform.",
    "created_at": "2011-05-12T15:40:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148981",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:1'></a>Can you try the package for PolyBoRi 0.7.1 from #11261? Unfortunately, I do not have access to that platform.
...
```json
{
    "body": "<a id='comment:3'></a>Another thing is that if you can give me a VERY easy way to try to build this from scratch, without Sage (though perhaps using Sage Python etc.) on this machine, I could see if that works.",
    "created_at": "2011-05-12T17:46:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148983",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Another thing is that if you can give me a VERY easy way to try to build this from scratch, without Sage (though perhaps using Sage Python etc.) on this machine, I could see if that works.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148984",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Okay, tried it from the build system in PolyBoRi itself.  Went very well for quite some time, but then failed on exactly the same file as before (BoolePolyRing.cc), though of course it had done all kinds of other stuff first.  Interestingly, it created BoolePolyRing.os fine, it was in making BoolePolyRing.o that the troubles came (as with the Sage build).  \n\nI will try to check what my other computer with this setup failed at; I don't think it was the same file.",
    "created_at": "2011-05-12T18:47:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148986",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Okay, tried it from the build system in PolyBoRi itself.  Went very well for quite some time, but then failed on exactly the same file as before (BoolePolyRing.cc), though of course it had done all kinds of other stuff first.  Interestingly, it created BoolePolyRing.os fine, it was in making BoolePolyRing.o that the troubles came (as with the Sage build).  
...
```json
{
    "body": "<a id='comment:8'></a>As ususal: the .os are prepared for shared libs (compiled with .-fPIC).\n\nDid you try out the changes in the src directory I suggested above?",
    "created_at": "2011-05-12T23:50:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148988",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:8'></a>As ususal: the .os are prepared for shared libs (compiled with .-fPIC).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148989",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Another update - the change to `pbori_order.h` did not fix the problem on the slower machine (the one that failed at `g++ -o polybori/src/BoolePolyRing.o`) but adding the change to `COrderedIter.h` did allow it to proceed past that very first file (hasn't finished yet).  \n\nAnd the attempt with only `pbori_order.h` changed on the newer machine led to the exact same failure as before.  So it seems that this is the problem.\n\nSo **why** is it the problem?  I do not want to have to chase this all down again with every PolyBoRi upgrade, as you can imagine.  If there is a good reference for why this would make the difference online, that would be great.  \n\nAnd if doing this on all files would help solve it in the future anyway, that would be fine too :)",
    "created_at": "2011-05-13T00:31:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148990",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Another update - the change to `pbori_order.h` did not fix the problem on the slower machine (the one that failed at `g++ -o polybori/src/BoolePolyRing.o`) but adding the change to `COrderedIter.h` did allow it to proceed past that very first file (hasn't finished yet).  
...
```json
{
    "body": "<a id='comment:11'></a>Yup, changing `COrderedIter.h` to move the `#include` statements did the trick on both machines.  \n\nIf you include something about this - and explanation!!! since this all seems quite magical to me - on #11261, then that would close this ticket as well.  Or a separate spkg update could be made for this.  Naturally, I would be willing to test them.",
    "created_at": "2011-05-13T00:53:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148991",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:11'></a>Yup, changing `COrderedIter.h` to move the `#include` statements did the trick on both machines.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148992",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "Attachment [polybori-0.7.0.p3-vs-p2.patch](tarball://root/attachments/some-uuid/ticket11331/polybori-0.7.0.p3-vs-p2.patch) by @alexanderdreyer created at 2011-05-13 08:34:34\n\nspkg-patch (just to simplify reviewing)",
    "created_at": "2011-05-13T08:34:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148993",
    "user": "https://github.com/alexanderdreyer"
}
```

Attachment [polybori-0.7.0.p3-vs-p2.patch](tarball://root/attachments/some-uuid/ticket11331/polybori-0.7.0.p3-vs-p2.patch) by @alexanderdreyer created at 2011-05-13 08:34:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148994",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148995",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148996",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148997",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148998",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-148999",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "Changing reviewer from \"Georg S. Weber\" to \"Georg S. Weber, Karl-Dieter Crisman\"",
    "created_at": "2011-05-14T23:46:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149001",
    "user": "https://github.com/kcrisman"
}
```

Changing reviewer from "Georg S. Weber" to "Georg S. Weber, Karl-Dieter Crisman"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149002",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149003",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149004",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149005",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>AlexanderDryer: could you please upload the spkg *without* the added `hg` tag?  My merge script gets confused with the already-added tag.",
    "created_at": "2011-05-16T07:49:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149006",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>AlexanderDryer: could you please upload the spkg *without* the added `hg` tag?  My merge script gets confused with the already-added tag.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149007",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149008",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149009",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149011",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149012",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11331#event-29390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149013",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149015",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing merged from \"\" to \"sage-4.7.rc4\"",
    "created_at": "2011-05-21T06:15:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11331#issuecomment-149016",
    "user": "https://github.com/jdemeyer"
}
```

Changing merged from "" to "sage-4.7.rc4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11331",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11331#event-29391"
}
```
