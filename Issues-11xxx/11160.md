...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113094",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113095",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113096",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket11160/tmp_0.png",
    "created_at": "2011-04-08T19:23:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11160/tmp_0.png",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [tmp_0.png](https://github.com/sagemath/sage/files/ticket11160/tmp_0.png) by @kcrisman created at 2011-04-08 19:23:50\n\nReplying to [kcrisman](#comment%3A2):\n> Adding the suboptions we usually send to save to the normal !Graphics class matplotlib removes the error, but does the following - see attached graphic.  I don't have time to do any more with this now, though.\n\n\nI should add that my code was slightly simpler:\n\n```\nsage: p = plot(x,legend_label='f')\nsage: G = graphics_array((p,p))\nsage: G\n```",
    "created_at": "2011-04-08T19:23:50Z",
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113097",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113098",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113099",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113100",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113101",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113102",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113103",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113104",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113105",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113106",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11160#issuecomment-113107",
    "user": "https://github.com/egourgoulhon"
}
```
