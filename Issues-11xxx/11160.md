...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29392"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29393"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29394"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29395"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29396"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29397"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29398"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122134",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122135",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122136",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29399"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29400"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122137",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122138",
...
```json
{
    "body": "Wait, what exactly are we trying to measure? I thought this ticket was about the overhead of `exp()` (I mean `sage.functions.log.exp`) for some argument types. If we allow ourselves to call the \u201cright\u201d function or method for each type, then both `RDF(x).exp()` and `math.exp(x)` are fast when applicable.",
    "created_at": "2015-04-23T06:52:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122140",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122141",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "Agreed that it is not exactly the same issue... but still there is a problem for `exp` being very slow. So we can either open a new ticket for that slightly similar issue or precise the issue here.",
    "created_at": "2015-04-24T21:36:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122142",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122143",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122145",
...
```json
{
    "body": "I agree that the original problem is fixed.",
    "created_at": "2017-08-30T18:44:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122146",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11160#event-29401"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11160#issuecomment-122147",
