...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-159349",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-159350",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-159351",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44643"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44644"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44645"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44646"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44647"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44648"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44649"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-44650"
}
```
