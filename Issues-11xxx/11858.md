...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11858#event-145914"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11858#event-145915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11858#event-145916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11858#issuecomment-126306",
    "user": "https://github.com/sagetrac-dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11858#issuecomment-126307",
    "user": "https://github.com/sagetrac-dangtuanhiep"
}
```
