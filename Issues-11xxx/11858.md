...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-126255",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-126256",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-126257",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95177"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95178"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95179"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95180"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95181"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95182"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95183"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95184"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-95185"
}
```
