...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-167482",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-167483",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11858#issuecomment-167484",
    "user": "https://trac.sagemath.org/admin/accounts/users/dangtuanhiep"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36956"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36957"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36958"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36959"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36960"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36961"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36962"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11858#event-36963"
}
```
