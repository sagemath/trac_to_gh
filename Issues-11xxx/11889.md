...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37077"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37078"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37079"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37080"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37081"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37082"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11889#event-37083"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/gh-belleb/power_series_exp_fails_uninformatively_when_base_ring_has_nonzero_characteristic\"",
    "created_at": "2019-02-05T05:14:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11889#issuecomment-168401",
    "user": "https://github.com/belleb"
}
```

Changing branch from "" to "u/gh-belleb/power_series_exp_fails_uninformatively_when_base_ring_has_nonzero_characteristic"
