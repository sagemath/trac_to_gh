...
```json
{
    ...
    "title": "yamanouchi.py: what is it for?",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193440",
...
```json
{
    "body": "It looks like it was added in #1685 with no content, as if it was going to have code to be used in computing LR coefficients. I'm tempted to remove it as there currently is no code, but it would be nice to have a simple generator for all Yamanouchi words.\n\nNicolas, Anne, Darij, do any of you currently have code to generate Yamanouci words (without appealing to the crystals code)? I have an idea about how to do it and could whip something up in a few hours if you think it's worthwhile to have.",
    "created_at": "2013-11-03T01:07:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193441",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193444",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193445",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193446",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Anne and I talked it over and decided that it would be best to remove it.",
    "created_at": "2013-11-08T22:59:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193447",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15110#issuecomment-193448",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15110",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15110#event-14788"
}
```
