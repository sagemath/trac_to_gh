...
Original creation time: 2017-11-21 12:12:50
...
Instead, we just want to strip u-prefixed strings from the desired output, and on Python 3 only, so that tests that expect some `str.__repr__()` pass the same on both Python 2 and 3.  Python 2 tests that _explicitly_ expect unicode will also pass on Python 3 since Python 3 `str``s are already unicode.

For tests that should expect bytes we can use the `b_` prefix and similarly strip `b_` prefixes from the desired output on Python 2, but I haven't actually hit too many cases like that yet so I will address that separately.


---

Comment by git created at 2017-11-21 12:18:16
...
Comment by embray created at 2017-11-21 12:18:42
...
Comment by chapoton created at 2017-11-21 12:49:21
...
Comment by chapoton created at 2017-11-21 14:34:41
...
Comment by embray created at 2017-11-21 15:14:00
...
Comment by git created at 2017-11-27 16:14:00
...
Comment by embray created at 2017-11-27 16:17:33
...
Comment by jdemeyer created at 2017-11-28 10:05:46
...
Comment by jdemeyer created at 2017-11-28 10:08:31
...
Comment by embray created at 2017-11-28 10:25:03
...
Comment by embray created at 2017-11-28 10:27:24
...
Comment by jdemeyer created at 2017-11-28 10:31:00
...
Comment by jdemeyer created at 2017-11-28 10:36:37
...
Comment by embray created at 2017-11-28 11:10:06
...
Comment by vbraun created at 2017-12-13 17:38:23
