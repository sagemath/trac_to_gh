# Issue 29414: error building docs of single file on Mac OS
...
```json
{
    ...
    "title": "error building docs of single file on Mac OS",
    "type": "issue",
...
```json
{
    "body": "Let me think more about the change to `sphinxbuild.py`. There should be another way to do this.",
    "created_at": "2020-05-07T03:26:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417269",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417270",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417272",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "I'm marking this as \"needs review\", but it could perhaps use improvements, as indicated in comment:5.\n----\nNew commits:",
    "created_at": "2020-08-29T21:06:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417273",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417274",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Note \"attempted relative import with no known parent package\"",
    "created_at": "2020-08-29T21:13:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417275",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "I can confirm that `./sage --docbuild file=src/sage/plot/text.py html` works",
    "created_at": "2020-08-29T21:14:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417276",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417277",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417278",
    "user": "git"
}
```
...
```json
{
    "body": "Maybe the module name needs to be set more intelligently if the path starts with `SAGE_SRC`, or something like that.",
    "created_at": "2020-08-29T22:53:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417279",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "Looks like the approach of `SingleFileBuilder`, creating a symlink to the source file, is not compatible with `from .module import ...`",
    "created_at": "2020-08-29T23:36:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417280",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417281",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417282",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "In any case, this is already an improvement. We can improve it further on a follow-up ticket.",
    "created_at": "2020-08-30T02:44:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417283",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417284",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29414#issuecomment-417285",
    "user": "vbraun"
}
```
