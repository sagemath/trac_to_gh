...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150442",
    "user": "hivert"
}
```
...
```json
{
    "body": "Sorry, I can not do any serious work (reviewing), as I am in the middle of holidays. But it looks promising!",
    "created_at": "2012-04-09T23:30:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150444",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150445",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Also, why not going all the way and remove the python version completely? Or at least: Why not cythonizing (and caching?) the `__contains__` method?",
    "created_at": "2012-04-20T07:18:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150446",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "PS: If that works, one could also get rid of the `DynamicClasscallMetaclass`, which seems like a hack that became necessary since one can not freely combine base classes with different metaclasses.",
    "created_at": "2012-04-20T08:06:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150448",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150449",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150450",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150451",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150452",
    "user": "hivert"
}
```
...
```json
{
    "body": "Could it be that the patch was created by something like \"hg remove sage/misc/classcall_metaclass.py\" followed by \"hg add sage/misc/classcall_metaclass.pyx\"?\n\nI am no mercurial expert, but I was told that one should better use \"hg rename sage/misc/classcall_metaclass.py sage/misc/classcall_metaclass.pyx\".",
    "created_at": "2012-04-22T08:46:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150453",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "While we are at it: Shouldn't we also try whether changing unique_representation.py into unique_representation.pyx yields a speedup (but not changing \"class\" into \"cdef class\", I guess that won't work)?",
    "created_at": "2012-04-22T08:58:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150454",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I have created an alternative patch (using hg rename). It is smaller than the original patch, but should result in identical code. So, either of the patches could be used, but I guess the smaller patch is easier to read (because one sees more easily the additional differences between classcall_metaclass.py and classcall_metaclass.pyx)\n\nApply trac_12808-classcall_speedup2.patch",
    "created_at": "2012-04-22T09:16:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150455",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I see that you added `_included_private_doc_`. Could you elaborate on it? I just searched the sources for that name, but it does not occur anywhere except in your patch. So, what does it do?",
    "created_at": "2012-04-22T19:04:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150458",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150459",
    "user": "nthiery"
}
```
...
```json
{
    "body": "Note that there is a conflict with #12215, so, either of the patches needs to be rebased. But I guess we first see what patch will be reviewed first...",
    "created_at": "2012-04-23T09:40:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150460",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150462",
    "user": "hivert"
}
```
...
```json
{
    "body": "I forgot: thanks for creating a new patch. I didn't use rename because at some point of my experiment, I was having the two files `*.py` and `*_c.pyx` with the `*.py` importing the other. Then I copied the documentation from `*.py` to `*_c.pyx` until the `*.py` becomes nearly empty. At the end, I renamed the `*_c.pyx` into the `*.pyx` and removed the `*.py`. \n\nHow did you manage to get a patch using rename at the end ?\n\nFlorent",
    "created_at": "2012-04-23T10:28:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150463",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150464",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150465",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150466",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150467",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150468",
    "user": "hivert"
}
```
...
```json
{
    "body": "How has the patch changed?",
    "created_at": "2012-04-23T21:01:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150469",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150470",
    "user": "hivert"
}
```
...
```json
{
    "body": "Replying to [comment:29 hivert]:\n> Oups ! Sorry I forgot to click \"submit changes\". Simon, your patch is broken. It is missing `classcall_metaclass.pxd` and as a consequence make Sage segfault as startup. I just added the file compared to your patch.\n\nAha! So, I forgot `hg add` at some point.",
    "created_at": "2012-04-24T05:08:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150471",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I notice that the crash seems to be related with importing the nested class examples in the nested_class module. Perhaps one needs to avoid any application of nested classes in the nested_class module, and move the examples to a different module?",
    "created_at": "2012-04-24T07:30:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150473",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150474",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "It seems that indeed it is impossible to use a cdef class as metaclass - see the example that I gave at [cython-users](http://groups.google.com/group/cython-users/browse_thread/thread/f1f7f004ee06aaad).\n\nHence, I guess your indirect solution (namely to define fast methods in a cdef class `ClasscallType` and then derive from it a usual Python class `ClasscallMetaclass`) is probably the only feasible.",
    "created_at": "2012-04-24T10:19:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150475",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150476",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150477",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150478",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150479",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150480",
    "user": "hivert"
}
```
...
```json
{
    "body": "Attachment [trac_12808-classcall_cdef.patch](tarball://root/attachments/some-uuid/ticket12808/trac_12808-classcall_cdef.patch) by SimonKing created at 2012-04-25 15:58:26\n\nMake ClasscallMetaclass an extension type of type",
    "created_at": "2012-04-25T15:58:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150482",
    "user": "SimonKing"
}
```

Attachment [trac_12808-classcall_cdef.patch](tarball://root/attachments/some-uuid/ticket12808/trac_12808-classcall_cdef.patch) by SimonKing created at 2012-04-25 15:58:26
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150484",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150485",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150486",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150487",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150488",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150489",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I forgot: Since your patch looks fine to me (independent on whether we eventually decide to cdef `ClasscallMetaclass` directly) and since all tests pass and the documentation looks fine, I give your part of the work a positive review.",
    "created_at": "2012-04-26T16:45:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150490",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150491",
    "user": "hivert"
}
```
...
```json
{
    "body": "Attachment [trac_12808_nested_class_cython.patch](tarball://root/attachments/some-uuid/ticket12808/trac_12808_nested_class_cython.patch) by SimonKing created at 2012-04-26 19:45:16\n\nCythonise nested classes",
    "created_at": "2012-04-26T19:45:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150492",
    "user": "SimonKing"
}
```

Attachment [trac_12808_nested_class_cython.patch](tarball://root/attachments/some-uuid/ticket12808/trac_12808_nested_class_cython.patch) by SimonKing created at 2012-04-26 19:45:16
...
```json
{
    "body": "Replying to [comment:49 hivert]:\n> Ok ! For your part I've a question: is there any reason why do you call\n> `sys_module` in `nested_pickle` whereas you call `sys.module` in\n> `NestedClassMetaclass.__init__` ?\n\nThanks for spotting it! I have updated the nested_class patch.\n\nApply trac_12808-classcall_speedup-fh.patch trac_12808_nested_class_cython.patch trac_12808-classcall_cdef.patch",
    "created_at": "2012-04-26T19:47:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150493",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150494",
    "user": "hivert"
}
```
...
```json
{
    "body": "Then it's a positive review for me !\n\nI also created #12886 as a followup.\n\nThanks Simon.",
    "created_at": "2012-04-26T21:13:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150495",
    "user": "hivert"
}
```
...
```json
{
    "body": "Please decide which patches have to be applied.",
    "created_at": "2012-04-26T22:20:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150496",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150497",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150498",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150499",
    "user": "hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150500",
    "user": "hivert"
}
```
...
```json
{
    "body": "There is a trivial conflict between this ticket and #12215 (in unique_representation.py). Which one should go first?",
    "created_at": "2012-04-30T08:22:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150501",
    "user": "nthiery"
}
```
...
```json
{
    "body": "I guess this one should go in first,: After all, #12215 has not been reviewed, yet.",
    "created_at": "2012-04-30T10:47:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150502",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150503",
    "user": "nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150504",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12636#issuecomment-150505",
    "user": "jdemeyer"
}
```
