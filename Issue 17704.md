...
Failed example:
    is_group_divisible_design([range(40)],[This is the Trac macro *e* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#e-macro),40,G=[5],lambd=1,verbose=True)
Expected:
