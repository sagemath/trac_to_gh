# Issue 18029: Conversion from Sage polynomial to gap/libgap
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18029#event-51572"
}
```
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18029#event-51573"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18029#event-51574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18029",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18029#event-51575"
}
```
