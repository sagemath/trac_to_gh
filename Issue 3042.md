...
```json
{
    "body": "Missing doctest for `matrix_modn_dense._matrix_from_rows_of_matrices()`",
...
```json
{
    "body": "The new patch applies fine on top of mine, and appears to resolve all my issues. Merge\n\n- trac-3042.hg\n\n- 3042-illustrative-doctest.patch\n\n- trac-3042-extra2.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3042#issuecomment-20950",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "If no one else wants to deal with this, I'll look at it next Weds when I get to Seattle. I'm happy to take care of it then.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3042#issuecomment-20952",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3042#issuecomment-20953",
    "user": "mabshoff"
}
```
