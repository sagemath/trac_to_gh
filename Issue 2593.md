# Issue 2593: [with patch, positive review] Sage chokes on utf-8 in .sage files
...
```json
{
    ...
    "title": "[with patch, positive review] Sage chokes on utf-8 in .sage files",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2593#issuecomment-17708",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2593#issuecomment-17709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2593#event-6049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2593#issuecomment-17710",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2593#issuecomment-17711",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
