...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186114",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186115",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    "body": "I have uploaded a new version of the patch which makes a small change: rather than building the terms of the *derivative* of a *CycleIndexSeries* using an opaque list concatenation, I have used the *CycleIndexSeriesRing.term* method.",
    "created_at": "2013-07-17T17:44:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186116",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186117",
...
```json
{
    "body": "Rebased patch to apply over 5.12.beta4.",
    "created_at": "2013-09-03T16:51:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186118",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    "body": "Attachment [trac_14846_cis_deriv_int_exp_methods.patch](tarball://root/attachments/some-uuid/ticket14846/trac_14846_cis_deriv_int_exp_methods.patch) by @fchapoton created at 2013-10-24 10:14:31\n\nCould you please add doctests to the three _lps functions ?",
    "created_at": "2013-10-24T10:14:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186119",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186120",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Skeletal doctests added for the three _lps_* functions. I have no idea whether this is the *right* way to test this sort of method, but at least it's *a* test.\n\nAdditionally, I've switched back over to using Git to manage this\u2014the old Mercurial workflow is just too confusing. How do I tell the build bot to ignore the attachments and only use the branch?",
    "created_at": "2013-11-23T17:01:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186121",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186122",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42638"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186123",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186124",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186125",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186126",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186127",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186128",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186129",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186131",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42640"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186132",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186133",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186135",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Cool, your changes look good to me!",
    "created_at": "2014-02-10T15:32:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186136",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42642"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42643"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42644"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42645"
}
```
...
```json
{
    "body": "I agree.  I wonder what happened to #16137.",
    "created_at": "2014-08-13T09:41:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186138",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42646"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186139",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Since #15673 seems to have died on the vine, I have rebuilt the code for this commit on top of current mainline Sage 6.7. All doctests in `combinat/species` pass.",
    "created_at": "2015-05-29T22:51:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186140",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42648"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186141",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186143",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14642#issuecomment-186144",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14642",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14642#event-42650"
}
```
