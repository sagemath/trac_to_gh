# Issue 6399: [with patch, positive review] Allow ATLAS to build on Solaris with Sun or GNU linker
...
```json
{
    ...
    "title": "[with patch, positive review] Allow ATLAS to build on Solaris with Sun or GNU linker",
    "type": "issue",
