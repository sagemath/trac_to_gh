...
```json
{
    "body": "Is this still an issue? I'm guessing you mean logging out of the Mac OSX system?",
...
```json
{
    "body": "timdumol -- I think this is not an issue.  It looks like a bug in the old templating code that you have long since replaced in sagenb.  So closed as fixed.   (And I can't replicate it.)",
    "created_at": "2009-11-19T23:36:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3802",
    "type": "issue_comment",
