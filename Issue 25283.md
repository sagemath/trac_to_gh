...
```json
{
    "body": "This is not really something we can do anything about, I expect. It's just a consequence of\n\n```\nsage: (0^x).simplify()\n0\n```\n\nwhich is wrong for `x=0`.",
    "created_at": "2018-06-06T20:50:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25283#issuecomment-356418",
    "user": "nbruin"
}
```
