...
```json
{
    "body": "Any self signed certificate causes issues with FF 3B4. So I don't think this has anything to do with Sage or GNUTLS. The solution is to add an exception rule so that firefox will access the site.\n\nI don't consider this a bug since it is a Firefox issue. The workaround needs to be documented and then this issue will be closed.\n\nCheers,\n\nMichael",
...
```json
{
    "body": "I just tried adding a security exception in Firefox 3 Beta 5 and it seems to work correctly (i.e., the firefox team fixed adding security exceptions of self-signed certificates).",
...
```json
{
    "body": "Can someone close this now? You can add exceptions with firefox 3 (officially released today) now.",
...
```json
{
    "body": "Yep, this is closed as wontfix.\n\nCheers,\n\nMichael",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1754",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1754#event-1912"
}
```
