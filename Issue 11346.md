...
Note that [https://www.math.ucdavis.edu/~latte/](https://www.math.ucdavis.edu/~latte/)(https://www.math.ucdavis.edu/~latte/) now has the most up to date "latest version, LattE integrale, has the ability to directly compute integrals of polynomial functions over polytopes and in particular to do volume computations."
