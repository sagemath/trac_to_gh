...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14075#issuecomment-175974",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14075#issuecomment-175975",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment [trac_14279-new_coercion_for_homsets.patch](tarball://root/attachments/some-uuid/ticket14279/trac_14279-new_coercion_for_homsets.patch) by @simon-king-jena created at 2013-03-15 17:06:43\n\nI change it into \"needs review\", in order to let the patchbot do some work.\n\nHowever, it will need a second patch, that improves documentation. But I certainly would like to get some input at that point.",
    "created_at": "2013-03-15T17:06:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14075#issuecomment-175976",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [trac_14279-new_coercion_for_homsets.patch](tarball://root/attachments/some-uuid/ticket14279/trac_14279-new_coercion_for_homsets.patch) by @simon-king-jena created at 2013-03-15 17:06:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14075#issuecomment-175977",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40410"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40411"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14075#issuecomment-175979",
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40413"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40414"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40415"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14075#event-40416"
}
```
