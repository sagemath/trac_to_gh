...
```
sage: L=K^2
sage: R=L.span([This is the Trac macro *x,1/x* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#x,1/x-macro))
sage: R.basis()[0][0]
x
sage: R.basis()[0][0].parent()
Fraction Field of Univariate Polynomial Ring in x over Rational Field
sage: R=L.span([This is the Trac macro *x,x^2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#x,x^2-macro))
sage: R.basis()[0][0].parent()
