...
```json
{
    ...
    "title": "Memory leak in automorphism groups of abelian groups",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381526",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    "body": "So I am proposing closing this.",
    "created_at": "2019-02-27T05:16:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381529",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67921"
}
```
...
```json
{
    "body": "So an `@`cached_method together with a unique representation would cause memory leaks?",
    "created_at": "2019-02-27T08:59:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381530",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    "body": "Not a ``@`cached_method` in a subclass of `UniqueRepresentation`. But I am pretty sure a ``@`cached_method` that creates a `UniqueRepresentation` `UR` whose input includes `self` ends up being a memory leak (because then `self` is a strong global reference as a key to `UR`, but `UR` has a strong reference being the output of ``@`cached_method`). (This also has a code smell because of the double-caching anyways.)\n\nIn some sense a `UniqueRepresentation` and ``@`cached_method` are the same as they use the same mechanism as ``@`cached_function` to store data.",
    "created_at": "2019-02-27T09:56:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381531",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381534",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "It has to do with the action.",
    "created_at": "2019-02-27T16:03:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381536",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381537",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    "body": "My understanding is that by creating the action, we are creating that cycle. So it is still apparently able to be collected. It is only when we actually multiply the elements that something changes. Maybe something also with checking for coercions?",
    "created_at": "2019-02-28T01:48:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381543",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Also, explicitly invoking `A.act(g, L.an_element())` does not nail things in memory.",
    "created_at": "2019-02-28T01:49:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381544",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "The test I wrote in comment:19 does is slightly different as `coercion_model.get_action` runs `Parent.get_action`, which does not put the action into the `_action_maps` `TripleDict`. Although I do believe the cycle mentioned in comment:15 is getting created, and it is that `coercion_model._action_maps` that nails it in memory.",
    "created_at": "2019-02-28T02:01:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381545",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381548",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381550",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67922"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381551",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67924"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67925"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67926"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27121#issuecomment-381552",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67928"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67929"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67930"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67931"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67932"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67933"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67934"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67935"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67936"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27121#event-67937"
}
```
