# Issue 28782: Make patch to pillow more robust (do not depend on "Py_MACOS_SYSROOT") and fix zlib problem on macOS
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28782",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28782#event-73515"
}
```
