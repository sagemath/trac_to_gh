...
Given that the very nature of Python (and any normal programming language), any circular reference is always inserted by _modifying_ and existing object(*). That's what `setstate` in pickling is for.
