...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89111",
    "user": "mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89113",
    "user": "mvngu"
}
```
...
```json
{
    "body": "Note from Rakhim: Authors of translation are Temirlan Kumargazhin and Rakhim Davletkaliyev, Vladimir was more an editor.",
    "created_at": "2010-06-29T18:49:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89114",
    "user": "schilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89115",
    "user": "schilly"
}
```
...
```json
{
    "body": "I've created a patch that includes the modifications to Sage 4.5 to include the russian tutorial. HTML builds fine, to get PDF working I had to install the cyrillic lang package for my livetex, too. It stopped once during latex compilation but worked fine when I just hit return.",
    "created_at": "2010-07-20T14:18:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89116",
    "user": "schilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89117",
    "user": "schilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89118",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89119",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89122",
    "user": "novoselt"
}
```
...
```json
{
    "body": "Here are my first corrections, there are also some obvious typos in section names which I am going to fix.",
    "created_at": "2011-06-14T05:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89123",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89124",
    "user": "novoselt"
}
```
...
```json
{
    "body": "I'll go through all examples to translate comments, here is an updated version of the patch. I have removed the makefile as it is not present in the French version and seems to be unnecessary, correct me if I am wrong.",
    "created_at": "2011-06-14T07:31:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89125",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89126",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89128",
    "user": "kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89129",
    "user": "kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89131",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89132",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89133",
    "user": "novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89134",
    "user": "kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89135",
    "user": "kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89136",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89137",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9378#issuecomment-89138",
    "user": "jdemeyer"
}
```
