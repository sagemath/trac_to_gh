# Issue 32928: faster evaluation of polynomials in R[x] at monomials in R[y] or R[u,v] and variables in R[x]/(f)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32928",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32928#event-87620"
}
```
