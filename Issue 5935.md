...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5935#issuecomment-46929",
    "user": "ekirkman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5935#issuecomment-46930",
    "user": "ekirkman"
}
```
...
```json
{
    "body": "Marked as duplicate because this documentation change is covered in the patch for ticket #5936.",
    "created_at": "2009-05-21T21:57:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5935#issuecomment-46931",
    "user": "ekirkman"
}
```
