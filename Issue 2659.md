...
```json
{
    "body": "The attached is (I believe) a simpler solution to the issue, after applying the patches for #2653 it is as fast as forceably casting everything to be an integer. \n\nThere is other stuff in `9029.patch` that should possibly be extracted, however.",
...
```json
{
    "body": "Only apply 9123.patch.  The changes in 9122.patch are in #210.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2659#issuecomment-18312",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2659#issuecomment-18313",
    "user": "mabshoff"
}
```
