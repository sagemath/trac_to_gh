...
```json
{
    "body": "The problem seems to be that the `Polynomial.__init__()` method doesn't check that the parent is a `PolynomialRing`. This could be easily fixed, but first I'm wondering what on earth the `construct=False` parameter in the constructor is supposed to mean?...\n\n\n```\ndef __init__(self, parent, is_gen = False, construct=False): \n          ring_element.RingElement.__init__(self, parent)\n          self._is_gen = is_gen\n```\n",
    "created_at": "2006-10-27T03:01:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/119#issuecomment-557",
    "user": "dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/119#issuecomment-559",
    "user": "was"
}
```
