...
Expected:
    B[(1,2,3)]
Got:
    B[This is the Trac macro *2, 3, 1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2, 3, 1-macro)
**********************************************************************
...
Got:
    4*B[This is the Trac macro *1, 2, 3, 4* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1, 2, 3, 4-macro) + 3*B[This is the Trac macro *2, 1, 3, 4* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2, 1, 3, 4-macro) + 2*B[This is the Trac macro *2, 1, 4, 3* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2, 1, 4, 3-macro) + 2*B[This is the Trac macro *2, 3, 1, 4* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2, 3, 1, 4-macro) + B[This is the Trac macro *2, 3, 4, 1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2, 3, 4, 1-macro)
**********************************************************************
