...
```json
{
    "body": "This is good code. I don't have time to run tests, but as long as they pass this should definitely be merged.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4447#issuecomment-32797",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "Merged in Sage 3.2.rc1 - doctests do pass.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-13T18:42:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4447#issuecomment-32798",
    "user": "mabshoff"
}
```
