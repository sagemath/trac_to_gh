...
```json
{
    "body": "Another useful resource is Guido's blog series on implementing a PEG parser for Python: https://medium.com/`@`gvanrossum_83706/peg-parsing-series-de5d41b2ed60",
    "created_at": "2020-10-13T14:15:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30523#issuecomment-435850",
    "user": "embray"
}
```
...
```json
{
    "body": "Python's built-in tokenizer (whether the C version or the plain Python version) is not so easy to extend as I'd hoped either.  Would be nice to have an explicit listing somewhere of exactly what would be needed to support Sage.",
    "created_at": "2020-10-14T10:56:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30523#issuecomment-435851",
    "user": "embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30523#issuecomment-435852",
    "user": "@mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30523#issuecomment-435853",
    "user": "slelievre"
}
```
