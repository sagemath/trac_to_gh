...
```json
{
    "body": "Attachment [eclib-flush.patch](tarball://root/attachments/some-uuid/ticket28454/eclib-flush.patch) by @jhpalmieri created at 2019-09-04 22:00:55",
    "created_at": "2019-09-04T22:00:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398027",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398031",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Thanks, that is helpful -- my guess is that the warning message is being created in an earlier doctest but only appearing in this one.  That code in mrank1.cc is only run when doing 2-descent on elliptic curves with no 2-torsion.  So the next step would be to manually run some subset of the doctests in that file interface.py.\n\nI'll make myself a new python3 build and see if I can get to the bottom of this.",
    "created_at": "2019-09-05T18:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398032",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Note that it is also platform-specific: I don't see it on OS X, for example. It is conceivable that it depends on a combination of the OS and the processor, or it could just be the OS. It makes it (along with a few other Python 3 failures) annoying to debug and fix.",
    "created_at": "2019-09-05T18:27:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398033",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "And of course, I am happy to test things on my virtual machine. Let me know how I can help.",
    "created_at": "2019-09-05T19:42:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398034",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398037",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398039",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "The tarball in comment 14 is looking good (to me).  After installing it in a python2 Sage I only needed to adjust one doctest in this file interface.py: line 359 now says\n\n```\nRuntimeError: A 2-descent did not complete successfully.\n```\n\n\nI have not yet done any python3 testing.",
    "created_at": "2019-09-09T16:36:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398040",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "It looks good to me, too, at least as far as the doctests in `libs/eclib/` are concerned: I just see the one problem you mentioned. This is with Python 3.\n\nI think I will still prepare a patch for the old version, since it's easy to do, and if we end up not needing it and going straight to your new version, that's fine with me.",
    "created_at": "2019-09-09T18:28:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398041",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398042",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "The other good news is that because of this ticket, I realized that the same non-flushing problem causes another Python 3 doctest failure (#28334), which I had no idea how to diagnose before.",
    "created_at": "2019-09-09T19:09:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398044",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Ticket #28472 has an eclib upgrade.  No reason why the patch here cannot be merged first.",
    "created_at": "2019-09-10T18:23:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398046",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398047",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "(No breach of etiquette at all, by the way. I just want to get the problem fixed.)",
    "created_at": "2019-09-10T19:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398049",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Strange.  I'll double check that I put in all the flushes, and perhaps insert some more before as well as after each library call.",
    "created_at": "2019-09-10T21:12:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398050",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398051",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398052",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28217#event-71281"
}
```
...
```json
{
    "body": "I agree. I'm marking this as a duplicate.",
    "created_at": "2019-09-11T18:38:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398053",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "(deleting the branch so it doesn't get merged by accident)",
    "created_at": "2019-09-12T21:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398054",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398055",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28217#event-71282"
}
```
...
```json
{
    "body": "I know this is closed, but can you reproduce the issue if you run the tests with `--memlimit=0`?",
    "created_at": "2019-09-18T11:28:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398056",
...
```json
{
    "body": "`./sage -t --memlimit=0 src/sage/lib/eclib/interface.py` fails the same way.",
    "created_at": "2019-09-18T16:59:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28217#issuecomment-398057",
    "user": "https://github.com/jhpalmieri"
}
```
