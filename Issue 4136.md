# Issue 4136: [with patch, positive review] enable tail reduction when reducing multivariate polynomials
...
```json
{
    ...
    "title": "[with patch, positive review] enable tail reduction when reducing multivariate polynomials",
    "type": "issue",
