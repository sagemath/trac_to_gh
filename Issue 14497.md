...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183306",
    "user": "https://github.com/amritanshu-prasad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183307",
    "user": "https://github.com/amritanshu-prasad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183309",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183310",
    "user": "https://github.com/amritanshu-prasad"
}
```
...
```json
{
    "body": "Attachment [18387.patch](tarball://root/attachments/some-uuid/ticket14701/18387.patch) by @amritanshu-prasad created at 2013-06-14 09:20:10\n\nDear Travis,\n\nThanks for the corrections; there was just one doctest that failed because of wrong spacing. I have corrected that, and I think this is ok now.\n\nAmri.\n\nReplying to [comment:2 tscrim]:\n> Hey Amri,\n> \n> Here's a review patch which does the following:\n> \n> - Uses `**` instead of `^` since in python (which all `.py` files get interpreted as) the latter means bitwise-xor.\n> - Makes some simplifications to your code by using the `prod` function instead of `reduce`.\n> - Expands on the docstrings and changes them around for some formatting and default latex macros for sage.\n> \n> If you're happy with my changes, you can go ahead and set this to positive review. Feel free to ask me any questions if you have any.\n> \n> Best,\n\n> Travis",
    "created_at": "2013-06-14T09:20:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183311",
    "user": "https://github.com/amritanshu-prasad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183312",
    "user": "https://github.com/amritanshu-prasad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14497#event-42108"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14497#issuecomment-183313",
