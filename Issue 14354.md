...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181047",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181048",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181049",
...
```json
{
    "body": "Attachment [trac_14558_apply_map_on_sparse_vectors.patch](tarball://root/attachments/some-uuid/ticket14558/trac_14558_apply_map_on_sparse_vectors.patch) by tfeulner created at 2013-06-26 13:36:07\n\nReplying to [comment:3 rbeezer]:\n> It looks like you have duplicated some code for finding the common ring.  I think that ideally this step should remain in the vector constructor.\n\nI agree with you, this should stay in the constructor.\n\nThe updated patch now just explicitly adds, in the cases where it is necessary, one zero entry to the dictionary.",
    "created_at": "2013-06-26T13:36:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181050",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14354#event-41466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181051",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181052",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14354#event-41467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14354#issuecomment-181053",
