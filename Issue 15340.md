...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15340#issuecomment-197297",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "Actually, I'm pretty sure now that my `_left_normal_form_perm_` is wrong for r2l order, but someone will have to tell me what it should be...",
    "created_at": "2013-12-23T22:44:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15340#issuecomment-197299",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15340#issuecomment-197300",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15340#event-45537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15340#issuecomment-197301",
...
```json
{
    "body": "I have rebased this on top of the new develop, and force-pushed it. (An alternative would be merging, but reviewing merge commits is error-prone.)\n\nAm I getting the meaning of the methods right? Anyone? Care to add some doctests using both left-to-right and right-to-left options?",
    "created_at": "2014-03-24T15:53:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15340#issuecomment-197302",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15340#event-45538"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15340#event-45539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15340#issuecomment-197303",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15340#event-45540"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15340#event-45541"
}
```
