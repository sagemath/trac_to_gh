...
```json
{
    ...
    "title": "On OS X ppc, to_poly_solve evidently doesn't exist / work, which breaks some symbolic doctests",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7202#issuecomment-59773",
    "user": "@williamstein"
}
```
