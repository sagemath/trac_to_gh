...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39798",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_4834_bug_demo.sws](tarball://root/attachments/some-uuid/ticket4834/trac_4834_bug_demo.sws) by @rbeezer created at 2010-12-10 02:14:37\n\nAttached worksheet does a better job of illustrating the problem.  I plan to attack this at Bug Days if it is still open.\n\nCan we naturally coerce vectors from lower-dimensional subspaces into the obvious ambient vector space (the one with same degree, same ring or a common super-ring)?  That might be one other solution.",
    "created_at": "2010-12-10T02:14:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39799",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:2'></a>Attachment [trac_4834_bug_demo.sws](tarball://root/attachments/some-uuid/ticket4834/trac_4834_bug_demo.sws) by @rbeezer created at 2010-12-10 02:14:37
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39800",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39801",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I fiddled with this a bit, and thought I posted a patch.  I can help at the Bug Days with this, if it's still open.",
    "created_at": "2010-12-10T02:43:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39802",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>I fiddled with this a bit, and thought I posted a patch.  I can help at the Bug Days with this, if it's still open.
...
```json
{
    "body": "<a id='comment:5'></a>I spent some time trying to see where to add this to the coercion system, but it was beyond me. I could probably review a fix.",
    "created_at": "2011-01-12T18:03:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39804",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:5'></a>I spent some time trying to see where to add this to the coercion system, but it was beyond me. I could probably review a fix.
...
```json
{
    "body": "<a id='comment:6'></a>A workaround is to begin with symbolic matrices, which are now amenable to eigenvector computations (albeit slowly).  See #6934, #10346 (coming soon to an official release).  Then results (eigenvectors) are symbolic for starters, so they play nicely with a symbolic expression like the variable t.\n\n```\nsage: B=matrix(SR, [[1,2],[2,1]])\nsage: spec=B.eigenvectors_left()\nsage: spec\n[(3, [(1, 1)], 1), (-1, [(1, -1)], 1)]\nsage: v = spec[0][1][0]\nsage: z = spec[1][1][0]\nsage: z.parent()\nVector space of dimension 2 over Symbolic Ring\nsage: var('t')\nt\nsage: v + t*z\n(t + 1, -t + 1)\n```\n\nBut I think an addition to the coercion system is still the best long-term solution, since these symbolic eigenvalue computations are not real robust.",
    "created_at": "2011-01-22T21:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4834#issuecomment-39805",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:6'></a>A workaround is to begin with symbolic matrices, which are now amenable to eigenvector computations (albeit slowly).  See #6934, #10346 (coming soon to an official release).  Then results (eigenvectors) are symbolic for starters, so they play nicely with a symbolic expression like the variable t.
