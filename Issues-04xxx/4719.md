...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4719#issuecomment-29402",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_4719_bin.patch](https://github.com/sagemath/sage/files/ticket4719/trac_4719_bin.patch) by @garyfurnish created at 2008-12-06 03:23:09\n\nFailing doctests should now fail correctly.",
    "created_at": "2008-12-06T03:23:09Z",
    "issue": "https://github.com/sagemath/sage/issues/4719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4719#issuecomment-29403",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4719#issuecomment-29404",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4719#issuecomment-29405",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4719#issuecomment-29406",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
