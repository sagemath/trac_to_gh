...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32609",
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4250#event-15860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32610",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32611",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "rename": {
        "from": "In QQ[t], 2**t should raise an error, but it crashes",
        "to": "[with patch, needs review] In QQ[t], 2**t should raise an error, but it crashes"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4250#event-15861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32612",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32613",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32614",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "rename": {
        "from": "[with patch, needs review] In QQ[t], 2**t should raise an error, but it crashes",
        "to": "[with patch, positive review] In QQ[t], 2**t should raise an error, but it crashes"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4250#event-15862"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4250#event-15863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32615",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4250#issuecomment-32616",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
