# Issue 4541: [with patch; positive review] kschur functions don't properly convert to schur's
...
```json
{
    ...
    "title": "[with patch; positive review] kschur functions don't properly convert to schur's",
    "type": "issue",
