...
```json
{
    "body": "<a id='comment:2'></a>A much simpler and faster algorithm. I'm sure there's a faster, balanced algorithm, but this is a huge improvement over what is there.",
    "created_at": "2008-11-16T08:51:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36590",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>A much simpler and faster algorithm. I'm sure there's a faster, balanced algorithm, but this is a huge improvement over what is there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36592",
...
```json
{
    "body": "<a id='comment:5'></a>Of course :). I've posted an updated patch.",
    "created_at": "2008-11-16T09:56:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36593",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>Of course :). I've posted an updated patch.
...
```json
{
    "body": "<a id='comment:7'></a>The new code looks very like my C++ functions in eclib (there for the taking!) which include various other options such as \n* only poitive divisors vs. both signs\n* only divisors d such that `d^2|n`\nwhich I did once need, and so on.\n\nJust a comment.",
    "created_at": "2008-11-17T09:57:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36595",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>The new code looks very like my C++ functions in eclib (there for the taking!) which include various other options such as 
* only poitive divisors vs. both signs
* only divisors d such that `d^2|n`
which I did once need, and so on.
...
```json
{
    "body": "<a id='comment:10'></a>Yep. I plan to specialize Integer.divisors() and attempt to call that in the top-level divisors function. It will have a much faster sort. \n\nI'm wondering though if the default should be sorted, or if one should use `sorted(divisors(n))` if one wants them in order.",
    "created_at": "2008-11-18T06:42:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36598",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:10'></a>Yep. I plan to specialize Integer.divisors() and attempt to call that in the top-level divisors function. It will have a much faster sort. 
...
```json
{
    "body": "<a id='comment:11'></a>OK, here's another patch that should resolve all of the above issues. One of the doctests depends on #4534 (odd_part returning an integer rather than a rational).",
    "created_at": "2008-11-18T23:40:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36599",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:11'></a>OK, here's another patch that should resolve all of the above issues. One of the doctests depends on #4534 (odd_part returning an integer rather than a rational).
...
```json
{
    "body": "<a id='comment:13'></a>I updated the patch, now its faster than pari. \n\nThere is a dependancy on #4564 for long long -> mpz_t.",
    "created_at": "2008-11-20T13:04:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36600",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>I updated the patch, now its faster than pari. 
...
```json
{
    "body": "<a id='comment:14'></a>Is it \"faster than Magma\" too?    Could you do some timings?",
    "created_at": "2008-11-20T17:40:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36601",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:14'></a>Is it "faster than Magma" too?    Could you do some timings?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36603",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36605",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36606",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Merged the edited patch in Sage 3.2.1.alpha0",
    "created_at": "2008-11-21T08:47:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4533",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4533#issuecomment-36607",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:19'></a>Merged the edited patch in Sage 3.2.1.alpha0
