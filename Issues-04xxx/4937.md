# Issue 4937: [with patch, positive review] bug in _p_primary_torsion_basis() for elliptic curves
...
```json
{
    ...
    "title": "[with patch, positive review] bug in _p_primary_torsion_basis() for elliptic curves",
    "type": "issue",
