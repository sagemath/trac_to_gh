...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39758",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] bug in _p_primary_torsion_basis() for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4937#event-19066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39759",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "rename": {
        "from": "[with patch, needs review] bug in _p_primary_torsion_basis() for elliptic curves",
        "to": "[with patch, positive review] bug in _p_primary_torsion_basis() for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4937#event-19067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39761",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "rename": {
        "from": "[with patch, positive review] bug in _p_primary_torsion_basis() for elliptic curves",
        "to": "[with patch, positive review, needs rebase] bug in _p_primary_torsion_basis() for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4937#event-19068"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4937#event-19069"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39762",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39763",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4937#issuecomment-39764",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4937#event-19070"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4937",
    "rename": {
        "from": "[with patch, positive review, needs rebase] bug in _p_primary_torsion_basis() for elliptic curves",
        "to": "[with patch, positive review] bug in _p_primary_torsion_basis() for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4937#event-19071"
}
```
