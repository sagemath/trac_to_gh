...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4856#issuecomment-39045",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "rename": {
        "from": "[with patch; needs review] make qasm an optional spkg",
        "to": "[with spkg; needs review] make qasm an optional spkg"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4856#event-18677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "rename": {
        "from": "[with spkg; needs review] make qasm an optional spkg",
        "to": "[with spkg; needs work] make qasm an optional spkg"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4856#event-18678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4856#issuecomment-39046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4856#event-18679"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4856#issuecomment-39047",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4856#issuecomment-39048",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4856#issuecomment-39049",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4856#event-18680"
}
```
