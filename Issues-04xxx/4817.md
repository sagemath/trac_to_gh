# Issue 4817: [with patch, positive review] make an os x clickable .app launcher thing for sage automatically when one does -bdist on osx
...
```json
{
    ...
    "title": "[with patch, positive review] make an os x clickable .app launcher thing for sage automatically when one does -bdist on osx",
    "type": "issue",
...
```json
{
    "body": "<a id='comment:1'></a>This should probably wait until 3.3, but it would be great if we could get this done for the AMS binaries.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-17T10:00:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37408",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This should probably wait until 3.3, but it would be great if we could get this done for the AMS binaries.
...
```json
{
    "body": "<a id='comment:2'></a>Any volunteers to make this happen?\n\nCheers,\n\nMichael",
    "created_at": "2009-01-12T02:29:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37409",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Any volunteers to make this happen?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37410",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37411",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37412",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37415",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37416",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37417",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4817#issuecomment-37418",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
