...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4128#event-23745"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4128#event-23746"
}
```
...
```json
{
    ...
    "label": "component: doctest framework",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4128#event-23747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4128#event-23748"
}
```
