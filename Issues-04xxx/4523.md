...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4523#event-17114"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "rename": {
        "from": "browser cache not cleared when restarting the worksheet",
        "to": "[with patch, needs review] browser cache not cleared when restarting the worksheet"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4523#event-17115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4523#issuecomment-35497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4523#issuecomment-35498",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "rename": {
        "from": "[with patch, needs review] browser cache not cleared when restarting the worksheet",
        "to": "[with patch, positive review] browser cache not cleared when restarting the worksheet"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4523#event-17116"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4523#event-17117"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4523#event-17118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4523#issuecomment-35499",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4523#event-17119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4523#issuecomment-35500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
