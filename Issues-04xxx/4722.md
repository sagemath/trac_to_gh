...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37802",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37803",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37804",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37805",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "rename": {
        "from": "BUG - number field K.hilbert_class_polynomial() is a *lie*",
        "to": "[with patch; needs review] BUG - number field K.hilbert_class_polynomial() is a *lie*"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4722#event-18037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37806",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "rename": {
        "from": "[with patch; needs review] BUG - number field K.hilbert_class_polynomial() is a *lie*",
        "to": "[with patch; positive review] BUG - number field K.hilbert_class_polynomial() is a *lie*"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4722#event-18038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4722#event-18039"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4722#issuecomment-37808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
