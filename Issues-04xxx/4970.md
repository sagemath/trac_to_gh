...
```json
{
    "body": "Changed assignee from **mabshoff** to **@NathanDunfield**",
    "created_at": "2015-01-07T15:27:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4970#issuecomment-31372",
    "user": "https://github.com/NathanDunfield"
}
```

Changed assignee from **mabshoff** to **@NathanDunfield**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4970#issuecomment-31373",
