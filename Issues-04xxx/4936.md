...
```json
{
    "body": "<a id='comment:1'></a>I know there are GAP users who always load GAP via a workspace. I'm worried that if the only way to use GAP in Sage was to use a \"recent\" workspace then these users would not be well-werved.\n\nA possible workaround would be if there was a way to optionally use a specific workspace. In other words, .\\sage -gap and gap_console() could take an optional argument with a specific workspace. Does this seem reasonable? It might be rarely used, but it could be a potentially very useful feature to allow users to use another workspace.",
    "created_at": "2009-01-04T17:34:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40705",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:1'></a>I know there are GAP users who always load GAP via a workspace. I'm worried that if the only way to use GAP in Sage was to use a "recent" workspace then these users would not be well-werved.
...
```json
{
    "body": "<a id='comment:3'></a>To test the attached patch, look $HOME/.sage/gap, and notice if you have a lot of old files there.  Maybe even fake some old workspace files like this:\n\n```\ntouch -t 01010000 workspace-00\n```\n\nThen touch local/bin/gap_stamp to force a recheck\n\n```\ncd SAGE_ROOT\ntouch local/bin/gap_stamp\n```\n\nand note that when you start sage the files you created in $DOT_SAGE/gap are deleted.",
    "created_at": "2009-01-24T06:07:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40707",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>To test the attached patch, look $HOME/.sage/gap, and notice if you have a lot of old files there.  Maybe even fake some old workspace files like this:
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_4936.patch](tarball://root/attachments/some-uuid/ticket4936/trac_4936.patch) by @mwhansen created at 2009-01-24 06:31:20\n\nThis works perfectly for me.",
    "created_at": "2009-01-24T06:31:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40708",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>Attachment [trac_4936.patch](tarball://root/attachments/some-uuid/ticket4936/trac_4936.patch) by @mwhansen created at 2009-01-24 06:31:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40710",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40711",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4936#issuecomment-40712",
    "user": "https://github.com/fchapoton"
}
```
