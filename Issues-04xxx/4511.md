...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44712"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44714"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44716"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4511#issuecomment-27443",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4511#issuecomment-27444",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4511",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4511#event-44722"
}
```
