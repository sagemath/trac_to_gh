...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37555",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] magma/sage interface -- coercion for single variable polynomials broken in some cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4701#event-17944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37556",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37557",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "rename": {
        "from": "[with patch; needs review] magma/sage interface -- coercion for single variable polynomials broken in some cases",
        "to": "[with patch; needs works] magma/sage interface -- coercion for single variable polynomials broken in some cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4701#event-17945"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "rename": {
        "from": "[with patch; needs works] magma/sage interface -- coercion for single variable polynomials broken in some cases",
        "to": "[with patch, with positive] magma/sage interface -- coercion for single variable polynomials broken in some cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4701#event-17946"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37558",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "rename": {
        "from": "[with patch, with positive] magma/sage interface -- coercion for single variable polynomials broken in some cases",
        "to": "[with patch, with positive review] magma/sage interface -- coercion for single variable polynomials broken in some cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4701#event-17947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37559",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4701#issuecomment-37561",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4701",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4701#event-17948"
}
```
