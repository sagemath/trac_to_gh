...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4701#issuecomment-29238",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [trac_4701.patch](https://github.com/sagemath/sage/files/ticket4701/trac_4701.patch) by @williamstein created at 2008-12-05 01:57:59",
    "created_at": "2008-12-05T01:57:59Z",
    "issue": "https://github.com/sagemath/sage/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4701#issuecomment-29239",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac_4701.patch](https://github.com/sagemath/sage/files/ticket4701/trac_4701.patch) by @williamstein created at 2008-12-05 01:57:59
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [4701-referee.patch](https://github.com/sagemath/sage/files/ticket4701/4701-referee.patch) by @ncalexan created at 2008-12-06 23:16:48\n\nAfter some discussion on IRC, wstein and I decided to review this positive and open a new ticket for the referee comments.  Apply trac_4701.patch and trac_4701_part2.patch only.",
    "created_at": "2008-12-06T23:16:48Z",
    "issue": "https://github.com/sagemath/sage/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4701#issuecomment-29241",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4701#issuecomment-29242",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4701#issuecomment-29243",
