...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37725",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Small bug in KodairaSymbol"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4715#event-18003"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4715#event-18004"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "rename": {
        "from": "[with patch, needs review] Small bug in KodairaSymbol",
        "to": "[with patch, not ready for review] Small bug in KodairaSymbol"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4715#event-18005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37726",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37727",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "rename": {
        "from": "[with patch, not ready for review] Small bug in KodairaSymbol",
        "to": "[with patch, needs review] Two small bugs in KodairaSymbol"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4715#event-18006"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37728",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "rename": {
        "from": "[with patch, needs review] Two small bugs in KodairaSymbol",
        "to": "[with patch; positive review] Two small bugs in KodairaSymbol"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4715#event-18007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4715#event-18008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37729",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37730",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37731",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4715#issuecomment-37732",
    "user": "https://github.com/jdemeyer"
}
```
