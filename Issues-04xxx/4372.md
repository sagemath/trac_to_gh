...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34777",
    "user": "https://github.com/jvoight"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>> totallyreal_dsage is still at a nodoctest status, so shouldn't require any (meaningful) review if the patch works (it's against 3.1.4). \n\n\nAny patch should be reviewed in detail regardless of nodoctest status or not. Is there a specific reason we shouldn't remove the nodoctest on that file now?\n\nCheers,\n\nMichael",
    "created_at": "2008-10-27T01:03:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34778",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>> totallyreal_dsage is still at a nodoctest status, so shouldn't require any (meaningful) review if the patch works (it's against 3.1.4). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34779",
    "user": "https://github.com/jvoight"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>> Agreed. I'd say the code is still 'experimental'; it only most of the time works \n> for me without extra effort, though this is probably because dsage itself \n> keeps getting upgraded.\n\n\nWell that will happen at most one more time, since dsage development stopped.",
    "created_at": "2008-11-28T22:34:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34781",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>> Agreed. I'd say the code is still 'experimental'; it only most of the time works 
> for me without extra effort, though this is probably because dsage itself 
> keeps getting upgraded.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34783",
    "user": "https://github.com/jvoight"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>As of Sage 4.3.1, ticket #7975 removed dsage from the standard spkg repository. I'm closing this ticket as wontfix. If there's a need for using dsage, one could make dsage an optional package with doctests marked as optional.",
    "created_at": "2010-02-02T06:37:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34784",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>As of Sage 4.3.1, ticket #7975 removed dsage from the standard spkg repository. I'm closing this ticket as wontfix. If there's a need for using dsage, one could make dsage an optional package with doctests marked as optional.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34785",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4372#issuecomment-34786",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
