...
archive/attachments_005466.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "elllog-2.patch",
    "asset_url": "tarball://root/attachments/ticket4901/elllog-2.patch",
    "created_at": "2009-01-01T18:41:00Z",
    "issue": "https://github.com/sagemath/sage/issues/4901",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4901/elllog-2.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [elllog-2.patch](https://github.com/sagemath/sage/files/ticket4901/elllog-2.patch) by @JohnCremona created at 2009-01-01 18:41:00",
    "created_at": "2009-01-01T18:41:00Z",
    "issue": "https://github.com/sagemath/sage/issues/4901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4901#issuecomment-30747",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [elllog-2.patch](https://github.com/sagemath/sage/files/ticket4901/elllog-2.patch) by @JohnCremona created at 2009-01-01 18:41:00
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4901#issuecomment-30748",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29847"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29848"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4901#issuecomment-30749",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4901#issuecomment-30750",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29851"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4901#event-29852"
}
```
