...
archive/attachments_004649.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_4217-html-system-formatting.patch](https://github.com/sagemath/sage/files/ticket4217/trac_4217-html-system-formatting.patch)\n\nRemoves Cell.__is_html and instead depends on the Cell.system() call for html cell detection",
    "created_at": "2010-01-17T01:22:36Z",
    "issue": "https://github.com/sagemath/sage/issues/4217",
    "type": "issue_comment",
...
**Attachment:** [trac_4217-html-system-formatting.patch](https://github.com/sagemath/sage/files/ticket4217/trac_4217-html-system-formatting.patch)
...
archive/attachments_004650.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_4217-html-system-formatting.2.patch](https://github.com/sagemath/sage/files/ticket4217/trac_4217-html-system-formatting.2.patch)\n\nRebase on new",
    "created_at": "2010-01-17T21:57:15Z",
    "issue": "https://github.com/sagemath/sage/issues/4217",
    "type": "issue_comment",
...
**Attachment:** [trac_4217-html-system-formatting.2.patch](https://github.com/sagemath/sage/files/ticket4217/trac_4217-html-system-formatting.2.patch)
...
archive/attachments_004651.json:
```json
{
    "asset_content_type": "application/octet-stream",
