...
```json
{
    "body": "<a id='comment:1'></a>Notice that now there is a concrete example in the above thread. It cannot be copy and pasted here since the wiki interprets part of the syntax.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-30T08:56:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33133",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Notice that now there is a concrete example in the above thread. It cannot be copy and pasted here since the wiki interprets part of the syntax.
...
```json
{
    "body": "<a id='comment:2'></a>I can reproduce this on sagenb.org, but I can't after some of my notebook patches.  I think we might be able to resolve this as fixed in 3.3.  I'll check in 3.3.alpha1 when I get ahold of it.",
    "created_at": "2009-01-24T05:54:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33134",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>I can reproduce this on sagenb.org, but I can't after some of my notebook patches.  I think we might be able to resolve this as fixed in 3.3.  I'll check in 3.3.alpha1 when I get ahold of it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33135",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33136",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33137",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33138",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33139",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33140",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33141",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33142",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>A related problem: The input cells with the `%hide` directive are not hidden upon page load.  I think we just need to use `input_cls` in `cell.html`.",
    "created_at": "2010-01-18T11:03:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33144",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>A related problem: The input cells with the `%hide` directive are not hidden upon page load.  I think we just need to use `input_cls` in `cell.html`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33145",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33146",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33147",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_4217-html-system-formatting.3.patch](tarball://root/attachments/some-uuid/ticket4217/trac_4217-html-system-formatting.3.patch) by @qed777 created at 2010-01-19 13:18:01\n\nI've attached V3, which just uses `cell.html`'s `input_cls`.\n\nSometimes, evaluating a cell with `%hide` at its top doesn't hide it.  This is a separate problem, apparently\n\nPositive review on this ticket.  Feel free to ignore V3.",
    "created_at": "2010-01-19T13:18:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33148",
    "user": "https://github.com/qed777"
}
```

<a id='comment:6'></a>Attachment [trac_4217-html-system-formatting.3.patch](tarball://root/attachments/some-uuid/ticket4217/trac_4217-html-system-formatting.3.patch) by @qed777 created at 2010-01-19 13:18:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33149",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33150",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Note: The commit strings for all of the patches above are actually for #3154.  I merged version 3 into SageNB 0.7 at #8051.",
    "created_at": "2010-02-06T19:37:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4217#issuecomment-33151",
    "user": "https://github.com/qed777"
}
```

<a id='comment:8'></a>Note: The commit strings for all of the patches above are actually for #3154.  I merged version 3 into SageNB 0.7 at #8051.
