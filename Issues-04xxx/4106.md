...
```json
{
    ...
    "rename": {
        ...
        "to": "[with easy patch, needs review] error coercing symbolic variable into polynomial ring modulo 4 (but not mod 3)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4106#event-15319"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4106#issuecomment-31361",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4106#issuecomment-31362",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "rename": {
        "from": "[with easy patch, needs review] error coercing symbolic variable into polynomial ring modulo 4 (but not mod 3)",
        "to": "[with easy patch, positive review] error coercing symbolic variable into polynomial ring modulo 4 (but not mod 3)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4106#event-15320"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4106#event-15321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4106#issuecomment-31363",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4106#issuecomment-31364",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4106#issuecomment-31365",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4106",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4106#event-15322"
}
```
