...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33314",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33315",
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16136"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16137"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16138"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33316",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] major @paralllel (hence pyprocessing) new bug in 3.1.3, still in 3.1.4"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33317",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33318",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33319",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "rename": {
        "from": "[with patch; needs review] major @paralllel (hence pyprocessing) new bug in 3.1.3, still in 3.1.4",
        "to": "[with patch; with positive review] major @paralllel (hence pyprocessing) new bug in 3.1.3, still in 3.1.4"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16140"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4312#event-16141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33320",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4312#issuecomment-33321",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
