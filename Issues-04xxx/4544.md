# Issue 4544: [with patch, positive review] comparison of CDF (or any inexact) elements needs fixing
...
```json
{
    ...
    "title": "[with patch, positive review] comparison of CDF (or any inexact) elements needs fixing",
    "type": "issue",
