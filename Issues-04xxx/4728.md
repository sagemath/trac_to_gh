...
```json
{
    ...
    "rename": {
        "from": ".roots() is inconsistent between polynomials and symbolic polynomials",
        "to": "[with patch, needs review] .roots() is inconsistent between polynomials and symbolic polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4728#event-18064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37850",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37851",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37852",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37853",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37854",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "rename": {
        "from": "[with patch, needs review] .roots() is inconsistent between polynomials and symbolic polynomials",
        "to": "[with patch, positive review] .roots() is inconsistent between polynomials and symbolic polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4728#event-18065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4728#event-18066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37855",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4728#issuecomment-37856",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4728#event-18067"
}
```
