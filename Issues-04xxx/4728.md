# Issue 4728: [with patch, positive review] .roots() is inconsistent between polynomials and symbolic polynomials
...
```json
{
    ...
    "title": "[with patch, positive review] .roots() is inconsistent between polynomials and symbolic polynomials",
    "type": "issue",
