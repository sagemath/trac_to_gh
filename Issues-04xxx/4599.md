...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-36515",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, neeeds review] sage/schemes/elliptic_curves/ell_rational_field.py doctest failure due to missing \"#optional\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4599#event-17443"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-36516",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-36517",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "rename": {
        "from": "[with patch, neeeds review] sage/schemes/elliptic_curves/ell_rational_field.py doctest failure due to missing \"#optional\"",
        "to": "[with patch, with positive review] sage/schemes/elliptic_curves/ell_rational_field.py doctest failure due to missing \"#optional\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4599#event-17444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-36518",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-36519",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-36520",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4599#event-17445"
}
```
