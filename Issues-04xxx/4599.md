# Issue 4599: [with positive review] sage/schemes/elliptic_curves/ell_rational_field.py doctest failure due to missing "#optional"
...
```json
{
    ...
    "title": "[with positive review] sage/schemes/elliptic_curves/ell_rational_field.py doctest failure due to missing \"#optional\"",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-40586",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4599#event-13617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-40587",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-40588",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] sage/schemes/elliptic_curves/ell_rational_field.py doctest failure due to missing \"#optional\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4599#event-13618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-40589",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-40590",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4599#issuecomment-40591",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4599",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4599#event-13619"
}
```
