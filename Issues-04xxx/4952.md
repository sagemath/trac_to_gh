...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4952#issuecomment-40939",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>The issue has been fixed (or at least no longer happens) with Sage 3.3.alpha6 with the system gcc as well as gcc 4.3.3:\n\n```\nmabshoff@menas:~/build-3.3.alpha6/sage-3.3.alpha6-menas-gcc433> ./sage -t -long devel/sage/sage/rings/finite_field_ntl_gf2e.pyx\nsage -t -long \"devel/sage/sage/rings/finite_field_ntl_gf2e.pyx\"\n\t [5.2 s]\n```\n\nCheers,\n\nMichael",
    "created_at": "2009-02-10T07:37:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4952#issuecomment-40940",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>The issue has been fixed (or at least no longer happens) with Sage 3.3.alpha6 with the system gcc as well as gcc 4.3.3:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4952#issuecomment-40941",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Hmm, to be 100% save I will also test eno and cleo with 3.3.rc0 using gcc 4.3.3.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-10T07:38:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4952#issuecomment-40942",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Hmm, to be 100% save I will also test eno and cleo with 3.3.rc0 using gcc 4.3.3.
