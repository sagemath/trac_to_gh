...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32695",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32696",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32697",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_4164_corrections.patch](tarball://root/attachments/some-uuid/ticket4164/trac_4164_corrections.patch) by anakha created at 2008-09-23 06:02:18\n\nNow it works in all cases, all the time.  It is faster for dimensions 2 and 3.\n\nDimensions higher than that can take really long (like 1 second in dimension 4) to compute, but at least they work.\n\nI would like someone familiar with polyhedrons and their triangularization to do a sanity check on the output for dimensions 4 or 5 since my level of understanding of this topic is a bit lacking.",
    "created_at": "2008-09-23T06:02:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32699",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```

<a id='comment:2'></a>Attachment [trac_4164_corrections.patch](tarball://root/attachments/some-uuid/ticket4164/trac_4164_corrections.patch) by anakha created at 2008-09-23 06:02:18
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_4164_corrections2.patch](tarball://root/attachments/some-uuid/ticket4164/trac_4164_corrections2.patch) by anakha created at 2008-09-23 06:03:17\n\nCrap, I forgot to remove the part that disabled the cache for the timings I did.  trac_4164_corrections2.patch fixes that.",
    "created_at": "2008-09-23T06:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32700",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```

<a id='comment:3'></a>Attachment [trac_4164_corrections2.patch](tarball://root/attachments/some-uuid/ticket4164/trac_4164_corrections2.patch) by anakha created at 2008-09-23 06:03:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32702",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I'm sorry, I don't know what I was thinking - about my point (3).  I guess I was thrown off by the edge having three coordinates.  I retested this on a pyramid with an octahedral base (what I really had in mind) and it was fine.  But on a 2D polytope, the \"triangulation\" of the faces would just be the edges.\n\nI will post a patch soon so you can take a look if you want at what I've been doing.  It might be useful for testing at least.",
    "created_at": "2008-09-23T21:52:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32703",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:6'></a>I'm sorry, I don't know what I was thinking - about my point (3).  I guess I was thrown off by the edge having three coordinates.  I retested this on a pyramid with an octahedral base (what I really had in mind) and it was fine.  But on a 2D polytope, the "triangulation" of the faces would just be the edges.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32704",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>New patch, and new method.  This time it should work in all cases and behave like one would expect.  \n\nThis does not include a render_solid() method because it is late and I don't want to work on it right now (plus the fact that I am not quite certain about what it should do for polyhedra of dimension > 3)\n\nTo try (or merge) only apply trac_4164_tfi.patch",
    "created_at": "2008-09-24T04:09:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32705",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```

<a id='comment:7'></a>New patch, and new method.  This time it should work in all cases and behave like one would expect.  
...
```json
{
    "body": "<a id='comment:8'></a>This passed all tests, and seems to work well for 3D polytopes, which was the original request.  It does fail for some 4D polytopes, for example for one with vertices:\n\n```\n[[99, 19, 38, 0],\n [-85, -86, -72, 0],\n [11, 31, 97, 0],\n [61, 99, 28, 0],\n [-50, -85, -90, 0],\n [-29, -56, 96, 0],\n [-48, 56, -83, 0],\n [97, -42, 60, 0],\n [-77, 73, 28, 0],\n [41, -92, 27, 0],\n [-34, 82, -58, 0],\n [-81, 37, -93, 0],\n [-96, 6, 11, 0],\n [-93, 66, 88, 0],\n [-35, -84, 77, 0],\n [82, 83, -66, 0],\n [-68, -72, -99, 0],\n [89, -96, -97, 0],\n [84, -92, -46, 0],\n [88, 67, -18, 0],\n [28, 93, 73, 0],\n [-97, -14, -84, 0],\n [97, 15, -61, 0],\n [39, 92, -36, 0],\n [-40, 99, 41, 0],\n [-39, 56, 99, 0],\n [-96, -85, -35, 0],\n [-48, -18, 99, 0],\n [91, 69, -95, 0],\n [-73, 60, -36, 0],\n [-65, -99, -32, 0],\n [100, 4, 65, 0],\n [32, 17, 94, 0],\n [-86, -93, 34, 0],\n [83, 48, -100, 0],\n [75, -75, 100, 0],\n [0, 0, 0, 1]]\n```\nI am happy to work on that if you (Arnaud) want; I didn't figure out why it fails on that example.",
    "created_at": "2008-09-25T23:05:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32706",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:8'></a>This passed all tests, and seems to work well for 3D polytopes, which was the original request.  It does fail for some 4D polytopes, for example for one with vertices:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32708",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32710",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>OK, I've combined your code in 3D with my improvements for higher dimensions.  I've also added you (Arnaud) as an author.  I've also based this against 3.1.2, with some improvements related to #4060.  I am putting it all as one patch to make review easier.  Since this is now combined work of me and Arnaud, we need to get another reviewer.",
    "created_at": "2008-09-30T02:54:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32711",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:11'></a>OK, I've combined your code in 3D with my improvements for higher dimensions.  I've also added you (Arnaud) as an author.  I've also based this against 3.1.2, with some improvements related to #4060.  I am putting it all as one patch to make review easier.  Since this is now combined work of me and Arnaud, we need to get another reviewer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32712",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32713",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>You can get 2 reviews for 1 by using the patch from #4256.",
    "created_at": "2008-10-16T15:32:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32714",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:12'></a>You can get 2 reviews for 1 by using the patch from #4256.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32715",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Merged in Sage 3.2 via the unified patch at #4256.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-26T01:07:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32716",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>Merged in Sage 3.2 via the unified patch at #4256.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32717",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>And since #4256 has a positive review so does this one :)\n\nCheers,\n\nMichael",
    "created_at": "2008-10-26T01:08:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4164#issuecomment-32718",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:14'></a>And since #4256 has a positive review so does this one :)
