# Issue 4043: [with patch, positive review] Sage 3.1.2.alpha4: numerical noise in plot.py
...
```json
{
    ...
    "title": "[with patch, positive review] Sage 3.1.2.alpha4: numerical noise in plot.py",
    "type": "issue",
