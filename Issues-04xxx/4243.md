...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4243#issuecomment-32532",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4243",
    "rename": {
        "from": "[with spkg, needs review] pynac package version bump to 0.1.1",
        "to": "[with spkg, positive review] pynac package version bump to 0.1.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4243#event-15828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4243#issuecomment-32533",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4243",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4243#event-15829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4243#issuecomment-32534",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4243#issuecomment-32535",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
