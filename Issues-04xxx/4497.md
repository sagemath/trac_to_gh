...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51048"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51051"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4497#issuecomment-26226",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4497",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51052"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4497#issuecomment-26227",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51054"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4497#event-51055"
}
```
