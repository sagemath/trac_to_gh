...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45637"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23041",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45640"
}
```
...
```json
{
    ...
    "subject": "https://github.com/cswiercz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45641"
}
```
...
```json
{
    ...
    "subject": "https://github.com/cswiercz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23042",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45643"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45644"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45645"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-psinis",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45647"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45648"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23043",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45650"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45651"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45652"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45653"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45654"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45655"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23044",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45661"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23045",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23046",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-45665"
}
```
