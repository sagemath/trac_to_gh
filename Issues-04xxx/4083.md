...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23985",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40682"
}
```
...
```json
{
    "body": "Changed assignee from **@cswiercz** to **@sagetrac-psinis**",
    "created_at": "2009-02-23T22:17:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23986",
    "user": "https://github.com/sagetrac-psinis"
}
```

Changed assignee from **@cswiercz** to **@sagetrac-psinis**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40683"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40684"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23987",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40686"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40687"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40688"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40689"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40690"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40691"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23988",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40696"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23989",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4083#issuecomment-23990",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4083",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4083#event-40701"
}
```
