...
```json
{
    ...
    "rename": {
        "from": "[with trivial patch] list_of_first_n() broken in interact.py",
        "to": "[with trivial patch, with positive review] list_of_first_n() broken in interact.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4037#event-12056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4037#issuecomment-33847",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4037#issuecomment-33848",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4037#issuecomment-33849",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4037",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4037#event-12057"
}
```
