...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45240"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45241"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45244"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45245"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45246"
}
```
...
```json
{
    "body": "Changed assignee from **justin** to **@tornaria**",
...
Changed assignee from **justin** to **@tornaria**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45247"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45248"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45249"
}
```
...
```json
{
    "body": "<a id='comment:9'>Comment 9:</a>\nAttachment: **[patch.4470.02-fixes_and_doctest.gz](https://github.com/sagemath/sage/files/ticket4470/patch.4470.02-fixes_and_doctest.gz)**\n\nAttached patches:\n\n- [attachment: patch.4470.01-inital_hanke_code:.gz](https://github.com/sagemath/sage/files/ticket4470/4e73b8769509a73dbc1bb17b3ce1b339.gz) applies Jon Hanke's quadratic forms code into sage. The merge is based in mabshoff work during SD Austin, with some minor updates.\n- [attachment: patch.4470.02-fixes_and_doctest:.gz](https://github.com/sagemath/sage/files/ticket4470/252d6c26b64e0e50a3f10bf1c934359d.gz) fixes and lots of doctests and documentation to be applied on top of the initial patch. This patch raises the doctest coverage from 33% to over 60%.\n\nThe patches apply cleanly on a 3.3 tree, all tests pass in sage.math and my core2 debian/64 laptop.",
    "created_at": "2009-02-23T03:45:35Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45250"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4470#issuecomment-27065",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4470#issuecomment-27066",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4470#issuecomment-27067",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4470#issuecomment-27068",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4470#issuecomment-27069",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45253"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4470",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4470#event-45254"
}
```
