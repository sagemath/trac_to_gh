...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4098#issuecomment-31179",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "rename": {
        "from": "\"T1 =  M1.hecke_operator(13^9)\" blows up on 32 bit builds",
        "to": "[with patch; needs review] \"T1 =  M1.hecke_operator(13^9)\" blows up on 32 bit builds"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4098#event-15294"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4098#event-15295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "rename": {
        "from": "[with patch; needs review] \"T1 =  M1.hecke_operator(13^9)\" blows up on 32 bit builds",
        "to": "[with patch; positive review] \"T1 =  M1.hecke_operator(13^9)\" blows up on 32 bit builds"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4098#event-15296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4098#issuecomment-31180",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4098#issuecomment-31181",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4098#event-15297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4098#issuecomment-31182",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4098#issuecomment-31183",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
