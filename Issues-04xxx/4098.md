# Issue 4098: [with patch; positive review] "T1 =  M1.hecke_operator(13^9)" blows up on 32 bit builds
...
```json
{
    ...
    "title": "[with patch; positive review] \"T1 =  M1.hecke_operator(13^9)\" blows up on 32 bit builds",
    "type": "issue",
