...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4661#issuecomment-37216",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4661",
    "rename": {
        "from": "clean up module_list.py",
        "to": "[with patch, positive review] clean up module_list.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4661#event-17743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4661",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4661#event-17744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4661#issuecomment-37217",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4661#issuecomment-37218",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
