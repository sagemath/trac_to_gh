...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-29232",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-29233",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-29234",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4700/javascript-spkg.patch",
    "created_at": "2008-12-05T00:54:34Z",
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4700/javascript-spkg.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [javascript-spkg.patch](https://github.com/sagemath/sage/files/ticket4700/javascript-spkg.patch) by @jasongrout created at 2008-12-05 00:54:34",
    "created_at": "2008-12-05T00:54:34Z",
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-29235",
    "user": "https://github.com/jasongrout"
}
```

Attachment [javascript-spkg.patch](https://github.com/sagemath/sage/files/ticket4700/javascript-spkg.patch) by @jasongrout created at 2008-12-05 00:54:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-29236",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-29237",
    "user": "https://github.com/jasongrout"
}
```
