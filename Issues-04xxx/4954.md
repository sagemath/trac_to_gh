...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4954#issuecomment-38586",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This problem was solved by #6519 :\n\n```\nsage: from sage.combinat.words.words import Words_over_Alphabet\nsage: W = Words_over_Alphabet([1,2,3])\nsage: W.alphabet()\n[1, 2, 3]\nsage: W([1,1,1,2,1,3])\nword: 111213\n```\n\n```\nsage: Y = Words_over_Alphabet('abcde')\nsage: Y.alphabet()\n'abcde'\nsage: Y('abababacde')\nword: abababacde\n```\n\nSo, I propose that this ticket be closed.",
    "created_at": "2009-07-22T20:39:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4954#issuecomment-38587",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:3'></a>This problem was solved by #6519 :
...
```json
{
    "body": "<a id='comment:4'></a>Closing this as a duplicate of #6519.",
    "created_at": "2009-07-22T20:53:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4954#issuecomment-38588",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>Closing this as a duplicate of #6519.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4954#issuecomment-38589",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4954#event-11454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4954",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4954#event-11455"
}
```
