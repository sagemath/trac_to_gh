...
```json
{
    "body": "Attachment [trac_4975.patch](tarball://root/attachments/some-uuid/ticket4975/trac_4975.patch) by @mwhansen created at 2009-01-19 10:26:44\n\nI've attached a patch for the scripts directory which fixes this.",
    "created_at": "2009-01-19T10:26:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4975",
    "type": "issue_comment",
...
Attachment [trac_4975.patch](tarball://root/attachments/some-uuid/ticket4975/trac_4975.patch) by @mwhansen created at 2009-01-19 10:26:44
...
```json
{
    "body": "Attachment [trac_4975-2.patch](tarball://root/attachments/some-uuid/ticket4975/trac_4975-2.patch) by @mwhansen created at 2009-01-19 11:01:46\n\nHeh, I didn't even notice that line :-)  I put up a patch which applies on top of the last one.",
...
Attachment [trac_4975-2.patch](tarball://root/attachments/some-uuid/ticket4975/trac_4975-2.patch) by @mwhansen created at 2009-01-19 11:01:46
...
```json
{
    "body": "Please do not reopen merged tickets. The issue you reported has been fixed. If you found more problems these will be addressed via the new ticket.\n\nCheers,\n\nMichael",
...
```json
{
    "body": "Oops, I missed a couple of the last messages and I will apply Mike's second patch. But my remark still applies.\n\nCheers,\n\nMichael",
...
```json
{
    "body": "Merged trac_4975-2.patch in Sage 3.3.alpha0.\n\nCheers,\n\nMichael",
