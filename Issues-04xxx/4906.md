...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50850"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4906#issuecomment-30823",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4906#issuecomment-30824",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-50858"
}
```
