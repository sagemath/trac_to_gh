...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49571"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49573"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49574"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4906#issuecomment-30825",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49576"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4906#issuecomment-30826",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-49579"
}
```
