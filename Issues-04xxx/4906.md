...
```json
{
    ...
    "type": "issue",
    "updated_at": "2009-02-24T18:37:59Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46587"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46590"
}
```
...
```json
{
    "body": "**Attachment:** [sage.combinat-final.patch.gz](https://github.com/sagemath/sage/files/ticket4906/sage.combinat-final.patch.gz)",
...
**Attachment:** [sage.combinat-final.patch.gz](https://github.com/sagemath/sage/files/ticket4906/sage.combinat-final.patch.gz)
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [trac4906-tiny-fix.patch.gz](https://github.com/sagemath/sage/files/ticket4906/trac4906-tiny-fix.patch.gz)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46592"
}
```
...
```json
{
    "body": "**Attachment:** [combinat-fixes.patch.gz](https://github.com/sagemath/sage/files/ticket4906/combinat-fixes.patch.gz)",
...
**Attachment:** [combinat-fixes.patch.gz](https://github.com/sagemath/sage/files/ticket4906/combinat-fixes.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-46594"
}
```
