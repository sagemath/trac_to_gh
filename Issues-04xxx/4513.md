...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36244",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Sorry, in the above code I forgot to copy/paste the line\n\n```\nsage: R.<x,y> = GF(3)[]\n```\n\nMoreover, for the reasons above, the ticket should belong to *commutative* algebra, not just algebra (I was clicking on the wrong button).",
    "created_at": "2008-11-13T22:11:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36245",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>Sorry, in the above code I forgot to copy/paste the line
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36246",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36248",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36249",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36251",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36254",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36257",
...
```json
{
    "body": "<a id='comment:10'></a>Cython code looks good (just read it).",
    "created_at": "2008-11-23T12:01:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36258",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>Cython code looks good (just read it).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36259",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36261",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Left actions should use __call__, right actions should use *exponentiation*.\n\nSubstitution is a right action. Substitution of the *inverse* is a left action.",
    "created_at": "2008-11-29T18:55:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36262",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:14'></a>Left actions should use __call__, right actions should use *exponentiation*.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36263",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36264",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36265",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36266",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36268",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I made Cc to malb and wdj, since it both concerns polynomials and groups.",
    "created_at": "2010-07-17T13:53:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36269",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>I made Cc to malb and wdj, since it both concerns polynomials and groups.
...
```json
{
    "body": "<a id='comment:19'></a>Sorry to be a nag, but matrix_group_element.py doesn't pass the doctests:\n\n```\n----------------------------------------------------------------------\nmatrix_group_element.py\nSCORE matrix_group_element.py: 87% (14 of 16)\n\nMissing documentation:\n\t * is_MatrixGroupElement(x):\n\t * __invert__(self):\n\n----------------------------------------------------------------------\n```\n\nThis is the same doctest score that the old unpatched file gets too.",
    "created_at": "2010-11-05T21:37:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36270",
    "user": "https://trac.sagemath.org/admin/accounts/users/nharris"
}
```

<a id='comment:19'></a>Sorry to be a nag, but matrix_group_element.py doesn't pass the doctests:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36271",
    "user": "https://trac.sagemath.org/admin/accounts/users/nharris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36273",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I'm sorry if I did something that I shouldn't have. I was just following this guideline for reviewing patches (found here [http://www.sagemath.org/doc/developer/trac.html#section-review-patches](http://www.sagemath.org/doc/developer/trac.html#section-review-patches)):\n\nIs it documented sufficiently, including both explanation and doctests? This is very important: all code in Sage must have doctests, **so even if the patch is for code which did not have a doctest before, the new version must include one**. In particular, all new code must be 100% doctested. Use the command sage -coverage <files> to see the coverage percentage of <files>.",
    "created_at": "2010-11-06T17:57:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36274",
    "user": "https://trac.sagemath.org/admin/accounts/users/nharris"
}
```

<a id='comment:21'></a>I'm sorry if I did something that I shouldn't have. I was just following this guideline for reviewing patches (found here [http://www.sagemath.org/doc/developer/trac.html#section-review-patches](http://www.sagemath.org/doc/developer/trac.html#section-review-patches)):
...
```json
{
    "body": "<a id='comment:23'></a>Apply `trac-4513_matrix_action_on_polynomials.patch`\n\n(for patchbot -- it's trying to apply all the patches at once)",
    "created_at": "2010-12-31T17:16:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36276",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:23'></a>Apply `trac-4513_matrix_action_on_polynomials.patch`
...
```json
{
    "body": "<a id='comment:24'></a>`Apply trac-4513_matrix_action_on_polynomials.patch`\n\n(maybe it will work this time?)",
    "created_at": "2010-12-31T17:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36277",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:24'></a>`Apply trac-4513_matrix_action_on_polynomials.patch`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36278",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36280",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"David Loeffler, William Stein\"",
    "created_at": "2011-01-20T09:09:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4513#issuecomment-36281",
    "user": "https://github.com/loefflerd"
}
```

Changing reviewer from "" to "David Loeffler, William Stein"
...
```json
{
    ...
    "milestone": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10227"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10228"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10229"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10230"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10231"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10232"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10233"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4513#event-10234"
}
```
