...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43422"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43431"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43432"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43433"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43438"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,9 +2,8 @@\n \n Attached patch trac_4411_and_10607_phc_fixes.patch fixes this problem and a recent change in phcpack output that breaks everything in the interface if not addressed.\n \n-Apply only the patch:\n-trac_4411_and_10607_phc_fixes.patch\n-[https://github.com/sagemath/sage/files/ticket4411/trac_4411_and_10607_phc_fixes_5.0.patch.gz](https://github.com/sagemath/sage/files/ticket4411/trac_4411_and_10607_phc_fixes_5.0.patch.gz)\n+Apply only the patches\n+[and [attachment: trac_4411-tmpfilename.patch.gz](https://github.com/sagemath/sage/files/ticket4411/trac_4411-tmpfilename.patch.gz)(https://github.com/sagemath/sage/files/ticket4411/7415461b164b6ec8630bc6e6219f1e54.gz).\n \n and test AFTER installing the optional spkg at #10607:\n [http://sage.math.washington.edu/home/mhampton/phc-2.3.65.spkg](http://sage.math.washington.edu/home/mhampton/phc-2.3.65.spkg)\n``````\n",
    "created_at": "2012-10-25T20:27:18Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43439"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43440"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4411#issuecomment-26596",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4411#issuecomment-26597",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4411#issuecomment-26598",
    "user": "https://github.com/sagetrac-mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4411#issuecomment-26599",
    "user": "https://github.com/sagetrac-mhampton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43442"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43443"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43446"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4411#issuecomment-26600",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4411#event-43448"
}
```
