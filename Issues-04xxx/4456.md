...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50458"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50461"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4456",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4456#issuecomment-25924",
...
```json
{
    ...
    "milestone_title": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4456",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4456#event-50466"
}
```
