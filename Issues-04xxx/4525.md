...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36377",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36380",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36382",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36383",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36385",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36387",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Sorry about my 3rd patch being based wrongly.  I'll look into the new bug (thanks for finding it).  I'm a bit embarrassed -- when we first released this code we tested it very thoroughly, but I have not repeated those tests after making changes.  As William says, we should do this every time.\n\nAbout the email addresses:  we ordinary mortals do not have a list of trac account names, so it can be impossible to add people in the way Michael recommends!  If that happens to me again, I'll add a comment asking for such-and-such a person to be added (if i don't know their trac a/c name) and hope that Michael picks it up ;)",
    "created_at": "2008-11-23T10:45:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36390",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:11'></a>Sorry about my 3rd patch being based wrongly.  I'll look into the new bug (thanks for finding it).  I'm a bit embarrassed -- when we first released this code we tested it very thoroughly, but I have not repeated those tests after making changes.  As William says, we should do this every time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36392",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36396",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Merged trac-4525-combined-2.patch in Sage 3.2.1.alpha1",
    "created_at": "2008-11-23T23:50:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36398",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:17'></a>Merged trac-4525-combined-2.patch in Sage 3.2.1.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4525#issuecomment-36399",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
