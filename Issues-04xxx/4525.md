...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/10902.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/10903.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/10984.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/sage-4525-patch3-rebased-3.2.patch",
...
```json
{
    "body": "this should replace the patch right above this one, which wouldn't apply cleanly for me.",
    "created_at": "2008-11-23T07:51:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/sage-4525-referee_numerical_noise.patch",
    "created_at": "2008-11-23T08:34:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/trac-4525-combined.patch",
...
```json
{
    "body": "Replaces ALL earlier patches combined",
    "created_at": "2008-11-23T15:49:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4525",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4525/trac-4525-combined-2.patch",
