...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57493"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57496"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4960#issuecomment-30091",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4960#issuecomment-30092",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4960",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4960#issuecomment-30093",
    "user": "https://github.com/williamstein"
}
```
