...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52633"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52635"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52636"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4608#issuecomment-27459",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52638"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hivert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4608#issuecomment-27460",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4608",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4608#issuecomment-27461",
    "user": "https://github.com/sagetrac-mvngu"
}
```
