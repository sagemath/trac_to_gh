...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34287",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34288",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34289",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "rename": {
        "from": "[with patch, needs review] extend the local information function for elliptic curves over number fields",
        "to": "[with patches, needs review] extend the local information function for elliptic curves over number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4412#event-16576"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34290",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34291",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "rename": {
        "from": "[with patches, needs review] extend the local information function for elliptic curves over number fields",
        "to": "[with patches, needs work] extend the local information function for elliptic curves over number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4412#event-16577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34292",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34293",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "rename": {
        "from": "[with patches, needs work] extend the local information function for elliptic curves over number fields",
        "to": "[with patches, needs review (again)] extend the local information function for elliptic curves over number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4412#event-16578"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patches, positive review] extend the local information function for elliptic curves over number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4412#event-16579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34294",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4412#issuecomment-34295",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4412",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4412#event-16580"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4412#event-16581"
}
```
