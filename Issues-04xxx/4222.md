...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32359",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs review] R fails to build when global readline headers are not present"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32360",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "rename": {
        "from": "[with spkg, needs review] R fails to build when global readline headers are not present",
        "to": "[with spkg, negative review] R fails to build when global readline headers are not present"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15746"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32361",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "rename": {
        "from": "[with spkg, negative review] R fails to build when global readline headers are not present",
        "to": "[with spkg, needs work] R fails to build when global readline headers are not present"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32362",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "rename": {
        "from": "[with spkg, needs work] R fails to build when global readline headers are not present",
        "to": "[with spkg, positive review] R fails to build when global readline headers are not present"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32363",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4222#event-15750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4222",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4222#issuecomment-32364",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
