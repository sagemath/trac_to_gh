# Issue 4398: [with patch; positive review] Sage 3.1.4: magma related optional doctest failure in sage/sage/modules/free_module.py
...
```json
{
    ...
    "title": "[with patch; positive review] Sage 3.1.4: magma related optional doctest failure in sage/sage/modules/free_module.py",
    "type": "issue",
