...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4398#issuecomment-34177",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4398",
    "rename": {
        "from": "Sage 3.1.4: magma related optional doctest failure in sage/sage/modules/free_module.py",
        "to": "[with patch; needs review] Sage 3.1.4: magma related optional doctest failure in sage/sage/modules/free_module.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4398#event-16517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4398",
    "rename": {
        "from": "[with patch; needs review] Sage 3.1.4: magma related optional doctest failure in sage/sage/modules/free_module.py",
        "to": "[with patch; positive review] Sage 3.1.4: magma related optional doctest failure in sage/sage/modules/free_module.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4398#event-16518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4398#issuecomment-34178",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4398",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4398#event-16519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4398#issuecomment-34179",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4398#issuecomment-34180",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
