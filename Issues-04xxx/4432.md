...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33338",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>See also #4433",
    "created_at": "2008-11-04T07:42:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33339",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```

<a id='comment:2'></a>See also #4433
...
```json
{
    "body": "<a id='comment:4'></a>The new patch keeps the algorithm keyword for the symbolic factorial.\nIt also keeps the docstrings from the nonsymbolic functions, plus some new doctests.",
    "created_at": "2008-11-06T10:50:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33341",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```

<a id='comment:4'></a>The new patch keeps the algorithm keyword for the symbolic factorial.
It also keeps the docstrings from the nonsymbolic functions, plus some new doctests.
...
```json
{
    "body": "<a id='comment:5'></a>I added a patch which I think presents a cleaner solution for #4432 _and_ #4433.  What are your thoughts?",
    "created_at": "2008-11-06T21:03:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33342",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:5'></a>I added a patch which I think presents a cleaner solution for #4432 _and_ #4433.  What are your thoughts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33343",
...
```json
{
    "body": "<a id='comment:6'></a>The call to `RR(x).gamma()` does not match the previous behavior of the gamma function. The following doesn't work with the given patches:\n\n```\nsage: gamma(QQbar(I))\n<boom>\n```\n\nattachment:trac_4432-gamma.patch fixes this, and adds a few more doctests. \n\nI give Mike's patch a positive review. Mike, can you check my changes?",
    "created_at": "2008-11-15T11:59:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33344",
    "user": "https://github.com/burcin"
}
```

<a id='comment:6'></a>The call to `RR(x).gamma()` does not match the previous behavior of the gamma function. The following doesn't work with the given patches:
...
```json
{
    "body": "<a id='comment:7'></a>+1 to Burcin's patch.\n\nApply only the last two patches: trac_4432.patch and trac_4432-gamma.patch",
    "created_at": "2008-11-21T14:45:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33345",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>+1 to Burcin's patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33348",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33349",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [trac_4432-plot-doc.patch](tarball://root/attachments/some-uuid/ticket4432/trac_4432-plot-doc.patch) by whuss created at 2008-11-24 16:18:56\n\nI fixed the doctests and the plotting of the gamma function, with\nattachment:trac_4432-plot-doc.patch.\n\nAlso\n\n```\nsage: timeit('h(10^4)')\n5 loops, best of 3: 1.68 s per loop\n```\n\nGreetings,\n\nWilfried",
    "created_at": "2008-11-24T16:18:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33350",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```

<a id='comment:11'></a>Attachment [trac_4432-plot-doc.patch](tarball://root/attachments/some-uuid/ticket4432/trac_4432-plot-doc.patch) by whuss created at 2008-11-24 16:18:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33351",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Apply all of the above patches.",
    "created_at": "2008-11-28T08:05:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33352",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:13'></a>Apply all of the above patches.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33353",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Merged all three patches in Sage 3.2.1.rc0",
    "created_at": "2008-11-28T08:36:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4432#issuecomment-33354",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:14'></a>Merged all three patches in Sage 3.2.1.rc0
