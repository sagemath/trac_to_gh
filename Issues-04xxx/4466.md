# Issue 4466: [with patch; positive review] fix det in linbox case to fail if proof=False isn't also set
...
```json
{
    ...
    "title": "[with patch; positive review] fix det in linbox case to fail if proof=False isn't also set",
    "type": "issue",
