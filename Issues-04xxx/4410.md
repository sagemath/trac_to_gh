...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4410#issuecomment-34243",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4410",
    "rename": {
        "from": "[with patch, needs review] Map.__pow__ should return identity for power 0",
        "to": "[with patch, positive review] Map.__pow__ should return identity for power 0"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4410#event-16566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4410#issuecomment-34244",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4410#issuecomment-34245",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4410#issuecomment-34246",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4410",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4410#event-16567"
}
```
