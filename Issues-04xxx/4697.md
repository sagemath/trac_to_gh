...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4697/trac_4697.patch",
    "created_at": "2009-01-29T00:55:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4697",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4697/trac_4697.patch",
...
```json
{
    "body": "Attachment [trac_4697.patch](https://github.com/sagemath/sage/files/ticket4697/trac_4697.patch) by @kcrisman created at 2009-01-29 00:55:22\n\nBased on 3.3.alpha0",
    "created_at": "2009-01-29T00:55:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4697#issuecomment-29213",
    "user": "https://github.com/kcrisman"
}
```

Attachment [trac_4697.patch](https://github.com/sagemath/sage/files/ticket4697/trac_4697.patch) by @kcrisman created at 2009-01-29 00:55:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4697#issuecomment-29214",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4697#issuecomment-29215",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4697#issuecomment-29216",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4697#issuecomment-29217",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
