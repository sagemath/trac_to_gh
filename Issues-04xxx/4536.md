...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36635",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac-4536.patch](tarball://root/attachments/some-uuid/ticket4536/trac-4536.patch) by @mwhansen created at 2008-11-17 06:58:05\n\nHi John,\n\nJust one quick comment. Is there a reason you are manually doing the caching instead of using the cached_method decorator in sage/misc/cachefunc.py?  I think the result is a bit cleaner.\n\nAlso, you don't need to use backslashes to continue lines if it occurs with in parens or brackets because Python knows that they need to be closed.\n\n--Mike",
    "created_at": "2008-11-17T06:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36636",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>Attachment [trac-4536.patch](tarball://root/attachments/some-uuid/ticket4536/trac-4536.patch) by @mwhansen created at 2008-11-17 06:58:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36637",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36638",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36639",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac-4526-2.patch](tarball://root/attachments/some-uuid/ticket4536/trac-4526-2.patch) by @JohnCremona created at 2008-11-18 16:11:25\n\nThe second patch trac-4536-2.patch fixes a bug in the first implementation of residues(): I forgot to take the Smith Normal Form of the matrix.  The first of the two new doctests is an example which failed with the old version.",
    "created_at": "2008-11-18T16:11:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36640",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>Attachment [trac-4526-2.patch](tarball://root/attachments/some-uuid/ticket4536/trac-4526-2.patch) by @JohnCremona created at 2008-11-18 16:11:25
...
```json
{
    "body": "<a id='comment:8'></a>David, you are quite right.  We could just delete that coprimality of norms pre-test except when the ideals are integral.  I'll correct it and put up a new patch.\n\nThanks for spotting this mistake!",
    "created_at": "2008-11-25T09:26:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36642",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>David, you are quite right.  We could just delete that coprimality of norms pre-test except when the ideals are integral.  I'll correct it and put up a new patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36643",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The new patch trac-4536-fix.patch address the reviewer's just criticism, and adds a relevant doctest.",
    "created_at": "2008-11-25T11:47:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36644",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>The new patch trac-4536-fix.patch address the reviewer's just criticism, and adds a relevant doctest.
...
```json
{
    "body": "<a id='comment:10'></a>I've found no other problems, and the third patch certainly fixes the issue I reported, so I'll happily give this a positive review.",
    "created_at": "2008-11-26T08:11:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36645",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:10'></a>I've found no other problems, and the third patch certainly fixes the issue I reported, so I'll happily give this a positive review.
...
```json
{
    "body": "<a id='comment:11'></a>Merged all three patches in Sage 3.2.1.alpha1",
    "created_at": "2008-11-26T10:30:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36646",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged all three patches in Sage 3.2.1.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36647",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36648",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Changing merged from \"\" to \"3.2.1.alpha1\"",
    "created_at": "2009-06-07T09:33:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36649",
    "user": "https://github.com/loefflerd"
}
```

Changing merged from "" to "3.2.1.alpha1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4536#issuecomment-36650",
    "user": "https://github.com/loefflerd"
}
```
