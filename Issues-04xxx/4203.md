...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31222",
...
```json
{
    "body": "<a id='comment:3'></a>I put up an initial implementation of this.",
    "created_at": "2008-10-23T16:29:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31223",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>I put up an initial implementation of this.
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_4203.patch](tarball://root/attachments/some-uuid/ticket4203/trac_4203.patch) by @mwhansen created at 2008-10-23 20:21:05\n\nI put up a new patch which addresses that issue.",
    "created_at": "2008-10-23T20:21:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31226",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:6'></a>Attachment [trac_4203.patch](tarball://root/attachments/some-uuid/ticket4203/trac_4203.patch) by @mwhansen created at 2008-10-23 20:21:05
...
```json
{
    "body": "<a id='comment:7'></a>Very nice.  It's all good now.",
    "created_at": "2008-10-23T21:00:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31227",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```

<a id='comment:7'></a>Very nice.  It's all good now.
...
```json
{
    "body": "<a id='comment:8'></a>I guess my one last comment is to compute len(self.name) outside of the inner loop, but if it doesn't get changed, I'm not going to cry.",
    "created_at": "2008-10-23T23:15:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31228",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:8'></a>I guess my one last comment is to compute len(self.name) outside of the inner loop, but if it doesn't get changed, I'm not going to cry.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31229",
...
```json
{
    "body": "<a id='comment:9'></a>Merged in Sage 3.2.alpha1",
    "created_at": "2008-10-25T21:22:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4203#issuecomment-31230",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Merged in Sage 3.2.alpha1
