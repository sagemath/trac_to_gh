...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24872",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24873",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24874",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24875",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4203/trac_4203.patch",
    "created_at": "2008-10-23T20:21:05Z",
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4203/trac_4203.patch",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [trac_4203.patch](https://github.com/sagemath/sage/files/ticket4203/trac_4203.patch) by @mwhansen created at 2008-10-23 20:21:05\n\nI put up a new patch which addresses that issue.",
    "created_at": "2008-10-23T20:21:05Z",
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24876",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24877",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24878",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4203#issuecomment-24879",
