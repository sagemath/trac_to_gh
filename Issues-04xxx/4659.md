...
```json
{
    ...
    "rename": {
        "from": "remove an extra 'cdef class Integer' line from integer.pyx",
        "to": "[with patch, positive review] remove an extra 'cdef class Integer' line from integer.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4659#event-17738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4659#issuecomment-37209",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4659#issuecomment-37210",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4659",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4659#event-17739"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4659#issuecomment-37211",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
