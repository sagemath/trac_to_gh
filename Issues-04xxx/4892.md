...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39354",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39355",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39356",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "rename": {
        "from": "Changing precision of a Complex can convert it to a real",
        "to": "[with patch, needs review] Changing precision of a Complex can convert it to a real"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "rename": {
        "from": "[with patch, needs review] Changing precision of a Complex can convert it to a real",
        "to": "[with patch, positive review] Changing precision of a Complex can convert it to a real"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39357",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "rename": {
        "from": "[with patch, positive review] Changing precision of a Complex can convert it to a real",
        "to": "[with patch, needs work] Changing precision of a Complex can convert it to a real"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "rename": {
        "from": "[with patch, needs work] Changing precision of a Complex can convert it to a real",
        "to": "[with patch, needs review] Changing precision of a Complex can convert it to a real"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39359",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39360",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39361",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39362",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18876"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4892#event-18877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4892#issuecomment-39363",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
