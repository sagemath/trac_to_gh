...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54326"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54328"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54329"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54330"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54331"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54332"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54333"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-54334"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4732#issuecomment-28426",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4732#issuecomment-28427",
    "user": "https://github.com/jasongrout"
}
```
