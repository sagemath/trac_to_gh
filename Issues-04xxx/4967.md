...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4967#issuecomment-40123",
    "user": "https://github.com/orontee"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4967#issuecomment-40124",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "rename": {
        "from": "[with patch] Trouble with .gaprc file when compiling from source",
        "to": "[with patch, needs reivew] Trouble with .gaprc file when compiling from source"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4967#event-19226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4967#issuecomment-40125",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4967#issuecomment-40126",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "rename": {
        "from": "[with patch, needs reivew] Trouble with .gaprc file when compiling from source",
        "to": "[with patch, positive reivew] Trouble with .gaprc file when compiling from source"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4967#event-19227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4967#event-19228"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4967#issuecomment-40127",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4967#issuecomment-40128",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
