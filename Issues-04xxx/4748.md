...
```json
{
    "body": "<a id='comment:2'></a>I meant \n\n```\nsage: R.<x> = ZZ[]   \nsage: sage: sqrt(1+x+O(x^5))\n1 + 1/2*x - 1/8*x^2 + 1/16*x^3 - 5/128*x^4 + O(x^5)\n```",
    "created_at": "2009-07-27T10:43:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4748#issuecomment-36810",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>I meant 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4748#issuecomment-36811",
    "user": "https://github.com/robertwb"
}
```
