...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30107",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30109",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Not sure what was going on with my version of sage--something must have happened during an upgrade.  A fresh install shows (as with Michael) that the patch applies cleanly.  \n\nI did several tests of my own, including a long one (9h 50m to compute the 70463 totally real quintic fields with discriminant <= 50000000), and it passed all of these tests.  So it gets the green flag from me.\n\nAwesome work, Craig!\n\nJV",
    "created_at": "2008-09-21T14:59:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30112",
    "user": "https://github.com/jvoight"
}
```

<a id='comment:5'></a>Not sure what was going on with my version of sage--something must have happened during an upgrade.  A fresh install shows (as with Michael) that the patch applies cleanly.  
...
```json
{
    "body": "<a id='comment:7'></a>Ok, having talked with Michael, we've cleaned up lots of valgrind-inspired stuff (explicitly initializing memory, etc), and caught one buglet (7 and 6 are apparently not equal).",
    "created_at": "2008-09-22T05:11:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30114",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:7'></a>Ok, having talked with Michael, we've cleaned up lots of valgrind-inspired stuff (explicitly initializing memory, etc), and caught one buglet (7 and 6 are apparently not equal).
...
```json
{
    "body": "<a id='comment:8'></a>Positive review on trac-4155-2.patch from my end - I was deeply involved with the fixes, but aside from one issue left over this is a giant improvement from millions of errors to two, which will be addressed via a follow up ticket.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-22T05:17:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30115",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Positive review on trac-4155-2.patch from my end - I was deeply involved with the fixes, but aside from one issue left over this is a giant improvement from millions of errors to two, which will be addressed via a follow up ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4155#event-9448"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Merged both patches in Sage 3.1.3.alpha1",
    "created_at": "2008-09-23T00:09:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30116",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Merged both patches in Sage 3.1.3.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4155#issuecomment-30117",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
