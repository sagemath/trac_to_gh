...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac-4112.patch](tarball://root/attachments/some-uuid/ticket4112/trac-4112.patch) by mabshoff created at 2008-09-14 09:34:42\n\nPositive review for trac-4112.patch. There is also some orthogonal issue, but that is followed up at #4116.\n\nCheers,\n\nMichael",
...
<a id='comment:1'></a>Attachment [trac-4112.patch](tarball://root/attachments/some-uuid/ticket4112/trac-4112.patch) by mabshoff created at 2008-09-14 09:34:42
