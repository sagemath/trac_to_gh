...
```json
{
    ...
    "asset_name": "trac_4112.patch",
    "asset_url": "tarball://root/attachments/ticket4112/trac_4112.patch",
    "created_at": "2008-09-14T09:01:46Z",
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4112/trac_4112.patch",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "Attachment [trac_4112.patch](https://github.com/sagemath/sage/files/ticket4112/trac_4112.patch) by @craigcitro created at 2008-09-14 09:01:46",
    "created_at": "2008-09-14T09:01:46Z",
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4112#issuecomment-24255",
    "user": "https://github.com/craigcitro"
}
```

Attachment [trac_4112.patch](https://github.com/sagemath/sage/files/ticket4112/trac_4112.patch) by @craigcitro created at 2008-09-14 09:01:46
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4112#event-23629"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac-4112.patch",
    "asset_url": "tarball://root/attachments/ticket4112/trac-4112.patch",
    "created_at": "2008-09-14T09:34:42Z",
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4112/trac-4112.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac-4112.patch](https://github.com/sagemath/sage/files/ticket4112/trac-4112.patch) by mabshoff created at 2008-09-14 09:34:42\n\nPositive review for trac-4112.patch. There is also some orthogonal issue, but that is followed up at #4116.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-14T09:34:42Z",
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4112#issuecomment-24256",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4112#issuecomment-24257",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4112#event-23630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4112#event-23631"
}
```
