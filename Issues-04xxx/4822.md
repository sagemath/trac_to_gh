...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39710",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39711",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39712",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39713",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This patch also works with the optional package. I give this ticket a positive review and I agree that the command-line to install the optional package should better not be included. It is very clear what to do as it is now.\n\n The second [independent] patch obtains also a positive review with this.\n\n I propose to address the issue that I raised on `cremona_label()` in a new ticket.\n\n Chris.",
    "created_at": "2009-08-17T16:38:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39716",
    "user": "https://github.com/categorie"
}
```

<a id='comment:5'></a>This patch also works with the optional package. I give this ticket a positive review and I agree that the command-line to install the optional package should better not be included. It is very clear what to do as it is now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39717",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39718",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39719",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39720",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4822#issuecomment-39721",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
