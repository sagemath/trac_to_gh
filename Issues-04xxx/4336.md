...
```json
{
    "body": "**Attachment:** [attach_bugfix.patch](https://github.com/sagemath/sage/files/ticket4336/attach_bugfix.patch)\n\nFixes a bug that occurs when an attached .pyx file is changed",
    "created_at": "2008-10-22T19:27:02Z",
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
...
**Attachment:** [attach_bugfix.patch](https://github.com/sagemath/sage/files/ticket4336/attach_bugfix.patch)
