...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26012",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26013",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26014",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26015",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4336/attach_bugfix.patch",
    "created_at": "2008-10-22T19:27:02Z",
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4336/attach_bugfix.patch",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment [attach_bugfix.patch](https://github.com/sagemath/sage/files/ticket4336/attach_bugfix.patch) by @simon-king-jena created at 2008-10-22 19:27:02\n\nFixes a bug that occurs when an attached .pyx file is changed",
    "created_at": "2008-10-22T19:27:02Z",
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26016",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [attach_bugfix.patch](https://github.com/sagemath/sage/files/ticket4336/attach_bugfix.patch) by @simon-king-jena created at 2008-10-22 19:27:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26017",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4336#issuecomment-26018",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
