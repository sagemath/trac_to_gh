...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4561#issuecomment-36183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4561",
    "rename": {
        "from": "_fast_float_ for sin/cos, etc., in caculus.py is implemented stupidly",
        "to": "[with patch, needs review] _fast_float_ for sin/cos, etc., in caculus.py is implemented stupidly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4561#event-17300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4561",
    "rename": {
        "from": "[with patch, needs review] _fast_float_ for sin/cos, etc., in caculus.py is implemented stupidly",
        "to": "[with patch, positive review] _fast_float_ for sin/cos, etc., in caculus.py is implemented stupidly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4561#event-17301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4561#issuecomment-36184",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4561",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4561#event-17302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4561#issuecomment-36185",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4561#issuecomment-36186",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
