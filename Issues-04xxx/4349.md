...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4349#issuecomment-26143",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4349#issuecomment-26144",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_4349.patch](https://github.com/sagemath/sage/files/ticket4349/trac_4349.patch) by anakha created at 2008-10-23 18:17:26\n\nFixes the bug by cleaning up the environment with sage-native-execute before calling jmol.",
    "created_at": "2008-10-23T18:17:26Z",
    "issue": "https://github.com/sagemath/sage/issues/4349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4349#issuecomment-26145",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4349#issuecomment-26146",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4349#issuecomment-26147",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
