...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39831",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "rename": {
        "from": "LaTeX for gp elements shouldn't use verbatim environment",
        "to": "[with patch, needs review] LaTeX for gp elements shouldn't use verbatim environment"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4945#event-19122"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39832",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39833",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39834",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39835",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39836",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "rename": {
        "from": "[with patch, needs review] LaTeX for gp elements shouldn't use verbatim environment",
        "to": "[with patch, positive review] LaTeX for gp elements shouldn't use verbatim environment"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4945#event-19123"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4945#event-19124"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39837",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4945#issuecomment-39838",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4945#event-19125"
}
```
