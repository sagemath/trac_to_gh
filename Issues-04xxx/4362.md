...
archive/attachments_004865.json:
```json
{
...
```json
{
    "body": "**Attachment:** [tableaux_output.patch](https://github.com/sagemath/sage/files/ticket4362/tableaux_output.patch)\n\nFirst of Dan's patches from #4355",
    "created_at": "2008-10-24T11:40:20Z",
    "issue": "https://github.com/sagemath/sage/issues/4362",
    "type": "issue_comment",
...
**Attachment:** [tableaux_output.patch](https://github.com/sagemath/sage/files/ticket4362/tableaux_output.patch)
...
archive/attachments_004866.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [tableaux_output1.patch](https://github.com/sagemath/sage/files/ticket4362/tableaux_output1.patch)\n\nSecond of Dan's patches from #4355",
    "created_at": "2008-10-24T11:40:42Z",
    "issue": "https://github.com/sagemath/sage/issues/4362",
    "type": "issue_comment",
...
**Attachment:** [tableaux_output1.patch](https://github.com/sagemath/sage/files/ticket4362/tableaux_output1.patch)
...
archive/attachments_004867.json:
```json
{
    "asset_content_type": "application/octet-stream",
