...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24881",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24882",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24883",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24884",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
archive/attachments_004454.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "numpy-deprecations.patch",
    "asset_url": "tarball://root/attachments/ticket4205/numpy-deprecations.patch",
    "created_at": "2008-09-27T10:48:23Z",
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4205/numpy-deprecations.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24886",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24887",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4205#event-24194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24888",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24889",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4205#event-24195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24890",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4205#event-24196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4205#issuecomment-24891",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4205#event-24197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4205",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4205#event-24198"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4205#event-24199"
}
```
