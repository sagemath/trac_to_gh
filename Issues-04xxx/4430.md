...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44715"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4430#issuecomment-26674",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4430#issuecomment-26675",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44721"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44722"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4430",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44723"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4430#event-44724"
}
```
