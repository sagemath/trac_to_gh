...
```json
{
    "body": "Attachment: **[sage0.png.gz](https://github.com/sagemath/sage/files/ticket4529/sage0.png.gz)**\n\n\"Wrong\" sage plot with log scale",
...
Attachment: **[sage0.png.gz](https://github.com/sagemath/sage/files/ticket4529/sage0.png.gz)**
...
```json
{
    "body": "<a id='comment:26'>Comment 26:</a>\nPatchbot:  Apply [and [attachment: trac_4529-add_docs_eg_to_some_user_facing_functions.patch.gz](https://github.com/sagemath/sage/files/ticket4529/trac_4529-add_docs_eg_to_some_user_facing_functions.patch.gz)(https://github.com/sagemath/sage/files/ticket4529/b00c80c86faba29627fc31e967f3ce14.gz).",
    "created_at": "2012-05-24T22:39:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4529",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,8 @@\n Attached is a patch which introduces log scale to `Graphics()` class.\n \n-Apply the following patches in the specified order. `SAGE_ROOT` is the directory where the sage installation is present.\n+Depends on #12974.  Apply [and [attachment: trac_4529-add_docs_eg_to_some_user_facing_functions.patch.gz](https://github.com/sagemath/sage/files/ticket4529/trac_4529-add_docs_eg_to_some_user_facing_functions.patch.gz)(https://github.com/sagemath/sage/files/ticket4529/b00c80c86faba29627fc31e967f3ce14.gz).\n+\n+Alternately, apply the following patches in the specified order. `SAGE_ROOT` is the directory where the sage installation is present.\n \n ```\n cd SAGE_ROOT/devel/sage\n``````\n",
    "created_at": "2012-05-24T22:39:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4529",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,10 @@\n Attached is a patch which introduces log scale to `Graphics()` class.\n \n Depends on #12974.\n+\n+Apply [attachment: trac_4529-add_logscale_to_Graphics.2.patch.gz](https://github.com/sagemath/sage/files/ticket4529/trac_4529-add_logscale_to_Graphics.2.patch.gz) and a patch to be determined.\n+\n+OR\n \n Apply the following patches in the specified order. `SAGE_ROOT` is the directory where the sage installation is present.\n \n``````\n",
    "created_at": "2012-05-26T23:53:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4529",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:93'>Comment 93:</a>\n[attachment: trac_4529-patch4.patch.gz](https://github.com/sagemath/sage/files/ticket4529/trac_4529-patch4.patch.gz) needs a proper commit message.",
    "created_at": "2012-07-03T09:55:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4529",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4529",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4529#issuecomment-27729",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4529",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4529#issuecomment-27730",
    "user": "https://github.com/kcrisman"
}
```
