...
```json
{
    ...
    "rename": {
        "from": "random element of multivariate polynomial ring in one variable is totally broken",
        "to": "[with patch, needs review] random element of multivariate polynomial ring in one variable is totally broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4776#event-18297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4776#issuecomment-38385",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4776",
    "rename": {
        "from": "[with patch, needs review] random element of multivariate polynomial ring in one variable is totally broken",
        "to": "[with patch, positive review] random element of multivariate polynomial ring in one variable is totally broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4776#event-18298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4776#issuecomment-38386",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4776#event-18299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4776#issuecomment-38387",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4776",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4776#event-18300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4776#issuecomment-38388",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
