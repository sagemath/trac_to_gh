...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] make sure garbage collection is reenabled after an exception in timeit.",
        "to": "[with patch, positive review] make sure garbage collection is reenabled after an exception in timeit."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4353#event-16322"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4353#issuecomment-33751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4353",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4353#event-16323"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4353#issuecomment-33752",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4353#issuecomment-33753",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
