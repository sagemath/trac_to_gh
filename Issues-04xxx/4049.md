...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30795",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "rename": {
        "from": "Don't use the -i option to tar as it does not exist on most BSDs",
        "to": "[with patch; needs review] Don't use the -i option to tar as it does not exist on most BSDs"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4049#event-15101"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4049#event-15102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30796",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "rename": {
        "from": "[with patch; needs review] Don't use the -i option to tar as it does not exist on most BSDs",
        "to": "[with patch; positive review] Don't use the -i option to tar as it does not exist on most BSDs"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4049#event-15103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30797",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30798",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30799",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4049#event-15104"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30800",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4049#issuecomment-30801",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
