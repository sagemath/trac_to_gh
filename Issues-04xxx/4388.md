...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4388",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4388#event-43212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4388#issuecomment-26469",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4388#issuecomment-26470",
    "user": "https://github.com/loefflerd"
}
```
