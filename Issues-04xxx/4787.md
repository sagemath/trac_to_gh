...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38489",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38490",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38491",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38492",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "rename": {
        "from": "Race condition in sage-doctest folder creation",
        "to": "[with patch, needs review] Race condition in sage-doctest folder creation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4787#event-18343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "rename": {
        "from": "[with patch, needs review] Race condition in sage-doctest folder creation",
        "to": "[with patch, positive review] Race condition in sage-doctest folder creation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4787#event-18344"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38494",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4787#event-18345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4787#issuecomment-38495",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
