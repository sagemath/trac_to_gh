...
```json
{
    ...
    "rename": {
        "from": "is_Blah functions: deprecate and then remove them from top level imports",
        "to": "[with patch, needs review] is_Blah functions: deprecate and then remove them from top level imports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4192#event-15625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32091",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32092",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32093",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "rename": {
        "from": "[with patch, needs review] is_Blah functions: deprecate and then remove them from top level imports",
        "to": "[with patch, needs work] is_Blah functions: deprecate and then remove them from top level imports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4192#event-15626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32094",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32095",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "rename": {
        "from": "[with patch, needs work] is_Blah functions: deprecate and then remove them from top level imports",
        "to": "[with patch, needs review] is_Blah functions: deprecate and then remove them from top level imports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4192#event-15627"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] is_Blah functions: deprecate and then remove them from top level imports",
        "to": "[with patch, positive review] is_Blah functions: deprecate and then remove them from top level imports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4192#event-15628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32096",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32097",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4192#issuecomment-32098",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4192",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4192#event-15629"
}
```
