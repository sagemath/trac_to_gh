...
```json
{
    "body": "<a id='comment:1'></a>There still might be some failures due to ones that I missed, but I think I got most of them.",
...
<a id='comment:1'></a>There still might be some failures due to ones that I missed, but I think I got most of them.
...
```json
{
    "body": "<a id='comment:3'></a>I've updated the patch to fix those issues.",
...
<a id='comment:3'></a>I've updated the patch to fix those issues.
...
```json
{
    "body": "<a id='comment:4'></a>Ok, things work now. Positive review. Followup work should be directed to new tickets.\n\nCheers,\n\nMichael",
...
<a id='comment:4'></a>Ok, things work now. Positive review. Followup work should be directed to new tickets.
