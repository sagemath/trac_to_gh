...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40857"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4187#issuecomment-24788",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4187#issuecomment-24789",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4187#event-40865"
}
```
