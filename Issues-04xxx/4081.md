...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4081/trac_4081-nonlinear-memleak.patch",
    "created_at": "2008-09-09T01:19:28Z",
    "issue": "https://github.com/sagemath/sage/issues/4081",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4081/trac_4081-nonlinear-memleak.patch",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4081#issuecomment-23962",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4081#issuecomment-23963",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4081#issuecomment-23964",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
