...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4600#issuecomment-28404",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4600#issuecomment-28405",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "**Attachment:** [scripts-4600.patch](https://github.com/sagemath/sage/files/ticket4600/scripts-4600.patch)\n\nthis patch to the scripts repo should fix everything.",
    "created_at": "2008-11-24T05:41:26Z",
    "issue": "https://github.com/sagemath/sage/issues/4600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4600#issuecomment-28406",
    "user": "https://github.com/williamstein"
}
```

**Attachment:** [scripts-4600.patch](https://github.com/sagemath/sage/files/ticket4600/scripts-4600.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4600#issuecomment-28407",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4600#issuecomment-28408",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
