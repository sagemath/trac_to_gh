...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4224#issuecomment-32382",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "rename": {
        "from": "small error in new question-mark interval printing",
        "to": "[with patch, needs review] small error in new question-mark interval printing"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4224#event-15760"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4224#issuecomment-32383",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "rename": {
        "from": "[with patch, needs review] small error in new question-mark interval printing",
        "to": "[with patch, positive review] small error in new question-mark interval printing"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4224#event-15761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4224#issuecomment-32384",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4224#event-15762"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4224#issuecomment-32385",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4224#issuecomment-32386",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4224#issuecomment-32387",
