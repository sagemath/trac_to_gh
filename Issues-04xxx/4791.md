...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4791#issuecomment-38513",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4791",
    "rename": {
        "from": "[with patch, needs review] purge nodoctest.py from the Sage library tree",
        "to": "[with patch, with positive review] purge nodoctest.py from the Sage library tree"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4791#event-18362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4791",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4791#issuecomment-38514",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4791",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4791#issuecomment-38515",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4791",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4791#event-18363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4791",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4791#issuecomment-38516",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
