...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4143#issuecomment-31746",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4143#issuecomment-31747",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "rename": {
        "from": "injvar() docstring should be the same as inject_variables()",
        "to": "[with patch, needs review] injvar() docstring should be the same as inject_variables()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4143#event-15460"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "rename": {
        "from": "[with patch, needs review] injvar() docstring should be the same as inject_variables()",
        "to": "[with patch, positive review] injvar() docstring should be the same as inject_variables()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4143#event-15461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4143#issuecomment-31748",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4143#issuecomment-31749",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4143#event-15462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4143#issuecomment-31750",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
