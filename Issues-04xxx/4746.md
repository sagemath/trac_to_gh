...
```json
{
    "body": "<a id='comment:1'></a>what if we added a tolerance option, which it would use in comparing the endpoint?  If you were within tolerance of the endpoint, you would compare as equal to the endpoint.",
    "created_at": "2008-12-09T09:46:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-38999",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>what if we added a tolerance option, which it would use in comparing the endpoint?  If you were within tolerance of the endpoint, you would compare as equal to the endpoint.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39000",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39001",
...
```json
{
    "body": "<a id='comment:4'></a>Maybe one could use Numpy's arange() to do the heavy lifting.\n\nThe only problem is that coercing it back could impact performance.",
    "created_at": "2008-12-12T21:42:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39002",
    "user": "https://trac.sagemath.org/admin/accounts/users/ronanpaixao"
}
```

<a id='comment:4'></a>Maybe one could use Numpy's arange() to do the heavy lifting.
...
```json
{
    "body": "<a id='comment:5'></a>Numpy's arange suffers from the same difficulties. \n\n```\nsage: numpy.arange(0.5r, 1.1r, .1r)\narray([ 0.5,  0.6,  0.7,  0.8,  0.9,  1. ,  1.1])\n```",
    "created_at": "2009-01-23T05:05:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39003",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>Numpy's arange suffers from the same difficulties. 
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [4746-srange.patch](tarball://root/attachments/some-uuid/ticket4746/4746-srange.patch) by @robertwb created at 2009-01-23 10:43:39\n\nBetter documentation, and hopefully a bit easier to follow.",
    "created_at": "2009-01-23T10:43:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39004",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:6'></a>Attachment [4746-srange.patch](tarball://root/attachments/some-uuid/ticket4746/4746-srange.patch) by @robertwb created at 2009-01-23 10:43:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39005",
...
```json
{
    "body": "<a id='comment:8'></a>Merged 4746-srange-rebased.patch and 4746-referee.patch in Sage 3.3.rc3.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-20T07:37:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39007",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Merged 4746-srange-rebased.patch and 4746-referee.patch in Sage 3.3.rc3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4746#issuecomment-39008",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
