...
{
    "assignees": [
        "https://github.com/sagetrac-mollerhansen"
    ],
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57537"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57538"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57539"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57540"
}
```
...
```json
{
    "actor": "https://github.com/sagetrac-mollerhansen",
    "created_at": "2009-01-11T17:54:28Z",
    "event": "assigned",
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "subject": "https://github.com/sagetrac-dmhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57541"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57542"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57544"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30106",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30107",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30108",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30109",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30110",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30111",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30112",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30113",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30115",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30116",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    "body": "<div id=\"comment:13\" align=\"right\">comment:13</div>\n\nReplying to [@sagetrac-dmhansen](#comment:12):\n> > I will make a bug report on it. \n\n> \n> No I won't. The sage output is ok. \n> Sorry it's a bit early in the morning. weil pairing result must then be wrong.. Think it's a bit to early in the morning to be doing this.\n\nAgreed: (0:0:1) has order 2, so that's consistent!  john",
    "created_at": "2009-02-06T10:31:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30117",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30118",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30119",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30120",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57553"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30121",
    "user": "https://github.com/sagetrac-dmhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30122",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30123",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30124",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4964#event-57558"
}
```
...
```json
{
    "body": "<div id=\"comment:21\" align=\"right\">comment:21</div>\n\nReplying to [@sagetrac-mabshoff](#comment:20):\n> Merged all three patches in Sage 3.3.alpha6. Doctests do pass, but if another reviewer looks at this again it would be good.\n> \n> Cheers,\n> \n> Michael\n\nThanks, Michael!  John",
    "created_at": "2009-02-08T10:16:41Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4964#issuecomment-30125",
    "user": "https://github.com/JohnCremona"
}
```
