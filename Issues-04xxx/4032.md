...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4032#issuecomment-30684",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4032#issuecomment-30685",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4032",
    "rename": {
        "from": "[with spkg, needs review] Add x86 Solaris build support for libSingular",
        "to": "[with spkg, positive review] Add x86 Solaris build support for libSingular"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4032#event-15041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4032#issuecomment-30686",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4032#issuecomment-30687",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4032",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4032#event-15042"
}
```
