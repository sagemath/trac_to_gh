...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4894#issuecomment-39369",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4894#issuecomment-39370",
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4894#event-18882"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4894#event-18883"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4894#event-18884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4894",
    "rename": {
        "from": "[with patch; needs review] save_session -- bug when saving %cython functions, etc.",
        "to": "[with patch; positive review] save_session -- bug when saving %cython functions, etc."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4894#event-18885"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4894#issuecomment-39371",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4894#issuecomment-39372",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4894",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4894#event-18886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4894#issuecomment-39373",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
