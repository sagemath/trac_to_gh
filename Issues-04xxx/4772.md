...
```json
{
    ...
    "rename": {
        "from": "make determinants of matrices over GF(2) way faster",
        "to": "[with patch; needs review] make determinants of matrices over GF(2) way faster"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4772#event-18272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4772#issuecomment-38334",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4772",
    "rename": {
        "from": "[with patch; needs review] make determinants of matrices over GF(2) way faster",
        "to": "[with patch; positive review] make determinants of matrices over GF(2) way faster"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4772#event-18273"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4772#issuecomment-38335",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4772#issuecomment-38336",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4772#issuecomment-38337",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4772",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4772#event-18274"
}
```
