...
```
Rather than the `_xxx_, `_xxx_`c, `_xxx_c_`impl` stuff we have now. 
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4175/4175-no-impl.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35289",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4175#event-12376"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35291",
...
```json
{
    "body": "<a id='comment:4'></a>\nThey should be fairly orthogonal--I tried to keep them that way.\n\nThe Dickman's function patch you just merged will need the `_impl_`c methods renamed though.",
    "created_at": "2008-09-23T22:54:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35292",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35293",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4175/4175-no-impl-RRx.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35294",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35295",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35296",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35297",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4175#event-12377"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4175#event-12378"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4175#issuecomment-35298",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
