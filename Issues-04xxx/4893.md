...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4893#issuecomment-39364",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4893#issuecomment-39365",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "rename": {
        "from": "srange docstring is misleading",
        "to": "[with patch, needs review] srange docstring is misleading"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4893#event-18878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4893#issuecomment-39366",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "rename": {
        "from": "[with patch, needs review] srange docstring is misleading",
        "to": "[with patch, positive review] srange docstring is misleading"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4893#event-18879"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4893#event-18880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4893#event-18881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4893#issuecomment-39367",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4893#issuecomment-39368",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
