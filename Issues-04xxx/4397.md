...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-34173",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; need review] Sage 3.1.4: optional doctest failure in sage/rings/number_field/number_field.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4397#event-16514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-34174",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-34175",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4397#event-16515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4397#issuecomment-34176",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4397",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4397#event-16516"
}
```
