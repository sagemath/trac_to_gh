...
```json
{
    "body": "<a id='comment:1'></a>Here's a patch; apply to the scripts repository.\n\n(This doesn't earn the bonus points Michael referred to.)",
...
<a id='comment:1'></a>Here's a patch; apply to the scripts repository.
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_4712_scripts.patch](tarball://root/attachments/some-uuid/ticket4712/trac_4712_scripts.patch) by @ncalexan created at 2009-06-15 19:09:00\n\nFine by me.",
...
<a id='comment:2'></a>Attachment [trac_4712_scripts.patch](tarball://root/attachments/some-uuid/ticket4712/trac_4712_scripts.patch) by @ncalexan created at 2009-06-15 19:09:00
