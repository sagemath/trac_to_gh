...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4818#event-18506"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4818#issuecomment-38744",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "rename": {
        "from": "bug in list_plot3d -- invalid index?",
        "to": "[with patch; needs review] bug in list_plot3d -- invalid index?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4818#event-18507"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4818#issuecomment-38745",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "rename": {
        "from": "[with patch; needs review] bug in list_plot3d -- invalid index?",
        "to": "[with patch; positive review] bug in list_plot3d -- invalid index?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4818#event-18508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4818#issuecomment-38746",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4818#event-18509"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4818#issuecomment-38747",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4818#issuecomment-38748",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
