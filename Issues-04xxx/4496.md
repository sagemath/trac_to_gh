...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35143",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "rename": {
        "from": "Plot doesn't allow variable outside tuple after lambda",
        "to": "[with patch, needs review] Plot doesn't allow variable outside tuple after lambda"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4496#event-16942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35144",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35145",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35146",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "rename": {
        "from": "[with patch, needs review] Plot doesn't allow variable outside tuple after lambda",
        "to": "[with patch, needs work] Plot doesn't allow variable outside tuple after lambda"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4496#event-16943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35147",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "rename": {
        "from": "[with patch, needs work] Plot doesn't allow variable outside tuple after lambda",
        "to": "[with patch, needs review] Plot doesn't allow variable outside tuple after lambda"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4496#event-16944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35148",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35149",
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] Plot doesn't allow variable outside tuple after lambda",
        "to": "[with patch, positive review] Plot doesn't allow variable outside tuple after lambda"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4496#event-16945"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35150",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35151",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4496#event-16946"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4496#issuecomment-35152",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
