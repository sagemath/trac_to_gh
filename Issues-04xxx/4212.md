...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42115"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42118"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24979",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24980",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24981",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    "body": "Changed assignee from **@craigcitro, @jvoight** to **@sagetrac-mabshoff**",
    "created_at": "2008-09-28T07:59:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24982",
    "user": "https://github.com/sagetrac-mabshoff"
}
```

Changed assignee from **@craigcitro, @jvoight** to **@sagetrac-mabshoff**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24983",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4212#event-42122"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24984",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4212#issuecomment-24985",
