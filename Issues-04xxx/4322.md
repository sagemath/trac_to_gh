# Issue 4322: [with patch, with positive review] modular polynomials database is broken
...
```json
{
    ...
    "title": "[with patch, with positive review] modular polynomials database is broken",
    "type": "issue",
