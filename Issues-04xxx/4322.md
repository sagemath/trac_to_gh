...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34240",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34241",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>RobertWB is the man here :)\n\nCheers,\n\nMichael",
    "created_at": "2008-10-20T22:27:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34242",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>RobertWB is the man here :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34243",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34244",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Actually, it looks like it's due to #4021, MPolynomial_libsingular over ZZ. It still works in the generic case: \n\n```\nsage: P.<x,y> = ZZ['t']['x,y']\nsage: a = sage.rings.polynomial.polydict.PolyDict({(1,0):1,(0,1):-1})\nsage: P(a)\nx - y\n```\n\nDespite the fact that polydicts are no longer used, I can't think of any reason why one would need this construction. More efficient (and less prone to breakage in the future is) direct construction from a dict. \n\n```\nsage: P.<x,y> = ZZ[]\nsage: P({(1,0):1,(0,1):-1})\nx - y\n```",
    "created_at": "2008-10-21T19:06:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34245",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>Actually, it looks like it's due to #4021, MPolynomial_libsingular over ZZ. It still works in the generic case: 
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_4322.patch](tarball://root/attachments/some-uuid/ticket4322/trac_4322.patch) by @aghitza created at 2009-01-23 18:40:41\n\nThe attached patch removes the uses of polydict.",
    "created_at": "2009-01-23T18:40:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34246",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:4'></a>Attachment [trac_4322.patch](tarball://root/attachments/some-uuid/ticket4322/trac_4322.patch) by @aghitza created at 2009-01-23 18:40:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34247",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4322#issuecomment-34248",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
