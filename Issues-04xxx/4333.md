...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4333#issuecomment-33547",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4333#issuecomment-33548",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4333#issuecomment-33549",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] bernoulli_python doesn't work, remove it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4333#event-16240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4333#issuecomment-33550",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "rename": {
        "from": "[with patch, needs review] bernoulli_python doesn't work, remove it",
        "to": "[with patch, positive review] bernoulli_python doesn't work, remove it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4333#event-16241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4333#event-16242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4333#issuecomment-33551",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4333#issuecomment-33552",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
