...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4597#issuecomment-35306",
...
```json
{
    "body": "<a id='comment:1'></a>I **think** the attached patch will fix the problem. The issue is this: when a file doesn't exist, we want to have different behaviors at different parts of the compilation process. So, I made the `timestamp` function take an extra argument, which is what to return if the file doesn't exist, and set it accordingly. The default behavior is that if the file doesn't exist, it returns the current time -- so that a nonexistent file is considered new (i.e. things depending on it need updated).\n\nLet me know if this doesn't fix the problem.",
    "created_at": "2008-11-23T23:00:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4597#issuecomment-35307",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>I **think** the attached patch will fix the problem. The issue is this: when a file doesn't exist, we want to have different behaviors at different parts of the compilation process. So, I made the `timestamp` function take an extra argument, which is what to return if the file doesn't exist, and set it accordingly. The default behavior is that if the file doesn't exist, it returns the current time -- so that a nonexistent file is considered new (i.e. things depending on it need updated).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4597#issuecomment-35308",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Looks reasonable, and does fix my problem.\n\nPositive review.",
    "created_at": "2008-11-25T01:40:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4597#issuecomment-35309",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:2'></a>Looks reasonable, and does fix my problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4597#issuecomment-35310",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4597#issuecomment-35311",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
