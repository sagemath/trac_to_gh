...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35792",
    "user": "https://trac.sagemath.org/admin/accounts/users/sengupta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35793",
    "user": "https://trac.sagemath.org/admin/accounts/users/sengupta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35794",
    "user": "https://trac.sagemath.org/admin/accounts/users/sengupta"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Hi David ... I have just posted the patch to the exp() code ... Please take a look ... It will be great if I can have it checked ... Thank you ...",
    "created_at": "2008-11-09T08:05:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35795",
    "user": "https://trac.sagemath.org/admin/accounts/users/sengupta"
}
```

<a id='comment:1'></a>Hi David ... I have just posted the patch to the exp() code ... Please take a look ... It will be great if I can have it checked ... Thank you ...
...
```json
{
    "body": "<a id='comment:2'></a>I will review this in the next few days.",
    "created_at": "2008-11-10T22:22:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35796",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:2'></a>I will review this in the next few days.
...
```json
{
    "body": "<a id='comment:7'></a>I agree with Michael on the value of \"Shouldn't have \"fixes \\#4477\" (what will that mean in two years)\", assuming we never loose all of trac :-)  I prefer writing \"Trac ticket \\#4477\" to clue people a little more about the meaning of it though, in any docstring.",
    "created_at": "2008-11-13T14:37:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35799",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:7'></a>I agree with Michael on the value of "Shouldn't have "fixes \#4477" (what will that mean in two years)", assuming we never loose all of trac :-)  I prefer writing "Trac ticket \#4477" to clue people a little more about the meaning of it though, in any docstring.
...
```json
{
    "body": "<a id='comment:8'></a>ok, fair enough. At some point it starts getting kind of cluttered though, and can distract from the \"documentation\" purpose of the docstring. I agree with moving it out to a TESTS section at some point.",
    "created_at": "2008-11-13T15:01:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35800",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:8'></a>ok, fair enough. At some point it starts getting kind of cluttered though, and can distract from the "documentation" purpose of the docstring. I agree with moving it out to a TESTS section at some point.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35801",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Second attempt, to address my previous concerns. Apply both patches.",
    "created_at": "2008-12-05T03:39:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35802",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:9'></a>Second attempt, to address my previous concerns. Apply both patches.
...
```json
{
    "body": "<a id='comment:11'></a>I suppose it's reasonable to expect it automatically passes to the quotient field where possible, but unless someone wants to fix that right now, it should probably go onto another ticket.\n\n(While we're here, shouldn't the sqrt function pass to the localisation away from the prime 2? Why all the way to Q? (Just kidding --- I know the answer :-)))",
    "created_at": "2008-12-09T23:27:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35804",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:11'></a>I suppose it's reasonable to expect it automatically passes to the quotient field where possible, but unless someone wants to fix that right now, it should probably go onto another ticket.
...
```json
{
    "body": "<a id='comment:12'></a>I've created #4748. Other than that it works great (and the issue above didn't work before either). \n\n- Robert",
    "created_at": "2008-12-10T00:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35805",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:12'></a>I've created #4748. Other than that it works great (and the issue above didn't work before either). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Merged trac_4477.patch and trac_4477-2.patch in Sage 3.2.2.alpha1",
    "created_at": "2008-12-10T07:54:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4477#issuecomment-35807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>Merged trac_4477.patch and trac_4477-2.patch in Sage 3.2.2.alpha1
