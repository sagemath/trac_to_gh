...
```json
{
    "body": "<a id='comment:1'></a>See http://trac.cython.org/cython_trac/ticket/339",
    "created_at": "2009-06-28T09:00:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35070",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>See http://trac.cython.org/cython_trac/ticket/339
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35071",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Preliminary patch, need a new Cython spkg for it to work all the way.",
    "created_at": "2009-06-28T09:02:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35072",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>Preliminary patch, need a new Cython spkg for it to work all the way.
...
```json
{
    "body": "<a id='comment:5'></a>Note (re: discussion on Cython ML) that shape in numpy.pxd is still a field, long story (well, it is performance critical), and I shouldn't change it.",
    "created_at": "2009-07-07T15:57:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35074",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```

<a id='comment:5'></a>Note (re: discussion on Cython ML) that shape in numpy.pxd is still a field, long story (well, it is performance critical), and I shouldn't change it.
...
```json
{
    "body": "<a id='comment:6'></a>Another quick comment: With this, full Cython/NumPy functionality is available from the notebook and works well.",
    "created_at": "2009-07-07T16:09:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35075",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```

<a id='comment:6'></a>Another quick comment: With this, full Cython/NumPy functionality is available from the notebook and works well.
...
```json
{
    "body": "<a id='comment:7'></a>Those errors seem completely unrelated, I'll see if I get them too. Other than that, it looks really good. \n\nI've used Cython + NumPy from the notebook before, as long as you weren't in sage.ext then \"cimport numpy\" worked as expected (though there was a point where it didn't).",
    "created_at": "2009-07-09T08:50:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35076",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>Those errors seem completely unrelated, I'll see if I get them too. Other than that, it looks really good. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35078",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Looks good. The single doctest failure was minor, fixed in #6438.",
    "created_at": "2009-07-22T14:19:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35079",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>Looks good. The single doctest failure was minor, fixed in #6438.
...
```json
{
    "body": "<a id='comment:13'></a>Looks like it'll have to be rebased, worked fine on vanilla 4.1. Where's the .tar on sage.math?",
    "created_at": "2009-07-23T08:50:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35082",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>Looks like it'll have to be rebased, worked fine on vanilla 4.1. Where's the .tar on sage.math?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35083",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Works fine form me. sage-4.1.1.alpha0-sage.math.washignton.edu-x86_64-Linux.tar.gz + #6438 + #4571. Are you sure applied the latest Cython spkg first? 4.1.1.alpha0 doesn't seem to have it.",
    "created_at": "2009-07-25T12:07:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35084",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:15'></a>Works fine form me. sage-4.1.1.alpha0-sage.math.washignton.edu-x86_64-Linux.tar.gz + #6438 + #4571. Are you sure applied the latest Cython spkg first? 4.1.1.alpha0 doesn't seem to have it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35085",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>dagss: The patch `4571-more-fixes.patch` doesn't contain your username. I'm committing it in your name. Merged in this order\n1. the SPKG at #6438\n2. `4571-numpy-pxd.patch`\n3. `4571-more-fixes.patch`",
    "created_at": "2009-07-25T15:45:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4571#issuecomment-35086",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:17'></a>dagss: The patch `4571-more-fixes.patch` doesn't contain your username. I'm committing it in your name. Merged in this order
1. the SPKG at #6438
2. `4571-numpy-pxd.patch`
3. `4571-more-fixes.patch`
