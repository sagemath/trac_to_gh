...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45096"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45100"
}
```
...
```json
{
    "body": "<a id='comment:3'>Comment 3:</a>\nThe letterplace interface in [attachment: letterplace.py.gz](https://github.com/sagemath/sage/files/ticket4539/letterplace.py.gz) is now at #7797.",
    "created_at": "2009-12-30T21:49:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
...
```json
{
    "body": "Changed assignee from **@burcin** to **OleksandrMotsak, @alexanderdreyer**",
...
Changed assignee from **@burcin** to **OleksandrMotsak, @alexanderdreyer**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45104"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45105"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45106"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45107"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45108"
}
```
...
```json
{
    "body": "Changed keywords from **** to **libsingular plural wrapper**",
    "created_at": "2011-03-13T14:13:21Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
...
Changed keywords from **** to **libsingular plural wrapper**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45110"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45111"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45112"
}
```
...
```json
{
    "body": "<a id='comment:59'>Comment 59:</a>\nAttachment: **[trac4539_monomial_quotient.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_monomial_quotient.patch.gz)**\n\nConcerning [attachment: trac4539_monomial_quotient.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_monomial_quotient.patch.gz): I am not sure if it is the right thing to do. I think that monomial_quotient is a method that should be as fast as possible, since in some situations it is used very frequently. In these situations, it is always the case that one monomial *does* divide the other. Hence, for the application, it is a bad idea to have a redundant sanity test in monomial_quotient. I'd rather have it return a wrong result when using it in a wrong way.\n\nNote that [attachment: trac4539_kwds.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_kwds.patch.gz) is not needed for my patch - I already have *args in it.\n\nWe have already briefly discussed why I think that [attachment: trac4539_lmul.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_lmul.patch.gz) probably is not a good approach: x._rmul_(c) and x._lmul_(c) (by specification of the coercion model) can assume that the argument c belongs to x.parent().base_ring(). In particular, I don't believe that c can actually be a non-commutative polynomial.\n\nCan you please provide an example that was segfaulting without the lmul-patch?",
...
```json
{
    "body": "<a id='comment:60'>Comment 60:</a>\nAt least, when I use [plus [attachment: trac4539_lmul.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_lmul.patch.gz)(https://github.com/sagemath/sage/files/ticket4539/6143729ca46d0a9823b3635831315ba6.gz) on top of sage-4.7.3.alpha3-prerelease, then all tests in sage/rings/polynomial pass (except those that fail in the unpatched version as well).\n\nSince I believe that the monomial quotient patch does not do the right thing, I'd prefer to work on top of [and [attachment: trac4539_lmul.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_lmul.patch.gz)(https://github.com/sagemath/sage/files/ticket4539/6143729ca46d0a9823b3635831315ba6.gz), and concentrate on getting the lmul business right.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45114"
}
```
...
```json
{
    "body": "<a id='comment:64'>Comment 64:</a>\nThe new [attachment: trac4539_libplural.2.patch.gz](https://github.com/sagemath/sage/files/ticket4539/trac4539_libplural.2.patch.gz) is stand-alone and is supposed to summarise the discussion we had here. I think it is ready to be reviewed (but as usual I didn't run the tests yet...).\n\nApply trac4539_libplural.2.patch",
    "created_at": "2011-09-28T14:14:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45115"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45118"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45119"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45125"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45131"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45140"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45141"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45150"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45152"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4539#issuecomment-27989",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4539#issuecomment-27990",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4539#issuecomment-27991",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45158"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4539#issuecomment-27992",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45159"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45160"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4539#issuecomment-27993",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45161"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45162"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4539#issuecomment-27994",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4539",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4539#event-45164"
}
```
