...
```json
{
    "body": "Changed assignee from **@burcin** to **@sagetrac-OleksandrMotsak, @alexanderdreyer**",
...
Changed assignee from **@burcin** to **@sagetrac-OleksandrMotsak, @alexanderdreyer**
