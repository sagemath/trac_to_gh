...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] hang in lisp.py on OS X 10.5",
        "to": "[with patch, positive review] hang in lisp.py on OS X 10.5"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4114#event-15345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4114#issuecomment-31413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4114",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4114#event-15346"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4114#issuecomment-31414",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4114",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4114#issuecomment-31415",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
