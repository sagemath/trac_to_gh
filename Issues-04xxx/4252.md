...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4252#issuecomment-25760",
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4252#event-25096"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4252#event-25097"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4252#event-25098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4252",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4252#event-25099"
}
```
