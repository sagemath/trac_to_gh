...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26002",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26004",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26005",
    "user": "https://trac.sagemath.org/admin/accounts/users/ljpk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26006",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26007",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26008",
...
```json
{
    "body": "<a id='comment:8'></a>\nAttachment [trac-4335-rebase.patch](https://github.com/sagemath/sage/files/ticket4335/trac-4335-rebase.patch) by @craigcitro created at 2008-10-26 04:53:40\n\nI rebased the patch, and it *should* work -- I don't have a current alpha, but I was pretty sure it was my patch from another ticket that caused the merge troubles. Let me know if this one doesn't work.",
    "created_at": "2008-10-26T04:53:40Z",
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26009",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26010",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4335",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4335#issuecomment-26011",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
