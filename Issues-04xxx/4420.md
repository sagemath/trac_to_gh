...
archive/attachments_004943.json:
```json
{
...
```json
{
    "body": "**Attachment:** [sort_gb.patch](https://github.com/sagemath/sage/files/ticket4420/sort_gb.patch)",
    "created_at": "2008-11-02T01:42:15Z",
    "issue": "https://github.com/sagemath/sage/issues/4420",
    "type": "issue_comment",
...
**Attachment:** [sort_gb.patch](https://github.com/sagemath/sage/files/ticket4420/sort_gb.patch)
...
archive/attachments_004944.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [sort_gb_doc.patch](https://github.com/sagemath/sage/files/ticket4420/sort_gb_doc.patch)\n\nThe attached patch fixes the doctest failures in `tut.tex` and `const.tex`",
    "created_at": "2008-11-02T14:37:29Z",
    "issue": "https://github.com/sagemath/sage/issues/4420",
    "type": "issue_comment",
