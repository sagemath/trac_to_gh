...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4991#issuecomment-40430",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4991#issuecomment-40431",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "rename": {
        "from": "GDB is broken on OSX due to ipython's readline detection",
        "to": "[with spkg, needs review] GDB is broken on OSX due to ipython's readline detection"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4991#event-19346"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "rename": {
        "from": "[with spkg, needs review] GDB is broken on OSX due to ipython's readline detection",
        "to": "[with spkg, positive review] GDB is broken on OSX due to ipython's readline detection"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4991#event-19347"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4991#issuecomment-40432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4991#issuecomment-40433",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4991#issuecomment-40434",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4991#issuecomment-40435",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4991",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4991#event-19348"
}
```
