...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49421"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49424"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49428"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4895#issuecomment-30702",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49429"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4895#issuecomment-30703",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4895",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-49432"
}
```
