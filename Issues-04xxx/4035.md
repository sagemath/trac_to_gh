...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4035/m2_optional_doctests.patch",
    "created_at": "2008-09-01T09:56:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4035",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4035/m2_optional_doctests.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [m2_optional_doctests.patch](https://github.com/sagemath/sage/files/ticket4035/m2_optional_doctests.patch) by @malb created at 2008-09-01 09:56:22\n\nGary, can you review this (I'm asking you since it involves M2)",
    "created_at": "2008-09-01T09:56:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4035#issuecomment-23679",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4035#issuecomment-23680",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4035#issuecomment-23681",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4035#issuecomment-23682",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4035#issuecomment-23683",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
