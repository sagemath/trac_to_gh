...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35722",
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_4637.patch](tarball://root/attachments/some-uuid/ticket4637/trac_4637.patch) by @roed314 created at 2009-03-18 06:17:07\n\nI know there are still problems.  But all doctests currently pass, I don't know of remaining bugs, and I wanted to keep this manageable (rather than continuing the tradition of patch-bombs).  I'm going to keep working on adding more documentation.",
    "created_at": "2009-03-18T06:17:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35723",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>Attachment [trac_4637.patch](tarball://root/attachments/some-uuid/ticket4637/trac_4637.patch) by @roed314 created at 2009-03-18 06:17:07
...
```json
{
    "body": "<a id='comment:4'></a>First comment: your choice of ... for eliding terms in printing conflicts with the doctest framework; could that be .. or something different?  For example, in factory.py around line 150,\n\n```\n        sage: T = Qp(5, print_mode='series', print_max_terms=4); b = R(-70700); repr(b)                                                  \n        '2*5^2 + 4*5^3 + 5^4 + 2*5^5 + ... + O(5^22)'\n```\n\nis *not* testing what you think it is -- the doctester matches ... inside of strings!  (You've typoed, and you meant `T(-70700)`.)",
    "created_at": "2009-03-18T18:41:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35724",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:4'></a>First comment: your choice of ... for eliding terms in printing conflicts with the doctest framework; could that be .. or something different?  For example, in factory.py around line 150,
...
```json
{
    "body": "<a id='comment:6'></a>Fair criticisms.  The current model of passing in parameters hasn't really stood up well as I've added features.  Now that someone else has read the code, I'd be happy to discuss better options.",
    "created_at": "2009-03-23T02:26:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35726",
    "user": "https://github.com/roed314"
}
```

<a id='comment:6'></a>Fair criticisms.  The current model of passing in parameters hasn't really stood up well as I've added features.  Now that someone else has read the code, I'd be happy to discuss better options.
...
```json
{
    "body": "<a id='comment:9'></a>(That said, the patch does add a *lot* of very good new examples and documentation.)",
    "created_at": "2009-04-10T17:05:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35728",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>(That said, the patch does add a *lot* of very good new examples and documentation.)
...
```json
{
    "body": "<a id='comment:10'></a>With the latest patch at #5499 all doctests pass.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-13T03:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35729",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>With the latest patch at #5499 all doctests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35730",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Merged in Sage 3.4.1.rc3.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-13T08:47:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35731",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged in Sage 3.4.1.rc3.
...
```json
{
    "body": "<a id='comment:12'></a>David: This patch is also a diff, so next time you might want to export. I have committed this patch in your name.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-15T02:35:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35732",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>David: This patch is also a diff, so next time you might want to export. I have committed this patch in your name.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4637#issuecomment-35733",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
