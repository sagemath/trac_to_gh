...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47409"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47411"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47412"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47413"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47415"
}
```
...
```json
{
    ...
    "title_was": "bug/stupid design of padic_printing.sep print mode stuff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-28800",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-28801",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47418"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47419"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-47420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-28802",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-28803",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-28804",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-28805",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
