# Issue 4202: [with patch, positive review] latex derivatives of symbolic functions nicely
...
```json
{
    ...
    "title": "[with patch, positive review] latex derivatives of symbolic functions nicely",
    "type": "issue",
