...
<a id='comment:24'></a>Replying to [justin](#comment%3A23):
> I will make the changes to raise errors rather than return unexpected values; that makes sense.
...
<a id='comment:46'></a>(added the accent to Gonzalo Tornaría's name; maybe this will also convince the patchbot to test this ticket)
