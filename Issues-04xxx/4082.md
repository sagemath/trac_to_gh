...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4082#issuecomment-31058",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4082#issuecomment-31059",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4082",
    "rename": {
        "from": "[with patch, needs review] Sage 3.1.2.rc0: numerical noise on OSX/Intel in schemes/elliptic_curves/ell_number_field.py",
        "to": "[with patch, positive review] Sage 3.1.2.rc0: numerical noise on OSX/Intel in schemes/elliptic_curves/ell_number_field.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4082#event-15218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4082",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4082#event-15219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4082#issuecomment-31060",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4082#issuecomment-31061",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
