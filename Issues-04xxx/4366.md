...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34703",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34705",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Very, very nice. Any chance that RobertWB might have some clue here? I would really like to have this fixed in 3.2 :)\n\nCheers,\n\nMichael",
    "created_at": "2008-10-26T21:24:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34706",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Very, very nice. Any chance that RobertWB might have some clue here? I would really like to have this fixed in 3.2 :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34708",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34709",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The coercion model caching what the right action is is essential to its speed, so the behavior remains the same but it remembers to not go down (all) the failed code paths the next time around. The only exceptions are float+ZZ and float+QQ. There's a ticket to handle these better. \n\nOne should be able to cache the exceptions *without* stating every file in the path, and I think this is what we should do.",
    "created_at": "2008-10-28T00:47:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34710",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>The coercion model caching what the right action is is essential to its speed, so the behavior remains the same but it remembers to not go down (all) the failed code paths the next time around. The only exceptions are float+ZZ and float+QQ. There's a ticket to handle these better. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34712",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>As it turns out, it's the formating of the exceptions that's expensive, not the call to sys.exc_info. This is good news for us, as we can defer that to later. See attached patch.",
    "created_at": "2008-10-28T06:57:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34713",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>As it turns out, it's the formating of the exceptions that's expensive, not the call to sys.exc_info. This is good news for us, as we can defer that to later. See attached patch.
...
```json
{
    "body": "<a id='comment:10'></a>The aforementioned tickets would be #3938 and #2898",
    "created_at": "2008-10-28T06:59:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34714",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:10'></a>The aforementioned tickets would be #3938 and #2898
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34715",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Ah, yes. That fix is fine to make (I saw it on my end, but thought it was due to an earlier patch I had in my repo changing some stuff).",
    "created_at": "2008-10-28T17:24:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34717",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>Ah, yes. That fix is fine to make (I saw it on my end, but thought it was due to an earlier patch I had in my repo changing some stuff).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34718",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34720",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Merged 4366-coercion-traceback-fixed.patch in Sage 3.2.alpha2",
    "created_at": "2008-10-28T21:28:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4366#issuecomment-34721",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>Merged 4366-coercion-traceback-fixed.patch in Sage 3.2.alpha2
