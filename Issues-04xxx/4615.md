...
```json
{
    "body": "<a id='comment:2'></a>Yes, it is technically correct that ecl will depend on boehm, but making Maxima depend on it wouldn't hurt anybody.\n\nOne thing missing from William's remarks about deps is that additionally `$(INST)/$(BOEHM_GC)` needs to be added to the `all` target in deps.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-29T07:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4615#issuecomment-37590",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Yes, it is technically correct that ecl will depend on boehm, but making Maxima depend on it wouldn't hurt anybody.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4615#issuecomment-37591",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4615#issuecomment-37592",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
