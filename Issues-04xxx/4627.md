# Issue 4627: [with positive review] CRT_list in HNF dominates computation
...
```json
{
    ...
    "title": "[with positive review] CRT_list in HNF dominates computation",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-40996",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4627/4627-ncalexan-hnf-crt-1.patch",
    "created_at": "2008-11-26T23:13:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-40997",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-40998",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4627/trac-4627-v2.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-40999",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-41000",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "rename": {
        "from": "CRT_list in HNF dominates computation",
        "to": "[with positive review] CRT_list in HNF dominates computation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4627#event-13729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4627#event-13730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-41001",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4627#issuecomment-41002",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
