...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44534"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44536"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44537"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44538"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44539"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44540"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44542"
}
```
...
```json
{
    "body": "Changed assignee from **mabshoff** to **GeorgSWeber**",
    "created_at": "2008-11-12T22:59:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
...
Changed assignee from **mabshoff** to **GeorgSWeber**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44546"
}
```
...
```json
{
    "body": "Changed assignee from **GeorgSWeber** to **@craigcitro**",
...
Changed assignee from **GeorgSWeber** to **@craigcitro**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4500#issuecomment-27325",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4500#issuecomment-27326",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4500#issuecomment-27327",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4500#issuecomment-27328",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4500#issuecomment-27329",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44548"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44549"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4500#event-44550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4500#issuecomment-27330",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
