...
```json
{
    ...
    "rename": {
        "from": "[with spkg; needs review] change genus2reduction to include GPL copyright file and email from liu making the program GPL'd",
        "to": "[with spkg; positive review] change genus2reduction to include GPL copyright file and email from liu making the program GPL'd"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4743#event-18138"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4743#issuecomment-38055",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4743#issuecomment-38056",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4743",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4743#event-18139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4743#issuecomment-38057",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
