...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49574"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49575"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49576"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49577"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49578"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49579"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49580"
}
```
...
```json
{
    "body": "Changed assignee from **@burcin** to **@sagetrac-fredrik**",
...
Changed assignee from **@burcin** to **@sagetrac-fredrik**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49581"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49582"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4807#issuecomment-30150",
    "user": "https://github.com/sagetrac-myurko"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49584"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4807#issuecomment-30151",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49585"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4807",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-49586"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4807#issuecomment-30152",
    "user": "https://github.com/mwhansen"
}
```
