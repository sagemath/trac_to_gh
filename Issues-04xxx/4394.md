...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4394#issuecomment-34154",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4394",
    "rename": {
        "from": "Sage 3.1.4: magma related optional doctest failure in sage/rings/polynomial/polynomial_element.pyx",
        "to": "[with patch; needs review] Sage 3.1.4: magma related optional doctest failure in sage/rings/polynomial/polynomial_element.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4394#event-16497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4394",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4394#issuecomment-34155",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4394",
    "rename": {
        "from": "[with patch; needs review] Sage 3.1.4: magma related optional doctest failure in sage/rings/polynomial/polynomial_element.pyx",
        "to": "[with patch; positive review] Sage 3.1.4: magma related optional doctest failure in sage/rings/polynomial/polynomial_element.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4394#event-16498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4394",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4394#issuecomment-34156",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4394",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4394#issuecomment-34157",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4394",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4394#event-16499"
}
```
