...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28350",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sage-4591.patch](https://github.com/sagemath/sage/files/ticket4591/sage-4591.patch) by @williamstein created at 2008-11-23 07:34:38",
    "created_at": "2008-11-23T07:34:38Z",
    "issue": "https://github.com/sagemath/sage/issues/4591",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28351",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4591",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28352",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [extcode-4591.patch](https://github.com/sagemath/sage/files/ticket4591/extcode-4591.patch) by mabshoff created at 2008-11-23 07:55:24\n\nPositive review. wstein explained the reasons behind the switch to Magma code in detail, so I am happy.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-23T07:55:24Z",
    "issue": "https://github.com/sagemath/sage/issues/4591",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28353",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4591",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28354",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Attachment [sage-4591.2.patch](https://github.com/sagemath/sage/files/ticket4591/sage-4591.2.patch) by @williamstein created at 2008-11-23 08:16:06\n\nrebased version.",
    "created_at": "2008-11-23T08:16:06Z",
    "issue": "https://github.com/sagemath/sage/issues/4591",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28355",
    "user": "https://github.com/williamstein"
}
```

Attachment [sage-4591.2.patch](https://github.com/sagemath/sage/files/ticket4591/sage-4591.2.patch) by @williamstein created at 2008-11-23 08:16:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4591",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4591#issuecomment-28356",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
