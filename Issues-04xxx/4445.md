...
```json
{
    ...
    "rename": {
        "from": "is_isomorphic throws an error when the graph is compared to itself",
        "to": "[with patch, positive review] is_isomorphic throws an error when the graph is compared to itself"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4445#event-16713"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4445#issuecomment-34544",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4445#issuecomment-34545",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4445#issuecomment-34546",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4445",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4445#event-16714"
}
```
