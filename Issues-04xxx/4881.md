...
```json
{
    "body": "<a id='comment:4'></a>Using vtk and wxPython we need an OpenGL (mesa is a good candidate).\n\nWe can test the installation of OpenGL at the start of spkg-install:\n\n```\n# Test OpenGL\nglxinfo\nif [ $? -ne 0 ]; then\n    echo \"Failed to find an OpenGL. Install mesa!\"\n    exit 1\nfi\n\n```\n\nI tested this by putting away /usr/bin/glxinfo. Works for me.\n\nI'll put up a changed vtk-5.2.skpg.\n\nSame for wxPython.\n\nJaap",
    "created_at": "2008-12-29T12:32:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40172",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:4'></a>Using vtk and wxPython we need an OpenGL (mesa is a good candidate).
...
```json
{
    "body": "<a id='comment:6'></a>Yeah, glxinfo is evidently separate from `libgl1-mesa-dev libglu1-mesa-dev` which are the devel libraries related to opengl that have to be installed.   I think it might be better to make a small minimal C program that tests for the presence of those libraries.",
    "created_at": "2008-12-30T01:20:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40174",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>Yeah, glxinfo is evidently separate from `libgl1-mesa-dev libglu1-mesa-dev` which are the devel libraries related to opengl that have to be installed.   I think it might be better to make a small minimal C program that tests for the presence of those libraries.
...
```json
{
    "body": "<a id='comment:9'></a>> I'm not giving this a positive review until it works on sage.math. Do you have an account \n> on sage.math? If so, I think you should get it to work there, so I can give it a positive \n> review.\n\n\nI just want to add that I'm fully willing to install any standard ubuntu packages to get this to work.",
    "created_at": "2008-12-30T18:08:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40177",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>> I'm not giving this a positive review until it works on sage.math. Do you have an account 
> on sage.math? If so, I think you should get it to work there, so I can give it a positive 
> review.
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [comment:11 jsp]:\n> I need a proper X display:\n\n\nLog into sage.math via \"ssh -X\"\n\nCheers,\n\nMichael",
    "created_at": "2008-12-30T22:42:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40180",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Replying to [comment:11 jsp]:
> I need a proper X display:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40181",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40182",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Replying to [comment:15 jsp]:\n> Maybe the following will work:\n> \n\n\n> This method allows the display of the remote X client output as if it were locally connected through a local UNIX domain socket. \n\n\n\n\nThis works on my local network.\n\nJaap",
    "created_at": "2008-12-31T15:32:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40184",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:16'></a>Replying to [comment:15 jsp]:
> Maybe the following will work:
> 
...
```json
{
    "body": "<a id='comment:19'></a>I hope that it would be possible to use from sage.math via X11 forwarding, but the OpenGL may be problematic.  As it is, I get:\n\n```\njason@sage:~$ sage -sh\n\nStarting subshell with Sage environment variables set.\nBe sure to exit when you are done and do not do anything\nwith other copies of Sage!\n\njason@sage:~$ mayavi2 \nTraceback (most recent call last):\n  File \"/usr/local/sage/local/bin/mayavi2\", line 5, in <module>\n    from pkg_resources import load_entry_point\n  File \"build/bdist.linux-x86_64/egg/pkg_resources.py\", line 2561, in <module>\n  File \"build/bdist.linux-x86_64/egg/pkg_resources.py\", line 626, in require\n  File \"build/bdist.linux-x86_64/egg/pkg_resources.py\", line 524, in resolve\npkg_resources.DistributionNotFound: EnthoughtBase>=3.0.2.dev\n```\n\nX11 Forwarding works for me (via ssh -X sage.math.washington.edu).\n\nI'll try installing these packages locally.",
    "created_at": "2009-01-30T17:06:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40187",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:19'></a>I hope that it would be possible to use from sage.math via X11 forwarding, but the OpenGL may be problematic.  As it is, I get:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40192",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40194",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>For the latest spks see:\n\n[http://sage.math.washington.edu/home/jsp/SPKGS/ETS/?C=M;O=D](http://sage.math.washington.edu/home/jsp/SPKGS/ETS/?C=M;O=D)\n\nFor instructions see the REAME.txt\n\nJaap",
    "created_at": "2009-03-17T18:16:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40196",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:27'></a>For the latest spks see:
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4881#event-11251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40197",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Closed in the Sage 3.4.1 time frame by merging ets-3.1.1.rev23241.spkg into the experimental spkg repo.\n\nJaap: Is there anything else that needed uploading? In case there is just comment on the ticket and I will take care of it - no need to reopen this ticket or open another one.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-01T05:39:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40198",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:28'></a>Closed in the Sage 3.4.1 time frame by merging ets-3.1.1.rev23241.spkg into the experimental spkg repo.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4881#event-11252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4881#issuecomment-40199",
    "user": "https://github.com/jaapspies"
}
```
