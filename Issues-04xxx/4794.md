...
```json
{
    "body": "<a id='comment:2'></a>Ok, due to various people like Nick and Tom running into numerous problems with the current pari we will update this in Sage 3.4. This will require changes on top of the ReST patches. \n\nI should post an spkg in the next 24 hours.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-09T05:50:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39481",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Ok, due to various people like Nick and Tom running into numerous problems with the current pari we will update this in Sage 3.4. This will require changes on top of the ReST patches. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39482",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39483",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Remember to turn on relative number field in the ring tester once this spkg has made it - see #4779.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-20T08:29:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39484",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Remember to turn on relative number field in the ring tester once this spkg has made it - see #4779.
...
```json
{
    "body": "<a id='comment:5'></a>What's the latest on this?  We have code which uses the pari library and will not work until a pari bug fix (in their current svn)  is in Sage too.\n\nIsn't Alex Ghitza working on this?  He is not on the CC list for this ticket though.",
    "created_at": "2009-03-19T12:45:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39485",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>What's the latest on this?  We have code which uses the pari library and will not work until a pari bug fix (in their current svn)  is in Sage too.
...
```json
{
    "body": "<a id='comment:6'></a>See #9343 instead.",
    "created_at": "2010-08-01T16:01:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39486",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>See #9343 instead.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39487",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39488",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Please close this ticket",
    "created_at": "2010-09-08T18:11:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39489",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Please close this ticket
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4794#issuecomment-39490",
