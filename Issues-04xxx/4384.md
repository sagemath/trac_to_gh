...
```json
{
    "body": "<a id='comment:1'></a>This is plotting related and has nothing to do with the notebook.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-31T01:11:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34909",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This is plotting related and has nothing to do with the notebook.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34910",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This no longer causes an error, given #5448 being included, but has a different problem, in that matplotlib doesn't just extend the axes all the way to zero.  I don't know if there is a way to fix this, though.",
    "created_at": "2009-09-15T17:35:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34911",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>This no longer causes an error, given #5448 being included, but has a different problem, in that matplotlib doesn't just extend the axes all the way to zero.  I don't know if there is a way to fix this, though.
...
```json
{
    "body": "<a id='comment:4'></a>There's *always* a way to fix it :).\n\nThis is odd, since `plot(1, -5, 5)` seems to give an okay axis range.  Even `plot(1+x-x,-1,1)` seems okay.",
    "created_at": "2009-09-15T17:44:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34912",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>There's *always* a way to fix it :).
...
```json
{
    "body": "<a id='comment:5'></a>Even weirder, for a second it did work on 4.1.2.alpha1 for me.  Then I exited and started again, and it went back to this weird behavior.\n\nAnyway, the problem is probably that we fixed something a while ago to catch constant function plotting, and 1+x-x evaluates to 1 in Sage, but the trig identity doesn't.",
    "created_at": "2009-09-15T18:25:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34913",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>Even weirder, for a second it did work on 4.1.2.alpha1 for me.  Then I exited and started again, and it went back to this weird behavior.
...
```json
{
    "body": "<a id='comment:6'></a>yes, it maybe has something to do with the fast_callable simplifying things or something.\n\nWe should probably add a special case for axes where the y-range is very small.",
    "created_at": "2009-09-15T18:26:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34914",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>yes, it maybe has something to do with the fast_callable simplifying things or something.
...
```json
{
    "body": "<a id='comment:7'></a>Okay, this shows problems: `plot(x^2-1-(x-1)*(x+1), -5, 5)`\n\nIn fact, it shows a lot of random noise.",
    "created_at": "2009-09-15T18:32:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34915",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>Okay, this shows problems: `plot(x^2-1-(x-1)*(x+1), -5, 5)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34916",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Okay, the bug (the error) is fixed.  If we want to open another ticket that somehow figures out the user doesn't want a small window, and instead gives a much bigger range, then I think that should go on another ticket and this should be closed as fixed (due to #5448).",
    "created_at": "2009-09-29T16:03:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34917",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:9'></a>Okay, the bug (the error) is fixed.  If we want to open another ticket that somehow figures out the user doesn't want a small window, and instead gives a much bigger range, then I think that should go on another ticket and this should be closed as fixed (due to #5448).
...
```json
{
    "body": "<a id='comment:10'></a>Changing subject back to the original bug...",
    "created_at": "2009-09-29T16:04:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34918",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:10'></a>Changing subject back to the original bug...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34919",
...
```json
{
    "body": "<a id='comment:11'></a>I can confirm this has been fixed:\n\n```\n[mvngu@darkstar sage-4.1.2.alpha4]$ ./sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n**********************************************************************\n*                                                                    *\n* Warning: this is a prerelease version, and it may be unstable.     *\n*                                                                    *\n**********************************************************************\nsage: h=plot(sin(x)^2+cos(x)^2, -6, 6)\nsage: show(h)\n```\nThe resulting plot is attached. Closing this ticket as being fixed by #5448.",
    "created_at": "2009-09-29T16:17:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34920",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:11'></a>I can confirm this has been fixed:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4384#issuecomment-34921",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
