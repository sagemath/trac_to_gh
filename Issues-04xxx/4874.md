...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18768"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] performance issue for generic polynomial rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4874#issuecomment-39148",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4874#issuecomment-39149",
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18770"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18771"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4874#issuecomment-39150",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "rename": {
        "from": "[with patch; needs review] performance issue for generic polynomial rings",
        "to": "[with patch; with positive review] performance issue for generic polynomial rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4874#issuecomment-39151",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4874#issuecomment-39152",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4874#issuecomment-39153",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4874",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4874#event-18774"
}
```
