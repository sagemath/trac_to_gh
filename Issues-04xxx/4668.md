...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4668#issuecomment-37289",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs review] libSingular's header have too tight permissions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4668#event-17814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4668#issuecomment-37290",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "rename": {
        "from": "[with spkg, needs review] libSingular's header have too tight permissions",
        "to": "[with spkg, with positive review] libSingular's header have too tight permissions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4668#event-17815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4668#issuecomment-37291",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4668#issuecomment-37292",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4668#event-17816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4668#issuecomment-37293",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
