...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Sage 3.2.a2: make three doctests from #788 random again"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4439#event-16677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4439#issuecomment-34476",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4439",
    "rename": {
        "from": "[with patch, needs review] Sage 3.2.a2: make three doctests from #788 random again",
        "to": "[with patch, with positive review] Sage 3.2.a2: make three doctests from #788 random again"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4439#event-16678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4439#issuecomment-34477",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4439",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4439#event-16679"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4439#issuecomment-34478",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
