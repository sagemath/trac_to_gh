...
```json
{
    "body": "<a id='comment:1'></a>I talked to John Hanke and he told me that the code can be deleted since it is no longer used.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-08T20:37:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4467#issuecomment-33758",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>I talked to John Hanke and he told me that the code can be deleted since it is no longer used.
...
```json
{
    "body": "<a id='comment:2'></a>Craig will remove the actual setup.py extension in a separate cleanup patch of setup.py\n\nCheers,\n\nMichael",
    "created_at": "2008-11-10T05:19:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4467#issuecomment-33759",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Craig will remove the actual setup.py extension in a separate cleanup patch of setup.py
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_4467.patch](tarball://root/attachments/some-uuid/ticket4467/trac_4467.patch) by @jonhanke created at 2008-11-10 06:20:23\n\n+1 since the code removes dead code only.",
    "created_at": "2008-11-10T06:20:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4467#issuecomment-33760",
    "user": "https://github.com/jonhanke"
}
```

<a id='comment:3'></a>Attachment [trac_4467.patch](tarball://root/attachments/some-uuid/ticket4467/trac_4467.patch) by @jonhanke created at 2008-11-10 06:20:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4467#issuecomment-33761",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Merged in Sage 3.2.rc0",
    "created_at": "2008-11-10T09:06:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4467#issuecomment-33762",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Merged in Sage 3.2.rc0
