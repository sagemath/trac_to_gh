...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38277",
    "user": "https://trac.sagemath.org/admin/accounts/users/ljpk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38278",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38279",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Odd error message for congruence subgroups"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4762#event-18245"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38280",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "rename": {
        "from": "[with patch, needs review] Odd error message for congruence subgroups",
        "to": "[with patch, needs work] Odd error message for congruence subgroups"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4762#event-18246"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38281",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "rename": {
        "from": "[with patch, needs work] Odd error message for congruence subgroups",
        "to": "[with patch, needs review] Odd error message for congruence subgroups"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4762#event-18247"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38282",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] Odd error message for congruence subgroups",
        "to": "[with patch, with positive review] Odd error message for congruence subgroups"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4762#event-18248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38283",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38284",
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4762#event-18249"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4762#event-18250"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4762#issuecomment-38285",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
