...
<a id='comment:1'></a>I suggest we remove the `power_mod` function completely, since python already supports this.
...
```json
{
    "body": "<a id='comment:3'></a>This is a humble patch that solves the problem of the ticket. I'm not addressing burcin's far more difficult enhancement of introducing a whole arithmetic architecture.  I'm also not addressing the powermod versus power_mod, since I don't want to break existing code by third party people.",
    "created_at": "2009-01-24T01:14:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4850",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>Given patch fixes the reported problem, and it's really simple.\n\nI will open a sage-wishlist issue for removing power_mod.",
...
<a id='comment:4'></a>Given patch fixes the reported problem, and it's really simple.
