...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36481",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36482",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36483",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17420"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17421"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36484",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36485",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36486",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36487",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "rename": {
        "from": "do not unconditionally use M2 for Gbasis computations over ZZ if it is installed",
        "to": "[with patch, needs review] do not unconditionally use M2 for Gbasis computations over ZZ if it is installed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "rename": {
        "from": "[with patch, needs review] do not unconditionally use M2 for Gbasis computations over ZZ if it is installed",
        "to": "[with patch, positive review] do not unconditionally use M2 for Gbasis computations over ZZ if it is installed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36488",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17425"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17426"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4593#event-17427"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36489",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4593#issuecomment-36490",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
