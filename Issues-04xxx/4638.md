...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37875",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This might become a problem when running -upgrade from 3.2 to 3.2.1, but we will see. For now reassign it to 3.2.1. Once we have tested the 3.2 upgrade to 3.2.1.final we will see if we have to do anything special here.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-01T09:19:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37876",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This might become a problem when running -upgrade from 3.2 to 3.2.1, but we will see. For now reassign it to 3.2.1. Once we have tested the 3.2 upgrade to 3.2.1.final we will see if we have to do anything special here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37877",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>wontfix since this was unsupported anyway. Upgrades from 3.2 to 3.2.1 are working.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-02T05:34:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>wontfix since this was unsupported anyway. Upgrades from 3.2 to 3.2.1 are working.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37880",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4638#issuecomment-37881",
    "user": "https://github.com/fchapoton"
}
```
