...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4620#issuecomment-36830",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "rename": {
        "from": "setup.py: if the cythonization fails then next \"sage -b\" starts to build extensions",
        "to": "[with patch, needs review] setup.py: if the cythonization fails then next \"sage -b\" starts to build extensions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4620#event-17535"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4620#issuecomment-36831",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4620#issuecomment-36832",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "rename": {
        "from": "[with patch, needs review] setup.py: if the cythonization fails then next \"sage -b\" starts to build extensions",
        "to": "[with patch, positive review] setup.py: if the cythonization fails then next \"sage -b\" starts to build extensions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4620#event-17536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4620#issuecomment-36833",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4620#issuecomment-36834",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4620#issuecomment-36835",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4620#event-17537"
}
```
