...
<a id='comment:2'></a>Attachment [4099.patch](tarball://root/attachments/some-uuid/ticket4099/4099.patch) by @jicama created at 2008-09-14 02:56:21
...
```json
{
    "body": "<a id='comment:3'></a>I think this is good for now.",
...
<a id='comment:3'></a>I think this is good for now.
