...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4165#event-15529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "rename": {
        "from": "Doctest for lisp.py blows chunks on (some) Mac OS X systems",
        "to": "[with patch, needs review] Doctest for lisp.py blows chunks on (some) Mac OS X systems"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4165#event-15530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4165#issuecomment-31909",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4165#issuecomment-31910",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4165#issuecomment-31911",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4165#issuecomment-31912",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "rename": {
        "from": "[with patch, needs review] Doctest for lisp.py blows chunks on (some) Mac OS X systems",
        "to": "[with patch, positive review] Doctest for lisp.py blows chunks on (some) Mac OS X systems"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4165#event-15531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4165#issuecomment-31913",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4165#issuecomment-31914",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4165",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4165#event-15532"
}
```
