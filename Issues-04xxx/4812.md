# Issue 4812: [with patch, positive review] matrix_plot is broken for matrices with "complicated" base rings
...
```json
{
    ...
    "title": "[with patch, positive review] matrix_plot is broken for matrices with \"complicated\" base rings",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38692",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "rename": {
        "from": "[with patch, needs review] matrix_plot is broken for matrices with \"complicated\" base rings",
        "to": "[with patch, positive review] matrix_plot is broken for matrices with \"complicated\" base rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18474"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38693",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "rename": {
        "from": "[with patch, positive review] matrix_plot is broken for matrices with \"complicated\" base rings",
        "to": "[with patch, needs work] matrix_plot is broken for matrices with \"complicated\" base rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38694",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38695",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38696",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "rename": {
        "from": "[with patch, needs work] matrix_plot is broken for matrices with \"complicated\" base rings",
        "to": "[with patch, positive review] matrix_plot is broken for matrices with \"complicated\" base rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18477"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18478"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18479"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38697",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4812#event-18480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38698",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4812#issuecomment-38699",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
