...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4507#issuecomment-35318",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4507",
    "rename": {
        "from": "compile warning for planarity code",
        "to": "[with patch, needs review] compile warning for planarity code"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4507#event-17010"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4507#issuecomment-35319",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4507",
    "rename": {
        "from": "[with patch, needs review] compile warning for planarity code",
        "to": "[with patch, positive review] compile warning for planarity code"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4507#event-17011"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4507#issuecomment-35320",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4507",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4507#event-17012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4507",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4507#issuecomment-35321",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
