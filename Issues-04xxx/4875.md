...
```json
{
    "body": "<a id='comment:3'></a>Oh, here's an example of manually altering triangulated_facial_incidences() so that show(fill=True) works:\n\n```\nP = Polyhedron(vertices = [[1, 2, 3], [0,1,0], [1,1,1]])\nP.triangulated_facial_incidences()\n# the method caches its result in this private variable\nP._triangulated_facial_incidences = [[0, [0, 1, 2]]]\nP.show(fill=True)\n```",
    "created_at": "2009-03-04T07:08:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37804",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```

<a id='comment:3'></a>Oh, here's an example of manually altering triangulated_facial_incidences() so that show(fill=True) works:
...
```json
{
    "body": "<a id='comment:4'></a>The problem is really that 2D polyhedra in 3D are not being handled well.  The triangulation is correct - you are constructing a 2D object, whose \"faces\" are its edges.  But for rendering, we should special-case this, and if the intrinsic dimension is 2 then we need to triangulate differently.\n\nI will try to fix this today if I can find the time.\n-M. Hampton",
    "created_at": "2009-03-05T13:38:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37805",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:4'></a>The problem is really that 2D polyhedra in 3D are not being handled well.  The triangulation is correct - you are constructing a 2D object, whose "faces" are its edges.  But for rendering, we should special-case this, and if the intrinsic dimension is 2 then we need to triangulate differently.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attached patch should fix the problem.  This issue is simpler than it first appeared, I think.",
    "created_at": "2009-03-21T04:14:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:5'></a>Attached patch should fix the problem.  This issue is simpler than it first appeared, I think.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37809",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Merged in Sage 4.0.rc0.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-21T02:06:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37811",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Merged in Sage 4.0.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4875#event-11228"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4875#issuecomment-37812",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4875#event-11229"
}
```
