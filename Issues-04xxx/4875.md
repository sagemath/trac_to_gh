...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30497",
    "user": "https://trac.sagemath.org/admin/accounts/users/abergeron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30498",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30499",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30500",
...
```json
{
    ...
    "asset_name": "trac_4875_1.patch",
    "asset_url": "tarball://root/attachments/ticket4875/trac_4875_1.patch",
    "created_at": "2009-03-21T04:13:12Z",
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4875/trac_4875_1.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "Attachment [trac_4875_1.patch](https://github.com/sagemath/sage/files/ticket4875/trac_4875_1.patch) by mhampton created at 2009-03-21 04:13:12\n\nspecial casing of 2d polytopes in 3d",
    "created_at": "2009-03-21T04:13:12Z",
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30501",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

Attachment [trac_4875_1.patch](https://github.com/sagemath/sage/files/ticket4875/trac_4875_1.patch) by mhampton created at 2009-03-21 04:13:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30502",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29608"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30503",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29609"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30504",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4875#issuecomment-30505",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4875",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29612"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29613"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4875#event-29614"
}
```
