...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] a single make_element function for pickling is hard to maintain",
        "to": "[with patch, positive review] a single make_element function for pickling is hard to maintain"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4698#event-17933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4698#issuecomment-37531",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4698",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4698#event-17934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4698#issuecomment-37532",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4698#issuecomment-37533",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
