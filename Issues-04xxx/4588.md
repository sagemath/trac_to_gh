...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-35247",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-35248",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-35250",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I think that this set of patches should be merged in. They all applied cleanly to alpha0 (I don't know about alpha1), and this definitely needs to be done. I think that any remaining issues which arise once this does get merged should become their own ticket.",
    "created_at": "2009-01-24T13:39:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-35251",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>I think that this set of patches should be merged in. They all applied cleanly to alpha0 (I don't know about alpha1), and this definitely needs to be done. I think that any remaining issues which arise once this does get merged should become their own ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-35252",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-35253",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
