...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36442",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; not ready for review] doctest -- get rid of the \"feature\" where docstrings with require, optional, and package all in them are automatically marked optional"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4588#event-17401"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4588#event-17402"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36443",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36444",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36445",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "rename": {
        "from": "[with patch; not ready for review] doctest -- get rid of the \"feature\" where docstrings with require, optional, and package all in them are automatically marked optional",
        "to": "[with patch; needs review] doctest -- get rid of the \"feature\" where docstrings with require, optional, and package all in them are automatically marked optional"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4588#event-17403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36446",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36447",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "rename": {
        "from": "[with patch; needs review] doctest -- get rid of the \"feature\" where docstrings with require, optional, and package all in them are automatically marked optional",
        "to": "[with patch; positive review] doctest -- get rid of the \"feature\" where docstrings with require, optional, and package all in them are automatically marked optional"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4588#event-17404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36448",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36449",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4588#issuecomment-36450",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4588",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4588#event-17405"
}
```
