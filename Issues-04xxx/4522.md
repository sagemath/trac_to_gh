...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4522#issuecomment-27528",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4522#issuecomment-27529",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4522#issuecomment-27530",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4522/trac_4522-polynomial_interface.patch",
    "created_at": "2008-11-28T12:41:51Z",
    "issue": "https://github.com/sagemath/sage/issues/4522",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4522/trac_4522-polynomial_interface.patch",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "Attachment [trac_4522-polynomial_interface.patch](https://github.com/sagemath/sage/files/ticket4522/trac_4522-polynomial_interface.patch) by @burcin created at 2008-11-28 12:41:51\n\nmake the interface of polynomials more consistent",
    "created_at": "2008-11-28T12:41:51Z",
    "issue": "https://github.com/sagemath/sage/issues/4522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4522#issuecomment-27531",
    "user": "https://github.com/burcin"
}
```

Attachment [trac_4522-polynomial_interface.patch](https://github.com/sagemath/sage/files/ticket4522/trac_4522-polynomial_interface.patch) by @burcin created at 2008-11-28 12:41:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4522#issuecomment-27532",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4522#issuecomment-27533",
