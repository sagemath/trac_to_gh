...
```json
{
    "body": "<a id='comment:2'></a>Since the first input two notebook has to be a string, if there are no named parameters we should rewrite the code to make the original user's input work.  I.e., This should work no matter what, and I see no reason not to make this work:\n\n```\nsage -notebook \"/Users/carson/doc/math/sage_notebook/\"\n```",
    "created_at": "2008-12-07T19:11:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38804",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Since the first input two notebook has to be a string, if there are no named parameters we should rewrite the code to make the original user's input work.  I.e., This should work no matter what, and I see no reason not to make this work:
...
```json
{
    "body": "<a id='comment:3'></a>Then the patch for ticket #4641 applied to Sage 3.2.1 should be abolished, and the original code\n\nnotebook(*sys.argv[1:])\n\nshould be recovered, until a better solution be found. The original code seems better than the code proposed by the reporter of this bug.",
    "created_at": "2008-12-08T04:25:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38805",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:3'></a>Then the patch for ticket #4641 applied to Sage 3.2.1 should be abolished, and the original code
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38806",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>apply the patch to the *SCRIPTS* repo!",
    "created_at": "2009-01-24T15:51:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38807",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>apply the patch to the *SCRIPTS* repo!
...
```json
{
    "body": "<a id='comment:6'></a>Nice, positive review.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-02T04:57:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Nice, positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38809",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Merged in Sage 3.3.alpha4.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-02T04:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4734#issuecomment-38810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged in Sage 3.3.alpha4.
