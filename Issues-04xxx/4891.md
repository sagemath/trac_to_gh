...
<a id='comment:2'></a>Attachment [trac_4891.patch](tarball://root/attachments/some-uuid/ticket4891/trac_4891.patch) by @williamstein created at 2008-12-30 07:54:50
...
```json
{
    "body": "<a id='comment:3'></a>boehm_gc-7.1.p0 is already in standard Sage, but also in the optional repo in case someone wants to install M2 into an older version of Sage.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-30T10:49:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4891",
    "type": "issue_comment",
...
<a id='comment:3'></a>boehm_gc-7.1.p0 is already in standard Sage, but also in the optional repo in case someone wants to install M2 into an older version of Sage.
...
<a id='comment:4'></a>I tested on OS X and got:
...
<a id='comment:5'></a>> boehm_gc-7.1.p0 is already in standard Sage, but also in the optional repo in case 
> someone wants to install M2 into an older version of Sage. 
...
```json
{
    "body": "<a id='comment:8'></a>Code looks fine, here's the test output:\n\n```\n...\nMaking script relocatable\nFinished installing valgrind_3.3.1.spkg\n['boehm_gc-7.1.p0', 'mpi4py-0.3.1']\nsage: optional_packages()\n...\n  'trac-20071204',\n  'valgrind_3.3.1'],\n ['mpi4py-0.3.1', 'polymake-2.2.p5'])\n```",
...
<a id='comment:8'></a>Code looks fine, here's the test output:
...
```json
{
    "body": "<a id='comment:9'></a>I guess that means **positiv review**",
...
<a id='comment:9'></a>I guess that means **positiv review**
...
```json
{
    "body": "<a id='comment:11'></a>Merged in Sage 3.3.alpha3.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-28T15:22:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4891",
    "type": "issue_comment",
...
<a id='comment:11'></a>Merged in Sage 3.3.alpha3.
