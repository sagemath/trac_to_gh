...
<a id='comment:1'></a>To generate the icon I used ImageMagick:
...
```json
{
    "body": "<a id='comment:4'></a>Note: [attachment:trac_4460_pdf_links.patch] depends on the [attachment:ticket:6485:trac_6485_website_links.patch trac_6485_website_links.patch] at #6485.",
...
<a id='comment:4'></a>Note: [attachment:trac_4460_pdf_links.patch] depends on the [attachment:ticket:6485:trac_6485_website_links.patch trac_6485_website_links.patch] at #6485.
...
```json
{
    "body": "<a id='comment:5'></a>Can someone check the form and function of the updated page in multiple browsers on Mac OS X?",
...
<a id='comment:5'></a>Can someone check the form and function of the updated page in multiple browsers on Mac OS X?
...
<a id='comment:6'></a>This is with both Safari and Firefox on a Mac.
...
<a id='comment:7'></a>Attachment [trac_4460-pdf_links_v2.patch](tarball://root/attachments/some-uuid/ticket4460/trac_4460-pdf_links_v2.patch) by @qed777 created at 2009-07-22 23:19:41
...
<a id='comment:10'></a>Is there an option to turn off this linking to the PDF version of the documents from the HTML version? Currently, we distribute the standard documentation in two standalone formats: as PDF and as HTML; see
...
```json
{
    "body": "<a id='comment:11'></a>That's a good idea.  With the patch at #6187, it should be straightforward to add a command-line option that selects, in effect, a different layout for the \"website\" document.  I'll try to implement this soon.  I don't mind side-lining this ticket for another update and review.",
...
<a id='comment:11'></a>That's a good idea.  With the patch at #6187, it should be straightforward to add a command-line option that selects, in effect, a different layout for the "website" document.  I'll try to implement this soon.  I don't mind side-lining this ticket for another update and review.
...
<a id='comment:12'></a>Attachment [trac_4460-pdf_links_v3.patch](tarball://root/attachments/some-uuid/ticket4460/trac_4460-pdf_links_v3.patch) by @qed777 created at 2009-07-24 08:30:48
...
```json
{
    "body": "<a id='comment:13'></a>The new patch `trac_4460-pdf_links_v3.patch` will need to be moved to another enhancement ticket.",
...
<a id='comment:13'></a>The new patch `trac_4460-pdf_links_v3.patch` will need to be moved to another enhancement ticket.
...
```json
{
    "body": "<a id='comment:15'></a>It seems that `doc/en/website/static/pdf.png` --- a new file --- from [attachment:trac_4460-pdf_links_v2.patch] is missing in v4.1.1.alpha1.",
...
<a id='comment:15'></a>It seems that `doc/en/website/static/pdf.png` --- a new file --- from [attachment:trac_4460-pdf_links_v2.patch] is missing in v4.1.1.alpha1.
...
<a id='comment:16'></a>Attachment [trac_4460-manifest.patch](tarball://root/attachments/some-uuid/ticket4460/trac_4460-manifest.patch) by mvngu created at 2009-07-28 17:44:57
...
```json
{
    "body": "<a id='comment:17'></a>Looks good.  Sorry I missed this the first time around.",
...
<a id='comment:17'></a>Looks good.  Sorry I missed this the first time around.
...
```json
{
    "body": "<a id='comment:18'></a>Replying to [mvngu](#comment%3A16):\n> mpatel: Can you please open another ticket for the patch `trac_4460-pdf_links_v3.patch` and upload that patch there?\nAbsolutely.  Please see #6653.",
...
<a id='comment:18'></a>Replying to [mvngu](#comment%3A16):
> mpatel: Can you please open another ticket for the patch `trac_4460-pdf_links_v3.patch` and upload that patch there?
Absolutely.  Please see #6653.
