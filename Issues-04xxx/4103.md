...
```json
{
    "body": "<a id='comment:2'></a>Patch looks good to me. Assuming it passes doctests (which are running now) this is a positive review.\n\nCheers,\n\nMichael",
...
<a id='comment:2'></a>Patch looks good to me. Assuming it passes doctests (which are running now) this is a positive review.
