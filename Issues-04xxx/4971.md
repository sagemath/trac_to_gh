# Issue 4971: [with patch; positive review] make get_memory_usage() return a float on all platforms
...
```json
{
    ...
    "title": "[with patch; positive review] make get_memory_usage() return a float on all platforms",
    "type": "issue",
