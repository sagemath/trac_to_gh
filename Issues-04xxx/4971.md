...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4971#issuecomment-40187",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4971",
    "rename": {
        "from": "make get_memory_usage() return a float on all platforms",
        "to": "[with patch; needs review] make get_memory_usage() return a float on all platforms"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4971#event-19251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4971#issuecomment-40188",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4971",
    "rename": {
        "from": "[with patch; needs review] make get_memory_usage() return a float on all platforms",
        "to": "[with patch; positive review] make get_memory_usage() return a float on all platforms"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4971#event-19252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4971#event-19253"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4971#issuecomment-40189",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4971#issuecomment-40190",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
