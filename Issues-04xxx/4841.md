...
<a id='comment:1'></a>Limits and assumption problems in functional.py:
...
```json
{
    "body": "<a id='comment:3'></a>Wontfix since there are regressions with assumptions that are too much of a problem compared with the benefit of upgrading. If someone disagrees feel free to reopen the ticket.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-26T18:13:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4841",
    "type": "issue_comment",
...
<a id='comment:3'></a>Wontfix since there are regressions with assumptions that are too much of a problem compared with the benefit of upgrading. If someone disagrees feel free to reopen the ticket.
