...
```json
{
    "body": "Attachment [trac_4604.patch](https://github.com/sagemath/sage/files/ticket4604/trac_4604.patch) by wcauchois created at 2010-01-16 23:49:52\n\nbased on sage 4.3.1.alpha1",
    "created_at": "2010-01-16T23:49:52Z",
    "issue": "https://github.com/sagemath/sage/issues/4604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4604#issuecomment-28411",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```

Attachment [trac_4604.patch](https://github.com/sagemath/sage/files/ticket4604/trac_4604.patch) by wcauchois created at 2010-01-16 23:49:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4604#issuecomment-28412",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4604#issuecomment-28413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4604#issuecomment-28414",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4604#issuecomment-28415",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4604#issuecomment-28416",
    "user": "https://github.com/rlmill"
}
```
