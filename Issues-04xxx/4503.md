# Issue 4503: [with patch, positive review] numerical noise in matrix_double_dense on intel mac os X 10.5: SVD
...
```json
{
    ...
    "title": "[with patch, positive review] numerical noise in matrix_double_dense on intel mac os X 10.5: SVD",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4503",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4503#event-10198"
}
```
