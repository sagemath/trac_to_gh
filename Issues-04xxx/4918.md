...
```json
{
    ...
    "rename": {
        "from": "convert sage.matrix.* docstrings to Sphinx",
        "to": "[with patch, needs review] convert sage.matrix.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4918#event-18984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4918#issuecomment-39589",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "rename": {
        "from": "[with patch, needs review] convert sage.matrix.* docstrings to Sphinx",
        "to": "[with patch, needs work] convert sage.matrix.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4918#event-18985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4918#issuecomment-39591",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4918#issuecomment-39592",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4918#issuecomment-39593",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "rename": {
        "from": "[with patch, needs work] convert sage.matrix.* docstrings to Sphinx",
        "to": "[with patch, needs review] convert sage.matrix.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4918#event-18986"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4918#issuecomment-39594",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4918#issuecomment-39595",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4918",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4918#event-18987"
}
```
