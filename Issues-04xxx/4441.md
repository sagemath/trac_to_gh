...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34502",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "rename": {
        "from": "[with patch, needs review] fixes to the doc repo",
        "to": "[with patch, needs work] fixes to the doc repo"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4441#event-16696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34503",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34504",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34505",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "rename": {
        "from": "[with patch, needs work] fixes to the doc repo",
        "to": "[with patch, needs review] corrections/additions to the doc repo to enable \"hg clone\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4441#event-16697"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34506",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "rename": {
        "from": "[with patch, needs review] corrections/additions to the doc repo to enable \"hg clone\"",
        "to": "[with patch, needs work] corrections/additions to the doc repo to enable \"hg clone\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4441#event-16698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34507",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34508",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "rename": {
        "from": "[with patch, needs work] corrections/additions to the doc repo to enable \"hg clone\"",
        "to": "[with patch, needs review] remove two obsolete entries from modabvar documentation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4441#event-16699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34509",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "rename": {
        "from": "[with patch, needs review] remove two obsolete entries from modabvar documentation",
        "to": "[with patch, positive review] remove two obsolete entries from modabvar documentation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4441#event-16700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34510",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4441#event-16701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4441#issuecomment-34511",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
