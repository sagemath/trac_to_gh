...
```json
{
    "body": "<a id='comment:1'></a>Seems to be fine now (3.4):\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nsage: K.<a> = NumberField(x^2 + 1)\nsage: L.<b> = NumberField(K['y'].0^2 + 1/2)\nsage: L\nNumber Field in b with defining polynomial y^2 + 1/2 over its base field\n```",
    "created_at": "2009-03-13T09:04:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39356",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```

<a id='comment:1'></a>Seems to be fine now (3.4):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39357",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39359",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>In the above example, you can create the field L but you can't do much with it (for instance, `L.absolute_discriminant()` fails). But I would argue that this is covered by ticket #252. I propose closing this ticket as \"duplicate\".",
    "created_at": "2009-07-21T08:31:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39360",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:3'></a>In the above example, you can create the field L but you can't do much with it (for instance, `L.absolute_discriminant()` fails). But I would argue that this is covered by ticket #252. I propose closing this ticket as "duplicate".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39361",
...
```json
{
    "body": "<a id='comment:4'></a>Closing this as a duplicate of #252.",
    "created_at": "2009-07-22T18:20:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-39362",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>Closing this as a duplicate of #252.
