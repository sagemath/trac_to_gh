...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18320"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-38429",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-38430",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-38431",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[duplicate, positive review] creation of relative number fields when defining polynomial not integral no longer broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18322"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-38432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18323"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4781#issuecomment-38433",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4781",
    "rename": {
        "from": "[duplicate, positive review] creation of relative number fields when defining polynomial not integral no longer broken",
        "to": "creation of relative number fields when defining polynomial not integral no longer broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18324"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18325"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4781#event-18326"
}
```
