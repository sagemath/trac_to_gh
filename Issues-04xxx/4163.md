# Issue 4163: [with patch, with positive review] tut -- improve factorial / valuation example
...
```json
{
    ...
    "title": "[with patch, with positive review] tut -- improve factorial / valuation example",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4163",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4163#event-9458"
}
```
