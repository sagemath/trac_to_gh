...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4767#issuecomment-38310",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4767#issuecomment-38311",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4767",
    "rename": {
        "from": "[with patch; needs review] magma/sage interface -- speed up conversion of integers and rationals to Magma",
        "to": "[with patch; positive review] magma/sage interface -- speed up conversion of integers and rationals to Magma"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4767#event-18258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4767#issuecomment-38312",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4767#issuecomment-38313",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4767",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4767#event-18259"
}
```
