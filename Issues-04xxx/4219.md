...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4219#issuecomment-32342",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4219#event-15735"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4219#issuecomment-32343",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4219#issuecomment-32344",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "rename": {
        "from": "MacOSX: work around java detection hang in r due to \"Mac OS X 10.5 Update 2\"",
        "to": "[with spkg, needs review] MacOSX: work around java detection hang in r due to \"Mac OS X 10.5 Update 2\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4219#event-15736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4219#issuecomment-32345",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "rename": {
        "from": "[with spkg, needs review] MacOSX: work around java detection hang in r due to \"Mac OS X 10.5 Update 2\"",
        "to": "[with spkg, positive review] MacOSX: work around java detection hang in r due to \"Mac OS X 10.5 Update 2\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4219#event-15737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4219#event-15738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4219#issuecomment-32346",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4219#issuecomment-32347",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
