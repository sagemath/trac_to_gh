# Issue 4219: [with spkg, positive review] MacOSX: work around java detection hang in r due to "Mac OS X 10.5 Update 2"
...
```json
{
    ...
    "title": "[with spkg, positive review] MacOSX: work around java detection hang in r due to \"Mac OS X 10.5 Update 2\"",
    "type": "issue",
