...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12124"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12125"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12126"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12127"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12128"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12129"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4207#event-12130"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4207#issuecomment-31715",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4207#issuecomment-31716",
    "user": "https://github.com/orlitzky"
}
```
