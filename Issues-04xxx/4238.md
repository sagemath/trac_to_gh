...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32492",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32493",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "rename": {
        "from": "option to create local .so file for .spyx modules",
        "to": "[with patch, needs review] option to create local .so file for .spyx modules"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4238#event-15806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32494",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4238#event-15807"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32495",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32496",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "rename": {
        "from": "[with patch, needs review] option to create local .so file for .spyx modules",
        "to": "[with patch, positive review] option to create local .so file for .spyx modules"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4238#event-15808"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32498",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4238#issuecomment-32500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4238",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4238#event-15809"
}
```
