...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30700",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30701",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4897/trac_4897.patch",
    "created_at": "2009-01-04T17:44:05Z",
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4897/trac_4897.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30703",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30704",
    "user": "https://trac.sagemath.org/admin/accounts/users/tnagel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30705",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30706",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30707",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4897/trac_4897.2.patch",
    "created_at": "2009-01-12T11:07:26Z",
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4897/trac_4897.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>\nAttachment [trac_4897.2.patch](https://github.com/sagemath/sage/files/ticket4897/trac_4897.2.patch) by mabshoff created at 2009-01-12 11:07:26\n\nReplying to [cremona](#comment%3A7):\n> Oops, just change `E=EllipticCurve('20160bg2')` to \n> `E=EllipticCurve([0,0,0,-468,2592])`\n> in that doctest.  It should suffice to edit the patch itself.\n\n\nYep, I should have thought of that. trac_4897.2.patch does exactly that.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-12T11:07:26Z",
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30708",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30709",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-30710",
    "user": "https://github.com/JohnCremona"
}
```
