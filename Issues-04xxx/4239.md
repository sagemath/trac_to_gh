...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] fix for problems with zero kernel and images",
        "to": "[with patch, positive review] fix for problems with zero kernel and images"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4239#event-15810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4239#issuecomment-32501",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4239#issuecomment-32502",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4239",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4239#event-15811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4239#issuecomment-32503",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
