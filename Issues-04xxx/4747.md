...
```json
{
    "body": "Attachment [trac_4747.patch](https://github.com/sagemath/sage/files/ticket4747/trac_4747.patch) by @williamstein created at 2008-12-09 22:00:17",
    "created_at": "2008-12-09T22:00:17Z",
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29688",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac_4747.patch](https://github.com/sagemath/sage/files/ticket4747/trac_4747.patch) by @williamstein created at 2008-12-09 22:00:17
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28570"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29689",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29690",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29691",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29692",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28572"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28573"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28574"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28576"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29693",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29694",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29695",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29696",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [trac-4747-doctest.patch](https://github.com/sagemath/sage/files/ticket4747/trac-4747-doctest.patch) by @JohnCremona created at 2008-12-14 19:10:14",
    "created_at": "2008-12-14T19:10:14Z",
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29697",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [trac-4747-doctest.patch](https://github.com/sagemath/sage/files/ticket4747/trac-4747-doctest.patch) by @JohnCremona created at 2008-12-14 19:10:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29698",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28578"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4747#issuecomment-29699",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28580"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28581"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28582"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4747",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4747#event-28583"
}
```
