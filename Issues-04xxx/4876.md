...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg; needs review] update to latest version of kash; replace the two kash3 optional spkg's by a single optional spkg that works on both Linux and OS X, and gives a graceful message on other systems"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39165",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39166",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39167",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39168",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39169",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39170",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "rename": {
        "from": "[with spkg; needs review] update to latest version of kash; replace the two kash3 optional spkg's by a single optional spkg that works on both Linux and OS X, and gives a graceful message on other systems",
        "to": "[with spkg; needs review] update to latest version of kash; improve spkg-install"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39171",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "rename": {
        "from": "[with spkg; needs review] update to latest version of kash; improve spkg-install",
        "to": "[with spkg; positive review (linux)] update to latest version of kash; improve spkg-install"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18781"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39172",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg; positive review] update to latest version of kash; improve spkg-install"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18783"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18784"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39173",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39174",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4876#issuecomment-39175",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4876#event-18787"
}
```
