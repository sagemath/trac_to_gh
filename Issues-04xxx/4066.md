...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4066#issuecomment-30047",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Oops, this patch is not ready for review since some doctests fail. I will post an updated patch shortly.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-05T07:42:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4066#issuecomment-30048",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Oops, this patch is not ready for review since some doctests fail. I will post an updated patch shortly.
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_4066_solaris_fixes.patch](tarball://root/attachments/some-uuid/ticket4066/trac_4066_solaris_fixes.patch) by mabshoff created at 2008-09-05 09:49:36\n\nOk, I have attached an updated patch that \n\n* passes -ba\n* builds fine on Solaris, OSX and Linux and passes doctests on OSX and Linux\n\nNote that _[A-Z] are numerical constants on BSD and Solaris and should not be used as variable names.\n\nI am CCing Robert since he was involved in writing that code (I think :))\n\nCheers,\n\nMichael",
    "created_at": "2008-09-05T09:49:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4066#issuecomment-30049",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Attachment [trac_4066_solaris_fixes.patch](tarball://root/attachments/some-uuid/ticket4066/trac_4066_solaris_fixes.patch) by mabshoff created at 2008-09-05 09:49:36
...
```json
{
    "body": "<a id='comment:5'></a>It applies cleanly against my alpha3, it builds on my 64-bit Linux box, `sage -t rings` passes which should use this functionality (?)\n\nIt SEGFAULTS with `sage -tp 2 sage/rings` in bernouli_mod_p.pyx though. If that can't be reproduced it might just be a weird combination of patches on my machine.",
    "created_at": "2008-09-05T12:04:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4066#issuecomment-30050",
    "user": "https://github.com/malb"
}
```

<a id='comment:5'></a>It applies cleanly against my alpha3, it builds on my 64-bit Linux box, `sage -t rings` passes which should use this functionality (?)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4066#issuecomment-30051",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Merged in Sage 3.1.2.rc0",
    "created_at": "2008-09-05T16:59:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4066#issuecomment-30052",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged in Sage 3.1.2.rc0
