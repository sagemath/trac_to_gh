...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50009"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50015"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4946#issuecomment-31086",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4946#issuecomment-31087",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-50017"
}
```
