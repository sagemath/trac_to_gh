...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-39839",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-39840",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "rename": {
        "from": "readline on opensuse11 64-bit still doesn't work",
        "to": "[with spkg, needs review] readline on opensuse11 64-bit still doesn't work"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4946#event-19126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-39841",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "rename": {
        "from": "[with spkg, needs review] readline on opensuse11 64-bit still doesn't work",
        "to": "[with spkg, positive review] readline on opensuse11 64-bit still doesn't work"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4946#event-19127"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-39842",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-39843",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4946#event-19128"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-39844",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
