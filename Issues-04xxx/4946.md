...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-40796",
...
```json
{
    "body": "<a id='comment:1'></a>The fix here is to use /lib64 on OpenSUSE 11.1 with 64 bits while using /lib with the 32 bit version. I will post an updated spkg in the next 24 hours.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-07T03:52:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-40797",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>The fix here is to use /lib64 on OpenSUSE 11.1 with 64 bits while using /lib with the 32 bit version. I will post an updated spkg in the next 24 hours.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-40798",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-40799",
...
```json
{
    "body": "<a id='comment:5'></a>Merged in Sage 3.3.alpha4.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-03T01:05:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-40800",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Merged in Sage 3.3.alpha4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4946#event-11422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4946#issuecomment-40801",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
