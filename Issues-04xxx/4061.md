...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4061#issuecomment-23847",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4061#issuecomment-23848",
...
archive/attachments_004456.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac-4061.patch](https://github.com/sagemath/sage/files/ticket4061/trac-4061.patch)",
    "created_at": "2008-11-30T11:56:07Z",
    "issue": "https://github.com/sagemath/sage/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4061#issuecomment-23849",
    "user": "https://github.com/JohnCremona"
}
```

**Attachment:** [trac-4061.patch](https://github.com/sagemath/sage/files/ticket4061/trac-4061.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4061#issuecomment-23850",
    "user": "https://github.com/JohnCremona"
}
```
...
archive/attachments_004457.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac-4061-2.patch](https://github.com/sagemath/sage/files/ticket4061/trac-4061-2.patch)",
    "created_at": "2008-11-30T14:44:08Z",
    "issue": "https://github.com/sagemath/sage/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4061#issuecomment-23851",
    "user": "https://github.com/JohnCremona"
}
```

**Attachment:** [trac-4061-2.patch](https://github.com/sagemath/sage/files/ticket4061/trac-4061-2.patch)



---

archive/attachments_004458.json:
```json
{
    "asset_content_type": "application/octet-stream",
