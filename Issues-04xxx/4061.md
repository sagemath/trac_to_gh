...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-29994",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The patch fixes this, based on 3.2.1.rc0.  All doctests in elliptic_curves pass, and both files touched still have 100% coverage :).\n\nThe behaviour for trivial torsion groups is not ideal, but is due to a bug in the Abelian Group class which causes the list of elements of a trivial abelian group to be empty.  That should be in a separate ticket, but it would of course be best solved by the total rewrite of Abelian Groups which we have all wanted (and some of us have partially implemented) for many months...",
    "created_at": "2008-11-30T12:02:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-29995",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>The patch fixes this, based on 3.2.1.rc0.  All doctests in elliptic_curves pass, and both files touched still have 100% coverage :).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-29996",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac-4061-3.patch](tarball://root/attachments/some-uuid/ticket4061/trac-4061-3.patch) by @JohnCremona created at 2008-11-30 14:44:48\n\nThe second patch (apply after the first) fixes the behaviour for trivial torsion, by fixing the method list() for abelian groups which are trivial.  The 3rd patch adds a doctest in the Abelian Groups code which I forgot the first time.",
    "created_at": "2008-11-30T14:44:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-29997",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>Attachment [trac-4061-3.patch](tarball://root/attachments/some-uuid/ticket4061/trac-4061-3.patch) by @JohnCremona created at 2008-11-30 14:44:48
...
```json
{
    "body": "<a id='comment:5'></a>Looks good. Thanks for fixing this (including that very annoying bug in trivial abelian groups). I still find it annoying that it returns a multiplicative abelian group (rather than an additive one) but as is mentioned, that's a later ticket/project. \n\nThis is a bit odd \n\n```\nsage: E = EllipticCurve('11a')\nsage: T = E.torsion_subgroup()\nsage: T.gen(0) in T\nFalse\n```\n\nbut I suppose that's how it used to be, not part of this ticket.",
    "created_at": "2008-12-07T03:58:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-29998",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>Looks good. Thanks for fixing this (including that very annoying bug in trivial abelian groups). I still find it annoying that it returns a multiplicative abelian group (rather than an additive one) but as is mentioned, that's a later ticket/project. 
...
```json
{
    "body": "<a id='comment:6'></a>Merged all three patches in Sage 3.2.2.alpha1",
    "created_at": "2008-12-07T09:59:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-29999",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Merged all three patches in Sage 3.2.2.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4061#issuecomment-30000",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4061",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4061#event-9271"
}
```
