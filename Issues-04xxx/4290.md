...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43041"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43045"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43048"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43049"
}
```
...
```json
{
    ...
    "title_was": "stopgap function to turn plane curves of genus one into elliptic curves",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4290#issuecomment-25685",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4290#issuecomment-25686",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4290#issuecomment-25687",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4290#issuecomment-25688",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43059"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4290",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4290#event-43060"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4290#issuecomment-25689",
