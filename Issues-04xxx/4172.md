...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46729"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46730"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46732"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4172#issuecomment-23751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4172",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46736"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46737"
}
```
