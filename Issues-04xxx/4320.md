# Issue 4320: [with patch, positive review] linear codes improvements
...
```json
{
    ...
    "title": "[with patch, positive review] linear codes improvements",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4320",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4320#event-9769"
}
```
