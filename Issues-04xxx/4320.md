...
archive/attachments_004801.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_4320-linear-codes.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes.patch)",
    "created_at": "2008-10-18T22:56:04Z",
    "issue": "https://github.com/sagemath/sage/issues/4320",
    "type": "issue_comment",
...
archive/attachments_004802.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_004803.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_4320-linear-codes3.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes3.patch)\n\nalso based on 3.2.alpha0. To be applied after trac_4320-linear-codes2.patch",
    "created_at": "2008-10-26T14:30:40Z",
    "issue": "https://github.com/sagemath/sage/issues/4320",
    "type": "issue_comment",
...
**Attachment:** [trac_4320-linear-codes3.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes3.patch)
...
archive/attachments_004804.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_4320-linear-codes4.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes4.patch)\n\nbased on 3.1.4 but applies to 3.2 as well. Goes on top of patches 2 and 3",
    "created_at": "2008-11-22T13:12:41Z",
    "issue": "https://github.com/sagemath/sage/issues/4320",
    "type": "issue_comment",
...
**Attachment:** [trac_4320-linear-codes4.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes4.patch)
...
```json
{
    "body": "**Attachment:** [trac_4320-linear-codes5.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes5.patch)\n\nto be applied on top of patches 2, 3, and 4",
    "created_at": "2008-11-26T01:51:30Z",
    "issue": "https://github.com/sagemath/sage/issues/4320",
    "type": "issue_comment",
...
**Attachment:** [trac_4320-linear-codes5.patch](https://github.com/sagemath/sage/files/ticket4320/trac_4320-linear-codes5.patch)
