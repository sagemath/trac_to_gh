...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4769#issuecomment-38320",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4769#issuecomment-38321",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "rename": {
        "from": "add 5 people to devmap; update info for 2 people",
        "to": "[with patch, needs review] add 5 people to devmap; update info for 2 people"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4769#event-18263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4769#issuecomment-38322",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4769#issuecomment-38323",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4769#event-18264"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "rename": {
        "from": "[with patch, needs review] add 5 people to devmap; update info for 2 people",
        "to": "[with patch, positive review] add 5 people to devmap; update info for 2 people"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4769#event-18265"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4769#issuecomment-38324",
