...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_4015-bench-docs.patch](https://github.com/sagemath/sage/files/ticket4015/trac_4015-bench-docs.patch) by mabshoff created at 2008-08-31 07:05:19\n\nNice work. Positive review. I guess eventually the code should be extended, but as is at least the code is being doctested :)\n\nCheers,\n\nMichael",
    "created_at": "2008-08-31T07:05:19Z",
    "issue": "https://github.com/sagemath/sage/issues/4015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4015#issuecomment-23565",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4015#issuecomment-23566",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_4015.2.patch](https://github.com/sagemath/sage/files/ticket4015/trac_4015.2.patch) by @rlmill created at 2008-08-31 07:36:56\n\nNote that in the second patch, calling the string representation of these functions also actually runs the test code.",
    "created_at": "2008-08-31T07:36:56Z",
    "issue": "https://github.com/sagemath/sage/issues/4015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4015#issuecomment-23567",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4015#issuecomment-23568",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
