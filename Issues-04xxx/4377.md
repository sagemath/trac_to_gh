...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4377#issuecomment-34012",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4377#issuecomment-34013",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4377#issuecomment-34014",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "rename": {
        "from": "Building the Sage library with parallel make is broken on OSX 10.4",
        "to": "[with patch; needs review] Building the Sage library with parallel make is broken on OSX 10.4"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4377#event-16437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4377#issuecomment-34015",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "rename": {
        "from": "[with patch; needs review] Building the Sage library with parallel make is broken on OSX 10.4",
        "to": "[with patch; positive review] Building the Sage library with parallel make is broken on OSX 10.4"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4377#event-16438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4377#event-16439"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4377#issuecomment-34016",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4377#issuecomment-34017",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
