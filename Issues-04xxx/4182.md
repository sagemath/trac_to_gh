...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-32017",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "rename": {
        "from": "plot3d fails with 'IndexError: list index out of range'",
        "to": "[with patch, needs review] plot3d fails with 'IndexError: list index out of range'"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4182#event-15588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-32018",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-32019",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "rename": {
        "from": "[with patch, needs review] plot3d fails with 'IndexError: list index out of range'",
        "to": "[with patch, positive review] plot3d fails with 'IndexError: list index out of range'"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4182#event-15589"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-32020",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4182#event-15590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4182#issuecomment-32021",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
