...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37720",
    "user": "https://trac.sagemath.org/admin/accounts/users/dgordon"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Got an email from Dan that he plans to go some minor modifications, after while I'll give this a positive review.",
    "created_at": "2008-12-30T02:56:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37722",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:3'></a>Got an email from Dan that he plans to go some minor modifications, after while I'll give this a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37723",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37724",
    "user": "https://trac.sagemath.org/admin/accounts/users/dgordon"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Both patches (in order) apply cleanly to 3.3.alpha1. They pass sage -t and sage -t -optional. \n\nLooks good to me.",
    "created_at": "2009-01-28T00:06:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37725",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:5'></a>Both patches (in order) apply cleanly to 3.3.alpha1. They pass sage -t and sage -t -optional. 
...
```json
{
    "body": "<a id='comment:6'></a>MABSHOFF -- when you apply this patch, make sure to add Dan Gordon as an official Sage developer somehow to the list.",
    "created_at": "2009-01-28T01:57:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37726",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>MABSHOFF -- when you apply this patch, make sure to add Dan Gordon as an official Sage developer somehow to the list.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37727",
...
```json
{
    "body": "<a id='comment:7'></a>Merged both patches into Sage 3.3.alpha3.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-28T13:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4859",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4859#issuecomment-37728",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged both patches into Sage 3.3.alpha3.
