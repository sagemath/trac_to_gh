...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4491#event-44399"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4491#event-44400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4491#event-44401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4491#event-44402"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4491#event-44403"
}
```
...
```json
{
    "body": "Changed assignee from **ghtdak** to **@jasongrout**",
    "created_at": "2008-11-22T17:52:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4491#issuecomment-27192",
    "user": "https://github.com/jasongrout"
}
```

Changed assignee from **ghtdak** to **@jasongrout**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4491#issuecomment-27193",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4491#issuecomment-27194",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4491#issuecomment-27195",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4491#issuecomment-27196",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4491#issuecomment-27197",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4491",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4491#event-44404"
}
```
