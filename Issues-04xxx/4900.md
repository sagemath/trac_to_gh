...
```json
{
    ...
    "asset_name": "bsgs.patch",
    "asset_url": "tarball://root/attachments/ticket4900/bsgs.patch",
    "created_at": "2009-01-01T15:34:37Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4900/bsgs.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [bsgs.patch](https://github.com/sagemath/sage/files/ticket4900/bsgs.patch) by @JohnCremona created at 2009-01-01 15:34:37",
    "created_at": "2009-01-01T15:34:37Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30735",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [bsgs.patch](https://github.com/sagemath/sage/files/ticket4900/bsgs.patch) by @JohnCremona created at 2009-01-01 15:34:37
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30736",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30737",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30738",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30739",
    "user": "https://github.com/JohnCremona"
}
```
...
archive/attachments_005463.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "bsgs-new.patch",
    "asset_url": "tarball://root/attachments/ticket4900/bsgs-new.patch",
    "created_at": "2009-01-06T21:37:00Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4900/bsgs-new.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "New BSGS point counting on elliptic curves over finite fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29838"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30741",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29839"
}
```
...
archive/attachments_005464.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_4900.patch",
    "asset_url": "tarball://root/attachments/ticket4900/trac_4900.patch",
    "created_at": "2009-01-07T11:57:16Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4900/trac_4900.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [trac_4900.patch](https://github.com/sagemath/sage/files/ticket4900/trac_4900.patch) by @JohnCremona created at 2009-01-07 11:57:16\n\ntrac_4900.patch should be identical to the previous one except that it is based on 3.2.3 vanilla without the sphinx/rest converted doctests.",
    "created_at": "2009-01-07T11:57:16Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30742",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30743",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29840"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30744",
    "user": "https://github.com/JohnCremona"
}
```
...
archive/attachments_005465.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_4900_typo.patch",
    "asset_url": "tarball://root/attachments/ticket4900/trac_4900_typo.patch",
    "created_at": "2009-01-24T17:46:09Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4900/trac_4900_typo.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>\nAttachment [trac_4900_typo.patch](https://github.com/sagemath/sage/files/ticket4900/trac_4900_typo.patch) by @JohnCremona created at 2009-01-24 17:46:09\n\nReplying to [roed](#comment%3A8):\n> Looks good to me.  One typo (combinarion).  I read through the paper and the code and didn't find any obvious errors.  I tried a few examples and the results seemed reasonable.\n\n\nThanks.  I added a patch which corrects the typo, otherwise is identical to the last one.",
    "created_at": "2009-01-24T17:46:09Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30745",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30746",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29842"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29843"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29844"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4900#event-29845"
}
```
