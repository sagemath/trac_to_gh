...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40392",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>* it seems the docstring for the option 'all' lacks a mention of 'bsgs' (it only mentions 'pari' and 'sea'\n  * I'm not sure about the current policy w.r.t. renaming stuff ('bsgs' -> 'pari'). Would this break existing code?\n  * maybe the debug printing should be handled using `verbose()`?\n  * is the `if debug` around `assert foo` necessary?",
    "created_at": "2009-01-01T21:56:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40393",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>* it seems the docstring for the option 'all' lacks a mention of 'bsgs' (it only mentions 'pari' and 'sea'
  * I'm not sure about the current policy w.r.t. renaming stuff ('bsgs' -> 'pari'). Would this break existing code?
  * maybe the debug printing should be handled using `verbose()`?
  * is the `if debug` around `assert foo` necessary?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40394",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I made this \"not ready for review\" since Drew has made some very helpful suggestions which should help the efficiency main function in this patch.  At the same time I am dealing with the trivialities raised by malb's non-review ;)",
    "created_at": "2009-01-02T14:06:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40395",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>I made this "not ready for review" since Drew has made some very helpful suggestions which should help the efficiency main function in this patch.  At the same time I am dealing with the trivialities raised by malb's non-review ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40398",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_4900.patch](tarball://root/attachments/some-uuid/ticket4900/trac_4900.patch) by @JohnCremona created at 2009-01-07 11:57:16\n\ntrac_4900.patch should be identical to the previous one except that it is based on 3.2.3 vanilla without the sphinx/rest converted doctests.",
    "created_at": "2009-01-07T11:57:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40399",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>Attachment [trac_4900.patch](tarball://root/attachments/some-uuid/ticket4900/trac_4900.patch) by @JohnCremona created at 2009-01-07 11:57:16
...
```json
{
    "body": "<a id='comment:8'></a>Looks good to me.  One typo (combinarion).  I read through the paper and the code and didn't find any obvious errors.  I tried a few examples and the results seemed reasonable.",
    "created_at": "2009-01-24T14:39:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40400",
    "user": "https://github.com/roed314"
}
```

<a id='comment:8'></a>Looks good to me.  One typo (combinarion).  I read through the paper and the code and didn't find any obvious errors.  I tried a few examples and the results seemed reasonable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40401",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_4900_typo.patch](tarball://root/attachments/some-uuid/ticket4900/trac_4900_typo.patch) by @JohnCremona created at 2009-01-24 17:46:09\n\nReplying to [roed](#comment%3A8):\n> Looks good to me.  One typo (combinarion).  I read through the paper and the code and didn't find any obvious errors.  I tried a few examples and the results seemed reasonable.\n\n\nThanks.  I added a patch which corrects the typo, otherwise is identical to the last one.",
    "created_at": "2009-01-24T17:46:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40402",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>Attachment [trac_4900_typo.patch](tarball://root/attachments/some-uuid/ticket4900/trac_4900_typo.patch) by @JohnCremona created at 2009-01-24 17:46:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40403",
...
```json
{
    "body": "<a id='comment:10'></a>Merged trac_4900_typo.patch only in Sage 3.3.alpha2.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-24T19:55:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4900#issuecomment-40404",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Merged trac_4900_typo.patch only in Sage 3.3.alpha2.
