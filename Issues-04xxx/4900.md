...
archive/attachments_005669.json:
```json
{
...
```json
{
    "body": "**Attachment:** [bsgs.patch](https://github.com/sagemath/sage/files/ticket4900/bsgs.patch)",
    "created_at": "2009-01-01T15:34:37Z",
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30749",
    "user": "https://github.com/JohnCremona"
}
```

**Attachment:** [bsgs.patch](https://github.com/sagemath/sage/files/ticket4900/bsgs.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30750",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30751",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30752",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4900#issuecomment-30753",
    "user": "https://github.com/JohnCremona"
}
```
...
archive/attachments_005672.json:
```json
{
    "asset_content_type": "application/octet-stream",
