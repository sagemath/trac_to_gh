...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37202",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4658#event-17734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37203",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "rename": {
        "from": "magma -- get rid of redundant caching: just have _magma_init_",
        "to": "[with patch; needs review] magma -- get rid of redundant caching: just have _magma_init_"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4658#event-17735"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37204",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37205",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "rename": {
        "from": "[with patch; needs review] magma -- get rid of redundant caching: just have _magma_init_",
        "to": "[with patch; positive review] magma -- get rid of redundant caching: just have _magma_init_"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4658#event-17736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37206",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37207",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4658#issuecomment-37208",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4658",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4658#event-17737"
}
```
