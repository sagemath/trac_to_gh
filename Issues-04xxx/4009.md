...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4009#issuecomment-30523",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "rename": {
        "from": "[with spkg, needs review] OSX 10.4/5: build R without the aqua support",
        "to": "[with spkg, positive review] OSX 10.4/5: build R without the aqua support"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4009#event-14954"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4009#event-14955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4009#issuecomment-30524",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4009",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4009#issuecomment-30525",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
