...
```json
{
    "body": "<a id='comment:2'></a>This depends on #3326.",
...
<a id='comment:2'></a>This depends on #3326.
...
```json
{
    "body": "<a id='comment:3'></a>This patch fixes the issue and looks correct.    Positive review.",
...
<a id='comment:3'></a>This patch fixes the issue and looks correct.    Positive review.
