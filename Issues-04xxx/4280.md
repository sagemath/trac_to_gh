...
```json
{
    "body": "Attachment [trac_4820.patch](https://github.com/sagemath/sage/files/ticket4280/trac_4820.patch) by @mwhansen created at 2009-01-24 04:48:38",
    "created_at": "2009-01-24T04:48:38Z",
    "issue": "https://github.com/sagemath/sage/issues/4280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4280#issuecomment-25580",
    "user": "https://github.com/mwhansen"
}
```

Attachment [trac_4820.patch](https://github.com/sagemath/sage/files/ticket4280/trac_4820.patch) by @mwhansen created at 2009-01-24 04:48:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4280#issuecomment-25581",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4280#issuecomment-25582",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4280#issuecomment-25583",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4280#issuecomment-25584",
