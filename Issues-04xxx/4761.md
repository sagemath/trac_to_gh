...
```json
{
    "body": "<a id='comment:4'></a>Cool. I admit I should have searched a bit longer if there is a list of running interfaces already. Most `cputime()` implementations throw `NotImplementedError` but I assume we can just ignore those cpu times or fix that.",
    "created_at": "2008-12-12T00:27:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39183",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>Cool. I admit I should have searched a bit longer if there is a list of running interfaces already. Most `cputime()` implementations throw `NotImplementedError` but I assume we can just ignore those cpu times or fix that.
...
```json
{
    "body": "<a id='comment:5'></a>I updated the patch based on was' comments. Also, the new patch doesn't introduce a new function to the global namespace.",
    "created_at": "2008-12-12T16:26:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39184",
    "user": "https://github.com/malb"
}
```

<a id='comment:5'></a>I updated the patch based on was' comments. Also, the new patch doesn't introduce a new function to the global namespace.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39185",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39187",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The behaviour described above is \"normal\" insofar as it is not caused by the patch, compare with the current implementation:\n\n```\nsage: cputime()\n0.73999999999999999\nsage: exit\nExiting SAGE (CPU time 0m0.05s, Wall time 0m5.60s).\n```\n\nThis should be due to the fact that `cputime()` uses user + sys time while the stuff at exit only uses the CPU time.",
    "created_at": "2009-05-12T02:04:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39188",
    "user": "https://github.com/malb"
}
```

<a id='comment:9'></a>The behaviour described above is "normal" insofar as it is not caused by the patch, compare with the current implementation:
...
```json
{
    "body": "<a id='comment:10'></a>Correction: the stuff at exit simply doesn't count the initialisation. Is that a positive review then?",
    "created_at": "2009-05-12T02:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39189",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>Correction: the stuff at exit simply doesn't count the initialisation. Is that a positive review then?
...
```json
{
    "body": "<a id='comment:11'></a>Just a quick note: The docstring formatting should now follow the ReST format.",
    "created_at": "2009-06-08T03:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39190",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:11'></a>Just a quick note: The docstring formatting should now follow the ReST format.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39191",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Thanks Minh, I've updated the patch. Can someone comment on the open issue raised above, i.e. that I don't agree with Simon's `needs work`?",
    "created_at": "2009-06-08T10:50:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39192",
    "user": "https://github.com/malb"
}
```

<a id='comment:12'></a>Thanks Minh, I've updated the patch. Can someone comment on the open issue raised above, i.e. that I don't agree with Simon's `needs work`?
...
```json
{
    "body": "Changing reviewer from \"\" to \"Simon King, Nick Alexander\"",
    "created_at": "2009-06-19T23:07:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39193",
    "user": "https://github.com/ncalexan"
}
```

Changing reviewer from "" to "Simon King, Nick Alexander"
...
```json
{
    "body": "<a id='comment:13'></a>I think the existing behaviour is fine.  The patch looks good and seems to work for me.  Positive review.",
    "created_at": "2009-06-19T23:07:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39194",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:13'></a>I think the existing behaviour is fine.  The patch looks good and seems to work for me.  Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39195",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39196",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4761#issuecomment-39197",
    "user": "https://github.com/rlmill"
}
```
