...
```json
{
    "body": "<a id='comment:2'></a>Attachment [4656.patch](tarball://root/attachments/some-uuid/ticket4656/4656.patch) by @roed314 created at 2009-01-24 11:07:36",
    "created_at": "2009-01-24T11:07:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38069",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>Attachment [4656.patch](tarball://root/attachments/some-uuid/ticket4656/4656.patch) by @roed314 created at 2009-01-24 11:07:36
...
```json
{
    "body": "<a id='comment:3'></a>Looks good to me and passes all tests. I changed the patch as the orinigally posted patch does not apply against sage 3.4. Thanks!",
    "created_at": "2009-03-12T19:28:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38070",
    "user": "https://github.com/categorie"
}
```

<a id='comment:3'></a>Looks good to me and passes all tests. I changed the patch as the orinigally posted patch does not apply against sage 3.4. Thanks!
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -24,8 +24,6 @@\n Return True if self equals self.parent()(0).\n ```\n \n-Keywords: padic powerseries\n-\n Comment: 1\n \n Summary: power series with zero p-adic coefficients\n``````\n",
    "created_at": "2009-03-12T19:28:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38071",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38072",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>That doctest failure is serious and I have to look into that once #4667 is in.",
    "created_at": "2009-03-30T10:18:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38074",
    "user": "https://github.com/categorie"
}
```

<a id='comment:5'></a>That doctest failure is serious and I have to look into that once #4667 is in.
...
```json
{
    "body": "<a id='comment:7'></a>I'm working on p-adic polynomials, and thus on p-adic power series.  If you want a status report on this ticket, let me know.",
    "created_at": "2009-04-26T19:44:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38076",
    "user": "https://github.com/roed314"
}
```

<a id='comment:7'></a>I'm working on p-adic polynomials, and thus on p-adic power series.  If you want a status report on this ticket, let me know.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38077",
...
```json
{
    "body": "<a id='comment:9'></a>Finally, I came back to this. I will attach a rebased patch. This patch solves the problem of this ticket, but the doctest failure in sha_tate.py is still present. But this is caused by another problem. I opened a new ticket #8198 for this. Once this new ticket is solved this ticket here should hopefully be resolved with this patch.",
    "created_at": "2010-02-05T23:13:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38078",
    "user": "https://github.com/categorie"
}
```

<a id='comment:9'></a>Finally, I came back to this. I will attach a rebased patch. This patch solves the problem of this ticket, but the doctest failure in sha_tate.py is still present. But this is caused by another problem. I opened a new ticket #8198 for this. Once this new ticket is solved this ticket here should hopefully be resolved with this patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38079",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38080",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>The proposed solutions at #9457 are solving this here partially and the problems there are the same as here.",
    "created_at": "2014-01-29T21:42:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38081",
    "user": "https://github.com/categorie"
}
```

<a id='comment:11'></a>The proposed solutions at #9457 are solving this here partially and the problems there are the same as here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38082",
...
```json
{
    "body": "<a id='comment:16'></a>Ping. Does anyone know what is going on here?",
    "created_at": "2017-09-06T03:33:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38083",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:16'></a>Ping. Does anyone know what is going on here?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38084",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4656#issuecomment-38085",
    "user": "https://github.com/saraedum"
}
```
