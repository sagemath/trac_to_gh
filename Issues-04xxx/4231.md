...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32441",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32442",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32443",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "rename": {
        "from": "magma -- long input too verbose in some cases",
        "to": "[with patch; needs review]  magma -- long input too verbose in some cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4231#event-15782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32444",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32445",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "rename": {
        "from": "[with patch; needs review]  magma -- long input too verbose in some cases",
        "to": "[with patch, positive review]  magma -- long input too verbose in some cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4231#event-15783"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32446",
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4231#event-15784"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4231#event-15785"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4231#event-15786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4231#event-15787"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32447",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4231#issuecomment-32448",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
