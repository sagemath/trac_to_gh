...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4016#issuecomment-23569",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4016#issuecomment-23570",
...
```json
{
    "body": "Attachment [4016-doctest_scheme.patch](https://github.com/sagemath/sage/files/ticket4016/4016-doctest_scheme.patch) by @aghitza created at 2008-08-31 12:08:04",
    "created_at": "2008-08-31T12:08:04Z",
    "issue": "https://github.com/sagemath/sage/issues/4016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4016#issuecomment-23571",
    "user": "https://github.com/aghitza"
}
```

Attachment [4016-doctest_scheme.patch](https://github.com/sagemath/sage/files/ticket4016/4016-doctest_scheme.patch) by @aghitza created at 2008-08-31 12:08:04
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4016#issuecomment-23572",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4016#issuecomment-23573",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4016#issuecomment-23574",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
