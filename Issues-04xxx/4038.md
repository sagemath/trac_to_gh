...
```json
{
    ...
    "rename": {
        "from": "Problem in factor() and roots() for p-adic polynomials",
        "to": "[with patch, needs review] Problem in factor() and roots() for p-adic polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4038#event-15061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4038#issuecomment-30720",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4038#issuecomment-30721",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4038",
    "rename": {
        "from": "[with patch, needs review] Problem in factor() and roots() for p-adic polynomials",
        "to": "[with patch, positive review] Problem in factor() and roots() for p-adic polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4038#event-15062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4038#issuecomment-30722",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4038#event-15063"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4038#issuecomment-30723",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4038",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4038#event-15064"
}
```
