...
```json
{
    "body": "<a id='comment:2'></a>This affects sage 3.1.3alpha1 and later.",
...
<a id='comment:2'></a>This affects sage 3.1.3alpha1 and later.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [4232-preparse-long-list.patch](tarball://root/attachments/some-uuid/ticket4232/4232-preparse-long-list.patch) by @robertwb created at 2008-10-01 21:10:32",
...
<a id='comment:3'></a>Attachment [4232-preparse-long-list.patch](tarball://root/attachments/some-uuid/ticket4232/4232-preparse-long-list.patch) by @robertwb created at 2008-10-01 21:10:32
...
```json
{
    "body": "<a id='comment:4'></a>This patch fixes the bug for me.",
...
<a id='comment:4'></a>This patch fixes the bug for me.
