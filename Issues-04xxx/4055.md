...
```json
{
    "body": "<a id='comment:1'></a>I believe this got fixed by Tom Boothby at Sage Days 12, see #3056.  I'm ccing him so he can react.  In any case, this looks fine now:\n\n```\n[ghitza@artin ~]$ sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nsage: sage: R.<x> = RR[]\nsage: sage: (x-1e16)*(x-1e17)\n1.00000000000000*x^2 - 1.10000000000000e17*x + 1.00000000000000e33\nsage: sage: R.<x> = RDF['y']['x']\nsage: sage: (x-1e123)*(x-1e100)\n1.0*x^2 + (-1e+123)*x + 1e+223\n```",
    "created_at": "2009-01-28T21:52:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4055#issuecomment-29928",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:1'></a>I believe this got fixed by Tom Boothby at Sage Days 12, see #3056.  I'm ccing him so he can react.  In any case, this looks fine now:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4055#issuecomment-29929",
...
```json
{
    "body": "<a id='comment:2'></a>Fixed via #3056.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-22T02:56:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4055#issuecomment-29930",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Fixed via #3056.
