...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42036"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42043"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42044"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42054"
}
```
...
```json
{
    ...
    "title_was": "convert RDF and CDF vectors to use numpy",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42055"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4206#issuecomment-24960",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42060"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4206#issuecomment-24961",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4206#issuecomment-24962",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4206#issuecomment-24963",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42063"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4206",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4206#event-42064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4206#issuecomment-24964",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
