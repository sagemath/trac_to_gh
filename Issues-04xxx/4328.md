...
```json
{
    "body": "<a id='comment:1'></a>I should have said it works with vanilla 3.1.4, thus it is most likely related to the recent patches for\nGF(2)[x] I have applied to my 3.1.4 version.",
    "created_at": "2008-10-20T11:58:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4328#issuecomment-34351",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>I should have said it works with vanilla 3.1.4, thus it is most likely related to the recent patches for
GF(2)[x] I have applied to my 3.1.4 version.
...
```json
{
    "body": "<a id='comment:2'></a>It works with my current 3.2.alpha0 merge tree:\n\n```\nmabshoff@sage:/scratch/mabshoff/release-cycle/sage-3.2.alpha0$ ./sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n| SAGE Version 3.1.4, Release Date: 2008-10-16                       |\n| Type notebook() for the GUI, and license() for information.        |\nsage: R=PolynomialRing(ZZ, x)\nsage: sage: f=R(x^4+1)\nsage: sage: f.roots(GF(2))\n[(1, 4)]\n```\nI suspect the root cause could be #4302.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-20T12:06:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4328#issuecomment-34352",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>It works with my current 3.2.alpha0 merge tree:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4328#issuecomment-34354",
    "user": "https://github.com/malb"
}
```
