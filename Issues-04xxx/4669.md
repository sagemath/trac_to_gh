...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4669#issuecomment-37294",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4669#issuecomment-37295",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "rename": {
        "from": "CDF matrices need complex doctests (see matrix/matrix_complex_double_dense.pyx)",
        "to": "[with patch, needs review] CDF matrices need complex doctests (see matrix/matrix_complex_double_dense.pyx)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4669#event-17817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4669#issuecomment-37296",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4669#issuecomment-37297",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "rename": {
        "from": "[with patch, needs review] CDF matrices need complex doctests (see matrix/matrix_complex_double_dense.pyx)",
        "to": "[with patch, positive review] CDF matrices need complex doctests (see matrix/matrix_complex_double_dense.pyx)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4669#event-17818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4669#event-17819"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4669#issuecomment-37298",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4669#issuecomment-37299",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
