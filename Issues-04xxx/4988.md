...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4988#issuecomment-40410",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4988#issuecomment-40411",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] major easy-to-fix but STUPID bug in gcd"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4988#event-19336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4988",
    "rename": {
        "from": "[with patch, needs review] major easy-to-fix but STUPID bug in gcd",
        "to": "[with patch, with positive review] major easy-to-fix but STUPID bug in gcd"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4988#event-19337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4988#issuecomment-40412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4988#issuecomment-40413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4988",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4988#event-19338"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4988#issuecomment-40414",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
