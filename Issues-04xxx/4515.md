...
```json
{
    "body": "**Attachment:** [sage-4515-sage_c_bug.patch](https://github.com/sagemath/sage/files/ticket4515/sage-4515-sage_c_bug.patch)",
    "created_at": "2008-11-13T23:48:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4515",
    "type": "issue_comment",
...
**Attachment:** [sage-4515-sage_c_bug.patch](https://github.com/sagemath/sage/files/ticket4515/sage-4515-sage_c_bug.patch)



---

archive/attachments_005102.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [sage-4515-sage_starts.patch](https://github.com/sagemath/sage/files/ticket4515/sage-4515-sage_starts.patch)\n\npart 2 -- creates a sage-starts script which is used to verify that sage works.",
    "created_at": "2008-11-13T23:50:13Z",
    "issue": "https://github.com/sagemath/sage/issues/4515",
    "type": "issue_comment",
...
**Attachment:** [sage-4515-sage_starts.patch](https://github.com/sagemath/sage/files/ticket4515/sage-4515-sage_starts.patch)
...
archive/attachments_005103.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "makefile",
