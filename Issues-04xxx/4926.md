...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57187"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57191"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57192"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57193"
}
```
...
```json
{
    ...
    "title_was": "convert sage.schemes.* docstrings to Sphinx",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4926",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4926#event-57196"
}
```
