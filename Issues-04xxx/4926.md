...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4926#issuecomment-39648",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] convert sage.schemes.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4926#event-19017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4926",
    "rename": {
        "from": "[with patch, needs review] convert sage.schemes.* docstrings to Sphinx",
        "to": "[with patch, with review, needs a little work] convert sage.schemes.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4926#event-19018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4926",
    "rename": {
        "from": "[with patch, with review, needs a little work] convert sage.schemes.* docstrings to Sphinx",
        "to": "[with patch, needs review] convert sage.schemes.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4926#event-19019"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] convert sage.schemes.* docstrings to Sphinx",
        "to": "[with patch, with positive  review] convert sage.schemes.* docstrings to Sphinx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4926#event-19020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4926",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4926#event-19021"
}
```
