...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4755#issuecomment-38188",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "rename": {
        "from": "CremonaDatabase().number_of_curves() should work when the optional database isn't installed.",
        "to": "[with patch, needs review] CremonaDatabase().number_of_curves() should work when the optional database isn't installed."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4755#event-18216"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4755#issuecomment-38189",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4755#issuecomment-38190",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "rename": {
        "from": "[with patch, needs review] CremonaDatabase().number_of_curves() should work when the optional database isn't installed.",
        "to": "[with patch, positive review] CremonaDatabase().number_of_curves() should work when the optional database isn't installed."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4755#event-18217"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4755#issuecomment-38191",
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4755#event-18218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4755#issuecomment-38192",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4755",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4755#event-18219"
}
```
