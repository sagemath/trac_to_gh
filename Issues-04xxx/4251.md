...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25227",
...
```json
{
    "body": "Attachment [trac_4251-typo-install-guide.patch](https://github.com/sagemath/sage/files/ticket4251/trac_4251-typo-install-guide.patch) by @wdjoyner created at 2008-10-08 00:05:13\n\na change to 2 lines of inst.tex, based on 3.1.3.alpha2",
    "created_at": "2008-10-08T00:05:13Z",
    "issue": "https://github.com/sagemath/sage/issues/4251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25228",
    "user": "https://github.com/wdjoyner"
}
```

Attachment [trac_4251-typo-install-guide.patch](https://github.com/sagemath/sage/files/ticket4251/trac_4251-typo-install-guide.patch) by @wdjoyner created at 2008-10-08 00:05:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25229",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25230",
...
```json
{
    "body": "Attachment [4251.patch](https://github.com/sagemath/sage/files/ticket4251/4251.patch) by @jhpalmieri created at 2008-10-17 21:12:55",
    "created_at": "2008-10-17T21:12:55Z",
    "issue": "https://github.com/sagemath/sage/issues/4251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25231",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [4251.patch](https://github.com/sagemath/sage/files/ticket4251/4251.patch) by @jhpalmieri created at 2008-10-17 21:12:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25232",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4251#issuecomment-25233",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
