...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4592#issuecomment-36474",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "rename": {
        "from": "new setup.py dependency checking does not handle Cython built-in pxd files",
        "to": "[with patch, needs review] new setup.py dependency checking does not handle Cython built-in pxd files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4592#event-17416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4592#issuecomment-36475",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4592#issuecomment-36476",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "rename": {
        "from": "[with patch, needs review] new setup.py dependency checking does not handle Cython built-in pxd files",
        "to": "[with patch, positive review] new setup.py dependency checking does not handle Cython built-in pxd files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4592#event-17417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4592#issuecomment-36477",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4592#issuecomment-36478",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4592#issuecomment-36479",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4592",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4592#event-17418"
}
```
