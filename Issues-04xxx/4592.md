...
```json
{
    "body": "<a id='comment:2'></a>Adds code to also check the Cython include directory for any included `.pxd` files. Raises an error if a file can't be found. (Note that sometimes, this will sneak through and be caught by Cython instead.)",
...
<a id='comment:2'></a>Adds code to also check the Cython include directory for any included `.pxd` files. Raises an error if a file can't be found. (Note that sometimes, this will sneak through and be caught by Cython instead.)
...
```json
{
    "body": "<a id='comment:3'></a>The patch looks good, and does fix a problem.\n\nPositive review.",
...
<a id='comment:3'></a>The patch looks good, and does fix a problem.
...
```json
{
    "body": "<a id='comment:4'></a>Merged in Sage 3.2.1.alpha1",
...
<a id='comment:4'></a>Merged in Sage 3.2.1.alpha1
