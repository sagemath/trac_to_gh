...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4087#issuecomment-31095",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4087#event-15247"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4087#issuecomment-31096",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4087",
    "rename": {
        "from": "[with patch, needs review] Improved printing of polynomials with 'negative' coefficients",
        "to": "[with patch, with positive review] Improved printing of polynomials with 'negative' coefficients"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4087#event-15248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4087#issuecomment-31097",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4087",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4087#event-15249"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4087#issuecomment-31098",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4087#issuecomment-31099",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
