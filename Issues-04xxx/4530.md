...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4530#issuecomment-27714",
    "user": "https://trac.sagemath.org/admin/accounts/users/ronanpaixao"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sage0.png](https://github.com/sagemath/sage/files/ticket4530/sage0.png) by ronanpaixao created at 2008-11-15 19:03:48\n\nDuplicate of bug #4529 (Submitted two times)",
    "created_at": "2008-11-15T19:03:48Z",
    "issue": "https://github.com/sagemath/sage/issues/4530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4530#issuecomment-27715",
    "user": "https://trac.sagemath.org/admin/accounts/users/ronanpaixao"
}
```
