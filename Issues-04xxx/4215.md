...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4215#issuecomment-32308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "rename": {
        "from": "[with patch, needs review] Bug in creating sparse vectors using a dictionary",
        "to": "[with patch, positive review] Bug in creating sparse vectors using a dictionary"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4215#event-15723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4215#issuecomment-32309",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4215#issuecomment-32310",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4215#event-15724"
}
```
