# Issue 4215: [with patch, positive review] Bug in creating sparse vectors using a dictionary
...
```json
{
    ...
    "title": "[with patch, positive review] Bug in creating sparse vectors using a dictionary",
    "type": "issue",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_4215.patch](tarball://root/attachments/some-uuid/ticket4215/trac_4215.patch) by mabshoff created at 2008-09-29 03:11:33\n\nPositive review.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-29T03:11:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4215#issuecomment-31351",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Attachment [trac_4215.patch](tarball://root/attachments/some-uuid/ticket4215/trac_4215.patch) by mabshoff created at 2008-09-29 03:11:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4215#issuecomment-31352",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4215#issuecomment-31353",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4215",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4215#event-9547"
}
```
