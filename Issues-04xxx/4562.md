...
```json
{
    "body": "<a id='comment:1'></a>This is based on sage 3.2.rc2",
...
<a id='comment:1'></a>This is based on sage 3.2.rc2
...
```json
{
    "body": "<a id='comment:3'></a>Patch looks reasonable, compiles, and all doctests in sage/matrix continue to pass after the patch.\n\nPositive review.",
...
<a id='comment:3'></a>Patch looks reasonable, compiles, and all doctests in sage/matrix continue to pass after the patch.
