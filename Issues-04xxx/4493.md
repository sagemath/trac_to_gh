...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4493#issuecomment-27220",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4493#issuecomment-27221",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [vector_derivative.patch](https://github.com/sagemath/sage/files/ticket4493/vector_derivative.patch) by @jasongrout created at 2008-12-05 08:15:34",
    "created_at": "2008-12-05T08:15:34Z",
    "issue": "https://github.com/sagemath/sage/issues/4493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4493#issuecomment-27222",
    "user": "https://github.com/jasongrout"
}
```

Attachment [vector_derivative.patch](https://github.com/sagemath/sage/files/ticket4493/vector_derivative.patch) by @jasongrout created at 2008-12-05 08:15:34
...
```json
{
    "body": "Attachment [matrix-derivative.patch](https://github.com/sagemath/sage/files/ticket4493/matrix-derivative.patch) by @jasongrout created at 2008-12-05 08:31:54",
    "created_at": "2008-12-05T08:31:54Z",
    "issue": "https://github.com/sagemath/sage/issues/4493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4493#issuecomment-27223",
    "user": "https://github.com/jasongrout"
}
```

Attachment [matrix-derivative.patch](https://github.com/sagemath/sage/files/ticket4493/matrix-derivative.patch) by @jasongrout created at 2008-12-05 08:31:54
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4493#issuecomment-27224",
