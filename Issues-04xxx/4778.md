...
archive/attachments_005552.json:
```json
{
...
```json
{
    "body": "<a id='comment:5'></a>\n**Attachment:** [trac_11129_Scilab-interface.patch](https://github.com/sagemath/sage/files/ticket4778/trac_11129_Scilab-interface.patch)\n\nLooks good to me:\n\n\n```\n137 tests in 24 items.\n137 passed and 0 failed.\nTest passed.\n\t [8.0 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 8.0 seconds\n\n```",
    "created_at": "2008-12-16T00:40:57Z",
    "issue": "https://github.com/sagemath/sage/issues/4778",
    "type": "issue_comment",
