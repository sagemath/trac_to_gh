# Issue 4405: [with patch, positive review] double/single quotation marks in docstring
...
```json
{
    ...
    "title": "[with patch, positive review] double/single quotation marks in docstring",
    "type": "issue",
