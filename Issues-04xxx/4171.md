...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46721"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46722"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4171#issuecomment-23749",
...
```json
{
    ...
    "milestone_title": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46724"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46725"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4171#issuecomment-23750",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46727"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-46728"
}
```
