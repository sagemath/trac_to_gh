...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4283#issuecomment-32603",
    "user": "https://trac.sagemath.org/admin/accounts/users/anovocin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4283#issuecomment-32604",
    "user": "https://trac.sagemath.org/admin/accounts/users/anovocin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4283#issuecomment-32605",
    "user": "https://trac.sagemath.org/admin/accounts/users/anovocin"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12302"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12303"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12304"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12305"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12306"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12307"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4283#event-12308"
}
```
