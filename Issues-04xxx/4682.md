...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29138",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
archive/attachments_005193.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_4682.patch",
    "asset_url": "tarball://root/attachments/ticket4682/trac_4682.patch",
    "created_at": "2008-12-04T21:20:31Z",
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4682/trac_4682.patch",
...
```json
{
    "body": "Attachment [trac_4682.patch](https://github.com/sagemath/sage/files/ticket4682/trac_4682.patch) by mvngu created at 2008-12-04 21:20:31\n\nfirst draft of revised devmap",
    "created_at": "2008-12-04T21:20:31Z",
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29139",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Attachment [trac_4682.patch](https://github.com/sagemath/sage/files/ticket4682/trac_4682.patch) by mvngu created at 2008-12-04 21:20:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29140",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28061"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28063"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29141",
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28064"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29142",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28066"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29143",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28068"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4682#event-28069"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4682#issuecomment-29144",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
