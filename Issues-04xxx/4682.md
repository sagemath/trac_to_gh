...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37427",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37428",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37429",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37430",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Add about 36 people missing from the DevMap for Sage 3.0.6-3.2.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4682#event-17877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4682#event-17878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37432",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37433",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "rename": {
        "from": "[with patch, needs review] Add about 36 people missing from the DevMap for Sage 3.0.6-3.2.1",
        "to": "[with patch, needs review] Add the first set of 12 people missing from the DevMap for Sage 3.0.6-3.2.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4682#event-17879"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37434",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "rename": {
        "from": "[with patch, needs review] Add the first set of 12 people missing from the DevMap for Sage 3.0.6-3.2.1",
        "to": "[with patch, positive review] Add the first set of 12 people missing from the DevMap for Sage 3.0.6-3.2.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4682#event-17880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4682#issuecomment-37435",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
