...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37808",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Sorry. What is a \"hg patch\"?",
    "created_at": "2008-11-27T01:48:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37809",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```

<a id='comment:2'></a>Sorry. What is a "hg patch"?
...
```json
{
    "body": "<a id='comment:3'></a>Replying to [bpage](#comment%3A2):\n> Sorry. What is a \"hg patch\"?\n\n\nA mercurial patch. hg is the chemical symbol for mercurial, so that is why the mercurial binary is called hg. \n\nCheers,\n\nMichael",
    "created_at": "2008-11-27T01:49:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Replying to [bpage](#comment%3A2):
> Sorry. What is a "hg patch"?
...
```json
{
    "body": "<a id='comment:4'></a>Further note: The new release of FriCAS-1.0.4 which is not yet available as a Sage spkg no longer produces this \"Fortranish\" functions names.",
    "created_at": "2008-11-27T01:50:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37811",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```

<a id='comment:4'></a>Further note: The new release of FriCAS-1.0.4 which is not yet available as a Sage spkg no longer produces this "Fortranish" functions names.
...
```json
{
    "body": "<a id='comment:5'></a>> A mercurial patch. hg is the chemical symbol for mercurial, so that is why the mercurial binary is called hg. \n\n\n:~) I meant, how do I create a \"hg patch\" if not by \"hg diff\"?",
    "created_at": "2008-11-27T01:52:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37812",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```

<a id='comment:5'></a>> A mercurial patch. hg is the chemical symbol for mercurial, so that is why the mercurial binary is called hg. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37814",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Is there a specific procedure for installing (and testing) these kinds of patches? That is, how do I get Sage to know that the code has been updated? This kind of thing would be nice on a wiki page for new developers. Or have I just missed it?",
    "created_at": "2008-11-30T21:42:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37815",
    "user": "https://github.com/tjl"
}
```

<a id='comment:7'></a>Is there a specific procedure for installing (and testing) these kinds of patches? That is, how do I get Sage to know that the code has been updated? This kind of thing would be nice on a wiki page for new developers. Or have I just missed it?
...
```json
{
    "body": "<a id='comment:10'></a>This is probably on top of #4036, which itself needs to be slightly rebased.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-02T23:24:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37818",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>This is probably on top of #4036, which itself needs to be slightly rebased.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37819",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37820",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Please add a doctest that illustrates what you're fixing and mark it \"#optional - fricas\".    The doctest could also include your integration example.\n\nThanks!!",
    "created_at": "2008-12-06T22:15:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37821",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:13'></a>Please add a doctest that illustrates what you're fixing and mark it "#optional - fricas".    The doctest could also include your integration example.
...
```json
{
    "body": "<a id='comment:17'></a>According to http://trac.sagemath.org/ticket/4633#comment:4, this is no longer needed in recent versions of FriCAS. Sage is now using FriCAS 1.0.9 (#9354).\n\nSo maybe this can be closed ?",
    "created_at": "2014-07-19T12:31:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37822",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:17'></a>According to http://trac.sagemath.org/ticket/4633#comment:4, this is no longer needed in recent versions of FriCAS. Sage is now using FriCAS 1.0.9 (#9354).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37823",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37824",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37825",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37826",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4633#issuecomment-37827",
