...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49717"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4401#issuecomment-25516",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4401",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49722"
}
```
