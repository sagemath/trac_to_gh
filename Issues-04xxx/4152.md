...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24591",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_4152.patch](https://github.com/sagemath/sage/files/ticket4152/trac_4152.patch) by @mwhansen created at 2009-01-22 08:27:42",
    "created_at": "2009-01-22T08:27:42Z",
    "issue": "https://github.com/sagemath/sage/issues/4152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24592",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24593",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24594",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_4152-docs-dispatch.patch](https://github.com/sagemath/sage/files/ticket4152/trac_4152-docs-dispatch.patch) by @jasongrout created at 2009-01-22 14:20:59\n\npositive review for mhansen's patch.  My patch further adds to the documentation and makes the parametric plot function dispatch the 3d version when needed.  My patch needs to be reviewed.",
    "created_at": "2009-01-22T14:20:59Z",
    "issue": "https://github.com/sagemath/sage/issues/4152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24595",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24596",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4152#issuecomment-24597",
