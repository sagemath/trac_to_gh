...
archive/attachments_005278.json:
```json
{
...
```json
{
    "body": "**Attachment:** [installpackage.patch](https://github.com/sagemath/sage/files/ticket4587/installpackage.patch)\n\ninstall_package: If there is a unique package starting with a given string, it gets installed",
    "created_at": "2008-11-28T22:58:35Z",
    "issue": "https://github.com/sagemath/sage/issues/4587",
    "type": "issue_comment",
...
**Attachment:** [installpackage.patch](https://github.com/sagemath/sage/files/ticket4587/installpackage.patch)
...
archive/attachments_005279.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [installpackageErrorMessage.patch](https://github.com/sagemath/sage/files/ticket4587/installpackageErrorMessage.patch)\n\nTo be applied after the first patch: Improving the error message",
    "created_at": "2008-11-29T00:12:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4587",
    "type": "issue_comment",
...
**Attachment:** [installpackageErrorMessage.patch](https://github.com/sagemath/sage/files/ticket4587/installpackageErrorMessage.patch)
