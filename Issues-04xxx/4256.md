...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31695",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31696",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This adds several enhancements such as Schegel diagrams, scalar dilation of polytopes, translation by a vector, built-in regular polytopes such as the 24-cell and cross-polytopes, and generation of polar duals.  To make it easier to review this patch includes changes from #4164, so you just need one patch.",
    "created_at": "2008-10-15T23:04:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31697",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:1'></a>This adds several enhancements such as Schegel diagrams, scalar dilation of polytopes, translation by a vector, built-in regular polytopes such as the 24-cell and cross-polytopes, and generation of polar duals.  To make it easier to review this patch includes changes from #4164, so you just need one patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31698",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_4256_v3.patch](tarball://root/attachments/some-uuid/ticket4256/trac_4256_v3.patch) by mhampton created at 2008-10-21 21:50:10\n\nThe trac_4256_v3.patch also incorporates the changes in #4164.  Polyhedra can now be multiplied, scaled, translated, and the polar (dual) constructed.  Several standard polytope families have been added.",
    "created_at": "2008-10-21T21:50:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31699",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:2'></a>Attachment [trac_4256_v3.patch](tarball://root/attachments/some-uuid/ticket4256/trac_4256_v3.patch) by mhampton created at 2008-10-21 21:50:10
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31701",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_4256_v4.patch](tarball://root/attachments/some-uuid/ticket4256/trac_4256_v4.patch) by mhampton created at 2008-10-24 04:05:35",
    "created_at": "2008-10-24T04:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31702",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:4'></a>Attachment [trac_4256_v4.patch](tarball://root/attachments/some-uuid/ticket4256/trac_4256_v4.patch) by mhampton created at 2008-10-24 04:05:35
...
```json
{
    "body": "<a id='comment:5'></a>The only thing left to do is to mark the lrs_volume() tests as optional.  I forgot that in my initial review.\n\nAnyway, apart from that, positive review",
    "created_at": "2008-10-24T16:56:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31703",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```

<a id='comment:5'></a>The only thing left to do is to mark the lrs_volume() tests as optional.  I forgot that in my initial review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31704",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>OK, I made the lrs_volume tests optional.  Thanks very much for reviewing this.",
    "created_at": "2008-10-24T19:07:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31705",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:6'></a>OK, I made the lrs_volume tests optional.  Thanks very much for reviewing this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31706",
...
```json
{
    "body": "<a id='comment:7'></a>Merged 4256_v5.patch in Sage 3.2.alpha1",
    "created_at": "2008-10-26T01:35:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4256#issuecomment-31707",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged 4256_v5.patch in Sage 3.2.alpha1
