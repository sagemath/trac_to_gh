...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4364#issuecomment-33857",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4364#issuecomment-33858",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "rename": {
        "from": "major bug in singular polynomial GCD (?)",
        "to": "[with patch, needs review] major bug in singular polynomial GCD (?)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4364#event-16385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4364#issuecomment-33859",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "rename": {
        "from": "[with patch, needs review] major bug in singular polynomial GCD (?)",
        "to": "[with patch, positive review] major bug in singular polynomial GCD (?)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4364#event-16386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4364#issuecomment-33860",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4364#event-16387"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4364#event-16388"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4364#issuecomment-33861",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
