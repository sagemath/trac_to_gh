...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4364#issuecomment-26246",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4364#issuecomment-26247",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25433"
}
```
...
archive/attachments_004683.json:
```json
{
...
```json
{
    "body": "Attachment [trac_4364.patch](https://github.com/sagemath/sage/files/ticket4364/trac_4364.patch) by @malb created at 2009-01-23 01:31:48",
    "created_at": "2009-01-23T01:31:48Z",
    "issue": "https://github.com/sagemath/sage/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4364#issuecomment-26248",
    "user": "https://github.com/malb"
}
```

Attachment [trac_4364.patch](https://github.com/sagemath/sage/files/ticket4364/trac_4364.patch) by @malb created at 2009-01-23 01:31:48
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25434"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4364#issuecomment-26249",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4364",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25437"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25438"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4364#event-25439"
}
```
