...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33711",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I am not sure what to do about the Aldor interface, i.e. we discourage spkgs downloading content dynamically during build. For now I would prefer that the default for now does not attempt to build the Aldor interface and only does so if some env variable (like SAGE_FRICAS_ALDOR is equal to 'yes').\n\nCheers,\n\nMichael",
    "created_at": "2008-11-07T17:08:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33712",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>I am not sure what to do about the Aldor interface, i.e. we discourage spkgs downloading content dynamically during build. For now I would prefer that the default for now does not attempt to build the Aldor interface and only does so if some env variable (like SAGE_FRICAS_ALDOR is equal to 'yes').
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33716",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33717",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It looks like this is being taken care of at http://groups.google.com/group/fricas-devel/browse_thread/thread/3f6186988dc9683e?hl=en",
    "created_at": "2009-02-19T22:39:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33718",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:5'></a>It looks like this is being taken care of at http://groups.google.com/group/fricas-devel/browse_thread/thread/3f6186988dc9683e?hl=en
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33719",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33720",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Closing this as #6517 deals with a more recent version of FriCAS than the current ticket.",
    "created_at": "2009-08-12T16:48:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4461#issuecomment-33721",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>Closing this as #6517 deals with a more recent version of FriCAS than the current ticket.
