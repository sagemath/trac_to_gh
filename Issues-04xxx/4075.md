...
```json
{
    "body": "<a id='comment:2'></a>If tests pass, this looks good to me.",
...
<a id='comment:2'></a>If tests pass, this looks good to me.
...
```json
{
    "body": "<a id='comment:3'></a>Doctests pass in my current 3.1.2.rc1 merge tree with this patch applied. Positive review.\n\nCheers,\n\nMichael",
...
<a id='comment:3'></a>Doctests pass in my current 3.1.2.rc1 merge tree with this patch applied. Positive review.
