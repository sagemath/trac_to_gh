...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4030/callable_vectors.patch",
    "created_at": "2008-09-01T05:23:47Z",
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4030/callable_vectors.patch",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [callable_vectors.patch](https://github.com/sagemath/sage/files/ticket4030/callable_vectors.patch) by @jicama created at 2008-09-01 05:23:47\n\nThe attached patch solves all the cases above except the last, which returns\n\n```\nsage: g(y=2,x=3)\nTraceback (most recent call last):\n...\nTypeError: __call__() got an unexpected keyword argument 'y'\n```\n\nNot sure what the deal is with that.\n\nThis patch should only be applied after #2547.",
    "created_at": "2008-09-01T05:23:47Z",
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23656",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23657",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23658",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23659",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23660",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23661",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4030#issuecomment-23662",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
