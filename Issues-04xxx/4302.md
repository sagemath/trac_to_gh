# Issue 4302: [with patch, positive review] improve modular composition in GF(2)[x] and GF(2)[x]
...
```json
{
    ...
    "title": "[with patch, positive review] improve modular composition in GF(2)[x] and GF(2)[x]",
    "type": "issue",
...
Replying to [comment:26 mabshoff]:
> #4328 seems to be caused by this patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4302",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4302#event-9713"
}
```
