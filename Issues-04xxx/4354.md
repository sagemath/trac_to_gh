...
```json
{
    "body": "Changed assignee from **@sagetrac-anakha** to **@sagetrac-abergeron**",
    "created_at": "2008-12-24T04:40:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4354",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-anakha** to **@sagetrac-abergeron**
