...
archive/attachments_004946.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_4424.patch](https://github.com/sagemath/sage/files/ticket4424/trac_4424.patch)\n\nI attched each m file from the extcode repo and then added each .sig file to the repo. Pointless, but what the hell :)\n\nCheers,\n\nMichael",
    "created_at": "2008-11-02T18:05:39Z",
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26648",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26649",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26650",
    "user": "https://github.com/williamstein"
}
```
