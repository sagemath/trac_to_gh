...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43589"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26653",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26654",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-43597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26655",
    "user": "https://github.com/williamstein"
}
```
