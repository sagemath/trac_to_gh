...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4424/trac_4424.patch",
    "created_at": "2008-11-02T18:05:39Z",
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4424/trac_4424.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_4424.patch](https://github.com/sagemath/sage/files/ticket4424/trac_4424.patch) by mabshoff created at 2008-11-02 18:05:39\n\nI attched each m file from the extcode repo and then added each .sig file to the repo. Pointless, but what the hell :)\n\nCheers,\n\nMichael",
    "created_at": "2008-11-02T18:05:39Z",
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26637",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-25850"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-25851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26638",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-25852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4424#event-25853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4424#issuecomment-26639",
    "user": "https://github.com/williamstein"
}
```
