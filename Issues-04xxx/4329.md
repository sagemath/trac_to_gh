...
```json
{
    "body": "<a id='comment:2'></a>Attachment [sage-4329.patch](tarball://root/attachments/some-uuid/ticket4329/sage-4329.patch) by shumow created at 2008-11-15 02:13:05\n\nCode looks good.\nConfirmed that it worked.\nConfirmed that it passes tests.",
...
<a id='comment:2'></a>Attachment [sage-4329.patch](tarball://root/attachments/some-uuid/ticket4329/sage-4329.patch) by shumow created at 2008-11-15 02:13:05
...
```json
{
    "body": "<a id='comment:3'></a>Replying to [shumow](#comment%3A2):\n> Code looks good.\n> Confirmed that it worked.\n> Confirmed that it passes tests.\n\n\nIs that a positive review?\n\nCheers,\n\nMichael",
...
<a id='comment:3'></a>Replying to [shumow](#comment%3A2):
> Code looks good.
> Confirmed that it worked.
> Confirmed that it passes tests.
