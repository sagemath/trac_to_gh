...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35778",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Jen's original code which this work is based on was at #2568. Obviously Jen should get partial credit once the code from this ticket has been merged.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-09T06:55:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35779",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Jen's original code which this work is based on was at #2568. Obviously Jen should get partial credit once the code from this ticket has been merged.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35780",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35781",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35782",
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [sage-4475-new_hope-part3.patch](tarball://root/attachments/some-uuid/ticket4475/sage-4475-new_hope-part3.patch) by @robertwb created at 2008-12-20 05:26:49\n\n(Partial) native implementation of the G function.",
    "created_at": "2008-12-20T05:26:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35784",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>Attachment [sage-4475-new_hope-part3.patch](tarball://root/attachments/some-uuid/ticket4475/sage-4475-new_hope-part3.patch) by @robertwb created at 2008-12-20 05:26:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35785",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4475#issuecomment-35786",
    "user": "https://github.com/williamstein"
}
```
