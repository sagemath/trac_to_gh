...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4770#issuecomment-39248",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4770#issuecomment-39249",
...
```json
{
    "body": "<a id='comment:1'></a>The patch applies cleanly, the doc test example works as expected, and it provides a useful functionality.\n\nHence, positive review!",
    "created_at": "2009-01-24T16:37:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4770#issuecomment-39250",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>The patch applies cleanly, the doc test example works as expected, and it provides a useful functionality.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4770#issuecomment-39251",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4770#issuecomment-39252",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
