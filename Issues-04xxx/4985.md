...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41328",
...
```json
{
    "body": "<a id='comment:2'></a>Here's a patch, adding to the list_plot docstring.  I feel neutral, or maybe a little negative, about the suggestion to add plot_list as an alias.  Would we then need to do the same for list_plot3d?  Anyway, that can be dealt with as a separate ticket.\n\nBy the way, I wasn't sure what \"the very unhelpful error message\" is. We might consider testing whether the second argument to list_plot (which is \"plotjoined\", should be boolean) is a list or tuple, and then print a warning, because perhaps someone ran \"list_plot([list1], [list2])\" without meaning to.  Opinions?",
    "created_at": "2009-03-22T23:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41329",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Here's a patch, adding to the list_plot docstring.  I feel neutral, or maybe a little negative, about the suggestion to add plot_list as an alias.  Would we then need to do the same for list_plot3d?  Anyway, that can be dealt with as a separate ticket.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [4985.patch](tarball://root/attachments/some-uuid/ticket4985/4985.patch) by @jasongrout created at 2009-03-23 21:16:08\n\nNice!  Positive review.",
    "created_at": "2009-03-23T21:16:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41330",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>Attachment [4985.patch](tarball://root/attachments/some-uuid/ticket4985/4985.patch) by @jasongrout created at 2009-03-23 21:16:08
...
```json
{
    "body": "<a id='comment:4'></a>(applies cleanly to 3.4, doctests in plot.py pass, and the plot looks right).",
    "created_at": "2009-03-23T21:20:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41331",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>(applies cleanly to 3.4, doctests in plot.py pass, and the plot looks right).
...
```json
{
    "body": "<a id='comment:5'></a>#5594 is for the suggestion by jhpalmieri above.",
    "created_at": "2009-03-23T21:23:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41332",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>#5594 is for the suggestion by jhpalmieri above.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41333",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4985#issuecomment-41334",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
