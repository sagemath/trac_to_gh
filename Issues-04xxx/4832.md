# Issue 4832: [with positive review] prevent search_src and search_doc from printing the sage banner
...
```json
{
    ...
    "title": "[with positive review] prevent search_src and search_doc from printing the sage banner",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4832/4832.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4832#issuecomment-43287",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "rename": {
        "from": "prevent search_src and search_doc from printing the sage banner",
        "to": "[with positive review] prevent search_src and search_doc from printing the sage banner"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4832#event-14454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4832#issuecomment-43288",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4832#event-14455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4832#issuecomment-43289",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4832#event-14456"
}
```
