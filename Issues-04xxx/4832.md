...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4832#issuecomment-38846",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "rename": {
        "from": "[with patch, needs review] prevent search_src and search_doc from printing the sage banner",
        "to": "[with patch, with positive review] prevent search_src and search_doc from printing the sage banner"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4832#event-18577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4832#issuecomment-38847",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4832#event-18578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4832#issuecomment-38848",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4832#event-18579"
}
```
