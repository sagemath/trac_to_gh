...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26333",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26334",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26335",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26336",
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac-4374.patch](https://github.com/sagemath/sage/files/ticket4374/trac-4374.patch) by @craigcitro created at 2008-10-27 19:47:28\n\nThe attached patch fixes the above issues, as well as cleaning up the files `book_stein_ent.py` and `book_stein_modform.py`. I'll keep an eye out for any new numerical noise that pops up during testing ...",
    "created_at": "2008-10-27T19:47:28Z",
    "issue": "https://github.com/sagemath/sage/issues/4374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26337",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26338",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4374#issuecomment-26339",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
