...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23789",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4057/underline_trick.patch",
    "created_at": "2008-09-04T03:15:50Z",
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4057/underline_trick.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [underline_trick.patch](https://github.com/sagemath/sage/files/ticket4057/underline_trick.patch) by mabshoff created at 2008-09-04 03:15:50\n\nHi,\n\nthis is some laundry list of things and should be first discussed on sage-devel before opening clearly defined tickets. Trac is not a discussion forum :)\n\nInvalid.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-04T03:15:50Z",
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23790",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23791",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23792",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23793",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23794",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23795",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23796",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4057/underline_trick.2.patch",
    "created_at": "2008-09-15T21:16:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4057/underline_trick.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [underline_trick.2.patch](https://github.com/sagemath/sage/files/ticket4057/underline_trick.2.patch) by aginiewicz created at 2008-09-15 21:16:22\n\nI attached better fix of problem, it fixes not only the r.sth? notation but also not fixed by previous - r.help(\"sth\") - also it doesn't add check related to R in generic module so I guess previous was bad",
    "created_at": "2008-09-15T21:16:22Z",
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4057#issuecomment-23797",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4057/sage-4057-part2.patch",
    "created_at": "2008-11-27T18:32:09Z",
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4057/sage-4057-part2.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [sage-4057-part2.patch](https://github.com/sagemath/sage/files/ticket4057/sage-4057-part2.patch) by @williamstein created at 2008-11-27 18:32:09\n\nREFEREE REPORT:\n\nLooks good, but needs to *only* delete the underline in embedded mode.  I've attached a patch to do that.",
    "created_at": "2008-11-27T18:32:09Z",
    "issue": "https://github.com/sagemath/sage/issues/4057",
    "type": "issue_comment",
