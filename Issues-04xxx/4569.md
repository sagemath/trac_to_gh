...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35059",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>After this patch:\n\n```\nsage: Permutation([()])\n[1]\nsage: Permutation('()')\n[1]\n```\nwhich agree with PermutationGroupElement:\n\n```\nsage: PermutationGroupElement([()]).list()\n[1]\nsage: PermutationGroupElement('()').list()\n[1]\n```\nand:\n\n```\nsage: p = Permutation('(1,2,3)')\nsage: q = Permutation('()')\nsage: gap.Group([p,q])\nGroup( [ (1,2,3), () ] )\nsage: gap.Group([p]) == gap.Group([p, q])\nTrue\n```",
    "created_at": "2008-11-20T21:51:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35060",
    "user": "https://github.com/saliola"
}
```

<a id='comment:1'></a>After this patch:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35061",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35062",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35063",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35064",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4569#issuecomment-35065",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
