...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4210#issuecomment-25479",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4210#event-24814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4210#issuecomment-25480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4210#event-24815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4210#event-24816"
}
```
