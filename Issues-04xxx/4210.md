# Issue 4210: [with spkg, positive review] Remove some deprecation warnings from numpy-1.2.spkg
...
```json
{
    ...
    "title": "[with spkg, positive review] Remove some deprecation warnings from numpy-1.2.spkg",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4210#issuecomment-32272",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4210#issuecomment-32273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "rename": {
        "from": "[with spkg, needs review] Remove some deprecation warnings from numpy-1.2.spkg",
        "to": "[with spkg, positive review] Remove some deprecation warnings from numpy-1.2.spkg"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4210#event-15704"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4210#issuecomment-32274",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4210#issuecomment-32275",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4210",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4210#event-15705"
}
```
