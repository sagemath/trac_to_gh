...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4999#issuecomment-40471",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4999#issuecomment-40472",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Solaris 10/Sparc: numerical noise doctest failure in sage/gsl/integration.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4999#event-19370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4999",
    "rename": {
        "from": "[with patch, needs review] Solaris 10/Sparc: numerical noise doctest failure in sage/gsl/integration.pyx",
        "to": "[with patch, with positive review] Solaris 10/Sparc: numerical noise doctest failure in sage/gsl/integration.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4999#event-19371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4999#issuecomment-40473",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4999#issuecomment-40474",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4999#event-19372"
}
```
