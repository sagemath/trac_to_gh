# Issue 4999: [with patch, with positive review] Solaris 10/Sparc: numerical noise doctest failure in sage/gsl/integration.pyx
...
```json
{
    ...
    "title": "[with patch, with positive review] Solaris 10/Sparc: numerical noise doctest failure in sage/gsl/integration.pyx",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4999#event-11559"
}
```
