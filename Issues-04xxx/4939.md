...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_4939.patch](tarball://root/attachments/some-uuid/ticket4939/trac_4939.patch) by @williamstein created at 2009-01-05 02:24:05",
    "created_at": "2009-01-05T02:24:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4939#issuecomment-38393",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Attachment [trac_4939.patch](tarball://root/attachments/some-uuid/ticket4939/trac_4939.patch) by @williamstein created at 2009-01-05 02:24:05
...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -41,11 +41,12 @@\n | Sage Version 3.2.2, Release Date: 2008-12-18                       |\n | Type notebook() for the GUI, and license() for information.        |\n The documentation also says:\n-{{\n+\n+\\`\\`\\`\n However, PARI integers are much different than                                      \n SAGE integers.  If you use this option the lower                                   \n bound must be 2.         \n-}}}\n+\\`\\`\\`\n which is patently false now.\n \n An easy fix is to get rid entirely of the leave_pari=True option.  It was only ever there because it used to be really fast.  But now it is 50% better. \n@@ -61,7 +62,9 @@\n Wall time: 0.97 s\n \\`\\`\\`\n \n-The easiest solution is to simply delete all this \"leave_pari\" stuff.  It's totally useless, bad from an api point of view, and gains only a little speed.  Writing code against this api that uses the option would be particularly stupid, since in the feature we could easily have a native prime_range that is way faster than pari's, hence code that tries to be clever would be slower.\n+The easiest solution is to simply delete all this \"leave_pari\" stuff.  It's totally useless, bad from an api point of view, and gains only a little speed.  Writing code against this api that uses the option would be particularly stupid, since in the feature we could easily have a native prime_range that is way faster than pari's, hence code that tries to be clever would be slower. \n+\n+\n \n Summary: massive performance regression to primes_first_n\n \n```\n",
    "created_at": "2009-01-05T02:24:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4939#issuecomment-38394",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Yep, looks good.",
    "created_at": "2009-01-05T04:57:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4939#issuecomment-38395",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:3'></a>Yep, looks good.
...
```json
{
    "body": "<a id='comment:5'></a>I have opened #4941 to address the massive performance issue with pari list slicing.",
    "created_at": "2009-01-05T17:10:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4939#issuecomment-38397",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>I have opened #4941 to address the massive performance issue with pari list slicing.
...
```json
{
    "body": "<a id='comment:6'></a>Merged in Sage 3.2.3.post-final\n\nCheers,\n\nMichael",
    "created_at": "2009-01-06T01:53:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4939#issuecomment-38398",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Merged in Sage 3.2.3.post-final
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4939#issuecomment-38399",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
