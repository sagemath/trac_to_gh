...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46252"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46256"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46257"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46258"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46259"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4878",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4878#event-46262"
}
```
...
```json
{
    "body": "**Attachment:** [4878_example.png.gz](https://github.com/sagemath/sage/files/ticket4878/4878_example.png.gz)\n\nexample image for mvngu",
...
**Attachment:** [4878_example.png.gz](https://github.com/sagemath/sage/files/ticket4878/4878_example.png.gz)
...
```json
{
    "body": "**Attachment:** [trac_4878-sample-plot-bw.png.gz](https://github.com/sagemath/sage/files/ticket4878/trac_4878-sample-plot-bw.png.gz)\n\nanother sample plot in black and white",
...
**Attachment:** [trac_4878-sample-plot-bw.png.gz](https://github.com/sagemath/sage/files/ticket4878/trac_4878-sample-plot-bw.png.gz)
