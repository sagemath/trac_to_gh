...
```json
{
    "body": "<a id='comment:1'></a>Here's a patch.  (Does anyone use \"%slide\"?  The output is pretty ugly, seems to me.)",
    "created_at": "2009-03-22T22:41:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35290",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>Here's a patch.  (Does anyone use "%slide"?  The output is pretty ugly, seems to me.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35291",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35292",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>> Here's a patch. (Does anyone use \"%slide\"? The output is pretty ugly, seems to me.) \n\n\nI have -- it allows one to use anything in latex beamer (in theory), which is pretty (in theory).  I haven't used %slide in a long time though, since I just use TinyMCE now.",
    "created_at": "2009-03-29T16:38:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35293",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>> Here's a patch. (Does anyone use "%slide"? The output is pretty ugly, seems to me.) 
...
```json
{
    "body": "<a id='comment:3'></a>Incidentally %slide takes a LONG time to tex any given slide on OS X... This has nothing to do with this patch (just an observation).",
    "created_at": "2009-03-29T16:50:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35294",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Incidentally %slide takes a LONG time to tex any given slide on OS X... This has nothing to do with this patch (just an observation).
...
```json
{
    "body": "<a id='comment:5'></a>Wait, so these things actually have to pass doctests?  :)\n\nHere's a new patch; the only change is to fix the doctests Michael pointed out.",
    "created_at": "2009-03-31T15:49:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35296",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Wait, so these things actually have to pass doctests?  :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35298",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35299",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Does this actually need review?  The only changes since its positive review are fixes to make doctests pass; should the positive review still stand?",
    "created_at": "2009-04-24T20:54:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35300",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>Does this actually need review?  The only changes since its positive review are fixes to make doctests pass; should the positive review still stand?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35301",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Version rebased against 3.4.2.alpha0 passes all tests on sage.math.",
    "created_at": "2009-04-24T21:15:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35302",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>Version rebased against 3.4.2.alpha0 passes all tests on sage.math.
...
```json
{
    "body": "<a id='comment:11'></a>Merged in Sage 3.4.2.rc0.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-30T03:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35303",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged in Sage 3.4.2.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4435",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4435#issuecomment-35304",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
