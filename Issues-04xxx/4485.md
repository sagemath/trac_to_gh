...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4485#issuecomment-35007",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4485#issuecomment-35008",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "rename": {
        "from": "notebook -- implicit multiplication is broken in the notebook but works on the command line (sage-3.1.4)",
        "to": "[with patch; needs review] notebook -- implicit multiplication is broken in the notebook but works on the command line (sage-3.1.4)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4485#event-16883"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4485#event-16884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4485#issuecomment-35009",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4485#issuecomment-35010",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "rename": {
        "from": "[with patch; needs review] notebook -- implicit multiplication is broken in the notebook but works on the command line (sage-3.1.4)",
        "to": "[with patch; positive review] notebook -- implicit multiplication is broken in the notebook but works on the command line (sage-3.1.4)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4485#event-16885"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4485#event-16886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4485#issuecomment-35011",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4485#issuecomment-35012",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
