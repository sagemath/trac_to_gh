...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4933#issuecomment-39714",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4933#issuecomment-39715",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4933#issuecomment-39716",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19050"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4933",
    "rename": {
        "from": "[with patch, needs review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual",
        "to": "[with patches, not ready for review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19051"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4933",
    "rename": {
        "from": "[with patches, not ready for review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual",
        "to": "[with patch, needs review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19052"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual",
        "to": "[with patch, positive review] lots of files in sage.schemes.elliptic_curves are not included in the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19053"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4933",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19054"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19055"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4933#event-19056"
}
```
