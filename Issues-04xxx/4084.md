...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31076",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "rename": {
        "from": "plot(1/cos,-1,1) fails",
        "to": "[with patch, needs work] plot(1/cos,-1,1) fails"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4084#event-15235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "rename": {
        "from": "[with patch, needs work] plot(1/cos,-1,1) fails",
        "to": "[with patch, needs review] plot(1/cos,-1,1) fails"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4084#event-15236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31077",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31078",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31079",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31080",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "rename": {
        "from": "[with patch, needs review] plot(1/cos,-1,1) fails",
        "to": "[with patch, positive review] plot(1/cos,-1,1) fails"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4084#event-15237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31081",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4084#event-15238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4084#issuecomment-31082",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
