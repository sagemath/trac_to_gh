...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4136#issuecomment-24485",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4136#issuecomment-24486",
...
```json
{
    "body": "Attachment [tail_reduce.patch](https://github.com/sagemath/sage/files/ticket4136/tail_reduce.patch) by @malb created at 2008-10-20 13:20:34",
    "created_at": "2008-10-20T13:20:34Z",
    "issue": "https://github.com/sagemath/sage/issues/4136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4136#issuecomment-24487",
    "user": "https://github.com/malb"
}
```

Attachment [tail_reduce.patch](https://github.com/sagemath/sage/files/ticket4136/tail_reduce.patch) by @malb created at 2008-10-20 13:20:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4136#issuecomment-24488",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4136#issuecomment-24489",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
