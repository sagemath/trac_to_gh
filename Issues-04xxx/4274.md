...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25481",
...
archive/attachments_004545.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_4274.patch",
    "asset_url": "tarball://root/attachments/ticket4274/trac_4274.patch",
    "created_at": "2009-01-22T14:19:02Z",
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4274/trac_4274.patch",
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_4274.patch](https://github.com/sagemath/sage/files/ticket4274/trac_4274.patch) by @williamstein created at 2009-01-22 14:19:02",
    "created_at": "2009-01-22T14:19:02Z",
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25482",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "rename": {
        "from": "assertion failure in rank for elliptic curves",
        "to": "[with positive review but one oddity] assertion failure in rank for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25483",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25484",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25485",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25486",
...
archive/attachments_004546.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_4274-doctest.patch",
    "asset_url": "tarball://root/attachments/ticket4274/trac_4274-doctest.patch",
    "created_at": "2009-02-15T15:11:21Z",
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4274/trac_4274-doctest.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [trac_4274-doctest.patch](https://github.com/sagemath/sage/files/ticket4274/trac_4274-doctest.patch) by @JohnCremona created at 2009-02-15 15:11:21\n\nApply after previous",
    "created_at": "2009-02-15T15:11:21Z",
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25487",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [trac_4274-doctest.patch](https://github.com/sagemath/sage/files/ticket4274/trac_4274-doctest.patch) by @JohnCremona created at 2009-02-15 15:11:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "rename": {
        "from": "[with positive review but one oddity] assertion failure in rank for elliptic curves",
        "to": "[with extra patch; needs review (quick)] assertion failure in rank for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25488",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24713"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25489",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "rename": {
        "from": "[with extra patch; needs review (quick)] assertion failure in rank for elliptic curves",
        "to": "[with extra patch] assertion failure in rank for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24715"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24716"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25490",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "rename": {
        "from": "[with extra patch] assertion failure in rank for elliptic curves",
        "to": "assertion failure in rank for elliptic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24720"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4274#event-24721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4274#issuecomment-25491",
    "user": "https://github.com/JohnCremona"
}
```
