...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42096",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42097",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42098",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42099",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42100",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42101",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42102",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42103",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nNice catch. I've written a fix for `_from_`im and have mostly done writing up code that given a \"short\" list for im_gens attempts to find a base_hom that works. I'll upload it when I get that done.",
    "created_at": "2013-04-17T18:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42104",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4726/trac_4726_enhance_relative_number_morphism_constructor.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42105",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42106",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>\nAlright, I've updated the patch. I added a check in `_from_`im for whether the morphism agrees with base_hom. And I added a new method `_from_im_without_base_`hom which is like `_from_`im, but attempts to find a base_hom compatible with the im_gen passed.",
    "created_at": "2013-04-18T18:58:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42107",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42108",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42109",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42110",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket4726/trac_4726_reviewer.patch",
...
```json
{
    "body": "To be applied on top of trac_4726_enhance_relative_number_morphism_constructor.patch",
    "created_at": "2013-04-23T18:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4726#issuecomment-42111",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14072"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14073"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14074"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14075"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14076"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14077"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4726#event-14078"
}
```
