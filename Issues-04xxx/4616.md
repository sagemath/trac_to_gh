...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28554",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28555",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28556",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28557",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4616/trac-4616.patch",
    "created_at": "2009-01-22T17:27:50Z",
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4616/trac-4616.patch",
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac-4616.patch](https://github.com/sagemath/sage/files/ticket4616/trac-4616.patch) by @rlmill created at 2009-01-22 17:27:50\n\nVerified that this is now fixed, attached a patch with a doctest.",
    "created_at": "2009-01-22T17:27:50Z",
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28558",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28559",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4616#issuecomment-28560",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
