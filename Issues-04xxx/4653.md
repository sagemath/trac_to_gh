...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35871",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35872",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35873",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35874",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>> Good move saliola! I was going to ask what were the objectives before getting the code into sage. I had one :\n> - Get back to the 100% documentation and coverage we had in sage-word google code. In fact, some functions had been added without doc and/or tests while merging the code in sage-combinat.\n\n\nDone. I added the missing doctests this evening. It is now at 100% again.\n\n>  - Any other?\n\n\nI think there are a few things that should be done at some point, but they are not \"blockers\". They are mostly issues to polish some of the rough edges.",
    "created_at": "2008-11-30T00:05:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35875",
    "user": "https://github.com/saliola"
}
```

<a id='comment:3'></a>> Good move saliola! I was going to ask what were the objectives before getting the code into sage. I had one :
> - Get back to the 100% documentation and coverage we had in sage-word google code. In fact, some functions had been added without doc and/or tests while merging the code in sage-combinat.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35879",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This discussion should probably be moved over to sage-devel and sage-combinat-devel.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-30T12:12:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35880",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>This discussion should probably be moved over to sage-devel and sage-combinat-devel.
...
```json
{
    "body": "<a id='comment:9'></a>>  I will change it, but I need a better name. Perhaps WordExamples or WordConstructor? That has the benefit of showing up in tab-completion.\n\n\nInstead of the actual 'words', a suggestion could be 'lexicon' or 'wordbook' (I prefer the latter but I'm still not convinced).\n\nslabbe",
    "created_at": "2008-12-09T22:34:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35881",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:9'></a>>  I will change it, but I need a better name. Perhaps WordExamples or WordConstructor? That has the benefit of showing up in tab-completion.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35882",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Another blocker :)\n\nCheers,\n\nMichael",
    "created_at": "2008-12-15T18:53:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35883",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Another blocker :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35884",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I am taking care of the second one (related to word_generators.py) right now!\n\nIt will be in the sage-combinat tree in the next minutes...\n\nslabbe",
    "created_at": "2008-12-15T20:37:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35887",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:14'></a>I am taking care of the second one (related to word_generators.py) right now!
...
```json
{
    "body": "<a id='comment:15'></a>I put my changes into sage_words-4653-final.patch . Should I have done a new patch for the modification I did?\n\nslabbe",
    "created_at": "2008-12-15T21:05:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35888",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:15'></a>I put my changes into sage_words-4653-final.patch . Should I have done a new patch for the modification I did?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35889",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I've looked over almost all of the code and am happy with it.  I think it should go in.  If any issues come up, we can take care of them later.\n\nAssuming that this applies and passes tests, I give it a positive review.",
    "created_at": "2008-12-17T11:03:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35892",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:18'></a>I've looked over almost all of the code and am happy with it.  I think it should go in.  If any issues come up, we can take care of them later.
...
```json
{
    "body": "<a id='comment:20'></a>Attachment [words-import-fix.patch](tarball://root/attachments/some-uuid/ticket4653/words-import-fix.patch) by mabshoff created at 2008-12-17 16:56:56\n\nPositive review on words-import-fix.patch",
    "created_at": "2008-12-17T16:56:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35894",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:20'></a>Attachment [words-import-fix.patch](tarball://root/attachments/some-uuid/ticket4653/words-import-fix.patch) by mabshoff created at 2008-12-17 16:56:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35895",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Merged in Sage 3.2.2.rc1 - the pickling issue will be dealt with at #4640",
    "created_at": "2008-12-17T16:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4653#issuecomment-35896",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:21'></a>Merged in Sage 3.2.2.rc1 - the pickling issue will be dealt with at #4640
