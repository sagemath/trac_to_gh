...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28165",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28166",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28167",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28168",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28169",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [save_session.patch](https://github.com/sagemath/sage/files/ticket4568/save_session.patch) by @simon-king-jena created at 2008-11-22 11:15:41\n\nReplying to [mhansen](#comment%3A3):\n> My concern with the current wording is that it's not entirely clear that the user should NOT save the session to a file in SAGE_TMP.  We only do that for doctesting purposes.\n\n\nHi Mike, \n\nGood point! I changed my patch accordingly - in the new patch I clearly say that for permanent saving SAGE_TMP would be a bad idea.\n\nCheers\n    Simon",
    "created_at": "2008-11-22T11:15:41Z",
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28170",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4568#issuecomment-28171",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
