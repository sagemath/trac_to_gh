...
```json
{
    "body": "Attachment [4686-code.patch](https://github.com/sagemath/sage/files/ticket4686/4686-code.patch) by @loefflerd created at 2008-12-03 10:22:15",
    "created_at": "2008-12-03T10:22:15Z",
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29162",
    "user": "https://github.com/loefflerd"
}
```

Attachment [4686-code.patch](https://github.com/sagemath/sage/files/ticket4686/4686-code.patch) by @loefflerd created at 2008-12-03 10:22:15
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [4686-doc.patch](https://github.com/sagemath/sage/files/ticket4686/4686-doc.patch) by @loefflerd created at 2008-12-03 10:23:12\n\nHere are two patches (one each for the hg_sage and hg_doc repositories).",
    "created_at": "2008-12-03T10:23:12Z",
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29163",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29164",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29165",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29166",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29167",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4686",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4686#issuecomment-29168",
    "user": "https://github.com/loefflerd"
}
```
