...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55905",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55906",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55907",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I'm not sure what \"intelligently\" means, but here is a patch which sets it to be the number of processors, as detected by `multiprocessing.cpu_count()`.  This also changes the command `sage -tp N <files>`: if N is 0, then replace it with the number of processors.\n\nThis depends on the patch at #2624.",
    "created_at": "2009-09-21T23:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55908",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>I'm not sure what "intelligently" means, but here is a patch which sets it to be the number of processors, as detected by `multiprocessing.cpu_count()`.  This also changes the command `sage -tp N <files>`: if N is 0, then replace it with the number of processors.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55909",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55910",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55911",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55913",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55914",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>After the [discussion on sage-devel](http://groups.google.com/group/sage-devel/t/7b767521e472e10a), I think we should merge this. The only concrete example of a machine where this doesn't work is t2.math, and anyone can fix it by editing the makefile -- which is what everyone has been doing all along anyway!\n\nRelease manager: merge attachment:trac_6283-numthreads.patch and also patch the makefile in $SAGE_ROOT with attachment:makefile.patch.",
    "created_at": "2009-09-25T00:11:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55915",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:5'></a>After the [discussion on sage-devel](http://groups.google.com/group/sage-devel/t/7b767521e472e10a), I think we should merge this. The only concrete example of a machine where this doesn't work is t2.math, and anyone can fix it by editing the makefile -- which is what everyone has been doing all along anyway!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55916",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55917",
...
```json
{
    "body": "<a id='comment:7'></a>Your warnings are a good idea. Perhaps we can make it part of release manager boot camp to teach release managers to do doctests with `./sage -tp <sensible positive int> devel/sage` or `make ptest NUM_THREADS=<s.p.i>` instead of just doing `make ptest`. (Similar comments for ptestlong.)",
    "created_at": "2009-09-25T05:33:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55919",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:7'></a>Your warnings are a good idea. Perhaps we can make it part of release manager boot camp to teach release managers to do doctests with `./sage -tp <sensible positive int> devel/sage` or `make ptest NUM_THREADS=<s.p.i>` instead of just doing `make ptest`. (Similar comments for ptestlong.)
...
```json
{
    "body": "<a id='comment:8'></a>Merged these patches in the script repository:\n\n1. `trac_6283-numthreads.patch`\n2. `trac_6283-warning.patch`\n\nManually patched the file `SAGE_ROOT/makefile` using `makefile.patch`, together with the above warning message.",
    "created_at": "2009-09-25T06:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55920",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:8'></a>Merged these patches in the script repository:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55921",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55922",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55923",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55925",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55926",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55927",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6283#issuecomment-55928",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
