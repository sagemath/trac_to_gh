...
archive/attachments_007664.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_6283-numthreads.patch](https://github.com/sagemath/sage/files/ticket6283/trac_6283-numthreads.patch)\n\napply to scripts repository.  depends on #2624.",
    "created_at": "2009-09-21T23:08:42Z",
    "issue": "https://github.com/sagemath/sage/issues/6283",
    "type": "issue_comment",
...
**Attachment:** [trac_6283-numthreads.patch](https://github.com/sagemath/sage/files/ticket6283/trac_6283-numthreads.patch)
...
archive/attachments_007665.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "makefile.patch",
    "asset_url": "tarball://root/attachments/ticket6283/makefile.patch",
    "created_at": "2009-09-21T23:12:51Z",
    "issue": "https://github.com/sagemath/sage/issues/6283",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6283/makefile.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Attachment:** [makefile.patch](https://github.com/sagemath/sage/files/ticket6283/makefile.patch)\n\n**Attachment:** [makefile](https://github.com/sagemath/sage/files/ticket6283/makefile)\n\nthe file SAGE_ROOT/makefile",
    "created_at": "2009-09-21T23:12:51Z",
    "issue": "https://github.com/sagemath/sage/issues/6283",
    "type": "issue_comment",
...
**Attachment:** [makefile.patch](https://github.com/sagemath/sage/files/ticket6283/makefile.patch)
...
```json
{
    "body": "**Attachment:** [trac_6283-warning.patch](https://github.com/sagemath/sage/files/ticket6283/trac_6283-warning.patch)\n\nadds warning about setting the number of threads to 0",
    "created_at": "2009-09-25T04:55:48Z",
    "issue": "https://github.com/sagemath/sage/issues/6283",
    "type": "issue_comment",
...
**Attachment:** [trac_6283-warning.patch](https://github.com/sagemath/sage/files/ticket6283/trac_6283-warning.patch)
