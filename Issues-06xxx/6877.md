...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50410",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "Attachment [trac_6877_Boolean_function_bugfix.patch](https://github.com/sagemath/sage/files/ticket6877/trac_6877_Boolean_function_bugfix.patch) by ylchapuy created at 2009-09-03 12:24:31",
    "created_at": "2009-09-03T12:24:31Z",
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50411",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

Attachment [trac_6877_Boolean_function_bugfix.patch](https://github.com/sagemath/sage/files/ticket6877/trac_6877_Boolean_function_bugfix.patch) by ylchapuy created at 2009-09-03 12:24:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50412",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50414",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50415",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-50416",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
