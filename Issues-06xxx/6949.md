...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76375"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76376"
}
```
...
```json
{
    "body": "<a id='comment:2'>Comment 2:</a>\n[attachment: trac_6949-symbolic_min_max.patch.gz](https://github.com/sagemath/sage/files/ticket6949/trac_6949-symbolic_min_max.patch.gz) provides basic implementations of `max_symbolic()` and `min_symbolic()` functions that work as expected when the input contains symbolic expressions.\n\nThe symbolic versions are significantly slower than Python's builtin `min()` and `max()`, so replacing the builtin functions with these is not possible at this point.",
    "created_at": "2010-04-02T21:33:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'>Comment 3:</a>\nI updated [attachment: trac_6949-symbolic_min_max.patch.gz](https://github.com/sagemath/sage/files/ticket6949/trac_6949-symbolic_min_max.patch.gz) to fix a minor doctest error in sage/symbolic/ring.pyx.",
    "created_at": "2010-04-06T15:26:01Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76378"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76380"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6949#issuecomment-51197",
    "user": "https://github.com/sagetrac-lfousse"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76381"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76382"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6949#issuecomment-51198",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6949#issuecomment-51199",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6949#event-76384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6949#issuecomment-51200",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6949#issuecomment-51201",
