...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6104#issuecomment-52830",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6104",
    "rename": {
        "from": "[with spkg, needs review] Fix Solaris specific build issue for libfplll.spkg",
        "to": "[with spkg, positive review] Fix Solaris specific build issue for libfplll.spkg"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6104#event-24511"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6104#issuecomment-52831",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6104#event-24512"
}
```
