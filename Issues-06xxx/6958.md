...
<a id='comment:2'></a>Given the nature of this function, i.e., it should never raise an exception with the default inputs, I think it should run successfully for all curves of conductor up to 100 (say) before getting into Sage.  It fails already on 11a2.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac-6958-referee_followup.patch](tarball://root/attachments/some-uuid/ticket6958/trac-6958-referee_followup.patch) by @rlmill created at 2009-09-19 22:38:57\n\nFor the second patch, proof=False and proof=True are reversed for the doctest on 389a.",
...
<a id='comment:3'></a>Attachment [trac-6958-referee_followup.patch](tarball://root/attachments/some-uuid/ticket6958/trac-6958-referee_followup.patch) by @rlmill created at 2009-09-19 22:38:57
...
```json
{
    "body": "<a id='comment:4'></a>OK, William agrees to my fixes and I to his. Positive review!",
...
<a id='comment:4'></a>OK, William agrees to my fixes and I to his. Positive review!
...
<a id='comment:5'></a>The patch `trac_6958-typos_followup.patch` results in a hunk failure:
...
```json
{
    "body": "<a id='comment:6'></a>I've attached a new version of `trac_6958-typos_followup.patch` which removes the failing hunk since the doctest that it changed had been removed.",
    "created_at": "2009-10-05T07:04:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6958",
    "type": "issue_comment",
...
<a id='comment:6'></a>I've attached a new version of `trac_6958-typos_followup.patch` which removes the failing hunk since the doctest that it changed had been removed.
