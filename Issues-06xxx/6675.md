...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80966"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80969"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6675#issuecomment-46796",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6675#issuecomment-46797",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6675",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80971"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6675#issuecomment-46798",
    "user": "https://github.com/sagetrac-mvngu"
}
```
