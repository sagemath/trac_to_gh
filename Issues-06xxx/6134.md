...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] Fix SR coercion issue with numpy.float128",
        "to": "[with patch, positive review] Fix SR coercion issue with numpy.float128"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6134#event-24648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6134#issuecomment-53129",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6134#issuecomment-53130",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6134#issuecomment-53131",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6134",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6134#event-24649"
}
```
