...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68476"
}
```
...
```json
{
    "body": "<a id='comment:1'>Comment 1:</a>\nAttachment: **[trac_6465-chain_rule.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-chain_rule.patch.gz)**\n\n[attachment: trac_6465-chain_rule.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-chain_rule.patch.gz) adds support for disabling chain rule for symbolic functions. It depends on the new pynac package here:\n\nhttp://sage.math.washington.edu/home/burcin/pynac/pynac-0.1.8.p2.spkg",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68480"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68483"
}
```
...
```json
{
    "body": "<a id='comment:10'>Comment 10:</a>\nNew pynac package available here:\n\nhttp://sage.math.washington.edu/home/burcin/pynac/pynac-0.1.11.spkg\n\nThe patches here depend on #7822, #7876, #7363, #7955, #7957 and #7916 (in this order).\n\nThe patches should be applied in this order:\n\n* [attachment: trac_6465-chain_rule.take2.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-chain_rule.take2.patch.gz) Download\n* [attachment: trac_6465-moves-integration-into-sfunction-subclass.take2.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-moves-integration-into-sfunction-subclass.take2.patch.gz) Download\n* [attachment: trac_6465-integral.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-integral.patch.gz)",
    "created_at": "2010-01-19T14:15:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68485"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68486"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68487"
}
```
...
```json
{
    "body": "<a id='comment:16'>Comment 16:</a>\n[attachment: trac_6465-integral.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-integral.patch.gz) renames the file `sage/symbolic/integration/integration.py` to `sage/symbolic/integration/integral.py`. Are you sure you applied the patches correctly? Since these are git style diffs using `hg import` or `hg qimport` is recommended.\n\nI applied the whole batch of symbolics patches associated to pynac-0.11 to 4.3.2.alpha0, and tested the sage/{symbolic,calculus,functions} directories. The only doctest failure I got was in  `sage/symbolic/integration/external.py`. [attachment: trac_6465-integral.take2.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-integral.take2.patch.gz) removes this dubious test.\n\nThe patches that need to be applied from this ticket are now:\n* [attachment: trac_6465-chain_rule.take2.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-chain_rule.take2.patch.gz)\n* [attachment: trac_6465-moves-integration-into-sfunction-subclass.take2.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-moves-integration-into-sfunction-subclass.take2.patch.gz)\n* [attachment: trac_6465-integral.take2.patch.gz](https://github.com/sagemath/sage/files/ticket6465/trac_6465-integral.take2.patch.gz)",
    "created_at": "2010-01-31T21:23:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'>Comment 18:</a>\nOops, the last patch to be applied is [attachment: trac_6465-integral.take3.patch!.gz](https://github.com/sagemath/sage/files/ticket6465/17e0c8479c66d210c37d8b38693bea7e.gz) That was a typo in the list above.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45482",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45483",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45484",
    "user": "https://github.com/sagetrac-rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45485",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68489"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45486",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45487",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6465#event-68491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6465#issuecomment-45488",
    "user": "https://github.com/sagetrac-mvngu"
}
```
