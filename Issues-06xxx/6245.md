...
```json
{
    "body": "<a id='comment:2'></a>The patch is an initial go at this.  The documentation for the function needs to change (it still is just the same docs as the code I followed in plot/misc.py).\n\nHere are some examples:\n\n```\nsage: from sage.misc.misc import infix_operator\nsage: # A post-fix operator\nsage: @infix_operator('or')\nsage: def pipe(a,b):\n...       return b(a)\n...\nsage: print (x |pipe| cos)\nsage: print pi |pipe| n\nsage: print pi |pipe| n |pipe| cos\ncos(x)\n3.14159265358979\n-1.00000000000000\nsage: # an infix dot product\nsage: @infix_operator('multiply')\nsage: def dot(a,b):\n...       return a.dot_product(b)\n...       \n...\nsage: vector([1,2]) *dot* vector([2,4])\n10\nsage: # an infix sum\nsage: @infix_operator('add')\nsage: def esum(a,b):\n...       return [i+j for i,j in zip(a,b)]\n...\nsage: [1,2,4] +esum+ [3,-1,2]\n[4, 1, 6]\n```",
    "created_at": "2009-09-16T06:01:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55507",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>The patch is an initial go at this.  The documentation for the function needs to change (it still is just the same docs as the code I followed in plot/misc.py).
...
```json
{
    "body": "<a id='comment:3'></a>CCing mhansen, since he probably has very enlightening things to say about how I dealt with the decorators :).",
    "created_at": "2009-09-16T06:02:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55508",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>CCing mhansen, since he probably has very enlightening things to say about how I dealt with the decorators :).
...
```json
{
    "body": "Changing author from \"\" to \"Jason Grout, Carl Witty, Florent Hivert\"",
    "created_at": "2009-09-16T06:03:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55509",
    "user": "https://github.com/jasongrout"
}
```

Changing author from "" to "Jason Grout, Carl Witty, Florent Hivert"
...
```json
{
    "body": "<a id='comment:5'></a>I cleaned up the code a bit and made much better documentation.",
    "created_at": "2009-09-17T05:53:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55510",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>I cleaned up the code a bit and made much better documentation.
...
```json
{
    "body": "<a id='comment:7'></a>I have no comment on the technical side, but wonder - are you limiting \"object\" to be or, add, or multiply?  What if someone wanted to create an infix for, say, factorial - would they have to change this code?",
    "created_at": "2009-09-17T13:46:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55511",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>I have no comment on the technical side, but wonder - are you limiting "object" to be or, add, or multiply?  What if someone wanted to create an infix for, say, factorial - would they have to change this code?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55512",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55513",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55515",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Attachment [trac-6245-infix-decorator.patch](tarball://root/attachments/some-uuid/ticket6245/trac-6245-infix-decorator.patch) by @jasongrout created at 2010-04-15 03:50:57\n\nI rebased the patch to Sage 4.3.4.  Can you look at it again?",
    "created_at": "2010-04-15T03:50:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55516",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:10'></a>Attachment [trac-6245-infix-decorator.patch](tarball://root/attachments/some-uuid/ticket6245/trac-6245-infix-decorator.patch) by @jasongrout created at 2010-04-15 03:50:57
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [jason](#comment%3A10):\n> I rebased the patch to Sage 4.3.4.  Can you look at it again?\n\n\nWill aim to look at this later today",
    "created_at": "2010-04-15T23:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55517",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```

<a id='comment:12'></a>Replying to [jason](#comment%3A10):
> I rebased the patch to Sage 4.3.4.  Can you look at it again?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55521",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Thanks Jason - I appreciate what your code is doing a bit more now and see where I erred - thanks for the explanation. I would think these are enough tests to update this to a positive review. \n \n```\nclass Fraction:\n  def __init__(self, numerator, denominator=1):\n    self.numerator = numerator\n    self.denominator = denominator\n  def __str__(self):\n    return \"Fraction(%d,%d)\" % (self.numerator, self.denominator)\n  __repr__=__str__\n  def zmul(self, other):\n    return Fraction(self.numerator*other.numerator,\n                  self.denominator*other.denominator)\n  def __mul__(self, other):\n    try:\n        return Fraction(self.numerator*other.numerator,\n                  self.denominator*other.denominator)\n    except:\n        return NotImplemented\n  def __rmul__(self, other):\n    try:\n      return Fraction(other*self.numerator,self.denominator)\n    except:\n        return NotImplemented\n    \ndef dot(a,b): \n    return a*b\ndot = infix_operator('multiply')(dot)\n\nu = Fraction(2,3)\nv = Fraction(5,4)\nprint u *dot* v\nprint 3 *dot* v\n```",
    "created_at": "2010-04-20T13:44:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55522",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```

<a id='comment:16'></a>Thanks Jason - I appreciate what your code is doing a bit more now and see where I erred - thanks for the explanation. I would think these are enough tests to update this to a positive review. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55523",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55524",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55525",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Merged into 4.4.alpha2.",
    "created_at": "2010-04-23T17:11:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6245",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6245#issuecomment-55526",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:17'></a>Merged into 4.4.alpha2.
