...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [trac-6743.patch](https://github.com/sagemath/sage/files/ticket6743/trac-6743.patch)",
    "created_at": "2009-08-19T23:31:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [trac_6743-SCRIPTS-part1.patch](https://github.com/sagemath/sage/files/ticket6743/trac_6743-SCRIPTS-part1.patch)",
    "created_at": "2009-09-26T01:23:36Z",
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_6743-rebase-sage-4.3.3.patch](https://github.com/sagemath/sage/files/ticket6743/trac_6743-rebase-sage-4.3.3.patch)\n\nthese are my notes when I tried to build sage-4.3.3.alpha0 from source on cygwin",
    "created_at": "2010-02-16T02:59:47Z",
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
...
**Attachment:** [trac_6743-rebase-sage-4.3.3.patch](https://github.com/sagemath/sage/files/ticket6743/trac_6743-rebase-sage-4.3.3.patch)
...
```json
{
    "body": "<a id='comment:24'></a>\nAnyone interested in this should check out [the wiki page](../wikis/CygwinPort) for the latest.",
...
```json
{
    "body": "<a id='comment:25'></a>\nMy proposal is that once Cygwin actually is able to be built out of the box (not necessarily running) that this ticket is then closed by updating prereq to include the various prereqs.  Again, see [the Cygwin wiki page on Sage Trac](../wikis/CygwinPort) for details of what is currently needed.",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,7 +10,7 @@\n \n ## Current instructions (work on Windows XP with Cygwin 1.7.3 and Windows 7 with Cygwin 1.7.9)\n \n-* As below with 4.7.2.alpha2\n+* As below with 4.7.2.alpha3\n \n ### Cygwin prereqs\n * Be sure to install `file`, `liblapack`, `liblapack0`, `liblapack-devel`.\n@@ -24,11 +24,8 @@\n \n ### Spkgs\n * [ecl-11.1.1.p3.spkg](http://sage.math.washington.edu/home/kcrisman/ecl-11.1.1.p3.spkg), #11119\n-* [tachyon-0.98.8.p4.spkg](http://sage.math.washington.edu/home/kcrisman/tachyon-0.98.9.p4.spkg), #11504\n * [twisted-9.0.p3.spkg](http://sage.math.washington.edu/home/kcrisman/twisted-9.0.p3.spkg), #11497\n-* [flint-1.5.0.p9.spkg](http://sage.math.washington.edu/home/kcrisman/flint-1.5.0.p9.spkg), #11727\n * [cddlib-094f.p9.spkg](http://sage.math.washington.edu/home/kcrisman/cddlib-094f.p9.spkg), #11245\n-* When building the Sage library, you will also need to apply the following [patch at Trac 11744](https://github.com/sagemath/sage/files/ticket11499/trac_11744.patch), #11744\n \n \n This should then work 'out of the box', modulo rebasing issues (see [CygwinPort](../wikis/CygwinPort)) and the continuing saga of building Maxima effectively (see #11502, #11260, but also some recent probable changes in ECL).\n@@ -36,8 +33,7 @@\n Apparently the change in the following is no longer necessary, since 4.7.1.alpha3 - but see #11635 where this is being tracked now.\n * [ntl-5.4.2.p13.spkg](http://sage.math.washington.edu/home/kcrisman/ntl-5.4.2.p13.spkg)\n \n-In previous alphas or releases, see [the wiki](../wikis/CygwinPort) for more details.  For instance, when building the Sage library, you would have needed to apply\n-* [the patch at Trac 11499](https://github.com/sagemath/sage/files/ticket11499/trac_11499.patch), #11499\n+See [the wiki](../wikis/CygwinPort) for other details.\n \n ---\n \n``````\n",
...
```json
{
    "body": "<a id='comment:59'></a>\nIf you can also update [CygwinPort](../wikis/CygwinPort), that would be wonderful!  (This is just for building - that is for *everything*.)",
...
```json
{
    "body": "<a id='comment:69'></a>\n> I had to install zlib-devel as well or had horrible linking problems with freetype and gd.\n\nHuh, maybe that's only on Win 7.  Well, add it to the list here and on the [CygwinPort](../wikis/CygwinPort) page.",
...
```json
{
    "body": "**Attachment:** [trac_6743-doc.patch](https://github.com/sagemath/sage/files/ticket6743/trac_6743-doc.patch)",
    "created_at": "2013-04-12T01:24:49Z",
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
...
**Attachment:** [trac_6743-doc.patch](https://github.com/sagemath/sage/files/ticket6743/trac_6743-doc.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49056",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49057",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49058",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49059",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49060",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49061",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49062",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49063",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49064",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49065",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49066",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49067",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49068",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49069",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49070",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49071",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49072",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6743#issuecomment-49073",
    "user": "https://github.com/jdemeyer"
}
```
