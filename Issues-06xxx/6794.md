...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68521"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68522"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68523"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6794",
    "rename": {
        "from": "doctest failure in sage/sage/interfaces/rubik.py due to upgrade to Maxima 5.19.1",
        "to": "doctest failure on 32-bit Solaris 10 SPARC in sage/sage/interfaces/rubik.py due to upgrade to Maxima 5.19.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6794#issuecomment-49552",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6794#issuecomment-49553",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68525"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68526"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6794#issuecomment-49554",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6794",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6794#event-68527"
}
```
