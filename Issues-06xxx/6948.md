...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76357"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76360"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76361"
}
```
...
```json
{
    "body": "<a id='comment:1'>Comment 1:</a>\nThis is fixed in my pynac tree, [attachment: trac_6948-exp_power.patch.gz](https://github.com/sagemath/sage/files/ticket6948/trac_6948-exp_power.patch.gz) is the corresponding patch for Sage. I will release a pynac spkg with some more fixes and post instructions for review.",
    "created_at": "2009-09-19T15:08:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76366"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6948#issuecomment-51180",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6948#event-76371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6948#issuecomment-51181",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6948#issuecomment-51182",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6948#issuecomment-51183",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6948#issuecomment-51184",
    "user": "https://github.com/sagetrac-mvngu"
}
```
