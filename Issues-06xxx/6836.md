...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64173",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64174",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Implemented Lloyd's suggestion (with some changes to the code).  See the patch.",
    "created_at": "2010-01-03T11:59:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64175",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:1'></a>Implemented Lloyd's suggestion (with some changes to the code).  See the patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64176",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64177",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64178",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64179",
...
```json
{
    "body": "<a id='comment:2'></a>Looks fine to me, and tests pass on 4.3.5 (with all the other patches in the positive_review pile already applied).",
    "created_at": "2010-04-05T13:30:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64180",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:2'></a>Looks fine to me, and tests pass on 4.3.5 (with all the other patches in the positive_review pile already applied).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64181",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64182",
...
```json
{
    "body": "<a id='comment:3'></a>Here's a patch to make the docs build without error.",
    "created_at": "2010-04-15T05:37:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64183",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Here's a patch to make the docs build without error.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64184",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64185",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6836#issuecomment-64186",
    "user": "https://github.com/jhpalmieri"
}
```
