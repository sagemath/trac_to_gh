...
```json
{
    "body": "<a id='comment:1'></a>I put in some `.. link` directives so that \"J\" would remain defined from one set of examples to the next.  I also had to reorder a list.",
    "created_at": "2009-06-16T19:13:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56468",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>I put in some `.. link` directives so that "J" would remain defined from one set of examples to the next.  I also had to reorder a list.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56469",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Patch applies fine to 4.0.2.rc1 and passes sage -tp 1\nSAGE_ROOT/devel/sage/doc/en/constructions/. Also the builds sage -docbuild\n constructions html (resp., pdf) went fine.",
    "created_at": "2009-06-16T23:12:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56470",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:2'></a>Patch applies fine to 4.0.2.rc1 and passes sage -tp 1
SAGE_ROOT/devel/sage/doc/en/constructions/. Also the builds sage -docbuild
 constructions html (resp., pdf) went fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56471",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56472",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6330#event-14870"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56473",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6330#issuecomment-56474",
    "user": "https://github.com/rlmill"
}
```
