...
```json
{
    "body": "<a id='comment:2'></a>The path name looks like it's Sage 4.1.1.alpha0. But it may be that adavid upgraded to Sage 4.1.1.alpha1 with that version and then ran doctests. One way to make sure is for adavid to have a look at the patch for #6594 and compare that with the file `sage/interfaces/r.py` in the version he doctested.",
    "created_at": "2009-07-28T18:11:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6646#issuecomment-61645",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:2'></a>The path name looks like it's Sage 4.1.1.alpha0. But it may be that adavid upgraded to Sage 4.1.1.alpha1 with that version and then ran doctests. One way to make sure is for adavid to have a look at the patch for #6594 and compare that with the file `sage/interfaces/r.py` in the version he doctested.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6646#issuecomment-61646",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is a duplicate of #6594.",
    "created_at": "2009-08-12T16:10:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6646#issuecomment-61647",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:3'></a>This is a duplicate of #6594.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6646#issuecomment-61648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6646#issuecomment-61649",
    "user": "https://github.com/fchapoton"
}
```
