...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61901",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This suppresses the private methods (`__init__`, etc.).  I'm not sure this is a good idea.  Before the transition to Sphinx, these were included in the reference manual, and then they weren't post-Sphinx, I think mainly because the default was to not include them.  I think they should be included.",
    "created_at": "2009-08-23T18:09:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61903",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>This suppresses the private methods (`__init__`, etc.).  I'm not sure this is a good idea.  Before the transition to Sphinx, these were included in the reference manual, and then they weren't post-Sphinx, I think mainly because the default was to not include them.  I think they should be included.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61904",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61905",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61907",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61908",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61909",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6664#issuecomment-61910",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
