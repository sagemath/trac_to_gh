...
```json
{
    "body": "<a id='comment:1'></a>Attachment [p1list_nf.patch](tarball://root/attachments/some-uuid/ticket6829/p1list_nf.patch) by mtaranes created at 2009-08-27 10:15:17",
...
<a id='comment:1'></a>Attachment [p1list_nf.patch](tarball://root/attachments/some-uuid/ticket6829/p1list_nf.patch) by mtaranes created at 2009-08-27 10:15:17
...
```json
{
    "body": "<a id='comment:2'></a>The patch is based on 4.1.1",
...
<a id='comment:2'></a>The patch is based on 4.1.1
...
<a id='comment:3'></a>Just my two cents.
