...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55484",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55485",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_6243-fderivative_hash.patch](tarball://root/attachments/some-uuid/ticket6243/trac_6243-fderivative_hash.patch) by @burcin created at 2009-07-31 21:25:17\n\nI have a fix for this in my local pynac tree. I took a shortcut and changed the fderivative hashes to include the parameters.\n\nI'll make a new pynac package with fixes for some other bugs available soon.",
    "created_at": "2009-07-31T21:25:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55486",
    "user": "https://github.com/burcin"
}
```

<a id='comment:1'></a>Attachment [trac_6243-fderivative_hash.patch](tarball://root/attachments/some-uuid/ticket6243/trac_6243-fderivative_hash.patch) by @burcin created at 2009-07-31 21:25:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55487",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This now depends on the package linked from #6404.\n\nPlease follow the instructions on that ticket to apply & test.",
    "created_at": "2009-08-01T02:31:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55488",
    "user": "https://github.com/burcin"
}
```

<a id='comment:2'></a>This now depends on the package linked from #6404.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55489",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I tested this out. Pynac changes seem fine to me. I encountered one issue though:\n\n```\nsage: d = {}\nsage: d[x] = 1\nsage: d\n{x: 1}\nsage: f(x) = function('f',x)\nsage: d[diff(f(x),x)] = 2\nsage: d.keys()\n[D[0](f)(x), x]\nsage: d.values()\n[2, 1]\nsage: d\n!boom!\n```\n\nThe origin of this !boom! lies in expression_conversions.py for fderivative\nwhich is clearly NOT in purview of this patch. So I am going to give it a positive review \nshortly.",
    "created_at": "2009-08-02T17:12:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55490",
    "user": "https://github.com/golam-m-hossain"
}
```

<a id='comment:3'></a>I tested this out. Pynac changes seem fine to me. I encountered one issue though:
...
```json
{
    "body": "<a id='comment:4'></a>Note: I am giving partial positive review because I tested this patch against my stable \nsage-4.1. So if it applies cleanly on Sage-4.1.1.rc1 then that would be full positive from me.",
    "created_at": "2009-08-02T19:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55491",
    "user": "https://github.com/golam-m-hossain"
}
```

<a id='comment:4'></a>Note: I am giving partial positive review because I tested this patch against my stable 
sage-4.1. So if it applies cleanly on Sage-4.1.1.rc1 then that would be full positive from me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55492",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6243#event-14625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55494",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6243#issuecomment-55495",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
