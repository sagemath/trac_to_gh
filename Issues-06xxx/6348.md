...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56747",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I have looked at the patch, and it indeed is just printing/ordering issues. Spkg looks fine, SPKG.txt updated. Tests are still running...",
    "created_at": "2009-06-25T10:37:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56749",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>I have looked at the patch, and it indeed is just printing/ordering issues. Spkg looks fine, SPKG.txt updated. Tests are still running...
...
```json
{
    "body": "<a id='comment:3'></a>Seems to have broken my install... maybe it was something else, but now I've got to fix my Sage :(.",
    "created_at": "2009-06-26T03:53:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56750",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>Seems to have broken my install... maybe it was something else, but now I've got to fix my Sage :(.
...
```json
{
    "body": "<a id='comment:4'></a>Just curious what happened. You installed the spkg using sage -f then maybe ran sage -b and then sage -testall? This failed somehow and rendered your Sage unusable?",
    "created_at": "2009-06-27T11:41:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56751",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:4'></a>Just curious what happened. You installed the spkg using sage -f then maybe ran sage -b and then sage -testall? This failed somehow and rendered your Sage unusable?
...
```json
{
    "body": "<a id='comment:5'></a>Yep--segfaulted on startup (so you can imagine how many tests failed...). It was acting a bit weird beforehand, so I'm not blaming this spkg for sure.",
    "created_at": "2009-06-27T17:09:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56752",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>Yep--segfaulted on startup (so you can imagine how many tests failed...). It was acting a bit weird beforehand, so I'm not blaming this spkg for sure.
...
```json
{
    "body": "<a id='comment:6'></a>This seems to be not quite a positive review. I'm changing this back to \"needs work,\" at least for now.",
    "created_at": "2009-07-04T02:08:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56753",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:6'></a>This seems to be not quite a positive review. I'm changing this back to "needs work," at least for now.
...
```json
{
    "body": "<a id='comment:7'></a>I think my sage was messed up from elsewhere, so the spkg probably doesn't need work, but it still needs to be reviewed.",
    "created_at": "2009-07-04T05:06:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56754",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>I think my sage was messed up from elsewhere, so the spkg probably doesn't need work, but it still needs to be reviewed.
...
```json
{
    "body": "<a id='comment:8'></a>The file sage/graphs/graph_isom.pyx was removed in ticket #6112. That breaks this patch so I guess I will switch it back to needs work.",
    "created_at": "2009-07-16T07:19:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56755",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:8'></a>The file sage/graphs/graph_isom.pyx was removed in ticket #6112. That breaks this patch so I guess I will switch it back to needs work.
...
```json
{
    "body": "<a id='comment:9'></a>I'm not sure how to fix the patch. Can I take the patch, open it in an editor, and delete the section containing the fixes for graph_isom.pyx, save it and rename the patch?",
    "created_at": "2009-07-16T14:15:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56756",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:9'></a>I'm not sure how to fix the patch. Can I take the patch, open it in an editor, and delete the section containing the fixes for graph_isom.pyx, save it and rename the patch?
...
```json
{
    "body": "<a id='comment:10'></a>I believe that you can. I tried cutting out that part and I was able to apply the patch but I don't know anything about Mercurial or if this is the \"proper\" way to do it. My first thought is to apply the \"cut\" patch and then export a new one to replace the one here. \n\nI see that graph_isom.pxd is still there although it is not needed. Should it be deleted? On this or a new ticket?",
    "created_at": "2009-07-16T15:40:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56757",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:10'></a>I believe that you can. I tried cutting out that part and I was able to apply the patch but I don't know anything about Mercurial or if this is the "proper" way to do it. My first thought is to apply the "cut" patch and then export a new one to replace the one here. 
...
```json
{
    "body": "<a id='comment:11'></a>Replying to [awebb](#comment%3A10):\n> I see that graph_isom.pxd is still there although it is not needed. Should it be deleted? On this or a new ticket?\n\n\n`graph_isom.pxd` should also be deleted. This is a new ticket: #6544",
    "created_at": "2009-07-16T18:54:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56758",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:11'></a>Replying to [awebb](#comment%3A10):
> I see that graph_isom.pxd is still there although it is not needed. Should it be deleted? On this or a new ticket?
...
```json
{
    "body": "<a id='comment:12'></a>I installed the spkg and applied a modified patch (removed the graph_isom.pyx part). I ran 'sage -ptest and everything passed. I could not change the patch but otherwise it looks positive.",
    "created_at": "2009-07-16T19:04:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56759",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:12'></a>I installed the spkg and applied a modified patch (removed the graph_isom.pyx part). I ran 'sage -ptest and everything passed. I could not change the patch but otherwise it looks positive.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56760",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [trac_6348b.patch](tarball://root/attachments/some-uuid/ticket6348/trac_6348b.patch) by @wdjoyner created at 2009-07-16 19:24:55\n\nReplying to [awebb](#comment%3A12):\n> I installed the spkg and applied a modified patch (removed the graph_isom.pyx part). \n> I ran 'sage -ptest and everything passed. I could not change the patch but otherwise it looks positive.\n\n\nNew patch (removed the graph_isom.pyx part) seems to solve the problem, passes sage -testall.",
    "created_at": "2009-07-16T19:24:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56761",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:13'></a>Attachment [trac_6348b.patch](tarball://root/attachments/some-uuid/ticket6348/trac_6348b.patch) by @wdjoyner created at 2009-07-16 19:24:55
...
```json
{
    "body": "<a id='comment:18'></a>On sage.math.",
    "created_at": "2009-07-16T21:48:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56766",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:18'></a>On sage.math.
...
```json
{
    "body": "<a id='comment:20'></a>This was a fresh build of Sage-4.1. What errors did you run into when building sage-4.1?",
    "created_at": "2009-07-17T01:45:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56768",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:20'></a>This was a fresh build of Sage-4.1. What errors did you run into when building sage-4.1?
...
```json
{
    "body": "<a id='comment:21'></a>I ran into an error building atlas. I don't know how to replicate your error so don't know how to try to fix this ticket. As I said, it works on my 2 machines. Do you have any suggestions?",
    "created_at": "2009-07-17T01:54:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56769",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:21'></a>I ran into an error building atlas. I don't know how to replicate your error so don't know how to try to fix this ticket. As I said, it works on my 2 machines. Do you have any suggestions?
...
```json
{
    "body": "<a id='comment:22'></a>Strangely, doing the exact same thing again gave different results.\n\nI was able to install `gap-4.4.12.p0` on top of `sage-4.1` on sage.math, and after applying the patch, I'm running long doctests everywhere. Will post the results shortly.",
    "created_at": "2009-07-17T01:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56770",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:22'></a>Strangely, doing the exact same thing again gave different results.
...
```json
{
    "body": "<a id='comment:23'></a>All tests pass!",
    "created_at": "2009-07-17T02:01:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56771",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:23'></a>All tests pass!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56772",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>The Mercurial repo is corrupted, but I am posting an spkg that will fix this. Tell me, what is the purpose of the `patch` file that was added? I can't read it in plain text, and I don't know what format it is...",
    "created_at": "2009-07-17T02:16:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56773",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:25'></a>The Mercurial repo is corrupted, but I am posting an spkg that will fix this. Tell me, what is the purpose of the `patch` file that was added? I can't read it in plain text, and I don't know what format it is...
...
```json
{
    "body": "<a id='comment:26'></a>Hmm, I've deleted that `patch` file, reinstalled (this time on 32-bit OS X), and I'm running long doctests on this. Next I'll test 64-bit OS X. I don't know what `patch` was, but it doesn't seem necessary.",
    "created_at": "2009-07-17T02:26:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56774",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:26'></a>Hmm, I've deleted that `patch` file, reinstalled (this time on 32-bit OS X), and I'm running long doctests on this. Next I'll test 64-bit OS X. I don't know what `patch` was, but it doesn't seem necessary.
...
```json
{
    "body": "<a id='comment:28'></a>These tests also ended with the seemingly infinite barrage of\n\n```\nException RuntimeError: 'maximum recursion depth exceeded while calling a Python object' in <type 'exceptions.AttributeError'> ignored\n```",
    "created_at": "2009-07-17T03:07:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56776",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:28'></a>These tests also ended with the seemingly infinite barrage of
...
```json
{
    "body": "<a id='comment:29'></a>These tests also pass the second time around. Could this have something to do with temp files or workspaces or something?",
    "created_at": "2009-07-17T04:58:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56777",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:29'></a>These tests also pass the second time around. Could this have something to do with temp files or workspaces or something?
...
```json
{
    "body": "<a id='comment:32'></a>Hmm, after doing the above, upgrading went just fine. I just can't reproduce the `AssertionError`, even though I've seen it on Linux and OS X. Maybe it's because of the state of my `DOT_SAGE` directories.\n\nI'm almost ready to give this a positive review, but it makes me uneasy, since it seems each user will experience this once on upgrade, possibly even if they've just installed a new version from scratch...",
    "created_at": "2009-07-17T16:56:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56780",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:32'></a>Hmm, after doing the above, upgrading went just fine. I just can't reproduce the `AssertionError`, even though I've seen it on Linux and OS X. Maybe it's because of the state of my `DOT_SAGE` directories.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56781",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56782",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Closing this as a duplicate of #8076.",
    "created_at": "2010-02-02T07:37:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6348",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6348#issuecomment-56783",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:34'></a>Closing this as a duplicate of #8076.
