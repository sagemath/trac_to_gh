...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58082",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [DetBugMatrix.sobj](tarball://root/attachments/some-uuid/ticket6442/DetBugMatrix.sobj) by @loefflerd created at 2009-07-05 08:09:47",
    "created_at": "2009-07-05T08:09:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58083",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:1'></a>Attachment [DetBugMatrix.sobj](tarball://root/attachments/some-uuid/ticket6442/DetBugMatrix.sobj) by @loefflerd created at 2009-07-05 08:09:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58084",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58085",
...
```json
{
    "body": "<a id='comment:3'></a>Here's a patch that should prevent this problem in the future. I used the smallest matrix I could find for the doctest, but I was just creating them randomly. I'd be happy to replace it with a smaller example.",
    "created_at": "2012-01-05T02:27:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58087",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:3'></a>Here's a patch that should prevent this problem in the future. I used the smallest matrix I could find for the doctest, but I was just creating them randomly. I'd be happy to replace it with a smaller example.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58088",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58089",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58090",
...
```json
{
    "body": "Changing work_issues from \"\" to \"problem is not fixed\"",
    "created_at": "2012-01-10T10:27:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58091",
    "user": "https://github.com/zimmermann6"
}
```

Changing work_issues from "" to "problem is not fixed"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58093",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The bug wasn't in the saving/loading of matrices, only in the cache code. DetBugMatrix.sobj contains a broken matrix -- one with an empty dictionary cached as the charpoly(). When you load it from file, it's still broken, so some operations won't work on it.\n\nThe patch prevents creating these matrices in the future by fixing the cache bug (hopefully).\n\nThe code from the doctest should work only after the patch, because prior to the patch, it would have created a matrix with the same problem as the one in DetBugMatrix.sobj.",
    "created_at": "2012-01-10T13:18:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58094",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:6'></a>The bug wasn't in the saving/loading of matrices, only in the cache code. DetBugMatrix.sobj contains a broken matrix -- one with an empty dictionary cached as the charpoly(). When you load it from file, it's still broken, so some operations won't work on it.
...
```json
{
    "body": "<a id='comment:7'></a>the doctest example can be simplified to:\n\n```\nA = matrix(z, [ [3 + O(5^1), 4 + O(5^1), 4 + O(5^1)],\n[2*5^2 + O(5^3), 2 + O(5^1), 1 + O(5^1)],\n[5 + O(5^2), 1 + O(5^1), 1 + O(5^1)]])\n```\nPaul",
    "created_at": "2012-01-10T14:34:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58095",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:7'></a>the doctest example can be simplified to:
...
```json
{
    "body": "<a id='comment:8'></a>> The bug wasn't in the saving/loading of matrices, only in the cache code [...]\n\n\nok, I put it back to \"needs review\". However the summary is misleading.\n\nPaul",
    "created_at": "2012-01-10T14:42:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58096",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:8'></a>> The bug wasn't in the saving/loading of matrices, only in the cache code [...]
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58097",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Thanks for the simplified test case, I'll be able to update the patch in a bit.\n\nI think you're correct about (2), but I would do that in a separate ticket since it's unrelated to this problem.",
    "created_at": "2012-01-10T14:59:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58099",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:10'></a>Thanks for the simplified test case, I'll be able to update the patch in a bit.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58100",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [sage-trac_6442.patch](tarball://root/attachments/some-uuid/ticket6442/sage-trac_6442.patch) by @orlitzky created at 2012-01-10 15:28:01\n\nI just updated the patch with your test case.\n\nI moved the \"Cache the result\" comment to where it belongs, but also added a comment above the code that creates the dictionary, explaining why it occurs near the end of the function.",
    "created_at": "2012-01-10T15:28:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58101",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:11'></a>Attachment [sage-trac_6442.patch](tarball://root/attachments/some-uuid/ticket6442/sage-trac_6442.patch) by @orlitzky created at 2012-01-10 15:28:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58102",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58103",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>thank you Michael for your changes. All doctests pass. I give a positive review.\n\nPaul",
    "created_at": "2012-01-11T07:22:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58104",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:12'></a>thank you Michael for your changes. All doctests pass. I give a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58105",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>the efficiency issue with the cache is now ticket #12292.\n\nPaul",
    "created_at": "2012-01-11T07:32:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58106",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:13'></a>the efficiency issue with the cache is now ticket #12292.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58107",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6442#issuecomment-58108",
    "user": "https://github.com/jdemeyer"
}
```
