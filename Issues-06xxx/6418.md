...
```json
{
    "body": "<a id='comment:1'></a>Attachment [ref_manual_6418.patch](tarball://root/attachments/some-uuid/ticket6418/ref_manual_6418.patch) by mvngu created at 2009-06-26 00:59:34\n\nI still get about 5 warnings when building the reference manual. That's better than 10 warnings.",
    "created_at": "2009-06-26T00:59:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6418",
    "type": "issue_comment",
...
<a id='comment:1'></a>Attachment [ref_manual_6418.patch](tarball://root/attachments/some-uuid/ticket6418/ref_manual_6418.patch) by mvngu created at 2009-06-26 00:59:34
...
```json
{
    "body": "<a id='comment:3'></a>See #6419 for a patch to get rid of the sage.misc.misc warnings (rather brutally, but it's the only thing I can figure out).",
...
<a id='comment:3'></a>See #6419 for a patch to get rid of the sage.misc.misc warnings (rather brutally, but it's the only thing I can figure out).
