...
```json
{
    "body": "<a id='comment:1'></a>One of the easier patches - it just needed one byte changed. In spkg-install:\n\n\n\n```\n  $CP -a libflint* \"$SAGE_LOCAL/lib/\"\n```\n\nwas changed to\n\n```\n  $CP -p libflint* \"$SAGE_LOCAL/lib/\"\n```\n\n\nSee http://sage.math.washington.edu/home/kirkby/Solaris-fixes/flint/",
    "created_at": "2009-06-30T17:04:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58246",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>One of the easier patches - it just needed one byte changed. In spkg-install:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58247",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58248",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58250",
...
```json
{
    "body": "<a id='comment:4'></a>The spkg posted by David Kirkby didn't check in all changes. I've checked in the changes in David's name. The updated spkg is up at\n\nhttp://sage.math.washington.edu/home/mvngu/patch/flint-1.3.0.p2.spkg\n\nJust to let people know, the updated spkg has been merged in sage-4.1.1-alpha0. I can't close this ticket because I don't have the privilege to do so. Sorry, folks :-(",
    "created_at": "2009-07-16T18:53:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58251",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>The spkg posted by David Kirkby didn't check in all changes. I've checked in the changes in David's name. The updated spkg is up at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58252",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58253",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6451#issuecomment-58254",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
