...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53086",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53087",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53088",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53089",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "rename": {
        "from": "[with patch; needs review] Bug - sage-cleaner failed due to NULLs in spawned-processes files written by cleaner.py",
        "to": "[with patch; needs work] Bug - sage-cleaner failed due to NULLs in spawned-processes files written by cleaner.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24623"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53090",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53091",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53092",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53093",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6128#issuecomment-53094",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24624"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24625"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24626"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24627"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24628"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24629"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6128#event-24630"
}
```
