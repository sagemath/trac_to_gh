...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41847",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41848",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
archive/attachments_007216.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "12339.patch",
    "asset_url": "tarball://root/attachments/ticket6128/12339.patch",
    "created_at": "2009-06-02T05:15:07Z",
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6128/12339.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    "body": "Attachment [12339.patch](https://github.com/sagemath/sage/files/ticket6128/12339.patch) by adavid created at 2009-06-02 05:15:07\n\ncleaner.patch",
    "created_at": "2009-06-02T05:15:07Z",
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41849",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```

Attachment [12339.patch](https://github.com/sagemath/sage/files/ticket6128/12339.patch) by adavid created at 2009-06-02 05:15:07
...
archive/attachments_007217.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6128.patch",
    "asset_url": "tarball://root/attachments/ticket6128/trac_6128.patch",
    "created_at": "2009-06-02T05:23:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6128/trac_6128.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_6128.patch](https://github.com/sagemath/sage/files/ticket6128/trac_6128.patch) by adavid created at 2009-06-02 05:23:41\n\nPlease ignore 12339.patch. Uploaded second patch (trac_6128.patch) to conform to patch name standards.",
    "created_at": "2009-06-02T05:23:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41850",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41851",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41852",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41853",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41854",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39785"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39786"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39787"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39788"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39789"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39790"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39791"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6128#event-39792"
}
```
