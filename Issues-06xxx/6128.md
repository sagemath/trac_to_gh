...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41864",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41865",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
archive/attachments_007484.json:
```json
{
...
```json
{
    "body": "**Attachment:** [12339.patch](https://github.com/sagemath/sage/files/ticket6128/12339.patch)\n\ncleaner.patch",
    "created_at": "2009-06-02T05:15:07Z",
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41866",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```

**Attachment:** [12339.patch](https://github.com/sagemath/sage/files/ticket6128/12339.patch)
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_6128.patch](https://github.com/sagemath/sage/files/ticket6128/trac_6128.patch)\n\nPlease ignore 12339.patch. Uploaded second patch (trac_6128.patch) to conform to patch name standards.",
    "created_at": "2009-06-02T05:23:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41867",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41868",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41870",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6128#issuecomment-41871",
    "user": "https://trac.sagemath.org/admin/accounts/users/adavid"
}
```
