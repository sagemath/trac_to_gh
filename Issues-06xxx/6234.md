...
```json
{
    "body": "<a id='comment:1'></a>I've added a patch that removes the check for the `SAGE_PARALLEL_DIST` flag, and adds a few comments at the top. This should be pretty easy to review; if it makes anyone feel better, I'll probably be using it while merging tickets, and I can report back.",
    "created_at": "2009-06-09T09:53:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55335",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>I've added a patch that removes the check for the `SAGE_PARALLEL_DIST` flag, and adds a few comments at the top. This should be pretty easy to review; if it makes anyone feel better, I'll probably be using it while merging tickets, and I can report back.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55336",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Fixed patch to correct a silly typo noted by Nick.",
    "created_at": "2009-06-10T00:39:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55337",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:3'></a>Fixed patch to correct a silly typo noted by Nick.
...
```json
{
    "body": "<a id='comment:4'></a>This wasn't showing up in the \"needs review\" list, because that does a text search for \"needs review\" and thus misses \"needs easy review\".",
    "created_at": "2009-06-10T10:32:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55338",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:4'></a>This wasn't showing up in the "needs review" list, because that does a text search for "needs review" and thus misses "needs easy review".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55340",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I think that's a race condition -- I suspect two calls to build_ext simultaneously realize that there's no directory to store a file and try to create it at the same time. The first is okay, but the second gets an error and bails.\n\nThe attached patch should fix this, as long as that's what's going on -- it creates all the appropriate directories in `build/` while processing files in serial, thereby eliminating the potential race problem.",
    "created_at": "2009-06-12T02:14:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55341",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:6'></a>I think that's a race condition -- I suspect two calls to build_ext simultaneously realize that there's no directory to store a file and try to create it at the same time. The first is okay, but the second gets an error and bails.
...
```json
{
    "body": "<a id='comment:7'></a>Real test will sage-4.0.2.alpha1.",
    "created_at": "2009-06-12T06:54:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55342",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:7'></a>Real test will sage-4.0.2.alpha1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55343",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55344",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55345",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6234#issuecomment-55346",
    "user": "https://github.com/craigcitro"
}
```
