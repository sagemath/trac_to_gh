...
```json
{
    ...
    "asset_name": "trac_6079-base-inclusion-morphism.patch",
    "asset_url": "tarball://root/attachments/ticket6079/trac_6079-base-inclusion-morphism.patch",
    "created_at": "2009-05-19T03:02:11Z",
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6079/trac_6079-base-inclusion-morphism.patch",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6079-base-inclusion-morphism.patch](https://github.com/sagemath/sage/files/ticket6079/trac_6079-base-inclusion-morphism.patch) by @ncalexan created at 2009-05-19 03:02:11\n\nSecond patch relies on first; might as well be on same ticket.  Adds a subfield_containing that tries to do a bit more than naive trial and error to find the smallest subfield of a number field containing the specified elements.",
    "created_at": "2009-05-19T03:02:11Z",
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41215",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41216",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41217",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39352"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41218",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41219",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41220",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41221",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41222",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41223",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41224",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41225",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39354"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41226",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6079#issuecomment-41227",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39358"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39359"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39360"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39361"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39362"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39363"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39364"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6079#event-39365"
}
```
