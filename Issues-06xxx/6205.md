...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6205-number_field-morphism-invert.patch](https://github.com/sagemath/sage/files/ticket6205/trac_6205-number_field-morphism-invert.patch) by @mwhansen created at 2009-06-04 05:35:23",
    "created_at": "2009-06-04T05:35:23Z",
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6205#issuecomment-42538",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6205#issuecomment-42539",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6205#issuecomment-42540",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6205#issuecomment-42541",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6205#issuecomment-42542",
    "user": "https://github.com/ncalexan"
}
```
