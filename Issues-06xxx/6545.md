...
```json
{
    "body": "<a id='comment:7'></a>\nStrange, here is what I do:\n* hg qimport https://github.com/sagemath/sage/files/ticket6545/trac_6545_mpolynomial_ideal_sorted_outputs.patch\n* hg qpush (no hunk fails)\n* sage -b\n\nDid you mix up raw-attachment and attachment?",
