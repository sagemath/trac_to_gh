...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] new scipy-0.7.p2 spkg is broken on 64-bit OS X"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6493#event-26200"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6493#issuecomment-57814",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6493#issuecomment-57815",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "rename": {
        "from": "[with patch; needs review] new scipy-0.7.p2 spkg is broken on 64-bit OS X",
        "to": "[with patch; positive review] new scipy-0.7.p2 spkg is broken on 64-bit OS X, due to numpy"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6493#event-26201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6493#issuecomment-57816",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6493#issuecomment-57817",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6493#event-26202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6493#issuecomment-57818",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6493#issuecomment-57819",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6493",
    "rename": {
        "from": "[with patch; positive review] new scipy-0.7.p2 spkg is broken on 64-bit OS X, due to numpy",
        "to": "[with patch, positive review] new scipy-0.7.p2 spkg is broken on 64-bit OS X, due to numpy"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6493#event-26203"
}
```
