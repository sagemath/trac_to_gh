...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79007"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79010"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79011"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6535#issuecomment-45100",
...
```json
{
    ...
    "milestone_title": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6535#issuecomment-45101",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-79015"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6535#issuecomment-45102",
    "user": "https://github.com/jdemeyer"
}
```
