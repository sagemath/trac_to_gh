...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6297#issuecomment-54844",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6297#event-25196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6297#issuecomment-54845",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "rename": {
        "from": "fix LaTeX formatting in sage/schemes/elliptic_curves/period_lattice.py",
        "to": "[with patch, needs review] fix LaTeX formatting in sage/schemes/elliptic_curves/period_lattice.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6297#event-25197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "rename": {
        "from": "[with patch, needs review] fix LaTeX formatting in sage/schemes/elliptic_curves/period_lattice.py",
        "to": "[with patch, positive review] fix LaTeX formatting in sage/schemes/elliptic_curves/period_lattice.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6297#event-25198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6297#issuecomment-54846",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6297#issuecomment-54847",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6297#event-25199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6297#issuecomment-54848",
...
```json
{
    ...
    "milestone": "sage-4.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6297#event-25200"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6297#event-25201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6297#issuecomment-54849",
    "user": "https://github.com/craigcitro"
}
```
