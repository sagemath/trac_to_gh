...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72845"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-72852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6826#issuecomment-49903",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6826#issuecomment-49904",
    "user": "https://github.com/sagetrac-mvngu"
}
```
