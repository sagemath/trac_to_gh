...
```json
{
    "body": "<a id='comment:1'></a>The patch `trac_6841-shift-cipher.patch` implements the shift cryptosystem. It also adds some doctests and documentation to existing crypto modules.",
    "created_at": "2009-08-29T09:07:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64277",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>The patch `trac_6841-shift-cipher.patch` implements the shift cryptosystem. It also adds some doctests and documentation to existing crypto modules.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64278",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64280",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Builds and runs on 4.1.2.alpha2.  Passes tests, docs build without warnings.  Great documentation.\n\nWould you want to put similar input protections on `inverse_key()`?  Your call.\n\nPositive review, either way.",
    "created_at": "2009-09-25T05:23:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64282",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:7'></a>Builds and runs on 4.1.2.alpha2.  Passes tests, docs build without warnings.  Great documentation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64283",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64284",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64285",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6841#issuecomment-64286",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
