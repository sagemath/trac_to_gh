...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-56015",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-56016",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-56017",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-56018",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Yep, this is a great idea. There's no hg repository there, but I've added the changes.",
    "created_at": "2009-06-18T00:03:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-56019",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>Yep, this is a great idea. There's no hg repository there, but I've added the changes.
