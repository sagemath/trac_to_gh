...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-54824",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "rename": {
        "from": "[with patch, needs review] build runs sphinx-build even on failure",
        "to": "[with patch, with positive review] build runs sphinx-build even on failure"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6295#event-25192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-54825",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-54826",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-54827",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6295#issuecomment-54828",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6295",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6295#event-25193"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6295#event-25194"
}
```
