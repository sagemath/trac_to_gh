# Issue 6295: [with patch, with positive review] build runs sphinx-build even on failure
...
```json
{
    ...
    "title": "[with patch, with positive review] build runs sphinx-build even on failure",
    "type": "issue",
