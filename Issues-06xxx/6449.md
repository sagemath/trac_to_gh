...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68178"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68182"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68183"
}
```
...
```json
{
    "body": "Changed keywords from **** to **abelian group**",
...
Changed keywords from **** to **abelian group**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68185"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68186"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68192"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45068",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45069",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45070",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45071",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45072",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45073",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6449#event-68203"
}
```
...
```json
{
    "body": "<a id='comment:41'>Comment 41:</a>\nReplying to [@JohnCremona](#comment%3A39):\n> I checked that the patches as specified by David, and repeated here:\n> \n> 1. trac_9287.coverage_for_elliptic_curves_part1.patch\n> 2. trac_9287.coverage_for_elliptic_curves_part2.patch\n> 3. trac_6449_everything.patch\n> 4. trac_6449_ones_that_got_away.patch\n> 5. trac_6449_more_doctests.patch\n> \n> apply ok to 4.5.alpha4.  The new doctests look fine and pass, and coverage in this directory is now 100%.\n> \n> I have therefore left the tag as \"positive review\" and hope that mhansen is now happy!\n\nFor the record, I did *not* apply [attachment: trac_6449_ones_that_got_away.1.patch.gz](https://github.com/sagemath/sage/files/ticket6449/trac_6449_ones_that_got_away.1.patch.gz) to 4.5.2.alpha0.",
    "created_at": "2010-07-20T07:12:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6449#issuecomment-45074",
    "user": "https://github.com/qed777"
}
```
