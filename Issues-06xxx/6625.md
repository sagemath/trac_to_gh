...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6625/scripts_6625_no_x_bit.patch",
    "created_at": "2010-01-19T02:18:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6625/scripts_6625_no_x_bit.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [scripts_6625_no_x_bit.patch](https://github.com/sagemath/sage/files/ticket6625/scripts_6625_no_x_bit.patch) by @wjp created at 2010-01-19 02:18:05\n\nThe `sage-make_devel_packages` explicitly set the x bit on all `sage-*` files.",
    "created_at": "2010-01-19T02:18:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47608",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6625/trac_6625-no-x-bit.patch",
    "created_at": "2010-01-19T17:26:07Z",
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6625/trac_6625-no-x-bit.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "Attachment [trac_6625-no-x-bit.patch](https://github.com/sagemath/sage/files/ticket6625/trac_6625-no-x-bit.patch) by mvngu created at 2010-01-19 17:26:07\n\nrebased against Sage 4.3.1.rc1; apply to SAGE_LOCAL/bin",
    "created_at": "2010-01-19T17:26:07Z",
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47609",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Attachment [trac_6625-no-x-bit.patch](https://github.com/sagemath/sage/files/ticket6625/trac_6625-no-x-bit.patch) by mvngu created at 2010-01-19 17:26:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47610",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47611",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nThe attachment [scripts_6625_no_x_bit.patch](https://github.com/sagemath/sage/files/ticket6625/scripts_6625_no_x_bit.patch) fails to apply against Sage 4.3.1.rc1:\n\n```\n[mvngu@mod bin]$ pwd\n/dev/shm/mvngu/sage-4.3.1.rc1/local/bin\n[mvngu@mod bin]$ hg qimport https://github.com/sagemath/sage/files/ticket6625/scripts_6625_no_x_bit.patch\nadding scripts_6625_no_x_bit.patch to series file\n[mvngu@mod bin]$ hg qpush\napplying scripts_6625_no_x_bit.patch\npatching file sage-make_devel_packages\nHunk #1 FAILED at 135\n1 out of 1 hunks FAILED -- saving rejects to file sage-make_devel_packages.rej\npatch failed, unable to continue (try -v)\npatch failed, rejects left in working dir\nerrors during apply, please fix and refresh scripts_6625_no_x_bit.patch\n[mvngu@mod bin]$ cat sage-make_devel_packages.rej \n--- sage-make_devel_packages\n+++ sage-make_devel_packages\n@@ -136,6 +136,8 @@\n rm -rf $SCRIPTS\n mkdir $SCRIPTS\n chmod +x sage-*\n+chmod -x sage-README-osx.txt sage-banner sage-gdb-commands\n+chmod -x sage-maxima.lisp sage-verify-pyc\n chmod +x dsage_*\n rm sage-*~\n```\nThe failure results from #7975, which removes dsage from Sage and the patches on #7975 have been merged in Sage 4.3.1.rc1. The guilty line from [scripts_6625_no_x_bit.patch](https://github.com/sagemath/sage/files/ticket6625/scripts_6625_no_x_bit.patch) is:\n\n```\n139\t141\tchmod +x dsage_*\n```\nEssentially the patch looks good. I have rebased it against Sage 4.3.1.rc1, so only my rebase [trac_6625-no-x-bit.patch](https://github.com/sagemath/sage/files/ticket6625/trac_6625-no-x-bit.patch) needs reviewing.",
    "created_at": "2010-01-19T17:28:33Z",
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47612",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47613",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47614",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nMerged [trac_6625-no-x-bit.patch](https://github.com/sagemath/sage/files/ticket6625/trac_6625-no-x-bit.patch) in the script repository.",
    "created_at": "2010-01-24T02:22:34Z",
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-47615",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
