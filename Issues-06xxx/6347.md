...
```json
{
    "body": "<a id='comment:2'></a>I turns out  that the assumption above is wrong. There are a couple of places in the Singular code where int is assumed so this ticket cannot be implemented unless Singular changes.",
    "created_at": "2009-09-09T19:46:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6347",
    "type": "issue_comment",
...
<a id='comment:2'></a>I turns out  that the assumption above is wrong. There are a couple of places in the Singular code where int is assumed so this ticket cannot be implemented unless Singular changes.
