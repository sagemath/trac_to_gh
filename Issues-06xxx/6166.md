...
```json
{
    "body": "Attachment [no-nodetex-ref.patch](https://github.com/sagemath/sage/files/ticket6166/no-nodetex-ref.patch) by @jhpalmieri created at 2009-05-31 04:58:59",
    "created_at": "2009-05-31T04:58:59Z",
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42096",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [no-nodetex-ref.patch](https://github.com/sagemath/sage/files/ticket6166/no-nodetex-ref.patch) by @jhpalmieri created at 2009-05-31 04:58:59
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42097",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6166-2.patch](https://github.com/sagemath/sage/files/ticket6166/trac_6166-2.patch) by @mwhansen created at 2009-06-01 05:10:55\n\nThe original patch looks good except it doesn't handle the case when there is an empty docstring.  I've added a patch on top which fixes this.  John, can you review my small patch?",
    "created_at": "2009-06-01T05:10:55Z",
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42098",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42099",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42100",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42101",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42102",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6166#issuecomment-42103",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
