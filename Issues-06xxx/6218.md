...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54045",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "rename": {
        "from": "small changes to jacobian_morphism to make hyperelliptic curve arithmetic faster",
        "to": "[with patch, needs review] small changes to jacobian_morphism to make hyperelliptic curve arithmetic faster"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6218#event-24941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54047",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54048",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54049",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "rename": {
        "from": "[with patch, needs review] small changes to jacobian_morphism to make hyperelliptic curve arithmetic faster",
        "to": "[with patch, positive review] small changes to jacobian_morphism to make hyperelliptic curve arithmetic faster"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6218#event-24942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54050",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54051",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-54052",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6218#event-24943"
}
```
