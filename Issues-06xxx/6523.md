...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69246"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69248"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69250"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6523#issuecomment-46491",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6523#issuecomment-46492",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'>Comment 3:</a>\nThis is fixed by #7490, since we don't use the `expression_conversions` module to convert to `RIF` any more.\n\n[attachment: trac_6523-derivative_is_zero.patch.gz](https://github.com/sagemath/sage/files/ticket6523/trac_6523-derivative_is_zero.patch.gz) adds a doctest with the example in the description.",
    "created_at": "2009-11-21T11:24:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6523#issuecomment-46493",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6523#issuecomment-46494",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6523#issuecomment-46495",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6523#issuecomment-46496",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6523",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6523#event-69253"
}
```
