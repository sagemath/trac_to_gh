...
```json
{
    "body": "<a id='comment:1'></a>I'm CC'ing Martin, as he's the only person I know who might be interested in reviewing this ticket.",
    "created_at": "2009-05-31T04:25:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54540",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>I'm CC'ing Martin, as he's the only person I know who might be interested in reviewing this ticket.
...
```json
{
    "body": "<a id='comment:2'></a>Hi, how does the MiniAES compare to the small scale AES variants already in Sage? I guess, they should at least re-use the same building blocks. e.g. there is an S-Box class which might be worth using, some of the functions might do the same etc.",
    "created_at": "2009-05-31T12:50:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54541",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>Hi, how does the MiniAES compare to the small scale AES variants already in Sage? I guess, they should at least re-use the same building blocks. e.g. there is an S-Box class which might be worth using, some of the functions might do the same etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54542",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54543",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54544",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54545",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The patch uses the S-box implementation in `sage/crypto/mq/sbox.py` for constructing the S-box of Mini-AES. It also distinguishes Mini-AES from SR, as implemented in `sage/crypto/mq/sr.py`.",
    "created_at": "2009-06-17T00:16:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54546",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>The patch uses the S-box implementation in `sage/crypto/mq/sbox.py` for constructing the S-box of Mini-AES. It also distinguishes Mini-AES from SR, as implemented in `sage/crypto/mq/sr.py`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54548",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Doctests fail in 4.1.alpha0:\n\n```\nsage: maes = MiniAES()\nNameError: name 'MiniAES' is not defined\n```",
    "created_at": "2009-06-24T14:27:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54551",
    "user": "https://github.com/malb"
}
```

<a id='comment:11'></a>Doctests fail in 4.1.alpha0:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54552",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [trac_6164-mini-aes.patch](tarball://root/attachments/some-uuid/ticket6164/trac_6164-mini-aes.patch) by mvngu created at 2009-06-24 21:56:40\n\nCan you try again with the new patch?",
    "created_at": "2009-06-24T21:56:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54553",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:12'></a>Attachment [trac_6164-mini-aes.patch](tarball://root/attachments/some-uuid/ticket6164/trac_6164-mini-aes.patch) by mvngu created at 2009-06-24 21:56:40
...
```json
{
    "body": "<a id='comment:13'></a>Yep that works! positive review again!",
    "created_at": "2009-06-24T22:35:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54554",
    "user": "https://github.com/malb"
}
```

<a id='comment:13'></a>Yep that works! positive review again!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54555",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54556",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6164#issuecomment-54557",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
