...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69041"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69045"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6368#issuecomment-44066",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6368#issuecomment-44067",
    "user": "https://github.com/sagetrac-acleone"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6368",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-69049"
}
```
