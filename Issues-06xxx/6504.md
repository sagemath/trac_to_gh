...
archive/attachments_008016.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_6504_toy_buch.patch](https://github.com/sagemath/sage/files/ticket6504/trac_6504_toy_buch.patch)\n\nPatches are the same, I just forgot to put the ticket number on the first one.",
    "created_at": "2009-07-09T22:54:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6504",
    "type": "issue_comment",
...
archive/attachments_008017.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_008018.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_6504_toy_buch.3.patch](https://github.com/sagemath/sage/files/ticket6504/trac_6504_toy_buch.3.patch)\n\nsupersedes previous versions; better ref manual formatting",
    "created_at": "2009-07-14T03:53:19Z",
    "issue": "https://github.com/sagemath/sage/issues/6504",
    "type": "issue_comment",
...
**Attachment:** [trac_6504_toy_buch.3.patch](https://github.com/sagemath/sage/files/ticket6504/trac_6504_toy_buch.3.patch)
...
archive/attachments_008019.json:
```json
{
    "asset_content_type": "application/octet-stream",
