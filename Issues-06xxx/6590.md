...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47240",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "Attachment [6590-cinit_rebased.patch](https://github.com/sagemath/sage/files/ticket6590/6590-cinit_rebased.patch) by @aghitza created at 2009-08-17 14:06:44\n\nrebased against sage-4.1.1, apply instead of previous patch",
    "created_at": "2009-08-17T14:06:44Z",
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47241",
    "user": "https://github.com/aghitza"
}
```

Attachment [6590-cinit_rebased.patch](https://github.com/sagemath/sage/files/ticket6590/6590-cinit_rebased.patch) by @aghitza created at 2009-08-17 14:06:44
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47242",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47243",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47244",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47245",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6590#issuecomment-47246",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
