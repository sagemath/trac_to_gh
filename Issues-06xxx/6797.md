...
```json
{
    "body": "<a id='comment:1'></a>The Rubik's cube solver (I think) calls a C program. Can it be tested if that C program is compiled correctly?\n\nBut honestly, I don't know what this failure means. I think Robert Bradshaw needs to look at it.",
    "created_at": "2009-08-21T11:05:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63646",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:1'></a>The Rubik's cube solver (I think) calls a C program. Can it be tested if that C program is compiled correctly?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63647",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63649",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63650",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63651",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6797#issuecomment-63652",
    "user": "https://github.com/jdemeyer"
}
```
