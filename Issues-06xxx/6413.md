...
```json
{
    "body": "<a id='comment:1'></a>I wrote the offending line of code, knowing full well that it would not work in the inseparable case.  I may or may not have made a ticket at the time, but likely not.\n\nWhen someone writes code to deal with the inseparable case, just make sure that it continues to be efficient in the separable case!",
    "created_at": "2009-07-09T08:30:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6413",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6413#issuecomment-57742",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>I wrote the offending line of code, knowing full well that it would not work in the inseparable case.  I may or may not have made a ticket at the time, but likely not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6413",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6413#issuecomment-57743",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6413",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6413#issuecomment-57744",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15107"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15108"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15109"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15110"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15111"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15112"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6413#event-15113"
}
```
