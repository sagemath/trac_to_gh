...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6039#issuecomment-51967",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6039",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6039#issuecomment-51968",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6039",
    "rename": {
        "from": "[with patch, needs review] Change name of pari's sum function when imported",
        "to": "[with patch, positive review] Change name of pari's sum function when imported"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6039#event-24212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6039",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6039#issuecomment-51969",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6039",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6039#issuecomment-51970",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6039",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6039#event-24213"
}
```
