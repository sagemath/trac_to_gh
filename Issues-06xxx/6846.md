...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-62998",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "rename": {
        "from": "follow up to #6751: fix warnings when building reference manual",
        "to": "[with patch, needs review] follow up to #6751: fix warnings when building reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6846#event-27694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-62999",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-63000",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-63001",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "rename": {
        "from": "[with patch, needs review] follow up to #6751: fix warnings when building reference manual",
        "to": "[with patch, positive review] follow up to #6751: fix warnings when building reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6846#event-27695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-63002",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6846#event-27696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-63003",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6846#issuecomment-63004",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
