...
```json
{
    "body": "<a id='comment:1'></a>Oh, I forgot: you need to apply the patch at #6585 for the reference manual to build.  This version of Sphinx also prints a lot of new warnings, too.",
    "created_at": "2009-07-22T05:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60686",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>Oh, I forgot: you need to apply the patch at #6585 for the reference manual to build.  This version of Sphinx also prints a lot of new warnings, too.
...
```json
{
    "body": "<a id='comment:3'></a>I think I got this error, too.  Once I deleted doc/output, things worked for me.  (I think there is something stored in the old version of the documentation which confuses the new version of Sphinx.)",
    "created_at": "2009-07-23T02:28:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60688",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>I think I got this error, too.  Once I deleted doc/output, things worked for me.  (I think there is something stored in the old version of the documentation which confuses the new version of Sphinx.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60690",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>With the patch at #6585 and the SPKG, building the reference manual on sage.math takes much longer than previously.",
    "created_at": "2009-07-25T23:34:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60691",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:7'></a>With the patch at #6585 and the SPKG, building the reference manual on sage.math takes much longer than previously.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60692",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Minor progress:  It seems that a custom [autodoc-skip-member](http://sphinx.pocoo.org/ext/autodoc.html?highlight=inherited%20members#skipping-members) method now *overrides* Sphinx's default behavior, which is to skip private methods (`__init__`, etc.).  To keep these out of the reference manual, we might use, e.g.,\n\n```\ndef skip_NestedClass(app, what, name, obj, skip, options):\n    \"\"\"docstring\"\"\"\n    skip_nested = str(obj).find(\"sage.misc.misc\") != -1 and name.find(\"MainClass.NestedClass\") != -1\n    return skip or skip_nested\n```\nin `conf.py`.  Unfortunately, this does not significantly reduce the build time or memory usage.",
    "created_at": "2009-08-01T15:05:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60694",
    "user": "https://github.com/qed777"
}
```

<a id='comment:10'></a>Minor progress:  It seems that a custom [autodoc-skip-member](http://sphinx.pocoo.org/ext/autodoc.html?highlight=inherited%20members#skipping-members) method now *overrides* Sphinx's default behavior, which is to skip private methods (`__init__`, etc.).  To keep these out of the reference manual, we might use, e.g.,
...
```json
{
    "body": "<a id='comment:12'></a>For `sage -docbuild reference html --jsmath`, at least, the results are close:\n\n```\n$ du -s output_v0*\n95550   output_v051\n97392   output_v062\n97388   output_v062_mod\n```\nThe differences are in `environmental.pickle` or stem from using a function as a default argument in\n* `combinat/words/word_content.py`\n* `rings/polynomial/groebner_fan.py`",
    "created_at": "2009-08-01T20:00:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60696",
    "user": "https://github.com/qed777"
}
```

<a id='comment:12'></a>For `sage -docbuild reference html --jsmath`, at least, the results are close:
...
```json
{
    "body": "<a id='comment:13'></a>Clearly, it's time for a break.",
    "created_at": "2009-08-01T20:00:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60697",
    "user": "https://github.com/qed777"
}
```

<a id='comment:13'></a>Clearly, it's time for a break.
...
```json
{
    "body": "<a id='comment:15'></a>Actually, noticing `__weakref__` for that module is what led to the comment about `autodoc-skip-member`.  I think this was before I \"patched\" Sphinx, but I may be mistaken.  I'm also not sure about why `__weakref__` appears spontaneously.  Perhaps a super class?",
    "created_at": "2009-08-02T01:24:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60699",
    "user": "https://github.com/qed777"
}
```

<a id='comment:15'></a>Actually, noticing `__weakref__` for that module is what led to the comment about `autodoc-skip-member`.  I think this was before I "patched" Sphinx, but I may be mistaken.  I'm also not sure about why `__weakref__` appears spontaneously.  Perhaps a super class?
...
```json
{
    "body": "<a id='comment:16'></a>See #6664 for the `autodoc-skip-member` issue.",
    "created_at": "2009-08-02T10:46:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60700",
    "user": "https://github.com/qed777"
}
```

<a id='comment:16'></a>See #6664 for the `autodoc-skip-member` issue.
...
```json
{
    "body": "<a id='comment:17'></a>Also, I've asked about the merits of the `weakref` workaround on [sphinx-dev](http://groups.google.com/group/sphinx-dev).",
    "created_at": "2009-08-02T10:48:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60701",
    "user": "https://github.com/qed777"
}
```

<a id='comment:17'></a>Also, I've asked about the merits of the `weakref` workaround on [sphinx-dev](http://groups.google.com/group/sphinx-dev).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60702",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I should add that this requires a local installation of [GraphViz](http://www.graphviz.org/).",
    "created_at": "2009-08-02T21:26:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60704",
    "user": "https://github.com/qed777"
}
```

<a id='comment:19'></a>I should add that this requires a local installation of [GraphViz](http://www.graphviz.org/).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60706",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>There's been no further activity about the workaround on sphinx-dev.  Since weakrefs appear to work for us, should we add a patch to the spkg?",
    "created_at": "2009-08-14T12:30:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60707",
    "user": "https://github.com/qed777"
}
```

<a id='comment:22'></a>There's been no further activity about the workaround on sphinx-dev.  Since weakrefs appear to work for us, should we add a patch to the spkg?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60708",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [mvngu](#comment%3A23):\n> Replying to [mpatel](#comment%3A22):\n> > There's been no further activity about the workaround on sphinx-dev.  Since weakrefs appear to work for us, should we add a patch to the spkg?\n\n> Hmm... could you make an spkg with that workaround?\n\nI can certainly do it, but not until Monday.",
    "created_at": "2009-08-14T15:01:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60709",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:24'></a>Replying to [mvngu](#comment%3A23):
> Replying to [mpatel](#comment%3A22):
> > There's been no further activity about the workaround on sphinx-dev.  Since weakrefs appear to work for us, should we add a patch to the spkg?
...
```json
{
    "body": "<a id='comment:25'></a>Does the problem described [here](http://groups.google.com/group/sage-devel/browse_thread/thread/fa1f33186d5fd636#) recur with the new spkg?",
    "created_at": "2009-08-20T06:15:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60710",
    "user": "https://github.com/qed777"
}
```

<a id='comment:25'></a>Does the problem described [here](http://groups.google.com/group/sage-devel/browse_thread/thread/fa1f33186d5fd636#) recur with the new spkg?
...
```json
{
    "body": "<a id='comment:28'></a>Does #6664 suppress the private methods?",
    "created_at": "2009-08-23T17:31:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60713",
    "user": "https://github.com/qed777"
}
```

<a id='comment:28'></a>Does #6664 suppress the private methods?
...
```json
{
    "body": "<a id='comment:29'></a>> Does #6664 suppress the private methods?\n\n\nYes, but do we *want* to suppress the private methods?  I actually prefer that they be included in the reference manual.",
    "created_at": "2009-08-23T18:08:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60714",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:29'></a>> Does #6664 suppress the private methods?
...
```json
{
    "body": "<a id='comment:30'></a>Uh oh, it seems as though with this spkg, changes to pyx files are not detected.  That is, build the documentation (say, with the jsmath option).  Then edit a .py file and a .pyx file (I chose sage/misc/latex.py and sage/matrix/matrix0.pyx).  Run 'sage -docbuild reference print_modified_modules': the .py file will be listed, but not the .pyx file.  I can't figure out why this is happening :(",
    "created_at": "2009-08-23T22:37:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60715",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:30'></a>Uh oh, it seems as though with this spkg, changes to pyx files are not detected.  That is, build the documentation (say, with the jsmath option).  Then edit a .py file and a .pyx file (I chose sage/misc/latex.py and sage/matrix/matrix0.pyx).  Run 'sage -docbuild reference print_modified_modules': the .py file will be listed, but not the .pyx file.  I can't figure out why this is happening :(
...
```json
{
    "body": "<a id='comment:33'></a>Okay, I now have a patch which seems to recognize changes to pyx files.  The dependency information is stored in the pickle, so to test this, first delete `SAGEDOC/output/doctrees/`.  The new spkg is available from\n[http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.2.p2.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.2.p2.spkg).\n\nPlease test thoroughly.  (One thing to watch out for: I thought it wasn't working because I was changing sage/matrix/action.pyx and seeing no notification when the reference manual was built, but then I realized that action.pyx isn't even included in the reference manual.  Doh.)",
    "created_at": "2009-09-02T21:20:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60718",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:33'></a>Okay, I now have a patch which seems to recognize changes to pyx files.  The dependency information is stored in the pickle, so to test this, first delete `SAGEDOC/output/doctrees/`.  The new spkg is available from
[http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.2.p2.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.2.p2.spkg).
...
```json
{
    "body": "<a id='comment:34'></a>In case anyone downloaded the version posted yesterday, there is a slightly modified version today: the author of Sphinx posted a patch for the Cython problem to the [Sphinx mercurial site](http://bitbucket.org/birkenfeld/sphinx/changeset/8a434cdb511f/), and so the version today uses that patch instead.  (Mine was similar to his, but why not use the official one?)\n\nI've replaced the old one with the new one, so the link is the same: [http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.2.p2.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.2.p2.spkg).",
    "created_at": "2009-09-03T21:05:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60719",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:34'></a>In case anyone downloaded the version posted yesterday, there is a slightly modified version today: the author of Sphinx posted a patch for the Cython problem to the [Sphinx mercurial site](http://bitbucket.org/birkenfeld/sphinx/changeset/8a434cdb511f/), and so the version today uses that patch instead.  (Mine was similar to his, but why not use the official one?)
...
```json
{
    "body": "<a id='comment:36'></a>For Sage 4.1.2.alpha0's HTML reference manual, at least, the new spkg seems to work just as Georg indicated.  I'll try to do more testing soon.\n\nBy the way, it might be useful to update spkg-install along the lines of #6598 and [this example](http://wiki.sagemath.org/DavidKirkby).  For example,\n\n```/usr/bin/env bash\n\nif [ -z \"$SAGE_LOCAL\" ]; then\n   echo \"SAGE_LOCAL undefined ... exiting\";\n   echo \"Maybe run 'sage -sh'?\"\n   exit 1\nfi\n\nsuccess() {\n    if [ $? -ne 0 ]; then\n        echo \"Error building Sphinx: '$1'\"\n        exit 1\n    fi\n}\n\nset -e\n\necho \"Removing old version...\"\nrm -rf \"$SAGE_LOCAL\"/lib/python/site-packages/Sphinx-*\nsuccess 'deleting previous version'\n\n[...]\n```",
    "created_at": "2009-09-04T07:40:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60721",
    "user": "https://github.com/qed777"
}
```

<a id='comment:36'></a>For Sage 4.1.2.alpha0's HTML reference manual, at least, the new spkg seems to work just as Georg indicated.  I'll try to do more testing soon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60722",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Thanks very much for pointing that out.  I may need to update the spkgs at #5447...",
    "created_at": "2009-09-05T14:30:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60723",
    "user": "https://github.com/qed777"
}
```

<a id='comment:38'></a>Thanks very much for pointing that out.  I may need to update the spkgs at #5447...
...
```json
{
    "body": "<a id='comment:39'></a>Forgive me if I'm mistaken, but doesn't Sphinx>=0.6 depend on Jinja2?\n\n  Incompatible changes:\n\n* Templating now requires the Jinja2 library, which is an enhanced version of the old Jinja1 engine.\n\nhttp://sphinx.pocoo.org/changes.html#release-0-6-mar-24-2009",
    "created_at": "2009-09-05T15:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60724",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:39'></a>Forgive me if I'm mistaken, but doesn't Sphinx>=0.6 depend on Jinja2?
...
```json
{
    "body": "<a id='comment:40'></a>Yes.  I think `site-packages/Jinja2-2.1.1-py2.6-linux-x86_64.egg`, say, is installed automatically (via network) by `python setup.py install` in `spkg-install`.\n\nShould we make it a separate spkg, to supplement or replace `jinja-1.2.p0.spkg`?",
    "created_at": "2009-09-05T16:21:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60725",
    "user": "https://github.com/qed777"
}
```

<a id='comment:40'></a>Yes.  I think `site-packages/Jinja2-2.1.1-py2.6-linux-x86_64.egg`, say, is installed automatically (via network) by `python setup.py install` in `spkg-install`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60726",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>I checked that Sphinx now incorporates changes to included .py and .pyx files.\n\nFor the HTML builder, both `jsmath` and `pngmath` modes appear to work as expected.  \n\nThe PDF reference manual's table of contents is missing.  This may stem from #6885 and my invoking LaTeX's batch mode with `b`.",
    "created_at": "2009-09-05T16:51:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60727",
    "user": "https://github.com/qed777"
}
```

<a id='comment:41'></a>I checked that Sphinx now incorporates changes to included .py and .pyx files.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60728",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60729",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>Okay, I've updated the file SPKG.txt (in [http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.3.p1.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.3.p1.spkg)) to say that it depends on Jinja >= 2.  If you want to post a link to an spkg for jinja, that would be great.",
    "created_at": "2009-09-06T02:09:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60730",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:43'></a>Okay, I've updated the file SPKG.txt (in [http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.3.p1.spkg](http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-0.6.3.p1.spkg)) to say that it depends on Jinja >= 2.  If you want to post a link to an spkg for jinja, that would be great.
...
```json
{
    "body": "<a id='comment:44'></a>Here you go: http://drop.io/jinja2_spkg",
    "created_at": "2009-09-06T03:43:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60731",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:44'></a>Here you go: http://drop.io/jinja2_spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60736",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:49'></a>To cremona: sorry about that.  When you switch versions of Sphinx, you have to delete the old output in the docs directory -- it caches some information there, apparently in ways which are not compatible between versions.  So after you install the spkg, delete the directory SAGE_ROOT/devel/sage/doc/output and try again.  I should change the summary on this ticket to reflect this...\n\nTo timdumol: I see, jinja and jinja2 can coexist on the same system, so for now we can have both.  That's the best solution now, I agree.  (I tried replacing all of the \"import jinja\" lines with \"import jinja2\", but there was a problem with one of them: in sage.ext.gen_interpreters, the line `from jinja.datastructure import ComplainingUndefined` doesn't translate, because there is no jinja2.datastructure.)",
    "created_at": "2009-09-06T17:26:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60737",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:49'></a>To cremona: sorry about that.  When you switch versions of Sphinx, you have to delete the old output in the docs directory -- it caches some information there, apparently in ways which are not compatible between versions.  So after you install the spkg, delete the directory SAGE_ROOT/devel/sage/doc/output and try again.  I should change the summary on this ticket to reflect this...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60739",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60740",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60741",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60742",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60743",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>Both the latest Sphinx and Jinja2 packages appear to install without network activity.  The changes to `install` and `deps` look good to me, but I haven't done a complete installation from scratch.\n\nTo the extent that it counts, my review is positive.",
    "created_at": "2009-09-11T00:54:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60744",
    "user": "https://github.com/qed777"
}
```

<a id='comment:52'></a>Both the latest Sphinx and Jinja2 packages appear to install without network activity.  The changes to `install` and `deps` look good to me, but I haven't done a complete installation from scratch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60745",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:53'></a>Documentation builds perfectly. Sphinx 0.6.3 takes only 2 minutes more `sys` time than 0.5.1 to build all the docs, for me.\n\nHaven't done a complete install yet, but I'll do so once I finish downloading the 4.1.2.alpha2 tarball.",
    "created_at": "2009-09-22T16:37:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60746",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:53'></a>Documentation builds perfectly. Sphinx 0.6.3 takes only 2 minutes more `sys` time than 0.5.1 to build all the docs, for me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60747",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:54'></a>I updated `spkg/install` and `spkg/standard/deps`, replaced the old Sphinx spkg with the new one in `spkg/standard`, and copied the Jinja2 package to `spkg/standard`.  With these changes, `sage -bdist 100` generates the expected binary distributions on sage.math from both binary and compiled source distributions.  Moreover, `sage -sdist 200` makes a source distribution that compiles as expected.\n\nThere's a failed test:\n\n```python\nmpatel@sage sage-200$ ./sage -t devel/sage/sage/misc/trace.py \nsage -t  \"devel/sage/sage/misc/trace.py\"                    \n**********************************************************************\nFile \"/scratch/mpatel/source/sage-200/devel/sage/sage/misc/trace.py\", line 61:\n    sage: print s.before[s.before.find('-'):]\nExpected:\n    ---...\n    ipdb> c\n    2 * 5\nGot:\n    --Call--\n    > /scratch/mpatel/source/sage-200/local/lib/python2.6/site-packages/sage/rings/arith.py(1944)factor()\n       1943 \n    -> 1944 def factor(n, proof=None, int_=False, algorithm='pari', verbose=0, **kwds):\n       1945     \"\"\"\n    \n    ipdb> c\n    2 * 5\n    <BLANKLINE>\n**********************************************************************\n1 items had failures:\n   1 of  10 in __main__.example_1\n***Test Failed*** 1 failures.\nFor whitespace errors, see the file /scratch/mpatel/source/sage-200/tmp/.doctest_trace.py\n         [3.7 s]\nexit code: 1024\n \n----------------------------------------------------------------------\nThe following tests failed:\n\n\n        sage -t  \"devel/sage/sage/misc/trace.py\"\nTotal time for all tests: 3.7 seconds\n```\nI *think* it's not related to this ticket.",
    "created_at": "2009-09-25T12:39:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60748",
    "user": "https://github.com/qed777"
}
```

<a id='comment:54'></a>I updated `spkg/install` and `spkg/standard/deps`, replaced the old Sphinx spkg with the new one in `spkg/standard`, and copied the Jinja2 package to `spkg/standard`.  With these changes, `sage -bdist 100` generates the expected binary distributions on sage.math from both binary and compiled source distributions.  Moreover, `sage -sdist 200` makes a source distribution that compiles as expected.
...
```json
{
    "body": "<a id='comment:55'></a>Problem: Somehow, Sphinx 0.6.3 breaks the sidebar toggle (cf. #6507) in the *live* docs.  In Firebug's console:\n\n```js\nunexpected end of XML source\n<span class=\"math\">('#searchbox').show(0);\n```",
    "created_at": "2009-10-04T14:56:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60749",
    "user": "https://github.com/qed777"
}
```

<a id='comment:55'></a>Problem: Somehow, Sphinx 0.6.3 breaks the sidebar toggle (cf. #6507) in the *live* docs.  In Firebug's console:
...
```json
{
    "body": "<a id='comment:56'></a>Patching Sphinx 0.6.3 should fix this and perhaps also a similar problem reported on [sage-devel](http://groups.google.com/group/sage-devel/browse_thread/thread/bb2d0d7f43efefc9/796d42841bd79c5c?#796d42841bd79c5c): \n\n```diff\n--- sphinx/themes/basic/layout.html.orig        2009-10-04 17:07:16.000000000 -0700\n+++ sphinx/themes/basic/layout.html     2009-10-04 17:07:28.000000000 -0700\n@@ -81,7 +81,7 @@\n               {{ _('Enter search terms or a module, class or function name.') }}\n               </p>\n           </div>\n-          <script type=\"text/javascript\">$('#searchbox').show(0);</script>\n+          <script type=\"text/javascript\">jQuery('#searchbox').show(0);</script>\n           {%- endif %}\n           {%- endblock %}\n         </div>\n```",
    "created_at": "2009-10-05T00:16:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60750",
    "user": "https://github.com/qed777"
}
```

<a id='comment:56'></a>Patching Sphinx 0.6.3 should fix this and perhaps also a similar problem reported on [sage-devel](http://groups.google.com/group/sage-devel/browse_thread/thread/bb2d0d7f43efefc9/796d42841bd79c5c?#796d42841bd79c5c): 
...
```json
{
    "body": "<a id='comment:57'></a>Or perhaps not.",
    "created_at": "2009-10-05T00:22:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60751",
    "user": "https://github.com/qed777"
}
```

<a id='comment:57'></a>Or perhaps not.
...
```json
{
    "body": "<a id='comment:58'></a>mpatel: The problem with the sidebar is caused by compression. Line comments (\"//\") are used in the sidebar code, therefore when the code is compressed, the entire function is commented out. Changing the line comments to block comments (\"/* */\") fixed the problem for me.",
    "created_at": "2009-10-05T18:53:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60752",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:58'></a>mpatel: The problem with the sidebar is caused by compression. Line comments ("//") are used in the sidebar code, therefore when the code is compressed, the entire function is commented out. Changing the line comments to block comments ("/* */") fixed the problem for me.
...
```json
{
    "body": "<a id='comment:59'></a>A patch for the doc sidebar problem is now up at #7126.",
    "created_at": "2009-10-05T19:04:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60753",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:59'></a>A patch for the doc sidebar problem is now up at #7126.
...
```json
{
    "body": "<a id='comment:60'></a>If [comment:ticket:7126:2 this comment] at #7126 is correct, we should still patch `sphinx/themes/basic/layout.html`.  I can do this.",
    "created_at": "2009-10-06T00:26:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60754",
    "user": "https://github.com/qed777"
}
```

<a id='comment:60'></a>If [comment:ticket:7126:2 this comment] at #7126 is correct, we should still patch `sphinx/themes/basic/layout.html`.  I can do this.
...
```json
{
    "body": "<a id='comment:61'></a>Replying to [mpatel](#comment%3A55):\n> Problem: Somehow, Sphinx 0.6.3 breaks the sidebar toggle (cf. #6507) in the *live* docs.  In Firebug's console:\n> \n> ```\n> #!js\n> unexpected end of XML source\n> <span class=\"math\">('#searchbox').show(0);\n> ```\n\n\n#7141 adds a patch that fixes this.",
    "created_at": "2009-10-06T15:38:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60755",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:61'></a>Replying to [mpatel](#comment%3A55):
> Problem: Somehow, Sphinx 0.6.3 breaks the sidebar toggle (cf. #6507) in the *live* docs.  In Firebug's console:
> 
> ```
> #!js
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60756",
...
```json
{
    "body": "<a id='comment:62'></a>Merged both the jinja2 and sphinx in spkg.",
    "created_at": "2009-10-16T04:45:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60757",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:62'></a>Merged both the jinja2 and sphinx in spkg.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6586#issuecomment-60758",
    "user": "https://github.com/mwhansen"
}
```
