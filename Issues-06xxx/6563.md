...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59068",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "rename": {
        "from": "[with patch; needs review] Singular fails to install header files, since it fails to find install-sh",
        "to": "[with spkg, needs review] Singular fails to install header files, since it fails to find install-sh"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6563#event-26503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59069",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "rename": {
        "from": "[with spkg, needs review] Singular fails to install header files, since it fails to find install-sh",
        "to": "[with spkg, positive review] Singular fails to install header files, since it fails to find install-sh"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6563#event-26504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6563#event-26505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59070",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59071",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59072",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59073",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6563#issuecomment-59074",
    "user": "https://github.com/jdemeyer"
}
```
