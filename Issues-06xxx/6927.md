...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76095"
}
```
...
```json
{
    "body": "Changed assignee from **cwitty** to **boothby**",
    "created_at": "2009-09-12T23:27:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
...
Changed assignee from **cwitty** to **boothby**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76096"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76097"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76100"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76104"
}
```
...
```json
{
    ...
    "title_was": "extend CachedFunction to handle disk-cache",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76105"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76106"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76107"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76108"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76109"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6927#issuecomment-50971",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76110"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-76111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6927#issuecomment-50972",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6927#issuecomment-50973",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6927#issuecomment-50974",
    "user": "https://github.com/sagetrac-boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6927#issuecomment-50975",
    "user": "https://github.com/sagetrac-boothby"
}
```
