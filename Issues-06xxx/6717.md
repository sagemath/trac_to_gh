...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6717/trac_6717.patch",
    "created_at": "2009-08-09T19:45:27Z",
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6717/trac_6717.patch",
...
```json
{
    "body": "Attachment [trac_6717.patch](https://github.com/sagemath/sage/files/ticket6717/trac_6717.patch) by @burcin created at 2009-08-09 19:45:27\n\nfix random printing problems in doctests",
    "created_at": "2009-08-09T19:45:27Z",
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48588",
    "user": "https://github.com/burcin"
}
```

Attachment [trac_6717.patch](https://github.com/sagemath/sage/files/ticket6717/trac_6717.patch) by @burcin created at 2009-08-09 19:45:27
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48589",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48590",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48591",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48592",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48593",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-48594",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
