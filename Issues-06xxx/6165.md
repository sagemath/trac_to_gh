...
```json
{
    "body": "<a id='comment:2'></a>The reason for this is to make it trivial to have eigenvector and eigenmatrix functions for symbolic matrices.",
...
<a id='comment:2'></a>The reason for this is to make it trivial to have eigenvector and eigenmatrix functions for symbolic matrices.
...
```json
{
    "body": "<a id='comment:4'></a>Positive review pending a statement from Dodier on this.",
...
<a id='comment:4'></a>Positive review pending a statement from Dodier on this.
...
```json
{
    "body": "<a id='comment:5'></a>I've posted a reply to the thread mentioned above asking that the patch be included in maxima.  I'll check on this later.",
...
<a id='comment:5'></a>I've posted a reply to the thread mentioned above asking that the patch be included in maxima.  I'll check on this later.
...
```json
{
    "body": "<a id='comment:6'></a>Jason, I think this has now been integrated in Maxima 5.19.1.  You can have a look at #6699 to double-check.",
...
<a id='comment:6'></a>Jason, I think this has now been integrated in Maxima 5.19.1.  You can have a look at #6699 to double-check.
...
```json
{
    "body": "<a id='comment:8'></a>From the above comments, it sounds like this ticket can be closed, as it has been superseded.",
...
<a id='comment:8'></a>From the above comments, it sounds like this ticket can be closed, as it has been superseded.
...
```json
{
    "body": "<a id='comment:9'></a>Closing this ticket as a duplicate of #6699.",
...
<a id='comment:9'></a>Closing this ticket as a duplicate of #6699.
