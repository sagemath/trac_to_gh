...
```json
{
    "body": "Attachment [trac_6856-fix_account_settings_cancel.patch](https://github.com/sagemath/sage/files/ticket6856/trac_6856-fix_account_settings_cancel.patch) by @wjp created at 2009-09-01 15:11:55",
    "created_at": "2009-09-01T15:11:55Z",
    "issue": "https://github.com/sagemath/sage/issues/6856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6856#issuecomment-50163",
    "user": "https://github.com/wjp"
}
```

Attachment [trac_6856-fix_account_settings_cancel.patch](https://github.com/sagemath/sage/files/ticket6856/trac_6856-fix_account_settings_cancel.patch) by @wjp created at 2009-09-01 15:11:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6856#issuecomment-50164",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6856#issuecomment-50165",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6856#issuecomment-50166",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6856#issuecomment-50167",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6856#issuecomment-50168",
