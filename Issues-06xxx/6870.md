...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64637",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64640",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64645",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64646",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I think you misunderstood.  My point is that one can ALSO do a check for symbolic expressions, as outlined above (that's what I meant by \"they'll have to pay the microsecond penalty\".  We can't catch every case, of course, but we might as well try to get the ones we know about.  \n\nI hope that these comments are not frustrating; this is overall a good fix to a non-critical but nonetheless important bug.",
    "created_at": "2009-09-21T16:41:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64647",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>I think you misunderstood.  My point is that one can ALSO do a check for symbolic expressions, as outlined above (that's what I meant by "they'll have to pay the microsecond penalty".  We can't catch every case, of course, but we might as well try to get the ones we know about.  
...
```json
{
    "body": "<a id='comment:10'></a>Thanks for the tip, I did not know about the pyobject method. It\ndefinitely improved performance in the symbolic case.\n\nI hope I finally got everything right in version 5 of the patch!",
    "created_at": "2009-09-22T15:01:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64650",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```

<a id='comment:10'></a>Thanks for the tip, I did not know about the pyobject method. It
definitely improved performance in the symbolic case.
...
```json
{
    "body": "<a id='comment:12'></a>You are right, binomial(SR(3/2),SR(1/1)) actually worked (for other\nreasons) but not e.g. binomial(3/2,SR(1/1)). Fixed in new version.",
    "created_at": "2009-09-22T16:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64652",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```

<a id='comment:12'></a>You are right, binomial(SR(3/2),SR(1/1)) actually worked (for other
reasons) but not e.g. binomial(3/2,SR(1/1)). Fixed in new version.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64653",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64654",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64656",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64657",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Incidentally, in the future you may want to name your patches by Trac number and replace ones that are outdated.  Not a big deal, but I know if I don't say it then Minh will :)",
    "created_at": "2009-09-22T18:09:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64658",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>Incidentally, in the future you may want to name your patches by Trac number and replace ones that are outdated.  Not a big deal, but I know if I don't say it then Minh will :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64659",
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [trac_6870-final-v2.patch](tarball://root/attachments/some-uuid/ticket6870/trac_6870-final-v2.patch) by mvngu created at 2009-09-24 11:10:03\n\nThe patch `trac_6870-final-v2.patch` is the same as `trac_6870-final.patch`. The only difference is that I have set the username to Hakan Granath. This is because `trac_6870-final.patch` is a rebase of Hakan's previous patches.",
    "created_at": "2009-09-24T11:10:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64660",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:15'></a>Attachment [trac_6870-final-v2.patch](tarball://root/attachments/some-uuid/ticket6870/trac_6870-final-v2.patch) by mvngu created at 2009-09-24 11:10:03
...
```json
{
    "body": "<a id='comment:17'></a>I do not know what is happening with the file boolean_function.pyx, I can not find it in my version of sage (4.1.1).",
    "created_at": "2009-09-24T11:48:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64662",
    "user": "https://trac.sagemath.org/admin/accounts/users/hgranath"
}
```

<a id='comment:17'></a>I do not know what is happening with the file boolean_function.pyx, I can not find it in my version of sage (4.1.1).
...
```json
{
    "body": "<a id='comment:18'></a>Yeah, I saw that, but couldn't figure out where it came from.  I don't think it's from this, because I got it in a branch without this patch.  Can you try that in a clean branch, Minh?\n\n(Incidentally, this file is in 4.1.2.alpha2, at any rate.)",
    "created_at": "2009-09-24T12:19:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64663",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>Yeah, I saw that, but couldn't figure out where it came from.  I don't think it's from this, because I got it in a branch without this patch.  Can you try that in a clean branch, Minh?
...
```json
{
    "body": "<a id='comment:19'></a>And how do you DO that keeping the name the same thing?",
    "created_at": "2009-09-24T12:20:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64664",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:19'></a>And how do you DO that keeping the name the same thing?
...
```json
{
    "body": "<a id='comment:20'></a>Minh, I tried this again in a branch with no binomial changes, and it is still there.  I am restoring positive review, and suggest that one looks at #6950 and friends for this.  \n\n(Actually, I think it's a true one-liner, because that function depends on the current random state in Sage, and probably somewhere that got reset or changed, so that the \"random\" output isn't really that random. But I leave it the release manager to verify this and open a ticket.)",
    "created_at": "2009-09-24T13:40:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64665",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:20'></a>Minh, I tried this again in a branch with no binomial changes, and it is still there.  I am restoring positive review, and suggest that one looks at #6950 and friends for this.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64666",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64667",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>I believe you, though I have no way of testing this, as I don't plan to build a 64-bit Sage any time soon.  My point is that, as far as I can tell, it should be the subject of its own ticket, not this one.  \n\nIn any case, I an unable to review that part of your patch.  I'm sorry :(",
    "created_at": "2009-09-27T00:32:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64668",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>I believe you, though I have no way of testing this, as I don't plan to build a 64-bit Sage any time soon.  My point is that, as far as I can tell, it should be the subject of its own ticket, not this one.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64669",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64670",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64672",
...
```json
{
    "body": "<a id='comment:25'></a>The patch looks good to me too. Tested on 32 and 64 bit systems.  ~ Adam",
    "created_at": "2009-09-30T07:43:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64673",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:25'></a>The patch looks good to me too. Tested on 32 and 64 bit systems.  ~ Adam
...
```json
{
    "body": "<a id='comment:26'></a>Merged `trac_6870-final-v2.2.patch`.",
    "created_at": "2009-09-30T08:26:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64674",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:26'></a>Merged `trac_6870-final-v2.2.patch`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6870#event-16161"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64675",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6870#issuecomment-64676",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
