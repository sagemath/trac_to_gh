...
```json
{
    ...
    "type": "issue",
    "updated_at": "2009-11-29T10:38:15Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64564"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64566"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64567"
}
```
...
```json
{
    "body": "**Attachment:** [config.log](https://github.com/sagemath/sage/files/ticket6453/config.log)\n\nconfig.log showing no optimisation on the command line. Still 20 tests fail",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6453",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6453#issuecomment-45139",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64570"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64571"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64573"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64574"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6453",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6453#event-64576"
}
```
