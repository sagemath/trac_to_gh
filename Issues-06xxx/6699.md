...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62372",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62374",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>So it seems that a number of doctests need to be fixed.  I'm marking this as \"needs work\", although the spkg itself seems fine, we just need a patch that fixes the doctests.\n\nNote that interfaces/maxima.py is most likely not the only file affected by this.",
    "created_at": "2009-08-17T10:06:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62376",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:4'></a>So it seems that a number of doctests need to be fixed.  I'm marking this as "needs work", although the spkg itself seems fine, we just need a patch that fixes the doctests.
...
```json
{
    "body": "<a id='comment:5'></a>After creating this ticket, a newer Maxima was released. The spkg can be found here\n\nhttp://sage.math.washington.edu/home/kirkby/Solaris-fixes/maxima-5.19.1/",
    "created_at": "2009-08-21T05:59:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62377",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>After creating this ticket, a newer Maxima was released. The spkg can be found here
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62379",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62380",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [maxima_doctests.patch](tarball://root/attachments/some-uuid/ticket6699/maxima_doctests.patch) by @golam-m-hossain created at 2009-08-21 13:30:25\n\nReplying to [AlexGhitza](#comment%3A6):\n\n> {{{\n\n sage -t  \"expression.pyx\"                                   \n**********************************************************************\n File \"/opt/sage-4.1.1/devel/sage-main/sage/symbolic/expression.pyx\", line 5541:\n     sage: solve(Q*sqrt(Q^2 + 2) - 1,Q)\n Expected:\n     [Q == 1/sqrt(-sqrt(2) + 1), Q == 1/sqrt(sqrt(2) + 1)]\n Got:\n     [Q == 1/sqrt(sqrt(2) + 1)]\n **********************************************************************\n }}}\n> \n> I think this is due to the fact that Maxima now only returns the real solution, and ignores the complex solution.  I'm not sure what we should do about this.\n\n\nI think you are right. Maxima treats variables to be real by default. To see that in maxima\n\n```\nsage: !maxima\nMaxima 5.16.3 http://maxima.sourceforge.net\nUsing Lisp ECL 9.4.1\nDistributed under the GNU Public License. See the file COPYING.\nDedicated to the memory of William Schelter.\nThe function bug_report() provides bug reporting information.\n(%i1) conjugate(Q);\n(%o1)                                  Q\n```\n\nSo, if maxima is throwing away complex solution then its consistent with its own assumptions. \nUnless someone else has different opinion then we should simply accept what maxima is returning\nnow.",
    "created_at": "2009-08-21T13:30:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62381",
    "user": "https://github.com/golam-m-hossain"
}
```

<a id='comment:7'></a>Attachment [maxima_doctests.patch](tarball://root/attachments/some-uuid/ticket6699/maxima_doctests.patch) by @golam-m-hossain created at 2009-08-21 13:30:25
...
```json
{
    "body": "<a id='comment:8'></a>Actually, I was wrong.  This is a bug in Maxima, which used to give the right answer but doesn't any more.  See \n\nhttp://www.math.utexas.edu/pipermail/maxima/2009/017632.html\n\nfor a discussion of this.",
    "created_at": "2009-08-22T12:03:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62382",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:8'></a>Actually, I was wrong.  This is a bug in Maxima, which used to give the right answer but doesn't any more.  See 
...
```json
{
    "body": "<a id='comment:9'></a>We might have to get Maxima's \"solutions\" and check them before returning them to the user.  This is a pain.",
    "created_at": "2009-08-22T12:06:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62383",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:9'></a>We might have to get Maxima's "solutions" and check them before returning them to the user.  This is a pain.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62384",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>OK, I have come up with a workaround for Maxima's bug.  Since we are now patching Maxima 5.19.1, I've made a new spkg with \"bumped\" version number:\n\nhttp://sage.math.washington.edu/home/ghitza/maxima-5.19.1.p0.spkg\n\nI will soon explain my workaround here to facilitate reviewing, but I thought I'd first put the spkg up in case people want to test it.",
    "created_at": "2009-08-24T01:16:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62385",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:10'></a>OK, I have come up with a workaround for Maxima's bug.  Since we are now patching Maxima 5.19.1, I've made a new spkg with "bumped" version number:
...
```json
{
    "body": "<a id='comment:12'></a>Note to the release manager: when this gets merged, the following tickets should be closed as fixed (they are all contained in this patch):\n\n#6782, #6783, #6784, #6785, #6786, #6787, #6789, #6792",
    "created_at": "2009-08-24T08:12:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62387",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:12'></a>Note to the release manager: when this gets merged, the following tickets should be closed as fixed (they are all contained in this patch):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62388",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Merged `maxima-5.19.1.p0.spkg` in the standard packages repository and applied the patch `maxima_doctests.patch`. See my comments at #6564 for test results on various platforms.",
    "created_at": "2009-09-02T10:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62391",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:15'></a>Merged `maxima-5.19.1.p0.spkg` in the standard packages repository and applied the patch `maxima_doctests.patch`. See my comments at #6564 for test results on various platforms.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62392",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62393",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62394",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>See #6883 for a follow-up to this ticket.",
    "created_at": "2009-09-04T06:40:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6699#issuecomment-62395",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:16'></a>See #6883 for a follow-up to this ticket.
