...
archive/attachments_007334.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "gap_interface_reg_expr.patch",
    "asset_url": "tarball://root/attachments/ticket6208/gap_interface_reg_expr.patch",
    "created_at": "2009-06-04T11:54:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6208/gap_interface_reg_expr.patch",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment [gap_interface_reg_expr.patch](https://github.com/sagemath/sage/files/ticket6208/gap_interface_reg_expr.patch) by @simon-king-jena created at 2009-06-04 11:54:50\n\nImproved performance of the gap interface by pre-compiling regular expressions",
    "created_at": "2009-06-04T11:54:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42564",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [gap_interface_reg_expr.patch](https://github.com/sagemath/sage/files/ticket6208/gap_interface_reg_expr.patch) by @simon-king-jena created at 2009-06-04 11:54:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42565",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42566",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6208#event-40274"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42567",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6208#event-40275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6208#event-40276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42568",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42569",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42570",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42571",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6208#issuecomment-42572",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6208#event-40277"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6208#event-40278"
}
```
