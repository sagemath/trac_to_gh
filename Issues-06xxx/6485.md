...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44199",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44200",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44201",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78310"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44202",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44203",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-78313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44204",
    "user": "https://github.com/qed777"
}
```
