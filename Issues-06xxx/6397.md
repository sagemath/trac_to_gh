...
```json
{
    ...
    "rename": {
        "from": "implement general Newton's method root finding for power series rings",
        "to": "[with patch, needs work] implement general Newton's method root finding for power series rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6397#event-25759"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6397#issuecomment-56378",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6397#issuecomment-56379",
    "user": "https://github.com/ncalexan"
}
```
