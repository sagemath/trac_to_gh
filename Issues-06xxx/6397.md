...
```json
{
    "body": "<a id='comment:1'></a>Here's a stand-alone implementation that needs to be plugged into the hell that is `polynomial.roots()`.",
    "created_at": "2009-06-24T20:06:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6397",
    "type": "issue_comment",
...
<a id='comment:1'></a>Here's a stand-alone implementation that needs to be plugged into the hell that is `polynomial.roots()`.
