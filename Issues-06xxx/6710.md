...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62465",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62466",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62467",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "created_at": "2009-12-03T04:12:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62468",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Can you try the new Maxima with this?  There isn't an spkg available yet but hopefully will be soon. See [http://groups.google.com/group/sage-devel/browse_thread/thread/bbd2c801032392f7](http://groups.google.com/group/sage-devel/browse_thread/thread/bbd2c801032392f7)",
    "created_at": "2009-12-21T02:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62469",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Can you try the new Maxima with this?  There isn't an spkg available yet but hopefully will be soon. See [http://groups.google.com/group/sage-devel/browse_thread/thread/bbd2c801032392f7](http://groups.google.com/group/sage-devel/browse_thread/thread/bbd2c801032392f7)
...
```json
{
    "body": "<a id='comment:5'></a>How many of the open tickets mentioned in the description are still problems?",
    "created_at": "2010-09-01T10:18:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62470",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>How many of the open tickets mentioned in the description are still problems?
...
```json
{
    "body": "<a id='comment:6'></a>Bump - a number of these have been closed, and perhaps some others are solved.  Since Solaris is now a supported platform at least some of the time, it would be helpful to have an update.",
    "created_at": "2011-08-19T13:51:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62471",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Bump - a number of these have been closed, and perhaps some others are solved.  Since Solaris is now a supported platform at least some of the time, it would be helpful to have an update.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15842"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15843"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15844"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15845"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15846"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15847"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15848"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15849"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62472",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62473",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6710#event-15851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6710#issuecomment-62474",
