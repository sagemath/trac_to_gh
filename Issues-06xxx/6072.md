...
```json
{
    "body": "<a id='comment:5'></a>\nHere is a git branch\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[d43eb4f](http://git.sagemath.org/sage.git/commit/?id=d43eb4f1f63db5949261331f87d1f514988eef7e)|`Fix trac #6072 (bug in _coerce_cusp for certain GammaH spaces).`|",
