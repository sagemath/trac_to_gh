...
```json
{
    "body": "<a id='comment:1'></a>I'm not sure how to fix this. Should I add \"# random numerical noise\" in addition to \"# requires optional octave\"? By the way, octave is not strictly speaking an optional package is it?",
...
<a id='comment:1'></a>I'm not sure how to fix this. Should I add "# random numerical noise" in addition to "# requires optional octave"? By the way, octave is not strictly speaking an optional package is it?
...
<a id='comment:2'></a>Reply by email:
