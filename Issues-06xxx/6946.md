...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6946/sage-4.1.1-list_plot.patch",
...
```json
{
    "body": "delaunay rpm patch",
    "created_at": "2009-09-16T20:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52410",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52411",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52412",
    "user": "https://github.com/fredrik-johansson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52413",
    "user": "https://github.com/fredrik-johansson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52414",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52415",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52416",
...
archive/attachments_008338.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage-4.1.1-mpmath.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket6946/sage-4.1.1-mpmath.patch",
    "created_at": "2011-03-15T05:34:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52417",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52418",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6946#event-47260"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6946#event-47261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52419",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6946#event-47262"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6946#event-47263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6946#issuecomment-52420",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6946#event-47264"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6946#event-47265"
}
```
