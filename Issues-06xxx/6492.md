# Issue 6492: [with patch; positive review] ratpoints -- new spkg is broken on OS X 64-bit
...
```json
{
    ...
    "title": "[with patch; positive review] ratpoints -- new spkg is broken on OS X 64-bit",
    "type": "issue",
