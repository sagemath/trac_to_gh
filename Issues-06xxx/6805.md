...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6805_integrality_check_in_lattice_polytope.patch](https://github.com/sagemath/sage/files/ticket6805/trac_6805_integrality_check_in_lattice_polytope.patch) by mhampton created at 2009-10-29 18:42:50\n\nSeems like a reasonable change, and tests out OK, so positive review.",
    "created_at": "2009-10-29T18:42:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6805#issuecomment-49580",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6805#issuecomment-49581",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6805#issuecomment-49582",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6805#issuecomment-49583",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6805#issuecomment-49584",
    "user": "https://github.com/mwhansen"
}
```
