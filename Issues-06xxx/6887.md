...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6887/URSS_Poster_Computing_Elliptic_Curve_Isogenies_October_2009.pdf",
...
```json
{
    "body": "poster by Jenny for an exhibition at U of Warwick",
    "created_at": "2009-11-09T09:22:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6887",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6887/trac_6887-isogeny.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6887/trac_6887-isogeny2.patch",
...
```json
{
    "body": "Replaces previous, applies to 4.3.alpha1",
    "created_at": "2009-12-09T20:20:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6887",
    "type": "issue_comment",
