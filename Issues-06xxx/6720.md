...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81503"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81504"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6720#issuecomment-47112",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6720#issuecomment-47113",
    "user": "https://github.com/sagetrac-jkantor"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6720#issuecomment-47114",
    "user": "https://github.com/sagetrac-jkantor"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6720#event-81507"
}
```
