# Issue 6334: [with patch, needs work] optional doctest failure -- broken finance doctest failures
...
```json
{
    ...
    "title": "[with patch, needs work] optional doctest failure -- broken finance doctest failures",
    "type": "issue",
