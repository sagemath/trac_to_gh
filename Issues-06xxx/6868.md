...
```json
{
    "body": "<a id='comment:2'></a>ncohen --- Can you also provide a local copy of the spkg under your sage.math home dir?",
...
<a id='comment:2'></a>ncohen --- Can you also provide a local copy of the spkg under your sage.math home dir?
...
```json
{
    "body": "<a id='comment:3'></a>Done : /home/ncohen/cbc-2.3.p0.spkg",
...
<a id='comment:3'></a>Done : /home/ncohen/cbc-2.3.p0.spkg
...
<a id='comment:4'></a>Updated package at
...
<a id='comment:5'></a>Merged in the optional packages repository at
