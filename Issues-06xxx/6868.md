...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63287",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63288",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "rename": {
        "from": "[with SPKG, needs review] Coin-OR CBC ( compatible with the symbolics from MIP )",
        "to": "[with spkg, needs review] Coin-OR CBC ( compatible with the symbolics from MIP )"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6868#event-27795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63289",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63290",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63291",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with spkg, needs review] Coin-OR CBC ( compatible with the symbolics from MIP )",
        "to": "[with spkg, positive review] Coin-OR CBC ( compatible with the symbolics from MIP )"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6868#event-27796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63292",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6868#event-27797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63293",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63294",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6868#issuecomment-63295",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
