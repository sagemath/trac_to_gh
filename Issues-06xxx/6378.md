...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44163",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41637"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41638"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41639"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41640"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41641"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44164",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44165",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44166",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6378/scripts-6378-automerge.patch",
    "created_at": "2009-06-26T05:48:28Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6378/scripts-6378-automerge.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "Attachment [scripts-6378-automerge.patch](https://github.com/sagemath/sage/files/ticket6378/scripts-6378-automerge.patch) by boothby created at 2009-06-26 05:48:28\n\nflattened & based on 4.0.2",
    "created_at": "2009-06-26T05:48:28Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44167",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

Attachment [scripts-6378-automerge.patch](https://github.com/sagemath/sage/files/ticket6378/scripts-6378-automerge.patch) by boothby created at 2009-06-26 05:48:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44168",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44169",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44170",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41644"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44171",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44172",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44173",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6378/trac-6378-bin.patch",
    "created_at": "2009-08-28T07:22:52Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6378/trac-6378-bin.patch",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "Attachment [trac-6378-bin.patch](https://github.com/sagemath/sage/files/ticket6378/trac-6378-bin.patch) by @craigcitro created at 2009-08-28 07:22:52\n\napply to main repo",
    "created_at": "2009-08-28T07:22:52Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44174",
    "user": "https://github.com/craigcitro"
}
```

Attachment [trac-6378-bin.patch](https://github.com/sagemath/sage/files/ticket6378/trac-6378-bin.patch) by @craigcitro created at 2009-08-28 07:22:52
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6378/trac-6378-main.patch",
    "created_at": "2009-08-31T13:17:57Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6378/trac-6378-main.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44176",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44177",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44178",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-44179",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6378/trac_6378-scripts-rebase.patch",
    "created_at": "2010-04-18T13:23:22Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6378/trac_6378-scripts-rebase.patch",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6378/trac_6378-scripts-rebase.v2.patch",
    "created_at": "2010-06-23T21:16:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6378/trac_6378-scripts-rebase.v2.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [trac_6378-scripts-rebase.v2.patch](https://github.com/sagemath/sage/files/ticket6378/trac_6378-scripts-rebase.v2.patch) by @jhpalmieri created at 2010-06-23 21:16:05\n\nuse this patch only",
    "created_at": "2010-06-23T21:16:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
...
Attachment [trac_6378-scripts-rebase.v2.patch](https://github.com/sagemath/sage/files/ticket6378/trac_6378-scripts-rebase.v2.patch) by @jhpalmieri created at 2010-06-23 21:16:05
...
```json
{
    ...
    "label": "component: build",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41645"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41646"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41648"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-41649"
}
```
