...
```json
{
    "body": "<a id='comment:1'></a>I should mention, this is OS X 10.4 with a 2.33 core duo. (OS X is known to be particularly bad, but < 1 second shouldn't be unreasonable.)",
    "created_at": "2009-06-05T10:17:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6224#issuecomment-55268",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>I should mention, this is OS X 10.4 with a 2.33 core duo. (OS X is known to be particularly bad, but < 1 second shouldn't be unreasonable.)
