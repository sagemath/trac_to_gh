# Issue 6807: [with patch, positive review] bug in blocks_and_cut_vertices() of a graph where a cut vertex can be listed more than once
...
```json
{
    ...
    "title": "[with patch, positive review] bug in blocks_and_cut_vertices() of a graph where a cut vertex can be listed more than once",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6807#issuecomment-62421",
    "user": "https://trac.sagemath.org/admin/accounts/users/hartke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "rename": {
        "from": "bug in blocks_and_cut_vertices() of a graph where a cut vertex can be listed more than once",
        "to": "[with patch, needs review] bug in blocks_and_cut_vertices() of a graph where a cut vertex can be listed more than once"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6807#event-27550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6807#issuecomment-62422",
    "user": "https://trac.sagemath.org/admin/accounts/users/hartke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "rename": {
        "from": "[with patch, needs review] bug in blocks_and_cut_vertices() of a graph where a cut vertex can be listed more than once",
        "to": "[with patch, positive review] bug in blocks_and_cut_vertices() of a graph where a cut vertex can be listed more than once"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6807#event-27551"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6807#issuecomment-62423",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6807#event-27552"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6807#event-27553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6807#issuecomment-62424",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6807#issuecomment-62425",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6807#issuecomment-62426",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
