...
```json
{
    "body": "Attachment [twist.py](https://github.com/sagemath/sage/files/ticket6683/twist.py) by NoSyu created at 2009-08-07 21:29:33\n\nDelete message in Worksheet_rating_info and Worksheet_rate class from Sage 4.1 original source file server/notebook/twist.py",
    "created_at": "2009-08-07T21:29:33Z",
    "issue": "https://github.com/sagemath/sage/issues/6683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6683#issuecomment-48376",
    "user": "https://trac.sagemath.org/admin/accounts/users/NoSyu"
}
```

Attachment [twist.py](https://github.com/sagemath/sage/files/ticket6683/twist.py) by NoSyu created at 2009-08-07 21:29:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6683#issuecomment-48377",
    "user": "https://trac.sagemath.org/admin/accounts/users/NoSyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6683#issuecomment-48378",
