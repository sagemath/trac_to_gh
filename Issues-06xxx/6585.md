...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71916"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71917"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71918"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47123",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47124",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47125",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47126",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-71923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47127",
    "user": "https://github.com/sagetrac-mvngu"
}
```
