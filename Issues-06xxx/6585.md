...
```json
{
    "body": "Attachment [trac_6585-backslash.patch](https://github.com/sagemath/sage/files/ticket6585/trac_6585-backslash.patch) by @jhpalmieri created at 2009-07-22 05:04:57",
    "created_at": "2009-07-22T05:04:57Z",
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47099",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [trac_6585-backslash.patch](https://github.com/sagemath/sage/files/ticket6585/trac_6585-backslash.patch) by @jhpalmieri created at 2009-07-22 05:04:57
...
```json
{
    "body": "Attachment [trac_6585-fix-warnings.patch](https://github.com/sagemath/sage/files/ticket6585/trac_6585-fix-warnings.patch) by mvngu created at 2009-07-24 08:17:35\n\nfix warning when building HTML version of sage/combinat/partition.py",
    "created_at": "2009-07-24T08:17:35Z",
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47100",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Attachment [trac_6585-fix-warnings.patch](https://github.com/sagemath/sage/files/ticket6585/trac_6585-fix-warnings.patch) by mvngu created at 2009-07-24 08:17:35
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47101",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47102",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-47103",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
