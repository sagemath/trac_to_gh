...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-56998",
...
```json
{
    "body": "<a id='comment:1'></a>For the record, this caused some actual problems for a potential Sage user recently, so it should get fixed - and soon.  Probably we'll need to make polygon=polygon2d (for 2d input) for deprecation reasons, for now.",
    "created_at": "2010-07-27T17:25:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-56999",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>For the record, this caused some actual problems for a potential Sage user recently, so it should get fixed - and soon.  Probably we'll need to make polygon=polygon2d (for 2d input) for deprecation reasons, for now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57000",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57001",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Unfortunately this is pretty hard to change since `polygon` is expected to work for two and three D input.  This patch does take care of the problem.",
    "created_at": "2012-05-26T21:11:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57002",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>Unfortunately this is pretty hard to change since `polygon` is expected to work for two and three D input.  This patch does take care of the problem.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_6367-polygon.patch](tarball://root/attachments/some-uuid/ticket6367/trac_6367-polygon.patch) by @kcrisman created at 2012-05-26 21:13:27\n\n> Unfortunately this is pretty hard to change since `polygon` is expected to work for two and three D input.\n\nWhat I mean, of course, is that it would be hard to change since users probably are using it this way a lot and the deprecation period and all simply isn't worth the effort at this point.  Anyway, needs review.",
    "created_at": "2012-05-26T21:13:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57003",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Attachment [trac_6367-polygon.patch](tarball://root/attachments/some-uuid/ticket6367/trac_6367-polygon.patch) by @kcrisman created at 2012-05-26 21:13:27
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57004",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Oops, totally forgot about #12214, which is a dup of this.  Given that #12214 is virtually the same ticket, this one is much older, and the patch is quite similar, I'm adding the author there to this ticket and closing that one.",
    "created_at": "2012-05-27T06:50:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57005",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Oops, totally forgot about #12214, which is a dup of this.  Given that #12214 is virtually the same ticket, this one is much older, and the patch is quite similar, I'm adding the author there to this ticket and closing that one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57006",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57007",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57008",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing merged from \"\" to \"sage-5.4.1.rc0\"",
    "created_at": "2012-11-11T09:48:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57009",
    "user": "https://github.com/jdemeyer"
}
```

Changing merged from "" to "sage-5.4.1.rc0"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6367#issuecomment-57010",
    "user": "https://github.com/jdemeyer"
}
```
