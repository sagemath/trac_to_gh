...
```json
{
    "body": "Attachment [trac_6024-doctest-fix.patch](https://github.com/sagemath/sage/files/ticket6024/trac_6024-doctest-fix.patch) by mabshoff created at 2009-05-12 06:14:17",
    "created_at": "2009-05-12T06:14:17Z",
    "issue": "https://github.com/sagemath/sage/issues/6024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6024#issuecomment-40788",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [trac_6024-doctest-fix.patch](https://github.com/sagemath/sage/files/ticket6024/trac_6024-doctest-fix.patch) by mabshoff created at 2009-05-12 06:14:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6024#issuecomment-40789",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6024#issuecomment-40790",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6024#issuecomment-40791",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6024#issuecomment-40792",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6024#issuecomment-40793",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
