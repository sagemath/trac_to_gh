...
```json
{
    "body": "<a id='comment:1'></a>Here's another optional doctest failure in the sage/axiom/fricas interface:\n\n```\n**********************************************************************\nFile \"/scratch/wstein/build/sage-4.0.2.alpha3/devel/sage-main/sage/rings/integer_mod_ring.py\", line 301:\n    sage: fricas(Z7) #optional - fricas\nExpected:\n    IntegerMod(7)\nGot:\n    IntegerMod 7\n**********************************************************************\n2 items had failures:\n   2 of   4 in __main__.example_6\n```",
    "created_at": "2009-06-16T14:55:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56292",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Here's another optional doctest failure in the sage/axiom/fricas interface:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56296",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56297",
...
```json
{
    "body": "<a id='comment:5'></a>Adding an __init__ method to the FriCAS class should clear up a few issues.",
    "created_at": "2009-06-21T13:48:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56298",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:5'></a>Adding an __init__ method to the FriCAS class should clear up a few issues.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56299",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56300",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Most changes were in the axiom.py and fricas.py files in the interfaces. \nChanges:\n* init method for FriCAS class should call fricas instead of axiom\n* expected output from fricas changed for some things e.g. Tuple PositiveInteger ==> Tuple(PositiveInteger)\n* fix fricas_init in sage_object\n* add equality symbol",
    "created_at": "2009-06-27T12:00:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56301",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:6'></a>Most changes were in the axiom.py and fricas.py files in the interfaces. 
Changes:
* init method for FriCAS class should call fricas instead of axiom
* expected output from fricas changed for some things e.g. Tuple PositiveInteger ==> Tuple(PositiveInteger)
* fix fricas_init in sage_object
...
```json
{
    "body": "<a id='comment:7'></a>See also ticket #6517 for an spkg of FriCAS 1.0.7.",
    "created_at": "2009-07-12T12:10:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56302",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:7'></a>See also ticket #6517 for an spkg of FriCAS 1.0.7.
...
```json
{
    "body": "<a id='comment:9'></a>This patch assumes a separate Fricas and Axiom. Axiom was tested using an installed system axiom. I may have not understood something but fricas no longer provides an 'axiom' script. That is, it not longer pretends to be axiom. \n\nMy reading of this thread is that the name axiom is not to used for fricas.\nhttp://trac.sagemath.org/sage_trac/ticket/5111\n\nThis thread points out a deviation where fricas is now different then axiom.\nhttp://groups.google.com/group/fricas-devel/browse_thread/thread/86bff34da5720955#\n\nAdam",
    "created_at": "2009-07-24T06:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56303",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:9'></a>This patch assumes a separate Fricas and Axiom. Axiom was tested using an installed system axiom. I may have not understood something but fricas no longer provides an 'axiom' script. That is, it not longer pretends to be axiom. 
...
```json
{
    "body": "<a id='comment:10'></a>Just to clarify. My understanding is that the name Axiom is only for Axiom for copyright reasons and Sage now uses Fricas. As the two programs diverge it seems unreasonable to have an 'axiom' script' point to fricas. However, I may be totally confused about this. \n\nAdam",
    "created_at": "2009-07-24T16:58:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56304",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:10'></a>Just to clarify. My understanding is that the name Axiom is only for Axiom for copyright reasons and Sage now uses Fricas. As the two programs diverge it seems unreasonable to have an 'axiom' script' point to fricas. However, I may be totally confused about this. 
...
```json
{
    "body": "<a id='comment:11'></a>I ran the doctests for axiom.py and fricas.py using axiom (compiled from source -July 2009), and fricas 1.0.8 (from #6517). All tests passed on sage 4.2.1.alpha0.  \n\nAdam",
    "created_at": "2009-11-14T13:55:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56305",
    "user": "https://github.com/maxthemouse"
}
```

<a id='comment:11'></a>I ran the doctests for axiom.py and fricas.py using axiom (compiled from source -July 2009), and fricas 1.0.8 (from #6517). All tests passed on sage 4.2.1.alpha0.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56306",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56307",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56308",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56309",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6318#event-14805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56310",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56311",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6318#issuecomment-56312",
    "user": "https://github.com/fchapoton"
}
```
