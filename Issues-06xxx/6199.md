...
```json
{
    "body": "<a id='comment:2'></a>We could make an action on Integers by ints.",
    "created_at": "2009-06-05T11:13:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-54995",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>We could make an action on Integers by ints.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-54996",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-54997",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-54998",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55000",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55002",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>If we're going to special case, we could override `__mul__` for Integer directly, rather than stick stuff in `Element.__mul__`. That's \"breaking the rules\" even more though. Alternatively, we could add a `cdef Element _mul_long(self, long n)` method which is checked for right after the parents aren't the same. This is a bit hackish, but would provide a good avenue for improvements for other types as well (QQ, RDF). Do we need addition as well? (No, I don't think this should be extended to other operands...)\n\nNote that \n\n```\nsage: timeit(\"a\", number=10**6)\n1000000 loops, best of 3: 58.1 ns per loop\n```\n\nso I wrote my own\n\n```\ndef time_mul(a, b, long n):\n    cdef long i\n    for i in range(n):\n        a*b\n```\n\nWith this, I did a special _mul_long method. \n\nBefore:\n\n```\nsage: a = 123 ; b = 456 ; c = 456r ; y = RDF(pi)\nsage: a*c, a*y\n(56088, 386.415896392)\nsage: %time time_mul(a,b, 10**7)\nCPU times: user 1.13 s, sys: 0.00 s, total: 1.13 s\nWall time: 1.13 s\nsage: %time time_mul(a,c, 10**7)\nCPU times: user 17.14 s, sys: 0.04 s, total: 17.18 s\nWall time: 17.25 s\nsage: %time time_mul(a,y, 10**7)\nCPU times: user 8.21 s, sys: 0.02 s, total: 8.24 s\nWall time: 8.25 s\n```\n\nAfter:\n\n```\nsage: a = 123 ; b = 456 ; c = 456r ; y = RDF(pi)\nsage: a*c, a*y\n(56088, 386.415896392)\nsage: %time time_mul(a,b, 10**7)\nCPU times: user 1.16 s, sys: 0.00 s, total: 1.16 s\nWall time: 1.17 s\nsage: %time time_mul(a,c, 10**7)\nCPU times: user 0.95 s, sys: 0.00 s, total: 0.96 s\nWall time: 0.96 s\nsage: %time time_mul(a,y, 10**7)\nCPU times: user 8.52 s, sys: 0.02 s, total: 8.54 s\nWall time: 8.57 s\n```\n\nI'm leaning towards it being worth it, on the right only, for * and + only. The cost is (on my machine) an extra 25ns per non-identical-parents operation, which are at the cheapest is at least 100s of ns.",
    "created_at": "2010-01-22T08:29:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55003",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:6'></a>If we're going to special case, we could override `__mul__` for Integer directly, rather than stick stuff in `Element.__mul__`. That's "breaking the rules" even more though. Alternatively, we could add a `cdef Element _mul_long(self, long n)` method which is checked for right after the parents aren't the same. This is a bit hackish, but would provide a good avenue for improvements for other types as well (QQ, RDF). Do we need addition as well? (No, I don't think this should be extended to other operands...)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55004",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>So what is the milestone for this ticket? Is it still a \"wontfix\"?",
    "created_at": "2010-01-22T14:45:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55006",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:8'></a>So what is the milestone for this ticket? Is it still a "wontfix"?
...
```json
{
    "body": "<a id='comment:10'></a>Multiplication on the left has less to gain, as it's going to try to call int.__mul__ before falling back to this code. Do you think it's worth doubling the general case penalty to support a smaller relative gain? People who care about timings this small (e.g. mpmath) can follow such rules, or ideally write Cython directly. I wrote a mode once that was verbose about all the coercions used, I could resurrect that somewhere for more easily tracking down stuff like this. \n\nFWIW, I put `_mul_long` onto ModuleElement, not just RingElement. The extra indirection needed to put it in coerce.pyx will make it at least 50% or more slower, probably much more.",
    "created_at": "2010-01-22T19:22:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55008",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:10'></a>Multiplication on the left has less to gain, as it's going to try to call int.__mul__ before falling back to this code. Do you think it's worth doubling the general case penalty to support a smaller relative gain? People who care about timings this small (e.g. mpmath) can follow such rules, or ideally write Cython directly. I wrote a mode once that was verbose about all the coercions used, I could resurrect that somewhere for more easily tracking down stuff like this. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55010",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Robert -- looks good, just needs some doctests.",
    "created_at": "2010-01-22T22:42:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55011",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:12'></a>Robert -- looks good, just needs some doctests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55012",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55013",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55014",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>OK, I've uploaded a new patch.",
    "created_at": "2010-01-24T08:27:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55015",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:14'></a>OK, I've uploaded a new patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55016",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Looks good. One question, though: why do a test and use `mpz_add_ui` instead of just using `mpz_add_si`? It obviously works, I'm just wondering if you know something about the relative speed that I don't.",
    "created_at": "2010-01-24T17:45:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55017",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:15'></a>Looks good. One question, though: why do a test and use `mpz_add_ui` instead of just using `mpz_add_si`? It obviously works, I'm just wondering if you know something about the relative speed that I don't.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55018",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [6199-fast-mul-fix.patch](tarball://root/attachments/some-uuid/ticket6199/6199-fast-mul-fix.patch) by @fredrik-johansson created at 2010-02-01 01:37:27\n\nI applied this and got roughly a 15% speedup for mpmath's test suite, with everything seemingly working, so +1 from me.",
    "created_at": "2010-02-01T01:37:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55019",
    "user": "https://github.com/fredrik-johansson"
}
```

<a id='comment:16'></a>Attachment [6199-fast-mul-fix.patch](tarball://root/attachments/some-uuid/ticket6199/6199-fast-mul-fix.patch) by @fredrik-johansson created at 2010-02-01 01:37:27
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55020",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Attachment [6199-fast-int-mul-all.patch](tarball://root/attachments/some-uuid/ticket6199/6199-fast-int-mul-all.patch) by @robertwb created at 2010-02-01 21:14:06\n\nAttached a new patch which cleans up subtraction and note about corner case.",
    "created_at": "2010-02-01T21:14:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55021",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:17'></a>Attachment [6199-fast-int-mul-all.patch](tarball://root/attachments/some-uuid/ticket6199/6199-fast-int-mul-all.patch) by @robertwb created at 2010-02-01 21:14:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55022",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55023",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55024",
...
```json
{
    "body": "<a id='comment:19'></a>The changes look good.",
    "created_at": "2010-02-02T20:00:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55025",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:19'></a>The changes look good.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Fredrik Johannson, Mike Hansen\"",
    "created_at": "2010-02-02T20:00:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55026",
    "user": "https://github.com/mwhansen"
}
```

Changing reviewer from "" to "Fredrik Johannson, Mike Hansen"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55027",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55028",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55029",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55030",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6199#issuecomment-55031",
    "user": "https://github.com/robertwb"
}
```
