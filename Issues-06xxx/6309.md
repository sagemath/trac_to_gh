...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56181",
    "user": "https://github.com/antieau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56182",
    "user": "https://github.com/antieau"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>It does not (shouldn't) rely on 6099. It applied cleanly for me to 4.0.2.rc1 once I created the second patch.\n\nI agree with merging remove_facet() with remove_face(). And, I will try to make things robust with the maximality_check=False.\n\nAs for is_connected(), consider the following behavior:\n\n```\nsage: T = SimplicialComplex(5,[[1,2,3],[4]])\nsage: T.graph().is_connected()\nTrue\nsage: T.is_connected()\nFalse\n```\nWhich should be correct?",
    "created_at": "2009-06-17T19:06:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56184",
    "user": "https://github.com/antieau"
}
```

<a id='comment:3'></a>It does not (shouldn't) rely on 6099. It applied cleanly for me to 4.0.2.rc1 once I created the second patch.
...
```json
{
    "body": "<a id='comment:4'></a>It looks like there's a bug in the graph method -- it shouldn't ignore isolated vertices.  I'll attach a patch for it.  \n\nWhen I applied the patch, the last part didn't apply because it couldn't find the line\n\n```\n     return SimplicialComplex(sub_vertex_set,faces,maximality_check=True) \n```\nwhich I think is added by #6099.",
    "created_at": "2009-06-17T19:39:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56185",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>It looks like there's a bug in the graph method -- it shouldn't ignore isolated vertices.  I'll attach a patch for it.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56186",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56187",
    "user": "https://github.com/antieau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56189",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56190",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56191",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56192",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Looks good to me.  I'm attaching a referee's patch which fixes a few formatting issues.",
    "created_at": "2009-11-06T21:11:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56193",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>Looks good to me.  I'm attaching a referee's patch which fixes a few formatting issues.
...
```json
{
    "body": "<a id='comment:7'></a>To the release manager: apply only \"6309-merged.patch\" and \"trac_6309-referee.patch\".",
    "created_at": "2009-11-06T21:12:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56194",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>To the release manager: apply only "6309-merged.patch" and "trac_6309-referee.patch".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56195",
...
```json
{
    "body": "<a id='comment:8'></a>I had to merge the above patch as well since the ordering between Simplex objects and Integer objects seems to vary from machine to machine.",
    "created_at": "2009-11-07T06:13:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56196",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:8'></a>I had to merge the above patch as well since the ordering between Simplex objects and Integer objects seems to vary from machine to machine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56197",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6309#issuecomment-56198",
    "user": "https://github.com/mwhansen"
}
```
