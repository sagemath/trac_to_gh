...
archive/attachments_008568.json:
```json
{
...
archive/attachments_008569.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [trac_6684-templates_manifest.patch](https://github.com/sagemath/sage/files/ticket6884/trac_6684-templates_manifest.patch)\n\nI apologize for missing this.",
    "created_at": "2009-09-05T14:10:59Z",
    "issue": "https://github.com/sagemath/sage/issues/6884",
    "type": "issue_comment",
...
archive/attachments_008570.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_6884-templates_manifest.patch](https://github.com/sagemath/sage/files/ticket6884/trac_6884-templates_manifest.patch)\n\nCorrected ticket number in patch filename. Apply only this patch.",
    "created_at": "2009-09-05T15:17:49Z",
    "issue": "https://github.com/sagemath/sage/issues/6884",
    "type": "issue_comment",
...
**Attachment:** [trac_6884-templates_manifest.patch](https://github.com/sagemath/sage/files/ticket6884/trac_6884-templates_manifest.patch)
