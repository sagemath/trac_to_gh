...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45523",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45524",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_6475-error-delete-data-file.patch](https://github.com/sagemath/sage/files/ticket6475/trac_6475-error-delete-data-file.patch) by @TimDumol created at 2010-01-19 10:54:49",
    "created_at": "2010-01-19T10:54:49Z",
    "issue": "https://github.com/sagemath/sage/issues/6475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45525",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45526",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45527",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45528",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6475#issuecomment-45529",
    "user": "https://github.com/qed777"
}
```
