...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-1.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-2.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-3.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-5.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-6.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-7.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-8.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-4-rebased.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-9-rebased.patch",
    "created_at": "2009-06-17T17:05:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6085",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-10.patch",
...
```json
{
    "body": "One last bugfix in bitsets",
    "created_at": "2009-06-18T15:47:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6085",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6085/trac_6085-part-11.patch",
...
```json
{
    "body": "Python 2.6 formatting changes",
    "created_at": "2009-06-25T08:59:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6085",
    "type": "issue_comment",
