...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6022#issuecomment-51818",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6022#issuecomment-51819",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6022#issuecomment-51820",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6022",
    "rename": {
        "from": "[with patch, needs review] latex.py: if dvipng fails, use dvips and convert instead",
        "to": "[with patch, positive review] latex.py: if dvipng fails, use dvips and convert instead"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6022#event-24140"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6022#issuecomment-51821",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6022",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6022#event-24141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6022#issuecomment-51822",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6022#event-24142"
}
```
