...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6040/patch-3__QF_misc_doctests__3.4.1.patch",
    "created_at": "2009-05-15T03:43:18Z",
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6040/patch-3__QF_misc_doctests__3.4.1.patch",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [patch-3__QF_misc_doctests__3.4.1.patch](https://github.com/sagemath/sage/files/ticket6040/patch-3__QF_misc_doctests__3.4.1.patch) by @jonhanke created at 2009-05-15 03:43:18\n\nNote:  There are currently two broken doctests in this patch (using the older routine IsPadic Square()), which should resolve themselves once Cremona's patch (Ticket #5834) is applied.",
    "created_at": "2009-05-15T03:43:18Z",
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40903",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40904",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6040/patch-4__QF_more_doctests__3.4.1.patch",
    "created_at": "2009-05-15T11:16:06Z",
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6040/patch-4__QF_more_doctests__3.4.1.patch",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    "body": "Attachment [patch-4__QF_more_doctests__3.4.1.patch](https://github.com/sagemath/sage/files/ticket6040/patch-4__QF_more_doctests__3.4.1.patch) by @jonhanke created at 2009-05-15 11:16:06",
    "created_at": "2009-05-15T11:16:06Z",
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40905",
    "user": "https://github.com/jonhanke"
}
```

Attachment [patch-4__QF_more_doctests__3.4.1.patch](https://github.com/sagemath/sage/files/ticket6040/patch-4__QF_more_doctests__3.4.1.patch) by @jonhanke created at 2009-05-15 11:16:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40906",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40907",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40908",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40909",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6040/patch-5__QF_reviewer__4.0.alpha0.patch",
    "created_at": "2009-05-18T05:46:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6040/patch-5__QF_reviewer__4.0.alpha0.patch",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "Attachment [patch-5__QF_reviewer__4.0.alpha0.patch](https://github.com/sagemath/sage/files/ticket6040/patch-5__QF_reviewer__4.0.alpha0.patch) by @tornaria created at 2009-05-18 05:46:41\n\nfix doctests for 4.0.alpha0",
    "created_at": "2009-05-18T05:46:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40910",
    "user": "https://github.com/tornaria"
}
```

Attachment [patch-5__QF_reviewer__4.0.alpha0.patch](https://github.com/sagemath/sage/files/ticket6040/patch-5__QF_reviewer__4.0.alpha0.patch) by @tornaria created at 2009-05-18 05:46:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40911",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40912",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40913",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40914",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6040#issuecomment-40915",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
