# Issue 6470: [with spkg, positive review] sage-4.1.rc0: On OS X 10.4/10.5 Singular 3.1.0.4 fails to work
...
```json
{
    ...
    "title": "[with spkg, positive review] sage-4.1.rc0: On OS X 10.4/10.5 Singular 3.1.0.4 fails to work",
    "type": "issue",
