...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68534"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68536"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68537"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6470",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68539"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-68540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6470#issuecomment-45521",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6470#issuecomment-45522",
    "user": "https://github.com/rlmill"
}
```
