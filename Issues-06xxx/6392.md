...
```json
{
    "body": "<a id='comment:9'></a>\nThe issue was in `finite_subgroup`. We had to include the lattice of the ambient jacobian and not just the ambient abelian subvariety. \n\nThis branch returns the identity map as well when quotienting by a trivial group. \n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|\n|[0bc6f5a](https://git.sagemath.org/sage.git/commit?id=0bc6f5a1c37f5a93e00d1fb4ecd4feaae7b35839)|`quotient by trivial subgroup now returns identity map, finite_subgroup now works when subgroup has different ambient variety`|",
