...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55276",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55279",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55280",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_6226-part3.patch](tarball://root/attachments/some-uuid/ticket6226/trac_6226-part3.patch) by mvngu created at 2009-06-05 20:57:24\n\nThe patch `trac_6226_part2.patch` looks good to me. After applying `trac_6226.patch` and `trac_6226_part2.patch` to Sage 4.0.1.rc2 and re-reading the developer's guide, I noticed more typos. These are fixed in `trac_6226-part3.patch`. If it gets positive review, then the patches on this ticket should be applied in the following order:\n1. `trac_6226.patch`\n2. `trac_6226_part2.patch`\n3. `trac_6226-part3.patch`",
    "created_at": "2009-06-05T20:57:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55281",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>Attachment [trac_6226-part3.patch](tarball://root/attachments/some-uuid/ticket6226/trac_6226-part3.patch) by mvngu created at 2009-06-05 20:57:24
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55282",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Michael Abshoff, Florent Hivert, Minh Van Nguyen\"",
    "created_at": "2009-06-08T17:08:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55283",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Changing author from "" to "Michael Abshoff, Florent Hivert, Minh Van Nguyen"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55284",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6226#issuecomment-55285",
    "user": "https://github.com/ncalexan"
}
```
