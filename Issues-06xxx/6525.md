...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6525#issuecomment-58645",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6525#issuecomment-58646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "rename": {
        "from": "Enabling some GraphLatex options that were hard coded.",
        "to": "[with patch, needs review] Enabling some GraphLatex options that were hard coded."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6525#event-26356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6525#issuecomment-58647",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "rename": {
        "from": "[with patch, needs review] Enabling some GraphLatex options that were hard coded.",
        "to": "[with patch, needs work] Enabling some GraphLatex options that were hard coded."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6525#event-26357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6525#issuecomment-58648",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6525#issuecomment-58649",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6525#issuecomment-58650",
    "user": "https://github.com/rbeezer"
}
```
