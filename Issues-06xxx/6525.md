...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6525#issuecomment-46483",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [graph_latex_options.patch](https://github.com/sagemath/sage/files/ticket6525/graph_latex_options.patch) by mvngu created at 2009-07-13 22:21:53",
    "created_at": "2009-07-13T22:21:53Z",
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6525#issuecomment-46484",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6525#issuecomment-46485",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6525#issuecomment-46486",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6525#issuecomment-46488",
    "user": "https://github.com/rbeezer"
}
```
