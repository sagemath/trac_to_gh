# Issue 6750: [with spkg, positive review] New version of optional Group Cohomology spkg
...
```json
{
    ...
    "title": "[with spkg, positive review] New version of optional Group Cohomology spkg",
    "type": "issue",
