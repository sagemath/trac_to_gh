...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -31,6 +31,11 @@\n \n How could the Pynac funtionality of setting latex names for variables at creation be exposed?\n \n+\n+**Patches:**\n+\n+Patches that will resolve this ticket is posted at #6559\n+\n Comment: 1\n \n Summary: Custom definitions for latex style\n``````\n",
    "created_at": "2009-09-05T21:57:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6403#issuecomment-57646",
...
```json
{
    "body": "<a id='comment:2'></a>There is no patch above, though the title said there was a patch.",
    "created_at": "2009-11-10T15:18:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6403#issuecomment-57647",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>There is no patch above, though the title said there was a patch.
...
```json
{
    "body": "<a id='comment:3'></a>Supposedly, the patch for #6559 fixes this (see comment added to description). Could you review #6559 instead? Thanks!\n\nStan",
    "created_at": "2009-11-10T16:11:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6403#issuecomment-57648",
    "user": "https://trac.sagemath.org/admin/accounts/users/schymans"
}
```

<a id='comment:3'></a>Supposedly, the patch for #6559 fixes this (see comment added to description). Could you review #6559 instead? Thanks!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6403#issuecomment-57649",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6403#issuecomment-57650",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'm closing this, since #6559 just got merged. It adds a `latex_name` keyword argument to `var()`, which is the functionality requested here.",
    "created_at": "2010-02-19T11:56:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6403#issuecomment-57651",
    "user": "https://github.com/burcin"
}
```

<a id='comment:4'></a>I'm closing this, since #6559 just got merged. It adds a `latex_name` keyword argument to `var()`, which is the functionality requested here.
