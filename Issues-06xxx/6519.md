...
```json
{
    "body": "<a id='comment:1'></a>You can find comparisons of the new code and the old code at the bottom of\nthe site [http://wiki.sagemath.org/WordDesign](http://wiki.sagemath.org/WordDesign). The new code is much\nfaster.",
    "created_at": "2009-07-12T16:02:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59794",
    "user": "https://github.com/saliola"
}
```

<a id='comment:1'></a>You can find comparisons of the new code and the old code at the bottom of
the site [http://wiki.sagemath.org/WordDesign](http://wiki.sagemath.org/WordDesign). The new code is much
faster.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59797",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59798",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I ran valgrind on sage-4.1 + the patch here on the `sage/combinat/words` directory, and all looks good!",
    "created_at": "2009-07-15T16:27:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59799",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:6'></a>I ran valgrind on sage-4.1 + the patch here on the `sage/combinat/words` directory, and all looks good!
...
```json
{
    "body": "<a id='comment:7'></a>Robert! Thank you very much for doing this. That's great.",
    "created_at": "2009-07-15T16:32:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59800",
    "user": "https://github.com/saliola"
}
```

<a id='comment:7'></a>Robert! Thank you very much for doing this. That's great.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59801",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>#6526 should probably be merged right after this, to avoid later conflicts.",
    "created_at": "2009-07-16T18:35:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59802",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:9'></a>#6526 should probably be merged right after this, to avoid later conflicts.
...
```json
{
    "body": "<a id='comment:12'></a>I am currently trying to understand the pickle problem... Using debug=True, I am getting more information (see below). The 10 problems look the same... I still don't know how to fix this...\n\nS\u00e9bastien\n\n```\nsage: std = os.environ['SAGE_DATA'] + '/extcode/pickle_jar/pickle_jar.tar.bz2'\nsage: sage.structure.sage_object.unpickle_all(std, debug=True)\n...\n[same thing as above]\n...\nSuccessfully unpickled 562 objects.\nFailed to unpickle 10 objects.\n\n[(<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbef502c>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbef5c84>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf006bc>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf005cc>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf00554>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf091bc>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf095f4>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf0966c>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf09b6c>),\n (<type 'exceptions.TypeError'>,\n  TypeError('__new__() takes at least 3 arguments (1 given)',),\n  <traceback object at 0xbf09c84>)]\n```",
    "created_at": "2009-07-17T19:32:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59805",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:12'></a>I am currently trying to understand the pickle problem... Using debug=True, I am getting more information (see below). The 10 problems look the same... I still don't know how to fix this...
...
```json
{
    "body": "<a id='comment:14'></a>I have a working patch right now. I am going to run a few more tests, and the post it.",
    "created_at": "2009-07-17T21:16:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59807",
    "user": "https://github.com/saliola"
}
```

<a id='comment:14'></a>I have a working patch right now. I am going to run a few more tests, and the post it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59809",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59810",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59813",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59814",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Merged `trac_6519-words_ng.patch`.",
    "created_at": "2009-07-18T14:07:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59815",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:20'></a>Merged `trac_6519-words_ng.patch`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6519#issuecomment-59816",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
