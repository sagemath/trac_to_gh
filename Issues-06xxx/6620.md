...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-59995",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "rename": {
        "from": "add a method to the Gap class to access elements of records",
        "to": "[with patch; needs review] add a method to the Gap class to access elements of records"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6620#event-26770"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-59996",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-59997",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "rename": {
        "from": "[with patch; needs review] add a method to the Gap class to access elements of records",
        "to": "[with patch; positive review] add a method to the Gap class to access elements of records"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6620#event-26771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-59998",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "rename": {
        "from": "[with patch; positive review] add a method to the Gap class to access elements of records",
        "to": "[with patch, positive review] add a method to the Gap class to access elements of records"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6620#event-26772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-59999",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-60000",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-60001",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6620#event-26773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-60002",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6620#issuecomment-60003",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
