...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60041",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I've just tried to build mpir on what I believe is the same OS as above - the 11/2008 release of OpenSolaris and do not see this issue - the configure  script reconises this as a non-GNU linker properly. It is not clear why it should get it wrong on another system with the same OS\n\n```\n$ cat /etc/release\n                       OpenSolaris 2008.11 snv_101b_rc2 X86\n           Copyright 2008 Sun Microsystems, Inc.  All Rights Reserved.\n                        Use is subject to license terms.\n                           Assembled 19 November 2008\n```\n\n\nHere's the output of configure of mpir-1.2.p4\n\n```\n./configure \n<SNIP>\nchecking for a sed that does not truncate output... /usr/bin/gsed\nchecking for ld used by gcc -std=gnu99... /usr/ccs/bin/ld\nchecking if the linker (/usr/ccs/bin/ld) is GNU ld... no\nchecking for /usr/ccs/bin/ld option to reload object files... -r\n\n```",
    "created_at": "2009-07-22T01:34:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60042",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>I've just tried to build mpir on what I believe is the same OS as above - the 11/2008 release of OpenSolaris and do not see this issue - the configure  script reconises this as a non-GNU linker properly. It is not clear why it should get it wrong on another system with the same OS
...
```json
{
    ...
    "created_at": "2009-12-03T04:08:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60043",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60044",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60045",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60047",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60048",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6539#issuecomment-60049",
    "user": "https://github.com/fchapoton"
}
```
