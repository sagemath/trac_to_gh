...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6195-match_dict.patch](https://github.com/sagemath/sage/files/ticket6195/trac_6195-match_dict.patch) by @ncalexan created at 2009-06-15 21:20:46\n\nI don't understand this.\n\nWhy does the first match but the second not?  \n\n```\nsage: ((x+y)).match(w0+w1)\n{$1: x, $0: y}\nsage: ((x+x)).match(w0+w1)\n```\n\n\nCan you explain the difference in these behaviours?\n\n```\nsage: ((x+y)^a).match((x+y)^a)\n{}\nsage: print ((x+y)^a).match((x+y)^b)\nNone\n```",
    "created_at": "2009-06-15T21:20:46Z",
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42425",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42426",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42427",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42428",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "Attachment [trac_6195-ref.patch](https://github.com/sagemath/sage/files/ticket6195/trac_6195-ref.patch) by @aghitza created at 2009-07-17 09:28:39\n\napply after the first patch",
    "created_at": "2009-07-17T09:28:39Z",
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42429",
    "user": "https://github.com/aghitza"
}
```

Attachment [trac_6195-ref.patch](https://github.com/sagemath/sage/files/ticket6195/trac_6195-ref.patch) by @aghitza created at 2009-07-17 09:28:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42430",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42431",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42432",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6195#issuecomment-42433",
