...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74774"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74777"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6231#issuecomment-41316",
    "user": "https://github.com/simon-king-jena"
}
```
