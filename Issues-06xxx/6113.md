...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73420"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40362",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40363",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40364",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40365",
    "user": "https://github.com/sagetrac-stankewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40366",
    "user": "https://github.com/sagetrac-stankewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40368",
    "user": "https://github.com/sagetrac-stankewicz"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73422"
}
```
...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73425"
}
```
...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73426"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40369",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40370",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73427"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6113#issuecomment-40371",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6113#event-73431"
}
```
