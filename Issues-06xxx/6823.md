...
```json
{
    "body": "<a id='comment:2'></a>New patch. Odds graphs are added, and with some luck each one of your remarks will find an answer in this new version. Hope you'll like it ! :-)\n\nNathann",
...
<a id='comment:2'></a>New patch. Odds graphs are added, and with some luck each one of your remarks will find an answer in this new version. Hope you'll like it ! :-)
...
```json
{
    "body": "<a id='comment:3'></a>New patch taking into account the comments from #6828",
...
<a id='comment:3'></a>New patch taking into account the comments from #6828
...
```json
{
    "body": "<a id='comment:5'></a>Good thinking ! ;-)\n\nNathann",
...
<a id='comment:5'></a>Good thinking ! ;-)
