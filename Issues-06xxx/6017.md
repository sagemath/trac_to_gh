...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72112"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72114"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72115"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72116"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72118"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6017#issuecomment-39328",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72120"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6017#issuecomment-39329",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6017#issuecomment-39330",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-72121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6017#issuecomment-39331",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6017#issuecomment-39332",
    "user": "https://github.com/ncalexan"
}
```
