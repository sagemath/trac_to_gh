...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] the detection of SAGE_ROOT in $SAGE_ROOT/sage script should expand symlinks recursively (fix this on systems that do *NOT* support readlink -f)",
        "to": "the detection of SAGE_ROOT in $SAGE_ROOT/sage script should expand symlinks recursively (fix this on systems that do *NOT* support readlink -f)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6146#event-24681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53231",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53232",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53233",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53234",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53235",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53236",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53237",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6146#event-24682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53238",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6146#event-24683"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6146#issuecomment-53239",
    "user": "https://github.com/tornaria"
}
```
