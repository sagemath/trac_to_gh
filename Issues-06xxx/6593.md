...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60879",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60880",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>The patch simply use the print statement which call the `__str__` instead of `__repr__`. The `__str__` sorts the string enumeration before printing it so that it should print the same way on Fedora or on other system.",
    "created_at": "2009-07-22T17:16:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60881",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:2'></a>The patch simply use the print statement which call the `__str__` instead of `__repr__`. The `__str__` sorts the string enumeration before printing it so that it should print the same way on Fedora or on other system.
...
```json
{
    "body": "<a id='comment:3'></a>After applying the patch in Fedora 11, 32 bit:\n\n```\n[jaap@paix sage-4.1.1.alpha0]$ ./sage -t \"devel/sage/sage/combinat/words/morphism.py\"\nsage -t  \"devel/sage/sage/combinat/words/morphism.py\"       \n\t [4.9 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 4.9 seconds\n\n```\n\n\nJaap",
    "created_at": "2009-07-22T21:54:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60882",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:3'></a>After applying the patch in Fedora 11, 32 bit:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60883",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60884",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60885",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60886",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60887",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6593#issuecomment-60888",
    "user": "https://github.com/fchapoton"
}
```
