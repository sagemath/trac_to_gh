...
```json
{
    "body": "<a id='comment:1'></a>The patch `trac_5793-cliquer-flattened.patch` at #5793 contains non-ASCII characters. This can result in errors and warning messages when loading Sage. Patches should only use ASCII characters. The offending characters from that patch are\n\n```\n\u00d6sterg\u00e5rd\n```\nThe attached patch `trac_6674-use-ascii.patch` changes that to \"Ostergard\". It also fixes referencing so that `[NisOst2003]` appears as a hyperlink in the HTML version of the reference manual, as it should be. This patch is based on Sage 4.1.1.rc0 and depends on #5793.\n\n\n\nNathann: Can I ask you to review this? The ASCII character issue needs to be fixed before releasing Sage 4.1.1.",
    "created_at": "2009-08-04T08:29:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62107",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>The patch `trac_5793-cliquer-flattened.patch` at #5793 contains non-ASCII characters. This can result in errors and warning messages when loading Sage. Patches should only use ASCII characters. The offending characters from that patch are
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62108",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62109",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62110",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62111",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62112",
...
```json
{
    "body": "<a id='comment:4'></a>ncohen: Do you have an account on sage.math?",
    "created_at": "2009-08-04T09:01:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62113",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>ncohen: Do you have an account on sage.math?
...
```json
{
    "body": "<a id='comment:6'></a>I don't think so... I only have an account on TRAC, but I think that's all... What is sage.math ? ^^;",
    "created_at": "2009-08-04T09:16:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62114",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>I don't think so... I only have an account on TRAC, but I think that's all... What is sage.math ? ^^;
...
```json
{
    "body": "<a id='comment:8'></a>Uhm, I question this a litte bit. It's true that you have to use ASCII only for variable names, but strings and comments can be UTF-8. At least it is technically feasible. You just have to add this line in the first or second one of the .py file:\n\n```\n# -*- coding: utf-8 -*-\n```\nI guess it also works with sphinx, but someone should try.\n\nOr is there a general policy i'm not aware of?!",
    "created_at": "2009-08-04T10:45:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62116",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:8'></a>Uhm, I question this a litte bit. It's true that you have to use ASCII only for variable names, but strings and comments can be UTF-8. At least it is technically feasible. You just have to add this line in the first or second one of the .py file:
...
```json
{
    "body": "<a id='comment:11'></a>This patch fails to apply on my version, and I am afraid I do not know where it comes from. As I still have no answer from William Stein for an account on sage.math, I hope somebody else will be able to try it !\nThe odd thing is that I am asked to enter the \"list of the changes\" when I apply the patch, as if I were committing it !",
    "created_at": "2009-08-04T16:01:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62119",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>This patch fails to apply on my version, and I am afraid I do not know where it comes from. As I still have no answer from William Stein for an account on sage.math, I hope somebody else will be able to try it !
The odd thing is that I am asked to enter the "list of the changes" when I apply the patch, as if I were committing it !
...
```json
{
    "body": "<a id='comment:12'></a>Perfect ! I was finally able to retry this patch on sage 4.1.1.rc0 on which it applied without any problem. I then built and started a binary version as described and no errors where reported.\n\nPositive review !",
    "created_at": "2009-08-05T07:42:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62120",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:12'></a>Perfect ! I was finally able to retry this patch on sage 4.1.1.rc0 on which it applied without any problem. I then built and started a binary version as described and no errors where reported.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62121",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62122",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Please refer to the new patch, which is based on Sage 4.1.1.rc1.",
    "created_at": "2009-08-05T13:11:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62123",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:14'></a>Please refer to the new patch, which is based on Sage 4.1.1.rc1.
...
```json
{
    "body": "<a id='comment:15'></a>I applied this on a 4.1.1.rc1, which refused to start before this patch was applied on it. I applied it from the command line using hg import, then re-built Sage.\n\nNothing wrong to report. Positive review !",
    "created_at": "2009-08-05T15:08:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62124",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:15'></a>I applied this on a 4.1.1.rc1, which refused to start before this patch was applied on it. I applied it from the command line using hg import, then re-built Sage.
...
```json
{
    "body": "Changing merged from \"\" to \"Sage 4.1.1.rc2\"",
    "created_at": "2009-08-07T05:54:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62125",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Changing merged from "" to "Sage 4.1.1.rc2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62126",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Nathann Cohen, Alex Ghitza\"",
    "created_at": "2009-08-07T05:54:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6674#issuecomment-62127",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Changing reviewer from "" to "Nathann Cohen, Alex Ghitza"
