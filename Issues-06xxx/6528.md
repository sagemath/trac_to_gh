# Issue 6528: [with spkg, positive review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler
...
```json
{
    ...
    "title": "[with spkg, positive review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58659",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with SPKG, needs review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6528#event-26361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58660",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "rename": {
        "from": "[with SPKG, needs review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler",
        "to": "[with spkg, needs review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6528#event-26362"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with spkg, needs review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler",
        "to": "[with spkg, positive review] PolyBoRi ignores CXX and passes Sun flags to GNU C compiler"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6528#event-26363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58661",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58662",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6528#event-26364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58663",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58664",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58665",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6528#issuecomment-58666",
    "user": "https://trac.sagemath.org/admin/accounts/users/ltw"
}
```
