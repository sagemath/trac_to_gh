...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "rename": {
        "from": "[with patch, needs review] add some files from the plot directory to the reference manual",
        "to": "[with patch, needs work] add some files from the plot directory to the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6270#event-25111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54625",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "rename": {
        "from": "[with patch, needs work] add some files from the plot directory to the reference manual",
        "to": "[with patch, needs review] add some files from the plot directory to the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6270#event-25112"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54626",
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] add some files from the plot directory to the reference manual",
        "to": "[with patch, positive review] add some files from the plot directory to the reference manual"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6270#event-25113"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54627",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54628",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54629",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54630",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6270#issuecomment-54631",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6270",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6270#event-25114"
}
```
