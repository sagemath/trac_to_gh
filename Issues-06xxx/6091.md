...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6091.patch](https://github.com/sagemath/sage/files/ticket6091/trac_6091.patch) by @loefflerd created at 2009-05-29 10:46:30\n\nPositive review. Patch applies fine to 4.0.rc1, all tests in sage/rings/number_field and doc/en/bordeaux_2008 pass; and the new syntax is a very useful thing to have.\n\nDavid",
    "created_at": "2009-05-29T10:46:30Z",
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41371",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41372",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41374",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    "body": "Attachment [trac_6091_revised.patch](https://github.com/sagemath/sage/files/ticket6091/trac_6091_revised.patch) by fwclarke created at 2009-06-01 21:41:17\n\nreplaces previous",
    "created_at": "2009-06-01T21:41:17Z",
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41375",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```

Attachment [trac_6091_revised.patch](https://github.com/sagemath/sage/files/ticket6091/trac_6091_revised.patch) by fwclarke created at 2009-06-01 21:41:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41376",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41377",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41378",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-41379",
    "user": "https://github.com/mwhansen"
}
```
