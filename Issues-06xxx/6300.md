...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56058",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_6300.patch](tarball://root/attachments/some-uuid/ticket6300/trac_6300.patch) by @malb created at 2009-06-15 15:58:25\n\nPatch depends on hotfix at #6051.",
    "created_at": "2009-06-15T15:58:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56059",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>Attachment [trac_6300.patch](tarball://root/attachments/some-uuid/ticket6300/trac_6300.patch) by @malb created at 2009-06-15 15:58:25
...
```json
{
    "body": "<a id='comment:3'></a>With this patch and the hotfix from #6051 all doctests pass on sage.math FWIW.",
    "created_at": "2009-06-15T16:23:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56060",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>With this patch and the hotfix from #6051 all doctests pass on sage.math FWIW.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56061",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56062",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56063",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56064",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6300#issuecomment-56065",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
