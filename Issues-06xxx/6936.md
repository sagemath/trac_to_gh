...
```json
{
    "body": "The patch calls TestSuite().run() every time load(dumps()) was called in the matrix directory.  I also renamed and adapted an existing `_test_`pickle() into `_test_`reduce().\n\n\n**Assignee:** @williamstein\n\n**CC:**  @kcrisman @nthiery @hivert @rbeezer\n\n**Keywords:** TestSuite\n\n**Resolution:** fixed\n\n**Author:** Jason Grout\n\n**Reviewer:** Nicolas M. Thi\u00e9ry\n\n**Merged:** sage-4.3.1.rc1\n\nIssue created by migration from https://trac.sagemath.org/ticket/6936\n\n",
...
```
The patch calls TestSuite().run() every time load(dumps()) was called in the matrix directory.  I also renamed and adapted an existing `_test_`pickle() into `_test_`reduce().
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72007",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72008",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72009",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72010",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72012",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72013",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72014",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72015",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-The patch calls TestSuite().run() every time load(dumps()) is called in the matrix directory.  I also added a `_test_`minpoly() function, and fixed an existing `_test_`pickle() function.\n+The patch calls TestSuite().run() every time load(dumps()) was called in the matrix directory.  I also added a `_test_`minpoly() function, and renamed and adapted an existing `_test_`pickle() into `_test_`reduce().\n \n Running doctests in matrix/*.pyx now fails for a number of files.  In other words, this testing infrastructure works and is uncovering bugs!\n \n``````\n",
    "created_at": "2009-09-17T19:53:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72016",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72017",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6936#event-20872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72019",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6936#event-20873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72020",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72021",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6936#event-20874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72022",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72023",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72024",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72025",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72026",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket6936/trac-6936-matrix-generic-doctesting.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72027",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72028",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72029",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72030",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72031",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72032",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72033",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72034",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72035",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6936#issuecomment-72036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6936",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6936#event-20875"
}
```
