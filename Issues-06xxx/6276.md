...
archive/attachments_007392.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "install.log.gz",
    "asset_url": "tarball://root/attachments/ticket6276/install.log.gz",
    "created_at": "2009-06-13T15:17:51Z",
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6276/install.log.gz",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [install.log.gz](https://github.com/sagemath/sage/files/ticket6276/install.log.gz) by drkirkby created at 2009-06-13 15:17:51\n\nCompressd copy of install process.",
    "created_at": "2009-06-13T15:17:51Z",
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43148",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [install.log.gz](https://github.com/sagemath/sage/files/ticket6276/install.log.gz) by drkirkby created at 2009-06-13 15:17:51
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40708"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40709"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43149",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43150",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43151",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43152",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43153",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43154",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43155",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40713"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6276#event-40714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43156",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6276#issuecomment-43157",
