...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55856",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55857",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55858",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55860",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55861",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I see there is a p3 of this package in sage-4.0.2.rc3.tar, so the version should be update to 4, which will need changes to the SPKG.txt.",
    "created_at": "2009-06-19T14:07:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55862",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>I see there is a p3 of this package in sage-4.0.2.rc3.tar, so the version should be update to 4, which will need changes to the SPKG.txt.
...
```json
{
    "body": "<a id='comment:4'></a>I've updated it, so should be ready to test. \n\nATLAS sure does take some time to build! Hours and hours.",
    "created_at": "2009-06-19T16:41:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55863",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:4'></a>I've updated it, so should be ready to test. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55865",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55866",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>drkirkby -- can you set the Author line for this ticket, and add your full name to the front page?",
    "created_at": "2009-07-02T21:34:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55867",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:7'></a>drkirkby -- can you set the Author line for this ticket, and add your full name to the front page?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55868",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6276#issuecomment-55869",
