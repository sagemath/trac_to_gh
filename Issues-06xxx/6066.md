...
```json
{
    ...
    "rename": {
        "from": "constructing Sage graphs is slow compared to NetworkX graphs",
        "to": "[with patch, needs review] constructing Sage graphs is slow compared to NetworkX graphs"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6066#event-24315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6066#issuecomment-52215",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "rename": {
        "from": "[with patch, needs review] constructing Sage graphs is slow compared to NetworkX graphs",
        "to": "[with patch, positive review] constructing Sage graphs is slow compared to NetworkX graphs"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6066#event-24316"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6066#issuecomment-52216",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6066#issuecomment-52217",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6066#event-24317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6066#issuecomment-52218",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6066",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6066#issuecomment-52219",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6066#event-24318"
}
```
