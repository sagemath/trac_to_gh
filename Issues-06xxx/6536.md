...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46561",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_6536-order_wrong_init.patch](https://github.com/sagemath/sage/files/ticket6536/trac_6536-order_wrong_init.patch) by @loefflerd created at 2009-07-15 07:40:25\n\nHere's a two-line fix.",
    "created_at": "2009-07-15T07:40:25Z",
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46562",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46563",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46564",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46565",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46566",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-46567",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
