...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42310",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42311",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42312",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42313",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42314",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6185/sbox_cnf.patch",
    "created_at": "2009-06-11T11:36:35Z",
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6185/sbox_cnf.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [sbox_cnf.patch](https://github.com/sagemath/sage/files/ticket6185/sbox_cnf.patch) by @malb created at 2009-06-11 11:36:35\n\nThe attached updated patch addresses the reviewer's comments. Is that a positive review then?",
    "created_at": "2009-06-11T11:36:35Z",
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42315",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42316",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42317",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42318",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6185#issuecomment-42319",
