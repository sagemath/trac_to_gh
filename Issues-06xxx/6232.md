...
```json
{
    "body": "<a id='comment:1'></a>I vote for closing this ticket, no point in having it around since no motion to actually include it is happening.",
    "created_at": "2010-07-21T16:07:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55314",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>I vote for closing this ticket, no point in having it around since no motion to actually include it is happening.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55315",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>We just released version 1.1 of CADO-NFS, see http://cado-nfs.gforge.inria.fr/\n\nPaul",
    "created_at": "2011-11-01T09:31:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55316",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>We just released version 1.1 of CADO-NFS, see http://cado-nfs.gforge.inria.fr/
...
```json
{
    "body": "<a id='comment:3'></a>see also #5310: both msieve and cado-nfs implement the number field sieve.",
    "created_at": "2011-11-01T09:34:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55317",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:3'></a>see also #5310: both msieve and cado-nfs implement the number field sieve.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55318",
...
```json
{
    "body": "<a id='comment:7'></a>by the way the above code, if we manage to make it work with recent versions of CADO-NFS, might be useful to factor large integers from within Sage.\n\nPaul",
    "created_at": "2015-06-03T12:00:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55320",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:7'></a>by the way the above code, if we manage to make it work with recent versions of CADO-NFS, might be useful to factor large integers from within Sage.
...
```json
{
    "body": "<a id='comment:8'></a>thanks to Alexander Kruppa, the solution is to undefine the environment variables PYTHONHOME and PYTHONPATH:\n\n```\nimport subprocess, os\ndef my_exec_factor(nbr):\n    cmd = ['/tmp/cado-nfs-2.1.1/factor.sh', str(nbr)]\n    my_env = os.environ\n    if my_env.has_key(\"PYTHONHOME\"):\n       my_env.pop(\"PYTHONHOME\")\n    if my_env.has_key(\"PYTHONPATH\"):\n       my_env.pop(\"PYTHONPATH\")\n    process = subprocess.Popen(cmd, stderr=subprocess.STDOUT, stdout=subprocess.PIPE, env=my_env)\n    output, unused_err = process.communicate()\n    retcode = process.poll()\n    if retcode:\n        print \"Output :\"\n        print output\n        raise subprocess.CalledProcessError(retcode, cmd)\n    return output\n```",
    "created_at": "2015-06-03T15:03:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55321",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:8'></a>thanks to Alexander Kruppa, the solution is to undefine the environment variables PYTHONHOME and PYTHONPATH:
...
```json
{
    "body": "<a id='comment:9'></a>in addition, one should unset PATH:\n\n```\n    if my_env.has_key(\"PATH\"):\n       my_env.pop(\"PATH\")\n```\nand replace `res.splitlines()[-6]` by `res.splitlines()[-2]` for CADO-NFS 2.1.1.\n\nPaul",
    "created_at": "2015-06-04T09:53:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55322",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:9'></a>in addition, one should unset PATH:
...
```json
{
    "body": "<a id='comment:11'></a>fixed typo in description (CADO-NSF -> CADO-NFS)",
    "created_at": "2017-01-17T09:28:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55323",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:11'></a>fixed typo in description (CADO-NSF -> CADO-NFS)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55324",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55325",
...
```json
{
    "body": "<a id='comment:16'></a>as said by Emmanuel, feel free to contribute the params.c45 file.",
    "created_at": "2021-11-22T09:04:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6232",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6232#issuecomment-55328",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:16'></a>as said by Emmanuel, feel free to contribute the params.c45 file.
