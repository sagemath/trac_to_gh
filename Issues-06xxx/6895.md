...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83752"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83753"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83754"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6895#issuecomment-49089",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6895#issuecomment-49090",
    "user": "https://github.com/sagetrac-nbonifas"
}
```
