...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68815"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68816"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68817"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68818"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68819"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68824"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68827"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -32,5 +32,6 @@\n \n - [attachment: trac_6495-part1-moving-files.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files.patch.gz) \u2014 this moves 'algebras.rst' to 'algebras/index.rst', and similarly for all other files.  It adds `.. include:: ../footer.txt` to the end of each of these files, and it removes any cross-referencing information like `.. _ch:groups:`, since that doesn't work anymore with the new structure.  It also creates identical files 'DIR/conf.py' in each of the new subdirectories of doc/en/reference, except for doc/en/algebras/conf.py.  That file is created in the next patch so that you can focus on reviewing just the second patch.\n - [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz) \u2014 this does everything else; in other words, all of the important content is in this patch.\n+- [attachment: trac_6495-root.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-root.patch.gz) \u2014 root repo.  Add \"doc-parallel\" and \"doc-pdf-parallel\" targets to the main Makefile.\n \n Before building the docs, you should delete the documentation output directory: `rm -rf SAGE_ROOT/devel/sage/doc/output`.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68833"
}
```
...
```json
{
    "body": "<a id='comment:75'>Comment 75:</a>\nHi there,\n\nI just uploaded a new [attachment: invbuilder.patch.gz](https://github.com/sagemath/sage/files/ticket6495/invbuilder.patch.gz); you need to apply it after the two mentionned patch in the header of this ticket. It seems to solve the problems of\n\n- merging todo lists\n- merging the html indexes\n\nIt remains to merge the javascript indexes.\n\nPlease tests.\n\nFlorent",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68835"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -31,5 +31,7 @@\n \n - [attachment: trac_6495-part1-moving-files.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files.patch.gz) \u2014 this moves 'algebras.rst' to 'algebras/index.rst', and similarly for all other files.  It adds `.. include:: ../footer.txt` to the end of each of these files, and it removes any cross-referencing information like `.. _ch:groups:`, since that doesn't work anymore with the new structure.  It also creates identical files 'DIR/conf.py' in each of the new subdirectories of doc/en/reference, except for doc/en/algebras/conf.py.  That file is created in the next patch so that you can focus on reviewing just the second patch.\n - [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz) \u2014 this does everything else; in other words, all of the important content is in this patch.\n+- [attachment: trac_6495-part3-the-remaining.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining.patch.gz) \u2014 this patch takes care of merging the indexes and the bibliography.\n \n Before building the docs, you should delete the documentation output directory: `rm -rf SAGE_ROOT/devel/sage/doc/output`.\n+\n``````\n",
    "created_at": "2012-05-07T18:52:41Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -32,6 +32,7 @@\n - [attachment: trac_6495-part1-moving-files.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files.patch.gz) \u2014 this moves 'algebras.rst' to 'algebras/index.rst', and similarly for all other files.  It adds `.. include:: ../footer.txt` to the end of each of these files, and it removes any cross-referencing information like `.. _ch:groups:`, since that doesn't work anymore with the new structure.  It also creates identical files 'DIR/conf.py' in each of the new subdirectories of doc/en/reference, except for doc/en/algebras/conf.py.  That file is created in the next patch so that you can focus on reviewing just the second patch.\n - [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz) \u2014 this does everything else; in other words, all of the important content is in this patch.\n - [attachment: trac_6495-part3-the-remaining.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining.patch.gz) \u2014 this patch takes care of merging the indexes and the bibliography.\n+- [attachment: trac_6495-part4-interrupts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part4-interrupts.patch.gz) \u2014 handle ctrl-c.\n \n Before building the docs, you should delete the documentation output directory: `rm -rf SAGE_ROOT/devel/sage/doc/output`.\n \n``````\n",
    "created_at": "2012-05-16T05:23:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68836"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68837"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68839"
}
```
...
```json
{
    "body": "<a id='comment:98'>Comment 98:</a>\nThis now depends on #9774. If you want to try it without the patches at #9774 (thus using jsMath instead of MathJax), apply [instead of [attachment: trac_6495-part2-everything-else-9774.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else-9774.patch.gz)(https://github.com/sagemath/sage/files/ticket6495/1db9ca7c0b1f6768c2447dd4fc13208e.gz).",
    "created_at": "2012-06-20T21:44:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,7 +36,7 @@\n Apply:\n \n - [attachment: trac_6495-part1-moving-files.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files.patch.gz) \u2014 this moves 'algebras.rst' to 'algebras/index.rst', and similarly for all other files.  It adds `.. include:: ../footer.txt` to the end of each of these files, and it removes any cross-referencing information like `.. _ch:groups:`, since that doesn't work anymore with the new structure.  It also creates identical files 'DIR/conf.py' in each of the new subdirectories of doc/en/reference, except for doc/en/algebras/conf.py.  That file is created in the next patch so that you can focus on reviewing just the second patch.\n-- [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz) \u2014 this does everything else; in other words, all of the important content is in this patch.\n+- [\u2014 this does everything else; in other words, all of the important content is in this patch.  (If you haven't applied the patches at #9774, apply [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz)(https://github.com/sagemath/sage/files/ticket6495/1f55a6ba430f1e7a771855bb3e968623.gz) instead.)\n - [attachment: trac_6495-part3-the-remaining.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining.patch.gz) \u2014 this patch takes care of merging the indexes and the bibliography.\n - [attachment: trac_6495-part4-interrupts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part4-interrupts.patch.gz) \u2014 handle ctrl-c.\n \n``````\n",
    "created_at": "2012-06-20T21:44:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68845"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -45,7 +45,7 @@\n \n - [attachment: trac_6495-part1-moving-files.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files.patch.gz) \u2014 this moves 'algebras.rst' to 'algebras/index.rst', and similarly for all other files.  It adds `.. include:: ../footer.txt` to the end of each of these files, and it removes any cross-referencing information like `.. _ch:groups:`, since that doesn't work anymore with the new structure.  It also creates identical files 'DIR/conf.py' in each of the new subdirectories of doc/en/reference, except for doc/en/algebras/conf.py.  That file is created in the next patch so that you can focus on reviewing just the second patch.\n - [\u2014 this does everything else; in other words, all of the important content is in this patch.  (If you haven't applied the patches at #9774, apply [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz)(https://github.com/sagemath/sage/files/ticket6495/1f55a6ba430f1e7a771855bb3e968623.gz) instead.)\n-- [attachment: trac_6495-part3-the-remaining.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining.patch.gz) \u2014 this patch takes care of merging the indexes and the bibliography.\n+- [attachment: trac_6495-part3-the-remaining-vs-5.4.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining-vs-5.4.patch.gz) \u2014 this patch takes care of merging the indexes and the bibliography.\n - [attachment: trac_6495-part4-interrupts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part4-interrupts.patch.gz) \u2014 handle ctrl-c.\n \n Before building the docs, you should delete the documentation output directory: `rm -rf SAGE_ROOT/devel/sage/doc/output`.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68849"
}
```
...
```json
{
    "body": "<a id='comment:1'>Comment 1:</a>\nI have yet to test [attachment: trac_6495-redirect_html.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-redirect_html.patch.gz), but the docstring for `html` ends rather abruptly.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68855"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68857"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -35,30 +35,15 @@\n \n ---\n \n-Apply:\n+**Apply**:\n+- **run** the script [attachment: trac_6495-script.sh.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-script.sh.gz) from `devel/sage/doc/en/reference`.\n+- [attachment: trac_6495-other-parts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-other-parts.patch.gz)\n \n+Or, for those afraid of scripts: **Apply**:\n - [attachment: trac_6495-all-in-one.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-all-in-one.patch.gz).\n - [attachment: trac-6495_silence_warning-fh.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac-6495_silence_warning-fh.patch.gz).\n - [attachment: trac_6495-redirect_html.2.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-redirect_html.2.patch.gz).\n - [attachment: trac_6495-docstrings.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-docstrings.patch.gz).\n-\n-Or:\n-\n-- run the script [attachment: trac_6495-script.sh.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-script.sh.gz) from the directory `devel/sage/doc/en/reference`. Then run `hg commit` with the message\n-\n-```\n-Break reference manual into manageable pieces.\n-\n-doc/en/reference: move MODULE.rst to MODULE/index.rst, create MODULE/conf.py.\n-Add \".. include:: ../footer.txt\" to the end of each file MODULE/index.rst.\n-Move media files from media/ to MODULE/media/\n-Remove chapter cross-references (\".. _ch:...\") from MODULE/index.rst\n-```\n-(How do you pass a multline string to `hg commit -m ...` in a shell script?)\n-\n-and apply:\n-\n-- [attachment: trac_6495-other-parts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-other-parts.patch.gz)\n \n ---\n \n``````\n",
    "created_at": "2013-01-27T11:46:21Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68861"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,7 +36,7 @@\n ---\n \n **Apply**:\n-- [attachment: trac_6495-all-in-one.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-all-in-one.patch.gz).\n+- [attachment: trac_6495-all-in-one.patch-vb.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-all-in-one.patch-vb.gz).\n - [attachment: trac-6495_silence_warning-fh.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac-6495_silence_warning-fh.patch.gz).\n - [attachment: trac_6495-redirect_html.2.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-redirect_html.2.patch.gz).\n - [attachment: trac_6495-docstrings.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-docstrings.patch.gz).\n``````\n",
...
```json
{
    "body": "<a id='comment:0'>Comment 0:</a>\nI haven't verified that the intersphinx warning is gone, but I see two other possible problems: I get a warning \n\n```\n[reference] .../sage-5.7.beta2/devel/sage/doc/en/reference/sat/index.rst:: WARNING: document isn't included in any toctree\n```\nalong with some citations not being found. Also with [attachment: trac_6495_separate_inventory.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495_separate_inventory.patch.gz), the build is a bit slower than without: on my OS X box (with only two threads), the fastest time with the patch was 858 seconds, and more typical (5 out of 6 runs) was 885 seconds or more. Without the patch, the slowest time was 813 seconds.  On sage.math, with `MAKE=\"make -j12\"`: with the patch, 450 seconds, without the patch, 390 seconds.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,21 +36,17 @@\n ---\n \n **Apply**:\n-- [attachment: trac_6495-all-in-one.patch-vb.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-all-in-one.patch-vb.gz).\n-- [attachment: trac-6495_silence_warning-fh.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac-6495_silence_warning-fh.patch.gz).\n+- [(or run [attachment: trac_6495-script.sh.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-script.sh.gz)(https://github.com/sagemath/sage/files/ticket6495/dfd9548f2230722b5ede131e90df2c28.gz))\n+- [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz)\n+- [attachment: trac_6495-part3-the-remaining-vs-5.4.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining-vs-5.4.patch.gz)\n+- [attachment: trac_6495-part4-interrupts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part4-interrupts.patch.gz)\n+- [attachment: trac-6495_silence_warning-fh.v2.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac-6495_silence_warning-fh.v2.patch.gz).\n - [attachment: trac_6495-redirect_html.2.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-redirect_html.2.patch.gz).\n - [attachment: trac_6495-docstrings.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-docstrings.patch.gz).\n - [attachment: trac_6495_separate_inventory.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495_separate_inventory.patch.gz)\n - [attachment: trac_6495_fixes.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495_fixes.patch.gz)\n-\n+- [attachment: trac_6495-filtering.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-filtering.patch.gz)\n \n ---\n \n-For ease of review, you can instead look at the following four patches:\n-\n-- [attachment: trac_6495-part1-moving-files.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files.patch.gz) \u2014 this moves 'algebras.rst' to 'algebras/index.rst', and similarly for all other files.  It adds `.. include:: ../footer.txt` to the end of each of these files, and it removes any cross-referencing information like `.. _ch:groups:`, since that doesn't work anymore with the new structure.  It also creates identical files 'DIR/conf.py' in each of the new subdirectories of doc/en/reference, except for doc/en/algebras/conf.py.  That file is created in the next patch so that you can focus on reviewing just the second patch.\n-- [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz) \u2014 this does everything else; in other words, all of the important content is in this patch.\n-- [attachment: trac_6495-part3-the-remaining-vs-5.4.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining-vs-5.4.patch.gz) \u2014 this patch takes care of merging the indexes and the bibliography.\n-- [attachment: trac_6495-part4-interrupts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part4-interrupts.patch.gz) \u2014 handle ctrl-c.\n-\n Before building the docs, you should delete the documentation output directory: `rm -rf SAGE_ROOT/devel/sage/doc/output`. To test this, you should run `sage --docbuild all html` and `sage --docbuild all pdf`. (Note: just running `sage --docbuild reference html` will probably produce many warnings. If you run it a second time, the warnings should go away.)\n``````\n",
    "created_at": "2013-02-06T04:01:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,9 +36,9 @@\n ---\n \n **Apply**:\n-- [(or run [attachment: trac_6495-script.sh.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-script.sh.gz)(https://github.com/sagemath/sage/files/ticket6495/dfd9548f2230722b5ede131e90df2c28.gz))\n+- [(or run [attachment: trac_6495-script-jhp.sh.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-script-jhp.sh.gz)(https://github.com/sagemath/sage/files/ticket6495/dfd9548f2230722b5ede131e90df2c28.gz))\n - [attachment: trac_6495-part2-everything-else.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part2-everything-else.patch.gz)\n-- [attachment: trac_6495-part3-the-remaining-vs-5.4.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining-vs-5.4.patch.gz)\n+- [attachment: trac_6495-part3-the-remaining-vs-5.7.beta4.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part3-the-remaining-vs-5.7.beta4.patch.gz)\n - [attachment: trac_6495-part4-interrupts.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part4-interrupts.patch.gz)\n - [attachment: trac-6495_silence_warning-fh.v2.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac-6495_silence_warning-fh.v2.patch.gz).\n - [attachment: trac_6495-redirect_html.2.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-redirect_html.2.patch.gz).\n``````\n",
...
```json
{
    "body": "<a id='comment:0'>Comment 0:</a>\nAttachment: **[trac_6495-part1-moving-files-link.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files-link.patch.gz)**\n\n[attachment: trac_6495-script-jhp.2.sh.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-script-jhp.2.sh.gz) is identical to the old script; it can be deleted. (Why can't I delete my own attachments?)",
...
```json
{
    "body": "<a id='comment:244'>Comment 244:</a>\nReplying to [@vbraun](#comment%3A243):\n> Is there anything left to review? \n\nThe only unreviewed parts are [and the change to [attachment: trac_6495-part1-moving-files-link.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-part1-moving-files-link.patch.gz) to use symbolic links for `reference/MODULE/conf.py` (see [comment:229](https://github.com/sagemath/sage/files/ticket6495/210da332817721da7410ced3e73e0bbe.gz)).",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68863"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68864"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68867"
}
```
...
```json
{
    "body": "<a id='comment:1'>Comment 1:</a>\nNew spkg: http://sage.math.washington.edu/home/palmieri/SPKG/sphinx-1.1.2.p2.spkg.\nSee [attachment: trac_6495-sphinx-grammar.patch.gz](https://github.com/sagemath/sage/files/ticket6495/trac_6495-sphinx-grammar.patch.gz) for the changes.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68871"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68872"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68875"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68877"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6495#event-68879"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6495#issuecomment-46105",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6495#issuecomment-46106",
    "user": "https://github.com/jdemeyer"
}
```
