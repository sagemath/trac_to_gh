...
```json
{
    ...
    "rename": {
        "from": "Quadratics in GF(2^m)",
        "to": "[with patch, needs review] Quadratics in GF(2^m)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59801",
    "user": "https://trac.sagemath.org/admin/accounts/users/wakep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59802",
    "user": "https://trac.sagemath.org/admin/accounts/users/wakep"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59803",
    "user": "https://trac.sagemath.org/admin/accounts/users/wakep"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26713"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "rename": {
        "from": "[with patch, needs review] Quadratics in GF(2^m)",
        "to": "Quadratics in GF(2^m)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59804",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59805",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6607",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6607#issuecomment-59806",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26715"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26716"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26717"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26718"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26719"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26720"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26721"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6607#event-26722"
}
```
