...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75262"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75263"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75264"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75265"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75266"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6272#issuecomment-41716",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6272",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6272#event-75268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6272#issuecomment-41717",
    "user": "https://github.com/craigcitro"
}
```
