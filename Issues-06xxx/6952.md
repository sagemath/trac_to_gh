...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65732",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65733",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65734",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Thanks! I learned a few things about writing in ReST from your patch.  I won't make those mistakes again (like enumerated lists).\n\nThis applied and looks fine.\n\nI assume you merged the necessary patches to make the functions in these examples work.  They did not work for me with a copy of 4.1.1.alpha1.  So doctests really ought to be run on this file just to make sure that the examples are correct.",
    "created_at": "2009-09-19T02:57:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65735",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>Thanks! I learned a few things about writing in ReST from your patch.  I won't make those mistakes again (like enumerated lists).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65736",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65737",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65738",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6952#issuecomment-65739",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
