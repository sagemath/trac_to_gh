...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51200",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "Attachment [trac_6952-typo-fixes.patch](https://github.com/sagemath/sage/files/ticket6952/trac_6952-typo-fixes.patch) by mvngu created at 2009-09-17 23:57:21\n\ndepends on #6774",
    "created_at": "2009-09-17T23:57:21Z",
    "issue": "https://github.com/sagemath/sage/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51201",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Attachment [trac_6952-typo-fixes.patch](https://github.com/sagemath/sage/files/ticket6952/trac_6952-typo-fixes.patch) by mvngu created at 2009-09-17 23:57:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51202",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51203",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51204",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51205",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6952#issuecomment-51206",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
