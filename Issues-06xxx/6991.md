...
```json
{
    "body": "<a id='comment:1'></a>This is actually fixed by this patch (which needs a review):\n\nhttp://trac.sagemath.org/sage_trac/ticket/6778",
...
<a id='comment:1'></a>This is actually fixed by this patch (which needs a review):
...
```json
{
    "body": "<a id='comment:2'></a>OK, sorry about that.  I am working through your tickets and I should have looked more closely.  This ticket can be closed as a duplicate of 6778.\n\n-Marshall",
...
<a id='comment:2'></a>OK, sorry about that.  I am working through your tickets and I should have looked more closely.  This ticket can be closed as a duplicate of 6778.
