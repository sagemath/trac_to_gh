...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50921",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This looks good. Points for adding doctests to a bunch of functions, not just the ones you happened to add code to.\n\nOn a related note, should we start a wiki page or something with all the workarounds we can remove once we update to a modern Pari?",
    "created_at": "2009-06-04T23:17:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50922",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>This looks good. Points for adding doctests to a bunch of functions, not just the ones you happened to add code to.
...
```json
{
    "body": "<a id='comment:2'></a>This conflicts with my patch at #6188 (but only in a fairly harmless way). I have prepared a rebased patch, which also corrects a few minor indentation errors in the new docstrings, which I will upload once I've checked that the reference manual builds OK.",
    "created_at": "2009-06-08T10:50:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50923",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:2'></a>This conflicts with my patch at #6188 (but only in a fairly harmless way). I have prepared a rebased patch, which also corrects a few minor indentation errors in the new docstrings, which I will upload once I've checked that the reference manual builds OK.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50925",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50926",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50927",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6204#issuecomment-50928",
    "user": "https://github.com/loefflerd"
}
```
