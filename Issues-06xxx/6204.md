...
```json
{
    ...
    "asset_name": "trac_6204-degree-1-relative-norms.patch",
    "asset_url": "tarball://root/attachments/ticket6204/trac_6204-degree-1-relative-norms.patch",
    "created_at": "2009-06-04T03:38:03Z",
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6204/trac_6204-degree-1-relative-norms.patch",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    "body": "Attachment [trac_6204-degree-1-relative-norms.patch](https://github.com/sagemath/sage/files/ticket6204/trac_6204-degree-1-relative-norms.patch) by @ncalexan created at 2009-06-04 03:38:03",
    "created_at": "2009-06-04T03:38:03Z",
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42531",
    "user": "https://github.com/ncalexan"
}
```

Attachment [trac_6204-degree-1-relative-norms.patch](https://github.com/sagemath/sage/files/ticket6204/trac_6204-degree-1-relative-norms.patch) by @ncalexan created at 2009-06-04 03:38:03
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40241"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42532",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42533",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42534",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40243"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42535",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42536",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6204#issuecomment-42537",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40245"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40246"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40247"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40248"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40249"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40250"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40251"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40252"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40253"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6204#event-40254"
}
```
