...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg; needs review] visibility.c in libgcrypt attempts to return value from void function."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61900",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "rename": {
        "from": "[with spkg; needs review] visibility.c in libgcrypt attempts to return value from void function.",
        "to": "[with spkg, needs review] visibility.c in libgcrypt attempts to return value from void function."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27351"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61901",
...
```json
{
    ...
    "rename": {
        "from": "[with spkg, needs review] visibility.c in libgcrypt attempts to return value from void function.",
        "to": "[with spkg, needs work] visibility.c in libgcrypt attempts to return value from void function."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27352"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61902",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "rename": {
        "from": "[with spkg, needs work] visibility.c in libgcrypt attempts to return value from void function.",
        "to": "[with spkg, needs review] visibility.c in libgcrypt attempts to return value from void function."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61903",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61904",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with spkg, needs review] visibility.c in libgcrypt attempts to return value from void function.",
        "to": "[with spkg, needs review] fix messed up libgcrypt package"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61905",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61906",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61907",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61908",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "rename": {
        "from": "[with spkg, needs review] fix messed up libgcrypt package",
        "to": "fix messed up libgcrypt package"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27355"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6758#issuecomment-61909",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6758",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6758#event-27357"
}
```
