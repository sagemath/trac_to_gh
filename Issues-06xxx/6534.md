# Issue 6534: [with patch, positive review] Jacobi sums are calculated in a ridiculously roundabout fashion
...
```json
{
    ...
    "title": "[with patch, positive review] Jacobi sums are calculated in a ridiculously roundabout fashion",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6534#event-15411"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6534",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6534#event-15412"
}
```
