...
<a id='comment:1'></a>Attachment [trac_6766.patch](tarball://root/attachments/some-uuid/ticket6766/trac_6766.patch) by mvngu created at 2009-08-16 22:36:52
...
```json
{
    "body": "<a id='comment:2'></a>This looks good to me;  it applies fine to 4.1.1.  I only tested the file which was changed.",
...
<a id='comment:2'></a>This looks good to me;  it applies fine to 4.1.1.  I only tested the file which was changed.
...
<a id='comment:5'></a>I agree with John's comments, but  for the record: before (4.1.1)
...
<a id='comment:6'></a>Replying to [fwclarke](#comment%3A5):
> I agree with John's comments, but  for the record: before (4.1.1)
