...
```json
{
    "body": "<a id='comment:2'></a>I'll run this later today (its one minute past midnight here), but I understood that if DELETE_TMP was changed on line 76, to 0, then all intermediate files would be retained. Changing that line 76 causes a syntax error report. I'll run it later and shoe you the output. \n\nDave",
    "created_at": "2009-07-17T23:03:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60167",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:2'></a>I'll run this later today (its one minute past midnight here), but I understood that if DELETE_TMP was changed on line 76, to 0, then all intermediate files would be retained. Changing that line 76 causes a syntax error report. I'll run it later and shoe you the output. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60168",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60169",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "created_at": "2009-12-03T04:09:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60171",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I'm wondering if either of you guys have a clue how to solve this. It seems a trivial problem, but I just can't get it to work. \n\nI can see it is going to be needed soon for debugging on Solaris, as deleting all the source files makes debugging much harder, as the debugger does not have the source code.",
    "created_at": "2010-08-03T02:44:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60172",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>I'm wondering if either of you guys have a clue how to solve this. It seems a trivial problem, but I just can't get it to work. 
...
```json
{
    "body": "<a id='comment:8'></a>There's a patch at #4949 that subsumes this and uses a better name than `SAGE_KEEP_SPKG_BUILD`.",
    "created_at": "2010-08-06T22:37:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60174",
    "user": "https://github.com/qed777"
}
```

<a id='comment:8'></a>There's a patch at #4949 that subsumes this and uses a better name than `SAGE_KEEP_SPKG_BUILD`.
...
```json
{
    "body": "<a id='comment:9'></a>Fixed by various patches to `sage-spkg`.",
    "created_at": "2013-05-24T12:22:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60175",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>Fixed by various patches to `sage-spkg`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60176",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6550#issuecomment-60177",
    "user": "https://github.com/jdemeyer"
}
```
