...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42690",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42691",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42692",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Attachment [trac_6228-multiplicity-maxima.patch](https://github.com/sagemath/sage/files/ticket6228/trac_6228-multiplicity-maxima.patch) by @kcrisman created at 2009-09-29 14:49:36\n\nBased on 4.1.2.alpha4",
    "created_at": "2009-09-29T14:49:36Z",
    "issue": "https://github.com/sagemath/sage/issues/6228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42693",
    "user": "https://github.com/kcrisman"
}
```

Attachment [trac_6228-multiplicity-maxima.patch](https://github.com/sagemath/sage/files/ticket6228/trac_6228-multiplicity-maxima.patch) by @kcrisman created at 2009-09-29 14:49:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42694",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42695",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6228#issuecomment-42696",
    "user": "https://github.com/mwhansen"
}
```
