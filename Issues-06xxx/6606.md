...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59789",
    "user": "https://trac.sagemath.org/admin/accounts/users/simon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "rename": {
        "from": "[with patch; needs review] Add a more efficient implementation of index for Gamma(N).",
        "to": "[with patch; needs work] Add a more efficient implementation of index for Gamma(N)."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6606#event-26707"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59790",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59791",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "rename": {
        "from": "[with patch; needs work] Add a more efficient implementation of index for Gamma(N).",
        "to": "[with patch; needs review] Add a more efficient implementation of index for Gamma(N)."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6606#event-26708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59792",
    "user": "https://trac.sagemath.org/admin/accounts/users/simon"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] Add a more efficient implementation of index for Gamma(N).",
        "to": "[with patch; positive review] Add a more efficient implementation of index for Gamma(N)."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6606#event-26709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59793",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59794",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59795",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6606#event-26710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59796",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59797",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59798",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6606#issuecomment-59799",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6606",
    "rename": {
        "from": "[with patch; positive review] Add a more efficient implementation of index for Gamma(N).",
        "to": "[with patch, positive review] Add a more efficient implementation of index for Gamma(N)."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6606#event-26711"
}
```
