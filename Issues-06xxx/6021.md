...
```json
{
    "body": "<a id='comment:1'></a>The patch does what was proposed.\n\nI added an is_real() method to mpfr reals (returning True of course) also, for convenience.",
    "created_at": "2009-05-11T16:43:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52933",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>The patch does what was proposed.
...
```json
{
    "body": "<a id='comment:3'></a>It looks good so far. Is there any reason we're still using Pari to compute in the real embedding case rather than just doing it all ourself?",
    "created_at": "2009-05-11T19:36:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52934",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>It looks good so far. Is there any reason we're still using Pari to compute in the real embedding case rather than just doing it all ourself?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52935",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>There have been additional comments about this on sage-nt. As a result I am adding to the patch, providing also (1) normalization of periods, (2) local implementation in the real case as an option instead of calling pari.\n \nThere will be an additional patch, so I have downgraded this to \"not ready for review\".",
    "created_at": "2009-05-13T11:47:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52936",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>There have been additional comments about this on sage-nt. As a result I am adding to the patch, providing also (1) normalization of periods, (2) local implementation in the real case as an option instead of calling pari.
...
```json
{
    "body": "<a id='comment:7'></a>Looks good to me. Works as advertised and well documented. Nice work.",
    "created_at": "2009-05-15T00:32:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52938",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>Looks good to me. Works as advertised and well documented. Nice work.
...
```json
{
    "body": "<a id='comment:9'></a>Maybe it's a 32/64 thing (I only tested on 32-bit, my fault).\n\nI will look into it.",
    "created_at": "2009-05-15T07:16:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52940",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>Maybe it's a 32/64 thing (I only tested on 32-bit, my fault).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52941",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>There was some 32/64 fuzz, which I have fixed, but there were also some bugs in the precision handling, which have also been fixed.\n\nThe new patch trac_6021_new.patch replaces all previous, and is based on 4.0.alpha0.  I tested the problem files on both 32- and 64-bit.",
    "created_at": "2009-05-17T16:57:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52942",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:10'></a>There was some 32/64 fuzz, which I have fixed, but there were also some bugs in the precision handling, which have also been fixed.
...
```json
{
    "body": "<a id='comment:11'></a>Why are there so many ...'s? Since we're no longer using Pari (unless we explicitly ask for it) the result should be deterministic and platform independent. (We are using Pari for complex agm, but not for real agm, but it seems to return exactly the same thing both 64- and 32-bit systems).",
    "created_at": "2009-05-18T21:33:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52943",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:11'></a>Why are there so many ...'s? Since we're no longer using Pari (unless we explicitly ask for it) the result should be deterministic and platform independent. (We are using Pari for complex agm, but not for real agm, but it seems to return exactly the same thing both 64- and 32-bit systems).
...
```json
{
    "body": "<a id='comment:13'></a>I'm headed to bed soon, but I think Pari is involved in the root finding.",
    "created_at": "2009-05-19T08:21:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52945",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>I'm headed to bed soon, but I think Pari is involved in the root finding.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52946",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52947",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Looks good. I like the idea of using AA/QQbar for embeddings as well.",
    "created_at": "2009-05-26T18:38:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52949",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:15'></a>Looks good. I like the idea of using AA/QQbar for embeddings as well.
...
```json
{
    "body": "<a id='comment:16'></a>Thanks Robert.  I'm now working on moving the elliptic log code into the Lattice class, which certainly depends on this but there's no reason to delay this.",
    "created_at": "2009-05-26T21:10:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52950",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:16'></a>Thanks Robert.  I'm now working on moving the elliptic log code into the Lattice class, which certainly depends on this but there's no reason to delay this.
...
```json
{
    "body": "<a id='comment:18'></a>I moved the last patch to #6193, as it's really starting to implement new functionality (though there is some good cleanup/precision handling of this code as well).",
    "created_at": "2009-06-03T07:03:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52952",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:18'></a>I moved the last patch to #6193, as it's really starting to implement new functionality (though there is some good cleanup/precision handling of this code as well).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52953",
...
```json
{
    "body": "<a id='comment:19'></a>Merged all three patches in 4.0.1.rc0.",
    "created_at": "2009-06-03T20:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52954",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:19'></a>Merged all three patches in 4.0.1.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52955",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52956",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52957",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>See also #7719.",
    "created_at": "2009-12-17T10:29:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52958",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:21'></a>See also #7719.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6021#issuecomment-52959",
    "user": "https://github.com/JohnCremona"
}
```
