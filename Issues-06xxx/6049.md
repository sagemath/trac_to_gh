...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6049#issuecomment-52090",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6049#issuecomment-52091",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6049",
    "rename": {
        "from": "[with patch, needs review] bitset complement zeroes out last word if the bitset is a multiple of the word size",
        "to": "[with patch, positive review] bitset complement zeroes out last word if the bitset is a multiple of the word size"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6049#event-24263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6049",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6049#event-24264"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6049#issuecomment-52092",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6049#issuecomment-52093",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
