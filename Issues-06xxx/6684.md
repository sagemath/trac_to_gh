...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-60959",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "rename": {
        "from": "warnings when building reference manual in Sage 4.1.1.rc2",
        "to": "[with patch, needs review] warnings when building reference manual in Sage 4.1.1.rc2"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6684#event-27041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-60960",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-60961",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-60962",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "rename": {
        "from": "[with patch, needs review] warnings when building reference manual in Sage 4.1.1.rc2",
        "to": "[with patch, positive review] warnings when building reference manual in Sage 4.1.1.rc2"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6684#event-27042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-60963",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-60964",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6684#event-27043"
}
```
