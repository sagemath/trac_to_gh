...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-62250",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-62251",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-62252",
...
```json
{
    "body": "<a id='comment:2'></a>This fixes the warnings and the rendering of this page of the reference manual.  All tests pass.",
    "created_at": "2009-08-07T16:15:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-62253",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>This fixes the warnings and the rendering of this page of the reference manual.  All tests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-62254",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6684#issuecomment-62255",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
