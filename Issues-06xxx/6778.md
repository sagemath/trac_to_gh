...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_6778_nfacets_bug_in_lattice_polytope.patch](https://github.com/sagemath/sage/files/ticket6778/trac_6778_nfacets_bug_in_lattice_polytope.patch) by mhampton created at 2009-09-22 20:53:19\n\nThis is a simple patch for a simple bug.  I filed a duplicate ticket for this at #6991 which should be closed as well.",
    "created_at": "2009-09-22T20:53:19Z",
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-49413",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-49414",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-49415",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-49416",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-49417",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-49418",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
