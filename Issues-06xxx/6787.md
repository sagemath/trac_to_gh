...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62283",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6787#event-27475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62284",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] fix doctest failures in doc/en/tutorial/interfaces.rst due to upgrade to Maxima 5.19.0"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6787#event-27476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62285",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62286",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "Attachment [trac_6787.patch](tarball://root/attachments/some-uuid/ticket6787/trac_6787.patch) by @aghitza created at 2009-08-21 00:49:24\n\napply after spkg's at #6564 and #6699",
    "created_at": "2009-08-21T00:49:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62287",
    "user": "https://github.com/aghitza"
}
```

Attachment [trac_6787.patch](tarball://root/attachments/some-uuid/ticket6787/trac_6787.patch) by @aghitza created at 2009-08-21 00:49:24
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "rename": {
        "from": "[with patch, needs review] fix doctest failures in doc/en/tutorial/interfaces.rst due to upgrade to Maxima 5.19.0",
        "to": "[with patch, needs review] fix doctest failures in doc/en/tutorial/interfaces.rst due to upgrade to Maxima 5.19.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6787#event-27477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "rename": {
        "from": "[with patch, needs review] fix doctest failures in doc/en/tutorial/interfaces.rst due to upgrade to Maxima 5.19.1",
        "to": "fix doctest failures in doc/en/tutorial/interfaces.rst due to upgrade to Maxima 5.19.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6787#event-27478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62288",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6787#issuecomment-62289",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6787#event-27479"
}
```
