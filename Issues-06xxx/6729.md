...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62597",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62598",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_6729-leading_space.patch](tarball://root/attachments/some-uuid/ticket6729/trac_6729-leading_space.patch) by acleone created at 2010-01-20 01:47:53\n\nOk, trac_6729-leading_space.patch adds the expected behavior.\n\n```\nCELL 1:\n    u = 2\n    u = 3\nCELL 2:\nprint u  # = 3\n```\n\nHowever, this fails silently (regardless of the patch):\n\n```\nCELL 1:\n u = 2\n  u = 3\nCELL 2:\nprint u  # = 2\n```\n\nWith `%python`, it correctly throws an indentation error:\n\n```\nCELL 1:\n%python\n u = 2\n  u = 3\n# Identation error\n```\n\nSo this is a bug in the `%sage` compile system.",
    "created_at": "2010-01-20T01:47:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62599",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

<a id='comment:2'></a>Attachment [trac_6729-leading_space.patch](tarball://root/attachments/some-uuid/ticket6729/trac_6729-leading_space.patch) by acleone created at 2010-01-20 01:47:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62600",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62601",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62602",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>See #8006 for the silent Indentation errors",
    "created_at": "2010-01-20T02:02:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62603",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

<a id='comment:3'></a>See #8006 for the silent Indentation errors
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62604",
...
```json
{
    "body": "<a id='comment:4'></a>The first indent goes away after saving, e.g., this:\n\n```\n  print 2\n  print 4\n  print 6\n```\n\nbecomes \n\n```\nprint 2\n  print 4\n  print 6\n```\n\nupon save & quit and re-opening.",
    "created_at": "2010-01-20T07:37:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62605",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:4'></a>The first indent goes away after saving, e.g., this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62606",
...
```json
{
    "body": "<a id='comment:9'></a>It's pretty likely that this is caused by the same thing as https://github.com/sagemath/sagenb/issues/288",
    "created_at": "2014-12-09T19:37:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62607",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>It's pretty likely that this is caused by the same thing as https://github.com/sagemath/sagenb/issues/288
...
```json
{
    "body": "<a id='comment:10'></a>> The first indent goes away after saving, e.g., this:\n> \n> \n> ```\n>   print 2\n>   print 4\n>   print 6\n> ```\n> \n> becomes \n> \n> \n> ```\n> print 2\n>   print 4\n>   print 6\n> ```\n> \n> upon save & quit and re-opening.\n\nTo be fair, that happens no matter what we do.",
    "created_at": "2014-12-10T04:00:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62608",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>> The first indent goes away after saving, e.g., this:
> 
> 
> ```
>   print 2
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62609",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6729#issuecomment-62610",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
