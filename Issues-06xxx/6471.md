...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57516",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6471#event-26100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57517",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57518",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57519",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "rename": {
        "from": "clarify differences between c.abs() and c.norm() for complex c",
        "to": "[with patch, needs review] clarify differences between c.abs() and c.norm() for complex c"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6471#event-26101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "rename": {
        "from": "[with patch, needs review] clarify differences between c.abs() and c.norm() for complex c",
        "to": "[with patch, positive review] clarify differences between c.abs() and c.norm() for complex c"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6471#event-26102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57520",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57521",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57522",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57523",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6471#issuecomment-57524",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6471#event-26103"
}
```
