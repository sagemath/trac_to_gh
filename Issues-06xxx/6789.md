...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82381"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82382"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6789#issuecomment-48010",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82383"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6789#issuecomment-48011",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-82385"
}
```
