...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49077",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "Attachment [tree.png](https://github.com/sagemath/sage/files/ticket6747/tree.png) by boothby created at 2009-08-14 18:02:51\n\ndesired output",
    "created_at": "2009-08-14T18:02:51Z",
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49078",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

Attachment [tree.png](https://github.com/sagemath/sage/files/ticket6747/tree.png) by boothby created at 2009-08-14 18:02:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49079",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [6747_tree_layout.patch](https://github.com/sagemath/sage/files/ticket6747/6747_tree_layout.patch) by boothby created at 2009-08-14 23:24:48\n\nUhm... my code does nothing like what you said.  And I didn't post the patch because I hadn't cleaned it up / incorporated it into the GraphPlot class / documented it.  But now I have!",
    "created_at": "2009-08-14T23:24:48Z",
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49080",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49081",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49082",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49083",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49085",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49086",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49087",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6747#issuecomment-49088",
    "user": "https://github.com/mwhansen"
}
```
