...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64388",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64389",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>AFAICT, introspection doesn't work simply because the given class doesn't have such a method. If you look at the file `sage/rings/polynomial/infinite_polynomial_element.py`, you'll see that a custom `__getattr__` method is used to pass the call on to the *real element* `self._p`.\n\nMaybe Mike knows a trick to make introspection work as well.",
    "created_at": "2009-11-30T16:18:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64390",
    "user": "https://github.com/burcin"
}
```

<a id='comment:3'></a>AFAICT, introspection doesn't work simply because the given class doesn't have such a method. If you look at the file `sage/rings/polynomial/infinite_polynomial_element.py`, you'll see that a custom `__getattr__` method is used to pass the call on to the *real element* `self._p`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64391",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64392",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64393",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64394",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64395",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64396",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64397",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64399",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64400",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64401",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [6854_tab_completion.patch](tarball://root/attachments/some-uuid/ticket6854/6854_tab_completion.patch) by @simon-king-jena created at 2009-11-30 22:10:52\n\nHi!\n\nYet another patch (still under the same name). This time, I added some doc tests. \n\n`dir()` provides a nice indirect doc test for `__getattr__` (after all, this is where the introspection eventually got implemented). But I still don't know how to properly test tab completion. Hence, I call the relevant method directly, although it is underscore. \n\nCheers,\nSimon",
    "created_at": "2009-11-30T22:10:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64402",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>Attachment [6854_tab_completion.patch](tarball://root/attachments/some-uuid/ticket6854/6854_tab_completion.patch) by @simon-king-jena created at 2009-11-30 22:10:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64403",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [6854_tab_completion_doctest.patch](tarball://root/attachments/some-uuid/ticket6854/6854_tab_completion_doctest.patch) by @simon-king-jena created at 2009-12-01 13:56:00\n\nThe second patch (to be applied after the first) provides a nice indirect doc test for tab completion, according to William's advice at [sage-devel](http://groups.google.com/group/sage-devel/browse_thread/thread/1bf6652891c4e45).",
    "created_at": "2009-12-01T13:56:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64404",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>Attachment [6854_tab_completion_doctest.patch](tarball://root/attachments/some-uuid/ticket6854/6854_tab_completion_doctest.patch) by @simon-king-jena created at 2009-12-01 13:56:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64406",
...
```json
{
    "body": "<a id='comment:11'></a>Patch looks good, applies fine against alpha1, I have two doctest failures:\n\n```\nsage -t  devel/sage/sage/graphs/graph_generators.py # 2 doctests failed\nsage -t  devel/sage/sage/server/misc.py # Segfault\n```\n\nThe first one is a known alpha1 problem and the second one I cannot reproduce (it would also be rather unrelated).",
    "created_at": "2009-12-08T14:00:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64407",
    "user": "https://github.com/malb"
}
```

<a id='comment:11'></a>Patch looks good, applies fine against alpha1, I have two doctest failures:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64408",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64409",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6854#issuecomment-64410",
    "user": "https://github.com/mwhansen"
}
```
