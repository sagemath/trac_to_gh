...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57619",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57620",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57621",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I have a fix for this in my local pynac tree. I will make a new package with a few more bugfixes available soon.",
    "created_at": "2009-07-28T12:45:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57622",
    "user": "https://github.com/burcin"
}
```

<a id='comment:1'></a>I have a fix for this in my local pynac tree. I will make a new package with a few more bugfixes available soon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57623",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57624",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>There is no specific reason I chose that format. We can change it in the future if we decide on a convention.",
    "created_at": "2009-08-02T15:47:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57626",
    "user": "https://github.com/burcin"
}
```

<a id='comment:4'></a>There is no specific reason I chose that format. We can change it in the future if we decide on a convention.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57627",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57628",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57629",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57630",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6401#issuecomment-57631",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
