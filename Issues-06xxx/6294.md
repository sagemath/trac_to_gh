...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6294#issuecomment-54818",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "rename": {
        "from": "lisp command in sage is now totally broken (because of ecl switch)",
        "to": "[with patch, needs review] lisp command in sage is now totally broken (because of ecl switch)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6294#event-25189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6294#issuecomment-54819",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6294#issuecomment-54820",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6294#issuecomment-54821",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "rename": {
        "from": "[with patch, needs review] lisp command in sage is now totally broken (because of ecl switch)",
        "to": "[with patch, positive review] lisp command in sage is now totally broken (because of ecl switch)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6294#event-25190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6294#issuecomment-54822",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6294#issuecomment-54823",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6294",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6294#event-25191"
}
```
