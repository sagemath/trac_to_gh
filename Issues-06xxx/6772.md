...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63368",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Maxima changed so that big factorials are symbolic (which is bizarre, but anyways...), so the above example no longer works.  The following does work:\n\n```\nsage: a = maxima(10)^(10^5)\nsage: b = a^600\nBoom!\n```\n\nI suggest the way to fix this problem is to add this line to the startup of code for the Maxima interface:\n\n```\nmaxima._eval_line(\":lisp (ext:set-limit 'ext:heap-size 100000000000)\", \nwait_for_prompt=False)\n```",
    "created_at": "2009-11-16T16:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63369",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Maxima changed so that big factorials are symbolic (which is bizarre, but anyways...), so the above example no longer works.  The following does work:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63370",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Even better:\n\n```\nself._sendline(\":lisp (ext:set-limit 'ext:heap-size 0)\")\n```\n\nThe above appears to make the heap unlimited.",
    "created_at": "2009-11-16T16:26:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63371",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Even better:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63373",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I had a similar experience (476MB) with this example, except I had to use heap-size 0 (as suggested earlier) instead of what's above; if I use the above it goes boom at the second try, in fact it does even if I add another zero.",
    "created_at": "2009-11-18T17:22:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63374",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>I had a similar experience (476MB) with this example, except I had to use heap-size 0 (as suggested earlier) instead of what's above; if I use the above it goes boom at the second try, in fact it does even if I add another zero.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63375",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63376",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63377",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63378",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63379",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63380",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63381",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63382",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6772#issuecomment-63383",
    "user": "https://github.com/mwhansen"
}
```
