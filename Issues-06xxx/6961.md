...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76511"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76515"
}
```
...
```json
{
    "body": "<a id='comment:2'>Comment 2:</a>\nIt turns out defining this function wasn't as straightforward as I thought. Pynac defines 2 functions with the same name `psi`. :)\n\n[attachment: trac_6961-psi.patch.gz](https://github.com/sagemath/sage/files/ticket6961/trac_6961-psi.patch.gz) wraps these 2 functions, and provides a global `psi()` to call the appropriate one. Unpickling these correctly requires changes in pynac. I'll make a new pynac package available later this week.",
    "created_at": "2010-01-17T05:05:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76521"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76522"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76523"
}
```
...
```json
{
    "body": "Changed keywords from **** to **psi, gamma, digamma, polygamma**",
    "created_at": "2010-02-15T08:03:25Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
...
Changed keywords from **** to **psi, gamma, digamma, polygamma**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76524"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6961#issuecomment-51335",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6961#issuecomment-51336",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6961#issuecomment-51337",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6961#event-76531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6961#issuecomment-51338",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6961#issuecomment-51339",
    "user": "https://github.com/sagetrac-mvngu"
}
```
