...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55263",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55264",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I don't think GB computations over SR make sense. How do we compare with zero, e.g., this: `cos(x)^2 *X + sin(x)^2 * X - X`. How do we decide divisibility, e.g. is \"cos(x)\" zero?",
    "created_at": "2012-01-26T20:38:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55266",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>I don't think GB computations over SR make sense. How do we compare with zero, e.g., this: `cos(x)^2 *X + sin(x)^2 * X - X`. How do we decide divisibility, e.g. is "cos(x)" zero?
...
```json
{
    "body": "<a id='comment:4'></a>I've had situations where you can still compute a Groebner basis with some indeterminate coefficients. It's annoying to have to do all the work by hand, though. I can see implementing this with a warning that it may not make sense.",
    "created_at": "2012-01-26T21:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55267",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:4'></a>I've had situations where you can still compute a Groebner basis with some indeterminate coefficients. It's annoying to have to do all the work by hand, though. I can see implementing this with a warning that it may not make sense.
...
```json
{
    "body": "<a id='comment:7'></a>Would this work when we place some assumptions on the variables; e.g., `a<sup>2+b</sup>2==1`? That was my particular situations, and I was under the impression that doing it in the way you suggest won't work for that.",
    "created_at": "2012-01-26T23:11:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55270",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:7'></a>Would this work when we place some assumptions on the variables; e.g., `a<sup>2+b</sup>2==1`? That was my particular situations, and I was under the impression that doing it in the way you suggest won't work for that.
...
```json
{
    "body": "<a id='comment:8'></a>(Sorry, I meant assumptions on the coefficients.)",
    "created_at": "2012-01-26T23:16:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55271",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:8'></a>(Sorry, I meant assumptions on the coefficients.)
...
```json
{
    "body": "<a id='comment:9'></a>This might be naive, but can't you add `a<sup>2+b</sup>2 - 1` to your ideal?",
    "created_at": "2012-01-26T23:45:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55272",
    "user": "https://github.com/malb"
}
```

<a id='comment:9'></a>This might be naive, but can't you add `a<sup>2+b</sup>2 - 1` to your ideal?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55273",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Unfortunately, your construction bombs out when we try to construct an actual ideal:\n\n```\nsage: R.<a,b> = QQ[]\nsage: I = R.ideal(a^2+b^2-1)\nsage: R2 = QuotientRing(R,I)\nsage: K = Frac(R2)\nsage: P.<x,y,z> = K[]\nsage: f = (a^2+b^2)*x + 1\nsage: g = x + 1\nsage: f - g\n0\nsage: Ideal([f,g])\nNotImplementedError\n```",
    "created_at": "2012-01-27T08:28:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55275",
    "user": "https://github.com/malb"
}
```

<a id='comment:12'></a>Unfortunately, your construction bombs out when we try to construct an actual ideal:
...
```json
{
    "body": "<a id='comment:14'></a>Nope, unfortunately, I don't.",
    "created_at": "2012-01-27T17:11:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55277",
    "user": "https://github.com/malb"
}
```

<a id='comment:14'></a>Nope, unfortunately, I don't.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55279",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I decided to upload the patch here. I didn't think a doctest was appropriate, but I can add one if desired.",
    "created_at": "2012-02-02T01:37:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55280",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:16'></a>I decided to upload the patch here. I didn't think a doctest was appropriate, but I can add one if desired.
...
```json
{
    "body": "<a id='comment:17'></a>Whoops -- the patch introduces doctest failures. I'll look into them.",
    "created_at": "2012-02-02T01:49:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55281",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:17'></a>Whoops -- the patch introduces doctest failures. I'll look into them.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55282",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55283",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Okay, that was pretty dumb. Fixed now. Added a doctest while I was at it.",
    "created_at": "2012-02-02T02:03:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55284",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:18'></a>Okay, that was pretty dumb. Fixed now. Added a doctest while I was at it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55285",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55286",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55287",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55288",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55289",
...
```json
{
    "body": "<a id='comment:20'></a>You should replace the line number in\n\n```\nverbose 0 (2854: multi_polynomial_ideal.py, groebner_basis) Warning: falling back to very slow toy implementation\n```\nby \"...\" because the line number will change all the time.",
    "created_at": "2012-02-05T11:25:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55290",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>You should replace the line number in
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55291",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55292",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Sorry, I should have thought of that myself.\n\nI remembered this time to check the box to replace the file of the same name, so I've changed the directions (& link) on which patch to apply.",
    "created_at": "2012-02-07T17:20:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55293",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:21'></a>Sorry, I should have thought of that myself.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55294",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55295",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Please write a proper commit message for your patch, use `hg qrefresh -e` for this.",
    "created_at": "2012-02-11T00:29:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55296",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>Please write a proper commit message for your patch, use `hg qrefresh -e` for this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55297",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55298",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>I should have thought of that, too. Sorry again...",
    "created_at": "2012-02-11T15:24:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55299",
    "user": "https://github.com/johnperry-math"
}
```

<a id='comment:24'></a>I should have thought of that, too. Sorry again...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55300",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6581#issuecomment-55301",
    "user": "https://github.com/jdemeyer"
}
```
