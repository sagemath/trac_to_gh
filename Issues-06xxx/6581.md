...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71848"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71858"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,4 +14,4 @@\n \n **Apply:**\n \n-    `trac_6581_enable_more_ideals_for_toy_buchberger.2.patch`\n+    [attachment: trac_6581_enable_more_ideals_for_toy_buchberger.2.patch.gz](https://github.com/sagemath/sage/files/ticket6581/trac_6581_enable_more_ideals_for_toy_buchberger.2.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6581#issuecomment-47080",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6581#issuecomment-47081",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71868"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6581#issuecomment-47082",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6581#issuecomment-47083",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71870"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6581#issuecomment-47084",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71871"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71872"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6581#event-71874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6581",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6581#issuecomment-47085",
    "user": "https://github.com/jdemeyer"
}
```
