...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43534",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41089"
}
```
...
```json
{
    ...
    "label": "trivial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41091"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41092"
}
```
...
```json
{
    "body": "Attachment [trac_6323.patch](https://github.com/sagemath/sage/files/ticket6323/trac_6323.patch) by @mwhansen created at 2013-06-21 15:29:41",
    "created_at": "2013-06-21T15:29:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43535",
    "user": "https://github.com/mwhansen"
}
```

Attachment [trac_6323.patch](https://github.com/sagemath/sage/files/ticket6323/trac_6323.patch) by @mwhansen created at 2013-06-21 15:29:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43536",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43537",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41095"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_6323-rev.patch](https://github.com/sagemath/sage/files/ticket6323/trac_6323-rev.patch) by @nathanncohen created at 2013-06-27 17:08:20\n\nHmmmmmm... The doctests do not pass because of a bug in Sage's interface with sloane, and #10358 fixes the file anyway !\n\nNathann",
    "created_at": "2013-06-27T17:08:20Z",
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43538",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43539",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43540",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41096"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43541",
