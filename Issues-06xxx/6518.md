# Issue 6518: [with patch, positive review] doctest script uses deprecated signature for showwarning
...
```json
{
    ...
    "title": "[with patch, positive review] doctest script uses deprecated signature for showwarning",
    "type": "issue",
