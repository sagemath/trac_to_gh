...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6061#issuecomment-52182",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6061#issuecomment-52183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6061",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6061#event-24301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6061#issuecomment-52184",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6061",
    "rename": {
        "from": "[with patch; needs review] refresh the pickle jar",
        "to": "[with patch; positive review] refresh the pickle jar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6061#event-24302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6061#issuecomment-52185",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
