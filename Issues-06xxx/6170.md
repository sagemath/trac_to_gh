# Issue 6170: [with patch, positive review] automate applying patches from a ticket and testing them
...
```json
{
    ...
    "title": "[with patch, positive review] automate applying patches from a ticket and testing them",
    "type": "issue",
