...
```json
{
    "body": "<a id='comment:1'></a>It was very easily fixed, with just a bit of code to change a flag is the operating system is Solaris and the linker is Suns. There was already code to apply a patch for OS X, do I just added to that, so spkg-install now has:\n\n```\nif [ `uname` = \"Darwin\" -a \"$SAGE64\" = \"yes\" ]; then\n   echo \"64 bit MacIntel\"\n   CFLAGS=\"-O3 -g -m64 -fPIC -L.\"; export CFLAGS\n   LDFLAGS=\"-m64 \"; export LDFLAGS\n   cp patches/makemakefile.py src/makemakefile.py\nelif [ `uname` = \"SunOS\" -a \"`ld  --version  2>&1  | grep GNU`\" = \"\"  ]; then\n   # Change -soname to -h if the Sun linker is used.\n   sed 's/-soname/-h/g' src/makemakefile.py > /tmp/makemakefile.py.$$\n   mv /tmp/makemakefile.py.$$ src/makemakefile.py\n   CFLAGS=\"-fPIC -O3 -L.\"; export CFLAGS\n   LDFLAGS=\"\"; export LDFLAGS\nelse\n   CFLAGS=\"-fPIC -O3 -L.\"; export CFLAGS\n   LDFLAGS=\"\"; export LDFLAGS\nfi\n```\n\nhttp://sage.math.washington.edu/home/kirkby/Solaris-fixes/zn_poly/",
    "created_at": "2009-06-29T02:36:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58109",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>It was very easily fixed, with just a bit of code to change a flag is the operating system is Solaris and the linker is Suns. There was already code to apply a patch for OS X, do I just added to that, so spkg-install now has:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58110",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58111",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58113",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58115",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This is a \n\n```\n****************\nPOSITIVE REVIEW!\n****************\n```\nMay the Solarisification of Sage... er... I mean the force be with you :-)",
    "created_at": "2009-07-15T18:48:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58116",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:7'></a>This is a 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58117",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Just to let people know, this has been merged in sage-4.1.1-alpha0. I can't close this ticket because I don't have the privilege to do so. Sorry, folks :-(",
    "created_at": "2009-07-16T10:26:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58118",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:8'></a>Just to let people know, this has been merged in sage-4.1.1-alpha0. I can't close this ticket because I don't have the privilege to do so. Sorry, folks :-(
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58119",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6443#issuecomment-58120",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6443",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6443#event-15195"
}
```
