...
```json
{
    "body": "**Attachment:** [trac_6956-derivatives.patch](https://github.com/sagemath/sage/files/ticket6956/trac_6956-derivatives.patch)\n\nAdded _derivative() functions to all functions in `trig.py` and `hyperbolic.py`",
    "created_at": "2009-09-19T00:24:46Z",
    "issue": "https://github.com/sagemath/sage/issues/6956",
    "type": "issue_comment",
...
**Attachment:** [trac_6956-derivatives.patch](https://github.com/sagemath/sage/files/ticket6956/trac_6956-derivatives.patch)
