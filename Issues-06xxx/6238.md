...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67346"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67349"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6238#issuecomment-42850",
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67352"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6238",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-67353"
}
```
