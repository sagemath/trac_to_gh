...
```json
{
    ...
    "created_at": "2009-08-17T16:17:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63166",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63167",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63168",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63170",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63171",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63172",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63173",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63174",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63175",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63176",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63177",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63178",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63179",
...
```json
{
    "body": "<a id='comment:14'></a>Replying to [gmhossain](#comment%3A13):\n> Replying to [burcin](#comment%3A12):\n> > Note that with these patches, the result of `f(y,y).diff(y)` is twice that of the current implementation.\n\n> \n> This is not accurate. \n> \n> Above will happen only when an user wants to apply chain rule by explicitly setting \n> diff_derivative_level to \"2\" or more and certainly NOT in default diff level of \"1\". \n> If some user wants to use some setting that are not default then its reasonable to\n> expect users to read the documentation to be aware of the assumptions associated with\n> the settings.\n\n\nSo you agree that setting this level to 2 gives wrong results. In[comment:10](#comment%3A10), I tried to say that this option that gives wrong results should be removed.\n\nWe can then merge this *inert* derivative with the global `diff` command by adding a keyword option `hold`. E.g.,\n\n```\nsage: f(y,y).diff(y,1)\nD[0](f)(y, y) + D[1](f)(y, y)\nsage: f(y,y).diff(y,1,hold=True)\ndiff(f(y, y), y, 1)\n```",
    "created_at": "2009-09-06T23:01:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63183",
    "user": "https://github.com/burcin"
}
```

<a id='comment:14'></a>Replying to [gmhossain](#comment%3A13):
> Replying to [burcin](#comment%3A12):
> > Note that with these patches, the result of `f(y,y).diff(y)` is twice that of the current implementation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63184",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63186",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63187",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63188",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63189",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63190",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63191",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63192",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6756#issuecomment-63193",
    "user": "https://github.com/kcrisman"
}
```
