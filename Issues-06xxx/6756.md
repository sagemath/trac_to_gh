...
```json
{
    ...
    "type": "issue",
    "updated_at": "2021-09-23T17:55:58Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74011"
}
```
...
```json
{
    "body": "Attachment: **[trac_6756-referee-patch-ncalexan-1.patch.gz](https://github.com/sagemath/sage/files/ticket6756/trac_6756-referee-patch-ncalexan-1.patch.gz)**",
...
Attachment: **[trac_6756-referee-patch-ncalexan-1.patch.gz](https://github.com/sagemath/sage/files/ticket6756/trac_6756-referee-patch-ncalexan-1.patch.gz)**
...
```json
{
    "body": "Attachment: **[trac_6756-diff-derivative-sage-v2.patch.gz](https://github.com/sagemath/sage/files/ticket6756/trac_6756-diff-derivative-sage-v2.patch.gz)**\n\nApply only this patch and ignore first two patches",
...
Attachment: **[trac_6756-diff-derivative-sage-v2.patch.gz](https://github.com/sagemath/sage/files/ticket6756/trac_6756-diff-derivative-sage-v2.patch.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74015"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-49227",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-49228",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-49229",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-49230",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-49231",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-49232",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-74023"
}
```
