...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47656",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47657",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47658",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47659",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47660",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47661",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47662",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47663",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47664",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47665",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47666",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47667",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47668",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47669",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47670",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47671",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47672",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    "body": "<div id=\"comment:14\" align=\"right\">comment:14</div>\n\nReplying to [@golam-m-hossain](#comment:13):\n> Replying to [@burcin](#comment:12):\n> > Note that with these patches, the result of `f(y,y).diff(y)` is twice that of the current implementation.\n\n> \n> This is not accurate. \n> \n> Above will happen only when an user wants to apply chain rule by explicitly setting \n> diff_derivative_level to \"2\" or more and certainly NOT in default diff level of \"1\". \n> If some user wants to use some setting that are not default then its reasonable to\n> expect users to read the documentation to be aware of the assumptions associated with\n> the settings.\n\nSo you agree that setting this level to 2 gives wrong results. In [comment:10](#comment:10), I tried to say that this option that gives wrong results should be removed.\n\nWe can then merge this *inert* derivative with the global `diff` command by adding a keyword option `hold`. E.g.,\n\n```\nsage: f(y,y).diff(y,1)\nD[0](f)(y, y) + D[1](f)(y, y)\nsage: f(y,y).diff(y,1,hold=True)\ndiff(f(y, y), y, 1)\n```",
    "created_at": "2009-09-06T23:01:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47673",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47674",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47676",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47677",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47678",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6756#issuecomment-47679",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6756#event-82243"
}
```
