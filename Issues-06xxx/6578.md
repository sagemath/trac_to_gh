...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47005",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6578/trac-6578-subgraph-refactoring.patch",
    "created_at": "2009-07-21T11:41:40Z",
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6578/trac-6578-subgraph-refactoring.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47007",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47008",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47009",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47010",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47011",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47012",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47013",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6578/trac_6578-referee.patch",
    "created_at": "2009-07-23T05:24:40Z",
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6578/trac_6578-referee.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [trac_6578-referee.patch](https://github.com/sagemath/sage/files/ticket6578/trac_6578-referee.patch) by mvngu created at 2009-07-23 05:24:40\n\nThe patch `trac_6578-referee.patch` adds a missing double colon \"::\". It also deletes two sets of redundant double colons.",
    "created_at": "2009-07-23T05:24:40Z",
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47014",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6578#issuecomment-47015",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
