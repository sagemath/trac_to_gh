...
```json
{
    "body": "Changed assignee from **@mwhansen** to **@sagetrac-numata**",
...
Changed assignee from **@mwhansen** to **@sagetrac-numata**
...
```json
{
    "body": "Changed assignee from **@sagetrac-numata** to **@hivert**",
    "created_at": "2010-04-22T19:03:40Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6655",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-numata** to **@hivert**
