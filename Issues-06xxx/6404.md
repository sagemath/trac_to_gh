...
```json
{
    "body": "<a id='comment:1'></a>I have a fix for this in my local pynac tree. I'll make a new pynac package available soon, with some other bug fixes.",
    "created_at": "2009-07-28T12:14:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6404",
    "type": "issue_comment",
...
<a id='comment:1'></a>I have a fix for this in my local pynac tree. I'll make a new pynac package available soon, with some other bug fixes.
...
<a id='comment:2'></a>New pynac package is available here:
...
<a id='comment:4'></a>I applied patches in the following order:
1. the spkg `pynac-0.1.8.p2.spkg`
2. `trac_6404-conjugate_typesetting.patch`
3. `trac_6401-real_imag_typesetting.patch`
4. `trac_6377-exp_infinity.patch`
