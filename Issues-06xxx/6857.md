...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6857#issuecomment-63123",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6857",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6857#issuecomment-63124",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6857",
    "rename": {
        "from": "[with patch, needs review] in automorphism_group, orbits=True does not translate vertices back",
        "to": "[with patch, positive review] in automorphism_group, orbits=True does not translate vertices back"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6857#event-27732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6857",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6857#issuecomment-63125",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6857",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6857#event-27733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6857",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6857#issuecomment-63126",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6857",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6857#issuecomment-63127",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
