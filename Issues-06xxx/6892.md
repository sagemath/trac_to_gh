...
```json
{
    "body": "<a id='comment:1'></a>Apply only trac_6892-dollars-rebased.patch.  This adds a little documentation in the developer's guide about using dollar signs instead of backticks.",
...
<a id='comment:1'></a>Apply only trac_6892-dollars-rebased.patch.  This adds a little documentation in the developer's guide about using dollar signs instead of backticks.
