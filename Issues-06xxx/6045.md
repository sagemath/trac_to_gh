...
```json
{
    "body": "<a id='comment:1'></a>I just looked at this and realized I can't just lift_x, I need to pick the right one. That should be easy given I have it embedded into C.",
    "created_at": "2009-05-16T03:11:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53183",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>I just looked at this and realized I can't just lift_x, I need to pick the right one. That should be easy given I have it embedded into C.
...
```json
{
    "body": "<a id='comment:2'></a>Fixed the lifting issue, ready for review.",
    "created_at": "2009-06-06T06:30:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53184",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>Fixed the lifting issue, ready for review.
...
```json
{
    "body": "<a id='comment:3'></a>This code isn't ready for primetime, even with the lifting issue fixed, because increasing the precision until algdep succeeds is a recipe for disaster.  Maybe a bound on the number of precision increases?",
    "created_at": "2009-06-06T20:26:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53185",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:3'></a>This code isn't ready for primetime, even with the lifting issue fixed, because increasing the precision until algdep succeeds is a recipe for disaster.  Maybe a bound on the number of precision increases?
...
```json
{
    "body": "<a id='comment:5'></a>There is a bound on how often it increases precision--in fact it's even one of the parameters (max_prec).",
    "created_at": "2009-06-06T23:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53186",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>There is a bound on how often it increases precision--in fact it's even one of the parameters (max_prec).
...
```json
{
    "body": "<a id='comment:6'></a>Sorry, totally asleep at the wheel.  This looks good to me, but I'm not expert in the genus 1 case.  Maybe was can be the final word?",
    "created_at": "2009-06-06T23:13:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53187",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:6'></a>Sorry, totally asleep at the wheel.  This looks good to me, but I'm not expert in the genus 1 case.  Maybe was can be the final word?
...
```json
{
    "body": "<a id='comment:7'></a>I'm intending to try this and review it since I have implemented similar in C++ and in gp.",
    "created_at": "2009-06-14T17:32:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53188",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>I'm intending to try this and review it since I have implemented similar in C++ and in gp.
...
```json
{
    "body": "<a id='comment:10'></a>Some of these are due to new symbolics printing differently, others may be due to different choices of root (it was developed on Sage < 4.0). I'll rebase and see what's up.",
    "created_at": "2009-06-17T06:19:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53190",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:10'></a>Some of these are due to new symbolics printing differently, others may be due to different choices of root (it was developed on Sage < 4.0). I'll rebase and see what's up.
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [6045-heegner.patch](tarball://root/attachments/some-uuid/ticket6045/6045-heegner.patch) by @robertwb created at 2009-06-23 08:58:57\n\nOK, I fixed the patch. As well as the symbolics printing changes, I had moved some doctests around and got some of them associated with the wrong output. Based on 4.0.2, ready to be looked at again.",
    "created_at": "2009-06-23T08:58:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53191",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:11'></a>Attachment [6045-heegner.patch](tarball://root/attachments/some-uuid/ticket6045/6045-heegner.patch) by @robertwb created at 2009-06-23 08:58:57
...
```json
{
    "body": "<a id='comment:13'></a>That's a clever way of getting someone to review your work :). Actually, I was planning on looking at your elliptic exponential function anyways, so I'll go review that (and modify this to use it, under the very safe assumption that it's good).",
    "created_at": "2009-06-25T03:42:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53193",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>That's a clever way of getting someone to review your work :). Actually, I was planning on looking at your elliptic exponential function anyways, so I'll go review that (and modify this to use it, under the very safe assumption that it's good).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53194",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Depends on #6386.",
    "created_at": "2009-06-26T04:47:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53195",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:15'></a>Depends on #6386.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53196",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53201",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Attachment [6045-heegner-more-fixes.patch](tarball://root/attachments/some-uuid/ticket6045/6045-heegner-more-fixes.patch) by @robertwb created at 2009-07-04 22:15:38\n\nApply all four patches.",
    "created_at": "2009-07-04T22:15:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53204",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:22'></a>Attachment [6045-heegner-more-fixes.patch](tarball://root/attachments/some-uuid/ticket6045/6045-heegner-more-fixes.patch) by @robertwb created at 2009-07-04 22:15:38
...
```json
{
    "body": "<a id='comment:23'></a>This looks ok now.  I applied it to 4.1.alpha3 + patches from #6386.  Tests pass.  Assuming that it's still ok with rc0 this can go in now.",
    "created_at": "2009-07-09T11:53:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53205",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:23'></a>This looks ok now.  I applied it to 4.1.alpha3 + patches from #6386.  Tests pass.  Assuming that it's still ok with rc0 this can go in now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53206",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53207",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Attachment [6045-heegner-doctest-noise.patch](tarball://root/attachments/some-uuid/ticket6045/6045-heegner-doctest-noise.patch) by @robertwb created at 2009-07-20 15:16:36\n\nNoise issue fixed.",
    "created_at": "2009-07-20T15:16:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53209",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:26'></a>Attachment [6045-heegner-doctest-noise.patch](tarball://root/attachments/some-uuid/ticket6045/6045-heegner-doctest-noise.patch) by @robertwb created at 2009-07-20 15:16:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53210",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53211",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53212",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>Ticket #4849 has been closed as a duplicate of this ticket.",
    "created_at": "2009-07-20T15:52:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6045#issuecomment-53213",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:29'></a>Ticket #4849 has been closed as a duplicate of this ticket.
