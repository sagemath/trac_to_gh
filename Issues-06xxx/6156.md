...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53297",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "rename": {
        "from": "gap packages don't load anymore on itanium, even with gap-4.4.10.p11 (!)",
        "to": "[with patch; needs review] gap packages don't load anymore on itanium, even with gap-4.4.10.p11 (!)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6156#event-24708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53298",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53299",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6156#event-24709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "rename": {
        "from": "[with patch; needs review] gap packages don't load anymore on itanium, even with gap-4.4.10.p11 (!)",
        "to": "[with patch; positive review] gap packages don't load anymore on itanium, even with gap-4.4.10.p11 (!)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6156#event-24710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53300",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53301",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53302",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6156#issuecomment-53303",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
