...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6784#event-27461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62262",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62263",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62264",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] fix doctest failures in doc/en/constructions/interface_issues.rst due to upgrade to Maxima 5.19.0"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6784#event-27462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62265",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62266",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "rename": {
        "from": "[with patch, needs review] fix doctest failures in doc/en/constructions/interface_issues.rst due to upgrade to Maxima 5.19.0",
        "to": "[with patch, needs review] fix doctest failures in doc/en/constructions/interface_issues.rst due to upgrade to Maxima 5.19.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6784#event-27463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "rename": {
        "from": "[with patch, needs review] fix doctest failures in doc/en/constructions/interface_issues.rst due to upgrade to Maxima 5.19.1",
        "to": "fix doctest failures in doc/en/constructions/interface_issues.rst due to upgrade to Maxima 5.19.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6784#event-27464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62267",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6784#issuecomment-62268",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6784",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6784#event-27465"
}
```
