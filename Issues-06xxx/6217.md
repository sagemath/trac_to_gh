...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_6217.patch](tarball://root/attachments/some-uuid/ticket6217/trac_6217.patch) by @mwhansen created at 2009-06-05 00:53:15\n\nI've made it so that the examples don't use the string 'a' as a bases since that was causing problems for the sorting.",
    "created_at": "2009-06-05T00:53:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6217#issuecomment-55215",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>Attachment [trac_6217.patch](tarball://root/attachments/some-uuid/ticket6217/trac_6217.patch) by @mwhansen created at 2009-06-05 00:53:15
...
```json
{
    "body": "<a id='comment:3'></a>merged in 4.0.1.rc3",
    "created_at": "2009-06-06T16:54:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6217#issuecomment-55216",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>merged in 4.0.1.rc3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6217#issuecomment-55217",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6217#issuecomment-55218",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6217#issuecomment-55219",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6217#issuecomment-55220",
    "user": "https://github.com/mwhansen"
}
```
