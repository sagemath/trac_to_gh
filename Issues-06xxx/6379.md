# Issue 6379: [with patch, positive review] #2513 made R.py doctest fail for non-english locale
...
```json
{
    ...
    "title": "[with patch, positive review] #2513 made R.py doctest fail for non-english locale",
    "type": "issue",
