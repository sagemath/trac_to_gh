...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76943"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76948"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6997",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-76949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6997#issuecomment-51647",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6997#issuecomment-51648",
    "user": "https://github.com/sagetrac-mvngu"
}
```
