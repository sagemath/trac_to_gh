...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52678",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52679",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52681",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52682",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52683",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [tornout_firefox.png](tarball://root/attachments/some-uuid/ticket6001/tornout_firefox.png) by @qed777 created at 2009-05-07 01:49:55\n\nUnexciting inaction shots:\n\n<img src=\"tearout_opera.png\" width=200px, right>\n<img src=\"tornout_firefox.png\" width=200px, left>\n\nThis ticket could *really* use *your* help.\n\nBy the way, to get rounded [docstring] borders in Firefox 3, put something like\n\n```\ndiv.docstring {\n    -moz-border-radius: 0.5em;\n    -webkit-border-radius: 0.5em;\n}\n```\nin `DOT_SAGE/notebook.css` .  I haven't tested this in Safari.",
    "created_at": "2009-05-07T01:49:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52684",
    "user": "https://github.com/qed777"
}
```

<a id='comment:3'></a>Attachment [tornout_firefox.png](tarball://root/attachments/some-uuid/ticket6001/tornout_firefox.png) by @qed777 created at 2009-05-07 01:49:55
...
```json
{
    "body": "<a id='comment:5'></a>On a Mac, works well with Firefox but not with Safari.  With Safari, clicking the tear-out button opens up a new blank window and leaves the docstring in the original window.\n\nWith Firefox, looks great, and I like font-resizing and toggling.",
    "created_at": "2009-05-09T02:08:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52685",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>On a Mac, works well with Firefox but not with Safari.  With Safari, clicking the tear-out button opens up a new blank window and leaves the docstring in the original window.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52686",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52688",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52689",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52691",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52692",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Version 4 is available.  New features: multiple columns, height limits.  Tested on Linux in Opera 9 and Firefox 3.  Note: Drag-and-drop in the latter is still problematic, but a jQuery/UI upgrade will fix this.  To do:\n* Add a function to \"balance\" or \"equalize\" columns, either by the number of docstrings or, perhaps, instantaneous total height.\n* Query sage-devel for volunteers to design nice icons?\n* Test on Mac OS X, though I can't do this myself.\n* Re-test on Windows.\n\nBy the way, running\n\n```\nhtml('<script>introspect.test1(10)</script>')\n```\nin a cell should open 10 docstrings selected not quite at random.  Alternatively, evaluate `introspect.test1(10)` in [Firebug's](http://getfirebug.com/) console.  See the code for details.",
    "created_at": "2009-06-04T10:20:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52693",
    "user": "https://github.com/qed777"
}
```

<a id='comment:8'></a>Version 4 is available.  New features: multiple columns, height limits.  Tested on Linux in Opera 9 and Firefox 3.  Note: Drag-and-drop in the latter is still problematic, but a jQuery/UI upgrade will fix this.  To do:
* Add a function to "balance" or "equalize" columns, either by the number of docstrings or, perhaps, instantaneous total height.
* Query sage-devel for volunteers to design nice icons?
* Test on Mac OS X, though I can't do this myself.
* Re-test on Windows.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52694",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>See [sage-devel](http://groups.google.com/group/sage-devel/msg/89996604f6cd9c6f) for thoughts about something almost completely different.  See [also](http://www.smartclient.com/docs/7.0rc2/a/b/c/go.html#search%3Dpython).",
    "created_at": "2009-09-23T00:57:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52695",
    "user": "https://github.com/qed777"
}
```

<a id='comment:10'></a>See [sage-devel](http://groups.google.com/group/sage-devel/msg/89996604f6cd9c6f) for thoughts about something almost completely different.  See [also](http://www.smartclient.com/docs/7.0rc2/a/b/c/go.html#search%3Dpython).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52696",
...
```json
{
    "body": "<a id='comment:11'></a>I think this has been fixed by one of the recent patches (~January). Close?",
    "created_at": "2010-04-21T20:15:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52697",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:11'></a>I think this has been fixed by one of the recent patches (~January). Close?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52698",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52700",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52701",
...
```json
{
    "body": "<a id='comment:13'></a>The original thing mentioned has long since been done, as pointed out, and the other piece is just far too vague to merit a specific ticket.  After five years, probably time to close.",
    "created_at": "2014-12-19T04:06:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52702",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:13'></a>The original thing mentioned has long since been done, as pointed out, and the other piece is just far too vague to merit a specific ticket.  After five years, probably time to close.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52703",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6001#issuecomment-52704",
