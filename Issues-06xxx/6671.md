...
```json
{
    "body": "<a id='comment:1'></a>Martin: The patch should contain your username so it can be identified as your contribution. Your username should follow the convention:\n\n```\nFull Name <your-email@somewhere.com>\n```\nYou can set your username in your Mercurial configuration file `~/.hgrc`. Furthermore, the patch must have a meaningful commit message. Again, one convention to follow is:\n\n```\ntrac #xxxx: <insert-meaningful-commit-message-here>\n```\nwhere `#xxxx` is the ticket number.",
    "created_at": "2009-08-04T06:18:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62047",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>Martin: The patch should contain your username so it can be identified as your contribution. Your username should follow the convention:
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac-6671-victor_miller.patch](tarball://root/attachments/some-uuid/ticket6671/trac-6671-victor_miller.patch) by @craigcitro created at 2009-08-06 08:26:59",
    "created_at": "2009-08-06T08:26:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62048",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:2'></a>Attachment [trac-6671-victor_miller.patch](tarball://root/attachments/some-uuid/ticket6671/trac-6671-victor_miller.patch) by @craigcitro created at 2009-08-06 08:26:59
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62049",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62051",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62052",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I added the docstrings and modified them, such that there is a reference to the credits for William and Craig. Besides I modified the code slightly, such that it uses the new code in flint.fmpz_poly (same functionality there; This was a patch also provided by me).\n\nPlease, consider this : Due to formating issues, that I don't understand, I had to reformat many doctests for victor_miller_basis(...).\n\nMartin",
    "created_at": "2010-04-05T23:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62053",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:4'></a>I added the docstrings and modified them, such that there is a reference to the credits for William and Craig. Besides I modified the code slightly, such that it uses the new code in flint.fmpz_poly (same functionality there; This was a patch also provided by me).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62054",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62056",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>It's me who has to be sorry; Especially for the Sequence/List thing where I didn't pay attention. If you feel it's better that you correct these mistakes, you can. But orginally I am obligated to do this, so don't hesitate to ask.\n\nMartin",
    "created_at": "2010-04-07T15:43:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62057",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:6'></a>It's me who has to be sorry; Especially for the Sequence/List thing where I didn't pay attention. If you feel it's better that you correct these mistakes, you can. But orginally I am obligated to do this, so don't hesitate to ask.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62058",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62060",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I've just uploaded a patch, to be applied on top of Martin's, which sorts out the things I mentioned in my last post. It also has a one-line bodge fix to get `delta_qexp` to work over finite fields (by calling the polynomial ring constructor with check=True, as in `eisenstein_series_qexp`), which should settle #6020.\n\nMartin: can you take a quick look at the new patch, in particular at the changes I've made in `eisenstein_series_poly` to fix the overflow error when the denominator of the Bernoulli number is big?",
    "created_at": "2010-04-07T19:38:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62061",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:9'></a>I've just uploaded a patch, to be applied on top of Martin's, which sorts out the things I mentioned in my last post. It also has a one-line bodge fix to get `delta_qexp` to work over finite fields (by calling the polynomial ring constructor with check=True, as in `eisenstein_series_qexp`), which should settle #6020.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62062",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I think if we merge Martin's patch and mine, that means the patch at #6020 is superseded. My patch means it will work over finite fields, fixing the original issue at #6020 (although clearly not in the most efficient possible way); and over ZZ, on all the platforms we now care about, Martin's FLINT-based code beats the patch at #6020 which is still using NTL.",
    "created_at": "2010-04-07T20:17:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62064",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:11'></a>I think if we merge Martin's patch and mine, that means the patch at #6020 is superseded. My patch means it will work over finite fields, fixing the original issue at #6020 (although clearly not in the most efficient possible way); and over ZZ, on all the platforms we now care about, Martin's FLINT-based code beats the patch at #6020 which is still using NTL.
...
```json
{
    "body": "Attachment [trac-6671-reviewer-2.patch](tarball://root/attachments/some-uuid/ticket6671/trac-6671-reviewer-2.patch) by mraum created at 2010-04-07 21:32:58\n\nFirst apply trac-6671-3-victor-miller.patch, then this one",
    "created_at": "2010-04-07T21:32:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62065",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

Attachment [trac-6671-reviewer-2.patch](tarball://root/attachments/some-uuid/ticket6671/trac-6671-reviewer-2.patch) by mraum created at 2010-04-07 21:32:58
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62067",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6671#event-15742"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62068",
...
```json
{
    "body": "<a id='comment:13'></a>Merged in 4.4.alpha0:\n\n- trac-6671-3-victor-miller.patch\n- trac-6671-reviewer-2.patch",
    "created_at": "2010-04-15T05:55:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62069",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:13'></a>Merged in 4.4.alpha0:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62070",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62071",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6671#issuecomment-62072",
    "user": "https://github.com/jhpalmieri"
}
```
