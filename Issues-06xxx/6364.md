...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56973",
...
```json
{
    "body": "<a id='comment:2'></a>The patch looks good, but would not apply using the usual system (which could not find the file being patched).\nIf you tell me how to apply it I will do so and test it!",
    "created_at": "2009-06-20T19:30:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56974",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>The patch looks good, but would not apply using the usual system (which could not find the file being patched).
If you tell me how to apply it I will do so and test it!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56975",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I did not know about hg_scripts.  I always used to use hg_sage (though did not realise the significance in the \"sage\" part of that as meaning \"the sage library, i.e. the devel directory\");  more recently I usually use mercurial queues via \"sage -hg\" from the command line.\n\nNow using hg_scripts pops up various editor windows, complaining about unsaved changes.  Same in a completely new clone.  I'll try again tomorrow, but it may be that my failed attempts at this trivial test have messed up my sage build so I might have to rebuild from source.  Meanwhile perhaps someone who knows what they are doing can review the patch!",
    "created_at": "2009-06-20T21:57:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56976",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>I did not know about hg_scripts.  I always used to use hg_sage (though did not realise the significance in the "sage" part of that as meaning "the sage library, i.e. the devel directory");  more recently I usually use mercurial queues via "sage -hg" from the command line.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56977",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_6364.patch](tarball://root/attachments/some-uuid/ticket6364/trac_6364.patch) by @JohnCremona created at 2009-07-11 15:23:29\n\nCraig's patch would not work for me, it failed to apply, perhaps because the script has changed in the interim.\n\nI have added a new patch and hope it can be reviewed before things  change again!",
    "created_at": "2009-07-11T15:23:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56978",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>Attachment [trac_6364.patch](tarball://root/attachments/some-uuid/ticket6364/trac_6364.patch) by @JohnCremona created at 2009-07-11 15:23:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56979",
...
```json
{
    "body": "<a id='comment:6'></a>Works for me -- however, there was a typo in the file (my fault) which prevents the merge script from working at all.  I attached a patch which fixes that typo.",
    "created_at": "2009-07-17T22:10:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56980",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

<a id='comment:6'></a>Works for me -- however, there was a typo in the file (my fault) which prevents the merge script from working at all.  I attached a patch which fixes that typo.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56981",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56982",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56983",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56984",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Merged only `trac_6364.patch`. The typo issue addressed by `scripts_6364_pre.patch` has been fixed by ticket #6511.",
    "created_at": "2009-07-18T18:22:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6364#issuecomment-56985",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:7'></a>Merged only `trac_6364.patch`. The typo issue addressed by `scripts_6364_pre.patch` has been fixed by ticket #6511.
