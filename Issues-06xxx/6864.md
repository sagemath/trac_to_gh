...
archive/attachments_008536.json:
```json
{
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6864#issuecomment-50281",
    "user": "https://github.com/kcrisman"
}
```
...
archive/attachments_008537.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6864#issuecomment-50282",
    "user": "https://github.com/kcrisman"
}
```
...
archive/attachments_008538.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage2.png",
    "asset_url": "tarball://root/attachments/ticket6864/sage2.png",
    "created_at": "2009-09-02T14:19:58Z",
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6864/sage2.png",
    "user": "https://github.com/kcrisman"
}
```
...
archive/attachments_008539.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "0.png",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6864#issuecomment-50283",
    "user": "https://github.com/kcrisman"
}
```
...
archive/attachments_008540.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "zz.png",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6864#issuecomment-50284",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6864#issuecomment-50285",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6864#issuecomment-50286",
...
archive/attachments_008541.json:
```json
{
    "asset_content_type": "application/octet-stream",
