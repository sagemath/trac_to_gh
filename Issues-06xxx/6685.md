...
```json
{
    ...
    "type": "issue",
    "updated_at": "2009-08-30T13:02:04Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73229"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73235"
}
```
...
```json
{
    "body": "Attachment: **[trac_6685-first-draft.patch.gz](https://github.com/sagemath/sage/files/ticket6685/trac_6685-first-draft.patch.gz)**",
...
Attachment: **[trac_6685-first-draft.patch.gz](https://github.com/sagemath/sage/files/ticket6685/trac_6685-first-draft.patch.gz)**
...
```json
{
    "body": "<a id='comment:6'>Comment 6:</a>\nAttachment: **[trac_6685-ref_pictures_no_symlinks_v2.patch.gz](https://github.com/sagemath/sage/files/ticket6685/trac_6685-ref_pictures_no_symlinks_v2.patch.gz)**\n\nDone.  Auto-generating and adding all 2D images under `sage/plot/` seems to be less straightforward.",
...
```json
{
    "body": "Attachment: **[trac_6685-proposal.patch.gz](https://github.com/sagemath/sage/files/ticket6685/trac_6685-proposal.patch.gz)**\n\nLike the \"v2\" patch, but just adds support for including images",
...
Attachment: **[trac_6685-proposal.patch.gz](https://github.com/sagemath/sage/files/ticket6685/trac_6685-proposal.patch.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6685#issuecomment-48425",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6685",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6685#event-73239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6685#issuecomment-48426",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6685#issuecomment-48427",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6685#issuecomment-48428",
    "user": "https://github.com/qed777"
}
```
