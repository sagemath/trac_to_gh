...
archive/attachments_008427.json:
```json
{
...
```json
{
    "body": "**Attachment:** [ecllib.2.patch](https://github.com/sagemath/sage/files/ticket6781/ecllib.2.patch)\n\nPatch to allow library access to ecl",
    "created_at": "2009-08-22T00:04:53Z",
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_comment",
...
**Attachment:** [ecllib.2.patch](https://github.com/sagemath/sage/files/ticket6781/ecllib.2.patch)
...
archive/attachments_008428.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [ecllib.patch](https://github.com/sagemath/sage/files/ticket6781/ecllib.patch)\n\nRebased against 4.3, with str -> bytes changes",
    "created_at": "2010-01-16T09:01:14Z",
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_comment",
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "deps",
    "asset_url": "tarball://root/attachments/ticket6781/deps",
    "created_at": "2010-04-16T02:49:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6781/deps",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket6781/deps)\n\n**Attachment:** [deps.diff](https://github.com/sagemath/sage/files/ticket6781/deps.diff)\n\ndiff for the file \"deps\"",
    "created_at": "2010-04-16T02:49:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_comment",
...
**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket6781/deps)
