...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72298"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72305"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72311"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72312"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72313"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72314"
}
```
...
```json
{
    "body": "<a id='comment:27'>Comment 27:</a>\nAttachment: **[trac_6781-review.patch.gz](https://github.com/sagemath/sage/files/ticket6781/trac_6781-review.patch.gz)**\n\n[attachment: trac_6781-review.patch.gz](https://github.com/sagemath/sage/files/ticket6781/trac_6781-review.patch.gz) contains some minor changes also mentioned in [comment:22](#comment%3A22). I give a positive review to [attachment: ecllib.patch,.gz](https://github.com/sagemath/sage/files/ticket6781/00d3e9e678095f87eaa270c540396e00.gz) if someone can review my changes this will be good to go.\n\nThe patches to be applied are:\n* [attachment: ecllib.patch.gz](https://github.com/sagemath/sage/files/ticket6781/ecllib.patch.gz)\n* [attachment: trac_6781-review.patch.gz](https://github.com/sagemath/sage/files/ticket6781/trac_6781-review.patch.gz)",
    "created_at": "2010-04-02T23:38:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72315"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72316"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72318"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72319"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72322"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6781#issuecomment-49497",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6781#event-72328"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6781#issuecomment-49498",
    "user": "https://github.com/jhpalmieri"
}
```
