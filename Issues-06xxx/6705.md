...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62424",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This has been closed on the ATLAS tracker, but there is still no solution.",
    "created_at": "2009-11-23T00:56:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62425",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>This has been closed on the ATLAS tracker, but there is still no solution.
...
```json
{
    "body": "<a id='comment:4'></a>If I run `./sage -f -m spkg/standard/atlas-*.spkg` on t2, where can I find the tuning parameters under `spkg/build/atlas-*`?  Can we include them in an updated ATLAS package?  I assume this will speed up the build, but please correct me if I'm wrong.",
    "created_at": "2010-09-01T10:22:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62426",
    "user": "https://github.com/qed777"
}
```

<a id='comment:4'></a>If I run `./sage -f -m spkg/standard/atlas-*.spkg` on t2, where can I find the tuning parameters under `spkg/build/atlas-*`?  Can we include them in an updated ATLAS package?  I assume this will speed up the build, but please correct me if I'm wrong.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62427",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62428",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62429",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62430",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62432",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6705#issuecomment-62434",
    "user": "https://github.com/fchapoton"
}
```
