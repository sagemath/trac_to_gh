...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6611#issuecomment-59827",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6611#issuecomment-59828",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6611#issuecomment-59829",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6611#issuecomment-59830",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6611",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6611#event-26730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6611",
    "rename": {
        "from": "[with spkg, needs review] rename networkx-0.99.p1-fake_really-0.36.p0.spkg to networkx-0.36.p0.spkg",
        "to": "rename networkx-0.99.p1-fake_really-0.36.p0.spkg to networkx-0.36.p0.spkg"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6611#event-26731"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6611#event-26732"
}
```
