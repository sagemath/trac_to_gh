...
```json
{
    "body": "<a id='comment:1'></a>This is a dup of #6181.",
...
<a id='comment:1'></a>This is a dup of #6181.
...
```json
{
    "body": "<a id='comment:3'></a>Closing this as wontfix. We have upgraded to R version 2.9.2 in Sage 4.1.2.alpha3. See ticket #6972.",
...
<a id='comment:3'></a>Closing this as wontfix. We have upgraded to R version 2.9.2 in Sage 4.1.2.alpha3. See ticket #6972.
