...
```json
{
    "body": "<a id='comment:5'></a>we have switched to git, this is obsolete",
    "created_at": "2014-03-14T16:44:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6212",
    "type": "issue_comment",
...
<a id='comment:5'></a>we have switched to git, this is obsolete
