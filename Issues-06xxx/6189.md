...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42383",
...
```json
{
    "body": "Attachment [trac_6189-num-approx-integral.patch](https://github.com/sagemath/sage/files/ticket6189/trac_6189-num-approx-integral.patch) by @kcrisman created at 2009-09-29 14:45:50\n\nBased on 4.1.2.alpha2",
    "created_at": "2009-09-29T14:45:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42384",
    "user": "https://github.com/kcrisman"
}
```

Attachment [trac_6189-num-approx-integral.patch](https://github.com/sagemath/sage/files/ticket6189/trac_6189-num-approx-integral.patch) by @kcrisman created at 2009-09-29 14:45:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42385",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42386",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42387",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42388",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6189#issuecomment-42389",
    "user": "https://github.com/mwhansen"
}
```
