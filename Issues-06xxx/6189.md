...
```json
{
    "body": "<a id='comment:1'></a>This is now fixed, presumably in the Maxima upgrade.  Note that the integral in fact computes *without* expand(), and in that case there is no 'experimental error'!  Attached patch verifies this.",
    "created_at": "2009-09-29T14:45:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54896",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>This is now fixed, presumably in the Maxima upgrade.  Note that the integral in fact computes *without* expand(), and in that case there is no 'experimental error'!  Attached patch verifies this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54897",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Despite what it says, actually based on 4.1.2.alpha4.",
    "created_at": "2009-09-29T14:46:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54898",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>Despite what it says, actually based on 4.1.2.alpha4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54899",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54900",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54901",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54902",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54903",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6189#issuecomment-54904",
    "user": "https://github.com/mwhansen"
}
```
