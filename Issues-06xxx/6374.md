...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6374#issuecomment-55916",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6374",
    "rename": {
        "from": "[with patch, needs review] Fix race condition in sage build process",
        "to": "[with patch, positive review] Fix race condition in sage build process"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6374#event-25649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6374#issuecomment-55917",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6374#issuecomment-55918",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6374#issuecomment-55919",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6374#issuecomment-55920",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6374",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6374#event-25650"
}
```
