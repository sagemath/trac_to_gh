...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60178",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60179",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60180",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Bad news: this conflicts quite severely with my patches at #6500. I feel a bit guilty about this, because it was my referee comments on #6183 that pushed you into working on this, so I will handle preparing a rebased version.",
    "created_at": "2009-07-20T08:43:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60181",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:2'></a>Bad news: this conflicts quite severely with my patches at #6500. I feel a bit guilty about this, because it was my referee comments on #6183 that pushed you into working on this, so I will handle preparing a rebased version.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60182",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Here's a patch that applies cleanly on top of the #6500 patches. For what it's worth, the patch looks fine to me, but I'm not an expert on multivariate commutative algebra so probably it'd be better to get someone else to review it.",
    "created_at": "2009-07-20T09:15:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60183",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:3'></a>Here's a patch that applies cleanly on top of the #6500 patches. For what it's worth, the patch looks fine to me, but I'm not an expert on multivariate commutative algebra so probably it'd be better to get someone else to review it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60185",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60186",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60187",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60188",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Yes, the problem was indeed that I was mixing up some stuff with #6183.\n\nI've added a small patch that takes care of this, and all tests (should) now pass.",
    "created_at": "2009-07-21T00:56:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60189",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:7'></a>Yes, the problem was indeed that I was mixing up some stuff with #6183.
...
```json
{
    "body": "<a id='comment:9'></a>After thinking about this some more time: I think the proposed implementation for libSingular polynomials is way too slow. I suggest someone (e.g. me) re-implements the PolyDict printing for those to make it reasonably efficient.",
    "created_at": "2009-08-26T17:16:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60191",
    "user": "https://github.com/malb"
}
```

<a id='comment:9'></a>After thinking about this some more time: I think the proposed implementation for libSingular polynomials is way too slow. I suggest someone (e.g. me) re-implements the PolyDict printing for those to make it reasonably efficient.
...
```json
{
    "body": "<a id='comment:16'></a>This ticket seems invalid. For the first example:\n\n```python\nsage: R.<x,y> = QQ[]\nsage: p = (-6/5)*x^2*y^2 + (-3)*x*y^3 + 6/5*x^2*y + 11/12*x*y^2 + (-18)*y^2 + (-3/4)*y\nsage: p\n-6/5*x^2*y^2 - 3*x*y^3 + 6/5*x^2*y + 11/12*x*y^2 - 18*y^2 - 3/4*y\n```\n\nI cannot make the second example work (and this does not appear in the doctests).",
    "created_at": "2016-04-13T14:28:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60193",
    "user": "https://github.com/bgrenet"
}
```

<a id='comment:16'></a>This ticket seems invalid. For the first example:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60194",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60195",
    "user": "https://github.com/bgrenet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6551#issuecomment-60196",
