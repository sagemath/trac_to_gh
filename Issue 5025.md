# Issue 5025: [with patch, positive review] tinymce: fix creation of text cells to not cause duplicate ids and not be considered compute cells
...
```json
{
    ...
    "title": "[with patch, positive review] tinymce: fix creation of text cells to not cause duplicate ids and not be considered compute cells",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5025",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5025#event-11602"
}
```
