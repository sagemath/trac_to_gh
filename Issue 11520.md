...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11520#issuecomment-129162",
    "user": "iandrus"
}
```
...
```json
{
    "body": "Attachment [trac_11692_import_choice.patch](tarball://root/attachments/some-uuid/ticket11692/trac_11692_import_choice.patch) by iandrus created at 2011-08-16 09:44:29",
    "created_at": "2011-08-16T09:44:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11520#issuecomment-129163",
    "user": "iandrus"
}
```

Attachment [trac_11692_import_choice.patch](tarball://root/attachments/some-uuid/ticket11692/trac_11692_import_choice.patch) by iandrus created at 2011-08-16 09:44:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11520#issuecomment-129164",
    "user": "ncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11520#issuecomment-129165",
    "user": "ncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11520#issuecomment-129166",
    "user": "leif"
}
```
