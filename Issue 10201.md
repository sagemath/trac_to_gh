...
```json
{
    ...
    "title": "Make freetype have ${SAGE_LOCAL} as its prefix in the pkgconfig file",
    "type": "issue",
...
```json
{
    "body": "Oh, may it be the case that `sage-location` is also called (first) **during** the build (through `sage-sage`)?",
    "created_at": "2010-11-02T16:43:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103806",
    "user": "leif"
}
```
...
```json
{
    "body": "I agree that the current solution is suboptimal.  If we can really use environment variables in pkgconfig files, then clearly the best place to fix the pkgconfig files is in the separate spkg-installs for the affected packages.  That would be way less error-prone (for example, libpng knows about the symbolic link, so it knows exactly which file to modify).  In other words, it is the responsibility of the spkg to make the package relocatable.\n\nI think we ought to just post new versions of the right spkgs, and not modify the pkgconfig files in sage-location.",
    "created_at": "2010-11-02T16:44:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103807",
    "user": "jason"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103808",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103809",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103810",
    "user": "leif"
}
```
...
```json
{
    "body": "Cf. http://trac.sagemath.org/sage_trac/ticket/10162#comment:3",
    "created_at": "2010-11-02T16:58:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103811",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103812",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103813",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103815",
    "user": "leif"
}
```
...
```json
{
    "body": "I'm curious where we are on this.  I haven't worked on it at all.  leif, you were going to do something (see your last comment).  I agree that the pkg files should be initialized conditionally.  Did you write a script of some sort to check to see if the files had been already modified?",
    "created_at": "2011-02-10T18:57:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103816",
    "user": "jason"
}
```
...
```json
{
    "body": "One other note.  I'm not sure that the basic idea of having ${SAGE_LOCAL} as a variable inside the .pc files works.  I just changed libpng.pc to not define `${SAGE_ROOT}`, but hopefully just take it out of the environment.  However, when I run pkg-config, it says:\n\n\n```\n$ pkg-config --cflags libpng\nVariable 'SAGE_ROOT' not defined in '/Users/grout/sage/local/lib/pkgconfig/libpng.pc'\n```\n\n\nSo I think the main idea of this ticket is doomed.",
    "created_at": "2011-04-21T15:54:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103818",
    "user": "jason"
}
```
...
```json
{
    "body": "Only one MB.  Comes with glib, which is perhaps half the download?",
    "created_at": "2011-04-21T16:32:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103821",
    "user": "kcrisman"
}
```
...
```json
{
    "body": "Attachment [pkg-config-SAGE_ROOT.patch](tarball://root/attachments/some-uuid/ticket10202/pkg-config-SAGE_ROOT.patch) by jason created at 2011-04-21 16:56:12\n\napply to sage scripts repository",
    "created_at": "2011-04-21T16:56:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103822",
    "user": "jason"
}
```

Attachment [pkg-config-SAGE_ROOT.patch](tarball://root/attachments/some-uuid/ticket10202/pkg-config-SAGE_ROOT.patch) by jason created at 2011-04-21 16:56:12
...
```json
{
    "body": "Actually, that path to pkg-config won't solve our problem, since it involves modifying each of the pkg-config files anyway, and then things depend on the package, etc. So I don't think anymore that it would be better to ship pkg-config.\n\nI changed the description to reflect the patch's new solution.",
    "created_at": "2011-04-21T17:04:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103823",
    "user": "jason"
}
```
...
```json
{
    "body": "I'm going to set this to \"needs review\" as it needs testing on a lot of systems.  My guess is that it needs to be tested by making a new `sage_scripts` spkg and then a system needs to be built fresh with that new spkg.",
    "created_at": "2011-04-21T17:08:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103824",
    "user": "jason"
}
```
...
```json
{
    "body": "So what happens if the computer doesn't have pkg-config?",
    "created_at": "2011-04-21T17:14:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103825",
    "user": "kcrisman"
}
```
...
```json
{
    "body": "Nothing.  Same thing that happens now.",
    "created_at": "2011-04-21T17:16:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103826",
    "user": "jason"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103827",
    "user": "jason"
}
```
...
```json
{
    "body": "P.S.: I currently have no idea where the shell script I wrote is... 8/ (IIRC it consisted of *more* than a single `sed` line, to be more robust and address some corner cases.)",
    "created_at": "2011-08-09T01:34:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103829",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103831",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103832",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "This ticket IMHO needs work anyway (see above), and its title should be changed (or I can open another one with a different approach as pointed out above).",
    "created_at": "2011-08-17T16:05:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103833",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103834",
    "user": "leif"
}
```
...
```json
{
    "body": "The one disadvantage I can see to the PC_TOP_BUILD_DIR solution is that if the user is already using that for some other purpose in their system-installed packages.  Using $${SAGE_ROOT} instead avoids this problem.\n\nAt any rate, I'm glad you're looking into this so carefully!",
    "created_at": "2011-08-17T16:26:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103835",
    "user": "jason"
}
```
...
```json
{
    "body": "It also seems like using PC_TOP_BUILD_DIR in this way goes against its purpose.  That would confuse users, I think.",
    "created_at": "2011-08-17T16:28:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103836",
    "user": "jason"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103837",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103838",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103839",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "created_at": "2020-07-16T01:23:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103840",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103841",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10201#issuecomment-103842",
    "user": "slelievre"
}
```
