# Issue 6493: [with patch, positive review] new scipy-0.7.p2 spkg is broken on 64-bit OS X, due to numpy
...
```json
{
    ...
    "title": "[with patch, positive review] new scipy-0.7.p2 spkg is broken on 64-bit OS X, due to numpy",
    "type": "issue",
