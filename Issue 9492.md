...
```json
{
    "body": "OK, I just wrote some Sage code from scratch that provably computes the swinnerton-dyer polynomials vastly more quickly than Magma or Mathematica.",
...
```json
{
    "body": "FLINT now includes a function that computes the nth Swinnerton-Dyer polynomial. It could be wrapped trivially.",
...
```json
{
    "body": "I have tried to wrap the flint function, but was not able to. Could someone more versed into interfaces do that ?",
