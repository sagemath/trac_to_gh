...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5681#issuecomment-44432",
    "user": "boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5681#issuecomment-44433",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5681#issuecomment-44434",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "See #5720 for a related ticket and a comment about the current state of affairs.",
