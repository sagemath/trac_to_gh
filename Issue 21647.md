# Issue 21647: giacpy_sage doctest failure and new libsingular cf.type == n_unknown ring test
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21647#event-57765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21647",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21647#event-57766"
}
```
