...
- #15696 Implement an_instance for more categories, and extend
  category_sample. This could benefit from #15801.
...
- Finite, Infinite, Associative, Unital, Commutative, Inverse (and
  additive variants), Division, Distributive, ...: #10963
...
- join and meet are misnomers: since we speak of subcategories, then
  ...
  As a first step, #10963 implements the shortcuts & and | for join
  and meet.
...
- Main index page: #7443 TODO: refactor it (maybe as in #16256); in
