...
```json
{
    "body": "Using defaultdict is faster than using rauzy graphs:\n\n\n```\nsage: m = WordMorphism({0:[2,1,0,1,2],1:[1,2,1],2:[0]})\nsage: x = m.periodic_point(0)\nsage: it = x[:6000].bispecial_factors_iterator()\nsage: %time L = [len(next(it)) for _ in range(20)]\nCPU times: user 18.5 s, sys: 288 ms, total: 18.7 s\nWall time: 18.7 s\n```\n\n\nNeeds review.\n----\nNew commits:",
    "created_at": "2016-09-19T15:23:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295358",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295359",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295360",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295361",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295362",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295363",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295364",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295365",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21305#event-20168"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21305#issuecomment-295366",
