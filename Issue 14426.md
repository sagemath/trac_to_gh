...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182149",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "MathJAX is throwing a \"Math Processing Error\" -- I'm not sure whether it's busted or I screwed up but the docs definitely need a review.",
    "created_at": "2013-05-23T00:53:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182150",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Attachment [sage-trac_14630.patch](tarball://root/attachments/some-uuid/ticket14630/sage-trac_14630.patch) by @orlitzky created at 2013-05-24 23:42:10\n\nAdd simplify_real() method to Expression",
    "created_at": "2013-05-24T23:42:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182152",
    "user": "https://github.com/orlitzky"
}
```

Attachment [sage-trac_14630.patch](tarball://root/attachments/some-uuid/ticket14630/sage-trac_14630.patch) by @orlitzky created at 2013-05-24 23:42:10
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182153",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "What about adding a parameter to all the simplify_* functions instead of adding more functions? \nLike \"def simplify(real_domain=False):...\"",
    "created_at": "2013-05-29T13:44:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182154",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182155",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Instead of adding a new function `simplify_real()` or a `domain` parameter to the existing functions, can we use a context manager instead?\n\nExample use would be:\n\n\n```\nsage: t = sqrt(x^2)\nsage: t.simplify()\nsqrt(x^2)\nsage: with maxima_domain(RR):\n....:    u = t.simplify()\n....:\nsage: u\nabs(x)\nsage: t.simplify()\nsqrt(x^2)\n```\n",
    "created_at": "2013-05-30T19:57:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182157",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182159",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182160",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41713"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41714"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41715"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41716"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41717"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41718"
}
```
...
```json
{
    "body": "I think the form/domain-simplify design issue has not been resolved and should be discussed/decided first: the/an author may benefit from presenting a solution to sage-devel, and if the crowd has no opinion then it should be implemented. Thus, I'm setting to needs_info.",
    "created_at": "2014-11-02T09:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182161",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182162",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182163",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Also note this probably conflicts slightly with #11912.",
    "created_at": "2014-11-18T03:38:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182165",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Just making a note to myself here to update all of the \"see also\" references in the other `simplify_*` methods. We should mention `simplify_real()`, `simplify_rectform()`, and any other new similar methods.",
    "created_at": "2014-11-18T16:57:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182166",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182167",
...
```json
{
    "body": "I just force-pushed a branch that's rebased on top of #11912 because of a conflict. That one has a positive review, so I guess when it's merged I could rebase this on top of the develop branch? Not sure what's easiest for the release manager.",
    "created_at": "2014-11-22T15:00:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182168",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182169",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182170",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "And per my note, I've included another left-out function in the `simplify()` \"see also\" list.",
    "created_at": "2014-11-22T15:10:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182171",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "I think it is fine now and certainly should be included, test pass in `expression.pyx`.",
    "created_at": "2014-12-12T16:38:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182172",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182173",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14426#event-41719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14426#issuecomment-182174",
