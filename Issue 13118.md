...
Attachment [mpc-1.0.spkg-gcc-4.7.0-config.log](tarball://root/attachments/some-uuid/ticket13290/mpc-1.0.spkg-gcc-4.7.0-config.log) by leif created at 2012-07-27 15:46:57
...
```json
{
    "body": "Attachment [configure.ac.patch](tarball://root/attachments/some-uuid/ticket13290/configure.ac.patch) by leif created at 2012-07-27 20:25:31\n\n\"Upstream\" patch to `configure.ac` to fix `CC` not being taken from `gmp.h`.",
...
Attachment [configure.ac.patch](tarball://root/attachments/some-uuid/ticket13290/configure.ac.patch) by leif created at 2012-07-27 20:25:31
