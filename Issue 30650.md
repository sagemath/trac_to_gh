# Issue 30650: Add spkg-configure.m4 for 4ti2, remove direct use of SAGE_LOCAL
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30650#event-80628"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30650#event-80629"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30650#event-80630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30650",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30650#event-80631"
}
```
