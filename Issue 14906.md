...
sage: %timeit SetPartition([This is the Trac macro *1,3,37* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1,3,37-macro)).__mul__(SetPartition([This is the Trac macro *13,3,7* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#13,3,7-macro)))                                      
1000 loops, best of 3: 662 us per loop
sage: %timeit SetPartition([This is the Trac macro *1,3,37* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1,3,37-macro)).inf(SetPartition([This is the Trac macro *13,3,7* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#13,3,7-macro)))    
