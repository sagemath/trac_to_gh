...
```json
{
    "body": "Also, we probably ought to reorganize the guide so that it's very, very easy for a person to pick it up and start doing at least small fixes.  Maybe put the short mercurial tutorial in the very front with a small documentation-fixing example or an example of adding a simple function.",
    "created_at": "2008-03-07T17:37:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2422#issuecomment-16354",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2422#issuecomment-16355",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2422#issuecomment-16356",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2422#issuecomment-16357",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2422#issuecomment-16358",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2422#event-2599"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2422#issuecomment-16359",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
