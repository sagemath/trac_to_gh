...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84809"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84810"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84811"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84812"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84813"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84814"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84815"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>seems to work now. Maybe this can be closed as invalid ?",
    "created_at": "2022-09-24T11:24:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637932",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>seems to work now. Maybe this can be closed as invalid ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637933",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>please confirm that this can be closed as invalid",
    "created_at": "2022-09-30T08:18:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637934",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:6'></a>please confirm that this can be closed as invalid
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84816"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637935",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637936",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>the command works for me now with 9.8.beta0",
    "created_at": "2022-09-30T08:24:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637937",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:7'></a>the command works for me now with 9.8.beta0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32051#event-84818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32051#issuecomment-637938",
    "user": "https://github.com/fchapoton"
}
```
