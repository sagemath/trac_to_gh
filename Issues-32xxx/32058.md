...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[d7a9ea8](https://git.sagemath.org/sage.git/commit?id=d7a9ea8781a336a25f1f7458dc21c01db9d8bafb)|`some typing annotation in permutation.py`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[d502d6b](https://git.sagemath.org/sage.git/commit/?id=d502d6b791844dad9e7440c212feb44c11dc3b27)|`minor details in permutation.py`|",
    "created_at": "2021-06-26T16:26:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32058",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[7b0ec52](https://git.sagemath.org/sage.git/commit/?id=7b0ec5295c68a829c1772e7e1c49b8a87792852b)|`do not use soon-deprecated List annotation`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[555c8ca](https://git.sagemath.org/sage.git/commit/?id=555c8ca2171d1c226ecea50a4d511284c723a20a)|`adding one future import that will need to be removed later`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[f0534fe](https://git.sagemath.org/sage.git/commit/?id=f0534fe010382260c100dc1cd684cb1a255a72d3)|`Merge branch 'u/chapoton/32058' in 9.4.b4`|",
    "created_at": "2021-07-02T19:55:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32058",
    "type": "issue_comment",
