...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435556"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435558"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435559"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435560"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32980#issuecomment-535649",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32980#issuecomment-535650",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435561"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32980",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32980#event-435564"
}
```
