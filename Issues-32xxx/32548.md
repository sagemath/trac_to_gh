...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448641"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448642"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32548#issuecomment-525005",
    "user": "https://github.com/MarcusAichmayr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32548#issuecomment-525006",
    "user": "https://github.com/MarcusAichmayr"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32548#issuecomment-525007",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32548#event-448651"
}
```
