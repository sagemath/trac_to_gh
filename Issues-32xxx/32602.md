...
```json
{
    "body": "<a id='comment:1'></a>In the last line, `F0.1` works but already\n\n```\nu(F0.1)\n```\ntriggers a \n\n```\nFatal Python error: _Py_CheckRecursiveCall: Cannot recover from stack overflow.\nPython runtime state: initialized\n```",
    "created_at": "2021-10-01T12:33:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649436",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>In the last line, `F0.1` works but already
...
```json
{
    "body": "<a id='comment:2'></a>For comparison, this works just fine:\n\n```\nsage: Q.<x,y> = PolynomialRing(GF(3), 2)\nsage: u = x^6+x^4+2*x^3+2*x+1\nsage: F0 = magma.FunctionField(GF(3))\nsage: u(F0.1,0)\n$.1^6 + $.1^4 + 2*$.1^3 + 2*$.1 + 1\n```\nso it is possible the underlying issue isn't in the interface at all.",
    "created_at": "2021-10-01T18:25:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649437",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:2'></a>For comparison, this works just fine:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649439",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Well, that explains my feeling of deja vu anyway!",
    "created_at": "2021-10-01T19:44:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649441",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:6'></a>Well, that explains my feeling of deja vu anyway!
...
```json
{
    "body": "Changing branch from \"\" to \"u/kedlaya/magma_interface_throws_segfault\"",
    "created_at": "2021-10-18T01:22:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649442",
    "user": "https://github.com/kedlaya"
}
```

Changing branch from "" to "u/kedlaya/magma_interface_throws_segfault"
...
```json
{
    "body": "<a id='comment:8'></a>Patch to change the `__bool__` method as nbruin suggests, doing the comparison at the level of the Magma string representation. I'm a bit nervous that this is too simple-minded, but it doesn't seem to break any of the doctests.\n\nSpeaking of which, I tweaked a couple of unrelated doctests which were slightly off (possibly dependent on Magma version; I tried this with 2.25-5).",
    "created_at": "2021-10-18T01:25:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649443",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:8'></a>Patch to change the `__bool__` method as nbruin suggests, doing the comparison at the level of the Magma string representation. I'm a bit nervous that this is too simple-minded, but it doesn't seem to break any of the doctests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649444",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649445",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649446",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"c896669b1f2303da42e33bbb50d664bd16c7124c\"",
    "created_at": "2021-10-18T01:25:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649447",
    "user": "https://github.com/kedlaya"
}
```

Changing commit from "" to "c896669b1f2303da42e33bbb50d664bd16c7124c"
...
```json
{
    "body": "<a id='comment:9'></a>It looks like the branch linked presently is just 9.5.beta3. Did you forget to push?",
    "created_at": "2021-10-18T17:44:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649448",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:9'></a>It looks like the branch linked presently is just 9.5.beta3. Did you forget to push?
...
```json
{
    "body": "Changing commit from \"c896669b1f2303da42e33bbb50d664bd16c7124c\" to \"46d7eac7c6b2ca798bcaa958043478c31b18b05a\"",
    "created_at": "2021-10-18T18:08:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649449",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "c896669b1f2303da42e33bbb50d664bd16c7124c" to "46d7eac7c6b2ca798bcaa958043478c31b18b05a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649450",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I had remembered to push but not to commit. :)",
    "created_at": "2021-10-18T18:08:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649451",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:11'></a>I had remembered to push but not to commit. :)
...
```json
{
    "body": "<a id='comment:12'></a>The fix seems reasonable to me. Nils, if you have any further comments, feel free to add them (including reverting the positive review).",
    "created_at": "2021-11-03T08:09:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649452",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:12'></a>The fix seems reasonable to me. Nils, if you have any further comments, feel free to add them (including reverting the positive review).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649453",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649454",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing branch from \"u/kedlaya/magma_interface_throws_segfault\" to \"46d7eac7c6b2ca798bcaa958043478c31b18b05a\"",
    "created_at": "2021-11-12T21:27:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649455",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/kedlaya/magma_interface_throws_segfault" to "46d7eac7c6b2ca798bcaa958043478c31b18b05a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32602#event-86399"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32602#issuecomment-649456",
    "user": "https://github.com/vbraun"
}
```
