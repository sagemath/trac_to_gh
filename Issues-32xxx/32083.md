...
```json
{
    "body": "<a id='comment:1'></a>`foo` is a doctest from `src/sage/rings/polynomial/pbori/pbori.pyx` that I'm going to mark `not tested` in #29979).",
    "created_at": "2021-06-29T08:28:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32083#issuecomment-485885",
    "user": "https://github.com/kliem"
}
```

<a id='comment:1'></a>`foo` is a doctest from `src/sage/rings/polynomial/pbori/pbori.pyx` that I'm going to mark `not tested` in #29979).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32083#issuecomment-485886",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84925"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84926"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84927"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84928"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84929"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84930"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32083#event-84931"
}
```
