...
```json
{
    "body": "<a id='comment:8'></a>\nA while-we-are-at-it, we probably should optimize `def `_copy_for_`parent(self, parent):` as\n\n```\ncpdef `_copy_for_`parent(self, Parent parent):\n```\nOtherwise LGTM.",
...
```json
{
    "body": "<a id='comment:9'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/c8124a9905f9bc2ffa406e4772a45a49e99c89ce\">c8124a9</a></td><td><code>sage.rings.numberfield: Make `_copy_for_`parent methods cpdef</code></td></tr></table>\n",
    "created_at": "2021-09-10T00:24:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32478",
    "type": "issue_comment",
