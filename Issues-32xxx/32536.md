...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32536#issuecomment-463592",
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32536#event-86716"
}
```
...
```json
{
    "body": "Here is an attempt at a partial fix which I think respects the original intent, while preserving the subspace inclusions and dimensions of the filtered vector spaces.\n\nThis fixes the issue in the description, but the test from comment:1 still sometimes fails:\n\n```\nsage -t --long --warn-long 69.2 --random-seed=298280877953805287150486292027026647714 src/sage/schemes/toric/sheaf/klyachko.py\n**********************************************************************\nFile \"src/sage/schemes/toric/sheaf/klyachko.py\", line 29, in sage.schemes.toric.sheaf.klyachko\nFailed example:\n    V.cohomology(dim=True, weight=(0,0,0,0))    # long time\nExpected:\n    (0, 0, 3, 0, 0)\nGot:\n    (0, 0, 5, 0, 0)\n```\n\n---\nNew commits:",
    "created_at": "2022-01-30T13:35:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32536#issuecomment-463594",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32536#issuecomment-463595",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "If the current fix seems acceptable, I would suggest to open a new ticket for the remaining failure. We can mark it as known bug here to make the tests pass again.",
    "created_at": "2022-02-14T21:18:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32536#issuecomment-463596",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "it seems to me that \"random\" here silently   means \"generic\", as well.",
    "created_at": "2022-04-04T11:06:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32536#issuecomment-463599",
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32536#event-86717"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32536#event-86718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32536#issuecomment-463601",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32536#event-86719"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32536#event-86720"
}
```
