...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,23 @@\n+After reinstalling the Python packages using the instructions shown in #32492:\n \n+```\n+$ grep -B2 -r \"Warning.*try.*no-deps\" logs/pkgs\n+logs/pkgs/html5lib-1.0.1.log-pip._internal.exceptions.DistributionNotFound: No matching distribution found for webencodings\n+logs/pkgs/html5lib-1.0.1.log-Removed build tracker: '/private/var/folders/38/wnh4gf1552g_crsjnv2vmmww0000gp/T/pip-req-tracker-tafh_kg_'\n+logs/pkgs/html5lib-1.0.1.log:Warning: installing with \"python3 -m pip install --verbose --no-index --find-links=/Users/mkoeppe/s/sage/sage-rebasing/worktree-rebase/venv-32492/var/lib/sage/wheels --disable-pip-version-check --isolated --no-cache-dir\" failed. Retrying, adding \"--no-deps --ignore-installed\"\n+--\n+logs/pkgs/importlib_resources-5.1.4.log-pip._internal.exceptions.DistributionNotFound: No matching distribution found for zipp>=3.1.0; python_version < \"3.10\"\n+logs/pkgs/importlib_resources-5.1.4.log-Removed build tracker: '/private/var/folders/38/wnh4gf1552g_crsjnv2vmmww0000gp/T/pip-req-tracker-3gqjedfc'\n+logs/pkgs/importlib_resources-5.1.4.log:Warning: installing with \"python3 -m pip install --verbose --no-index --find-links=/Users/mkoeppe/s/sage/sage-rebasing/worktree-rebase/venv-32492/var/lib/sage/wheels --disable-pip-version-check --isolated --no-cache-dir\" failed. Retrying, adding \"--no-deps --ignore-installed\"\n+--\n+logs/pkgs/bleach-3.1.5.log-pip._internal.exceptions.DistributionNotFound: No matching distribution found for packaging\n+logs/pkgs/bleach-3.1.5.log-Removed build tracker: '/private/var/folders/38/wnh4gf1552g_crsjnv2vmmww0000gp/T/pip-req-tracker-v0hoaj95'\n+logs/pkgs/bleach-3.1.5.log:Warning: installing with \"python3 -m pip install --verbose --no-index --find-links=/Users/mkoeppe/s/sage/sage-rebasing/worktree-rebase/venv-32492/var/lib/sage/wheels --disable-pip-version-check --isolated --no-cache-dir\" failed. Retrying, adding \"--no-deps --ignore-installed\"\n+--\n+logs/pkgs/sagenb_export-3.3.log-pip._internal.exceptions.DistributionNotFound: No matching distribution found for notebook\n+logs/pkgs/sagenb_export-3.3.log-Removed build tracker: '/private/var/folders/38/wnh4gf1552g_crsjnv2vmmww0000gp/T/pip-req-tracker-gz3vbd0n'\n+logs/pkgs/sagenb_export-3.3.log:Warning: installing with \"python3 -m pip install --verbose --no-index --find-links=/Users/mkoeppe/s/sage/sage-rebasing/worktree-rebase/venv-32492/var/lib/sage/wheels --disable-pip-version-check --isolated --no-cache-dir\" failed. Retrying, adding \"--no-deps --ignore-installed\"\n+```\n \n Dependencies: #32492, #31280\n \n``````\n",
    "created_at": "2021-09-09T01:56:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647407",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647408",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647409",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mkoeppe/add_missing_dependencies_for_python_packages_revealed_by__32492\"",
    "created_at": "2021-09-09T02:50:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647410",
    "user": "https://github.com/mkoeppe"
}
```

Changing branch from "" to "u/mkoeppe/add_missing_dependencies_for_python_packages_revealed_by__32492"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647411",
...
```json
{
    "body": "Changing commit from \"\" to \"0fc01d3c3ad024ab98c2968a5609cfe46c5e543a\"",
    "created_at": "2021-09-09T03:10:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647412",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "0fc01d3c3ad024ab98c2968a5609cfe46c5e543a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647413",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647414",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Tested now with #32492 using `make -j50`.",
    "created_at": "2021-09-09T03:22:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647415",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>Tested now with #32492 using `make -j50`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647416",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing commit from \"0fc01d3c3ad024ab98c2968a5609cfe46c5e543a\" to \"8a314c2043dcea51d05b904b77dbb72e1549cf6c\"",
    "created_at": "2021-09-09T04:47:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647417",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0fc01d3c3ad024ab98c2968a5609cfe46c5e543a" to "8a314c2043dcea51d05b904b77dbb72e1549cf6c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647418",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647420",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Same issue, fixed by this ticket. Needs review",
    "created_at": "2021-09-14T04:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647422",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:12'></a>Same issue, fixed by this ticket. Needs review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647423",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647424",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647425",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647426",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647427",
...
```json
{
    "body": "Changing branch from \"u/mkoeppe/add_missing_dependencies_for_python_packages_revealed_by__32492\" to \"8a314c2043dcea51d05b904b77dbb72e1549cf6c\"",
    "created_at": "2021-09-19T09:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32493#issuecomment-647428",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/mkoeppe/add_missing_dependencies_for_python_packages_revealed_by__32492" to "8a314c2043dcea51d05b904b77dbb72e1549cf6c"
