...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645990",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"6b8e9017a9721d254d45499e1d57a7275d65c73b\"",
    "created_at": "2021-09-20T23:02:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645991",
    "user": "https://github.com/tornaria"
}
```

Changing commit from "" to "6b8e9017a9721d254d45499e1d57a7275d65c73b"
...
```json
{
    "body": "Changing branch from \"\" to \"public/32425\"",
    "created_at": "2021-09-20T23:02:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645992",
    "user": "https://github.com/tornaria"
}
```

Changing branch from "" to "public/32425"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645993",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>If system-wide `pari-seadata` is not installed, by system-wide `pari` is used, Sage has no way to install its `pari_seadata` spkg.\n\nThat's why we check for `pari-seadata`, not for its smaller brother.\n\nThus, this patch will break an optional package for no good reason.",
    "created_at": "2021-09-21T08:08:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645994",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:5'></a>If system-wide `pari-seadata` is not installed, by system-wide `pari` is used, Sage has no way to install its `pari_seadata` spkg.
...
```json
{
    "body": "<a id='comment:7'></a>I sent a feature request upstream but it hasn't shown up on the bug tracker yet.\n\nEdit: https://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=2316",
    "created_at": "2021-09-21T12:44:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645996",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:7'></a>I sent a feature request upstream but it hasn't shown up on the bug tracker yet.
...
```json
{
    "body": "<a id='comment:8'></a>I think we are on our own with the datadir. So long as the data packages cannot be installed independently, they don't really make sense as optional SPKGs, and our \"pari\" package is really \"pari with all of the additional data.\" They must all be installed the same way, either as system packages, or as SPKGs.\n\nGiven that, I think it makes the most sense to keep requiring the full seadata package, just to keep the (already complicated) mess as simple as possible. But I don't feel strongly about it.",
    "created_at": "2021-09-21T22:00:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32425#issuecomment-645997",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:8'></a>I think we are on our own with the datadir. So long as the data packages cannot be installed independently, they don't really make sense as optional SPKGs, and our "pari" package is really "pari with all of the additional data." They must all be installed the same way, either as system packages, or as SPKGs.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32425#event-86021"
}
```
