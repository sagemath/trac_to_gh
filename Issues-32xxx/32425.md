...
```json
{
    "body": "I sent a feature request upstream but it hasn't shown up on the bug tracker yet.\n\nEdit: https://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=2316",
