...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435405"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435407"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32967#issuecomment-535479",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435409"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32967",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32967#issuecomment-535480",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435411"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32967",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32967#event-435413"
}
```
