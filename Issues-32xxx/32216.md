...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444439"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444443"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519146",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519147",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519148",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519149",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519150",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519152",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">comment:8</div>\n\nThank you. I didn't read [comment:2](#comment:2) until later, when I was only on the smartphone and couldn't do anything about it anymore.",
    "created_at": "2021-07-19T20:43:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519153",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519154",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444446"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32216#event-444447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32216#issuecomment-519155",
