...
```json
{
    "body": "<a id='comment:22'></a>\nTry this\n\n---\nNew commits:\n|                                                                                                                                          |                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[5ce41d9](https://git.sagemath.org/sage.git/commit?id=5ce41d90c51a4cbfaf0cbb80a030ed4f4e27e585)|`build/bin/sage-build-env [conda]: Use SETUPTOOLS_USE_DISTUTILS=stdlib`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nNew commits:\n|                                                                                                                                          |                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[e15d3c3](https://git.sagemath.org/sage.git/commit?id=e15d3c3a1dd075212773618a91af5b7870b43783)|`remove pari_jupyter conda.txt because it is not compatible with pari=2.13`|\n|[1ea51b6](https://git.sagemath.org/sage.git/commit?id=1ea51b65f661b60b27d6666aa1b4a8957f62892d)|`make sure pari>=2.13 is used with conda`|\n|[a2da866](https://git.sagemath.org/sage.git/commit?id=a2da866d26d0c80302b91a9e6bb8c453dde95741)|`set SUITESPARSE_INC_DIR to SAGE_LOCAL/include if we are using system suitesparse`|\n|[27ced51](https://git.sagemath.org/sage.git/commit?id=27ced511c773bacd2f3c5256f29c4ce658f39c4b)|`Fix lib dirs for cvxopts`|\n|[3592860](https://git.sagemath.org/sage.git/commit?id=35928608621161d9c4709474792d2a7dcaf2b6d4)|`Ask for pthread version of pari`|",
    "created_at": "2021-07-09T20:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32087",
    "type": "issue_comment",
