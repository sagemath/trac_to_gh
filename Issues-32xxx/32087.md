...
archive/attachments_022257.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "conda-list.txt",
    "asset_url": "tarball://root/attachments/ticket32087/conda-list.txt",
    "created_at": "2021-06-29T21:30:55Z",
    "issue": "https://github.com/sagemath/sage/issues/32087",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket32087/conda-list.txt",
    "user": "https://github.com/videlec"
}
```
...
archive/attachments_022258.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022259.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022260.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022261.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022262.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022263.json:
```json
{
    "asset_content_type": "application/octet-stream",
