...
<a id='comment:4'></a>One trivial little change:
...
<a id='comment:8'></a>Replying to [tscrim](#comment%3A4):
...
```json
{
    "body": "<a id='comment:9'></a>Thanks. Sounds good. Green bot => positive review.",
...
<a id='comment:9'></a>Thanks. Sounds good. Green bot => positive review.
