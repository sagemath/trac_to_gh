...
```json
{
    "body": "<a id='comment:1'></a>Attachment [bug Derivative of the symbolic sum of function of two variables.ipynb](tarball://root/attachments/some-uuid/ticket32161/bug Derivative of the symbolic sum of function of two variables.ipynb) by @daju1 created at 2021-07-21 15:16:19",
    "created_at": "2021-07-21T15:16:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640147",
    "user": "https://github.com/daju1"
}
```

<a id='comment:1'></a>Attachment [bug Derivative of the symbolic sum of function of two variables.ipynb](tarball://root/attachments/some-uuid/ticket32161/bug Derivative of the symbolic sum of function of two variables.ipynb) by @daju1 created at 2021-07-21 15:16:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640148",
    "user": "https://github.com/daju1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640152",
    "user": "https://github.com/daju1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640153",
    "user": "https://github.com/daju1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640154",
    "user": "https://github.com/daju1"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Please see my commit which fixes the issue\n\n---\nNew commits:",
    "created_at": "2021-07-26T04:04:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640155",
    "user": "https://github.com/daju1"
}
```

<a id='comment:6'></a>Please see my commit which fixes the issue
...
```json
{
    "body": "<a id='comment:8'></a>What does your code presently do with `sum(f(x,b),x,a,b).diff(b)`? It should probably check that the differentiation variable is independent from the bounds as well and perhaps throw an error if it's not.\n\nI'm also not so sure that 0 is the best answer if a derivative with respect to the summation variable is requested. Sure, it's not a free variable, so an external reference to it can be interpreted as a \"different\" variable, but it' more likely a typo.",
    "created_at": "2021-07-26T16:03:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640156",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:8'></a>What does your code presently do with `sum(f(x,b),x,a,b).diff(b)`? It should probably check that the differentiation variable is independent from the bounds as well and perhaps throw an error if it's not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640159",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640160",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640161",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640162",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640163",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640164",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640165",
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85162"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I think we should also be a bit careful if one of the summation limits is `oo`.\n\n```\nsage: n,x = var('n,x')\nsage: F = function('F')(x)\nsage: sum(F(x=x), x, 1, oo)\nsum(F(x), x, 1, +Infinity)\nsage: sum(x^(n*x), x, 1, oo)\nsum(x^(n*x), x, 1, +Infinity)\n```\nLimits may not commute. While I think such a useful case for this is unlikely, we might want to be a little more on the cautious side here.",
    "created_at": "2021-08-23T00:21:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640166",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:16'></a>I think we should also be a bit careful if one of the summation limits is `oo`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640167",
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85163"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85164"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85165"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85166"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32161#issuecomment-640170",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85167"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32161#event-85168"
}
```
