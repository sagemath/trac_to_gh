...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524142",
    "user": "https://github.com/Vectornaut"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524144",
    "user": "https://github.com/Vectornaut"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524145",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524146",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524147",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524148",
    "user": "https://github.com/Vectornaut"
}
```
...
```json
{
    "body": "Attachment [hyperbolic_geodesic_PD.sage](https://github.com/sagemath/sage/files/ticket32362/hyperbolic_geodesic_PD.sage) by @Vectornaut created at 2021-08-20 04:56:02\n\nFinding ideal endpoints of geodesics on the Poincar\u00e9 disk: method explanation",
    "created_at": "2021-08-20T04:56:02Z",
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524149",
    "user": "https://github.com/Vectornaut"
}
```

Attachment [hyperbolic_geodesic_PD.sage](https://github.com/sagemath/sage/files/ticket32362/hyperbolic_geodesic_PD.sage) by @Vectornaut created at 2021-08-20 04:56:02
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [drawing-geodesics.pdf](https://github.com/sagemath/sage/files/ticket32362/drawing-geodesics.pdf) by @Vectornaut created at 2021-08-20 04:59:34\n\nI just attached an example implementation. I've done some basic tests, but no systematic challenges or comparison with the current implementation (via the upper half-plane).",
    "created_at": "2021-08-20T04:59:34Z",
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524150",
    "user": "https://github.com/Vectornaut"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32362#issuecomment-524151",
