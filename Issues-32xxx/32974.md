...
```json
{
    "body": "<a id='comment:5'></a>Do you have references/literature?",
    "created_at": "2021-12-04T19:49:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32974#issuecomment-498616",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:5'></a>Do you have references/literature?
...
```json
{
    "body": "<a id='comment:6'></a>Looks to me that natural bundles are already the most canonical things you can have over manifolds. Is it true that any non-natural bundle does not contain useful (geometric) information?\n\nIf that is the case, natural bundles are perhaps *the* thing we actually need. Unfortunately, I don't know enough to form an opinion here.",
    "created_at": "2021-12-04T19:57:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32974#issuecomment-498617",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:6'></a>Looks to me that natural bundles are already the most canonical things you can have over manifolds. Is it true that any non-natural bundle does not contain useful (geometric) information?
...
```json
{
    "body": "<a id='comment:8'></a>Fascinating! Thank you for the explanation and references.\n\nReplying to [comment:7 gh-tobiasdiez]:\n> That probably depends on your definition of \"geometric information\".\n\n\nWell, I'd consider spin bundles already quite geometric. So I assume the answer is \"no\".",
    "created_at": "2021-12-04T23:17:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32974#issuecomment-498619",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:8'></a>Fascinating! Thank you for the explanation and references.
...
```json
{
    "body": "<a id='comment:9'></a>More feedback is strongly appreciated before I continue working on this. Thanks!",
    "created_at": "2021-12-28T17:56:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32974#issuecomment-498620",
    "user": "https://github.com/tobiasdiez"
}
```

<a id='comment:9'></a>More feedback is strongly appreciated before I continue working on this. Thanks!
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32974#event-87120"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32974#event-87121"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32974#event-87122"
}
```
