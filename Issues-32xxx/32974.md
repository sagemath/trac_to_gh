...
```json
{
    "body": "Do you have references/literature?",
...
```json
{
    "body": "Looks to me that natural bundles are already the most canonical things you can have over manifolds. Is it true that any non-natural bundle does not contain useful (geometric) information?\n\nIf that is the case, natural bundles are perhaps *the* thing we actually need. Unfortunately, I don't know enough to form an opinion here.",
...
```json
{
    "body": "More feedback is strongly appreciated before I continue working on this. Thanks!",
