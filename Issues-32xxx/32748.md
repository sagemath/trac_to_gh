...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[271f765](https://git.sagemath.org/sage.git/commit?id=271f765fc84fb1e61182d4bd0afbacd66a2d0084)|`trac #32748: better handling of networkx graphs in (di)graph constructor`|",
    "created_at": "2021-10-23T17:01:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32748",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[0146309](https://git.sagemath.org/sage.git/commit/?id=01463095386995d8bbe2c487b19f67a4b70d535d)|`trac #32748: remove extra spaces`|",
