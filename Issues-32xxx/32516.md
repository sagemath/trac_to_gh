...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394772"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32516#issuecomment-527332",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394775"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32516#issuecomment-527333",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32516#issuecomment-527334",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32516",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32516#event-394778"
}
```
