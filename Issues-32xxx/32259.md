...
```json
{
    "body": "<a id='comment:1'></a>This ticket along with #32255 and #32256 point out some errors and inconsistencies with `solve` that seem related, so it might be advantageous to deal with these issues all at once.",
    "created_at": "2021-07-21T15:32:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32259#issuecomment-456838",
    "user": "https://github.com/saliola"
}
```

<a id='comment:1'></a>This ticket along with #32255 and #32256 point out some errors and inconsistencies with `solve` that seem related, so it might be advantageous to deal with these issues all at once.
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85476"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85477"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85478"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85479"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85480"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85481"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32259#event-85482"
}
```
