...
```json
{
    "body": "<a id='comment:1'></a>Thanks for pointing this out!",
    "created_at": "2021-09-05T17:47:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32476",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32476#issuecomment-459843",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:1'></a>Thanks for pointing this out!
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32476#event-86144"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32476#event-86145"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32476#event-86146"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32476#event-86147"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32476#event-86148"
}
```
