...
```json
{
    "body": "<a id='comment:6'></a>\nI think I'll eventually add a small configure script to set up all the versions right.\nIf only there was a way to put tarballs up on [GitHub](../wikis/GitHub) and creating [GitHub](../wikis/GitHub) releases from\nthe command line.",
...
```json
{
    "body": "<a id='comment:11'></a>\nReplying to [dimpase](#comment%3A6):\n> I think I'll eventually add a small configure script to set up all the versions right.\n> If only there was a way to put tarballs up on [GitHub](../wikis/GitHub) and creating [GitHub](../wikis/GitHub) releases from\n> the command line.\n\nHave you looked into rever? I use it to create tarballs for autoconfiscated packages, release them on [GitHub](../wikis/GitHub) and on PyPI. See, e.g., https://github.com/flatsurf/flatsurf/blob/master/rever.xsh.",
