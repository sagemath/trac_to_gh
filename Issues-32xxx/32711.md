...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket32711/gap_package.patch",
...
```json
{
    "body": "Add -l option to gap_cmd.",
    "created_at": "2021-10-18T17:30:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32711#issuecomment-532105",
    "user": "https://github.com/culler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32711#issuecomment-532106",
    "user": "https://github.com/culler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32711#issuecomment-532107",
    "user": "https://github.com/culler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32711#issuecomment-532108",
    "user": "https://github.com/culler"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32711#event-298405"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32711#event-298406"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32711#event-298407"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32711#event-298408"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32711#event-298409"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32711#event-298410"
}
```
