...
archive/attachments_022297.json:
```json
{
...
```json
{
    "body": "**Attachment:** [gap_package.patch](https://github.com/sagemath/sage/files/ticket32711/gap_package.patch)\n\nAdd -l option to gap_cmd.",
    "created_at": "2021-10-18T17:30:10Z",
    "issue": "https://github.com/sagemath/sage/issues/32711",
    "type": "issue_comment",
...
**Attachment:** [gap_package.patch](https://github.com/sagemath/sage/files/ticket32711/gap_package.patch)
