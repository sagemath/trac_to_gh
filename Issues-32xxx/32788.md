...
```json
{
    "body": "<a id='comment:7'></a>\npycodestyle probably only looks at py files\n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[db41390](https://git.sagemath.org/sage.git/commit?id=db4139091e9c524779271c45aa8450892107fc3e)|`fix most E722 (first pass)`|",
    "created_at": "2021-10-28T19:13:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[cffd35e](https://git.sagemath.org/sage.git/commit/?id=cffd35e12c9fd4ef535654947ee167d3f9dfe55a)|`no except: in most pyx files`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------|\n|[279b592](https://git.sagemath.org/sage.git/commit/?id=279b5927981a98f698b7fc7a90ac842b0b3a7721)|`fix typo`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------|\n|[eb4ae95](https://git.sagemath.org/sage.git/commit/?id=eb4ae950f6caa27cef7b1d04c5b0473d36139ae3)|`add import`|",
    "created_at": "2021-10-28T19:48:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nI added 2 commits dealing with `giac.pyx` to your branch. The first commit only fixes bad indentation that made my editor crazy, the second one fixes most `try/except` statements (most of them seem just useless).\n\nThe last two remaining cases are related with some `pari_lock` and need to be explored.\n\n---\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[bcdb620](https://git.sagemath.org/sage.git/commit?id=bcdb6201a705715c7b995270064b1d734b9ef81c)|`#32788 : fix intentations for libs/giac/giac.pyx`|\n|[da3e437](https://git.sagemath.org/sage.git/commit?id=da3e43762af6b5d0b40547d382cbbac3375988fc)|`#32788 : remove useless try/except statements in src/sage/libs/giac/giac.pyx`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nSur ta branche, j'ai ajout\u00e9 un commit pour corriger les doctests.\n\n---\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[e98b6e3](https://git.sagemath.org/sage.git/commit?id=e98b6e3b84ade9fe9e2a59106bd854a9cd1c08bf)|`Merge branch 'u/tmonteil/32788' in 9.5.beta5`|\n|[be872c1](https://git.sagemath.org/sage.git/commit?id=be872c16d193602a548c98b1b18deb24dc2e0d37)|`some fixes in giac, schemes, geometry`|",
    "created_at": "2021-10-29T11:44:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nI hope that makes any sense:\n\n- Cleaned up the syntax.\n- `pari_unlock` shouldn't haven been called like that, because we are in `sig_on ... sig_off` and one should not call python functions in that case: https://cysignals.readthedocs.io/en/latest/interrupt.html.\n- `_wrap_gen(result)` doesn't belong in the `try ... except` block, because it has its own error handling (and if it was to raise an error, we would slip into the except block calling `sig_off` again.\n- Use `finally` to call `sig_off` before exit.\n- Apparently `giac` raises `RuntimeError` in case something goes wrong. So I used that.\n \n---\nNew commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[fadbade](https://git.sagemath.org/sage.git/commit?id=fadbadef8a30968f7fb50ab43c84eed48e630085)|`Merge branch 'u/tmonteil/32788' of git://trac.sagemath.org/sage into u/gh-kliem/32788`|\n|[66ec40e](https://git.sagemath.org/sage.git/commit?id=66ec40edd4ac85ab46852a7d79b9f1ea68b4e17f)|`codestyle`|\n|[35cab30](https://git.sagemath.org/sage.git/commit?id=35cab30d9976d9d58d45e3f648747a8ddeb25fd9)|`Merge branch 'u/chapoton/32788' of git://trac.sagemath.org/sage into u/gh-kliem/32788`|\n|[0113b72](https://git.sagemath.org/sage.git/commit?id=0113b72725babbf822e7be0831c8281db4253a57)|`code style again`|\n|[6c08ce1](https://git.sagemath.org/sage.git/commit?id=6c08ce185d4a44e89cf8d2804f0be658a8e95dee)|`remove blank except in GIAC call`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[04a1f01](https://git.sagemath.org/sage.git/commit/?id=04a1f01de963dbc6a7c8f67bcbcfadbf1cd9a9c7)|`fix distinction between two calls`|\n|[9905930](https://git.sagemath.org/sage.git/commit/?id=9905930022910ded1dbd483896a4a171968eded1)|`remove code duplication`|",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[a903f72](https://git.sagemath.org/sage.git/commit/?id=a903f72bbcaaf6430947e51dc413caa3ed9fea62)|`#32788 : ensure bare except: statements will not reappear`|",
    "created_at": "2021-10-30T12:25:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:47'></a>\nI have made a branch with only a minimal change to polymake file. And squashed all the commits into one single commit. \n\n---\nNew commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[1afd3a3](https://git.sagemath.org/sage.git/commit?id=1afd3a3cd62b550844d2fcd6a5412f0ef5b987c2)|`fix all E722 and activate the check`|",
    "created_at": "2021-11-14T09:37:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[de356d6](https://git.sagemath.org/sage.git/commit/?id=de356d6ad561427653969c5b1fd147af7eeb7ccc)|`forgotten one`|",
    "created_at": "2021-11-14T16:15:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:52'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[2ec7374](https://git.sagemath.org/sage.git/commit/?id=2ec7374092ee2b537ff9b0657451c03786cdfa2d)|`add one tag in polymake interface`|",
...
```json
{
    "body": "<a id='comment:57'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[ec236ec](https://git.sagemath.org/sage.git/commit/?id=ec236ec43466e74d29670afb25ce2612bd3e9bb0)|`comment before`|",
...
```json
{
    "body": "<a id='comment:62'></a>\nI cherry-picked the relevant commits and merged with `9.5.beta6` so that `git diff trac/u/chapoton/except_fix_branch trac/u/tmonteil/except_fix_branch` leads to:\n\n\n```diff\n--- a/src/sage/interfaces/polymake.py\n+++ b/src/sage/interfaces/polymake.py\n@@ -364,7 +364,7 @@ class PolymakeAbstract(ExtraTabCompletion, Interface):\n             try:\n                 x = RDF(x)\n                 return '{}'.format(x)\n-            except Exception:\n+            except (TypeError, ValueError):\n                 pass\n \n             raise NotImplementedError\n```\n\nI am not sure if i have to revert that change.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[be872c1](https://git.sagemath.org/sage.git/commit?id=be872c16d193602a548c98b1b18deb24dc2e0d37)|`some fixes in giac, schemes, geometry`|\n|[35cab30](https://git.sagemath.org/sage.git/commit?id=35cab30d9976d9d58d45e3f648747a8ddeb25fd9)|`Merge branch 'u/chapoton/32788' of git://trac.sagemath.org/sage into u/gh-kliem/32788`|\n|[0113b72](https://git.sagemath.org/sage.git/commit?id=0113b72725babbf822e7be0831c8281db4253a57)|`code style again`|\n|[6c08ce1](https://git.sagemath.org/sage.git/commit?id=6c08ce185d4a44e89cf8d2804f0be658a8e95dee)|`remove blank except in GIAC call`|\n|[04a1f01](https://git.sagemath.org/sage.git/commit?id=04a1f01de963dbc6a7c8f67bcbcfadbf1cd9a9c7)|`fix distinction between two calls`|\n|[9905930](https://git.sagemath.org/sage.git/commit?id=9905930022910ded1dbd483896a4a171968eded1)|`remove code duplication`|\n|[d3df701](https://git.sagemath.org/sage.git/commit?id=d3df701affc8d1b24775fca5d1ae9bb8d9135e1a)|`#32788 : ensure bare except: statements will not reappear`|\n|[e92b905](https://git.sagemath.org/sage.git/commit?id=e92b905a359977dce92a0b8118d26fd41877ac48)|`mark polymake_expect import as optional`|\n|[f463e49](https://git.sagemath.org/sage.git/commit?id=f463e49b287475f9751e16d8d241fc030b606953)|`comment before`|\n|[9522357](https://git.sagemath.org/sage.git/commit?id=9522357774ad8fb36eb7c997997b5c30f7af3ea5)|`Merge branch 'develop.9.5.beta6' into HEAD`|",
    "created_at": "2021-11-29T19:10:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:65'></a>\nrebased on 9.5.rc1\n\n---\nNew commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[58865ce](https://git.sagemath.org/sage.git/commit?id=58865ceee554f2cf263bc541fd003ba40b72b274)|`various lgtm-suggested details`|\n|[db57c4f](https://git.sagemath.org/sage.git/commit?id=db57c4f7b5be2590a8cfa1e4878b4b88525f6aaa)|`Merge branch 'u/tmonteil/except_fix_branch' in 9.5.rc1`|",
    "created_at": "2022-01-14T19:37:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:66'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[de4faf6](https://git.sagemath.org/sage.git/commit/?id=de4faf6146521e81991677edb6743449343d8f96)|`Merge branch 'u/tmonteil/except_fix_branch' in 9.5.rc1`|",
    "created_at": "2022-01-14T19:48:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32788",
    "type": "issue_comment",
