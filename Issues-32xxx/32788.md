...
```json
{
    "body": "<div id=\"comment:31\" align=\"right\">comment:31</div>\n\nI added E722 to `src/tox.ini` so that the second part of the ticked get fixed too (using tox as @fchapoton suggested). Regarding [comment 7](#comment:7), will the `pyx` be tested as well ? Otherwise, how to deal with them ?",
