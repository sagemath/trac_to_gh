...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[e0e1a62](https://git.sagemath.org/sage.git/commit/?id=e0e1a62dfbe70d692bb78cf80fece8dd5ea1e18d)|`Revert \"make is_prime() work for integral rationals\"`|\n|[42795ff](https://git.sagemath.org/sage.git/commit/?id=42795ff9f23efdf4ded68e2074e00caaba0c3d0b)|`restrict the global is_prime() function to integers`|",
