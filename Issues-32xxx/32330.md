...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413462"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413463"
}
```
...
```json
{
    "body": "Changed keywords from **** to **Rank-metric, Channel**",
    "created_at": "2021-08-03T16:21:24Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/32330",
    "type": "issue_comment",
...
Changed keywords from **** to **Rank-metric, Channel**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413466"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413467"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32330#issuecomment-523917",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32330",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32330#issuecomment-523918",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413472"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413474"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413475"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32330#event-413476"
}
```
