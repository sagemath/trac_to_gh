...
```json
{
    "body": "<a id='comment:1'></a>(https://trac.sagemath.org/ticket/31280#comment:46):\nIf we are lucky, this is just https://github.com/pexpect/ptyprocess/commit/f673a54f1fef9c390bc1a683cbcdfa8128385bd0",
    "created_at": "2021-07-18T02:51:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32147",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32147#issuecomment-639884",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>(https://trac.sagemath.org/ticket/31280#comment:46):
If we are lucky, this is just https://github.com/pexpect/ptyprocess/commit/f673a54f1fef9c390bc1a683cbcdfa8128385bd0
...
```json
{
    "body": "<a id='comment:2'></a>Just catching `PtyProcessError` in addition to `ExceptionPexpect` on our side does not seem to fix the problem.",
    "created_at": "2021-07-18T04:52:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32147",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32147#issuecomment-639885",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>Just catching `PtyProcessError` in addition to `ExceptionPexpect` on our side does not seem to fix the problem.
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85121"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85122"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85123"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Just to mention that I've been using system `ptyprocess-0.7.0` (via #29665) for a few weeks without any issue.\n\nWhat's the exact issue? I haven't seen any report of what goes wrong on macos when using an updated ptyprocess.",
    "created_at": "2022-01-19T17:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32147",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32147#issuecomment-639886",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:6'></a>Just to mention that I've been using system `ptyprocess-0.7.0` (via #29665) for a few weeks without any issue.
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [ptyprocess-failures.txt](tarball://root/attachments/some-uuid/ticket32147/ptyprocess-failures.txt) by @mkoeppe created at 2022-03-05 01:55:27",
    "created_at": "2022-03-05T01:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32147",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32147#issuecomment-639888",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:8'></a>Attachment [ptyprocess-failures.txt](tarball://root/attachments/some-uuid/ticket32147/ptyprocess-failures.txt) by @mkoeppe created at 2022-03-05 01:55:27
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85124"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85125"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85126"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32147#event-85127"
}
```
