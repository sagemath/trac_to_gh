...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[dfa6725](https://git.sagemath.org/sage.git/commit?id=dfa672544bb71b34c8e719028764a74167179324)|`configure.ac, m4/: Eliminate use of variable SAGE_SPKG_INST`|",
    "created_at": "2021-11-23T06:41:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32918",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|\n|[493f855](https://git.sagemath.org/sage.git/commit/?id=493f855f4f00e6d516b7d988290c59a81b5abb6f)|`m4/sage_spkg_collect.m4: Check installation record in SAGE_VENV for packages installed there`|\n|[ba42f8c](https://git.sagemath.org/sage.git/commit/?id=ba42f8c02df2a59d675da46edd532f11164d21aa)|`m4/sage_spkg_collect.m4: No multiple installation record check for script packages`|\n|[9eca9ae](https://git.sagemath.org/sage.git/commit/?id=9eca9ae7dd39cf5a104a5005dfe406ac958f842d)|`m4/sage_spkg_collect.m4: Move if_installed logic earlier`|",
