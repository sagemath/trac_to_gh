...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414726"
}
```
...
archive/issue_events_414727.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2021-08-27T10:41:23Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414727"
}
```
...
archive/issue_events_414728.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2021-08-27T10:41:23Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414728"
}
```
...
archive/issue_events_414729.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2021-08-27T10:41:23Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414730"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32428#event-414734"
}
```
