...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[fe510ef](https://git.sagemath.org/sage.git/commit/?id=fe510ef42ceb7f9c25c838d8bb952019a246ac5a)|`build/pkgs/sage_{conf,setup}/install-requires: Use ~= 9.7.b3`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[b5fedff](https://git.sagemath.org/sage.git/commit/?id=b5fedffa3d46f099109a75368f2a18151c31980a)|`build/pkgs/giac/spkg-configure.m4: Pop what was pushed`|",
