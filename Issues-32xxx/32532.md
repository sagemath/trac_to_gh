...
```json
{
    "body": "<a id='comment:9'></a>\nstill needs adding some Fortran to CI for the minimal macOS configuration.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|\n|[48cdeb4](https://git.sagemath.org/sage.git/commit?id=48cdeb484462aad084a3dec5bc54a0afc6caadfe)|`configure.ac, sage_spkg_configure.m4: Set default --with-system-gcc=force, --with-system-python3=force`|\n|[8e92b98](https://git.sagemath.org/sage.git/commit?id=8e92b98212e3f4c6ef9cc52114eea4017e07c8c8)|`tox.ini: Override new configure --with-system-python3=force default from #32060`|\n|[19efe21](https://git.sagemath.org/sage.git/commit?id=19efe2125c0903a52011390850122651ceccb6d6)|`configure.ac: Revert the change to the default for --with-system-python3`|\n|[c5e1dec](https://git.sagemath.org/sage.git/commit?id=c5e1deca80eb80020cd5be84532aac136204d1c0)|`add gfortran to _prereq/distros`|\n|[2482aa1](https://git.sagemath.org/sage.git/commit?id=2482aa13fda6bc3e27e327dde665c2c916aa5b29)|`error out if C/C++ is not good enough`|\n|[6366b2a](https://git.sagemath.org/sage.git/commit?id=6366b2a8da2f865bc5221968dbb2688320e51a84)|`error out if no good Fortran found.`|\n|[f103f2a](https://git.sagemath.org/sage.git/commit?id=f103f2a1bf1a73d65a1671384b7c3525167a82c5)|`remove *gcc_spkg workflows`|\n|[f58e236](https://git.sagemath.org/sage.git/commit?id=f58e23682a20ac16330d6f5361a55e040a88a39b)|`correct the order of messages`|\n|[657c1e0](https://git.sagemath.org/sage.git/commit?id=657c1e065792832852536af087dbc287264871ce)|`adjust tox.ini for no gcc spkg`|\n|[5461d81](https://git.sagemath.org/sage.git/commit?id=5461d81da43b1bd8b3be85fc7e89975568910e24)|`correct order of messages`|",
...
```json
{
    "body": "<a id='comment:36'></a>\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[58ca5d2](https://git.sagemath.org/sage.git/commit?id=58ca5d29c50bf4732c567f7a97dd83fe56ac07f6)|`gcc->experimental, gfortran->optional`|",
    "created_at": "2022-10-09T08:38:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32532",
    "type": "issue_comment",
