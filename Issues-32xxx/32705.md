...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[d8123bf](https://git.sagemath.org/sage.git/commit?id=d8123bfdb43b6d3be6b685a208cf2aa16a0025ac)|`toml must not be a dependency for tomli`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[e436848](https://git.sagemath.org/sage.git/commit/?id=e43684811c0e5681940704f842f11d0be954f3f4)|`Build the flit_core wheel by hand`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[cf586c7](https://git.sagemath.org/sage.git/commit/?id=cf586c7e7fd504c5c1bdf6c884dcfecb4b67e020)|`Set PYTHONPATH when installing tomli to handle cyclic dependency with flit_core`|",
