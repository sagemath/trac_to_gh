...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640193",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640194",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640195",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640196",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640197",
...
```json
{
    "body": "<a id='comment:3'></a>It seems that the best syntax is `int | None` starting from python 3.10 :\n\nhttps://stackoverflow.com/questions/51710037/how-should-i-use-the-optional-type-hint",
    "created_at": "2021-07-09T11:24:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640198",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>It seems that the best syntax is `int | None` starting from python 3.10 :
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640201",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640202",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I have undone the change to `color` and removed its annotation.\n\nI also used the new syntax for union annotation elsewhere in the same file.",
    "created_at": "2021-07-11T06:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640203",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>I have undone the change to `color` and removed its annotation.
...
```json
{
    "body": "<a id='comment:8'></a>LGTM and also passes tests also on Python 3.7.11.",
    "created_at": "2021-07-11T21:00:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640204",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:8'></a>LGTM and also passes tests also on Python 3.7.11.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640205",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640206",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32164#event-85177"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640207",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32164#issuecomment-640208",
    "user": "https://github.com/vbraun"
}
```
