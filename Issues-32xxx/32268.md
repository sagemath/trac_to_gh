...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460137",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "This is not the final draft \u2014\u00a0I'd like to resolve at least some of the \"TODO\"s \u2014 but I'll mark it as \"needs review\".\n\n---\nNew commits:",
    "created_at": "2021-09-12T00:28:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460138",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Structurally, the starting place for a review perhaps should be the `free_*` files; the others are built on top of those.",
    "created_at": "2021-09-12T00:30:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460139",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460140",
...
```json
{
    "body": "In order to follow #32501, `__init__.py` should be empty, so I changed it, moving the TODO list to `module.py`.",
    "created_at": "2021-09-13T20:55:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460141",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460143",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Here are some of the changes: everything you suggested except for the category framework and changing the documentation to reflect what we mean by basis. (I thought I would take care of the easy things first.)\n\nIf you have more thoughts about how to use the category framework, I would be happy to hear them.",
    "created_at": "2021-09-28T20:43:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460144",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460147",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460148",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460149",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460150",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460152",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Now including doctest coverage for everything.",
    "created_at": "2021-10-09T01:28:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460153",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "I think this all works. We can use the suggestion at the end of comment:10 now or defer to another ticket. I think I would prefer to wait and see where the real bottlenecks are.",
    "created_at": "2021-10-09T02:54:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460154",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460155",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460157",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460160",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "I am also +1 on changing the print (and latex) representation of elements to have user specified names. We can just use the framework of `IndexedGenerators` to handle the printing. We can also add an option to retain the current printing (as it matches what `FreeModule` does). John, what would `(x + y)*a`, where `x,y` are different basis elements of the algebra `A`, print as? `x*a + y*a` or `(x + y)*a`? Should we add such an option too?",
    "created_at": "2021-12-10T00:25:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460163",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460165",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460166",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460167",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460168",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Here is a branch that uses the new print representation and adds a LaTeX representation. It also changes `submodule` to `submodule_inclusion`, `kernel` -> `kernel_morphism`, `cokernel` -> `cokernel_morphism`.",
    "created_at": "2021-12-10T04:11:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460169",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "We can undo these changes if there are sound objections, of course.",
    "created_at": "2021-12-10T04:12:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460170",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460171",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460172",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460173",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460174",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460175",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460177",
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32268#event-86211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460179",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Here is a branch with comment:41 incorporated. If you can push a branch with `names` etc., that would be great!",
    "created_at": "2022-01-01T02:54:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460180",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460181",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460183",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460184",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "I changed `G[0]` to `g[0]` but also changed `G(0, 0)` to `g(0, 0)` \u2014\u00a0it wasn't clear how to get brackets in the second case. I also changed the print representation for morphisms. I think I fixed all of the doctests, too.",
    "created_at": "2022-01-25T05:45:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460185",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460186",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460187",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460188",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460190",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460191",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460192",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460193",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460195",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "This passes all tests for me now. Let's not worry about allowing a morphism as input to the `FPModule` constructor. I'd like to be able to move on to #30680. Travis, I'm happy with all of your work on this; thank you. Any objections to my most recent changes?",
    "created_at": "2022-01-29T01:56:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460196",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460197",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460198",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460200",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460201",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460202",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460203",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460204",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "So maybe the choice for `resolution` was because the initial map has codomain `M` which is likely not free. With the new `as_free=True` option, the later maps are all converted to type `FreeGradedModuleMorphism`, and you could just omit the 0th term to get an honest (graded) free resolution out of it.\n\nMaybe now we're done?",
    "created_at": "2022-01-30T02:03:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460206",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460207",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Fixed a few more things: the `free_graded_module` method for algebras with basis wasn't handling the `names` argument correctly, and a few doctests were failing. I changed some of the documentation, too.",
    "created_at": "2022-01-30T03:26:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460208",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "I was just running into that problem in comment:74 and about to fix it. Thanks. I will be pushing a bunch of changes shortly too.",
    "created_at": "2022-01-30T03:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460209",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460210",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460213",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460214",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460215",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "> Good question. Comments from the original authors? Why not just use free modules in resolution? \n\nIn the original version, the free module class was not intended for public use.",
    "created_at": "2022-01-30T07:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460216",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460217",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460218",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Travis, was your intention to delete the `identity` method from `free_homspace`? Perhaps also remove `zero`?",
    "created_at": "2022-01-30T17:06:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460219",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460221",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460222",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460223",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Followup in #33275.",
    "created_at": "2022-02-02T17:56:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460224",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32268#issuecomment-460225",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32268",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32268#event-86212"
}
```
