...
archive/issue_events_420851.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420851"
}
```
...
archive/issue_events_420852.json:
```json
{
    "actor": "https://github.com/tobiasdiez",
    "created_at": "2021-11-29T12:15:10Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420852"
}
```
...
archive/issue_events_420853.json:
```json
{
    "actor": "https://github.com/tobiasdiez",
    "created_at": "2021-11-29T12:15:10Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420853"
}
```
...
archive/issue_events_420854.json:
```json
{
    "actor": "https://github.com/tobiasdiez",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420854"
}
```
...
archive/issue_events_420855.json:
```json
{
    "actor": "https://github.com/tobiasdiez",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420855"
}
```
...
archive/issue_events_420856.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32948",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32948#event-420859"
}
```
