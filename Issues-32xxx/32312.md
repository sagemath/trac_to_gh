...
<a id='comment:7'></a>I cannot attest to the validity of the algorithm, but it is implemented as defined as far as I can tell and it passes doctests.
...
<a id='comment:11'></a>Replying to [lorenz](#comment%3A9):
> Replying to [tscrim](#comment%3A7):
> > Is this something that is guaranteed to happen or is it for controlling user input?
> > 
> > ```
