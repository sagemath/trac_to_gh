...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-435781"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-435782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32995#issuecomment-535866",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-435783"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-435784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32995#issuecomment-535867",
    "user": "https://github.com/orlitzky"
}
```
