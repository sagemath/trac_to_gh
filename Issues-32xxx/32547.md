...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32547#issuecomment-527946",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32547#issuecomment-527947",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32547#event-430333"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32547#event-430334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32547#event-430335"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32547",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32547#event-430336"
}
```
