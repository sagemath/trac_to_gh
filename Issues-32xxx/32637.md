# Issue 32637: New option "./configure --enable-wheels"
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32637#event-86911"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32637#event-86912"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32637#event-86913"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32637#event-86914"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32637#event-86915"
}
```
...
Replying to [comment:27 Matthias Köppe]:
> It would be worth checking if we can use an on-disk cache to speed up dependency tracking and package/module discovery.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32637",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32637#event-86916"
}
```
