...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32554#issuecomment-648551",
    "user": "https://github.com/spaghettisalat"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32554#issuecomment-648553",
    "user": "https://github.com/spaghettisalat"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>OK. I don't think it matters much which version is included. As you can see in the discussion from 2012, the tricky bit is where this code should go and whether we can actually claim D in the global namespace for it.",
    "created_at": "2021-09-23T22:55:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32554#issuecomment-648554",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:4'></a>OK. I don't think it matters much which version is included. As you can see in the discussion from 2012, the tricky bit is where this code should go and whether we can actually claim D in the global namespace for it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32554#issuecomment-648555",
    "user": "https://github.com/spaghettisalat"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32554#event-86315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32554#issuecomment-648556",
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32554#event-86316"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32554#event-86317"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32554#event-86318"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32554#event-86319"
}
```
