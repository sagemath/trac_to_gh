# Issue 32901: Fix SAGE_FAT_BINARY regression for numpy ("Ignoring --build-option when building numpy using PEP 517")
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32901#event-87562"
}
```
