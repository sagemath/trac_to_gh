...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32809#event-86788"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>see #33497",
    "created_at": "2022-04-15T19:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32809",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32809#issuecomment-464088",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:2'></a>see #33497
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32809#event-86789"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32809#event-86790"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Now remains only\n\n```\ngit grep -l '\\._coerce_('\nrings/polynomial/pbori/pbori.pyx\nstructure/parent_base.pyx\nstructure/parent_old.pyx\n```\n\nand the one in pbori is commented out.",
    "created_at": "2022-07-04T08:55:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32809",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32809#issuecomment-464089",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>Now remains only
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32809#event-86791"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32809#event-86792"
}
```
