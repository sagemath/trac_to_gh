# Issue 32517: Add make option to use prebuilt wheels from PyPI
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32517#event-86691"
}
```
...
```json
{
    "body": "What kind of problems do you anticipate of using the prebuilt wheels from pypi of say numpy/scipy? As far as I know it shouldn't be a problem to use prebuilt wheels of two libraries that depend on the same native library but use different versions of that native library to create the wheels.",
    "created_at": "2021-10-24T22:03:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463320",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    "body": "how about wheels from other places, not only pypi?",
    "created_at": "2021-12-14T20:08:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463321",
...
```json
{
    "body": "If both `requirements.txt` and `checksums.ini` are present, install should not try to unpack the wheel file, but merely download and verify the checksums - then the wheel from `upstream/` can be used, not necessarily from pypi.",
    "created_at": "2021-12-14T20:12:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32517#issuecomment-463322",
    "user": "https://github.com/dimpase"
}
```
