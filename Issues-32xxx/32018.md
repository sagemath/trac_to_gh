...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[af7de16](https://git.sagemath.org/sage.git/commit?id=af7de168802757e09796e40a064668bca5c8a50e)|`Fixed error by ammending typo.`|",
    "created_at": "2021-06-21T10:55:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32018",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[d65ffb2](https://git.sagemath.org/sage.git/commit/?id=d65ffb2c7728b328429c3f593aef4c3f35713dbc)|`Doctest added`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|\n|[97bad77](https://git.sagemath.org/sage.git/commit/?id=97bad77be8bc82fe574febc0edac1a9d7e212406)|`Merge branch 'develop' into t/32018/error_in_sage_numerical_gauss_legendre_nodes and fix merge conflict`|",
