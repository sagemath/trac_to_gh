...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614133",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614134",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614135",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32282#event-95942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614136",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32282#event-95943"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32282#event-95944"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32282#event-95945"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614137",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614138",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614139",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614140",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614141",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614142",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_614143.json:
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -11,16 +11,13 @@\n \n highs also has a rudimentary python interface in its own source tree - https://github.com/ERGO-Code/HiGHS/blob/master/src/interfaces/highs_python_api.py\n \n-A possible route for a high-level interface goes through CVXPY (#31962)\n-\n For an interface that provides access to tableau data, as of 2022-04, neither scipy nor the [OsiHiGHSSolverInterface](https://github.com/ERGO-Code/HiGHS/blob/master/src/interfaces/OsiHiGHSSolverInterface.hpp) provides the necessary methods:\n - https://github.com/ERGO-Code/HiGHS/issues/525#issuecomment-1038529096\n - https://github.com/scipy/scipy/issues/15915 (feature request)\n \n-HiGHS is developing its own Python interface in https://github.com/ERGO-Code/HiGHS/tree/master/src/interfaces/highspy (using pybind11); tableau data access methods yet to be done\n-- https://github.com/ERGO-Code/HiGHS/issues/525#issuecomment-1086217397\n-\n-\n+See also:\n+- A possible route for a high-level interface goes through CVXPY (#31962)\n+- #33919 Add MILP solver backends for HiGHS via highspy\n \n Part of Meta-ticket #26511: Use Python optimization interfaces: CVXPY, or-tools, PuLP, Pyomo, cylp...\n \n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614143",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32282#issuecomment-614144",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32282#event-95946"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32282#event-95947"
}
```
