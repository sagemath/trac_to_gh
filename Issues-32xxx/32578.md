...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416386"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416389"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416390"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416391"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416392"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32578#issuecomment-528299",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32578#issuecomment-528300",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32578",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32578#event-416394"
}
```
