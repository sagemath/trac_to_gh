...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448376"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448378"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448379"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448380"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448381"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448382"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448384"
}
```
...
```json
{
    "body": "<div id=\"comment:4\" align=\"right\">comment:4</div>\n\nAs pointed out in [comment:1](#comment:1) (but not in these words), this is a duplicate of #29818, which was fixed in version 9.2, so the reporter was presumably using version 9.1.",
    "created_at": "2022-06-27T01:58:21Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/32526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32526#issuecomment-524750",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448385"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448386"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32526#issuecomment-524751",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32526#event-448391"
}
```
