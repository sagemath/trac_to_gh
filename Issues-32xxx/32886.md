...
archive/issue_events_454859.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454859"
}
```
...
archive/issue_events_454860.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2021-11-16T15:16:51Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454860"
}
```
...
archive/issue_events_454861.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2021-11-16T15:16:51Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454861"
}
```
...
archive/issue_events_454862.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2021-11-16T15:16:51Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454862"
}
```
...
archive/issue_events_454863.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454866"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32886",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32886#event-454867"
}
```
