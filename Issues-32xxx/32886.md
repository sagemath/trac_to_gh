...
```json
{
    "body": "See also a similar report for Sage 9.5.beta5 on Debian 10 buster.\n\n- https://groups.google.com/g/sage-release/c/AAW7uCh1iZs/m/WQvClVRjAQAJ",
...
```json
{
    "body": "Almost trivial fix, making the doctest more robust.  (What's tested is actually that an unevaluated integral produces proper LaTeX, and it does.)\n\n---\nNew commits:",
