...
```json
{
    "body": "<a id='comment:2'></a>\nI wasn't able to reproduce the failure, but I'm pretty sure that `Pi` is arising from `pi.pyobject()` during the comparison. In any case, it looks like I've fixed at least one bug. I'll test the new branch overnight.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[1ab9784](https://git.sagemath.org/sage.git/commit?id=1ab9784b7e3c1d8c5bcbb51b41ecbf7674244e81)|`Trac #32243: patch gfan to look for cddlib headers in new location.`|\n|[cfab03a](https://git.sagemath.org/sage.git/commit?id=cfab03af1f3cd9be334da0ab07e3890bb183ece0)|`Trac #32243: look for cddlib-0.94m headers in the right place.`|\n|[b30ce37](https://git.sagemath.org/sage.git/commit?id=b30ce37a7e11ed6c871d7167737ef1fb932ab31c)|`Trac #32185: special case constant symbolic relations.`|",
    "created_at": "2021-07-21T04:32:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32185",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[551d3ae](https://git.sagemath.org/sage.git/commit/?id=551d3ae99249456904eb6d2cdc97dbe9ed6201b9)|`Trac #32185: special case constant symbolic relations.`|",
