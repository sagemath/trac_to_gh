...
```json
{
    "body": "<a id='comment:7'></a>\nNew commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[981bb21](https://git.sagemath.org/sage.git/commit?id=981bb21fbd18ef9fe9931698d752a3238110f351)|`allow rich comparison of pickled faces`|\n|[52a6f40](https://git.sagemath.org/sage.git/commit?id=52a6f40d204d88fff4c0ac3bf56c9bec9ed232d1)|`do not skip `test_pickling`, if it works`|",
