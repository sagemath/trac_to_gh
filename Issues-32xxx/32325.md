...
```json
{
    "body": "<a id='comment:1'></a>FWIW, `Mathematica` can sort-of-solve the full system :\n\n```\nsage: mathematica.FullSimplify(mathematica.Reduce(eqL, varL))                   \n((c == 0 && ((a == 0 && (b != Re[b] || Re[b] != 0)) || \n    (b == 0 && (a != Re[a] || Re[a] != 0)))) || \n  (b == 0 && a == 0 && (c != Re[c] || Re[c] != 0))) && a + d == 0\n```",
    "created_at": "2021-08-02T12:18:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32325#issuecomment-489306",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:1'></a>FWIW, `Mathematica` can sort-of-solve the full system :
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85738"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85739"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85740"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85741"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85742"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85743"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32325#event-85744"
}
```
