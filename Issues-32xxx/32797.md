...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433326"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32797#issuecomment-532511",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32797#issuecomment-532512",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433328"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433330"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433331"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433332"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32797",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32797#event-433334"
}
```
