...
```json
{
    "body": "<a id='comment:1'></a>Using `Polyhedron` instead of `Cone` in this case would be an option.",
    "created_at": "2021-06-21T15:08:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32020#issuecomment-637173",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>Using `Polyhedron` instead of `Cone` in this case would be an option.
...
```json
{
    "body": "<a id='comment:3'></a>See also #30172, where an ABC for convex cones (not necessarily rational polyhedral) is in the works",
    "created_at": "2021-06-21T15:55:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32020#issuecomment-637174",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>See also #30172, where an ABC for convex cones (not necessarily rational polyhedral) is in the works
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32020#issuecomment-637175",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>You would need to pass `base_ring=AA`. Polyhedron refuses to compute with `SR`.",
    "created_at": "2021-06-21T17:35:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32020#issuecomment-637176",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>You would need to pass `base_ring=AA`. Polyhedron refuses to compute with `SR`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32020#issuecomment-637177",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>If you need cones with transcendental data, #30234 would be an approach.",
    "created_at": "2021-06-21T17:40:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32020#issuecomment-637178",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:7'></a>If you need cones with transcendental data, #30234 would be an approach.
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84700"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84701"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84702"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84703"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84704"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84705"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32020#event-84706"
}
```
