...
```
Non-binary files that are part of the sage sources and needed by the sage package at import time should be installed in the package, using `package_data` in `setup.py`.  See e.g. ticket:27040#comment:48
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422026",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422027",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1 +1 @@\n-See e.g. Non-binary files that are part of the sage sources and needed by the sage package at import time should live in the package.  See e.g. ticket:27040#comment:48\n+Non-binary files that are part of the sage sources and needed by the sage package at import time should be installed in the package, using `package_data` in `setup.py`.  See e.g. ticket:27040#comment:48\n``````\n",
    "created_at": "2019-01-30T09:21:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422028",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422029",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239934"
}
```
...
```json
{
    ...
    "label": "pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239935"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422030",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239936"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239937"
}
```
...
```json
{
    ...
    "label": "pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422031",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422032",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422033",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239939"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422034",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422035",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239940"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422037",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422038",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27171#issuecomment-422039",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27171#event-239943"
}
```
