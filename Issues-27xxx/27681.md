...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534403",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/embray/ticket-27681\"",
    "created_at": "2019-04-17T15:58:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534405",
    "user": "https://github.com/embray"
}
```

Changing branch from "" to "u/embray/ticket-27681"
...
```json
{
    "body": "Changing commit from \"\" to \"0b6d94ee889e35b167b616fc4b9488a29cedc6d1\"",
    "created_at": "2019-04-17T15:58:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534407",
    "user": "https://github.com/embray"
}
```

Changing commit from "" to "0b6d94ee889e35b167b616fc4b9488a29cedc6d1"
...
```json
{
    "body": "Changing dependencies from \"\" to \"#27680\"",
    "created_at": "2019-04-17T15:58:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534408",
    "user": "https://github.com/embray"
}
```

Changing dependencies from "" to "#27680"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534409",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534410",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>The attached fix worked around the issue superficially for one use case, but it still seems to be a problem after all as I am still able to reproduce it in other cases even with this fix.",
    "created_at": "2019-04-17T17:39:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534411",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>The attached fix worked around the issue superficially for one use case, but it still seems to be a problem after all as I am still able to reproduce it in other cases even with this fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534412",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I am not able to reproduce the problem in the ticket description. Is it platform-specific?",
    "created_at": "2019-05-06T11:52:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534413",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:5'></a>I am not able to reproduce the problem in the ticket description. Is it platform-specific?
...
```json
{
    "body": "<a id='comment:10'></a>I'm not sure it has *nothing* to do with libgap.  In [0b6d94ee](https://git.sagemath.org/sage.git/commit?id=0b6d94ee889e35b167b616fc4b9488a29cedc6d1) I fixed a problem where libgap was being used *during* pexpect-gap initialization in the `all_installed_packages` function.\n\nThis seemed to alleviate the problem somewhat, but it seems to be more of a bandaid.\n\nWhat's really weird is that the way the problem manifests itself is in the form of some pretty severe memory corruption affecting just random things in Sage.  And I would think that only the libgap interface would be capable of breaking things that badly.\n\nI haven't looked at the issue in a few weeks though so I don't have any good ideas at the moment.  I need to start looking at it again...",
    "created_at": "2019-05-06T13:20:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534416",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>I'm not sure it has *nothing* to do with libgap.  In [0b6d94ee](https://git.sagemath.org/sage.git/commit?id=0b6d94ee889e35b167b616fc4b9488a29cedc6d1) I fixed a problem where libgap was being used *during* pexpect-gap initialization in the `all_installed_packages` function.
...
```json
{
    "body": "<a id='comment:11'></a>As usual with race conditions, it's extremely fluid, changes somewhere unrelated might \"fix\" it. First of all, there is no reason for GAP workspace to get updated during this test, yet is updated (not only on systems where these errors are seen, it seems it happens everywhere).",
    "created_at": "2019-05-06T13:40:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534417",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:11'></a>As usual with race conditions, it's extremely fluid, changes somewhere unrelated might "fix" it. First of all, there is no reason for GAP workspace to get updated during this test, yet is updated (not only on systems where these errors are seen, it seems it happens everywhere).
...
```json
{
    "body": "<a id='comment:12'></a>After rebasing this branch on 8.8.beta4 I can't reproduce the issue anymore, at least not in the same way. I'll keep trying things though.",
    "created_at": "2019-05-06T14:04:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534418",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>After rebasing this branch on 8.8.beta4 I can't reproduce the issue anymore, at least not in the same way. I'll keep trying things though.
...
```json
{
    "body": "Changing commit from \"0b6d94ee889e35b167b616fc4b9488a29cedc6d1\" to \"ecacac8b9440cb8ac1950a3d0619a50cbb19ede6\"",
    "created_at": "2019-05-06T15:20:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534419",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0b6d94ee889e35b167b616fc4b9488a29cedc6d1" to "ecacac8b9440cb8ac1950a3d0619a50cbb19ede6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534420",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534421",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Rebased the branch on 8.8.beta4.  Did a full `make ptestlong` and it passed, no problem.  This is on my Ubuntu machine; which IIRC is where I originally noted the problem.\n\nCan you try this updated version of the branch and see if it's fixed on Fedora as well?  Anyways, try as I might and I can't get this to come back, at least not in the way I originally reproduced it.\n\nI'll try again on Cygwin too...",
    "created_at": "2019-05-06T15:22:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534422",
    "user": "https://github.com/embray"
}
```

<a id='comment:14'></a>Rebased the branch on 8.8.beta4.  Did a full `make ptestlong` and it passed, no problem.  This is on my Ubuntu machine; which IIRC is where I originally noted the problem.
...
```json
{
    "body": "<a id='comment:16'></a>Note that if I wipe out ~/.sage/ then after that the 1st run the test passes, but on the 2nd, etc. runs it does not.",
    "created_at": "2019-05-06T16:03:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534424",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:16'></a>Note that if I wipe out ~/.sage/ then after that the 1st run the test passes, but on the 2nd, etc. runs it does not.
...
```json
{
    "body": "<a id='comment:17'></a>Right, that's the behavior I was getting before too, but now I'm not getting it anymore, even on the exact same system as before :(",
    "created_at": "2019-05-06T16:16:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534425",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>Right, that's the behavior I was getting before too, but now I'm not getting it anymore, even on the exact same system as before :(
...
```json
{
    "body": "<a id='comment:18'></a>How does one check the caller stack while running tests? I would like to see where `gap_reset_workspace()` is triggered during this test run, but the usual `inspect` thing does not print anything:\n\n```diff\n--- a/src/sage/interfaces/gap.py\n+++ b/src/sage/interfaces/gap.py\n@@ -1575,6 +1575,11 @@ def gap_reset_workspace(max_workspace_size=None, verbose=False):\n         sage: sage.interfaces.gap.WORKSPACE = ORIGINAL_WORKSPACE\n     \"\"\"\n     # Create new workspace with filename WORKSPACE\n+    import inspect\n+    curframe = inspect.currentframe()\n+    calframe = inspect.getouterframes(curframe, 2)\n+    print('caller name:', calframe[1][3])\n+\n     g = Gap(use_workspace_cache=False, max_workspace_size=None)\n     g.eval('SetUserPreference(\"HistoryMaxLines\", 30)')\n     from sage.tests.gap_packages import all_installed_packages\n```\nyes the GAP workspace is changed during the test run!",
    "created_at": "2019-05-07T09:32:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534426",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:18'></a>How does one check the caller stack while running tests? I would like to see where `gap_reset_workspace()` is triggered during this test run, but the usual `inspect` thing does not print anything:
...
```json
{
    "body": "<a id='comment:20'></a>One way would be to run the test with `--serial`.",
    "created_at": "2019-05-07T12:28:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534428",
    "user": "https://github.com/embray"
}
```

<a id='comment:20'></a>One way would be to run the test with `--serial`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534429",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>You can put `import pdb; pdb.set_trace()` in a function, and then run the tests with `--serial` and break where the function is first called.  This is how I found that it was originally being called by `all_installed_packages`.",
    "created_at": "2019-05-07T14:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534430",
    "user": "https://github.com/embray"
}
```

<a id='comment:22'></a>You can put `import pdb; pdb.set_trace()` in a function, and then run the tests with `--serial` and break where the function is first called.  This is how I found that it was originally being called by `all_installed_packages`.
...
```json
{
    "body": "<a id='comment:23'></a>OK, I was able to find where the workspace is accessed (more precisely, `os.utime()` is called on it, and commented it  out, and still get the same crashes.\n\nSo it is a race condition, as `--serial` allows the tests to pass, but it appears that it has nothing to do with GAP or libgap workspaces.",
    "created_at": "2019-05-07T15:40:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534431",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:23'></a>OK, I was able to find where the workspace is accessed (more precisely, `os.utime()` is called on it, and commented it  out, and still get the same crashes.
...
```json
{
    "body": "<a id='comment:24'></a>But what would be *racing*?  If you run a single test module then there's still only one test running concurrently, so there's nothing for it to race against.",
    "created_at": "2019-05-07T16:09:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534432",
    "user": "https://github.com/embray"
}
```

<a id='comment:24'></a>But what would be *racing*?  If you run a single test module then there's still only one test running concurrently, so there's nothing for it to race against.
...
```json
{
    "body": "<a id='comment:25'></a>whatever `--serial` is doing, it removes some parallelism somewhere, I gather.",
    "created_at": "2019-05-07T16:20:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534433",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:25'></a>whatever `--serial` is doing, it removes some parallelism somewhere, I gather.
...
```json
{
    "body": "<a id='comment:26'></a>That's exactly what it's doing.  Normally the doctests for each module are run in a separate process.  `--serial` makes it run in the same process that started the test runner.\n\nIIRC I was *not* able to reproduce the problem with `--serial` but now I can't remember for sure.  My point is that it's just an easier way to run the test interactively and stop at a breakpoint.",
    "created_at": "2019-05-07T17:36:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534434",
    "user": "https://github.com/embray"
}
```

<a id='comment:26'></a>That's exactly what it's doing.  Normally the doctests for each module are run in a separate process.  `--serial` makes it run in the same process that started the test runner.
...
```json
{
    "body": "<a id='comment:27'></a>If there is a problem here, it's with doctest framework. Otherwise, looks good.",
    "created_at": "2019-05-08T07:03:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534435",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:27'></a>If there is a problem here, it's with doctest framework. Otherwise, looks good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534436",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534437",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534438",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27681#event-68673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534439",
...
```json
{
    "body": "Changing branch from \"u/embray/ticket-27681\" to \"ecacac8b9440cb8ac1950a3d0619a50cbb19ede6\"",
    "created_at": "2019-05-14T12:37:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534440",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/embray/ticket-27681" to "ecacac8b9440cb8ac1950a3d0619a50cbb19ede6"
...
```json
{
    "body": "Changing commit from \"ecacac8b9440cb8ac1950a3d0619a50cbb19ede6\" to \"\"",
    "created_at": "2019-05-14T23:53:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534442",
    "user": "https://github.com/kiwifb"
}
```

Changing commit from "ecacac8b9440cb8ac1950a3d0619a50cbb19ede6" to ""
...
```json
{
    "body": "<a id='comment:32'></a>Follow up at #27878",
    "created_at": "2019-05-28T00:04:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534444",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:32'></a>Follow up at #27878
...
```json
{
    "body": "<a id='comment:33'></a>Using 8.8.rc2 with Python 2, I still consistently get the same error as in[comment:15](#comment%3A15). This is on CentOS Linux release 7.6.1810 (Core). Using `--serial` makes the test pass.",
    "created_at": "2019-06-22T08:46:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534445",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:33'></a>Using 8.8.rc2 with Python 2, I still consistently get the same error as in[comment:15](#comment%3A15). This is on CentOS Linux release 7.6.1810 (Core). Using `--serial` makes the test pass.
...
```json
{
    "body": "<a id='comment:34'></a>I was able to reproduce this again in #18267 specifically.",
    "created_at": "2019-06-25T16:01:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534446",
    "user": "https://github.com/embray"
}
```

<a id='comment:34'></a>I was able to reproduce this again in #18267 specifically.
...
```json
{
    "body": "<a id='comment:36'></a>I've opened #28106 to track this issue further.",
    "created_at": "2019-07-03T15:13:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534448",
    "user": "https://github.com/embray"
}
```

<a id='comment:36'></a>I've opened #28106 to track this issue further.
...
```json
{
    "body": "Changing branch from \"ecacac8b9440cb8ac1950a3d0619a50cbb19ede6\" to \"u/embray/ticket-27681\"",
    "created_at": "2019-07-13T11:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534449",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "ecacac8b9440cb8ac1950a3d0619a50cbb19ede6" to "u/embray/ticket-27681"
...
```json
{
    "body": "Changing commit from \"\" to \"ecacac8b9440cb8ac1950a3d0619a50cbb19ede6\"",
    "created_at": "2019-07-13T11:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534450",
    "user": "https://github.com/vbraun"
}
```

Changing commit from "" to "ecacac8b9440cb8ac1950a3d0619a50cbb19ede6"
...
```json
{
    "body": "<a id='comment:37'></a>Reopening as it breaks the buildbot",
    "created_at": "2019-07-13T11:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534451",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:37'></a>Reopening as it breaks the buildbot
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534452",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534453",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27681#event-68674"
}
```
...
```json
{
    "body": "Changing dependencies from \"#27680\" to \"#27680, #28106\"",
    "created_at": "2019-07-13T11:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534454",
    "user": "https://github.com/vbraun"
}
```

Changing dependencies from "#27680" to "#27680, #28106"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534455",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534456",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Setting this back to positive review assuming that it'll be fixed in #28106",
    "created_at": "2019-07-13T11:59:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534457",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:39'></a>Setting this back to positive review assuming that it'll be fixed in #28106
...
```json
{
    "body": "Changing dependencies from \"#27680, #28106\" to \"27680, 28106\"",
    "created_at": "2019-07-13T12:01:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534458",
    "user": "https://github.com/vbraun"
}
```

Changing dependencies from "#27680, #28106" to "27680, 28106"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534459",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534460",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27681#event-68675"
}
```
...
```json
{
    "body": "Changing dependencies from \"27680, 28106\" to \"#27680\"",
    "created_at": "2019-07-13T12:09:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534461",
    "user": "https://github.com/vbraun"
}
```

Changing dependencies from "27680, 28106" to "#27680"
...
```json
{
    "body": "<a id='comment:41'></a>Wrong ticket, sorry for the noise",
    "created_at": "2019-07-13T12:09:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534462",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:41'></a>Wrong ticket, sorry for the noise
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27681#issuecomment-534463",
    "user": "https://github.com/vbraun"
}
```
