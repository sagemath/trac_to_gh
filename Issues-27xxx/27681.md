...
```json
{
    "body": "<a id='comment:33'></a>Using 8.8.rc2 with Python 2, I still consistently get the same error as in comment:15. This is on CentOS Linux release 7.6.1810 (Core). Using `--serial` makes the test pass.",
...
<a id='comment:33'></a>Using 8.8.rc2 with Python 2, I still consistently get the same error as in comment:15. This is on CentOS Linux release 7.6.1810 (Core). Using `--serial` makes the test pass.
...
<a id='comment:35'></a>Replying to [comment:33 gh-mwageringel]:
> Using 8.8.rc2 with Python 2, I still consistently get the same error as in comment:15. This is on CentOS Linux release 7.6.1810 (Core). Using `--serial` makes the test pass.
