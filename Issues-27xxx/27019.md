...
```json
{
    "body": "<a id='comment:1'></a>Part of the problem is that `BooleanMonomialMonoid` is a **monoid** and not a **ring**.\n\nSo there cannot be a coercion from `ZZ` to the `BooleanMonomialMonoid`. There could be a coercion to the common parent `P` but that requires a pushout construction...",
    "created_at": "2019-01-04T14:48:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27019#issuecomment-519369",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Part of the problem is that `BooleanMonomialMonoid` is a **monoid** and not a **ring**.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27019#issuecomment-519370",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27019#issuecomment-519371",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27019#issuecomment-519372",
    "user": "https://github.com/embray"
}
```
