...
```json
{
    "body": "green bot, please review. I have a small doubt on what to do exactly..",
...
```json
{
    "body": "Hmm. Sympy send us back a variable `_None` whose name is `'None'`. What should we do with that ? Make a special case to map it to `None` ?\n\n```\nsage: var('t, s')\nsage: ex=cos(s)\nsage: ex_sy, s, t = [expr._sympy_() for expr in (ex, s, t)]\n....: from sympy import inverse_laplace_transform\n....: from sage.interfaces.sympy import sympy_init\n....: sympy_init()\n....: result = inverse_laplace_transform(ex_sy, s, t)\nsage: d = result.args[3]; d\n```",
...
```json
{
    "body": "still need to fix the failure with python3 in src/sage/calculus/calculus.py",
    "created_at": "2019-03-30T17:21:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27457",
    "type": "issue_comment",
...
```json
{
    "body": "Does the change in comment:10 work and make sense?",
...
```json
{
    "body": "I am not so sure about your comment:10. When sympy send us `None`, we should probably not make a symbolic variable out of it, but understand it as `None`.\n\nEDIT: at least now, we have the same failure in py2 and py3..",
...
```json
{
    "body": "let us try John's first proposal",
    "created_at": "2019-04-05T15:23:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27457",
    "type": "issue_comment",
...
```json
{
    "body": "bot is green on python2, and tests are ok with python3. I would say this is a reasonable solution, even if not elegant.",
...
```json
{
    "body": "I see--as long as it works it's fine by me.",
