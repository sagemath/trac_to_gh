...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[5b2c1ab](https://git.sagemath.org/sage.git/commit?id=5b2c1abd219754b78c692425589905a1c2df4425)|`Display of tensor fields with only a chart given as argument`|\n|[9155312](https://git.sagemath.org/sage.git/commit?id=91553126483bc1e91f910e0af7813bbea0c44ad5)|`Merge branch 'public/manifolds/display_from_chart' of git://trac.sagemath.org/sage into Sage 8.8.beta1.`|\n|[d975e85](https://git.sagemath.org/sage.git/commit?id=d975e8599f22a73f6ba371e8491592e06c9d0c53)|`Update documentation with display of tensor fields with only a chart given as argument`|",
    "created_at": "2019-04-12T15:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27655",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[b97afe2](https://git.sagemath.org/sage.git/commit/?id=b97afe2304d8dcfa4c41a2c6d5b68685373839c6)|`Check of chart with isinstance(basis, Chart) in FreeModuleTensor._preparse_display`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|\n|[c529eb5](https://git.sagemath.org/sage.git/commit/?id=c529eb5ce1c1121c9d13bfbaec723739f921d3e4)|`Merge branch 'public/manifolds/display_from_chart' of git://trac.sagemath.org/sage into Sage 8.8.beta2`|\n|[5106067](https://git.sagemath.org/sage.git/commit/?id=5106067e6b4c30f6167ef3f2531232b94f99184d)|`Make the import of Chart local to FreeModuleTensor._preparse_display`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|\n|[5536b94](https://git.sagemath.org/sage.git/commit/?id=5536b9431def2dce5a78f90a9b2a33c495192060)|`Lazy import of FiniteRankFreeModule + import of Chart at the module level in free_module_tensor.py`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[093bd08](https://git.sagemath.org/sage.git/commit/?id=093bd082a9d1129444e7fa5085796cac39fc881d)|`Check basis against a FreeModuleBasis in FreeModuleTensor._preparse_display`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[4060557](https://git.sagemath.org/sage.git/commit/?id=4060557d205263fd5c8a2ce2e1d0e0e96e5baa94)|`Check basis against a Chart in FreeModuleTensor._preparse_display`|",
    "created_at": "2019-04-17T08:28:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27655",
    "type": "issue_comment",
