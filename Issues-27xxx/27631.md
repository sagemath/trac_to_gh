...
archive/attachments_021906.json:
```json
{
...
```json
{
    "body": "**Attachment:** [py2.patch](https://github.com/sagemath/sage/files/ticket27631/py2.patch)",
    "created_at": "2019-04-09T17:26:59Z",
    "issue": "https://github.com/sagemath/sage/issues/27631",
    "type": "issue_comment",
...
**Attachment:** [py2.patch](https://github.com/sagemath/sage/files/ticket27631/py2.patch)



---

archive/attachments_021907.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [py3.patch](https://github.com/sagemath/sage/files/ticket27631/py3.patch)\n\nOne also has to do something to pillow:\n\n```\nThe headers or library files could not be found for zlib,\na required dependency when compiling Pillow from source.\n\n```",
    "created_at": "2019-04-09T17:30:04Z",
    "issue": "https://github.com/sagemath/sage/issues/27631",
    "type": "issue_comment",
