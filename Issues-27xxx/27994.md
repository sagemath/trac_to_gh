...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352790"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352793"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352795"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352797"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27994",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27994#event-352800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27994#issuecomment-438495",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27994#issuecomment-438496",
    "user": "https://github.com/mkoeppe"
}
```
