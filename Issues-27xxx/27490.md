...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530220",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530221",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530222",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530223",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Jeroen, you will likely have thoughts about this.  Keep in mind, it's not meant to be at all robust--just a quick workaround so I don't have to spend too much more time on it.  But if you have any thoughts on straightforward improvements to this I'm all for it.\n\nObviously a better workaround, if it were possible, would be to use the much talked-about idea for generalizing the parallel processing loop from the Sage doctester. But since we don't have that yet this will do for now.\n\n---\nNew commits:",
    "created_at": "2019-03-15T11:08:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530224",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>Jeroen, you will likely have thoughts about this.  Keep in mind, it's not meant to be at all robust--just a quick workaround so I don't have to spend too much more time on it.  But if you have any thoughts on straightforward improvements to this I'm all for it.
...
```json
{
    "body": "<a id='comment:2'></a>I'm just wondering why you even bother with parallel docbuilding in the first place. The obvious solution is just using a single process.",
    "created_at": "2019-03-15T13:13:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530225",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>I'm just wondering why you even bother with parallel docbuilding in the first place. The obvious solution is just using a single process.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530227",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530230",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530231",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530232",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530233",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530234",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I addressed most of your comments, but I still have the big `if/else`.  Since that `sage_setup.docbuild.__init__` module is already quite large, perhaps I could move that code to a utility module at least.\n\nI'd still be open to just using it on all platforms, but I'm wary, given that this isn't battle-tested.",
    "created_at": "2019-03-15T15:26:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530235",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>I addressed most of your comments, but I still have the big `if/else`.  Since that `sage_setup.docbuild.__init__` module is already quite large, perhaps I could move that code to a utility module at least.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530236",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530237",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530238",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I'm willing to give this the benefit of the doubt. You'll probably be the only user of this code anyway.\n\nI'm sure that there is room for improvement (I still don't like the `finally` block for example), but we can defer that to the point that we decide to use this code for all systems.",
    "created_at": "2019-03-15T16:01:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530239",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>I'm willing to give this the benefit of the doubt. You'll probably be the only user of this code anyway.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530240",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Thanks.  However, I need to double back now since my last change broke something.  It's not starting new processes up after previous ones finish.",
    "created_at": "2019-03-15T16:05:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530241",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>Thanks.  However, I need to double back now since my last change broke something.  It's not starting new processes up after previous ones finish.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530242",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I see. In the doctester, we solve this by checking for the `SIGCHLD` signal instead of `os.wait()`. Now I know why.",
    "created_at": "2019-03-15T17:01:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530243",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>I see. In the doctester, we solve this by checking for the `SIGCHLD` signal instead of `os.wait()`. Now I know why.
...
```json
{
    "body": "<a id='comment:15'></a>I thought of doing that as a solution, but then you start involving signal handling and basically reimplementing parts of the doctester.  I have another solution that's a bit ugly but simpler.\n\nIt would be nice if there were a sort of `multiprocessing.wait()` that could wait for any one `multiprocessing.Process` to finish (or maybe one out of a specific list thereof).  Since multiprocessing already tracks its child processes this could be done.  Maybe I'll propose it...",
    "created_at": "2019-03-15T17:12:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530244",
    "user": "https://github.com/embray"
}
```

<a id='comment:15'></a>I thought of doing that as a solution, but then you start involving signal handling and basically reimplementing parts of the doctester.  I have another solution that's a bit ugly but simpler.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530245",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530246",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>One can see how quickly more complex this *can* become.",
    "created_at": "2019-03-15T17:40:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530247",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>One can see how quickly more complex this *can* become.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530248",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530249",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Setting back to positive review since Jeroen was okay with (or at least resigned to) the current approach.  I've tested the updated code several times with different numbers of processes and am satisfied with it for now.",
    "created_at": "2019-03-15T17:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530250",
    "user": "https://github.com/embray"
}
```

<a id='comment:18'></a>Setting back to positive review since Jeroen was okay with (or at least resigned to) the current approach.  I've tested the updated code several times with different numbers of processes and am satisfied with it for now.
...
```json
{
    "body": "<a id='comment:19'></a>Can we move that abomination at least into a separate file",
    "created_at": "2019-03-15T18:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530251",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:19'></a>Can we move that abomination at least into a separate file
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530252",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530253",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Which \"abomination\"?  I'm not necessarily going to do anything at your behest if you put it in such negative terms.",
    "created_at": "2019-03-18T11:00:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530254",
    "user": "https://github.com/embray"
}
```

<a id='comment:21'></a>Which "abomination"?  I'm not necessarily going to do anything at your behest if you put it in such negative terms.
...
```json
{
    "body": "<a id='comment:22'></a>(Which is not not say I necessarily think this is pretty as-is but it's still not even clear exactly what you're asking to move).",
    "created_at": "2019-03-18T11:32:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530255",
    "user": "https://github.com/embray"
}
```

<a id='comment:22'></a>(Which is not not say I necessarily think this is pretty as-is but it's still not even clear exactly what you're asking to move).
...
```json
{
    "body": "<a id='comment:23'></a>Im asking you to move the parallel implementation of multiprocessing into a separate file, ideally with a small doctstring explaining what is going on here.",
    "created_at": "2019-03-18T16:28:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530256",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:23'></a>Im asking you to move the parallel implementation of multiprocessing into a separate file, ideally with a small doctstring explaining what is going on here.
...
```json
{
    "body": "<a id='comment:24'></a>But both versions? Just the one I added?",
    "created_at": "2019-03-19T08:51:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530257",
    "user": "https://github.com/embray"
}
```

<a id='comment:24'></a>But both versions? Just the one I added?
...
```json
{
    "body": "<a id='comment:25'></a>At least for now just the one you added in the else branch. Thanks.",
    "created_at": "2019-03-19T09:24:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530258",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:25'></a>At least for now just the one you added in the else branch. Thanks.
...
```json
{
    "body": "<a id='comment:26'></a>Okay, I'll do that.",
    "created_at": "2019-03-19T10:22:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530259",
    "user": "https://github.com/embray"
}
```

<a id='comment:26'></a>Okay, I'll do that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530260",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530261",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530262",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530263",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530264",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530265",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>(Just removed an unused import.)",
    "created_at": "2019-03-19T11:32:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530266",
    "user": "https://github.com/embray"
}
```

<a id='comment:30'></a>(Just removed an unused import.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530267",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530268",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530269",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530270",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Followup at #27514",
    "created_at": "2019-03-19T21:28:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530271",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:33'></a>Followup at #27514
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27490#issuecomment-530272",
    "user": "https://github.com/vbraun"
}
```
