...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[a0422ae](https://git.sagemath.org/sage.git/commit/?id=a0422aec4197a21cf088a75f6cf168571bb6992b)|`add SAGE_FREETYPE_PREFIX for libgd`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[a6e554f](https://git.sagemath.org/sage.git/commit/?id=a6e554f8755a08140b67ccad28f72d5c30d1d207)|`spkg-configure for libpng`|\n|[adc901c](https://git.sagemath.org/sage.git/commit/?id=adc901cdcb4ae4850a9dcc4a009add6c569903fc)|`don't check unneeded requirements for system libpng`|\n|[61daadd](https://git.sagemath.org/sage.git/commit/?id=61daadde5fdc2622f07a8e01f4343b477a6dd23a)|`a straightforward version with pkg-config only`|\n|[9eeaa56](https://git.sagemath.org/sage.git/commit/?id=9eeaa56f37f863635edd9edc02a9bfa98bc47517)|`add SAGE_FREETYPE_PREFIX for libgd`|",
...
```json
{
    "body": "<a id='comment:38'></a>\nHere are some minor updates that incorporate my review comments from earlier in this ticket, and a few other minor tweaks that seemed worth including.  Please review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|\n|[4b1850a](https://git.sagemath.org/sage.git/commit?id=4b1850a3b6cc7a8cf84e70c683c54f028f3564e8)|`For consistency's sake, set SAGE_FREETYPE_PREFIX to empty when using the system lib`|\n|[eef8a64](https://git.sagemath.org/sage.git/commit?id=eef8a646ada59e95ca08573f32349f8bb5f7da00)|`As we are updating libgd, go ahead and add an spkg-legacy-uninstall for removing old versions`|\n|[8b2cf94](https://git.sagemath.org/sage.git/commit?id=8b2cf94e4d041d0bbe4d27bf98af5c7dbbed1c59)|`Update these messages to match stylistically with the similar messages`|",
