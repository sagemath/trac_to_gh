...
```json
{
    "body": "<a id='comment:1'></a>\nLast 10 new commits:\n|                                                                                                                                          |                                                                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|\n|[4bbdf88](https://git.sagemath.org/sage.git/commit?id=4bbdf8861bd938d06abc0fa4545cd1f92fa317ec)|`Add helper function _parse_figsize in module graphics and use it in matplotlib() methods of classes Graphics and MultiGraphics`|\n|[788a53d](https://git.sagemath.org/sage.git/commit?id=788a53d8c05800efb930436572f50e600425069d)|`Add documentation in module multigraphics`|\n|[7d61e86](https://git.sagemath.org/sage.git/commit?id=7d61e86d02212d8dde7bcc68e72404d2fee5817e)|`Improve documentation of GraphicsArray`|\n|[af6d312](https://git.sagemath.org/sage.git/commit?id=af6d312b97d49316a59106246574206fecff256e)|`More documentation in classes MultiGraphics and GraphicsArray`|\n|[58b3ca3](https://git.sagemath.org/sage.git/commit?id=58b3ca39afefdabe3d490269e7559bf8875f883b)|`Completed documentation of MultiGraphics and GraphicsArray`|\n|[1bf8ad1](https://git.sagemath.org/sage.git/commit?id=1bf8ad16bd29211742090e1c1b7c54bb309abd2e)|`Small cleaning in MultiGraphics`|\n|[ccff60c](https://git.sagemath.org/sage.git/commit?id=ccff60c7fb3b4aaf554fea1b924407dd9161d84d)|`Fix some doctests after the improved computation of nrows and ncols in graphics_array`|\n|[26180ab](https://git.sagemath.org/sage.git/commit?id=26180ab93d915320eba64be8edd53b53b61dc10f)|`Some cleaning in MultiGraphics.matplotlib`|\n|[3bd6a56](https://git.sagemath.org/sage.git/commit?id=3bd6a56484edb3782c828d490246f546e3e5e7c7)|`Minor cleaning in GraphicsArray`|\n|[3a5ef55](https://git.sagemath.org/sage.git/commit?id=3a5ef55af4d104c840107f46abbcba90fa401a18)|`Change index range in GraphicsArray._add_subplot()`|",
    "created_at": "2019-05-24T12:14:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27865",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|\n|[ebebd4f](https://git.sagemath.org/sage.git/commit/?id=ebebd4fb84c0f8fc3e0dd58ef2782dbcba5aa782)|`Merge branch 'public/graphics/multi_graphics' of git://trac.sagemath.org/sage into Sage 8.8.beta7.`|\n|[af2bf46](https://git.sagemath.org/sage.git/commit/?id=af2bf46ee0fc9cc5d24a696d55f4a1af1cc45f52)|`Restore 'not tested' flag on MultiGraphics._latex_() + example of error in GraphicsArray.__getitem__()`|",
    "created_at": "2019-06-06T22:20:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27865",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[36c0f17](https://git.sagemath.org/sage.git/commit/?id=36c0f178353017ac12573ff038c40ed55a24ba2d)|`Error message valid for py3 only in a multigraphics doctest`|",
