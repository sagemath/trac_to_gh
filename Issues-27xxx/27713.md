...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[5816c4b](https://git.sagemath.org/sage.git/commit/?id=5816c4b75a1a1ed823b7eb20ba5b3de48237032c)|`Trac #27713: Include patch to pynac to fix build issue when using Cygwin's system GMP`|",
