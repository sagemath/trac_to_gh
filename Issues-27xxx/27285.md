...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356760"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356761"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356763"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424666",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424667",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424669",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356764"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356765"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356766"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424670",
    "user": "https://github.com/embray"
}
```
