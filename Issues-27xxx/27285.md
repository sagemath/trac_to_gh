...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27285#issuecomment-525736",
...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[d3fd999](https://git.sagemath.org/sage.git/commit/?id=d3fd999ae78daf7ad0fb645b8531d6c880e56824)|`Code concerned by the ticket`|",
    "created_at": "2019-02-15T07:35:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27285#issuecomment-525737",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27285#issuecomment-525738",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27285#issuecomment-525739",
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27285#event-67729"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27285#event-67730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27285#issuecomment-525740",
    "user": "https://github.com/embray"
}
```
