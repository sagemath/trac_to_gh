...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356756"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356757"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356758"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-356759"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424671",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424672",
    "user": "https://github.com/embray"
}
```
