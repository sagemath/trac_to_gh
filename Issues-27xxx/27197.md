...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/27197",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382788",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "One reason to suspect Cygwin is that the processes that get stuck are *really* stuck and unkillable through Cygwin.  They no longer respond to signals including SIGKILL.  Though this can also happen sometimes in multithreading deadlocks.",
    "created_at": "2019-03-07T09:26:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382789",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Yep. This looks almost exactly like a reprise of #27213.  It's bizarre though--this shouldn't be happening.",
    "created_at": "2019-03-07T10:50:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382791",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "*facepalm* it just occurred to me that the fix from #27256 was incorrect/insufficient.  I didn't realize that there is an earlier call to `sdh_make` inside an `if` statement, and that the latter call (the one I actually fixed) is only run if the first one fails--it retries then with a more generic target.\n\nTesting now...",
    "created_at": "2019-03-07T11:08:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382792",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Just looking at the logs from my last rebuild of OpenBLAS on the buildbot, I can see that `USE_TLS` was not defined when compiling the module it's relevant to, so this definitely has to be it.  What a pain!",
    "created_at": "2019-03-07T11:13:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382793",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Quite possibly related but not sure: #27509. There is actually a fairly severe memory leak in OpenBLAS on Cygwin.  The conditions that cause this leak (e.g. numerous interleaved multi-threaded BLAS operations and forking off subprocesses) are especially prevalent in the plot3d docs where docbuild was most frequently hanging.",
    "created_at": "2019-03-19T09:18:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382797",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382798",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27197#event-68138"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27197#event-68139"
}
```
...
```json
{
    "body": "This can be closed.  I haven't had an particular docbuild issues on Cygwin in a while, related to OpenBLAS or otherwise.  Also the new doctest forker code that has since been added is more robust against hangs.\n\nThe buildbot this references hasn't been running in some time either.",
    "created_at": "2021-03-10T15:25:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27197#issuecomment-382799",
    "user": "https://github.com/embray"
}
```
