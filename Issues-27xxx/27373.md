...
```json
{
    "body": "Replying to [@dimpase](https://github.com/sagemath/sage/issues/27373#comment:0):\n> `$SAGE_LOCAL/bin/sage-env-config` must get updated after, say, `sage -i mpir`\n\nCan you explain why?",
...
Replying to [@dimpase](https://github.com/sagemath/sage/issues/27373#comment:0):
> `$SAGE_LOCAL/bin/sage-env-config` must get updated after, say, `sage -i mpir`
