...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357401"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425575",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425576",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425577",
...
archive/issue_events_357405.json:
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357405"
}
```
...
archive/issue_events_357406.json:
```json
{
    "actor": "https://github.com/embray",
    "created_at": "2019-03-25T10:56:15Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357406"
}
```
...
archive/issue_events_357407.json:
```json
{
    "actor": "https://github.com/embray",
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-357407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425578",
    "user": "https://github.com/embray"
}
```
