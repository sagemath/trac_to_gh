...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523823",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I see.  It's GAP/libgap that's making that allocation.  Something to look into later...",
    "created_at": "2019-02-04T11:51:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523825",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>I see.  It's GAP/libgap that's making that allocation.  Something to look into later...
...
```json
{
    "body": "<a id='comment:5'></a>To finish off on the memory issue I opened #27214.  As one final point on that, I temporarily tried setting the initial memory allocation in GAP to 0.  I'm not exactly clear on what it does in this case, but it did seem to cause it to limit GAP to only allocating as much memory as it needed at a minimum (possibly at some performance cost).\n\nThis also had no effect on the original issue that this ticket was opened for.  The test still hangs at exactly the same point.",
    "created_at": "2019-02-04T12:29:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523826",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>To finish off on the memory issue I opened #27214.  As one final point on that, I temporarily tried setting the initial memory allocation in GAP to 0.  I'm not exactly clear on what it does in this case, but it did seem to cause it to limit GAP to only allocating as much memory as it needed at a minimum (possibly at some performance cost).
...
```json
{
    "body": "<a id='comment:6'></a>Oops, gotta love that early 2000s web.",
    "created_at": "2019-02-04T12:30:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523827",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>Oops, gotta love that early 2000s web.
...
```json
{
    "body": "<a id='comment:7'></a>Bizarrely, if I run the test with `./sage -t --debug` it does not hang.",
    "created_at": "2019-02-04T13:17:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523828",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>Bizarrely, if I run the test with `./sage -t --debug` it does not hang.
...
```json
{
    "body": "<a id='comment:9'></a>Okay, 262144 = 256KB is the default size of \"arenas\" for object pools in the python memory allocator (something I've studied before but not in many years).  Regardless, that means there's nothing really special about this mmap either.  The hang might actually be happening somewhere else just after this...",
    "created_at": "2019-02-04T13:51:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523830",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Okay, 262144 = 256KB is the default size of "arenas" for object pools in the python memory allocator (something I've studied before but not in many years).  Regardless, that means there's nothing really special about this mmap either.  The hang might actually be happening somewhere else just after this...
...
```json
{
    "body": "<a id='comment:10'></a>So what's the relation between this ticket and #27214? Is it the same issue?",
    "created_at": "2019-02-05T12:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523831",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>So what's the relation between this ticket and #27214? Is it the same issue?
...
```json
{
    "body": "<a id='comment:11'></a>Git bisect narrowed it down to this commit: https://github.com/xianyi/OpenBLAS/commit/1ad1e79062d40cc9445e5c2098e15b8c45081a75\n\nI think this may be partly coincidental, but it does suggest that the problem has something to do with the \"new TLS code\".  I haven't looked closely into what that is yet though I'm aware it exists: there is some code using TLS for *something* though I'm not sure exactly what, and it looks like it might be a bit of a mess.",
    "created_at": "2019-02-05T12:42:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523832",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>Git bisect narrowed it down to this commit: https://github.com/xianyi/OpenBLAS/commit/1ad1e79062d40cc9445e5c2098e15b8c45081a75
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523833",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523834",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Well this is disconcerting.  A clean build of v0.3.5 *with* `USE_SIMPLE_THREADED_LEVEL3=1` does not appear to have fixed the problem.",
    "created_at": "2019-02-06T16:19:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523836",
    "user": "https://github.com/embray"
}
```

<a id='comment:14'></a>Well this is disconcerting.  A clean build of v0.3.5 *with* `USE_SIMPLE_THREADED_LEVEL3=1` does not appear to have fixed the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523837",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523838",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523839",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27213#event-67568"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I believe this is fixed with #27256.  There's a clear and repeatable pattern of having terrible hangs without this fix which go away with this fix.",
    "created_at": "2019-03-05T11:11:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27213#issuecomment-523840",
    "user": "https://github.com/embray"
}
```

<a id='comment:16'></a>I believe this is fixed with #27256.  There's a clear and repeatable pattern of having terrible hangs without this fix which go away with this fix.
