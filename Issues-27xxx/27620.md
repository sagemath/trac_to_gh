...
```json
{
    "body": "<a id='comment:1'></a>Please check #27464. We are now using \n\n```\nfrom libcpp.queue cimport priority_queue\nfrom libcpp.pair cimport pair\n```",
    "created_at": "2019-04-08T09:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27620#issuecomment-533084",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:1'></a>Please check #27464. We are now using 
...
```json
{
    "body": "<a id='comment:2'></a>Priority queue in c++ implements Binomial heap which gives complexity of:\n\n```\nAlgorithm      Average\tWorst case\nSpace\t\tO(n)\t        O(n)\nSearch\t\tO(n)\t        O(n)\nInsert\t\tO(1)\t        O(log n)\nDelete\t\tO(log n)        O(log n)\nPeek\t\tO(1)\t        O(1)  \n```\nwhereas \nFibonacci Heap  reduces complexity Insertion and Decrease key\n\n```\nAlgorithm      Average\t\nInsert\t\t\u0398(1)\t\nFind-min\t\u0398(1)\t \nDelete-min\tO(log n)\t \nDecrease-key\t\u0398(1)\t \nMerge\t\t\u0398(1)\n```",
    "created_at": "2019-04-09T21:22:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27620#issuecomment-533085",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:2'></a>Priority queue in c++ implements Binomial heap which gives complexity of:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27620#issuecomment-533086",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27620#issuecomment-533087",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>You can give it a try.",
    "created_at": "2019-04-10T09:15:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27620#issuecomment-533088",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:5'></a>You can give it a try.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27620#issuecomment-533089",
