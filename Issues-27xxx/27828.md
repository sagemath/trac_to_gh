...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27828#event-363540"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27828#event-363541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27828#event-363542"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27828#issuecomment-434929",
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27828#event-363543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27828#issuecomment-434930",
    "user": "https://github.com/embray"
}
```
