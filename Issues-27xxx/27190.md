...
```
In many (all?) of the combinatorial Hopf algebras implemented in [SageMath](../wikis/SageMath), using the `__call__` method of a basis can be used:
* to convert from other bases;
* coerce from other algebras;
* create a basis vector from an element of the indexing set.
