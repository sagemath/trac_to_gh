...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-354259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27095#issuecomment-420847",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27095#issuecomment-420848",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-354260"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-354261"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-354262"
}
```
