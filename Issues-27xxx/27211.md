...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27211#event-355689"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27211#event-355690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27211#event-355691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27211#event-355692"
}
```
...
```json
{
    "body": "Changed keywords from **** to **simplicial complex**",
    "created_at": "2019-02-05T16:14:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/27211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27211#issuecomment-422927",
    "user": "https://github.com/darijgr"
}
```

Changed keywords from **** to **simplicial complex**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27211#issuecomment-422928",
