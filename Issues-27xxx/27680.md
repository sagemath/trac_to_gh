...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27680#issuecomment-431851",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27680#issuecomment-431852",
    "user": "https://github.com/sagetrac-gitlab-bot"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27680#event-361614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27680#event-361615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27680#event-361616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27680",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27680#event-361617"
}
```
