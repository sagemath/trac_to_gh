...
<a id='comment:3'></a>I am not quite in favor of these changes:
...
<a id='comment:4'></a>grepping `__split_local_cover`
shows that is is either a quadratic form 
or an Integer. The change mentioned should be safe.
...
```json
{
    "body": "<a id='comment:6'></a>some fixes as suggested",
...
<a id='comment:6'></a>some fixes as suggested
