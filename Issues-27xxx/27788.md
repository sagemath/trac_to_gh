...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27788#issuecomment-537115",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27788#issuecomment-537116",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This should be easily resolved by implementing `__format__` on the relevant types.  This might be a good beginner project.",
    "created_at": "2020-08-31T16:41:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27788#issuecomment-537117",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>This should be easily resolved by implementing `__format__` on the relevant types.  This might be a good beginner project.
