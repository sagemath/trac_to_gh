...
```json
{
    "body": "<a id='comment:1'></a>\nStill confirming that the updated test works on Python 3, but I believe it will.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[a6bc173](https://git.sagemath.org/sage.git/commit?id=a6bc173a66694b6c914932c7c5b15dacdf9309e1)|`Trac #27359: Rewrite this test to use a temp file instead of risk`|",
    "created_at": "2019-02-26T11:25:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27359",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[a971864](https://git.sagemath.org/sage.git/commit/?id=a971864aec5d477b02266c92a71be8e7fa1f53ff)|`Trac #27359: Rewrite this test to use a temp file instead of risk`|\n|[87bc817](https://git.sagemath.org/sage.git/commit/?id=87bc8177ff587434d61c05a4889e89aecdc29f74)|`trivial: change argument name in this function to not shadow the `dir` builtin`|",
    "created_at": "2019-02-26T12:14:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27359",
    "type": "issue_comment",
