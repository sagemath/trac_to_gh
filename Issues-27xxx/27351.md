...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[cee2894](https://git.sagemath.org/sage.git/commit/?id=cee28946b4a3eb8439bca86fbb75acfca3bd9773)|`m4/sage_spkg_collect.m4: Fixup`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|\n|[9a8f693](https://git.sagemath.org/sage.git/commit/?id=9a8f69363cb95def900d387caa7810fa6fb0f8a1)|`Merge tag '9.1.beta7' into t/27351/at_end_of_configure__suggest_a_list_of_system_packages_to_install`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[35e1e7d](https://git.sagemath.org/sage.git/commit/?id=35e1e7d50ffa9ce488fddd85afcb330e187ae752)|`Add missing file build/bin/sage-get-system-packages`|",
