...
<a id='comment:30'></a>Replying to [embray](#comment%3A28):
> It seems like this would also be able to benefit from #27641.  In this case you would want to add the bits that set
> 
> 
> ```
...
<a id='comment:46'></a>Replying to [dimpase](#comment%3A32):
> Please remove the configure bump from this branch, while you're at it.
...
<a id='comment:47'></a>Replying to [embray](#comment%3A46):
> Replying to [dimpase](#comment%3A32):
> > Please remove the configure bump from this branch, while you're at it.
...
<a id='comment:55'></a>Replying to [git](#comment%3A53):
> Branch pushed to git repo; I updated commit sha1. New commits:
> |                                                                                                                                           |                                                       |
> |-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|
> |[1948e33](https://git.sagemath.org/sage.git/commit/?id=1948e335c3b5c447c674c8ec27c49f6472556ecf)|`Add one missing SAGE_CONFIGURE_MPFR, for building gcc`|
...
```json
{
    "body": "<a id='comment:66'></a>The[comment:63](#comment%3A63) did say this should not be merged on its own, didn't?",
...
<a id='comment:66'></a>The[comment:63](#comment%3A63) did say this should not be merged on its own, didn't?
