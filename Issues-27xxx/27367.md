...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27367#event-357800"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27367#event-357801"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27367#event-357802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27367#event-357803"
}
```
...
```json
{
    "body": "Changed keywords from **** to **upgrade, mpfrcx**",
    "created_at": "2019-02-27T12:00:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/27367",
    "type": "issue_comment",
...
Changed keywords from **** to **upgrade, mpfrcx**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27367#issuecomment-426230",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27367#issuecomment-426231",
    "user": "https://github.com/embray"
}
```
