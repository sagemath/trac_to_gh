...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[884e9da](https://git.sagemath.org/sage.git/commit?id=884e9da55b7e425a5f567b0ad0cf1e8610f1664d)|`isl patch is in gcc-9`|\n|[a11398e](https://git.sagemath.org/sage.git/commit?id=a11398edecc15a435e3794fae91c91005d24013c)|`Disable isl when building gcc to avoid inconsistently building gcc with sage's optional isl package. See also #26735.`|\n|[2d6dc98](https://git.sagemath.org/sage.git/commit?id=2d6dc9824489722fba9dab1f6d74baa6322f9a43)|`Update gcc to the 9-20190414 snapshot`|\n|[6a54ee1](https://git.sagemath.org/sage.git/commit?id=6a54ee185d83bdf29877d6fc6ec6a54236812bc6)|`Update OpenBLAS to 2019/04/14`|",
