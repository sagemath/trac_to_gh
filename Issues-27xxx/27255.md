...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27255#issuecomment-379907",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This might be fixed by #25558 (which is work in progress).",
    "created_at": "2019-02-11T22:06:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27255#issuecomment-379908",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>This might be fixed by #25558 (which is work in progress).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27255#issuecomment-379909",
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27255#event-67644"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27255#issuecomment-379910",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27255#event-67645"
}
```
