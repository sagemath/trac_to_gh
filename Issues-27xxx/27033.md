...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[f1dccbf](https://git.sagemath.org/sage.git/commit/?id=f1dccbfbfe27d1ec4523aa470e27a635fa03d588)|`Make relabel() of DynkinDiagram more compatible with GenericGraph`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[f360ac0](https://git.sagemath.org/sage.git/commit/?id=f360ac0a9d46afafd6c76cd3625bac0ba19633e9)|`Make relabel() of DynkinDiagram more compatible with GenericGraph`|",
