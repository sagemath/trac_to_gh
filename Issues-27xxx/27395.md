...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358136"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426644",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426645",
    "user": "https://github.com/slel"
}
```
