...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358140"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426635",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426636",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426637",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426638",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27395#event-358147"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426639",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426640",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "Changed keywords from **** to **genus2red, cypari2**",
    "created_at": "2019-03-04T16:07:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426641",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **genus2red, cypari2**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426642",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27395#issuecomment-426643",
    "user": "https://github.com/slel"
}
```
