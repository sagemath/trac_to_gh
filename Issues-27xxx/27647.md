...
```json
{
    "body": "<a id='comment:5'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                           |                                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|\n|[9aa119a](https://github.com/sagemath/sagetrac-mirror/commit/9aa119a22277320a3053b99cadbb8ea76d94991a)|<code>Added the parameter `closed` to `.neighbors` as well and added an INPU block in the docstrings.</code>|",
