...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[d8830e7](https://git.sagemath.org/sage.git/commit?id=d8830e7133893ca8212d12e4efb2b93c2adebc9f)|`an iterator, slightly faster than the original`|",
    "created_at": "2019-02-01T00:01:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27195",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[bdac73c](https://git.sagemath.org/sage.git/commit/?id=bdac73c1aafb96c06521cca25d2c3ec1fd4e7220)|`optimize check for being highest weight`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[ac5924a](https://git.sagemath.org/sage.git/commit/?id=ac5924afc301faa290665bdfdd6f656735da0b9f)|`remove superfluous assignment`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[83036ef](https://git.sagemath.org/sage.git/commit/?id=83036ef26d19352b6f15bcb88dc52a5b2f65f3a9)|`remove unnecessary duplication of index set, better names`|",
    "created_at": "2019-02-01T18:34:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27195",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[8e2ab93](https://git.sagemath.org/sage.git/commit/?id=8e2ab9386795b40182e6789a72b7904212b31165)|`avoid unnecessary computations of phi`|",
    "created_at": "2019-02-02T20:52:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27195",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:49'></a>\nUsing a modified version from your[comment:38](#comment%3A38), I now get\n\n```\nsage: n = 3; C = crystals.Spins([\"B\", n])\nsage: r = 10; T = crystals.TensorProduct(*([C]*r))\nsage: %time len(T.highest_weight_vectors())\nCPU times: user 2.11 s, sys: 31.5 ms, total: 2.14 s\nWall time: 2.14 s\n731808\n```\nvs your branch:\n\n```\nCPU times: user 2.38 s, sys: 35.7 ms, total: 2.42 s\nWall time: 2.42 s\n731808\n```\nIf I cut out storing each of the crystal factors in memory, I get roughly a 2x slowdown. However, I figure most crystals will be \"small\" so this is okay.\n\nI also now better handle the infinite crystal case.\n\nSo if my changes are okay, then positive review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[5f8dc0a](https://git.sagemath.org/sage.git/commit?id=5f8dc0aaba6ff1df02e9cb6468c9f16617eaf6d0)|`Merge branch 'u/mantepse/slightly_faster_highest_weight_vectors_iterator' of git://trac.sagemath.org/sage into public/crystals/faster_highest_weight_vectors-27195`|\n|[7787b92](https://git.sagemath.org/sage.git/commit?id=7787b92a51e616e60a29d4d4e455dabeb019522f)|`Getting some extra speed out for tensor products of regular crystals.`|",
    "created_at": "2019-11-06T02:48:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27195",
    "type": "issue_comment",
