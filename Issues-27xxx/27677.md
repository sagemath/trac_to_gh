...
```json
{
    "body": "<a id='comment:1'></a>`build-from-clean` is only called very rarely so it's not that important when looking at runtime. I guess that using system provided libraries might make the resulting image a bit smaller.\n\nIn any case, I agree that building everything from scratch is what the buildbots are good for. So removing things from build-from-clean appears to be a good idea.",
    "created_at": "2019-04-16T15:01:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386418",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:1'></a>`build-from-clean` is only called very rarely so it's not that important when looking at runtime. I guess that using system provided libraries might make the resulting image a bit smaller.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386419",
...
```json
{
    "body": "<a id='comment:3'></a>Not *that* rarely though, and it will still save significant time in the long term.\n\nI don't think it will make images *much* smaller, but certainly a little bit.",
    "created_at": "2019-04-16T15:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386420",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>Not *that* rarely though, and it will still save significant time in the long term.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386421",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>If I understand correctly one problem we're having in the docker builds is that when running `make build` in the `sagemath/sagemath-dev` image more and more stuff over time has been getting rebuilt.\n\nThis seems to be directly related to #27330, as the packages getting rebuilt in the docker image are those that can now be used from the system.  So it seems like, possibly, there is a bug (either in the build system, or in the Dockerfiles) causing these packages to be rebuilt (even if they were already built rather than using the system copies).  Strange.\n\nI think probably just using the system packages in the first place would avoid this, but that's not entirely clear either.",
    "created_at": "2019-06-25T12:53:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386422",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>If I understand correctly one problem we're having in the docker builds is that when running `make build` in the `sagemath/sagemath-dev` image more and more stuff over time has been getting rebuilt.
...
```json
{
    "body": "<a id='comment:6'></a>embray: Last time I checked it was not packages being rebuilt but only documentation (rebuilds though no dependency appears to have changed.)",
    "created_at": "2019-06-25T12:57:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386423",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:6'></a>embray: Last time I checked it was not packages being rebuilt but only documentation (rebuilds though no dependency appears to have changed.)
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68656"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68657"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68658"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68659"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27677#issuecomment-386424",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68661"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68662"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68663"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68664"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68665"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68666"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68667"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27677#event-68668"
}
```
