...
```json
{
    "body": "<a id='comment:2'></a>`@`nbruin thanks for verification! \nI am using `isqrt` now and it works fine. I just wanted to report this peculiar memory leak as it took a while to locate it.",
    "created_at": "2019-02-01T15:37:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27185#issuecomment-522984",
    "user": "https://github.com/ph4r05"
}
```

<a id='comment:2'></a>`@`nbruin thanks for verification! 
I am using `isqrt` now and it works fine. I just wanted to report this peculiar memory leak as it took a while to locate it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27185#issuecomment-522985",
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27185#event-67486"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27185#issuecomment-522986",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27185#event-67487"
}
```
