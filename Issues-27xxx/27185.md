...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355338"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355339"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422375",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422376",
    "user": "https://github.com/ph4r05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422377",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355342"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422378",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355344"
}
```
