...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422374",
    "user": "https://github.com/ph4r05"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355346"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355347"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-355348"
}
```
