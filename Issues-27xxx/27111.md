...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27111#issuecomment-422514",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27111#event-243693"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27111#event-243694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27111#issuecomment-422515",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27111#event-243695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27111#issuecomment-422516",
    "user": "https://github.com/kevinywlui"
}
```
