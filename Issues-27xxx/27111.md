...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27111#issuecomment-420900",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27111#event-239414"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27111#event-239415"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27111#issuecomment-420901",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27111#event-239416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27111#issuecomment-420902",
    "user": "https://github.com/kevinywlui"
}
```
