...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[96b8150](https://git.sagemath.org/sage.git/commit?id=96b815023ed635532ec72d02e49c99afb76fa42f)|`more algorithm for coxeter_smith_form in posets`|",
    "created_at": "2019-03-06T08:39:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27430",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[5dcd3cd](https://git.sagemath.org/sage.git/commit/?id=5dcd3cd304b94e70dc936f3a9cc22e8c2d37ee3a)|`trac 27430 some details`|",
    "created_at": "2019-03-06T13:52:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27430",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nIs this a working branch or what ?\n\nNota bene: If you do not make a comment, I do not see the change of branch.\n\n---\nNew commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[6a548d9](https://git.sagemath.org/sage.git/commit?id=6a548d9b162a2b1c29d2eed51028c8e3cde72c32)|`tentative code for friacs algorithm in posets`|\n|[aa07710](https://git.sagemath.org/sage.git/commit?id=aa07710ce924921675135496cf7faa1f8f62992e)|`tweak fricas code so variables don't leak`|",
    "created_at": "2019-03-11T19:05:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27430",
    "type": "issue_comment",
