...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349819"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349821"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349822"
}
```
...
```json
{
    "body": "Changed keywords from **** to **julia**",
    "created_at": "2019-11-17T22:46:28Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/27762",
    "type": "issue_comment",
...
Changed keywords from **** to **julia**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349823"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349824"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27762#issuecomment-433663",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27762#issuecomment-433664",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349826"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349827"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27762#event-349828"
}
```
