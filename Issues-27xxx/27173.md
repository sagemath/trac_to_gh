...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27173#event-355230"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27173#event-355231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27173#event-355232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27173#event-355233"
}
```
...
```json
{
    "body": "Changed keywords from **** to **dependencies**",
    "created_at": "2019-01-30T09:40:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/27173",
    "type": "issue_comment",
...
Changed keywords from **** to **dependencies**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27173#issuecomment-422293",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27173#issuecomment-422294",
