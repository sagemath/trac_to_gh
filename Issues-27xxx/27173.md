...
Replying to [@jdemeyer](https://github.com/sagemath/sage/issues/27173#comment:0):
> The fix is simple: rebuilding `p_group_cohomology` is sufficient 
