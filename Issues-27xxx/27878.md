...
```json
{
    "body": "<a id='comment:2'></a>\nTrivial change.\n\n---\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[8958e4d](https://git.sagemath.org/sage.git/commit?id=8958e4dcc53243d2702615482c30c82400a6b5ca)|`remove extraneous -r from gap_cmd`|",
    "created_at": "2019-05-28T01:11:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nOK wanting some feedback on this. So I still make the default to be run without `-r` but I introduce an option `no_dotgap` which default to `False` to enable it. I also fixed the doctest that triggered the issue in the first place so that `~/.gap` is always ignored in that test.\n\n---\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[8958e4d](https://git.sagemath.org/sage.git/commit?id=8958e4dcc53243d2702615482c30c82400a6b5ca)|`remove extraneous -r from gap_cmd`|\n|[cab2211](https://git.sagemath.org/sage.git/commit?id=cab2211040528270ec93f3505fdfbb920fcda76f)|`Add an option to restore -r and document it`|\n|[474b365](https://git.sagemath.org/sage.git/commit?id=474b3657371e9334cbdafbbdf6763a032c89a9f2)|`Make the all_installed_package test ignore .gap content.`|",
