...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539347",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539348",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539349",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539350",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Trivial change.\n\n---\nNew commits:",
    "created_at": "2019-05-28T01:11:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539351",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>Trivial change.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539352",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539353",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539355",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539356",
...
```json
{
    "body": "<a id='comment:5'></a>I don't quite understand the intention behind this change.  When using the pexpect interface to GAP, which much of Sage still (sadly) relies on (I am making progress fixing that) we *want* the `-r` flag because we *don't* want random stuff a user might have in their `~/.gap` interfering with Sage functionality.",
    "created_at": "2019-05-31T15:41:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539357",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539358",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>ISTM the problem is not that we pass `-r` in the pexpect interface, but that we *aren't* passing `-r` to the libgap interface.",
    "created_at": "2019-05-31T15:48:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539359",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>ISTM the problem is not that we pass `-r` in the pexpect interface, but that we *aren't* passing `-r` to the libgap interface.
...
```json
{
    "body": "<a id='comment:7'></a>My problem with putting `-r` is that we are removing some capabilities from `gap`. Of course for other packages where the user can make changes the custom space is moved, usually by environment variables, to `.sage`. And we aren't quite able to do that with gap. Anyway the big concern is for protect the user from themselves and limit our debugging. I am not in favor of protecting the user from themselves to that degree, but we should have a way to a safe mode for debugging..",
    "created_at": "2019-05-31T19:58:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539360",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:7'></a>My problem with putting `-r` is that we are removing some capabilities from `gap`. Of course for other packages where the user can make changes the custom space is moved, usually by environment variables, to `.sage`. And we aren't quite able to do that with gap. Anyway the big concern is for protect the user from themselves and limit our debugging. I am not in favor of protecting the user from themselves to that degree, but we should have a way to a safe mode for debugging..
...
```json
{
    "body": "<a id='comment:8'></a>Indeed, as a user, I would be annoyed if I could not use from Sage the GAP packages I installed in my gap directory (e.g. by GAP's PackageManager). The GAP devs have decided to include the user's .gap directory by default; I would tend to follow that decision to have a GAP that's as close as possible from a normal gap.\n\nThat being said, maybe we should indeed set -r whenever running Sage's test, to make them less context-dependent? With the annoying side effect that behavior may change between tests and normal usage.",
    "created_at": "2019-06-01T05:05:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539361",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:8'></a>Indeed, as a user, I would be annoyed if I could not use from Sage the GAP packages I installed in my gap directory (e.g. by GAP's PackageManager). The GAP devs have decided to include the user's .gap directory by default; I would tend to follow that decision to have a GAP that's as close as possible from a normal gap.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27878#event-69119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539362",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539363",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539364",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539365",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27878#event-69120"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539366",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539367",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>In any case, while this clearly needs to be discussed further the right answer is definitely *not* to just disable use of `-r` completely, as that is only likely to break more things when testing.\n\nI agree with nthiery that one way or other ignoring the user's `.gap` should *definitely* be the default when running the test suite.  The rest is debatable.",
    "created_at": "2019-06-03T06:32:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539369",
    "user": "https://github.com/embray"
}
```

<a id='comment:13'></a>In any case, while this clearly needs to be discussed further the right answer is definitely *not* to just disable use of `-r` completely, as that is only likely to break more things when testing.
...
```json
{
    "body": "<a id='comment:15'></a>We may want to have an option to inject `-r` for diagnostics. Which to my mind is one of its use. It gives you a rescue mode. If things works once you enter that mode then you know you messed up your `.gap` folder.\n\ngap is behaving a bit differently than say `R` where you have to explicitly load packages rather than them being loaded, mostly, on presence. This is more of a question for upstream I guess.",
    "created_at": "2019-06-03T22:59:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539371",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:15'></a>We may want to have an option to inject `-r` for diagnostics. Which to my mind is one of its use. It gives you a rescue mode. If things works once you enter that mode then you know you messed up your `.gap` folder.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539372",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Feedback from Alex and Michael: it used to be that GAP package authors could control whether their package was loaded automatically, and many if not most did. Nowadays, the normal behavior is not to autoload (like in e.g. Python or R), unless GAP core or some other autoloaded package requires it. So most recent packages don't autoload. But many old packages still autoload, for backward compatibility.",
    "created_at": "2019-06-04T19:45:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539373",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:17'></a>Feedback from Alex and Michael: it used to be that GAP package authors could control whether their package was loaded automatically, and many if not most did. Nowadays, the normal behavior is not to autoload (like in e.g. Python or R), unless GAP core or some other autoloaded package requires it. So most recent packages don't autoload. But many old packages still autoload, for backward compatibility.
...
```json
{
    "body": "<a id='comment:18'></a>That's nice. So it we can expect things to settle down slowly on that front. We just have to bear it for a little while. So now we need a mechanism to insert `-r` on request. There is already some mechanism for some other options I think, so it should just be modeled on them.",
    "created_at": "2019-06-04T20:00:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539374",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:18'></a>That's nice. So it we can expect things to settle down slowly on that front. We just have to bear it for a little while. So now we need a mechanism to insert `-r` on request. There is already some mechanism for some other options I think, so it should just be modeled on them.
...
```json
{
    "body": "<a id='comment:19'></a>OK wanting some feedback on this. So I still make the default to be run without `-r` but I introduce an option `no_dotgap` which default to `False` to enable it. I also fixed the doctest that triggered the issue in the first place so that `~/.gap` is always ignored in that test.\n\n---\nNew commits:",
    "created_at": "2019-06-04T23:54:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539375",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:19'></a>OK wanting some feedback on this. So I still make the default to be run without `-r` but I introduce an option `no_dotgap` which default to `False` to enable it. I also fixed the doctest that triggered the issue in the first place so that `~/.gap` is always ignored in that test.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539376",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539377",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>If I had my way I would also be more aggressive about controlling exactly what GAP packages are loaded by the GAP interpreter used by Sage, because my experience has been that random GAP packages being loaded can lead to *very* difficult to trace bugs or differences in results.",
    "created_at": "2019-06-07T09:00:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539381",
    "user": "https://github.com/embray"
}
```

<a id='comment:23'></a>If I had my way I would also be more aggressive about controlling exactly what GAP packages are loaded by the GAP interpreter used by Sage, because my experience has been that random GAP packages being loaded can lead to *very* difficult to trace bugs or differences in results.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539383",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539384",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539385",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>I am trying to answer too fast. I see you are trying to avoid negative settings and I can understand that. I guess we just have to bear the negative use internally.",
    "created_at": "2019-06-07T09:20:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539386",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:28'></a>I am trying to answer too fast. I see you are trying to avoid negative settings and I can understand that. I guess we just have to bear the negative use internally.
...
```json
{
    "body": "<a id='comment:29'></a>I am testing an alternative based on my comments.",
    "created_at": "2019-06-07T09:33:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539387",
    "user": "https://github.com/embray"
}
```

<a id='comment:29'></a>I am testing an alternative based on my comments.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539388",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>The other complication to this that I haven't addressed yet is that GAP should probably also load a different workspace (if any) for when it's running with or without the .gap directory loaded, or this could lead to even more confusing inconsistencies :/\n\nPerhaps the arguments passed when starting GAP should be hashed into the hash in the workspace filename, or something?  I'm not confident about this part as I still don't fully understand how GAP workspaces work (just enough to know that they can definitely be influenced heavily by what pakages and globals are loaded).",
    "created_at": "2019-06-07T09:51:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539390",
    "user": "https://github.com/embray"
}
```

<a id='comment:32'></a>The other complication to this that I haven't addressed yet is that GAP should probably also load a different workspace (if any) for when it's running with or without the .gap directory loaded, or this could lead to even more confusing inconsistencies :/
...
```json
{
    "body": "<a id='comment:34'></a>All right. I think it is also important to have the doctest that started it all to be fixed quickly.",
    "created_at": "2019-06-10T23:41:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539392",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:34'></a>All right. I think it is also important to have the doctest that started it all to be fixed quickly.
...
```json
{
    "body": "<a id='comment:36'></a>the sooneer a complete switch to libgap happens in sagelib, the better.\n\nI don't quite understand what \"pass gap objects efficiently from internal code to user code\" means here. IMHO this all fine in libgap, no?",
    "created_at": "2019-06-11T08:26:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539394",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:36'></a>the sooneer a complete switch to libgap happens in sagelib, the better.
...
```json
{
    "body": "<a id='comment:38'></a>I'm not sure many instances of libgap loaded as python extensions are technically feasible; this seem to mean that one would have to mangle names in the dlls to avoid clashes etc.\n\nWhat might be feasible are several libgap workspaces.",
    "created_at": "2019-06-11T22:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539396",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:38'></a>I'm not sure many instances of libgap loaded as python extensions are technically feasible; this seem to mean that one would have to mangle names in the dlls to avoid clashes etc.
...
```json
{
    "body": "<a id='comment:39'></a>Tickets still needing working or clarification should be moved to the next release milestone at the soonest (please feel free to revert if you think the ticket is close to being resolved).",
    "created_at": "2019-06-14T14:50:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539397",
    "user": "https://github.com/embray"
}
```

<a id='comment:39'></a>Tickets still needing working or clarification should be moved to the next release milestone at the soonest (please feel free to revert if you think the ticket is close to being resolved).
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27878#event-69121"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>I am opening a new ticket to fix the doctest in `gap_packages` under all scenario #28233. Let's keep this ticket for the serious stuff about how we are supposed to run gap.",
    "created_at": "2019-07-23T02:11:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27878#issuecomment-539398",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:40'></a>I am opening a new ticket to fix the doctest in `gap_packages` under all scenario #28233. Let's keep this ticket for the serious stuff about how we are supposed to run gap.
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27878#event-69122"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27878#event-69123"
}
```
