...
```json
{
    "body": "<a id='comment:2'></a>green bot, please review this simple change",
...
<a id='comment:2'></a>green bot, please review this simple change
...
<a id='comment:3'></a>This fixes one doctest in interfaces, but not the last one, at least not for me. I still see
...
```json
{
    "body": "<a id='comment:4'></a>One needs to replace `msg[0]` by `msg.args[0]`. Let me do that.",
...
<a id='comment:4'></a>One needs to replace `msg[0]` by `msg.args[0]`. Let me do that.
...
```json
{
    "body": "<a id='comment:6'></a>works for me. Please check if it works for you.",
...
<a id='comment:6'></a>works for me. Please check if it works for you.
...
```json
{
    "body": "<a id='comment:7'></a>Thank you, works with Python 2 and 3.",
    "created_at": "2019-05-31T20:29:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27904",
    "type": "issue_comment",
...
<a id='comment:7'></a>Thank you, works with Python 2 and 3.
