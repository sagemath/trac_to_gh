...
```json
{
    "body": "The branch is not clean, but it is mixed up with another branch.",
...
```json
{
    "body": "A minor issue: remove the `.` at the end of `'vertex (%s) not in the graph.'` and of course in the doctest.\n\nThis is [PEP8](https://www.python.org/dev/peps/pep-0008/).",
