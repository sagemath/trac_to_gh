...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538626",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538627",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538628",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538629",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>A good general rule that you should follow is to not overwrite `__call__`. Instead, the typical thing to do is implement an `_act_on_` (or `_acted_upon_`), and let the coercion framework handle the dispatching.",
    "created_at": "2019-05-26T23:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538630",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>A good general rule that you should follow is to not overwrite `__call__`. Instead, the typical thing to do is implement an `_act_on_` (or `_acted_upon_`), and let the coercion framework handle the dispatching.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538631",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Ah, I see. I saw act in the ticket and was thinking it should behave like a normal action (and be written with a binary operation such as multiplication). So sorry about that noise there. I guess this is fine since it is done on an element and not a parent. (As a side note, it is actually `__call__` that starts the dispatch to the coercion framework, not something that is dealt out from it.)\n\nOnly other thing you need to address is changing `EXAMPLES::` -> `EXAMPLES:` to get a positive review.",
    "created_at": "2019-05-28T13:19:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538632",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>Ah, I see. I saw act in the ticket and was thinking it should behave like a normal action (and be written with a binary operation such as multiplication). So sorry about that noise there. I guess this is fine since it is done on an element and not a parent. (As a side note, it is actually `__call__` that starts the dispatch to the coercion framework, not something that is dealt out from it.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538633",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538634",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538635",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538636",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538637",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538638",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538639",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538640",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538641",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27856#event-69051"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27856#issuecomment-538642",
    "user": "https://github.com/vbraun"
}
```
