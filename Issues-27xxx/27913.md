...
```json
{
    "body": "<a id='comment:1'></a>Duplicate of #27878 really.",
...
<a id='comment:1'></a>Duplicate of #27878 really.
...
```json
{
    "body": "<a id='comment:2'></a>Thanks Fran\u00e7ois for the super-fast pointer!",
...
<a id='comment:2'></a>Thanks François for the super-fast pointer!
...
<a id='comment:4'></a>> Make gap and libgap behave consistently, presumably by having gap include the user's .gap directory
