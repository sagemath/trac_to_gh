...
```json
{
    "body": "<a id='comment:4'></a>\nThis should fix the reported issue.\n\n---\nNew commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[7fcd8ae](https://git.sagemath.org/sage.git/commit?id=7fcd8ae3fc9d8b7146e59af45dd13f9e44a28fe2)|`trac #27079: edgeless graph`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[0a9b292](https://git.sagemath.org/sage.git/commit/?id=0a9b292a92543e9c4f28c71c3ac9a48554ada2b7)|`trac #27079: empty graph`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[2996f7a](https://git.sagemath.org/sage.git/commit/?id=2996f7a3a05f6d788c80093257b3009d9d7ad82b)|`trac #27079: further improvements`|",
