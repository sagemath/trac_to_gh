...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27339#issuecomment-425595",
    "user": "https://github.com/sagetrac-mercatp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27339#issuecomment-425596",
    "user": "https://github.com/sagetrac-mercatp"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27339#event-357436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27339#event-357437"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27339#event-357438"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27339#event-357439"
}
```
