...
```json
{
    "body": "<a id='comment:3'></a>Since you seem to be able to reproduce it relatively reliably (5 runs of a single test should be cheap), couldn't you bisect between giac 1.4.9.45 and 1.5.0.37?",
    "created_at": "2019-03-04T14:28:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527906",
    "user": "https://github.com/timokau"
}
```

<a id='comment:3'></a>Since you seem to be able to reproduce it relatively reliably (5 runs of a single test should be cheap), couldn't you bisect between giac 1.4.9.45 and 1.5.0.37?
...
```json
{
    "body": "<a id='comment:7'></a>Good work! Did you try reproducing it on non-cygwin and/or plain giac without sage's interface?",
    "created_at": "2019-03-06T13:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527910",
    "user": "https://github.com/timokau"
}
```

<a id='comment:7'></a>Good work! Did you try reproducing it on non-cygwin and/or plain giac without sage's interface?
...
```json
{
    "body": "<a id='comment:8'></a>I haven't tried reproducing the problem outside of Sage, but using `giac.eval` is pretty close to just using pexpect directly, and in this case it's useful just to slam the interface with input much faster than a human could, making the deadloop more probable.\n\nI've tried to reproduce the problem in Linux but haven't been successful.  I bet it might be possible to reproduce by reducing the delay in the `usleep()` call quoted above but I'm not sure.",
    "created_at": "2019-03-06T13:48:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527911",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>I haven't tried reproducing the problem outside of Sage, but using `giac.eval` is pretty close to just using pexpect directly, and in this case it's useful just to slam the interface with input much faster than a human could, making the deadloop more probable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527912",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Temporary fix for now.  This patch only impacts Cygwin so I think it should be no problem, but I bumped the patch version for the buildbots anyways.\n\nI'd like to continue to investigate the problem when I can, but for the purposes of getting 8.7 stable on Cygwin again I think we should go ahead and use this patch since it's an easy fix.\n\n---\nNew commits:",
    "created_at": "2019-03-06T14:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527913",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>Temporary fix for now.  This patch only impacts Cygwin so I think it should be no problem, but I bumped the patch version for the buildbots anyways.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527914",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527915",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527916",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527917",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Replying to [gh-timokau](#comment%3A9):\n> Replying to [embray](#comment%3A8):\n> > I haven't tried reproducing the problem outside of Sage, but using `giac.eval` is pretty close to just using pexpect directly, and in this case it's useful just to slam the interface with input much faster than a human could, making the deadloop more probable.\n\n> \n> You should be able to do the same thing in a shell: `while :; do echo '1+1;'; done | giac`\n\n\nYep, I was able to reproduce the same problem like that too.",
    "created_at": "2019-03-06T14:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527918",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>Replying to [gh-timokau](#comment%3A9):
> Replying to [embray](#comment%3A8):
> > I haven't tried reproducing the problem outside of Sage, but using `giac.eval` is pretty close to just using pexpect directly, and in this case it's useful just to slam the interface with input much faster than a human could, making the deadloop more probable.
...
```json
{
    "body": "<a id='comment:12'></a>Sorry I can't test on cygwin, but are you able to build giacpy_sage on cygwin?\nbecause this cython interface should avoid these problems and provides the samething.",
    "created_at": "2019-03-06T15:30:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527919",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

<a id='comment:12'></a>Sorry I can't test on cygwin, but are you able to build giacpy_sage on cygwin?
because this cython interface should avoid these problems and provides the samething.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527923",
...
```json
{
    "body": "<a id='comment:16'></a>Looks good to me, modulo its working on Cygwin - something I did't test, even though I have access to a Windows 10 VM on Azure, so I potentially could.",
    "created_at": "2019-03-21T12:36:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527924",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:16'></a>Looks good to me, modulo its working on Cygwin - something I did't test, even though I have access to a Windows 10 VM on Azure, so I potentially could.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527925",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27385#event-68016"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Moving all blocker/critical issues from 8.7 to 8.8.",
    "created_at": "2019-03-25T10:41:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527927",
    "user": "https://github.com/embray"
}
```

<a id='comment:18'></a>Moving all blocker/critical issues from 8.7 to 8.8.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527928",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527929",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27385#event-68017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527930",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527933",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Did you upgrade to the latest version of giac (1.5.0-61)? I thought I fixed that 4 months ago. I'd prefer not to waste time checking again...",
    "created_at": "2019-07-03T05:08:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527934",
    "user": "https://trac.sagemath.org/admin/accounts/users/parisse"
}
```

<a id='comment:23'></a>Did you upgrade to the latest version of giac (1.5.0-61)? I thought I fixed that 4 months ago. I'd prefer not to waste time checking again...
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [parisse](#comment%3A23):\n> Did you upgrade to the latest version of giac (1.5.0-61)?\n\n\nNo.",
    "created_at": "2019-07-03T06:30:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527935",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:24'></a>Replying to [parisse](#comment%3A23):
> Did you upgrade to the latest version of giac (1.5.0-61)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27385#issuecomment-527936",
    "user": "https://github.com/dimpase"
}
```
