...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333073"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333074"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333076"
}
```
...
```json
{
    "body": "**Attachment:** [perl_cpan_polymake_prereq-2019-05-13.tar.gz.gz](https://github.com/sagemath/sage/files/ticket27763/perl_cpan_polymake_prereq-2019-05-13.tar.gz.gz)",
...
**Attachment:** [perl_cpan_polymake_prereq-2019-05-13.tar.gz.gz](https://github.com/sagemath/sage/files/ticket27763/perl_cpan_polymake_prereq-2019-05-13.tar.gz.gz)
...
```json
{
    "body": "**Attachment:** [perl_cpan_polymake_prereq-2019-05-17.tar.gz.gz](https://github.com/sagemath/sage/files/ticket27763/perl_cpan_polymake_prereq-2019-05-17.tar.gz.gz)",
...
**Attachment:** [perl_cpan_polymake_prereq-2019-05-17.tar.gz.gz](https://github.com/sagemath/sage/files/ticket27763/perl_cpan_polymake_prereq-2019-05-17.tar.gz.gz)
...
```json
{
    "body": "**Attachment:** [perl_cpan_polymake_prereq-2019-05-19.tar.gz.gz](https://github.com/sagemath/sage/files/ticket27763/perl_cpan_polymake_prereq-2019-05-19.tar.gz.gz)",
...
**Attachment:** [perl_cpan_polymake_prereq-2019-05-19.tar.gz.gz](https://github.com/sagemath/sage/files/ticket27763/perl_cpan_polymake_prereq-2019-05-19.tar.gz.gz)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333077"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333078"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333079"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333080"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333081"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333084"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333085"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333086"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333087"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333088"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333089"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333090"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333091"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333092"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333094"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333095"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333096"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333097"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27763#event-333098"
}
```
