...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[c5c4e81](https://git.sagemath.org/sage.git/commit?id=c5c4e8185d3c266e549e7b438f53417095e37330)|`Handle ETuple in coefficient()`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[a406d1e](https://git.sagemath.org/sage.git/commit/?id=a406d1ec194bac92656be1c450234b4bf2a20b92)|`Added Doctest for #27421`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[5c5fe61](https://git.sagemath.org/sage.git/commit/?id=5c5fe615439bc6dbb8f45250dace2074224e1681)|`Using ETuple directly instead of converting to list`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[db2f045](https://git.sagemath.org/sage.git/commit/?id=db2f0458b3e6b96b6d8ce032bb1d106256657dc4)|`Removed over indentation and added equivalence test`|",
    "created_at": "2019-03-11T19:30:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27421",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[f5e3eb4](https://git.sagemath.org/sage.git/commit/?id=f5e3eb47b1f08fafcc9578327eab74c84be8491c)|`Modified DocTests`|",
    "created_at": "2019-03-13T15:11:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27421",
    "type": "issue_comment",
