...
```json
{
    "body": "The change from Maxima factorization to Pynac one, which triggered the bug, was introduced in #23835, which has been merged in Sage 8.4.beta3.",
...
```json
{
    "body": "This sage-support [post](https://groups.google.com/d/msg/sage-support/tSE0z2ajwug/nHSuCX6_GQAJ) might be related...",
...
```json
{
    "body": "Would it be an option to let pynac handle factorization only when called on a rational function and call maxima (just as it was before #23835) otherwise?",
