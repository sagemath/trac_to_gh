...
```json
{
    "body": "<a id='comment:17'></a>\nThis is what I would suggest. I'm entirely open for suggestions regarding the name as well as the code for `is_rational_expression`.\n\nLocally, I only checked the doctests in `expression.pyx`, maybe a patchbot finds further occurrences of the symbolic `factor` method where the output has to be changed.\n\n---\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[0618fd3](https://git.sagemath.org/sage.git/commit?id=0618fd3e7ae65e34507f8218818aa6346262eb1d)|`helper method: is_rational_expression`|\n|[131cd84](https://git.sagemath.org/sage.git/commit?id=131cd847c0d28f56a5de85d3de314ca21bed0a4d)|`let maxima handle factorization of non-rational expressions`|\n|[7c2432c](https://git.sagemath.org/sage.git/commit?id=7c2432ce2fdfe7eb905b91179a0fcaccef3d0a52)|`fix doctest; add more tests`|",
    "created_at": "2019-05-14T09:45:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27304",
    "type": "issue_comment",
