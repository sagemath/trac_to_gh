...
```json
{
    "body": "<a id='comment:8'></a>From Rudi's comment:4, I agree that this is the correct fix.",
...
<a id='comment:8'></a>From Rudi's comment:4, I agree that this is the correct fix.
