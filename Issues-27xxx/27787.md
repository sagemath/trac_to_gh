...
```json
{
    "body": "<a id='comment:5'></a>Thanks very much for the comments. `min_spanning_tree` has indeed changed from Python 2 to Python 3, so we will just have different outputs for the doctests for the two versions.",
    "created_at": "2019-05-30T17:32:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537104",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Thanks very much for the comments. `min_spanning_tree` has indeed changed from Python 2 to Python 3, so we will just have different outputs for the doctests for the two versions.
...
```json
{
    "body": "Changing branch from \"\" to \"u/jhpalmieri/matroid-utilities\"",
    "created_at": "2019-05-30T20:17:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537105",
    "user": "https://github.com/jhpalmieri"
}
```

Changing branch from "" to "u/jhpalmieri/matroid-utilities"
...
```json
{
    "body": "Changing commit from \"\" to \"ba7554124bd266801d3af8c0dde4a68d9faac878\"",
    "created_at": "2019-05-30T20:22:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537106",
    "user": "https://github.com/jhpalmieri"
}
```

Changing commit from "" to "ba7554124bd266801d3af8c0dde4a68d9faac878"
...
```json
{
    "body": "<a id='comment:7'></a>Here is a branch which has different doctests for py2 and py3, and it also adds a doctest for the `representation` method which uses the `lift_map` optional argument. It also has different outputs depending on the version of Python.\n\nI think it is likely that the difference is with `min_spanning_tree`. At least for the doctest for `lift_cross_ratios`, I checked the particular matrix involved, and py2 and py3 give different spanning trees for the graph produced from that matrix. I couldn't see a way to get the same spanning tree, hence different doctests depending on the version of Python.\n\n---\nNew commits:",
    "created_at": "2019-05-30T20:22:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537107",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>Here is a branch which has different doctests for py2 and py3, and it also adds a doctest for the `representation` method which uses the `lift_map` optional argument. It also has different outputs depending on the version of Python.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537108",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537109",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>From Rudi's[comment:4](#comment%3A4), I agree that this is the correct fix.",
    "created_at": "2019-05-31T01:19:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537110",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>From Rudi's[comment:4](#comment%3A4), I agree that this is the correct fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537111",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537112",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27787#event-68927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537113",
...
```json
{
    "body": "Changing branch from \"u/jhpalmieri/matroid-utilities\" to \"ba7554124bd266801d3af8c0dde4a68d9faac878\"",
    "created_at": "2019-06-05T18:31:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27787#issuecomment-537114",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jhpalmieri/matroid-utilities" to "ba7554124bd266801d3af8c0dde4a68d9faac878"
