...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27833#event-350730"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27833#event-350731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27833#event-350732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27833#issuecomment-435001",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27833#issuecomment-435002",
    "user": "https://github.com/slel"
}
```
