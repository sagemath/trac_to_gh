...
```json
{
    "body": "<a id='comment:1'></a>Maybe this amounts to: when some list or tuple elements display on multiple lines,\nmake sure there are line breaks between the elements.",
    "created_at": "2019-05-15T00:02:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27833#issuecomment-538170",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>Maybe this amounts to: when some list or tuple elements display on multiple lines,
make sure there are line breaks between the elements.
...
```json
{
    "body": "<a id='comment:2'></a>Does this have to do with the display hook?",
    "created_at": "2019-05-19T22:32:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27833#issuecomment-538171",
    "user": "https://github.com/slel"
}
```

<a id='comment:2'></a>Does this have to do with the display hook?
