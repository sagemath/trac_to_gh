...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27369#event-345139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27369#event-345140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27369#event-345141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27369#issuecomment-426240",
    "user": "https://github.com/arminstraub"
}
```
