...
<a id='comment:22'></a>Addressed[comment:16](#comment%3A16) and obvious bugs from[comment:15](#comment%3A15) (in the latter case, it previously worked on Cygwin but I did not test on Cygwin after the refactoring I did; I'm confident now that it's right-enough).
