...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|\n|[d064855](https://git.sagemath.org/sage.git/commit?id=d064855d326e0b63809b6d8c7c4a8415c45f31f3)|`NumberField._element_constructor_: when given a constant PARI t_POL, there's no ambiguity and hence no need to warn the user`|",
    "created_at": "2019-05-04T17:13:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27765",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[f63c289](https://git.sagemath.org/sage.git/commit/?id=f63c289556e8e6d464e02b8abaef023730572567)|`Merge branch 'master' into t/27765/nf_warning`|\n|[5b89a97](https://git.sagemath.org/sage.git/commit/?id=5b89a97874b2af34a34f036073f2d6d3afe611ea)|`Improved test for constant polynomial.`|",
