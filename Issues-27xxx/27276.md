...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27276#event-67705"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27276#issuecomment-405602",
...
```json
{
    "body": "<a id='comment:3'></a>A possible progress towards the aim of this ticket could be #27865, which provides `GraphicsArray` with a proper `matplotlib()` method.",
    "created_at": "2019-05-24T13:14:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27276#issuecomment-405603",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:3'></a>A possible progress towards the aim of this ticket could be #27865, which provides `GraphicsArray` with a proper `matplotlib()` method.
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27276#event-67706"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27276#issuecomment-405604",
    "user": "https://github.com/embray"
}
```
