...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[f9089b2](https://git.sagemath.org/sage.git/commit?id=f9089b2bb70a8a9a0b11b42a70695e9869ea80f9)|`trac 27604: fix topcom + Python 3`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[73b304c](https://git.sagemath.org/sage.git/commit/?id=73b304c4fcf7e80b0ec3ef07ebd0aaa1cc6db6e6)|`trac 27604: fix topcom + Python 3`|",
