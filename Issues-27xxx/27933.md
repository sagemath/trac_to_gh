...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540497",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540498",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Also specifying a variable\n\n```\n....: sage: sF.subs(sF=sP+1)\nsP\n```\ngives something wrong. (Note that `sF` is not the variable, but `s` is.) The proper  result here should be an error message, I guess",
    "created_at": "2019-06-05T06:10:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540499",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:4'></a>Also specifying a variable
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540500",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540501",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540503",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69217"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Moving open critical and blocker issues to the next release milestone (optimistically).",
    "created_at": "2019-07-03T11:39:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540504",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>Moving open critical and blocker issues to the next release milestone (optimistically).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540505",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69218"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69219"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69220"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69221"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69222"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69223"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69224"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69225"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Moving to 9.4, as 9.3 has been released.",
    "created_at": "2021-05-10T17:42:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27933#issuecomment-540507",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:14'></a>Moving to 9.4, as 9.3 has been released.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69226"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69227"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69228"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69229"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69230"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69231"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69232"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27933#event-69233"
}
```
