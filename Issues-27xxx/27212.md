...
```json
{
    "body": "<a id='comment:34'></a>\nOops, typo on branch name.\n\n---\nNew commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[1ed38e1](https://git.sagemath.org/sage.git/commit?id=1ed38e19baea5feb0d2f5d79e7989a7e80440a21)|`spkg-configure for GMP`|\n|[dd39b84](https://git.sagemath.org/sage.git/commit?id=dd39b8453c2eda2d4b9bc83f0bc146a42743c14a)|`Move all the --with-mp logic into the spkg-configure.m4 for MPIR so that it`|",
    "created_at": "2019-02-12T10:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27212",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:57'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[b364988](https://git.sagemath.org/sage.git/commit/?id=b364988a362ba2c4872a002b0477858b9cac073d)|`correct logic for SAGE_GMP_PREFIX etc`|",
    "created_at": "2019-02-18T14:21:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27212",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:60'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[cb6f124](https://git.sagemath.org/sage.git/commit/?id=cb6f12448719f9fec4ec56d24b8e1275a168f09f)|`add the AX_ABSOLUTE_HEADER macro`|",
    "created_at": "2019-02-19T17:09:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27212",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:61'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[cf359b1](https://git.sagemath.org/sage.git/commit/?id=cf359b1df8fe4bf2009401888ac2e32600ec1ce0)|`iml in particular is very picky about being given an absolute path to the`|",
...
```json
{
    "body": "<a id='comment:88'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[8c8285f](https://git.sagemath.org/sage.git/commit/?id=8c8285fd7cb6df74d0430e3589581c07bae14d8d)|`spkg-configure for GMP`|\n|[956e382](https://git.sagemath.org/sage.git/commit/?id=956e3820e2bcc86db75e5a7ab1682d3c9c2cbd3e)|`Move all the --with-mp logic into the spkg-configure.m4 for MPIR so that it`|\n|[687cdf0](https://git.sagemath.org/sage.git/commit/?id=687cdf07061f4410b072a4ccd7d371e3a6fbe315)|`Replace various --with-gmp=$SAGE_LOCAL flags in spkg-installs with a`|\n|[6de961d](https://git.sagemath.org/sage.git/commit/?id=6de961d90d9e06756579f0be85a8b74b7ca04360)|`Reworked this a bit more`|\n|[f76d6d5](https://git.sagemath.org/sage.git/commit/?id=f76d6d57b3166af20da2f36299f97c2db6ec0907)|`fix typo`|\n|[5f90ff7](https://git.sagemath.org/sage.git/commit/?id=5f90ff72d2ea8f48e893d9b0bfa6fb5d3f1a7fe7)|`added a bit more explanation`|\n|[3dee97c](https://git.sagemath.org/sage.git/commit/?id=3dee97c228e0a4bf16ecd43877e93fc3e79d5610)|`correct logic for SAGE_GMP_PREFIX etc`|\n|[0308142](https://git.sagemath.org/sage.git/commit/?id=0308142fc8342c91b83b7744c47c1c3b9ae3d54e)|`add the AX_ABSOLUTE_HEADER macro`|\n|[eea0685](https://git.sagemath.org/sage.git/commit/?id=eea06854a43e37c893c9fa9e26866d7e4cce1da5)|`iml in particular is very picky about being given an absolute path to the`|",
    "created_at": "2019-04-10T10:11:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27212",
    "type": "issue_comment",
