...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379784"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379785"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379786"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379787"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27678#issuecomment-429006",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27678",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379790"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27678#issuecomment-429007",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27678#event-379794"
}
```
