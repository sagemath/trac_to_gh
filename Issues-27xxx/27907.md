...
```json
{
    "body": "<a id='comment:8'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[e8c0e64](https://git.sagemath.org/sage.git/commit?id=e8c0e64eea486a78dd51558d1889de3c6db32868)|`build-gcc: Find crti.o via ${CC} -print-file-name`|",
    "created_at": "2019-06-01T17:53:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27907",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[169fdf2](https://git.sagemath.org/sage.git/commit/?id=169fdf2c681445aab9410cd837c13bd9eefd1303)|`Add to end of LIBRARY_PATH, not front`|",
    "created_at": "2019-06-02T01:28:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27907",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[cdf180d](https://git.sagemath.org/sage.git/commit/?id=cdf180d3408bce1590afffc893c23e9f87557454)|`LIBRARY_PATH is needed in spkg-install too`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[f57d00c](https://git.sagemath.org/sage.git/commit/?id=f57d00c90048a6de34a2ad1e0045be9750a02b39)|`Find SAGE_CRTI_DIR at configure time.`|\n|[73be6cf](https://git.sagemath.org/sage.git/commit/?id=73be6cf53f30b53e5a8a3dedf8f30c2c9960475a)|`Symlink crt1.o and friends where gcc can find it`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[d8e9adf](https://git.sagemath.org/sage.git/commit/?id=d8e9adf27242e2ad4eca877c9f80b03865c04e42)|`Remove symlinks in postrm`|",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------|\n|[cd9a0e8](https://git.sagemath.org/sage.git/commit/?id=cd9a0e88aabf85d555b2062f9b25b8270ca48024)|`Fixup`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------|\n|[9e3da9b](https://git.sagemath.org/sage.git/commit/?id=9e3da9b5f00b872cf50121b70f635498db1c22ec)|`Fix up`|",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------|\n|[a04ea6b](https://git.sagemath.org/sage.git/commit/?id=a04ea6bb6fc02a21b74b9b4421eaaa9f6604a63f)|`Fix up`|",
...
```json
{
    "body": "<a id='comment:42'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------|\n|[0558eef](https://git.sagemath.org/sage.git/commit/?id=0558eef992198c4e1074b96c719be7c702c75152)|`Fix up`|",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[4f08015](https://git.sagemath.org/sage.git/commit/?id=4f0801520ef3c01cd2816081d858e6c25991d8e2)|`Define SAGE_SPKG_SCRIPTS in build scripts`|",
    "created_at": "2019-06-21T16:51:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27907",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------|\n|[18300da](https://git.sagemath.org/sage.git/commit/?id=18300dab8505158b6c9d274d0267c719f5a69e99)|`Fix postrm additions`|",
...
```json
{
    "body": "<a id='comment:49'></a>\nWent ahead and rebased on current develop so it could incorporate all the additional variables we've since added.\n\nI didn't change the name of the script yet; I would still prefer to shorten it but if anyone disagrees we can leave it as-is.\n\n---\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[a34a9f1](https://git.sagemath.org/sage.git/commit?id=a34a9f1c60297944ef119faafe65342cb9cc6ca2)|`Move sage-dist-helpers from src/bin to build/bin`|\n|[ff07121](https://git.sagemath.org/sage.git/commit?id=ff0712125a3d05500a1f77e62c371d695d1a9794)|`Split out build/bin/sage-build-env-config from sage-env-config`|",
    "created_at": "2019-07-01T12:56:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27907",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:54'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[8ed2677](https://git.sagemath.org/sage.git/commit/?id=8ed2677d73e1222c6c84e187a0772221d52946ca)|`build/pkgs/gcc/spkg-postrm: Update comments`|",
