...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-382684"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-382685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-382686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27905#issuecomment-433647",
    "user": "https://github.com/Miguel-OYeah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27905#issuecomment-433648",
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-382687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27905#issuecomment-433649",
    "user": "https://github.com/embray"
}
```
