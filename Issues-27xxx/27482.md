...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530052",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530053",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530054",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530055",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530056",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530057",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530059",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530060",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530061",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530062",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530063",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530064",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530067",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>it seems that doctests errors shown by patchbot are not related to this ticket.\n(it also says that pyflakes plugin should show things to be fixed, but this does not happen somehow)",
    "created_at": "2019-03-18T11:07:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530068",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:13'></a>it seems that doctests errors shown by patchbot are not related to this ticket.
(it also says that pyflakes plugin should show things to be fixed, but this does not happen somehow)
...
```json
{
    "body": "<a id='comment:14'></a>What can be done?",
    "created_at": "2019-03-18T12:10:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530069",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:14'></a>What can be done?
...
```json
{
    "body": "<a id='comment:15'></a>You can try running pyflakes locally. There is nothing you can do about patchbot errors not related to this ticket...",
    "created_at": "2019-03-18T12:11:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530070",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:15'></a>You can try running pyflakes locally. There is nothing you can do about patchbot errors not related to this ticket...
...
```json
{
    "body": "<a id='comment:16'></a>Replying to [dimpase](#comment%3A15): Is there a way to run pyflakes for cython file, apparently pyflakes is not able read any cpp part in the code\n> You can try running pyflakes locally. There is nothing you can do about patchbot errors not related to this ticket...",
    "created_at": "2019-03-18T14:42:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530071",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:16'></a>Replying to [dimpase](#comment%3A15): Is there a way to run pyflakes for cython file, apparently pyflakes is not able read any cpp part in the code
> You can try running pyflakes locally. There is nothing you can do about patchbot errors not related to this ticket...
...
```json
{
    "body": "<a id='comment:17'></a>Perhaps flake8 is better: see https://stackoverflow.com/questions/31269527/running-pep8-or-pylint-on-cython-code\n\nYou can install it via pip into Sage's python, naturally.",
    "created_at": "2019-03-18T14:50:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530072",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:17'></a>Perhaps flake8 is better: see https://stackoverflow.com/questions/31269527/running-pep8-or-pylint-on-cython-code
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530074",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530075",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530076",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530077",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>I still don't understand what's the problem with the patchbot. Can someone explain me?",
    "created_at": "2019-03-20T18:11:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530079",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:22'></a>I still don't understand what's the problem with the patchbot. Can someone explain me?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530081",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530082",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530083",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530084",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530087",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530088",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>Implementation and Documentation of `kruskal_iterator_from_edges` is done, Thanks for the guidelines. I am currently on my learning phase and working on such projects is only going to help me. So it doesn't matter about duration of the project. Please review the recent commit, Thanks! :)",
    "created_at": "2019-03-21T19:29:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530089",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:29'></a>Implementation and Documentation of `kruskal_iterator_from_edges` is done, Thanks for the guidelines. I am currently on my learning phase and working on such projects is only going to help me. So it doesn't matter about duration of the project. Please review the recent commit, Thanks! :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530091",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530092",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530093",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530094",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>sorry I was not clear enough, but there is a misunderstanding. I mean to replace `wfunction` by `weight_function` in the new code you are adding (= only in `filter_kruskal` and `kruskal_iterator_from_edges`), not in previously existing methods like `kruskal`, `kruskal_iterator` and `boruvka`. \n\nIndeed, these methods are called by other methods (e.g., `.min_spanning_tree()`). So with the current modifications, some doctests will break. Moreover, we usually add a deprecation warning during 1 year before effectively changing the name of a parameter to let enough time to users to update their own code.",
    "created_at": "2019-03-22T18:18:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530095",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:33'></a>sorry I was not clear enough, but there is a misunderstanding. I mean to replace `wfunction` by `weight_function` in the new code you are adding (= only in `filter_kruskal` and `kruskal_iterator_from_edges`), not in previously existing methods like `kruskal`, `kruskal_iterator` and `boruvka`. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530096",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530097",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>In method kruskal: `raise ValueError(\"The input G must be an undirected graph.\")`  and in method boruvka : ` raise ValueError(\"the input graph must be undirected\") `, error statements have written in such way. I have verified this according to Doctest.",
    "created_at": "2019-03-22T22:34:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530098",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:35'></a>In method kruskal: `raise ValueError("The input G must be an undirected graph.")`  and in method boruvka : ` raise ValueError("the input graph must be undirected") `, error statements have written in such way. I have verified this according to Doctest.
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27482#event-68244"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Ticket retargeted after milestone closed (if you don't believe this ticket is appropriate for the Sage 8.8 release please retarget manually)",
    "created_at": "2019-03-25T10:56:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530100",
    "user": "https://github.com/embray"
}
```

<a id='comment:37'></a>Ticket retargeted after milestone closed (if you don't believe this ticket is appropriate for the Sage 8.8 release please retarget manually)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530101",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530102",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530103",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530105",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>You can try it on your side and see how it affects the running time. You could also investigate on how quicksort do in practice (i.e., how is it done in C/C++ libraries). You can certainly find some experiments with different algorithms for pivot selection.",
    "created_at": "2019-03-27T08:13:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530107",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:42'></a>You can try it on your side and see how it affects the running time. You could also investigate on how quicksort do in practice (i.e., how is it done in C/C++ libraries). You can certainly find some experiments with different algorithms for pivot selection.
...
```json
{
    "body": "<a id='comment:43'></a>Do you still plan to (try to) improve the implementation or can we try to conclude this ticket ?",
    "created_at": "2019-04-09T12:15:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530108",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:43'></a>Do you still plan to (try to) improve the implementation or can we try to conclude this ticket ?
...
```json
{
    "body": "<a id='comment:44'></a>Yeah, I did try to implement it and results weren't quite good. Problem with median_of_medians is that although it is a linear time algorithm but also has large coefficient.\n\nThe result of median_of_median was still better than the one currently used for finding median. \n\nYeah it will be better if we conclude this ticket now, but still I am planning to study more about pivot selection. I also came across a data structure used for selection algorithm: https://en.wikipedia.org/wiki/Soft_heap\nWill be planning to implement it in future, for now we can conclude this ticket. Any suggestion?",
    "created_at": "2019-04-09T20:18:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530109",
    "user": "https://github.com/Hrishabh-yadav"
}
```

<a id='comment:44'></a>Yeah, I did try to implement it and results weren't quite good. Problem with median_of_medians is that although it is a linear time algorithm but also has large coefficient.
...
```json
{
    "body": "<a id='comment:45'></a>As reported by the patchbot\n\n```diff\n-    EXAMPLE:\n+    EXAMPLES::\n```",
    "created_at": "2019-04-10T08:35:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530110",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:45'></a>As reported by the patchbot
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530111",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530112",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>No. Please revert last commit. The needed change is in `kruskal_iterator_from_edges`.\n\nAlso, you should build the documentation and check if the resulting html pages display well.",
    "created_at": "2019-04-10T09:07:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530113",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:47'></a>No. Please revert last commit. The needed change is in `kruskal_iterator_from_edges`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530114",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530115",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530116",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530117",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530118",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530119",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:50'></a>LGTM.",
    "created_at": "2019-04-11T08:13:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530120",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:50'></a>LGTM.
...
```json
{
    "body": "<a id='comment:51'></a>author name should be real name",
    "created_at": "2019-04-16T09:23:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530121",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:51'></a>author name should be real name
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530122",
    "user": "https://github.com/Hrishabh-yadav"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27482#event-68245"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530123",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27482#issuecomment-530124",
    "user": "https://github.com/vbraun"
}
```
