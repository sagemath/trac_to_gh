...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27228#event-355974"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27228#issuecomment-423389",
    "user": "https://github.com/sorger-c"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27228#issuecomment-423390",
    "user": "https://github.com/sorger-c"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27228#event-355975"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27228#event-355976"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27228#event-355977"
}
```
