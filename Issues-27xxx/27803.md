...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27803#issuecomment-434361",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27803#issuecomment-434362",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27803#event-363197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27803#event-363198"
}
```
...
archive/issue_events_363199.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27803#event-363199"
}
```
...
archive/issue_events_363200.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2019-06-08T06:45:52Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/27803",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27803#event-363200"
}
```
