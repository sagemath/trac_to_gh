...
```json
{
    "body": "<a id='comment:2'></a>Have to fix some merge conflict with Sage 8.8.beta0.",
...
<a id='comment:2'></a>Have to fix some merge conflict with Sage 8.8.beta0.
...
```json
{
    "body": "<a id='comment:4'></a>Merge conflict solved.",
...
<a id='comment:4'></a>Merge conflict solved.
