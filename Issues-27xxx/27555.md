...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27555#event-360150"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27555#event-360151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27555#event-360152"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27555#event-360153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27555#issuecomment-429745",
    "user": "https://github.com/abhayptp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27555#issuecomment-429746",
    "user": "https://github.com/abhayptp"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27555#event-360154"
}
```
