...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389157",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>With python3-sage, and M2 (version 1.14) installed and working, and this ticket's branch, I get\n\n```\nsage -t --long src/sage/matrix/matrix1.pyx  # 2 doctests failed\nsage -t --long src/sage/interfaces/macaulay2.py  # 2 doctests failed\n```\nSome of these failures may be there without the branch here.",
    "created_at": "2019-06-20T09:59:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389158",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:2'></a>With python3-sage, and M2 (version 1.14) installed and working, and this ticket's branch, I get
...
```json
{
    "body": "<a id='comment:3'></a>The matrix failure should be an easy fix: please replace\n\n```\nentries = map(list, self)\n```\nby \n\n```\nentries = [list(c) for c in self]\n```\nin the macaulay method in the file matrix1.pyx.",
    "created_at": "2019-06-20T10:00:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389159",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>The matrix failure should be an easy fix: please replace
...
```json
{
    "body": "<a id='comment:4'></a>The other failure is a \"bytes versus string\" problem.\n\nEDIT:\n\nThis shoud be fixed by replacing\n\n```\nreturn s\n```\nby\n`return bytes_to_str(s)`\nin the\n`_sage_src_` method of the M2 interface.",
    "created_at": "2019-06-20T10:02:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389160",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>The other failure is a "bytes versus string" problem.
...
```json
{
    "body": "<a id='comment:5'></a>I have made my suggested changes. If you agree with them, you can set this ticket to positive review.\n\n---\nNew commits:",
    "created_at": "2019-06-20T11:07:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389161",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>I have made my suggested changes. If you agree with them, you can set this ticket to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389162",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Ok, thank you.",
    "created_at": "2019-06-20T17:04:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389163",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:6'></a>Ok, thank you.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389164",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27848#issuecomment-389165",
