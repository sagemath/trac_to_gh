...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[57d5508](https://git.sagemath.org/sage.git/commit?id=57d550854eea4adb1d51278479db75245473a5ed)|`added direction argument to NormalFan`|\n|[484bf56](https://git.sagemath.org/sage.git/commit?id=484bf563c383e0b0fc85fd3e2af991dfb41a9932)|`added outer_normal method`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[d8763cf](https://git.sagemath.org/sage.git/commit/?id=d8763cfb599939cd609099f9ab0705a861a79c9c)|`Revert \"added direction argument to NormalFan\"`|\n|[7bfda6e](https://git.sagemath.org/sage.git/commit/?id=7bfda6e46213d20d94dbaa4b87bb71e1d1f7389a)|`added hint to NormalFan(-P)`|\n|[0c653c9](https://git.sagemath.org/sage.git/commit/?id=0c653c97785a52d9a19c147e0a9bb686408120e1)|`added direction argument to Polyhedron.normal_fan`|\n|[b41def5](https://git.sagemath.org/sage.git/commit/?id=b41def5d69156640996e4a6e60d29d17b36bd435)|`Merge branch 'develop' into normalfan_outer`|",
    "created_at": "2019-07-22T12:51:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27993",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------|\n|[fd3e899](https://git.sagemath.org/sage.git/commit/?id=fd3e89926e9648fb36bb2c087deb24b0c3938ef1)|`Fixed typo`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[257d367](https://git.sagemath.org/sage.git/commit/?id=257d367898ae768446fecfae495b4c549078e369)|`Added check that the direction is inner or outer`|\n|[5ae5e68](https://git.sagemath.org/sage.git/commit/?id=5ae5e6832ca58278bff15d33d20bbddb3cf36268)|`pyflakes fix`|\n|[691046a](https://git.sagemath.org/sage.git/commit/?id=691046ad277f0a4bb30606cbbc3b3add0cb83f6e)|`fixed typo`|\n|[308dada](https://git.sagemath.org/sage.git/commit/?id=308dada78b84d1436dca28bd970e768d6ea6c42b)|`added examples`|",
    "created_at": "2019-07-23T07:59:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27993",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[9d20a1d](https://git.sagemath.org/sage.git/commit/?id=9d20a1d2ef73c9fa4e89dc0657033191d22793fd)|`replaced backtick by single quote`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[440689c](https://git.sagemath.org/sage.git/commit/?id=440689c758f36b80c4dd0a9a88eee5c5d60f2b22)|`replaced backticks in doctest`|",
    "created_at": "2019-07-24T06:18:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27993",
    "type": "issue_comment",
