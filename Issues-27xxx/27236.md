...
```json
{
    "body": "<a id='comment:16'></a>\nOK, this fixes the problem on ##27778. Ready for review?\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[efa38d1](https://git.sagemath.org/sage.git/commit?id=efa38d1ef5c06620021d8a62c387a23aa7dbb26b)|`Add patch for PARI bug https://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=2125`|",
