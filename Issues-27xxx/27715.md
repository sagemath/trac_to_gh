...
```json
{
    "body": "<a id='comment:1'></a>As it happens, the [POSIX specification for bind()](https://pubs.opengroup.org/onlinepubs/009695399/functions/bind.html) does not mention `EPERM` as an expected error, just `EACCES`.  Perhaps this is a Cygwin-specific bug.  Will have to dig a bit to see where it might be coming from.",
    "created_at": "2019-04-23T11:44:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535234",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>As it happens, the [POSIX specification for bind()](https://pubs.opengroup.org/onlinepubs/009695399/functions/bind.html) does not mention `EPERM` as an expected error, just `EACCES`.  Perhaps this is a Cygwin-specific bug.  Will have to dig a bit to see where it might be coming from.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535235",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535236",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I confirmed that this is [likely a bug in Cygwin](https://cygwin.com/ml/cygwin/2019-04/msg00161.html).  For now though it is easiest to workaround in the Notebook code.",
    "created_at": "2019-04-23T12:51:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535237",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>I confirmed that this is [likely a bug in Cygwin](https://cygwin.com/ml/cygwin/2019-04/msg00161.html).  For now though it is easiest to workaround in the Notebook code.
...
```json
{
    "body": "Changing commit from \"\" to \"75bcf7789bed4dca62c7d110fa4e470aaedcc3c5\"",
    "created_at": "2019-04-23T13:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535238",
    "user": "https://github.com/embray"
}
```

Changing commit from "" to "75bcf7789bed4dca62c7d110fa4e470aaedcc3c5"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535239",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/embray/ticket-27715\"",
    "created_at": "2019-04-23T13:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535240",
    "user": "https://github.com/embray"
}
```

Changing branch from "" to "u/embray/ticket-27715"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535241",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'm okay, in this case, with just patching the package in Sage, since the patch is only needed (in some cases) on Cygwin, so it won't be needed by most other downstream packagers, etc.\n\nI will just note for the record that the issue *could* be worked around by monkey-patching, but this is probably easier in this case.\n\n---\nNew commits:",
    "created_at": "2019-04-23T13:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535242",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>I'm okay, in this case, with just patching the package in Sage, since the patch is only needed (in some cases) on Cygwin, so it won't be needed by most other downstream packagers, etc.
...
```json
{
    "body": "<a id='comment:5'></a>I will also probably backport this to Sage 8.7 for Windows now that I have a mechanism for that.",
    "created_at": "2019-04-23T13:57:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535243",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>I will also probably backport this to Sage 8.7 for Windows now that I have a mechanism for that.
...
```json
{
    "body": "<a id='comment:6'></a>Note possible slight conflict with #26919.",
    "created_at": "2019-04-24T14:34:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535244",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>Note possible slight conflict with #26919.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535245",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535246",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535247",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535248",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27715#event-68724"
}
```
...
```json
{
    "body": "Changing branch from \"u/embray/ticket-27715\" to \"75bcf7789bed4dca62c7d110fa4e470aaedcc3c5\"",
    "created_at": "2019-04-29T12:35:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27715#issuecomment-535249",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/embray/ticket-27715" to "75bcf7789bed4dca62c7d110fa4e470aaedcc3c5"
