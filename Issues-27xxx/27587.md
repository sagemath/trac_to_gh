...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347772"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347774"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347775"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347776"
}
```
...
```json
{
    "body": "Changed keywords from **** to **py3, cygwin**",
...
Changed keywords from **** to **py3, cygwin**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27587",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27587#event-347780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27587#issuecomment-430436",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27587#issuecomment-430437",
    "user": "https://github.com/jhpalmieri"
}
```
