# Issue 27641: Remove the "-r" option in calling gap in the pexpect interface
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389784",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389785",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389786",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389787",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389788",
...
```json
{
    "body": "I don't quite understand the intention behind this change.  When using the pexpect interface to GAP, which much of Sage still (sadly) relies on (I am making progress fixing that) we *want* the `-r` flag because we *don't* want random stuff a user might have in their `~/.gap` interfering with Sage functionality.",
    "created_at": "2019-05-31T15:41:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389789",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389790",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "ISTM the problem is not that we pass `-r` in the pexpect interface, but that we *aren't* passing `-r` to the libgap interface.",
    "created_at": "2019-05-31T15:48:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389791",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "My problem with putting `-r` is that we are removing some capabilities from `gap`. Of course for other packages where the user can make changes the custom space is moved, usually by environment variables, to `.sage`. And we aren't quite able to do that with gap. Anyway the big concern is for protect the user from themselves and limit our debugging. I am not in favor of protecting the user from themselves to that degree, but we should have a way to a safe mode for debugging..",
    "created_at": "2019-05-31T19:58:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389792",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27641#event-69119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389794",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389795",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389796",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27641#event-69120"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389797",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "In any case, while this clearly needs to be discussed further the right answer is definitely *not* to just disable use of `-r` completely, as that is only likely to break more things when testing.\n\nI agree with nthiery that one way or other ignoring the user's `.gap` should *definitely* be the default when running the test suite.  The rest is debatable.",
    "created_at": "2019-06-03T06:32:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389799",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "We may want to have an option to inject `-r` for diagnostics. Which to my mind is one of its use. It gives you a rescue mode. If things works once you enter that mode then you know you messed up your `.gap` folder.\n\ngap is behaving a bit differently than say `R` where you have to explicitly load packages rather than them being loaded, mostly, on presence. This is more of a question for upstream I guess.",
    "created_at": "2019-06-03T22:59:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389801",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389802",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "That's nice. So it we can expect things to settle down slowly on that front. We just have to bear it for a little while. So now we need a mechanism to insert `-r` on request. There is already some mechanism for some other options I think, so it should just be modeled on them.",
    "created_at": "2019-06-04T20:00:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389804",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "OK wanting some feedback on this. So I still make the default to be run without `-r` but I introduce an option `no_dotgap` which default to `False` to enable it. I also fixed the doctest that triggered the issue in the first place so that `~/.gap` is always ignored in that test.\n\n---\nNew commits:",
    "created_at": "2019-06-04T23:54:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389805",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "If I had my way I would also be more aggressive about controlling exactly what GAP packages are loaded by the GAP interpreter used by Sage, because my experience has been that random GAP packages being loaded can lead to *very* difficult to trace bugs or differences in results.",
    "created_at": "2019-06-07T09:00:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389809",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389810",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389811",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389812",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389813",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "I am trying to answer too fast. I see you are trying to avoid negative settings and I can understand that. I guess we just have to bear the negative use internally.",
    "created_at": "2019-06-07T09:20:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389814",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "I am testing an alternative based on my comments.",
    "created_at": "2019-06-07T09:33:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389815",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389816",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389817",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389819",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "All right. I think it is also important to have the doctest that started it all to be fixed quickly.",
    "created_at": "2019-06-10T23:41:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389820",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389821",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389823",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "I'm not sure many instances of libgap loaded as python extensions are technically feasible; this seem to mean that one would have to mangle names in the dlls to avoid clashes etc.\n\nWhat might be feasible are several libgap workspaces.",
    "created_at": "2019-06-11T22:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389824",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389825",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27641#event-69121"
}
```
...
```json
{
    "body": "I am opening a new ticket to fix the doctest in `gap_packages` under all scenario #28233. Let's keep this ticket for the serious stuff about how we are supposed to run gap.",
    "created_at": "2019-07-23T02:11:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27641",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27641#issuecomment-389826",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27641#event-69122"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27641#event-69123"
}
```
