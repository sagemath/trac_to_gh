...
```json
{
    "body": "<a id='comment:7'></a>\nNew commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[1f1ec27](https://git.sagemath.org/sage.git/commit?id=1f1ec27c3a35d4c62e825a47567d67cb0e291431)|`some packages upgrade`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[7d825c3](https://git.sagemath.org/sage.git/commit/?id=7d825c350afc01515a67b9827c628567c5c057f8)|`some packages upgrade`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[e226ab8](https://git.sagemath.org/sage.git/commit/?id=e226ab8649d4bd3686acb8ed5919e3eaf9ab50ff)|`some packages upgrade, including cython`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[34aba48](https://git.sagemath.org/sage.git/commit/?id=34aba4806942cd2478530faeaac4c36a18085f95)|`Add Cython patch to fix Py_hash_t conversion`|",
