...
```json
{
    "body": "<a id='comment:11'></a>\nReplying to [dcoudert](#comment%3A9):\n> Then, for edges, instead of adding vertices to the queue, you add edges (with root to leaf orientation). Then, you yield an edge after a pop and add out edges to the queue.\n\n\nImplemented this. Please review. \n\n---\nNew commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[a179f9a](https://git.sagemath.org/sage.git/commit?id=a179f9ac7b81e3c5725a923ffce9513c4ee7b853)|`added edges parameter in dfs`|\n|[5284000](https://git.sagemath.org/sage.git/commit?id=5284000e2c173a709afb45c8078a7096f1938a2f)|`Merge branch 'u/gh-akshat1136/return_edges_from_depth_first_search' of git://trac.sagemath.org/sage into t/27636/return_edges_from_depth_first_search`|\n|[2b7f6e1](https://git.sagemath.org/sage.git/commit?id=2b7f6e1016d10d980195147b0a7134820dc68153)|`Made the DFS edge returning routine linear from quadratic by separating the cases where vertices and edges are returned`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|\n|[8aa0a70](https://git.sagemath.org/sage.git/commit/?id=8aa0a709f8bc354e661d8bd65b1f0b645814d458)|`Made minor changes to documentation for uniformity. Fixed errors related to DFS with number of starting vertices not equal to one.`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[7f13e03](https://git.sagemath.org/sage.git/commit/?id=7f13e031a585292ec72faa129d2d79aff415aae8)|`Fixed errors related to DFS with number of starting vertices not equal to one. Made minor change to documentation of depth_first_search function to maintain uniformity`|",
    "created_at": "2020-02-28T04:17:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27636",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[04fe5a3](https://git.sagemath.org/sage.git/commit/?id=04fe5a3f01de8e6976eb25793c212eb026849105)|`Added new tests to demonstrate working in all cases.`|",
    "created_at": "2020-02-28T09:46:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27636",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[31aa806](https://git.sagemath.org/sage.git/commit/?id=31aa806fa7a548a598aa7b270bfd6b589c3a9e81)|`Added new tests to demonstrate working in all cases.`|",
...
```json
{
    "body": "<a id='comment:33'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[b5e28e1](https://git.sagemath.org/sage.git/commit/?id=b5e28e14ef34227f6c0b18a86a51b4ab6e162488)|`added edges parameter in dfs`|\n|[7510d95](https://git.sagemath.org/sage.git/commit/?id=7510d95eb82b48345f1387c36cf183a60aa4983c)|`Made the DFS edge returning routine linear from quadratic by separating the cases where vertices and edges are returned`|\n|[3f2756e](https://git.sagemath.org/sage.git/commit/?id=3f2756e1d02e16fd7c907395a62f8bd1d89fa0b5)|`Fixed errors related to DFS with number of starting vertices not equal to one. Made minor change to documentation of depth_first_search function to maintain uniformity`|\n|[f480fd0](https://git.sagemath.org/sage.git/commit/?id=f480fd0c0426ef9dbdb02f128ff702c260763880)|`Added new tests to demonstrate working in all cases.`|",
